 ...
 */const ws=globalThis,ct=ws.ShadowRoot&&(ws.ShadyCSS===void 0||ws.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,pt=Symbol(),St=new WeakMap;let Xt=class{constructor(s,t,a){if(this._$cssResult$=!0,a!==pt)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=s,this.t=t}get styleSheet(){let s=this.o;const t=this.t;if(ct&&s===void 0){const a=t!==void 0&&t.length===1;a&&(s=St.get(t)),s===void 0&&((this.o=s=new CSSStyleSheet).replaceSync(this.cssText),a&&St.set(t,s))}return s}toString(){return this.cssText}};const zi=e=>new Xt(typeof e=="string"?e:e+"",void 0,pt),m=(e,...s)=>{const t=e.length===1?e[0]:s.reduce((a,i,r)=>a+(o=>{if(o._$cssResult$===!0)return o.cssText;if(typeof o=="number")return o;throw Error("Value passed to 'css' function must be a 'css' function result: "+o+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(i)+e[r+1],e[0]);return new Xt(t,e,pt)},_i=(e,s)=>{if(ct)e.adoptedStyleSheets=s.map(t=>t instanceof CSSStyleSheet?t:t.styleSheet);else for(const t of s){const a=document.createElement("style"),i=ws.litNonce;i!==void 0&&a.setAttribute("nonce",i),a.textContent=t.cssText,e.appendChild(a)}},Mt=ct?e=>e:e=>e instanceof CSSStyleSheet?(s=>{let t="";for(const a of s.cssRules)t+=a.cssText;return zi(t)})(e):e;/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const{is:Si,defineProperty:Mi,getOwnPropertyDescriptor:Pi,getOwnPropertyNames:Oi,getOwnPropertySymbols:Ci,getPrototypeOf:Ai}=Object,Cs=globalThis,Pt=Cs.trustedTypes,Ei=Pt?Pt.emptyScript:"",Ii=Cs.reactiveElementPolyfillSupport,Ue=(e,s)=>e,gs={toAttribute(e,s){switch(s){case Boolean:e=e?Ei:null;break;case Object:case Array:e=e==null?e:JSON.stringify(e)}return e},fromAttribute(e,s){let t=e;switch(s){case Boolean:t=e!==null;break;case Number:t=e===null?null:Number(e);break;case Object:case Array:try{t=JSON.parse(e)}catch{t=null}}return t}},ht=(e,s)=>!Si(e,s),Ot={attribute:!0,type:String,converter:gs,reflect:!1,useDefault:!1,hasChanged:ht};Symbol.metadata??=Symbol("metadata"),Cs.litPropertyMetadata??=new WeakMap;let Pe=class extends HTMLElement{static addInitializer(s){this._$Ei(),(this.l??=[]).push(s)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(s,t=Ot){if(t.state&&(t.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(s)&&((t=Object.create(t)).wrapped=!0),this.elementProperties.set(s,t),!t.noAccessor){const a=Symbol(),i=this.getPropertyDescriptor(s,a,t);i!==void 0&&Mi(this.prototype,s,i)}}static getPropertyDescriptor(s,t,a){const{get:i,set:r}=Pi(this.prototype,s)??{get(){return this[t]},set(o){this[t]=o}};return{get:i,set(o){const l=i?.call(this);r?.call(this,o),this.requestUpdate(s,l,a)},configurable:!0,enumerable:!0}}static getPropertyOptions(s){return this.elementProperties.get(s)??Ot}static _$Ei(){if(this.hasOwnProperty(Ue("elementProperties")))return;const s=Ai(this);s.finalize(),s.l!==void 0&&(this.l=[...s.l]),this.elementProperties=new Map(s.elementProperties)}static finalize(){if(this.hasOwnProperty(Ue("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(Ue("properties"))){const t=this.properties,a=[...Oi(t),...Ci(t)];for(const i of a)this.createProperty(i,t[i])}const s=this[Symbol.metadata];if(s!==null){const t=litPropertyMetadata.get(s);if(t!==void 0)for(const[a,i]of t)this.elementProperties.set(a,i)}this._$Eh=new Map;for(const[t,a]of this.elementProperties){const i=this._$Eu(t,a);i!==void 0&&this._$Eh.set(i,t)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(s){const t=[];if(Array.isArray(s)){const a=new Set(s.flat(1/0).reverse());for(const i of a)t.unshift(Mt(i))}else s!==void 0&&t.push(Mt(s));return t}static _$Eu(s,t){const a=t.attribute;return a===!1?void 0:typeof a=="string"?a:typeof s=="string"?s.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise(s=>this.enableUpdating=s),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach(s=>s(this))}addController(s){(this._$EO??=new Set).add(s),this.renderRoot!==void 0&&this.isConnected&&s.hostConnected?.()}removeController(s){this._$EO?.delete(s)}_$E_(){const s=new Map,t=this.constructor.elementProperties;for(const a of t.keys())this.hasOwnProperty(a)&&(s.set(a,this[a]),delete this[a]);s.size>0&&(this._$Ep=s)}createRenderRoot(){const s=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return _i(s,this.constructor.elementStyles),s}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this._$EO?.forEach(s=>s.hostConnected?.())}enableUpdating(s){}disconnectedCallback(){this._$EO?.forEach(s=>s.hostDisconnected?.())}attributeChangedCallback(s,t,a){this._$AK(s,a)}_$ET(s,t){const a=this.constructor.elementProperties.get(s),i=this.constructor._$Eu(s,a);if(i!==void 0&&a.reflect===!0){const r=(a.converter?.toAttribute!==void 0?a.converter:gs).toAttribute(t,a.type);this._$Em=s,r==null?this.removeAttribute(i):this.setAttribute(i,r),this._$Em=null}}_$AK(s,t){const a=this.constructor,i=a._$Eh.get(s);if(i!==void 0&&this._$Em!==i){const r=a.getPropertyOptions(i),o=typeof r.converter=="function"?{fromAttribute:r.converter}:r.converter?.fromAttribute!==void 0?r.converter:gs;this._$Em=i;const l=o.fromAttribute(t,r.type);this[i]=l??this._$Ej?.get(i)??l,this._$Em=null}}requestUpdate(s,t,a,i=!1,r){if(s!==void 0){const o=this.constructor;if(i===!1&&(r=this[s]),a??=o.getPropertyOptions(s),!((a.hasChanged??ht)(r,t)||a.useDefault&&a.reflect&&r===this._$Ej?.get(s)&&!this.hasAttribute(o._$Eu(s,a))))return;this.C(s,t,a)}this.isUpdatePending===!1&&(this._$ES=this._$EP())}C(s,t,{useDefault:a,reflect:i,wrapped:r},o){a&&!(this._$Ej??=new Map).has(s)&&(this._$Ej.set(s,o??t??this[s]),r!==!0||o!==void 0)||(this._$AL.has(s)||(this.hasUpdated||a||(t=void 0),this._$AL.set(s,t)),i===!0&&this._$Em!==s&&(this._$Eq??=new Set).add(s))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(t){Promise.reject(t)}const s=this.scheduleUpdate();return s!=null&&await s,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),this._$Ep){for(const[i,r]of this._$Ep)this[i]=r;this._$Ep=void 0}const a=this.constructor.elementProperties;if(a.size>0)for(const[i,r]of a){const{wrapped:o}=r,l=this[i];o!==!0||this._$AL.has(i)||l===void 0||this.C(i,void 0,r,l)}}let s=!1;const t=this._$AL;try{s=this.shouldUpdate(t),s?(this.willUpdate(t),this._$EO?.forEach(a=>a.hostUpdate?.()),this.update(t)):this._$EM()}catch(a){throw s=!1,this._$EM(),a}s&&this._$AE(t)}willUpdate(s){}_$AE(s){this._$EO?.forEach(t=>t.hostUpdated?.()),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(s)),this.updated(s)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(s){return!0}update(s){this._$Eq&&=this._$Eq.forEach(t=>this._$ET(t,this[t])),this._$EM()}updated(s){}firstUpdated(s){}};Pe.elementStyles=[],Pe.shadowRootOptions={mode:"open"},Pe[Ue("elementProperties")]=new Map,Pe[Ue("finalized")]=new Map,Ii?.({ReactiveElement:Pe}),(Cs.reactiveElementVersions??=[]).push("2.1.2");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const ut=globalThis,Ct=e=>e,xs=ut.trustedTypes,At=xs?xs.createPolicy("lit-html",{createHTML:e=>e}):void 0,Zt="$lit$",le=`lit$${Math.random().toFixed(9).slice(2)}$`,Qt="?"+le,Ti=`<${Qt}>`,be=document,We=()=>be.createComment(""),Fe=e=>e===null||typeof e!="object"&&typeof e!="function",ft=Array.isArray,Di=e=>ft(e)||typeof e?.[Symbol.iterator]=="function",Ws=`[ 	
\f\r]`,Be=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,Et=/-->/g,It=/>/g,we=RegExp(`>|${Ws}(?:([^\\s"'>=/]+)(${Ws}*=${Ws}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),Tt=/'/g,Dt=/"/g,ei=/^(?:script|style|textarea|title)$/i,si=e=>(s,...t)=>({_$litType$:e,strings:s,values:t}),n=si(1),d=si(2),me=Symbol.for("lit-noChange"),h=Symbol.for("lit-nothing"),Nt=new WeakMap,ve=be.createTreeWalker(be,129);function ti(e,s){if(!ft(e)||!e.hasOwnProperty("raw"))throw Error("invalid template strings array");return At!==void 0?At.createHTML(s):s}const Ni=(e,s)=>{const t=e.length-1,a=[];let i,r=s===2?"<svg>":s===3?"<math>":"",o=Be;for(let l=0;l<t;l++){const u=e[l];let y,g,f=-1,$=0;for(;$<u.length&&(o.lastIndex=$,g=o.exec(u),g!==null);)$=o.lastIndex,o===Be?g[1]==="!--"?o=Et:g[1]!==void 0?o=It:g[2]!==void 0?(ei.test(g[2])&&(i=RegExp("</"+g[2],"g")),o=we):g[3]!==void 0&&(o=we):o===we?g[0]===">"?(o=i??Be,f=-1):g[1]===void 0?f=-2:(f=o.lastIndex-g[2].length,y=g[1],o=g[3]===void 0?we:g[3]==='"'?Dt:Tt):o===Dt||o===Tt?o=we:o===Et||o===It?o=Be:(o=we,i=void 0);const K=o===we&&e[l+1].startsWith("/>")?" ":"";r+=o===Be?u+Ti:f>=0?(a.push(y),u.slice(0,f)+Zt+u.slice(f)+le+K):u+le+(f===-2?l:K)}return[ti(e,r+(e[t]||"<?>")+(s===2?"</svg>":s===3?"</math>":"")),a]};class qe{constructor({strings:s,_$litType$:t},a){let i;this.parts=[];let r=0,o=0;const l=s.length-1,u=this.parts,[y,g]=Ni(s,t);if(this.el=qe.createElement(y,a),ve.currentNode=this.el.content,t===2||t===3){const f=this.el.content.firstChild;f.replaceWith(...f.childNodes)}for(;(i=ve.nextNode())!==null&&u.length<l;){if(i.nodeType===1){if(i.hasAttributes())for(const f of i.getAttributeNames())if(f.endsWith(Zt)){const $=g[o++],K=i.getAttribute(f).split(le),ps=/([.?@])?(.*)/.exec($);u.push({type:1,index:r,name:ps[2],strings:K,ctor:ps[1]==="."?Ri:ps[1]==="?"?Hi:ps[1]==="@"?Li:As}),i.removeAttribute(f)}else f.startsWith(le)&&(u.push({type:6,index:r}),i.removeAttribute(f));if(ei.test(i.tagName)){const f=i.textContent.split(le),$=f.length-1;if($>0){i.textContent=xs?xs.emptyScript:"";for(let K=0;K<$;K++)i.append(f[K],We()),ve.nextNode(),u.push({type:2,index:++r});i.append(f[$],We())}}}else if(i.nodeType===8)if(i.data===Qt)u.push({type:2,index:r});else{let f=-1;for(;(f=i.data.indexOf(le,f+1))!==-1;)u.push({type:7,index:r}),f+=le.length-1}r++}}static createElement(s,t){const a=be.createElement("template");return a.innerHTML=s,a}}function Oe(e,s,t=e,a){if(s===me)return s;let i=a!==void 0?t._$Co?.[a]:t._$Cl;const r=Fe(s)?void 0:s._$litDirective$;return i?.constructor!==r&&(i?._$AO?.(!1),r===void 0?i=void 0:(i=new r(e),i._$AT(e,t,a)),a!==void 0?(t._$Co??=[])[a]=i:t._$Cl=i),i!==void 0&&(s=Oe(e,i._$AS(e,s.values),i,a)),s}class ji{constructor(s,t){this._$AV=[],this._$AN=void 0,this._$AD=s,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(s){const{el:{content:t},parts:a}=this._$AD,i=(s?.creationScope??be).importNode(t,!0);ve.currentNode=i;let r=ve.nextNode(),o=0,l=0,u=a[0];for(;u!==void 0;){if(o===u.index){let y;u.type===2?y=new is(r,r.nextSibling,this,s):u.type===1?y=new u.ctor(r,u.name,u.strings,this,s):u.type===6&&(y=new Bi(r,this,s)),this._$AV.push(y),u=a[++l]}o!==u?.index&&(r=ve.nextNode(),o++)}return ve.currentNode=be,i}p(s){let t=0;for(const a of this._$AV)a!==void 0&&(a.strings!==void 0?(a._$AI(s,a,t),t+=a.strings.length-2):a._$AI(s[t])),t++}}class is{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(s,t,a,i){this.type=2,this._$AH=h,this._$AN=void 0,this._$AA=s,this._$AB=t,this._$AM=a,this.options=i,this._$Cv=i?.isConnected??!0}get parentNode(){let s=this._$AA.parentNode;const t=this._$AM;return t!==void 0&&s?.nodeType===11&&(s=t.parentNode),s}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(s,t=this){s=Oe(this,s,t),Fe(s)?s===h||s==null||s===""?(this._$AH!==h&&this._$AR(),this._$AH=h):s!==this._$AH&&s!==me&&this._(s):s._$litType$!==void 0?this.$(s):s.nodeType!==void 0?this.T(s):Di(s)?this.k(s):this._(s)}O(s){return this._$AA.parentNode.insertBefore(s,this._$AB)}T(s){this._$AH!==s&&(this._$AR(),this._$AH=this.O(s))}_(s){this._$AH!==h&&Fe(this._$AH)?this._$AA.nextSibling.data=s:this.T(be.createTextNode(s)),this._$AH=s}$(s){const{values:t,_$litType$:a}=s,i=typeof a=="number"?this._$AC(s):(a.el===void 0&&(a.el=qe.createElement(ti(a.h,a.h[0]),this.options)),a);if(this._$AH?._$AD===i)this._$AH.p(t);else{const r=new ji(i,this),o=r.u(this.options);r.p(t),this.T(o),this._$AH=r}}_$AC(s){let t=Nt.get(s.strings);return t===void 0&&Nt.set(s.strings,t=new qe(s)),t}k(s){ft(this._$AH)||(this._$AH=[],this._$AR());const t=this._$AH;let a,i=0;for(const r of s)i===t.length?t.push(a=new is(this.O(We()),this.O(We()),this,this.options)):a=t[i],a._$AI(r),i++;i<t.length&&(this._$AR(a&&a._$AB.nextSibling,i),t.length=i)}_$AR(s=this._$AA.nextSibling,t){for(this._$AP?.(!1,!0,t);s!==this._$AB;){const a=Ct(s).nextSibling;Ct(s).remove(),s=a}}setConnected(s){this._$AM===void 0&&(this._$Cv=s,this._$AP?.(s))}}class As{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(s,t,a,i,r){this.type=1,this._$AH=h,this._$AN=void 0,this.element=s,this.name=t,this._$AM=i,this.options=r,a.length>2||a[0]!==""||a[1]!==""?(this._$AH=Array(a.length-1).fill(new String),this.strings=a):this._$AH=h}_$AI(s,t=this,a,i){const r=this.strings;let o=!1;if(r===void 0)s=Oe(this,s,t,0),o=!Fe(s)||s!==this._$AH&&s!==me,o&&(this._$AH=s);else{const l=s;let u,y;for(s=r[0],u=0;u<r.length-1;u++)y=Oe(this,l[a+u],t,u),y===me&&(y=this._$AH[u]),o||=!Fe(y)||y!==this._$AH[u],y===h?s=h:s!==h&&(s+=(y??"")+r[u+1]),this._$AH[u]=y}o&&!i&&this.j(s)}j(s){s===h?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,s??"")}}class Ri extends As{constructor(){super(...arguments),this.type=3}j(s){this.element[this.name]=s===h?void 0:s}}class Hi extends As{constructor(){super(...arguments),this.type=4}j(s){this.element.toggleAttribute(this.name,!!s&&s!==h)}}class Li extends As{constructor(s,t,a,i,r){super(s,t,a,i,r),this.type=5}_$AI(s,t=this){if((s=Oe(this,s,t,0)??h)===me)return;const a=this._$AH,i=s===h&&a!==h||s.capture!==a.capture||s.once!==a.once||s.passive!==a.passive,r=s!==h&&(a===h||i);i&&this.element.removeEventListener(this.name,this,a),r&&this.element.addEventListener(this.name,this,s),this._$AH=s}handleEvent(s){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,s):this._$AH.handleEvent(s)}}class Bi{constructor(s,t,a){this.element=s,this.type=6,this._$AN=void 0,this._$AM=t,this.options=a}get _$AU(){return this._$AM._$AU}_$AI(s){Oe(this,s)}}const Vi=ut.litHtmlPolyfillSupport;Vi?.(qe,is),(ut.litHtmlVersions??=[]).push("3.3.3");const Ui=(e,s,t)=>{const a=t?.renderBefore??s;let i=a._$litPart$;if(i===void 0){const r=t?.renderBefore??null;a._$litPart$=i=new is(s.insertBefore(We(),r),r,void 0,t??{})}return i._$AI(e),i};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const wt=globalThis;let w=class extends Pe{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){const s=super.createRenderRoot();return this.renderOptions.renderBefore??=s.firstChild,s}update(s){const t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(s),this._$Do=Ui(t,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return me}};w._$litElement$=!0,w.finalized=!0,wt.litElementHydrateSupport?.({LitElement:w});const Wi=wt.litElementPolyfillSupport;Wi?.({LitElement:w});(wt.litElementVersions??=[]).push("4.2.2");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 */const Ve=Gi(class extends Ji{constructor(e){if(super(e),e.type!==Yi.ATTRIBUTE||e.name!=="class"||e.strings?.length>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(e){return" "+Object.keys(e).filter(s=>e[s]).join(" ")+" "}update(e,[s]){if(this.st===void 0){this.st=new Set,e.strings!==void 0&&(this.nt=new Set(e.strings.join(" ").split(/\s/).filter(a=>a!=="")));for(const a in s)s[a]&&!this.nt?.has(a)&&this.st.add(a);return this.render(s)}const t=e.element.classList;for(const a of this.st)a in s||(t.remove(a),this.st.delete(a));for(const a in s){const i=!!s[a];i===this.st.has(a)||this.nt?.has(a)||(i?(t.add(a),this.st.add(a)):(t.remove(a),this.st.delete(a)))}return me}});var Xi=Object.defineProperty,Zi=Object.getOwnPropertyDescriptor,Es=(e,s,t,a)=>{for(var i=a>1?void 0:a?Zi(s,t):s,r=e.length-1,o;r>=0;r--)(o=e[r])&&(i=(a?o(s,t,i):o(i))||i);return a&&i&&Xi(s,t,i),i};const jt={live:d`<circle cx="12" cy="12" r="3"/><path d="M6.3 6.3a8 8 0 0 0 0 11.4M17.7 6.3a8 8 0 0 1 0 11.4M3.5 3.5a12 12 0 0 0 0 17M20.5 3.5a12 12 0 0 1 0 17"/>`,explore:d`<path d="M3 6.5 9 4l6 2.5 6-2.5v13.5L15 20l-6-2.5L3 20z"/><path d="M9 4v13.5M15 6.5V20"/>`,investigate:d`<circle cx="11" cy="11" r="6.5"/><path d="m20 20-4.3-4.3M11 8v3l2 1.5"/>`,system:d`<circle cx="12" cy="12" r="3"/><path d="M19.4 15a1.7 1.7 0 0 0 .3 1.8l.1.1a2 2 0 1 1-2.8 2.8l-.1-.1a1.7 1.7 0 0 0-1.8-.3 1.7 1.7 0 0 0-1 1.5V21a2 2 0 1 1-4 0v-.1a1.7 1.7 0 0 0-1.1-1.5 1.7 1.7 0 0 0-1.8.3l-.1.1a2 2 0 1 1-2.8-2.8l.1-.1a1.7 1.7 0 0 0 .3-1.8 1.7 1.7 0 0 0-1.5-1H3a2 2 0 1 1 0-4h.1a1.7 1.7 0 0 0 1.5-1.1 1.7 1.7 0 0 0-.3-1.8l-.1-.1a2 2 0 1 1 2.8-2.8l.1.1a1.7 1.7 0 0 0 1.8.3H9a1.7 1.7 0 0 0 1-1.5V3a2 2 0 1 1 4 0v.1a1.7 1.7 0 0 0 1 1.5 1.7 1.7 0 0 0 1.8-.3l.1-.1a2 2 0 1 1 2.8 2.8l-.1.1a1.7 1.7 0 0 0-.3 1.8V9a1.7 1.7 0 0 0 1.5 1H21a2 2 0 1 1 0 4h-.1a1.7 1.7 0 0 0-1.5 1z"/>`,camera:d`<path d="M3 8.5A1.5 1.5 0 0 1 4.5 7H8l1.5-2h5L16 7h3.5A1.5 1.5 0 0 1 21 8.5v9a1.5 1.5 0 0 1-1.5 1.5h-15A1.5 1.5 0 0 1 3 17.5z"/><circle cx="12" cy="13" r="3.5"/>`,search:d`<circle cx="11" cy="11" r="6.5"/><path d="m20 20-4.3-4.3"/>`,bell:d`<path d="M6 16V11a6 6 0 0 1 12 0v5l1.5 2h-15z"/><path d="M10 20a2 2 0 0 0 4 0"/>`,user:d`<circle cx="12" cy="8" r="4"/><path d="M4 21a8 8 0 0 1 16 0"/>`,play:d`<path d="M7 5v14l11-7z"/>`,expand:d`<path d="M15 4h5v5M9 20H4v-5M20 4l-6 6M4 20l6-6"/>`,close:d`<path d="M6 6l12 12M18 6 6 18"/>`,chevron:d`<path d="m9 6 6 6-6 6"/>`,warning:d`<path d="M12 3 2.5 20h19z"/><path d="M12 9v5M12 17h.01"/>`,info:d`<circle cx="12" cy="12" r="9"/><path d="M12 11v5M12 8h.01"/>`,lock:d`<rect x="5" y="11" width="14" height="10" rx="2"/><path d="M8 11V7a4 4 0 0 1 8 0v4"/>`,unlock:d`<rect x="5" y="11" width="14" height="10" rx="2"/><path d="M8 11V7a4 4 0 0 1 7.5-2"/>`,offline:d`<path d="M2 8.5a15 15 0 0 1 20 0M5.5 12a10 10 0 0 1 13 0M9 15.5a5 5 0 0 1 6 0"/><path d="M12 19h.01"/><path d="M3 3l18 18"/>`,refresh:d`<path d="M20 12a8 8 0 1 1-2.3-5.7"/><path d="M20 4v5h-5"/>`,layers:d`<path d="m12 3 9 5-9 5-9-5z"/><path d="m3 13 9 5 9-5M3 17.5l9 5 9-5"/>`,floor:d`<path d="M4 6h16M4 12h16M4 18h16"/><path d="M8 3v18"/>`,plus:d`<path d="M12 5v14M5 12h14"/>`,minus:d`<path d="M5 12h14"/>`,fit:d`<path d="M4 9V4h5M20 9V4h-5M4 15v5h5M20 15v5h-5"/>`,door:d`<rect x="6" y="3" width="12" height="18" rx="1"/><path d="M14 12h.01"/>`,light:d`<path d="M9 18h6M10 21h4"/><path d="M12 3a6 6 0 0 0-3.5 10.9c.8.6 1.5 1.6 1.5 2.6h4c0-1 .7-2 1.5-2.6A6 6 0 0 0 12 3z"/>`,sensor:d`<circle cx="12" cy="12" r="2"/><path d="M7.8 7.8a6 6 0 0 0 0 8.4M16.2 7.8a6 6 0 0 1 0 8.4M4.9 4.9a10 10 0 0 0 0 14.2M19.1 4.9a10 10 0 0 1 0 14.2"/>`,check:d`<path d="m5 12 5 5 9-10"/>`,clock:d`<circle cx="12" cy="12" r="9"/><path d="M12 7v5l3 2"/>`,download:d`<path d="M12 4v11M7 10l5 5 5-5M4 20h16"/>`,pin:d`<path d="M9 4h6l-1 6 3 3v2H7v-2l3-3z"/><path d="M12 15v6"/>`,more:d`<circle cx="6" cy="12" r="1.3"/><circle cx="12" cy="12" r="1.3"/><circle cx="18" cy="12" r="1.3"/>`,building:d`<rect x="4" y="3" width="16" height="18" rx="1"/><path d="M9 7h2M13 7h2M9 11h2M13 11h2M9 15h2M13 15h2M10 21v-3h4v3"/>`,map:d`<path d="M3 6.5 9 4l6 2.5 6-2.5v13.5L15 20l-6-2.5L3 20z"/>`,upload:d`<path d="M12 16V5M7 10l5-5 5 5M4 20h16"/>`,list:d`<path d="M8 6h13M8 12h13M8 18h13M3 6h.01M3 12h.01M3 18h.01"/>`,history:d`<path d="M3 12a9 9 0 1 0 3-6.7"/><path d="M3 4v5h5M12 8v4l3 2"/>`,target:d`<circle cx="12" cy="12" r="8"/><circle cx="12" cy="12" r="3"/><path d="M12 2v4M12 18v4M2 12h4M18 12h4"/>`,filter:d`<path d="M4 5h16l-6 8v6l-4-2v-4z"/>`,users:d`<circle cx="9" cy="8" r="3.5"/><path d="M2.5 20a6.5 6.5 0 0 1 13 0"/><circle cx="17" cy="9" r="2.5"/><path d="M15.5 14.5A5 5 0 0 1 21.5 20"/>`,shield:d`<path d="M12 3 4 6v6c0 4.5 3.4 7.7 8 9 4.6-1.3 8-4.5 8-9V6z"/><path d="m9 12 2 2 4-4"/>`,storage:d`<rect x="3" y="4" width="18" height="6" rx="1.5"/><rect x="3" y="14" width="18" height="6" rx="1.5"/><path d="M7 7h.01M7 17h.01"/>`,edit:d`<path d="M4 20h4l10.5-10.5a2 2 0 0 0 0-2.8l-1.2-1.2a2 2 0 0 0-2.8 0L4 16z"/><path d="m13 7 4 4"/>`,pause:d`<path d="M8 5v14M16 5v14"/>`,skip:d`<path d="M5 5v14l8-7zM15 5h2v14h-2z"/>`,case:d`<rect x="3" y="7" width="18" height="13" rx="2"/><path d="M8 7V5a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2M3 12h18"/>`,rule:d`<path d="M4 6h10M4 12h16M4 18h7"/><circle cx="18" cy="6" r="2"/><circle cx="15" cy="18" r="2"/>`,link:d`<path d="M10 14a4 4 0 0 0 5.7 0l3-3a4 4 0 0 0-5.7-5.7l-1 1"/><path d="M14 10a4 4 0 0 0-5.7 0l-3 3a4 4 0 0 0 5.7 5.7l1-1"/>`,grid:d`<rect x="3" y="3" width="7" height="7" rx="1.5"/><rect x="14" y="3" width="7" height="7" rx="1.5"/><rect x="3" y="14" width="7" height="7" rx="1.5"/><rect x="14" y="14" width="7" height="7" rx="1.5"/>`,dashboard:d`<rect x="3" y="3" width="8" height="10" rx="1.5"/><rect x="13" y="3" width="8" height="6" rx="1.5"/><rect x="13" y="11" width="8" height="10" rx="1.5"/><rect x="3" y="15" width="8" height="6" rx="1.5"/>`,home:d`<path d="M3 11 12 4l9 7"/><path d="M5 10v10h14V10"/><path d="M10 20v-6h4v6"/>`,star:d`<path d="m12 3 2.8 5.7 6.2.9-4.5 4.4 1 6.2-5.5-2.9L6.5 20.2l1-6.2L3 9.6l6.2-.9z"/>`,aperture:d`<circle cx="12" cy="12" r="9"/><path d="m14.3 4.5-5 8.6M20.7 9.5H10.8M18.4 17.5l-5-8.6M9.7 19.5l5-8.6M3.3 14.5h9.9M5.6 6.5l5 8.6"/>`,volume:d`<path d="M4 9.5v5h3.5L12 18.5v-13L7.5 9.5z"/><path d="M15.5 8.5a5 5 0 0 1 0 7M18.5 5.5a9 9 0 0 1 0 13"/>`,mic:d`<rect x="9" y="3" width="6" height="11" rx="3"/><path d="M5.5 11a6.5 6.5 0 0 0 13 0M12 17.5V21M9 21h6"/>`,back10:d`<path d="M4 12a8 8 0 1 0 2.3-5.7"/><path d="M4 4v5h5"/><path d="M10.5 15.5V10l-1.5 1"/><rect x="13.5" y="10" width="3.5" height="5.5" rx="1.7"/>`,forward10:d`<path d="M20 12a8 8 0 1 1-2.3-5.7"/><path d="M20 4v5h-5"/><path d="M10.5 15.5V10l-1.5 1"/><rect x="13.5" y="10" width="3.5" height="5.5" rx="1.7"/>`,chevronDown:d`<path d="m6 9 6 6 6-6"/>`,stairs:d`<path d="M3 20h4v-4h4v-4h4V8h5"/>`,elevator:d`<rect x="4" y="3" width="16" height="18" rx="1.5"/><path d="M12 3v18M8 10l1.5-2 1.5 2M14.5 14l1.5 2 1.5-2"/>`,menu:d`<path d="M4 7h16M4 12h16M4 17h16"/>`,calendar:d`<rect x="3" y="5" width="18" height="16" rx="2"/><path d="M3 10h18M8 3v4M16 3v4"/>`,trash:d`<path d="M4 7h16M9 7V4h6v3M6 7l1 13h10l1-13"/>`,eye:d`<path d="M2 12s3.5-6 10-6 10 6 10 6-3.5 6-10 6S2 12 2 12z"/><circle cx="12" cy="12" r="3"/>`,cpu:d`<rect x="6" y="6" width="12" height="12" rx="2"/><rect x="9" y="9" width="6" height="6"/><path d="M9 2v4M15 2v4M9 18v4M15 18v4M2 9h4M2 15h4M18 9h4M18 15h4"/>`,activity:d`<path d="M3 12h4l3-8 4 16 3-8h4"/>`,image:d`<rect x="3" y="4" width="18" height="16" rx="2"/><circle cx="8.5" cy="9.5" r="1.5"/><path d="m21 16-5-5-9 9"/>`,wifi:d`<path d="M2 8.5a15 15 0 0 1 20 0M5.5 12a10 10 0 0 1 13 0M9 15.5a5 5 0 0 1 6 0"/><path d="M12 19h.01"/>`,signal:d`<path d="M4 18v-3M9 18v-7M14 18V7M19 18V4"/>`,move:d`<path d="M12 3v18M3 12h18M8 7l4-4 4 4M8 17l4 4 4-4M7 8l-4 4 4 4M17 8l4 4-4 4"/>`,bookmark:d`<path d="M6 3h12v18l-6-4-6 4z"/>`,route:d`<circle cx="6" cy="18" r="2.5"/><circle cx="18" cy="6" r="2.5"/><path d="M8 17c5-1 3-9 8-10"/>`,logout:d`<path d="M10 4H5v16h5M14 8l4 4-4 4M18 12H9"/>`};let Ce=class extends w{constructor(){super(...arguments),this.name="info",this.size=20,this.flip=!1}render(){this.style.setProperty("--sw-icon-size",`${this.size}px`);const e=this.name==="chevron";return n`<svg viewBox="0 0 24 24" aria-hidden="true" ?data-dir=${e}>${jt[this.name]??jt.info}</svg>`}};Ce.styles=m`
  ...
  `;Es([p()],Ce.prototype,"name",2);Es([p({type:Number})],Ce.prototype,"size",2);Es([p({type:Boolean,reflect:!0})],Ce.prototype,"flip",2);Ce=Es([b("sw-icon")],Ce);var Qi=Object.defineProperty,ea=Object.getOwnPropertyDescriptor,re=(e,s,t,a)=>{for(var i=a>1?void 0:a?ea(s,t):s,r=e.length-1,o;r>=0;r--)(o=e[r])&&(i=(a?o(s,t,i):o(i))||i);return a&&i&&Qi(s,t,i),i};let Y=class extends w{constructor(){super(...arguments),this.variant="secondary",this.size="md",this.disabled=!1,this.iconOnly=!1,this.round=!1,this.label="",this.type="button"}render(){return n`
  ...
  `;Is([p({reflect:!0})],Ae.prototype,"kind",2);Is([p()],Ae.prototype,"label",2);Is([p({type:Boolean,reflect:!0})],Ae.prototype,"onImage",2);Ae=Is([b("sw-badge")],Ae);var ra=Object.defineProperty,na=Object.getOwnPropertyDescriptor,rs=(e,s,t,a)=>{for(var i=a>1?void 0:a?na(s,t):s,r=e.length-1,o;r>=0;r--)(o=e[r])&&(i=(a?o(s,t,i):o(i))||i);return a&&i&&ra(s,t,i),i};let ge=class extends w{constructor(){super(...arguments),this.items=[],this.active="",this.segmented=!1,this.underline=!1}choose(e){this.active=e.id,this.dispatchEvent(new CustomEvent("change",{detail:{id:e.id},bubbles:!0,composed:!0}))}render(){return n`${this.items.map(e=>e.href?n`<a href=${e.href} class=${e.id===this.active?"on":""} aria-current=${e.id===this.active?"page":"false"}>${e.label}${e.count!==void 0?n`<span class="count">(${e.count})</span>`:""}</a>`:n`<button type="button" class=${e.id===this.active?"on":""} aria-pressed=${e.id===this.active} @click=${()=>this.choose(e)}>${e.label}${e.count!==void 0?n`<span class="count">(${e.count})</span>`:""}</button>`)}`}};ge.styles=m`
    :host {
      display: inline-flex;
      gap: 2px;
      overflow-x: auto;
  ...
  `;rs([p({attribute:!1})],ge.prototype,"items",2);rs([p()],ge.prototype,"active",2);rs([p({type:Boolean,reflect:!0})],ge.prototype,"segmented",2);rs([p({type:Boolean,reflect:!0})],ge.prototype,"underline",2);ge=rs([b("sw-tabs")],ge);var oa=Object.defineProperty,la=Object.getOwnPropertyDescriptor,vt=(e,s,t,a)=>{for(var i=a>1?void 0:a?la(s,t):s,r=e.length-1,o;r>=0;r--)(o=e[r])&&(i=(a?o(s,t,i):o(i))||i);return a&&i&&oa(s,t,i),i};let Ke=class extends w{constructor(){super(...arguments),this.name="",this.size=32}render(){this.style.setProperty("--sz",`${this.size}px`);const e=this.name.trim().split(/\s+/),s=e.length>1?e[0][0]+e[1][0]:this.name.slice(0,2);return n`${s}`}};Ke.styles=m`
    :host {
      display: inline-grid;
      place-items: center;
  ...
  `;vt([p()],Ke.prototype,"name",2);vt([p({type:Number})],Ke.prototype,"size",2);Ke=vt([b("sw-avatar")],Ke);var da=Object.defineProperty,ca=Object.getOwnPropertyDescriptor,ns=(e,s,t,a)=>{for(var i=a>1?void 0:a?ca(s,t):s,r=e.length-1,o;r>=0;r--)(o=e[r])&&(i=(a?o(s,t,i):o(i))||i);return a&&i&&da(s,t,i),i};let xe=class extends w{constructor(){super(...arguments),this.selected=!1,this.dot=""}render(){return n`
  ...
  `;ns([p({type:Boolean,reflect:!0})],xe.prototype,"selected",2);ns([p()],xe.prototype,"icon",2);ns([p({type:Number})],xe.prototype,"count",2);ns([p()],xe.prototype,"dot",2);xe=ns([b("sw-chip")],xe);var pa=Object.defineProperty,ha=Object.getOwnPropertyDescriptor,Ts=(e,s,t,a)=>{for(var i=a>1?void 0:a?ha(s,t):s,r=e.length-1,o;r>=0;r--)(o=e[r])&&(i=(a?o(s,t,i):o(i))||i);return a&&i&&pa(s,t,i),i};let Ee=class extends w{constructor(){super(...arguments),this.open=!1,this.heading="",this.subheading=""}close(){this.open=!1,this.dispatchEvent(new CustomEvent("close",{bubbles:!0,composed:!0}))}render(){return n`
  ...
  `;Re([p()],de.prototype,"heading",2);Re([p({type:Number})],de.prototype,"x",2);Re([p({type:Number})],de.prototype,"y",2);Re([p({type:Number})],de.prototype,"stageWidth",2);Re([p({type:Number})],de.prototype,"stageHeight",2);de=Re([b("sw-popover")],de);var wa=Object.defineProperty,va=Object.getOwnPropertyDescriptor,Ds=(e,s,t,a)=>{for(var i=a>1?void 0:a?va(s,t):s,r=e.length-1,o;r>=0;r--)(o=e[r])&&(i=(a?o(s,t,i):o(i))||i);return a&&i&&wa(s,t,i),i};let Ie=class extends w{constructor(){super(...arguments),this.label="",this.hint="",this.inline=!1}render(){return n`
  ...
  `;Ds([p()],Ie.prototype,"label",2);Ds([p()],Ie.prototype,"hint",2);Ds([p({type:Boolean,reflect:!0})],Ie.prototype,"inline",2);Ie=Ds([b("sw-field")],Ie);var ba=Object.defineProperty,ma=Object.getOwnPropertyDescriptor,ii=(e,s,t,a)=>{for(var i=a>1?void 0:a?ma(s,t):s,r=e.length-1,o;r>=0;r--)(o=e[r])&&(i=(a?o(s,t,i):o(i))||i);return a&&i&&ba(s,t,i),i};let ga=0,ys=class extends w{constructor(){super(...arguments),this.kind="lobby",this.uid=`sc${ga+=1}`}grad(e,s,t=!0){const a=`${e}-${this.uid}`;return d`<linearGradient id=${a} x1="0" y1="0" x2=${t?0:1} y2=${t?1:0}>${s.map(([i,r])=>d`<stop offset=${i} stop-color=${r} />`)}</linearGradient>`}url(e){return`url(#${e}-${this.uid})`}vignette(){const e=`vig-${this.uid}`;return d`<defs><radialGradient id=${e} cx="50%" cy="45%" r="72%"><stop offset="0.55" stop-color="#000" stop-opacity="0" /><stop offset="1" stop-color="#000" stop-opacity="0.38" /></radialGradient></defs><rect width="320" height="180" fill=${`url(#${e})`} />`}entrance(){return d`
  ...
  `;ii([p({reflect:!0})],ys.prototype,"kind",2);ys=ii([b("sw-scene")],ys);class Te extends Error{constructor(s,t){super(t.user_message||t.code),this.status=s,this.body=t}get code(){return this.body.code}}function xa(){return new URL("api/v1/",document.baseURI)}function bt(e){return new URL(e.replace(/^\/+/,""),xa()).toString()}function vs(e){return new URL(e.replace(/^\/+/,""),document.baseURI).toString()}async function os(e,s={}){const t=new Headers(s.headers);s.body&&!(s.body instanceof FormData)&&!t.has("Content-Type")&&t.set("Content-Type","application/json");const a=await fetch(bt(e),{...s,headers:t,credentials:"same-origin"});if(a.status===204)return;const i=await a.text();let r=null;try{r=i?JSON.parse(i):null}catch{r=null}if(!a.ok){const o=r??{code:`http_${a.status}`,user_message:a.statusText,retryable:!1,correlation_id:"",details:{}};throw new Te(a.status,o)}return r}const ne=e=>os(e),oe=(e,s)=>os(e,{method:"POST",body:s===void 0?void 0:JSON.stringify(s)}),Ns=(e,s)=>os(e,{method:"PATCH",body:JSON.stringify(s)}),ai=e=>os(e,{method:"DELETE"}),ya=(e,s)=>os(e,{method:"POST",body:s});function k(e){return e instanceof Te?e.body.user_message||e.body.code:e instanceof TypeError?"אין חיבור לשרת.":e instanceof Error?e.message:String(e)}const ri=()=>ne("settings"),$a=e=>Ns("settings",e),ka=()=>oe("media/streams/sync"),za=()=>ne("media/streams"),_a=()=>ne("media/sessions");function Ye(e,s){return bt(`cameras/${e}/snapshot.jpg${s?`?t=${s}`:""}`)}function Sa(e,s){const t=new URL(bt(`media/live/${e}/ws?profile=${s}`));return t.protocol=t.protocol==="https:"?"wss:":"ws:",t.toString()}const Ys="sw.transport";function ni(){try{const e=localStorage.getItem(Ys);return e==="webrtc"||e==="mse"||e==="auto"?e:""}catch{return""}}function Ma(e){try{e?localStorage.setItem(Ys,e):localStorage.removeItem(Ys)}catch{}}var Pa=Object.defineProperty,Oa=Object.getOwnPropertyDescriptor,F=(e,s,t,a)=>{for(var i=a>1?void 0:a?Oa(s,t):s,r=e.length-1,o;r>=0;r--)(o=e[r])&&(i=(a?o(s,t,i):o(i))||i);return a&&i&&Pa(s,t,i),i};const Ca=["avc1.640029","avc1.64002A","avc1.640033","hvc1.1.6.L153.B0","mp4a.40.2","mp4a.40.5","flac","opus"],Aa=12e3,Ea=2e4,Ia=3e3,Ta=3e4;let j=class extends w{constructor(){super(...arguments),this.cameraId="",this.profile="sub",this.mode="auto",this.poster="",this.active=!0,this.compact=!1,this.status="idle",this.transport="",this.error="",this.muted=!0,this.ws=null,this.pc=null,this.ms=null,this.sb=null,this.queue=[],this.generation=0,this.triedWebrtc=!1,this.pendingMime="",this.attempts=0,this.lastPreferMse=!1}disconnectedCallback(){super.disconnectedCallback(),this.disconnect()}updated(e){(e.has("active")||e.has("cameraId")||e.has("profile")||e.has("mode"))&&(!this.active||!this.cameraId?this.disconnect():this.reconnect())}reconnect(){this.disconnect(),this.connect()}connect(e=!1){if(!this.cameraId||!this.active)return;this.teardown();const s=this.generation+=1;this.status="connecting",this.error="",this.transport="",this.triedWebrtc=e,this.lastPreferMse=e;let t;try{t=new WebSocket(Sa(this.cameraId,this.profile))}catch{this.fail("לא ניתן לפתוח חיבור");return}t.binaryType="arraybuffer",this.ws=t,t.onopen=()=>{s===this.generation&&(this.mode==="mse"||this.mode==="auto"&&e?this.startMse():this.startWebrtc())},t.onmessage=a=>{s===this.generation&&(typeof a.data=="string"?this.onSignal(a.data):this.onFragment(a.data))},t.onerror=()=>{},t.onclose=a=>{if(s!==this.generation||this.status==="error")return;if(this.mode==="auto"&&this.transport==="webrtc"&&this.status!=="playing"&&a.code<4e3){this.webrtcFailed("WebRTC נכשל");return}const i=a.code===4403?"אין הרשאת צפייה":a.code===4429?"הגיע למכסת הזרמים":a.code===4503?"go2rtc לא זמין":a.code===4401?"נדרשת הזדהות":this.status==="playing"?"החיבור נותק":"החיבור נסגר";this.fail(i,a.code!==4401&&a.code!==4403)}}disconnect(){this.teardown(),window.clearTimeout(this.retryTimer),this.attempts=0,this.status="idle",this.transport=""}teardown(){this.generation+=1,window.clearTimeout(this.timer),window.clearTimeout(this.retryTimer),this.pendingMime="",this.pc&&(this.pc.close(),this.pc=null),this.ws&&(this.ws.onclose=null,this.ws.onerror=null,this.ws.onmessage=null,this.ws.onopen=null,this.ws.close(),this.ws=null),this.sb=null,this.queue=[],this.ms=null,this.video&&(this.video.pause(),this.video.srcObject=null,this.video.src.startsWith("blob:")&&URL.revokeObjectURL(this.video.src),this.video.removeAttribute("src"),this.video.load())}send(e){this.ws&&this.ws.readyState===WebSocket.OPEN&&this.ws.send(JSON.stringify(e))}fail(e,s=!0){if(this.teardown(),this.status="error",this.error=e,this.dispatchEvent(new CustomEvent("player-status",{detail:{status:"error",error:e},bubbles:!0,composed:!0})),s&&this.active&&this.cameraId){const t=Math.min(Ta,Ia*2**Math.min(this.attempts,6));this.attempts+=1,this.retryTimer=window.setTimeout(()=>this.connect(this.lastPreferMse),t)}}async startWebrtc(){this.triedWebrtc=!0,this.transport="webrtc";const e=this.generation,s=new RTCPeerConnection({iceServers:[{urls:"stun:stun.l.google.com:19302"}]});this.pc=s,s.ontrack=t=>{if(e!==this.generation)return;const a=t.streams[0]??new MediaStream([t.track]);this.video.srcObject!==a&&(this.video.srcObject=a,this.video.play().catch(()=>{}))},s.onicecandidate=t=>{e===this.generation&&t.candidate&&this.send({type:"webrtc/candidate",value:t.candidate.candidate})},s.onconnectionstatechange=()=>{e===this.generation&&(s.connectionState==="failed"||s.connectionState==="disconnected"||s.connectionState==="closed")&&this.webrtcFailed("WebRTC נכשל")},s.addTransceiver("video",{direction:"recvonly"}),s.addTransceiver("audio",{direction:"recvonly"});try{const t=await s.createOffer();await s.setLocalDescription(t),this.send({type:"webrtc/offer",value:t.sdp})}catch{this.webrtcFailed("WebRTC לא נתמך בדפדפן");return}window.clearTimeout(this.timer),this.timer=window.setTimeout(()=>{if(this.status==="playing")return;const t=this.pc?.connectionState==="connected";this.webrtcFailed(t?"WebRTC התחבר אך הדפדפן לא מפענח את הזרם הזה — בחר MSE או אוטומטי":"WebRTC לא התחבר (UDP חסום?)")},Aa)}webrtcFailed(e){if(this.status==="playing"&&this.transport==="webrtc"){this.fail("החיבור נותק");return}if(this.mode==="auto"&&!this.triedWebrtc){this.fail(e);return}this.mode==="auto"?(this.disconnect(),this.connect(!0)):this.fail(e)}startMse(){if(!("MediaSource"in window)){this.fail("MSE לא נתמך בדפדפן");return}window.clearTimeout(this.timer),this.transport="mse",this.queue=[],this.sb=null;const e=new MediaSource;this.ms=e,this.video.srcObject=null,this.video.src=URL.createObjectURL(e);const s=this.generation;e.addEventListener("sourceopen",()=>{if(s!==this.generation)return;const t=Ca.filter(a=>MediaSource.isTypeSupported(`video/mp4; codecs="${a}"`)).join(",");this.send({type:"mse",value:t}),this.pendingMime&&this.openSourceBuffer(this.pendingMime)},{once:!0}),this.timer=window.setTimeout(()=>{this.status!=="playing"&&this.fail(`לא התקבל וידאו (${this.mseTrace()})`)},Ea)}mseTrace(){const e=this.video;return`ms=${this.ms?.readyState??"-"} sb=${this.sb?"y":"n"} q=${this.queue.length} rs=${e?.readyState??"-"} buf=${e?.buffered.length?e.buffered.end(e.buffered.length-1).toFixed(1):"-"}`}openSourceBuffer(e){if(!this.ms||this.ms.readyState!=="open"){this.pendingMime=e;return}this.pendingMime="";try{const s=this.ms.addSourceBuffer(e);s.mode="segments",s.addEventListener("updateend",()=>this.flush()),this.sb=s,this.video.play().catch(()=>{}),this.flush()}catch{this.fail("הדפדפן לא תומך ב־codec של המצלמה")}}onSignal(e){let s;try{s=JSON.parse(e)}catch{return}switch(s.type){case"webrtc/answer":this.pc?.setRemoteDescription({type:"answer",sdp:s.value??""}).catch(()=>this.webrtcFailed("WebRTC: תשובה לא תקינה"));break;case"webrtc/candidate":this.pc?.addIceCandidate({candidate:s.value??"",sdpMid:"0"}).catch(()=>{});break;case"mse":this.openSourceBuffer(s.value??'video/mp4; codecs="avc1.640029"');break;case"error":this.transport==="webrtc"&&this.mode==="auto"?this.webrtcFailed(s.value??"WebRTC"):this.fail(s.value==="upstream_unavailable"?"go2rtc לא זמין":`שגיאת זרם: ${s.value??""}`);break}}onFragment(e){this.queue.push(e),this.flush()}evict(e){const s=this.sb,t=this.video;if(!s||s.updating||!t.buffered.length)return!1;const a=t.buffered.start(0),i=Math.max(a,t.currentTime-e);if(i-a<1)return!1;try{return s.remove(a,i),!0}catch{return!1}}flush(){const e=this.sb;if(!e||e.updating||!this.ms||this.ms.readyState!=="open")return;const s=this.video;if(s.buffered.length&&s.currentTime-s.buffered.start(0)>12&&this.evict(6))return;const t=this.queue.shift();if(t)try{e.appendBuffer(t)}catch(a){const i=a?.name??"Error";if(i==="QuotaExceededError"){this.queue.unshift(t),this.evict(2)||this.queue.shift();return}console.warn("sw-live-player: appendBuffer failed",i,a?.message),this.fail(`שגיאת buffer (${i})`)}}onTimeUpdate(){const e=this.video;if(this.transport!=="mse"||!e.buffered.length)return;const s=e.buffered.end(e.buffered.length-1);s-e.currentTime>2.5&&(e.currentTime=s-.5)}onPlaying(){window.clearTimeout(this.timer),this.attempts=0,this.status="playing",this.dispatchEvent(new CustomEvent("player-status",{detail:{status:"playing",transport:this.transport},bubbles:!0,composed:!0}))}toggleMute(){this.muted=!this.muted,this.video.muted=this.muted}fullscreen(){this.video.requestFullscreen?.()??Promise.resolve()}render(){const e=this.status!=="playing";return n`
  ...
  `;F([p()],j.prototype,"cameraId",2);F([p()],j.prototype,"profile",2);F([p()],j.prototype,"mode",2);F([p()],j.prototype,"poster",2);F([p({type:Boolean})],j.prototype,"active",2);F([p({type:Boolean,reflect:!0})],j.prototype,"compact",2);F([c()],j.prototype,"status",2);F([c()],j.prototype,"transport",2);F([c()],j.prototype,"error",2);F([c()],j.prototype,"muted",2);F([as("video")],j.prototype,"video",2);j=F([b("sw-live-player")],j);var Da=Object.defineProperty,Na=Object.getOwnPropertyDescriptor,N=(e,s,t,a)=>{for(var i=a>1?void 0:a?Na(s,t):s,r=e.length-1,o;r>=0;r--)(o=e[r])&&(i=(a?o(s,t,i):o(i))||i);return a&&i&&Da(s,t,i),i};let O=class extends w{constructor(){super(...arguments),this.name="",this.meta="",this.state="unknown",this.scene="lobby",this.selected=!1,this.compact=!1,this.dark=!1,this.noDemo=!1,this.stamp="",this.poster="",this.cameraId="",this.live=!1,this.profile="sub",this.transport="auto"}offMessage(){return this.state==="forbidden"?"אין הרשאת צפייה":this.state==="offline"?"המצלמה מנותקת":"מצב לא ידוע"}render(){if(this.state==="offline"||this.state==="forbidden"||this.state==="unknown")return n`<div class="off">
  ...
  `;N([p()],O.prototype,"name",2);N([p()],O.prototype,"meta",2);N([p({reflect:!0})],O.prototype,"state",2);N([p({reflect:!0})],O.prototype,"scene",2);N([p({type:Boolean,reflect:!0})],O.prototype,"selected",2);N([p({type:Boolean,reflect:!0})],O.prototype,"compact",2);N([p({type:Boolean,reflect:!0})],O.prototype,"dark",2);N([p({type:Boolean,reflect:!0})],O.prototype,"noDemo",2);N([p()],O.prototype,"stamp",2);N([p()],O.prototype,"poster",2);N([p()],O.prototype,"cameraId",2);N([p({type:Boolean})],O.prototype,"live",2);N([p()],O.prototype,"profile",2);N([p()],O.prototype,"transport",2);O=N([b("sw-camera-tile")],O);var ja=Object.defineProperty,Ra=Object.getOwnPropertyDescriptor,He=(e,s,t,a)=>{for(var i=a>1?void 0:a?Ra(s,t):s,r=e.length-1,o;r>=0;r--)(o=e[r])&&(i=(a?o(s,t,i):o(i))||i);return a&&i&&ja(s,t,i),i};const Ha={loading:{icon:"clock",title:()=>v("states.loading"),hint:()=>"",tone:"neutral"},empty:{icon:"map",title:()=>v("states.empty"),hint:()=>"",tone:"neutral"},error:{icon:"warning",title:()=>v("states.error"),hint:()=>v("states.errorHint"),tone:"danger"},forbidden:{icon:"lock",title:()=>v("states.forbidden"),hint:()=>v("states.forbiddenHint"),tone:"forbidden"},stale:{icon:"offline",title:()=>v("states.stale"),hint:()=>v("states.staleHint"),tone:"stale"},partial:{icon:"info",title:()=>v("states.partial"),hint:()=>"",tone:"stale"}};let ce=class extends w{constructor(){super(...arguments),this.state="empty",this.heading="",this.hint="",this.actionLabel="",this.compact=!1}render(){const e=Ha[this.state],s=this.hint||e.hint();return n`
  ...
  `;He([p({reflect:!0})],ce.prototype,"state",2);He([p()],ce.prototype,"heading",2);He([p()],ce.prototype,"hint",2);He([p()],ce.prototype,"actionLabel",2);He([p({type:Boolean,reflect:!0})],ce.prototype,"compact",2);ce=He([b("sw-state-panel")],ce);var La=Object.defineProperty,Ba=Object.getOwnPropertyDescriptor,E=(e,s,t,a)=>{for(var i=a>1?void 0:a?Ba(s,t):s,r=e.length-1,o;r>=0;r--)(o=e[r])&&(i=(a?o(s,t,i):o(i))||i);return a&&i&&La(s,t,i),i};const Rt=.2,Ht=6,Lt={live:"var(--sw-accent)",recorded:"var(--sw-accent)",historic:"var(--sw-accent)",offline:"var(--sw-offline)",stale:"var(--sw-stale)",unknown:"var(--sw-unknown)",forbidden:"var(--sw-forbidden)",error:"var(--sw-danger)",neutral:"var(--sw-surface)",partial:"var(--sw-stale)"},Va={camera:d`<path d="M-7 -4.5A1.5 1.5 0 0 1 -5.5 -6H-2l1.5-2h5L6 -6h1.5A1.5 1.5 0 0 1 9 -4.5v9A1.5 1.5 0 0 1 7.5 6h-13A1.5 1.5 0 0 1 -7 4.5z" transform="translate(-1 0) scale(0.9)"/><circle cx="-1" cy="0" r="3"/>`,lock:d`<rect x="-6" y="-2" width="12" height="9" rx="2"/><path d="M-3.5 -2v-3a3.5 3.5 0 0 1 7 0v3"/>`,light:d`<path d="M-3 6h6M-2 8.5h4"/><path d="M0 -8a5 5 0 0 0-3 9c.7.5 1.2 1.3 1.2 2.2h3.6c0-.9.5-1.7 1.2-2.2A5 5 0 0 0 0 -8z"/>`,binary_sensor:d`<circle cx="0" cy="0" r="2"/><path d="M-4.5 -4.5a6.4 6.4 0 0 0 0 9M4.5 -4.5a6.4 6.4 0 0 1 0 9"/>`};let M=class extends w{constructor(){super(...arguments),this.planWidth=1e3,this.planHeight=700,this.plan=null,this.markers=[],this.selectedId=null,this.dimEntities=!1,this.alwaysLabel=!1,this.imageUrl=null,this.editable=!1,this.scale=1,this.tx=0,this.ty=0,this.hoverId=null,this.dragging=null,this.pointers=new Map,this.lastPan=null,this.lastPinchDist=0,this.dragMoved=!1,this.fitted=!1,this.onWheel=e=>{e.preventDefault();const s=this.getBoundingClientRect();this.zoomBy(e.deltaY<0?1.15:1/1.15,e.clientX-s.left,e.clientY-s.top)},this.onMarkerPointerDown=(e,s)=>{if(!this.editable||s.button!==0)return;s.stopPropagation(),s.preventDefault(),this.dragging={id:e.id,x:e.x,y:e.y},this.viewport.setPointerCapture(s.pointerId);const t=i=>{const r=this.getBoundingClientRect(),o=this.toPlan(i.clientX-r.left,i.clientY-r.top);this.dragging={id:e.id,x:o.x,y:o.y}},a=i=>{this.viewport.removeEventListener("pointermove",t),this.viewport.removeEventListener("pointerup",a),this.viewport.removeEventListener("pointercancel",a);const r=this.getBoundingClientRect(),o=this.toPlan(i.clientX-r.left,i.clientY-r.top),l=Math.abs(o.x-e.x)>5e-4||Math.abs(o.y-e.y)>5e-4;this.dragging=null,l?this.dispatchEvent(new CustomEvent("marker-move",{detail:{id:e.id,x:o.x,y:o.y},bubbles:!0,composed:!0})):this.select(e,i)};this.viewport.addEventListener("pointermove",t),this.viewport.addEventListener("pointerup",a),this.viewport.addEventListener("pointercancel",a)},this.onPointerDown=e=>{this.pointers.set(e.pointerId,{x:e.clientX,y:e.clientY}),this.dragMoved=!1,this.pointers.size===1?(this.lastPan={x:e.clientX,y:e.clientY},this.viewport.classList.add("dragging")):this.pointers.size===2&&(this.lastPinchDist=this.pinchDistance(),this.lastPan=null)},this.onPointerMove=e=>{if(this.pointers.has(e.pointerId)){if(this.pointers.set(e.pointerId,{x:e.clientX,y:e.clientY}),this.pointers.size===2){const s=this.pinchDistance();if(this.lastPinchDist>0){const[t,a]=[...this.pointers.values()],i=this.getBoundingClientRect();this.zoomBy(s/this.lastPinchDist,(t.x+a.x)/2-i.left,(t.y+a.y)/2-i.top)}this.lastPinchDist=s,this.dragMoved=!0;return}if(this.lastPan){const s=e.clientX-this.lastPan.x,t=e.clientY-this.lastPan.y;!this.dragMoved&&Math.abs(s)+Math.abs(t)>2&&(this.dragMoved=!0,this.viewport.hasPointerCapture(e.pointerId)||this.viewport.setPointerCapture(e.pointerId)),this.tx+=s,this.ty+=t,this.lastPan={x:e.clientX,y:e.clientY}}}},this.onPointerUp=e=>{if(this.pointers.delete(e.pointerId),this.pointers.size===0)this.lastPan=null,this.viewport.classList.remove("dragging");else if(this.pointers.size===1){const[s]=[...this.pointers.values()];this.lastPan={x:s.x,y:s.y}}},this.onBackgroundClick=()=>{this.dragMoved||this.dispatchEvent(new CustomEvent("marker-select",{detail:{id:null},bubbles:!0,composed:!0}))}}connectedCallback(){super.connectedCallback(),this.resizeObserver=new ResizeObserver(()=>{this.fitted||this.fit()}),this.resizeObserver.observe(this)}disconnectedCallback(){super.disconnectedCallback(),this.resizeObserver?.disconnect()}updated(e){(e.has("planWidth")||e.has("planHeight"))&&(this.fitted=!1,this.fit()),(e.has("scale")||e.has("tx")||e.has("ty"))&&this.dispatchEvent(new CustomEvent("view-change",{bubbles:!0,composed:!0}))}toScreen(e,s){return{x:this.tx+e*this.planWidth*this.scale,y:this.ty+s*this.planHeight*this.scale}}fit(){const e=this.clientWidth,s=this.clientHeight;if(!e||!s||!this.planWidth||!this.planHeight)return;const t=24,a=Math.min((e-t*2)/this.planWidth,(s-t*2)/this.planHeight);this.scale=Math.max(Rt,Math.min(Ht,a)),this.tx=(e-this.planWidth*this.scale)/2,this.ty=(s-this.planHeight*this.scale)/2,this.fitted=!0}zoomBy(e,s,t){const a=this.clientWidth,i=this.clientHeight,r=s??a/2,o=t??i/2,l=Math.max(Rt,Math.min(Ht,this.scale*e)),u=l/this.scale;this.tx=r-(r-this.tx)*u,this.ty=o-(o-this.ty)*u,this.scale=l,this.fitted=!0}toPlan(e,s){return{x:Math.min(1,Math.max(0,(e-this.tx)/this.scale/this.planWidth)),y:Math.min(1,Math.max(0,(s-this.ty)/this.scale/this.planHeight))}}pinchDistance(){const[e,s]=[...this.pointers.values()];return Math.hypot(e.x-s.x,e.y-s.y)}select(e,s){if(this.dragMoved)return;s.stopPropagation();const t=this.toScreen(e.x,e.y),a={id:e.id,sx:t.x,sy:t.y};this.dispatchEvent(new CustomEvent("marker-select",{detail:a,bubbles:!0,composed:!0}))}fovPath(e,s,t){const a=(e-s/2)*Math.PI/180,i=(e+s/2)*Math.PI/180,r=Math.cos(a)*t,o=Math.sin(a)*t,l=Math.cos(i)*t,u=Math.sin(i)*t;return`M0 0 L${r.toFixed(1)} ${o.toFixed(1)} A${t} ${t} 0 ${s>180?1:0} 1 ${l.toFixed(1)} ${u.toFixed(1)} Z`}renderMarker(e){const s=this.dragging?.id===e.id?this.dragging:e,t=s.x*this.planWidth,a=s.y*this.planHeight,i=1/this.scale,r=e.kind==="camera",o=Lt[e.state]??Lt.neutral,l=this.selectedId===e.id,u=this.alwaysLabel||l||this.hoverId===e.id,y=Math.max(44,e.label.length*6.5+16),g=this.dimEntities&&!r,f=r?13:11;return d`
      <g class="marker ${e.state} ${l?"selected":""} ${g?"dimmed":""} ${this.editable?"editable":""}"
        ...
        <g transform="scale(${i})">
          ...
          <g class="icon" transform="scale(${r?.85:.75})">${Va[e.kind]}</g>
  ...
  `;E([p({type:Number})],M.prototype,"planWidth",2);E([p({type:Number})],M.prototype,"planHeight",2);E([p({attribute:!1})],M.prototype,"plan",2);E([p({attribute:!1})],M.prototype,"markers",2);E([p()],M.prototype,"selectedId",2);E([p({type:Boolean})],M.prototype,"dimEntities",2);E([p({type:Boolean})],M.prototype,"alwaysLabel",2);E([p()],M.prototype,"imageUrl",2);E([p({type:Boolean})],M.prototype,"editable",2);E([c()],M.prototype,"scale",2);E([c()],M.prototype,"tx",2);E([c()],M.prototype,"ty",2);E([c()],M.prototype,"hoverId",2);E([c()],M.prototype,"dragging",2);E([as(".viewport")],M.prototype,"viewport",2);M=E([b("sw-plan-canvas")],M);const Bt={name:"אתר הדגמה",building:"מבנה א"},pe=[{id:"f0",name:"קומה 0",hasPlan:!0,planWidth:1200,planHeight:800,cameraCount:6,entityCount:4},{id:"f-1",name:"קומה 1-",hasPlan:!0,planWidth:900,planHeight:1100,cameraCount:3,entityCount:1},{id:"f-2",name:"קומה 2-",hasPlan:!1,planWidth:0,planHeight:0,cameraCount:2,entityCount:0}],$s=[{id:"cam-1",name:"כניסה ראשית",floorId:"f0",x:.09,y:.52,rotation:20,fov:70,state:"live",source:"NVR ערוץ 1"},{id:"cam-2",name:"לובי",floorId:"f0",x:.34,y:.3,rotation:120,fov:80,state:"live",source:"NVR ערוץ 2"},{id:"cam-3",name:"מסדרון מזרחי",floorId:"f0",x:.62,y:.55,rotation:180,fov:60,state:"offline",source:"NVR ערוץ 3"},{id:"cam-4",name:"אולם",floorId:"f0",x:.82,y:.22,rotation:210,fov:90,state:"live",source:"NVR ערוץ 4"},{id:"cam-5",name:"חדר מדרגות",floorId:"f0",x:.9,y:.8,rotation:250,fov:60,state:"stale",source:"NVR ערוץ 5"},{id:"cam-6",name:"חניה",floorId:"f0",x:.4,y:.86,rotation:300,fov:75,state:"forbidden",source:"NVR ערוץ 6"},{id:"cam-7",name:"מחסן",floorId:"f-1",x:.3,y:.3,rotation:45,fov:70,state:"live",source:"NVR ערוץ 7"},{id:"cam-8",name:"חדר מכונות",floorId:"f-1",x:.7,y:.6,rotation:200,fov:70,state:"live",source:"NVR ערוץ 8"},{id:"cam-9",name:"מקלט",floorId:"f-1",x:.5,y:.85,rotation:270,fov:70,state:"offline",source:"NVR ערוץ 9"}],Gs=[{id:"lock.main_door",name:"דלת כניסה",floorId:"f0",x:.05,y:.4,domain:"lock",state:"locked",stateLabelKey:"entity.locked",controllable:!1,lastChanged:"לפני 12 דק׳"},{id:"light.lobby",name:"תאורת לובי",floorId:"f0",x:.3,y:.42,domain:"light",state:"on",stateLabelKey:"entity.on",controllable:!0,lastChanged:"לפני שעה"},{id:"binary_sensor.hall_motion",name:"תנועה באולם",floorId:"f0",x:.7,y:.3,domain:"binary_sensor",state:"off",stateLabelKey:"entity.off",controllable:!1,lastChanged:"לפני 3 דק׳"},{id:"light.corridor",name:"תאורת מסדרון",floorId:"f0",x:.55,y:.66,domain:"light",state:"off",stateLabelKey:"entity.off",controllable:!0,lastChanged:"אתמול 22:10"},{id:"lock.shelter",name:"דלת מקלט",floorId:"f-1",x:.46,y:.9,domain:"lock",state:"locked",stateLabelKey:"entity.locked",controllable:!1,lastChanged:"לפני 2 שעות"}],oi={f0:[{x:40,y:40,w:300,h:260,label:"לובי",kind:"lobby"},{x:40,y:340,w:300,h:220,label:"משרדים",kind:"office"},{x:40,y:600,w:460,h:160,label:"חניה מקורה",kind:"parking"},{x:380,y:40,w:420,h:300,label:"אולם",kind:"hall"},{x:840,y:40,w:320,h:300,label:"אולם ב",kind:"meeting"},{x:380,y:380,w:300,h:180,label:"חדר ישיבות",kind:"meeting"},{x:720,y:380,w:440,h:180,label:"מסדרון מזרחי",kind:"corridor"},{x:540,y:600,w:620,h:160,label:"שירותים ומדרגות",kind:"stairs"}],"f-1":[{x:40,y:40,w:400,h:400,label:"מחסן",kind:"storage"},{x:480,y:40,w:380,h:400,label:"חדר מכונות",kind:"machines"},{x:40,y:480,w:820,h:200,label:"מסדרון",kind:"corridor"},{x:40,y:720,w:820,h:340,label:"מקלט",kind:"shelter"}]};function Js(e){const s=oi[e],t=pe.find(a=>a.id===e);return!s||!t?.hasPlan?[]:s.map(a=>({x:a.x/t.planWidth,y:a.y/t.planHeight,w:a.w/t.planWidth,h:a.h/t.planHeight}))}const P="var(--sw-map-furniture)",_="var(--sw-map-furniture-line)";function Ua(e){const s=e.x+e.w/2,t=e.y+e.h/2;switch(e.kind){case"lobby":return d`<rect x=${e.x+30} y=${e.y+e.h-70} width="130" height="30" rx="4" fill=${P} stroke=${_} /><rect x=${e.x+170} y=${e.y+30} width="110" height="36" rx="10" fill=${P} stroke=${_} /><circle cx=${e.x+22} cy=${e.y+22} r="10" fill="#dfe9d9" stroke="#b9cfae" /><circle cx=${e.x+e.w-22} cy=${e.y+22} r="10" fill="#dfe9d9" stroke="#b9cfae" />`;case"office":return d`${[0,1].map(a=>[0,1,2].map(i=>d`<rect x=${e.x+30+i*92} y=${e.y+36+a*92} width="56" height="28" rx="2" fill=${P} stroke=${_} /><circle cx=${e.x+58+i*92} cy=${e.y+78+a*92} r="8" fill=${P} stroke=${_} />`))}`;case"parking":return d`${[0,1,2,3,4,5,6,7].map(a=>d`<line x1=${e.x+30+a*56} y1=${e.y+20} x2=${e.x+30+a*56} y2=${e.y+e.h-20} stroke=${_} stroke-dasharray="6 6" />`)}${[1,3,4].map(a=>d`<rect x=${e.x+42+a*56} y=${e.y+36} width="30" height="70" rx="8" fill="#d5dce8" stroke=${_} />`)}`;case"hall":return d`${[0,1,2,3].map(a=>[0,1,2,3,4,5].map(i=>d`<rect x=${e.x+50+i*56} y=${e.y+60+a*52} width="26" height="16" rx="3" fill=${P} stroke=${_} />`))}<rect x=${e.x+40} y=${e.y+20} width=${e.w-80} height="14" rx="2" fill=${P} stroke=${_} />`;case"meeting":return d`<rect x=${s-80} y=${t-26} width="160" height="52" rx="12" fill=${P} stroke=${_} />${[0,1,2].map(a=>d`<circle cx=${s-50+a*50} cy=${t-44} r="9" fill=${P} stroke=${_} /><circle cx=${s-50+a*50} cy=${t+44} r="9" fill=${P} stroke=${_} />`)}`;case"corridor":return d`<rect x=${e.x+30} y=${t-8} width="90" height="16" rx="3" fill=${P} stroke=${_} />`;case"stairs":return d`<rect x=${e.x+e.w-130} y=${e.y+30} width="100" height="100" fill=${P} stroke=${_} />${[1,2,3,4,5,6,7].map(a=>d`<line x1=${e.x+e.w-130} y1=${e.y+30+a*12.5} x2=${e.x+e.w-30} y2=${e.y+30+a*12.5} stroke=${_} />`)}${[0,1,2,3].map(a=>d`<rect x=${e.x+30+a*46} y=${e.y+30} width="36" height="46" fill=${P} stroke=${_} />`)}`;case"storage":return d`${[0,1,2,3].map(a=>d`<rect x=${e.x+40+a*92} y=${e.y+40} width="30" height=${e.h-80} fill=${P} stroke=${_} />`)}`;case"machines":return d`${[0,1,2].map(a=>d`<rect x=${e.x+40} y=${e.y+40+a*120} width="110" height="72" rx="4" fill=${P} stroke=${_} /><circle cx=${e.x+240} cy=${e.y+76+a*120} r="26" fill=${P} stroke=${_} />`)}`;case"shelter":return d`${[0,1,2,3].map(a=>d`<rect x=${e.x+60} y=${e.y+50+a*70} width="220" height="22" rx="3" fill=${P} stroke=${_} /><rect x=${e.x+e.w-280} y=${e.y+50+a*70} width="220" height="22" rx="3" fill=${P} stroke=${_} />`)}`;default:return""}}function li(e){const s=oi[e],t=pe.find(a=>a.id===e);return!s||!t?null:d`
    ...
    ${s.map(a=>d`
      ...
      `)}
  `}const Xs=[{id:"site-a",name:"אתר הדגמה",address:"רחוב הדוגמה 1",buildings:2,cameras:10,online:9,alerts:2,health:"stale"},{id:"site-b",name:"סניף צפון",address:"שדרות הדגמה 20",buildings:1,cameras:6,online:6,alerts:0,health:"live"},{id:"site-c",name:"מחסן לוגיסטי",address:"אזור תעשייה",buildings:1,cameras:4,online:3,alerts:1,health:"offline"}],Wa=[{id:"bld-a",siteId:"site-a",name:"מבנה א",floors:[{id:"f0",name:"קומה 0",cameras:6,entities:4,hasPlan:!0},{id:"f-1",name:"קומה 1-",cameras:3,entities:1,hasPlan:!0},{id:"f-2",name:"קומה 2-",cameras:2,entities:0,hasPlan:!1}]},{id:"bld-b",siteId:"site-a",name:"מבנה ב",floors:[{id:"b-f0",name:"קרקע",cameras:1,entities:2,hasPlan:!1}]}],z=[{id:"cam-1",name:"כניסה ראשית",floor:"קומה 0",state:"live",stream:"sub",fps:25,bitrateKbps:3072,firmware:"V5.8.10",lastEvent:"לפני 2 דק׳",recording:"continuous",ptz:!1,audio:!1},{id:"cam-2",name:"לובי",floor:"קומה 0",state:"live",stream:"sub",fps:25,bitrateKbps:3072,firmware:"V5.8.10",lastEvent:"לפני 5 דק׳",recording:"motion",ptz:!1,audio:!0},{id:"cam-3",name:"מסדרון מזרחי",floor:"קומה 0",state:"offline",stream:"sub",fps:null,bitrateKbps:null,firmware:"V5.8.10",lastEvent:"לפני שעה",recording:"unknown",ptz:!1,audio:!1},{id:"cam-4",name:"אולם",floor:"קומה 0",state:"live",stream:"main",fps:25,bitrateKbps:5120,firmware:"V5.8.10",lastEvent:"לפני 12 דק׳",recording:"continuous",ptz:!0,audio:!1},{id:"cam-5",name:"חדר מדרגות",floor:"קומה 0",state:"stale",stream:"sub",fps:20,bitrateKbps:2048,firmware:"V5.8.9",lastEvent:"לפני 40 דק׳",recording:"continuous",ptz:!1,audio:!1},{id:"cam-6",name:"חניה מקורה",floor:"קומה 0",state:"forbidden",stream:"sub",fps:null,bitrateKbps:null,firmware:"—",lastEvent:"—",recording:"unknown",ptz:!1,audio:!1},{id:"cam-7",name:"מחסן",floor:"קומה 1-",state:"live",stream:"sub",fps:25,bitrateKbps:3072,firmware:"V5.8.10",lastEvent:"לפני 3 שעות",recording:"motion",ptz:!1,audio:!1},{id:"cam-8",name:"חדר מכונות",floor:"קומה 1-",state:"live",stream:"sub",fps:25,bitrateKbps:3072,firmware:"V5.8.10",lastEvent:"אתמול",recording:"continuous",ptz:!1,audio:!1},{id:"cam-9",name:"מקלט",floor:"קומה 1-",state:"offline",stream:"sub",fps:null,bitrateKbps:null,firmware:"V5.8.10",lastEvent:"לפני יומיים",recording:"unknown",ptz:!1,audio:!1},{id:"cam-10",name:"חצר אחורית",floor:"חוץ",state:"live",stream:"sub",fps:25,bitrateKbps:4096,firmware:"V5.8.10",lastEvent:"לפני 8 דק׳",recording:"continuous",ptz:!0,audio:!0}],G={"cam-1":"entrance","cam-2":"lobby","cam-3":"corridor","cam-4":"hall","cam-5":"corridor","cam-6":"parking","cam-7":"warehouse","cam-8":"warehouse","cam-9":"night","cam-10":"backyard"},Zs={person:"זיהוי אדם",vehicle:"זיהוי רכב",motion:"תנועה",line:"חציית קו",offline:"מצלמה מנותקת",door:"דלת נפתחה"},Q=[{id:"ev-1",time:"היום 10:14",minuteOfDay:614,type:"person",title:"אדם זוהה",camera:"כניסה ראשית",floor:"קומה 0",source:"NVR",acked:!1,severity:"alert"},{id:"ev-2",time:"היום 09:42",minuteOfDay:582,type:"vehicle",title:"רכב זוהה",camera:"חצר אחורית",floor:"חוץ",source:"NVR",acked:!1,severity:"info"},{id:"ev-3",time:"היום 08:31",minuteOfDay:511,type:"motion",title:"תנועה",camera:"מחסן",floor:"קומה 1-",source:"NVR",acked:!0,severity:"info"},{id:"ev-4",time:"היום 08:12",minuteOfDay:492,type:"door",title:"דלת כניסה נפתחה",camera:"כניסה ראשית",floor:"קומה 0",source:"HA",acked:!0,severity:"info"},{id:"ev-5",time:"היום 07:55",minuteOfDay:475,type:"offline",title:"מסדרון מזרחי מנותק",camera:"מסדרון מזרחי",floor:"קומה 0",source:"NVR",acked:!1,severity:"critical"},{id:"ev-6",time:"היום 06:43",minuteOfDay:403,type:"line",title:"חציית קו",camera:"חניה מקורה",floor:"קומה 0",source:"NVR",acked:!0,severity:"alert"},{id:"ev-7",time:"אתמול 23:10",minuteOfDay:1390,type:"person",title:"אדם זוהה",camera:"לובי",floor:"קומה 0",source:"NVR",acked:!0,severity:"info"}],ks=[{startMin:0,endMin:190,kind:"continuous"},{startMin:205,endMin:460,kind:"continuous"},{startMin:470,endMin:474,kind:"motion"},{startMin:480,endMin:486,kind:"motion"},{startMin:492,endMin:640,kind:"continuous"},{startMin:660,endMin:1439,kind:"continuous"}],Qs=[{id:"u-1",name:"יוני",haUser:"joni",active:!0,lastSync:"לפני 20 שנ׳",groups:["מנהלי מערכת"],bindings:[{role:"מנהל מערכת VMS",scope:"כל ההתקנה"}],haAdmin:!0},{id:"u-2",name:"דנה",haUser:"dana",active:!0,lastSync:"לפני 20 שנ׳",groups:["עורכי קומה 2"],bindings:[{role:"עורך מפות",scope:"מבנה א · קומה 2"}],haAdmin:!1},{id:"u-3",name:"יוסי",haUser:"yossi",active:!0,lastSync:"לפני 20 שנ׳",groups:["מנהלי מבנה א"],bindings:[{role:"מנהל אתר/מבנה",scope:"מבנה א"}],haAdmin:!1},{id:"u-4",name:"codex",haUser:"codex",active:!0,lastSync:"לפני 20 שנ׳",groups:[],bindings:[],haAdmin:!1},{id:"u-5",name:"רון",haUser:"ron",active:!1,lastSync:"לפני 3 ימים",groups:["צופים"],bindings:[{role:"צופה",scope:"אתר הדגמה"}],haAdmin:!1}],di=[{id:"g-1",name:"מנהלי מערכת",members:1,bindings:["מנהל מערכת VMS · כל ההתקנה"]},{id:"g-2",name:"עורכי קומה 2",members:1,bindings:["עורך מפות · מבנה א · קומה 2"]},{id:"g-3",name:"מנהלי מבנה א",members:1,bindings:["מנהל אתר/מבנה · מבנה א"]},{id:"g-4",name:"צופים",members:1,bindings:["צופה · אתר הדגמה"]}],ci=[{id:"viewer",name:"צופה",allowed:"מפה, מצב ישויות מורשה, שידור חי",denied:"היסטוריה, עריכה, ייצוא, שליטה"},{id:"operator",name:"מפעיל",allowed:"צפייה, Playback, סקירת אירועים וסימון טיפול",denied:"עריכת מפות, תפקידים, ייצוא, פעולות פיזיות"},{id:"editor",name:"עורך מפות ותצוגות",allowed:"צפייה, יבוא/עריכה/פרסום מפות, מיקומים ותצוגות",denied:"Playback, ייצוא, משתמשים, סודות, שליטה"},{id:"site_admin",name:"מנהל אתר / מבנה / קומה",allowed:"מפעיל + עורך, הגדרות תוכן מקומיות",denied:"הגדרות מערכת, תפקידים, סודות, כתיבה ל־NVR"},{id:"system_admin",name:"מנהל מערכת VMS",allowed:"הגדרות מוצר, מקורות, מדיניות, קבוצות ושיוכים",denied:"ניהול HA, שליטה פיזית, ייצוא ראיות ללא grant"}],pi=[{time:"10:24",user:"יוני",action:"צפייה חיה",resource:"כניסה ראשית",decision:"הותר",role:"מנהל מערכת · כל ההתקנה"},{time:"10:18",user:"דנה",action:"פרסום תוכנית",resource:"מבנה א · קומה 2",decision:"הותר",role:"עורך מפות · קומה 2"},{time:"10:11",user:"דנה",action:"עריכת תוכנית",resource:"מבנה א · קומה 3",decision:"נחסם: מחוץ להיקף",role:"עורך מפות · קומה 2"},{time:"09:55",user:"יוסי",action:"ייצוא קטע",resource:"לובי 09:10–09:20",decision:"נחסם: אין הרשאת ייצוא",role:"מנהל מבנה · מבנה א"},{time:"09:43",user:"codex",action:"כניסה דרך Ingress",resource:"—",decision:"הותר, ללא שיוך",role:"—"},{time:"09:30",user:"יוני",action:"הפעלת תאורה",resource:"light.lobby",decision:"הותר (HA אישר)",role:"מנהל מערכת"},{time:"08:12",user:"מערכת",action:"סנכרון משתמשים",resource:"HA bridge",decision:"5 משתמשים, 0 שינויים",role:"—"}],hi=[{id:"job-1",title:"ייצוא: כניסה ראשית 09:10–09:25",status:"הושלם",progress:100,size:"182 MB",hash:"sha256 ✓"},{id:"job-2",title:"ייצוא: לובי 23:00–23:40",status:"בתהליך",progress:62,size:"—",hash:"—"},{id:"job-3",title:"תמונות מקדימות: קומה 0",status:"ממתין",progress:0,size:"—",hash:"—"},{id:"job-4",title:"ייצוא: חצר אחורית 02:00–04:00",status:"נכשל: פער בהקלטה",progress:35,size:"—",hash:"—"}],et=[{id:"case-1",title:"כניסה לא מורשית — 13.09",status:"פתוח",owner:"יוני",clips:3,notes:2,preserved:2,missing:1},{id:"case-2",title:"נזק לרכב בחניה",status:"בבדיקה",owner:"יוסי",clips:2,notes:1,preserved:2,missing:0},{id:"case-3",title:"דלת מקלט פתוחה בלילה",status:"סגור",owner:"יוני",clips:1,notes:3,preserved:1,missing:0}],st=[{id:"r-1",name:"אדם בלילה",trigger:"זיהוי אדם",scope:"חוץ · 22:00–06:00",action:"התראה + פתיחת מצלמות",enabled:!0,last:"אתמול 23:10"},{id:"r-2",name:"רכב באזור מוגבל",trigger:"זיהוי רכב",scope:"חניה מקורה",action:"התראה",enabled:!0,last:"היום 09:42"},{id:"r-3",name:"דלת נשארה פתוחה",trigger:"דלת > 60 שנ׳",scope:"כל הדלתות",action:"התראה + הקלטה",enabled:!0,last:"—"},{id:"r-4",name:"מצלמה מנותקת",trigger:"ניתוק",scope:"כל האתר",action:"התראה מיידית",enabled:!1,last:"היום 07:55"}],ui=[{name:"NVR (הקלטה)",state:"live",detail:"10/10 ערוצים, דיסק תקין"},{name:"go2rtc (מדיה)",state:"live",detail:"גרסה ‎1.9.x‎ · 4 זרמים פעילים"},{name:"גשר Home Assistant",state:"stale",detail:"סנכרון אחרון לפני 4 דק׳"},{name:"מסד נתונים",state:"live",detail:"WAL · גיבוי אחרון אתמול 02:00"},{name:"תור עבודות",state:"partial",detail:"1 בתהליך · 1 נכשל"}],Fa=["live","explore","investigate","system"];function Vt(e=window.location.hash){const s=e.replace(/^#/,"")||"/explore/floors/f0",[t,a=""]=s.split("?"),i=t.startsWith("/")?t:`/${t}`,r=i.split("/").filter(Boolean),o=r[0];return{path:i,segments:r,params:new URLSearchParams(a),mode:o&&Fa.includes(o)?o:null}}function x(e,s){window.location.hash=`#${e}`}function qa(e){const s=()=>e(Vt());return window.addEventListener("hashchange",s),e(Vt()),()=>window.removeEventListener("hashchange",s)}const tt=new Set;let Ge={mode:"loading",me:null,error:null};function hs(e){Ge=e,tt.forEach(s=>s(Ge))}function fi(e){return tt.add(e),e(Ge),()=>tt.delete(e)}async function Ka(){try{const e=await ne("me");hs({mode:e.has_access?"api":"no_access",me:e,error:null})}catch(e){e instanceof Te&&e.status===401?hs({mode:"unauthenticated",me:null,error:e.body.user_message}):e instanceof Te?hs({mode:"demo",me:null,error:e.body.user_message}):hs({mode:"demo",me:null,error:null})}return Ge}const S=()=>Ge.mode==="api";function Ya(e){const s=pe.find(a=>a.id===e)??pe[0],t=$s.filter(a=>a.floorId===s.id);return{source:"demo",floorId:s.id,floorName:s.name,buildingName:Bt.building,siteName:Bt.name,width:s.planWidth||1200,height:s.planHeight||800,imageUrl:null,planSvg:s.hasPlan?li(s.id):null,planStatus:s.hasPlan?"published":"none",planVersionId:s.hasPlan?`demo-${s.id}`:null,needsAlignment:!1,anchors:t.map((a,i)=>({id:`demo-anchor-${a.id}`,floor_id:s.id,plan_version_id:`demo-${s.id}`,resource_type:"camera",resource_id:a.id,position:{x:a.x,y:a.y},rotation_degrees:a.rotation,field_of_view_degrees:a.fov,layer_id:"cameras",label:a.name,revision:1,effective_from:"",effective_to:null,updated_at:"",camera:{id:a.id,recorder_id:"demo",channel:i+1,name:a.name,name_source:a.name,alias:null,enabled:!0,sort_order:i,main_track:null,sub_track:null,status:a.state==="offline"?"offline":"online",last_seen_at:null}})),cameras:[],permissions:{edit:!0,publish:!0,import:!0}}}async function wi(e,s=!1){if(!S())return Ya(e);const t=await ne(`floors/${e}/map${s?"?draft=true":""}`);return{source:"api",floorId:t.floor.id,floorName:t.floor.name,buildingName:t.building.name,siteName:t.site.name,width:t.plan?.width_px??1200,height:t.plan?.height_px??800,imageUrl:t.plan?vs(t.plan.image_url):null,planSvg:null,planStatus:t.plan?t.plan.status==="published"?"published":"draft":"none",planVersionId:t.plan?.id??null,needsAlignment:t.needs_alignment,anchors:t.anchors,cameras:t.cameras,permissions:t.permissions}}function bs(e,s){const t=e.camera;return t?t.status==="online"?"live":t.status==="offline"?"offline":s??"unknown":s??"unknown"}const Ga=e=>ne(`floors/${e}/plan-assets`),Ja=(e,s)=>{const t=new FormData;return t.append("file",s,s.name),ya(`floors/${e}/plan-assets`,t)},Xa=(e,s)=>oe(`floors/${e}/plan-versions`,s),vi=e=>oe(`plan-versions/${e}/publish`),Za=(e,s)=>oe(`floors/${e}/anchors`,s),Qa=(e,s)=>Ns(`map-anchors/${e}`,s),er=e=>ai(`map-anchors/${e}`),js=()=>ne("cameras"),sr=()=>oe("cameras/sync"),tr=e=>oe("cameras",e),ir=(e,s)=>Ns(`cameras/${e}`,s);function ar(){return{source:"demo",sites:Xs.map((s,t)=>({id:s.id,name:s.name,address:s.address,timezone:"Asia/Jerusalem",sort_order:t,updated_at:"",buildings:Wa.filter(a=>a.siteId===s.id).map((a,i)=>({id:a.id,site_id:s.id,name:a.name,sort_order:i,updated_at:"",floors:a.floors.map((r,o)=>{const l=pe.find(u=>u.id===r.id);return{id:r.id,building_id:a.id,name:r.name,level:-o,sort_order:o,ha_area_id:null,has_plan:r.hasPlan,published_version_id:r.hasPlan?`demo-${r.id}`:null,plan_width_px:l?.planWidth??null,plan_height_px:l?.planHeight??null,draft_version_id:null,anchor_count:r.cameras+r.entities,camera_count:r.cameras,updated_at:""}})}))})),canCreateSite:!0}}async function Rs(){if(!S())return ar();const e=await ne("sites?tree=true");return{source:"api",sites:e.sites,canCreateSite:e.can_create_site}}const rr=e=>oe("sites",e),bi=(e,s)=>oe(`sites/${e}/buildings`,s),nr=(e,s)=>oe(`buildings/${e}/floors`,s),or=(e,s)=>Ns(`floors/${e}`,s),lr=(e,s=!1)=>ai(`floors/${e}${s?"?force=true":""}`);function mi(e,s){for(const t of e.sites)for(const a of t.buildings??[]){const i=(a.floors??[]).find(r=>r.id===s);if(i)return{site:t,building:a,floor:i}}return null}function dr(e){for(const s of e.sites)for(const t of s.buildings??[])for(const a of t.floors??[])return a;return null}var cr=Object.defineProperty,pr=Object.getOwnPropertyDescriptor,B=(e,s,t,a)=>{for(var i=a>1?void 0:a?pr(s,t):s,r=e.length-1,o;r>=0;r--)(o=e[r])&&(i=(a?o(s,t,i):o(i))||i);return a&&i&&cr(s,t,i),i};const hr=[{id:"cameras",icon:"camera",label:()=>v("floor.cameras")},{id:"doors",icon:"door",label:()=>v("floor.doors")},{id:"lights",icon:"light",label:()=>v("floor.lights")},{id:"sensors",icon:"sensor",label:()=>v("floor.sensors")}],Ut=["entrance","lobby","corridor","hall","parking","warehouse","backyard","driveway","night"];let I=class extends w{constructor(){super(...arguments),this.floorId="f0",this.screenState="ready",this.bundle=null,this.tree=null,this.loadError="",this.selectedId=null,this.anchor=null,this.layers=new Set(["cameras","doors","lights","sensors"]),this.pinned=!1,this.narrow=!1,this.mq=window.matchMedia("(max-width: 767px)"),this.onMq=()=>this.narrow=this.mq.matches}connectedCallback(){super.connectedCallback(),this.narrow=this.mq.matches,this.mq.addEventListener("change",this.onMq),this.load()}disconnectedCallback(){super.disconnectedCallback(),this.mq.removeEventListener("change",this.onMq)}updated(e){e.has("floorId")&&e.get("floorId")!==void 0&&(this.selectedId=null,this.anchor=null,this.load())}async load(){this.loadError="";try{const e=this.tree??await Rs();if(this.tree=e,S()&&!mi(e,this.floorId)){const s=dr(e);if(s&&s.id!==this.floorId){x(`/explore/floors/${s.id}`);return}}this.bundle=await wi(this.floorId)}catch(e){this.loadError=k(e),this.bundle=null}}get floors(){return this.tree?.source==="api"?this.tree.sites.flatMap(e=>(e.buildings??[]).flatMap(s=>(s.floors??[]).map(t=>({id:t.id,name:`${s.name} · ${t.name}`,cameraCount:t.camera_count,hasPlan:t.has_plan})))):pe.map(e=>({id:e.id,name:e.name,cameraCount:e.cameraCount,hasPlan:e.hasPlan}))}get markers(){const e=this.bundle;if(!e)return[];const s=this.screenState==="stale";if(e.source==="demo"){const t=this.layers.has("cameras")?$s.filter(i=>i.floorId===e.floorId).map(i=>({id:i.id,kind:"camera",label:i.name,x:i.x,y:i.y,rotation:i.rotation,fov:i.fov,state:i.state})):[],a=Gs.filter(i=>i.floorId===e.floorId).filter(i=>i.domain==="lock"&&this.layers.has("doors")||i.domain==="light"&&this.layers.has("lights")||i.domain==="binary_sensor"&&this.layers.has("sensors")).map(i=>({id:i.id,kind:i.domain,label:i.name,x:i.x,y:i.y,state:s?"stale":"neutral"}));return[...t,...a]}return e.anchors.filter(t=>t.resource_type==="camera"?this.layers.has("cameras"):!0).map(t=>({id:t.id,kind:t.resource_type==="camera"?"camera":t.layer_id==="doors"?"lock":t.layer_id==="lights"?"light":"binary_sensor",label:t.camera?.name??t.label??t.resource_id,x:t.position.x,y:t.position.y,rotation:t.rotation_degrees,fov:t.field_of_view_degrees??void 0,state:t.resource_type==="camera"?bs(t):"neutral"}))}toggleLayer(e){const s=new Set(this.layers);s.has(e)?s.delete(e):s.add(e),this.layers=s}onSelect(e){this.selectedId=e.detail.id,this.anchor=e.detail.id&&e.detail.sx!==void 0&&e.detail.sy!==void 0?{x:e.detail.sx,y:e.detail.sy}:null}onViewChange(){if(!this.selectedId||!this.canvas)return;const e=this.markers.find(t=>t.id===this.selectedId);if(!e)return;const s=this.canvas.toScreen(e.x,e.y);this.anchor={x:s.x,y:s.y}}close(){this.selectedId=null,this.anchor=null}demoCameraBody(e,s){const t=e.state==="offline"?v("camera.offlineReason"):e.state==="forbidden"?v("camera.forbiddenReason"):e.state==="stale"?v("camera.staleReason"):"",a=e.state==="live"||e.state==="stale";return n`
      ${a?n`<sw-camera-tile name="" state=${e.state} scene=${G[e.id]??"lobby"} @click=${()=>x(`/live/cameras/${e.id}`)}></sw-camera-tile>`:n`<div class="off"><div><sw-icon name=${e.state==="forbidden"?"lock":"offline"} size=${22}></sw-icon><div>${t}</div></div></div>`}
    ...
    `}apiCameraBody(e,s){const t=e.camera,a=bs(e),i=Ut[((t?.channel??1)-1)%Ut.length];return n`
      ${a==="offline"?n`<div class="off"><div><sw-icon name="offline" size=${22}></sw-icon><div>${v("camera.offlineReason")}</div></div></div>`:n`<sw-camera-tile name="" state=${a==="live"?"live":"unknown"} scene=${i} poster=${t?Ye(t.id,Date.now()):""} @click=${()=>t&&x(`/live/cameras/${t.id}`)}></sw-camera-tile>`}
      ...
      <div class="head">
        ...
        <div class="tools">
          <div class="layers" role="group" aria-label=${v("floor.layers")}>
            ${hr.map(r=>n`<button class=${this.layers.has(r.id)?"on":""} title=${r.label()} aria-label=${r.label()} aria-pressed=${this.layers.has(r.id)} @click=${()=>this.toggleLayer(r.id)}><sw-icon name=${r.icon} size=${14}></sw-icon></button>`)}
          </div>
  ...
  `;B([p()],I.prototype,"floorId",2);B([p()],I.prototype,"screenState",2);B([c()],I.prototype,"bundle",2);B([c()],I.prototype,"tree",2);B([c()],I.prototype,"loadError",2);B([c()],I.prototype,"selectedId",2);B([c()],I.prototype,"anchor",2);B([c()],I.prototype,"layers",2);B([c()],I.prototype,"pinned",2);B([c()],I.prototype,"narrow",2);B([as("sw-plan-canvas")],I.prototype,"canvas",2);B([as(".stage")],I.prototype,"stage",2);I=B([b("explore-floor-map")],I);var ur=Object.defineProperty,fr=Object.getOwnPropertyDescriptor,Le=(e,s,t,a)=>{for(var i=a>1?void 0:a?fr(s,t):s,r=e.length-1,o;r>=0;r--)(o=e[r])&&(i=(a?o(s,t,i):o(i))||i);return a&&i&&ur(s,t,i),i};let he=class extends w{constructor(){super(...arguments),this.heading="",this.subheading="",this.crumbs="",this.wide=!1,this.flush=!1}render(){const e=this.crumbs?this.crumbs.split("|").map(s=>s.trim()):[];return n`
      <header>
        <div>
  ...
  `;Le([p()],he.prototype,"heading",2);Le([p()],he.prototype,"subheading",2);Le([p()],he.prototype,"crumbs",2);Le([p({type:Boolean,reflect:!0})],he.prototype,"wide",2);Le([p({type:Boolean,reflect:!0})],he.prototype,"flush",2);he=Le([b("sw-page")],he);var wr=Object.defineProperty,vr=Object.getOwnPropertyDescriptor,ls=(e,s,t,a)=>{for(var i=a>1?void 0:a?vr(s,t):s,r=e.length-1,o;r>=0;r--)(o=e[r])&&(i=(a?o(s,t,i):o(i))||i);return a&&i&&wr(s,t,i),i};let ye=class extends w{constructor(){super(...arguments),this.heading="",this.subheading="",this.flush=!1,this.interactive=!1}render(){return n`
  ...
  `;ls([p()],ye.prototype,"heading",2);ls([p()],ye.prototype,"subheading",2);ls([p({type:Boolean,reflect:!0})],ye.prototype,"flush",2);ls([p({type:Boolean,reflect:!0})],ye.prototype,"interactive",2);ye=ls([b("sw-card")],ye);var br=Object.defineProperty,mr=Object.getOwnPropertyDescriptor,Hs=(e,s,t,a)=>{for(var i=a>1?void 0:a?mr(s,t):s,r=e.length-1,o;r>=0;r--)(o=e[r])&&(i=(a?o(s,t,i):o(i))||i);return a&&i&&br(s,t,i),i};let De=class extends w{constructor(){super(...arguments),this.open=!1,this.heading="",this.subheading="",this.onKey=e=>{e.key==="Escape"&&this.open&&this.close()}}close(){this.open=!1,this.dispatchEvent(new CustomEvent("close",{bubbles:!0,composed:!0}))}connectedCallback(){super.connectedCallback(),window.addEventListener("keydown",this.onKey)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("keydown",this.onKey)}render(){return n`<div class="backdrop" @click=${e=>e.target===e.currentTarget&&this.close()}>
  ...
  `;Hs([p({type:Boolean,reflect:!0})],De.prototype,"open",2);Hs([p()],De.prototype,"heading",2);Hs([p()],De.prototype,"subheading",2);De=Hs([b("sw-dialog")],De);var gr=Object.defineProperty,xr=Object.getOwnPropertyDescriptor,ue=(e,s,t,a)=>{for(var i=a>1?void 0:a?xr(s,t):s,r=e.length-1,o;r>=0;r--)(o=e[r])&&(i=(a?o(s,t,i):o(i))||i);return a&&i&&gr(s,t,i),i};const yr=["house","building","warehouse"];let J=class extends w{constructor(){super(...arguments),this.tab="all",this.tree=null,this.dialog=null,this.formName="",this.formAddress="",this.busy=!1,this.error=""}connectedCallback(){super.connectedCallback(),this.reload()}async reload(){try{this.tree=await Rs()}catch(e){this.error=k(e)}}open(e){this.formName="",this.formAddress="",this.error="",this.dialog=e}async submit(){const e=this.dialog;if(e){this.busy=!0,this.error="";try{if(e.kind==="site"){const s=await rr({name:this.formName.trim(),address:this.formAddress.trim()});this.dialog=null,await this.reload(),this.open({kind:"building",site:s})}else{const s=await bi(e.site.id,{name:this.formName.trim()});this.dialog=null,x(`/explore/buildings/${s.id}/floors`)}}catch(s){this.error=k(s)}finally{this.busy=!1}}}openSite(e){const s=e.buildings?.[0];s?x(`/explore/buildings/${s.id}/floors`):this.open({kind:"building",site:e})}renderSites(e){return n`<div class="grid">
      ${e.sites.map((s,t)=>{const a=s.buildings??[],i=a.reduce((r,o)=>r+(o.floors??[]).reduce((l,u)=>l+u.camera_count,0),0);return n`<sw-card flush interactive @click=${()=>this.openSite(s)}>
          <div class="pic"><sw-scene kind=${yr[t%3]}></sw-scene>${e.source==="demo"?n`<span class="demo">דמו</span>`:n`<span class="demo">איור</span>`}</div>
          <div class="info">
  ...
  `;ue([c()],J.prototype,"tab",2);ue([c()],J.prototype,"tree",2);ue([c()],J.prototype,"dialog",2);ue([c()],J.prototype,"formName",2);ue([c()],J.prototype,"formAddress",2);ue([c()],J.prototype,"busy",2);ue([c()],J.prototype,"error",2);J=ue([b("explore-sites")],J);var $r=Object.defineProperty,kr=Object.getOwnPropertyDescriptor,ds=(e,s,t,a)=>{for(var i=a>1?void 0:a?kr(s,t):s,r=e.length-1,o;r>=0;r--)(o=e[r])&&(i=(a?o(s,t,i):o(i))||i);return a&&i&&$r(s,t,i),i};let $e=class extends w{constructor(){super(...arguments),this.rooms=[],this.selected=!1,this.empty=!1,this.width=132}iso(e,s){return{x:60+(e-s)*58,y:6+(e+s)*26}}poly(e){return e.map(s=>`${s.x.toFixed(1)},${s.y.toFixed(1)}`).join(" ")}render(){this.style.setProperty("--w",`${this.width}px`);const e=[this.iso(0,0),this.iso(1,0),this.iso(1,1),this.iso(0,1)],s=7,t=[this.iso(1,0),this.iso(1,1),{x:this.iso(1,1).x,y:this.iso(1,1).y+s},{x:this.iso(1,0).x,y:this.iso(1,0).y+s}],a=[this.iso(0,1),this.iso(1,1),{x:this.iso(1,1).x,y:this.iso(1,1).y+s},{x:this.iso(0,1).x,y:this.iso(0,1).y+s}];return n`<svg viewBox="0 0 120 72" aria-hidden="true">
  ...
  `;ds([p({attribute:!1})],$e.prototype,"rooms",2);ds([p({type:Boolean,reflect:!0})],$e.prototype,"selected",2);ds([p({type:Boolean,reflect:!0})],$e.prototype,"empty",2);ds([p({type:Number})],$e.prototype,"width",2);$e=ds([b("sw-floor-iso")],$e);var zr=Object.defineProperty,_r=Object.getOwnPropertyDescriptor,Z=(e,s,t,a)=>{for(var i=a>1?void 0:a?_r(s,t):s,r=e.length-1,o;r>=0;r--)(o=e[r])&&(i=(a?o(s,t,i):o(i))||i);return a&&i&&zr(s,t,i),i};let W=class extends w{constructor(){super(...arguments),this.buildingId="bld-a",this.tree=null,this.selected=null,this.tab="floors",this.dialog=null,this.busy=!1,this.error="",this.formName="",this.formLevel=0}connectedCallback(){super.connectedCallback(),this.reload()}updated(e){e.has("buildingId")&&e.get("buildingId")!==void 0&&(this.selected=null)}async reload(){try{this.tree=await Rs(),this.error=""}catch(e){this.error=k(e)}}get context(){if(!this.tree)return null;for(const t of this.tree.sites)for(const a of t.buildings??[])if(a.id===this.buildingId)return{site:t,building:a};const e=this.tree.sites[0],s=e?.buildings?.[0];return e&&s?{site:e,building:s}:null}async run(e){this.busy=!0,this.error="";try{await e(),this.dialog=null,await this.reload()}catch(s){s instanceof Te&&s.code==="has_anchors"&&this.dialog?.kind==="delete"?(this.dialog={...this.dialog,force:!0},this.error=`${s.body.user_message} (${s.body.details.anchors??""} פריטים)`):this.error=k(s)}finally{this.busy=!1}}openDialog(e){this.error="",this.formName=e?.kind==="rename"?e.floor.name:"",this.formLevel=e?.kind==="rename"?e.floor.level:0,this.dialog=e}renderDialog(e){const s=this.dialog;if(!s)return h;const t=this.tree?.source==="demo",a=n`<sw-field label="שם"><input .value=${this.formName} @input=${l=>this.formName=l.target.value} placeholder="למשל: קומה 1" autofocus /></sw-field>`,i=n`<sw-field label="מפלס (0 = קרקע, שלילי = מרתף)" hint="קובע את סדר התצוגה בין הקומות"><input type="number" data-ltr .value=${String(this.formLevel)} @input=${l=>this.formLevel=Number(l.target.value)} /></sw-field>`,r=this.error?n`<div class="err">${this.error}</div>`:h,o=t?n`<div class="err">נתוני הדגמה: אין שרת מחובר, השינוי לא יישמר.</div>`:h;switch(s.kind){case"floor":return n`<sw-dialog open heading="קומה חדשה" subheading=${`${e.name}`} @close=${()=>this.dialog=null}>
          ${a}${i}${r}${o}
          <sw-button slot="footer" variant="ghost" @click=${()=>this.dialog=null}>ביטול</sw-button>
          <sw-button slot="footer" variant="primary" ?disabled=${!this.formName.trim()||this.busy||t} @click=${()=>this.run(async()=>{const l=await nr(e.id,{name:this.formName.trim(),level:this.formLevel});this.selected=l.id})}>הוסף קומה</sw-button>
        </sw-dialog>`;case"rename":return n`<sw-dialog open heading="עריכת קומה" subheading=${s.floor.name} @close=${()=>this.dialog=null}>
          ${a}${i}${r}${o}
          <sw-button slot="footer" variant="ghost" @click=${()=>this.dialog=null}>ביטול</sw-button>
          <sw-button slot="footer" variant="primary" ?disabled=${!this.formName.trim()||this.busy||t} @click=${()=>this.run(()=>or(s.floor.id,{name:this.formName.trim(),level:this.formLevel}))}>שמירה</sw-button>
          ...
          ${r}${o}
          <sw-button slot="footer" variant="ghost" @click=${()=>this.dialog=null}>ביטול</sw-button>
          <sw-button slot="footer" variant="danger" ?disabled=${this.busy||t} @click=${()=>this.run(async()=>{await lr(s.floor.id,s.force),this.selected===s.floor.id&&(this.selected=null)})}>${s.force?"מחק כולל הפריטים":"מחק קומה"}</sw-button>
          ...
          ${a}${r}${o}
          <sw-button slot="footer" variant="ghost" @click=${()=>this.dialog=null}>ביטול</sw-button>
          <sw-button slot="footer" variant="primary" ?disabled=${!this.formName.trim()||this.busy||t} @click=${()=>this.run(async()=>{const l=await bi(this.context.site.id,{name:this.formName.trim()});x(`/explore/buildings/${l.id}/floors`)})}>הוסף מבנה</sw-button>
      ...
      <sw-page heading=${t.name} subheading=${`${s.address||s.name} · ${a.length} קומות${o.source==="demo"?" · נתוני הדגמה":""}`} crumbs=${`אתרים | ${s.name} | ${t.name}`}>
        ...
        ${this.tab==="floors"?n`<div class="list">
              ...
              ${a.map(l=>n`<button class="floor ${i?.id===l.id?"on":""}" @click=${()=>i?.id===l.id?x(`/explore/floors/${l.id}`):this.selected=l.id} aria-pressed=${i?.id===l.id}>
                  ...
                  <sw-floor-iso .rooms=${o.source==="demo"?Js(l.id):[]} ?selected=${i?.id===l.id} ?empty=${!l.has_plan} width=${128}></sw-floor-iso>
  ...
  `;Z([p()],W.prototype,"buildingId",2);Z([c()],W.prototype,"tree",2);Z([c()],W.prototype,"selected",2);Z([c()],W.prototype,"tab",2);Z([c()],W.prototype,"dialog",2);Z([c()],W.prototype,"busy",2);Z([c()],W.prototype,"error",2);Z([c()],W.prototype,"formName",2);Z([c()],W.prototype,"formLevel",2);W=Z([b("explore-floors")],W);var Sr=Object.defineProperty,Mr=Object.getOwnPropertyDescriptor,mt=(e,s,t,a)=>{for(var i=a>1?void 0:a?Mr(s,t):s,r=e.length-1,o;r>=0;r--)(o=e[r])&&(i=(a?o(s,t,i):o(i))||i);return a&&i&&Sr(s,t,i),i};let Je=class extends w{constructor(){super(...arguments),this.steps=[],this.current=0}render(){return n`${this.steps.map((e,s)=>n`
  ...
  `;mt([p({attribute:!1})],Je.prototype,"steps",2);mt([p({type:Number})],Je.prototype,"current",2);Je=mt([b("sw-steps")],Je);var Pr=Object.defineProperty,Or=Object.getOwnPropertyDescriptor,H=(e,s,t,a)=>{for(var i=a>1?void 0:a?Or(s,t):s,r=e.length-1,o;r>=0;r--)(o=e[r])&&(i=(a?o(s,t,i):o(i))||i);return a&&i&&Pr(s,t,i),i};const Fs=["קובץ","עמוד","חיתוך וסיבוב","שם והערות","שמירה ופרסום"];let C=class extends w{constructor(){super(...arguments),this.floorId="",this.step=0,this.tree=null,this.assets=[],this.asset=null,this.page=1,this.rotation=0,this.crop={x:0,y:0,w:1,h:1},this.notes="",this.version=null,this.busy=!1,this.error="",this.dragOver=!1}connectedCallback(){super.connectedCallback(),this.init()}async init(){try{this.tree=await Rs(),S()&&this.floorId&&(this.assets=(await Ga(this.floorId)).assets)}catch(e){this.error=k(e)}}get floor(){return this.tree&&this.floorId?mi(this.tree,this.floorId):null}async onFile(e){if(!(!e||!this.floorId)){this.busy=!0,this.error="";try{this.asset=await Ja(this.floorId,e),this.page=1,this.rotation=0,this.crop={x:0,y:0,w:1,h:1},this.version=null,this.step=this.asset.page_count>1?1:2,this.assets=[this.asset,...this.assets.filter(s=>s.id!==this.asset.id)]}catch(s){this.error=k(s)}finally{this.busy=!1}}}async save(){if(!(!this.asset||!this.floorId)){this.busy=!0,this.error="";try{const e=this.crop.x===0&&this.crop.y===0&&this.crop.w===1&&this.crop.h===1;this.version=await Xa(this.floorId,{asset_id:this.asset.id,page:this.page,rotation:this.rotation,crop:e?null:this.crop,notes:this.notes})}catch(e){this.error=k(e)}finally{this.busy=!1}}}async publish(){if(this.version){this.busy=!0,this.error="";try{this.version=await vi(this.version.id)}catch(e){this.error=k(e)}finally{this.busy=!1}}}setCrop(e,s){const t=Math.max(0,Math.min(100,s))/100,a={...this.crop,[e]:t};a.x+a.w>1&&(a.w=1-a.x),a.y+a.h>1&&(a.h=1-a.y),a.w<=.02&&(a.w=.02),a.h<=.02&&(a.h=.02),this.crop=a}previewUrl(){const e=this.asset?.pages.find(s=>s.page===this.page)??this.asset?.pages[0];return e?vs(e.preview_url):""}renderStep(){const e=this.asset;switch(this.step){case 0:return n`
          ...
          <div class="pages">${e?.pages.map(s=>n`<button class="pg ${s.page===this.page?"on":""}" @click=${()=>this.page=s.page}><img src=${vs(s.preview_url)} alt=${`עמוד ${s.page}`} loading="lazy" />עמוד ${s.page}</button>`)}</div>`;case 2:{const s=this.rotation,t=this.crop,a=s%180===0?t:{x:t.x,y:t.y,w:t.w,h:t.h};return n`
          <div class="preview">
          ...
          ${this.version?n`<div class="ok">✓ הגרסה נשמרה (${this.version.width_px}×${this.version.height_px} px) · ${this.version.status==="published"?"פורסמה — היא הרקע של הקומה":"טיוטה — עורכי הקומה רואים אותה, צופים עדיין לא"}</div>
                <div class="preview" style="min-block-size:220px"><img src=${vs(this.version.image_url)} alt="רקע התוכנית" /></div>`:n`<div class="note">סיכום: ${e?.original_name} · עמוד ${this.page} · סיבוב ${this.rotation}° · חיתוך ${Math.round(this.crop.w*100)}%×${Math.round(this.crop.h*100)}%. השמירה מייצרת רקע נגזר; המקור לא משתנה.</div>`}
          <div class="row">
                ...
                <div class="layout">
                  ...
                  <div class="side">
                    ...
                    <div class="foot">
                      ...
                      ${this.step<Fs.length-1?n`<sw-button variant="primary" ?disabled=${!s||this.busy} @click=${()=>this.step=Math.min(Fs.length-1,this.step+1)}>הבא</sw-button>`:h}
                    </div>
                  </div>
                </div>`:this.renderDemo()}
      </sw-page>
  ...
  `;H([p()],C.prototype,"floorId",2);H([c()],C.prototype,"step",2);H([c()],C.prototype,"tree",2);H([c()],C.prototype,"assets",2);H([c()],C.prototype,"asset",2);H([c()],C.prototype,"page",2);H([c()],C.prototype,"rotation",2);H([c()],C.prototype,"crop",2);H([c()],C.prototype,"notes",2);H([c()],C.prototype,"version",2);H([c()],C.prototype,"busy",2);H([c()],C.prototype,"error",2);H([c()],C.prototype,"dragOver",2);C=H([b("explore-plan-import")],C);var Cr=Object.defineProperty,Ar=Object.getOwnPropertyDescriptor,q=(e,s,t,a)=>{for(var i=a>1?void 0:a?Ar(s,t):s,r=e.length-1,o;r>=0;r--)(o=e[r])&&(i=(a?o(s,t,i):o(i))||i);return a&&i&&Cr(s,t,i),i};const Er=[{id:"select",icon:"target",label:"בחירה",ready:!0},{id:"camera",icon:"camera",label:"הוספת מצלמה",ready:!0},{id:"entity",icon:"light",label:"הוספת ישות",ready:!1},{id:"area",icon:"map",label:"ציור אזור",ready:!1},{id:"label",icon:"list",label:"תווית",ready:!1},{id:"scale",icon:"fit",label:"קנה מידה",ready:!1}];let R=class extends w{constructor(){super(...arguments),this.floorId="",this.bundle=null,this.anchors=[],this.dirty=new Set,this.undo=[],this.redo=[],this.selectedId=null,this.tool="select",this.busy=!1,this.error="",this.info=""}connectedCallback(){super.connectedCallback(),this.load()}async load(){this.error="";try{const e=await wi(this.floorId||"f0",!0);this.bundle=e,this.anchors=e.anchors.map(s=>({...s,position:{...s.position}})),this.dirty=new Set,this.undo=[],this.redo=[],this.selectedId&&!this.anchors.some(s=>s.id===this.selectedId)&&(this.selectedId=null)}catch(e){this.error=k(e)}}get markers(){return this.anchors.map(e=>({id:e.id,kind:e.resource_type==="camera"?"camera":e.layer_id==="doors"?"lock":e.layer_id==="lights"?"light":"binary_sensor",label:e.camera?.name??e.label??e.resource_id,x:e.position.x,y:e.position.y,rotation:e.rotation_degrees,fov:e.field_of_view_degrees??void 0,state:e.resource_type==="camera"?this.bundle?.source==="demo"?"live":bs(e):"neutral"}))}snapshot(){this.undo=[...this.undo.slice(-30),this.anchors.map(e=>({...e,position:{...e.position}}))],this.redo=[]}apply(e,s){this.snapshot(),this.anchors=this.anchors.map(t=>t.id===e?{...t,...s,position:s.position??t.position}:t),this.dirty=new Set(this.dirty).add(e)}doUndo(){const e=this.undo[this.undo.length-1];e&&(this.redo=[...this.redo,this.anchors],this.undo=this.undo.slice(0,-1),this.anchors=e,this.dirty=new Set(this.anchors.map(s=>s.id)))}doRedo(){const e=this.redo[this.redo.length-1];e&&(this.undo=[...this.undo,this.anchors],this.redo=this.redo.slice(0,-1),this.anchors=e,this.dirty=new Set(this.anchors.map(s=>s.id)))}async save(){if(!this.bundle||this.bundle.source==="demo")return this.info="נתוני הדגמה: השינויים נשמרים רק במסך זה.",this.dirty=new Set,!0;this.busy=!0,this.error="";let e=!1;try{for(const s of this.dirty){const t=this.anchors.find(a=>a.id===s);if(t)try{const a=await Qa(s,{revision:t.revision,x:t.position.x,y:t.position.y,rotation_degrees:t.rotation_degrees,field_of_view_degrees:t.field_of_view_degrees,label:t.label});this.anchors=this.anchors.map(i=>i.id===s?{...i,revision:a.revision}:i)}catch(a){if(a instanceof Te&&a.code==="stale_revision")e=!0;else throw a}}return e?(this.error="חלק מהפריטים השתנו בינתיים על ידי עורך אחר; המפה נטענה מחדש בלי לדרוס את השינוי שלו.",await this.load(),!1):(this.dirty=new Set,this.info="נשמר",setTimeout(()=>this.info="",2e3),!0)}catch(s){return this.error=k(s),!1}finally{this.busy=!1}}async addCamera(e){if(this.bundle){if(this.bundle.source==="demo"){this.info="נתוני הדגמה: הוספה עובדת מול השרת.";return}if(!(this.dirty.size&&!await this.save())){this.busy=!0,this.error="";try{const s=await Za(this.bundle.floorId,{resource_type:"camera",resource_id:e.id,x:.5,y:.5,rotation_degrees:0,field_of_view_degrees:70});await this.load(),this.selectedId=s.id,this.tool="select"}catch(s){this.error=k(s)}finally{this.busy=!1}}}}async removeSelected(){const e=this.anchors.find(s=>s.id===this.selectedId);if(!(!e||!this.bundle)){if(this.bundle.source==="demo"){this.snapshot(),this.anchors=this.anchors.filter(s=>s.id!==e.id),this.selectedId=null;return}if(window.confirm(`להסיר את "${e.camera?.name??e.resource_id}" מהמפה? (המצלמה עצמה נשארת רשומה)`)){this.busy=!0;try{await er(e.id),this.selectedId=null,await this.load()}catch(s){this.error=k(s)}finally{this.busy=!1}}}}async publish(){if(!(!this.bundle?.planVersionId||this.bundle.source==="demo")&&!(this.dirty.size&&!await this.save())){this.busy=!0;try{await vi(this.bundle.planVersionId),await this.load(),this.info="התוכנית פורסמה"}catch(e){this.error=k(e)}finally{this.busy=!1}}}render(){const e=this.bundle;if(this.error&&!e)return n`<sw-page heading="עורך תוכנית"><sw-state-panel state="error" hint=${this.error} actionLabel="נסה שוב" @action=${()=>this.load()}></sw-state-panel></sw-page>`;if(!e)return n`<sw-page heading="עורך תוכנית"><sw-state-panel state="loading"></sw-state-panel></sw-page>`;const s=this.anchors.find(r=>r.id===this.selectedId),t=new Set(this.anchors.map(r=>r.resource_id)),a=e.cameras.filter(r=>!t.has(r.id)),i=this.dirty.size;return n`
      <sw-page heading="עורך תוכנית קומה" subheading=${`${e.buildingName} · ${e.floorName} · ${e.planStatus==="draft"?"טיוטה":e.planStatus==="published"?"תוכנית מפורסמת":"אין תוכנית"}${e.source==="demo"?" · נתוני הדגמה":""}`} crumbs=${`אתרים | ${e.siteName} | ${e.buildingName} | ${e.floorName}`} wide>
        ...
        ${e.planStatus==="none"?n`<sw-state-panel state="empty" heading="לקומה אין תוכנית" hint="העלה תוכנית קודם; אחר כך אפשר להציב מצלמות."><div style="margin-block-start:10px"><sw-button variant="primary" icon="upload" @click=${()=>x(`/explore/floors/${e.floorId}/import`)}>העלאת תוכנית</sw-button></div></sw-state-panel>`:n`<div class="layout">
              <div class="tools">${Er.map(r=>n`<button class=${r.id===this.tool?"on":""} ?disabled=${!r.ready} title=${r.ready?r.label:`${r.label} · בקרוב`} @click=${()=>this.tool=r.id}><sw-icon .name=${r.icon} size=${18}></sw-icon>${r.label}</button>`)}</div>
  ...
  `;q([p()],R.prototype,"floorId",2);q([c()],R.prototype,"bundle",2);q([c()],R.prototype,"anchors",2);q([c()],R.prototype,"dirty",2);q([c()],R.prototype,"undo",2);q([c()],R.prototype,"redo",2);q([c()],R.prototype,"selectedId",2);q([c()],R.prototype,"tool",2);q([c()],R.prototype,"busy",2);q([c()],R.prototype,"error",2);q([c()],R.prototype,"info",2);R=q([b("explore-plan-editor")],R);var Ir=Object.defineProperty,Tr=Object.getOwnPropertyDescriptor,ze=(e,s,t,a)=>{for(var i=a>1?void 0:a?Tr(s,t):s,r=e.length-1,o;r>=0;r--)(o=e[r])&&(i=(a?o(s,t,i):o(i))||i);return a&&i&&Ir(s,t,i),i};let se=class extends w{constructor(){super(...arguments),this.columns=[],this.rows=[],this.rowKey="id",this.selected=null,this.emptyText="אין שורות להצגה",this.dense=!1}pick(e){const s=String(e[this.rowKey]??"");this.dispatchEvent(new CustomEvent("row-select",{detail:{id:s,row:e},bubbles:!0,composed:!0}))}render(){return this.rows.length?n`
      <table>
        <thead>
    ...
    `:n`<div class="empty">${this.emptyText}</div>`}};se.styles=m`
    :host {
      display: block;
      background: var(--sw-surface);
      border: 1px solid var(--sw-border);
  ...
  `;ze([p({attribute:!1})],se.prototype,"columns",2);ze([p({attribute:!1})],se.prototype,"rows",2);ze([p()],se.prototype,"rowKey",2);ze([p()],se.prototype,"selected",2);ze([p()],se.prototype,"emptyText",2);ze([p({type:Boolean,reflect:!0})],se.prototype,"dense",2);se=ze([b("sw-table")],se);var Dr=Object.defineProperty,Nr=Object.getOwnPropertyDescriptor,gt=(e,s,t,a)=>{for(var i=a>1?void 0:a?Nr(s,t):s,r=e.length-1,o;r>=0;r--)(o=e[r])&&(i=(a?o(s,t,i):o(i))||i);return a&&i&&Dr(s,t,i),i};const us=[{id:"lock.main_door",name:"דלת כניסה",domain:"lock",area:"לובי",state:"נעול",fresh:"live",placed:!0,actions:"נעילה / פתיחה (grant נפרד)"},{id:"light.lobby",name:"תאורת לובי",domain:"light",area:"לובי",state:"דולק · 80%",fresh:"live",placed:!0,actions:"הדלקה / כיבוי / עמעום"},{id:"binary_sensor.hall_motion",name:"תנועה באולם",domain:"binary_sensor",area:"אולם",state:"ללא תנועה",fresh:"live",placed:!0,actions:"קריאה בלבד"},{id:"climate.hall",name:"מזגן אולם",domain:"climate",area:"אולם",state:"קירור · 23°",fresh:"stale",placed:!1,actions:"יעד טמפרטורה (allowlist)"},{id:"cover.parking_gate",name:"שער חניה",domain:"cover",area:"חניה",state:"סגור",fresh:"live",placed:!1,actions:"פתיחה / סגירה (רגיש)"},{id:"script.night_mode",name:"מצב לילה",domain:"script",area:"—",state:"—",fresh:"unknown",placed:!1,actions:"חסום עד allowlist"},{id:"sensor.power_main",name:"צריכת חשמל",domain:"sensor",area:"חדר מכונות",state:"4.2 kW",fresh:"live",placed:!1,actions:"קריאה בלבד"},{id:"camera.intercom_m2",name:"אינטרקום M2",domain:"camera",area:"כניסה",state:"זמין",fresh:"live",placed:!1,actions:"צפייה (provider נפרד)"}];let Xe=class extends w{constructor(){super(...arguments),this.selected=null,this.domain="all",this.columns=[{key:"name",label:"ישות",render:e=>n`<span style="display:inline-flex;align-items:center;gap:8px"><span style="display:grid;place-items:center;inline-size:26px;block-size:26px;border-radius:7px;background:var(--sw-accent-soft);color:var(--sw-accent)"><sw-icon name=${e.domain==="lock"||e.domain==="cover"?"lock":e.domain==="light"?"light":e.domain==="camera"?"camera":e.domain==="climate"?"activity":"sensor"} size=${13}></sw-icon></span><span><strong>${String(e.name)}</strong><div class="ltr" style="font-size:var(--sw-fs-xs);color:var(--sw-text-3)">${String(e.id)}</div></span></span>`},{key:"domain",label:"Domain",ltr:!0},{key:"area",label:"אזור HA"},{key:"state",label:"מצב"},{key:"fresh",label:"רעננות",render:e=>n`<sw-badge kind=${e.fresh} label=${e.fresh==="live"?"עדכני":e.fresh==="stale"?"מיושן":"לא ידוע"}></sw-badge>`},{key:"placed",label:"במפה",render:e=>e.placed?n`<sw-badge kind="recorded" label="מוצב"></sw-badge>`:n`<span style="color:var(--sw-text-3)">לא</span>`}]}render(){const e=["all",...new Set(us.map(a=>a.domain))],s=us.filter(a=>this.domain==="all"||a.domain===this.domain),t=us.find(a=>a.id===this.selected);return n`
      <sw-page heading="קטלוג ישויות Home Assistant" subheading="${us.length} ישויות מורשות לחיבור · הצבה על המפה ושליטה הן הרשאות נפרדות · נתוני הדגמה">
  ...
  `;gt([c()],Xe.prototype,"selected",2);gt([c()],Xe.prototype,"domain",2);Xe=gt([b("explore-entities")],Xe);var jr=Object.defineProperty,Rr=Object.getOwnPropertyDescriptor,gi=(e,s,t,a)=>{for(var i=a>1?void 0:a?Rr(s,t):s,r=e.length-1,o;r>=0;r--)(o=e[r])&&(i=(a?o(s,t,i):o(i))||i);return a&&i&&jr(s,t,i),i};const qs=[{id:"d1",name:"כניסה ראשית",kind:"דלת זכוכית",lock:"נעול",contact:"סגור",relay:"לא פעיל",ringing:!1,scene:"entrance"},{id:"d2",name:"לובי",kind:"דלת פנימית",lock:"פתוח",contact:"פתוח",relay:"לא פעיל",ringing:!1,scene:"lobby"},{id:"d3",name:"אינטרקום M2",kind:"עמדת דלת",lock:"נעול",contact:"סגור",relay:"לא פעיל",ringing:!0,scene:"entrance"},{id:"d4",name:"מחסן",kind:"דלת שירות",lock:"נעול",contact:"סגור",relay:"לא פעיל",ringing:!1,scene:"warehouse"}];let zs=class extends w{constructor(){super(...arguments),this.selected="d1"}render(){const e=qs.find(s=>s.id===this.selected)??qs[0];return n`
      <sw-page heading="דלתות ואינטרקום" subheading="V1 · מצלמה, צלצול, מגע דלת וממסר הם ארבעה נתונים שונים · נתוני הדגמה">
        ...
        <div class="layout">
          <div class="list">
            ${qs.map(s=>n`<button class="door ${s.id===this.selected?"on":""}" @click=${()=>this.selected=s.id} aria-pressed=${s.id===this.selected}>
  ...
  `;gi([c()],zs.prototype,"selected",2);zs=gi([b("explore-access")],zs);var Hr=Object.defineProperty,Lr=Object.getOwnPropertyDescriptor,_e=(e,s,t,a)=>{for(var i=a>1?void 0:a?Lr(s,t):s,r=e.length-1,o;r>=0;r--)(o=e[r])&&(i=(a?o(s,t,i):o(i))||i);return a&&i&&Hr(s,t,i),i};let te=class extends w{constructor(){super(...arguments),this.label="",this.value="",this.detail="",this.icon="info",this.tone="neutral",this.badge=""}render(){return n`
  ...
  `;_e([p()],te.prototype,"label",2);_e([p()],te.prototype,"value",2);_e([p()],te.prototype,"detail",2);_e([p()],te.prototype,"icon",2);_e([p({reflect:!0})],te.prototype,"tone",2);_e([p()],te.prototype,"badge",2);te=_e([b("sw-kpi")],te);var Br=Object.getOwnPropertyDescriptor,Vr=(e,s,t,a)=>{for(var i=a>1?void 0:a?Br(s,t):s,r=e.length-1,o;r>=0;r--)(o=e[r])&&(i=o(i)||i);return i};const Ur={person:"var(--sw-accent)",vehicle:"var(--sw-live)",motion:"var(--sw-danger)",line:"var(--sw-stale)",offline:"var(--sw-offline)",door:"var(--sw-purple)"},Wr={"כניסה ראשית":"entrance","חצר אחורית":"backyard",מחסן:"warehouse",לובי:"lobby","חניה מקורה":"parking"};let it=class extends w{render(){const e=z.filter(l=>l.state==="live"||l.state==="stale").length,s=Q.filter(l=>!l.acked),t=[{kind:"critical",title:"מצלמה מנותקת: מסדרון מזרחי",meta:"קומה 0 · מאז 07:55",why:"מוצג כי אין הקלטה ממצלמה זו כבר שעתיים",link:"#/system/devices"},{kind:"alert",title:`${s.length} אירועים שלא נבדקו`,meta:"אדם בכניסה הראשית 10:14, רכב בחצר 09:42",why:"מוצג כי אירועי אדם/רכב מחכים לסימון טיפול",link:"#/investigate/events"},{kind:"alert",title:"החיבור ל־Home Assistant לא רענן",meta:"סנכרון אחרון לפני 4 דק׳",why:"מוצג כי מצבי הישויות עלולים להיות מיושנים",link:"#/system/diagnostics"}],a=.68,i=34,r=2*Math.PI*i,o=z.filter(l=>l.state==="live").slice(0,2);return n`
      <sw-page heading="בוקר טוב, יוני" subheading="המערכת פועלת · גשר Home Assistant לא רענן · נתוני הדגמה">
        ...
        <div class="kpis">
          ...
          <sw-kpi icon="bell" value=${String(Q.length)} label="אירועים" detail="ב־24 השעות" tone="neutral" badge=${`${s.length} חדשים`}></sw-kpi>
          <sw-kpi icon="shield" tone="stale" value="חלקי" label="מצב מערכת" detail="גשר HA לא רענן"></sw-kpi>
        </div>
        <div class="fav">
          ${o.map(l=>n`<sw-camera-tile name=${l.name} state=${l.state} scene=${G[l.id]??"lobby"} @click=${()=>x(`/live/cameras/${l.id}`)}></sw-camera-tile>`)}
        </div>
        <div class="row2">
          ...
          <sw-card heading="בריאות האתרים">
            ${Xs.map(l=>n`<div class="hrow"><span>${l.name}<div class="muted">${l.online}/${l.cameras} מצלמות · ${l.alerts} התראות</div></span><span class="status"><i style="--c:${l.health==="live"?"var(--sw-live)":l.health==="offline"?"var(--sw-danger)":"var(--sw-stale)"}"></i>${l.health==="live"?"מחובר":l.health==="offline"?"מנותק":"חלקי"}</span></div>`)}
            ${ui.slice(0,2).map(l=>n`<div class="hrow"><span>${l.name}<div class="muted">${l.detail}</div></span><span class="status"><i style="--c:${l.state==="live"?"var(--sw-live)":"var(--sw-stale)"}"></i>${l.state==="live"?"מחובר":"לא רענן"}</span></div>`)}
          </sw-card>
        </div>
        <div class="row3">
          <sw-card heading="אירועים אחרונים">
            <a slot="actions" class="seeall" href="#/investigate/events">הצג הכל</a>
            ${Q.slice(0,5).map(l=>n`<div class="ev" @click=${()=>x("/investigate/events")}>
                ${l.type==="offline"||l.type==="door"?n`<div class="none"><sw-icon name=${l.type==="offline"?"offline":"door"} size=${14}></sw-icon></div>`:n`<sw-scene kind=${Wr[l.camera]??"lobby"}></sw-scene>`}
                <div class="txt"><b style="--tone:${Ur[l.type]}"><i></i>${Zs[l.type]}</b><small>${l.camera} · ${l.floor}</small></div>
                <time>${l.time}</time>
              </div>`)}
          </sw-card>
  ...
  `;it=Vr([b("live-overview")],it);let ms=null,fs=null;const Fr={"media.transport_default":"mse","media.max_live_sessions":8,"media.wall_profile":"sub","snapshots.max_age_s":60};async function xt(e=!1){return S()?ms&&!e?ms:(fs||(fs=ri().then(s=>ms=s.settings).finally(()=>fs=null)),fs):Fr}function qr(){ms=null}function yt(e){return ni()||e?.["media.transport_default"]||"mse"}var Kr=Object.defineProperty,Yr=Object.getOwnPropertyDescriptor,fe=(e,s,t,a)=>{for(var i=a>1?void 0:a?Yr(s,t):s,r=e.length-1,o;r>=0;r--)(o=e[r])&&(i=(a?o(s,t,i):o(i))||i);return a&&i&&Kr(s,t,i),i};const Gr=[1,2,4,6,8,9,12,16],Wt=[{id:"all",label:"כל המצלמות"},{id:"outside",label:"חוץ"},{id:"inside",label:"פנים"},{id:"night",label:"לילה"}];let X=class extends w{constructor(){super(...arguments),this.count=4,this.stream="auto",this.view="all",this.cams=null,this.settings=null,this.error="",this.posterBust=Date.now()}connectedCallback(){super.connectedCallback(),this.load(),this.posterTimer=window.setInterval(()=>this.posterBust=Date.now(),6e4)}disconnectedCallback(){super.disconnectedCallback(),window.clearInterval(this.posterTimer)}async load(){if(S())try{const[e,s]=await Promise.all([js(),xt()]);this.cams=e.cameras.filter(t=>t.enabled),this.settings=s}catch(e){this.error=k(e)}}renderApi(){const e=this.cams;if(this.error)return n`<sw-state-panel state="error" hint=${this.error} actionLabel="נסה שוב" @action=${()=>this.load()}></sw-state-panel>`;if(!e)return n`<sw-state-panel state="loading"></sw-state-panel>`;if(!e.length)return n`<sw-state-panel state="empty" heading="אין מצלמות זמינות" hint="סנכרן מצלמות מה־NVR או בקש הרשאה למצלמות בקומות שלך."><div style="margin-block-start:10px"><sw-button @click=${()=>x("/system/devices")}>למצלמות</sw-button></div></sw-state-panel>`;const s=e.slice(0,this.count),t=this.count===1?1:this.count===2||this.count<=4?2:this.count<=9?3:4,a=this.settings?.["media.max_live_sessions"]??8,i=this.stream==="auto"?this.settings?.["media.wall_profile"]??"sub":this.stream,r=yt(this.settings);return n`
      <div class="grid" style="--cols:${t}">
        ${s.map((o,l)=>n`<sw-camera-tile
            ...
            profile=${i}
            transport=${r}
            poster=${o.status==="offline"?"":Ye(o.id,this.posterBust)}
    ...
    `}renderDemo(){const e=z.slice(0,this.count),s=this.count===1?1:this.count===2||this.count<=4?2:this.count<=9?3:4;return n`
      <div class="grid" style="--cols:${s}">
        ${e.map(t=>n`<sw-camera-tile name=${t.name} meta=${`${t.floor} · ${this.stream==="auto"?this.count>4?"משני":"ראשי":this.stream==="main"?"ראשי":"משני"}`} state=${t.state} scene=${G[t.id]??"lobby"} ?compact=${this.count>=9} @click=${()=>x(`/live/cameras/${t.id}`)}></sw-camera-tile>`)}
      </div>
    ...
    `}render(){const e=S(),s=e?this.cams?.length??0:z.length;return n`
      <sw-page heading="כל המצלמות" subheading="${s} מצלמות${e?"":` · תצוגה: ${Wt.find(t=>t.id===this.view)?.label} · נתוני הדגמה`}" wide>
        ${e?h:n`<sw-field slot="actions"><select aria-label="תצוגה" @change=${t=>this.view=t.target.value}>${Wt.map(t=>n`<option value=${t.id} ?selected=${t.id===this.view}>${t.label}</option>`)}</select></sw-field>`}
        ...
        <div slot="actions" class="layouts" role="group" aria-label="פריסה">
          ${Gr.map(t=>n`<button class=${t===this.count?"on":""} @click=${()=>this.count=t} aria-pressed=${t===this.count}>${t}</button>`)}
        </div>
  ...
  `;fe([c()],X.prototype,"count",2);fe([c()],X.prototype,"stream",2);fe([c()],X.prototype,"view",2);fe([c()],X.prototype,"cams",2);fe([c()],X.prototype,"settings",2);fe([c()],X.prototype,"error",2);fe([c()],X.prototype,"posterBust",2);X=fe([b("live-wall")],X);var Jr=Object.defineProperty,Xr=Object.getOwnPropertyDescriptor,L=(e,s,t,a)=>{for(var i=a>1?void 0:a?Xr(s,t):s,r=e.length-1,o;r>=0;r--)(o=e[r])&&(i=(a?o(s,t,i):o(i))||i);return a&&i&&Jr(s,t,i),i};let A=class extends w{constructor(){super(...arguments),this.cameraId="cam-1",this.cam=null,this.cams=[],this.settings=null,this.error="",this.loading=!0,this.profile="main",this.transport="auto",this.playerStatus="",this.playerTransport="",this.posterBust=Date.now(),this.ptzMode="presets"}connectedCallback(){super.connectedCallback(),this.load()}updated(e){e.has("cameraId")&&e.get("cameraId")!==void 0&&this.load()}async load(){this.loading=!0,this.error="";try{if(S()){const[e,s]=await Promise.all([js(),xt()]);this.cams=e.cameras,this.cam=e.cameras.find(t=>t.id===this.cameraId)??null,this.settings=s,this.transport=yt(s)}}catch(e){this.error=k(e)}finally{this.loading=!1}}setTransport(e){Ma(e===(this.settings?.["media.transport_default"]??"mse")?"":e),this.transport=e}onPlayer(e){this.playerStatus=e.detail.status,this.playerTransport=e.detail.transport??""}renderApi(){const e=this.cam;if(this.loading)return n`<sw-state-panel state="loading"></sw-state-panel>`;if(this.error)return n`<sw-state-panel state="error" hint=${this.error} actionLabel="נסה שוב" @action=${()=>this.load()}></sw-state-panel>`;if(!e)return n`<sw-state-panel state="forbidden" heading="המצלמה לא זמינה" hint="המצלמה לא נמצאה או שאין לך הרשאת צפייה בה."></sw-state-panel>`;const s=e.can_view_live!==!1&&e.status!=="offline",t=Ye(e.id,this.posterBust),a=e.stream;return n`
      ...
      <div class="controls">
        <div class="round" role="group" aria-label="פקדי מצלמה">
          ...
          ${ni()?n`<span class="note">ברירת המחדל של המערכת: ${this.settings?.["media.transport_default"]??"mse"}</span>`:h}
        </div>
      ...
      <div class="grid">
        ...
        <sw-card heading="מצלמות נוספות">
          <div class="tiles">
            ${this.cams.filter(i=>i.id!==e.id).slice(0,4).map(i=>n`<sw-camera-tile compact name=${i.name} state=${i.status==="online"?"live":i.status==="offline"?"offline":"unknown"} poster=${i.status==="offline"?"":Ye(i.id)} @click=${()=>x(`/live/cameras/${i.id}`)}></sw-camera-tile>`)}
          </div>
        </sw-card>
      </div>
    `}renderDemo(){const e=z.find(a=>a.id===this.cameraId)??z[0],s=e.state==="live"||e.state==="stale",t=G[e.id]??"lobby";return n`
      ...
      <div class="grid">
        ...
        <sw-card heading="מצלמות באותה קומה">
          <div class="tiles">
            ${z.filter(a=>a.floor===e.floor&&a.id!==e.id).slice(0,4).map(a=>n`<sw-camera-tile compact name=${a.name} state=${a.state} scene=${G[a.id]??"lobby"} @click=${()=>x(`/live/cameras/${a.id}`)}></sw-camera-tile>`)}
          </div>
        </sw-card>
      </div>
    `}render(){const e=S(),s=e?this.cam?.name??"מצלמה":(z.find(a=>a.id===this.cameraId)??z[0]).name,t=e?this.cam?`ערוץ ${this.cam.channel} · ${this.cam.name_source||""}`:"":`${(z.find(a=>a.id===this.cameraId)??z[0]).floor} · נתוני הדגמה`;return n`
  ...
  `;L([p()],A.prototype,"cameraId",2);L([c()],A.prototype,"cam",2);L([c()],A.prototype,"cams",2);L([c()],A.prototype,"settings",2);L([c()],A.prototype,"error",2);L([c()],A.prototype,"loading",2);L([c()],A.prototype,"profile",2);L([c()],A.prototype,"transport",2);L([c()],A.prototype,"playerStatus",2);L([c()],A.prototype,"playerTransport",2);L([c()],A.prototype,"posterBust",2);L([c()],A.prototype,"ptzMode",2);L([as("sw-live-player")],A.prototype,"player",2);A=L([b("live-camera")],A);var Zr=Object.defineProperty,Qr=Object.getOwnPropertyDescriptor,Ls=(e,s,t,a)=>{for(var i=a>1?void 0:a?Qr(s,t):s,r=e.length-1,o;r>=0;r--)(o=e[r])&&(i=(a?o(s,t,i):o(i))||i);return a&&i&&Zr(s,t,i),i};let Ne=class extends w{constructor(){super(...arguments),this.checked=!1,this.disabled=!1,this.label=""}flip(){this.disabled||(this.checked=!this.checked,this.dispatchEvent(new CustomEvent("change",{detail:{checked:this.checked},bubbles:!0,composed:!0})))}render(){return n`<button type="button" role="switch" aria-checked=${this.checked} aria-label=${this.label} ?disabled=${this.disabled} @click=${this.flip}></button>${this.label?n`<span>${this.label}</span>`:""}`}};Ne.styles=m`
    :host {
      display: inline-flex;
      align-items: center;
      gap: var(--sw-s-2);
  ...
  `;Ls([p({type:Boolean,reflect:!0})],Ne.prototype,"checked",2);Ls([p({type:Boolean,reflect:!0})],Ne.prototype,"disabled",2);Ls([p()],Ne.prototype,"label",2);Ne=Ls([b("sw-toggle")],Ne);var en=Object.getOwnPropertyDescriptor,sn=(e,s,t,a)=>{for(var i=a>1?void 0:a?en(s,t):s,r=e.length-1,o;r>=0;r--)(o=e[r])&&(i=o(i)||i);return i};const tn=[{name:"כל המצלמות",layout:9,scope:"משותפת",mobile:"4 · משני",owner:"יוני",kiosk:!0},{name:"חוץ",layout:4,scope:"משותפת",mobile:"2 · משני",owner:"יוני",kiosk:!1},{name:"פנים",layout:6,scope:"משותפת",mobile:"ללא",owner:"יוסי",kiosk:!1},{name:"לילה",layout:4,scope:"אישית",mobile:"4 · משני",owner:"דנה",kiosk:!1}];let at=class extends w{render(){return n`
      <sw-page heading="תצוגות שמורות" subheading="תבניות 1 / 2 / 4 / 6 / 9 / 12 / 16 / מותאם, אישיות או משותפות, עם התאמה למובייל · נתוני הדגמה">
        ...
        <div class="grid">
          ${tn.map(e=>{const s=Math.ceil(Math.sqrt(e.layout));return n`<sw-card heading=${e.name}>
              <sw-badge slot="actions" kind="neutral" label=${e.scope}></sw-badge>
              <div class="thumb" style="grid-template-columns:repeat(${s},1fr)">${z.filter(t=>t.state==="live").slice(0,e.layout).map(t=>n`<sw-scene kind=${G[t.id]??"lobby"}></sw-scene>`)}</div>
              <dl>
  ...
  `;at=sn([b("live-views")],at);var an=Object.defineProperty,rn=Object.getOwnPropertyDescriptor,Bs=(e,s,t,a)=>{for(var i=a>1?void 0:a?rn(s,t):s,r=e.length-1,o;r>=0;r--)(o=e[r])&&(i=(a?o(s,t,i):o(i))||i);return a&&i&&an(s,t,i),i};let je=class extends w{constructor(){super(...arguments),this.cams=null,this.settings=null,this.clock=""}connectedCallback(){super.connectedCallback(),this.tick(),this.timer=window.setInterval(()=>this.tick(),1e3),this.unsubscribe=fi(e=>{e.mode==="api"&&this.cams===null?this.load():e.mode!=="loading"&&this.requestUpdate()})}disconnectedCallback(){super.disconnectedCallback(),window.clearInterval(this.timer),this.unsubscribe?.()}tick(){const e=new Date;this.clock=`${e.toLocaleDateString("he-IL",{weekday:"long",day:"2-digit",month:"2-digit",year:"numeric"})} · ${e.toLocaleTimeString("he-IL")}`}async load(){if(S())try{const[e,s]=await Promise.all([js(),xt()]);this.cams=e.cameras.filter(t=>t.enabled),this.settings=s}catch{this.cams=[]}}render(){const s=S(),t=s?(this.cams??[]).slice(0,9):[],a=z.filter(o=>o.state!=="forbidden").slice(0,9),i=s?t.filter(o=>o.status==="online").length:7,r=this.settings?.["media.max_live_sessions"]??8;return n`
      <header>
      ...
      <div class="grid">
        ${s?t.map((o,l)=>n`<sw-camera-tile dark name=${o.name} state=${o.status==="online"?"live":o.status==="offline"?"offline":"unknown"} ?live=${o.status!=="offline"&&l<r} cameraId=${o.id} profile="sub" transport=${yt(this.settings)} poster=${o.status==="offline"?"":Ye(o.id)} noDemo></sw-camera-tile>`):a.map(o=>n`<sw-camera-tile dark name=${o.name} state=${o.state} scene=${G[o.id]??"lobby"} noDemo></sw-camera-tile>`)}
      </div>
      <div class="stats">
  ...
  `;Bs([c()],je.prototype,"cams",2);Bs([c()],je.prototype,"settings",2);Bs([c()],je.prototype,"clock",2);je=Bs([b("kiosk-wall")],je);var nn=Object.defineProperty,on=Object.getOwnPropertyDescriptor,Se=(e,s,t,a)=>{for(var i=a>1?void 0:a?on(s,t):s,r=e.length-1,o;r>=0;r--)(o=e[r])&&(i=(a?o(s,t,i):o(i))||i);return a&&i&&nn(s,t,i),i};const ln=[{label:"שעה",minutes:60},{label:"6 שע׳",minutes:360},{label:"יום",minutes:1440}];function Ft(e){return String(e).padStart(2,"0")}function ee(e){const s=(e%1440+1440)%1440;return`${Ft(Math.floor(s/60))}:${Ft(Math.floor(s%60))}`}const dn={motion:"#ef4444",person:"#2f6bff",vehicle:"#22c55e",line:"#f59e0b",offline:"#6b7280",door:"#8b5cf6"};let ie=class extends w{constructor(){super(...arguments),this.segments=[],this.events=[],this.cursor=615,this.windowMinutes=360,this.precision="estimated",this.hover=null}get start(){return Math.max(0,Math.min(1440-this.windowMinutes,this.cursor-this.windowMinutes/2))}x(e,s){return(e-this.start)/this.windowMinutes*s}onMove(e){const s=e.currentTarget.getBoundingClientRect();this.hover=Math.round(this.start+(e.clientX-s.left)/s.width*this.windowMinutes)}onClick(e){const s=e.currentTarget.getBoundingClientRect(),t=Math.round(this.start+(e.clientX-s.left)/s.width*this.windowMinutes);this.cursor=t,this.dispatchEvent(new CustomEvent("seek",{detail:{minute:t},bubbles:!0,composed:!0}))}buckets(e){const s=[],t=this.windowMinutes/e;for(let a=0;a<e;a++){const i=this.start+a*t,r=i+t;let o=0;for(const l of this.segments)l.endMin>i&&l.startMin<r&&(o=Math.max(o,l.kind==="motion"?2:1));o&&this.events.some(l=>l.minute>=i-t&&l.minute<=r+t)&&(o=3),s.push(o)}return s}render(){const r=this.windowMinutes<=60?10:this.windowMinutes<=360?60:180,o=[];for(let f=Math.ceil(this.start/r)*r;f<=this.start+this.windowMinutes;f+=r)o.push(f);const l=[0,12,26,36],u={verified:"זמן מאומת",keyframe_limited:"דיוק לפי keyframe",estimated:"זמן משוער",unknown:"דיוק לא ידוע"}[this.precision],y=this.x(this.cursor,1e3),g=ee(this.cursor);return n`
      <div class="bar">
        <span class="precision">${u} · לחיצה על הציר מבצעת seek</span>
        <div class="windows">
          ${ln.map(f=>n`<button class=${f.minutes===this.windowMinutes?"on":""} @click=${()=>this.windowMinutes=f.minutes}>${f.label}</button>`)}
        </div>
      </div>
      <svg viewBox="0 0 ${1e3} ${84}" preserveAspectRatio="none" @mousemove=${this.onMove} @mouseleave=${()=>this.hover=null} @click=${this.onClick} role="img" aria-label="ציר זמן הקלטות">
        ...
        ${this.buckets(160).map((f,$)=>{if(!f)return h;const K=l[f];return d`<rect x=${$*6.25+1} y=${58-K} width=${Math.max(2,6.25-2)} height=${K} rx="1.5" fill=${"var(--sw-accent)"} opacity=${f===1?.45:f===2?.8:1} />`})}
        ${o.map(f=>d`<line x1=${this.x(f,1e3)} x2=${this.x(f,1e3)} y1=${58} y2=${63} stroke="var(--sw-border-strong)" /><text x=${this.x(f,1e3)} y=${78} font-size="10.5" text-anchor="middle" fill="var(--sw-text-3)" font-family="var(--sw-font)">${ee(f)}</text>`)}
        ${this.events.map(f=>{const $=this.x(f.minute,1e3);return $<0||$>1e3?h:d`<g><circle cx=${$} cy=${58-l[3]-8} r="3.5" fill=${dn[f.kind]} /><title>${f.label} · ${ee(f.minute)}</title></g>`})}
  ...
  `;Se([p({attribute:!1})],ie.prototype,"segments",2);Se([p({attribute:!1})],ie.prototype,"events",2);Se([p({type:Number})],ie.prototype,"cursor",2);Se([p({type:Number})],ie.prototype,"windowMinutes",2);Se([p()],ie.prototype,"precision",2);Se([c()],ie.prototype,"hover",2);ie=Se([b("sw-timeline")],ie);var cn=Object.defineProperty,pn=Object.getOwnPropertyDescriptor,Me=(e,s,t,a)=>{for(var i=a>1?void 0:a?pn(s,t):s,r=e.length-1,o;r>=0;r--)(o=e[r])&&(i=(a?o(s,t,i):o(i))||i);return a&&i&&cn(s,t,i),i};let ae=class extends w{constructor(){super(...arguments),this.cameraId="cam-10",this.cursor=615,this.generation=3,this.playing=!0,this.speed=1,this.filter="all"}seek(e){this.cursor=e.detail.minute,this.generation+=1}render(){const e=z.find(a=>a.id===this.cameraId)??z[0],s=!ks.some(a=>this.cursor>=a.startMin&&this.cursor<=a.endMin),t=Q.filter(a=>a.minuteOfDay<1440).filter(a=>this.filter==="all"||a.type===this.filter).map(a=>({minute:a.minuteOfDay,kind:a.type,label:a.title}));return n`
      <sw-page heading=${e.name} subheading="14.09.2026 ${ee(this.cursor)} · אזור זמן האתר Asia/Jerusalem · נתוני הדגמה" crumbs="הקלטות | ${e.floor}" wide>
        <div slot="actions" class="pick">
          <sw-field><select aria-label="מצלמה" @change=${a=>this.cameraId=a.target.value}>${z.map(a=>n`<option value=${a.id} ?selected=${a.id===this.cameraId}>${a.name}</option>`)}</select></sw-field>
          <sw-field><input type="date" value="2026-09-14" data-ltr aria-label="תאריך" /></sw-field>
          <sw-field style="inline-size:96px"><input type="time" value=${ee(this.cursor)} data-ltr aria-label="שעה" @change=${a=>{const[i,r]=a.target.value.split(":").map(Number);this.cursor=i*60+r,this.generation+=1}} /></sw-field>
        </div>
        ...
        <div class="video ${s?"gap":""}">
          ${s?n`<div class="center"><div><sw-icon name="offline" size=${32}></sw-icon><span>אין הקלטה בזמן הזה: פער בכיסוי, לא מדלגים ל־Live</span></div></div>`:n`<sw-scene kind=${G[e.id]??"lobby"}></sw-scene><div class="shade"></div><span class="demo">דמו · הניגון יתחבר ב־T028</span>`}
          <div class="tag"><sw-badge kind=${s?"unknown":"recorded"} ?onImage=${!s}></sw-badge><span class="nm">${e.name}</span></div>
          <span class="stamp">2026-09-14 ${ee(this.cursor)}:00 · actual: ${s?"—":ee(this.cursor)}</span>
        ...
        <sw-timeline .segments=${ks} .events=${t} .cursor=${this.cursor} precision="estimated" @seek=${this.seek}></sw-timeline>
        <div class="filters">
  ...
  `;Me([c()],ae.prototype,"cameraId",2);Me([c()],ae.prototype,"cursor",2);Me([c()],ae.prototype,"generation",2);Me([c()],ae.prototype,"playing",2);Me([c()],ae.prototype,"speed",2);Me([c()],ae.prototype,"filter",2);ae=Me([b("investigate-playback")],ae);var hn=Object.defineProperty,un=Object.getOwnPropertyDescriptor,$t=(e,s,t,a)=>{for(var i=a>1?void 0:a?un(s,t):s,r=e.length-1,o;r>=0;r--)(o=e[r])&&(i=(a?o(s,t,i):o(i))||i);return a&&i&&hn(s,t,i),i};let Ze=class extends w{constructor(){super(...arguments),this.cursor=615,this.playing=!1}render(){const e=[{cam:z[0],drift:"+0.2s",state:"recorded"},{cam:z[9],drift:"-0.4s",state:"recorded"},{cam:z[3],drift:"gap",state:"unknown"},{cam:z[1],drift:"buffering",state:"stale"}];return n`
      <sw-page heading="מרכז שליטה" subheading="ניטור חי עם ניגון מסונכרן · 4 מקורות · שעון ייחוס אחד · נתוני הדגמה" wide>
        ...
        <div class="grid">
          ${e.map(s=>n`<div class="tile">
              ...
              <sw-camera-tile name=${s.cam.name} state=${s.state} scene=${G[s.cam.id]??"lobby"}></sw-camera-tile>
            </div>`)}
        </div>
        <div class="transport">
          <sw-field><input type="datetime-local" value=${`2026-09-14T${ee(this.cursor)}`} data-ltr aria-label="זמן" @change=${s=>{const t=s.target.value.split("T")[1]??"10:15",[a,i]=t.split(":").map(Number);this.cursor=a*60+i}} /></sw-field>
        ...
        <sw-timeline .segments=${ks} .events=${Q.slice(0,4).map(s=>({minute:s.minuteOfDay,kind:s.type,label:s.title}))} .cursor=${this.cursor} precision="estimated" @seek=${s=>this.cursor=s.detail.minute}></sw-timeline>
        <div class="filters">
  ...
  `;$t([c()],Ze.prototype,"cursor",2);$t([c()],Ze.prototype,"playing",2);Ze=$t([b("investigate-sync")],Ze);var fn=Object.defineProperty,wn=Object.getOwnPropertyDescriptor,kt=(e,s,t,a)=>{for(var i=a>1?void 0:a?wn(s,t):s,r=e.length-1,o;r>=0;r--)(o=e[r])&&(i=(a?o(s,t,i):o(i))||i);return a&&i&&fn(s,t,i),i};let Qe=class extends w{constructor(){super(...arguments),this.floorId="f0",this.minute=615}get markers(){const e=a=>a==="cam-3"||this.minute>=190&&this.minute<=205?"unknown":"historic",s=$s.filter(a=>a.floorId===this.floorId).map(a=>({id:a.id,kind:"camera",label:a.name,x:a.x,y:a.y,rotation:a.rotation,fov:a.fov,state:a.state==="forbidden"?"forbidden":e(a.id)})),t=Gs.filter(a=>a.floorId===this.floorId).map((a,i)=>({id:a.id,kind:a.domain,label:a.name,x:a.x,y:a.y,state:i%2?"unknown":"historic"}));return[...s,...t]}render(){const e=pe.find(s=>s.id===this.floorId)??pe[0];return n`
      <div class="head">
      ...
      <div class="stage">
        <sw-plan-canvas .planWidth=${e.planWidth} .planHeight=${e.planHeight} .plan=${li(e.id)} .markers=${this.markers}></sw-plan-canvas>
  ...
  `;kt([p()],Qe.prototype,"floorId",2);kt([c()],Qe.prototype,"minute",2);Qe=kt([b("investigate-history-map")],Qe);var vn=Object.defineProperty,bn=Object.getOwnPropertyDescriptor,zt=(e,s,t,a)=>{for(var i=a>1?void 0:a?bn(s,t):s,r=e.length-1,o;r>=0;r--)(o=e[r])&&(i=(a?o(s,t,i):o(i))||i);return a&&i&&vn(s,t,i),i};const mn={person:"#2f6bff",vehicle:"#22c55e",motion:"#ef4444",line:"#f59e0b",offline:"#6b7280",door:"#8b5cf6"},qt={"כניסה ראשית":"entrance","חצר אחורית":"backyard",מחסן:"warehouse",לובי:"lobby","חניה מקורה":"parking","מסדרון מזרחי":"corridor"};let es=class extends w{constructor(){super(...arguments),this.selected=null,this.filter="all",this.columns=[{key:"thumb",label:"תמונה",width:"80px",render:e=>e.type==="offline"||e.type==="door"?n`<div class="thumb none"><sw-icon name=${e.type==="offline"?"offline":"door"} size=${14}></sw-icon></div>`:n`<sw-scene class="thumb" kind=${qt[String(e.camera)]??"lobby"}></sw-scene>`},{key:"title",label:"אירוע",render:e=>n`<span class="ty" style="--tone:${mn[e.type]}"><i></i>${Zs[e.type]}</span><div class="sub">${String(e.title)} · ${e.acked?"טופל":"ממתין לטיפול"}</div>`},{key:"camera",label:"מצלמה",render:e=>n`${String(e.camera)}<div class="sub">${String(e.floor)}</div>`},{key:"time",label:"זמן",render:e=>n`${String(e.time)}<div class="sub ltr">${String(e.source)}</div>`},{key:"severity",label:"חומרה",render:e=>n`<sw-badge kind=${e.severity==="critical"?"error":e.severity==="alert"?"stale":"neutral"} label=${{info:"מידע",alert:"התראה",critical:"קריטי"}[e.severity]}></sw-badge>`},{key:"more",label:"",width:"40px",render:()=>n`<sw-button variant="ghost" size="sm" iconOnly icon="more" label="עוד"></sw-button>`}]}render(){const e=Q.filter(t=>this.filter==="all"||!t.acked),s=Q.find(t=>t.id===this.selected);return n`
      <sw-page heading="מרכז אירועים" subheading="חיפוש, סינון וסקירה של כל האירועים · מקור וזמן קליטה נשמרים · נתוני הדגמה">
        ...
        <div class="filters">
          ...
          <sw-field><input type="date" value="2026-09-14" data-ltr aria-label="תאריך" /></sw-field>
          <span class="grow"></span>
          <sw-chip ?selected=${this.filter==="all"} @click=${()=>this.filter="all"} count=${Q.length}>הכל</sw-chip>
          <sw-chip ?selected=${this.filter==="unacked"} @click=${()=>this.filter="unacked"} count=${Q.filter(t=>!t.acked).length}>ללא טיפול</sw-chip>
        </div>
        <div class="stage">
          <sw-table .columns=${this.columns} .rows=${e} .selected=${this.selected} @row-select=${t=>this.selected=t.detail.id}></sw-table>
          ${s?n`<sw-drawer open heading=${Zs[s.type]} subheading=${`${s.camera} · ${s.time}`} @close=${()=>this.selected=null}>
                <div class="preview">${s.type==="offline"||s.type==="door"?"אין תמונה לאירוע זה":n`<sw-scene kind=${qt[s.camera]??"lobby"}></sw-scene><span class="demo">דמו · תמונת אירוע מה־NVR (T044)</span>`}</div>
                <dl>
  ...
  `;zt([c()],es.prototype,"selected",2);zt([c()],es.prototype,"filter",2);es=zt([b("investigate-events")],es);var gn=Object.getOwnPropertyDescriptor,xn=(e,s,t,a)=>{for(var i=a>1?void 0:a?gn(s,t):s,r=e.length-1,o;r>=0;r--)(o=e[r])&&(i=o(i)||i);return i};const yn=[{id:"rv-1",title:"כניסה ראשית · 10:12–10:16",primary:"כניסה ראשית",scene:"entrance",related:["לובי"],events:3,severity:"alert",status:"חדש"},{id:"rv-2",title:"חצר אחורית · 09:40–09:44",primary:"חצר אחורית",scene:"backyard",related:[],events:2,severity:"info",status:"בבדיקה"},{id:"rv-3",title:"חניה מקורה · 06:41–06:45",primary:"חניה מקורה",scene:"parking",related:["כניסה ראשית"],events:1,severity:"alert",status:"טופל"},{id:"rv-4",title:"לובי · אתמול 23:08–23:12",primary:"לובי",scene:"lobby",related:[],events:4,severity:"info",status:"false positive"}];let rt=class extends w{render(){return n`
  ...
  `;rt=xn([b("investigate-reviews")],rt);var $n=Object.defineProperty,kn=Object.getOwnPropertyDescriptor,Vs=(e,s,t,a)=>{for(var i=a>1?void 0:a?kn(s,t):s,r=e.length-1,o;r>=0;r--)(o=e[r])&&(i=(a?o(s,t,i):o(i))||i);return a&&i&&$n(s,t,i),i};const zn=[{key:"title",label:"תיק",render:e=>n`<strong>${String(e.title)}</strong>`},{key:"status",label:"סטטוס",render:e=>n`<sw-badge kind=${e.status==="פתוח"?"stale":e.status==="סגור"?"neutral":"recorded"} label=${String(e.status)}></sw-badge>`},{key:"owner",label:"בעלים"},{key:"clips",label:"קטעים"},{key:"notes",label:"הערות"},{key:"preserved",label:"ראיות שמורות",render:e=>n`${e.preserved} שמורות${Number(e.missing)?n` · <span style="color:var(--sw-danger)">${e.missing} חסרות</span>`:""}`},{key:"more",label:"",width:"40px",render:()=>n`<sw-button variant="ghost" size="sm" iconOnly icon="more" label="עוד"></sw-button>`}];let Kt=class extends w{render(){return n`
      <sw-page heading="תיקים" subheading="קישור להקלטה אינו שימור: ראיה נחשבת שמורה רק אחרי העתקה מאומתת ו־hash · נתוני הדגמה">
        ...
        <sw-table .columns=${zn} .rows=${et} @row-select=${e=>x(`/investigate/cases/${e.detail.id}`)}></sw-table>
      </sw-page>
    `}};Kt=Vs([b("investigate-cases")],Kt);let ss=class extends w{constructor(){super(...arguments),this.caseId="case-1",this.tab="details"}render(){const e=et.find(s=>s.id===this.caseId)??et[0];return n`
  ...
  `;Vs([p()],ss.prototype,"caseId",2);Vs([c()],ss.prototype,"tab",2);ss=Vs([b("investigate-case-detail")],ss);var _n=Object.getOwnPropertyDescriptor,Sn=(e,s,t,a)=>{for(var i=a>1?void 0:a?_n(s,t):s,r=e.length-1,o;r>=0;r--)(o=e[r])&&(i=o(i)||i);return i};let nt=class extends w{render(){return n`
  ...
  `;nt=Sn([b("investigate-exports")],nt);var Mn=Object.defineProperty,Pn=Object.getOwnPropertyDescriptor,xi=(e,s,t,a)=>{for(var i=a>1?void 0:a?Pn(s,t):s,r=e.length-1,o;r>=0;r--)(o=e[r])&&(i=(a?o(s,t,i):o(i))||i);return a&&i&&Mn(s,t,i),i};const On=[{scene:"entrance",when:"14.09.2026 10:14",cam:"כניסה ראשית",why:"NVR: זיהוי אדם (Smart)"},{scene:"lobby",when:"14.09.2026 10:13",cam:"לובי",why:"NVR: תנועה + סמיכות במפה לכניסה"},{scene:"parking",when:"14.09.2026 06:43",cam:"חניה מקורה",why:"NVR: חציית קו"},{scene:"entrance",when:"14.09.2026 08:12",cam:"כניסה ראשית",why:"HA: דלת נפתחה + תנועה"},{scene:"corridor",when:"13.09.2026 23:10",cam:"מסדרון מזרחי",why:"NVR: זיהוי אדם"},{scene:"backyard",when:"13.09.2026 18:03",cam:"חצר אחורית",why:"NVR: תנועה"}];let _s=class extends w{constructor(){super(...arguments),this.by="person"}render(){return n`
      <sw-page heading="חיפוש AI" subheading="מצא בדיוק את מה שאתה מחפש · חיפוש סמנטי רק עם אינדקס אמיתי · נתוני הדגמה">
        ...
        <div class="wrap">
          ...
          <div class="results">
            ${On.map(e=>n`<div class="res" @click=${()=>window.location.hash="#/investigate/playback"}><div class="pic"><sw-scene kind=${e.scene}></sw-scene><span class="demo">דמו</span></div><div class="cap">${e.when}<small>${e.cam} · ${e.why}</small></div></div>`)}
          </div>
        </div>
      </sw-page>
    `}};_s.styles=m`
  ...
  `;xi([c()],_s.prototype,"by",2);_s=xi([b("investigate-search")],_s);var Cn=Object.defineProperty,An=Object.getOwnPropertyDescriptor,Us=(e,s,t,a)=>{for(var i=a>1?void 0:a?An(s,t):s,r=e.length-1,o;r>=0;r--)(o=e[r])&&(i=(a?o(s,t,i):o(i))||i);return a&&i&&Cn(s,t,i),i};const Yt={"r-1":{icon:"user",bg:"#eaf0ff",fg:"#2f6bff"},"r-2":{icon:"move",bg:"#e8f8ee",fg:"#16a34a"},"r-3":{icon:"door",bg:"#fff4e0",fg:"#d97706"},"r-4":{icon:"offline",bg:"#fdecec",fg:"#ef4444"}};let Ss=class extends w{constructor(){super(...arguments),this.tab="rules"}render(){return n`
      <sw-page heading="התראות וחוקי אוטומציה" subheading="Trigger → היקף → תנאים → פעולה · בדיקה יבשה לפני הפעלה · נתוני הדגמה">
        ...
        <sw-tabs .items=${[{id:"rules",label:"חוקים",count:st.length},{id:"notif",label:"התראות"},{id:"sched",label:"לוחות זמנים"},{id:"trig",label:"Triggers"}]} .active=${this.tab} @change=${e=>this.tab=e.detail.id}></sw-tabs>
        ${this.tab==="rules"?n`<div class="list">
              ${st.map(e=>{const s=Yt[e.id]??Yt["r-1"];return n`<sw-card flush class="rule" style="--bg:${s.bg};--fg:${s.fg}">
  ...
  `;Us([c()],Ss.prototype,"tab",2);Ss=Us([b("investigate-rules")],Ss);let Ms=class extends w{constructor(){super(...arguments),this.ruleId="r-1"}render(){const e=st.find(s=>s.id===this.ruleId)??{name:"חוק חדש",trigger:"זיהוי אדם",scope:"חוץ",action:"התראה"};return n`
  ...
  `;Us([p()],Ms.prototype,"ruleId",2);Ms=Us([b("investigate-rule-editor")],Ms);var En=Object.defineProperty,In=Object.getOwnPropertyDescriptor,cs=(e,s,t,a)=>{for(var i=a>1?void 0:a?In(s,t):s,r=e.length-1,o;r>=0;r--)(o=e[r])&&(i=(a?o(s,t,i):o(i))||i);return a&&i&&En(s,t,i),i};const Tn=[{id:"users",label:"משתמשים",count:Qs.length},{id:"groups",label:"קבוצות",count:di.length},{id:"roles",label:"תפקידים",count:ci.length},{id:"effective",label:"הרשאות אפקטיביות"},{id:"audit",label:"אודיט הרשאות"}];let ke=class extends w{constructor(){super(...arguments),this.tab="users",this.selected=null,this.assigning=!1,this.step=0,this.userColumns=[{key:"name",label:"שם",render:e=>n`<div class="who"><sw-avatar name=${String(e.name)} size=${30}></sw-avatar><div><strong>${String(e.name)}</strong>${e.haAdmin?n` <sw-badge kind="neutral" label="מנהל HA · מידע בלבד"></sw-badge>`:""}<div class="ltr sub">${String(e.haUser)}@ha.local</div></div></div>`},{key:"role",label:"תפקיד",render:e=>{const s=e.bindings[0];return s?n`<span class="pillsel">${s.role}<sw-icon name="chevronDown" size=${11}></sw-icon></span>`:n`<span class="pillsel" style="color:var(--sw-text-3)">ללא שיוך<sw-icon name="chevronDown" size=${11}></sw-icon></span>`}},{key:"scope",label:"היקף גישה",render:e=>{const s=e.bindings[0];return s?n`<span class="pillsel">${s.scope}<sw-icon name="chevronDown" size=${11}></sw-icon></span>`:n`<span class="sub">—</span>`}},{key:"active",label:"מצב",render:e=>n`<span class="status ${e.active?"":"off"}"><i></i>${e.active?"פעיל":"מושבת ב־HA"}</span>`},{key:"lastSync",label:"סנכרון"},{key:"more",label:"",width:"40px",render:()=>n`<sw-button variant="ghost" size="sm" iconOnly icon="more" label="עוד"></sw-button>`}]}renderUsers(){const e=Qs.find(s=>s.id===this.selected);return n`
    ...
    `}renderAudit(){return n`<sw-table dense .columns=${[{key:"time",label:"זמן"},{key:"user",label:"משתמש",render:s=>n`<div class="who"><sw-avatar name=${String(s.user)} size=${24}></sw-avatar>${String(s.user)}</div>`},{key:"action",label:"פעולה"},{key:"resource",label:"משאב"},{key:"decision",label:"החלטה",render:s=>n`<sw-badge kind=${String(s.decision).startsWith("נחסם")?"forbidden":"live"} label=${String(s.decision)}></sw-badge>`},{key:"role",label:"תפקיד/היקף ששימשו"}]} .rows=${pi.filter(s=>s.action.includes("תוכנית")||s.action.includes("סנכרון")||s.action.includes("Ingress"))}></sw-table>`}render(){return n`
      <sw-page heading="משתמשים והרשאות" subheading="זהות מ־Home Assistant · הרשאות בתוך SMPLWISE בלבד · נתוני הדגמה">
        ...
        <sw-tabs .items=${Tn} .active=${this.tab} @change=${e=>this.tab=e.detail.id}></sw-tabs>
  ...
  `;cs([c()],ke.prototype,"tab",2);cs([c()],ke.prototype,"selected",2);cs([c()],ke.prototype,"assigning",2);cs([c()],ke.prototype,"step",2);ke=cs([b("system-access")],ke);var Dn=Object.getOwnPropertyDescriptor,Nn=(e,s,t,a)=>{for(var i=a>1?void 0:a?Dn(s,t):s,r=e.length-1,o;r>=0;r--)(o=e[r])&&(i=o(i)||i);return i};const jn=[{key:"time",label:"זמן",render:e=>n`14.09.2026 ${String(e.time)}`},{key:"user",label:"משתמש",render:e=>n`<span style="display:inline-flex;align-items:center;gap:8px"><sw-avatar name=${String(e.user)} size=${24}></sw-avatar>${String(e.user)}</span>`},{key:"action",label:"פעולה",render:e=>n`<span style=${String(e.decision).startsWith("נחסם")?"color:var(--sw-danger);font-weight:600":""}>${String(e.action)}</span>`},{key:"resource",label:"פרטים",render:e=>n`${String(e.resource)} <span style="color:var(--sw-text-3)">· ${String(e.decision)}</span>`},{key:"role",label:"תפקיד / היקף"},{key:"rev",label:"rev",ltr:!0,render:()=>n`7`}];let ot=class extends w{render(){return n`
      <sw-page heading="יומן אודיט" subheading="מי צפה, שינה, ייצא או שלח פעולה · actor, מקור זהות, תפקיד והיקף, החלטה, request_id, permission_revision · נתוני הדגמה">
        ...
        <sw-table .columns=${jn} .rows=${pi}></sw-table>
        <div class="pager">
  ...
  `;ot=Nn([b("system-audit")],ot);var Rn=Object.defineProperty,Hn=Object.getOwnPropertyDescriptor,yi=(e,s,t,a)=>{for(var i=a>1?void 0:a?Hn(s,t):s,r=e.length-1,o;r>=0;r--)(o=e[r])&&(i=(a?o(s,t,i):o(i))||i);return a&&i&&Rn(s,t,i),i};const Ks=["גילוי","NVR","go2rtc","גשר HA","מנהל ראשון","שעון","סיום"];let Ps=class extends w{constructor(){super(...arguments),this.step=0}renderStep(){switch(this.step){case 0:return n`<sw-card heading="גילוי מכשירים" subheading="חיפוש NVR ומצלמות ברשת המקומית · קריאה בלבד, ללא שינוי תצורה במכשיר">
          <div class="scan">
  ...
  `;yi([c()],Ps.prototype,"step",2);Ps=yi([b("system-setup")],Ps);var Ln=Object.defineProperty,Bn=Object.getOwnPropertyDescriptor,V=(e,s,t,a)=>{for(var i=a>1?void 0:a?Bn(s,t):s,r=e.length-1,o;r>=0;r--)(o=e[r])&&(i=(a?o(s,t,i):o(i))||i);return a&&i&&Ln(s,t,i),i};const Gt=["entrance","lobby","corridor","hall","parking","warehouse","backyard","driveway","night"];let T=class extends w{constructor(){super(...arguments),this.selected=null,this.filter="all",this.cameras=null,this.recorder=null,this.canSync=!1,this.busy=!1,this.message="",this.error="",this.dialog=!1,this.formChannel=1,this.formAlias="",this.alias="",this.columns=[{key:"name",label:"מצלמה",render:e=>n`<div class="cam">${e.scene?n`<sw-scene kind=${e.scene}></sw-scene>`:n`<div class="none"></div>`}<div><b>${String(e.name)}</b><small>${String(e.sub)}</small></div></div>`},{key:"state",label:"מצב",render:e=>n`<span class="status"><i style="--c:${e.state==="live"?"var(--sw-live)":e.state==="offline"?"var(--sw-danger)":e.state==="unknown"?"var(--sw-unknown)":"var(--sw-stale)"}"></i>${e.state==="live"?"מחוברת":e.state==="offline"?"מנותקת":e.state==="stale"?"לא מעודכן":e.state==="forbidden"?"ללא הרשאה":"לא נבדק"}</span>`},{key:"fps",label:"FPS",ltr:!0},{key:"bitrate",label:"קצב",ltr:!0},{key:"firmware",label:"זרם ראשי",ltr:!0},{key:"lastEvent",label:"נראתה לאחרונה"},{key:"net",label:"רשת",render:e=>this.net(e.state==="live"?4:e.state==="stale"?2:0)},{key:"more",label:"",width:"40px",render:()=>n`<sw-button variant="ghost" size="sm" iconOnly icon="more" label="עוד"></sw-button>`}]}connectedCallback(){super.connectedCallback(),this.reload()}async reload(){if(!S()){this.cameras=null;return}try{const e=await js();this.cameras=e.cameras,this.recorder=e.recorder,this.canSync=e.can_sync}catch(e){this.error=k(e)}}async sync(){this.busy=!0,this.error="",this.message="";try{const e=await sr();this.message=`סנכרון הושלם: ${e.channels} ערוצים (${e.created} חדשים, ${e.updated} עודכנו)${e.recorder.model?` · ${e.recorder.model}`:""}`,await this.reload()}catch(e){this.error=k(e)}finally{this.busy=!1}}async register(){this.busy=!0,this.error="";try{await tr({channel:this.formChannel,alias:this.formAlias.trim()}),this.dialog=!1,await this.reload()}catch(e){this.error=k(e)}finally{this.busy=!1}}async saveAlias(e){this.busy=!0,this.error="";try{await ir(e,{alias:this.alias.trim()||void 0}),await this.reload(),this.message="הכינוי נשמר (שם ה־NVR לא השתנה)"}catch(s){this.error=k(s)}finally{this.busy=!1}}get rows(){return this.cameras?this.cameras.map(e=>({id:e.id,name:e.name,sub:`ערוץ ${e.channel}${e.name_source&&e.alias?` · NVR: ${e.name_source}`:""}`,state:e.status==="online"?"live":e.status==="offline"?"offline":"unknown",fps:e.stream?.fps?String(e.stream.fps):"—",bitrate:e.stream?.bitrate_kbps?`${(e.stream.bitrate_kbps/1024).toFixed(1)} Mbps`:"—",firmware:e.stream?.resolution?`${e.stream.resolution} ${e.stream.codec??""}`.trim():"—",lastEvent:e.last_seen_at?e.last_seen_at.replace("T"," ").replace("Z",""):"לא נבדק",scene:e.status==="online"?Gt[(e.channel-1)%Gt.length]:null,channel:e.channel,api:e})):z.map(e=>({id:e.id,name:e.name,sub:`${e.floor} · ערוץ ${e.id.replace("cam-","")}`,state:e.state,fps:e.fps?String(e.fps):"—",bitrate:e.bitrateKbps?`${(e.bitrateKbps/1024).toFixed(1)} Mbps`:"—",firmware:e.firmware,lastEvent:e.lastEvent,scene:e.state==="offline"||e.state==="forbidden"?null:G[e.id]??"lobby",channel:Number(e.id.replace("cam-",""))}))}net(e){return d`<svg class="net" viewBox="0 0 22 14" aria-label="רשת">${[0,1,2,3].map(s=>d`<rect x=${s*5.5} y=${11-s*3} width="4" height=${3+s*3} rx="1" fill=${s<e?e>=3?"#22c55e":"#f59e0b":"var(--sw-border-strong)"} />`)}</svg>`}render(){const e=this.rows,s=e.filter(i=>this.filter==="all"?!0:this.filter==="online"?i.state==="live":this.filter==="offline"?i.state==="offline":i.state==="stale"||i.state==="forbidden"||i.state==="unknown"),t=e.find(i=>i.id===this.selected),a=!!this.cameras;return n`
  ...
  `;V([c()],T.prototype,"selected",2);V([c()],T.prototype,"filter",2);V([c()],T.prototype,"cameras",2);V([c()],T.prototype,"recorder",2);V([c()],T.prototype,"canSync",2);V([c()],T.prototype,"busy",2);V([c()],T.prototype,"message",2);V([c()],T.prototype,"error",2);V([c()],T.prototype,"dialog",2);V([c()],T.prototype,"formChannel",2);V([c()],T.prototype,"formAlias",2);V([c()],T.prototype,"alias",2);T=V([b("system-devices")],T);var Vn=Object.defineProperty,Un=Object.getOwnPropertyDescriptor,U=(e,s,t,a)=>{for(var i=a>1?void 0:a?Un(s,t):s,r=e.length-1,o;r>=0;r--)(o=e[r])&&(i=(a?o(s,t,i):o(i))||i);return a&&i&&Vn(s,t,i),i};const Wn=[{id:"general",label:"כללי"},{id:"media",label:"וידאו ומדיה"},{id:"health",label:"בריאות ועבודות"},{id:"backup",label:"גיבוי ושחזור"},{id:"support",label:"תמיכה"}];let D=class extends w{constructor(){super(...arguments),this.tab="general",this.settings=null,this.canEdit=!1,this.draft={},this.streams=null,this.go2rtc=null,this.foreign=0,this.sessions=[],this.busy=!1,this.message="",this.error="",this.version=""}connectedCallback(){super.connectedCallback(),this.loadSettings()}async loadSettings(){if(S())try{const[e,s]=await Promise.all([ri(),ne("health").catch(()=>null)]);this.settings=e.settings,this.canEdit=e.can_edit,this.draft={},this.version=s?.version??""}catch(e){this.error=k(e)}}async loadMedia(){if(!(!S()||!this.canEdit))try{const[e,s]=await Promise.all([za(),_a()]);this.streams=e.streams,this.go2rtc=e.go2rtc,this.foreign=e.foreign_streams,this.sessions=s.sessions,this.error=""}catch(e){this.streams=[],this.error=k(e)}}set(e,s){this.draft={...this.draft,[e]:s}}value(e){return this.draft[e]??this.settings?.[e]}async save(){if(Object.keys(this.draft).length){this.busy=!0,this.error="";try{const e=await $a(this.draft);this.settings=e.settings,this.draft={},qr(),this.message="ההגדרות נשמרו",setTimeout(()=>this.message="",2500)}catch(e){this.error=k(e)}finally{this.busy=!1}}}async sync(){this.busy=!0,this.error="";try{const e=await ka();this.message=`זרמים: ${e.created} נוצרו, ${e.updated} עודכנו, ${e.unchanged} ללא שינוי · ${e.foreign_streams_untouched} זרמים זרים לא נגעו`,await this.loadMedia()}catch(e){this.error=k(e)}finally{this.busy=!1}}renderGeneral(){return n`<div class="sections">
      ...
      <sw-card heading="מצבים נפרדים, לא נורה אחת">${ui.map(e=>n`<div class="row"><span class="lbl">${e.name}<span class="muted">${e.detail}</span></span><sw-badge kind=${e.state}></sw-badge></div>`)}
      ...
      <sw-card heading="תור עבודות">${hi.map(e=>n`<div class="row"><span class="lbl">${e.title}<span class="muted">${e.status}</span></span><span style="display:flex;align-items:center;gap:10px"><span class="bar ${e.status.startsWith("נכשל")?"fail":""}"><i style="--p:${e.progress}%"></i></span><span class="ltr">${e.progress}%</span></span></div>`)}</sw-card>
      ...
      <sw-page heading="הגדרות המערכת" subheading=${S()?"תעבורת וידאו, go2rtc, מכסות ובריאות":"אזור זמן, מדיניות אחסון, אינטגרציות ובריאות · נתוני הדגמה"}>
        <sw-tabs underline .items=${Wn} .active=${this.tab} @change=${e=>{this.tab=e.detail.id,this.tab==="media"&&this.loadMedia()}}></sw-tabs>
  ...
  `;U([c()],D.prototype,"tab",2);U([c()],D.prototype,"settings",2);U([c()],D.prototype,"canEdit",2);U([c()],D.prototype,"draft",2);U([c()],D.prototype,"streams",2);U([c()],D.prototype,"go2rtc",2);U([c()],D.prototype,"foreign",2);U([c()],D.prototype,"sessions",2);U([c()],D.prototype,"busy",2);U([c()],D.prototype,"message",2);U([c()],D.prototype,"error",2);U([c()],D.prototype,"version",2);D=U([b("system-diagnostics")],D);var Fn=Object.defineProperty,qn=Object.getOwnPropertyDescriptor,$i=(e,s,t,a)=>{for(var i=a>1?void 0:a?qn(s,t):s,r=e.length-1,o;r>=0;r--)(o=e[r])&&(i=(a?o(s,t,i):o(i))||i);return a&&i&&Fn(s,t,i),i};const Kn=[{name:"כניסה ראשית",gb:320},{name:"אולם",gb:410},{name:"חצר אחורית",gb:380},{name:"לובי",gb:180},{name:"מחסן",gb:96}];let Os=class extends w{constructor(){super(...arguments),this.range="30D"}render(){const e=[.3,.36,.45,.5,.58,.63,.7],s=600,t=200,a=g=>g/(e.length-1)*420,i=g=>170-g*150,r=e.map((g,f)=>`${f===0?"M":"L"}${a(f)} ${i(g)}`).join(" "),o=`M${a(e.length-1)} ${i(.7)} L520 ${i(.86)} L${s} ${i(1)}`,l=16,u=2*Math.PI*l,y=410;return n`
      <sw-page heading="אנליטיקת אחסון" subheading="Beta · ניטור שימוש, תכנון קדימה ושליטה · נתון נמדד לעומת אומדן מסומן · אין format או RAID · נתוני הדגמה">
        ...
        <div class="grid">
          <sw-card heading="שימוש באחסון לפי מצלמה" subheading="נמדד · לפני retention">
            ${Kn.map(g=>n`<div class="cam"><span>${g.name}</span><span class="bar"><i style="--p:${g.gb/y*100}%"></i></span><span class="gb ltr">${g.gb} GB</span></div>`)}
  ...
  `;$i([c()],Os.prototype,"range",2);Os=$i([b("system-storage")],Os);var Yn=Object.getOwnPropertyDescriptor,Gn=(e,s,t,a)=>{for(var i=a>1?void 0:a?Yn(s,t):s,r=e.length-1,o;r>=0;r--)(o=e[r])&&(i=o(i)||i);return i};const Jn=[{mode:"סקירה ומצלמות",items:[{sc:"SC01",name:"סקירה (Dashboard)",route:"#/live",phase:"PILOT",board:"1:01 · 2:15"},{sc:"SC07",name:"כל המצלמות (Grid)",route:"#/live/wall",phase:"PILOT",board:"1:06"},{sc:"SC08",name:"מצלמה בודדת",route:"#/live/cameras/cam-4",phase:"PILOT",board:"1:05"},{sc:"SC09",name:"תצוגות שמורות",route:"#/live/views",phase:"PILOT",board:"legacy"},{sc:"SC27",name:"בריאות מצלמות",route:"#/system/devices",phase:"PILOT",board:"2:12"},{sc:"SC31",name:"קיוסק / תצוגת קיר",route:"#/kiosk/all",phase:"BETA",board:"3:24"}]},{mode:"אתרים ומפות",items:[{sc:"SC02",name:"אתרים ומבנים",route:"#/explore/sites",phase:"PILOT",board:"1:02 · 3:17"},{sc:"SC03",name:"דפדפן קומות",route:"#/explore/buildings/bld-a/floors",phase:"PILOT",board:"1:03"},{sc:"SC04",name:"מפת קומה חיה",route:"#/explore/floors/f0",phase:"PILOT",board:"1:04"},{sc:"SC05",name:"ייבוא ותיקון תוכנית",route:"#/explore/floors/f-2/import",phase:"PILOT",board:"2:13"},{sc:"SC06",name:"עורך תוכנית ועוגנים",route:"#/explore/floors/f0/edit",phase:"PILOT",board:"2:13"},{sc:"SC10",name:"קטלוג ישויות HA",route:"#/explore/entities",phase:"PILOT",board:"new"},{sc:"SC23",name:"דלתות ואינטרקום",route:"#/explore/access/d1",phase:"V1",board:"3:18"}]},{mode:"אירועים והקלטות",items:[{sc:"SC14",name:"מרכז אירועים",route:"#/investigate/events",phase:"PILOT",board:"1:08"},{sc:"SC12",name:"הקלטות / ציר זמן",route:"#/investigate/playback",phase:"PILOT",board:"1:07 · 2:16"},{sc:"SC13",name:"מרכז שליטה / ניגון מסונכרן",route:"#/investigate/playback/sync",phase:"BETA",board:"2:14"},{sc:"SC11",name:"מפה היסטורית",route:"#/investigate/floors/f0/history",phase:"PILOT",board:"new"},{sc:"SC15",name:"תור Review",route:"#/investigate/reviews",phase:"BETA",board:"legacy"},{sc:"SC16",name:"תיקים",route:"#/investigate/cases",phase:"BETA",board:"2:10"},{sc:"SC17",name:"סקירת אירוע / תיק",route:"#/investigate/cases/case-1",phase:"BETA",board:"2:10"},{sc:"SC18",name:"ייצוא והורדות",route:"#/investigate/exports",phase:"BETA",board:"2:10"},{sc:"SC19",name:"חיפוש AI",route:"#/investigate/search",phase:"BETA",board:"2:09"},{sc:"SC21",name:"התראות וחוקים",route:"#/investigate/rules",phase:"BETA",board:"3:19"},{sc:"SC22",name:"עורך חוק",route:"#/investigate/rules/r-1",phase:"BETA",board:"3:19"}]},{mode:"הגדרות",items:[{sc:"SC28",name:"הגדרות המערכת",route:"#/system/diagnostics",phase:"PILOT",board:"3:23"},{sc:"SC24",name:"משתמשים והרשאות",route:"#/system/access",phase:"PILOT",board:"3:20"},{sc:"SC25",name:"יומן אודיט",route:"#/system/audit",phase:"PILOT",board:"3:21"},{sc:"SC20",name:"אנליטיקת אחסון",route:"#/system/storage",phase:"BETA",board:"2:11"},{sc:"SC26",name:"אשף התקנה",route:"#/system/setup",phase:"PILOT",board:"3:22"}]}],Xn={PILOT:"live",BETA:"recorded",V1:"neutral"};let lt=class extends w{render(){return n`
      <sw-page heading="כל המסכים (סקירת עיצוב)" subheading="29 מסכים על נתוני הדגמה · SC29/SC30 הם אותם מסכים ברוחב טלפון · SC32 (Lovelace) הוא עטיפה של אותם רכיבים">
        ...
        <div class="groups">
          ${Jn.map(e=>n`<sw-card heading=${e.mode}>
              ${e.items.map(s=>n`<a href=${s.route}><span class="sc">${s.sc}</span><span class="name">${s.name}</span><span class="board">${s.board}</span><sw-badge kind=${Xn[s.phase]} label=${s.phase}></sw-badge><sw-icon name="chevron" size=${12}></sw-icon></a>`)}
            </sw-card>`)}
        </div>
      </sw-page>
    `}};lt.styles=m`
  ...
  `;lt=Gn([b("screens-index")],lt);var Zn=Object.getOwnPropertyDescriptor,Qn=(e,s,t,a)=>{for(var i=a>1?void 0:a?Zn(s,t):s,r=e.length-1,o;r>=0;r--)(o=e[r])&&(i=o(i)||i);return i};const eo=[["--sw-bg","רקע"],["--sw-surface","משטח"],["--sw-surface-3","משטח 3"],["--sw-border","גבול"],["--sw-text","טקסט"],["--sw-text-2","טקסט משני"],["--sw-text-3","טקסט שלישי"],["--sw-accent","כחול"],["--sw-accent-soft","כחול רך"],["--sw-live","חי"],["--sw-offline","מנותק"],["--sw-stale","מיושן"],["--sw-danger","שגיאה"],["--sw-purple","סגול (דלת)"]],so=["live","recorded","historic","offline","stale","partial","unknown","forbidden","error"],to=["loading","empty","error","forbidden","stale","partial"],io=["entrance","lobby","corridor","hall","parking","warehouse","backyard","driveway","night","building","house"],ao=["dashboard","building","camera","bell","history","system","search","user","play","pause","back10","forward10","aperture","volume","mic","expand","close","chevron","chevronDown","warning","info","lock","unlock","offline","refresh","layers","floor","plus","minus","fit","door","light","sensor","check","clock","download","pin","more","map","upload","list","target","filter","users","shield","storage","edit","case","rule","link","grid","home","star","calendar","trash","eye","cpu","activity","image","wifi","signal","move","bookmark","route"];let dt=class extends w{render(){return n`
      ...
      <h3>צבעים</h3>
      <div class="swatches">
        ${eo.map(([e,s])=>n`<div class="swatch"><div class="c" style="background:var(${e})"></div><div class="n"><span>${s}</span><span class="ltr">${e}</span></div></div>`)}
      </div>
      ...
      <div class="scenes">${io.map(e=>n`<div><sw-scene kind=${e}></sw-scene><span>${e}</span></div>`)}</div>
      ...
      <div class="row">${so.map(e=>n`<sw-badge kind=${e}></sw-badge>`)}</div>
      ...
      <h3>מצבי מסך</h3>
      <div class="grid">
        ${to.map(e=>n`<div class="panel"><sw-state-panel state=${e} actionLabel=${e==="error"?"נסה שוב":""}></sw-state-panel></div>`)}
      </div>

      <h3>אייקונים</h3>
      <div class="icons">${ao.map(e=>n`<div class="icon"><sw-icon .name=${e} size=${18}></sw-icon><span class="ltr">${e}</span></div>`)}</div>
    `}};dt.styles=m`
    :host {
      display: block;
      padding: 14px 24px 24px;
  ...
  `;dt=Qn([b("styleguide-screen")],dt);const Jt=[{id:"overview",icon:"dashboard",label:"סקירה",href:"#/live"},{id:"sites",icon:"building",label:"אתרים",href:"#/explore/sites"},{id:"cameras",icon:"camera",label:"מצלמות",href:"#/live/wall"},{id:"events",icon:"bell",label:"אירועים",href:"#/investigate/events"},{id:"playback",icon:"history",label:"הקלטות",href:"#/investigate/playback"},{id:"settings",icon:"system",label:"הגדרות",href:"#/system/diagnostics"}],ro={overview:[],sites:[{id:"sites",label:"אתרים ומבנים",href:"#/explore/sites"},{id:"floors",label:"מפת קומה",href:"#/explore/floors/f0"},{id:"entities",label:"ישויות HA",href:"#/explore/entities"},{id:"access",label:"דלתות ואינטרקום",href:"#/explore/access/d1"}],cameras:[{id:"wall",label:"כל המצלמות",href:"#/live/wall"},{id:"views",label:"תצוגות שמורות",href:"#/live/views"},{id:"devices",label:"בריאות מצלמות",href:"#/system/devices"}],events:[{id:"events",label:"מרכז אירועים",href:"#/investigate/events"},{id:"reviews",label:"Review",href:"#/investigate/reviews"},{id:"search",label:"חיפוש",href:"#/investigate/search"},{id:"cases",label:"תיקים",href:"#/investigate/cases"},{id:"rules",label:"חוקים והתראות",href:"#/investigate/rules"},{id:"exports",label:"ייצוא",href:"#/investigate/exports"}],playback:[{id:"playback",label:"הקלטות",href:"#/investigate/playback"},{id:"sync",label:"ניגון מסונכרן",href:"#/investigate/playback/sync"},{id:"history",label:"מפה היסטורית",href:"#/investigate/floors/f0/history"}],settings:[{id:"general",label:"כללי",href:"#/system/diagnostics"},{id:"access",label:"משתמשים והרשאות",href:"#/system/access"},{id:"audit",label:"אודיט",href:"#/system/audit"},{id:"storage",label:"אחסון",href:"#/system/storage"},{id:"setup",label:"אשף התקנה",href:"#/system/setup"}]};function ki(e){if(!e?.mode)return null;const s=e.segments;switch(e.mode){case"live":return s.length===1?"overview":"cameras";case"explore":return"sites";case"investigate":return!s[1]||s[1]==="playback"||s[1]==="floors"?"playback":"events";case"system":return s[1]==="devices"?"cameras":"settings";default:return null}}function no(e){const s=ki(e);if(!s||!e)return"";const t=e.segments;switch(s){case"sites":return t[1]==="buildings"||t[1]==="floors"?"floors":t[1]==="entities"?"entities":t[1]==="access"?"access":"sites";case"cameras":return e.mode==="system"?"devices":t[1]==="views"?"views":"wall";case"events":return t[1]??"events";case"playback":return t[1]==="floors"?"history":t[2]==="sync"?"sync":"playback";case"settings":return!t[1]||t[1]==="diagnostics"?"general":t[1];default:return""}}var oo=Object.defineProperty,lo=Object.getOwnPropertyDescriptor,_t=(e,s,t,a)=>{for(var i=a>1?void 0:a?lo(s,t):s,r=e.length-1,o;r>=0;r--)(o=e[r])&&(i=(a?o(s,t,i):o(i))||i);return a&&i&&oo(s,t,i),i};let ts=class extends w{constructor(){super(...arguments),this.route=null,this.session={mode:"loading",me:null,error:null}}connectedCallback(){super.connectedCallback(),this.stopSession=fi(e=>this.session=e),Ka(),this.stopRouter=qa(e=>{this.route=e,this.toggleAttribute("data-kiosk",e.segments[0]==="kiosk")})}disconnectedCallback(){super.disconnectedCallback(),this.stopRouter?.(),this.stopSession?.()}renderGate(){const e=this.session;return e.mode==="unauthenticated"?n`<div class="gate"><sw-state-panel state="forbidden" heading="הזדהות דרך Home Assistant נדרשת" hint=${e.error??""}></sw-state-panel></div>`:e.mode==="no_access"?n`<div class="gate"><sw-state-panel state="forbidden" heading="אין לך עדיין תפקיד במערכת" hint="המשתמש ${e.me?.user.display_name||e.me?.user.username||""} מזוהה מ־Home Assistant, אך מנהל ה־VMS טרם שייך לו תפקיד והיקף. פנה למנהל המערכת."></sw-state-panel></div>`:null}renderScreen(){const e=this.route;if(!e)return h;const s=e.segments;if(s[0]==="styleguide")return n`<styleguide-screen></styleguide-screen>`;if(s[0]==="screens")return n`<screens-index></screens-index>`;if(s[0]==="kiosk")return n`<kiosk-wall></kiosk-wall>`;switch(e.mode){case"live":return s[1]==="wall"?n`<live-wall></live-wall>`:s[1]==="views"?n`<live-views></live-views>`:s[1]==="cameras"?n`<live-camera .cameraId=${s[2]??"cam-1"}></live-camera>`:n`<live-overview></live-overview>`;case"investigate":return s[1]==="playback"&&s[2]==="sync"?n`<investigate-sync></investigate-sync>`:s[1]==="playback"?n`<investigate-playback></investigate-playback>`:s[1]==="floors"?n`<investigate-history-map .floorId=${s[2]??"f0"}></investigate-history-map>`:s[1]==="events"?n`<investigate-events></investigate-events>`:s[1]==="reviews"?n`<investigate-reviews></investigate-reviews>`:s[1]==="cases"&&s[2]?n`<investigate-case-detail .caseId=${s[2]}></investigate-case-detail>`:s[1]==="cases"?n`<investigate-cases></investigate-cases>`:s[1]==="exports"?n`<investigate-exports></investigate-exports>`:s[1]==="search"?n`<investigate-search></investigate-search>`:s[1]==="rules"&&s[2]?n`<investigate-rule-editor .ruleId=${s[2]}></investigate-rule-editor>`:s[1]==="rules"?n`<investigate-rules></investigate-rules>`:n`<investigate-playback></investigate-playback>`;case"system":return s[1]==="audit"?n`<system-audit></system-audit>`:s[1]==="setup"?n`<system-setup></system-setup>`:s[1]==="devices"?n`<system-devices></system-devices>`:s[1]==="storage"?n`<system-storage></system-storage>`:s[1]==="access"?n`<system-access></system-access>`:n`<system-diagnostics></system-diagnostics>`;case"explore":default:{if(s[1]==="sites")return n`<explore-sites></explore-sites>`;if(s[1]==="buildings")return n`<explore-floors .buildingId=${s[2]??"bld-a"}></explore-floors>`;if(s[1]==="entities")return n`<explore-entities></explore-entities>`;if(s[1]==="access")return n`<explore-access></explore-access>`;if(s[1]==="floors"&&s[3]==="import")return n`<explore-plan-import .floorId=${s[2]}></explore-plan-import>`;if(s[1]==="floors"&&s[3]==="edit")return n`<explore-plan-editor .floorId=${s[2]}></explore-plan-editor>`;const t=s[1]==="floors"&&s[2]?s[2]:"f0",a=e.params.get("state")??"ready";return n`<explore-floor-map .floorId=${t} .screenState=${a}></explore-floor-map>`}}}render(){if(this.route?.segments[0]==="kiosk")return n`<main style="block-size:100dvh">${this.renderScreen()}</main>`;const s=ki(this.route),t=s?ro[s]:[],a=this.route?.segments[3]==="edit"||this.route?.segments[3]==="import";return n`
      ...
      <main>
        ${this.renderGate()||n`
          <div class="subnav">${t.length>1&&!a?n`<sw-tabs .items=${t} .active=${no(this.route)}></sw-tabs>`:h}</div>
          <div class="screen">${this.session.mode==="loading"?h:this.renderScreen()}</div>`}
      </main>
      <nav class="bottom" aria-label="ניווט ראשי">
        ${Jt.slice(0,4).map(i=>n`<a class=${Ve({active:s===i.id})} href=${i.href}><sw-icon .name=${i.icon} size=${20}></sw-icon>${i.label}</a>`)}
        <a class=${Ve({active:s==="settings"||s==="playback"})} href="#/system/diagnostics"><sw-icon name="more" size=${20}></sw-icon>עוד</a>
      </nav>
    `}};ts.styles=m`
    :host {
      display: grid;
  ...
  `;_t([c()],ts.prototype,"route",2);_t([c()],ts.prototype,"session",2);ts=_t([b("sw-app")],ts);
//# sourceMappingURL=index-by6RSLt5.js.map
