 ...
 */const Xs=globalThis,wa=Xs.ShadowRoot&&(Xs.ShadyCSS===void 0||Xs.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,va=Symbol(),Ba=new WeakMap;let Yr=class{constructor(t,s,i){if(this._$cssResult$=!0,i!==va)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=t,this.t=s}get styleSheet(){let t=this.o;const s=this.t;if(wa&&t===void 0){const i=s!==void 0&&s.length===1;i&&(t=Ba.get(s)),t===void 0&&((this.o=t=new CSSStyleSheet).replaceSync(this.cssText),i&&Ba.set(s,t))}return t}toString(){return this.cssText}};const Kn=e=>new Yr(typeof e=="string"?e:e+"",void 0,va),M=(e,...t)=>{const s=e.length===1?e[0]:t.reduce((i,a,n)=>i+(o=>{if(o._$cssResult$===!0)return o.cssText;if(typeof o=="number")return o;throw Error("Value passed to 'css' function must be a 'css' function result: "+o+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(a)+e[n+1],e[0]);return new Yr(s,e,va)},Gn=(e,t)=>{if(wa)e.adoptedStyleSheets=t.map(s=>s instanceof CSSStyleSheet?s:s.styleSheet);else for(const s of t){const i=document.createElement("style"),a=Xs.litNonce;a!==void 0&&i.setAttribute("nonce",a),i.textContent=s.cssText,e.appendChild(i)}},La=wa?e=>e:e=>e instanceof CSSStyleSheet?(t=>{let s="";for(const i of t.cssRules)s+=i.cssText;return Kn(s)})(e):e;/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const{is:Yn,defineProperty:Jn,getOwnPropertyDescriptor:Xn,getOwnPropertyNames:Qn,getOwnPropertySymbols:eo,getPrototypeOf:to}=Object,fi=globalThis,Va=fi.trustedTypes,so=Va?Va.emptyScript:"",io=fi.reactiveElementPolyfillSupport,ws=(e,t)=>e,si={toAttribute(e,t){switch(t){case Boolean:e=e?so:null;break;case Object:case Array:e=e==null?e:JSON.stringify(e)}return e},fromAttribute(e,t){let s=e;switch(t){case Boolean:s=e!==null;break;case Number:s=e===null?null:Number(e);break;case Object:case Array:try{s=JSON.parse(e)}catch{s=null}}return s}},ba=(e,t)=>!Yn(e,t),Ha={attribute:!0,type:String,converter:si,reflect:!1,useDefault:!1,hasChanged:ba};Symbol.metadata??=Symbol("metadata"),fi.litPropertyMetadata??=new WeakMap;let Kt=class extends HTMLElement{static addInitializer(t){this._$Ei(),(this.l??=[]).push(t)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(t,s=Ha){if(s.state&&(s.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(t)&&((s=Object.create(s)).wrapped=!0),this.elementProperties.set(t,s),!s.noAccessor){const i=Symbol(),a=this.getPropertyDescriptor(t,i,s);a!==void 0&&Jn(this.prototype,t,a)}}static getPropertyDescriptor(t,s,i){const{get:a,set:n}=Xn(this.prototype,t)??{get(){return this[s]},set(o){this[s]=o}};return{get:a,set(o){const l=a?.call(this);n?.call(this,o),this.requestUpdate(t,l,i)},configurable:!0,enumerable:!0}}static getPropertyOptions(t){return this.elementProperties.get(t)??Ha}static _$Ei(){if(this.hasOwnProperty(ws("elementProperties")))return;const t=to(this);t.finalize(),t.l!==void 0&&(this.l=[...t.l]),this.elementProperties=new Map(t.elementProperties)}static finalize(){if(this.hasOwnProperty(ws("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(ws("properties"))){const s=this.properties,i=[...Qn(s),...eo(s)];for(const a of i)this.createProperty(a,s[a])}const t=this[Symbol.metadata];if(t!==null){const s=litPropertyMetadata.get(t);if(s!==void 0)for(const[i,a]of s)this.elementProperties.set(i,a)}this._$Eh=new Map;for(const[s,i]of this.elementProperties){const a=this._$Eu(s,i);a!==void 0&&this._$Eh.set(a,s)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(t){const s=[];if(Array.isArray(t)){const i=new Set(t.flat(1/0).reverse());for(const a of i)s.unshift(La(a))}else t!==void 0&&s.push(La(t));return s}static _$Eu(t,s){const i=s.attribute;return i===!1?void 0:typeof i=="string"?i:typeof t=="string"?t.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise(t=>this.enableUpdating=t),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach(t=>t(this))}addController(t){(this._$EO??=new Set).add(t),this.renderRoot!==void 0&&this.isConnected&&t.hostConnected?.()}removeController(t){this._$EO?.delete(t)}_$E_(){const t=new Map,s=this.constructor.elementProperties;for(const i of s.keys())this.hasOwnProperty(i)&&(t.set(i,this[i]),delete this[i]);t.size>0&&(this._$Ep=t)}createRenderRoot(){const t=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return Gn(t,this.constructor.elementStyles),t}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this._$EO?.forEach(t=>t.hostConnected?.())}enableUpdating(t){}disconnectedCallback(){this._$EO?.forEach(t=>t.hostDisconnected?.())}attributeChangedCallback(t,s,i){this._$AK(t,i)}_$ET(t,s){const i=this.constructor.elementProperties.get(t),a=this.constructor._$Eu(t,i);if(a!==void 0&&i.reflect===!0){const n=(i.converter?.toAttribute!==void 0?i.converter:si).toAttribute(s,i.type);this._$Em=t,n==null?this.removeAttribute(a):this.setAttribute(a,n),this._$Em=null}}_$AK(t,s){const i=this.constructor,a=i._$Eh.get(t);if(a!==void 0&&this._$Em!==a){const n=i.getPropertyOptions(a),o=typeof n.converter=="function"?{fromAttribute:n.converter}:n.converter?.fromAttribute!==void 0?n.converter:si;this._$Em=a;const l=o.fromAttribute(s,n.type);this[a]=l??this._$Ej?.get(a)??l,this._$Em=null}}requestUpdate(t,s,i,a=!1,n){if(t!==void 0){const o=this.constructor;if(a===!1&&(n=this[t]),i??=o.getPropertyOptions(t),!((i.hasChanged??ba)(n,s)||i.useDefault&&i.reflect&&n===this._$Ej?.get(t)&&!this.hasAttribute(o._$Eu(t,i))))return;this.C(t,s,i)}this.isUpdatePending===!1&&(this._$ES=this._$EP())}C(t,s,{useDefault:i,reflect:a,wrapped:n},o){i&&!(this._$Ej??=new Map).has(t)&&(this._$Ej.set(t,o??s??this[t]),n!==!0||o!==void 0)||(this._$AL.has(t)||(this.hasUpdated||i||(s=void 0),this._$AL.set(t,s)),a===!0&&this._$Em!==t&&(this._$Eq??=new Set).add(t))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(s){Promise.reject(s)}const t=this.scheduleUpdate();return t!=null&&await t,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),this._$Ep){for(const[a,n]of this._$Ep)this[a]=n;this._$Ep=void 0}const i=this.constructor.elementProperties;if(i.size>0)for(const[a,n]of i){const{wrapped:o}=n,l=this[a];o!==!0||this._$AL.has(a)||l===void 0||this.C(a,void 0,n,l)}}let t=!1;const s=this._$AL;try{t=this.shouldUpdate(s),t?(this.willUpdate(s),this._$EO?.forEach(i=>i.hostUpdate?.()),this.update(s)):this._$EM()}catch(i){throw t=!1,this._$EM(),i}t&&this._$AE(s)}willUpdate(t){}_$AE(t){this._$EO?.forEach(s=>s.hostUpdated?.()),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(t)),this.updated(t)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(t){return!0}update(t){this._$Eq&&=this._$Eq.forEach(s=>this._$ET(s,this[s])),this._$EM()}updated(t){}firstUpdated(t){}};Kt.elementStyles=[],Kt.shadowRootOptions={mode:"open"},Kt[ws("elementProperties")]=new Map,Kt[ws("finalized")]=new Map,io?.({ReactiveElement:Kt}),(fi.reactiveElementVersions??=[]).push("2.1.2");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const ya=globalThis,ja=e=>e,ii=ya.trustedTypes,Fa=ii?ii.createPolicy("lit-html",{createHTML:e=>e}):void 0,Jr="$lit$",vt=`lit$${Math.random().toFixed(9).slice(2)}$`,Xr="?"+vt,ao=`<${Xr}>`,Ot=document,Ps=()=>Ot.createComment(""),Is=e=>e===null||typeof e!="object"&&typeof e!="function",$a=Array.isArray,ro=e=>$a(e)||typeof e?.[Symbol.iterator]=="function",Ei=`[ 	
\f\r]`,hs=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,Wa=/-->/g,Ua=/>/g,Et=RegExp(`>|${Ei}(?:([^\\s"'>=/]+)(${Ei}*=${Ei}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),Za=/'/g,qa=/"/g,Qr=/^(?:script|style|textarea|title)$/i,en=e=>(t,...s)=>({_$litType$:e,strings:t,values:s}),r=en(1),u=en(2),Rt=Symbol.for("lit-noChange"),d=Symbol.for("lit-nothing"),Ka=new WeakMap,Dt=Ot.createTreeWalker(Ot,129);function tn(e,t){if(!$a(e)||!e.hasOwnProperty("raw"))throw Error("invalid template strings array");return Fa!==void 0?Fa.createHTML(t):t}const no=(e,t)=>{const s=e.length-1,i=[];let a,n=t===2?"<svg>":t===3?"<math>":"",o=hs;for(let l=0;l<s;l++){const p=e[l];let h,m,g=-1,v=0;for(;v<p.length&&(o.lastIndex=v,m=o.exec(p),m!==null);)v=o.lastIndex,o===hs?m[1]==="!--"?o=Wa:m[1]!==void 0?o=Ua:m[2]!==void 0?(Qr.test(m[2])&&(a=RegExp("</"+m[2],"g")),o=Et):m[3]!==void 0&&(o=Et):o===Et?m[0]===">"?(o=a??hs,g=-1):m[1]===void 0?g=-2:(g=o.lastIndex-m[2].length,h=m[1],o=m[3]===void 0?Et:m[3]==='"'?qa:Za):o===qa||o===Za?o=Et:o===Wa||o===Ua?o=hs:(o=Et,a=void 0);const b=o===Et&&e[l+1].startsWith("/>")?" ":"";n+=o===hs?p+ao:g>=0?(i.push(h),p.slice(0,g)+Jr+p.slice(g)+vt+b):p+vt+(g===-2?l:b)}return[tn(e,n+(e[s]||"<?>")+(t===2?"</svg>":t===3?"</math>":"")),i]};class Cs{constructor({strings:t,_$litType$:s},i){let a;this.parts=[];let n=0,o=0;const l=t.length-1,p=this.parts,[h,m]=no(t,s);if(this.el=Cs.createElement(h,i),Dt.currentNode=this.el.content,s===2||s===3){const g=this.el.content.firstChild;g.replaceWith(...g.childNodes)}for(;(a=Dt.nextNode())!==null&&p.length<l;){if(a.nodeType===1){if(a.hasAttributes())for(const g of a.getAttributeNames())if(g.endsWith(Jr)){const v=m[o++],b=a.getAttribute(g).split(vt),S=/([.?@])?(.*)/.exec(v);p.push({type:1,index:n,name:S[2],strings:b,ctor:S[1]==="."?lo:S[1]==="?"?co:S[1]==="@"?po:gi}),a.removeAttribute(g)}else g.startsWith(vt)&&(p.push({type:6,index:n}),a.removeAttribute(g));if(Qr.test(a.tagName)){const g=a.textContent.split(vt),v=g.length-1;if(v>0){a.textContent=ii?ii.emptyScript:"";for(let b=0;b<v;b++)a.append(g[b],Ps()),Dt.nextNode(),p.push({type:2,index:++n});a.append(g[v],Ps())}}}else if(a.nodeType===8)if(a.data===Xr)p.push({type:2,index:n});else{let g=-1;for(;(g=a.data.indexOf(vt,g+1))!==-1;)p.push({type:7,index:n}),g+=vt.length-1}n++}}static createElement(t,s){const i=Ot.createElement("template");return i.innerHTML=t,i}}function Xt(e,t,s=e,i){if(t===Rt)return t;let a=i!==void 0?s._$Co?.[i]:s._$Cl;const n=Is(t)?void 0:t._$litDirective$;return a?.constructor!==n&&(a?._$AO?.(!1),n===void 0?a=void 0:(a=new n(e),a._$AT(e,s,i)),i!==void 0?(s._$Co??=[])[i]=a:s._$Cl=a),a!==void 0&&(t=Xt(e,a._$AS(e,t.values),a,i)),t}class oo{constructor(t,s){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=s}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){const{el:{content:s},parts:i}=this._$AD,a=(t?.creationScope??Ot).importNode(s,!0);Dt.currentNode=a;let n=Dt.nextNode(),o=0,l=0,p=i[0];for(;p!==void 0;){if(o===p.index){let h;p.type===2?h=new Bs(n,n.nextSibling,this,t):p.type===1?h=new p.ctor(n,p.name,p.strings,this,t):p.type===6&&(h=new ho(n,this,t)),this._$AV.push(h),p=i[++l]}o!==p?.index&&(n=Dt.nextNode(),o++)}return Dt.currentNode=Ot,a}p(t){let s=0;for(const i of this._$AV)i!==void 0&&(i.strings!==void 0?(i._$AI(t,i,s),s+=i.strings.length-2):i._$AI(t[s])),s++}}class Bs{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(t,s,i,a){this.type=2,this._$AH=d,this._$AN=void 0,this._$AA=t,this._$AB=s,this._$AM=i,this.options=a,this._$Cv=a?.isConnected??!0}get parentNode(){let t=this._$AA.parentNode;const s=this._$AM;return s!==void 0&&t?.nodeType===11&&(t=s.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,s=this){t=Xt(this,t,s),Is(t)?t===d||t==null||t===""?(this._$AH!==d&&this._$AR(),this._$AH=d):t!==this._$AH&&t!==Rt&&this._(t):t._$litType$!==void 0?this.$(t):t.nodeType!==void 0?this.T(t):ro(t)?this.k(t):this._(t)}O(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.O(t))}_(t){this._$AH!==d&&Is(this._$AH)?this._$AA.nextSibling.data=t:this.T(Ot.createTextNode(t)),this._$AH=t}$(t){const{values:s,_$litType$:i}=t,a=typeof i=="number"?this._$AC(t):(i.el===void 0&&(i.el=Cs.createElement(tn(i.h,i.h[0]),this.options)),i);if(this._$AH?._$AD===a)this._$AH.p(s);else{const n=new oo(a,this),o=n.u(this.options);n.p(s),this.T(o),this._$AH=n}}_$AC(t){let s=Ka.get(t.strings);return s===void 0&&Ka.set(t.strings,s=new Cs(t)),s}k(t){$a(this._$AH)||(this._$AH=[],this._$AR());const s=this._$AH;let i,a=0;for(const n of t)a===s.length?s.push(i=new Bs(this.O(Ps()),this.O(Ps()),this,this.options)):i=s[a],i._$AI(n),a++;a<s.length&&(this._$AR(i&&i._$AB.nextSibling,a),s.length=a)}_$AR(t=this._$AA.nextSibling,s){for(this._$AP?.(!1,!0,s);t!==this._$AB;){const i=ja(t).nextSibling;ja(t).remove(),t=i}}setConnected(t){this._$AM===void 0&&(this._$Cv=t,this._$AP?.(t))}}class gi{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,s,i,a,n){this.type=1,this._$AH=d,this._$AN=void 0,this.element=t,this.name=s,this._$AM=a,this.options=n,i.length>2||i[0]!==""||i[1]!==""?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=d}_$AI(t,s=this,i,a){const n=this.strings;let o=!1;if(n===void 0)t=Xt(this,t,s,0),o=!Is(t)||t!==this._$AH&&t!==Rt,o&&(this._$AH=t);else{const l=t;let p,h;for(t=n[0],p=0;p<n.length-1;p++)h=Xt(this,l[i+p],s,p),h===Rt&&(h=this._$AH[p]),o||=!Is(h)||h!==this._$AH[p],h===d?t=d:t!==d&&(t+=(h??"")+n[p+1]),this._$AH[p]=h}o&&!a&&this.j(t)}j(t){t===d?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}}class lo extends gi{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===d?void 0:t}}class co extends gi{constructor(){super(...arguments),this.type=4}j(t){this.element.toggleAttribute(this.name,!!t&&t!==d)}}class po extends gi{constructor(t,s,i,a,n){super(t,s,i,a,n),this.type=5}_$AI(t,s=this){if((t=Xt(this,t,s,0)??d)===Rt)return;const i=this._$AH,a=t===d&&i!==d||t.capture!==i.capture||t.once!==i.once||t.passive!==i.passive,n=t!==d&&(i===d||a);a&&this.element.removeEventListener(this.name,this,i),n&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,t):this._$AH.handleEvent(t)}}class ho{constructor(t,s,i){this.element=t,this.type=6,this._$AN=void 0,this._$AM=s,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(t){Xt(this,t)}}const uo=ya.litHtmlPolyfillSupport;uo?.(Cs,Bs),(ya.litHtmlVersions??=[]).push("3.3.3");const mo=(e,t,s)=>{const i=s?.renderBefore??t;let a=i._$litPart$;if(a===void 0){const n=s?.renderBefore??null;i._$litPart$=a=new Bs(t.insertBefore(Ps(),n),n,void 0,s??{})}return a._$AI(e),a};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const xa=globalThis;let z=class extends Kt{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){const t=super.createRenderRoot();return this.renderOptions.renderBefore??=t.firstChild,t}update(t){const s=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=mo(s,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return Rt}};z._$litElement$=!0,z.finalized=!0,xa.litElementHydrateSupport?.({LitElement:z});const fo=xa.litElementPolyfillSupport;fo?.({LitElement:z});(xa.litElementVersions??=[]).push("4.2.2");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 */const ft=yo(class extends $o{constructor(e){if(super(e),e.type!==bo.ATTRIBUTE||e.name!=="class"||e.strings?.length>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(e){return" "+Object.keys(e).filter(t=>e[t]).join(" ")+" "}update(e,[t]){if(this.st===void 0){this.st=new Set,e.strings!==void 0&&(this.nt=new Set(e.strings.join(" ").split(/\s/).filter(i=>i!=="")));for(const i in t)t[i]&&!this.nt?.has(i)&&this.st.add(i);return this.render(t)}const s=e.element.classList;for(const i of this.st)i in t||(s.remove(i),this.st.delete(i));for(const i in t){const a=!!t[i];a===this.st.has(i)||this.nt?.has(i)||(a?(s.add(i),this.st.add(i)):(s.remove(i),this.st.delete(i)))}return Rt}});var xo=Object.defineProperty,ko=Object.getOwnPropertyDescriptor,wi=(e,t,s,i)=>{for(var a=i>1?void 0:i?ko(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&xo(t,s,a),a};const Ga={live:u`<circle cx="12" cy="12" r="3"/><path d="M6.3 6.3a8 8 0 0 0 0 11.4M17.7 6.3a8 8 0 0 1 0 11.4M3.5 3.5a12 12 0 0 0 0 17M20.5 3.5a12 12 0 0 1 0 17"/>`,explore:u`<path d="M3 6.5 9 4l6 2.5 6-2.5v13.5L15 20l-6-2.5L3 20z"/><path d="M9 4v13.5M15 6.5V20"/>`,investigate:u`<circle cx="11" cy="11" r="6.5"/><path d="m20 20-4.3-4.3M11 8v3l2 1.5"/>`,system:u`<circle cx="12" cy="12" r="3"/><path d="M19.4 15a1.7 1.7 0 0 0 .3 1.8l.1.1a2 2 0 1 1-2.8 2.8l-.1-.1a1.7 1.7 0 0 0-1.8-.3 1.7 1.7 0 0 0-1 1.5V21a2 2 0 1 1-4 0v-.1a1.7 1.7 0 0 0-1.1-1.5 1.7 1.7 0 0 0-1.8.3l-.1.1a2 2 0 1 1-2.8-2.8l.1-.1a1.7 1.7 0 0 0 .3-1.8 1.7 1.7 0 0 0-1.5-1H3a2 2 0 1 1 0-4h.1a1.7 1.7 0 0 0 1.5-1.1 1.7 1.7 0 0 0-.3-1.8l-.1-.1a2 2 0 1 1 2.8-2.8l.1.1a1.7 1.7 0 0 0 1.8.3H9a1.7 1.7 0 0 0 1-1.5V3a2 2 0 1 1 4 0v.1a1.7 1.7 0 0 0 1 1.5 1.7 1.7 0 0 0 1.8-.3l.1-.1a2 2 0 1 1 2.8 2.8l-.1.1a1.7 1.7 0 0 0-.3 1.8V9a1.7 1.7 0 0 0 1.5 1H21a2 2 0 1 1 0 4h-.1a1.7 1.7 0 0 0-1.5 1z"/>`,camera:u`<path d="M3 8.5A1.5 1.5 0 0 1 4.5 7H8l1.5-2h5L16 7h3.5A1.5 1.5 0 0 1 21 8.5v9a1.5 1.5 0 0 1-1.5 1.5h-15A1.5 1.5 0 0 1 3 17.5z"/><circle cx="12" cy="13" r="3.5"/>`,search:u`<circle cx="11" cy="11" r="6.5"/><path d="m20 20-4.3-4.3"/>`,bell:u`<path d="M6 16V11a6 6 0 0 1 12 0v5l1.5 2h-15z"/><path d="M10 20a2 2 0 0 0 4 0"/>`,user:u`<circle cx="12" cy="8" r="4"/><path d="M4 21a8 8 0 0 1 16 0"/>`,play:u`<path d="M7 5v14l11-7z"/>`,expand:u`<path d="M15 4h5v5M9 20H4v-5M20 4l-6 6M4 20l6-6"/>`,close:u`<path d="M6 6l12 12M18 6 6 18"/>`,chevron:u`<path d="m9 6 6 6-6 6"/>`,chevronBack:u`<path d="m15 6-6 6 6 6"/>`,warning:u`<path d="M12 3 2.5 20h19z"/><path d="M12 9v5M12 17h.01"/>`,info:u`<circle cx="12" cy="12" r="9"/><path d="M12 11v5M12 8h.01"/>`,lock:u`<rect x="5" y="11" width="14" height="10" rx="2"/><path d="M8 11V7a4 4 0 0 1 8 0v4"/>`,unlock:u`<rect x="5" y="11" width="14" height="10" rx="2"/><path d="M8 11V7a4 4 0 0 1 7.5-2"/>`,offline:u`<path d="M2 8.5a15 15 0 0 1 20 0M5.5 12a10 10 0 0 1 13 0M9 15.5a5 5 0 0 1 6 0"/><path d="M12 19h.01"/><path d="M3 3l18 18"/>`,refresh:u`<path d="M20 12a8 8 0 1 1-2.3-5.7"/><path d="M20 4v5h-5"/>`,layers:u`<path d="m12 3 9 5-9 5-9-5z"/><path d="m3 13 9 5 9-5M3 17.5l9 5 9-5"/>`,floor:u`<path d="M4 6h16M4 12h16M4 18h16"/><path d="M8 3v18"/>`,plus:u`<path d="M12 5v14M5 12h14"/>`,minus:u`<path d="M5 12h14"/>`,fit:u`<path d="M4 9V4h5M20 9V4h-5M4 15v5h5M20 15v5h-5"/>`,door:u`<rect x="6" y="3" width="12" height="18" rx="1"/><path d="M14 12h.01"/>`,light:u`<path d="M9 18h6M10 21h4"/><path d="M12 3a6 6 0 0 0-3.5 10.9c.8.6 1.5 1.6 1.5 2.6h4c0-1 .7-2 1.5-2.6A6 6 0 0 0 12 3z"/>`,sensor:u`<circle cx="12" cy="12" r="2"/><path d="M7.8 7.8a6 6 0 0 0 0 8.4M16.2 7.8a6 6 0 0 1 0 8.4M4.9 4.9a10 10 0 0 0 0 14.2M19.1 4.9a10 10 0 0 1 0 14.2"/>`,check:u`<path d="m5 12 5 5 9-10"/>`,clock:u`<circle cx="12" cy="12" r="9"/><path d="M12 7v5l3 2"/>`,download:u`<path d="M12 4v11M7 10l5 5 5-5M4 20h16"/>`,pin:u`<path d="M9 4h6l-1 6 3 3v2H7v-2l3-3z"/><path d="M12 15v6"/>`,more:u`<circle cx="6" cy="12" r="1.3"/><circle cx="12" cy="12" r="1.3"/><circle cx="18" cy="12" r="1.3"/>`,building:u`<rect x="4" y="3" width="16" height="18" rx="1"/><path d="M9 7h2M13 7h2M9 11h2M13 11h2M9 15h2M13 15h2M10 21v-3h4v3"/>`,map:u`<path d="M3 6.5 9 4l6 2.5 6-2.5v13.5L15 20l-6-2.5L3 20z"/>`,upload:u`<path d="M12 16V5M7 10l5-5 5 5M4 20h16"/>`,list:u`<path d="M8 6h13M8 12h13M8 18h13M3 6h.01M3 12h.01M3 18h.01"/>`,history:u`<path d="M3 12a9 9 0 1 0 3-6.7"/><path d="M3 4v5h5M12 8v4l3 2"/>`,target:u`<circle cx="12" cy="12" r="8"/><circle cx="12" cy="12" r="3"/><path d="M12 2v4M12 18v4M2 12h4M18 12h4"/>`,filter:u`<path d="M4 5h16l-6 8v6l-4-2v-4z"/>`,users:u`<circle cx="9" cy="8" r="3.5"/><path d="M2.5 20a6.5 6.5 0 0 1 13 0"/><circle cx="17" cy="9" r="2.5"/><path d="M15.5 14.5A5 5 0 0 1 21.5 20"/>`,shield:u`<path d="M12 3 4 6v6c0 4.5 3.4 7.7 8 9 4.6-1.3 8-4.5 8-9V6z"/><path d="m9 12 2 2 4-4"/>`,storage:u`<rect x="3" y="4" width="18" height="6" rx="1.5"/><rect x="3" y="14" width="18" height="6" rx="1.5"/><path d="M7 7h.01M7 17h.01"/>`,edit:u`<path d="M4 20h4l10.5-10.5a2 2 0 0 0 0-2.8l-1.2-1.2a2 2 0 0 0-2.8 0L4 16z"/><path d="m13 7 4 4"/>`,pause:u`<path d="M8 5v14M16 5v14"/>`,skip:u`<path d="M5 5v14l8-7zM15 5h2v14h-2z"/>`,case:u`<rect x="3" y="7" width="18" height="13" rx="2"/><path d="M8 7V5a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2M3 12h18"/>`,rule:u`<path d="M4 6h10M4 12h16M4 18h7"/><circle cx="18" cy="6" r="2"/><circle cx="15" cy="18" r="2"/>`,link:u`<path d="M10 14a4 4 0 0 0 5.7 0l3-3a4 4 0 0 0-5.7-5.7l-1 1"/><path d="M14 10a4 4 0 0 0-5.7 0l-3 3a4 4 0 0 0 5.7 5.7l1-1"/>`,grid:u`<rect x="3" y="3" width="7" height="7" rx="1.5"/><rect x="14" y="3" width="7" height="7" rx="1.5"/><rect x="3" y="14" width="7" height="7" rx="1.5"/><rect x="14" y="14" width="7" height="7" rx="1.5"/>`,dashboard:u`<rect x="3" y="3" width="8" height="10" rx="1.5"/><rect x="13" y="3" width="8" height="6" rx="1.5"/><rect x="13" y="11" width="8" height="10" rx="1.5"/><rect x="3" y="15" width="8" height="6" rx="1.5"/>`,home:u`<path d="M3 11 12 4l9 7"/><path d="M5 10v10h14V10"/><path d="M10 20v-6h4v6"/>`,star:u`<path d="m12 3 2.8 5.7 6.2.9-4.5 4.4 1 6.2-5.5-2.9L6.5 20.2l1-6.2L3 9.6l6.2-.9z"/>`,aperture:u`<circle cx="12" cy="12" r="9"/><path d="m14.3 4.5-5 8.6M20.7 9.5H10.8M18.4 17.5l-5-8.6M9.7 19.5l5-8.6M3.3 14.5h9.9M5.6 6.5l5 8.6"/>`,volume:u`<path d="M4 9.5v5h3.5L12 18.5v-13L7.5 9.5z"/><path d="M15.5 8.5a5 5 0 0 1 0 7M18.5 5.5a9 9 0 0 1 0 13"/>`,mic:u`<rect x="9" y="3" width="6" height="11" rx="3"/><path d="M5.5 11a6.5 6.5 0 0 0 13 0M12 17.5V21M9 21h6"/>`,back10:u`<path d="M4 12a8 8 0 1 0 2.3-5.7"/><path d="M4 4v5h5"/><path d="M10.5 15.5V10l-1.5 1"/><rect x="13.5" y="10" width="3.5" height="5.5" rx="1.7"/>`,forward10:u`<path d="M20 12a8 8 0 1 1-2.3-5.7"/><path d="M20 4v5h-5"/><path d="M10.5 15.5V10l-1.5 1"/><rect x="13.5" y="10" width="3.5" height="5.5" rx="1.7"/>`,chevronDown:u`<path d="m6 9 6 6 6-6"/>`,stairs:u`<path d="M3 20h4v-4h4v-4h4V8h5"/>`,wall:u`<path d="M3 5h18v4H3zM3 15h18v4H3zM8 9v6M16 9v6"/>`,ruler:u`<path d="M3 16 16 3l5 5L8 21z"/><path d="m7 12 2 2M10 9l2 2M13 6l2 2"/>`,scale:u`<path d="M4 20h16M4 20V8M20 20V8M4 8l8-4 8 4M8 14h8"/>`,elevator:u`<rect x="4" y="3" width="16" height="18" rx="1.5"/><path d="M12 3v18M8 10l1.5-2 1.5 2M14.5 14l1.5 2 1.5-2"/>`,menu:u`<path d="M4 7h16M4 12h16M4 17h16"/>`,calendar:u`<rect x="3" y="5" width="18" height="16" rx="2"/><path d="M3 10h18M8 3v4M16 3v4"/>`,trash:u`<path d="M4 7h16M9 7V4h6v3M6 7l1 13h10l1-13"/>`,eye:u`<path d="M2 12s3.5-6 10-6 10 6 10 6-3.5 6-10 6S2 12 2 12z"/><circle cx="12" cy="12" r="3"/>`,cpu:u`<rect x="6" y="6" width="12" height="12" rx="2"/><rect x="9" y="9" width="6" height="6"/><path d="M9 2v4M15 2v4M9 18v4M15 18v4M2 9h4M2 15h4M18 9h4M18 15h4"/>`,activity:u`<path d="M3 12h4l3-8 4 16 3-8h4"/>`,image:u`<rect x="3" y="4" width="18" height="16" rx="2"/><circle cx="8.5" cy="9.5" r="1.5"/><path d="m21 16-5-5-9 9"/>`,wifi:u`<path d="M2 8.5a15 15 0 0 1 20 0M5.5 12a10 10 0 0 1 13 0M9 15.5a5 5 0 0 1 6 0"/><path d="M12 19h.01"/>`,signal:u`<path d="M4 18v-3M9 18v-7M14 18V7M19 18V4"/>`,move:u`<path d="M12 3v18M3 12h18M8 7l4-4 4 4M8 17l4 4 4-4M7 8l-4 4 4 4M17 8l4 4-4 4"/>`,bookmark:u`<path d="M6 3h12v18l-6-4-6 4z"/>`,route:u`<circle cx="6" cy="18" r="2.5"/><circle cx="18" cy="6" r="2.5"/><path d="M8 17c5-1 3-9 8-10"/>`,logout:u`<path d="M10 4H5v16h5M14 8l4 4-4 4M18 12H9"/>`};let Qt=class extends z{constructor(){super(...arguments),this.name="info",this.size=20,this.flip=!1}render(){this.style.setProperty("--sw-icon-size",`${this.size}px`);const e=this.name==="chevron"||this.name==="chevronBack";return r`<svg viewBox="0 0 24 24" aria-hidden="true" ?data-dir=${e}>${Ga[this.name]??Ga.info}</svg>`}};Qt.styles=M`
  ...
  `;wi([f()],Qt.prototype,"name",2);wi([f({type:Number})],Qt.prototype,"size",2);wi([f({type:Boolean,reflect:!0})],Qt.prototype,"flip",2);Qt=wi([E("sw-icon")],Qt);var _o=Object.defineProperty,zo=Object.getOwnPropertyDescriptor,ht=(e,t,s,i)=>{for(var a=i>1?void 0:i?zo(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&_o(t,s,a),a};let Ue=class extends z{constructor(){super(...arguments),this.variant="secondary",this.size="md",this.disabled=!1,this.iconOnly=!1,this.round=!1,this.label="",this.type="button"}render(){return r`
  ...
  `;vi([f({reflect:!0})],es.prototype,"kind",2);vi([f()],es.prototype,"label",2);vi([f({type:Boolean,reflect:!0})],es.prototype,"onImage",2);es=vi([E("sw-badge")],es);var Po=Object.defineProperty,Io=Object.getOwnPropertyDescriptor,Ls=(e,t,s,i)=>{for(var a=i>1?void 0:i?Io(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&Po(t,s,a),a};let Nt=class extends z{constructor(){super(...arguments),this.items=[],this.active="",this.segmented=!1,this.underline=!1}choose(e){this.active=e.id,this.dispatchEvent(new CustomEvent("change",{detail:{id:e.id},bubbles:!0,composed:!0}))}render(){return r`${this.items.map(e=>e.href?r`<a href=${e.href} class=${e.id===this.active?"on":""} aria-current=${e.id===this.active?"page":"false"}>${e.label}${e.count!==void 0?r`<span class="count">(${e.count})</span>`:""}</a>`:r`<button type="button" class=${e.id===this.active?"on":""} aria-pressed=${e.id===this.active} @click=${()=>this.choose(e)}>${e.label}${e.count!==void 0?r`<span class="count">(${e.count})</span>`:""}</button>`)}`}};Nt.styles=M`
    :host {
      display: inline-flex;
      gap: 2px;
      overflow-x: auto;
  ...
  `;Ls([f({attribute:!1})],Nt.prototype,"items",2);Ls([f()],Nt.prototype,"active",2);Ls([f({type:Boolean,reflect:!0})],Nt.prototype,"segmented",2);Ls([f({type:Boolean,reflect:!0})],Nt.prototype,"underline",2);Nt=Ls([E("sw-tabs")],Nt);var Co=Object.defineProperty,Do=Object.getOwnPropertyDescriptor,ka=(e,t,s,i)=>{for(var a=i>1?void 0:i?Do(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&Co(t,s,a),a};let Ds=class extends z{constructor(){super(...arguments),this.name="",this.size=32}render(){this.style.setProperty("--sz",`${this.size}px`);const e=this.name.trim().split(/\s+/),t=e.length>1?e[0][0]+e[1][0]:this.name.slice(0,2);return r`${t}`}};Ds.styles=M`
    :host {
      display: inline-grid;
      place-items: center;
  ...
  `;ka([f()],Ds.prototype,"name",2);ka([f({type:Number})],Ds.prototype,"size",2);Ds=ka([E("sw-avatar")],Ds);var To=Object.defineProperty,Oo=Object.getOwnPropertyDescriptor,Vs=(e,t,s,i)=>{for(var a=i>1?void 0:i?Oo(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&To(t,s,a),a};let Bt=class extends z{constructor(){super(...arguments),this.selected=!1,this.dot=""}render(){return r`
  ...
  `;Vs([f({type:Boolean,reflect:!0})],Bt.prototype,"selected",2);Vs([f()],Bt.prototype,"icon",2);Vs([f({type:Number})],Bt.prototype,"count",2);Vs([f()],Bt.prototype,"dot",2);Bt=Vs([E("sw-chip")],Bt);var Ro=Object.defineProperty,No=Object.getOwnPropertyDescriptor,bi=(e,t,s,i)=>{for(var a=i>1?void 0:i?No(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&Ro(t,s,a),a};let ts=class extends z{constructor(){super(...arguments),this.open=!1,this.heading="",this.subheading=""}close(){this.open=!1,this.dispatchEvent(new CustomEvent("close",{bubbles:!0,composed:!0}))}render(){return r`
      <aside class="panel" role="dialog" aria-modal="false" aria-label=${this.heading} ?hidden=${!this.open}>
        ...
        <header>
          ...
          <sw-button variant="ghost" size="sm" iconOnly icon="close" label=${x("actions.close")} @click=${this.close}></sw-button>
        </header>
  ...
  `;os([f()],yt.prototype,"heading",2);os([f({type:Number})],yt.prototype,"x",2);os([f({type:Number})],yt.prototype,"y",2);os([f({type:Number})],yt.prototype,"stageWidth",2);os([f({type:Number})],yt.prototype,"stageHeight",2);yt=os([E("sw-popover")],yt);var Vo=Object.defineProperty,Ho=Object.getOwnPropertyDescriptor,yi=(e,t,s,i)=>{for(var a=i>1?void 0:i?Ho(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&Vo(t,s,a),a};let ss=class extends z{constructor(){super(...arguments),this.label="",this.hint="",this.inline=!1}render(){return r`
  ...
  `;yi([f()],ss.prototype,"label",2);yi([f()],ss.prototype,"hint",2);yi([f({type:Boolean,reflect:!0})],ss.prototype,"inline",2);ss=yi([E("sw-field")],ss);var jo=Object.defineProperty,Fo=Object.getOwnPropertyDescriptor,sn=(e,t,s,i)=>{for(var a=i>1?void 0:i?Fo(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&jo(t,s,a),a};let Wo=0,ai=class extends z{constructor(){super(...arguments),this.kind="lobby",this.uid=`sc${Wo+=1}`}grad(e,t,s=!0){const i=`${e}-${this.uid}`;return u`<linearGradient id=${i} x1="0" y1="0" x2=${s?0:1} y2=${s?1:0}>${t.map(([a,n])=>u`<stop offset=${a} stop-color=${n} />`)}</linearGradient>`}url(e){return`url(#${e}-${this.uid})`}vignette(){const e=`vig-${this.uid}`;return u`<defs><radialGradient id=${e} cx="50%" cy="45%" r="72%"><stop offset="0.55" stop-color="#000" stop-opacity="0" /><stop offset="1" stop-color="#000" stop-opacity="0.38" /></radialGradient></defs><rect width="320" height="180" fill=${`url(#${e})`} />`}entrance(){return u`
  ...
  `;xe([f()],me.prototype,"cameraId",2);xe([f()],me.prototype,"profile",2);xe([f()],me.prototype,"mode",2);xe([f()],me.prototype,"poster",2);xe([f({type:Boolean})],me.prototype,"active",2);xe([f({type:Boolean,reflect:!0})],me.prototype,"compact",2);xe([f()],me.prototype,"wsUrl",2);xe([f({type:Boolean})],me.prototype,"retry",2);xe([f({type:Boolean})],me.prototype,"recorded",2);xe([c()],me.prototype,"status",2);xe([c()],me.prototype,"transport",2);xe([c()],me.prototype,"error",2);xe([c()],me.prototype,"muted",2);xe([ns("video")],me.prototype,"video",2);me=xe([E("sw-live-player")],me);var ll=Object.defineProperty,dl=Object.getOwnPropertyDescriptor,ke=(e,t,s,i)=>{for(var a=i>1?void 0:i?dl(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&ll(t,s,a),a};let fe=class extends z{constructor(){super(...arguments),this.name="",this.meta="",this.state="unknown",this.scene="lobby",this.selected=!1,this.compact=!1,this.dark=!1,this.noDemo=!1,this.stamp="",this.poster="",this.cameraId="",this.live=!1,this.profile="sub",this.transport="auto"}offMessage(){return this.state==="forbidden"?"אין הרשאת צפייה":this.state==="offline"?"המצלמה מנותקת":"מצב לא ידוע"}render(){if(this.state==="offline"||this.state==="forbidden"||this.state==="unknown")return r`<div class="off">
  ...
  `;ke([f()],fe.prototype,"name",2);ke([f()],fe.prototype,"meta",2);ke([f({reflect:!0})],fe.prototype,"state",2);ke([f({reflect:!0})],fe.prototype,"scene",2);ke([f({type:Boolean,reflect:!0})],fe.prototype,"selected",2);ke([f({type:Boolean,reflect:!0})],fe.prototype,"compact",2);ke([f({type:Boolean,reflect:!0})],fe.prototype,"dark",2);ke([f({type:Boolean,reflect:!0})],fe.prototype,"noDemo",2);ke([f()],fe.prototype,"stamp",2);ke([f()],fe.prototype,"poster",2);ke([f()],fe.prototype,"cameraId",2);ke([f({type:Boolean})],fe.prototype,"live",2);ke([f()],fe.prototype,"profile",2);ke([f()],fe.prototype,"transport",2);fe=ke([E("sw-camera-tile")],fe);var cl=Object.defineProperty,pl=Object.getOwnPropertyDescriptor,ls=(e,t,s,i)=>{for(var a=i>1?void 0:i?pl(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&cl(t,s,a),a};const hl={loading:{icon:"clock",title:()=>x("states.loading"),hint:()=>"",tone:"neutral"},empty:{icon:"map",title:()=>x("states.empty"),hint:()=>"",tone:"neutral"},error:{icon:"warning",title:()=>x("states.error"),hint:()=>x("states.errorHint"),tone:"danger"},forbidden:{icon:"lock",title:()=>x("states.forbidden"),hint:()=>x("states.forbiddenHint"),tone:"forbidden"},stale:{icon:"offline",title:()=>x("states.stale"),hint:()=>x("states.staleHint"),tone:"stale"},partial:{icon:"info",title:()=>x("states.partial"),hint:()=>"",tone:"stale"}};let $t=class extends z{constructor(){super(...arguments),this.state="empty",this.heading="",this.hint="",this.actionLabel="",this.compact=!1}render(){const e=this.state==="error"&&/אין (לך )?הרשא/.test(this.hint),t=hl[e?"forbidden":this.state],s=this.hint||t.hint();return r`
  ...
  `;ls([f({reflect:!0})],$t.prototype,"state",2);ls([f()],$t.prototype,"heading",2);ls([f()],$t.prototype,"hint",2);ls([f()],$t.prototype,"actionLabel",2);ls([f({type:Boolean,reflect:!0})],$t.prototype,"compact",2);$t=ls([E("sw-state-panel")],$t);var ul=Object.defineProperty,ml=Object.getOwnPropertyDescriptor,xi=(e,t,s,i)=>{for(var a=i>1?void 0:i?ml(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&ul(t,s,a),a};let is=class extends z{constructor(){super(...arguments),this.open=!1,this.heading="",this.subheading="",this.onKey=e=>{e.key==="Escape"&&this.open&&this.close()}}close(){this.open=!1,this.dispatchEvent(new CustomEvent("close",{bubbles:!0,composed:!0}))}updated(e){!e.has("open")||!this.open||requestAnimationFrame(()=>{const t=i=>{for(const a of i.querySelectorAll("[autofocus], input, textarea, select, sw-button, button"))if(!(a.hasAttribute("disabled")||a.type==="hidden"||a.slot==="footer"))return a.tagName==="SW-BUTTON"?a.shadowRoot?.querySelector("button")??a:a;for(const a of i.querySelectorAll("*")){const n=a.shadowRoot&&t(a.shadowRoot);if(n)return n}return null},s=t(this)??this.renderRoot.querySelector(".box");s&&(!s.hasAttribute("tabindex")&&!s.matches("input, textarea, select, button, a[href]")&&s.setAttribute("tabindex","-1"),s.focus({preventScroll:!0}))})}connectedCallback(){super.connectedCallback(),window.addEventListener("keydown",this.onKey)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("keydown",this.onKey)}render(){return r`<div class="backdrop" @click=${e=>e.target===e.currentTarget&&this.close()}>
  ...
  `;xi([f({type:Boolean,reflect:!0})],is.prototype,"open",2);xi([f()],is.prototype,"heading",2);xi([f()],is.prototype,"subheading",2);is=xi([E("sw-dialog")],is);const fl="L0",nn=.2,gl=.006,wl={door:{width_m:.9,height_m:2.1,sill_m:0},window:{width_m:1.2,height_m:1.2,sill_m:.9},passage:{width_m:1,height_m:2.1,sill_m:0}},bt=e=>Math.floor(e*100+.5)/100,he=e=>[bt(e[0]),bt(e[1])],Ai=(e,t)=>e.id<t.id?-1:e.id>t.id?1:0,Ya=e=>Math.min(1,Math.max(0,e));function vs(e){const t=e.dimensions,s=t.scale_m_per_px,i=t.calibration?.status;return typeof s=="number"&&Number.isFinite(s)&&s>0&&(i==="measured"||i==="estimated")?{scale:s,estimated:i==="estimated"}:{scale:nn/(gl*(t.width_px||1e3)),estimated:!0}}function _a(e){const t=[0];for(let s=1;s<e.length;s++)t.push(t[s-1]+Math.hypot(e[s][0]-e[s-1][0],e[s][1]-e[s-1][1]));return t}function ri(e,t,s){let i=0;for(;i<e.length-2&&s>t[i+1];)i++;const[a,n]=e[i],[o,l]=e[i+1],p=t[i+1]-t[i];if(p<=1e-9)return{p:[a,n],d:[1,0]};const h=Math.min(1,Math.max(0,(s-t[i])/p));return{p:[a+(o-a)*h,n+(l-n)*h],d:[(o-a)/p,(l-n)/p]}}function vl(e,t,s,i){const a=[];for(let n=1;n<e.length-1;n++)s<t[n]&&t[n]<i&&a.push(e[n]);return[ri(e,t,s).p,...a,ri(e,t,i).p]}const Ja=(e,t,s)=>{const i=e[0]-t[0],a=e[1]-t[1],n=Math.hypot(i,a);return n<1e-9?e:[e[0]+i/n*s,e[1]+a/n*s]},We=(e,t,s)=>[e[0]+t[0]*s,e[1]+t[1]*s],Xa=(e,t,s)=>(t[0]-e[0])*(s[1]-e[1])-(t[1]-e[1])*(s[0]-e[0])>0?1:0;function bl(e,t,s,i,a){const n=[s[1],-s[0]],o=[-s[1],s[0]],l=i.swing||"right";if(l==="none")return{leaves:[],arcs:[]};if(l==="sliding"){const v=a*.12;return{leaves:[[he(We(e,n,v)),he(We(t,n,v))]],arcs:[]}}if(l==="double"){const v=a/2,b=[],S=[],N=[[e,s],[t,[-s[0],-s[1]]]];for(const[q,_]of N){const I=We(q,n,v),Q=We(q,_,v);b.push([he(q),he(I)]),S.push({from:he(I),to:he(Q),r:bt(v),sweep:Xa(q,I,Q)})}return{leaves:b,arcs:S}}const p=l==="left"?n:o,[h,m]=(i.hinge||"start")==="start"?[e,t]:[t,e],g=We(h,p,a);return{leaves:[[he(h),he(g)]],arcs:[{from:he(g),to:he(m),r:bt(a),sweep:Xa(h,g,m)}]}}function yl(e,t,s,i=null){const{scale:a}=vs(e),n=1/a,o=new Map;for(const h of e.openings){const m=o.get(h.wall_id);m?m.push(h):o.set(h.wall_id,[h])}const l=[],p=new Map;for(const h of[...new Map(e.walls.map(m=>[m.id,m])).values()].sort(Ai)){if(i!==null&&h.level_id!==i)continue;const m=h.polyline.map(I=>[I[0]*t,I[1]*s]),g=_a(m),v=g[g.length-1];if(v<=1e-6)continue;const b=Math.max(1,(h.thickness_m||nn)*n);p.set(h.id,{pts:m,cum:g,wpx:b});const S=(o.get(h.id)??[]).map(I=>{const Q=(I.t||0)*v,ye=(I.width_m||0)*n/2;return[Math.max(0,Q-ye),Math.min(v,Q+ye)]});S.sort((I,Q)=>I[0]-Q[0]||I[1]-Q[1]);const N=[];let q=0;for(const[I,Q]of S)I>q&&N.push([q,I]),q=Math.max(q,Q);q<v&&N.push([q,v]);let _=0;for(const[I,Q]of N){if(Q-I<=.01)continue;const ye=vl(m,g,I,Q);I<=0&&(ye[0]=Ja(ye[0],ye[1],b/2)),Q>=v&&(ye[ye.length-1]=Ja(ye[ye.length-1],ye[ye.length-2],b/2)),l.push({kind:"wall",id:h.id,part:_,points:ye.map(he),width:bt(b)}),_+=1}}for(const h of[...e.openings].sort(Ai)){const m=p.get(h.wall_id);if(!m)continue;const{p:g,d:v}=ri(m.pts,m.cum,(h.t||0)*m.cum[m.cum.length-1]),b=(h.width_m||0)*n,S=We(g,v,-b/2),N=We(g,v,b/2),q=[he(S),he(N)];if(h.kind==="door")l.push({kind:"door",id:h.id,gap:q,...bl(S,N,v,h,b)});else if(h.kind==="window"){const _=[v[1],-v[0]],I=m.wpx/4;l.push({kind:"window",id:h.id,gap:q,lines:[[he(We(S,_,I)),he(We(N,_,I))],[he(We(S,_,-I)),he(We(N,_,-I))]]})}else l.push({kind:"passage",id:h.id,gap:q})}for(const h of[...e.labels].sort(Ai))i!==null&&h.level_id!==i||l.push({kind:"label",id:h.id,x:bt(h.position[0]*t),y:bt(h.position[1]*s),text:String(h.text??""),size:bt(h.size||14)});return l}function za(e,t,s){let i=0;for(let a=1;a<e.length;a++)i+=Math.hypot((e[a][0]-e[a-1][0])*t,(e[a][1]-e[a-1][1])*s);return i}function $l(e,t,s,i,a){return Math.hypot((t[0]-e[0])*s,(t[1]-e[1])*i)*a}function xl(e,t,s,i){let a=0;for(let n=0;n<e.length;n++){const[o,l]=e[n],[p,h]=e[(n+1)%e.length];a+=o*t*(h*s)-p*t*(l*s)}return Math.abs(a)/2*i*i}function kl(e,t,s,i){return za([...e,e[0]],t,s)*i}function Pi(e,t,s,i,a,n){const o=[e[0]*s,e[1]*i];let l=null;for(const p of t){if(n&&p.id!==n)continue;const h=p.polyline.map(v=>[v[0]*s,v[1]*i]),m=_a(h),g=m[m.length-1];if(!(g<=1e-6))for(let v=0;v<h.length-1;v++){const[b,S]=h[v],N=h[v+1][0]-b,q=h[v+1][1]-S,_=N*N+q*q,I=_>0?Math.max(0,Math.min(1,((o[0]-b)*N+(o[1]-S)*q)/_)):0,Q=Math.hypot(o[0]-(b+I*N),o[1]-(S+I*q));Q<=a&&(!l||Q<l.distPx)&&(l={wall:p,t:(m[v]+I*Math.sqrt(_))/g,distPx:Q})}}return l}function Qa(e,t,s,i,a,n){let o=null,l=n.tolPx;for(const b of s)for(const S of b.polyline){const N=Math.hypot((S[0]-e[0])*i,(S[1]-e[1])*a);N<=l&&(o=S,l=N)}if(o)return[o[0],o[1]];if(!t||n.free)return e;const p=(e[0]-t[0])*i,h=(e[1]-t[1])*a,m=Math.hypot(p,h);if(m<1e-9)return e;const g=Math.PI/4,v=Math.round(Math.atan2(h,p)/g)*g;return[Ya(t[0]+Math.cos(v)*m/i),Ya(t[1]+Math.sin(v)*m/a)]}function Ii(e,t,s,i){const a=e.polyline.map(l=>[l[0]*s,l[1]*i]),n=_a(a),{p:o}=ri(a,n,Math.min(1,Math.max(0,t))*n[n.length-1]);return[o[0]/s,o[1]/i]}function on(e){const t=e.length;return t>=4&&e[0][0]===e[t-1][0]&&e[0][1]===e[t-1][1]}var _l=Object.defineProperty,zl=Object.getOwnPropertyDescriptor,L=(e,t,s,i)=>{for(var a=i>1?void 0:i?zl(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&_l(t,s,a),a};const Ci=.2,Di=6,er={live:"var(--sw-accent)",recorded:"var(--sw-accent)",historic:"var(--sw-accent)",offline:"var(--sw-offline)",stale:"var(--sw-stale)",unknown:"var(--sw-unknown)",forbidden:"var(--sw-forbidden)",error:"var(--sw-danger)",neutral:"var(--sw-surface)",partial:"var(--sw-stale)"},Sl={camera:u`<path d="M-7 -4.5A1.5 1.5 0 0 1 -5.5 -6H-2l1.5-2h5L6 -6h1.5A1.5 1.5 0 0 1 9 -4.5v9A1.5 1.5 0 0 1 7.5 6h-13A1.5 1.5 0 0 1 -7 4.5z" transform="translate(-1 0) scale(0.9)"/><circle cx="-1" cy="0" r="3"/>`,lock:u`<rect x="-6" y="-2" width="12" height="9" rx="2"/><path d="M-3.5 -2v-3a3.5 3.5 0 0 1 7 0v3"/>`,light:u`<path d="M-3 6h6M-2 8.5h4"/><path d="M0 -8a5 5 0 0 0-3 9c.7.5 1.2 1.3 1.2 2.2h3.6c0-.9.5-1.7 1.2-2.2A5 5 0 0 0 0 -8z"/>`,binary_sensor:u`<circle cx="0" cy="0" r="2"/><path d="M-4.5 -4.5a6.4 6.4 0 0 0 0 9M4.5 -4.5a6.4 6.4 0 0 1 0 9"/>`};function Ml(e){let t=0,s=0,i=0;for(let a=0;a<e.length;a++){const n=e[a],o=e[(a+1)%e.length],l=n.x*o.y-o.x*n.y;t+=l,s+=(n.x+o.x)*l,i+=(n.y+o.y)*l}if(Math.abs(t)<1e-12){const a=e.length||1;return{x:e.reduce((n,o)=>n+o.x,0)/a,y:e.reduce((n,o)=>n+o.y,0)/a}}return{x:s/(3*t),y:i/(3*t)}}const tr=e=>e.map(t=>`${t[0]},${t[1]}`).join(" ");let D=class extends z{constructor(){super(...arguments),this.planWidth=1e3,this.planHeight=700,this.plan=null,this.markers=[],this.selectedId=null,this.selectedIds=[],this.dimEntities=!1,this.alwaysLabel=!1,this.imageUrl=null,this.editable=!1,this.placing=!1,this.coneRadius=140,this.zones=[],this.selectedZoneId=null,this.zoneLabels=!0,this.draftPoints=[],this.boxSelect=!1,this.geometry=null,this.structureLevel=null,this.issueIds=[],this.selectedGeomId=null,this.primCache=null,this.geomEditable=!1,this.wallDraft=[],this.hoverPoint=null,this.rulers=[],this.geomDrag=null,this.hoverFrame=0,this.hoverEvent=null,this.box=null,this.boxStart=null,this.scale=1,this.tx=0,this.ty=0,this.hoverId=null,this.dragging=null,this.orienting=null,this.shaping=null,this.zoneDraft=null,this.lastVertexPress=null,this.pointers=new Map,this.lastPan=null,this.lastPinchDist=0,this.dragMoved=!1,this.fitted=!1,this.minScale=Ci,this.onWheel=e=>{e.preventDefault();const t=this.getBoundingClientRect();this.zoomBy(e.deltaY<0?1.15:1/1.15,e.clientX-t.left,e.clientY-t.top)},this.onMarkerPointerDown=(e,t)=>{if(!this.editable||t.button!==0)return;t.stopPropagation(),t.preventDefault(),this.dragging={id:e.id,x:e.x,y:e.y},this.viewport.setPointerCapture(t.pointerId);const s=a=>{const n=this.getBoundingClientRect(),o=this.toPlan(a.clientX-n.left,a.clientY-n.top);this.dragging={id:e.id,x:o.x,y:o.y}},i=a=>{this.viewport.removeEventListener("pointermove",s),this.viewport.removeEventListener("pointerup",i),this.viewport.removeEventListener("pointercancel",i);const n=this.getBoundingClientRect(),o=this.toPlan(a.clientX-n.left,a.clientY-n.top),l=Math.abs(o.x-e.x)>5e-4||Math.abs(o.y-e.y)>5e-4;this.dragging=null,l?this.dispatchEvent(new CustomEvent("marker-move",{detail:{id:e.id,x:o.x,y:o.y},bubbles:!0,composed:!0})):this.select(e,a),this.dragMoved=!0,setTimeout(()=>this.dragMoved=!1,0)};this.viewport.addEventListener("pointermove",s),this.viewport.addEventListener("pointerup",i),this.viewport.addEventListener("pointercancel",i)},this.onPointerDown=e=>{if(this.pointers.set(e.pointerId,{x:e.clientX,y:e.clientY}),this.dragMoved=!1,this.pointers.size===1){if(this.boxSelect&&e.button===0&&!e.shiftKey&&!this.editable&&!this.placing){const t=this.getBoundingClientRect();this.boxStart={x:e.clientX-t.left,y:e.clientY-t.top},this.lastPan=null;return}this.lastPan={x:e.clientX,y:e.clientY},this.viewport.classList.add("dragging")}else this.pointers.size===2&&(this.lastPinchDist=this.pinchDistance(),this.lastPan=null,this.boxStart=null,this.box=null)},this.onPointerMove=e=>{if(this.placing&&e.pointerType!=="touch"&&this.queueHover(e),!!this.pointers.has(e.pointerId)){if(this.pointers.set(e.pointerId,{x:e.clientX,y:e.clientY}),this.pointers.size===2){const t=this.pinchDistance();if(this.lastPinchDist>0){const[s,i]=[...this.pointers.values()],a=this.getBoundingClientRect();this.zoomBy(t/this.lastPinchDist,(s.x+i.x)/2-a.left,(s.y+i.y)/2-a.top)}this.lastPinchDist=t,this.dragMoved=!0;return}if(this.boxStart){const t=this.getBoundingClientRect(),s=e.clientX-t.left,i=e.clientY-t.top;!this.dragMoved&&Math.abs(s-this.boxStart.x)+Math.abs(i-this.boxStart.y)>3&&(this.dragMoved=!0,this.viewport.hasPointerCapture(e.pointerId)||this.viewport.setPointerCapture(e.pointerId)),this.dragMoved&&(this.box={x0:Math.min(this.boxStart.x,s),y0:Math.min(this.boxStart.y,i),x1:Math.max(this.boxStart.x,s),y1:Math.max(this.boxStart.y,i)});return}if(this.lastPan){const t=e.clientX-this.lastPan.x,s=e.clientY-this.lastPan.y;!this.dragMoved&&Math.abs(t)+Math.abs(s)>2&&(this.dragMoved=!0,this.viewport.hasPointerCapture(e.pointerId)||this.viewport.setPointerCapture(e.pointerId)),this.tx+=t,this.ty+=s,this.lastPan={x:e.clientX,y:e.clientY}}}},this.onPointerUp=e=>{if(this.pointers.delete(e.pointerId),this.boxStart&&this.pointers.size===0){const t=this.box;if(this.boxStart=null,this.box=null,t&&t.x1-t.x0>=4&&t.y1-t.y0>=4){const s=this.markers.filter(i=>{const a=this.toScreen(i.x,i.y);return a.x>=t.x0&&a.x<=t.x1&&a.y>=t.y0&&a.y<=t.y1}).map(i=>i.id);this.dispatchEvent(new CustomEvent("box-select",{detail:{ids:s},bubbles:!0,composed:!0}))}}if(this.pointers.size===0)this.lastPan=null,this.viewport.classList.remove("dragging");else if(this.pointers.size===1){const[t]=[...this.pointers.values()];this.lastPan={x:t.x,y:t.y}}},this.onBackgroundClick=e=>{if(!this.dragMoved){if(this.placing){const t=this.getBoundingClientRect(),s=this.toPlan(e.clientX-t.left,e.clientY-t.top);this.dispatchEvent(new CustomEvent("plan-click",{detail:{x:+s.x.toFixed(4),y:+s.y.toFixed(4),shift:e.shiftKey},bubbles:!0,composed:!0}));return}this.dispatchEvent(new CustomEvent("marker-select",{detail:{id:null},bubbles:!0,composed:!0}))}},this.onHandlePointerDown=(e,t,s)=>{if(!this.editable||s.button!==0)return;s.stopPropagation(),s.preventDefault();const i=this.getBoundingClientRect(),a=e.rotation??0,n=e.fov??90,o=t==="left"?a+n/2:a-n/2;this.orienting={id:e.id,rotation:a,fov:n},this.viewport.setPointerCapture(s.pointerId);const l=m=>{const g=this.bearingTo(e,m.clientX-i.left,m.clientY-i.top);if(t==="dir")return{rotation:Math.round(g),fov:n};let v=t==="left"?o-g:g-o;v=(v%360+360)%360;const b=Math.max(10,Math.min(180,Math.round(v))),S=t==="left"?o-b/2:o+b/2;return{rotation:Math.round((S%360+360)%360),fov:b}},p=m=>{this.orienting={id:e.id,...l(m)}},h=m=>{this.viewport.removeEventListener("pointermove",p),this.viewport.removeEventListener("pointerup",h),this.viewport.removeEventListener("pointercancel",h);const g=l(m);this.orienting=null,this.dragMoved=!0,setTimeout(()=>this.dragMoved=!1,0),(g.rotation!==a||g.fov!==n)&&this.dispatchEvent(new CustomEvent("marker-orient",{detail:{id:e.id,...g},bubbles:!0,composed:!0}))};this.viewport.addEventListener("pointermove",p),this.viewport.addEventListener("pointerup",h),this.viewport.addEventListener("pointercancel",h)},this.onRangePointerDown=(e,t)=>{if(!this.editable||t.button!==0)return;t.stopPropagation(),t.preventDefault();const s=this.getBoundingClientRect(),i=e.radius??this.coneRadius/this.planWidth;this.shaping={id:e.id,radius:i},this.viewport.setPointerCapture(t.pointerId);const a=l=>{const p=this.toScreen(e.x,e.y),h=Math.hypot(l.clientX-s.left-p.x,l.clientY-s.top-p.y)/this.scale;return+Math.max(.02,Math.min(1,h/this.planWidth)).toFixed(4)},n=l=>this.shaping={id:e.id,radius:a(l)},o=l=>{this.viewport.removeEventListener("pointermove",n),this.viewport.removeEventListener("pointerup",o),this.viewport.removeEventListener("pointercancel",o);const p=a(l);this.shaping=null,this.dragMoved=!0,setTimeout(()=>this.dragMoved=!1,0),p!==i&&this.dispatchEvent(new CustomEvent("marker-coverage",{detail:{id:e.id,radius:p},bubbles:!0,composed:!0}))};this.viewport.addEventListener("pointermove",n),this.viewport.addEventListener("pointerup",o),this.viewport.addEventListener("pointercancel",o)},this.onCoverageVertexDown=(e,t,s)=>{if(!this.editable||s.button!==0||!e.polygon)return;s.stopPropagation(),s.preventDefault();const i=Date.now();if(this.lastVertexPress&&this.lastVertexPress.id===e.id&&this.lastVertexPress.index===t&&i-this.lastVertexPress.at<450){this.lastVertexPress=null,this.editPolygon(e,{remove:t});return}this.lastVertexPress={id:e.id,index:t,at:i};const a=this.getBoundingClientRect(),n=e.polygon.map(m=>({...m}));this.shaping={id:e.id,polygon:n},this.viewport.setPointerCapture(s.pointerId);let o=!1;const l=m=>{const g=this.toPlan(m.clientX-a.left,m.clientY-a.top),v=n.map(b=>({...b}));return v[t]={x:+Math.max(0,Math.min(1,g.x)).toFixed(4),y:+Math.max(0,Math.min(1,g.y)).toFixed(4)},v},p=m=>{o=!0,this.shaping={id:e.id,polygon:l(m)}},h=m=>{this.viewport.removeEventListener("pointermove",p),this.viewport.removeEventListener("pointerup",h),this.viewport.removeEventListener("pointercancel",h);const g=l(m);this.shaping=null,this.dragMoved=!0,setTimeout(()=>this.dragMoved=!1,0),o&&this.dispatchEvent(new CustomEvent("marker-coverage",{detail:{id:e.id,polygon:g},bubbles:!0,composed:!0}))};this.viewport.addEventListener("pointermove",p),this.viewport.addEventListener("pointerup",h),this.viewport.addEventListener("pointercancel",h)}}connectedCallback(){super.connectedCallback(),this.resizeObserver=new ResizeObserver(()=>{this.fitted||this.fit()}),this.resizeObserver.observe(this)}disconnectedCallback(){super.disconnectedCallback(),this.resizeObserver?.disconnect(),cancelAnimationFrame(this.hoverFrame),this.hoverFrame=0}updated(e){(e.has("planWidth")||e.has("planHeight"))&&(this.fitted=!1,this.fit()),(e.has("scale")||e.has("tx")||e.has("ty"))&&this.dispatchEvent(new CustomEvent("view-change",{bubbles:!0,composed:!0}))}get zoom(){return this.scale}focusMarker(e){const t=this.renderRoot.querySelector(`g.marker[data-id="${CSS.escape(e)}"]`);return t?.focus(),!!t}toScreen(e,t){return{x:this.tx+e*this.planWidth*this.scale,y:this.ty+t*this.planHeight*this.scale}}fit(){const e=this.clientWidth,t=this.clientHeight;if(!e||!t||!this.planWidth||!this.planHeight)return;const s=24,i=Math.min((e-s*2)/this.planWidth,(t-s*2)/this.planHeight);this.minScale=Math.min(Ci,i),this.scale=Math.max(this.minScale,Math.min(Di,i)),this.tx=(e-this.planWidth*this.scale)/2,this.ty=(t-this.planHeight*this.scale)/2,this.fitted=!0}centerOn(e,t){const s=this.clientWidth,i=this.clientHeight;!s||!i||(this.tx=s/2-e*this.planWidth*this.scale,this.ty=i/2-t*this.planHeight*this.scale,this.fitted=!0)}zoomToBox(e,t,s,i,a=48,n=0){const o=this.clientWidth,l=this.clientHeight;if(!o||!l||!this.planWidth||!this.planHeight)return;const p=Math.max(1e-6,s-e)*this.planWidth,h=Math.max(1e-6,i-t)*this.planHeight,m=Math.min((o-48)/this.planWidth,(l-48)/this.planHeight),g=n>0?Math.min(2.5,Math.max(m*n,m)):2.5,v=Math.max(Ci,Math.min(Di,Math.min((o-a*2)/p,(l-a*2)/h,g)));this.scale=v,this.tx=o/2-(e+s)/2*this.planWidth*v,this.ty=l/2-(t+i)/2*this.planHeight*v,this.fitted=!0}zoomBy(e,t,s){const i=this.clientWidth,a=this.clientHeight,n=t??i/2,o=s??a/2,l=Math.max(this.minScale,Math.min(Di,this.scale*e)),p=l/this.scale;this.tx=n-(n-this.tx)*p,this.ty=o-(o-this.ty)*p,this.scale=l,this.fitted=!0}toPlan(e,t){return{x:Math.min(1,Math.max(0,(e-this.tx)/this.scale/this.planWidth)),y:Math.min(1,Math.max(0,(t-this.ty)/this.scale/this.planHeight))}}pinchDistance(){const[e,t]=[...this.pointers.values()];return Math.hypot(e.x-t.x,e.y-t.y)}select(e,t){if(this.dragMoved)return;t.stopPropagation();const s=this.toScreen(e.x,e.y),i={id:e.id,sx:s.x,sy:s.y};this.dispatchEvent(new CustomEvent("marker-select",{detail:i,bubbles:!0,composed:!0}))}selectZone(e,t){this.dragMoved||this.placing||(t.stopPropagation(),this.dispatchEvent(new CustomEvent("zone-select",{detail:{id:e.id},bubbles:!0,composed:!0})))}onVertexPointerDown(e,t,s,i=!1){if(!this.editable||s.button!==0)return;if(s.stopPropagation(),s.preventDefault(),!i){const h=this.lastVertexPress,m=performance.now();if(h&&h.id===e.id&&h.index===t&&m-h.at<450){this.lastVertexPress=null,this.removeVertex(e,t,s);return}this.lastVertexPress={id:e.id,index:t,at:m}}const a=this.getBoundingClientRect();let n=e.polygon.map(h=>({x:h.x,y:h.y})),o=t;if(i){const h=n[t],m=n[(t+1)%n.length];n.splice(t+1,0,{x:+((h.x+m.x)/2).toFixed(4),y:+((h.y+m.y)/2).toFixed(4)}),o=t+1}this.zoneDraft={id:e.id,polygon:n},this.viewport.setPointerCapture(s.pointerId);const l=h=>{const m=this.toPlan(h.clientX-a.left,h.clientY-a.top);n=n.map((g,v)=>v===o?{x:+m.x.toFixed(4),y:+m.y.toFixed(4)}:g),this.zoneDraft={id:e.id,polygon:n}},p=()=>{this.viewport.removeEventListener("pointermove",l),this.viewport.removeEventListener("pointerup",p),this.viewport.removeEventListener("pointercancel",p);const h=i||n.some((m,g)=>m.x!==e.polygon[g].x||m.y!==e.polygon[g].y);this.zoneDraft=null,this.dragMoved=!0,setTimeout(()=>this.dragMoved=!1,0),h&&this.dispatchEvent(new CustomEvent("zone-edit",{detail:{id:e.id,polygon:n},bubbles:!0,composed:!0}))};this.viewport.addEventListener("pointermove",l),this.viewport.addEventListener("pointerup",p),this.viewport.addEventListener("pointercancel",p)}removeVertex(e,t,s){if(s.stopPropagation(),!this.editable||e.polygon.length<=3)return;const i=e.polygon.filter((a,n)=>n!==t);this.dispatchEvent(new CustomEvent("zone-edit",{detail:{id:e.id,polygon:i},bubbles:!0,composed:!0}))}renderZoneHandles(e,t){const s=1/this.scale,i=this.planWidth,a=this.planHeight;return u`<g class="zone-handles">
    ...
    </g>`}renderZone(e){if(e.polygon.length<3)return d;const t=1/this.scale,s=this.zoneDraft?.id===e.id?this.zoneDraft.polygon:e.polygon,i=s.map(v=>`${(v.x*this.planWidth).toFixed(1)},${(v.y*this.planHeight).toFixed(1)}`).join(" "),a=Ml(s),n=this.selectedZoneId===e.id,o=Math.max(36,e.name.length*7+18),l=s.map(v=>v.x),p=s.map(v=>v.y),h=(Math.max(...l)-Math.min(...l))*this.planWidth*this.scale,m=(Math.max(...p)-Math.min(...p))*this.planHeight*this.scale,g=n||e.candidate||h>=o+12&&m>=30;return u`
    ...
    `}renderHandles(e,t,s){const i=this.radiusOf(e),a=1/this.scale,n=(m,g)=>({x:Math.cos(D.rad(m))*g,y:Math.sin(D.rad(m))*g}),o=n(t-s/2,i),l=n(t+s/2,i),p=n(t,i*.72),h=7*a;return u`
      <line class="handle-line" x1="0" y1="0" x2=${p.x.toFixed(1)} y2=${p.y.toFixed(1)} />
      <rect class="handle" x=${(o.x-h).toFixed(1)} y=${(o.y-h).toFixed(1)} width=${(h*2).toFixed(1)} height=${(h*2).toFixed(1)} rx=${(1.5*a).toFixed(1)} role="slider" aria-label="קצה שדה ראייה" @pointerdown=${m=>this.onHandlePointerDown(e,"left",m)} @click=${m=>m.stopPropagation()} />
      <rect class="handle" x=${(l.x-h).toFixed(1)} y=${(l.y-h).toFixed(1)} width=${(h*2).toFixed(1)} height=${(h*2).toFixed(1)} rx=${(1.5*a).toFixed(1)} role="slider" aria-label="קצה שדה ראייה" @pointerdown=${m=>this.onHandlePointerDown(e,"right",m)} @click=${m=>m.stopPropagation()} />
    ...
    `}static rad(e){return(e-90)*Math.PI/180}fovPath(e,t,s){const i=D.rad(e-t/2),a=D.rad(e+t/2),n=Math.cos(i)*s,o=Math.sin(i)*s,l=Math.cos(a)*s,p=Math.sin(a)*s;return`M0 0 L${n.toFixed(1)} ${o.toFixed(1)} A${s} ${s} 0 ${t>180?1:0} 1 ${l.toFixed(1)} ${p.toFixed(1)} Z`}renderMarker(e){const t=this.dragging?.id===e.id?this.dragging:e,s=this.orienting?.id===e.id?this.orienting:null,i=s?s.rotation:e.rotation??0,a=s?s.fov:e.fov,n=t.x*this.planWidth,o=t.y*this.planHeight,l=1/this.scale,p=e.kind==="camera",h=er[e.state]??er.neutral,m=this.selectedId===e.id||this.selectedIds.includes(e.id),g=this.alwaysLabel||m||this.hoverId===e.id,v=Math.max(44,e.label.length*6.5+16),b=this.dimEntities&&!p,S=p?13:11;return u`
      <g class="marker ${e.state} ${m?"selected":""} ${b?"dimmed":""} ${this.editable?"editable":""}"
         ...
         @pointerdown=${N=>this.onMarkerPointerDown(e,N)}
         @click=${N=>this.editable?N.stopPropagation():this.select(e,N)}
         @keydown=${N=>(N.key==="Enter"||N.key===" ")&&this.select(e,N)}>
        ${p&&a&&e.state!=="forbidden"?(()=>{const N=this.polygonPath(e);return N?u`<polygon class="fov ${e.state==="offline"?"off":""}" data-cov-polygon points=${N} />`:u`<path class="fov ${e.state==="offline"?"off":""}" d=${this.fovPath(i,a,this.radiusOf(e))} />`})():d}
        ${p&&a&&this.editable&&m&&!this.dragging?this.polygonPath(e)?this.renderPolygonHandles(e):this.renderHandles(e,i,a):d}
        <g transform="scale(${l})">
          <circle class="halo" r=${S+9} />
          <circle class="pin" r=${S} fill=${h} />
          <g class="icon" transform="scale(${p?.85:.75})">${Sl[e.kind]}</g>
          ...
          ${g?u`<g transform="translate(${D.labelOffset(e.labelPos,S,v).x.toFixed(1)} ${D.labelOffset(e.labelPos,S,v).y.toFixed(1)})" data-label-pos=${e.labelPos??"auto"}>
                <rect class="lbl-bg" x=${-v/2} y="-10" width=${v} height="20" rx="6" />
                <text class="lbl" y="3.5">${e.label}</text>
              </g>`:d}
        </g>
      </g>
    `}primitives(e){const t=this.primCache;if(t&&t.doc===e&&t.w===this.planWidth&&t.h===this.planHeight&&t.level===this.structureLevel)return t.prims;const s=yl(e,this.planWidth,this.planHeight,this.structureLevel);return this.primCache={doc:e,w:this.planWidth,h:this.planHeight,level:this.structureLevel,prims:s},s}renderStructure(){const e=this.geometry;if(!e)return d;const t=1/this.scale,s=new Set(this.issueIds);return u`<g class="structure" data-structure>${this.primitives(e).map(i=>this.renderPrimitive(i,t,s))}</g>`}renderPrimitive(e,t,s){const i=`${e.id===this.selectedGeomId?"sel":""} ${s.has(e.id)?"issue":""}`;switch(e.kind){case"wall":return u`<g class="wall-g ${i}" data-wall=${e.id}><polyline class="wall" points=${tr(e.points)} stroke-width=${e.width} /></g>`;case"door":return u`<g class="opening ${i}" data-opening=${e.id} data-kind="door">
        ...
        </g>`;case"window":return u`<g class="opening ${i}" data-opening=${e.id} data-kind="window">${e.lines.map(([a,n])=>u`<line class="glass" x1=${a[0]} y1=${a[1]} x2=${n[0]} y2=${n[1]} stroke-width=${1.6*t} />`)}</g>`;case"passage":return u`<g class="opening ${i}" data-opening=${e.id} data-kind="passage"><line class="gapline" x1=${e.gap[0][0]} y1=${e.gap[0][1]} x2=${e.gap[1][0]} y2=${e.gap[1][1]} stroke-width=${t} stroke-dasharray=${`${2*t} ${3*t}`} /></g>`;case"label":return u`<text class="glabel ${i}" data-label=${e.id} x=${e.x} y=${e.y} font-size=${e.size}>${e.text}</text>`}}queueHover(e){const t=this.getBoundingClientRect(),s=this.toPlan(e.clientX-t.left,e.clientY-t.top);this.hoverEvent={x:s.x,y:s.y,shift:e.shiftKey},!this.hoverFrame&&(this.hoverFrame=requestAnimationFrame(()=>{this.hoverFrame=0;const i=this.hoverEvent;i&&this.dispatchEvent(new CustomEvent("plan-hover",{detail:i,bubbles:!0,composed:!0}))}))}pickGeom(e,t){t.stopPropagation(),!this.dragMoved&&this.dispatchEvent(new CustomEvent("geom-select",{detail:{id:e,kind:"wall"},bubbles:!0,composed:!0}))}onGeomDragStart(e,t,s,i){if(!this.geomEditable||i.button!==0)return;i.stopPropagation(),i.preventDefault();const a=this.getBoundingClientRect(),n=this.toPlan(i.clientX-a.left,i.clientY-a.top);let o=!1,l=n;this.viewport.setPointerCapture(i.pointerId);const p=v=>{const b=this.toPlan(v.clientX-a.left,v.clientY-a.top);!o&&Math.hypot((b.x-n.x)*this.planWidth,(b.y-n.y)*this.planHeight)*this.scale<3||(o=!0,l=b,this.geomDrag={x:b.x,y:b.y})},h=()=>{this.viewport.removeEventListener("pointermove",p),this.viewport.removeEventListener("pointerup",m),this.viewport.removeEventListener("pointercancel",g),this.geomDrag=null,this.dragMoved=!0,setTimeout(()=>this.dragMoved=!1,0)},m=()=>{h(),o?this.dispatchEvent(new CustomEvent("geom-drag",{detail:{kind:e,id:t,index:s,x:+l.x.toFixed(5),y:+l.y.toFixed(5)},bubbles:!0,composed:!0})):e!=="vertex"&&this.dispatchEvent(new CustomEvent("geom-select",{detail:{id:t,kind:e},bubbles:!0,composed:!0}))},g=()=>h();this.viewport.addEventListener("pointermove",p),this.viewport.addEventListener("pointerup",m),this.viewport.addEventListener("pointercancel",g)}renderGeomHits(){const e=this.geometry;if(!e||!this.geomEditable||this.placing)return d;const t=1/this.scale,s=this.planWidth,i=this.planHeight,a=e.walls.find(o=>o.id===this.selectedGeomId),n=this.geomDrag;return u`<g class="geom-hits">
      ${this.primitives(e).map(o=>o.kind==="wall"?u`<polyline class="hit" data-hit-wall=${o.id} points=${tr(o.points)} stroke-width=${Math.max(o.width,12*t)} @click=${l=>this.pickGeom(o.id,l)} />`:o.kind==="label"?u`<circle class="hit" data-hit-label=${o.id} cx=${o.x} cy=${o.y} r=${Math.max(o.size,10*t)} @pointerdown=${l=>this.onGeomDragStart("label",o.id,0,l)} @click=${l=>l.stopPropagation()} />`:u`<line class="hit" data-hit-opening=${o.id} x1=${o.gap[0][0]} y1=${o.gap[0][1]} x2=${o.gap[1][0]} y2=${o.gap[1][1]} stroke-width=${14*t} @pointerdown=${l=>this.onGeomDragStart("opening",o.id,0,l)} @click=${l=>l.stopPropagation()} />`)}
      ${a?(on(a.polyline)?a.polyline.slice(0,-1):a.polyline).map((o,l)=>u`<circle class="gvtx" data-wall-vertex=${l} cx=${o[0]*s} cy=${o[1]*i} r=${6*t} stroke-width=${1.6*t} role="slider" aria-label=${`פינת קיר ${l+1}`}
          @pointerdown=${p=>this.onGeomDragStart("vertex",a.id,l,p)} @click=${p=>p.stopPropagation()} />`):d}
      ${n?u`<circle class="gdrag" cx=${n.x*s} cy=${n.y*i} r=${5*t} stroke-width=${1.5*t} />`:d}
      ...
      ${this.rulers.map(i=>{const a=i.a[0]*t,n=i.a[1]*s,o=i.b[0]*t,l=i.b[1]*s,p=(a+o)/2,h=(n+l)/2,m=(i.label.length*7+14)*e;return u`<g class="ruler ${i.tone}" data-ruler>
          ...
          ${i.label?u`<rect x=${p-m/2} y=${h-11*e} width=${m} height=${22*e} rx=${11*e} stroke-width=${e} /><text x=${p} y=${h} font-size=${12*e}>${i.label}</text>`:d}
        </g>`})}
    </g>`}render(){return r`
      ...
      <div class="controls" role="group" aria-label="זום">
        <sw-button variant="ghost" size="sm" iconOnly icon="plus" label=${x("floor.zoomIn")} @click=${()=>this.zoomBy(1.25)}></sw-button>
        <sw-button variant="ghost" size="sm" iconOnly icon="minus" label=${x("floor.zoomOut")} @click=${()=>this.zoomBy(.8)}></sw-button>
        <sw-button variant="ghost" size="sm" iconOnly icon="fit" label=${x("floor.fit")} @click=${()=>{this.fitted=!1,this.fit()}}></sw-button>
      </div>
  ...
  `;L([f({type:Number})],D.prototype,"planWidth",2);L([f({type:Number})],D.prototype,"planHeight",2);L([f({attribute:!1})],D.prototype,"plan",2);L([f({attribute:!1})],D.prototype,"markers",2);L([f()],D.prototype,"selectedId",2);L([f({attribute:!1})],D.prototype,"selectedIds",2);L([f({type:Boolean})],D.prototype,"dimEntities",2);L([f({type:Boolean})],D.prototype,"alwaysLabel",2);L([f()],D.prototype,"imageUrl",2);L([f({type:Boolean})],D.prototype,"editable",2);L([f({type:Boolean})],D.prototype,"placing",2);L([f({type:Number})],D.prototype,"coneRadius",2);L([f({attribute:!1})],D.prototype,"zones",2);L([f()],D.prototype,"selectedZoneId",2);L([f({type:Boolean})],D.prototype,"zoneLabels",2);L([f({attribute:!1})],D.prototype,"draftPoints",2);L([f({type:Boolean})],D.prototype,"boxSelect",2);L([f({attribute:!1})],D.prototype,"geometry",2);L([f()],D.prototype,"structureLevel",2);L([f({attribute:!1})],D.prototype,"issueIds",2);L([f()],D.prototype,"selectedGeomId",2);L([f({type:Boolean})],D.prototype,"geomEditable",2);L([f({attribute:!1})],D.prototype,"wallDraft",2);L([f({attribute:!1})],D.prototype,"hoverPoint",2);L([f({attribute:!1})],D.prototype,"rulers",2);L([c()],D.prototype,"geomDrag",2);L([c()],D.prototype,"box",2);L([c()],D.prototype,"scale",2);L([c()],D.prototype,"tx",2);L([c()],D.prototype,"ty",2);L([c()],D.prototype,"hoverId",2);L([c()],D.prototype,"dragging",2);L([c()],D.prototype,"orienting",2);L([c()],D.prototype,"shaping",2);L([c()],D.prototype,"zoneDraft",2);L([ns(".viewport")],D.prototype,"viewport",2);D=L([E("sw-plan-canvas")],D);const sr={name:"אתר הדגמה",building:"מבנה א"},xt=[{id:"f0",name:"קומה 0",hasPlan:!0,planWidth:1200,planHeight:800,cameraCount:6,entityCount:4},{id:"f-1",name:"קומה 1-",hasPlan:!0,planWidth:900,planHeight:1100,cameraCount:3,entityCount:1},{id:"f-2",name:"קומה 2-",hasPlan:!1,planWidth:0,planHeight:0,cameraCount:2,entityCount:0}],bs=[{id:"cam-1",name:"כניסה ראשית",floorId:"f0",x:.09,y:.52,rotation:20,fov:70,state:"live",source:"NVR ערוץ 1"},{id:"cam-2",name:"לובי",floorId:"f0",x:.34,y:.3,rotation:120,fov:80,state:"live",source:"NVR ערוץ 2"},{id:"cam-3",name:"מסדרון מזרחי",floorId:"f0",x:.62,y:.55,rotation:180,fov:60,state:"offline",source:"NVR ערוץ 3"},{id:"cam-4",name:"אולם",floorId:"f0",x:.82,y:.22,rotation:210,fov:90,state:"live",source:"NVR ערוץ 4"},{id:"cam-5",name:"חדר מדרגות",floorId:"f0",x:.9,y:.8,rotation:250,fov:60,state:"stale",source:"NVR ערוץ 5"},{id:"cam-6",name:"חניה",floorId:"f0",x:.4,y:.86,rotation:300,fov:75,state:"forbidden",source:"NVR ערוץ 6"},{id:"cam-7",name:"מחסן",floorId:"f-1",x:.3,y:.3,rotation:45,fov:70,state:"live",source:"NVR ערוץ 7"},{id:"cam-8",name:"חדר מכונות",floorId:"f-1",x:.7,y:.6,rotation:200,fov:70,state:"live",source:"NVR ערוץ 8"},{id:"cam-9",name:"מקלט",floorId:"f-1",x:.5,y:.85,rotation:270,fov:70,state:"offline",source:"NVR ערוץ 9"}],Qs=[{id:"lock.main_door",name:"דלת כניסה",floorId:"f0",x:.05,y:.4,domain:"lock",state:"locked",stateLabelKey:"entity.locked",controllable:!1,lastChanged:"לפני 12 דק׳"},{id:"light.lobby",name:"תאורת לובי",floorId:"f0",x:.3,y:.42,domain:"light",state:"on",stateLabelKey:"entity.on",controllable:!0,lastChanged:"לפני שעה"},{id:"binary_sensor.hall_motion",name:"תנועה באולם",floorId:"f0",x:.7,y:.3,domain:"binary_sensor",state:"off",stateLabelKey:"entity.off",controllable:!1,lastChanged:"לפני 3 דק׳"},{id:"light.corridor",name:"תאורת מסדרון",floorId:"f0",x:.55,y:.66,domain:"light",state:"off",stateLabelKey:"entity.off",controllable:!0,lastChanged:"אתמול 22:10"},{id:"lock.shelter",name:"דלת מקלט",floorId:"f-1",x:.46,y:.9,domain:"lock",state:"locked",stateLabelKey:"entity.locked",controllable:!1,lastChanged:"לפני 2 שעות"}],ln={f0:[{x:40,y:40,w:300,h:260,label:"לובי",kind:"lobby"},{x:40,y:340,w:300,h:220,label:"משרדים",kind:"office"},{x:40,y:600,w:460,h:160,label:"חניה מקורה",kind:"parking"},{x:380,y:40,w:420,h:300,label:"אולם",kind:"hall"},{x:840,y:40,w:320,h:300,label:"אולם ב",kind:"meeting"},{x:380,y:380,w:300,h:180,label:"חדר ישיבות",kind:"meeting"},{x:720,y:380,w:440,h:180,label:"מסדרון מזרחי",kind:"corridor"},{x:540,y:600,w:620,h:160,label:"שירותים ומדרגות",kind:"stairs"}],"f-1":[{x:40,y:40,w:400,h:400,label:"מחסן",kind:"storage"},{x:480,y:40,w:380,h:400,label:"חדר מכונות",kind:"machines"},{x:40,y:480,w:820,h:200,label:"מסדרון",kind:"corridor"},{x:40,y:720,w:820,h:340,label:"מקלט",kind:"shelter"}]};function Ji(e){const t=ln[e],s=xt.find(i=>i.id===e);return!t||!s?.hasPlan?[]:t.map(i=>({x:i.x/s.planWidth,y:i.y/s.planHeight,w:i.w/s.planWidth,h:i.h/s.planHeight}))}const pe="var(--sw-map-furniture)",se="var(--sw-map-furniture-line)";function El(e){const t=e.x+e.w/2,s=e.y+e.h/2;switch(e.kind){case"lobby":return u`<rect x=${e.x+30} y=${e.y+e.h-70} width="130" height="30" rx="4" fill=${pe} stroke=${se} /><rect x=${e.x+170} y=${e.y+30} width="110" height="36" rx="10" fill=${pe} stroke=${se} /><circle cx=${e.x+22} cy=${e.y+22} r="10" fill="#dfe9d9" stroke="#b9cfae" /><circle cx=${e.x+e.w-22} cy=${e.y+22} r="10" fill="#dfe9d9" stroke="#b9cfae" />`;case"office":return u`${[0,1].map(i=>[0,1,2].map(a=>u`<rect x=${e.x+30+a*92} y=${e.y+36+i*92} width="56" height="28" rx="2" fill=${pe} stroke=${se} /><circle cx=${e.x+58+a*92} cy=${e.y+78+i*92} r="8" fill=${pe} stroke=${se} />`))}`;case"parking":return u`${[0,1,2,3,4,5,6,7].map(i=>u`<line x1=${e.x+30+i*56} y1=${e.y+20} x2=${e.x+30+i*56} y2=${e.y+e.h-20} stroke=${se} stroke-dasharray="6 6" />`)}${[1,3,4].map(i=>u`<rect x=${e.x+42+i*56} y=${e.y+36} width="30" height="70" rx="8" fill="#d5dce8" stroke=${se} />`)}`;case"hall":return u`${[0,1,2,3].map(i=>[0,1,2,3,4,5].map(a=>u`<rect x=${e.x+50+a*56} y=${e.y+60+i*52} width="26" height="16" rx="3" fill=${pe} stroke=${se} />`))}<rect x=${e.x+40} y=${e.y+20} width=${e.w-80} height="14" rx="2" fill=${pe} stroke=${se} />`;case"meeting":return u`<rect x=${t-80} y=${s-26} width="160" height="52" rx="12" fill=${pe} stroke=${se} />${[0,1,2].map(i=>u`<circle cx=${t-50+i*50} cy=${s-44} r="9" fill=${pe} stroke=${se} /><circle cx=${t-50+i*50} cy=${s+44} r="9" fill=${pe} stroke=${se} />`)}`;case"corridor":return u`<rect x=${e.x+30} y=${s-8} width="90" height="16" rx="3" fill=${pe} stroke=${se} />`;case"stairs":return u`<rect x=${e.x+e.w-130} y=${e.y+30} width="100" height="100" fill=${pe} stroke=${se} />${[1,2,3,4,5,6,7].map(i=>u`<line x1=${e.x+e.w-130} y1=${e.y+30+i*12.5} x2=${e.x+e.w-30} y2=${e.y+30+i*12.5} stroke=${se} />`)}${[0,1,2,3].map(i=>u`<rect x=${e.x+30+i*46} y=${e.y+30} width="36" height="46" fill=${pe} stroke=${se} />`)}`;case"storage":return u`${[0,1,2,3].map(i=>u`<rect x=${e.x+40+i*92} y=${e.y+40} width="30" height=${e.h-80} fill=${pe} stroke=${se} />`)}`;case"machines":return u`${[0,1,2].map(i=>u`<rect x=${e.x+40} y=${e.y+40+i*120} width="110" height="72" rx="4" fill=${pe} stroke=${se} /><circle cx=${e.x+240} cy=${e.y+76+i*120} r="26" fill=${pe} stroke=${se} />`)}`;case"shelter":return u`${[0,1,2,3].map(i=>u`<rect x=${e.x+60} y=${e.y+50+i*70} width="220" height="22" rx="3" fill=${pe} stroke=${se} /><rect x=${e.x+e.w-280} y=${e.y+50+i*70} width="220" height="22" rx="3" fill=${pe} stroke=${se} />`)}`;default:return""}}function dn(e){const t=ln[e],s=xt.find(i=>i.id===e);return!t||!s?null:u`
    ...
    ${t.map(i=>u`
      ...
      `)}
  `}const Xi=[{id:"site-a",name:"אתר הדגמה",address:"רחוב הדוגמה 1",buildings:2,cameras:10,online:9,alerts:2,health:"stale"},{id:"site-b",name:"סניף צפון",address:"שדרות הדגמה 20",buildings:1,cameras:6,online:6,alerts:0,health:"live"},{id:"site-c",name:"מחסן לוגיסטי",address:"אזור תעשייה",buildings:1,cameras:4,online:3,alerts:1,health:"offline"}],Al=[{id:"bld-a",siteId:"site-a",name:"מבנה א",floors:[{id:"f0",name:"קומה 0",cameras:6,entities:4,hasPlan:!0},{id:"f-1",name:"קומה 1-",cameras:3,entities:1,hasPlan:!0},{id:"f-2",name:"קומה 2-",cameras:2,entities:0,hasPlan:!1}]},{id:"bld-b",siteId:"site-a",name:"מבנה ב",floors:[{id:"b-f0",name:"קרקע",cameras:1,entities:2,hasPlan:!1}]}],X=[{id:"cam-1",name:"כניסה ראשית",floor:"קומה 0",state:"live",stream:"sub",fps:25,bitrateKbps:3072,firmware:"V5.8.10",lastEvent:"לפני 2 דק׳",recording:"continuous",ptz:!1,audio:!1},{id:"cam-2",name:"לובי",floor:"קומה 0",state:"live",stream:"sub",fps:25,bitrateKbps:3072,firmware:"V5.8.10",lastEvent:"לפני 5 דק׳",recording:"motion",ptz:!1,audio:!0},{id:"cam-3",name:"מסדרון מזרחי",floor:"קומה 0",state:"offline",stream:"sub",fps:null,bitrateKbps:null,firmware:"V5.8.10",lastEvent:"לפני שעה",recording:"unknown",ptz:!1,audio:!1},{id:"cam-4",name:"אולם",floor:"קומה 0",state:"live",stream:"main",fps:25,bitrateKbps:5120,firmware:"V5.8.10",lastEvent:"לפני 12 דק׳",recording:"continuous",ptz:!0,audio:!1},{id:"cam-5",name:"חדר מדרגות",floor:"קומה 0",state:"stale",stream:"sub",fps:20,bitrateKbps:2048,firmware:"V5.8.9",lastEvent:"לפני 40 דק׳",recording:"continuous",ptz:!1,audio:!1},{id:"cam-6",name:"חניה מקורה",floor:"קומה 0",state:"forbidden",stream:"sub",fps:null,bitrateKbps:null,firmware:"—",lastEvent:"—",recording:"unknown",ptz:!1,audio:!1},{id:"cam-7",name:"מחסן",floor:"קומה 1-",state:"live",stream:"sub",fps:25,bitrateKbps:3072,firmware:"V5.8.10",lastEvent:"לפני 3 שעות",recording:"motion",ptz:!1,audio:!1},{id:"cam-8",name:"חדר מכונות",floor:"קומה 1-",state:"live",stream:"sub",fps:25,bitrateKbps:3072,firmware:"V5.8.10",lastEvent:"אתמול",recording:"continuous",ptz:!1,audio:!1},{id:"cam-9",name:"מקלט",floor:"קומה 1-",state:"offline",stream:"sub",fps:null,bitrateKbps:null,firmware:"V5.8.10",lastEvent:"לפני יומיים",recording:"unknown",ptz:!1,audio:!1},{id:"cam-10",name:"חצר אחורית",floor:"חוץ",state:"live",stream:"sub",fps:25,bitrateKbps:4096,firmware:"V5.8.10",lastEvent:"לפני 8 דק׳",recording:"continuous",ptz:!0,audio:!0}],tt={"cam-1":"entrance","cam-2":"lobby","cam-3":"corridor","cam-4":"hall","cam-5":"corridor","cam-6":"parking","cam-7":"warehouse","cam-8":"warehouse","cam-9":"night","cam-10":"backyard"},Qi={person:"זיהוי אדם",vehicle:"זיהוי רכב",motion:"תנועה",line:"חציית קו",offline:"מצלמה מנותקת",door:"דלת נפתחה"},ot=[{id:"ev-1",time:"היום 10:14",minuteOfDay:614,type:"person",title:"אדם זוהה",camera:"כניסה ראשית",floor:"קומה 0",source:"NVR",acked:!1,severity:"alert"},{id:"ev-2",time:"היום 09:42",minuteOfDay:582,type:"vehicle",title:"רכב זוהה",camera:"חצר אחורית",floor:"חוץ",source:"NVR",acked:!1,severity:"info"},{id:"ev-3",time:"היום 08:31",minuteOfDay:511,type:"motion",title:"תנועה",camera:"מחסן",floor:"קומה 1-",source:"NVR",acked:!0,severity:"info"},{id:"ev-4",time:"היום 08:12",minuteOfDay:492,type:"door",title:"דלת כניסה נפתחה",camera:"כניסה ראשית",floor:"קומה 0",source:"HA",acked:!0,severity:"info"},{id:"ev-5",time:"היום 07:55",minuteOfDay:475,type:"offline",title:"מסדרון מזרחי מנותק",camera:"מסדרון מזרחי",floor:"קומה 0",source:"NVR",acked:!1,severity:"critical"},{id:"ev-6",time:"היום 06:43",minuteOfDay:403,type:"line",title:"חציית קו",camera:"חניה מקורה",floor:"קומה 0",source:"NVR",acked:!0,severity:"alert"},{id:"ev-7",time:"אתמול 23:10",minuteOfDay:1390,type:"person",title:"אדם זוהה",camera:"לובי",floor:"קומה 0",source:"NVR",acked:!0,severity:"info"}],ni=[{startMin:0,endMin:190,kind:"continuous"},{startMin:205,endMin:460,kind:"continuous"},{startMin:470,endMin:474,kind:"motion"},{startMin:480,endMin:486,kind:"motion"},{startMin:492,endMin:640,kind:"continuous"},{startMin:660,endMin:1439,kind:"continuous"}],ea=[{id:"u-1",name:"יוני",haUser:"joni",active:!0,lastSync:"לפני 20 שנ׳",groups:["מנהלי מערכת"],bindings:[{role:"מנהל מערכת VMS",scope:"כל ההתקנה"}],haAdmin:!0},{id:"u-2",name:"דנה",haUser:"dana",active:!0,lastSync:"לפני 20 שנ׳",groups:["עורכי קומה 2"],bindings:[{role:"עורך מפות",scope:"מבנה א · קומה 2"}],haAdmin:!1},{id:"u-3",name:"יוסי",haUser:"yossi",active:!0,lastSync:"לפני 20 שנ׳",groups:["מנהלי מבנה א"],bindings:[{role:"מנהל אתר/מבנה",scope:"מבנה א"}],haAdmin:!1},{id:"u-4",name:"codex",haUser:"codex",active:!0,lastSync:"לפני 20 שנ׳",groups:[],bindings:[],haAdmin:!1},{id:"u-5",name:"רון",haUser:"ron",active:!1,lastSync:"לפני 3 ימים",groups:["צופים"],bindings:[{role:"צופה",scope:"אתר הדגמה"}],haAdmin:!1}],cn=[{id:"g-1",name:"מנהלי מערכת",members:1,bindings:["מנהל מערכת VMS · כל ההתקנה"]},{id:"g-2",name:"עורכי קומה 2",members:1,bindings:["עורך מפות · מבנה א · קומה 2"]},{id:"g-3",name:"מנהלי מבנה א",members:1,bindings:["מנהל אתר/מבנה · מבנה א"]},{id:"g-4",name:"צופים",members:1,bindings:["צופה · אתר הדגמה"]}],pn=[{id:"viewer",name:"צופה",allowed:"מפה, מצב ישויות מורשה, שידור חי",denied:"היסטוריה, עריכה, ייצוא, שליטה"},{id:"operator",name:"מפעיל",allowed:"צפייה, Playback, סקירת אירועים וסימון טיפול",denied:"עריכת מפות, תפקידים, ייצוא, פעולות פיזיות"},{id:"editor",name:"עורך מפות ותצוגות",allowed:"צפייה, יבוא/עריכה/פרסום מפות, מיקומים ותצוגות",denied:"Playback, ייצוא, משתמשים, סודות, שליטה"},{id:"site_admin",name:"מנהל אתר / מבנה / קומה",allowed:"מפעיל + עורך, הגדרות תוכן מקומיות",denied:"הגדרות מערכת, תפקידים, סודות, כתיבה ל־NVR"},{id:"system_admin",name:"מנהל מערכת VMS",allowed:"הגדרות מוצר, מקורות, מדיניות, קבוצות ושיוכים",denied:"ניהול HA, שליטה פיזית, ייצוא ראיות ללא grant"}],hn=[{time:"10:24",user:"יוני",action:"צפייה חיה",resource:"כניסה ראשית",decision:"הותר",role:"מנהל מערכת · כל ההתקנה"},{time:"10:18",user:"דנה",action:"פרסום תוכנית",resource:"מבנה א · קומה 2",decision:"הותר",role:"עורך מפות · קומה 2"},{time:"10:11",user:"דנה",action:"עריכת תוכנית",resource:"מבנה א · קומה 3",decision:"נחסם: מחוץ להיקף",role:"עורך מפות · קומה 2"},{time:"09:55",user:"יוסי",action:"ייצוא קטע",resource:"לובי 09:10–09:20",decision:"נחסם: אין הרשאת ייצוא",role:"מנהל מבנה · מבנה א"},{time:"09:43",user:"codex",action:"כניסה דרך Ingress",resource:"—",decision:"הותר, ללא שיוך",role:"—"},{time:"09:30",user:"יוני",action:"הפעלת תאורה",resource:"light.lobby",decision:"הותר (HA אישר)",role:"מנהל מערכת"},{time:"08:12",user:"מערכת",action:"סנכרון משתמשים",resource:"HA bridge",decision:"5 משתמשים, 0 שינויים",role:"—"}],un=[{id:"job-1",title:"ייצוא: כניסה ראשית 09:10–09:25",status:"הושלם",progress:100,size:"182 MB",hash:"sha256 ✓"},{id:"job-2",title:"ייצוא: לובי 23:00–23:40",status:"בתהליך",progress:62,size:"—",hash:"—"},{id:"job-3",title:"תמונות מקדימות: קומה 0",status:"ממתין",progress:0,size:"—",hash:"—"},{id:"job-4",title:"ייצוא: חצר אחורית 02:00–04:00",status:"נכשל: פער בהקלטה",progress:35,size:"—",hash:"—"}],ta=[{id:"case-1",title:"כניסה לא מורשית — 13.09",status:"פתוח",owner:"יוני",clips:3,notes:2,preserved:2,missing:1},{id:"case-2",title:"נזק לרכב בחניה",status:"בבדיקה",owner:"יוסי",clips:2,notes:1,preserved:2,missing:0},{id:"case-3",title:"דלת מקלט פתוחה בלילה",status:"סגור",owner:"יוני",clips:1,notes:3,preserved:1,missing:0}],sa=[{id:"r-1",name:"אדם בלילה",trigger:"זיהוי אדם",scope:"חוץ · 22:00–06:00",action:"התראה + פתיחת מצלמות",enabled:!0,last:"אתמול 23:10"},{id:"r-2",name:"רכב באזור מוגבל",trigger:"זיהוי רכב",scope:"חניה מקורה",action:"התראה",enabled:!0,last:"היום 09:42"},{id:"r-3",name:"דלת נשארה פתוחה",trigger:"דלת > 60 שנ׳",scope:"כל הדלתות",action:"התראה + הקלטה",enabled:!0,last:"—"},{id:"r-4",name:"מצלמה מנותקת",trigger:"ניתוק",scope:"כל האתר",action:"התראה מיידית",enabled:!1,last:"היום 07:55"}],mn=[{name:"NVR (הקלטה)",state:"live",detail:"10/10 ערוצים, דיסק תקין"},{name:"go2rtc (מדיה)",state:"live",detail:"גרסה ‎1.9.x‎ · 4 זרמים פעילים"},{name:"גשר Home Assistant",state:"stale",detail:"סנכרון אחרון לפני 4 דק׳"},{name:"מסד נתונים",state:"live",detail:"WAL · גיבוי אחרון אתמול 02:00"},{name:"תור עבודות",state:"partial",detail:"1 בתהליך · 1 נכשל"}],Pl=["live","explore","investigate","system"];function as(e=window.location.hash){const t=e.replace(/^#/,"")||"/explore/floors/f0",[s,i=""]=t.split("?"),a=s.startsWith("/")?s:`/${s}`,n=a.split("/").filter(Boolean),o=n[0];return{path:a,segments:n,params:new URLSearchParams(i),mode:o&&Pl.includes(o)?o:null}}function $(e,t){const s=t?`?${new URLSearchParams(t).toString()}`:"";window.location.hash=`#${e}${s}`}function Il(e){const t=()=>e(as());return window.addEventListener("hashchange",t),e(as()),()=>window.removeEventListener("hashchange",t)}const ia=new Set;let Te={mode:"loading",me:null,error:null};function Us(e){Te=e,ia.forEach(t=>t(Te))}function fn(e){return ia.add(e),e(Te),()=>ia.delete(e)}async function Cl(){try{const e=await k("me");Us({mode:e.has_access?"api":"no_access",me:e,error:null})}catch(e){e instanceof ue&&e.status===401?Us({mode:"unauthenticated",me:null,error:e.body.user_message}):e instanceof ue?Us({mode:"demo",me:null,error:e.body.user_message}):Us({mode:"demo",me:null,error:null})}return Te}function us(e){const t=Te.me;return(t?.permissions_any??t?.permissions_installation??[]).includes(e)}function ir(){return(Te.me?.permissions_any??Te.me?.permissions_installation??[]).some(t=>t==="system.configure"||t.startsWith("nvr."))}const y=()=>Te.mode==="api";function Dl(e){const t=xt.find(i=>i.id===e)??xt[0],s=bs.filter(i=>i.floorId===t.id);return{source:"demo",floorId:t.id,floorName:t.name,buildingName:sr.building,siteName:sr.name,width:t.planWidth||1200,height:t.planHeight||800,imageUrl:null,planSvg:t.hasPlan?dn(t.id):null,planStatus:t.hasPlan?"published":"none",planVersionId:t.hasPlan?`demo-${t.id}`:null,needsAlignment:!1,renderMode:"source",stylizedAvailable:!1,planPublishedAt:null,planArchivedAt:null,at:null,history:null,historyFrom:null,haHistory:null,geometryRef:null,scaleMPerPx:null,anchors:s.map((i,a)=>({id:`demo-anchor-${i.id}`,floor_id:t.id,plan_version_id:`demo-${t.id}`,resource_type:"camera",resource_id:i.id,position:{x:i.x,y:i.y},rotation_degrees:i.rotation,field_of_view_degrees:i.fov,coverage_radius:null,coverage_polygon:null,layer_id:"cameras",label:i.name,revision:1,effective_from:"",effective_to:null,updated_at:"",camera:{id:i.id,recorder_id:"demo",channel:a+1,name:i.name,name_source:i.name,alias:null,enabled:!0,sort_order:a,main_track:null,sub_track:null,status:i.state==="offline"?"offline":"online",last_seen_at:null}})),zones:[],cameras:[],permissions:{edit:!0,publish:!0,import:!0,structure:!1}}}async function Ts(e,t=!1,s){if(!y())return Dl(e);const i=new URLSearchParams;t&&i.set("draft","true"),s&&i.set("at",s);const a=i.toString(),n=await k(`floors/${e}/map${a?`?${a}`:""}`);return{source:"api",floorId:n.floor.id,floorName:n.floor.name,buildingName:n.building.name,siteName:n.site.name,width:n.plan?.width_px??1200,height:n.plan?.height_px??800,imageUrl:n.plan?Qe(n.plan.image_url):null,planSvg:null,planStatus:n.plan?n.plan.status==="published"?"published":"draft":"none",planVersionId:n.plan?.id??null,needsAlignment:n.needs_alignment,anchors:n.anchors,zones:n.zones??[],cameras:n.cameras,permissions:n.permissions,renderMode:n.plan?.render_mode==="stylized"?"stylized":"source",stylizedAvailable:!!n.plan?.stylized_url,planPublishedAt:n.plan?.published_at??null,planArchivedAt:n.plan?.archived_at??null,at:n.at??null,history:n.history??null,historyFrom:n.history_from??null,haHistory:n.ha_history??null,geometryRef:n.geometry??null,scaleMPerPx:n.plan?.scale_m_per_px??null}}function ys(e,t){const s=e.camera;return s?s.status==="online"?"live":s.status==="offline"?"offline":t??"unknown":t??"unknown"}const Tl=e=>k(`floors/${e}/plan-assets`),Ol=(e,t)=>{const s=new FormData;return s.append("file",t,t.name),$i(`floors/${e}/plan-assets`,s)},Rl=e=>k(`floors/${e}/plan-versions`),Nl=(e,t)=>A(`floors/${e}/plan-versions`,t),aa=e=>A(`plan-versions/${e}/publish`),Bl=(e,t)=>k(`plan-versions/${e}/diff`),Ll=(e,t,s)=>A(`plan-versions/${e}/rollback`,{revision:t,expected_published_id:s});function $s(e){return e.resource_type==="camera"?e.camera?.name??e.label??e.resource_id:e.label??e.entity?.name??e.resource_id}const ar=(e,t)=>A(`floors/${e}/anchors`,t),gn=(e,t)=>Be(`map-anchors/${e}`,t),Vl=(e,t)=>A(`floors/${e}/anchors/realign`,{mode:t}),Hl=e=>ve(`map-anchors/${e}`),Le=()=>k("cameras"),jl=()=>A("cameras/sync"),Fl=e=>A("cameras",e),wn=(e,t)=>Be(`cameras/${e}`,t),Wl=e=>k(`plan-assets/${e}/dxf`),Ul=(e,t)=>Me(`plan-assets/${e}/dxf`,t);function Zl(){return{source:"demo",sites:Xi.map((t,s)=>({id:t.id,name:t.name,address:t.address,timezone:"Asia/Jerusalem",sort_order:s,updated_at:"",buildings:Al.filter(i=>i.siteId===t.id).map((i,a)=>({id:i.id,site_id:t.id,name:i.name,sort_order:a,updated_at:"",floors:i.floors.map((n,o)=>{const l=xt.find(p=>p.id===n.id);return{id:n.id,building_id:i.id,name:n.name,level:-o,sort_order:o,ha_area_id:null,has_plan:n.hasPlan,published_version_id:n.hasPlan?`demo-${n.id}`:null,plan_width_px:l?.planWidth??null,plan_height_px:l?.planHeight??null,draft_version_id:null,anchor_count:n.cameras+n.entities,camera_count:n.cameras,updated_at:""}})}))})),canCreateSite:!0}}async function St(){if(!y())return Zl();const e=await k("sites?tree=true");return{source:"api",sites:e.sites,canCreateSite:e.can_create_site}}const ql=e=>A("sites",e),Kl=(e,t)=>Be(`sites/${e}`,t),Gl=e=>ve(`sites/${e}`),vn=(e,t)=>A(`sites/${e}/buildings`,t),Yl=(e,t)=>Be(`buildings/${e}`,t),Jl=e=>ve(`buildings/${e}`),Xl=(e,t)=>A(`buildings/${e}/floors`,t),Ql=(e,t)=>Be(`floors/${e}`,t),ed=(e,t=!1)=>ve(`floors/${e}${t?"?force=true":""}`);function td(e,t,s){const i=new FormData;return i.append("file",s,s.name),$i(`${e}s/${t}/image`,i)}const sd=(e,t)=>Ft(`${e}s/${t}/image`,{method:"DELETE"}),rr=e=>ge(e.replace(/^api\/v1\//,""));function bn(e,t){for(const s of e.sites)for(const i of s.buildings??[]){const a=(i.floors??[]).find(n=>n.id===t);if(a)return{site:s,building:i,floor:a}}return null}function yn(e){for(const t of e.sites)for(const s of t.buildings??[])for(const i of s.floors??[])return i;return null}function Lt(e){return String(e??"").replace(/(^|[^\w])(-\d)/g,"$1‎$2")}function id(e){return e==null?"":`‎${e}`}const ra=[{id:"room",label:"חדר"},{id:"zone",label:"אזור"},{id:"corridor",label:"מסדרון"},{id:"outdoor",label:"חוץ"},{id:"service",label:"שירות / טכני"}],ad=e=>ra.find(t=>t.id===e)?.label??e,rd=e=>k(`floors/${e}/zones`),nd=(e,t)=>A(`floors/${e}/zones`,t),od=(e,t)=>Be(`zones/${e}`,t),ld=e=>ve(`zones/${e}`),dd=(e,t="medium")=>A(`floors/${e}/zones/detect`,{strength:t}),cd=(e,t,s)=>A(`floors/${e}/zones/accept`,{candidates:t,replace_auto:s});function xs(e,t){let s=!1;for(let i=0,a=t.length-1;i<t.length;a=i++){const n=t[i],o=t[a];n.y>e.y!=o.y>e.y&&e.x<(o.x-n.x)*(e.y-n.y)/(o.y-n.y)+n.x&&(s=!s)}return s}const $n=()=>k("views"),xn=e=>A("views",e),pd=(e,t)=>Me(`views/${e}`,t),hd=e=>ve(`views/${e}`),kn=e=>`#/live/wall?cameras=${encodeURIComponent(e.cameras.join(","))}`,ud=e=>`#/kiosk/all?cameras=${encodeURIComponent(e.cameras.join(","))}&cols=${e.cols}&rows=${e.rows}`;var md=Object.defineProperty,fd=Object.getOwnPropertyDescriptor,Hs=(e,t,s,i)=>{for(var a=i>1?void 0:i?fd(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&md(t,s,a),a};let Vt=class extends z{constructor(){super(...arguments),this.checked=!1,this.disabled=!1,this.label="",this.labelHidden=!1}flip(){this.disabled||(this.checked=!this.checked,this.dispatchEvent(new CustomEvent("change",{detail:{checked:this.checked},bubbles:!0,composed:!0})))}render(){return r`<button type="button" role="switch" aria-checked=${this.checked} aria-label=${this.label} ?disabled=${this.disabled} @click=${this.flip}></button>${this.label&&!this.labelHidden?r`<span>${this.label}</span>`:""}`}};Vt.styles=M`
    :host {
      display: inline-flex;
      align-items: center;
      gap: var(--sw-s-2);
  ...
  `;Hs([f({type:Boolean,reflect:!0})],Vt.prototype,"checked",2);Hs([f({type:Boolean,reflect:!0})],Vt.prototype,"disabled",2);Hs([f()],Vt.prototype,"label",2);Hs([f({type:Boolean})],Vt.prototype,"labelHidden",2);Vt=Hs([E("sw-toggle")],Vt);function _n(e={}){const t=new URLSearchParams;e.domain&&t.set("domain",e.domain),e.q&&t.set("q",e.q),e.area&&t.set("area",e.area),e.placed!==void 0&&t.set("placed",String(e.placed)),e.includeDisabled&&t.set("include_disabled","true"),e.limit&&t.set("limit",String(e.limit));const s=t.toString();return k(`ha/entities${s?`?${s}`:""}`)}const gd=()=>k("ha/status"),wd=(e=!1)=>k(`ha/bridge/pairing${e?"?regenerate=true":""}`),nr=e=>k(`ha/actions/${e}`),vd=()=>A("ha/bridge/install");function bd(e,t,s={},i=!1){const a={allowed_action_id:t,arguments:s,expected_state_version:null,confirmation_grant:i?"confirmed":null,client_request_id:crypto.randomUUID(),expires_at:new Date(Date.now()+6e4).toISOString().replace(/\.\d{3}Z$/,"Z")};return A(`ha/entities/${encodeURIComponent(e)}/actions`,a)}async function yd(e,t,s){let i=await nr(e);t(i);for(let a=0;a<16&&i.status==="pending";a++)await new Promise(n=>setTimeout(n,1500)),i=await nr(e),t(i);return i}const $d={ha_unauthorized:"Home Assistant דחה את הפעולה: למשתמש שלך אין הרשאה לישות זו ב־Home Assistant",ha_unknown_user:"Home Assistant אינו מכיר את המשתמש שמאחורי ההפעלה הזו",bridge_not_paired:"גשר SMPLWISE אינו מצומד",bridge_error:"הגשר החזיר שגיאה",ha_unavailable:"Home Assistant אינו זמין",service_not_allowed:"הגשר סירב: השירות אינו ברשימת הפעולות המאושרות (גשר ישן? מאז 0.2.1 נוספו climate / media / number / select / alarm — הפעל את Home Assistant מחדש כדי לטעון את הגרסה החדשה)",unknown_user:"Home Assistant אינו מכיר את המשתמש"},xd={pending:"נשלח · ממתין לעדכון מ־Home Assistant",confirmed:"אושר · המצב התעדכן",unknown:"לא ידוע · לא התקבל עדכון מצב",failed:"נכשל",denied:"נדחה · אין הרשאה ב־Home Assistant"},kd=new Set(["on","open","opening","unlocked","unlocking","playing","home","heat","cool","heat_cool","dry","fan_only","cleaning","active","detected","problem","running"]),Zs={on:"דולק",off:"כבוי",locked:"נעול",unlocked:"פתוח",locking:"נועל…",unlocking:"פותח…",jammed:"תקוע",open:"פתוח",closed:"סגור",opening:"נפתח…",closing:"נסגר…",unavailable:"לא זמין",unknown:"לא ידוע",idle:"לא פעיל",home:"בבית",not_home:"מחוץ לבית",playing:"מנגן",paused:"מושהה",standby:"המתנה",heat:"חימום",cool:"קירור",auto:"אוטומטי",dry:"ייבוש",fan_only:"מאוורר",docked:"בתחנה",cleaning:"מנקה",returning:"חוזר"},_d={motion:["תנועה","ללא תנועה"],occupancy:["נוכחות","ללא נוכחות"],presence:["נוכח","לא נוכח"],door:["פתוחה","סגורה"],window:["פתוח","סגור"],opening:["פתוח","סגור"],garage_door:["פתוח","סגור"],lock:["פתוח","נעול"],connectivity:["מחובר","מנותק"],power:["פועל","כבוי"],problem:["תקלה","תקין"],safety:["לא בטוח","בטוח"],smoke:["עשן","ללא עשן"],moisture:["רטוב","יבש"],battery:["סוללה חלשה","סוללה תקינה"],running:["פועל","לא פועל"],sound:["רעש","שקט"],vibration:["רטט","ללא רטט"],update:["עדכון זמין","מעודכן"]};function kt(e){const t=e.state;if(t==null)return"לא ידוע";if(t==="unavailable"||t==="unknown")return Zs[t];if(e.domain==="binary_sensor"){const s=_d[e.device_class??""];return s?t==="on"?s[0]:s[1]:t==="on"?"פעיל":"לא פעיל"}if(e.domain==="sensor"||e.domain==="number"||e.domain==="input_number"){const s=Number(t);return!Number.isNaN(s)&&t.trim()!==""?`${Number.isInteger(s)?s:s.toFixed(Math.min(2,(t.split(".")[1]??"").length))}${e.unit?` ${e.unit}`:""}`:t}return e.domain==="light"&&t==="on"&&typeof e.attributes.brightness=="number"?`דולק · ${Math.round(e.attributes.brightness/255*100)}%`:e.domain==="cover"&&typeof e.attributes.current_position=="number"&&(t==="open"||t==="closed")?`${Zs[t]} · ${e.attributes.current_position}%`:e.domain==="climate"&&typeof e.attributes.current_temperature=="number"?`${Zs[t]??t} · ${e.attributes.current_temperature}°`:Zs[t]??t}function na(e){return!e||e.removed_at?"unknown":e.state==="unavailable"||!e.available?"offline":e.fresh?e.state===null||e.state==="unknown"?"unknown":kd.has(e.state)?"live":"neutral":"stale"}function ki(e,t){return e==="doors"||t==="lock"||t==="cover"?"lock":e==="lights"||t==="light"||t==="switch"||t==="fan"?"light":"binary_sensor"}function Os(e){return{light:"תאורה",switch:"מתג",lock:"מנעול",cover:"תריס / שער",binary_sensor:"חיישן בינארי",sensor:"חיישן",fan:"מאוורר",climate:"אקלים",camera:"מצלמת HA",button:"כפתור",script:"סקריפט",scene:"סצנה",automation:"אוטומציה",media_player:"נגן",event:"אירוע",number:"מספר",select:"בחירה",input_boolean:"דגל",alarm_control_panel:"אזעקה",siren:"צופר",vacuum:"שואב",weather:"מזג אוויר",sun:"שמש"}[e]??e}function Fe(e){if(!e)return"—";const t=new Date(e);return Number.isNaN(t.getTime())?e:t.toLocaleString("he-IL",{dateStyle:"short",timeStyle:"medium"})}function zn(e,t){let s=null,i=!1,a=2e3;const n=(()=>{const l=new URL(ge("ha/ws"));return l.protocol=l.protocol==="https:"?"wss:":"ws:",l.toString()})(),o=()=>{if(!i){try{s=new WebSocket(n)}catch{return}s.onopen=()=>{a=2e3},s.onmessage=l=>{try{const p=JSON.parse(l.data);p.type==="entity_state_changed"?e({type:"entity_state_changed",entity:p.payload.entity}):p.type==="ha_sync_state"?e({type:"ha_sync_state",connected:!!p.payload.connected}):p.type==="heartbeat"&&e({type:"heartbeat",sync:p.payload.sync})}catch{}},s.onclose=l=>{!i&&l.code!==4403&&l.code!==4401&&(window.setTimeout(o,a),a=Math.min(3e4,a*2))}}};return o(),()=>{i=!0,s?.close()}}const oi=new Map,gs=new Map;function Sa(e,t={}){const s=new URLSearchParams;t.draft&&s.set("draft","true"),t.at&&s.set("at",t.at);const i=s.toString();return k(`plan-versions/${e}/geometry${i?`?${i}`:""}`)}async function Ma(e){const t=e.geometryRef;if(e.source!=="api"||!t||!e.planVersionId)return null;const s=oi.get(t.doc_hash);if(s)return s;try{const i=await Sa(e.planVersionId,t.status==="draft"?{draft:!0}:t.published_at?{at:t.published_at}:{});return oi.set(i.geometry.doc_hash,i.doc),i.doc}catch{return null}}async function zd(e,t){let s=gs.get(e);if(!s){const n=k(`plan-versions/${e}/geometry/timeline`).then(o=>o.timeline).catch(()=>(gs.get(e)===n&&gs.delete(e),[]));s=n,gs.set(e,s)}const i=(await s).find(n=>n.published_at<=t&&(!n.archived_at||t<n.archived_at));if(!i)return null;const a=oi.get(i.doc_hash);if(a)return a;try{const n=await Sa(e,{at:i.published_at});return oi.set(n.geometry.doc_hash,n.doc),n.doc}catch{return null}}const Sd=(e,t,s)=>Me(`plan-versions/${e}/geometry`,{doc:t,base_revision:s});async function Md(e){const t=await A(`plan-versions/${e}/geometry/publish`);return gs.delete(e),t}const Ed=e=>k(`plan-versions/${e}/geometry/diff`),Ad=(e,t)=>A(`plan-versions/${e}/geometry/copy-from`,{from_version_id:t}),Pd=(e,t)=>Be(`plan-versions/${e}/calibration`,{pairs:t});function or(e,t,s={}){return Qe(`api/v1/plan-versions/${e}/export.${t}${s.draft?"?draft=true":""}`)}var Id=Object.defineProperty,Cd=Object.getOwnPropertyDescriptor,F=(e,t,s,i)=>{for(var a=i>1?void 0:i?Cd(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&Id(t,s,a),a};const Dd={off:"כבוי",heat:"חימום",cool:"קירור",heat_cool:"חימום/קירור",auto:"אוטומטי",dry:"ייבוש",fan_only:"מאוורר בלבד"},lr=[{id:"cameras",icon:"camera",label:()=>x("floor.cameras")},{id:"doors",icon:"door",label:()=>x("floor.doors")},{id:"lights",icon:"light",label:()=>x("floor.lights")},{id:"sensors",icon:"sensor",label:()=>x("floor.sensors")},{id:"zones",icon:"map",label:()=>"חדרים ואזורים"},{id:"structure",icon:"wall",label:()=>"מבנה"}],dr=["entrance","lobby","corridor","hall","parking","warehouse","backyard","driveway","night"];function Td(e){const t=e.match(/-?\d+/);return t?t[0]:/קרקע/.test(e)?"ק":/גג/.test(e)?"גג":/מרתף/.test(e)?"מ":(e.split(/[\s–-]+/).filter(Boolean).pop()??e).slice(0,4)}let V=class extends z{constructor(){super(...arguments),this.floorId="f0",this.screenState="ready",this.focusZone="",this.focusCamera="",this.focusEntity="",this.selectedZoneId=null,this.bundle=null,this.tree=null,this.loadError="",this.noFloors=!1,this.selectedId=null,this.anchor=null,this.layers=new Set(["cameras","doors","lights","sensors","zones","structure"]),this.geometry=null,this.geomSeq=0,this.pinned=!1,this.panel=!1,this.multi=!1,this.sideList=(()=>{try{return localStorage.getItem("sw.map.sidelist")==="1"}catch{return!1}})(),this.jumpZoom=(()=>{try{return localStorage.getItem("sw.map.jumpzoom")==="1"}catch{return!1}})(),this.focusZoom=!0,this.saveView=null,this.savedView=null,this.picked=[],this.narrow=!1,this.syncConnected=!0,this.action=null,this.confirmSpec=null,this.stopWs=null,this.mq=window.matchMedia("(max-width: 767px)"),this.onMq=()=>this.narrow=this.mq.matches,this.onKey=e=>{if(e.key==="Escape"&&!this.confirmSpec)if(this.selectedId){const t=this.selectedId;this.close(),this.canvas?.focusMarker(t)}else this.panel&&(this.panel=!1)},this.actionArgs={},this.renaming=null,this.notice=""}connectedCallback(){super.connectedCallback(),this.narrow=this.mq.matches,this.mq.addEventListener("change",this.onMq),window.addEventListener("keydown",this.onKey),this.load()}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("keydown",this.onKey),this.mq.removeEventListener("change",this.onMq),this.stopWs?.(),this.stopWs=null}startWs(){this.stopWs||!y()||(this.stopWs=zn(e=>{const t=this.bundle;if(e.type==="entity_state_changed"&&t){if(!t.anchors.some(s=>s.resource_type==="ha_entity"&&s.resource_id===e.entity.entity_id))return;this.bundle={...t,anchors:t.anchors.map(s=>s.resource_type==="ha_entity"&&s.resource_id===e.entity.entity_id?{...s,entity:{...s.entity??{},...e.entity,actions:s.entity?.actions}}:s)}}else e.type==="ha_sync_state"?this.syncConnected=e.connected:e.type==="heartbeat"&&(this.syncConnected=e.sync.connected)}))}updated(e){e.has("floorId")&&e.get("floorId")!==void 0?(this.selectedId=null,this.anchor=null,this.selectedZoneId=null,this.load()):(e.has("focusZone")||e.has("focusCamera")||e.has("focusEntity"))&&this.bundle&&this.applyFocus()}async applyFocus(){const e=this.bundle;if(!e||!this.focusZone&&!this.focusCamera&&!this.focusEntity)return;await this.updateComplete;const t=this.canvas;if(!t)return;const s=this.focusZone?e.zones.find(a=>a.id===this.focusZone):null;if(s){const a=s.polygon.map(o=>o.x),n=s.polygon.map(o=>o.y);this.selectedZoneId=s.id,t.zoomToBox(Math.min(...a),Math.min(...n),Math.max(...a),Math.max(...n))}const i=this.focusCamera?e.anchors.find(a=>a.resource_type==="camera"&&a.resource_id===this.focusCamera):this.focusEntity?e.anchors.find(a=>a.resource_type==="ha_entity"&&a.resource_id===this.focusEntity):null;if(i){this.focusZoom?t.zoomToBox(i.position.x-.15,i.position.y-.15,i.position.x+.15,i.position.y+.15,48,2.2):t.centerOn(i.position.x,i.position.y),await this.updateComplete;const a=t.toScreen(i.position.x,i.position.y);this.selectedId=i.id,this.anchor={x:a.x,y:a.y}}}async load(){this.loadError="";try{const e=this.tree??await St();if(this.tree=e,y()&&!bn(e,this.floorId)){const s=yn(e);if(s&&s.id!==this.floorId){$(`/explore/floors/${s.id}`);return}if(!s){this.noFloors=!0,this.bundle=null;return}}this.noFloors=!1,this.restoreLayers(),this.bundle=await Ts(this.floorId);const t=++this.geomSeq;this.geometry=null,Ma(this.bundle).then(s=>{t===this.geomSeq&&(this.geometry=s)}),this.bundle.source==="api"&&this.startWs(),this.applyFocus()}catch(e){this.loadError=w(e),this.bundle=null}}get buildingFloors(){if(this.tree?.source!=="api")return[];for(const e of this.tree.sites)for(const t of e.buildings??[]){const s=t.floors??[];if(!s.some(a=>a.id===this.floorId))continue;const i=s.map(a=>Td(a.name));return s.map((a,n)=>({id:a.id,name:a.name,hasPlan:a.has_plan,short:i.filter(o=>o===i[n]).length>1?`${i[n]}${n+1}`:i[n]}))}return[]}get floors(){return this.tree?.source==="api"?this.tree.sites.flatMap(e=>(e.buildings??[]).flatMap(t=>(t.floors??[]).map(s=>({id:s.id,name:`${t.name} · ${s.name}`,cameraCount:s.camera_count,hasPlan:s.has_plan})))):xt.map(e=>({id:e.id,name:e.name,cameraCount:e.cameraCount,hasPlan:e.hasPlan}))}get markers(){const e=this.bundle;if(!e)return[];const t=this.screenState==="stale";if(e.source==="demo"){const s=this.layers.has("cameras")?bs.filter(a=>a.floorId===e.floorId).map(a=>({id:a.id,kind:"camera",label:a.name,x:a.x,y:a.y,rotation:a.rotation,fov:a.fov,state:a.state})):[],i=Qs.filter(a=>a.floorId===e.floorId).filter(a=>a.domain==="lock"&&this.layers.has("doors")||a.domain==="light"&&this.layers.has("lights")||a.domain==="binary_sensor"&&this.layers.has("sensors")).map(a=>({id:a.id,kind:a.domain,label:a.name,x:a.x,y:a.y,state:t?"stale":"neutral"}));return[...s,...i]}return e.anchors.filter(s=>s.resource_type==="camera"?this.layers.has("cameras"):this.layers.has(s.layer_id==="doors"?"doors":s.layer_id==="lights"?"lights":"sensors")).map(s=>({id:s.id,kind:s.resource_type==="camera"?"camera":ki(s.layer_id,s.entity?.domain),label:$s(s),x:s.position.x,y:s.position.y,rotation:s.rotation_degrees,fov:s.field_of_view_degrees??void 0,radius:s.coverage_radius??void 0,polygon:s.coverage_polygon?s.coverage_polygon.map(([i,a])=>({x:i,y:a})):void 0,labelPos:s.label_pos??void 0,state:s.resource_type==="camera"?ys(s):t?"stale":this.entityTone(s.entity)}))}layerCounts(){const e=this.bundle,t={cameras:0,doors:0,lights:0,sensors:0,zones:e?.zones.length??0,structure:this.geometry?.walls.length??0};if(!e)return t;if(e.source==="demo"){t.cameras=bs.filter(s=>s.floorId===e.floorId).length;for(const s of Qs.filter(i=>i.floorId===e.floorId))s.domain==="lock"?t.doors++:s.domain==="light"?t.lights++:t.sensors++;return t}for(const s of e.anchors)s.resource_type==="camera"?t.cameras++:s.layer_id==="doors"?t.doors++:s.layer_id==="lights"?t.lights++:t.sensors++;return t}zoneOf(e){return this.bundle?.zones.find(s=>xs(e.position,s.polygon))?.name??null}toggleLayer(e){const t=new Set(this.layers);t.has(e)?t.delete(e):t.add(e),this.setLayers(t)}setLayers(e){this.layers=e;try{const t=[...e];e.has("structure")||t.push("-structure"),localStorage.setItem(`sw.floor.layers.${this.floorId}`,JSON.stringify(t))}catch{}}restoreLayers(){try{const e=localStorage.getItem(`sw.floor.layers.${this.floorId}`);if(!e)return;const t=JSON.parse(e);if(!Array.isArray(t))return;const s=new Set(t.filter(i=>lr.some(a=>a.id===i)));t.includes("-structure")||s.add("structure"),this.layers=s}catch{}}cameraAnchors(){return(this.bundle?.anchors??[]).filter(e=>e.resource_type==="camera"&&this.layers.has("cameras"))}togglePick(e){this.picked=this.picked.includes(e)?this.picked.filter(t=>t!==e):[...this.picked,e]}pickedCameraIds(){const e=new Map((this.bundle?.anchors??[]).map(t=>[t.id,t.resource_id]));return this.picked.map(t=>e.get(t)).filter(t=>!!t)}setMulti(e){this.multi=e,this.picked=[],this.saveView=null,this.savedView=null,e&&this.close()}addPicks(e){const t=new Set(this.cameraAnchors().map(i=>i.id)),s=e.filter(i=>t.has(i)&&!this.picked.includes(i));s.length&&(this.picked=[...this.picked,...s])}pickZone(e){const t=this.bundle?.zones.find(a=>a.id===e);if(!t)return;const s=this.cameraAnchors().filter(a=>xs(a.position,t.polygon)).map(a=>a.id);if(!s.length)return;const i=s.every(a=>this.picked.includes(a));this.picked=i?this.picked.filter(a=>!s.includes(a)):[...this.picked,...s.filter(a=>!this.picked.includes(a))]}roomChips(){const e=this.bundle;if(!e)return d;const t=this.cameraAnchors(),s=e.zones.map(i=>({z:i,ids:t.filter(a=>xs(a.position,i.polygon)).map(a=>a.id)})).filter(i=>i.ids.length);return s.length?r`<span class="roomchips" data-room-chips>${s.map(i=>r`<sw-chip icon="layers" data-room-chip=${i.z.id} ?selected=${i.ids.every(a=>this.picked.includes(a))} @click=${()=>this.pickZone(i.z.id)}>${i.z.name} (${i.ids.length})</sw-chip>`)}</span>`:d}toggleSideList(){this.sideList=!this.sideList;try{localStorage.setItem("sw.map.sidelist",this.sideList?"1":"0")}catch{}}async jumpTo(e){if(e.resource_type==="camera"?(this.focusCamera=e.resource_id,this.focusEntity=""):(this.focusEntity=e.resource_id,this.focusCamera=""),this.focusZone="",this.multi&&e.resource_type==="camera"){this.togglePick(e.id);return}this.focusZoom=this.jumpZoom,await this.applyFocus(),window.setTimeout(()=>this.focusZoom=!0,900)}setJumpZoom(e){this.jumpZoom=e;try{localStorage.setItem("sw.map.jumpzoom",e?"1":"0")}catch{}}renderSideList(){const e=this.bundle;if(!e||!this.sideList||e.source!=="api")return d;const t=e.anchors.filter(o=>o.resource_type==="camera"),s=e.anchors.filter(o=>o.resource_type==="ha_entity"),i={light:"תאורה",switch:"מפסקים",lock:"מנעולים",binary_sensor:"חיישנים",sensor:"חיישנים",cover:"תריסים",climate:"מיזוג",media_player:"מדיה",alarm_control_panel:"אזעקה"},a=new Map;for(const o of s){const l=o.entity?.domain??o.resource_id.split(".")[0];a.set(l,[...a.get(l)??[],o])}const n=o=>o.camera?o.camera.status==="online"?"#22c55e":o.camera.status==="offline"?"#ef4444":"var(--sw-text-3)":o.entity?.state==="on"||o.entity?.state==="unlocked"||o.entity?.state==="open"?"var(--sw-accent)":"var(--sw-text-3)";return r`<div class="sidelist" data-sidelist>
      ...
      <div class="body">
        ...
        ${this.floors.map(o=>r`<button class="it ${o.id===this.floorId?"on":""}" data-side-floor=${o.id} @click=${()=>{o.id!==this.floorId&&$(`/explore/floors/${o.id}`)}}>
          <sw-icon name="building" size=${12}></sw-icon><span class="nm">${Lt(o.name)}</span><span class="st">${o.cameraCount} מצלמות${o.hasPlan?"":" · אין תוכנית"}</span></button>`)}
      ...
      <div slot="footer"><sw-button variant="primary" ?disabled=${e.busy} data-save-view-submit @click=${()=>this.submitSave()}>${e.busy?"שומר…":"שמור תצוגה"}</sw-button><sw-button variant="ghost" @click=${()=>this.saveView=null}>${x("actions.cancel")}</sw-button></div>
    </sw-dialog>`}openWall(){const e=this.pickedCameraIds();e.length&&$("/live/wall",{cameras:e.join(",")})}openSync(){const e=this.pickedCameraIds();e.length&&$("/investigate/playback",{camera:e[0],extra:e.slice(1,4).join(",")})}renderPickbar(){const e=this.bundle;if(!e)return d;const t=this.cameraAnchors(),s=h=>e.anchors.find(m=>m.id===h),i=h=>{const m=s(h);return m?.camera?.name??m?.label??m?.resource_id??h},a=this.pickSummary(),n=e.anchors.filter(h=>h.resource_type==="camera").length,o=this.floors.find(h=>h.id===this.floorId)?.cameraCount??n,l=Math.max(0,o-n),p=a.total?`נבחרו ${a.total} · ${a.online} זמינות${a.offline?` · ${a.offline} לא מקוונות`:""}${a.denied?` · ${a.denied} ללא הרשאה`:""}${l?` · ${l} מצלמות של הקומה אינן על המפה`:""}`:`לחץ על מצלמות או גרור מלבן על המפה · לחיצה על חדר בוחרת את מצלמותיו · Shift+גרירה מזיזה את המפה · עד 4 לניגון מסונכרן${l?` · ${l} מצלמות של הקומה אינן על המפה`:""}`;return r`<div class="pickbar" data-pickbar>
      <span class="hint" data-pick-hint>${p}</span>
      ${this.picked.map(h=>{const m=s(h),g=m?.camera?.can_view_live===!1;return r`<sw-chip selected icon="camera" dot=${this.pickDot(m)} title=${g?"אין הרשאת צפייה חיה":m?.camera?.status==="online"?"מקוונת":"לא מקוונת"} data-pick-chip=${g?"denied":m?.camera?.status??"unknown"} @click=${()=>this.togglePick(h)}>${i(h)}</sw-chip>`})}
      ...
      <div class="ecard" data-entity-card>
        ...
        <details class="more"><summary>פרטים</summary>
          <dl class="meta">
            <dt>${x("entity.lastChanged")}</dt><dd>${Fe(s.last_changed)}</dd>
            <dt>נראה לאחרונה</dt><dd>${Fe(s.state_seen_at)}</dd>
      ...
      ${s.actions===void 0?r`<div class="note">${x("entity.noControl")}</div>`:s.actions.length===0?r`<div class="note">קריאה בלבד — אין פעולות מותרות ל־${Os(s.domain)}.</div>`:d}
    ...
    `}async saveRename(e){const t=this.renaming;if(!(!t||t.id!==e.id||t.busy)){this.renaming={...t,busy:!0};try{const s=await gn(e.id,{revision:e.revision,label:t.value.trim()||null});this.bundle&&(this.bundle={...this.bundle,anchors:this.bundle.anchors.map(i=>i.id===e.id?{...i,label:s.label,revision:s.revision}:i)}),this.renaming=null,this.notice=s.label?`השם „${s.label}“ נשמר`:"חזרה לשם מ־Home Assistant"}catch(s){this.notice=w(s),this.renaming={...t,busy:!1}}}}entityActions(e){return(e.entity?.actions??[]).length?r`<div class="eactions" data-entity-actions>${this.entityFooter(e)}</div>`:d}entityFooter(e){const t=e.entity,s=!!(this.action&&t&&this.action.entityId===t.entity_id&&this.action.busy),i=t?.actions??[];return r`${i.map(a=>r`<span class="actrow" data-action-row=${a.id}>${t&&a.argument_specs?.length?a.argument_specs.map(n=>this.renderArg(t,a,n)):d}<sw-button block variant=${a.risk==="sensitive"||a.sensitive?"danger":"primary"} ?disabled=${s||this.screenState==="stale"||t?.state==="unavailable"||a.granted===!1} title=${a.granted===!1?`נדרשת הרשאה נפרדת: ${a.grant??""}`:a.risk_label?`פעולה ${a.risk_label}`:""} data-action=${a.id} data-risk=${a.risk??(a.sensitive?"attention":"routine")} data-granted=${a.granted===!1?"no":"yes"} @click=${()=>t&&this.trigger(t.entity_id,a)}>${a.label}</sw-button></span>`)}`}renderConfirm(){const e=this.confirmSpec;if(!e)return d;const t=this.bundle?.anchors.find(s=>s.resource_type==="ha_entity"&&s.resource_id===e.entityId)?.entity;return r`<sw-dialog open heading=${x("entity.confirm")} subheading=${t?.name??e.entityId} @close=${()=>this.confirmSpec=null}>
      ...
      <div slot="footer"><sw-button variant="danger" @click=${()=>this.send(e.entityId,e.spec,!0)}>${e.spec.label}</sw-button><sw-button variant="ghost" @click=${()=>this.confirmSpec=null}>${x("actions.cancel")}</sw-button></div>
    </sw-dialog>`}demoCameraBody(e,t){const s=e.state==="offline"?x("camera.offlineReason"):e.state==="forbidden"?x("camera.forbiddenReason"):e.state==="stale"?x("camera.staleReason"):"",i=e.state==="live"||e.state==="stale";return r`
      ${i?r`<sw-camera-tile name="" state=${e.state} scene=${tt[e.id]??"lobby"} @click=${()=>$(`/live/cameras/${e.id}`)}></sw-camera-tile>`:r`<div class="off"><div><sw-icon name=${e.state==="forbidden"?"lock":"offline"} size=${22}></sw-icon><div>${s}</div></div></div>`}
    ...
    `}demoEntityBody(e){const t=this.screenState==="stale",s=t?"stale":e.state==="on"||e.state==="unlocked"?"live":"neutral";return r`
      <dl class="meta">
        <dt>${x("entity.state")}</dt><dd><sw-badge kind=${s} label=${x(e.stateLabelKey)}></sw-badge></dd>
        <dt>${x("entity.lastChanged")}</dt><dd>${e.lastChanged}</dd>
        <dt>ID</dt><dd><span class="ltr">${e.id}</span></dd>
      </dl>
      ${t?r`<div class="warn">${x("states.staleHint")}</div>`:d}
      ${e.controllable?d:r`<div class="note">${x("entity.noControl")}</div>`}
    `}apiCameraBody(e,t){const s=e.camera,i=ys(e),a=dr[((s?.channel??1)-1)%dr.length],n=i==="live"&&!!s&&s.can_view_live!==!1,o=this.zoneOf(e),l=o?`${t} / ${o}`:`${t} · ערוץ ${s?.channel??"?"}`;return r`
      ${i==="offline"?r`<div class="off"><div><sw-icon name="offline" size=${22}></sw-icon><div>${x("camera.offlineReason")}</div></div></div>`:r`<sw-camera-tile name="" state=${i==="live"?"live":"unknown"} scene=${a} poster=${s?et(s.id,Date.now()):""} ?live=${n} .cameraId=${n?s.id:""} data-live=${n?"1":"0"} @click=${()=>s&&$(`/live/cameras/${s.id}`)}></sw-camera-tile>`}
    ...
    `}renderCard(){const e=this.bundle;if(!this.selectedId||!e)return d;let t="",s="",i=d,a=d;if(e.source==="demo"){const l=bs.find(m=>m.id===this.selectedId),p=l?void 0:Qs.find(m=>m.id===this.selectedId);if(!l&&!p)return d;t=l?l.name:p.name,s=l?`${e.floorName} · ${l.source}`:`${e.floorName} · ${x(p.domain==="lock"?"entity.door":p.domain==="light"?"entity.light":"entity.sensor")}`,i=l?this.demoCameraBody(l,e.floorName):this.demoEntityBody(p);const h=l?l.state==="live"||l.state==="stale":!1;a=l?r`<sw-button variant="primary" size="sm" icon="expand" ?disabled=${!h} @click=${()=>$(`/live/cameras/${l.id}`)}>צפייה חיה</sw-button>
            <sw-button size="sm" icon="history" ?disabled=${l.state==="forbidden"} @click=${()=>$("/investigate/playback")}>${x("camera.recordings")}</sw-button>
            <sw-button variant="ghost" size="sm" iconOnly icon="pin" label=${this.pinned?x("camera.unpin"):x("camera.pin")} @click=${()=>this.pinned=!this.pinned}></sw-button>`:r`<sw-button variant="primary" size="sm" ?disabled=${!p.controllable||this.screenState==="stale"}>${x("entity.control")}</sw-button><sw-button variant="ghost" size="sm">${x("entity.openInHa")}</sw-button>`}else{const l=e.anchors.find(p=>p.id===this.selectedId);if(!l)return d;t=$s(l),s=`${e.buildingName} · ${e.floorName}`,i=l.resource_type==="camera"?this.apiCameraBody(l,e.floorName):this.apiEntityBody(l,e.floorName),a=r`${l.resource_type==="camera"?r`<sw-button variant="primary" size="sm" icon="expand" ?disabled=${ys(l)==="offline"} @click=${()=>l.camera&&$(`/live/cameras/${l.camera.id}`)}>צפייה מלאה</sw-button>
            <sw-button size="sm" icon="history" ?disabled=${!l.camera} @click=${()=>l.camera&&$("/investigate/playback",{camera:l.camera.id})}>${x("camera.recordings")}</sw-button>`:d}
        ...
        ${e.permissions.edit?r`<sw-button variant="ghost" size="sm" icon="edit" @click=${()=>$(`/explore/floors/${e.floorId}/edit`)}>עריכה</sw-button>`:d}`}if(this.narrow||!this.anchor)return r`<sw-drawer open heading=${t} subheading=${s} @close=${this.close}>${i}<div slot="footer">${a}</div></sw-drawer>`;const n=this.stage?.clientWidth??0,o=this.stage?.clientHeight??0;return r`<sw-popover heading=${t} .x=${this.anchor.x} .y=${this.anchor.y} .stageWidth=${n} .stageHeight=${o} @close=${this.close}>${i}<div slot="footer">${a}</div></sw-popover>`}renderPanel(){const e=this.layerCounts(),t=[{id:"cameras",label:x("floor.cameras"),count:`${e.cameras} ממוקמות`},{id:"doors",label:"דלתות ואינטרקום",count:`${e.doors} ישויות`},{id:"lights",label:x("floor.lights"),count:`${e.lights} ישויות`},{id:"sensors",label:"אבטחה וחיישנים",count:`${e.sensors} ישויות`},{id:"zones",label:"שמות חדרים",count:e.zones?`${e.zones} אזורים · תוויות לפי רמת זום`:"אין חדרים מוגדרים"},{id:"structure",label:"מבנה",count:this.geometry?`${this.geometry.walls.length} קירות · ${this.geometry.openings.length} פתחים`:"לא שורטט מבנה"}];return r`<div class="panel" role="group" aria-label="שכבות פעילות" data-layers-panel>
      <h3>שכבות פעילות</h3>
    ...
    </div>`}renderStage(){const e=this.bundle;if(this.loadError)return r`<div class="cover"><sw-state-panel state="error" hint=${this.loadError} actionLabel=${x("states.retry")} @action=${()=>this.load()}></sw-state-panel></div>`;if(this.noFloors)return r`<div class="cover"><sw-state-panel state="empty" heading="עדיין אין קומות" hint="צור אתר, מבנה וקומה ואז ייבא תוכנית קומה."><div style="margin-block-start:10px"><sw-button variant="primary" icon="building" @click=${()=>$("/explore/sites")}>לאתרים ומבנים</sw-button></div></sw-state-panel></div>`;if(!e)return r`<div class="cover"><sw-state-panel state="loading"></sw-state-panel></div>`;switch(this.screenState){case"loading":return r`<div class="cover"><sw-state-panel state="loading"></sw-state-panel></div>`;case"error":return r`<div class="cover"><sw-state-panel state="error" actionLabel=${x("states.retry")}></sw-state-panel></div>`;case"forbidden":return r`<div class="cover"><sw-state-panel state="forbidden"></sw-state-panel></div>`}return this.screenState==="empty"||e.planStatus==="none"?r`<div class="cover">
        <sw-state-panel state="empty" heading=${x("floor.noPlan")} hint=${e.permissions.import?x("floor.noPlanHint"):"עורך המפות של הקומה יכול להעלות תוכנית."}>
          <div style="display:flex;gap:8px;margin-block-start:10px;justify-content:center;flex-wrap:wrap">
            ${e.permissions.import?r`<sw-button variant="primary" icon="upload" @click=${()=>$(`/explore/floors/${e.floorId}/import`)}>${x("floor.uploadPlan")}</sw-button>`:d}
            <sw-button icon="list" @click=${()=>$("/live/wall")}>${x("floor.listView")}</sw-button>
          </div>
        </sw-state-panel>
      </div>`:r`
      ...
      ${e.source==="api"&&this.buildingFloors.length>1?r`<div class="floorbtns" role="group" aria-label="מעבר מהיר בין קומות" data-floor-buttons>
            ${this.buildingFloors.map(t=>r`<button class=${t.id===this.floorId?"on":""} data-floor-button=${t.id} title=${`${t.name}${t.hasPlan?"":" · אין תוכנית"}`} aria-pressed=${t.id===this.floorId} @click=${()=>{t.id!==this.floorId&&$(`/explore/floors/${t.id}`)}}>${t.short}</button>`)}
          </div>`:d}
    ...
    `}render(){const e=this.bundle,t=this.floors,s=t.find(n=>n.id===this.floorId),i=e?e.source==="demo"?s?.cameraCount??0:e.anchors.filter(n=>n.resource_type==="camera").length:0,a=this.tree?.source==="api"?this.tree.sites.flatMap(n=>(n.buildings??[]).flatMap(o=>o.floors??[])).find(n=>n.id===this.floorId):null;return r`
      <div class="head">
        ...
        <div class="tools">
          <div class="layers" role="group" aria-label=${x("floor.layers")}>
            ${lr.map(n=>r`<button class=${this.layers.has(n.id)?"on":""} title=${n.label()} aria-label=${n.label()} aria-pressed=${this.layers.has(n.id)} @click=${()=>this.toggleLayer(n.id)}><sw-icon name=${n.icon} size=${14}></sw-icon></button>`)}
          </div>
          <sw-button icon="layers" aria-pressed=${this.panel} @click=${()=>this.panel=!this.panel}>${x("floor.layers")}</sw-button>
          ...
          <sw-field style="min-inline-size:280px"><select aria-label=${x("floor.switcher")} @change=${n=>$(`/explore/floors/${n.target.value}`)}>${t.map(n=>r`<option value=${n.id} ?selected=${n.id===this.floorId}>${Lt(n.name)} · ${n.cameraCount} מצלמות${n.hasPlan?"":" · אין תוכנית"}</option>`)}</select></sw-field>
          ${!e||e.permissions.edit?r`<sw-button icon="edit" @click=${()=>$(`/explore/floors/${this.floorId}/edit`)}>עריכת תוכנית</sw-button>`:d}
        </div>
      </div>
  ...
  `;F([f()],V.prototype,"floorId",2);F([f()],V.prototype,"screenState",2);F([f()],V.prototype,"focusZone",2);F([f()],V.prototype,"focusCamera",2);F([f()],V.prototype,"focusEntity",2);F([c()],V.prototype,"selectedZoneId",2);F([c()],V.prototype,"bundle",2);F([c()],V.prototype,"tree",2);F([c()],V.prototype,"loadError",2);F([c()],V.prototype,"noFloors",2);F([c()],V.prototype,"selectedId",2);F([c()],V.prototype,"anchor",2);F([c()],V.prototype,"layers",2);F([c()],V.prototype,"geometry",2);F([c()],V.prototype,"pinned",2);F([c()],V.prototype,"panel",2);F([c()],V.prototype,"multi",2);F([c()],V.prototype,"sideList",2);F([c()],V.prototype,"jumpZoom",2);F([c()],V.prototype,"saveView",2);F([c()],V.prototype,"savedView",2);F([c()],V.prototype,"picked",2);F([c()],V.prototype,"narrow",2);F([c()],V.prototype,"syncConnected",2);F([c()],V.prototype,"action",2);F([c()],V.prototype,"confirmSpec",2);F([ns("sw-plan-canvas")],V.prototype,"canvas",2);F([ns(".stage")],V.prototype,"stage",2);F([c()],V.prototype,"actionArgs",2);F([c()],V.prototype,"renaming",2);F([c()],V.prototype,"notice",2);V=F([E("explore-floor-map")],V);var Od=Object.defineProperty,Rd=Object.getOwnPropertyDescriptor,Wt=(e,t,s,i)=>{for(var a=i>1?void 0:i?Rd(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&Od(t,s,a),a};let lt=class extends z{constructor(){super(...arguments),this.heading="",this.subheading="",this.crumbs="",this.backHref="",this.wide=!1,this.flush=!1}render(){const e=this.crumbs?this.crumbs.split("|").map(t=>t.trim()):[];return r`
      <header>
        <div>
          ${e.length?r`<div class="crumbs">${e.map((t,s)=>r`${s?r`<sw-icon name="chevron" size=${11}></sw-icon>`:""}<span>${t}</span>`)}</div>`:""}
          <div class="titlebar">
            ${this.backHref?r`<sw-button class="back" data-page-back variant="ghost" size="sm" iconOnly icon="chevronBack" label=${x("actions.back")} @click=${()=>$(this.backHref)}></sw-button>`:""}
            <h1>${this.heading}</h1>
          </div>
          ${this.subheading?r`<div class="sub">${this.subheading}</div>`:""}
        </div>
  ...
  `;Wt([f()],lt.prototype,"heading",2);Wt([f()],lt.prototype,"subheading",2);Wt([f()],lt.prototype,"crumbs",2);Wt([f()],lt.prototype,"backHref",2);Wt([f({type:Boolean,reflect:!0})],lt.prototype,"wide",2);Wt([f({type:Boolean,reflect:!0})],lt.prototype,"flush",2);lt=Wt([E("sw-page")],lt);var Nd=Object.defineProperty,Bd=Object.getOwnPropertyDescriptor,js=(e,t,s,i)=>{for(var a=i>1?void 0:i?Bd(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&Nd(t,s,a),a};let Ht=class extends z{constructor(){super(...arguments),this.heading="",this.subheading="",this.flush=!1,this.interactive=!1}render(){return r`
  ...
  `;js([f()],Ht.prototype,"heading",2);js([f()],Ht.prototype,"subheading",2);js([f({type:Boolean,reflect:!0})],Ht.prototype,"flush",2);js([f({type:Boolean,reflect:!0})],Ht.prototype,"interactive",2);Ht=js([E("sw-card")],Ht);var Ld=Object.defineProperty,Vd=Object.getOwnPropertyDescriptor,ut=(e,t,s,i)=>{for(var a=i>1?void 0:i?Vd(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&Ld(t,s,a),a};const Hd=["house","building","warehouse"];let Ze=class extends z{constructor(){super(...arguments),this.tab="all",this.tree=null,this.dialog=null,this.notice="",this.formName="",this.formAddress="",this.busy=!1,this.error=""}connectedCallback(){super.connectedCallback(),this.reload()}async reload(){try{this.tree=await St()}catch(e){this.error=w(e)}}open(e){this.formName=e&&e.kind==="edit-site"?e.site.name:e&&e.kind==="edit-building"?e.building.name:"",this.formAddress=e&&e.kind==="edit-site"?e.site.address:"",this.error="",this.dialog=e}pickImage(e,t){const s=document.createElement("input");s.type="file",s.accept="image/png,image/jpeg",s.addEventListener("change",async()=>{const i=s.files?.[0];if(i){this.busy=!0;try{await td(e,t,i),this.notice="התמונה נשמרה.",await this.reload()}catch(a){this.notice=w(a)}finally{this.busy=!1}}}),s.click()}async removeImage(e,t){this.busy=!0;try{await sd(e,t),await this.reload()}catch(s){this.notice=w(s)}finally{this.busy=!1}}renderMenu(e,t,s){const i=s?!!s.image_url:!!t.image_url,a=s?s.id:t.id;return r`<span class="menu" @click=${o=>o.stopPropagation()}>
    ...
    </span>`}async submit(){const e=this.dialog;if(e){this.busy=!0,this.error="";try{if(e.kind==="site"){const t=await ql({name:this.formName.trim(),address:this.formAddress.trim()});this.dialog=null,await this.reload(),this.open({kind:"building",site:t})}else if(e.kind==="building"){const t=await vn(e.site.id,{name:this.formName.trim()});this.dialog=null,$(`/explore/buildings/${t.id}/floors`)}else e.kind==="edit-site"?(await Kl(e.site.id,{name:this.formName.trim(),address:this.formAddress.trim()}),this.dialog=null,await this.reload()):e.kind==="edit-building"?(await Yl(e.building.id,{name:this.formName.trim()}),this.dialog=null,await this.reload()):e.kind==="delete-site"?(await Gl(e.site.id),this.dialog=null,await this.reload()):e.kind==="delete-building"&&(await Jl(e.building.id),this.dialog=null,await this.reload())}catch(t){this.error=w(t)}finally{this.busy=!1}}}openSite(e){const t=e.buildings?.[0];t?$(`/explore/buildings/${t.id}/floors`):this.open({kind:"building",site:e})}renderSites(e){return r`<div class="grid">
      ${e.sites.map((t,s)=>{const i=t.buildings??[],a=i.reduce((n,o)=>n+(o.floors??[]).reduce((l,p)=>l+p.camera_count,0),0);return r`<sw-card flush interactive data-site-card=${t.id} @click=${()=>this.openSite(t)}>
          <div class="pic">${t.image_url?r`<img class="photo" src=${rr(t.image_url)} alt="" />`:r`<sw-scene kind=${Hd[s%3]}></sw-scene>${e.source==="demo"?r`<span class="demo">דמו</span>`:r`<span class="demo">איור</span>`}`}</div>
          <div class="info">
      ...
      ${t.map(({s,b:i},a)=>r`<sw-card class="brow" data-building-card=${i.id} @click=${()=>$(`/explore/buildings/${i.id}/floors`)}>
          ${i.image_url?r`<img class="photo small" src=${rr(i.image_url)} alt="" />`:r`<sw-scene kind=${a%2?"house":"building"}></sw-scene>`}
  ...
  `;ut([c()],Ze.prototype,"tab",2);ut([c()],Ze.prototype,"tree",2);ut([c()],Ze.prototype,"dialog",2);ut([c()],Ze.prototype,"notice",2);ut([c()],Ze.prototype,"formName",2);ut([c()],Ze.prototype,"formAddress",2);ut([c()],Ze.prototype,"busy",2);ut([c()],Ze.prototype,"error",2);Ze=ut([E("explore-sites")],Ze);var jd=Object.defineProperty,Fd=Object.getOwnPropertyDescriptor,Fs=(e,t,s,i)=>{for(var a=i>1?void 0:i?Fd(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&jd(t,s,a),a};let jt=class extends z{constructor(){super(...arguments),this.rooms=[],this.selected=!1,this.empty=!1,this.width=132}iso(e,t){return{x:60+(e-t)*58,y:6+(e+t)*26}}poly(e){return e.map(t=>`${t.x.toFixed(1)},${t.y.toFixed(1)}`).join(" ")}render(){this.style.setProperty("--w",`${this.width}px`);const e=[this.iso(0,0),this.iso(1,0),this.iso(1,1),this.iso(0,1)],t=7,s=[this.iso(1,0),this.iso(1,1),{x:this.iso(1,1).x,y:this.iso(1,1).y+t},{x:this.iso(1,0).x,y:this.iso(1,0).y+t}],i=[this.iso(0,1),this.iso(1,1),{x:this.iso(1,1).x,y:this.iso(1,1).y+t},{x:this.iso(0,1).x,y:this.iso(0,1).y+t}];return r`<svg viewBox="0 0 120 72" aria-hidden="true">
  ...
  `;Fs([f({attribute:!1})],jt.prototype,"rooms",2);Fs([f({type:Boolean,reflect:!0})],jt.prototype,"selected",2);Fs([f({type:Boolean,reflect:!0})],jt.prototype,"empty",2);Fs([f({type:Number})],jt.prototype,"width",2);jt=Fs([E("sw-floor-iso")],jt);var Wd=Object.defineProperty,Ud=Object.getOwnPropertyDescriptor,it=(e,t,s,i)=>{for(var a=i>1?void 0:i?Ud(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&Wd(t,s,a),a};let Oe=class extends z{constructor(){super(...arguments),this.buildingId="bld-a",this.tree=null,this.selected=null,this.tab="floors",this.dialog=null,this.busy=!1,this.error="",this.formName="",this.formLevel=0}connectedCallback(){super.connectedCallback(),this.reload()}updated(e){e.has("buildingId")&&e.get("buildingId")!==void 0&&(this.selected=null)}async reload(){try{this.tree=await St(),this.error=""}catch(e){this.error=w(e)}}get context(){if(!this.tree)return null;for(const s of this.tree.sites)for(const i of s.buildings??[])if(i.id===this.buildingId)return{site:s,building:i};const e=this.tree.sites[0],t=e?.buildings?.[0];return e&&t?{site:e,building:t}:null}async run(e){this.busy=!0,this.error="";try{await e(),this.dialog=null,await this.reload()}catch(t){t instanceof ue&&t.code==="has_anchors"&&this.dialog?.kind==="delete"?(this.dialog={...this.dialog,force:!0},this.error=`${t.body.user_message} (${t.body.details.anchors??""} פריטים)`):this.error=w(t)}finally{this.busy=!1}}openDialog(e){this.error="",this.formName=e?.kind==="rename"?e.floor.name:"",this.formLevel=e?.kind==="rename"?e.floor.level:0,this.dialog=e}renderDialog(e){const t=this.dialog;if(!t)return d;const s=this.tree?.source==="demo",i=r`<sw-field label="שם"><input .value=${this.formName} @input=${l=>this.formName=l.target.value} placeholder="למשל: קומה 1" autofocus /></sw-field>`,a=r`<sw-field label="מפלס (0 = קרקע, שלילי = מרתף)" hint="קובע את סדר התצוגה בין הקומות"><input type="number" data-ltr .value=${String(this.formLevel)} @input=${l=>this.formLevel=Number(l.target.value)} /></sw-field>`,n=this.error?r`<div class="err">${this.error}</div>`:d,o=s?r`<div class="err">נתוני הדגמה: אין שרת מחובר, השינוי לא יישמר.</div>`:d;switch(t.kind){case"floor":return r`<sw-dialog open heading="קומה חדשה" subheading=${`${e.name}`} @close=${()=>this.dialog=null}>
          ${i}${a}${n}${o}
          <sw-button slot="footer" variant="ghost" @click=${()=>this.dialog=null}>ביטול</sw-button>
          <sw-button slot="footer" variant="primary" ?disabled=${!this.formName.trim()||this.busy||s} @click=${()=>this.run(async()=>{const l=await Xl(e.id,{name:this.formName.trim(),level:this.formLevel});this.selected=l.id})}>הוסף קומה</sw-button>
        </sw-dialog>`;case"rename":return r`<sw-dialog open heading="עריכת קומה" subheading=${t.floor.name} @close=${()=>this.dialog=null}>
          ${i}${a}${n}${o}
          <sw-button slot="footer" variant="ghost" @click=${()=>this.dialog=null}>ביטול</sw-button>
          <sw-button slot="footer" variant="primary" ?disabled=${!this.formName.trim()||this.busy||s} @click=${()=>this.run(()=>Ql(t.floor.id,{name:this.formName.trim(),level:this.formLevel}))}>שמירה</sw-button>
          ...
          ${n}${o}
          <sw-button slot="footer" variant="ghost" @click=${()=>this.dialog=null}>ביטול</sw-button>
          <sw-button slot="footer" variant="danger" ?disabled=${this.busy||s} @click=${()=>this.run(async()=>{await ed(t.floor.id,t.force),this.selected===t.floor.id&&(this.selected=null)})}>${t.force?"מחק כולל הפריטים":"מחק קומה"}</sw-button>
          ...
          ${i}${n}${o}
          <sw-button slot="footer" variant="ghost" @click=${()=>this.dialog=null}>ביטול</sw-button>
          <sw-button slot="footer" variant="primary" ?disabled=${!this.formName.trim()||this.busy||s} @click=${()=>this.run(async()=>{const l=await vn(this.context.site.id,{name:this.formName.trim()});$(`/explore/buildings/${l.id}/floors`)})}>הוסף מבנה</sw-button>
      ...
      <sw-page heading=${s.name} subheading=${`${t.address||t.name} · ${i.length} קומות${o.source==="demo"?" · נתוני הדגמה":""}`} crumbs=${`אתרים | ${t.name} | ${s.name}`}>
        ...
        ${this.tab==="floors"?r`<div class="list">
              ...
              ${i.map(l=>r`<button class="floor ${a?.id===l.id?"on":""}" @click=${()=>a?.id===l.id?$(`/explore/floors/${l.id}`):this.selected=l.id} aria-pressed=${a?.id===l.id}>
                  <div class="txt">
                    <div class="title">${Lt(l.name)}</div>
                    <div class="counts">${l.camera_count} מצלמות · ${l.anchor_count} פריטים במפה · מפלס ${id(l.level)}${l.has_plan?"":" · אין תוכנית עדיין"}${l.draft_version_id?" · טיוטה ממתינה לפרסום":""}</div>
                  </div>
                  <sw-floor-iso .rooms=${o.source==="demo"?Ji(l.id):[]} ?selected=${a?.id===l.id} ?empty=${!l.has_plan} width=${128}></sw-floor-iso>
            ...
            </div>`:this.tab==="cameras"?r`<div class="cams">${i.map(l=>r`<sw-card heading=${Lt(l.name)} subheading="${l.camera_count} מצלמות" interactive @click=${()=>$(`/explore/floors/${l.id}`)}></sw-card>`)}</div>`:r`<sw-card heading="פרטי המבנה">
                <dl>
  ...
  `;it([f()],Oe.prototype,"buildingId",2);it([c()],Oe.prototype,"tree",2);it([c()],Oe.prototype,"selected",2);it([c()],Oe.prototype,"tab",2);it([c()],Oe.prototype,"dialog",2);it([c()],Oe.prototype,"busy",2);it([c()],Oe.prototype,"error",2);it([c()],Oe.prototype,"formName",2);it([c()],Oe.prototype,"formLevel",2);Oe=it([E("explore-floors")],Oe);var Zd=Object.defineProperty,qd=Object.getOwnPropertyDescriptor,Ea=(e,t,s,i)=>{for(var a=i>1?void 0:i?qd(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&Zd(t,s,a),a};let Rs=class extends z{constructor(){super(...arguments),this.steps=[],this.current=0}render(){return r`${this.steps.map((e,t)=>r`
  ...
  `;Ea([f({attribute:!1})],Rs.prototype,"steps",2);Ea([f({type:Number})],Rs.prototype,"current",2);Rs=Ea([E("sw-steps")],Rs);var Kd=Object.defineProperty,Gd=Object.getOwnPropertyDescriptor,ne=(e,t,s,i)=>{for(var a=i>1?void 0:i?Gd(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&Kd(t,s,a),a};const Ti=["קובץ","עמוד","חיתוך וסיבוב","שם והערות","שמירה ופרסום"];function cr(e){return e>=1024*1024?`${(e/1024/1024).toFixed(1)} MB`:`${Math.max(1,Math.round(e/1024))} KB`}let te=class extends z{constructor(){super(...arguments),this.floorId="",this.step=0,this.tree=null,this.assets=[],this.asset=null,this.page=1,this.rotation=0,this.crop={x:0,y:0,w:1,h:1},this.notes="",this.version=null,this.busy=!1,this.error="",this.dragOver=!1,this.dxf=null,this.dxfLayers=null,this.dxfUnits=null,this.dxfBusy=!1,this.previewBust=0,this.startCrop=e=>{if(e.button!==0)return;const t=e.currentTarget,s=t.getBoundingClientRect(),i=l=>({x:Math.min(1,Math.max(0,(l.clientX-s.left)/s.width)),y:Math.min(1,Math.max(0,(l.clientY-s.top)/s.height))}),a=i(e);t.setPointerCapture(e.pointerId),e.preventDefault();const n=l=>{const p=i(l),h=Math.min(a.x,p.x),m=Math.min(a.y,p.y),g=Math.abs(p.x-a.x),v=Math.abs(p.y-a.y);g>.01&&v>.01&&(this.crop={x:+h.toFixed(4),y:+m.toFixed(4),w:+g.toFixed(4),h:+v.toFixed(4)})},o=()=>{t.removeEventListener("pointermove",n),t.removeEventListener("pointerup",o),t.removeEventListener("pointercancel",o),(this.crop.w<.02||this.crop.h<.02)&&(this.crop={x:0,y:0,w:1,h:1})};t.addEventListener("pointermove",n),t.addEventListener("pointerup",o),t.addEventListener("pointercancel",o)}}connectedCallback(){super.connectedCallback(),this.init()}async init(){try{this.tree=await St(),y()&&this.floorId&&(this.assets=(await Tl(this.floorId)).assets)}catch(e){this.error=w(e)}}get floor(){return this.tree&&this.floorId?bn(this.tree,this.floorId):null}updated(e){if(e.has("asset")&&y()){const t=this.asset;t&&t.kind==="dxf"&&(!this.dxf||this.dxf.asset_id!==t.id)?this.loadDxf(t.id):(!t||t.kind!=="dxf")&&(this.dxf=null)}}async loadDxf(e){try{const t=await Wl(e);this.dxf=t,this.dxfLayers=t.options.layers,this.dxfUnits=t.options.units??(t.info?.units&&t.info.units!=="unitless"?t.info.units:null)}catch(t){this.error=w(t)}}toggleDxfLayer(e){const t=this.dxf?.info?.layers.filter(i=>i.drawable>0).map(i=>i.name)??[],s=this.dxfLayers??t;this.dxfLayers=s.includes(e)?s.filter(i=>i!==e):[...s,e]}async applyDxf(){if(this.dxf){this.dxfBusy=!0,this.error="";try{const e=this.dxf.info?.layers.filter(s=>s.drawable>0).map(s=>s.name)??[],t=this.dxfLayers&&this.dxfLayers.length!==e.length?this.dxfLayers:null;this.dxf=await Ul(this.dxf.asset_id,{layers:t,units:this.dxfUnits}),this.dxfLayers=this.dxf.options.layers,this.previewBust=Date.now()}catch(e){this.error=w(e)}finally{this.dxfBusy=!1}}}renderDxf(){const e=this.dxf;if(!e||!e.info)return d;const t=e.info.layers.filter(l=>l.drawable>0).map(l=>l.name),s=this.dxfLayers??t,i=e.info.extent,a=Object.entries(e.render?.skipped??e.info.unsupported),n=e.render?.meters_per_px,o=e.render?.units&&e.render.units!=="unitless";return r`<sw-card heading="DXF · שכבות, יחידות וקנה מידה" subheading=${`${e.adapter.library} (${e.adapter.license}) · המקור נשמר כפי שהועלה; התצוגה נגזרת ממנו`} data-dxf>
      ...
      <div class="note">DWG אינו נתמך (פורמט סגור) — יש להמיר ל־DXF לפני הייבוא.</div>
    </sw-card>`}async onFile(e){if(!(!e||!this.floorId)){this.busy=!0,this.error="";try{this.asset=await Ol(this.floorId,e),this.page=1,this.rotation=0,this.crop={x:0,y:0,w:1,h:1},this.version=null,this.step=this.asset.page_count>1?1:2,this.assets=[this.asset,...this.assets.filter(t=>t.id!==this.asset.id)]}catch(t){this.error=w(t)}finally{this.busy=!1}}}async save(){if(!(!this.asset||!this.floorId)){this.busy=!0,this.error="";try{const e=this.crop.x===0&&this.crop.y===0&&this.crop.w===1&&this.crop.h===1;this.version=await Nl(this.floorId,{asset_id:this.asset.id,page:this.page,rotation:this.rotation,crop:e?null:this.crop,notes:this.notes})}catch(e){this.error=w(e)}finally{this.busy=!1}}}async publish(){if(this.version){this.busy=!0,this.error="";try{this.version=await aa(this.version.id)}catch(e){this.error=w(e)}finally{this.busy=!1}}}setCrop(e,t){const s=Math.max(0,Math.min(100,t))/100,i={...this.crop,[e]:s};i.x+i.w>1&&(i.w=1-i.x),i.y+i.h>1&&(i.h=1-i.y),i.w<=.02&&(i.w=.02),i.h<=.02&&(i.h=.02),this.crop=i}previewUrl(){const e=this.asset?.pages.find(s=>s.page===this.page)??this.asset?.pages[0];if(!e)return"";const t=Qe(e.preview_url)+(this.previewBust?`${e.preview_url.includes("?")?"&":"?"}v=${this.previewBust}`:"");return this.rotation?`${t}${t.includes("?")?"&":"?"}rotation=${this.rotation}`:t}renderStep(){const e=this.asset;switch(this.step){case 0:return r`
          ...
          ${this.version?r`<div class="ok">✓ הגרסה נשמרה (${this.version.width_px}×${this.version.height_px} px) · ${this.version.status==="published"?"פורסמה — היא הרקע של הקומה":"טיוטה — עורכי הקומה רואים אותה, צופים עדיין לא"}</div>
                <div class="preview" style="min-block-size:220px"><img src=${Qe(this.version.image_url)} alt="רקע התוכנית" /></div>`:r`<div class="note">סיכום: ${e?.original_name} · עמוד ${this.page} · סיבוב ${this.rotation}° · חיתוך ${Math.round(this.crop.w*100)}%×${Math.round(this.crop.h*100)}%. השמירה מייצרת רקע נגזר; המקור לא משתנה.</div>`}
          <div class="row">
            ...
            ${this.version?r`<sw-button icon="map" @click=${()=>$(`/explore/floors/${this.floorId}`)}>פתח במפה</sw-button><sw-button variant="ghost" icon="edit" @click=${()=>$(`/explore/floors/${this.floorId}/edit`)}>הצב מצלמות</sw-button>`:d}
      ...
      <sw-page heading=${e?`ייבוא תוכנית ל${e.floor.name}`:"ייבוא תוכנית"} subheading="המקור נשמר ללא שינוי; כל תיקון הוא שכבה נגזרת" crumbs=${e?`אתרים | ${e.site.name} | ${e.building.name} | ${e.floor.name}`:"אתרים"}>
        ${y()?!this.floorId||this.tree&&!e?r`<sw-state-panel state="empty" heading="בחר קומה" hint="ייבוא תוכנית מתחיל מדף הקומות."><div style="margin-block-start:10px"><sw-button variant="primary" @click=${()=>$("/explore/sites")}>לאתרים</sw-button></div></sw-state-panel>`:r`
                <sw-card><sw-steps .steps=${Ti} .current=${this.step}></sw-steps></sw-card>
                <div class="layout">
                  <div class="stage">${this.renderStep()}${this.error?r`<div class="err">${this.error}</div>`:d}</div>
                  <div class="side">
                    <sw-card heading="קובץ">
                      ${this.asset?r`<div class="note">${this.asset.original_name}</div><div class="row" style="margin-block-start:6px"><sw-badge kind="neutral" label=${`${this.asset.mime.split("/")[1].toUpperCase()} · ${cr(this.asset.bytes)} · ${this.asset.page_count} עמ׳`}></sw-badge></div><div class="note ltr" style="margin-block-start:6px">sha256 ${this.asset.sha256.slice(0,16)}…</div>`:r`<div class="note">עדיין לא נבחר קובץ.</div>`}
                    </sw-card>
                    ${this.renderDxf()}
                    ...
                    <div class="foot">
                      ...
                      ${this.step<Ti.length-1?r`<sw-button variant="primary" ?disabled=${!t||this.busy} @click=${()=>this.step=Math.min(Ti.length-1,this.step+1)}>הבא</sw-button>`:d}
                    </div>
                  </div>
                </div>`:this.renderDemo()}
      </sw-page>
  ...
  `;ne([f()],te.prototype,"floorId",2);ne([c()],te.prototype,"step",2);ne([c()],te.prototype,"tree",2);ne([c()],te.prototype,"assets",2);ne([c()],te.prototype,"asset",2);ne([c()],te.prototype,"page",2);ne([c()],te.prototype,"rotation",2);ne([c()],te.prototype,"crop",2);ne([c()],te.prototype,"notes",2);ne([c()],te.prototype,"version",2);ne([c()],te.prototype,"busy",2);ne([c()],te.prototype,"error",2);ne([c()],te.prototype,"dragOver",2);ne([c()],te.prototype,"dxf",2);ne([c()],te.prototype,"dxfLayers",2);ne([c()],te.prototype,"dxfUnits",2);ne([c()],te.prototype,"dxfBusy",2);ne([c()],te.prototype,"previewBust",2);te=ne([E("explore-plan-import")],te);const Oi={white:"לבן",tint:"גוון לכל חדר",none:"ללא מילוי"};async function Yd(e,t){const s=await A(`plan-versions/${e}/stylize`,t);return{...s,source_url:Qe(s.source_url)+`?v=${Date.now()}`,stylized_url:Qe(s.stylized_url)+`?v=${Date.now()}`}}const Jd=(e,t)=>Be(`plan-versions/${e}`,{render_mode:t});let ei=null,qs=null;const Xd={"media.transport_default":"mse","media.max_live_sessions":8,"media.wall_profile":"sub","snapshots.max_age_s":60};async function Ve(e=!1){return y()?ei&&!e?ei:(qs||(qs=an().then(t=>ei=t.settings).finally(()=>qs=null)),qs):Xd}function pr(){ei=null}function Aa(e){return rn()||e?.["media.transport_default"]||"mse"}const Qd={load:e=>Sa(e,{draft:!0}),save:(e,t,s)=>Sd(e,t,s)};class ec{constructor(t,s=Qd,i=2e3){this.host=t,this.api=s,this.delayMs=i,this.doc=null,this.revision=0,this.hash=null,this.publishedHash=null,this.issues=[],this.copyCandidates=[],this.saveState="idle",this.error="",this.versionId=null,this.undoStack=[],this.redoStack=[],this.dirty=!1,this.inflight=null,this.conflicted=!1,this.loadToken=0,this.loaded=0,t.addController(this)}hostConnected(){}hostDisconnected(){clearTimeout(this.timer)}get canUndo(){return this.undoStack.length>0}get canRedo(){return this.redoStack.length>0}get hasConflict(){return this.conflicted}get pendingPublish(){const t=this.doc;return!t||!this.hash||this.hash===this.publishedHash?!1:this.publishedHash!==null||t.walls.length>0||t.openings.length>0||t.labels.length>0||t.objects.length>0||t.connectors.length>0}async load(t){clearTimeout(this.timer);const s=++this.loadToken;let i;try{i=await this.api.load(t)}catch(a){if(s===this.loadToken)throw a;return}s===this.loadToken&&(this.loaded=s,this.versionId=t,this.apply(i),this.doc=i.doc,this.copyCandidates=i.copy_candidates??[],this.undoStack=[],this.redoStack=[],this.dirty=!1,this.conflicted=!1,this.saveState="idle",this.error="",this.host.requestUpdate())}commit(t){this.doc&&(this.undoStack=[...this.undoStack.slice(-59),this.doc],this.redoStack=[],this.change(t))}undo(){const t=this.undoStack.pop();!t||!this.doc||(this.redoStack.push(this.doc),this.change(t))}redo(){const t=this.redoStack.pop();!t||!this.doc||(this.undoStack.push(this.doc),this.change(t))}async flush(){clearTimeout(this.timer);let t=!1;for(;;){if(this.inflight){await this.inflight;continue}if(!this.dirty||this.conflicted||t&&this.saveState==="error")break;t=!0,this.inflight=this.saveOnce(),await this.inflight,this.inflight=null}return!this.dirty&&this.saveState!=="error"}change(t){this.doc=t,this.dirty=!0,clearTimeout(this.timer),this.conflicted||(this.saveState!=="saving"&&(this.saveState="pending"),this.timer=setTimeout(()=>void this.flush(),this.delayMs)),this.host.requestUpdate()}apply(t){this.revision=t.geometry.revision,this.hash=t.geometry.doc_hash,this.publishedHash=t.published_hash,this.issues=t.issues}async saveOnce(){const t=this.doc,s=this.versionId,i=this.loaded;if(!(!t||!s)){this.dirty=!1,this.saveState="saving",this.host.requestUpdate();try{const a=await this.api.save(s,t,this.revision);if(i!==this.loaded)return;this.apply(a),this.saveState=this.dirty?"pending":"saved",this.error=""}catch(a){if(i!==this.loaded)return;this.dirty=!0,a instanceof ue&&a.code==="stale_revision"&&(this.conflicted=!0),this.saveState="error",this.error=this.conflicted?"טיוטת המבנה נערכה במקום אחר; טען מחדש את העורך כדי לא לדרוס שינוי.":w(a)}finally{this.host.requestUpdate()}}}}function Pa(){const e=new Uint8Array(8);return crypto.getRandomValues(e),Array.from(e,t=>t.toString(16).padStart(2,"0")).join("")}const li=e=>Math.round(e*1e5)/1e5,_i=e=>[li(Math.min(1,Math.max(0,e[0]))),li(Math.min(1,Math.max(0,e[1])))];function Sn(e){return e.levels.find(t=>t.is_default)?.id??fl}function Mn(e){const t=e==="door"?"right":"none";return{kind:e,...wl[e],swing:t}}function tc(e,t,s){const i=Pa(),a={id:i,level_id:Sn(e),polyline:t.map(_i),thickness_m:s.thickness_m,height_m:null,base_z_m:0,kind:s.kind,confidence:1,source:"manual",locked:!1,external_ids:{}};return{doc:{...e,walls:[...e.walls,a]},id:i}}function sc(e,t,s,i){const a={id:Pa(),wall_id:t,t:li(Math.min(1,Math.max(0,s))),...Mn(i),hinge:"start",anchor_ref:null,confidence:1,source:"manual",external_ids:{}};return{doc:{...e,openings:[...e.openings,a]},id:a.id}}function ic(e,t,s){return{...e,walls:e.walls.map(i=>i.id===t?{...i,...s,id:i.id}:i)}}function hr(e,t,s){return{...e,openings:e.openings.map(i=>i.id===t?{...i,...s,id:i.id,t:s.t===void 0?i.t:li(Math.min(1,Math.max(0,s.t)))}:i)}}function Ri(e,t,s,i){return{...e,walls:e.walls.map(a=>a.id===t?{...a,polyline:a.polyline.map((n,o)=>o===s?_i(i):n)}:a)}}function ur(e,t){return e.walls.some(s=>s.id===t)?{...e,walls:e.walls.filter(s=>s.id!==t),openings:e.openings.filter(s=>s.wall_id!==t)}:{...e,openings:e.openings.filter(s=>s.id!==t),labels:e.labels.filter(s=>s.id!==t)}}function ac(e,t,s){const i={id:Pa(),text:s,position:_i(t),level_id:Sn(e),size:14};return{doc:{...e,labels:[...e.labels,i]},id:i.id}}function mr(e,t,s){return{...e,labels:e.labels.map(i=>i.id===t?{...i,...s,id:i.id,position:s.position?_i(s.position):i.position}:i)}}const Ni=[{id:"select",label:"בחירה",hint:"לחץ על קיר, פתח או תווית כדי לערוך. גרור פתח לאורך הקיר, תווית למקומה ופינה של קיר נבחר."},{id:"wall",label:"קיר",hint:"לחץ נקודה אחר נקודה. Enter או לחיצה חוזרת על הנקודה האחרונה מסיימים, לחיצה על הנקודה הראשונה סוגרת מתאר, Shift מבטל הצמדה לזוויות, Backspace מוחק נקודה."},{id:"door",label:"דלת",hint:"לחץ על קיר כדי להציב דלת. כיוון הפתיחה והציר נקבעים כאן בפאנל."},{id:"window",label:"חלון",hint:"לחץ על קיר כדי להציב חלון."},{id:"passage",label:"מעבר",hint:"פתח בלי דלת בקיר."},{id:"label",label:"תווית",hint:"לחץ במקום התווית ואז הקלד את הטקסט כאן בפאנל."}],ks={exterior:"חיצוני",interior:"פנימי",partition:"מחיצה",railing:"מעקה",low:"קיר נמוך"},Ks={door:"דלת",window:"חלון",passage:"מעבר"},fr={right:"לצד ימין של הקיר",left:"לצד שמאל של הקיר",double:"כנף כפולה",sliding:"הזזה",none:"ללא כנף"},gr={start:"בצד תחילת הקיר",end:"בצד סוף הקיר"},rc={idle:"טיוטת המבנה",pending:"שינויים ממתינים לשמירה…",saving:"שומר…",saved:"הטיוטה נשמרה · הצופים יראו אותה אחרי פרסום",error:"השמירה נכשלה"},nc={walls:"קירות",openings:"פתחים",labels:"תוויות",levels:"מפלסים",rooms:"חדרים",objects:"עצמים",circuits:"מעגלי תאורה",connectors:"מחברים",groups:"קבוצות"};function di(e,t,s=!0){return t&&!s?"לא מכויל":`${t?"≈":""}${e<10?e.toFixed(2):e.toFixed(1)} מ׳`}function oa(e,t,s){return e===1?t:`${e} ${s}`}function Ia(e){return`1 מ׳ = ${(1/e).toFixed(1)} פיקסלים בתוכנית`}function oc(e,t,s=!0){return t&&!s?"לא מכויל":`${t?"≈":""}${e<100?e.toFixed(1):e.toFixed(0)} מ״ר`}const Yt=e=>parseFloat(e.target.value);function lc(e,t){const{scale:s,estimated:i}=vs(e.doc),a=e.issues.filter(p=>p.severity==="error"),n=e.issues.filter(p=>p.severity==="warning"),o=Ni.find(p=>p.id===e.mode)??Ni[0],l=!e.doc.walls.length&&!e.doc.openings.length&&!e.doc.labels.length;return r`<sw-card heading="מבנה" subheading=${rc[e.saveState]} data-studio-panel data-studio-save=${e.saveState}>
    <div class="modes" role="group" aria-label="כלי ציור">
      ${Ni.map(p=>r`<button class=${p.id===e.mode?"on":""} data-studio-mode=${p.id} aria-pressed=${p.id===e.mode} @click=${()=>t.setMode(p.id)}>${p.label}</button>`)}
    </div>
    <div class="note">${o.hint}</div>
    ${e.mode==="wall"?dc(e.wallDefaults,t):d}
    <div class="row"><span class="lbl">קנה מידה<span class="muted" data-studio-scale>${i?e.showEstimates?"לא מכויל: מידות משוערות (≈)":"לא מכויל: מידות מוסתרות עד הכיול":Ia(s)}</span></span><sw-button size="sm" icon="scale" data-studio-calibrate @click=${()=>t.calibrate()}>${i?"כיול":"כיול מחדש"}</sw-button></div>
    <div class="note" data-studio-counts>${e.doc.walls.length} קירות · ${e.doc.openings.length} פתחים · ${e.doc.labels.length} תוויות</div>
    ${e.sel?cc(e,e.sel,t,s,i):d}
    ${a.length||n.length?mc(a,n,t):d}
    ${l&&e.copyCandidates.length?fc(e.copyCandidates,t,e.busy):d}
  ...
  </sw-card>`}function dc(e,t){return r`<div class="two">
    <sw-field label="עובי קיר (מ׳)"><input type="number" min="0.01" max="3" step="0.01" data-ltr data-wall-thickness .value=${String(e.thickness_m)}
      @change=${s=>{const i=Yt(s);i>0&&i<=3&&t.setWallDefaults({...e,thickness_m:i})}} /></sw-field>
    <sw-field label="סוג קיר"><select aria-label="סוג קיר" data-wall-kind @change=${s=>t.setWallDefaults({...e,kind:s.target.value})}>
      ${Object.keys(ks).map(s=>r`<option value=${s} ?selected=${e.kind===s}>${ks[s]}</option>`)}
    </select></sw-field>
  </div>`}function cc(e,t,s,i,a){if(t.kind==="wall"){const o=e.doc.walls.find(l=>l.id===t.id);return o?pc(o,e,s,i,a):d}if(t.kind==="opening"){const o=e.doc.openings.find(l=>l.id===t.id);return o?hc(o,s):d}const n=e.doc.labels.find(o=>o.id===t.id);return n?uc(n,s):d}function pc(e,t,s,i,a){const n=za(e.polyline,t.W,t.H)*i,o=t.doc.openings.filter(l=>l.wall_id===e.id).length;return r`<div class="sel" data-selected-wall=${e.id}>
    <div class="selhead"><strong>קיר ${ks[e.kind]}</strong><span class="muted">${di(n,a,t.showEstimates)} · ${o} פתחים</span></div>
    <div class="two">
      <sw-field label="עובי (מ׳)"><input type="number" min="0.01" max="3" step="0.01" data-ltr .value=${String(e.thickness_m)}
        @change=${l=>{const p=Yt(l);p>0&&p<=3&&s.patchWall(e.id,{thickness_m:p})}} /></sw-field>
      <sw-field label="סוג"><select aria-label="סוג קיר" @change=${l=>s.patchWall(e.id,{kind:l.target.value})}>
        ${Object.keys(ks).map(l=>r`<option value=${l} ?selected=${e.kind===l}>${ks[l]}</option>`)}
      </select></sw-field>
    </div>
  ...
  </div>`}function hc(e,t){return r`<div class="sel" data-selected-opening=${e.id}>
    <div class="selhead"><strong>${Ks[e.kind]}</strong><span class="muted">${e.width_m.toFixed(2)} מ׳ רוחב${e.anchor_ref?" · מקושר לישות":""}</span></div>
    <div class="two">
      <sw-field label="סוג"><select aria-label="סוג פתח" @change=${s=>t.patchOpening(e.id,Mn(s.target.value))}>
        ${Object.keys(Ks).map(s=>r`<option value=${s} ?selected=${e.kind===s}>${Ks[s]}</option>`)}
      </select></sw-field>
      <sw-field label="רוחב (מ׳)"><input type="number" min="0.1" max="10" step="0.05" data-ltr .value=${String(e.width_m)}
        @change=${s=>{const i=Yt(s);i>0&&i<=10&&t.patchOpening(e.id,{width_m:i})}} /></sw-field>
    </div>
    <div class="two">
      <sw-field label="גובה (מ׳)"><input type="number" min="0.1" max="10" step="0.05" data-ltr .value=${String(e.height_m)}
        @change=${s=>{const i=Yt(s);i>0&&i<=10&&t.patchOpening(e.id,{height_m:i})}} /></sw-field>
      ${e.kind==="window"?r`<sw-field label="גובה אדן (מ׳)"><input type="number" min="0" max="10" step="0.05" data-ltr .value=${String(e.sill_m)}
            @change=${s=>{const i=Yt(s);i>=0&&i<=10&&t.patchOpening(e.id,{sill_m:i})}} /></sw-field>`:d}
    </div>
    ${e.kind==="door"?r`<div class="two">
          <sw-field label="כיוון פתיחה"><select aria-label="כיוון פתיחה" @change=${s=>t.patchOpening(e.id,{swing:s.target.value})}>
            ${Object.keys(fr).map(s=>r`<option value=${s} ?selected=${e.swing===s}>${fr[s]}</option>`)}
          </select></sw-field>
          <sw-field label="ציר"><select aria-label="ציר" @change=${s=>t.patchOpening(e.id,{hinge:s.target.value})}>
            ${Object.keys(gr).map(s=>r`<option value=${s} ?selected=${e.hinge===s}>${gr[s]}</option>`)}
          </select></sw-field>
        </div>`:d}
    <div class="btns"><sw-button size="sm" variant="ghost" icon="trash" data-geom-delete @click=${()=>t.remove(e.id)}>מחק ${Ks[e.kind]}</sw-button></div>
  </div>`}function uc(e,t){return r`<div class="sel" data-selected-label=${e.id}>
    ...
    <sw-field label="גודל"><input type="number" min="6" max="200" step="1" data-ltr .value=${String(e.size)}
      @change=${s=>{const i=Yt(s);i>=6&&i<=200&&t.patchLabel(e.id,{size:i})}} /></sw-field>
    <div class="btns"><sw-button size="sm" variant="ghost" icon="trash" data-geom-delete @click=${()=>t.remove(e.id)}>מחק תווית</sw-button></div>
  </div>`}function mc(e,t,s){return r`<div class="issues" data-studio-issues>
  ...
  </div>`}function fc(e,t,s){return r`<div class="copy" data-copy-candidates>
    ...
    ${e.map(i=>r`<button class="issue" data-copy-from=${i.version_id} ?disabled=${s} @click=${()=>t.copyFrom(i.version_id)}>
      <span>העתק ${i.walls} קירות ו־${i.openings} פתחים מגרסה ${i.status==="published"?"מפורסמת":i.status==="draft"?"בטיוטה":"מהארכיון"}</span>
      <span class="muted">${i.same_drawing?"אותו שרטוט":"שרטוט אחר: המיקומים לא מיושרים, בדוק אותם"}</span>
    </button>`)}
  </div>`}function gc(e,t,s,i){const a=parseFloat(e.metres),n=e.pixels!==null&&e.pixels<5,o=!!e.a&&!!e.b&&e.pixels!==null&&e.pixels>=5&&a>0&&a<=1e3&&!e.busy,l=e.showEstimates?"התוכנית לא מכוילת: מידות מוצגות כמשוערות (≈)":"התוכנית לא מכוילת: מידות מוסתרות עד הכיול (הגדרות)";return r`<sw-card heading="כיול קנה מידה" subheading=${e.estimated?l:`מכויל · ${Ia(e.scale)}`} data-calib-panel>
    <ol class="steps">
  ...
  </sw-card>`}function wc(e,t,s,i,a,n,o){const l=e.length>1?za(e,t,s)*i:0;return r`<sw-card heading="מדידה" subheading=${a?n?"לא מכויל: הערכים משוערים (≈)":"לא מכויל: המידות מוסתרות עד הכיול (הגדרות)":"לפי הכיול של גרסת התוכנית"} data-measure-panel>
    <div class="note">לחץ נקודות על התוכנית. Shift מבטל הצמדה לזוויות, Esc מנקה.</div>
    <div class="measure-val" data-measure-distance>${e.length>1?di(l,a,n):"—"}</div>
    ${e.length>=3?r`<div class="note">שטח המצולע <span class="measure-val" data-measure-area>${oc(xl(e,t,s,i),a,n)}</span> · היקף ${di(kl(e,t,s,i),a,n)}</div>`:d}
...
`;var bc=Object.defineProperty,yc=Object.getOwnPropertyDescriptor,R=(e,t,s,i)=>{for(var a=i>1?void 0:i?yc(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&bc(t,s,a),a};const Gs=["#2767ED","#22A06B","#F59E0B","#8B5CF6","#0EA5E9","#EC4899","#14B8A6","#F97316"],$c=[{id:"select",icon:"target",label:"בחירה וגרירה",ready:!0},{id:"camera",icon:"camera",label:"הוספת מצלמה",ready:!0},{id:"lights",icon:"light",label:"הוספת תאורה (מפסקים)",ready:!0},{id:"entity",icon:"plus",label:"ישות HA אחרת",ready:!0},{id:"zones",icon:"map",label:"חדרים ואזורים",ready:!0},{id:"structure",icon:"wall",label:"מבנה: קירות, דלתות וחלונות",ready:!0},{id:"calibrate",icon:"scale",label:"כיול קנה מידה",ready:!0},{id:"measure",icon:"ruler",label:"מדידת מרחק ושטח",ready:!0},{id:"layers",icon:"layers",label:"שכבות",ready:!0}],wr=["structure","calibrate","measure"],At={a:null,b:null,metres:"",result:"",warning:""},Bi=(e,t)=>`${oa(e,"קיר אחד","קירות")}, ${oa(t,"פתח אחד","פתחים")}`,vr=[{id:"cameras",label:"מצלמות"},{id:"doors",label:"דלתות ומנעולים"},{id:"lights",label:"תאורה ומתגים"},{id:"sensors",label:"חיישנים"}],xc={asset:"קובץ",page:"עמוד",rotation:"סיבוב",crop:"חיתוך",width_px:"רוחב",height_px:"גובה"},Li=e=>e?new Intl.DateTimeFormat("he-IL",{dateStyle:"short",timeStyle:"short"}).format(new Date(e)):"";let T=class extends z{constructor(){super(...arguments),this.floorId="",this.presetEntity="",this.bundle=null,this.anchors=[],this.dirty=new Set,this.undo=[],this.redo=[],this.selectedId=null,this.tool="select",this.layers=new Set(["cameras","doors","lights","sensors"]),this.placing=null,this.entQ="",this.entResults=null,this.entBusy=!1,this.lightsAll=!1,this.busy=!1,this.error="",this.info="",this.stylizing=!1,this.stylized=null,this.stylizeOpts={strength:"medium",keepLines:!1,roomFill:"white"},this.zones=[],this.versions=[],this.diff=null,this.selectedZoneId=null,this.candidates=null,this.detecting=!1,this.detectStrength="medium",this.replaceAuto=!0,this.drawing=null,this.showZones=!0,this.zoneBusy=!1,this.studio=new ec(this),this.studioVersion=null,this.studioMode="wall",this.wallDefaults={thickness_m:.2,kind:"interior"},this.geomSel=null,this.wallDraft=null,this.lastDrawClick=null,this.hover=null,this.calib={...At},this.measurePts=[],this.geomDiff=null,this.showEstimates=!0,this.entTimer=0,this.onKey=e=>this.handleKey(e)}connectedCallback(){super.connectedCallback(),this.load(),window.addEventListener("keydown",this.onKey),this.presetEntity&&(this.tool="entity",this.entQ=this.presetEntity,this.searchEntities())}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("keydown",this.onKey),this.studio.flush()}async realign(e){if(!(!this.bundle||this.busy)){this.busy=!0;try{const t=await Vl(this.bundle.floorId,e);this.error=t.moved||!t.skipped?"":`${t.skipped} פריטים לא ניתנים ליישור אוטומטי (שרטוט אחר) — בדוק אותם ולחץ "אשר מיקומים".`,await this.load()}catch(t){this.error=w(t)}finally{this.busy=!1}}}async load(){this.error="";try{const e=await Ts(this.floorId||"f0",!0);this.bundle=e,this.loadStudio(e),Ve().then(t=>{this.showEstimates=t["plan.estimates"]!=="false"}).catch(()=>{}),this.anchors=e.anchors.map(t=>({...t,position:{...t.position}})),this.zones=e.zones,this.loadVersions(),this.selectedZoneId&&!this.zones.some(t=>t.id===this.selectedZoneId)&&(this.selectedZoneId=null),this.dirty=new Set,this.undo=[],this.redo=[],this.selectedId&&!this.anchors.some(t=>t.id===this.selectedId)&&(this.selectedId=null)}catch(e){this.error=w(e)}}get selected(){return this.anchors.find(e=>e.id===this.selectedId)}layerOf(e){return e.resource_type==="camera"?"cameras":e.layer_id==="doors"?"doors":e.layer_id==="lights"?"lights":"sensors"}get markers(){return this.anchors.filter(e=>this.layers.has(this.layerOf(e))).map(e=>({id:e.id,kind:e.resource_type==="camera"?"camera":ki(e.layer_id,e.entity?.domain),label:this.anchorName(e),x:e.position.x,y:e.position.y,rotation:e.rotation_degrees,fov:e.field_of_view_degrees??void 0,radius:e.coverage_radius??void 0,polygon:e.coverage_polygon?e.coverage_polygon.map(([t,s])=>({x:t,y:s})):void 0,labelPos:e.label_pos??void 0,state:e.resource_type==="camera"?this.bundle?.source==="demo"?"live":ys(e):"neutral"}))}anchorName(e){return e.resource_type==="camera"?e.camera?.name??e.label??e.resource_id:e.label??e.entity?.name??e.resource_id}get selectedZone(){return this.zones.find(e=>e.id===this.selectedZoneId)}get planZones(){if(!this.showZones)return[];const e=this.zones.map(s=>({id:s.id,name:s.name,kind:s.kind,color:s.color,polygon:s.polygon,labelPos:s.label_pos})),t=(this.candidates??[]).map((s,i)=>({id:`cand-${i}`,name:s.include?s.name:"",color:s.include?Gs[i%Gs.length]:"#9AA3B5",polygon:s.polygon,candidate:!0}));return[...e,...t]}async detect(){const e=this.bundle;if(e){if(e.source==="demo"){this.info="נתוני הדגמה: הזיהוי עובד מול השרת.";return}this.detecting=!0,this.error="";try{const t=await dd(e.floorId,this.detectStrength);this.candidates=t.rooms.map((s,i)=>({polygon:s.polygon,name:`חדר ${i+1}`,kind:"room",include:!0})),this.selectedZoneId=null,this.selectedId=null,this.info=t.rooms.length?`${t.rooms.length} חדרים זוהו · תן שמות ושמור`:"לא זוהו חדרים סגורים; נסה עוצמה אחרת או צייר אזור ידנית",setTimeout(()=>this.info="",5e3)}catch(t){this.error=w(t)}finally{this.detecting=!1}}}setCandidate(e,t){this.candidates&&(this.candidates=this.candidates.map((s,i)=>i===e?{...s,...t}:s))}async acceptCandidates(){const e=this.bundle,t=(this.candidates??[]).filter(s=>s.include);if(!(!e||!t.length)){this.zoneBusy=!0,this.error="";try{const s=await cd(e.floorId,t.map(i=>({polygon:i.polygon,name:i.name,kind:i.kind})),this.replaceAuto);this.candidates=null,this.zones=s.zones,this.info=`${s.created.length} חדרים נשמרו`,setTimeout(()=>this.info="",3e3)}catch(s){this.error=w(s)}finally{this.zoneBusy=!1}}}startDrawing(){this.drawing=[],this.placing=null,this.candidates=null,this.selectedZoneId=null,this.selectedId=null}addDraftPoint(e,t){const s=this.drawing,i=this.bundle;if(!(!s||!i)){if(s.length>=3){const a=this.canvas?.zoom??1;if(Math.hypot((e-s[0].x)*i.width*a,(t-s[0].y)*i.height*a)<12){this.finishDrawing();return}}this.drawing=[...s,{x:+e.toFixed(4),y:+t.toFixed(4)}]}}async finishDrawing(){const e=this.drawing,t=this.bundle;if(!(!e||!t||e.length<3)){if(t.source==="demo"){this.info="נתוני הדגמה: השמירה עובדת מול השרת.",this.drawing=null;return}this.zoneBusy=!0,this.error="";try{const s=await nd(t.floorId,{name:`אזור ${this.zones.length+1}`,kind:"zone",polygon:e});this.drawing=null,this.zones=[...this.zones,s],this.selectedZoneId=s.id,this.info="האזור נוצר · תן לו שם",setTimeout(()=>this.info="",3e3)}catch(s){this.error=w(s)}finally{this.zoneBusy=!1}}}async patchZone(e,t){if(this.bundle?.source!=="demo"){this.zoneBusy=!0,this.error="";try{const s=await od(e.id,{revision:e.revision,...t});this.zones=this.zones.map(i=>i.id===s.id?s:i)}catch(s){s instanceof ue&&s.status===409?(this.error="האזור השתנה בינתיים על ידי עורך אחר; נטען מחדש בלי לדרוס.",await this.load()):this.error=w(s)}finally{this.zoneBusy=!1}}}async removeZone(e){if(this.bundle?.source!=="demo"&&window.confirm(`למחוק את "${e.name}"? המצלמות והישויות בקומה לא מושפעות.`)){this.zoneBusy=!0,this.error="";try{await ld(e.id),this.zones=this.zones.filter(t=>t.id!==e.id),this.selectedZoneId===e.id&&(this.selectedZoneId=null)}catch(t){this.error=w(t)}finally{this.zoneBusy=!1}}}snapshot(){this.undo=[...this.undo.slice(-40),this.anchors.map(e=>({...e,position:{...e.position}}))],this.redo=[]}apply(e,t){this.snapshot(),this.anchors=this.anchors.map(s=>s.id===e?{...s,...t,position:t.position??s.position}:s),this.dirty=new Set(this.dirty).add(e)}nudge(e,t){const s=this.selected;s&&this.apply(s.id,{position:{x:+Math.min(1,Math.max(0,s.position.x+e)).toFixed(4),y:+Math.min(1,Math.max(0,s.position.y+t)).toFixed(4)}})}doUndo(){const e=this.undo[this.undo.length-1];e&&(this.redo=[...this.redo,this.anchors],this.undo=this.undo.slice(0,-1),this.anchors=e,this.dirty=new Set(this.anchors.map(t=>t.id)))}doRedo(){const e=this.redo[this.redo.length-1];e&&(this.undo=[...this.undo,this.anchors],this.redo=this.redo.slice(0,-1),this.anchors=e,this.dirty=new Set(this.anchors.map(t=>t.id)))}handleKey(e){const t=e.composedPath()[0],s=t&&(t.tagName==="INPUT"||t.tagName==="TEXTAREA"||t.tagName==="SELECT"||t.isContentEditable);if(e.key==="Escape"){this.wallDraft?(this.wallDraft=null,this.hover=null):this.tool==="measure"&&this.measurePts.length?this.measurePts=[]:this.tool==="calibrate"&&this.calib.a?this.calib={...At}:this.drawing?this.drawing=null:this.placing?this.placing=null:this.candidates?this.candidates=null:(this.selectedId=null,this.selectedZoneId=null,this.geomSel=null);return}if(s||this.studioOn&&this.handleStudioKey(e))return;if(e.key==="Enter"&&this.drawing){e.preventDefault(),this.finishDrawing();return}if((e.key==="Delete"||e.key==="Backspace")&&!this.selected&&this.selectedZone){e.preventDefault(),this.removeZone(this.selectedZone);return}if((e.ctrlKey||e.metaKey)&&e.key.toLowerCase()==="z"){e.preventDefault(),e.shiftKey?this.doRedo():this.doUndo();return}if((e.ctrlKey||e.metaKey)&&e.key.toLowerCase()==="y"){e.preventDefault(),this.doRedo();return}if((e.ctrlKey||e.metaKey)&&e.key.toLowerCase()==="s"){e.preventDefault(),this.save();return}if(!this.selected)return;const i=e.shiftKey?.01:.002;e.key==="ArrowLeft"?(e.preventDefault(),this.nudge(-i,0)):e.key==="ArrowRight"?(e.preventDefault(),this.nudge(i,0)):e.key==="ArrowUp"?(e.preventDefault(),this.nudge(0,-i)):e.key==="ArrowDown"?(e.preventDefault(),this.nudge(0,i)):(e.key==="Delete"||e.key==="Backspace")&&(e.preventDefault(),this.removeSelected())}async save(){if(!this.bundle||this.bundle.source==="demo")return this.info="נתוני הדגמה: השינויים נשמרים רק במסך זה.",this.dirty=new Set,!0;if(!this.dirty.size)return!0;this.busy=!0,this.error="";let e=!1;try{for(const t of this.dirty){const s=this.anchors.find(i=>i.id===t);if(s)try{const i=await gn(t,{revision:s.revision,x:s.position.x,y:s.position.y,rotation_degrees:s.rotation_degrees,field_of_view_degrees:s.field_of_view_degrees,label:s.label,coverage_radius:s.coverage_radius??null,coverage_polygon:s.coverage_polygon??null,label_pos:s.label_pos??"auto"});this.anchors=this.anchors.map(a=>a.id===t?{...a,revision:i.revision}:a)}catch(i){if(i instanceof ue&&i.code==="stale_revision")e=!0;else throw i}}return e?(this.error="חלק מהפריטים השתנו בינתיים על ידי עורך אחר; המפה נטענה מחדש בלי לדרוס את השינוי שלו.",await this.load(),!1):(this.dirty=new Set,this.info="המיקומים נשמרו",setTimeout(()=>this.info="",2500),!0)}catch(t){return this.error=w(t),!1}finally{this.busy=!1}}async place(e,t){const s=this.placing;if(!(!s||!this.bundle)){if(this.bundle.source==="demo"){this.info="נתוני הדגמה: הוספה עובדת מול השרת.",this.placing=null;return}if(!(this.dirty.size&&!await this.save())){this.busy=!0,this.error="";try{const i=s.kind==="camera"?await ar(this.bundle.floorId,{resource_type:"camera",resource_id:s.camera.id,x:e,y:t,rotation_degrees:0,field_of_view_degrees:90}):await ar(this.bundle.floorId,{resource_type:"ha_entity",resource_id:s.entity.entity_id,x:e,y:t,rotation_degrees:0,field_of_view_degrees:null});this.placing=null,await this.load(),this.selectedId=i.id,this.tool="select",this.info=`${this.anchorName(i)} הוצב · גרור לדיוק, קבע כיוון בידיות`,setTimeout(()=>this.info="",4e3)}catch(i){this.error=w(i)}finally{this.busy=!1}}}}async removeSelected(){const e=this.selected;if(!(!e||!this.bundle)){if(this.bundle.source==="demo"){this.info="נתוני הדגמה: הסרה עובדת מול השרת.";return}if(window.confirm(`להסיר את "${this.anchorName(e)}" מהמפה? המקור עצמו לא נמחק.`)){this.busy=!0,this.error="";try{await Hl(e.id),this.selectedId=null,await this.load()}catch(t){this.error=w(t)}finally{this.busy=!1}}}}async loadVersions(){const e=this.bundle;if(!e||e.source==="demo"||!e.permissions.edit){this.versions=[];return}try{this.versions=(await Rl(e.floorId)).versions}catch{this.versions=[]}}async publish(){const e=this.bundle;if(!e?.planVersionId||this.dirty.size&&!await this.save())return;if(!await this.studio.flush()){this.error=this.studio.error;return}if(this.error="",e.planStatus==="published"){await this.openGeomDiff(e.planVersionId);return}const t=this.versions.find(s=>s.id===e.planVersionId);if(!t){await this.publishNow(e.planVersionId);return}await this.openDiff("publish",t)}async openGeomDiff(e){this.geomDiff={versionId:e,data:null,error:""};try{const t=await Ed(e);this.geomDiff?.versionId===e&&(this.geomDiff={versionId:e,data:t,error:""})}catch(t){this.geomDiff?.versionId===e&&(this.geomDiff={versionId:e,data:null,error:w(t)})}}async confirmGeomPublish(){const e=this.bundle,t=this.geomDiff;if(!(!e||!t?.data)){this.busy=!0;try{await Md(t.versionId),this.geomDiff=null,this.info="המבנה פורסם; הצופים רואים אותו עכשיו",setTimeout(()=>this.info="",4e3),await this.loadStudio(e,!0)}catch(s){this.geomDiff={...t,error:w(s)}}finally{this.busy=!1}}}async publishNow(e){this.busy=!0,this.error="";try{await aa(e),this.info="הגרסה פורסמה; הצופים רואים אותה עכשיו",await this.load(),this.bundle&&await this.loadStudio(this.bundle,!0)}catch(t){this.error=w(t),t instanceof ue&&t.code==="geometry_invalid"&&(this.pickTool("structure"),this.studioMode="select")}finally{this.busy=!1}}async openDiff(e,t){this.diff={mode:e,version:t,data:null,error:""};try{const s=await Bl(t.id);this.diff?.version.id===t.id&&(this.diff={mode:e,version:t,data:s,error:""})}catch(s){this.diff?.version.id===t.id&&(this.diff={mode:e,version:t,data:null,error:w(s)})}}async confirmDiff(){const e=this.diff;if(!e?.data||e.mode==="compare")return;const t=e.version.id===this.bundle?.planVersionId;this.busy=!0,this.error="";try{if(t&&!await this.studio.flush()){this.diff={...e,error:this.studio.error};return}e.mode==="publish"?(await aa(e.version.id),this.info="הגרסה פורסמה; הצופים רואים אותה עכשיו"):(await Ll(e.version.id,e.version.revision,e.data.from?.id??null),this.info="הגרסה שוחזרה ופורסמה מחדש; העוגנים נשמרו"),this.diff=null,await this.load(),this.bundle&&await this.loadStudio(this.bundle,!0),setTimeout(()=>this.info="",4e3)}catch(s){this.diff={...e,error:w(s)},s instanceof ue&&s.status===409&&this.loadVersions(),t&&s instanceof ue&&s.code==="geometry_invalid"&&(this.pickTool("structure"),this.studioMode="select")}finally{this.busy=!1}}async searchEntities(){if(this.bundle?.source!=="demo"){this.entBusy=!0;try{const e=this.tool==="lights",t=await _n({q:this.entQ||void 0,domain:e&&!this.lightsAll?"switch":void 0,limit:e?200:40});this.entResults=e?t.entities.filter(s=>s.domain==="switch"||this.lightsAll&&s.domain==="light").slice(0,60):t.entities}catch(e){this.error=w(e),this.entResults=[]}finally{this.entBusy=!1}}}onEntQuery(e){this.entQ=e,window.clearTimeout(this.entTimer),this.entTimer=window.setTimeout(()=>void this.searchEntities(),250)}async stylize(e,t){if(!this.bundle?.planVersionId||this.bundle.source==="demo")return;const s=this.stylizeOpts;(e!==void 0||t!==void 0)&&(this.stylizeOpts={...s,strength:e??s.strength,keepLines:t??s.keepLines}),this.stylizing=!0,this.error="";try{this.stylized=await Yd(this.bundle.planVersionId,{strength:this.stylizeOpts.strength,keep_lines:this.stylizeOpts.keepLines,room_fill:this.stylizeOpts.roomFill})}catch(i){this.error=w(i)}finally{this.stylizing=!1}}async useRender(e){if(this.bundle?.planVersionId){this.busy=!0,this.error="";try{await Jd(this.bundle.planVersionId,e),this.stylized=null,await this.load(),this.info=e==="stylized"?"המפה מציגה עכשיו את שפת SMPLWISE":"המפה מציגה את תוכנית המקור",setTimeout(()=>this.info="",3e3)}catch(t){this.error=w(t)}finally{this.busy=!1}}}pickTool(e){this.tool=e,this.placing=null,this.wallDraft=null,this.hover=null,e!=="structure"&&(this.geomSel=null),e!=="measure"&&(this.measurePts=[]),e!=="calibrate"&&(this.calib={...At}),(e==="entity"||e==="lights")&&(this.entResults=null,this.searchEntities())}async loadStudio(e,t=!1){if(e.source!=="api"||!e.planVersionId||!e.permissions.structure||!t&&this.studioVersion===e.planVersionId)return!1;this.studioVersion=e.planVersionId;try{return!await this.studio.flush()&&!(t&&this.studio.hasConflict)?(this.studioVersion=null,this.error=this.studio.error,!1):(await this.studio.load(e.planVersionId),this.geomSel=null,this.wallDraft=null,this.calib={...At},this.measurePts=[],!0)}catch(s){return this.studioVersion=null,this.error=w(s),!1}}get studioOn(){return wr.includes(this.tool)&&!!this.studio.doc}get studioPlacing(){return this.studioOn&&(this.tool!=="structure"||this.studioMode!=="select")}get issueIds(){return this.studio.issues.filter(e=>e.severity==="error"&&e.id).map(e=>e.id)}edit(e){const t=this.studio.doc;if(!t)return;const s=e(t);s===t||JSON.stringify(s)===JSON.stringify(t)||this.studio.commit(s)}snap(e,t,s){const i=this.bundle,a=this.studio.doc;return!i||!a?e:Qa(e,t,a.walls,i.width,i.height,{tolPx:10/(this.canvas?.zoom??1),free:s})}snapDraw(e,t,s){const i=this.bundle,a=t.length>=3?t[0]:null;return i&&a&&Math.hypot((e[0]-a[0])*i.width,(e[1]-a[1])*i.height)*(this.canvas?.zoom??1)<=10?a:this.snap(e,t.at(-1)??null,s)}onPlanHover(e,t,s){const i=this.bundle,a=this.studio.doc;if(!i||!a||!this.studioPlacing){this.hover=null;return}const n=[e,t];if(this.tool==="calibrate")this.hover=this.snap(n,null,!0);else if(this.tool==="measure")this.hover=this.snap(n,this.measurePts.at(-1)??null,s);else if(this.studioMode==="wall")this.hover=this.snapDraw(n,this.wallDraft??[],s);else if(this.studioMode==="label")this.hover=n;else{const o=Pi(n,a.walls,i.width,i.height,14/(this.canvas?.zoom??1));this.hover=o?Ii(o.wall,o.t,i.width,i.height):null}}studioClick(e,t,s){const i=this.bundle,a=this.studio.doc;if(!i||!a)return;const n=[e,t];if(this.tool==="calibrate"){const m=this.snap(n,null,!0),g=this.calib;this.calib=!g.a||g.b?{...At,a:m}:{...g,b:m};return}if(this.tool==="measure"){this.measurePts=[...this.measurePts,this.snap(n,this.measurePts.at(-1)??null,s)];return}const o=this.studioMode,l=this.canvas?.zoom??1;if(o==="wall"){const m=this.wallDraft??[],g=this.snapDraw(n,m,s),v=b=>!!b&&Math.hypot((b[0]-n[0])*i.width,(b[1]-n[1])*i.height)*l<8;if(m.length&&(v(m[m.length-1])||v(this.lastDrawClick))){this.finishWall();return}if(m.length>=3&&g===m[0]){this.wallDraft=[...m,m[0]],this.finishWall();return}this.wallDraft=[...m,g],this.lastDrawClick=n;return}if(o==="label"){const m=ac(a,n,"תווית");this.studio.commit(m.doc),this.geomSel={id:m.id,kind:"label"};return}if(o==="select")return;const p=Pi(n,a.walls,i.width,i.height,14/l);if(!p){this.info="לחץ על קיר כדי להציב פתח",setTimeout(()=>this.info="",2500);return}const h=sc(a,p.wall.id,p.t,o);this.studio.commit(h.doc),this.geomSel={id:h.id,kind:"opening"}}finishWall(){const e=this.wallDraft;this.wallDraft=null,this.hover=null;const t=this.studio.doc;if(!t||!e||e.length<2)return;const s=tc(t,e,this.wallDefaults);this.studio.commit(s.doc),this.geomSel={id:s.id,kind:"wall"}}onGeomSelect(e,t){this.geomSel={id:e,kind:t},this.selectedId=null,this.selectedZoneId=null}onGeomDrag(e){const t=this.bundle,s=this.studio.doc;if(!t||!s)return;const i=[e.x,e.y];if(e.kind==="vertex"){const a=s.walls.find(S=>S.id===e.id);if(!a)return;const n=a.polyline,o=n.length-1,l=on(n),p=l&&e.index===o?0:e.index,h=l?o:n.length,m=l?[(p+h-1)%h,p,(p+1)%h]:[p-1,p,p+1],g={...a,polyline:n.slice(0,h).filter((S,N)=>!m.includes(N))},v=[...s.walls.filter(S=>S.id!==e.id),g],b=Qa(i,p>0?n[p-1]:null,v,t.width,t.height,{tolPx:10/(this.canvas?.zoom??1),free:!0});this.edit(S=>l&&p===0?Ri(Ri(S,e.id,0,b),e.id,o,b):Ri(S,e.id,p,b)),this.geomSel={id:e.id,kind:"wall"}}else if(e.kind==="opening"){const a=s.openings.find(o=>o.id===e.id),n=a?Pi(i,s.walls,t.width,t.height,Number.POSITIVE_INFINITY,a.wall_id):null;n&&this.edit(o=>hr(o,e.id,{t:n.t})),this.geomSel={id:e.id,kind:"opening"}}else this.edit(a=>mr(a,e.id,{position:i})),this.geomSel={id:e.id,kind:"label"}}handleStudioKey(e){const t=e.ctrlKey||e.metaKey,s=e.key.toLowerCase();if(e.key==="Enter"&&this.wallDraft)return e.preventDefault(),this.finishWall(),!0;if((e.key==="Backspace"||e.key==="Delete")&&this.wallDraft)return e.preventDefault(),this.wallDraft=this.wallDraft.length>1?this.wallDraft.slice(0,-1):null,this.lastDrawClick=null,!0;if((e.key==="Delete"||e.key==="Backspace")&&this.geomSel){e.preventDefault();const i=this.geomSel.id;return this.edit(a=>ur(a,i)),this.geomSel=null,!0}return t&&(s==="z"||s==="y")?(e.preventDefault(),s==="y"||e.shiftKey?this.studio.redo():this.studio.undo(),this.geomSel=null,!0):t&&s==="s"?(e.preventDefault(),this.studio.flush(),!0):!1}focusGeom(e){const t=this.bundle,s=this.studio.doc;if(!t||!s)return;const i=s.walls.find(p=>p.id===e),a=s.openings.find(p=>p.id===e),n=s.labels.find(p=>p.id===e),o=a?s.walls.find(p=>p.id===a.wall_id):void 0,l=i?Ii(i,.5,t.width,t.height):a&&o?Ii(o,a.t,t.width,t.height):n?n.position:null;this.tool="structure",this.studioMode="select",this.wallDraft=null,this.geomSel=i?{id:e,kind:"wall"}:a?{id:e,kind:"opening"}:n?{id:e,kind:"label"}:null,l&&this.canvas?.centerOn(Math.min(1,Math.max(0,l[0])),Math.min(1,Math.max(0,l[1])))}async copyStructure(e){const t=this.bundle;if(t?.planVersionId){this.busy=!0,this.error="";try{if(!await this.studio.flush()){this.error=this.studio.error;return}await Ad(t.planVersionId,e),await this.loadStudio(t,!0)&&(this.info="המבנה הועתק לטיוטה; בדוק מיקומים ופרסם",setTimeout(()=>this.info="",4e3))}catch(s){this.error=w(s)}finally{this.busy=!1}}}exportJson(){const e=this.studio.doc;if(!e)return;const t=URL.createObjectURL(new Blob([JSON.stringify(e,null,2)],{type:"application/json"})),s=document.createElement("a");s.href=t,s.download=`plan-structure-${e.plan_version_id}.json`,s.click(),setTimeout(()=>URL.revokeObjectURL(t),1e3)}renderStructurePanel(e){const t=this.studio.doc,s=e.planVersionId;return!t||!s?r`<sw-card heading="מבנה"><div class="note">${e.source==="demo"?"נתוני הדגמה: ציור המבנה עובד מול השרת.":this.error||"טוען את טיוטת המבנה…"}</div></sw-card>`:lc({doc:t,W:e.width,H:e.height,mode:this.studioMode,wallDefaults:this.wallDefaults,sel:this.geomSel,saveState:this.studio.saveState,saveError:this.studio.error,conflict:this.studio.hasConflict,issues:this.studio.issues,copyCandidates:this.studio.copyCandidates,exportSvg:or(s,"svg",{draft:!0}),exportPng:or(s,"png",{draft:!0}),busy:this.busy,showEstimates:this.showEstimates},{setMode:i=>{this.studioMode=i,this.wallDraft=null,this.hover=null},setWallDefaults:i=>{this.wallDefaults=i},patchWall:(i,a)=>this.edit(n=>ic(n,i,a)),patchOpening:(i,a)=>this.edit(n=>hr(n,i,a)),patchLabel:(i,a)=>this.edit(n=>mr(n,i,a)),remove:i=>{this.edit(a=>ur(a,i)),this.geomSel=null},focus:i=>this.focusGeom(i),copyFrom:i=>void this.copyStructure(i),exportJson:()=>this.exportJson(),reload:()=>void this.loadStudio(e,!0),calibrate:()=>this.pickTool("calibrate"),retry:async()=>{await this.studio.flush()&&this.loadStudio(e)}})}get rulers(){const e=this.bundle,t=this.studio.doc;if(!e||!t)return[];const{scale:s,estimated:i}=vs(t),a=(n,o)=>di($l(n,o,e.width,e.height,s),i,this.showEstimates);if(this.tool==="calibrate"){const{a:n,b:o,metres:l}=this.calib,p=o??this.hover;return!n||!p?[]:[{a:n,b:p,label:o?parseFloat(l)>0?`${l} מ׳`:"? מ׳":"",tone:o?"accent":"muted"}]}if(this.tool==="measure"){const n=this.measurePts,o=this.hover&&n.length?[...n,this.hover]:n,l=[];for(let p=1;p<o.length;p++)l.push({a:o[p-1],b:o[p],label:a(o[p-1],o[p]),tone:p>n.length-1?"muted":"accent"});return n.length>=3&&l.push({a:n[n.length-1],b:n[0],label:"",tone:"muted"}),l}return[]}async saveCalibration(){const e=this.bundle,{a:t,b:s,metres:i}=this.calib,a=parseFloat(i);if(!(!e?.planVersionId||!t||!s||!(a>0))){this.busy=!0,this.error="";try{if(!await this.studio.flush()){this.error=this.studio.error;return}const n=await Pd(e.planVersionId,[{a:t,b:s,metres:a}]);await this.loadStudio(e,!0),this.calib={...At,result:`קנה המידה נשמר: ${Ia(n.scale_m_per_px)}`,warning:n.warning??""}}catch(n){this.error=w(n)}finally{this.busy=!1}}}renderCalibrate(e){const t=this.studio.doc;if(!t)return r`<sw-card heading="כיול קנה מידה"><div class="note">${e.source==="demo"?"נתוני הדגמה: הכיול עובד מול השרת.":"טוען…"}</div></sw-card>`;const{scale:s,estimated:i}=vs(t),a=this.calib,n=a.a&&a.b?Math.hypot((a.b[0]-a.a[0])*e.width,(a.b[1]-a.a[1])*e.height):null;return gc({a:a.a,b:a.b,metres:a.metres,pixels:n,scale:s,estimated:i,showEstimates:this.showEstimates,result:a.result,warning:a.warning,busy:this.busy},o=>{this.calib={...this.calib,metres:o}},()=>void this.saveCalibration(),()=>{this.calib={...At}})}renderMeasure(e){const t=this.studio.doc;if(!t)return r`<sw-card heading="מדידה"><div class="note">${e.source==="demo"?"נתוני הדגמה: המדידה עובדת מול השרת.":"טוען…"}</div></sw-card>`;const{scale:s,estimated:i}=vs(t);return wc(this.measurePts,e.width,e.height,s,i,this.showEstimates,()=>{this.measurePts=[]})}renderCoverage(e){const t=e.coverage_polygon,s=e.coverage_radius??0,i=Math.round((s||.1)*100),a=()=>{const n=e.field_of_view_degrees??90,o=s||.1,l=this.bundle&&this.bundle.height?this.bundle.width/this.bundle.height:1,p=[[e.position.x,e.position.y]],h=Math.max(3,Math.round(n/15));for(let m=0;m<=h;m++){const g=(e.rotation_degrees-n/2+n*m/h-90)*Math.PI/180;p.push([+Math.max(0,Math.min(1,e.position.x+Math.cos(g)*o)).toFixed(4),+Math.max(0,Math.min(1,e.position.y+Math.sin(g)*o*l)).toFixed(4)])}this.apply(e.id,{coverage_polygon:p})};return r`<div class="row" data-coverage style="flex-direction:column;align-items:stretch;gap:6px">
      ...
      ${t?r`<div class="kv"><span class="k">מצב עכשיו</span><span>${kt(t)}</span></div><div class="kv"><span class="k">סוג</span><span>${Os(t.domain)}</span></div>`:d}
      <sw-field label="שכבה" style="margin-block-start:8px"><select @change=${s=>this.apply(e.id,{layer_id:s.target.value})}>${vr.filter(s=>s.id!=="cameras").map(s=>r`<option value=${s.id} ?selected=${e.layer_id===s.id}>${s.label}</option>`)}</select></sw-field>
      <div class="two">
      ...
      <div class="two">
        <sw-field label="סוג"><select @change=${i=>this.patchZone(e,{kind:i.target.value})}>${ra.map(i=>r`<option value=${i.id} ?selected=${e.kind===i.id}>${i.label}</option>`)}</select></sw-field>
      ...
      ${t?r`<div class="note">${t.length} חדרים זוהו · סמן, תן שם ושמור. הפוליגונים מוצגים במפה בקו מקווקו.</div>
            <div class="candlist">${t.map((i,a)=>r`<div class="cand" data-candidate><input type="checkbox" .checked=${i.include} aria-label="כלול" @change=${n=>this.setCandidate(a,{include:n.target.checked})} /><i class="sw" style="background:${Gs[a%Gs.length]}"></i><input class="name" .value=${i.name} placeholder="שם החדר" aria-label="שם החדר" @input=${n=>this.setCandidate(a,{name:n.target.value})} /><select aria-label="סוג" @change=${n=>this.setCandidate(a,{kind:n.target.value})}>${ra.map(n=>r`<option value=${n.id} ?selected=${i.kind===n.id}>${n.label}</option>`)}</select></div>`)}</div>
      ...
      ${e.planStatus==="none"?d:r`<div class="row"><span class="lbl">תצוגת המפה<span class="muted">${e.renderMode==="stylized"?"שפת SMPLWISE (עיבוד אוטומטי של המקור)":"תוכנית המקור כפי שהועלתה"}</span></span>${e.renderMode==="stylized"?r`<sw-button size="sm" ?disabled=${this.busy} @click=${()=>this.useRender("source")}>הצג מקור</sw-button>`:e.stylizedAvailable?r`<sw-button size="sm" ?disabled=${this.busy} @click=${()=>this.useRender("stylized")}>הצג שפת SMPLWISE</sw-button>`:d}</div>
          ...
          <div class="two" data-stylize-opts>
            ...
            <sw-field label="מילוי חדרים"><select aria-label="מילוי חדרים" @change=${s=>this.stylizeOpts={...this.stylizeOpts,roomFill:s.target.value}}>${Object.keys(Oi).map(s=>r`<option value=${s} ?selected=${this.stylizeOpts.roomFill===s}>${Oi[s]}</option>`)}</select></sw-field>
          </div>
      ...
      <div class="vlist" data-version-list>
        ${this.versions.map(t=>{const s=t.id===e.planVersionId,i=t.status==="published"?"recorded":t.status==="draft"?"partial":"neutral",a=t.status==="published"?"מפורסמת":t.status==="draft"?"טיוטה":"ארכיון";return r`<div class="vrow ${s?"cur":""}" data-version-row data-version-id=${t.id} data-version-status=${t.status}>
            ...
            <div class="meta">
              <span><sw-badge kind=${i} label=${a}></sw-badge> <span class="ltr">${Li(t.published_at??t.created_at)}</span></span>
      ...
      </div>`:d}renderDiffDialog(){const e=this.diff;if(!e)return d;const t=e.data,s=e.mode==="publish"&&e.version.id===this.bundle?.planVersionId?this.studio.doc:null,i=s&&(s.walls.length||s.openings.length||s.labels.length||s.objects.length||s.connectors.length)?s:null,a=this.studio.issues.some(l=>l.severity==="error"),n=e.mode==="publish"?"פרסום גרסה":e.mode==="rollback"?"שחזור גרסה מהארכיון":"השוואת גרסאות",o=e.mode==="publish"?"מה ישתנה לצופים ומה יקרה לפריטים המוצבים":e.mode==="rollback"?"הגרסה תפורסם מחדש כעותק חדש; הגרסה הנוכחית תעבור לארכיון":"מול הגרסה המפורסמת";return r`<sw-dialog open heading=${n} subheading=${o} data-diff-dialog @close=${()=>this.diff=null}>
      ${e.error?r`<div class="err" data-diff-error>${e.error}</div>`:d}
      ${t?r`<div class="compare">
              <div><div class="note">${t.from?`מפורסמת · ${Li(t.from.published_at??t.from.created_at)}`:"אין גרסה מפורסמת"}</div>${t.from?r`<img src=${Qe(t.from.image_url)} alt="הגרסה המפורסמת" />`:r`<div class="note">—</div>`}</div>
              <div><div class="note">${e.mode==="rollback"?"לשחזור":"חדשה"} · ${Li(t.to.published_at??t.to.created_at)}</div><img src=${Qe(t.to.image_url)} alt="הגרסה החדשה" /></div>
            </div>
            <div class="dsum" data-diff-summary>
              ${t.from?t.geometry.same?r`<sw-badge kind="recorded" label="גאומטריה זהה"></sw-badge>`:r`<sw-badge kind="partial" label=${`שינוי: ${t.geometry.changes.map(l=>xc[l.field]??l.field).join(", ")}`}></sw-badge>`:r`<sw-badge kind="neutral" label="פרסום ראשון"></sw-badge>`}
              <span>${t.anchors.total} פריטים מוצבים · ${t.anchors.carried} עוברים כמו שהם · ${t.anchors.needs_alignment} ידרשו יישור</span>
            </div>
            ${i?r`<div class="note" data-diff-structure>המבנה של הטיוטה (${Bi(i.walls.length,i.openings.length)}) יפורסם יחד עם הגרסה${a?"; יש בו שגיאות שיחסמו את הפרסום":""}.</div>`:d}
      ...
      ${e.mode!=="compare"&&t?r`<sw-button slot="footer" variant="primary" icon=${e.mode==="publish"?"check":"history"} data-diff-confirm ?disabled=${this.busy} @click=${()=>this.confirmDiff()}>${e.mode==="publish"?"פרסם גרסה":"שחזר ופרסם"}</sw-button>`:d}
      ...
      ${t?r`<div class="ditems" data-geom-diff-rows>
              ${i.length?i.map(([a,n])=>r`<div><span>${nc[a]??a}</span><span>${n.added.length} נוספו · ${n.changed.length} שונו · ${n.removed.length} הוסרו</span></div>`):r`<div><span>אין שינוי בפריטים</span></div>`}
              ${t.diff.calibration_changed?r`<div><span>כיול</span><span>קנה המידה השתנה</span></div>`:d}
            </div>
            <div class="note">${t.published_counts?`כעת: ${Bi(t.published_counts.walls,t.published_counts.openings)}`:"פרסום ראשון של מבנה"} · אחרי הפרסום: ${Bi(t.counts.walls,t.counts.openings)}</div>
            ${s.length?r`<div class="err" data-geom-diff-error>${oa(s.length,"שגיאה חוסמת אחת","שגיאות חוסמות")} בטיוטה: הפרסום חסום עד לתיקון. ראה את הסימון האדום על המפה ואת רשימת הבעיות של המבנה.</div>`:d}`:e.error?d:r`<div class="note">טוען השוואה…</div>`}
      <sw-button slot="footer" variant="ghost" data-geom-cancel @click=${()=>this.geomDiff=null}>ביטול</sw-button>
      <sw-button slot="footer" variant="primary" icon="check" data-geom-publish ?disabled=${this.busy||!t||s.length>0||!!t?.diff.same} @click=${()=>this.confirmGeomPublish()}>פרסם מבנה</sw-button>
        ...
        ${e.planStatus==="none"?r`<sw-state-panel state="empty" heading="לקומה אין תוכנית" hint="העלה תוכנית קודם; אחר כך אפשר להציב מצלמות וישויות."><div style="margin-block-start:10px"><sw-button variant="primary" icon="upload" @click=${()=>$(`/explore/floors/${e.floorId}/import`)}>העלאת תוכנית</sw-button></div></sw-state-panel>`:r`<div class="layout">
              <div class="mapwrap">
                ...
                <div class="rail" role="toolbar" aria-label="כלי עריכה">
                  ${$c.map(n=>r`<button class=${n.id===this.tool?"on":""} data-tool=${n.id} ?disabled=${!n.ready||wr.includes(n.id)&&!e.permissions.structure} title=${n.label} aria-label=${n.label} aria-pressed=${n.id===this.tool} @click=${()=>this.pickTool(n.id)}><sw-icon .name=${n.icon} size=${18}></sw-icon></button>`)}
                  <hr />
                ...
                <sw-plan-canvas editable alwaysLabel .placing=${!!this.placing||!!this.drawing||this.studioPlacing} .planWidth=${e.width} .planHeight=${e.height} .plan=${e.planSvg} .imageUrl=${e.imageUrl} .markers=${this.markers} .selectedId=${this.selectedId}
                  ...
                  @plan-hover=${n=>this.onPlanHover(n.detail.x,n.detail.y,n.detail.shift)}
                  @geom-select=${n=>this.onGeomSelect(n.detail.id,n.detail.kind)}
                  @geom-drag=${n=>this.onGeomDrag(n.detail)}
                  @zone-select=${n=>{if(!(this.placing||this.drawing||this.studioPlacing||n.detail.id.startsWith("cand-"))){if(this.tool==="structure"){this.geomSel=null;return}this.selectedZoneId=n.detail.id,this.selectedId=null}}}
                  ...
                  @plan-click=${n=>this.drawing?this.addDraftPoint(n.detail.x,n.detail.y):this.studioPlacing?this.studioClick(n.detail.x,n.detail.y,!!n.detail.shift):this.place(n.detail.x,n.detail.y)}></sw-plan-canvas>
  ...
  `,vc];R([f()],T.prototype,"floorId",2);R([f()],T.prototype,"presetEntity",2);R([c()],T.prototype,"bundle",2);R([c()],T.prototype,"anchors",2);R([c()],T.prototype,"dirty",2);R([c()],T.prototype,"undo",2);R([c()],T.prototype,"redo",2);R([c()],T.prototype,"selectedId",2);R([c()],T.prototype,"tool",2);R([c()],T.prototype,"layers",2);R([c()],T.prototype,"placing",2);R([c()],T.prototype,"entQ",2);R([c()],T.prototype,"entResults",2);R([c()],T.prototype,"entBusy",2);R([c()],T.prototype,"lightsAll",2);R([c()],T.prototype,"busy",2);R([c()],T.prototype,"error",2);R([c()],T.prototype,"info",2);R([c()],T.prototype,"stylizing",2);R([c()],T.prototype,"stylized",2);R([c()],T.prototype,"stylizeOpts",2);R([c()],T.prototype,"zones",2);R([c()],T.prototype,"versions",2);R([c()],T.prototype,"diff",2);R([c()],T.prototype,"selectedZoneId",2);R([c()],T.prototype,"candidates",2);R([c()],T.prototype,"detecting",2);R([c()],T.prototype,"detectStrength",2);R([c()],T.prototype,"replaceAuto",2);R([c()],T.prototype,"drawing",2);R([c()],T.prototype,"showZones",2);R([c()],T.prototype,"zoneBusy",2);R([ns("sw-plan-canvas")],T.prototype,"canvas",2);R([c()],T.prototype,"studioMode",2);R([c()],T.prototype,"wallDefaults",2);R([c()],T.prototype,"geomSel",2);R([c()],T.prototype,"wallDraft",2);R([c()],T.prototype,"hover",2);R([c()],T.prototype,"calib",2);R([c()],T.prototype,"measurePts",2);R([c()],T.prototype,"geomDiff",2);R([c()],T.prototype,"showEstimates",2);T=R([E("explore-plan-editor")],T);var kc=Object.defineProperty,_c=Object.getOwnPropertyDescriptor,Ut=(e,t,s,i)=>{for(var a=i>1?void 0:i?_c(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&kc(t,s,a),a};let dt=class extends z{constructor(){super(...arguments),this.columns=[],this.rows=[],this.rowKey="id",this.selected=null,this.emptyText="אין שורות להצגה",this.dense=!1}pick(e){const t=String(e[this.rowKey]??"");this.dispatchEvent(new CustomEvent("row-select",{detail:{id:t,row:e},bubbles:!0,composed:!0}))}render(){return this.rows.length?r`
      <table>
        <thead>
    ...
    `:r`<div class="empty">${this.emptyText}</div>`}};dt.styles=M`
    :host {
      display: block;
      background: var(--sw-surface);
      border: 1px solid var(--sw-border);
  ...
  `;Ut([f({attribute:!1})],dt.prototype,"columns",2);Ut([f({attribute:!1})],dt.prototype,"rows",2);Ut([f()],dt.prototype,"rowKey",2);Ut([f()],dt.prototype,"selected",2);Ut([f()],dt.prototype,"emptyText",2);Ut([f({type:Boolean,reflect:!0})],dt.prototype,"dense",2);dt=Ut([E("sw-table")],dt);var zc=Object.defineProperty,Sc=Object.getOwnPropertyDescriptor,Ke=(e,t,s,i)=>{for(var a=i>1?void 0:i?Sc(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&zc(t,s,a),a};const Ys=[{id:"lock.main_door",name:"דלת כניסה",domain:"lock",area:"לובי",state:"נעול",fresh:"live",placed:!0,actions:"נעילה / פתיחה (grant נפרד)"},{id:"light.lobby",name:"תאורת לובי",domain:"light",area:"לובי",state:"דולק · 80%",fresh:"live",placed:!0,actions:"הדלקה / כיבוי / עמעום"},{id:"binary_sensor.hall_motion",name:"תנועה באולם",domain:"binary_sensor",area:"אולם",state:"ללא תנועה",fresh:"live",placed:!0,actions:"קריאה בלבד"},{id:"climate.hall",name:"מזגן אולם",domain:"climate",area:"אולם",state:"קירור · 23°",fresh:"stale",placed:!1,actions:"יעד טמפרטורה (allowlist)"},{id:"cover.parking_gate",name:"שער חניה",domain:"cover",area:"חניה",state:"סגור",fresh:"live",placed:!1,actions:"פתיחה / סגירה (רגיש)"},{id:"script.night_mode",name:"מצב לילה",domain:"script",area:"—",state:"—",fresh:"unknown",placed:!1,actions:"חסום עד allowlist"},{id:"sensor.power_main",name:"צריכת חשמל",domain:"sensor",area:"חדר מכונות",state:"4.2 kW",fresh:"live",placed:!1,actions:"קריאה בלבד"},{id:"camera.intercom_m2",name:"אינטרקום M2",domain:"camera",area:"כניסה",state:"זמין",fresh:"live",placed:!1,actions:"צפייה (provider נפרד)"}];function Mc(e){return e==="lock"||e==="cover"?"lock":e==="light"||e==="switch"||e==="fan"?"light":e==="camera"?"camera":e==="climate"||e==="script"||e==="scene"||e==="button"||e==="automation"?"activity":"sensor"}let Ae=class extends z{constructor(){super(...arguments),this.selected=null,this.domain="all",this.q="",this.area="",this.onlyPlaced=!1,this.cat=null,this.error="",this.loading=!1,this.sync=null,this.firstFloorId=null,this.stopWs=null,this.searchTimer=0,this.columns=[{key:"name",label:"ישות",render:e=>r`<span style="display:inline-flex;align-items:center;gap:8px"><span style="display:grid;place-items:center;inline-size:26px;block-size:26px;border-radius:7px;background:var(--sw-accent-soft);color:var(--sw-accent)"><sw-icon name=${Mc(String(e.domain))} size=${13}></sw-icon></span><span><strong>${String(e.name)}</strong><div class="ltr" style="font-size:var(--sw-fs-xs);color:var(--sw-text-3)">${String(e.id)}</div></span></span>`},{key:"domain",label:"Domain",ltr:!0},{key:"area",label:"אזור HA"},{key:"state",label:"מצב"},{key:"fresh",label:"רעננות",render:e=>r`<sw-badge kind=${e.fresh} label=${e.fresh==="live"||e.fresh==="neutral"?"עדכני":e.fresh==="stale"?"מיושן":e.fresh==="offline"?"לא זמין":"לא ידוע"}></sw-badge>`},{key:"placed",label:"במפה",render:e=>e.placed?r`<sw-badge kind="recorded" label="מוצב"></sw-badge>`:r`<span style="color:var(--sw-text-3)">לא</span>`}]}connectedCallback(){super.connectedCallback(),y()&&(this.load(),St().then(e=>this.firstFloorId=yn(e)?.id??null).catch(()=>{}),this.stopWs=zn(e=>{if(e.type==="entity_state_changed"&&this.cat){const t=this.cat.entities.findIndex(s=>s.entity_id===e.entity.entity_id);if(t>=0){const s=[...this.cat.entities];s[t]={...s[t],...e.entity,placements:s[t].placements,actions:s[t].actions},this.cat={...this.cat,entities:s}}}else e.type==="heartbeat"?this.sync=e.sync:e.type==="ha_sync_state"&&this.sync&&(this.sync={...this.sync,connected:e.connected})}))}disconnectedCallback(){super.disconnectedCallback(),this.stopWs?.(),this.stopWs=null}async load(){this.loading=!0,this.error="";try{this.cat=await _n({domain:this.domain==="all"?void 0:this.domain,q:this.q||void 0,area:this.area||void 0,placed:this.onlyPlaced?!0:void 0,limit:800}),this.sync=this.cat.sync}catch(e){this.error=w(e)}finally{this.loading=!1}}onSearch(e){this.q=e,window.clearTimeout(this.searchTimer),this.searchTimer=window.setTimeout(()=>void this.load(),250)}toRow(e){return{id:e.entity_id,name:e.name||e.original_name||e.entity_id,domain:e.domain,area:e.area_name??"—",state:kt(e),fresh:na(e),placed:!!e.placements?.length,actions:e.actions?.length?e.actions.map(t=>`${t.label}${t.sensitive?" (רגיש)":""}`).join(" / "):"קריאה בלבד"}}renderApiDrawer(e){const t=na(e),s=Object.entries(e.attributes).filter(([i])=>i!=="friendly_name"&&i!=="icon").slice(0,14);return r`<sw-drawer open heading=${e.name||e.original_name||e.entity_id} subheading=${e.entity_id} @close=${()=>this.selected=null}>
      <dl>
        <dt>מצב</dt><dd><sw-badge kind=${t} label=${kt(e)}></sw-badge></dd>
        <dt>Domain</dt><dd><span class="ltr">${e.domain}</span> · ${Os(e.domain)}${e.device_class?r` · <span class="ltr">${e.device_class}</span>`:d}</dd>
        <dt>אזור HA</dt><dd>${e.area_name??"—"}${e.ha_floor_name?` · ${e.ha_floor_name}`:""}</dd>
        <dt>שינוי אחרון</dt><dd>${Fe(e.last_changed)}</dd>
        <dt>נראה לאחרונה</dt><dd>${Fe(e.state_seen_at)}${e.fresh?"":" · הסנכרון מנותק"}</dd>
    ...
    `}render(){if(y())return this.renderApi();const e=["all",...new Set(Ys.map(i=>i.domain))],t=Ys.filter(i=>this.domain==="all"||i.domain===this.domain),s=Ys.find(i=>i.id===this.selected);return r`
      <sw-page heading="קטלוג ישויות Home Assistant" subheading="${Ys.length} ישויות מורשות לחיבור · הצבה על המפה ושליטה הן הרשאות נפרדות · נתוני הדגמה">
  ...
  `;Ke([c()],Ae.prototype,"selected",2);Ke([c()],Ae.prototype,"domain",2);Ke([c()],Ae.prototype,"q",2);Ke([c()],Ae.prototype,"area",2);Ke([c()],Ae.prototype,"onlyPlaced",2);Ke([c()],Ae.prototype,"cat",2);Ke([c()],Ae.prototype,"error",2);Ke([c()],Ae.prototype,"loading",2);Ke([c()],Ae.prototype,"sync",2);Ke([c()],Ae.prototype,"firstFloorId",2);Ae=Ke([E("explore-entities")],Ae);var Ec=Object.defineProperty,Ac=Object.getOwnPropertyDescriptor,En=(e,t,s,i)=>{for(var a=i>1?void 0:i?Ac(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&Ec(t,s,a),a};const Vi=[{id:"d1",name:"כניסה ראשית",kind:"דלת זכוכית",lock:"נעול",contact:"סגור",relay:"לא פעיל",ringing:!1,scene:"entrance"},{id:"d2",name:"לובי",kind:"דלת פנימית",lock:"פתוח",contact:"פתוח",relay:"לא פעיל",ringing:!1,scene:"lobby"},{id:"d3",name:"אינטרקום M2",kind:"עמדת דלת",lock:"נעול",contact:"סגור",relay:"לא פעיל",ringing:!0,scene:"entrance"},{id:"d4",name:"מחסן",kind:"דלת שירות",lock:"נעול",contact:"סגור",relay:"לא פעיל",ringing:!1,scene:"warehouse"}];let ci=class extends z{constructor(){super(...arguments),this.selected="d1"}render(){if(y())return r`<sw-page heading="דלתות ואינטרקום" subheading="V1 · מצלמה, צלצול, מגע דלת וממסר הם ארבעה נתונים שונים">
      ...
      </sw-page>`;const e=Vi.find(t=>t.id===this.selected)??Vi[0];return r`
      <sw-page heading="דלתות ואינטרקום" subheading="V1 · מצלמה, צלצול, מגע דלת וממסר הם ארבעה נתונים שונים · נתוני הדגמה">
        ...
        <div class="layout">
          <div class="list">
            ${Vi.map(t=>r`<button class="door ${t.id===this.selected?"on":""}" @click=${()=>this.selected=t.id} aria-pressed=${t.id===this.selected}>
  ...
  `;En([c()],ci.prototype,"selected",2);ci=En([E("explore-access")],ci);var Pc=Object.defineProperty,Ic=Object.getOwnPropertyDescriptor,Zt=(e,t,s,i)=>{for(var a=i>1?void 0:i?Ic(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&Pc(t,s,a),a};let ct=class extends z{constructor(){super(...arguments),this.label="",this.value="",this.detail="",this.icon="info",this.tone="neutral",this.badge=""}render(){return r`
  ...
  `;Zt([f()],ct.prototype,"label",2);Zt([f()],ct.prototype,"value",2);Zt([f()],ct.prototype,"detail",2);Zt([f()],ct.prototype,"icon",2);Zt([f({reflect:!0})],ct.prototype,"tone",2);Zt([f()],ct.prototype,"badge",2);ct=Zt([E("sw-kpi")],ct);function zi(e={}){const t=new URLSearchParams;e.date&&t.set("date",e.date),e.from&&e.to&&(t.set("from",e.from),t.set("to",e.to)),e.acked&&t.set("acked","true"),e.cameraId&&t.set("camera_id",e.cameraId),e.type&&t.set("type",e.type),e.unacked&&t.set("unacked","true"),e.limit&&t.set("limit",String(e.limit)),e.floorId&&t.set("floor_id",e.floorId),e.zoneId&&t.set("zone_id",e.zoneId),e.buildingId&&t.set("building_id",e.buildingId),e.siteId&&t.set("site_id",e.siteId),e.source&&t.set("source",e.source),e.severity&&t.set("severity",e.severity),e.query&&t.set("q",e.query);const s=t.toString();return k(`events${s?`?${s}`:""}`)}const Cc=()=>k("events/summary"),Dc=(e,t)=>k(`cameras/${e}/events?date=${t}`),An=e=>A(`events/${e}/ack`),br=e=>A("events/ack-many",{event_ids:e}),yr={camera:"לפי מצלמה",all:"כל המצלמות יחד",zone:"לפי חדר",floor:"לפי קומה"};function Tc(e={}){const t=new URLSearchParams;e.date&&t.set("date",e.date),e.cameraId&&t.set("camera_id",e.cameraId),e.gap&&t.set("gap",String(e.gap)),e.by&&t.set("by",e.by),e.limit&&t.set("limit",String(e.limit));const s=t.toString();return k(`events/windows${s?`?${s}`:""}`)}const Oc=e=>k(`events/${e}`),Tt=(e,t=0)=>ge(`events/${e}/thumbnail${t?`?v=${t}`:""}`);async function Pn(e){try{const t=await fetch(Tt(e),{credentials:"include",cache:"no-store"});return t.status===200?"ready":t.status===202?"pending":"unavailable"}catch{return"pending"}}const ee={motion:"תנועה",person:"אדם",vehicle:"רכב",line:"חציית קו",field:"חדירה לאזור",offline:"אובדן וידאו",tamper:"חבלה במצלמה",door:"דלת",io:"כניסת חיווי",storage:"אחסון",system:"מערכת",coverage_gap:"פער בקליטת אירועים",manual:"הקלטה ידנית",other:"אחר"},ti={motion:"#ef4444",person:"#2f6bff",vehicle:"#22c55e",line:"#f59e0b",field:"#f59e0b",offline:"#6b7280",tamper:"#b45309",door:"#8b5cf6",io:"#8b5cf6",storage:"#6b7280",system:"#6b7280",coverage_gap:"#6b7280",manual:"#2f6bff",other:"#6b7280"};function Rc(e){return e==="person"||e==="vehicle"||e==="motion"||e==="line"||e==="offline"||e==="door"?e:e==="field"?"line":e==="io"?"door":e==="tamper"||e==="coverage_gap"||e==="storage"||e==="system"?"offline":"motion"}function Nc(e,t){let s=null,i=!1,a=2e3;const n=(()=>{const l=new URL(ge("events/ws"));return l.protocol=l.protocol==="https:"?"wss:":"ws:",l.toString()})(),o=()=>{if(!i){try{s=new WebSocket(n)}catch{return}s.onopen=()=>{a=2e3,t?.(null,!0)},s.onmessage=l=>{try{const p=JSON.parse(l.data);p.type==="event_added"||p.type==="event_updated"?e(p.payload):p.type==="heartbeat"&&t?.(p.payload.ingest,!0)}catch{}},s.onclose=()=>{t?.(null,!1),i||(window.setTimeout(o,a),a=Math.min(3e4,a*2))}}};return o(),()=>{i=!0,s?.close()}}const Bc={measured:"נמדד",inferred:"נגזר",command:"פקודה",availability:"זמינות"},Lc=(e,t=120)=>k(`events/${e}/correlation?window=${t}`),Vc=(e=90)=>k(`events/facets?days=${e}`),$r={alertstream:"אירוע NVR",recording:"נגזר מהקלטה",system:"מערכת",ha:"חיישן HA"},Hc=(e,t=90)=>k(`events/${e}/route?window=${t}`),In=(e=!1)=>k(`storage${e?"?fresh=true":""}`);function Ct(e){return e==null?"—":e>=1024*1024?`${(e/1024/1024).toFixed(2)} TB`:e>=1024?`${(e/1024).toFixed(0)} GB`:`${e} MB`}const _s={ok:"תקין",warn:"לתשומת לב",error:"שגיאה"},xr={ok:"live",warn:"stale",error:"offline"},Cn=(e=!1)=>k(`health/report${e?"?fresh=1":""}`),Ca=()=>k("health/summary");function jc(e){return e<3600?`${Math.floor(e/60)} דק׳`:e<86400?`${Math.floor(e/3600)} שע׳ ${Math.floor(e%3600/60)} דק׳`:`${Math.floor(e/86400)} ימים ${Math.floor(e%86400/3600)} שע׳`}var Fc=Object.defineProperty,Wc=Object.getOwnPropertyDescriptor,Ce=(e,t,s,i)=>{for(var a=i>1?void 0:i?Wc(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&Fc(t,s,a),a};function Uc(e){return e<5?"לילה טוב":e<12?"בוקר טוב":e<17?"צהריים טובים":e<21?"ערב טוב":"לילה טוב"}const Zc={person:"var(--sw-accent)",vehicle:"var(--sw-live)",motion:"var(--sw-danger)",line:"var(--sw-stale)",offline:"var(--sw-offline)",door:"var(--sw-purple)"},qc={"כניסה ראשית":"entrance","חצר אחורית":"backyard",מחסן:"warehouse",לובי:"lobby","חניה מקורה":"parking"};let $e=class extends z{constructor(){super(...arguments),this.cams=null,this.recorder=null,this.sites=null,this.summary=null,this.summaryDenied=!1,this.recent=[],this.storage=null,this.health=null,this.raw=null,this.tz="Asia/Jerusalem",this.now=new Date,this.loaded=!1,this.timer=0,this.clockTimer=0}connectedCallback(){super.connectedCallback(),y()&&(this.load(),this.timer=window.setInterval(()=>void this.load(),6e4),this.clockTimer=window.setInterval(()=>this.now=new Date,3e4))}disconnectedCallback(){window.clearInterval(this.timer),window.clearInterval(this.clockTimer),super.disconnectedCallback()}async load(){this.loadStorage();const[e,t,s,i,a,n,o]=await Promise.allSettled([Ve(),Le(),k("sites?tree=true"),Cc(),zi({limit:6}),Ca(),k("health")]);e.status==="fulfilled"&&(this.tz=e.value["time.zone"]??this.tz),t.status==="fulfilled"?(this.cams=t.value.cameras.filter(l=>l.enabled),this.recorder=t.value.recorder):this.cams===null&&(this.cams=[]),s.status==="fulfilled"?this.sites=s.value.sites:this.sites===null&&(this.sites=[]),i.status==="fulfilled"?this.summary=i.value:this.summaryDenied=i.reason instanceof ue&&i.reason.status===403,a.status==="fulfilled"&&(this.recent=a.value.events),n.status==="fulfilled"&&(this.health=n.value),o.status==="fulfilled"&&(this.raw=o.value),this.loaded=!0,this.now=new Date}async loadStorage(){try{this.storage=await In()}catch{this.storage=null}}fmtTime(e){return new Date(e).toLocaleTimeString("he-IL",{hour:"2-digit",minute:"2-digit",timeZone:this.tz})}spots(){const e=[],t=this.cams??[];for(const a of t.filter(n=>n.status==="offline"))e.push({kind:"critical",title:`מצלמה מנותקת: ${a.name}`,meta:`ערוץ ${a.channel}${a.last_seen_at?` · נראתה לאחרונה ${this.fmtTime(a.last_seen_at)}`:""}`,why:"מוצג כי ה־NVR מדווח שהערוץ אינו מחובר",link:`#/live/cameras/${a.id}`});for(const a of(this.health?.items??[]).filter(n=>n.status!=="ok"))e.push({kind:a.status==="error"?"critical":"alert",title:a.label,meta:`בדיקת מערכת · ${_s[a.status]}`,why:"מוצג כי בדיקת הבריאות של ה־Add-on מדווחת על כך",link:"#/system/diagnostics"});const s=this.summary?.today.unacked??0;if(s>0){const a=Object.entries(this.summary?.today.by_type??{}).sort((n,o)=>o[1]-n[1]).slice(0,3).map(([n,o])=>`${ee[n]??n} ${o}`).join(" · ");e.push({kind:"alert",title:`${s} אירועים שלא נבדקו היום`,meta:a,why:"מוצג כי אירועים ממתינים לסימון טיפול במרכז האירועים",link:"#/investigate/events"})}const i=this.raw?.events.ingest;return i?.connected&&!i.events_stored&&!i.last_event_at&&e.push({kind:"info",title:"ה־NVR לא שלח התראות מאז ההפעלה",meta:"אירועי תנועה נגזרים מההקלטות כל 10 דקות",why:'מוצג כי זרם ההתראות מחובר אך ריק — ב־NVR יש להפעיל "Notify Surveillance Center" ב־linkage של זיהוי התנועה',link:"#/system/setup"}),this.raw?.home_assistant.configured&&!this.raw.home_assistant.connected&&e.push({kind:"alert",title:"אין חיבור ל־Home Assistant",meta:this.raw.home_assistant.last_error??"",why:"מוצג כי מצבי הישויות והדלתות עלולים להיות מיושנים",link:"#/system/setup"}),e}renderApi(){const e=Te.me?.user,t=e?.display_name||e?.username||"",s=Number(this.now.toLocaleString("en-GB",{hour:"numeric",hour12:!1,timeZone:this.tz})),i=this.cams??[],a=i.filter(_=>_.status==="online").length,n=this.sites??[],o=n.flatMap(_=>(_.buildings??[]).flatMap(I=>I.floors??[])),l=this.health,p=l?l.status==="ok"?"live":l.status==="warn"?"stale":"offline":"neutral",h=l?.items.find(_=>_.status!=="ok"),m=this.loaded?this.spots():[],g=this.storage,v=g?.totals??null,b=v?.used_pct??null,S=34,N=2*Math.PI*S,q=i.filter(_=>_.status==="online").slice(0,2);return r`
      <sw-page heading=${`${Uc(s)}${t?`, ${t}`:""}`} subheading=${l?`מצב המערכת: ${_s[l.status]}${h?` · ${h.label}`:" · כל הבדיקות תקינות"}`:"קורא את מצב המערכת…"}>
        ...
        <div class="kpis" data-overview-kpis>
          ...
          <sw-kpi icon="building" value=${String(n.length)} label="אתרים" detail=${`${o.length} קומות · ${o.filter(_=>_.has_plan).length} עם תוכנית`} tone="neutral"></sw-kpi>
          ...
          <sw-kpi icon="shield" tone=${p} value=${l?_s[l.status]:"…"} label="מצב מערכת" detail=${h?h.label:"NVR, go2rtc, HA ואחסון"}></sw-kpi>
        </div>
        ${q.length?r`<div class="fav" data-overview-favorites>
              ${q.map(_=>r`<sw-camera-tile name=${_.name} state="live" cameraId=${_.id} poster=${et(_.id)} noDemo @click=${()=>$(`/live/cameras/${_.id}`)}></sw-camera-tile>`)}
            </div>`:d}
        <div class="row2">
          ${g&&v?r`<sw-card heading="אחסון" subheading=${g.cached?"מהמטמון · נמדד מול ה־NVR":"נמדד מול ה־NVR"}>
                <div class="donut">
                  <svg viewBox="0 0 84 84" role="img" aria-label=${`אחסון בשימוש ${b??0}%`}>
                    ${u`<circle cx="42" cy="42" r=${S} fill="none" stroke="var(--sw-surface-3)" stroke-width="9" />
                    <circle cx="42" cy="42" r=${S} fill="none" stroke="var(--sw-accent)" stroke-width="9" stroke-linecap="round" stroke-dasharray=${`${N*(b??0)/100} ${N}`} transform="rotate(-90 42 42)" />
                    <text x="42" y="47" text-anchor="middle" font-size="15" font-weight="700" fill="var(--sw-text)" font-family="var(--sw-font)">${b??0}%</text>`}
                  </svg>
                  <div class="txt">
                    <div class="big">${Ct(v.used_mb)} מתוך ${Ct(v.capacity_mb)}</div>
                    <div class="bar"><i style=${`inline-size:${b??0}%`}></i></div>
                    <div class="muted">${g.retention.measured_days_min!==null?`הקלטה ישנה ביותר ≈ ${g.retention.measured_days_min}${g.retention.measured_days_max!==null&&g.retention.measured_days_max!==g.retention.measured_days_min?`–${g.retention.measured_days_max}`:""} ימים (נמדד)`:g.retention.measured_reason}${g.work_mode?` · ${g.work_mode}`:""} · ${v.disks} דיסקים</div>
                  </div>
                </div>
              </sw-card>`:d}
          <sw-card heading="אתרים ומבנים" subheading=${n.length?`${n.length} אתרים · ${o.length} קומות`:"עדיין לא הוגדרו אתרים"}>
            ${n.map(_=>{const I=(_.buildings??[]).flatMap(ps=>ps.floors??[]),Q=I.filter(ps=>ps.has_plan).length,ye=I.reduce((ps,qn)=>ps+qn.camera_count,0);return r`<div class="hrow" @click=${()=>$("/explore/sites")} style="cursor:pointer"><span>${_.name}<div class="muted">${(_.buildings??[]).length} מבנים · ${I.length} קומות · ${ye} מצלמות מוצבות · ${Q}/${I.length} תוכניות</div></span><span class="status"><i style=${`--c:${I.length&&Q===I.length?"var(--sw-live)":"var(--sw-stale)"}`}></i>${I.length&&Q===I.length?"תוכניות מפורסמות":"חסרות תוכניות"}</span></div>`})}
        ...
        <div class="row3">
          <sw-card heading="אירועים אחרונים" subheading=${this.summary?`${this.summary.today.total} היום · ${this.summary.today.measured} נמדדו · ${this.summary.today.inferred} נגזרו מהקלטה`:""}>
            ...
            ${this.recent.length?this.recent.map(_=>r`<div class="ev" data-overview-event @click=${()=>$(`/investigate/events/${_.id}`)}>
                    ${_.thumbnail==="ready"?r`<img class="thumb" src=${Tt(_.id)} alt="" loading="lazy" />`:r`<div class="none"><sw-icon name=${_.type==="offline"||_.type==="coverage_gap"?"offline":_.type==="door"||_.type==="io"?"door":_.type==="person"?"user":_.type==="vehicle"?"route":"bell"} size=${14}></sw-icon></div>`}
                    <div class="txt"><b style=${`--tone:${ti[_.type]??"#6b7280"}`}><i></i>${ee[_.type]??_.type}${_.acked_at?"":" · לבדיקה"}</b><small>${_.camera_name??_.details?.name??"ללא מצלמה"} · ${_.confidence==="inferred"?"נגזר מהקלטה":_.source==="ha"?"חיישן HA":"התראה"}</small></div>
                    <time>${this.fmtTime(_.occurred_at)}</time>
          ...
          <sw-card heading="דורש תשומת לב" subheading="כל פריט מסביר מדוע הוא מוצג">
            ${m.length?m.map(_=>r`<div class="spot ${_.kind}" data-overview-spot>
                    <div class="ic"><sw-icon name=${_.kind==="critical"?"offline":_.kind==="info"?"info":"warning"} size=${15}></sw-icon></div>
                    <div><div class="t">${_.title}</div><div class="muted">${_.meta}</div><div class="why">${_.why}</div></div>
                    <div class="actions"><a href=${_.link}><sw-button size="sm">פתח</sw-button></a></div>
                  </div>`):r`<div class="muted" data-overview-calm>${this.loaded?"הכול תקין — אין פריטים שדורשים תשומת לב כרגע.":"בודק…"}</div>`}
          </sw-card>
        </div>
      </sw-page>
    `}render(){if(y())return this.renderApi();const e=X.filter(l=>l.state==="live"||l.state==="stale").length,t=ot.filter(l=>!l.acked),s=[{kind:"critical",title:"מצלמה מנותקת: מסדרון מזרחי",meta:"קומה 0 · מאז 07:55",why:"מוצג כי אין הקלטה ממצלמה זו כבר שעתיים",link:"#/system/devices"},{kind:"alert",title:`${t.length} אירועים שלא נבדקו`,meta:"אדם בכניסה הראשית 10:14, רכב בחצר 09:42",why:"מוצג כי אירועי אדם/רכב מחכים לסימון טיפול",link:"#/investigate/events"},{kind:"alert",title:"החיבור ל־Home Assistant לא רענן",meta:"סנכרון אחרון לפני 4 דק׳",why:"מוצג כי מצבי הישויות עלולים להיות מיושנים",link:"#/system/diagnostics"}],i=.68,a=34,n=2*Math.PI*a,o=X.filter(l=>l.state==="live").slice(0,2);return r`
      <sw-page heading="בוקר טוב, יוני" subheading="המערכת פועלת · גשר Home Assistant לא רענן · נתוני הדגמה">
        ...
        <div class="kpis">
          ...
          <sw-kpi icon="building" value=${String(Xi.length)} label="אתרים" detail="פעילים" tone="neutral"></sw-kpi>
        ...
        <div class="fav">
          ${o.map(l=>r`<sw-camera-tile name=${l.name} state=${l.state} scene=${tt[l.id]??"lobby"} @click=${()=>$(`/live/cameras/${l.id}`)}></sw-camera-tile>`)}
        </div>
        <div class="row2">
          ...
          <sw-card heading="בריאות האתרים">
            ${Xi.map(l=>r`<div class="hrow"><span>${l.name}<div class="muted">${l.online}/${l.cameras} מצלמות · ${l.alerts} התראות</div></span><span class="status"><i style="--c:${l.health==="live"?"var(--sw-live)":l.health==="offline"?"var(--sw-danger)":"var(--sw-stale)"}"></i>${l.health==="live"?"מחובר":l.health==="offline"?"מנותק":"חלקי"}</span></div>`)}
            ${mn.slice(0,2).map(l=>r`<div class="hrow"><span>${l.name}<div class="muted">${l.detail}</div></span><span class="status"><i style="--c:${l.state==="live"?"var(--sw-live)":"var(--sw-stale)"}"></i>${l.state==="live"?"מחובר":"לא רענן"}</span></div>`)}
          </sw-card>
        </div>
        <div class="row3">
          <sw-card heading="אירועים אחרונים">
            <a slot="actions" class="seeall" href="#/investigate/events">הצג הכל</a>
            ${ot.slice(0,5).map(l=>r`<div class="ev" @click=${()=>$("/investigate/events")}>
                ${l.type==="offline"||l.type==="door"?r`<div class="none"><sw-icon name=${l.type==="offline"?"offline":"door"} size=${14}></sw-icon></div>`:r`<sw-scene kind=${qc[l.camera]??"lobby"}></sw-scene>`}
                <div class="txt"><b style="--tone:${Zc[l.type]}"><i></i>${Qi[l.type]}</b><small>${l.camera} · ${l.floor}</small></div>
                <time>${l.time}</time>
              </div>`)}
          </sw-card>
          <sw-card heading="דורש תשומת לב" subheading="כל פריט מסביר מדוע הוא מוצג">
  ...
  `;Ce([c()],$e.prototype,"cams",2);Ce([c()],$e.prototype,"recorder",2);Ce([c()],$e.prototype,"sites",2);Ce([c()],$e.prototype,"summary",2);Ce([c()],$e.prototype,"summaryDenied",2);Ce([c()],$e.prototype,"recent",2);Ce([c()],$e.prototype,"storage",2);Ce([c()],$e.prototype,"health",2);Ce([c()],$e.prototype,"raw",2);Ce([c()],$e.prototype,"tz",2);Ce([c()],$e.prototype,"now",2);Ce([c()],$e.prototype,"loaded",2);$e=Ce([E("live-overview")],$e);var Kc=Object.defineProperty,Gc=Object.getOwnPropertyDescriptor,Ge=(e,t,s,i)=>{for(var a=i>1?void 0:i?Gc(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&Kc(t,s,a),a};const Hi=[1,2,4,6,8,9,12,16,20,25,32],kr="sw.wall.count",_r=[{id:"all",label:"כל המצלמות"},{id:"outside",label:"חוץ"},{id:"inside",label:"פנים"},{id:"night",label:"לילה"}];let Pe=class extends z{constructor(){super(...arguments),this.cameras="",this.count=4,this.stream="auto",this.view="all",this.cams=null,this.settings=null,this.error="",this.posterBust=Date.now(),this.colsOverride=(()=>{try{return Number(localStorage.getItem("sw.wall.cols")??0)||0}catch{return 0}})(),this.box={w:0,h:0},this.measure=()=>{const e=this.renderRoot.querySelector(".grid");if(!e)return;const t=Math.round(e.clientWidth),s=Math.round(window.innerHeight-e.getBoundingClientRect().top-56);(t!==this.box.w||s!==this.box.h)&&(this.box={w:t,h:s})}}setCols(e){this.colsOverride=e;try{localStorage.setItem("sw.wall.cols",String(e))}catch{}}bestFit(e){const{w:t,h:s}=this.box;if(!t||s<120||e<1)return null;const i=12;let a={cols:1,tile:0};for(let n=1;n<=e;n++){const o=Math.ceil(e/n),l=Math.min((t-i*(n-1))/n,(s-i*(o-1))/o*(16/9));l>a.tile&&(a={cols:n,tile:l})}return a.tile>80?{cols:a.cols,tile:Math.floor(a.tile)}:null}firstUpdated(){this.ro=new ResizeObserver(()=>this.measure()),this.ro.observe(this),window.addEventListener("resize",this.measure)}updated(){this.measure()}connectedCallback(){super.connectedCallback(),this.load(),this.posterTimer=window.setInterval(()=>this.posterBust=Date.now(),6e4)}disconnectedCallback(){super.disconnectedCallback(),window.clearInterval(this.posterTimer),this.ro?.disconnect(),window.removeEventListener("resize",this.measure)}setCount(e){this.count=e;try{localStorage.setItem(kr,String(e))}catch{}}async load(){if(y())try{const[e,t]=await Promise.all([Le(),Ve()]);this.cams=e.cameras.filter(n=>n.enabled),this.settings=t;let s=0;try{s=Number(localStorage.getItem(kr)??0)}catch{}const i=Number(t["ui.wall_count"]??0),a=Hi.includes(s)?s:Hi.includes(i)?i:0;a&&(this.count=a)}catch(e){this.error=w(e)}}renderApi(){const e=this.cams;if(this.error)return r`<sw-state-panel state="error" hint=${this.error} actionLabel="נסה שוב" @action=${()=>this.load()}></sw-state-panel>`;if(!e)return r`<sw-state-panel state="loading"></sw-state-panel>`;if(!e.length)return r`<sw-state-panel state="empty" heading="אין מצלמות זמינות" hint="המצלמות מתגלות אוטומטית מה־NVR בהפעלה ובכל 10 דקות. אם הרשימה ריקה: בדוק את פרטי ה־NVR בהגדרות ה־Add-on ואת יומן ה־Add-on, או הרץ סנכרון ידני; ייתכן גם שאין לך הרשאה למצלמות."><div style="margin-block-start:10px"><sw-button @click=${()=>$("/system/devices")}>למצלמות</sw-button></div></sw-state-panel>`;const t=this.cameras?this.cameras.split(",").filter(Boolean):[],s=t.length?e.filter(g=>t.includes(g.id)):e,i=t.length?Math.max(1,s.length):this.count,a=s.slice(0,i),n=window.innerWidth>=768?this.bestFit(a.length):null,o=this.colsOverride?Math.min(this.colsOverride,Math.max(1,a.length)):n?n.cols:i===1?1:i===2||i<=4?2:i<=9?3:i<=16?4:i<=25?5:6;let l=n&&!this.colsOverride?n:null;if(this.box.w&&(this.colsOverride||!l)){const g=Math.ceil(a.length/o),v=Math.min((this.box.w-12*(o-1))/o,this.box.h>120?(this.box.h-12*(g-1))/g*(16/9):1/0);v>80&&Number.isFinite(v)&&(l={cols:o,tile:Math.floor(v)})}const p=this.settings?.["media.max_live_sessions"]??8,h=this.stream==="auto"?this.settings?.["media.wall_profile"]??"sub":this.stream,m=Aa(this.settings);return r`
      ...
      <div class="note">${a.length} מתוך ${e.length} מצלמות · פרופיל ${h==="sub"?"משני":"ראשי"} · תעבורה ${m} · מכסת זרמים ${p}${a.length>p?" — מעבר למכסה מוצג צילום בלבד":""} · צילומים מתרעננים כל דקה</div>
    `}renderDemo(){const e=X.slice(0,this.count),t=this.count===1?1:this.count===2||this.count<=4?2:this.count<=9?3:4;return r`
      <div class="grid" style="--cols:${t}">
        ${e.map(s=>r`<sw-camera-tile name=${s.name} meta=${`${s.floor} · ${this.stream==="auto"?this.count>4?"משני":"ראשי":this.stream==="main"?"ראשי":"משני"}`} state=${s.state} scene=${tt[s.id]??"lobby"} ?compact=${this.count>=9} @click=${()=>$(`/live/cameras/${s.id}`)}></sw-camera-tile>`)}
      </div>
    ...
    `}openKiosk(){const e=`${window.location.origin}${window.location.pathname}${window.location.search}#/kiosk/all`;window.open(e,"_blank","noopener")}render(){const e=y(),t=e?this.cams?.length??0:X.length;return r`
      <sw-page heading="כל המצלמות" subheading="${t} מצלמות${e?"":` · תצוגה: ${_r.find(s=>s.id===this.view)?.label} · נתוני הדגמה`}" wide>
        ${e?d:r`<sw-field slot="actions"><select aria-label="תצוגה" @change=${s=>this.view=s.target.value}>${_r.map(s=>r`<option value=${s.id} ?selected=${s.id===this.view}>${s.label}</option>`)}</select></sw-field>`}
        ...
        <div slot="actions" class="layouts" role="group" aria-label="פריסה">
          ${Hi.map(s=>r`<button class=${s===this.count&&!this.cameras?"on":""} @click=${()=>{this.setCount(s),this.cameras&&$("/live/wall")}} aria-pressed=${s===this.count&&!this.cameras}>${s}</button>`)}
        </div>
  ...
  `;Ge([f()],Pe.prototype,"cameras",2);Ge([c()],Pe.prototype,"count",2);Ge([c()],Pe.prototype,"stream",2);Ge([c()],Pe.prototype,"view",2);Ge([c()],Pe.prototype,"cams",2);Ge([c()],Pe.prototype,"settings",2);Ge([c()],Pe.prototype,"error",2);Ge([c()],Pe.prototype,"posterBust",2);Ge([c()],Pe.prototype,"colsOverride",2);Ge([c()],Pe.prototype,"box",2);Pe=Ge([E("live-wall")],Pe);const Yc=()=>k("nvr/notify"),Jc=e=>Me("nvr/notify",e),zr=(e=20)=>k(`nvr/changes?limit=${e}`),Xc=e=>A(`nvr/changes/${e}/rollback`),Qc=e=>k(`cameras/${e}/record`),ep=(e,t)=>A(`cameras/${e}/record/start`,{minutes:t}),tp=e=>A(`cameras/${e}/record/stop`),sp=(e,t)=>Me(`cameras/${e}/motion`,t),ip=()=>k("nvr/system"),ap=e=>Me("nvr/time",e),rp=e=>Me("nvr/ntp",e),np=e=>A(`nvr/outputs/${e}/pulse`),op=(e,t="short")=>A(`nvr/storage/${e}/smart-test`,{kind:t}),lp=e=>A("nvr/reboot",{confirm:e}),dp=()=>k("nvr/connection"),cp=e=>Me("nvr/connection",e),pp=e=>k(`cameras/${e}/osd`),ji=(e,t)=>Me(`cameras/${e}/osd`,t),hp=e=>k(`cameras/${e}/schedules`),up=(e,t,s)=>Me(`cameras/${e}/schedules/${t}`,{days:s}),mp=(e,t)=>Me(`cameras/${e}/record-schedule`,t),fp=e=>k(`cameras/${e}/smart`),gp=(e,t)=>Me(`cameras/${e}/smart`,t),wp=(e,t)=>A(`cameras/${e}/osd/name`,{});var vp=Object.defineProperty,bp=Object.getOwnPropertyDescriptor,ds=(e,t,s,i)=>{for(var a=i>1?void 0:i?bp(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&vp(t,s,a),a};const yp=[6,0,1,2,3,4,5],Sr=["א׳","ב׳","ג׳","ד׳","ה׳","ו׳","ש׳"],Gt=e=>String(e).padStart(2,"0"),Mr=e=>Number(e.slice(0,2))+Number(e.slice(3,5))/60;function $p(e){return Array.from({length:7},(t,s)=>{const i=Array.from({length:24},()=>"");for(const a of e[s]??[]){const n=Math.floor(Mr(a.begin)),o=Math.min(24,Math.ceil(Mr(a.end)));for(let l=n;l<o;l++)i[l]=a.mode??"on"}return i})}function xp(e,t){return e.map(s=>{const i=[];let a=0;for(;a<24;){const n=s[a];if(!n){a++;continue}let o=a;for(;o<24&&s[o]===n;)o++;i.push(t?{begin:`${Gt(a)}:00:00`,end:`${Gt(o)}:00:00`,mode:n}:{begin:`${Gt(a)}:00:00`,end:`${Gt(o)}:00:00`}),a=o}return i})}let _t=class extends z{constructor(){super(...arguments),this.days=Array.from({length:7},()=>[]),this.modes=[{id:"on",label:"פעיל",color:"var(--sw-accent)"}],this.mode="on",this.editable=!1,this.painting=null,this.cells=[],this.lastDays=null,this.end=()=>{this.painting=null},this.onDown=e=>{if(!this.editable||e.button!==0)return;const t=this.cellAt(e);t&&(e.preventDefault(),e.currentTarget.setPointerCapture(e.pointerId),this.paint(t[0],t[1],!0))},this.onMove=e=>{if(this.painting===null||!e.buttons)return;const t=this.cellAt(e);t&&this.paint(t[0],t[1],!1)}}sync(){this.lastDays!==this.days&&(this.cells=$p(this.days),this.lastDays=this.days)}colorOf(e){return this.modes.find(t=>t.id===e)?.color??"var(--sw-accent)"}paint(e,t,s){if(!this.editable||(s&&(this.painting=this.cells[e][t]===this.mode?"":this.mode),this.painting===null)||this.cells[e][t]===this.painting)return;this.cells=this.cells.map((a,n)=>n===e?a.map((o,l)=>l===t?this.painting:o):a);const i=xp(this.cells,this.modes.length>1||this.modes[0]?.id!=="on");this.lastDays=i,this.days=i,this.dispatchEvent(new CustomEvent("change",{detail:{days:i},bubbles:!0,composed:!0}))}cellAt(e){const t=this.renderRoot,i=(t.elementFromPoint?t.elementFromPoint(e.clientX,e.clientY):null)?.dataset?.cell;if(!i)return null;const[a,n]=i.split("-").map(Number);return Number.isFinite(a)&&Number.isFinite(n)?[a,n]:null}connectedCallback(){super.connectedCallback(),window.addEventListener("pointerup",this.end)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("pointerup",this.end)}renderLegend(){const e=this.editable&&this.modes.length>1;return r`<div class="legend" data-week-legend>
      ...
      <div class="grid" role="grid" aria-label="לוח שבועי" @pointerdown=${this.onDown} @pointermove=${this.onMove} @pointerup=${this.end} @pointercancel=${this.end}>
        ...
        ${yp.map((e,t)=>r`
          <span class="d">${Sr[t]}</span>
          ${this.cells[e].map((s,i)=>r`<div class="c ${s?"on":""}" data-cell=${`${e}-${i}`} data-mode=${s} style=${s?`--cell:${this.colorOf(s)}`:""} title=${`${Sr[t]} ${Gt(i)}:00–${Gt(i+1)}:00${s?` · ${this.modes.find(a=>a.id===s)?.label??s}`:""}`}></div>`)}
        `)}
      </div>
      ${this.renderLegend()}
    `}};_t.styles=M`
  ...
  `;ds([f({attribute:!1})],_t.prototype,"days",2);ds([f({attribute:!1})],_t.prototype,"modes",2);ds([f()],_t.prototype,"mode",2);ds([f({type:Boolean})],_t.prototype,"editable",2);ds([c()],_t.prototype,"painting",2);_t=ds([E("sw-week-grid")],_t);var kp=Object.defineProperty,_p=Object.getOwnPropertyDescriptor,C=(e,t,s,i)=>{for(var a=i>1?void 0:i?_p(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&kp(t,s,a),a};let P=class extends z{constructor(){super(...arguments),this.cameraId="cam-1",this.cam=null,this.zones=null,this.zonesBusy=!1,this.zonesError="",this.motionEdit=null,this.motionConfirm=!1,this.motionBusy=!1,this.motionMsg="",this.paintValue=null,this.rec=null,this.osd=null,this.sched=null,this.schedError="",this.schedTab="motion",this.schedEdit=null,this.schedBusy=!1,this.schedMsg="",this.schedConfirm=!1,this.smart=null,this.smartEdit=null,this.smartBusy=!1,this.smartMsg="",this.osdMsg="",this.renameTo=null,this.renameBusy=!1,this.renameMsg="",this.osdBusy=!1,this.recMinutes=10,this.recBusy=!1,this.recMsg="",this.recTimer=0,this.zoneLayers={motion:!0,privacy:!0,intrusion:!0,lines:!0},this.caps=null,this.capsError="",this.cams=[],this.canConfigure=!1,this.settings=null,this.error="",this.loading=!0,this.profile="main",this.transport="auto",this.playerStatus="",this.playerTransport="",this.posterBust=Date.now(),this.ptzMode="presets"}async loadSchedules(){if(!(!this.cam||!y())){if(!ir()){this.sched=null,this.smart=null,this.schedError="לוחות הזמנים וחוקי ה־smart של ה־NVR נקראים עם הרשאת ניהול NVR.";return}try{this.sched=await hp(this.cam.id),this.schedError="",!this.sched.arming[this.schedTab]&&this.schedTab!=="record"&&(this.schedTab=Object.keys(this.sched.arming)[0]??"record")}catch(e){this.schedError=w(e)}try{this.smart=await fp(this.cam.id)}catch{this.smart=null}}}startSchedEdit(){const e=this.sched;if(!e)return;const t=this.schedTab,s=(t==="record"?e.record?.days:e.arming[t])??Array.from({length:7},()=>[]);this.schedMsg="",this.schedEdit={kind:t,days:s.map(i=>i.map(a=>({...a}))),schedule_enabled:e.record?.schedule_enabled??null,enabled:e.record?.enabled}}schedDiff(){const e=this.schedEdit,t=this.sched;if(!e||!t)return 0;const s=(e.kind==="record"?t.record?.days:t.arming[e.kind])??[],i=a=>a.map(n=>n.map(o=>`${o.begin}-${o.end}-${o.mode??""}`).join(",")).join("|");return i(s)===i(e.days)?0:1}async saveSched(){const e=this.schedEdit;if(!(!e||!this.cam||this.schedBusy)){this.schedBusy=!0,this.schedConfirm=!1;try{const t=e.kind==="record"?await mp(this.cam.id,{days:e.days,...e.schedule_enabled!==null&&e.schedule_enabled!==this.sched?.record?.schedule_enabled?{schedule_enabled:e.schedule_enabled??void 0}:{}}):await up(this.cam.id,e.kind,e.days);this.schedMsg=t.status==="unchanged"?"ה־NVR כבר היה במצב הזה — לא נכתב דבר.":"הלוח נכתב ל־NVR ונרשם (ניתן להחזרה מרשימת השינויים בהגדרות › חיבורים).",this.schedEdit=null,await this.loadSchedules()}catch(t){this.schedMsg=w(t)}finally{this.schedBusy=!1}}}renderSchedules(){const e=this.sched;if(this.schedError&&!e)return r`<div class="note">${this.schedError}</div>`;if(!e)return r`<div class="note">קורא לוחות מה־NVR…</div>`;const t=[{id:"motion",label:"זיהוי תנועה",ok:!!e.arming.motion},{id:"line",label:"חציית קו",ok:!!e.arming.line},{id:"field",label:"פריצה לאזור",ok:!!e.arming.field},{id:"record",label:"לוח הקלטה",ok:!!e.record}],s=this.schedTab,i=this.schedEdit?.kind===s?this.schedEdit:null,a=i?i.days:s==="record"?e.record?.days:e.arming[s],n=[{id:"CMR",label:"רציף",color:"#2f6bff"},{id:"MOTION",label:"תנועה",color:"#16a34a"},{id:"EDR",label:"אירוע",color:"#f59e0b"},{id:"ALARM",label:"אזעקה",color:"#dc2626"}],o=s==="record"?e.can.schedule:e.can.events,l=t.find(p=>p.id===s)?.label??"";return r`<div class="note">${t.length} לוחות בכרטיס הזה, כולל <strong>לוח הקלטה</strong> (מתי הערוץ מקליט בפועל) — לא רק לוחות הזיהוי.</div>
      ...
      ${s==="record"&&e.record?r`<div class="note" style="margin-block-start:6px">ברירת מחדל: ${e.record.default_mode??"—"} · לפני אירוע ${e.record.pre_record_s??"—"} שנ׳ · אחרי ${e.record.post_record_s??"—"} שנ׳ · הקלטה ${e.record.enabled?"פעילה":"כבויה"} · לוח ${e.record.schedule_enabled===!1?"כבוי (מקליט לפי ברירת המחדל)":"פעיל"}
            ${i?r`<label style="display:inline-flex;gap:4px;align-items:center;margin-inline-start:8px"><input type="checkbox" data-sched-enabled .checked=${i.schedule_enabled!==!1} @change=${p=>this.schedEdit={...i,schedule_enabled:p.target.checked}} /> לוח פעיל</label>`:d}</div>`:d}
    ...
    `}renderSmartEditor(){const e=this.smartEdit,t=s=>({any:"שני הכיוונים","left-right":"שמאל → ימין","right-left":"ימין → שמאל"})[s]??s;return r`<div class="legend" data-smart-editor style="display:grid;gap:8px;margin-block-start:8px">
    ...
    </sw-dialog>`}async loadOsd(){if(!(!this.cam||!y())){if(!ir()){this.osd=null;return}try{this.osd=await pp(this.cam.id)}catch{this.osd=null}}}async osdAction(e,t){if(!this.osdBusy){this.osdBusy=!0,this.osdMsg="";try{await t(),this.osdMsg=`${e}: נכתב ל־NVR ונרשם.`,await this.loadOsd()}catch(s){this.osdMsg=`${e}: ${w(s)}`}finally{this.osdBusy=!1}}}renderOsd(){const e=this.osd;if(!e||!e.can_write)return d;const t=(e.nvr_name??"")===e.vms_name;return r`<div class="note" style="margin-block-start:8px;display:flex;flex-wrap:wrap;gap:8px;align-items:center" data-osd>
      <span>שם ב־NVR: <b data-osd-nvr-name>${e.nvr_name??"—"}</b>${t?" (זהה לשם ב־VMS)":` · ב־VMS: ${e.vms_name}`}</span>
      <sw-button size="sm" icon="edit" ?disabled=${this.osdBusy||t} data-osd-write-name @click=${()=>this.osdAction("שם הערוץ",()=>wp(this.cam.id))}>כתוב את שם ה־VMS ל־NVR</sw-button>
      ${e.channel_name?r`<label style="display:inline-flex;gap:4px;align-items:center"><input type="checkbox" data-osd-name-enabled .checked=${e.channel_name.enabled} ?disabled=${this.osdBusy} @change=${s=>this.osdAction("שם על התמונה",()=>ji(this.cam.id,{name_enabled:s.target.checked}))} /> שם על התמונה</label>`:d}
      ${e.datetime?r`<label style="display:inline-flex;gap:4px;align-items:center"><input type="checkbox" data-osd-datetime-enabled .checked=${e.datetime.enabled} ?disabled=${this.osdBusy} @change=${s=>this.osdAction("חותמת זמן",()=>ji(this.cam.id,{datetime_enabled:s.target.checked}))} /> חותמת זמן</label>
        <sw-field><select aria-label="פורמט תאריך" data-osd-date-style ?disabled=${this.osdBusy} @change=${s=>this.osdAction("פורמט תאריך",()=>ji(this.cam.id,{date_style:s.target.value}))}>${e.date_styles.map(s=>r`<option value=${s} ?selected=${s===e.datetime.date_style}>${s}</option>`)}</select></sw-field>`:d}
      ${this.osdMsg?r`<span data-osd-msg>${this.osdMsg}</span>`:d}
    </div>`}async loadRecord(){if(!(!this.cam||!y())){try{this.rec=await Qc(this.cam.id)}catch{this.rec=null}window.clearTimeout(this.recTimer),this.rec?.active&&(this.recTimer=window.setTimeout(()=>void this.loadRecord(),15e3))}}async toggleRecord(){if(!(!this.cam||this.recBusy)){this.recBusy=!0,this.recMsg="";try{if(this.rec?.active)await tp(this.cam.id),this.recMsg="ההקלטה הידנית נעצרה.";else{const e=await ep(this.cam.id,this.recMinutes);this.recMsg=`הקלטה ידנית החלה · תיעצר אוטומטית ב־${new Date(e.stop_at).toLocaleTimeString("he-IL",{hour:"2-digit",minute:"2-digit"})}.`}await this.loadRecord()}catch(e){this.recMsg=w(e)}finally{this.recBusy=!1}}}renderRecord(){const e=this.rec;if(!e||!e.can_write)return d;const t=e.active,s=t?`${Math.floor(t.remaining_s/60)}:${String(t.remaining_s%60).padStart(2,"0")}`:"";return r`<div class="note" style="margin-block-start:8px;display:flex;flex-wrap:wrap;gap:8px;align-items:center" data-manual-record data-active=${t?"yes":"no"}>
    ...
    </div>`}connectedCallback(){super.connectedCallback(),this.load()}updated(e){e.has("cameraId")&&e.get("cameraId")!==void 0&&this.load(),e.has("cam")&&this.cam&&y()&&!this.zonesBusy&&(!this.zones||this.zones.camera_id!==this.cam.id)&&(this.loadRecord(),this.loadOsd(),this.loadSchedules(),this.zonesError="",this.loadZones()),e.has("cam")&&this.cam&&y()&&(!this.caps||this.caps.camera_id!==this.cam.id)&&this.loadCaps()}async loadZones(e=!1){if(this.cam){this.zonesBusy=!0,this.zonesError="";try{this.zones=await Xo(this.cam.id,e)}catch(t){this.zonesError=w(t)}finally{this.zonesBusy=!1}}}async loadCaps(e=!1){if(this.cam){this.capsError="";try{this.caps=await Qo(this.cam.id,e)}catch(t){this.capsError=w(t)}}}renderCaps(){const e=this.caps;if(this.capsError&&!e)return r`<div class="note" data-caps>יכולות המצלמה לא נקראו מה־NVR: ${this.capsError}</div>`;if(!e)return r`<div class="note" data-caps>קורא יכולות מה־NVR…</div>`;const t=e.ptz.state==="supported"?"live":e.ptz.state==="unsupported"?"neutral":"unknown",s=e.ptz.state==="supported"?`PTZ: נתמך${e.ptz.preset_count!==null?` · ${e.ptz.preset_count} presets`:""}`:e.ptz.state==="unsupported"?"PTZ: לא נתמך במצלמה זו":"PTZ: לא ידוע",i=e.audio.state==="available"?"live":e.audio.state==="disabled"?"stale":e.audio.state==="unsupported"?"neutral":"unknown",a=e.audio.state==="available"?`שמע דו־כיווני: ערוץ פעיל${e.audio.codec?` (${e.audio.codec})`:""}`:e.audio.state==="disabled"?"שמע דו־כיווני: ערוץ קיים אך כבוי במכשיר":e.audio.state==="unsupported"?"שמע דו־כיווני: אין ערוץ למצלמה זו":"שמע דו־כיווני: לא ידוע";return r`<div class="note" style="margin-block-start:8px;display:flex;flex-wrap:wrap;gap:6px;align-items:center" data-caps data-ptz=${e.ptz.state} data-audio=${e.audio.state}>
      ...
      <div class="zones" data-zones-loaded>
        <div class="frame">
          ...
          <svg viewBox="0 0 1000 1000" preserveAspectRatio="none" aria-label="אזורי זיהוי מעל תמונת המצלמה" style=${this.smartEdit?"cursor:crosshair":""} data-zones-svg @click=${o=>this.smartClick(o)}>
            ${this.motionEdit&&i&&i.rows&&i.cols?this.motionEdit.cells.flatMap((o,l)=>o.map((p,h)=>u`<rect class=${p?"cell":"cell off"} data-motion-cell=${`${l}-${h}`} x=${h*1e3/i.cols} y=${l*1e3/i.rows} width=${1e3/i.cols} height=${1e3/i.rows} style="cursor:crosshair;${p?"":"fill:rgba(255,255,255,0.03);stroke:rgba(255,255,255,0.18)"}" @pointerdown=${m=>{m.preventDefault(),this.paintCell(l,h,!0)}} @pointerenter=${m=>{m.buttons&1&&this.paintCell(l,h)}} @pointerup=${()=>this.paintValue=null}></rect>`)):d}
            ${!this.motionEdit&&s.motion&&i&&i.rows&&i.cols?i.cells.flatMap((o,l)=>o.map((p,h)=>p?u`<rect x=${h*1e3/i.cols} y=${l*1e3/i.rows} width=${1e3/i.cols} height=${1e3/i.rows} class="cell"></rect>`:d)):d}
      ...
      </div>`}async load(){this.loading=!0,this.error="";try{if(y()){const[e,t]=await Promise.all([Le(),Ve()]);this.cams=e.cameras,this.cam=e.cameras.find(s=>s.id===this.cameraId)??null,this.canConfigure=e.can_sync,this.settings=t,this.transport=Aa(t)}}catch(e){this.error=w(e)}finally{this.loading=!1}}setTransport(e){Jo(e===(this.settings?.["media.transport_default"]??"mse")?"":e),this.transport=e}onPlayer(e){this.playerStatus=e.detail.status,this.playerTransport=e.detail.transport??""}renderApi(){const e=this.cam;if(this.loading)return r`<sw-state-panel state="loading"></sw-state-panel>`;if(this.error)return r`<sw-state-panel state="error" hint=${this.error} actionLabel="נסה שוב" @action=${()=>this.load()}></sw-state-panel>`;if(!e)return r`<sw-state-panel state="forbidden" heading="המצלמה לא זמינה" hint="המצלמה לא נמצאה או שאין לך הרשאת צפייה בה."></sw-state-panel>`;const t=e.can_view_live!==!1&&e.status!=="offline",s=et(e.id,this.posterBust),i=e.stream;return r`
      ...
      <div class="controls">
        <div class="round" role="group" aria-label="פקדי מצלמה">
          ...
          ${rn()?r`<span class="note">ברירת המחדל של המערכת: ${this.settings?.["media.transport_default"]??"mse"}</span>`:d}
        </div>
    ...
    `}renderSettingsAccordion(e,t){const s=this.renderCaps(),i=this.renderRecord(),a=this.renderOsd();return r`<details class="acc-root" data-camera-settings>
      ...
      <div class="acc-body">
        ...
        <details class="acc" data-acc-more>
          ...
          <div class="acc-content tiles">
            ${this.cams.filter(n=>n.id!==e.id).slice(0,4).map(n=>r`<sw-camera-tile compact name=${n.name} state=${n.status==="online"?"live":n.status==="offline"?"offline":"unknown"} poster=${n.status==="offline"?"":et(n.id)} @click=${()=>$(`/live/cameras/${n.id}`)}></sw-camera-tile>`)}
          </div>
        </details>
      </div>
    </details>`}renderDemo(){const e=X.find(i=>i.id===this.cameraId)??X[0],t=e.state==="live"||e.state==="stale",s=tt[e.id]??"lobby";return r`
      ...
      <div class="grid">
        ...
        <sw-card heading="מצלמות באותה קומה">
          <div class="tiles">
            ${X.filter(i=>i.floor===e.floor&&i.id!==e.id).slice(0,4).map(i=>r`<sw-camera-tile compact name=${i.name} state=${i.state} scene=${tt[i.id]??"lobby"} @click=${()=>$(`/live/cameras/${i.id}`)}></sw-camera-tile>`)}
          </div>
        </sw-card>
      </div>
    `}render(){const e=y(),t=e?this.cam?.name??"מצלמה":(X.find(i=>i.id===this.cameraId)??X[0]).name,s=e?this.cam?`ערוץ ${this.cam.channel} · ${this.cam.name_source||""}`:"":`${(X.find(i=>i.id===this.cameraId)??X[0]).floor} · נתוני הדגמה`;return r`
  ...
  `;C([f()],P.prototype,"cameraId",2);C([c()],P.prototype,"cam",2);C([c()],P.prototype,"zones",2);C([c()],P.prototype,"zonesBusy",2);C([c()],P.prototype,"zonesError",2);C([c()],P.prototype,"motionEdit",2);C([c()],P.prototype,"motionConfirm",2);C([c()],P.prototype,"motionBusy",2);C([c()],P.prototype,"motionMsg",2);C([c()],P.prototype,"rec",2);C([c()],P.prototype,"osd",2);C([c()],P.prototype,"sched",2);C([c()],P.prototype,"schedError",2);C([c()],P.prototype,"schedTab",2);C([c()],P.prototype,"schedEdit",2);C([c()],P.prototype,"schedBusy",2);C([c()],P.prototype,"schedMsg",2);C([c()],P.prototype,"schedConfirm",2);C([c()],P.prototype,"smart",2);C([c()],P.prototype,"smartEdit",2);C([c()],P.prototype,"smartBusy",2);C([c()],P.prototype,"smartMsg",2);C([c()],P.prototype,"osdMsg",2);C([c()],P.prototype,"renameTo",2);C([c()],P.prototype,"renameBusy",2);C([c()],P.prototype,"renameMsg",2);C([c()],P.prototype,"osdBusy",2);C([c()],P.prototype,"recMinutes",2);C([c()],P.prototype,"recBusy",2);C([c()],P.prototype,"recMsg",2);C([c()],P.prototype,"zoneLayers",2);C([c()],P.prototype,"caps",2);C([c()],P.prototype,"capsError",2);C([c()],P.prototype,"cams",2);C([c()],P.prototype,"canConfigure",2);C([c()],P.prototype,"settings",2);C([c()],P.prototype,"error",2);C([c()],P.prototype,"loading",2);C([c()],P.prototype,"profile",2);C([c()],P.prototype,"transport",2);C([c()],P.prototype,"playerStatus",2);C([c()],P.prototype,"playerTransport",2);C([c()],P.prototype,"posterBust",2);C([c()],P.prototype,"ptzMode",2);C([ns("sw-live-player")],P.prototype,"player",2);P=C([E("live-camera")],P);var zp=Object.defineProperty,Sp=Object.getOwnPropertyDescriptor,at=(e,t,s,i)=>{for(var a=i>1?void 0:i?Sp(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&zp(t,s,a),a};const Mp={name:"",cameras:[],cols:2,rows:2,shared:!1,kiosk:!1},Ep=[{name:"כל המצלמות",layout:9,scope:"משותפת",mobile:"4 · משני",owner:"יוני",kiosk:!0},{name:"חוץ",layout:4,scope:"משותפת",mobile:"2 · משני",owner:"יוני",kiosk:!1},{name:"פנים",layout:6,scope:"משותפת",mobile:"ללא",owner:"יוסי",kiosk:!1},{name:"לילה",layout:4,scope:"אישית",mobile:"4 · משני",owner:"דנה",kiosk:!1}];let Re=class extends z{constructor(){super(...arguments),this.views=null,this.cams=[],this.canShare=!1,this.canManageAll=!1,this.editing=null,this.confirmDelete=null,this.busy=!1,this.error="",this.formError=""}connectedCallback(){super.connectedCallback(),y()&&this.load()}async load(){try{const[e,t]=await Promise.all([$n(),Le()]);this.views=e.views,this.canShare=e.can_share,this.canManageAll=e.can_manage_all,this.cams=t.cameras.filter(s=>s.enabled&&s.can_view_live!==!1),this.error=""}catch(e){this.error=w(e),this.views=this.views??[]}}canEdit(e){return this.canManageAll||e.owner_user_id===Te.me?.user.id}open(e){this.formError="",this.editing=e?{id:e.id,name:e.name,cameras:[...e.cameras],cols:e.cols,rows:e.rows,shared:e.shared,kiosk:e.kiosk}:{...Mp,cameras:[]}}toggleCamera(e){if(!this.editing)return;const t=this.editing.cameras.includes(e);!t&&this.editing.cameras.length>=16||(this.editing={...this.editing,cameras:t?this.editing.cameras.filter(s=>s!==e):[...this.editing.cameras,e]})}async save(){const e=this.editing;if(e){if(!e.name.trim()){this.formError="לתצוגה צריך שם.";return}if(!e.cameras.length){this.formError="בחר לפחות מצלמה אחת.";return}this.busy=!0;try{const t={name:e.name.trim(),cameras:e.cameras,cols:e.cols,rows:e.rows,shared:e.shared,kiosk:e.kiosk};e.id?await pd(e.id,t):await xn(t),this.editing=null,await this.load()}catch(t){this.formError=w(t)}finally{this.busy=!1}}}async removeView(){const e=this.confirmDelete;if(e){this.busy=!0;try{await hd(e.id),this.confirmDelete=null,await this.load()}catch(t){this.error=w(t)}finally{this.busy=!1}}}renderEditor(){const e=this.editing;return r`<sw-dialog open heading=${e.id?"עריכת תצוגה":"תצוגה חדשה"} subheading="שם, מצלמות ופריסה · תצוגה משותפת נראית לכל המשתמשים" data-view-dialog @close=${()=>this.editing=null}>
      <div class="form">
        ...
        ${e===null?r`<sw-state-panel state="loading" heading="טוען תצוגות…"></sw-state-panel>`:e.length?r`<div class="grid" data-views>
                ${e.map(t=>r`<sw-card data-view=${t.id}>
                    <div class="thumb" style=${`grid-template-columns:repeat(${Math.min(2,Math.max(1,t.cameras.length))}, 1fr)`}>
                      ${t.cameras.slice(0,4).map(s=>r`<img src=${et(s)} alt="" loading="lazy" @error=${i=>i.target.style.visibility="hidden"} />`)}
                    ...
                    <div class="foot">
                      <a href=${kn(t)}><sw-button size="sm" variant="primary" icon="play" data-view-open ?disabled=${!t.cameras.length}>פתח</sw-button></a>
                      <a href=${ud(t)} target="_blank" rel="noopener"><sw-button size="sm" icon="layers" data-view-kiosk-open ?disabled=${!t.cameras.length}>קיוסק</sw-button></a>
                      <span class="grow"></span>
    ...
    `}render(){return y()?this.renderApi():r`
      <sw-page heading="תצוגות שמורות" subheading="תבניות 1 / 2 / 4 / 6 / 9 / 12 / 16 / מותאם, אישיות או משותפות, עם התאמה למובייל · נתוני הדגמה">
        ...
        <div class="grid">
          ${Ep.map(e=>{const t=Math.ceil(Math.sqrt(e.layout));return r`<sw-card heading=${e.name}>
              <sw-badge slot="actions" kind="neutral" label=${e.scope}></sw-badge>
              <div class="thumb" style="grid-template-columns:repeat(${t},1fr)">${X.filter(s=>s.state==="live").slice(0,e.layout).map(s=>r`<sw-scene kind=${tt[s.id]??"lobby"}></sw-scene>`)}</div>
              <dl>
  ...
  `;at([c()],Re.prototype,"views",2);at([c()],Re.prototype,"cams",2);at([c()],Re.prototype,"canShare",2);at([c()],Re.prototype,"canManageAll",2);at([c()],Re.prototype,"editing",2);at([c()],Re.prototype,"confirmDelete",2);at([c()],Re.prototype,"busy",2);at([c()],Re.prototype,"error",2);at([c()],Re.prototype,"formError",2);Re=at([E("live-views")],Re);var Ap=Object.defineProperty,Pp=Object.getOwnPropertyDescriptor,mt=(e,t,s,i)=>{for(var a=i>1?void 0:i?Pp(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&Ap(t,s,a),a};const Dn="sw.kiosk.layout",Ip=[[2,2],[3,2],[3,3],[4,3],[4,4],[5,4],[6,4]];function Tn(e){try{const i=localStorage.getItem(Dn);if(i){const[a,n]=i.split("x").map(Number);if(a>=1&&n>=1)return{cols:a,rows:n}}}catch{}const t=Number(e?.["ui.kiosk_cols"]??0),s=Number(e?.["ui.kiosk_rows"]??0);return{cols:t>=1?t:3,rows:s>=1?s:2}}function Fi(e=Tn()){const t=as().params,s=Math.min(6,Math.max(1,Number(t.get("cols")??e.cols)||e.cols)),i=Math.min(5,Math.max(1,Number(t.get("rows")??e.rows)||e.rows));return{cameras:(t.get("cameras")??"").split(",").map(a=>a.trim()).filter(Boolean),cols:s,rows:i,rotate:Math.max(0,Number(t.get("rotate")??0)||0)}}let qe=class extends z{constructor(){super(...arguments),this.cams=null,this.settings=null,this.clock="",this.page=0,this.health=null,this.disconnected=!1,this.view=Fi(),this.failures=0,this.onHash=()=>{this.view=Fi(),this.page=this.restorePage(),this.startRotation()},this.started=0,this.staggerTimer=0}setLayout(e){const[t,s]=e.split("x").map(Number);if(!(t>=1&&s>=1))return;try{localStorage.setItem(Dn,`${t}x${s}`)}catch{}const i=new URLSearchParams(as().params);i.set("cols",String(t)),i.set("rows",String(s)),window.location.replace(`#/kiosk/all?${i.toString()}`)}get pageKey(){return`sw.kiosk.page:${this.view.cameras.join(",")}|${this.view.cols}x${this.view.rows}`}restorePage(){try{const e=Number(localStorage.getItem(this.pageKey)??"0");return Number.isFinite(e)&&e>=0?e:0}catch{return 0}}setPage(e){this.page=e;try{localStorage.setItem(this.pageKey,String(e%Math.max(1,this.pages)))}catch{}}connectedCallback(){super.connectedCallback(),this.page=this.restorePage(),this.tick(),this.timer=window.setInterval(()=>this.tick(),1e3),this.unsubscribe=fn(e=>{e.mode==="api"&&this.cams===null?this.load():e.mode!=="loading"&&this.requestUpdate()}),window.addEventListener("hashchange",this.onHash),this.startRotation(),this.pollHealth(),this.healthTimer=window.setInterval(()=>void this.pollHealth(),15e3)}disconnectedCallback(){window.clearTimeout(this.staggerTimer),super.disconnectedCallback(),window.clearInterval(this.timer),window.clearInterval(this.rotateTimer),window.clearInterval(this.healthTimer),window.removeEventListener("hashchange",this.onHash),this.unsubscribe?.()}startRotation(){window.clearInterval(this.rotateTimer),this.view.rotate>0&&(this.rotateTimer=window.setInterval(()=>{this.setPage(this.page+1),this.stagger()},this.view.rotate*1e3)),this.stagger()}async pollHealth(){if(y())try{this.health=await Ca(),(this.disconnected||this.failures>=3)&&this.load(),this.failures=0,this.disconnected=!1}catch{this.failures+=1,this.failures>=3&&(this.disconnected=!0)}}get pageSize(){return this.view.cols*this.view.rows}stagger(){window.clearTimeout(this.staggerTimer),this.started=0;const e=()=>{this.started<this.pageSize&&(this.started+=1,this.staggerTimer=window.setTimeout(e,400))};e()}get selected(){const e=(this.cams??[]).filter(t=>this.view.cameras.length===0||this.view.cameras.includes(t.id));return this.view.cameras.length?this.view.cameras.map(t=>e.find(s=>s.id===t)).filter(t=>!!t):e}get pages(){return Math.max(1,Math.ceil(this.selected.length/this.pageSize))}tick(){const e=new Date;this.clock=`${e.toLocaleDateString("he-IL",{weekday:"long",day:"2-digit",month:"2-digit",year:"numeric"})} · ${e.toLocaleTimeString("he-IL")}`}async load(){if(y())try{const[e,t]=await Promise.all([Le(),Ve()]);this.cams=e.cameras.filter(s=>s.enabled),this.settings=t,this.view=Fi(Tn(t))}catch{this.cams=[]}}render(){const t=y(),s=this.page%this.pages,i=t?this.selected.slice(s*this.pageSize,(s+1)*this.pageSize):[],a=X.filter(l=>l.state!=="forbidden").slice(0,9),n=t?i.filter(l=>l.status==="online").length:7,o=this.settings?.["media.max_live_sessions"]??8;return r`
      <header>
        ...
        ${t?r`<select class="layout" data-kiosk-layout aria-label="פריסה" @change=${l=>this.setLayout(l.target.value)}>
          ${Ip.map(([l,p])=>r`<option value=${`${l}x${p}`} ?selected=${l===this.view.cols&&p===this.view.rows}>${l}×${p} · ${l*p} מצלמות בעמוד</option>`)}
        </select>`:d}
        ${t&&this.health?r`<span class="pill" data-kiosk-health data-status=${this.health.status}>מערכת: ${_s[this.health.status]}${this.health.items.filter(l=>l.status!=="ok").length?` · ${this.health.items.filter(l=>l.status!=="ok").map(l=>l.label).join(", ")}`:""}</span>`:d}
  ...
  `;mt([c()],qe.prototype,"cams",2);mt([c()],qe.prototype,"settings",2);mt([c()],qe.prototype,"clock",2);mt([c()],qe.prototype,"page",2);mt([c()],qe.prototype,"health",2);mt([c()],qe.prototype,"disconnected",2);mt([c()],qe.prototype,"view",2);mt([c()],qe.prototype,"started",2);qe=mt([E("kiosk-wall")],qe);var Cp=Object.defineProperty,Dp=Object.getOwnPropertyDescriptor,He=(e,t,s,i)=>{for(var a=i>1?void 0:i?Dp(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&Cp(t,s,a),a};const Tp={preserved:"#16a34a",preserving:"#d97706",nvr:"#7c3aed"},Js=[{label:"יום",minutes:1440},{label:"6 שע׳",minutes:360},{label:"שעה",minutes:60},{label:"10 דק׳",minutes:10},{label:"דקה",minutes:1}];function la(e){return String(e).padStart(2,"0")}function De(e){const t=(e%1440+1440)%1440;return`${la(Math.floor(t/60))}:${la(Math.floor(t%60))}`}function nt(e){const t=(e%1440+1440)%1440,s=Math.min(59,Math.round(t%1*60));return`${De(t)}:${la(s)}`}const Op={motion:"#ef4444",person:"#2f6bff",vehicle:"#22c55e",line:"#f59e0b",offline:"#6b7280",door:"#8b5cf6"};let _e=class extends z{constructor(){super(...arguments),this.segments=[],this.events=[],this.bookmarks=[],this.cursor=615,this.windowMinutes=360,this.precision="estimated",this.follow=!0,this.limit=1440,this.hover=null,this.lastHoverBucket=-1,this.viewStart=-1,this.dragging=!1}get start(){const e=Math.max(0,1440-this.windowMinutes);return this.viewStart>=0&&!this.follow?Math.max(0,Math.min(e,this.viewStart)):Math.max(0,Math.min(e,this.cursor-this.windowMinutes/2))}get step(){return this.windowMinutes>=360?1:this.windowMinutes>=60?1/6:1/60}snap(e){const t=this.step;return Math.max(0,Math.min(this.limit,Math.round(e/t)*t))}x(e,t){return(e-this.start)/this.windowMinutes*t}minuteAt(e){const t=e.currentTarget.getBoundingClientRect();return this.start+(e.clientX-t.left)/t.width*this.windowMinutes}onMove(e){const t=this.minuteAt(e);if(this.hover=t,!this.dragging){const s=Math.floor(t*6);if(s!==this.lastHoverBucket){this.lastHoverBucket=s;const i=e.currentTarget.getBoundingClientRect();this.dispatchEvent(new CustomEvent("hover",{detail:{minute:t,x:e.clientX-i.left,width:i.width},bubbles:!0,composed:!0}))}}if(this.dragging){const s=this.snap(t);this.cursor=s,this.dispatchEvent(new CustomEvent("scrub",{detail:{minute:s},bubbles:!0,composed:!0}))}}onDown(e){e.button===0&&(e.currentTarget.setPointerCapture(e.pointerId),this.dragging=!0,this.viewStart=this.start,this.follow=!1)}onUp(e){if(!this.dragging)return;this.dragging=!1;const t=this.snap(this.minuteAt(e));this.cursor=t,this.follow=!0,this.dispatchEvent(new CustomEvent("seek",{detail:{minute:t,alt:e.altKey},bubbles:!0,composed:!0}))}onWheel(e){e.preventDefault();const t=Js.findIndex(i=>i.minutes===this.windowMinutes),s=Math.max(0,Math.min(Js.length-1,t+(e.deltaY>0?-1:1)));s!==t&&this.setWindow(Js[s].minutes,this.minuteAt(e))}setWindow(e,t=this.cursor){const s=Math.max(0,Math.min(1,(t-this.start)/this.windowMinutes));this.windowMinutes=e,this.viewStart=t-s*e,this.follow=!1,this.dispatchEvent(new CustomEvent("window-change",{detail:{minutes:e},bubbles:!0,composed:!0}))}buckets(e){const t=[],s=this.windowMinutes/e;for(let i=0;i<e;i++){const a=this.start+i*s,n=a+s;let o=0;for(const l of this.segments)l.endMin>a&&l.startMin<n&&(o=Math.max(o,l.kind==="motion"?2:1));o&&this.events.some(l=>l.minute>=a-s&&l.minute<=n+s)&&(o=3),t.push(o)}return t}tickEvery(){const e=this.windowMinutes;return e<=1?10/60:e<=10?1:e<=60?10:e<=360?60:180}label(e){return this.windowMinutes<=10?nt(e):De(e)}render(){const n=this.tickEvery(),o=[];for(let b=Math.ceil(this.start/n-1e-9)*n;b<=this.start+this.windowMinutes+1e-9;b+=n)o.push(b);const l=[0,12,26,36],p={verified:"זמן מאומת",keyframe_limited:"דיוק לפי keyframe",estimated:"זמן משוער",unknown:"דיוק לא ידוע"}[this.precision],h=this.x(this.cursor,1e3),m=this.label(this.cursor),g=m.length>5?62:48,v=this.limit<this.start+this.windowMinutes?Math.max(0,this.x(this.limit,1e3)):null;return r`
      <div class="bar">
        <span class="precision">${p} · לחיצה או גרירה = seek · גלגלת = זום</span>
        <div class="windows">
          ${Js.map(b=>r`<button class=${b.minutes===this.windowMinutes?"on":""} @click=${()=>this.setWindow(b.minutes)}>${b.label}</button>`)}
        </div>
      </div>
      <svg
        ...
        ${v!==null?u`<rect x=${v} y="14" width=${Math.max(0,1e3-v)} height=${44} fill="var(--sw-surface-3)" opacity="0.7" />`:d}
        ${this.buckets(160).map((b,S)=>{if(!b)return d;const N=l[b];return u`<rect x=${S*6.25+1} y=${58-N} width=${Math.max(2,6.25-2)} height=${N} rx="1.5" fill="var(--sw-accent)" opacity=${b===1?.45:b===2?.8:1} />`})}
        ${o.map(b=>u`<line x1=${this.x(b,1e3)} x2=${this.x(b,1e3)} y1=${58} y2=${63} stroke="var(--sw-border-strong)" /><text x=${this.x(b,1e3)} y=${78} font-size="10.5" text-anchor="middle" fill="var(--sw-text-3)" font-family="var(--sw-font)">${this.label(b)}</text>`)}
        ${this.events.map(b=>{const S=this.x(b.minute,1e3);return S<0||S>1e3?d:u`<g><circle cx=${S} cy=${58-l[3]-8} r="3.5" fill=${Op[b.kind]} /><title>${b.label} · ${De(b.minute)}</title></g>`})}
        ${this.bookmarks.map(b=>{const S=this.x(b.minute,1e3),N=this.x(b.endMinute,1e3);if(N<0||S>1e3)return d;const q=Tp[b.preservation],_=I=>{I.stopPropagation(),this.cursor=b.minute,this.follow=!0,this.dispatchEvent(new CustomEvent("seek",{detail:{minute:b.minute,alt:!1},bubbles:!0,composed:!0})),this.dispatchEvent(new CustomEvent("bookmark-click",{detail:{id:b.id,minute:b.minute},bubbles:!0,composed:!0}))};return u`<g class="bm" data-bookmark=${b.id} role="button" tabindex="0" aria-label=${b.label} @pointerdown=${I=>I.stopPropagation()} @click=${_} @keydown=${I=>(I.key==="Enter"||I.key===" ")&&_(I)}>
            <rect x=${Math.max(0,S)} y="13" width=${Math.max(2,Math.min(1e3,N)-Math.max(0,S))} height="3" rx="1.5" fill=${q} opacity="0.55" />
            <line x1=${S} x2=${S} y1="3" y2=${58} stroke=${q} stroke-dasharray="2 3" opacity="0.6" />
            <polygon points=${`${S},2 ${S+9},6 ${S},10`} fill=${q} />
            <title>${b.label} · ${De(b.minute)}</title>
          </g>`})}
        ...
        ${h>=-60&&h<=1060?u`<g transform="translate(${h} 0)" pointer-events="none">
  ...
  `;He([f({attribute:!1})],_e.prototype,"segments",2);He([f({attribute:!1})],_e.prototype,"events",2);He([f({attribute:!1})],_e.prototype,"bookmarks",2);He([f({type:Number})],_e.prototype,"cursor",2);He([f({type:Number})],_e.prototype,"windowMinutes",2);He([f()],_e.prototype,"precision",2);He([f({type:Boolean})],_e.prototype,"follow",2);He([f({type:Number})],_e.prototype,"limit",2);He([c()],_e.prototype,"hover",2);He([c()],_e.prototype,"viewStart",2);He([c()],_e.prototype,"dragging",2);_e=He([E("sw-timeline")],_e);const zs={open:"פתוח",in_review:"בבדיקה",closed:"סגור"},Rp={preserved:"עותק שמור",preserving:"מעתיק מה־NVR…",nvr_only:"סימנייה ל־NVR בלבד",missing:"חסר: ה־NVR כבר לא מחזיק את הקטע",unknown:"לא נבדק מול ה־NVR",none:""};function On(e={}){const t=new URLSearchParams;e.status&&t.set("status",e.status),e.q&&t.set("q",e.q);const s=t.toString();return k(`cases${s?`?${s}`:""}`)}const Rn=e=>A("cases",e),Np=(e,t=!0)=>k(`cases/${e}${t?"":"?check=false"}`),Bp=(e,t)=>Be(`cases/${e}`,t),Lp=e=>ve(`cases/${e}`),da=(e,t)=>A(`cases/${e}/items`,t),Vp=(e,t)=>ve(`cases/${e}/items/${t}`),Hp=(e,t)=>A(`cases/${e}/items/${t}/preserve`),Er={preserved:"עותק שמור",preserving:"מעתיק מה־NVR…",nvr:"סימנייה ל־NVR"},Ar=(e,t)=>k(`cases/bookmarks?camera_id=${encodeURIComponent(e)}&date=${encodeURIComponent(t)}`),Pr=e=>e.toISOString().replace(/\.\d{3}Z$/,"Z"),ca=(e,t=15,s=45)=>({from_at:Pr(new Date(e.getTime()-t*1e3)),to_at:Pr(new Date(e.getTime()+s*1e3))}),jp=()=>k("evidence/signing"),Fp=()=>A("evidence/signing/rotate"),Wp=e=>A(`cases/${e}/bundle`),Up=e=>k(`cases/${e}/bundles`),Zp=(e,t)=>ge(`cases/${e}/bundles/${t}`),qp=(e,t)=>ge(`cases/${e}/items/${t}/file`);function Kp(e){const t=new FormData;return t.append("file",e,e.name),$i("cases/bundles/verify",t)}var Gp=Object.defineProperty,Yp=Object.getOwnPropertyDescriptor,je=(e,t,s,i)=>{for(var a=i>1?void 0:i?Yp(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&Gp(t,s,a),a};let ze=class extends z{constructor(){super(...arguments),this.item=null,this.subheading="",this.cases=[],this.loading=!1,this.error="",this.picked="",this.newTitle="",this.note="",this.busy=!1,this.done=null,this.canManage=!0}updated(e){e.has("item")&&this.item&&this.load()}async load(){this.loading=!0,this.error="",this.done=null,this.note="";try{const e=await On({status:"open"});this.cases=e.cases,this.canManage=e.can_manage,this.picked=e.cases[0]?.id??"new"}catch(e){this.error=w(e)}finally{this.loading=!1}}close(){this.item=null,this.dispatchEvent(new CustomEvent("close",{bubbles:!0,composed:!0}))}async confirm(){const e=this.item;if(e){this.busy=!0,this.error="";try{let t=this.picked,s=this.cases.find(a=>a.id===t)?.title??"";if(t==="new"){if(!this.newTitle.trim()){this.error="תן שם לתיק החדש.";return}const a=await Rn({title:this.newTitle.trim()});t=a.id,s=a.title}const i=await da(t,{...e,note:this.note.trim()||e.note});this.done={id:t,title:s},this.dispatchEvent(new CustomEvent("added",{detail:{caseId:t,item:i},bubbles:!0,composed:!0}))}catch(t){this.error=w(t)}finally{this.busy=!1}}}render(){const e=this.item;if(!e)return d;const t=e.kind==="event"?"האירוע":e.kind==="clip"?"הקטע":"ההערה";return r`<sw-dialog open heading="הוסף לתיק" subheading=${this.subheading} data-case-picker @close=${()=>this.close()}>
      ...
      ${this.done?r`<sw-button slot="footer" variant="ghost" @click=${()=>this.close()}>סגור</sw-button>
            <sw-button slot="footer" variant="primary" icon="case" data-case-open @click=${()=>{const s=this.done?.id??"";this.close(),$(`/investigate/cases/${s}`)}}>פתח את התיק</sw-button>`:r`<sw-button slot="footer" variant="ghost" @click=${()=>this.close()}>ביטול</sw-button>
  ...
  `;je([f({attribute:!1})],ze.prototype,"item",2);je([f()],ze.prototype,"subheading",2);je([c()],ze.prototype,"cases",2);je([c()],ze.prototype,"loading",2);je([c()],ze.prototype,"error",2);je([c()],ze.prototype,"picked",2);je([c()],ze.prototype,"newTitle",2);je([c()],ze.prototype,"note",2);je([c()],ze.prototype,"busy",2);je([c()],ze.prototype,"done",2);je([c()],ze.prototype,"canManage",2);ze=je([E("sw-case-picker")],ze);const Nn=(e,t)=>k(`cameras/${e}/recordings?date=${t}`),Ss=new Set,Ms=new Set;function Jp(){if(!(!Ss.size&&!Ms.size)){for(const e of Ms)navigator.sendBeacon?.(ge(`playback/groups/${e}/close`),"");for(const e of Ss)navigator.sendBeacon?.(ge(`playback/sessions/${e}/close`),"");Ss.clear(),Ms.clear()}}typeof window<"u"&&window.addEventListener("pagehide",Jp);const Da=async(e,t)=>{const s=await A("playback/sessions",{camera_id:e,start_at:t});return Ss.add(s.id),s},Ir=(e,t)=>A(`playback/sessions/${e}/seek`,{start_at:t}),Ns=e=>(Ss.delete(e),ve(`playback/sessions/${e}`));function pi(e){const t=new URL(ge(`playback/sessions/${e.id}/ws?generation=${e.generation}`));return t.protocol=t.protocol==="https:"?"wss:":"ws:",t.toString()}function Xe(e,t){const s=new Intl.DateTimeFormat("en-CA",{timeZone:t,year:"numeric",month:"2-digit",day:"2-digit"}).formatToParts(e),i=a=>s.find(n=>n.type===a)?.value??"";return`${i("year")}-${i("month")}-${i("day")}`}function re(e,t){const s=new Intl.DateTimeFormat("en-GB",{timeZone:t,hour:"2-digit",minute:"2-digit",second:"2-digit",hourCycle:"h23"}).formatToParts(e),i=a=>Number(s.find(n=>n.type===a)?.value??0);return i("hour")*60+i("minute")+i("second")/60}function Je(e,t,s){const[i,a,n]=e.split("-").map(Number),o=Date.UTC(i,a-1,n,Math.floor(t/60),Math.floor(t%60),Math.round(t%1*60)),l=h=>{const m=new Intl.DateTimeFormat("en-US",{timeZone:s,hour12:!1,year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit",second:"2-digit"}).formatToParts(new Date(h)),g=b=>Number(m.find(S=>S.type===b)?.value??0);return Date.UTC(g("year"),g("month")-1,g("day"),g("hour")%24,g("minute"),g("second"))-h};let p=o-l(o);return p=o-l(p),new Date(p)}const Xp=async(e,t)=>{const s=await A("playback/groups",{camera_ids:e,start_at:t});return Ms.add(s.id),s},Qp=(e,t)=>A(`playback/groups/${e}/seek`,{start_at:t}),eh=e=>(Ms.delete(e),ve(`playback/groups/${e}`)),th=(e,t)=>A(`playback/groups/${e}/sync`,{p95_s:t.p95,quality:t.quality,samples:t.samples,partial:t.partial,members:t.members}),Si=(e,t)=>ge(`cameras/${e}/frame?at=${encodeURIComponent(t)}`),Bn=(e,t,s)=>({camera_id:e,from_at:t,to_at:s}),Cr=(e,t,s)=>A("exports/estimate",Bn(e,t,s)),sh=(e,t,s)=>A("exports",Bn(e,t,s)),ih=()=>k("exports"),ah=e=>A(`exports/${e}/cancel`),rh=e=>ve(`exports/${e}`),Ln=e=>ge(`exports/${e}/download`),nh=e=>ge(`exports/${e}/manifest`);function Jt(e){return e==null?"—":e<1024*1024?`${Math.round(e/1024)} KB`:e<1024*1024*1024?`${(e/1024/1024).toFixed(1)} MB`:`${(e/1024/1024/1024).toFixed(2)} GB`}var oh=Object.defineProperty,lh=Object.getOwnPropertyDescriptor,B=(e,t,s,i)=>{for(var a=i>1?void 0:i?lh(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&oh(t,s,a),a};const Pt=["closed","expired","failed"];function ms(e){return nt(Math.max(0,Math.min(1439.983,e)))}function Wi(e){const[t=0,s=0,i=0]=e.split(":").map(Number);return t*60+s+i/60}function dh(e){const t=e.map(s=>Math.abs(s)).sort((s,i)=>s-i);return t[Math.min(t.length-1,Math.max(0,Math.ceil(.95*t.length)-1))]}let O=class extends z{constructor(){super(...arguments),this.cameraId="",this.at="",this.extraParam="",this.demoCamera="cam-10",this.cursor=615,this.generation=3,this.playing=!0,this.speed=1,this.filter="all",this.cams=null,this.tz="Asia/Jerusalem",this.date="",this.rec=null,this.dayEvents=[],this.bookmarks=[],this.activeBookmark=null,this.loadingRec=!1,this.session=null,this.group=null,this.extra=[],this.casePick=null,this.preview=null,this.previewTimer=0,this.busy=!1,this.error="",this.notice="",this.tileStatus={},this.drifts={},this.clock=null,this.barrier="none",this.syncStats=null,this.clockPausedAt=0,this.driftSamples={},this.lateSince={},this.resyncAt={},this.resyncs={},this.nudges={},this.groupStartedAt=0,this.lastReport=0,this.seekSentAt={},this.firstPlayAt={},this.startLatency={},this.paused=!1,this.scrubbing=!1,this.position=null,this.exportOpen=!1,this.exportFrom="",this.exportTo="",this.estimate=null,this.exportJob=null,this.exportBusy=!1,this.exportError="",this.onTlHover=e=>{if(!this.cameraId||!y())return;window.clearTimeout(this.previewTimer);const t=e.detail;this.previewTimer=window.setTimeout(()=>{const s=Je(this.date,t.minute,this.tz).toISOString().replace(/\.\d{3}Z$/,"Z");this.preview={minute:t.minute,x:t.x,width:t.width,url:Si(this.cameraId,s),failed:!1}},250)},this.onTlHoverEnd=()=>{window.clearTimeout(this.previewTimer),this.preview=null}}connectedCallback(){super.connectedCallback(),y()&&(this.init(),this.ticker=window.setInterval(()=>this.tick(),500))}disconnectedCallback(){super.disconnectedCallback(),window.clearInterval(this.ticker),this.endSession()}updated(e){y()&&e.has("cameraId")&&e.get("cameraId")!==void 0&&this.cams&&this.selectCamera(this.cameraId,!0)}get members(){return[this.cameraId,...this.extra.filter(e=>e!==this.cameraId)]}get groupMode(){return this.extra.filter(e=>e!==this.cameraId).length>0}get masterSession(){return this.groupMode?this.group?.sessions.find(e=>e.camera_id===this.cameraId)??this.group?.sessions[0]??null:this.session}get live(){const e=this.masterSession;return!!e&&!Pt.includes(e.state)&&(this.groupMode?!!this.group:!0)}async init(){try{const[e,t]=await Promise.all([Ve(),Le()]);this.tz=e["time.zone"]??"Asia/Jerusalem",this.cams=t.cameras.filter(n=>n.enabled);const s=this.cams.find(n=>n.id===this.cameraId)??this.cams[0],i=this.at?new Date(this.at):null,a=!!i&&!Number.isNaN(i.getTime());if(this.date=Xe(a?i:new Date,this.tz),s)if(this.cameraId=s.id,this.extraParam&&(this.extra=this.extraParam.split(",").filter(n=>n&&n!==s.id&&this.cams.some(o=>o.id===n)).slice(0,3)),await this.loadRecordings(),a)this.cursor=re(i,this.tz),await this.startAt(i);else{const n=this.rec?.segments.at(-1);this.cursor=n?this.insideLast(n):Math.max(0,re(new Date,this.tz)-5)}}catch(e){this.error=w(e)}}async selectCamera(e,t=!1){!e||!t&&e===this.cameraId||(await this.endSession(),this.cameraId=e,this.extra=this.extra.filter(s=>s!==e),this.error="",this.notice="",await this.loadRecordings())}async setDate(e){if(!e||e===this.date)return;await this.endSession(),this.date=e,await this.loadRecordings();const t=this.rec?.segments.at(-1);this.cursor=t?this.insideLast(t):540}insideLast(e){const t=re(new Date(e.start_at),this.tz),s=re(new Date(e.end_at),this.tz);return Math.max(0,t,s-5)}async loadRecordings(){if(!(!this.cameraId||!this.date)){this.loadingRec=!0,this.rec=null;try{const[e,t,s]=await Promise.all([Nn(this.cameraId,this.date).then(i=>({ok:!0,r:i}),i=>({ok:!1,e:i})),Dc(this.cameraId,this.date).catch(()=>({events:[]})),Ar(this.cameraId,this.date).catch(()=>({bookmarks:[]}))]);if(this.dayEvents=t.events,this.bookmarks=s.bookmarks,this.activeBookmark=null,!e.ok)throw e.e;this.rec=e.r,this.error=""}catch(e){this.error=w(e)}finally{this.loadingRec=!1}}}get markers(){return this.dayEvents.map(e=>({minute:re(new Date(e.occurred_at),this.tz),kind:Rc(e.type),label:`${ee[e.type]??e.type}${e.confidence==="inferred"?" (מהקלטה)":""}${e.count>1?` ×${e.count}`:""}`}))}get bookmarkMarkers(){return this.bookmarks.map(e=>({id:e.id,minute:re(new Date(e.from_at),this.tz),endMinute:re(new Date(e.to_at),this.tz),label:`תיק „${e.case_title}”${e.note?` · ${e.note}`:""} · ${Er[e.preservation]}`,preservation:e.preservation}))}async loadBookmarks(){if(!(!this.cameraId||!this.date))try{this.bookmarks=(await Ar(this.cameraId,this.date)).bookmarks}catch{}}bookmarkAt(e){this.cameraId&&(this.casePick={kind:"clip",camera_id:this.cameraId,...ca(Je(this.date,e,this.tz),10,20),note:"סימנייה"})}get segmentsMin(){return this.rec?this.rec.segments.map(e=>{const t=re(new Date(e.start_at),this.tz);let s=re(new Date(e.end_at),this.tz);return s<t&&(s=1440),{startMin:t,endMin:s,kind:e.kind==="continuous"?"continuous":"motion"}}):[]}inRecording(e){return this.segmentsMin.some(t=>e>=t.startMin&&e<=t.endMin)}get limitMinute(){return this.date===Xe(new Date,this.tz)?re(new Date,this.tz):1440}cameraName(e){return this.cams?.find(t=>t.id===e)?.name??e}async startAt(e){if(!(!this.cameraId||this.busy)){this.busy=!0,this.error="",this.notice="",this.scrubbing=!1;try{const t=e.toISOString().replace(/\.\d{3}Z$/,"Z");if(this.groupMode){const s=performance.now(),i=this.group&&this.group.sessions.some(n=>!Pt.includes(n.state))?await Qp(this.group.id,t):await Xp(this.members,t);this.group=i;for(const n of i.sessions)this.seekSentAt[n.camera_id]=s,delete this.firstPlayAt[n.camera_id];this.session=null,this.position=new Date(i.requested_at);const a=Object.keys(i.missing);a.length&&(this.notice=`ללא הקלטה בזמן הזה: ${a.map(n=>this.cameraName(n)).join(", ")}`)}else{const s=this.session&&!Pt.includes(this.session.state)?await Ir(this.session.id,t):await Da(this.cameraId,t);this.session=s,this.group=null,this.position=new Date(s.requested_at),s.moved_to_next_segment&&(this.notice=`אין הקלטה בזמן שנבחר; הניגון התחיל בקטע הבא (${this.fmt(new Date(s.requested_at))}).`)}if(this.cursor=re(this.position,this.tz),this.paused=!1,this.tileStatus={},this.drifts={},this.resetClock(),!this.isConnected){await this.endSession();return}}catch(t){if(t instanceof ue&&t.body.code==="no_recording")this.notice="אין הקלטה בזמן הזה ובשש השעות שאחריו: פער בכיסוי, לא מדלגים ל־Live.",this.position=e;else if(t instanceof ue&&(t.body.code==="session_over"||t.body.code==="not_found")){this.session=null,this.group=null,this.busy=!1,await this.startAt(e);return}else this.error=w(t)}finally{this.busy=!1}}}async endSession(){const e=this.session,t=this.group;this.session=null,this.group=null,this.tileStatus={},this.drifts={},this.resetClock();try{t?await eh(t.id):e&&!Pt.includes(e.state)&&await Ns(e.id)}catch{}}async toggleExtra(e){const t=this.extra.includes(e)?this.extra.filter(i=>i!==e):[...this.extra,e].slice(-3),s=this.currentInstant();await this.endSession(),this.extra=t,s&&await this.startAt(s)}players(){return Array.from(this.renderRoot.querySelectorAll("sw-live-player"))}masterPlayer(){return this.players().find(e=>e.dataset.camera===this.cameraId)??this.players()[0]}currentInstant(){const e=this.masterSession;if(!e)return this.position;if(this.groupMode&&this.clock)return new Date(this.clockNow());const t=new Date(e.requested_at).getTime();return new Date(t+(this.masterPlayer()?.mediaTime??0)*1e3)}tick(){if(!this.masterSession||this.paused||this.scrubbing)return;if(this.groupMode&&this.group){this.tickGroup();return}const t=this.masterPlayer();if(!t||t.status!=="playing")return;const s=this.currentInstant();s&&(this.position=s,this.cursor=re(s,this.tz),t.stale&&t.bufferAhead<.4&&!this.busy&&this.startAt(s))}resetClock(){this.clock=null,this.clockPausedAt=0,this.barrier=this.groupMode?"waiting":"none",this.driftSamples={},this.lateSince={},this.resyncAt={},this.resyncs={},this.nudges={};for(const e of this.players())e.rate=1;this.groupMode&&(this.speed=1),this.syncStats=null,this.groupStartedAt=performance.now(),this.lastReport=0}clockNow(){const e=this.clock;return e.baseMs+((this.paused&&this.clockPausedAt?this.clockPausedAt:performance.now())-e.startedAt)}tickGroup(){const e=this.group,t=performance.now(),s=this.players().map(l=>{const p=l.dataset.camera??"",h=e.sessions.find(m=>m.camera_id===p);return{cid:p,p:l,sess:h,at:h?new Date(h.requested_at).getTime()+l.mediaTime*1e3:NaN}}).filter(l=>l.sess&&!Pt.includes(l.sess.state)),i=s.filter(l=>l.p.status==="playing");if(!this.clock){const l=s.length>0&&i.length===s.length,p=t-this.groupStartedAt>12e3&&i.length>0;if(!l&&!p){this.barrier="waiting";return}const h=i.find(m=>m.cid===this.cameraId)??i[0];this.clock={baseMs:h.at,startedAt:t},this.barrier="passed",this.driftSamples={},this.lateSince={}}let a=this.clockNow();if(i.length>=3){const l=i.map(p=>p.at).sort((p,h)=>p-h);a=l[Math.floor(l.length/2)]}else i.length&&(a=(i.find(l=>l.cid===this.cameraId)??i[0]).at);this.clock={baseMs:a,startedAt:t};const n=new Date(a);this.position=n,this.cursor=re(n,this.tz);const o={};for(const l of s){if(l.p.status!=="playing"){o[l.cid]=NaN,this.lateSince[l.cid]||(this.lateSince[l.cid]=t);continue}delete this.lateSince[l.cid];const p=(l.at-a)/1e3;o[l.cid]=p;const h=this.driftSamples[l.cid]??=[];if(h.push(p),h.length>40&&h.shift(),h.length>=2&&Math.abs(p)>.25&&Math.abs(p)<=3){const m=p<0?Math.abs(p)>1?1.15:1.05:Math.abs(p)>1?.85:.95;l.p.rate!==m&&(this.nudges[l.cid]=(this.nudges[l.cid]??0)+1),l.p.rate=m}else(Math.abs(p)<=.25||Math.abs(p)>3)&&(l.p.rate=1);l.cid!==this.cameraId&&h.length>=4&&h.slice(-4).every(m=>Math.abs(m)>3)&&(this.resyncs[l.cid]??0)<2&&t-(this.resyncAt[l.cid]??0)>2e4&&this.resyncMember(l.cid,a)}this.drifts=o,this.syncStats=this.computeSync(s.map(l=>l.cid),t),t-this.lastReport>5e3&&this.syncStats.samples>=4&&(this.lastReport=t,th(e.id,this.syncStats).catch(()=>{}))}computeSync(e,t){const s={};let i=null,a=0;for(const p of e){const h=this.driftSamples[p]??[],m=h.length?dh(h):null,g=this.lateSince[p]?t-this.lateSince[p]>8e3:!1;s[p]={p95:m,samples:h.length,last:h.length?h[h.length-1]:null,resyncs:this.resyncs[p]??0,state:g?"late":h.length?"measured":"waiting",latency_ms:this.startLatency[p]??null,nudges:this.nudges[p]??0},a+=h.length,m!==null&&(i=i===null?m:Math.max(i,m))}const n=Object.keys(this.group?.missing??{}),o=Object.values(s).some(p=>p.state==="late"),l=this.barrier!=="passed"||i===null?"waiting":i<=.5?"synced":i<=2?"slight":"out_of_sync";return{p95:i,quality:l,samples:a,partial:n.length>0||o,missing:n,members:s}}async resyncMember(e,t){const s=this.group,i=s?.sessions.find(n=>n.camera_id===e);if(!s||!i||Pt.includes(i.state))return;this.resyncAt[e]=performance.now(),this.resyncs[e]=(this.resyncs[e]??0)+1,this.driftSamples[e]=[];const a=Math.min(this.startLatency[e]??4e3,15e3);try{const n=await Ir(i.id,new Date(t+a).toISOString().replace(/\.\d{3}Z$/,"Z"));this.group===s&&(this.group={...s,sessions:s.sessions.map(o=>o.id===n.id?n:o)}),this.seekSentAt[e]=performance.now(),delete this.firstPlayAt[e]}catch{}}syncLabel(){const e=this.syncStats;if(this.barrier==="waiting"||!e||e.quality==="waiting")return"סנכרון: ממתין לחסם הפתיחה";const t=e.p95===null?"—":`${e.p95.toFixed(2)} ש׳`;return`סנכרון: ${{synced:"מסונכרן",slight:"סטייה קלה",out_of_sync:"לא מסונכרן",waiting:""}[e.quality]} · p95 ${t}${e.partial?" · חלקי":""}`}async onSeek(e){const t=e.detail.minute,s=Je(this.date,t,this.tz);if(s.getTime()>Date.now()){this.notice="לא ניתן לנגן זמן עתידי.",this.scrubbing=!1;return}this.cursor=t,e.detail.alt&&this.bookmarkAt(t),await this.startAt(s)}onScrub(e){this.scrubbing=!0,this.cursor=e.detail.minute,this.position=Je(this.date,e.detail.minute,this.tz)}async nudge(e){const t=this.currentInstant();t&&await this.startAt(new Date(t.getTime()+e*1e3))}setSpeed(e){if(this.groupMode||e>1)return;this.speed=e;const t=this.masterPlayer();t&&(t.rate=e)}stepFrame(e){const t=this.masterPlayer(),s=this.cams?.find(n=>n.id===this.cameraId),i=s?.stream?.fps&&s.stream.fps>0?s.stream.fps:25;if(!t)return;if(!t.stepFrame(e,i)){this.notice="הפריים המבוקש מחוץ למאגר שכבר הגיע מה־NVR — השתמש בקפיצה של 10 שניות או בציר הזמן.";return}this.notice="";const a=this.currentInstant();a&&(this.position=a,this.cursor=re(a,this.tz))}togglePause(){const e=this.players();if(e.length){if(this.paused){const t=this.masterPlayer();if(!this.groupMode&&t?.stale&&this.position){this.startAt(this.position);return}e.forEach(s=>s.resume()),this.clock&&this.clockPausedAt&&(this.clock={...this.clock,startedAt:this.clock.startedAt+(performance.now()-this.clockPausedAt)}),this.clockPausedAt=0}else e.forEach(t=>t.pause()),this.clockPausedAt=performance.now();this.paused=!this.paused}}onTilePlayer(e,t){if(this.tileStatus={...this.tileStatus,[e]:t.detail.status},t.detail.status==="playing"&&this.seekSentAt[e]&&!this.firstPlayAt[e]&&(this.firstPlayAt[e]=performance.now(),this.startLatency[e]=this.firstPlayAt[e]-this.seekSentAt[e]),e===this.cameraId){if(this.masterSession&&t.detail.status==="playing"&&(this.session&&(this.session={...this.session,state:"playing"}),!this.groupMode&&this.speed!==1)){const s=this.masterPlayer();s&&s.rate!==this.speed&&(s.rate=this.speed)}if(t.detail.status==="ended"){const s=this.currentInstant(),i=this.masterSession;s&&i&&new Date(i.playback_end_at).getTime()-s.getTime()<5e3&&this.startAt(new Date(new Date(i.playback_end_at).getTime()+1e3))}}}fmt(e){return new Intl.DateTimeFormat("he-IL",{timeZone:this.tz,hour:"2-digit",minute:"2-digit",second:"2-digit",hourCycle:"h23"}).format(e)}openExport(){const e=Math.floor(this.cursor*60)/60;this.exportFrom=ms(Math.max(0,e-1)),this.exportTo=ms(Math.min(this.limitMinute,e+1)),this.estimate=null,this.exportJob=null,this.exportError="",this.exportOpen=!0}exportRange(){const e=Je(this.date,Wi(this.exportFrom),this.tz),t=Je(this.date,Wi(this.exportTo),this.tz);return t.getTime()<=e.getTime()?(this.exportError="זמן הסיום חייב להיות אחרי ההתחלה.",null):[e.toISOString().replace(/\.\d{3}Z$/,"Z"),t.toISOString().replace(/\.\d{3}Z$/,"Z")]}async runEstimate(){const e=this.exportRange();if(e){this.exportBusy=!0,this.exportError="";try{this.estimate=await Cr(this.cameraId,e[0],e[1])}catch(t){this.exportError=w(t)}finally{this.exportBusy=!1}}}async runExport(){const e=this.exportRange();if(e){this.exportBusy=!0,this.exportError="";try{const t=this.estimate??await Cr(this.cameraId,e[0],e[1]);if(this.estimate=t,!t.files){this.exportError="אין קבצים מוקלטים בטווח שנבחר.";return}this.exportJob=await sh(this.cameraId,e[0],e[1])}catch(t){this.exportError=w(t)}finally{this.exportBusy=!1}}}renderExportDialog(){const e=this.estimate,t=this.exportJob;return r`<sw-dialog ?open=${this.exportOpen} heading="ייצוא קטע" subheading=${`${this.cameraName(this.cameraId)} · ${this.date} · ${this.tz}`} @close=${()=>this.exportOpen=!1}>
      <div class="dlg">
        ${t?r`<div class="est"><strong>עבודת הייצוא נוצרה</strong><span>${t.files.length} קבצים · משוער ${Jt(t.estimate_bytes)} · מצב: ${t.state}</span><span>ה־NVR עדיין מכין את הקובץ; "מעקב והורדה" למטה עובר למסך שבו כפתור ההורדה יופיע ברגע שהוא מוכן.</span></div>`:r`
              <div class="row">
              ...
              ${e?r`<div class="est">
                    <span>${e.files} קבצי NVR בטווח · נפח משוער ${Jt(e.estimate_bytes)} (מקסימום ${Jt(e.max_bytes)}) · כיסוי ${e.coverage==="complete"?"מלא":"חלקי"}</span>
      ...
      <div slot="footer" style="display:flex;gap:8px;justify-content:flex-end">
        ${t?r`<sw-button variant="primary" icon="download" @click=${()=>$("/investigate/exports")}>מעקב והורדה</sw-button><sw-button @click=${()=>this.exportOpen=!1}>סגור</sw-button>`:r`<sw-button ?disabled=${this.exportBusy} @click=${()=>this.runEstimate()}>חשב נפח</sw-button>
        ...
        ${a.map(n=>{const o=this.group?.sessions.find(m=>m.camera_id===n),l=this.group?.missing[n],p=this.drifts[n],h=this.tileStatus[n];return r`<div class="tile ${n===this.cameraId?"master":""}">
            ${o&&!Pt.includes(o.state)?r`<sw-live-player data-camera=${n} .wsUrl=${pi(o)} mode="mse" .retry=${!1} recorded compact @player-status=${m=>this.onTilePlayer(n,m)}></sw-live-player>`:r`<div class="center"><div><sw-icon name="offline" size=${20}></sw-icon><span>${l==="gap"||l==="no_recording"?"אין הקלטה בזמן הזה":l==="playback_quota"?"מכסת הניגון מלאה":this.busy?"מכין…":this.group?"לא זמין":"לחץ על ציר הזמן"}</span></div></div>`}
            <span class="name" data-tile=${n} data-tile-state=${this.syncStats?.members[n]?.state??""}>${this.cameraName(n)}${n===this.cameraId?r` · מוביל`:d}${o&&h==="playing"&&Number.isFinite(p)?r`<span class="drift ${Math.abs(p)>2?"bad":""}" title="סטייה מהשעון־אב, נמדדת מהפריים המוצג">${p>=0?"+":""}${p.toFixed(1)}s</span>`:d}${this.syncStats?.members[n]?.state==="late"?r`<span class="drift bad">מאחרת</span>`:d}${(this.syncStats?.members[n]?.resyncs??0)>0?r`<span class="drift">סונכרן מחדש ×${this.syncStats.members[n].resyncs}</span>`:d}</span>
          </div>`})}
      </div>`}const i=this.session;return r`<div class="video ${s?"gap":""}">
      ${t&&i?r`<sw-live-player data-camera=${e.id} .wsUrl=${pi(i)} mode="mse" .retry=${!1} recorded @player-status=${a=>this.onTilePlayer(e.id,a)}></sw-live-player>`:s?r`<div class="center"><div><sw-icon name="offline" size=${32}></sw-icon><span>${this.notice||"אין הקלטה בזמן הזה: פער בכיסוי, לא מדלגים ל־Live"}</span></div></div>`:r`<div class="center"><div><sw-icon name="play" size=${32}></sw-icon><span>${this.busy?"מכין ניגון…":"לחץ על ציר הזמן (או על נגן) כדי להתחיל מהזמן שנבחר"}</span>${this.busy?d:r`<sw-button variant="primary" size="sm" icon="play" @click=${()=>this.startAt(Je(this.date,this.cursor,this.tz))}>נגן מ־${ms(this.cursor)}</sw-button>`}</div></div>`}
      <div class="tag"><sw-badge kind=${t?"recorded":"unknown"} ?onImage=${!!t}></sw-badge><span class="nm">${e.name}</span></div>
    </div>`}renderApi(){if(this.error&&!this.cams)return r`<sw-state-panel state="error" hint=${this.error} actionLabel="נסה שוב" @action=${()=>this.init()}></sw-state-panel>`;if(!this.cams)return r`<sw-state-panel state="loading"></sw-state-panel>`;if(!this.cams.length)return r`<sw-state-panel state="empty" heading="אין מצלמות" hint="סנכרן מצלמות מה־NVR או בקש הרשאת ניגון."></sw-state-panel>`;const e=this.cams.find(o=>o.id===this.cameraId)??this.cams[0],t=this.masterSession,s=this.live,i=t?.time_precision??"unknown",a=this.position??Je(this.date,this.cursor,this.tz),n=this.tileStatus[this.cameraId]??"";return r`
      <div class="filters">
        ${this.rec?r`<sw-chip icon="history">${this.rec.segments.length} מקטעים · ${this.rec.matches} קבצים</sw-chip>`:d}
        ${this.dayEvents.length?r`<sw-chip icon="bell" @click=${()=>$("/investigate/events",{camera:this.cameraId,date:this.date})}>${this.dayEvents.length} אירועים${this.dayEvents.every(o=>o.confidence==="inferred")?" (מהקלטות)":""}</sw-chip>`:d}
        ...
        ${this.activeBookmark?r`<sw-chip selected icon="case" data-bookmark-active @click=${()=>$(`/investigate/cases/${this.activeBookmark.case_id}`)}>תיק „${this.activeBookmark.case_title}”${this.activeBookmark.note?` · ${this.activeBookmark.note}`:""} · ${Er[this.activeBookmark.preservation]} · פתח</sw-chip>`:d}
        ...
        ${this.error?r`<span class="err">${this.error}</span>`:d}
        <span class="grow"></span>
        <sw-button size="sm" icon="case" data-add-to-case title="סימנייה בנקודה הנוכחית · Alt+לחיצה על הציר מסמנת נקודה אחרת" ?disabled=${!this.cameraId} @click=${()=>this.casePick={kind:"clip",camera_id:this.cameraId,...ca(Je(this.date,this.cursor,this.tz))}}>הוסף לתיק</sw-button>
      ...
      <div class="stage">
        ...
        <div class="bar"><div class="inner">
          ...
          <span class="sep"></span>
          ${[.25,.5,1,2,4].map(o=>{const l=(t?.capabilities.supported_speeds??[1]).includes(o),p=this.masterPlayer()?.transport==="mse",h=o===1||!this.groupMode&&l&&(o>1||p),m=h?o<1?"הילוך איטי: המאגר מתמלא בזמן אמת ונצרך לאט יותר — זמן המקור נשאר מדויק":"":this.groupMode?"בסנכרון רב־מצלמות נתמך רק 1×":o>1?"לא נתמך במסלול הזה: הזרם מגיע מה־NVR בזמן אמת; מהירות מוגברת דורשת מקור ששולח מהר מזמן אמת":"הילוך איטי זמין רק בנתיב MSE";return r`<button class="q ${this.speed===o?"on":""}" data-speed=${o} ?disabled=${!h} title=${m} @click=${()=>this.setSpeed(o)}>${o}×</button>`})}
          <span class="sep"></span>
      ...
      <div class="tlwrap">
        ...
        ${this.preview?r`<div class="tlpreview" data-tl-preview style="left:${Math.max(104,Math.min(this.preview.width-104,this.preview.x))}px">
              ...
              <span>${nt(this.preview.minute)}</span>
            </div>`:d}
      </div>
      <sw-case-picker .item=${this.casePick} subheading=${`${this.cams?.find(o=>o.id===this.cameraId)?.name??""} · ${this.date} ${nt(this.cursor)}`} @added=${()=>void this.loadBookmarks()} @close=${()=>this.casePick=null}></sw-case-picker>
      <div class="session">
    ...
    `}seekDemo(e){this.cursor=e.detail.minute,this.generation+=1}renderDemo(){const e=X.find(i=>i.id===this.demoCamera)??X[0],t=!ni.some(i=>this.cursor>=i.startMin&&this.cursor<=i.endMin),s=ot.filter(i=>i.minuteOfDay<1440).filter(i=>this.filter==="all"||i.type===this.filter).map(i=>({minute:i.minuteOfDay,kind:i.type,label:i.title}));return r`
      <div class="video ${t?"gap":""}">
        ${t?r`<div class="center"><div><sw-icon name="offline" size=${32}></sw-icon><span>אין הקלטה בזמן הזה: פער בכיסוי, לא מדלגים ל־Live</span></div></div>`:r`<sw-scene kind=${tt[e.id]??"lobby"}></sw-scene><div class="shade"></div><span class="demo">דמו · אין שרת מחובר</span>`}
      ...
      <sw-timeline .segments=${ni} .events=${s} .cursor=${this.cursor} precision="estimated" @seek=${this.seekDemo}></sw-timeline>
      <div class="filters">
    ...
    `}render(){const e=y(),t=e?this.cams?.find(o=>o.id===this.cameraId):X.find(o=>o.id===this.demoCamera)??X[0],s=t?.name??"הקלטות",i=e?`${this.date} ${ms(this.cursor)} · אזור זמן ${this.tz}`:`14.09.2026 ${De(this.cursor)} · אזור זמן האתר Asia/Jerusalem · נתוני הדגמה`,a=e?"הקלטות":`הקלטות | ${t?.floor??""}`,n=e?Xe(new Date,this.tz):"2026-09-14";return r`
      <sw-page heading=${s} subheading=${i} crumbs=${a} wide>
        <div slot="actions" class="pick">
          ${e?r`<sw-field><select aria-label="מצלמה" @change=${o=>this.selectCamera(o.target.value)}>${(this.cams??[]).map(o=>r`<option value=${o.id} ?selected=${o.id===this.cameraId}>${o.name}</option>`)}</select></sw-field>`:r`<sw-field><select aria-label="מצלמה" @change=${o=>this.demoCamera=o.target.value}>${X.map(o=>r`<option value=${o.id} ?selected=${o.id===this.demoCamera}>${o.name}</option>`)}</select></sw-field>`}
          ...
          <sw-field style="inline-size:132px"><input type="time" step="1" .value=${e?ms(this.cursor):De(this.cursor)} data-ltr aria-label="שעה" @change=${o=>{const l=o.target.value;if(e)this.onSeek(new CustomEvent("seek",{detail:{minute:Wi(l)}}));else{const[p,h]=l.split(":").map(Number);this.cursor=p*60+h,this.generation+=1}}} /></sw-field>
        </div>
  ...
  `;B([f()],O.prototype,"cameraId",2);B([f()],O.prototype,"at",2);B([f()],O.prototype,"extraParam",2);B([c()],O.prototype,"demoCamera",2);B([c()],O.prototype,"cursor",2);B([c()],O.prototype,"generation",2);B([c()],O.prototype,"playing",2);B([c()],O.prototype,"speed",2);B([c()],O.prototype,"filter",2);B([c()],O.prototype,"cams",2);B([c()],O.prototype,"tz",2);B([c()],O.prototype,"date",2);B([c()],O.prototype,"rec",2);B([c()],O.prototype,"dayEvents",2);B([c()],O.prototype,"bookmarks",2);B([c()],O.prototype,"activeBookmark",2);B([c()],O.prototype,"loadingRec",2);B([c()],O.prototype,"session",2);B([c()],O.prototype,"group",2);B([c()],O.prototype,"extra",2);B([c()],O.prototype,"casePick",2);B([c()],O.prototype,"preview",2);B([c()],O.prototype,"busy",2);B([c()],O.prototype,"error",2);B([c()],O.prototype,"notice",2);B([c()],O.prototype,"tileStatus",2);B([c()],O.prototype,"drifts",2);B([c()],O.prototype,"clock",2);B([c()],O.prototype,"barrier",2);B([c()],O.prototype,"syncStats",2);B([c()],O.prototype,"paused",2);B([c()],O.prototype,"scrubbing",2);B([c()],O.prototype,"position",2);B([c()],O.prototype,"exportOpen",2);B([c()],O.prototype,"exportFrom",2);B([c()],O.prototype,"exportTo",2);B([c()],O.prototype,"estimate",2);B([c()],O.prototype,"exportJob",2);B([c()],O.prototype,"exportBusy",2);B([c()],O.prototype,"exportError",2);O=B([E("investigate-playback")],O);var ch=Object.defineProperty,ph=Object.getOwnPropertyDescriptor,Mt=(e,t,s,i)=>{for(var a=i>1?void 0:i?ph(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&ch(t,s,a),a};const Dr="sw.sync.recent";function Ui(e){const t=s=>String(s).padStart(2,"0");return`${e.getFullYear()}-${t(e.getMonth()+1)}-${t(e.getDate())}T${t(e.getHours())}:${t(e.getMinutes())}:${t(e.getSeconds())}`}let st=class extends z{constructor(){super(...arguments),this.cursor=615,this.playing=!1,this.cams=null,this.picked=[],this.when=Ui(new Date(Date.now()-10*6e4)),this.recent=[],this.error=""}connectedCallback(){if(super.connectedCallback(),!!y()){try{this.recent=JSON.parse(localStorage.getItem(Dr)??"[]")}catch{this.recent=[]}this.load()}}async load(){try{const e=await Le();this.cams=e.cameras.filter(t=>t.enabled&&t.can_view_live!==!1),this.error=""}catch(e){this.error=w(e),this.cams=[]}}toggle(e){this.picked=this.picked.includes(e)?this.picked.filter(t=>t!==e):this.picked.length>=4?this.picked:[...this.picked,e]}launch(e=this.picked,t){if(e.length<2)return;const s=t??new Date(this.when).toISOString(),i={cameras:e,at:s,opened:new Date().toISOString()},a=this.recent.filter(n=>n.cameras.join(",")!==e.join(","));this.recent=[i,...a].slice(0,6);try{localStorage.setItem(Dr,JSON.stringify(this.recent))}catch{}$("/investigate/playback",{camera:e[0],extra:e.slice(1).join(","),t:s})}name(e){return this.cams?.find(t=>t.id===e)?.name??e}renderApi(){const e=this.cams;return r`
        ...
        ${e===null?r`<sw-state-panel state="loading" heading="טוען מצלמות…"></sw-state-panel>`:r`
            ...
            <sw-card heading="זמן התחלה" subheading="זמן מקומי של הדפדפן; ההקלטה נפתחת מהפריים הקרוב ביותר">
              <div class="transport">
                ...
                <sw-button size="sm" @click=${()=>this.when=Ui(new Date(Date.now()-10*6e4))}>לפני 10 דק׳</sw-button>
                <sw-button size="sm" @click=${()=>this.when=Ui(new Date(Date.now()-60*6e4))}>לפני שעה</sw-button>
                <span class="grow"></span>
    ...
    `}render(){if(y())return this.renderApi();const e=[{cam:X[0],drift:"+0.2s",state:"recorded"},{cam:X[9],drift:"-0.4s",state:"recorded"},{cam:X[3],drift:"gap",state:"unknown"},{cam:X[1],drift:"buffering",state:"stale"}];return r`
      <sw-page heading="מרכז שליטה" subheading="ניטור חי עם ניגון מסונכרן · 4 מקורות · שעון ייחוס אחד · נתוני הדגמה" wide>
        ...
        <sw-timeline .segments=${ni} .events=${ot.slice(0,4).map(t=>({minute:t.minuteOfDay,kind:t.type,label:t.title}))} .cursor=${this.cursor} precision="estimated" @seek=${t=>this.cursor=t.detail.minute}></sw-timeline>
        <div class="filters">
  ...
  `;Mt([c()],st.prototype,"cursor",2);Mt([c()],st.prototype,"playing",2);Mt([c()],st.prototype,"cams",2);Mt([c()],st.prototype,"picked",2);Mt([c()],st.prototype,"when",2);Mt([c()],st.prototype,"recent",2);Mt([c()],st.prototype,"error",2);st=Mt([E("investigate-sync")],st);var hh=Object.defineProperty,uh=Object.getOwnPropertyDescriptor,de=(e,t,s,i)=>{for(var a=i>1?void 0:i?uh(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&hh(t,s,a),a};const Zi=10;function mh(e){return e==="person"||e==="vehicle"||e==="motion"||e==="line"||e==="offline"||e==="door"?e:"motion"}let ie=class extends z{constructor(){super(...arguments),this.floorId="f0",this.at="",this.camera="",this.minute=615,this.tz="Asia/Jerusalem",this.date="",this.tree=null,this.bundle=null,this.events=[],this.recordings=new Map,this.selectedId=null,this.loading=!1,this.error="",this.frameAt="",this.frameFailed=!1,this.casePick=null,this.geometry=null,this.geomSeq=0,this.frameTimer=0}connectedCallback(){super.connectedCallback(),y()&&this.init()}updated(e){y()&&(e.has("floorId")&&e.get("floorId")!==void 0||e.has("at")&&e.get("at")!==void 0)&&this.init()}async init(){this.loading=!0,this.error="";try{const[e,t]=await Promise.all([Ve(),this.tree?Promise.resolve(this.tree):St()]);if(this.tz=e["time.zone"]??this.tz,this.tree=t,y()&&this.floors.length&&!this.floors.some(i=>i.id===this.floorId)){const i=new URLSearchParams(window.location.hash.split("?")[1]??"").toString();window.location.replace(`#/investigate/floors/${this.floors[0].id}/history${i?`?${i}`:""}`);return}const s=this.at?new Date(this.at):new Date;if(this.date=Xe(s,this.tz),this.minute=re(s,this.tz),this.bundle=await Ts(this.floorId,!1,this.instant.toISOString().replace(/\.\d{3}Z$/,"Z")),this.geometry=null,this.updateGeometry(),this.scheduleFrame(),this.camera){const i=this.bundle.anchors.find(a=>a.resource_type==="camera"&&a.resource_id===this.camera);this.selectedId=i?.id??null}await this.loadDay()}catch(e){this.error=w(e)}finally{this.loading=!1}}async loadDay(){const e=this.bundle;if(!e)return;const t=e.anchors.filter(n=>n.resource_type==="camera").map(n=>n.resource_id),[s,i]=await Promise.all([zi({date:this.date,limit:1e3}).then(n=>n.events.filter(o=>o.camera_id&&t.includes(o.camera_id))).catch(()=>[]),Promise.allSettled(t.map(n=>Nn(n,this.date)))]);this.events=s;const a=new Map;t.forEach((n,o)=>{const l=i[o];a.set(n,l.status==="fulfilled"?l.value:null)}),this.recordings=a}get instant(){return Je(this.date,this.minute,this.tz)}segmentsFor(e){const t=this.recordings.get(e);return t?t.segments.map(s=>{const i=re(new Date(s.start_at),this.tz);let a=re(new Date(s.end_at),this.tz);return a<i&&(a=1440),{startMin:i,endMin:a,kind:s.kind==="continuous"?"continuous":"motion"}}):null}coverageAt(e){const t=this.segmentsFor(e);if(!t)return{state:"unknown"};const s=t.find(i=>this.minute>=i.startMin&&this.minute<=i.endMin);return s?{state:"historic",segment:s}:{state:"unknown"}}eventsNear(e,t=Zi){const s=this.instant.getTime();return this.events.filter(i=>(!e||i.camera_id===e)&&Math.abs(new Date(i.occurred_at).getTime()-s)<=t*60*1e3).sort((i,a)=>Math.abs(new Date(i.occurred_at).getTime()-s)-Math.abs(new Date(a.occurred_at).getTime()-s))}get apiMarkers(){const e=this.bundle;return e?e.anchors.map(t=>{if(t.resource_type==="camera"){const a=this.coverageAt(t.resource_id),n=this.eventsNear(t.resource_id,5).length,o=t.camera?.name??t.label??t.resource_id;return{id:t.id,kind:"camera",label:n?`${o} · ${n} אירועים`:o,x:t.position.x,y:t.position.y,rotation:t.rotation_degrees,fov:t.field_of_view_degrees??void 0,radius:t.coverage_radius??void 0,polygon:t.coverage_polygon?t.coverage_polygon.map(([l,p])=>({x:l,y:p})):void 0,labelPos:t.label_pos??void 0,state:a.state}}const s=t.entity?.state_at,i=$s(t);return{id:t.id,kind:ki(t.layer_id,t.entity?.domain),label:s?.known&&s.state?`${i} · ${kt({...t.entity??{domain:"",unit:null,device_class:null,attributes:{}},state:s.state})}`:i,x:t.position.x,y:t.position.y,state:s?.known?"historic":"unknown"}}):[]}get selectedAnchor(){return this.bundle?.anchors.find(e=>e.id===this.selectedId)??null}get limitMinute(){return this.date===Xe(new Date,this.tz)?re(new Date,this.tz):1440}setMinute(e){this.minute=Math.max(0,Math.min(this.limitMinute,e)),this.scheduleFrame()}scheduleFrame(){window.clearTimeout(this.frameTimer),this.frameTimer=window.setTimeout(()=>{this.frameAt=this.instant.toISOString().replace(/\.\d{3}Z$/,"Z"),this.frameFailed=!1,this.ensureVersion()},600)}async updateGeometry(){const e=this.bundle,t=++this.geomSeq;if(!e||e.source!=="api"||!e.planVersionId){this.geometry=null;return}const s=this.instant.toISOString().replace(/\.\d{3}Z$/,"Z"),i=e.history==="exact"?await zd(e.planVersionId,s):await Ma(e);t===this.geomSeq&&(this.geometry=i)}async ensureVersion(){const e=this.bundle;if(!e||e.source!=="api"||!e.at)return;const t=this.instant.toISOString().replace(/\.\d{3}Z$/,"Z");if(e.history==="current"?!e.historyFrom||t<e.historyFrom:(!e.planPublishedAt||e.planPublishedAt<=t)&&(!e.planArchivedAt||t<e.planArchivedAt)){this.updateGeometry();return}try{const i=await Ts(this.floorId,!1,t),a=e.anchors.map(n=>n.resource_id).sort().join(",");this.bundle=i,i.planVersionId!==e.planVersionId&&(this.geometry=null),this.updateGeometry(),this.selectedId&&!i.anchors.some(n=>n.id===this.selectedId)&&(this.selectedId=null),i.anchors.map(n=>n.resource_id).sort().join(",")!==a&&await this.loadDay()}catch{}}renderEntityStates(e){const t=e.anchors.filter(a=>a.resource_type==="ha_entity");if(!t.length)return r`אין ישויות מוצבות בקומה`;const s=t.filter(a=>a.entity?.state_at?.known),i=e.haHistory;return r`${s.length} מתוך ${t.length} ידועות בזמן זה${i?.from?r` <span class="note">(היסטוריה מקומית מ־<span class="ltr">${this.fmtWhen(i.from)}</span>, ${i.retention_days} ימים)</span>`:r` <span class="note">(אין עדיין היסטוריה מקומית)</span>`}
      <div class="evl" style="margin-block-start:4px">${t.slice(0,8).map(a=>{const n=a.entity?.state_at,o=$s(a);return r`<div data-history-entity data-known=${n?.known?"true":"false"} data-source=${n?.source??"vms"}><span>${o}${n?.source==="ha_recorder"?r` <span class="note" title="המצב מגיע מה־recorder של Home Assistant (מקור משני)">· HA recorder</span>`:d}</span><span class="note">${n?.known&&n.state?r`${kt({...a.entity??{domain:"",unit:null,device_class:null,attributes:{}},state:n.state})} · מ־<span class="ltr">${n.changed_at?this.fmt(n.changed_at):""}</span>`:r`לא ידוע${n?.reason?` · ${n.reason}`:""}${n?.state?r` <span class="ltr">(אחרון: ${n.state})</span>`:""}`}</span></div>`})}</div>`}fmtWhen(e){return new Intl.DateTimeFormat("he-IL",{timeZone:this.tz,dateStyle:"short",timeStyle:"short"}).format(new Date(e))}setDate(e){this.date=e,this.minute=Math.min(this.minute,this.limitMinute),this.loadDay()}fmt(e){return new Intl.DateTimeFormat("he-IL",{timeZone:this.tz,hour:"2-digit",minute:"2-digit",second:"2-digit",hourCycle:"h23"}).format(new Date(e))}get floors(){return this.tree?.source!=="api"?[]:this.tree.sites.flatMap(e=>(e.buildings??[]).flatMap(t=>(t.floors??[]).map(s=>({id:s.id,name:`${t.name} · ${s.name}`}))))}renderPanel(e){const t=this.selectedAnchor,s=t?.resource_type==="camera"?t:null,i=s?this.coverageAt(s.resource_id):null,a=s?this.recordings.get(s.resource_id):void 0,n=this.eventsNear(void 0,Zi),o=this.instant.toISOString().replace(/\.\d{3}Z$/,"Z");return r`<div class="panel">
      <sw-card heading="בנקודת הזמן שנבחרה" subheading="זמן ונתונים מאותו רגע" data-history-panel>
        <dl>
          <dt>זמן</dt><dd><span class="ltr" data-history-time>${this.date} ${nt(this.minute)}</span> <span class="note">${this.tz}</span></dd>
          <dt>מצלמה נבחרת</dt><dd data-history-camera>${s?s.camera?.name??s.resource_id:"לחץ על מצלמה במפה"}</dd>
          ${s?r`<dt>הקלטה</dt><dd>${a===void 0?"טוען…":a===null?"לא ניתן לבדוק מול ה־NVR":i?.segment?r`יש הקלטה · ${De(i.segment.startMin)}–${De(i.segment.endMin)} · ${i.segment.kind==="continuous"?"רציף":"תנועה"}`:"אין הקלטה בזמן זה (פער)"}</dd>
          ...
          ${s&&this.frameAt?r`<dt>פריים</dt><dd><div class="frame" data-history-frame>${this.frameFailed?r`<span>אין פריים בהקלטה בזמן זה</span>`:r`<img src=${Si(s.resource_id,this.frameAt)} alt="פריים מההקלטה בזמן שנבחר" @error=${()=>this.frameFailed=!0} />`}</div></dd>`:d}
        ...
        <div style="display:flex;gap:8px;flex-wrap:wrap;margin-block-start:10px">
          ${s?r`<sw-button variant="primary" size="sm" icon="history" @click=${()=>$("/investigate/playback",{camera:s.resource_id,t:o})}>נגן מכאן</sw-button>`:d}
      ...
      <sw-case-picker .item=${this.casePick} subheading=${s?`${s.camera?.name??s.resource_id} · ${this.date} ${nt(this.minute)}`:""} @close=${()=>this.casePick=null}></sw-case-picker>
      <sw-card heading="אירועים סביב הזמן" subheading=${`±${Zi} דקות · מצלמות הקומה`}>
        ${n.length?r`<div class="evl" data-history-events>${n.slice(0,8).map(l=>r`<a class=${s&&l.camera_id===s.resource_id?"hit":""} href=${`#/investigate/events/${l.id}`}><span>${ee[l.type]??l.type} · ${l.camera_name??l.channel??""}<div class="s">${l.confidence==="inferred"?"נגזר מהקלטה":"התראה מה־NVR"}${l.acked_at?" · טופל":""}</div></span><span class="ltr">${this.fmt(l.occurred_at)}</span></a>`)}</div>`:r`<div class="note">אין אירועים בחלון הזה.</div>`}
      </sw-card>
    </div>`}renderApi(){const e=this.bundle;if(this.error&&!e)return r`<div class="head"><h1>מפה היסטורית</h1></div><sw-state-panel state="error" hint=${this.error}></sw-state-panel>`;if(!e)return r`<div class="head"><h1>מפה היסטורית</h1></div><sw-state-panel state="loading"></sw-state-panel>`;const t=this.selectedAnchor,s=t?.resource_type==="camera"?this.segmentsFor(t.resource_id)??[]:Array.from(this.recordings.keys()).flatMap(a=>this.segmentsFor(a)??[]),i=(t?.resource_type==="camera"?this.events.filter(a=>a.camera_id===t.resource_id):this.events).map(a=>({minute:re(new Date(a.occurred_at),this.tz),kind:mh(a.type),label:`${ee[a.type]??a.type}${a.count>1?` ×${a.count}`:""}`}));return r`
      <div class="head">
        <div><h1>המפה בזמן שנבחר · ${e.floorName}</h1><div class="sub">${e.buildingName} · <span class="ltr">${this.date} ${nt(this.minute)}</span> · ${this.tz}</div></div>
        <span class="grow"></span>
        ${this.floors.length>1?r`<sw-field><select aria-label="קומה" @change=${a=>$(`/investigate/floors/${a.target.value}`,{t:this.instant.toISOString()})}>${this.floors.map(a=>r`<option value=${a.id} ?selected=${a.id===this.floorId}>${Lt(a.name)}</option>`)}</select></sw-field>`:d}
        <sw-button icon="live" data-back-live @click=${()=>$(`/explore/floors/${e.floorId}`)}>חזרה למצב חי</sw-button>
      </div>
      ...
      <div class="layout">
        <div class="stage">
          ...
          <div class="hist">מצב היסטורי · <span class="ltr">${nt(this.minute)}</span></div>
      ...
      <div class="tl">
        <div class="tlbar">
          ...
          <span class="time">${this.date} ${nt(this.minute)}</span>
    ...
    `}get demoMarkers(){const e=i=>i==="cam-3"||this.minute>=190&&this.minute<=205?"unknown":"historic",t=bs.filter(i=>i.floorId===this.floorId).map(i=>({id:i.id,kind:"camera",label:i.name,x:i.x,y:i.y,rotation:i.rotation,fov:i.fov,state:i.state==="forbidden"?"forbidden":e(i.id)})),s=Qs.filter(i=>i.floorId===this.floorId).map((i,a)=>({id:i.id,kind:i.domain,label:i.name,x:i.x,y:i.y,state:a%2?"unknown":"historic"}));return[...t,...s]}renderDemo(){const e=xt.find(t=>t.id===this.floorId)??xt[0];return r`
      <div class="head">
        <div><h1>מפה היסטורית · ${Lt(e.name)}</h1><div class="sub">מצב המפה בזמן נבחר · פעולות פיזיות כבויות בחקירה · נתוני הדגמה</div></div>
        <span class="grow"></span>
      ...
      <div class="stage alone">
        <sw-plan-canvas .planWidth=${e.planWidth} .planHeight=${e.planHeight} .plan=${dn(e.id)} .markers=${this.demoMarkers}></sw-plan-canvas>
        <div class="legend"><span>כחול = יש הקלטה בזמן זה</span><span>מקווקו = לא ידוע / פער</span><span>ישות: מצב ידוע אחרון</span></div>
      </div>
    `}render(){return y()?this.renderApi():this.renderDemo()}};ie.styles=M`
    :host {
      display: flex;
      flex-direction: column;
      min-block-size: 100%;
  ...
  `;de([f()],ie.prototype,"floorId",2);de([f()],ie.prototype,"at",2);de([f()],ie.prototype,"camera",2);de([c()],ie.prototype,"minute",2);de([c()],ie.prototype,"tz",2);de([c()],ie.prototype,"date",2);de([c()],ie.prototype,"tree",2);de([c()],ie.prototype,"bundle",2);de([c()],ie.prototype,"events",2);de([c()],ie.prototype,"recordings",2);de([c()],ie.prototype,"selectedId",2);de([c()],ie.prototype,"loading",2);de([c()],ie.prototype,"error",2);de([c()],ie.prototype,"frameAt",2);de([c()],ie.prototype,"frameFailed",2);de([c()],ie.prototype,"casePick",2);de([c()],ie.prototype,"geometry",2);ie=de([E("investigate-history-map")],ie);var fh=Object.defineProperty,gh=Object.getOwnPropertyDescriptor,W=(e,t,s,i)=>{for(var a=i>1?void 0:i?gh(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&fh(t,s,a),a};const wh={person:"#2f6bff",vehicle:"#22c55e",motion:"#ef4444",line:"#f59e0b",offline:"#6b7280",door:"#8b5cf6"},Tr={"כניסה ראשית":"entrance","חצר אחורית":"backyard",מחסן:"warehouse",לובי:"lobby","חניה מקורה":"parking","מסדרון מזרחי":"corridor"},vh={info:"מידע",alert:"התראה",critical:"קריטי"};let H=class extends z{constructor(){super(...arguments),this.cameraId="",this.date="",this.initialMode="",this.selected=null,this.filter="all",this.cams=null,this.tz="Asia/Jerusalem",this.type="",this.events=null,this.ingest=null,this.live=!1,this.error="",this.busy=!1,this.thumbVersion=new Map,this.player=null,this.mode="raw",this.windows=null,this.windowGap=180,this.windowBy="camera",this.selectedWindow=null,this.windowsBusy=!1,this.facets=null,this.placeFloor="",this.placeZone="",this.source="",this.unsupported=[],this.q="",this.rangeDays=1,this.qTimer=0,this.thumbTimers=new Map,this.thumbInFlight=0,this.rowPreview=null,this.rowPreviewTimer=0,this.windowColumns=[{key:"thumb",label:"",width:"72px",render:e=>this.renderWindowThumb(e)},{key:"title",label:"חלון אירוע",render:e=>{const t=e;return r`<span class="ty" style="--tone:${ti[t.dominant_type]??"#6b7280"}"><i></i>${ee[t.dominant_type]??t.dominant_type}${t.count>1?r` <span class="sub">×${String(t.count)}</span>`:d}</span><div class="sub">${Object.entries(t.types).map(([s,i])=>`${ee[s]??s} ${i}`).join(" · ")} · ${t.confidence==="inferred"?"נגזר מהקלטה":"התראות מה־NVR"}</div>`}},{key:"camera_name",label:"מצלמה / קבוצה",render:e=>{const t=e;return r`${t.camera_name??(t.channel?`ערוץ ${t.channel}`:"מערכת")}${t.group&&t.group!=="camera"&&t.camera_names?.length?r`<div class="sub">${t.camera_names.join(" · ")}</div>`:d}`}},{key:"start",label:"זמן",render:e=>{const t=e;return r`${this.fmt(t.start)}${t.end!==t.start?r` – ${this.fmt(t.end)}`:d}<div class="sub">${this.fmtDate(t.start)}</div>`}},{key:"acked",label:"מצב",render:e=>{const t=e;return r`<sw-badge kind=${t.acked?"live":t.acked_count?"stale":"neutral"} label=${t.acked?"טופל":t.acked_count?`בטיפול ${t.acked_count}/${t.count}`:"חדש"}></sw-badge>`}}],this.apiColumns=[{key:"thumb",label:"",width:"72px",render:e=>this.renderThumb(e)},{key:"type",label:"אירוע",render:e=>r`<span class="ty" style="--tone:${ti[e.type]??"#6b7280"}"><i></i>${ee[e.type]??String(e.type)}${Number(e.count)>1?r` <span class="sub">×${String(e.count)}</span>`:d}</span><div class="sub">${e.source==="ha"?"חיישן HA":e.source==="system"?"מערכת":e.confidence==="inferred"?"נגזר מהקלטה":"התראה מה־NVR"} · ${e.acked_at?`טופל · ${String(e.acked_by_username??"")}`:"ממתין לטיפול"}</div>`},{key:"camera_name",label:"מצלמה",render:e=>r`${String(e.camera_name??(e.channel?`ערוץ ${String(e.channel)}`:"מערכת"))}<div class="sub ltr">${String(e.raw_type)}</div>`},{key:"occurred_at",label:"זמן",render:e=>r`${this.fmt(String(e.occurred_at))}<div class="sub">${this.fmtDate(String(e.occurred_at))}${e.ended_at?` · עד ${this.fmt(String(e.ended_at))}`:""}</div>`},{key:"severity",label:"חומרה",render:e=>r`<sw-badge kind=${e.severity==="critical"?"error":e.severity==="alert"?"stale":"neutral"} label=${vh[e.severity]??String(e.severity)}></sw-badge>`}],this.columns=[{key:"thumb",label:"תמונה",width:"80px",render:e=>e.type==="offline"||e.type==="door"?r`<div class="thumb none"><sw-icon name=${e.type==="offline"?"offline":"door"} size=${14}></sw-icon></div>`:r`<sw-scene class="thumb" kind=${Tr[String(e.camera)]??"lobby"}></sw-scene>`},{key:"title",label:"אירוע",render:e=>r`<span class="ty" style="--tone:${wh[e.type]}"><i></i>${Qi[e.type]}</span><div class="sub">${String(e.title)} · ${e.acked?"טופל":"ממתין לטיפול"}</div>`},{key:"camera",label:"מצלמה",render:e=>r`${String(e.camera)}<div class="sub">${String(e.floor)}</div>`},{key:"time",label:"זמן",render:e=>r`${String(e.time)}<div class="sub ltr">${String(e.source)}</div>`},{key:"severity",label:"חומרה",render:e=>r`<sw-badge kind=${e.severity==="critical"?"error":e.severity==="alert"?"stale":"neutral"} label=${{info:"מידע",alert:"התראה",critical:"קריטי"}[e.severity]}></sw-badge>`},{key:"more",label:"",width:"40px",render:()=>r`<sw-button variant="ghost" size="sm" iconOnly icon="more" label="עוד"></sw-button>`}]}connectedCallback(){super.connectedCallback(),y()&&(this.init(),this.unsubscribe=Nc(e=>this.onPushed(e),(e,t)=>{this.live=t,e&&(this.ingest=e)}))}disconnectedCallback(){super.disconnectedCallback(),this.unsubscribe?.();for(const e of this.thumbTimers.values())window.clearTimeout(e);this.thumbTimers.clear(),this.stopPlayer()}hoverStart(e,t){if(!e.camera_id||t.pointerType==="touch")return;window.clearTimeout(this.rowPreviewTimer);const s=t.clientX,i=t.clientY;this.rowPreviewTimer=window.setTimeout(()=>{const a=new Date(e.occurred_at).getTime(),n=[-5,0,5].map(o=>{const l=new Date(a+o*1e3).toISOString().replace(/\.\d{3}Z$/,"Z");return{at:l,url:Si(e.camera_id,l),label:o===0?this.fmt(e.occurred_at):`${o>0?"+":""}${o} ש׳`,failed:!1}});this.rowPreview={id:e.id,x:s,y:i,frames:n,camera:e.camera_name??""}},250)}hoverEnd(){window.clearTimeout(this.rowPreviewTimer),this.rowPreview=null}renderRowPreview(){const e=this.rowPreview;if(!e)return d;const t=Math.max(16,Math.min(window.innerWidth-388,e.x-186)),s=e.y+18+230>window.innerHeight?e.y-18-230:e.y+18;return r`<div class="rowpreview" data-row-preview style="left:${t}px;top:${s}px">
      <div class="strip">
      ...
      <div class="wlist" data-window-events>
        ${t.map(s=>r`<a class="wrow" href=${`#/investigate/events/${s.id}`}><span class="ty" style="--tone:${ti[s.type]??"#6b7280"}"><i></i>${ee[s.type]??s.type}</span><span class="ltr">${this.fmt(s.occurred_at)}</span><span class="sub">${s.acked_at?"טופל":"ממתין"}</span></a>`)}
        ${t.length<e.count?r`<div class="sub">${e.count-t.length} אירועים נוספים אינם בסינון הנוכחי.</div>`:d}
      </div>
      <div slot="footer">
        <sw-button variant="primary" size="sm" icon="expand" data-review-window @click=${()=>$(`/investigate/events/${e.first_event_id}`)}>סקירה מלאה</sw-button>
        <sw-button size="sm" icon="check" ?disabled=${e.acked||this.busy} @click=${()=>this.ackWindow(e)}>${e.acked?"טופל":"סמן הכל כטופל"}</sw-button>
      </div>
    </sw-drawer>`}onPushed(e){if(!this.events)return;const t=Xe(new Date(e.occurred_at),this.tz);if(this.date&&t!==this.date||this.cameraId&&e.camera_id!==this.cameraId||this.type&&e.type!==this.type)return;const s=this.cams?.find(n=>n.id===e.camera_id)?.name??null,i={...e,camera_name:e.camera_name??s};(e.thumbnail==="ready"||e.thumbnail==="unavailable")&&(this.cancelPoll(e.id),e.thumbnail==="ready"&&(this.thumbVersion=new Map(this.thumbVersion).set(e.id,Date.now())));const a=this.events.findIndex(n=>n.id===e.id);this.events=a>=0?this.events.map((n,o)=>o===a?{...n,...i}:n):[i,...this.events]}fmt(e){return new Intl.DateTimeFormat("he-IL",{timeZone:this.tz,hour:"2-digit",minute:"2-digit",second:"2-digit",hourCycle:"h23"}).format(new Date(e))}fmtDate(e){return new Intl.DateTimeFormat("he-IL",{timeZone:this.tz,day:"2-digit",month:"2-digit"}).format(new Date(e))}async ack(e){this.busy=!0;try{const t=await An(e.id);this.events=(this.events??[]).map(s=>s.id===e.id?{...s,...t}:s)}catch(t){this.error=w(t)}finally{this.busy=!1}}renderApi(){if(this.error&&!this.events)return r`<sw-state-panel state="error" hint=${this.error} actionLabel="נסה שוב" @action=${()=>this.init()}></sw-state-panel>`;if(!this.events)return r`<sw-state-panel state="loading"></sw-state-panel>`;const e=this.events.find(i=>i.id===this.selected)??null,t=this.ingest,s=this.events.filter(i=>!i.acked_at).length;return r`
      ...
      <div class="filters">
        ...
        <sw-field><select aria-label="סוג" @change=${i=>{this.type=i.target.value,this.load()}}><option value="" ?selected=${!this.type}>כל סוגי האירועים</option>${Object.keys(ee).map(i=>r`<option value=${i} ?selected=${i===this.type}>${ee[i]}</option>`)}</select></sw-field>
        ...
        <sw-field><select aria-label="מקור" data-filter-source @change=${i=>{this.source=i.target.value,this.load()}}><option value="" ?selected=${!this.source}>כל המקורות</option>${Object.entries($r).map(([i,a])=>r`<option value=${i} ?selected=${i===this.source}>${a}</option>`)}</select></sw-field>
        <span class="grow"></span>
      ...
      <div class="stage">
        ${this.mode==="windows"?this.windows===null||this.windowsBusy&&!this.windows.length?r`<sw-state-panel state="loading"></sw-state-panel>`:this.windows.length?r`<div class="banner" style="margin-block-end:8px"><sw-icon name="info" size=${14}></sw-icon><span>${this.windowBy==="camera"?"התראות סמוכות באותה מצלמה":this.windowBy==="all"?"התראות סמוכות מכל המצלמות":this.windowBy==="zone"?"התראות סמוכות באותו חדר":"התראות סמוכות באותה קומה"} הופכות לחלון אירוע אחד (מרווח עד ${Math.round(this.windowGap/60)} דק׳). האירועים המקוריים נשמרים לצפייה.</span><span class="grow"></span>
                  <sw-field><select aria-label="קיבוץ" data-window-by @change=${i=>{this.windowBy=i.target.value,this.loadWindows()}}>${Object.keys(yr).map(i=>r`<option value=${i} ?selected=${this.windowBy===i}>${yr[i]}</option>`)}</select></sw-field>
        ...
        ${e?r`<sw-drawer open heading=${ee[e.type]??e.type} subheading=${`${e.camera_name??(e.channel?`ערוץ ${e.channel}`:"מערכת")} · ${this.fmt(e.occurred_at)}`} @close=${()=>this.closeDrawer()}>
              <div class="big">
                ${this.player?.eventId===e.id&&this.player.session?r`<sw-live-player .wsUrl=${pi(this.player.session)} mode="mse" .retry=${!1}></sw-live-player>`:e.thumbnail==="ready"?r`<img src=${Tt(e.id,this.thumbVersion.get(e.id)??0)} alt="תמונת האירוע מההקלטה" />`:r`<div class="hint">${e.camera_id?e.thumbnail==="unavailable"?"אין פריים זמין בהקלטה בזמן האירוע":this.player?.eventId===e.id?"פותח את ההקלטה…":"מכין תמונה מההקלטה…":"אירוע ללא מצלמה"}</div>`}
              ...
              <div slot="footer">
                <sw-button variant="primary" size="sm" icon="expand" data-review @click=${()=>$(`/investigate/events/${e.id}`)}>סקירה מלאה</sw-button>
                ${e.camera_id?r`<sw-button size="sm" icon="play" @click=${()=>this.play(e)}>${this.player?.eventId===e.id?"עצור":"נגן כאן"}</sw-button>
                    <sw-button size="sm" icon="history" @click=${()=>$("/investigate/playback",{camera:e.camera_id,t:e.occurred_at})}>להקלטה</sw-button>`:d}
                <sw-button variant="ghost" size="sm" icon="check" ?disabled=${!!e.acked_at||this.busy} @click=${()=>this.ack(e)}>סמן טופל</sw-button>
              </div>
            </sw-drawer>`:d}
      </div>
    `}renderDemo(){const e=ot.filter(s=>this.filter==="all"||!s.acked),t=ot.find(s=>s.id===this.selected);return r`
      <div class="filters">
      ...
      <div class="stage">
        ...
        ${t?r`<sw-drawer open heading=${Qi[t.type]} subheading=${`${t.camera} · ${t.time}`} @close=${()=>this.selected=null}>
              <div class="preview">${t.type==="offline"||t.type==="door"?"אין תמונה לאירוע זה":r`<sw-scene kind=${Tr[t.camera]??"lobby"}></sw-scene><span class="demo">דמו · תמונת אירוע מה־NVR (T044)</span>`}</div>
              <dl>
  ...
  `;W([f()],H.prototype,"cameraId",2);W([f()],H.prototype,"date",2);W([f()],H.prototype,"initialMode",2);W([c()],H.prototype,"selected",2);W([c()],H.prototype,"filter",2);W([c()],H.prototype,"cams",2);W([c()],H.prototype,"tz",2);W([c()],H.prototype,"type",2);W([c()],H.prototype,"events",2);W([c()],H.prototype,"ingest",2);W([c()],H.prototype,"live",2);W([c()],H.prototype,"error",2);W([c()],H.prototype,"busy",2);W([c()],H.prototype,"thumbVersion",2);W([c()],H.prototype,"player",2);W([c()],H.prototype,"mode",2);W([c()],H.prototype,"windows",2);W([c()],H.prototype,"windowGap",2);W([c()],H.prototype,"windowBy",2);W([c()],H.prototype,"selectedWindow",2);W([c()],H.prototype,"windowsBusy",2);W([c()],H.prototype,"facets",2);W([c()],H.prototype,"placeFloor",2);W([c()],H.prototype,"placeZone",2);W([c()],H.prototype,"source",2);W([c()],H.prototype,"unsupported",2);W([c()],H.prototype,"q",2);W([c()],H.prototype,"rangeDays",2);W([c()],H.prototype,"rowPreview",2);H=W([E("investigate-events")],H);var bh=Object.defineProperty,yh=Object.getOwnPropertyDescriptor,be=(e,t,s,i)=>{for(var a=i>1?void 0:i?yh(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&bh(t,s,a),a};const $h={measured:"recorded",inferred:"unknown",command:"partial",availability:"stale"},Or={alertstream:"אירוע NVR",recording:"נגזר מהקלטה",system:"מערכת",ha:"חיישן HA"},Rr=600*1e3;let oe=class extends z{constructor(){super(...arguments),this.eventId="",this.ev=null,this.error="",this.tz="Asia/Jerusalem",this.session=null,this.playerError="",this.bundle=null,this.nearby=[],this.corr=null,this.corrError="",this.route=null,this.busy=!1,this.thumbVersion=0,this.casePick=null,this.geometry=null,this.pollTimer=0}connectedCallback(){super.connectedCallback(),this.load()}disconnectedCallback(){super.disconnectedCallback(),window.clearTimeout(this.pollTimer),this.stopPlayer()}updated(e){e.has("eventId")&&e.get("eventId")!==void 0&&this.load()}async load(){if(y()){this.error="",await this.stopPlayer();try{const e=await Oc(this.eventId);this.ev=e,this.tz=e.timezone||this.tz,e.location?.has_plan?this.loadMap(e.location.floor_id):this.bundle=null,this.loadNearby(e),this.loadCorrelation(e.id),this.loadRoute(e.id),e.camera_id&&this.play(e),e.thumbnail==="pending"&&this.pollThumb(e.id)}catch(e){this.error=w(e),this.ev=null}}}async loadRoute(e){this.route=null;try{this.route=await Hc(e)}catch{this.route=null}}renderRoute(){const e=this.route;return!e||!e.spatial?d:r`<sw-card heading="המשך מסלול מוצע" subheading="השערה לפי טופולוגיית המפה · ±${Math.round((new Date(e.window.to).getTime()-new Date(e.window.from).getTime())/1e3)} שניות" style="margin-block-start:12px" data-route>
      ${e.suggestions.length?r`<div class="corr" data-route-list>${e.suggestions.map(t=>r`<div class="link" data-route-item data-relation=${t.relation}>
              ...
              <sw-button size="sm" icon="play" @click=${()=>$("/investigate/playback",{camera:t.camera_id,t:t.playback_at})}>נגן</sw-button>
    ...
    </sw-card>`}async loadCorrelation(e){this.corr=null,this.corrError="";try{this.corr=await Lc(e)}catch(t){this.corrError=w(t)}}async loadMap(e){try{const t=await Ts(e);this.bundle=t,this.geometry=null;const s=await Ma(t);this.bundle===t&&(this.geometry=s)}catch{this.bundle=null,this.geometry=null}}async loadNearby(e){try{const t=new Date(e.occurred_at).getTime(),s=a=>new Date(a).toISOString().replace(/\.\d{3}Z$/,"Z"),i=await zi({from:s(t-Rr),to:s(t+Rr),limit:30});this.nearby=i.events.filter(a=>a.id!==e.id).slice(0,6)}catch{this.nearby=[]}}pollThumb(e){window.clearTimeout(this.pollTimer),this.pollTimer=window.setTimeout(async()=>{const t=await Pn(e).catch(()=>"unavailable");this.ev?.id===e&&(t==="pending"?this.pollThumb(e):(this.ev={...this.ev,thumbnail:t},t==="ready"&&(this.thumbVersion=Date.now())))},1500)}async play(e){if(e.camera_id){this.playerError="";try{const t=new Date(new Date(e.occurred_at).getTime()-2e3).toISOString().replace(/\.\d{3}Z$/,"Z"),s=await Da(e.camera_id,t);this.ev?.id===e.id?this.session=s:await Ns(s.id).catch(()=>{})}catch(t){this.playerError=w(t)}}}async stopPlayer(){const e=this.session;this.session=null,e&&await Ns(e.id).catch(()=>{})}async ack(){const e=this.ev;if(!(!e||e.acked_at)){this.busy=!0;try{const t=await An(e.id);this.ev={...e,acked_at:t.acked_at,acked_by_username:t.acked_by_username}}catch(t){this.error=w(t)}finally{this.busy=!1}}}fmt(e,t=!1){const s=new Date(e),i=new Intl.DateTimeFormat("he-IL",{timeZone:this.tz,hour:"2-digit",minute:"2-digit",second:"2-digit",hourCycle:"h23"}).format(s);return t?`${new Intl.DateTimeFormat("he-IL",{timeZone:this.tz,day:"2-digit",month:"2-digit",year:"numeric"}).format(s)} · ${i}`:i}renderCorrelation(){const e=this.corr,t=e?`±${e.window_s} שניות · ${e.spatial?`סביבת ${e.location?.zone??"המיקום על התוכנית"} (${e.location?.floor_name??""})`:"לפי זמן בלבד"}`:this.corrError?"לא נטען":"טוען…";return r`<sw-card heading="קורלציה דלת–מצלמה–חיישן" subheading=${t} style="margin-block-start:12px" data-correlation>
      ${e?r`${e.entities.length?r`<div class="note" style="margin:0 0 6px" data-correlation-entities>בסביבה: ${e.entities.map(s=>`${s.name}${s.state_missing?" (ללא מצב)":s.state?` · ${s.state}`:""}`).join(" · ")}</div>`:r`<div class="note" style="margin:0 0 6px" data-correlation-entities>אין חיישנים או מנעולים מוצבים בסביבה.</div>`}
            ${e.links.length?r`<div class="corr" data-correlation-links>${e.links.map(s=>r`<div class="link" data-correlation-link data-certainty=${s.certainty}>
                    ...
                    <sw-badge kind=${$h[s.certainty]} label=${Bc[s.certainty]}></sw-badge>
      ...
      <sw-page heading=${`${t} · ${s}`} subheading=${`${Or[e.source]??e.source} · ${this.fmt(e.occurred_at,!0)}`} crumbs=${`חקירה | אירועים | ${t}`} wide>
        ...
        <sw-button slot="actions" variant="ghost" icon="list" @click=${()=>$("/investigate/events")}>למרכז האירועים</sw-button>
        ${this.error?r`<div class="err">${this.error}</div>`:d}
        <div class="layout">
          <div>
            <div class="player" data-player>
              ${this.session?r`<sw-live-player .wsUrl=${pi(this.session)} mode="mse" .retry=${!1}></sw-live-player>`:e.thumbnail==="ready"?r`<img src=${Tt(e.id,this.thumbVersion)} alt="תמונת האירוע מההקלטה" />`:r`<div class="hint">${e.camera_id?this.playerError?`ההקלטה לא נפתחה: ${this.playerError}`:e.thumbnail==="unavailable"?"אין הקלטה זמינה בזמן האירוע":"פותח את ההקלטה…":"אירוע ללא מצלמה — אין וידאו"}</div>`}
            ...
            <div class="bar">
              ...
              <span class="grow"></span>
              ${e.camera_id?r`<sw-button size="sm" icon="history" @click=${()=>$("/investigate/playback",{camera:e.camera_id,t:e.occurred_at})}>הנגן המלא עם ציר הזמן</sw-button>`:d}
          ...
          <div>
            <sw-card heading="הקשר האירוע" data-context>
              <dl class="meta">
                ...
                <dt>מקור</dt><dd>${Or[e.source]??e.source}${e.camera_id?r` / ${s}`:d} <span class="note" style="margin:0">raw <span class="ltr">${e.raw_type}</span></span></dd>
              ...
              ${i&&i.has_plan&&this.bundle?r`<div class="map">
                  ...
                  <div style="display:flex;gap:8px;margin-block-start:10px;flex-wrap:wrap">
                    <sw-button size="sm" icon="map" data-history-map @click=${()=>$(`/investigate/floors/${i.floor_id}`,{t:e.occurred_at,camera:e.camera_id??""})}>המשך חקירה במפה</sw-button>
                    <sw-button size="sm" variant="ghost" icon="live" @click=${()=>$(`/explore/floors/${i.floor_id}`)}>מפה חיה</sw-button>
            ...
            <sw-card heading="אירועים קרובים" subheading="±10 דקות סביב האירוע" style="margin-block-start:12px">
              ${this.nearby.length?r`<div class="nearby">${this.nearby.map(o=>r`<a href=${`#/investigate/events/${o.id}`}><span>${ee[o.type]??o.type} · ${o.camera_name??(o.channel?`ערוץ ${o.channel}`:"מערכת")}</span><span class="ltr">${this.fmt(o.occurred_at)}</span></a>`)}</div>`:r`<div class="note" style="margin:0">אין אירועים נוספים בחלון הזה.</div>`}
            </sw-card>
          </div>
        </div>
  ...
  `;be([f()],oe.prototype,"eventId",2);be([c()],oe.prototype,"ev",2);be([c()],oe.prototype,"error",2);be([c()],oe.prototype,"tz",2);be([c()],oe.prototype,"session",2);be([c()],oe.prototype,"playerError",2);be([c()],oe.prototype,"bundle",2);be([c()],oe.prototype,"nearby",2);be([c()],oe.prototype,"corr",2);be([c()],oe.prototype,"corrError",2);be([c()],oe.prototype,"route",2);be([c()],oe.prototype,"busy",2);be([c()],oe.prototype,"thumbVersion",2);be([c()],oe.prototype,"casePick",2);be([c()],oe.prototype,"geometry",2);oe=be([E("investigate-event-detail")],oe);var xh=Object.getOwnPropertyDescriptor,kh=(e,t,s,i)=>{for(var a=i>1?void 0:i?xh(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=o(a)||a);return a};const _h=[{id:"rv-1",title:"כניסה ראשית · 10:12–10:16",primary:"כניסה ראשית",scene:"entrance",related:["לובי"],events:3,severity:"alert",status:"חדש"},{id:"rv-2",title:"חצר אחורית · 09:40–09:44",primary:"חצר אחורית",scene:"backyard",related:[],events:2,severity:"info",status:"בבדיקה"},{id:"rv-3",title:"חניה מקורה · 06:41–06:45",primary:"חניה מקורה",scene:"parking",related:["כניסה ראשית"],events:1,severity:"alert",status:"טופל"},{id:"rv-4",title:"לובי · אתמול 23:08–23:12",primary:"לובי",scene:"lobby",related:[],events:4,severity:"info",status:"false positive"}];let pa=class extends z{render(){return r`
  ...
  `;pa=kh([E("investigate-reviews")],pa);var zh=Object.defineProperty,Sh=Object.getOwnPropertyDescriptor,U=(e,t,s,i)=>{for(var a=i>1?void 0:i?Sh(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&zh(t,s,a),a};const Mh={open:"stale",in_review:"recorded",closed:"neutral"},Eh={preserved:"recorded",preserving:"partial",nvr_only:"stale",missing:"error",unknown:"unknown",none:"neutral"},Ah=(e,t)=>new Intl.DateTimeFormat("he-IL",{timeZone:t,dateStyle:"short",timeStyle:"short"}).format(new Date(e)),Ph=[{key:"title",label:"תיק",render:e=>r`<strong>${String(e.title)}</strong>${e.tags?r`<div style="font-size:11px;color:var(--sw-text-3)">${String(e.tags)}</div>`:d}`},{key:"status",label:"סטטוס",render:e=>r`<sw-badge kind=${Mh[e.status]} label=${zs[e.status]}></sw-badge>`},{key:"owner",label:"בעלים"},{key:"items",label:"פריטים"},{key:"preserved",label:"עותקים שמורים",render:e=>r`${String(e.preserved)} מתוך ${String(e.clips)}`},{key:"updated",label:"עודכן",ltr:!0,render:e=>Ah(String(e.updated))}],Ih=[{key:"title",label:"תיק",render:e=>r`<strong>${String(e.title)}</strong>`},{key:"status",label:"סטטוס",render:e=>r`<sw-badge kind=${e.status==="פתוח"?"stale":e.status==="סגור"?"neutral":"recorded"} label=${String(e.status)}></sw-badge>`},{key:"owner",label:"בעלים"},{key:"clips",label:"קטעים"},{key:"notes",label:"הערות"},{key:"preserved",label:"ראיות שמורות",render:e=>r`${e.preserved} שמורות${Number(e.missing)?r` · <span style="color:var(--sw-danger)">${e.missing} חסרות</span>`:""}`},{key:"more",label:"",width:"40px",render:()=>r`<sw-button variant="ghost" size="sm" iconOnly icon="more" label="עוד"></sw-button>`}];let Se=class extends z{constructor(){super(...arguments),this.cases=[],this.canManage=!1,this.loading=!1,this.error="",this.status="all",this.q="",this.creating=!1,this.newTitle="",this.newDesc="",this.newTags="",this.busy=!1,this.qTimer=0}connectedCallback(){super.connectedCallback(),y()&&this.load()}async load(){this.loading=!0,this.error="";try{const e=await On({status:this.status==="all"?void 0:this.status,q:this.q||void 0});this.cases=e.cases,this.canManage=e.can_manage}catch(e){this.error=w(e)}finally{this.loading=!1}}setStatus(e){this.status=e,this.load()}onQuery(e){this.q=e,window.clearTimeout(this.qTimer),this.qTimer=window.setTimeout(()=>void this.load(),250)}async create(){if(this.newTitle.trim()){this.busy=!0,this.error="";try{const e=await Rn({title:this.newTitle.trim(),description:this.newDesc,tags:this.newTags.split(",").map(t=>t.trim()).filter(Boolean)});this.creating=!1,this.newTitle=this.newDesc=this.newTags="",$(`/investigate/cases/${e.id}`)}catch(e){this.error=w(e)}finally{this.busy=!1}}}renderApi(){const e=this.cases.map(t=>({id:t.id,title:t.title,status:t.status,owner:t.owner_username,items:t.counts.items,clips:t.counts.events+t.counts.clips,preserved:t.counts.preserved,updated:t.updated_at,tags:t.tags.join(" · ")}));return r`
      <sw-page heading="תיקים" subheading="קישור להקלטה אינו שימור: ראיה נחשבת שמורה רק אחרי העתקה מאומתת מה־NVR">
        ...
        <div class="bar">
          ${["all","open","in_review","closed"].map(t=>r`<sw-chip ?selected=${this.status===t} @click=${()=>this.setStatus(t)}>${t==="all"?"הכל":zs[t]}</sw-chip>`)}
          <span class="grow"></span>
        ...
        ${this.error?r`<div class="err">${this.error}</div>`:d}
        ${this.loading&&!this.cases.length?r`<sw-state-panel state="loading"></sw-state-panel>`:this.cases.length?r`<sw-table data-cases-table .columns=${Ph} .rows=${e} @row-select=${t=>$(`/investigate/cases/${t.detail.id}`)}></sw-table>`:r`<sw-state-panel state="empty" heading="אין תיקים עדיין" hint="פתח תיק מדף אירוע, מהנגן או מהמפה ההיסטורית (הוסף לתיק), או כאן."></sw-state-panel>`}
    ...
    `}render(){return y()?this.renderApi():r`
      <sw-page heading="תיקים" subheading="קישור להקלטה אינו שימור: ראיה נחשבת שמורה רק אחרי העתקה מאומתת ו־hash · נתוני הדגמה">
        ...
        <sw-table .columns=${Ih} .rows=${ta} @row-select=${e=>$(`/investigate/cases/${e.detail.id}`)}></sw-table>
      </sw-page>
    `}};Se.styles=M`
    .bar {
      display: flex;
  ...
  `;U([c()],Se.prototype,"cases",2);U([c()],Se.prototype,"canManage",2);U([c()],Se.prototype,"loading",2);U([c()],Se.prototype,"error",2);U([c()],Se.prototype,"status",2);U([c()],Se.prototype,"q",2);U([c()],Se.prototype,"creating",2);U([c()],Se.prototype,"newTitle",2);U([c()],Se.prototype,"newDesc",2);U([c()],Se.prototype,"newTags",2);U([c()],Se.prototype,"busy",2);Se=U([E("investigate-cases")],Se);let ae=class extends z{constructor(){super(...arguments),this.caseId="case-1",this.tab="details",this.data=null,this.error="",this.info="",this.busy=!1,this.tz="Asia/Jerusalem",this.noteText="",this.editing=!1,this.editTitle="",this.editDesc="",this.editTags="",this.confirmDelete=!1,this.bundles=[],this.verifyResult=null,this.cams=[],this.snapCam="",this.loadedFor="",this.pollTimer=0}updated(e){e.has("caseId")&&y()&&this.loadedFor!==this.caseId&&this.load()}disconnectedCallback(){super.disconnectedCallback(),window.clearTimeout(this.pollTimer)}async load(){const e=this.caseId;this.loadedFor=e,this.error="";try{const[t,s]=await Promise.all([Ve(),Np(e)]);this.tz=t["time.zone"]??this.tz,this.data=s,this.bundles=(await Up(e).catch(()=>({bundles:[]}))).bundles,this.cams.length||(this.cams=(await Le().catch(()=>({cameras:[]}))).cameras.filter(i=>i.enabled),!this.snapCam&&this.cams[0]&&(this.snapCam=this.cams[0].id)),window.clearTimeout(this.pollTimer),s.items.some(i=>i.preservation==="preserving")&&(this.pollTimer=window.setTimeout(()=>void this.load(),5e3))}catch(t){this.error=w(t)}}fmt(e){return new Intl.DateTimeFormat("he-IL",{timeZone:this.tz,dateStyle:"short",timeStyle:"medium"}).format(new Date(e))}async run(e,t=""){this.busy=!0,this.error="";try{await e(),this.info=t,await this.load(),t&&setTimeout(()=>this.info="",4e3)}catch(s){this.error=w(s),s instanceof ue&&s.status===409&&await this.load()}finally{this.busy=!1}}patchCase(e){const t=this.data;t&&this.run(async()=>{await Bp(t.id,{revision:t.revision,...e})})}async verify(e){if(e){this.verifyResult=null,this.busy=!0,this.error="";try{this.verifyResult=await Kp(e)}catch(t){this.error=w(t)}finally{this.busy=!1}}}renderBundleCard(e){const t=this.verifyResult;return r`<sw-card heading="חבילת ראיות" subheading="ZIP עם הקטעים השמורים, התמונות, ההערות, manifest עם SHA-256 לכל קובץ ודוח קריא" data-bundle>
      ${e.can_manage?r`<sw-button size="sm" variant="primary" icon="download" data-bundle-create ?disabled=${this.busy} @click=${()=>void this.run(async()=>{await Wp(e.id)},'החבילה נוצרה; פריטים שאינם עותק שמור מופיעים בה כ"לא נכללו"')}>צור חבילת ראיות</sw-button>`:d}
      ${this.bundles.length?r`<div class="items" style="margin-block-start:8px">${this.bundles.map(s=>r`<div class="item" data-bundle-row style="grid-template-columns:minmax(0,1fr) auto"><div class="body"><strong class="ltr">${s.name}</strong><span class="meta">${Jt(s.bytes)} · ${this.fmt(s.created_at)}${s.signed?` · חתום · מפתח ${s.signed}`:" · ללא חתימה"}</span></div><div class="acts"><a href=${Zp(e.id,s.name)} download><sw-button size="sm" icon="download">הורדה</sw-button></a></div></div>`)}</div>`:r`<div class="hint" style="margin-block-start:6px">עדיין לא נוצרה חבילה לתיק הזה.</div>`}
    ...
    </sw-card>`}renderItem(e,t){const s=e.kind==="event"?`אירוע · ${ee[e.event?.type??"other"]??e.event?.type??""}`:e.kind==="clip"?"קטע הקלטה":e.kind==="snapshot"?"תמונה":"הערה",i=e.preservation,a=e.kind==="event"&&e.event?e.event.occurred_at:e.from_at,n=e.kind==="note"?r`<div class="thumb"><sw-icon name="edit" size=${18}></sw-icon></div>`:e.kind==="snapshot"?r`<img class="thumb" src=${qp(t.id,e.id)} alt="תמונה מהמצלמה" />`:e.kind==="event"&&e.event?.thumbnail==="ready"&&e.event_id?r`<img class="thumb" src=${Tt(e.event_id)} alt="" />`:e.camera_id&&a?r`<img class="thumb" src=${Si(e.camera_id,a)} alt="" @error=${o=>o.target.style.visibility="hidden"} />`:r`<div class="thumb"></div>`;return r`<div class="item" data-case-item data-kind=${e.kind} data-preservation=${i}>
      ${n}
      <div class="body">
        <div class="head"><strong>${s}</strong>${e.camera_name?r`<span>· ${e.camera_name}</span>`:d}${i!=="none"?r`<sw-badge kind=${Eh[i]} label=${Rp[i]}></sw-badge>`:d}</div>
      ...
      <div class="acts">
        ${e.camera_id&&a&&e.kind!=="snapshot"?r`<sw-button size="sm" icon="play" @click=${()=>$("/investigate/playback",{camera:e.camera_id??"",t:a})}>נגן</sw-button>`:d}
        ${e.kind==="snapshot"&&e.file_sha256?r`<span class="meta ltr" title="SHA-256">${e.file_sha256.slice(0,12)}…</span>`:d}
        ${e.event_id?r`<sw-button size="sm" variant="ghost" icon="bell" @click=${()=>$(`/investigate/events/${e.event_id}`)}>אירוע</sw-button>`:d}
        ...
        ${e.export?.download_ready?r`<a href=${Ln(e.export.id)} download><sw-button size="sm" variant="ghost" icon="download">הורדה</sw-button></a>`:d}
      ...
      <sw-page heading=${e.title} subheading=${`${zs[e.status]} · בעלים: ${e.owner_username} · ${t.items} פריטים · ${t.preserved} עותקים שמורים · עודכן ${this.fmt(e.updated_at)}`} crumbs="חקירה | תיקים" wide>
        ${e.can_manage?r`<sw-field slot="actions"><select aria-label="סטטוס" data-case-status ?disabled=${this.busy} @change=${s=>this.patchCase({status:s.target.value})}>${Object.keys(zs).map(s=>r`<option value=${s} ?selected=${s===e.status}>${zs[s]}</option>`)}</select></sw-field>
        ...
        <sw-button slot="actions" variant="ghost" icon="list" @click=${()=>$("/investigate/cases")}>לרשימת התיקים</sw-button>
        <div class="wrap">
          ${this.error?r`<div class="err" data-case-error>${this.error}</div>`:d}
          ...
          <sw-card heading="ראיות והערות" subheading=${e.checked?"מצב השימור נבדק מול ה־NVR עכשיו":"מצב השימור לא נבדק מול ה־NVR"}>
            ...
            ${e.can_manage&&e.status!=="closed"?r`<div class="composer"><sw-field label="הערה חדשה"><textarea rows="2" data-note-text .value=${this.noteText} @input=${s=>this.noteText=s.target.value}></textarea></sw-field><sw-button size="sm" icon="plus" data-note-add ?disabled=${this.busy||!this.noteText.trim()} @click=${()=>void this.run(async()=>{await da(e.id,{kind:"note",note:this.noteText.trim()}),this.noteText=""})}>הוסף הערה</sw-button></div>
                  <div class="composer"><sw-field label="תמונה ממצלמה לתיק (עותק שמור מיידי)"><select aria-label="מצלמה לצילום" data-snapshot-camera @change=${s=>this.snapCam=s.target.value}>${this.cams.map(s=>r`<option value=${s.id} ?selected=${s.id===this.snapCam}>${s.name}</option>`)}</select></sw-field><sw-button size="sm" icon="camera" data-snapshot-add ?disabled=${this.busy||!this.snapCam} @click=${()=>void this.run(async()=>{await da(e.id,{kind:"snapshot",camera_id:this.snapCam})},"התמונה נשמרה בתיק עם ה־hash שלה")}>צלם תמונה לתיק</sw-button></div>`:d}
          </sw-card>
        ...
        ${this.confirmDelete?r`<sw-dialog open heading="מחיקת תיק" subheading="הפריטים בתיק יימחקו; ההקלטות ב־NVR והעותקים שיוצאו נשארים" @close=${()=>this.confirmDelete=!1}>
              ...
              <sw-button slot="footer" variant="danger" icon="trash" data-case-delete-confirm ?disabled=${this.busy} @click=${()=>{this.confirmDelete=!1,this.run(async()=>{await Lp(e.id),$("/investigate/cases")})}}>מחק תיק</sw-button>
            </sw-dialog>`:d}
      </sw-page>
    `}render(){if(y())return this.renderApi();const e=ta.find(t=>t.id===this.caseId)??ta[0];return r`
  ...
  `;U([f()],ae.prototype,"caseId",2);U([c()],ae.prototype,"tab",2);U([c()],ae.prototype,"data",2);U([c()],ae.prototype,"error",2);U([c()],ae.prototype,"info",2);U([c()],ae.prototype,"busy",2);U([c()],ae.prototype,"tz",2);U([c()],ae.prototype,"noteText",2);U([c()],ae.prototype,"editing",2);U([c()],ae.prototype,"editTitle",2);U([c()],ae.prototype,"editDesc",2);U([c()],ae.prototype,"editTags",2);U([c()],ae.prototype,"confirmDelete",2);U([c()],ae.prototype,"bundles",2);U([c()],ae.prototype,"verifyResult",2);U([c()],ae.prototype,"cams",2);U([c()],ae.prototype,"snapCam",2);ae=U([E("investigate-case-detail")],ae);var Ch=Object.defineProperty,Dh=Object.getOwnPropertyDescriptor,Mi=(e,t,s,i)=>{for(var a=i>1?void 0:i?Dh(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&Ch(t,s,a),a};const Nr={queued:"ממתין",running:"מוריד",done:"הושלם",partial:"חלקי",failed:"נכשל",cancelled:"בוטל",interrupted:"הופסק"},Th={queued:"neutral",running:"live",done:"recorded",partial:"partial",failed:"error",cancelled:"unknown",interrupted:"stale"};let rs=class extends z{constructor(){super(...arguments),this.jobs=null,this.ffmpeg=!0,this.error=""}connectedCallback(){super.connectedCallback(),y()&&(this.load(),this.timer=window.setInterval(()=>this.poll(),3e3))}disconnectedCallback(){super.disconnectedCallback(),window.clearInterval(this.timer)}async load(){try{const e=await ih();this.jobs=e.jobs,this.ffmpeg=e.ffmpeg,this.error=""}catch(e){this.error=w(e)}}poll(){this.jobs?.some(e=>e.state==="queued"||e.state==="running")&&this.load()}fmt(e,t){return new Intl.DateTimeFormat("he-IL",{timeZone:t,day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit",second:"2-digit",hourCycle:"h23"}).format(new Date(e))}async cancel(e){try{await ah(e.id),await this.load()}catch(t){this.error=w(t)}}async removeJob(e){try{await rh(e.id),await this.load()}catch(t){this.error=w(t)}}renderApi(){return this.error&&!this.jobs?r`<sw-state-panel state="error" hint=${this.error} actionLabel="נסה שוב" @action=${()=>this.load()}></sw-state-panel>`:this.jobs?this.jobs.length?r`
      ...
      <sw-card>
        ${this.jobs.map(e=>{const t=Math.round((e.progress??0)*100),s=e.files.filter(i=>i.state==="downloaded"||i.state==="remuxed").length;return r`<div class="job">
            <div>
              <div class="title"><strong>${e.camera_name}</strong><sw-badge kind=${Th[e.state]} label=${Nr[e.state]}></sw-badge></div>
              <div class="meta"><span class="ltr">${this.fmt(e.requested_from,e.timezone)} → ${this.fmt(e.requested_to,e.timezone)}</span> · ${e.files.length} קבצים (${s} ירדו) · משוער ${Jt(e.estimate_bytes)}${e.actual_from?r` · בפועל <span class="ltr">${this.fmt(e.actual_from,e.timezone)} → ${this.fmt(e.actual_to??e.actual_from,e.timezone)}</span>`:d}</div>
            ...
            <div><div class="bar ${e.state==="failed"?"fail":e.state==="partial"?"partial":""}"><i style="inline-size:${t}%"></i></div><div class="meta">${Nr[e.state]} · ${t}%${e.state==="running"?` · ${Jt(e.files.reduce((i,a)=>i+a.bytes,0))}`:""}</div></div>
            <div class="actions">
              ${e.download_ready?r`<a href=${Ln(e.id)} download=${e.output_name??""}><sw-button size="sm" icon="download">הורדה</sw-button></a><a href=${nh(e.id)} target="_blank" rel="noopener"><sw-button size="sm" variant="ghost" icon="list">מניפסט</sw-button></a>`:d}
  ...
  `;Mi([c()],rs.prototype,"jobs",2);Mi([c()],rs.prototype,"ffmpeg",2);Mi([c()],rs.prototype,"error",2);rs=Mi([E("investigate-exports")],rs);const Oh={zone:"חדר / אזור",camera:"מצלמה",floor:"קומה",building:"מבנה",entity:"ישות HA"},Rh={zone:"map",camera:"camera",floor:"floor",building:"building",entity:"light"},Nh=(e,t=8)=>k(`search?q=${encodeURIComponent(e)}&limit=${t}`),Bh=(e,t=30)=>k(`search/semantic?q=${encodeURIComponent(e)}&limit=${t}`),Lh=()=>k("search/providers"),Vh={person:"אדם",vehicle:"רכב",motion:"תנועה",door:"דלת",line:"חציית קו",field:"חדירה"};var Hh=Object.defineProperty,jh=Object.getOwnPropertyDescriptor,qt=(e,t,s,i)=>{for(var a=i>1?void 0:i?jh(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&Hh(t,s,a),a};const Fh=[{scene:"entrance",when:"14.09.2026 10:14",cam:"כניסה ראשית",why:"NVR: זיהוי אדם (Smart)"},{scene:"lobby",when:"14.09.2026 10:13",cam:"לובי",why:"NVR: תנועה + סמיכות במפה לכניסה"},{scene:"parking",when:"14.09.2026 06:43",cam:"חניה מקורה",why:"NVR: חציית קו"},{scene:"entrance",when:"14.09.2026 08:12",cam:"כניסה ראשית",why:"HA: דלת נפתחה + תנועה"},{scene:"corridor",when:"13.09.2026 23:10",cam:"מסדרון מזרחי",why:"NVR: זיהוי אדם"},{scene:"backyard",when:"13.09.2026 18:03",cam:"חצר אחורית",why:"NVR: תנועה"}];let pt=class extends z{constructor(){super(...arguments),this.by="person",this.q="",this.answer=null,this.providers=null,this.busy=!1,this.error=""}connectedCallback(){super.connectedCallback(),y()&&this.loadProviders()}async loadProviders(){try{this.providers=await Lh()}catch(e){this.error=w(e)}}async run(){const e=this.q.trim();if(e){this.busy=!0,this.error="";try{this.answer=await Bh(e)}catch(t){this.error=w(t)}finally{this.busy=!1}}}fmt(e){try{return new Date(e).toLocaleString("he-IL",{day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit"})}catch{return e}}renderApi(){const e=this.answer,t=this.providers,s=t?.providers.find(n=>n.id==="local"),i=t?.providers.find(n=>n.id==="external"),a={person:"אדם",vehicle:"רכב",motion:"תנועה",line:"חציית קו",field:"חדירה",door:"דלת",offline:"ניתוק",coverage_gap:"פער כיסוי",other:"אחר"};return r`
      <sw-page heading="חיפוש AI" subheading="שאלה חופשית → מסננים של מרכז האירועים (סוג, מקום, זמן) · baseline מקומי ללא רשת · ספק חיצוני רק ב־opt-in">
        ...
        <div class="wrap">
          ...
          ${e?r`<sw-card heading="כך פורשה השאלה" subheading=${`${e.provider.name} · ${e.provider.model_version} · ללא רשת`} data-semantic-parsed>
                  <div class="chips">
                    ${e.parsed.objects.map(n=>r`<sw-chip selected icon="target">${Vh[n]??n}</sw-chip>`)}
                ...
                ${e.results.length?r`<div class="list">${e.results.map(n=>r`<div class="row" data-semantic-result data-confidence=${n.match.confidence} @click=${()=>$(`/investigate/events/${n.id}`)}>
    ...
    `}render(){return y()?this.renderApi():r`
      <sw-page heading="חיפוש AI" subheading="מצא בדיוק את מה שאתה מחפש · חיפוש סמנטי רק עם אינדקס אמיתי · נתוני הדגמה">
        ...
        <div class="wrap">
          ...
          <div class="results">
            ${Fh.map(e=>r`<div class="res" @click=${()=>window.location.hash="#/investigate/playback"}><div class="pic"><sw-scene kind=${e.scene}></sw-scene><span class="demo">דמו</span></div><div class="cap">${e.when}<small>${e.cam} · ${e.why}</small></div></div>`)}
          </div>
        </div>
      </sw-page>
    `}};pt.styles=M`
  ...
  `;qt([c()],pt.prototype,"by",2);qt([c()],pt.prototype,"q",2);qt([c()],pt.prototype,"answer",2);qt([c()],pt.prototype,"providers",2);qt([c()],pt.prototype,"busy",2);qt([c()],pt.prototype,"error",2);pt=qt([E("investigate-search")],pt);const Wh=()=>({name:"",description:"",enabled:!0,owner:"local",ha_automation_id:null,trigger:{types:[],sources:[],severity_min:"info"},scope:{site_ids:[],building_ids:[],floor_ids:[],zone_ids:[],camera_ids:[],entity_ids:[]},window:{days:[],from:null,to:null},cooldown_s:300,actions:[{kind:"notify",message:""}]}),Uh=()=>k("rules"),Zh=e=>A("rules",e),Br=(e,t)=>Be(`rules/${e}`,t),qh=e=>ve(`rules/${e}`),Lr=(e,t=24)=>A("rules/dry-run",{rule:e,hours:t}),Kh=(e=!1)=>k(`rules/alerts${e?"?unacked=true":""}`),Gh=e=>A(`rules/alerts/${e}/ack`),Vr={mon:"ב׳",tue:"ג׳",wed:"ד׳",thu:"ה׳",fri:"ו׳",sat:"ש׳",sun:"א׳"},Yh={alertstream:"התראת NVR",recording:"נגזר מהקלטה",system:"מערכת",ha:"חיישן HA"};var Jh=Object.defineProperty,Xh=Object.getOwnPropertyDescriptor,ce=(e,t,s,i)=>{for(var a=i>1?void 0:i?Xh(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&Jh(t,s,a),a};const Hr={"r-1":{icon:"user",bg:"#eaf0ff",fg:"#2f6bff"},"r-2":{icon:"move",bg:"#e8f8ee",fg:"#16a34a"},"r-3":{icon:"door",bg:"#fff4e0",fg:"#d97706"},"r-4":{icon:"offline",bg:"#fdecec",fg:"#ef4444"}},Qh=[{id:"person-night",label:"אדם בלילה",body:{name:"אדם בלילה",description:"זיהוי אדם בשעות הסגירה",trigger:{types:["person"],sources:[],severity_min:"info"},window:{days:[],from:"22:00",to:"06:00"},cooldown_s:300,actions:[{kind:"notify",message:"זוהה אדם בשעות הסגירה"}]}},{id:"camera-offline",label:"מצלמה מנותקת",body:{name:"מצלמה מנותקת",description:"התראה כשמצלמה יורדת מהרשת",trigger:{types:["offline"],sources:[],severity_min:"info"},window:{days:[],from:null,to:null},cooldown_s:1800,actions:[{kind:"notify",message:"מצלמה מנותקת"}]}},{id:"door-after-hours",label:"דלת נפתחה אחרי שעות",body:{name:"דלת נפתחה אחרי שעות",description:"פתיחת דלת מחוץ לשעות הפעילות",trigger:{types:["door"],sources:["ha"],severity_min:"info"},window:{days:[],from:"20:00",to:"07:00"},cooldown_s:600,actions:[{kind:"notify",message:"דלת נפתחה מחוץ לשעות הפעילות"}]}}];let le=class extends z{constructor(){super(...arguments),this.tab="rules",this.rules=[],this.alerts=[],this.unacked=0,this.meta={types:[],sources:[],days:[]},this.error="",this.busy=!1,this.loading=!1,this.editing=null,this.dry=null,this.dryBusy=!1,this.tree=null,this.cams=[],this.zones=[],this.confirmDelete=null,this.tz="Asia/Jerusalem"}connectedCallback(){super.connectedCallback(),y()&&this.load()}async load(){this.loading=!0,this.error="";try{const[e,t]=await Promise.all([Uh(),Kh()]);if(this.rules=e.rules,this.meta={types:e.types,sources:e.sources,days:e.days},this.alerts=t.alerts,this.unacked=t.unacked,!this.tree){const[s,i]=await Promise.all([St(),Le()]);this.tree=s,this.cams=i.cameras.filter(a=>a.enabled)}}catch(e){this.error=w(e)}finally{this.loading=!1}}fmt(e){return e?new Intl.DateTimeFormat("he-IL",{timeZone:this.tz,dateStyle:"short",timeStyle:"short"}).format(new Date(e)):"—"}get floors(){return(this.tree?.sites??[]).flatMap(e=>(e.buildings??[]).flatMap(t=>(t.floors??[]).map(s=>({id:s.id,name:`${t.name} · ${s.name}`}))))}async run(e){this.busy=!0,this.error="";try{await e(),await this.load()}catch(t){this.error=w(t),t instanceof ue&&t.status===409&&await this.load()}finally{this.busy=!1}}openEditor(e){if(this.dry=null,this.zones=[],e){const{id:t,revision:s,alerts:i,created_by_username:a,updated_by_username:n,created_at:o,updated_at:l,last_fired_at:p,...h}=e;this.editing={id:t,revision:s,body:JSON.parse(JSON.stringify(h))},h.scope.floor_ids.length===1&&this.loadZones(h.scope.floor_ids[0])}else this.editing={id:null,revision:0,body:Wh()}}async loadZones(e){try{this.zones=(await rd(e)).zones}catch{this.zones=[]}}edit(e){if(!this.editing)return;const t=JSON.parse(JSON.stringify(this.editing.body));e(t),this.editing={...this.editing,body:t}}toggleIn(e,t){const s=e.indexOf(t);s>=0?e.splice(s,1):e.push(t)}async dryRun(){if(this.editing){this.dryBusy=!0,this.error="";try{this.dry=this.editing.id?await Lr({...this.editing.body},24):await Lr(this.editing.body,24)}catch(e){this.error=w(e)}finally{this.dryBusy=!1}}}save(){const e=this.editing;!e||!e.body.name.trim()||this.run(async()=>{e.id?await Br(e.id,{...e.body,revision:e.revision}):await Zh(e.body),this.editing=null,this.dry=null})}summary(e){const t=e.trigger.types.length?e.trigger.types.map(a=>ee[a]??a).join(", "):"כל הסוגים",s=e.scope.floor_ids.length||e.scope.zone_ids.length||e.scope.camera_ids.length||e.scope.building_ids.length||e.scope.site_ids.length?[e.scope.floor_ids.length?`${e.scope.floor_ids.length} קומות`:"",e.scope.zone_ids.length?`${e.scope.zone_ids.length} אזורים`:"",e.scope.camera_ids.length?`${e.scope.camera_ids.length} מצלמות`:""].filter(Boolean).join(" · "):"כל המתקן",i=e.window.from||e.window.to||e.window.days.length?`${e.window.days.map(a=>Vr[a]??a).join("")||"כל יום"} ${e.window.from??"00:00"}–${e.window.to??"24:00"}`:"תמיד";return`${t} · ${s} · ${i} · השהיה ${e.cooldown_s} שנ׳ · ${e.owner==="ha"?`בבעלות HA (${e.ha_automation_id})`:"התראה במערכת"}`}renderEditor(){const e=this.editing;if(!e)return d;const t=e.body,s=this.dry;return r`<sw-dialog open heading=${e.id?"עריכת חוק":"חוק חדש"} subheading="Trigger → היקף → חלון זמן → השהיה → התראה במערכת · הרצה יבשה לפני שמירה" data-rule-dialog @close=${()=>this.editing=null}>
      ${this.error?r`<div class="err">${this.error}</div>`:d}
      ${e.id?d:r`<sw-field label="תבניות (ממלאות את הטופס; אפשר לשנות אחר כך)"><div class="chips">${Qh.map(i=>r`<sw-chip data-rule-template=${i.id} @click=${()=>this.edit(a=>Object.assign(a,JSON.parse(JSON.stringify(i.body))))}>${i.label}</sw-chip>`)}</div></sw-field>`}
      <sw-field label="שם"><input data-rule-name .value=${t.name} @input=${i=>this.edit(a=>a.name=i.target.value)} /></sw-field>
      <sw-field label="סוגי אירועים (ריק = הכל)"><div class="chips">${this.meta.types.map(i=>r`<sw-chip data-rule-type=${i} ?selected=${t.trigger.types.includes(i)} @click=${()=>this.edit(a=>this.toggleIn(a.trigger.types,i))}>${ee[i]??i}</sw-chip>`)}</div></sw-field>
      <sw-field label="מקורות (ריק = הכל)"><div class="chips">${this.meta.sources.map(i=>r`<sw-chip ?selected=${t.trigger.sources.includes(i)} @click=${()=>this.edit(a=>this.toggleIn(a.trigger.sources,i))}>${Yh[i]??i}</sw-chip>`)}</div></sw-field>
      <div class="two">
      ...
      <sw-field label="ימים (ריק = כל יום)"><div class="chips">${this.meta.days.map(i=>r`<sw-chip ?selected=${t.window.days.includes(i)} @click=${()=>this.edit(a=>this.toggleIn(a.window.days,i))}>${Vr[i]??i}</sw-chip>`)}</div></sw-field>
      <div class="two">
      ...
      ${s?r`<div class="dry">${[...s.would_fire.map(i=>({...i,fire:!0})),...s.suppressed.map(i=>({...i,fire:!1}))].sort((i,a)=>i.occurred_at.localeCompare(a.occurred_at)).slice(0,40).map(i=>r`<div class="dryrow" data-dryrun-row data-fire=${i.fire?"true":"false"}><span class="ltr">${this.fmt(i.occurred_at)}</span><span>${ee[i.type]??i.type} · ${i.camera_name??"—"}</span><span class="hint">${i.fire?i.reasons.join(" · "):`נחסם: ${i.suppressed}`}</span></div>`)}${s.would_fire.length+s.suppressed.length>40?r`<div class="hint">מוצגות 40 הראשונות</div>`:d}<div class="hint">${s.note}</div></div>`:d}
      ...
      <sw-page heading="התראות וחוקי אוטומציה" subheading="Trigger → היקף → חלון זמן → השהיה → התראה במערכת · הרצה יבשה לפני הפעלה · אין פקודות למכשירים">
        ...
        ${this.tab==="rules"?this.loading&&!this.rules.length?r`<sw-state-panel state="loading"></sw-state-panel>`:this.rules.length?r`<div class="list">${this.rules.map(e=>r`<sw-card flush class="rule" data-rule-row data-rule-id=${e.id} style="--bg:#eaf0ff;--fg:#2f6bff">
                    ...
                    <sw-toggle ?checked=${e.enabled} ?disabled=${this.busy||e.owner==="ha"} labelHidden label="פעיל" data-rule-toggle @change=${t=>void this.run(async()=>{const{id:s,revision:i,alerts:a,created_by_username:n,updated_by_username:o,created_at:l,updated_at:p,last_fired_at:h,...m}=e;await Br(s,{...m,enabled:t.detail.checked,revision:i})})}></sw-toggle>
                  ...
                  ${e.acked_at?r`<span class="last">טופל · ${e.acked_by_username??""}</span>`:r`<sw-button size="sm" icon="check" data-alert-ack ?disabled=${this.busy} @click=${()=>void this.run(async()=>{await Gh(e.id)})}>סמן כטופל</sw-button>`}
        ...
        ${this.confirmDelete?r`<sw-dialog open heading="מחיקת חוק" subheading=${this.confirmDelete.name} @close=${()=>this.confirmDelete=null}>
              ...
              <sw-button slot="footer" variant="danger" icon="trash" data-rule-delete-confirm @click=${()=>{const e=this.confirmDelete;this.confirmDelete=null,this.run(async()=>{await qh(e.id)})}}>מחק</sw-button>
            </sw-dialog>`:d}
      </sw-page>
    `}render(){return y()?this.renderApi():r`
      <sw-page heading="התראות וחוקי אוטומציה" subheading="Trigger → היקף → תנאים → פעולה · בדיקה יבשה לפני הפעלה · נתוני הדגמה">
        ...
        ${this.tab==="rules"?r`<div class="list">
              ${sa.map(e=>{const t=Hr[e.id]??Hr["r-1"];return r`<sw-card flush class="rule" style="--bg:${t.bg};--fg:${t.fg}">
  ...
  `;ce([f()],hi.prototype,"ruleId",2);hi=ce([E("investigate-rule-editor")],hi);const eu=()=>k("identity/users"),tu=()=>A("identity/sync"),fs=()=>k("access/roles"),jr=e=>A("access/bindings",e),su=e=>ve(`access/bindings/${e}`),iu=()=>k("access/groups"),au=e=>A("access/groups",{name:e}),ru=e=>ve(`access/groups/${e}`),nu=(e,t)=>Me(`access/groups/${e}/members`,{user_ids:t}),ou=e=>A("access/preview",e),Fr=(e={})=>{const t=new URLSearchParams;e.prefix&&t.set("prefix",e.prefix),e.actor&&t.set("actor",e.actor),e.resourceId&&t.set("resource_id",e.resourceId),e.limit&&t.set("limit",String(e.limit));const s=t.toString();return k(`audit${s?`?${s}`:""}`)},Wr={verified:"מסונכרן",stale:"סנכרון מיושן",removed:"מושבת / נמחק ב־HA",unavailable:"לא בספריית HA",unknown:"טרם סונכרן",dev:"משתמש פיתוח"},lu={"rbac.bind":"שיוך תפקיד","rbac.unbind":"ביטול שיוך","rbac.group_create":"יצירת קבוצה","rbac.group_members":"שינוי חברי קבוצה","rbac.group_delete":"מחיקת קבוצה","rbac.bootstrap_admin":"מנהל ראשון (bootstrap)","identity.user_disabled":"משתמש הושבת (HA)","identity.user_enabled":"משתמש הופעל (HA)","identity.sync":"סנכרון ספרייה"};function gt(e){if(!e)return"—";const t=new Date(e);return Number.isNaN(t.getTime())?e:t.toLocaleString("he-IL",{dateStyle:"short",timeStyle:"short"})}const du=e=>A("access/roles",e),cu=(e,t)=>Be(`access/roles/${e}`,t),pu=e=>ve(`access/roles/${e}`),hu=e=>A("access/roles/preview",e),uu=e=>Me("access/delegation",{delegable_roles:e});var mu=Object.defineProperty,fu=Object.getOwnPropertyDescriptor,Y=(e,t,s,i)=>{for(var a=i>1?void 0:i?fu(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&mu(t,s,a),a};const gu=[{id:"users",label:"משתמשים",count:ea.length},{id:"groups",label:"קבוצות",count:cn.length},{id:"roles",label:"תפקידים",count:pn.length},{id:"effective",label:"הרשאות אפקטיביות"},{id:"audit",label:"אודיט הרשאות"}];let K=class extends z{constructor(){super(...arguments),this.tab="users",this.selected=null,this.assigning=!1,this.step=0,this.directory=null,this.roles=null,this.groups=null,this.tree=null,this.audit=null,this.selectedGroup=null,this.wizard=null,this.members=null,this.newGroup="",this.preview=null,this.previewUser="",this.previewScope="installation:*",this.busy=!1,this.error="",this.message="",this.forbidden=!1,this.roleEdit=null,this.roleImpact=null,this.roleDelete=null,this.roleImpactTimer=0,this.userColumns=[{key:"name",label:"שם",render:e=>r`<div class="who"><sw-avatar name=${String(e.name)} size=${30}></sw-avatar><div><strong>${String(e.name)}</strong>${e.haAdmin?r` <sw-badge kind="neutral" label="מנהל HA · מידע בלבד"></sw-badge>`:""}<div class="ltr sub">${String(e.haUser)}@ha.local</div></div></div>`},{key:"role",label:"תפקיד",render:e=>{const t=e.bindings[0];return t?r`<span class="pillsel">${t.role}<sw-icon name="chevronDown" size=${11}></sw-icon></span>`:r`<span class="pillsel" style="color:var(--sw-text-3)">ללא שיוך<sw-icon name="chevronDown" size=${11}></sw-icon></span>`}},{key:"scope",label:"היקף גישה",render:e=>{const t=e.bindings[0];return t?r`<span class="pillsel">${t.scope}<sw-icon name="chevronDown" size=${11}></sw-icon></span>`:r`<span class="sub">—</span>`}},{key:"active",label:"מצב",render:e=>r`<span class="status ${e.active?"":"off"}"><i></i>${e.active?"פעיל":"מושבת ב־HA"}</span>`},{key:"lastSync",label:"סנכרון"},{key:"more",label:"",width:"40px",render:()=>r`<sw-button variant="ghost" size="sm" iconOnly icon="more" label="עוד"></sw-button>`}]}connectedCallback(){super.connectedCallback(),y()&&this.load()}async load(){this.error="";try{const[e,t,s,i]=await Promise.all([eu(),fs(),iu(),St()]);this.directory=e,this.roles=t,this.groups=s.groups,this.tree=i,this.forbidden=!1,this.previewUser||(this.previewUser=Te.me?.user.id??"")}catch(e){const t=w(e);this.error=t,this.forbidden=/403|הרשאה|forbidden/i.test(t)&&!this.directory}}async loadAudit(){try{const[e,t]=await Promise.all([Fr({prefix:"rbac.",limit:100}),Fr({prefix:"identity.",limit:50})]);this.audit=[...e.rows,...t.rows].sort((s,i)=>s.at<i.at?1:-1).slice(0,150)}catch(e){this.error=w(e),this.audit=[]}}flash(e){this.message=e,setTimeout(()=>this.message="",3500)}get scopeOptions(){const e=[{type:"installation",id:"*",name:"כל ההתקנה"}];for(const t of this.tree?.sites??[]){e.push({type:"site",id:t.id,name:`אתר · ${t.name}`});for(const s of t.buildings??[]){e.push({type:"building",id:s.id,name:`${t.name} · ${s.name}`});for(const i of s.floors??[])e.push({type:"floor",id:i.id,name:`${t.name} · ${s.name} · ${i.name}`})}}return e}userName(e){return this.directory?.users.find(t=>t.id===e)?.name??e}label(e){return this.roles?.labels[e]??e}startWizard(e,t,s){this.wizard={subjectKind:e,subjectId:t,subjectName:s,roleId:"viewer",scopeKey:"installation:*",effect:"allow"}}async saveWizard(){const e=this.wizard;if(!e)return;const[t,s]=e.scopeKey.split(":");this.busy=!0,this.error="";try{const i=await jr({subject_kind:e.subjectKind,subject_id:e.subjectId,role_id:e.roleId,scope_type:t,scope_id:s,effect:e.effect});this.flash(e.effect==="deny"?`נחסם: ${i.role_name} · ${i.scope_name} (רוויזיה ${i.revision})`:`שויך: ${i.role_name} · ${i.scope_name} (רוויזיה ${i.revision})`),this.wizard=null,await this.load()}catch(i){this.error=w(i)}finally{this.busy=!1}}async revoke(e){this.busy=!0,this.error="";try{await su(e.id),this.flash(`בוטל: ${e.role_name} · ${e.scope_name}`),await this.load()}catch(t){this.error=w(t)}finally{this.busy=!1}}async sync(){this.busy=!0,this.error="";try{const e=await tu();this.flash(e.requested?"הספרייה נדחפה מ־Home Assistant":e.note??"הספרייה מתעדכנת אוטומטית כל דקה"),await this.load()}catch(e){this.error=w(e)}finally{this.busy=!1}}async addGroup(){const e=this.newGroup.trim();if(e){this.busy=!0,this.error="";try{const t=await au(e);this.newGroup="",this.flash(`נוצרה קבוצה "${t.name}"`),await this.load(),this.selectedGroup=t.id}catch(t){this.error=w(t)}finally{this.busy=!1}}}async saveMembers(e){if(this.members){this.busy=!0,this.error="";try{await nu(e.id,[...this.members]),this.members=null,this.flash("חברי הקבוצה עודכנו"),await this.load()}catch(t){this.error=w(t)}finally{this.busy=!1}}}async removeGroup(e){this.busy=!0,this.error="";try{await ru(e.id),this.selectedGroup=null,this.flash(`הקבוצה "${e.name}" נמחקה והשיוכים שלה בוטלו`),await this.load()}catch(t){this.error=w(t)}finally{this.busy=!1}}async runPreview(){if(!this.previewUser)return;const[e,t]=this.previewScope.split(":");this.busy=!0,this.error="";try{this.preview=await ou({user_id:this.previewUser,scope_type:e,scope_id:t})}catch(s){this.error=w(s)}finally{this.busy=!1}}renderBindingRow(e,t){return r`<div class="bind">
      <div><strong>${e.role_name}</strong> · ${e.scope_name}${e.effect==="deny"?r` <sw-badge kind="forbidden" label="חסימה"></sw-badge>`:d}<div class="sub">${e.via_group?`דרך קבוצה "${e.via_group}" · `:""}מאז ${gt(e.created_at)}${e.expires_at?` · עד ${gt(e.expires_at)}`:""} · רוויזיה ${e.permission_revision}</div></div>
      ...
      <div class="stage">
        ...
        ${i?r`<sw-drawer open heading=${i.name} subheading=${`Home Assistant · ${i.username||i.id} · ${i.active?"פעיל":"ללא גישה"}`} @close=${()=>{this.selected=null,this.wizard=null}}>
              ${this.wizard&&this.wizard.subjectKind==="user"?this.renderWizard():r`<dl>
                    ...
                    <dt>סנכרון</dt><dd>${Wr[i.sync_status]}${i.synced_at?` · ${gt(i.synced_at)}`:""}</dd>
                    <dt>ב־VMS</dt><dd>${i.first_seen_at?`מאז ${gt(i.first_seen_at)} · לאחרונה ${gt(i.last_seen_at)}`:"טרם נכנס לממשק"}</dd>
    ...
    `}renderUsers(){const e=ea.find(t=>t.id===this.selected);return r`
      <div class="stage">
        <sw-table .columns=${this.userColumns} .rows=${ea} .selected=${this.selected} @row-select=${t=>{this.selected=t.detail.id,this.assigning=!1}}></sw-table>
    ...
    `}renderAudit(){return r`<sw-table dense .columns=${[{key:"time",label:"זמן"},{key:"user",label:"משתמש",render:t=>r`<div class="who"><sw-avatar name=${String(t.user)} size=${24}></sw-avatar>${String(t.user)}</div>`},{key:"action",label:"פעולה"},{key:"resource",label:"משאב"},{key:"decision",label:"החלטה",render:t=>r`<sw-badge kind=${String(t.decision).startsWith("נחסם")?"forbidden":"live"} label=${String(t.decision)}></sw-badge>`},{key:"role",label:"תפקיד/היקף ששימשו"}]} .rows=${hn.filter(t=>t.action.includes("תוכנית")||t.action.includes("סנכרון")||t.action.includes("Ingress"))}></sw-table>`}render(){return y()?this.renderApi():r`
      <sw-page heading="משתמשים והרשאות" subheading="זהות מ־Home Assistant · הרשאות בתוך SMPLWISE בלבד · נתוני הדגמה">
        ...
        <sw-tabs .items=${gu} .active=${this.tab} @change=${e=>this.tab=e.detail.id}></sw-tabs>
        <div class="notice"><sw-icon name="shield" size=${14}></sw-icon>שיוך כאן אינו משנה דבר ב־Home Assistant: לא קבוצות HA, לא דגל מנהל, לא סיסמאות. אין "הוספת משתמש" — משתמשים נוצרים ב־HA בלבד.</div>
  ...
  `;Y([c()],K.prototype,"tab",2);Y([c()],K.prototype,"selected",2);Y([c()],K.prototype,"assigning",2);Y([c()],K.prototype,"step",2);Y([c()],K.prototype,"directory",2);Y([c()],K.prototype,"roles",2);Y([c()],K.prototype,"groups",2);Y([c()],K.prototype,"tree",2);Y([c()],K.prototype,"audit",2);Y([c()],K.prototype,"selectedGroup",2);Y([c()],K.prototype,"wizard",2);Y([c()],K.prototype,"members",2);Y([c()],K.prototype,"newGroup",2);Y([c()],K.prototype,"preview",2);Y([c()],K.prototype,"previewUser",2);Y([c()],K.prototype,"previewScope",2);Y([c()],K.prototype,"busy",2);Y([c()],K.prototype,"error",2);Y([c()],K.prototype,"message",2);Y([c()],K.prototype,"forbidden",2);Y([c()],K.prototype,"roleEdit",2);Y([c()],K.prototype,"roleImpact",2);Y([c()],K.prototype,"roleDelete",2);K=Y([E("system-access")],K);var wu=Object.defineProperty,vu=Object.getOwnPropertyDescriptor,cs=(e,t,s,i)=>{for(var a=i>1?void 0:i?vu(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&wu(t,s,a),a};const bu=[{key:"time",label:"זמן",render:e=>r`14.09.2026 ${String(e.time)}`},{key:"user",label:"משתמש",render:e=>r`<span style="display:inline-flex;align-items:center;gap:8px"><sw-avatar name=${String(e.user)} size=${24}></sw-avatar>${String(e.user)}</span>`},{key:"action",label:"פעולה",render:e=>r`<span style=${String(e.decision).startsWith("נחסם")?"color:var(--sw-danger);font-weight:600":""}>${String(e.action)}</span>`},{key:"resource",label:"פרטים",render:e=>r`${String(e.resource)} <span style="color:var(--sw-text-3)">· ${String(e.decision)}</span>`},{key:"role",label:"תפקיד / היקף"},{key:"rev",label:"rev",ltr:!0,render:()=>r`7`}],yu=[{id:"",label:"כל הפעולות"},{id:"rbac.",label:"הרשאות ותפקידים"},{id:"video.",label:"וידאו (לייב, הקלטות, ייצוא)"},{id:"events.",label:"אירועים"},{id:"cases.",label:"תיקים וראיות"},{id:"ha.",label:"פעולות Home Assistant"},{id:"system.",label:"מערכת והגדרות"},{id:"plan.",label:"תוכניות ומפות"}],$u={allowed:{kind:"success",label:"הותר"},granted:{kind:"success",label:"הוענק"},denied:{kind:"danger",label:"נחסם"},refused:{kind:"danger",label:"סורב"},failed:{kind:"warning",label:"נכשל"}},xu=[{key:"at",label:"זמן",ltr:!0,render:e=>r`<span class="ltr">${new Date(String(e.at)).toLocaleString("he-IL",{day:"2-digit",month:"2-digit",year:"numeric",hour:"2-digit",minute:"2-digit",second:"2-digit"})}</span>`},{key:"actor",label:"משתמש",render:e=>r`<span style="display:inline-flex;align-items:center;gap:8px"><sw-avatar name=${String(e.actor_username??"מערכת")} size=${24}></sw-avatar>${String(e.actor_username??"מערכת")}</span>`},{key:"action",label:"פעולה",ltr:!0,render:e=>r`<span class="ltr">${String(e.action)}</span>`},{key:"decision",label:"החלטה",render:e=>{const t=$u[String(e.decision)]??{kind:"neutral",label:String(e.decision)};return r`<sw-badge kind=${t.kind} label=${t.label}></sw-badge>`}},{key:"resource",label:"משאב",render:e=>r`${e.resource_type?r`<span style="color:var(--sw-text-3)">${String(e.resource_type)}</span> `:d}<span class="ltr">${String(e.resource_id??"")}</span>`},{key:"reason",label:"סיבה / פרטים",render:e=>r`${String(e.reason??"")}${Object.keys(e.details??{}).length?r` <span style="color:var(--sw-text-3)" class="ltr">${JSON.stringify(e.details).slice(0,120)}</span>`:d}`},{key:"permission_revision",label:"rev",ltr:!0}];let zt=class extends z{constructor(){super(...arguments),this.rows=null,this.error="",this.family="",this.actor="",this.limit=100}connectedCallback(){super.connectedCallback(),y()&&this.load()}async load(){try{const e=new URLSearchParams({prefix:this.family,limit:String(this.limit)});this.actor.trim()&&e.set("actor",this.actor.trim());const t=await k(`/audit?${e.toString()}`);this.rows=t.rows,this.error=""}catch(e){this.error=w(e),this.rows=[]}}exportCsv(){const e=this.rows??[],t=n=>`"${String(n??"").replace(/"/g,'""')}"`,s=[["at","actor","action","decision","resource_type","resource_id","reason","request_id","permission_revision"].join(",")];for(const n of e)s.push([n.at,n.actor_username,n.action,n.decision,n.resource_type,n.resource_id,n.reason,n.request_id,n.permission_revision].map(t).join(","));const i=new Blob(["\uFEFF"+s.join(`
`)],{type:"text/csv;charset=utf-8"}),a=document.createElement("a");a.href=URL.createObjectURL(i),a.download=`audit-${new Date().toISOString().slice(0,10)}.csv`,a.click(),setTimeout(()=>URL.revokeObjectURL(a.href),2e3)}renderApi(){const e=this.rows;return r`
      <sw-page heading="יומן אודיט" subheading="מי צפה, שינה, ייצא או שלח פעולה · actor, פעולה, החלטה, משאב, סיבה, request_id, permission_revision · אין סיסמאות או טוקנים ביומן">
        ...
        <div class="filters" data-audit-filters>
          <sw-field><select aria-label="פעולה" .value=${this.family} @change=${t=>{this.family=t.target.value,this.load()}}>${yu.map(t=>r`<option value=${t.id} ?selected=${t.id===this.family}>${t.label}</option>`)}</select></sw-field>
        ...
        ${e===null?r`<sw-state-panel state="loading" heading="טוען יומן…"></sw-state-panel>`:e.length?r`<sw-table data-audit-table .columns=${xu} .rows=${e}></sw-table>`:this.error?d:r`<sw-state-panel state="empty" heading="אין רשומות לסינון הזה" hint="נסה משפחת פעולות אחרת או נקה את שם המשתמש"></sw-state-panel>`}
    ...
    `}render(){return y()?this.renderApi():r`
      <sw-page heading="יומן אודיט" subheading="מי צפה, שינה, ייצא או שלח פעולה · actor, מקור זהות, תפקיד והיקף, החלטה, request_id, permission_revision · נתוני הדגמה">
        ...
        <sw-table .columns=${bu} .rows=${hn}></sw-table>
        <div class="pager">
  ...
  `;cs([c()],zt.prototype,"rows",2);cs([c()],zt.prototype,"error",2);cs([c()],zt.prototype,"family",2);cs([c()],zt.prototype,"actor",2);cs([c()],zt.prototype,"limit",2);zt=cs([E("system-audit")],zt);var ku=Object.defineProperty,_u=Object.getOwnPropertyDescriptor,J=(e,t,s,i)=>{for(var a=i>1?void 0:i?_u(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&ku(t,s,a),a};const zu=[{key:"nvr_host",label:"כתובת ה־NVR"},{key:"nvr_http_port",label:"פורט ISAPI (HTTP)"},{key:"nvr_rtsp_port",label:"פורט RTSP"},{key:"nvr_username",label:"משתמש NVR (קריאה)"},{key:"nvr_password",label:"סיסמת NVR"},{key:"go2rtc_url",label:"כתובת go2rtc"},{key:"go2rtc_api_username",label:"משתמש go2rtc (אם מוגן)"},{key:"go2rtc_api_password",label:"סיסמת go2rtc"},{key:"bootstrap_admin_username",label:"שם משתמש HA של המנהל הראשון"},{key:"log_level",label:"רמת לוג"}];function It(e){if(!e)return"—";const t=new Date(e);return Number.isNaN(t.getTime())?String(e):t.toLocaleString("he-IL",{day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit",second:"2-digit"})}const qi=["גילוי","NVR","go2rtc","גשר HA","מנהל ראשון","שעון","סיום"];let G=class extends z{constructor(){super(...arguments),this.step=0,this.raw=null,this.report=null,this.recorder=null,this.error="",this.busy=!1,this.notify=null,this.notifyError="",this.notifyPlan=null,this.notifyBusy=!1,this.notifyResult="",this.sys=null,this.sysError="",this.sysMsg="",this.sysBusy=!1,this.ntpForm=null,this.rebootWord="",this.rebootOpen=!1,this.connection=null,this.connForm=null,this.connMsg="",this.connBusy=!1,this.changes=[]}connectedCallback(){super.connectedCallback(),y()&&this.load()}async load(){this.loadNvr(),this.busy=!0;try{this.raw=await k("health"),this.error=""}catch(e){this.error=w(e)}try{this.recorder=(await Le()).recorder}catch{this.recorder=null}try{this.report=await Cn()}catch{this.report=null}this.busy=!1}check(e){return this.report?.checks.find(t=>t.id===e)??null}row(e,t,s=""){return r`<div class="check"><span>${e}</span><span class=${`val ${s}`}>${t==null||t===""?"—":String(t)}</span></div>`}sectionHead(e,t){return r`<div class="syshead"><sw-icon name=${e} size=${15}></sw-icon>${t}</div>`}async loadNvr(){if(y()){try{const[e,t]=await Promise.all([Yc(),zr(10)]);this.notify=e,this.changes=t.changes,this.notifyError=""}catch(e){this.notifyError=w(e)}this.loadSystem(),dp().then(e=>this.connection=e).catch(()=>this.connection=null)}}async loadSystem(){try{this.sys=await ip(),this.sysError=""}catch(e){this.sysError=w(e)}}async sysAction(e,t){if(!this.sysBusy){this.sysBusy=!0,this.sysMsg="";try{await t(),await Promise.all([this.loadSystem(),zr(10).then(s=>this.changes=s.changes)]),this.sysMsg=`${e}: בוצע ונרשם באודיט.`}catch(s){this.sysMsg=`${e}: ${w(s)}`}finally{this.sysBusy=!1}}}async saveConnection(){const e=this.connForm;if(!(!e||this.connBusy)){this.connBusy=!0,this.connMsg="";try{const t=await cp({host:e.host.trim(),http_port:e.http_port,rtsp_port:e.rtsp_port,user:e.user.trim(),...e.password?{password:e.password}:{}});this.connection=t,this.connForm=null,this.connMsg=t.restarting?`החיבור נבדק (${t.device.model} · ${t.device.firmware}) ונשמר ב־Add-on options; ה־Add-on מופעל מחדש כעת.`:`החיבור נבדק (${t.device.model} · ${t.device.firmware}) ונשמר; בתוקף מיד.`,this.loadSystem()}catch(t){this.connMsg=`לא נשמר: ${w(t)}`}finally{this.connBusy=!1}}}renderSystemCard(){const e=this.sys,t=a=>`${(a/1024).toFixed(0)} GB`,s=e?.time?.drift_s??null,i=s===null?"":Math.abs(s)<=2?"ok":Math.abs(s)<=30?"warn":"err";return r`<sw-card heading="מערכת ה־NVR" subheading="שעון ו־NTP, דיסקים ובדיקת S.M.A.R.T., יציאות אזעקה, הפעלה מחדש · כל כתיבה דורשת הרשאה רגישה ונרשמת" data-nvr-system>
      ...
      ${e?r`
          ...
          ${e.time?r`${this.row("שעון ה־NVR",`${e.time.local_time??"—"} · ${e.time.mode==="NTP"?"NTP":"ידני"}`)}
                ...
                ${e.can.time?r`<div class="actions">
                      <sw-button size="sm" icon="clock" ?disabled=${this.sysBusy} data-nvr-sync-clock @click=${()=>this.sysAction("סנכרון השעון",()=>ap({sync_now:!0}))}>סנכרן לשעון השרת עכשיו</sw-button>
          ...
          ${e.disks.length?e.disks.map(a=>r`<div data-nvr-disk=${a.id}>
                ...
                ${e.can.storage?r`<div class="actions"><sw-button size="sm" icon="storage" ?disabled=${this.sysBusy} data-nvr-smart-test=${a.id} @click=${()=>this.sysAction("בדיקת S.M.A.R.T. קצרה",()=>op(a.id,"short"))}>בדיקת S.M.A.R.T. קצרה</sw-button><span class="hint">מעמיסה את הדיסק בזמן ריצתה; מומלץ בשעות שקטות</span></div>`:d}
          ...
          ${e.outputs.length?e.outputs.map(a=>r`<div class="check" data-nvr-output=${a.id}><span>יציאה ${a.id}${a.name?` · ${a.name}`:""} <span class="hint">${a.io_type==="local"?"ממסר ב־NVR":"במצלמה"} · ${a.use_type==="whiteLight"?"אור לבן":a.use_type==="disable"?"לא בשימוש":a.use_type}${a.pulse_ms?` · פולס ${a.pulse_ms/1e3} שנ׳`:""}</span></span>
                ${a.pulse_supported?e.can.alarm?r`<sw-button size="sm" icon="bell" ?disabled=${this.sysBusy||!a.enabled} data-nvr-pulse=${a.id} @click=${()=>this.sysAction(`הפעלת יציאה ${a.id}`,()=>np(a.id))}>הפעל (pulse)</sw-button>`:r`<span class="val">${a.enabled?"פעיל":"כבוי"}</span>`:r`<span class="val" data-nvr-output-unsupported>הפעלה דרך המצלמה בלבד (ה־NVR לא מעביר)</span>`}
      ...
      ${this.rebootOpen?r`<sw-dialog open heading="הפעלה מחדש של ה־NVR" subheading="במשך 1–2 דקות אין לייב ואין הקלטה" data-nvr-reboot-dialog @close=${()=>this.rebootOpen=!1}>
            ...
            <div slot="footer"><sw-button variant="danger" ?disabled=${this.sysBusy||this.rebootWord.trim().toUpperCase()!=="RESTART"} data-nvr-reboot-run @click=${()=>{const a=this.rebootWord;this.rebootOpen=!1,this.sysAction("הפעלה מחדש",()=>lp(a))}}>הפעל מחדש</sw-button><sw-button variant="ghost" @click=${()=>this.rebootOpen=!1}>ביטול</sw-button></div>
          </sw-dialog>`:d}
    ...
    </sw-card>`}planNotify(e,t,s){const i=e?e.length:this.notify?.channels.length??0;this.notifyResult="",this.notifyPlan={channels:e,smart:t,enabled:s,label:`${s?"הפעלת":"כיבוי"} Notify Surveillance Center ב־${i} ערוצים${t?" · תנועה + אירועים חכמים":" · זיהוי תנועה"}`}}async runNotify(){const e=this.notifyPlan;if(!(!e||this.notifyBusy)){this.notifyBusy=!0;try{const t=await Jc({channels:e.channels,smart:e.smart,enabled:e.enabled});this.notifyResult=`בוצע: ${t.applied} שינויים · ${t.unchanged} כבר היו כך · ${t.skipped} דולגו (סוג אירוע שלא מוגדר בערוץ) · ${t.failed} נכשלו`,this.notifyPlan=null,await this.loadNvr()}catch(t){this.notifyResult=w(t)}finally{this.notifyBusy=!1}}}async rollback(e){if(!this.notifyBusy){this.notifyBusy=!0;try{await Xc(e.id),this.notifyResult=`השינוי ${e.target} הוחזר למצב הקודם.`,await this.loadNvr()}catch(t){this.notifyResult=w(t)}finally{this.notifyBusy=!1}}}renderNotifyCard(){const e=this.notify,t=s=>s===null?"—":s?"✓":"✗";return r`<sw-card heading="התראות מה־NVR (Notify Surveillance Center)" subheading="אילו ערוצים מודיעים ל־VMS על תנועה ועל אירועים חכמים · כתיבה מאושרת ל־NVR, עם החזר" data-nvr-notify>
      ...
      <sw-page heading="חיבורים" subheading="מצב החיבורים של ה־Add-on: NVR, go2rtc, Home Assistant ואחסון · קריאה בלבד · הערכים עצמם מוגדרים ב־Home Assistant › Add-ons › SMPLWISE VMS › Configuration">
        ...
        ${e?r`<div class="two" data-connections>
              ...
              <sw-card heading="NVR (Hikvision, ISAPI + RTSP)" subheading=${e.nvr_configured?"מוגדר · קריאה בלבד":"לא מוגדר"}>
                ...
                ${this.row("גילוי אחרון תקין",It(e.discovery.cameras_last_ok),e.discovery.cameras_last_error?"warn":"ok")}
                ${e.discovery.cameras_last_error?this.row("שגיאת גילוי",e.discovery.cameras_last_error,"err"):d}
                ${this.row("זרם התראות (alertStream)",e.events.ingest.connected?`מחובר · פעימה ${It(e.events.ingest.last_heartbeat_at)}`:`מנותק${e.events.ingest.last_error?` · ${e.events.ingest.last_error}`:""}`,e.events.ingest.connected?"ok":"err")}
                ...
                ${this.row("אירועים שנגזרו מהקלטות (ריצה אחרונה)",`${e.events.derive.derived} · ${It(e.events.derive.last_ok)}`,e.events.derive.last_error?"warn":"")}
              </sw-card>
              ...
              <sw-card heading="go2rtc (relay לווידאו)" subheading=${e.go2rtc_configured?"מוגדר":"לא מוגדר"}>
                ...
                ${this.row("סנכרון זרמים אחרון תקין",It(e.discovery.streams_last_ok),e.discovery.streams_last_error?"warn":"ok")}
              ...
              <sw-card heading="Home Assistant" subheading=${e.home_assistant.connected?`מחובר · HA ${e.home_assistant.ha_version??""}`:e.home_assistant.configured?"מוגדר, מנותק":"לא מוגדר"}>
                ...
                ${this.row("תמונת מצב אחרונה",It(e.home_assistant.last_snapshot_at))}
                ${this.row("עדכון ישות אחרון",It(e.home_assistant.last_event_at))}
                ${this.row("רישום (אזורים / קומות) עודכן",It(e.home_assistant.last_registry_at))}
            ...
            <sw-card heading="איפה מגדירים" subheading="הערכים אינם מוצגים כאן ואינם נשמרים ב־VMS; שינוי דורש הפעלה מחדש של ה־Add-on">
              <div class="opts" data-connection-options>
                ${zu.map(t=>r`<div class="check"><span>${t.label}</span><span class="val ltr">${t.key}</span></div>`)}
              </div>
        ...
        <div class="wrap">
          ...
          <div class="foot">
            ...
            <div style="display:flex;gap:8px">
              ...
              <sw-button variant="primary" @click=${()=>this.step=Math.min(qi.length-1,this.step+1)}>${this.step===qi.length-1?"סיום":"הבא"}</sw-button>
            </div>
          </div>
        </div>
      </sw-page>
  ...
  `;J([c()],G.prototype,"step",2);J([c()],G.prototype,"raw",2);J([c()],G.prototype,"report",2);J([c()],G.prototype,"recorder",2);J([c()],G.prototype,"error",2);J([c()],G.prototype,"busy",2);J([c()],G.prototype,"notify",2);J([c()],G.prototype,"notifyError",2);J([c()],G.prototype,"notifyPlan",2);J([c()],G.prototype,"notifyBusy",2);J([c()],G.prototype,"notifyResult",2);J([c()],G.prototype,"sys",2);J([c()],G.prototype,"sysError",2);J([c()],G.prototype,"sysMsg",2);J([c()],G.prototype,"sysBusy",2);J([c()],G.prototype,"ntpForm",2);J([c()],G.prototype,"rebootWord",2);J([c()],G.prototype,"rebootOpen",2);J([c()],G.prototype,"connection",2);J([c()],G.prototype,"connForm",2);J([c()],G.prototype,"connMsg",2);J([c()],G.prototype,"connBusy",2);J([c()],G.prototype,"changes",2);G=J([E("system-setup")],G);var Su=Object.defineProperty,Mu=Object.getOwnPropertyDescriptor,Ee=(e,t,s,i)=>{for(var a=i>1?void 0:i?Mu(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&Su(t,s,a),a};const Ur=["entrance","lobby","corridor","hall","parking","warehouse","backyard","driveway","night"];let we=class extends z{constructor(){super(...arguments),this.selected=null,this.filter="all",this.cameras=null,this.recorder=null,this.canSync=!1,this.discovery=null,this.busy=!1,this.message="",this.error="",this.dialog=!1,this.formChannel=1,this.formAlias="",this.alias="",this.columns=[{key:"name",label:"מצלמה",render:e=>r`<div class="cam">${e.api&&e.api.status==="online"?r`<img class="snap" src=${et(String(e.id))} alt="" loading="lazy" style="inline-size:64px;block-size:40px;object-fit:cover;border-radius:5px;flex-shrink:0;background:var(--sw-surface-3);display:block" @error=${t=>t.target.style.visibility="hidden"} />`:e.scene?r`<sw-scene kind=${e.scene}></sw-scene>`:r`<div class="none"></div>`}<div><b>${String(e.name)}</b><small>${String(e.sub)}</small></div></div>`},{key:"state",label:"מצב",render:e=>r`<span class="status"><i style="--c:${e.state==="live"?"var(--sw-live)":e.state==="offline"?"var(--sw-danger)":e.state==="unknown"?"var(--sw-unknown)":"var(--sw-stale)"}"></i>${e.state==="live"?"מחוברת":e.state==="offline"?"מנותקת":e.state==="stale"?"לא מעודכן":e.state==="forbidden"?"ללא הרשאה":"לא נבדק"}</span>`},{key:"fps",label:"FPS",ltr:!0},{key:"bitrate",label:"קצב",ltr:!0},{key:"firmware",label:"זרם ראשי",ltr:!0},{key:"lastEvent",label:"נראתה לאחרונה"},{key:"net",label:"רשת",render:e=>this.net(e.state==="live"?4:e.state==="stale"?2:0)},{key:"more",label:"",width:"40px",render:()=>r`<sw-button variant="ghost" size="sm" iconOnly icon="more" label="עוד"></sw-button>`}]}connectedCallback(){super.connectedCallback(),this.reload()}async reload(){if(!y()){this.cameras=null;return}try{const e=await Le();this.cameras=e.cameras,this.recorder=e.recorder,this.canSync=e.can_sync,k("health").then(t=>this.discovery=t.discovery).catch(()=>{})}catch(e){this.error=w(e)}}async sync(){this.busy=!0,this.error="",this.message="";try{const e=await jl();this.message=`סנכרון הושלם: ${e.channels} ערוצים (${e.created} חדשים, ${e.updated} עודכנו)${e.recorder.model?` · ${e.recorder.model}`:""}`,await this.reload()}catch(e){this.error=w(e)}finally{this.busy=!1}}async register(){this.busy=!0,this.error="";try{await Fl({channel:this.formChannel,alias:this.formAlias.trim()}),this.dialog=!1,await this.reload()}catch(e){this.error=w(e)}finally{this.busy=!1}}async saveAlias(e){this.busy=!0,this.error="";try{await wn(e,{alias:this.alias.trim()||void 0}),await this.reload(),this.message="הכינוי נשמר (שם ה־NVR לא השתנה)"}catch(t){this.error=w(t)}finally{this.busy=!1}}get rows(){return this.cameras?this.cameras.map(e=>({id:e.id,name:e.name,sub:`ערוץ ${e.channel}${e.name_source&&e.alias?` · NVR: ${e.name_source}`:""}`,state:e.status==="online"?"live":e.status==="offline"?"offline":"unknown",fps:e.stream?.fps?String(e.stream.fps):"—",bitrate:e.stream?.bitrate_kbps?`${(e.stream.bitrate_kbps/1024).toFixed(1)} Mbps`:"—",firmware:e.stream?.resolution?`${e.stream.resolution} ${e.stream.codec??""}`.trim():"—",lastEvent:e.last_seen_at?e.last_seen_at.replace("T"," ").replace("Z",""):"לא נבדק",scene:e.status==="online"?Ur[(e.channel-1)%Ur.length]:null,channel:e.channel,api:e})):X.map(e=>({id:e.id,name:e.name,sub:`${e.floor} · ערוץ ${e.id.replace("cam-","")}`,state:e.state,fps:e.fps?String(e.fps):"—",bitrate:e.bitrateKbps?`${(e.bitrateKbps/1024).toFixed(1)} Mbps`:"—",firmware:e.firmware,lastEvent:e.lastEvent,scene:e.state==="offline"||e.state==="forbidden"?null:tt[e.id]??"lobby",channel:Number(e.id.replace("cam-",""))}))}net(e){return u`<svg class="net" viewBox="0 0 22 14" aria-label="רשת">${[0,1,2,3].map(t=>u`<rect x=${t*5.5} y=${11-t*3} width="4" height=${3+t*3} rx="1" fill=${t<e?e>=3?"#22c55e":"#f59e0b":"var(--sw-border-strong)"} />`)}</svg>`}render(){const e=this.rows,t=e.filter(a=>this.filter==="all"?!0:this.filter==="online"?a.state==="live":this.filter==="offline"?a.state==="offline":a.state==="stale"||a.state==="forbidden"||a.state==="unknown"),s=e.find(a=>a.id===this.selected),i=!!this.cameras;return r`
  ...
  `;Ee([c()],we.prototype,"selected",2);Ee([c()],we.prototype,"filter",2);Ee([c()],we.prototype,"cameras",2);Ee([c()],we.prototype,"recorder",2);Ee([c()],we.prototype,"canSync",2);Ee([c()],we.prototype,"discovery",2);Ee([c()],we.prototype,"busy",2);Ee([c()],we.prototype,"message",2);Ee([c()],we.prototype,"error",2);Ee([c()],we.prototype,"dialog",2);Ee([c()],we.prototype,"formChannel",2);Ee([c()],we.prototype,"formAlias",2);Ee([c()],we.prototype,"alias",2);we=Ee([E("system-devices")],we);const Ta="sw.design.override",Oa="sw.design.last",Es={a:"SW A",b:"SW B"};let Ws="b";const ha=new Set;function ui(e){try{return localStorage.getItem(e)}catch{return null}}function Vn(e,t){try{t===null?localStorage.removeItem(e):localStorage.setItem(e,t)}catch{}}function Eu(){try{const s=new URLSearchParams(window.location.search).get("design");if(s==="a"||s==="b")return s}catch{}const e=ui(Ta);if(e==="a"||e==="b")return e;const t=ui(Oa);return t==="a"||t==="b"?t:"b"}Ws=Eu();function ua(){const e=ui(Ta);return e==="a"||e==="b"?e:null}function Au(e){Vn(Ta,e),jn()}function Hn(){return Ws}function Pu(e){return ha.add(e),e(Ws),()=>ha.delete(e)}function wt(e){Ws=e,document.documentElement.dataset.design=e,Vn(Oa,e),ha.forEach(t=>t(e))}function Iu(e){try{const t=e?JSON.parse(e):{};return{a:(t.a||Es.a).slice(0,24),b:(t.b||Es.b).slice(0,24)}}catch{return{...Es}}}async function jn(){const e=new URLSearchParams(window.location.search).get("design");if(e==="a"||e==="b")return wt(e),e;const t=ua();if(t)return wt(t),t;if(!y())return wt("b"),"b";const s=ui(Oa);(s==="a"||s==="b")&&wt(s);try{const a=(await Ve())["ui.design"]==="b"?"b":"a";return wt(a),a}catch{return wt(s==="b"?"b":"a"),Ws}}const Cu={manual:"ידני",upload:"הועלה","auto-pre-upgrade":"אוטומטי · לפני עדכון","auto-daily":"אוטומטי · יומי"},Ki={sites:"אתרים",buildings:"מבנים",floors:"קומות",plan_assets:"קבצי תוכנית",plan_versions:"גרסאות תוכנית",map_anchors:"עוגנים",cameras:"מצלמות",spatial_zones:"אזורים",settings:"הגדרות",users:"משתמשים",bindings:"הרשאות",groups:"קבוצות"},Du=()=>k("backups"),Tu=(e={})=>A("backups",e),Ou=e=>ve(`backups/${encodeURIComponent(e)}`),Ru=(e,t)=>A(`backups/${encodeURIComponent(e)}/restore`,t),Nu=e=>ge(`backups/${encodeURIComponent(e)}/download`);function Bu(e){const t=new FormData;return t.append("file",e,e.name),$i("backups/upload",t)}function Zr(e){return e<1024?`${e} B`:e<1024*1024?`${(e/1024).toFixed(0)} KB`:`${(e/1024/1024).toFixed(1)} MB`}var Lu=Object.defineProperty,Vu=Object.getOwnPropertyDescriptor,Z=(e,t,s,i)=>{for(var a=i>1?void 0:i?Vu(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&Lu(t,s,a),a};const qr=[{id:"general",label:"כללי"},{id:"media",label:"וידאו ומדיה"},{id:"ha",label:"גשר Home Assistant"},{id:"health",label:"בריאות ועבודות"},{id:"backup",label:"גיבוי ושחזור"},{id:"support",label:"תמיכה"}];let j=class extends z{constructor(){super(...arguments),this.tab="general",this.settings=null,this.canEdit=!1,this.draft={},this.streams=null,this.go2rtc=null,this.foreign=0,this.sessions=[],this.busy=!1,this.message="",this.error="",this.version="",this.ha=null,this.pairing=null,this.showCode=!1,this.regenArmed=!1,this.copied=!1,this.report=null,this.reportBusy=!1,this.backups=null,this.backupPolicy={},this.backupBusy=!1,this.backupNote="",this.backupMsg="",this.restoreTarget=null,this.restoreMode="replace",this.restoreAccess=!1,this.restoreConfirm="",this.health=null}connectedCallback(){super.connectedCallback();const e=as().params.get("tab");e&&qr.some(t=>t.id===e)&&(this.tab=e,e==="health"&&this.loadReport(),e==="backup"&&this.loadBackups(),e==="media"&&this.loadMedia(),e==="ha"&&this.loadHa()),this.loadSettings()}async loadSettings(){if(y())try{const[e,t]=await Promise.all([an(),k("health").catch(()=>null)]);this.settings=e.settings,this.canEdit=e.can_edit,this.draft={},this.version=t?.version??"",this.health=t??null}catch(e){this.error=w(e)}}async loadMedia(){if(!(!y()||!this.canEdit))try{const[e,t]=await Promise.all([Ko(),Go()]);this.streams=e.streams,this.go2rtc=e.go2rtc,this.foreign=e.foreign_streams,this.sessions=t.sessions,this.error=""}catch(e){this.streams=[],this.error=w(e)}}async loadHa(e=!1){if(y()){this.error="";try{this.ha=await gd(),this.canEdit&&(this.pairing=await wd(e)),e&&(this.regenArmed=!1,this.showCode=!0,this.message="נוצר קוד צימוד חדש; יש להגדיר מחדש את האינטגרציה ב־Home Assistant.",setTimeout(()=>this.message="",4e3))}catch(t){this.error=w(t)}}}async copyCode(){if(this.pairing)try{await navigator.clipboard.writeText(this.pairing.pairing_code),this.copied=!0,setTimeout(()=>this.copied=!1,2e3)}catch{this.showCode=!0}}async installBridgeNow(){this.busy=!0,this.error="";try{const e=await vd();this.message=e.state==="installed_pending"?"האינטגרציה הועתקה ל־Home Assistant; הפעל מחדש את Home Assistant ואשר את הגשר שהתגלה.":e.state==="active"?"האינטגרציה פעילה.":e.state==="not_available"?"תיקיית ההגדרות של Home Assistant אינה נגישה ל־Add-on.":`מצב: ${e.state}`,await this.loadHa(),setTimeout(()=>this.message="",6e3)}catch(e){this.error=w(e)}finally{this.busy=!1}}integrationText(e){switch(e.state){case"active":return`פעילה ב־Home Assistant (גרסה ${e.active_version??"?"})`;case"installed_pending":return`הועתקה לתיקיית ההגדרות של HA (גרסה ${e.installed_version??"?"}) ב־${Fe(e.installed_at)} · הפעל מחדש את Home Assistant ואז אשר את "SMPLWISE Bridge" שהתגלה בהגדרות → מכשירים ושירותים`;case"update_pending":return`עודכנה לגרסה ${e.installed_version??"?"} אך Home Assistant עדיין מריץ ${e.active_version??"?"} · נדרש Restart ל־Home Assistant`;case"not_installed":return"טרם הועתקה";case"error":return`ההעתקה נכשלה (${e.last_error??""})`;default:return e.last_error==="ha_config_not_mapped"?"ה־Add-on לא רואה את תיקיית ההגדרות של Home Assistant (המיפוי homeassistant_config לא ניתן) · התקנה ידנית לפי השלבים למטה":e.last_error==="source_missing"?"קבצי האינטגרציה חסרים בתמונת ה־Add-on · התקנה ידנית לפי השלבים למטה":`ההתקנה האוטומטית נכשלה (${e.last_error??"סיבה לא ידועה"}) · התקנה ידנית לפי השלבים למטה`}}renderIntegration(e){const t=e.integration;if(!t)return d;const s=t.state==="active"?"live":t.state==="installed_pending"||t.state==="update_pending"?"stale":t.state==="error"?"error":"unknown",i=t.state==="active"?"פעילה":t.state==="installed_pending"?"ממתינה ל־Restart":t.state==="update_pending"?"עדכון ממתין":t.state==="error"?"שגיאה":t.state==="not_installed"?"לא הותקנה":"לא זמין";return r`<div class="row"><span class="lbl">התקנת האינטגרציה ב־Home Assistant<span class="muted">${this.integrationText(t)}${t.discovery_posted_at?` · הוכרזה ל־Supervisor ${Fe(t.discovery_posted_at)}`:""}</span></span><span style="display:flex;gap:8px;align-items:center"><sw-badge kind=${s} label=${i}></sw-badge>${this.canEdit&&t.state!=="not_available"?r`<sw-button size="sm" ?disabled=${this.busy} @click=${()=>this.installBridgeNow()}>התקן / עדכן</sw-button>`:d}</span></div>`}renderHa(){if(!y())return r`<div class="sections"><sw-card heading="גשר Home Assistant"><div class="muted">נתוני הדגמה — הסטטוס והצימוד זמינים מול השרת.</div></sw-card></div>`;const e=this.ha,t=e?.sync,s=this.pairing;return r`<div class="sections">
      <sw-card heading="חיבור ל־Home Assistant" subheading="קריאה בלבד: מצבים, רישום ישויות, אזורים וקומות">
        ${e?r`
            ...
            <div class="row"><span class="lbl">סנכרון מצבים (WebSocket)<span class="muted">${t?.connected?`מחובר · HA ${t.ha_version??"?"} · ${t.entities} ישויות · אירוע אחרון ${Fe(t.last_event_at)}`:`מנותק${t?.last_error?` · ${t.last_error}`:""} · ${t?.reconnects??0} חיבורים מחדש`}</span></span><sw-badge kind=${t?.connected?"live":"offline"}></sw-badge></div>
            <div class="row"><span class="lbl">רישום ישויות (registry)<span class="muted">עודכן ${Fe(t?.last_registry_at)} · תמונת מצב ${Fe(t?.last_snapshot_at)}</span></span><sw-button size="sm" @click=${()=>$("/explore/entities")}>לקטלוג</sw-button></div>`:r`<div class="muted">טוען…</div>`}
      </sw-card>
      <sw-card heading="גשר SMPLWISE (אינטגרציה ב־Home Assistant)" subheading="פעולות על ישויות רצות רק דרך הגשר, בזהות המשתמש, לפי ההרשאות של Home Assistant">
        ${e?r`${this.renderIntegration(e)}<div class="row"><span class="lbl">צימוד<span class="muted">${e.bridge.paired?`מצומד מאז ${Fe(e.bridge.paired_at)}`:"לא מצומד — פעולות HA ייחסמו עד להתקנת הגשר"}</span></span><sw-badge kind=${e.bridge.paired?"live":"stale"} label=${e.bridge.paired?"מצומד":"לא מצומד"}></sw-badge></div>
            <div class="row"><span class="lbl">ספריית משתמשי HA<span class="muted">${e.bridge.directory_users} משתמשים · עודכן ${Fe(e.bridge.last_directory_at)}</span></span><sw-badge kind=${e.bridge.directory_users?"recorded":"unknown"}></sw-badge></div>`:d}
    ...
    </div>`}set(e,t){this.draft={...this.draft,[e]:t}}value(e){return this.draft[e]??this.settings?.[e]}async save(){if(Object.keys(this.draft).length){this.busy=!0,this.error="";try{const e=await Zo(this.draft);this.settings=e.settings,this.draft={},pr(),this.message="ההגדרות נשמרו",setTimeout(()=>this.message="",2500)}catch(e){this.error=w(e)}finally{this.busy=!1}}}async sync(){this.busy=!0,this.error="";try{const e=await qo();this.message=`זרמים: ${e.created} נוצרו, ${e.updated} עודכנו, ${e.unchanged} ללא שינוי · ${e.foreign_streams_untouched} זרמים זרים לא נגעו`,await this.loadMedia()}catch(e){this.error=w(e)}finally{this.busy=!1}}renderDesign(){if(!y())return d;const e=Iu(this.value("ui.design_names")),t=this.value("ui.design")??"a",s=ua(),i="ui.design"in this.draft||"ui.design_names"in this.draft,a=(n,o)=>this.set("ui.design_names",JSON.stringify({...e,[n]:o.slice(0,24)}));return r`<sw-card heading="עיצוב הממשק" subheading=${`פעיל עכשיו בדפדפן הזה: ${e[Hn()]}${s?" (עקיפה מקומית)":""}`}>
      ...
      <div class="row"><span class="lbl">שם העיצוב החדש<span class="muted">ברירת מחדל: ${Es.a} · העיצוב מחבילת 50 המסכים</span></span><sw-field class="ctl"><input maxlength="24" ?disabled=${!this.canEdit} .value=${e.a} @change=${n=>a("a",n.target.value)} /></sw-field></div>
      <div class="row"><span class="lbl">שם העיצוב הקודם<span class="muted">ברירת מחדל: ${Es.b} · הלוחות המקוריים</span></span><sw-field class="ctl"><input maxlength="24" ?disabled=${!this.canEdit} .value=${e.b} @change=${n=>a("b",n.target.value)} /></sw-field></div>
      <div class="row"><span class="lbl">בדפדפן הזה בלבד<span class="muted">עקיפה אישית שנשמרת במכשיר; לא משנה את ברירת המחדל</span></span><sw-field class="ctl"><select @change=${n=>{const o=n.target.value;Au(o==="a"||o==="b"?o:null),o!=="a"&&o!=="b"&&wt(t),this.requestUpdate()}}><option value="" ?selected=${!s}>לפי ברירת המחדל</option><option value="a" ?selected=${s==="a"}>${e.a}</option><option value="b" ?selected=${s==="b"}>${e.b}</option></select></sw-field></div>
    ...
    </sw-card>`}async saveDesign(){await this.save(),!ua()&&this.settings&&wt(this.settings["ui.design"]==="b"?"b":"a")}renderGeneral(){return r`<div class="sections">
      ${this.renderDesign()}
      <sw-card heading="זמן ומיקום">
        ...
        ${y()?d:r`<div class="row"><span class="lbl">NTP במכשיר<span class="muted">pool.ntp.org · סטייה 2 שנ׳</span></span><sw-toggle checked label="פעיל"></sw-toggle></div>`}
      </sw-card>
    ...
    </div>`}renderMedia(){const e=y(),t=Object.keys(this.draft).length>0;return r`<div class="sections">
    ...
    </div>`}async loadReport(e=!1){if(y()){this.reportBusy=!0;try{this.report=await Cn(e)}catch(t){this.error=w(t)}finally{this.reportBusy=!1}}}renderReport(){const e=this.report;if(!e)return r`<div class="sections"><sw-card heading="בריאות המערכת"><div class="muted">${this.reportBusy?"בודק…":"טוען…"}</div></sw-card></div>`;const t=new Intl.DateTimeFormat("he-IL",{hour:"2-digit",minute:"2-digit",second:"2-digit",hourCycle:"h23"}).format(new Date(e.checked_at));return r`<div class="sections">
      <sw-card heading="בריאות המערכת" subheading="מצב נפרד לכל רכיב, לא נורה אחת">
        <div class="hsum"><sw-badge kind=${xr[e.status]} label=${e.status==="ok"?"הכל תקין":e.status==="warn"?"יש מה לבדוק":"יש תקלה"}></sw-badge><span>גרסה <span class="ltr">${e.version}</span> · פעיל ${jc(e.uptime_s)} · נבדק <span class="ltr" data-health-checked>${t}</span></span><span class="grow"></span><sw-button size="sm" icon="refresh" ?disabled=${this.reportBusy} @click=${()=>this.loadReport(!0)}>${this.reportBusy?"בודק…":"בדוק עכשיו"}</sw-button></div>
        <div class="hgrid">${e.checks.map(s=>r`<div class="hcard ${s.status}" data-health-card=${s.id}><div class="hh"><span>${s.label}</span><sw-badge kind=${xr[s.status]} label=${_s[s.status]}></sw-badge></div><div class="hd">${s.detail}</div></div>`)}</div>
    ...
    </div>`}renderHealth(){return y()?this.renderReport():r`<div class="sections">
      <sw-card heading="מצבים נפרדים, לא נורה אחת">${mn.map(e=>r`<div class="row"><span class="lbl">${e.name}<span class="muted">${e.detail}</span></span><sw-badge kind=${e.state}></sw-badge></div>`)}
        ...
        <div class="row"><span class="lbl">זרמים פעילים<span class="muted">${y()?`${this.sessions.length} דרך ה־relay`:"4 חיים · 1 ניגון · 0 יתומים"}</span></span><sw-badge kind="live"></sw-badge></div>
        ${y()&&this.health?.events?r`<div class="row"><span class="lbl">קליטת אירועים מה־NVR (alertStream)<span class="muted">${this.health.events.ingest.connected?`מחובר · פעימה אחרונה ${this.health.events.ingest.last_heartbeat_at?.replace("T"," ").replace("Z"," UTC")??"—"}`:`מנותק${this.health.events.ingest.last_error?` · ${this.health.events.ingest.last_error}`:""}`} · ${this.health.events.ingest.events_stored} אירועים נקלטו · ${this.health.events.ingest.reconnects} חיבורים מחדש</span></span><sw-badge kind=${this.health.events.ingest.connected?"live":"offline"}></sw-badge></div>
      ...
      <sw-card heading="תור עבודות">${un.map(e=>r`<div class="row"><span class="lbl">${e.title}<span class="muted">${e.status}</span></span><span style="display:flex;align-items:center;gap:10px"><span class="bar ${e.status.startsWith("נכשל")?"fail":""}"><i style="--p:${e.progress}%"></i></span><span class="ltr">${e.progress}%</span></span></div>`)}</sw-card>
    </div>`}async loadBackups(){if(y())try{const e=await Du();this.backups=e.backups,this.backupPolicy=e.policy}catch(e){this.error=w(e),this.backups=[]}}async createBackup(){this.backupBusy=!0,this.backupMsg="";try{const e=await Tu({note:this.backupNote.trim()});this.backupNote="",this.backupMsg=`הגיבוי ${e.name} נוצר (${Zr(e.bytes)})`,await this.loadBackups()}catch(e){this.error=w(e)}finally{this.backupBusy=!1}}async onBackupFile(e){if(e){this.backupBusy=!0,this.backupMsg="";try{const t=await Bu(e);this.backupMsg=`הקובץ הועלה כ־${t.name}; עכשיו אפשר לשחזר ממנו`,await this.loadBackups()}catch(t){this.error=w(t)}finally{this.backupBusy=!1}}}async removeBackup(e){if(window.confirm(`למחוק את הגיבוי ${e.name}?`)){this.backupBusy=!0;try{await Ou(e.name),await this.loadBackups()}catch(t){this.error=w(t)}finally{this.backupBusy=!1}}}openRestore(e){this.restoreTarget=e,this.restoreMode="replace",this.restoreAccess=!1,this.restoreConfirm=""}async doRestore(){const e=this.restoreTarget;if(!(!e||this.restoreConfirm!=="RESTORE")){this.backupBusy=!0,this.error="";try{const t=await Ru(e.name,{mode:this.restoreMode,scope:this.restoreAccess?"project+access":"project",confirm:this.restoreConfirm}),s=Object.entries(t.tables).filter(([i])=>Ki[i]).map(([i,a])=>`${a} ${Ki[i]}`);this.backupMsg=`שוחזר מ־${e.name} (${t.mode==="replace"?"החלפה":"מיזוג"}): ${s.join(", ")} · ${t.files} קבצים`,this.restoreTarget=null,pr(),await this.loadBackups()}catch(t){this.error=w(t)}finally{this.backupBusy=!1}}}fmtWhen(e){return new Intl.DateTimeFormat("he-IL",{day:"2-digit",month:"2-digit",year:"numeric",hour:"2-digit",minute:"2-digit",hourCycle:"h23"}).format(new Date(e))}renderBackupRow(e){const t=["sites","floors","plan_versions","map_anchors","spatial_zones","cameras"].filter(s=>e.tables[s]!==void 0).map(s=>`${e.tables[s]} ${Ki[s]}`).join(" · ");return r`<div class="brow" data-backup-row>
      <div>
        <div class="name"><span class="ltr">${e.name}</span><sw-badge kind=${e.kind.startsWith("auto")?"neutral":e.kind==="upload"?"stale":"live"} label=${Cu[e.kind]??e.kind}></sw-badge>${e.valid?d:r`<sw-badge kind="error" label="קובץ לא תקין"></sw-badge>`}</div>
        <div class="sub">${this.fmtWhen(e.created_at)} · ${Zr(e.bytes)} · גרסה ${e.app_version??"?"}${e.note?` · ${e.note}`:""}</div>
        ${t?r`<div class="sub">${t} · ${e.files} קבצי תוכנית</div>`:d}
      </div>
      <div class="acts">
        <a href=${Nu(e.name)} download=${e.name} data-backup-download><sw-button size="sm" icon="download">הורד</sw-button></a>
      ...
      <sw-card heading="גיבויים של הפרויקט" subheading="אתרים, קומות, תוכניות, עוגנים, אזורים, מצלמות והגדרות · בלי סודות ובלי וידאו">
        ...
        <div class="row"><span class="lbl">העלאת גיבוי<span class="muted">קובץ zip שהורד מכאן (גם מהתקנה קודמת); אחרי ההעלאה לוחצים "שחזר"</span></span>
          <span><input type="file" accept=".zip,application/zip" hidden @change=${t=>{const s=t.target;this.onBackupFile(s.files?.[0]),s.value=""}} /><sw-button size="sm" icon="upload" ?disabled=${this.backupBusy||!y()} @click=${()=>this.renderRoot.querySelector("input[type=file]")?.click()}>בחר קובץ…</sw-button></span></div>
        ${this.backupMsg?r`<div class="muted" style="color:#15803d;padding-block:6px" data-backup-msg>${this.backupMsg}</div>`:d}
        ${y()?this.backups===null?r`<div class="muted">טוען…</div>`:e.length?r`<div class="blist" data-backups>${e.map(t=>this.renderBackupRow(t))}</div>`:r`<div class="muted" style="padding-block:6px">עדיין אין גיבויים. הראשון ייווצר אוטומטית לפני העדכון הבא, או עכשיו בלחיצה.</div>`:r`<div class="muted">נתוני הדגמה: הגיבויים עובדים מול השרת.</div>`}
      </sw-card>
    ...
    ${this.restoreTarget?this.renderRestoreDialog(this.restoreTarget):d}`}renderSupport(){return r`<div class="sections"><sw-card heading="חבילת תמיכה מצונזרת">
      ...
      <sw-page heading="הגדרות המערכת" subheading=${y()?"תעבורת וידאו, go2rtc, מכסות ובריאות":"אזור זמן, מדיניות אחסון, אינטגרציות ובריאות · נתוני הדגמה"}>
        <sw-tabs underline .items=${qr} .active=${this.tab} @change=${e=>{this.tab=e.detail.id,this.tab==="media"&&this.loadMedia(),this.tab==="ha"&&this.loadHa(),this.tab==="backup"&&this.loadBackups(),this.tab==="health"&&this.loadReport()}}></sw-tabs>
  ...
  `;Z([c()],j.prototype,"tab",2);Z([c()],j.prototype,"settings",2);Z([c()],j.prototype,"canEdit",2);Z([c()],j.prototype,"draft",2);Z([c()],j.prototype,"streams",2);Z([c()],j.prototype,"go2rtc",2);Z([c()],j.prototype,"foreign",2);Z([c()],j.prototype,"sessions",2);Z([c()],j.prototype,"busy",2);Z([c()],j.prototype,"message",2);Z([c()],j.prototype,"error",2);Z([c()],j.prototype,"version",2);Z([c()],j.prototype,"ha",2);Z([c()],j.prototype,"pairing",2);Z([c()],j.prototype,"showCode",2);Z([c()],j.prototype,"regenArmed",2);Z([c()],j.prototype,"copied",2);Z([c()],j.prototype,"report",2);Z([c()],j.prototype,"reportBusy",2);Z([c()],j.prototype,"backups",2);Z([c()],j.prototype,"backupPolicy",2);Z([c()],j.prototype,"backupBusy",2);Z([c()],j.prototype,"backupNote",2);Z([c()],j.prototype,"backupMsg",2);Z([c()],j.prototype,"restoreTarget",2);Z([c()],j.prototype,"restoreMode",2);Z([c()],j.prototype,"restoreAccess",2);Z([c()],j.prototype,"restoreConfirm",2);Z([c()],j.prototype,"health",2);j=Z([E("system-diagnostics")],j);var Hu=Object.defineProperty,ju=Object.getOwnPropertyDescriptor,rt=(e,t,s,i)=>{for(var a=i>1?void 0:i?ju(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&Hu(t,s,a),a};const Fu=[{name:"כניסה ראשית",gb:320},{name:"אולם",gb:410},{name:"חצר אחורית",gb:380},{name:"לובי",gb:180},{name:"מחסן",gb:96}];let Ne=class extends z{constructor(){super(...arguments),this.range="30D",this.data=null,this.error="",this.loading=!1,this.tz="Asia/Jerusalem",this.signing=null,this.signingError="",this.signingBusy=!1,this.rotateConfirm=!1}connectedCallback(){super.connectedCallback(),y()&&(this.load(),this.loadSigning())}async load(e=!1){this.loading=!0,this.error="";try{const[t,s]=await Promise.all([Ve(),In(e)]);this.tz=t["time.zone"]??this.tz,this.data=s}catch(t){this.error=w(t)}finally{this.loading=!1}}fmt(e){return e?new Intl.DateTimeFormat("he-IL",{timeZone:this.tz,dateStyle:"short",timeStyle:"short"}).format(new Date(e)):"—"}async loadSigning(){try{this.signing=await jp(),this.signingError=""}catch(e){this.signingError=w(e)}}async rotateKey(){this.signingBusy=!0;try{this.signing=await Fp(),this.rotateConfirm=!1}catch(e){this.signingError=w(e)}finally{this.signingBusy=!1}}renderSigning(){const e=this.signing,t=s=>s?s.replace("T"," ").replace("Z"," UTC"):"—";return r`<sw-card heading="חתימת ראיות" subheading="כל חבילת ראיות חתומה ב־Ed25519 במפתח הפעיל של המתקן; החלק הפרטי נשאר ב־/data/keys ואינו נכלל בגיבוי" data-signing>
      ...
      <sw-page heading="אחסון ותוכנית הקלטה" subheading="קריאה בלבד מה־NVR · נמדד לעומת אומדן, עם הסיבה לכל מספר · אין format, RAID או מחיקה מכאן">
        ...
        ${e.nvr.configured?e.nvr.reachable?r`
                <div class="kpis" data-storage-kpis>
                  <sw-card flush class="kpi"><div><div class="v">${Ct(t?.used_mb)}</div><div class="l">בשימוש (נמדד מה־NVR)</div></div><div class="ic"><sw-icon name="storage" size=${16}></sw-icon></div></sw-card>
                  <sw-card flush class="kpi"><div><div class="v">${Ct(t?.capacity_mb)}</div><div class="l">קיבולת · ${t?.disks??0} דיסקים${t?.nas?` · ${t.nas} NAS`:""} · מצב ${e.work_mode??"?"}</div></div><div class="ic"><sw-icon name="cpu" size=${16}></sw-icon></div></sw-card>
                  <sw-card flush class="kpi"><div><div class="v">${t?.used_pct==null?"—":`${t.used_pct}%`}</div><div class="l">ניצולת · פנוי ${Ct(t?.free_mb)}</div></div><svg viewBox="0 0 40 40" aria-hidden="true">${u`<circle cx="20" cy="20" r=${i} fill="none" stroke="var(--sw-surface-3)" stroke-width="6" /><circle cx="20" cy="20" r=${i} fill="none" stroke="var(--sw-accent)" stroke-width="6" stroke-linecap="round" stroke-dasharray=${`${a*n/100} ${a}`} transform="rotate(-90 20 20)" />`}</svg></sw-card>
                </div>
                  ...
                  <div>
                    <sw-card heading="דיסקים" subheading=${`${t?.disks_ok??0} מתוך ${(t?.disks??0)+(t?.nas??0)} תקינים`}>
                      <div class="tbl disks" data-storage-disks>
                        ...
                        ${[...e.disks,...e.nas].map(l=>r`<div class="r" data-storage-disk><span>${l.name}${l.path?r`<small>${l.path}</small>`:d}</span><span>${l.kind}</span><span><sw-badge kind=${l.status==="ok"?"recorded":"error"} label=${l.status}></sw-badge></span><span class="num">${Ct(l.capacity_mb)}</span><span class="num">${Ct(l.free_mb)}</span><span>${l.property}</span></div>`)}
                      </div>
                    </sw-card>
                    ${this.renderSigning()}
    ...
    `}render(){if(y())return this.renderApi();const e=[.3,.36,.45,.5,.58,.63,.7],t=600,s=200,i=m=>m/(e.length-1)*420,a=m=>170-m*150,n=e.map((m,g)=>`${g===0?"M":"L"}${i(g)} ${a(m)}`).join(" "),o=`M${i(e.length-1)} ${a(.7)} L520 ${a(.86)} L${t} ${a(1)}`,l=16,p=2*Math.PI*l,h=410;return r`
      <sw-page heading="אנליטיקת אחסון" subheading="Beta · ניטור שימוש, תכנון קדימה ושליטה · נתון נמדד לעומת אומדן מסומן · אין format או RAID · נתוני הדגמה">
        ...
        <div class="grid">
          <sw-card heading="שימוש באחסון לפי מצלמה" subheading="נמדד · לפני retention">
            ${Fu.map(m=>r`<div class="cam"><span>${m.name}</span><span class="bar"><i style="--p:${m.gb/h*100}%"></i></span><span class="gb ltr">${m.gb} GB</span></div>`)}
  ...
  `;rt([c()],Ne.prototype,"range",2);rt([c()],Ne.prototype,"data",2);rt([c()],Ne.prototype,"error",2);rt([c()],Ne.prototype,"loading",2);rt([c()],Ne.prototype,"tz",2);rt([c()],Ne.prototype,"signing",2);rt([c()],Ne.prototype,"signingError",2);rt([c()],Ne.prototype,"signingBusy",2);rt([c()],Ne.prototype,"rotateConfirm",2);Ne=rt([E("system-storage")],Ne);var Wu=Object.getOwnPropertyDescriptor,Uu=(e,t,s,i)=>{for(var a=i>1?void 0:i?Wu(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=o(a)||a);return a};const Zu=[{mode:"סקירה ומצלמות",items:[{sc:"SC01",name:"סקירה (Dashboard)",route:"#/live",phase:"PILOT",board:"1:01 · 2:15"},{sc:"SC07",name:"כל המצלמות (Grid)",route:"#/live/wall",phase:"PILOT",board:"1:06"},{sc:"SC08",name:"מצלמה בודדת",route:"#/live/cameras/cam-4",phase:"PILOT",board:"1:05"},{sc:"SC09",name:"תצוגות שמורות",route:"#/live/views",phase:"PILOT",board:"legacy"},{sc:"SC27",name:"בריאות מצלמות",route:"#/system/devices",phase:"PILOT",board:"2:12"},{sc:"SC31",name:"קיוסק / תצוגת קיר",route:"#/kiosk/all",phase:"BETA",board:"3:24"}]},{mode:"אתרים ומפות",items:[{sc:"SC02",name:"אתרים ומבנים",route:"#/explore/sites",phase:"PILOT",board:"1:02 · 3:17"},{sc:"SC03",name:"דפדפן קומות",route:"#/explore/buildings/bld-a/floors",phase:"PILOT",board:"1:03"},{sc:"SC04",name:"מפת קומה חיה",route:"#/explore/floors/f0",phase:"PILOT",board:"1:04"},{sc:"SC05",name:"ייבוא ותיקון תוכנית",route:"#/explore/floors/f-2/import",phase:"PILOT",board:"2:13"},{sc:"SC06",name:"עורך תוכנית ועוגנים",route:"#/explore/floors/f0/edit",phase:"PILOT",board:"2:13"},{sc:"SC10",name:"קטלוג ישויות HA",route:"#/explore/entities",phase:"PILOT",board:"new"},{sc:"SC23",name:"דלתות ואינטרקום",route:"#/explore/access/d1",phase:"V1",board:"3:18"}]},{mode:"אירועים והקלטות",items:[{sc:"SC14",name:"מרכז אירועים",route:"#/investigate/events",phase:"PILOT",board:"1:08"},{sc:"SC12",name:"הקלטות / ציר זמן",route:"#/investigate/playback",phase:"PILOT",board:"1:07 · 2:16"},{sc:"SC13",name:"מרכז שליטה / ניגון מסונכרן",route:"#/investigate/playback/sync",phase:"BETA",board:"2:14"},{sc:"SC11",name:"מפה היסטורית",route:"#/investigate/floors/f0/history",phase:"PILOT",board:"new"},{sc:"SC15",name:"תור Review",route:"#/investigate/reviews",phase:"BETA",board:"legacy"},{sc:"SC16",name:"תיקים",route:"#/investigate/cases",phase:"BETA",board:"2:10"},{sc:"SC17",name:"סקירת אירוע / תיק",route:"#/investigate/cases/case-1",phase:"BETA",board:"2:10"},{sc:"SC18",name:"ייצוא והורדות",route:"#/investigate/exports",phase:"BETA",board:"2:10"},{sc:"SC19",name:"חיפוש AI",route:"#/investigate/search",phase:"BETA",board:"2:09"},{sc:"SC21",name:"התראות וחוקים",route:"#/investigate/rules",phase:"BETA",board:"3:19"},{sc:"SC22",name:"עורך חוק",route:"#/investigate/rules/r-1",phase:"BETA",board:"3:19"}]},{mode:"הגדרות",items:[{sc:"SC28",name:"הגדרות המערכת",route:"#/system/diagnostics",phase:"PILOT",board:"3:23"},{sc:"SC24",name:"משתמשים והרשאות",route:"#/system/access",phase:"PILOT",board:"3:20"},{sc:"SC25",name:"יומן אודיט",route:"#/system/audit",phase:"PILOT",board:"3:21"},{sc:"SC20",name:"אנליטיקת אחסון",route:"#/system/storage",phase:"BETA",board:"2:11"},{sc:"SC26",name:"אשף התקנה",route:"#/system/setup",phase:"PILOT",board:"3:22"}]}],qu={PILOT:"live",BETA:"recorded",V1:"neutral"};let ma=class extends z{render(){return r`
      <sw-page heading="כל המסכים (סקירת עיצוב)" subheading="29 מסכים על נתוני הדגמה · SC29/SC30 הם אותם מסכים ברוחב טלפון · SC32 (Lovelace) הוא עטיפה של אותם רכיבים">
        ...
        <div class="groups">
          ${Zu.map(e=>r`<sw-card heading=${e.mode}>
              ${e.items.map(t=>r`<a href=${t.route}><span class="sc">${t.sc}</span><span class="name">${t.name}</span><span class="board">${t.board}</span><sw-badge kind=${qu[t.phase]} label=${t.phase}></sw-badge><sw-icon name="chevron" size=${12}></sw-icon></a>`)}
            </sw-card>`)}
        </div>
      </sw-page>
    `}};ma.styles=M`
  ...
  `;ma=Uu([E("screens-index")],ma);var Ku=Object.getOwnPropertyDescriptor,Gu=(e,t,s,i)=>{for(var a=i>1?void 0:i?Ku(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=o(a)||a);return a};const Yu=[["--sw-bg","רקע"],["--sw-surface","משטח"],["--sw-surface-3","משטח 3"],["--sw-border","גבול"],["--sw-text","טקסט"],["--sw-text-2","טקסט משני"],["--sw-text-3","טקסט שלישי"],["--sw-accent","כחול"],["--sw-accent-soft","כחול רך"],["--sw-live","חי"],["--sw-offline","מנותק"],["--sw-stale","מיושן"],["--sw-danger","שגיאה"],["--sw-purple","סגול (דלת)"]],Ju=["live","recorded","historic","offline","stale","partial","unknown","forbidden","error"],Xu=["loading","empty","error","forbidden","stale","partial"],Qu=["entrance","lobby","corridor","hall","parking","warehouse","backyard","driveway","night","building","house"],em=["dashboard","building","camera","bell","history","system","search","user","play","pause","back10","forward10","aperture","volume","mic","expand","close","chevron","chevronDown","warning","info","lock","unlock","offline","refresh","layers","floor","plus","minus","fit","door","light","sensor","check","clock","download","pin","more","map","upload","list","target","filter","users","shield","storage","edit","case","rule","link","grid","home","star","calendar","trash","eye","cpu","activity","image","wifi","signal","move","bookmark","route"];let fa=class extends z{render(){return r`
      ...
      <h3>צבעים</h3>
      <div class="swatches">
        ${Yu.map(([e,t])=>r`<div class="swatch"><div class="c" style="background:var(${e})"></div><div class="n"><span>${t}</span><span class="ltr">${e}</span></div></div>`)}
      </div>
      ...
      <div class="scenes">${Qu.map(e=>r`<div><sw-scene kind=${e}></sw-scene><span>${e}</span></div>`)}</div>
      ...
      <div class="row">${Ju.map(e=>r`<sw-badge kind=${e}></sw-badge>`)}</div>

      <h3>ציר זמן, שלבים, קומות איזומטריות</h3>
      <sw-timeline .segments=${ni} .events=${[{minute:614,kind:"person",label:"אדם"},{minute:582,kind:"vehicle",label:"רכב"}]} .cursor=${615}></sw-timeline>
      <div class="row" style="margin-block-start:10px">
        ...
        <sw-floor-iso .rooms=${Ji("f0")} selected></sw-floor-iso>
        <sw-floor-iso .rooms=${Ji("f-1")}></sw-floor-iso>
        <sw-floor-iso empty></sw-floor-iso>
      </div>

      <h3>מצבי מסך</h3>
      <div class="grid">
        ${Xu.map(e=>r`<div class="panel"><sw-state-panel state=${e} actionLabel=${e==="error"?"נסה שוב":""}></sw-state-panel></div>`)}
      </div>

      <h3>אייקונים</h3>
      <div class="icons">${em.map(e=>r`<div class="icon"><sw-icon .name=${e} size=${18}></sw-icon><span class="ltr">${e}</span></div>`)}</div>
    `}};fa.styles=M`
    :host {
      display: block;
...
`):"כל הרכיבים שהתוסף רואה עובדים";return r`<button class="status-a sys ${t.status} ${e?"":"b"}" data-sys-pill data-status=${t.status} title=${a} aria-label=${`מצב המערכת: ${i}`} @click=${()=>window.location.hash="#/system/diagnostics?tab=health"}><i></i>${i}</button>`}renderSysBanner(){const e=this.sys;if(!e||e.status!=="error")return d;const t=e.items.filter(s=>s.status==="error");return r`<div class="sysbanner" role="alert" data-sys-banner><sw-icon name="warning" size=${16}></sw-icon><span>${t.map(s=>s.label).join(" · ")}</span><a href="#/system/diagnostics?tab=health">לבריאות המערכת</a></div>`}onSearchInput(e){const t=e.target.value;if(this.searchQ=t,window.clearTimeout(this.searchTimer),!t.trim()){this.searchResults=[],this.searchOpen=!1;return}this.searchTimer=window.setTimeout(()=>void this.runSearch(t),180)}async runSearch(e){if(!y()){this.searchResults=[],this.searchOpen=!0;return}const t=++this.searchSeq;this.searchBusy=!0;try{const s=await Nh(e,6);if(t!==this.searchSeq)return;this.searchResults=s.results,this.searchIndex=s.results.length?0:-1,this.searchOpen=!0}catch{t===this.searchSeq&&(this.searchResults=[],this.searchOpen=!0)}finally{t===this.searchSeq&&(this.searchBusy=!1)}}onSearchKey(e){if(e.key==="Escape"){this.closeSearch(),e.target.blur();return}if(!this.searchOpen||!this.searchResults.length){e.key==="Enter"&&this.searchQ.trim()&&this.runSearch(this.searchQ);return}if(e.key==="ArrowDown")e.preventDefault(),this.searchIndex=(this.searchIndex+1)%this.searchResults.length;else if(e.key==="ArrowUp")e.preventDefault(),this.searchIndex=(this.searchIndex-1+this.searchResults.length)%this.searchResults.length;else if(e.key==="Enter"){e.preventDefault();const t=this.searchResults[this.searchIndex]??this.searchResults[0];t&&this.openResult(t)}}openResult(e){this.closeSearch();const t=this.renderRoot.querySelector(".search input");t&&(t.value="",t.blur()),this.searchQ="",this.searchResults=[],window.location.hash=`#${e.route}`}closeSearch(){this.searchOpen=!1,this.searchIndex=-1}redirectDemo(e){if(this.enforceKiosk(e))return!0;const t=om(e.path,this.session.mode==="api");return t?(window.location.replace(`#${t}`),!0):!1}get kioskOnly(){const e=(this.session.me?.bindings??[]).filter(t=>t.effect!=="deny");return this.session.mode==="api"&&e.length>0&&e.every(t=>t.role_id==="kiosk")}enforceKiosk(e){return!this.kioskOnly||e.segments[0]==="kiosk"?!1:(window.location.replace("#/kiosk/all"),!0)}get gated(){return this.session.mode==="no_access"||this.session.mode==="unauthenticated"}renderSearch(e){if(this.gated)return d;const t=this.searchOpen&&!!this.searchQ.trim();return r`<span class="searchwrap ${e?"a":""}">
      ...
      <header class="topbar">
        ...
        <sw-button class="bell" variant="ghost" size="sm" iconOnly icon="bell" label=${x("app.notifications")}></sw-button>
        <span class="user-a"><sw-avatar name=${n} size=${34} title=${x("app.account")} aria-label=${x("app.account")}></sw-avatar><span class="who-a"><b>${n}</b><span>${a?.bindings[0]?.role_name??(this.session.mode==="demo"?"מנהל VMS":"ללא שיוך")}</span></span></span>
        <span class="logo-a"><b>smplwise</b><small>VMS</small></span>
      </header>
      ${this.renderSysBanner()}
      <main>
        ${this.renderGate()||r`
          <div class="subnav">${t.length>1&&!s?r`<sw-tabs .items=${t} .active=${Un(this.route)}></sw-tabs>`:d}</div>
          <div class="screen">${this.session.mode==="loading"?d:this.renderScreen()}</div>`}
      </main>
      <nav class="bottom" aria-label="ניווט ראשי">
        ${Gr(this.session.mode==="api",us).map(o=>r`<a class=${ft({active:e===o.id})} href=${o.href}><sw-icon .name=${o.icon} size=${20}></sw-icon>${o.label}</a>`)}
      </nav>
    `}embedded(e=this.route){if(e?.params.get("embed")==="1")return!0;try{return sessionStorage.getItem("sw-embed")==="1"}catch{return!1}}render(){if(this.route?.segments[0]==="kiosk")return r`<main style="block-size:100dvh">${this.renderScreen()}</main>`;if(this.embedded())return r`<main class="embed" style="block-size:100dvh;overflow:auto">${this.renderScreen()}</main>`;if(this.design==="a")return this.renderA();const t=Fn(this.route),s=t?ga(tm[t],this.session.mode==="api",us):[],i=this.route?.segments[3]==="edit"||this.route?.segments[3]==="import";return r`
      <nav class="rail" aria-label="ניווט ראשי">
        <div class="brand">
          <img src="${"./"}brand/smplwise-mark.png" alt="SmplWise" />
          <span class="name">SmplWise</span>
        </div>
        ${Kr.filter(a=>this.session.mode!=="api"||Zn(a.href,us)).map(a=>r`<a class=${ft({item:!0,active:t===a.id})} href=${a.href} title=${a.label} aria-current=${t===a.id?"page":"false"}>
            <sw-icon .name=${a.icon} size=${16}></sw-icon><span>${a.label}</span>
          </a>`)}
        <div class="grow"></div>
        ${this.gated?d:r`<a class=${ft({item:!0,small:!0,active:this.route?.segments[0]==="screens"})} href="#/screens" title="כל המסכים">
          <sw-icon name="list" size=${14}></sw-icon><span>כל המסכים</span>
        </a>
        <a class=${ft({item:!0,small:!0,active:this.route?.segments[0]==="styleguide"})} href="#/styleguide" title=${x("nav.styleguide")}>
          <sw-icon name="layers" size=${14}></sw-icon><span>${x("nav.styleguide")}</span>
        </a>`}
      </nav>
      <header class="topbar">
        ...
        <sw-button class="bell" variant="ghost" size="sm" iconOnly icon="bell" label=${x("app.notifications")}></sw-button>
        <sw-avatar name=${this.session.me?.user.display_name||this.session.me?.user.username||"יוני"} size=${28} title=${x("app.account")} aria-label=${x("app.account")}></sw-avatar>
      </header>
      <main>
        ${this.renderGate()||r`
          <div class="subnav">${s.length>1&&!i?r`<sw-tabs .items=${s} .active=${sm(this.route)}></sw-tabs>`:d}</div>
          <div class="screen">${this.session.mode==="loading"?d:this.renderScreen()}</div>`}
      </main>
      <nav class="bottom" aria-label="ניווט ראשי">
        ${Kr.slice(0,4).map(a=>r`<a class=${ft({active:t===a.id})} href=${a.href}><sw-icon .name=${a.icon} size=${20}></sw-icon>${a.label}</a>`)}
        <a class=${ft({active:t==="settings"||t==="playback"})} href="#/system/diagnostics"><sw-icon name="more" size=${20}></sw-icon>עוד</a>
      </nav>
    `}};Ie.styles=M`
    :host {
      display: grid;
  ...
  `;Ye([c()],Ie.prototype,"route",2);Ye([c()],Ie.prototype,"session",2);Ye([c()],Ie.prototype,"design",2);Ye([c()],Ie.prototype,"sys",2);Ye([c()],Ie.prototype,"searchQ",2);Ye([c()],Ie.prototype,"searchResults",2);Ye([c()],Ie.prototype,"searchOpen",2);Ye([c()],Ie.prototype,"searchIndex",2);Ye([c()],Ie.prototype,"searchBusy",2);Ye([c()],Ie.prototype,"startResolved",2);Ie=Ye([E("sw-app")],Ie);
//# sourceMappingURL=index-C3-JTSdw.js.map
