 ...
 */const Ns=globalThis,Ui=Ns.ShadowRoot&&(Ns.ShadyCSS===void 0||Ns.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,Wi=Symbol(),aa=new WeakMap;let Ja=class{constructor(t,s,i){if(this._$cssResult$=!0,i!==Wi)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=t,this.t=s}get styleSheet(){let t=this.o;const s=this.t;if(Ui&&t===void 0){const i=s!==void 0&&s.length===1;i&&(t=aa.get(s)),t===void 0&&((this.o=t=new CSSStyleSheet).replaceSync(this.cssText),i&&aa.set(s,t))}return t}toString(){return this.cssText}};const Fr=e=>new Ja(typeof e=="string"?e:e+"",void 0,Wi),k=(e,...t)=>{const s=e.length===1?e[0]:t.reduce((i,a,n)=>i+(o=>{if(o._$cssResult$===!0)return o.cssText;if(typeof o=="number")return o;throw Error("Value passed to 'css' function must be a 'css' function result: "+o+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(a)+e[n+1],e[0]);return new Ja(s,e,Wi)},Ur=(e,t)=>{if(Ui)e.adoptedStyleSheets=t.map(s=>s instanceof CSSStyleSheet?s:s.styleSheet);else for(const s of t){const i=document.createElement("style"),a=Ns.litNonce;a!==void 0&&i.setAttribute("nonce",a),i.textContent=s.cssText,e.appendChild(i)}},ra=Ui?e=>e:e=>e instanceof CSSStyleSheet?(t=>{let s="";for(const i of t.cssRules)s+=i.cssText;return Fr(s)})(e):e;/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const{is:Wr,defineProperty:Zr,getOwnPropertyDescriptor:qr,getOwnPropertyNames:Kr,getOwnPropertySymbols:Gr,getPrototypeOf:Yr}=Object,Ys=globalThis,na=Ys.trustedTypes,Jr=na?na.emptyScript:"",Xr=Ys.reactiveElementPolyfillSupport,rs=(e,t)=>e,Vs={toAttribute(e,t){switch(t){case Boolean:e=e?Jr:null;break;case Object:case Array:e=e==null?e:JSON.stringify(e)}return e},fromAttribute(e,t){let s=e;switch(t){case Boolean:s=e!==null;break;case Number:s=e===null?null:Number(e);break;case Object:case Array:try{s=JSON.parse(e)}catch{s=null}}return s}},Zi=(e,t)=>!Wr(e,t),oa={attribute:!0,type:String,converter:Vs,reflect:!1,useDefault:!1,hasChanged:Zi};Symbol.metadata??=Symbol("metadata"),Ys.litPropertyMetadata??=new WeakMap;let Bt=class extends HTMLElement{static addInitializer(t){this._$Ei(),(this.l??=[]).push(t)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(t,s=oa){if(s.state&&(s.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(t)&&((s=Object.create(s)).wrapped=!0),this.elementProperties.set(t,s),!s.noAccessor){const i=Symbol(),a=this.getPropertyDescriptor(t,i,s);a!==void 0&&Zr(this.prototype,t,a)}}static getPropertyDescriptor(t,s,i){const{get:a,set:n}=qr(this.prototype,t)??{get(){return this[s]},set(o){this[s]=o}};return{get:a,set(o){const l=a?.call(this);n?.call(this,o),this.requestUpdate(t,l,i)},configurable:!0,enumerable:!0}}static getPropertyOptions(t){return this.elementProperties.get(t)??oa}static _$Ei(){if(this.hasOwnProperty(rs("elementProperties")))return;const t=Yr(this);t.finalize(),t.l!==void 0&&(this.l=[...t.l]),this.elementProperties=new Map(t.elementProperties)}static finalize(){if(this.hasOwnProperty(rs("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(rs("properties"))){const s=this.properties,i=[...Kr(s),...Gr(s)];for(const a of i)this.createProperty(a,s[a])}const t=this[Symbol.metadata];if(t!==null){const s=litPropertyMetadata.get(t);if(s!==void 0)for(const[i,a]of s)this.elementProperties.set(i,a)}this._$Eh=new Map;for(const[s,i]of this.elementProperties){const a=this._$Eu(s,i);a!==void 0&&this._$Eh.set(a,s)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(t){const s=[];if(Array.isArray(t)){const i=new Set(t.flat(1/0).reverse());for(const a of i)s.unshift(ra(a))}else t!==void 0&&s.push(ra(t));return s}static _$Eu(t,s){const i=s.attribute;return i===!1?void 0:typeof i=="string"?i:typeof t=="string"?t.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise(t=>this.enableUpdating=t),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach(t=>t(this))}addController(t){(this._$EO??=new Set).add(t),this.renderRoot!==void 0&&this.isConnected&&t.hostConnected?.()}removeController(t){this._$EO?.delete(t)}_$E_(){const t=new Map,s=this.constructor.elementProperties;for(const i of s.keys())this.hasOwnProperty(i)&&(t.set(i,this[i]),delete this[i]);t.size>0&&(this._$Ep=t)}createRenderRoot(){const t=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return Ur(t,this.constructor.elementStyles),t}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this._$EO?.forEach(t=>t.hostConnected?.())}enableUpdating(t){}disconnectedCallback(){this._$EO?.forEach(t=>t.hostDisconnected?.())}attributeChangedCallback(t,s,i){this._$AK(t,i)}_$ET(t,s){const i=this.constructor.elementProperties.get(t),a=this.constructor._$Eu(t,i);if(a!==void 0&&i.reflect===!0){const n=(i.converter?.toAttribute!==void 0?i.converter:Vs).toAttribute(s,i.type);this._$Em=t,n==null?this.removeAttribute(a):this.setAttribute(a,n),this._$Em=null}}_$AK(t,s){const i=this.constructor,a=i._$Eh.get(t);if(a!==void 0&&this._$Em!==a){const n=i.getPropertyOptions(a),o=typeof n.converter=="function"?{fromAttribute:n.converter}:n.converter?.fromAttribute!==void 0?n.converter:Vs;this._$Em=a;const l=o.fromAttribute(s,n.type);this[a]=l??this._$Ej?.get(a)??l,this._$Em=null}}requestUpdate(t,s,i,a=!1,n){if(t!==void 0){const o=this.constructor;if(a===!1&&(n=this[t]),i??=o.getPropertyOptions(t),!((i.hasChanged??Zi)(n,s)||i.useDefault&&i.reflect&&n===this._$Ej?.get(t)&&!this.hasAttribute(o._$Eu(t,i))))return;this.C(t,s,i)}this.isUpdatePending===!1&&(this._$ES=this._$EP())}C(t,s,{useDefault:i,reflect:a,wrapped:n},o){i&&!(this._$Ej??=new Map).has(t)&&(this._$Ej.set(t,o??s??this[t]),n!==!0||o!==void 0)||(this._$AL.has(t)||(this.hasUpdated||i||(s=void 0),this._$AL.set(t,s)),a===!0&&this._$Em!==t&&(this._$Eq??=new Set).add(t))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(s){Promise.reject(s)}const t=this.scheduleUpdate();return t!=null&&await t,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),this._$Ep){for(const[a,n]of this._$Ep)this[a]=n;this._$Ep=void 0}const i=this.constructor.elementProperties;if(i.size>0)for(const[a,n]of i){const{wrapped:o}=n,l=this[a];o!==!0||this._$AL.has(a)||l===void 0||this.C(a,void 0,n,l)}}let t=!1;const s=this._$AL;try{t=this.shouldUpdate(s),t?(this.willUpdate(s),this._$EO?.forEach(i=>i.hostUpdate?.()),this.update(s)):this._$EM()}catch(i){throw t=!1,this._$EM(),i}t&&this._$AE(s)}willUpdate(t){}_$AE(t){this._$EO?.forEach(s=>s.hostUpdated?.()),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(t)),this.updated(t)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(t){return!0}update(t){this._$Eq&&=this._$Eq.forEach(s=>this._$ET(s,this[s])),this._$EM()}updated(t){}firstUpdated(t){}};Bt.elementStyles=[],Bt.shadowRootOptions={mode:"open"},Bt[rs("elementProperties")]=new Map,Bt[rs("finalized")]=new Map,Xr?.({ReactiveElement:Bt}),(Ys.reactiveElementVersions??=[]).push("2.1.2");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const qi=globalThis,la=e=>e,js=qi.trustedTypes,da=js?js.createPolicy("lit-html",{createHTML:e=>e}):void 0,Xa="$lit$",ct=`lit$${Math.random().toFixed(9).slice(2)}$`,Qa="?"+ct,Qr=`<${Qa}>`,St=document,fs=()=>St.createComment(""),ws=e=>e===null||typeof e!="object"&&typeof e!="function",Ki=Array.isArray,en=e=>Ki(e)||typeof e?.[Symbol.iterator]=="function",di=`[ 	
\f\r]`,is=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,ca=/-->/g,pa=/>/g,yt=RegExp(`>|${di}(?:([^\\s"'>=/]+)(${di}*=${di}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),ha=/'/g,ua=/"/g,er=/^(?:script|style|textarea|title)$/i,tr=e=>(t,...s)=>({_$litType$:e,strings:t,values:s}),r=tr(1),h=tr(2),Mt=Symbol.for("lit-noChange"),c=Symbol.for("lit-nothing"),ma=new WeakMap,_t=St.createTreeWalker(St,129);function sr(e,t){if(!Ki(e)||!e.hasOwnProperty("raw"))throw Error("invalid template strings array");return da!==void 0?da.createHTML(t):t}const tn=(e,t)=>{const s=e.length-1,i=[];let a,n=t===2?"<svg>":t===3?"<math>":"",o=is;for(let l=0;l<s;l++){const p=e[l];let f,u,v=-1,S=0;for(;S<p.length&&(o.lastIndex=S,u=o.exec(p),u!==null);)S=o.lastIndex,o===is?u[1]==="!--"?o=ca:u[1]!==void 0?o=pa:u[2]!==void 0?(er.test(u[2])&&(a=RegExp("</"+u[2],"g")),o=yt):u[3]!==void 0&&(o=yt):o===yt?u[0]===">"?(o=a??is,v=-1):u[1]===void 0?v=-2:(v=o.lastIndex-u[2].length,f=u[1],o=u[3]===void 0?yt:u[3]==='"'?ua:ha):o===ua||o===ha?o=yt:o===ca||o===pa?o=is:(o=yt,a=void 0);const x=o===yt&&e[l+1].startsWith("/>")?" ":"";n+=o===is?p+Qr:v>=0?(i.push(f),p.slice(0,v)+Xa+p.slice(v)+ct+x):p+ct+(v===-2?l:x)}return[sr(e,n+(e[s]||"<?>")+(t===2?"</svg>":t===3?"</math>":"")),i]};class vs{constructor({strings:t,_$litType$:s},i){let a;this.parts=[];let n=0,o=0;const l=t.length-1,p=this.parts,[f,u]=tn(t,s);if(this.el=vs.createElement(f,i),_t.currentNode=this.el.content,s===2||s===3){const v=this.el.content.firstChild;v.replaceWith(...v.childNodes)}for(;(a=_t.nextNode())!==null&&p.length<l;){if(a.nodeType===1){if(a.hasAttributes())for(const v of a.getAttributeNames())if(v.endsWith(Xa)){const S=u[o++],x=a.getAttribute(v).split(ct),R=/([.?@])?(.*)/.exec(S);p.push({type:1,index:n,name:R[2],strings:x,ctor:R[1]==="."?an:R[1]==="?"?rn:R[1]==="@"?nn:Js}),a.removeAttribute(v)}else v.startsWith(ct)&&(p.push({type:6,index:n}),a.removeAttribute(v));if(er.test(a.tagName)){const v=a.textContent.split(ct),S=v.length-1;if(S>0){a.textContent=js?js.emptyScript:"";for(let x=0;x<S;x++)a.append(v[x],fs()),_t.nextNode(),p.push({type:2,index:++n});a.append(v[S],fs())}}}else if(a.nodeType===8)if(a.data===Qa)p.push({type:2,index:n});else{let v=-1;for(;(v=a.data.indexOf(ct,v+1))!==-1;)p.push({type:7,index:n}),v+=ct.length-1}n++}}static createElement(t,s){const i=St.createElement("template");return i.innerHTML=t,i}}function jt(e,t,s=e,i){if(t===Mt)return t;let a=i!==void 0?s._$Co?.[i]:s._$Cl;const n=ws(t)?void 0:t._$litDirective$;return a?.constructor!==n&&(a?._$AO?.(!1),n===void 0?a=void 0:(a=new n(e),a._$AT(e,s,i)),i!==void 0?(s._$Co??=[])[i]=a:s._$Cl=a),a!==void 0&&(t=jt(e,a._$AS(e,t.values),a,i)),t}class sn{constructor(t,s){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=s}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){const{el:{content:s},parts:i}=this._$AD,a=(t?.creationScope??St).importNode(s,!0);_t.currentNode=a;let n=_t.nextNode(),o=0,l=0,p=i[0];for(;p!==void 0;){if(o===p.index){let f;p.type===2?f=new ks(n,n.nextSibling,this,t):p.type===1?f=new p.ctor(n,p.name,p.strings,this,t):p.type===6&&(f=new on(n,this,t)),this._$AV.push(f),p=i[++l]}o!==p?.index&&(n=_t.nextNode(),o++)}return _t.currentNode=St,a}p(t){let s=0;for(const i of this._$AV)i!==void 0&&(i.strings!==void 0?(i._$AI(t,i,s),s+=i.strings.length-2):i._$AI(t[s])),s++}}class ks{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(t,s,i,a){this.type=2,this._$AH=c,this._$AN=void 0,this._$AA=t,this._$AB=s,this._$AM=i,this.options=a,this._$Cv=a?.isConnected??!0}get parentNode(){let t=this._$AA.parentNode;const s=this._$AM;return s!==void 0&&t?.nodeType===11&&(t=s.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,s=this){t=jt(this,t,s),ws(t)?t===c||t==null||t===""?(this._$AH!==c&&this._$AR(),this._$AH=c):t!==this._$AH&&t!==Mt&&this._(t):t._$litType$!==void 0?this.$(t):t.nodeType!==void 0?this.T(t):en(t)?this.k(t):this._(t)}O(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.O(t))}_(t){this._$AH!==c&&ws(this._$AH)?this._$AA.nextSibling.data=t:this.T(St.createTextNode(t)),this._$AH=t}$(t){const{values:s,_$litType$:i}=t,a=typeof i=="number"?this._$AC(t):(i.el===void 0&&(i.el=vs.createElement(sr(i.h,i.h[0]),this.options)),i);if(this._$AH?._$AD===a)this._$AH.p(s);else{const n=new sn(a,this),o=n.u(this.options);n.p(s),this.T(o),this._$AH=n}}_$AC(t){let s=ma.get(t.strings);return s===void 0&&ma.set(t.strings,s=new vs(t)),s}k(t){Ki(this._$AH)||(this._$AH=[],this._$AR());const s=this._$AH;let i,a=0;for(const n of t)a===s.length?s.push(i=new ks(this.O(fs()),this.O(fs()),this,this.options)):i=s[a],i._$AI(n),a++;a<s.length&&(this._$AR(i&&i._$AB.nextSibling,a),s.length=a)}_$AR(t=this._$AA.nextSibling,s){for(this._$AP?.(!1,!0,s);t!==this._$AB;){const i=la(t).nextSibling;la(t).remove(),t=i}}setConnected(t){this._$AM===void 0&&(this._$Cv=t,this._$AP?.(t))}}class Js{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,s,i,a,n){this.type=1,this._$AH=c,this._$AN=void 0,this.element=t,this.name=s,this._$AM=a,this.options=n,i.length>2||i[0]!==""||i[1]!==""?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=c}_$AI(t,s=this,i,a){const n=this.strings;let o=!1;if(n===void 0)t=jt(this,t,s,0),o=!ws(t)||t!==this._$AH&&t!==Mt,o&&(this._$AH=t);else{const l=t;let p,f;for(t=n[0],p=0;p<n.length-1;p++)f=jt(this,l[i+p],s,p),f===Mt&&(f=this._$AH[p]),o||=!ws(f)||f!==this._$AH[p],f===c?t=c:t!==c&&(t+=(f??"")+n[p+1]),this._$AH[p]=f}o&&!a&&this.j(t)}j(t){t===c?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}}class an extends Js{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===c?void 0:t}}class rn extends Js{constructor(){super(...arguments),this.type=4}j(t){this.element.toggleAttribute(this.name,!!t&&t!==c)}}class nn extends Js{constructor(t,s,i,a,n){super(t,s,i,a,n),this.type=5}_$AI(t,s=this){if((t=jt(this,t,s,0)??c)===Mt)return;const i=this._$AH,a=t===c&&i!==c||t.capture!==i.capture||t.once!==i.once||t.passive!==i.passive,n=t!==c&&(i===c||a);a&&this.element.removeEventListener(this.name,this,i),n&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,t):this._$AH.handleEvent(t)}}class on{constructor(t,s,i){this.element=t,this.type=6,this._$AN=void 0,this._$AM=s,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(t){jt(this,t)}}const ln=qi.litHtmlPolyfillSupport;ln?.(vs,ks),(qi.litHtmlVersions??=[]).push("3.3.3");const dn=(e,t,s)=>{const i=s?.renderBefore??t;let a=i._$litPart$;if(a===void 0){const n=s?.renderBefore??null;i._$litPart$=a=new ks(t.insertBefore(fs(),n),n,void 0,s??{})}return a._$AI(e),a};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Gi=globalThis;let $=class extends Bt{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){const t=super.createRenderRoot();return this.renderOptions.renderBefore??=t.firstChild,t}update(t){const s=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=dn(s,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return Mt}};$._$litElement$=!0,$.finalized=!0,Gi.litElementHydrateSupport?.({LitElement:$});const cn=Gi.litElementPolyfillSupport;cn?.({LitElement:$});(Gi.litElementVersions??=[]).push("4.2.2");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const _=e=>(t,s)=>{s!==void 0?s.addInitializer(()=>{customElements.define(e,t)}):customElements.define(e,t)};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const pn={attribute:!0,type:String,converter:Vs,reflect:!1,hasChanged:Zi},hn=(e=pn,t,s)=>{const{kind:i,metadata:a}=s;let n=globalThis.litPropertyMetadata.get(a);if(n===void 0&&globalThis.litPropertyMetadata.set(a,n=new Map),i==="setter"&&((e=Object.create(e)).wrapped=!0),n.set(s.name,e),i==="accessor"){const{name:o}=s;return{set(l){const p=t.get.call(this);t.set.call(this,l),this.requestUpdate(o,p,e,!0,l)},init(l){return l!==void 0&&this.C(o,void 0,e,l),l}}}if(i==="setter"){const{name:o}=s;return function(l){const p=this[o];t.call(this,l),this.requestUpdate(o,p,e,!0,l)}}throw Error("Unsupported decorator location: "+i)};function m(e){return(t,s)=>typeof s=="object"?hn(e,t,s):((i,a,n)=>{const o=a.hasOwnProperty(n);return a.constructor.createProperty(n,i),o?Object.getOwnPropertyDescriptor(a,n):void 0})(e,t,s)}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 */const ot=fn(class extends wn{constructor(e){if(super(e),e.type!==mn.ATTRIBUTE||e.name!=="class"||e.strings?.length>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(e){return" "+Object.keys(e).filter(t=>e[t]).join(" ")+" "}update(e,[t]){if(this.st===void 0){this.st=new Set,e.strings!==void 0&&(this.nt=new Set(e.strings.join(" ").split(/\s/).filter(i=>i!=="")));for(const i in t)t[i]&&!this.nt?.has(i)&&this.st.add(i);return this.render(t)}const s=e.element.classList;for(const i of this.st)i in t||(s.remove(i),this.st.delete(i));for(const i in t){const a=!!t[i];a===this.st.has(i)||this.nt?.has(i)||(a?(s.add(i),this.st.add(i)):(s.remove(i),this.st.delete(i)))}return Mt}});var vn=Object.defineProperty,gn=Object.getOwnPropertyDescriptor,Xs=(e,t,s,i)=>{for(var a=i>1?void 0:i?gn(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&vn(t,s,a),a};const fa={live:h`<circle cx="12" cy="12" r="3"/><path d="M6.3 6.3a8 8 0 0 0 0 11.4M17.7 6.3a8 8 0 0 1 0 11.4M3.5 3.5a12 12 0 0 0 0 17M20.5 3.5a12 12 0 0 1 0 17"/>`,explore:h`<path d="M3 6.5 9 4l6 2.5 6-2.5v13.5L15 20l-6-2.5L3 20z"/><path d="M9 4v13.5M15 6.5V20"/>`,investigate:h`<circle cx="11" cy="11" r="6.5"/><path d="m20 20-4.3-4.3M11 8v3l2 1.5"/>`,system:h`<circle cx="12" cy="12" r="3"/><path d="M19.4 15a1.7 1.7 0 0 0 .3 1.8l.1.1a2 2 0 1 1-2.8 2.8l-.1-.1a1.7 1.7 0 0 0-1.8-.3 1.7 1.7 0 0 0-1 1.5V21a2 2 0 1 1-4 0v-.1a1.7 1.7 0 0 0-1.1-1.5 1.7 1.7 0 0 0-1.8.3l-.1.1a2 2 0 1 1-2.8-2.8l.1-.1a1.7 1.7 0 0 0 .3-1.8 1.7 1.7 0 0 0-1.5-1H3a2 2 0 1 1 0-4h.1a1.7 1.7 0 0 0 1.5-1.1 1.7 1.7 0 0 0-.3-1.8l-.1-.1a2 2 0 1 1 2.8-2.8l.1.1a1.7 1.7 0 0 0 1.8.3H9a1.7 1.7 0 0 0 1-1.5V3a2 2 0 1 1 4 0v.1a1.7 1.7 0 0 0 1 1.5 1.7 1.7 0 0 0 1.8-.3l.1-.1a2 2 0 1 1 2.8 2.8l-.1.1a1.7 1.7 0 0 0-.3 1.8V9a1.7 1.7 0 0 0 1.5 1H21a2 2 0 1 1 0 4h-.1a1.7 1.7 0 0 0-1.5 1z"/>`,camera:h`<path d="M3 8.5A1.5 1.5 0 0 1 4.5 7H8l1.5-2h5L16 7h3.5A1.5 1.5 0 0 1 21 8.5v9a1.5 1.5 0 0 1-1.5 1.5h-15A1.5 1.5 0 0 1 3 17.5z"/><circle cx="12" cy="13" r="3.5"/>`,search:h`<circle cx="11" cy="11" r="6.5"/><path d="m20 20-4.3-4.3"/>`,bell:h`<path d="M6 16V11a6 6 0 0 1 12 0v5l1.5 2h-15z"/><path d="M10 20a2 2 0 0 0 4 0"/>`,user:h`<circle cx="12" cy="8" r="4"/><path d="M4 21a8 8 0 0 1 16 0"/>`,play:h`<path d="M7 5v14l11-7z"/>`,expand:h`<path d="M15 4h5v5M9 20H4v-5M20 4l-6 6M4 20l6-6"/>`,close:h`<path d="M6 6l12 12M18 6 6 18"/>`,chevron:h`<path d="m9 6 6 6-6 6"/>`,warning:h`<path d="M12 3 2.5 20h19z"/><path d="M12 9v5M12 17h.01"/>`,info:h`<circle cx="12" cy="12" r="9"/><path d="M12 11v5M12 8h.01"/>`,lock:h`<rect x="5" y="11" width="14" height="10" rx="2"/><path d="M8 11V7a4 4 0 0 1 8 0v4"/>`,unlock:h`<rect x="5" y="11" width="14" height="10" rx="2"/><path d="M8 11V7a4 4 0 0 1 7.5-2"/>`,offline:h`<path d="M2 8.5a15 15 0 0 1 20 0M5.5 12a10 10 0 0 1 13 0M9 15.5a5 5 0 0 1 6 0"/><path d="M12 19h.01"/><path d="M3 3l18 18"/>`,refresh:h`<path d="M20 12a8 8 0 1 1-2.3-5.7"/><path d="M20 4v5h-5"/>`,layers:h`<path d="m12 3 9 5-9 5-9-5z"/><path d="m3 13 9 5 9-5M3 17.5l9 5 9-5"/>`,floor:h`<path d="M4 6h16M4 12h16M4 18h16"/><path d="M8 3v18"/>`,plus:h`<path d="M12 5v14M5 12h14"/>`,minus:h`<path d="M5 12h14"/>`,fit:h`<path d="M4 9V4h5M20 9V4h-5M4 15v5h5M20 15v5h-5"/>`,door:h`<rect x="6" y="3" width="12" height="18" rx="1"/><path d="M14 12h.01"/>`,light:h`<path d="M9 18h6M10 21h4"/><path d="M12 3a6 6 0 0 0-3.5 10.9c.8.6 1.5 1.6 1.5 2.6h4c0-1 .7-2 1.5-2.6A6 6 0 0 0 12 3z"/>`,sensor:h`<circle cx="12" cy="12" r="2"/><path d="M7.8 7.8a6 6 0 0 0 0 8.4M16.2 7.8a6 6 0 0 1 0 8.4M4.9 4.9a10 10 0 0 0 0 14.2M19.1 4.9a10 10 0 0 1 0 14.2"/>`,check:h`<path d="m5 12 5 5 9-10"/>`,clock:h`<circle cx="12" cy="12" r="9"/><path d="M12 7v5l3 2"/>`,download:h`<path d="M12 4v11M7 10l5 5 5-5M4 20h16"/>`,pin:h`<path d="M9 4h6l-1 6 3 3v2H7v-2l3-3z"/><path d="M12 15v6"/>`,more:h`<circle cx="6" cy="12" r="1.3"/><circle cx="12" cy="12" r="1.3"/><circle cx="18" cy="12" r="1.3"/>`,building:h`<rect x="4" y="3" width="16" height="18" rx="1"/><path d="M9 7h2M13 7h2M9 11h2M13 11h2M9 15h2M13 15h2M10 21v-3h4v3"/>`,map:h`<path d="M3 6.5 9 4l6 2.5 6-2.5v13.5L15 20l-6-2.5L3 20z"/>`,upload:h`<path d="M12 16V5M7 10l5-5 5 5M4 20h16"/>`,list:h`<path d="M8 6h13M8 12h13M8 18h13M3 6h.01M3 12h.01M3 18h.01"/>`,history:h`<path d="M3 12a9 9 0 1 0 3-6.7"/><path d="M3 4v5h5M12 8v4l3 2"/>`,target:h`<circle cx="12" cy="12" r="8"/><circle cx="12" cy="12" r="3"/><path d="M12 2v4M12 18v4M2 12h4M18 12h4"/>`,filter:h`<path d="M4 5h16l-6 8v6l-4-2v-4z"/>`,users:h`<circle cx="9" cy="8" r="3.5"/><path d="M2.5 20a6.5 6.5 0 0 1 13 0"/><circle cx="17" cy="9" r="2.5"/><path d="M15.5 14.5A5 5 0 0 1 21.5 20"/>`,shield:h`<path d="M12 3 4 6v6c0 4.5 3.4 7.7 8 9 4.6-1.3 8-4.5 8-9V6z"/><path d="m9 12 2 2 4-4"/>`,storage:h`<rect x="3" y="4" width="18" height="6" rx="1.5"/><rect x="3" y="14" width="18" height="6" rx="1.5"/><path d="M7 7h.01M7 17h.01"/>`,edit:h`<path d="M4 20h4l10.5-10.5a2 2 0 0 0 0-2.8l-1.2-1.2a2 2 0 0 0-2.8 0L4 16z"/><path d="m13 7 4 4"/>`,pause:h`<path d="M8 5v14M16 5v14"/>`,skip:h`<path d="M5 5v14l8-7zM15 5h2v14h-2z"/>`,case:h`<rect x="3" y="7" width="18" height="13" rx="2"/><path d="M8 7V5a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2M3 12h18"/>`,rule:h`<path d="M4 6h10M4 12h16M4 18h7"/><circle cx="18" cy="6" r="2"/><circle cx="15" cy="18" r="2"/>`,link:h`<path d="M10 14a4 4 0 0 0 5.7 0l3-3a4 4 0 0 0-5.7-5.7l-1 1"/><path d="M14 10a4 4 0 0 0-5.7 0l-3 3a4 4 0 0 0 5.7 5.7l1-1"/>`,grid:h`<rect x="3" y="3" width="7" height="7" rx="1.5"/><rect x="14" y="3" width="7" height="7" rx="1.5"/><rect x="3" y="14" width="7" height="7" rx="1.5"/><rect x="14" y="14" width="7" height="7" rx="1.5"/>`,dashboard:h`<rect x="3" y="3" width="8" height="10" rx="1.5"/><rect x="13" y="3" width="8" height="6" rx="1.5"/><rect x="13" y="11" width="8" height="10" rx="1.5"/><rect x="3" y="15" width="8" height="6" rx="1.5"/>`,home:h`<path d="M3 11 12 4l9 7"/><path d="M5 10v10h14V10"/><path d="M10 20v-6h4v6"/>`,star:h`<path d="m12 3 2.8 5.7 6.2.9-4.5 4.4 1 6.2-5.5-2.9L6.5 20.2l1-6.2L3 9.6l6.2-.9z"/>`,aperture:h`<circle cx="12" cy="12" r="9"/><path d="m14.3 4.5-5 8.6M20.7 9.5H10.8M18.4 17.5l-5-8.6M9.7 19.5l5-8.6M3.3 14.5h9.9M5.6 6.5l5 8.6"/>`,volume:h`<path d="M4 9.5v5h3.5L12 18.5v-13L7.5 9.5z"/><path d="M15.5 8.5a5 5 0 0 1 0 7M18.5 5.5a9 9 0 0 1 0 13"/>`,mic:h`<rect x="9" y="3" width="6" height="11" rx="3"/><path d="M5.5 11a6.5 6.5 0 0 0 13 0M12 17.5V21M9 21h6"/>`,back10:h`<path d="M4 12a8 8 0 1 0 2.3-5.7"/><path d="M4 4v5h5"/><path d="M10.5 15.5V10l-1.5 1"/><rect x="13.5" y="10" width="3.5" height="5.5" rx="1.7"/>`,forward10:h`<path d="M20 12a8 8 0 1 1-2.3-5.7"/><path d="M20 4v5h-5"/><path d="M10.5 15.5V10l-1.5 1"/><rect x="13.5" y="10" width="3.5" height="5.5" rx="1.7"/>`,chevronDown:h`<path d="m6 9 6 6 6-6"/>`,stairs:h`<path d="M3 20h4v-4h4v-4h4V8h5"/>`,elevator:h`<rect x="4" y="3" width="16" height="18" rx="1.5"/><path d="M12 3v18M8 10l1.5-2 1.5 2M14.5 14l1.5 2 1.5-2"/>`,menu:h`<path d="M4 7h16M4 12h16M4 17h16"/>`,calendar:h`<rect x="3" y="5" width="18" height="16" rx="2"/><path d="M3 10h18M8 3v4M16 3v4"/>`,trash:h`<path d="M4 7h16M9 7V4h6v3M6 7l1 13h10l1-13"/>`,eye:h`<path d="M2 12s3.5-6 10-6 10 6 10 6-3.5 6-10 6S2 12 2 12z"/><circle cx="12" cy="12" r="3"/>`,cpu:h`<rect x="6" y="6" width="12" height="12" rx="2"/><rect x="9" y="9" width="6" height="6"/><path d="M9 2v4M15 2v4M9 18v4M15 18v4M2 9h4M2 15h4M18 9h4M18 15h4"/>`,activity:h`<path d="M3 12h4l3-8 4 16 3-8h4"/>`,image:h`<rect x="3" y="4" width="18" height="16" rx="2"/><circle cx="8.5" cy="9.5" r="1.5"/><path d="m21 16-5-5-9 9"/>`,wifi:h`<path d="M2 8.5a15 15 0 0 1 20 0M5.5 12a10 10 0 0 1 13 0M9 15.5a5 5 0 0 1 6 0"/><path d="M12 19h.01"/>`,signal:h`<path d="M4 18v-3M9 18v-7M14 18V7M19 18V4"/>`,move:h`<path d="M12 3v18M3 12h18M8 7l4-4 4 4M8 17l4 4 4-4M7 8l-4 4 4 4M17 8l4 4-4 4"/>`,bookmark:h`<path d="M6 3h12v18l-6-4-6 4z"/>`,route:h`<circle cx="6" cy="18" r="2.5"/><circle cx="18" cy="6" r="2.5"/><path d="M8 17c5-1 3-9 8-10"/>`,logout:h`<path d="M10 4H5v16h5M14 8l4 4-4 4M18 12H9"/>`};let Ft=class extends ${constructor(){super(...arguments),this.name="info",this.size=20,this.flip=!1}render(){this.style.setProperty("--sw-icon-size",`${this.size}px`);const e=this.name==="chevron";return r`<svg viewBox="0 0 24 24" aria-hidden="true" ?data-dir=${e}>${fa[this.name]??fa.info}</svg>`}};Ft.styles=k`
  ...
  `;Xs([m()],Ft.prototype,"name",2);Xs([m({type:Number})],Ft.prototype,"size",2);Xs([m({type:Boolean,reflect:!0})],Ft.prototype,"flip",2);Ft=Xs([_("sw-icon")],Ft);var bn=Object.defineProperty,yn=Object.getOwnPropertyDescriptor,at=(e,t,s,i)=>{for(var a=i>1?void 0:i?yn(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&bn(t,s,a),a};let Re=class extends ${constructor(){super(...arguments),this.variant="secondary",this.size="md",this.disabled=!1,this.iconOnly=!1,this.round=!1,this.label="",this.type="button"}render(){return r`
  ...
  `;Qs([m({reflect:!0})],Ut.prototype,"kind",2);Qs([m()],Ut.prototype,"label",2);Qs([m({type:Boolean,reflect:!0})],Ut.prototype,"onImage",2);Ut=Qs([_("sw-badge")],Ut);var zn=Object.defineProperty,Sn=Object.getOwnPropertyDescriptor,_s=(e,t,s,i)=>{for(var a=i>1?void 0:i?Sn(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&zn(t,s,a),a};let At=class extends ${constructor(){super(...arguments),this.items=[],this.active="",this.segmented=!1,this.underline=!1}choose(e){this.active=e.id,this.dispatchEvent(new CustomEvent("change",{detail:{id:e.id},bubbles:!0,composed:!0}))}render(){return r`${this.items.map(e=>e.href?r`<a href=${e.href} class=${e.id===this.active?"on":""} aria-current=${e.id===this.active?"page":"false"}>${e.label}${e.count!==void 0?r`<span class="count">(${e.count})</span>`:""}</a>`:r`<button type="button" class=${e.id===this.active?"on":""} aria-pressed=${e.id===this.active} @click=${()=>this.choose(e)}>${e.label}${e.count!==void 0?r`<span class="count">(${e.count})</span>`:""}</button>`)}`}};At.styles=k`
    :host {
      display: inline-flex;
      gap: 2px;
      overflow-x: auto;
  ...
  `;_s([m({attribute:!1})],At.prototype,"items",2);_s([m()],At.prototype,"active",2);_s([m({type:Boolean,reflect:!0})],At.prototype,"segmented",2);_s([m({type:Boolean,reflect:!0})],At.prototype,"underline",2);At=_s([_("sw-tabs")],At);var Mn=Object.defineProperty,An=Object.getOwnPropertyDescriptor,Yi=(e,t,s,i)=>{for(var a=i>1?void 0:i?An(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&Mn(t,s,a),a};let gs=class extends ${constructor(){super(...arguments),this.name="",this.size=32}render(){this.style.setProperty("--sz",`${this.size}px`);const e=this.name.trim().split(/\s+/),t=e.length>1?e[0][0]+e[1][0]:this.name.slice(0,2);return r`${t}`}};gs.styles=k`
    :host {
      display: inline-grid;
      place-items: center;
  ...
  `;Yi([m()],gs.prototype,"name",2);Yi([m({type:Number})],gs.prototype,"size",2);gs=Yi([_("sw-avatar")],gs);var Pn=Object.defineProperty,In=Object.getOwnPropertyDescriptor,zs=(e,t,s,i)=>{for(var a=i>1?void 0:i?In(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&Pn(t,s,a),a};let Pt=class extends ${constructor(){super(...arguments),this.selected=!1,this.dot=""}render(){return r`
  ...
  `;zs([m({type:Boolean,reflect:!0})],Pt.prototype,"selected",2);zs([m()],Pt.prototype,"icon",2);zs([m({type:Number})],Pt.prototype,"count",2);zs([m()],Pt.prototype,"dot",2);Pt=zs([_("sw-chip")],Pt);var En=Object.defineProperty,Cn=Object.getOwnPropertyDescriptor,ei=(e,t,s,i)=>{for(var a=i>1?void 0:i?Cn(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&En(t,s,a),a};let Wt=class extends ${constructor(){super(...arguments),this.open=!1,this.heading="",this.subheading=""}close(){this.open=!1,this.dispatchEvent(new CustomEvent("close",{bubbles:!0,composed:!0}))}render(){return r`
  ...
  `;Jt([m()],pt.prototype,"heading",2);Jt([m({type:Number})],pt.prototype,"x",2);Jt([m({type:Number})],pt.prototype,"y",2);Jt([m({type:Number})],pt.prototype,"stageWidth",2);Jt([m({type:Number})],pt.prototype,"stageHeight",2);pt=Jt([_("sw-popover")],pt);var On=Object.defineProperty,Rn=Object.getOwnPropertyDescriptor,ti=(e,t,s,i)=>{for(var a=i>1?void 0:i?Rn(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&On(t,s,a),a};let Zt=class extends ${constructor(){super(...arguments),this.label="",this.hint="",this.inline=!1}render(){return r`
  ...
  `;ti([m()],Zt.prototype,"label",2);ti([m()],Zt.prototype,"hint",2);ti([m({type:Boolean,reflect:!0})],Zt.prototype,"inline",2);Zt=ti([_("sw-field")],Zt);var Nn=Object.defineProperty,Ln=Object.getOwnPropertyDescriptor,ir=(e,t,s,i)=>{for(var a=i>1?void 0:i?Ln(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&Nn(t,s,a),a};let Bn=0,Fs=class extends ${constructor(){super(...arguments),this.kind="lobby",this.uid=`sc${Bn+=1}`}grad(e,t,s=!0){const i=`${e}-${this.uid}`;return h`<linearGradient id=${i} x1="0" y1="0" x2=${s?0:1} y2=${s?1:0}>${t.map(([a,n])=>h`<stop offset=${a} stop-color=${n} />`)}</linearGradient>`}url(e){return`url(#${e}-${this.uid})`}vignette(){const e=`vig-${this.uid}`;return h`<defs><radialGradient id=${e} cx="50%" cy="45%" r="72%"><stop offset="0.55" stop-color="#000" stop-opacity="0" /><stop offset="1" stop-color="#000" stop-opacity="0.38" /></radialGradient></defs><rect width="320" height="180" fill=${`url(#${e})`} />`}entrance(){return h`
  ...
  `;me([m()],ne.prototype,"cameraId",2);me([m()],ne.prototype,"profile",2);me([m()],ne.prototype,"mode",2);me([m()],ne.prototype,"poster",2);me([m({type:Boolean})],ne.prototype,"active",2);me([m({type:Boolean,reflect:!0})],ne.prototype,"compact",2);me([m()],ne.prototype,"wsUrl",2);me([m({type:Boolean})],ne.prototype,"retry",2);me([m({type:Boolean})],ne.prototype,"recorded",2);me([d()],ne.prototype,"status",2);me([d()],ne.prototype,"transport",2);me([d()],ne.prototype,"error",2);me([d()],ne.prototype,"muted",2);me([Yt("video")],ne.prototype,"video",2);ne=me([_("sw-live-player")],ne);var io=Object.defineProperty,ao=Object.getOwnPropertyDescriptor,fe=(e,t,s,i)=>{for(var a=i>1?void 0:i?ao(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&io(t,s,a),a};let oe=class extends ${constructor(){super(...arguments),this.name="",this.meta="",this.state="unknown",this.scene="lobby",this.selected=!1,this.compact=!1,this.dark=!1,this.noDemo=!1,this.stamp="",this.poster="",this.cameraId="",this.live=!1,this.profile="sub",this.transport="auto"}offMessage(){return this.state==="forbidden"?"אין הרשאת צפייה":this.state==="offline"?"המצלמה מנותקת":"מצב לא ידוע"}render(){if(this.state==="offline"||this.state==="forbidden"||this.state==="unknown")return r`<div class="off">
  ...
  `;fe([m()],oe.prototype,"name",2);fe([m()],oe.prototype,"meta",2);fe([m({reflect:!0})],oe.prototype,"state",2);fe([m({reflect:!0})],oe.prototype,"scene",2);fe([m({type:Boolean,reflect:!0})],oe.prototype,"selected",2);fe([m({type:Boolean,reflect:!0})],oe.prototype,"compact",2);fe([m({type:Boolean,reflect:!0})],oe.prototype,"dark",2);fe([m({type:Boolean,reflect:!0})],oe.prototype,"noDemo",2);fe([m()],oe.prototype,"stamp",2);fe([m()],oe.prototype,"poster",2);fe([m()],oe.prototype,"cameraId",2);fe([m({type:Boolean})],oe.prototype,"live",2);fe([m()],oe.prototype,"profile",2);fe([m()],oe.prototype,"transport",2);oe=fe([_("sw-camera-tile")],oe);var ro=Object.defineProperty,no=Object.getOwnPropertyDescriptor,Qt=(e,t,s,i)=>{for(var a=i>1?void 0:i?no(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&ro(t,s,a),a};const oo={loading:{icon:"clock",title:()=>y("states.loading"),hint:()=>"",tone:"neutral"},empty:{icon:"map",title:()=>y("states.empty"),hint:()=>"",tone:"neutral"},error:{icon:"warning",title:()=>y("states.error"),hint:()=>y("states.errorHint"),tone:"danger"},forbidden:{icon:"lock",title:()=>y("states.forbidden"),hint:()=>y("states.forbiddenHint"),tone:"forbidden"},stale:{icon:"offline",title:()=>y("states.stale"),hint:()=>y("states.staleHint"),tone:"stale"},partial:{icon:"info",title:()=>y("states.partial"),hint:()=>"",tone:"stale"}};let ht=class extends ${constructor(){super(...arguments),this.state="empty",this.heading="",this.hint="",this.actionLabel="",this.compact=!1}render(){const e=oo[this.state],t=this.hint||e.hint();return r`
  ...
  `;Qt([m({reflect:!0})],ht.prototype,"state",2);Qt([m()],ht.prototype,"heading",2);Qt([m()],ht.prototype,"hint",2);Qt([m()],ht.prototype,"actionLabel",2);Qt([m({type:Boolean,reflect:!0})],ht.prototype,"compact",2);ht=Qt([_("sw-state-panel")],ht);var lo=Object.defineProperty,co=Object.getOwnPropertyDescriptor,ii=(e,t,s,i)=>{for(var a=i>1?void 0:i?co(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&lo(t,s,a),a};let qt=class extends ${constructor(){super(...arguments),this.open=!1,this.heading="",this.subheading="",this.onKey=e=>{e.key==="Escape"&&this.open&&this.close()}}close(){this.open=!1,this.dispatchEvent(new CustomEvent("close",{bubbles:!0,composed:!0}))}connectedCallback(){super.connectedCallback(),window.addEventListener("keydown",this.onKey)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("keydown",this.onKey)}render(){return r`<div class="backdrop" @click=${e=>e.target===e.currentTarget&&this.close()}>
  ...
  `;ii([m({type:Boolean,reflect:!0})],qt.prototype,"open",2);ii([m()],qt.prototype,"heading",2);ii([m()],qt.prototype,"subheading",2);qt=ii([_("sw-dialog")],qt);var po=Object.defineProperty,ho=Object.getOwnPropertyDescriptor,j=(e,t,s,i)=>{for(var a=i>1?void 0:i?ho(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&po(t,s,a),a};const ci=.2,pi=6,wa={live:"var(--sw-accent)",recorded:"var(--sw-accent)",historic:"var(--sw-accent)",offline:"var(--sw-offline)",stale:"var(--sw-stale)",unknown:"var(--sw-unknown)",forbidden:"var(--sw-forbidden)",error:"var(--sw-danger)",neutral:"var(--sw-surface)",partial:"var(--sw-stale)"},uo={camera:h`<path d="M-7 -4.5A1.5 1.5 0 0 1 -5.5 -6H-2l1.5-2h5L6 -6h1.5A1.5 1.5 0 0 1 9 -4.5v9A1.5 1.5 0 0 1 7.5 6h-13A1.5 1.5 0 0 1 -7 4.5z" transform="translate(-1 0) scale(0.9)"/><circle cx="-1" cy="0" r="3"/>`,lock:h`<rect x="-6" y="-2" width="12" height="9" rx="2"/><path d="M-3.5 -2v-3a3.5 3.5 0 0 1 7 0v3"/>`,light:h`<path d="M-3 6h6M-2 8.5h4"/><path d="M0 -8a5 5 0 0 0-3 9c.7.5 1.2 1.3 1.2 2.2h3.6c0-.9.5-1.7 1.2-2.2A5 5 0 0 0 0 -8z"/>`,binary_sensor:h`<circle cx="0" cy="0" r="2"/><path d="M-4.5 -4.5a6.4 6.4 0 0 0 0 9M4.5 -4.5a6.4 6.4 0 0 1 0 9"/>`};function mo(e){let t=0,s=0,i=0;for(let a=0;a<e.length;a++){const n=e[a],o=e[(a+1)%e.length],l=n.x*o.y-o.x*n.y;t+=l,s+=(n.x+o.x)*l,i+=(n.y+o.y)*l}if(Math.abs(t)<1e-12){const a=e.length||1;return{x:e.reduce((n,o)=>n+o.x,0)/a,y:e.reduce((n,o)=>n+o.y,0)/a}}return{x:s/(3*t),y:i/(3*t)}}let C=class extends ${constructor(){super(...arguments),this.planWidth=1e3,this.planHeight=700,this.plan=null,this.markers=[],this.selectedId=null,this.selectedIds=[],this.dimEntities=!1,this.alwaysLabel=!1,this.imageUrl=null,this.editable=!1,this.placing=!1,this.coneRadius=140,this.zones=[],this.selectedZoneId=null,this.zoneLabels=!0,this.draftPoints=[],this.boxSelect=!1,this.box=null,this.boxStart=null,this.scale=1,this.tx=0,this.ty=0,this.hoverId=null,this.dragging=null,this.orienting=null,this.shaping=null,this.zoneDraft=null,this.lastVertexPress=null,this.pointers=new Map,this.lastPan=null,this.lastPinchDist=0,this.dragMoved=!1,this.fitted=!1,this.minScale=ci,this.onWheel=e=>{e.preventDefault();const t=this.getBoundingClientRect();this.zoomBy(e.deltaY<0?1.15:1/1.15,e.clientX-t.left,e.clientY-t.top)},this.onMarkerPointerDown=(e,t)=>{if(!this.editable||t.button!==0)return;t.stopPropagation(),t.preventDefault(),this.dragging={id:e.id,x:e.x,y:e.y},this.viewport.setPointerCapture(t.pointerId);const s=a=>{const n=this.getBoundingClientRect(),o=this.toPlan(a.clientX-n.left,a.clientY-n.top);this.dragging={id:e.id,x:o.x,y:o.y}},i=a=>{this.viewport.removeEventListener("pointermove",s),this.viewport.removeEventListener("pointerup",i),this.viewport.removeEventListener("pointercancel",i);const n=this.getBoundingClientRect(),o=this.toPlan(a.clientX-n.left,a.clientY-n.top),l=Math.abs(o.x-e.x)>5e-4||Math.abs(o.y-e.y)>5e-4;this.dragging=null,l?this.dispatchEvent(new CustomEvent("marker-move",{detail:{id:e.id,x:o.x,y:o.y},bubbles:!0,composed:!0})):this.select(e,a),this.dragMoved=!0,setTimeout(()=>this.dragMoved=!1,0)};this.viewport.addEventListener("pointermove",s),this.viewport.addEventListener("pointerup",i),this.viewport.addEventListener("pointercancel",i)},this.onPointerDown=e=>{if(this.pointers.set(e.pointerId,{x:e.clientX,y:e.clientY}),this.dragMoved=!1,this.pointers.size===1){if(this.boxSelect&&e.button===0&&!e.shiftKey&&!this.editable&&!this.placing){const t=this.getBoundingClientRect();this.boxStart={x:e.clientX-t.left,y:e.clientY-t.top},this.lastPan=null;return}this.lastPan={x:e.clientX,y:e.clientY},this.viewport.classList.add("dragging")}else this.pointers.size===2&&(this.lastPinchDist=this.pinchDistance(),this.lastPan=null,this.boxStart=null,this.box=null)},this.onPointerMove=e=>{if(this.pointers.has(e.pointerId)){if(this.pointers.set(e.pointerId,{x:e.clientX,y:e.clientY}),this.pointers.size===2){const t=this.pinchDistance();if(this.lastPinchDist>0){const[s,i]=[...this.pointers.values()],a=this.getBoundingClientRect();this.zoomBy(t/this.lastPinchDist,(s.x+i.x)/2-a.left,(s.y+i.y)/2-a.top)}this.lastPinchDist=t,this.dragMoved=!0;return}if(this.boxStart){const t=this.getBoundingClientRect(),s=e.clientX-t.left,i=e.clientY-t.top;!this.dragMoved&&Math.abs(s-this.boxStart.x)+Math.abs(i-this.boxStart.y)>3&&(this.dragMoved=!0,this.viewport.hasPointerCapture(e.pointerId)||this.viewport.setPointerCapture(e.pointerId)),this.dragMoved&&(this.box={x0:Math.min(this.boxStart.x,s),y0:Math.min(this.boxStart.y,i),x1:Math.max(this.boxStart.x,s),y1:Math.max(this.boxStart.y,i)});return}if(this.lastPan){const t=e.clientX-this.lastPan.x,s=e.clientY-this.lastPan.y;!this.dragMoved&&Math.abs(t)+Math.abs(s)>2&&(this.dragMoved=!0,this.viewport.hasPointerCapture(e.pointerId)||this.viewport.setPointerCapture(e.pointerId)),this.tx+=t,this.ty+=s,this.lastPan={x:e.clientX,y:e.clientY}}}},this.onPointerUp=e=>{if(this.pointers.delete(e.pointerId),this.boxStart&&this.pointers.size===0){const t=this.box;if(this.boxStart=null,this.box=null,t&&t.x1-t.x0>=4&&t.y1-t.y0>=4){const s=this.markers.filter(i=>{const a=this.toScreen(i.x,i.y);return a.x>=t.x0&&a.x<=t.x1&&a.y>=t.y0&&a.y<=t.y1}).map(i=>i.id);this.dispatchEvent(new CustomEvent("box-select",{detail:{ids:s},bubbles:!0,composed:!0}))}}if(this.pointers.size===0)this.lastPan=null,this.viewport.classList.remove("dragging");else if(this.pointers.size===1){const[t]=[...this.pointers.values()];this.lastPan={x:t.x,y:t.y}}},this.onBackgroundClick=e=>{if(!this.dragMoved){if(this.placing){const t=this.getBoundingClientRect(),s=this.toPlan(e.clientX-t.left,e.clientY-t.top);this.dispatchEvent(new CustomEvent("plan-click",{detail:{x:+s.x.toFixed(4),y:+s.y.toFixed(4)},bubbles:!0,composed:!0}));return}this.dispatchEvent(new CustomEvent("marker-select",{detail:{id:null},bubbles:!0,composed:!0}))}},this.onHandlePointerDown=(e,t,s)=>{if(!this.editable||s.button!==0)return;s.stopPropagation(),s.preventDefault();const i=this.getBoundingClientRect(),a=e.rotation??0,n=e.fov??90,o=t==="left"?a+n/2:a-n/2;this.orienting={id:e.id,rotation:a,fov:n},this.viewport.setPointerCapture(s.pointerId);const l=u=>{const v=this.bearingTo(e,u.clientX-i.left,u.clientY-i.top);if(t==="dir")return{rotation:Math.round(v),fov:n};let S=t==="left"?o-v:v-o;S=(S%360+360)%360;const x=Math.max(10,Math.min(180,Math.round(S))),R=t==="left"?o-x/2:o+x/2;return{rotation:Math.round((R%360+360)%360),fov:x}},p=u=>{this.orienting={id:e.id,...l(u)}},f=u=>{this.viewport.removeEventListener("pointermove",p),this.viewport.removeEventListener("pointerup",f),this.viewport.removeEventListener("pointercancel",f);const v=l(u);this.orienting=null,this.dragMoved=!0,setTimeout(()=>this.dragMoved=!1,0),(v.rotation!==a||v.fov!==n)&&this.dispatchEvent(new CustomEvent("marker-orient",{detail:{id:e.id,...v},bubbles:!0,composed:!0}))};this.viewport.addEventListener("pointermove",p),this.viewport.addEventListener("pointerup",f),this.viewport.addEventListener("pointercancel",f)},this.onRangePointerDown=(e,t)=>{if(!this.editable||t.button!==0)return;t.stopPropagation(),t.preventDefault();const s=this.getBoundingClientRect(),i=e.radius??this.coneRadius/this.planWidth;this.shaping={id:e.id,radius:i},this.viewport.setPointerCapture(t.pointerId);const a=l=>{const p=this.toScreen(e.x,e.y),f=Math.hypot(l.clientX-s.left-p.x,l.clientY-s.top-p.y)/this.scale;return+Math.max(.02,Math.min(1,f/this.planWidth)).toFixed(4)},n=l=>this.shaping={id:e.id,radius:a(l)},o=l=>{this.viewport.removeEventListener("pointermove",n),this.viewport.removeEventListener("pointerup",o),this.viewport.removeEventListener("pointercancel",o);const p=a(l);this.shaping=null,this.dragMoved=!0,setTimeout(()=>this.dragMoved=!1,0),p!==i&&this.dispatchEvent(new CustomEvent("marker-coverage",{detail:{id:e.id,radius:p},bubbles:!0,composed:!0}))};this.viewport.addEventListener("pointermove",n),this.viewport.addEventListener("pointerup",o),this.viewport.addEventListener("pointercancel",o)},this.onCoverageVertexDown=(e,t,s)=>{if(!this.editable||s.button!==0||!e.polygon)return;s.stopPropagation(),s.preventDefault();const i=Date.now();if(this.lastVertexPress&&this.lastVertexPress.id===e.id&&this.lastVertexPress.index===t&&i-this.lastVertexPress.at<450){this.lastVertexPress=null,this.editPolygon(e,{remove:t});return}this.lastVertexPress={id:e.id,index:t,at:i};const a=this.getBoundingClientRect(),n=e.polygon.map(u=>({...u}));this.shaping={id:e.id,polygon:n},this.viewport.setPointerCapture(s.pointerId);let o=!1;const l=u=>{const v=this.toPlan(u.clientX-a.left,u.clientY-a.top),S=n.map(x=>({...x}));return S[t]={x:+Math.max(0,Math.min(1,v.x)).toFixed(4),y:+Math.max(0,Math.min(1,v.y)).toFixed(4)},S},p=u=>{o=!0,this.shaping={id:e.id,polygon:l(u)}},f=u=>{this.viewport.removeEventListener("pointermove",p),this.viewport.removeEventListener("pointerup",f),this.viewport.removeEventListener("pointercancel",f);const v=l(u);this.shaping=null,this.dragMoved=!0,setTimeout(()=>this.dragMoved=!1,0),o&&this.dispatchEvent(new CustomEvent("marker-coverage",{detail:{id:e.id,polygon:v},bubbles:!0,composed:!0}))};this.viewport.addEventListener("pointermove",p),this.viewport.addEventListener("pointerup",f),this.viewport.addEventListener("pointercancel",f)}}connectedCallback(){super.connectedCallback(),this.resizeObserver=new ResizeObserver(()=>{this.fitted||this.fit()}),this.resizeObserver.observe(this)}disconnectedCallback(){super.disconnectedCallback(),this.resizeObserver?.disconnect()}updated(e){(e.has("planWidth")||e.has("planHeight"))&&(this.fitted=!1,this.fit()),(e.has("scale")||e.has("tx")||e.has("ty"))&&this.dispatchEvent(new CustomEvent("view-change",{bubbles:!0,composed:!0}))}get zoom(){return this.scale}focusMarker(e){const t=this.renderRoot.querySelector(`g.marker[data-id="${CSS.escape(e)}"]`);return t?.focus(),!!t}toScreen(e,t){return{x:this.tx+e*this.planWidth*this.scale,y:this.ty+t*this.planHeight*this.scale}}fit(){const e=this.clientWidth,t=this.clientHeight;if(!e||!t||!this.planWidth||!this.planHeight)return;const s=24,i=Math.min((e-s*2)/this.planWidth,(t-s*2)/this.planHeight);this.minScale=Math.min(ci,i),this.scale=Math.max(this.minScale,Math.min(pi,i)),this.tx=(e-this.planWidth*this.scale)/2,this.ty=(t-this.planHeight*this.scale)/2,this.fitted=!0}zoomToBox(e,t,s,i,a=48,n=0){const o=this.clientWidth,l=this.clientHeight;if(!o||!l||!this.planWidth||!this.planHeight)return;const p=Math.max(1e-6,s-e)*this.planWidth,f=Math.max(1e-6,i-t)*this.planHeight,u=Math.min((o-48)/this.planWidth,(l-48)/this.planHeight),v=n>0?Math.min(2.5,Math.max(u*n,u)):2.5,S=Math.max(ci,Math.min(pi,Math.min((o-a*2)/p,(l-a*2)/f,v)));this.scale=S,this.tx=o/2-(e+s)/2*this.planWidth*S,this.ty=l/2-(t+i)/2*this.planHeight*S,this.fitted=!0}zoomBy(e,t,s){const i=this.clientWidth,a=this.clientHeight,n=t??i/2,o=s??a/2,l=Math.max(this.minScale,Math.min(pi,this.scale*e)),p=l/this.scale;this.tx=n-(n-this.tx)*p,this.ty=o-(o-this.ty)*p,this.scale=l,this.fitted=!0}toPlan(e,t){return{x:Math.min(1,Math.max(0,(e-this.tx)/this.scale/this.planWidth)),y:Math.min(1,Math.max(0,(t-this.ty)/this.scale/this.planHeight))}}pinchDistance(){const[e,t]=[...this.pointers.values()];return Math.hypot(e.x-t.x,e.y-t.y)}select(e,t){if(this.dragMoved)return;t.stopPropagation();const s=this.toScreen(e.x,e.y),i={id:e.id,sx:s.x,sy:s.y};this.dispatchEvent(new CustomEvent("marker-select",{detail:i,bubbles:!0,composed:!0}))}selectZone(e,t){this.dragMoved||this.placing||(t.stopPropagation(),this.dispatchEvent(new CustomEvent("zone-select",{detail:{id:e.id},bubbles:!0,composed:!0})))}onVertexPointerDown(e,t,s,i=!1){if(!this.editable||s.button!==0)return;if(s.stopPropagation(),s.preventDefault(),!i){const f=this.lastVertexPress,u=performance.now();if(f&&f.id===e.id&&f.index===t&&u-f.at<450){this.lastVertexPress=null,this.removeVertex(e,t,s);return}this.lastVertexPress={id:e.id,index:t,at:u}}const a=this.getBoundingClientRect();let n=e.polygon.map(f=>({x:f.x,y:f.y})),o=t;if(i){const f=n[t],u=n[(t+1)%n.length];n.splice(t+1,0,{x:+((f.x+u.x)/2).toFixed(4),y:+((f.y+u.y)/2).toFixed(4)}),o=t+1}this.zoneDraft={id:e.id,polygon:n},this.viewport.setPointerCapture(s.pointerId);const l=f=>{const u=this.toPlan(f.clientX-a.left,f.clientY-a.top);n=n.map((v,S)=>S===o?{x:+u.x.toFixed(4),y:+u.y.toFixed(4)}:v),this.zoneDraft={id:e.id,polygon:n}},p=()=>{this.viewport.removeEventListener("pointermove",l),this.viewport.removeEventListener("pointerup",p),this.viewport.removeEventListener("pointercancel",p);const f=i||n.some((u,v)=>u.x!==e.polygon[v].x||u.y!==e.polygon[v].y);this.zoneDraft=null,this.dragMoved=!0,setTimeout(()=>this.dragMoved=!1,0),f&&this.dispatchEvent(new CustomEvent("zone-edit",{detail:{id:e.id,polygon:n},bubbles:!0,composed:!0}))};this.viewport.addEventListener("pointermove",l),this.viewport.addEventListener("pointerup",p),this.viewport.addEventListener("pointercancel",p)}removeVertex(e,t,s){if(s.stopPropagation(),!this.editable||e.polygon.length<=3)return;const i=e.polygon.filter((a,n)=>n!==t);this.dispatchEvent(new CustomEvent("zone-edit",{detail:{id:e.id,polygon:i},bubbles:!0,composed:!0}))}renderZoneHandles(e,t){const s=1/this.scale,i=this.planWidth,a=this.planHeight;return h`<g class="zone-handles">
    ...
    </g>`}renderZone(e){if(e.polygon.length<3)return c;const t=1/this.scale,s=this.zoneDraft?.id===e.id?this.zoneDraft.polygon:e.polygon,i=s.map(S=>`${(S.x*this.planWidth).toFixed(1)},${(S.y*this.planHeight).toFixed(1)}`).join(" "),a=mo(s),n=this.selectedZoneId===e.id,o=Math.max(36,e.name.length*7+18),l=s.map(S=>S.x),p=s.map(S=>S.y),f=(Math.max(...l)-Math.min(...l))*this.planWidth*this.scale,u=(Math.max(...p)-Math.min(...p))*this.planHeight*this.scale,v=n||e.candidate||f>=o+12&&u>=30;return h`
    ...
    `}renderHandles(e,t,s){const i=this.radiusOf(e),a=1/this.scale,n=(u,v)=>({x:Math.cos(C.rad(u))*v,y:Math.sin(C.rad(u))*v}),o=n(t-s/2,i),l=n(t+s/2,i),p=n(t,i*.72),f=7*a;return h`
    ...
    `}static rad(e){return(e-90)*Math.PI/180}fovPath(e,t,s){const i=C.rad(e-t/2),a=C.rad(e+t/2),n=Math.cos(i)*s,o=Math.sin(i)*s,l=Math.cos(a)*s,p=Math.sin(a)*s;return`M0 0 L${n.toFixed(1)} ${o.toFixed(1)} A${s} ${s} 0 ${t>180?1:0} 1 ${l.toFixed(1)} ${p.toFixed(1)} Z`}renderMarker(e){const t=this.dragging?.id===e.id?this.dragging:e,s=this.orienting?.id===e.id?this.orienting:null,i=s?s.rotation:e.rotation??0,a=s?s.fov:e.fov,n=t.x*this.planWidth,o=t.y*this.planHeight,l=1/this.scale,p=e.kind==="camera",f=wa[e.state]??wa.neutral,u=this.selectedId===e.id||this.selectedIds.includes(e.id),v=this.alwaysLabel||u||this.hoverId===e.id,S=Math.max(44,e.label.length*6.5+16),x=this.dimEntities&&!p,R=p?13:11;return h`
      <g class="marker ${e.state} ${u?"selected":""} ${x?"dimmed":""} ${this.editable?"editable":""}"
         ...
         @pointerdown=${Y=>this.onMarkerPointerDown(e,Y)}
         @click=${Y=>this.editable?Y.stopPropagation():this.select(e,Y)}
         @keydown=${Y=>(Y.key==="Enter"||Y.key===" ")&&this.select(e,Y)}>
        ${p&&a&&e.state!=="forbidden"?(()=>{const Y=this.polygonPath(e);return Y?h`<polygon class="fov ${e.state==="offline"?"off":""}" data-cov-polygon points=${Y} />`:h`<path class="fov ${e.state==="offline"?"off":""}" d=${this.fovPath(i,a,this.radiusOf(e))} />`})():c}
        ...
        <g transform="scale(${l})">
          ...
          <circle class="pin" r=${R} fill=${f} />
          <g class="icon" transform="scale(${p?.85:.75})">${uo[e.kind]}</g>
          ...
          ${v?h`<g transform="translate(0 ${R+14})">
  ...
  `;j([m({type:Number})],C.prototype,"planWidth",2);j([m({type:Number})],C.prototype,"planHeight",2);j([m({attribute:!1})],C.prototype,"plan",2);j([m({attribute:!1})],C.prototype,"markers",2);j([m()],C.prototype,"selectedId",2);j([m({attribute:!1})],C.prototype,"selectedIds",2);j([m({type:Boolean})],C.prototype,"dimEntities",2);j([m({type:Boolean})],C.prototype,"alwaysLabel",2);j([m()],C.prototype,"imageUrl",2);j([m({type:Boolean})],C.prototype,"editable",2);j([m({type:Boolean})],C.prototype,"placing",2);j([m({type:Number})],C.prototype,"coneRadius",2);j([m({attribute:!1})],C.prototype,"zones",2);j([m()],C.prototype,"selectedZoneId",2);j([m({type:Boolean})],C.prototype,"zoneLabels",2);j([m({attribute:!1})],C.prototype,"draftPoints",2);j([m({type:Boolean})],C.prototype,"boxSelect",2);j([d()],C.prototype,"box",2);j([d()],C.prototype,"scale",2);j([d()],C.prototype,"tx",2);j([d()],C.prototype,"ty",2);j([d()],C.prototype,"hoverId",2);j([d()],C.prototype,"dragging",2);j([d()],C.prototype,"orienting",2);j([d()],C.prototype,"shaping",2);j([d()],C.prototype,"zoneDraft",2);j([Yt(".viewport")],C.prototype,"viewport",2);C=j([_("sw-plan-canvas")],C);const va={name:"אתר הדגמה",building:"מבנה א"},ut=[{id:"f0",name:"קומה 0",hasPlan:!0,planWidth:1200,planHeight:800,cameraCount:6,entityCount:4},{id:"f-1",name:"קומה 1-",hasPlan:!0,planWidth:900,planHeight:1100,cameraCount:3,entityCount:1},{id:"f-2",name:"קומה 2-",hasPlan:!1,planWidth:0,planHeight:0,cameraCount:2,entityCount:0}],ns=[{id:"cam-1",name:"כניסה ראשית",floorId:"f0",x:.09,y:.52,rotation:20,fov:70,state:"live",source:"NVR ערוץ 1"},{id:"cam-2",name:"לובי",floorId:"f0",x:.34,y:.3,rotation:120,fov:80,state:"live",source:"NVR ערוץ 2"},{id:"cam-3",name:"מסדרון מזרחי",floorId:"f0",x:.62,y:.55,rotation:180,fov:60,state:"offline",source:"NVR ערוץ 3"},{id:"cam-4",name:"אולם",floorId:"f0",x:.82,y:.22,rotation:210,fov:90,state:"live",source:"NVR ערוץ 4"},{id:"cam-5",name:"חדר מדרגות",floorId:"f0",x:.9,y:.8,rotation:250,fov:60,state:"stale",source:"NVR ערוץ 5"},{id:"cam-6",name:"חניה",floorId:"f0",x:.4,y:.86,rotation:300,fov:75,state:"forbidden",source:"NVR ערוץ 6"},{id:"cam-7",name:"מחסן",floorId:"f-1",x:.3,y:.3,rotation:45,fov:70,state:"live",source:"NVR ערוץ 7"},{id:"cam-8",name:"חדר מכונות",floorId:"f-1",x:.7,y:.6,rotation:200,fov:70,state:"live",source:"NVR ערוץ 8"},{id:"cam-9",name:"מקלט",floorId:"f-1",x:.5,y:.85,rotation:270,fov:70,state:"offline",source:"NVR ערוץ 9"}],Ls=[{id:"lock.main_door",name:"דלת כניסה",floorId:"f0",x:.05,y:.4,domain:"lock",state:"locked",stateLabelKey:"entity.locked",controllable:!1,lastChanged:"לפני 12 דק׳"},{id:"light.lobby",name:"תאורת לובי",floorId:"f0",x:.3,y:.42,domain:"light",state:"on",stateLabelKey:"entity.on",controllable:!0,lastChanged:"לפני שעה"},{id:"binary_sensor.hall_motion",name:"תנועה באולם",floorId:"f0",x:.7,y:.3,domain:"binary_sensor",state:"off",stateLabelKey:"entity.off",controllable:!1,lastChanged:"לפני 3 דק׳"},{id:"light.corridor",name:"תאורת מסדרון",floorId:"f0",x:.55,y:.66,domain:"light",state:"off",stateLabelKey:"entity.off",controllable:!0,lastChanged:"אתמול 22:10"},{id:"lock.shelter",name:"דלת מקלט",floorId:"f-1",x:.46,y:.9,domain:"lock",state:"locked",stateLabelKey:"entity.locked",controllable:!1,lastChanged:"לפני 2 שעות"}],nr={f0:[{x:40,y:40,w:300,h:260,label:"לובי",kind:"lobby"},{x:40,y:340,w:300,h:220,label:"משרדים",kind:"office"},{x:40,y:600,w:460,h:160,label:"חניה מקורה",kind:"parking"},{x:380,y:40,w:420,h:300,label:"אולם",kind:"hall"},{x:840,y:40,w:320,h:300,label:"אולם ב",kind:"meeting"},{x:380,y:380,w:300,h:180,label:"חדר ישיבות",kind:"meeting"},{x:720,y:380,w:440,h:180,label:"מסדרון מזרחי",kind:"corridor"},{x:540,y:600,w:620,h:160,label:"שירותים ומדרגות",kind:"stairs"}],"f-1":[{x:40,y:40,w:400,h:400,label:"מחסן",kind:"storage"},{x:480,y:40,w:380,h:400,label:"חדר מכונות",kind:"machines"},{x:40,y:480,w:820,h:200,label:"מסדרון",kind:"corridor"},{x:40,y:720,w:820,h:340,label:"מקלט",kind:"shelter"}]};function zi(e){const t=nr[e],s=ut.find(i=>i.id===e);return!t||!s?.hasPlan?[]:t.map(i=>({x:i.x/s.planWidth,y:i.y/s.planHeight,w:i.w/s.planWidth,h:i.h/s.planHeight}))}const re="var(--sw-map-furniture)",J="var(--sw-map-furniture-line)";function fo(e){const t=e.x+e.w/2,s=e.y+e.h/2;switch(e.kind){case"lobby":return h`<rect x=${e.x+30} y=${e.y+e.h-70} width="130" height="30" rx="4" fill=${re} stroke=${J} /><rect x=${e.x+170} y=${e.y+30} width="110" height="36" rx="10" fill=${re} stroke=${J} /><circle cx=${e.x+22} cy=${e.y+22} r="10" fill="#dfe9d9" stroke="#b9cfae" /><circle cx=${e.x+e.w-22} cy=${e.y+22} r="10" fill="#dfe9d9" stroke="#b9cfae" />`;case"office":return h`${[0,1].map(i=>[0,1,2].map(a=>h`<rect x=${e.x+30+a*92} y=${e.y+36+i*92} width="56" height="28" rx="2" fill=${re} stroke=${J} /><circle cx=${e.x+58+a*92} cy=${e.y+78+i*92} r="8" fill=${re} stroke=${J} />`))}`;case"parking":return h`${[0,1,2,3,4,5,6,7].map(i=>h`<line x1=${e.x+30+i*56} y1=${e.y+20} x2=${e.x+30+i*56} y2=${e.y+e.h-20} stroke=${J} stroke-dasharray="6 6" />`)}${[1,3,4].map(i=>h`<rect x=${e.x+42+i*56} y=${e.y+36} width="30" height="70" rx="8" fill="#d5dce8" stroke=${J} />`)}`;case"hall":return h`${[0,1,2,3].map(i=>[0,1,2,3,4,5].map(a=>h`<rect x=${e.x+50+a*56} y=${e.y+60+i*52} width="26" height="16" rx="3" fill=${re} stroke=${J} />`))}<rect x=${e.x+40} y=${e.y+20} width=${e.w-80} height="14" rx="2" fill=${re} stroke=${J} />`;case"meeting":return h`<rect x=${t-80} y=${s-26} width="160" height="52" rx="12" fill=${re} stroke=${J} />${[0,1,2].map(i=>h`<circle cx=${t-50+i*50} cy=${s-44} r="9" fill=${re} stroke=${J} /><circle cx=${t-50+i*50} cy=${s+44} r="9" fill=${re} stroke=${J} />`)}`;case"corridor":return h`<rect x=${e.x+30} y=${s-8} width="90" height="16" rx="3" fill=${re} stroke=${J} />`;case"stairs":return h`<rect x=${e.x+e.w-130} y=${e.y+30} width="100" height="100" fill=${re} stroke=${J} />${[1,2,3,4,5,6,7].map(i=>h`<line x1=${e.x+e.w-130} y1=${e.y+30+i*12.5} x2=${e.x+e.w-30} y2=${e.y+30+i*12.5} stroke=${J} />`)}${[0,1,2,3].map(i=>h`<rect x=${e.x+30+i*46} y=${e.y+30} width="36" height="46" fill=${re} stroke=${J} />`)}`;case"storage":return h`${[0,1,2,3].map(i=>h`<rect x=${e.x+40+i*92} y=${e.y+40} width="30" height=${e.h-80} fill=${re} stroke=${J} />`)}`;case"machines":return h`${[0,1,2].map(i=>h`<rect x=${e.x+40} y=${e.y+40+i*120} width="110" height="72" rx="4" fill=${re} stroke=${J} /><circle cx=${e.x+240} cy=${e.y+76+i*120} r="26" fill=${re} stroke=${J} />`)}`;case"shelter":return h`${[0,1,2,3].map(i=>h`<rect x=${e.x+60} y=${e.y+50+i*70} width="220" height="22" rx="3" fill=${re} stroke=${J} /><rect x=${e.x+e.w-280} y=${e.y+50+i*70} width="220" height="22" rx="3" fill=${re} stroke=${J} />`)}`;default:return""}}function or(e){const t=nr[e],s=ut.find(i=>i.id===e);return!t||!s?null:h`
    ...
    ${t.map(i=>h`
      ...
      `)}
  `}const Si=[{id:"site-a",name:"אתר הדגמה",address:"רחוב הדוגמה 1",buildings:2,cameras:10,online:9,alerts:2,health:"stale"},{id:"site-b",name:"סניף צפון",address:"שדרות הדגמה 20",buildings:1,cameras:6,online:6,alerts:0,health:"live"},{id:"site-c",name:"מחסן לוגיסטי",address:"אזור תעשייה",buildings:1,cameras:4,online:3,alerts:1,health:"offline"}],wo=[{id:"bld-a",siteId:"site-a",name:"מבנה א",floors:[{id:"f0",name:"קומה 0",cameras:6,entities:4,hasPlan:!0},{id:"f-1",name:"קומה 1-",cameras:3,entities:1,hasPlan:!0},{id:"f-2",name:"קומה 2-",cameras:2,entities:0,hasPlan:!1}]},{id:"bld-b",siteId:"site-a",name:"מבנה ב",floors:[{id:"b-f0",name:"קרקע",cameras:1,entities:2,hasPlan:!1}]}],q=[{id:"cam-1",name:"כניסה ראשית",floor:"קומה 0",state:"live",stream:"sub",fps:25,bitrateKbps:3072,firmware:"V5.8.10",lastEvent:"לפני 2 דק׳",recording:"continuous",ptz:!1,audio:!1},{id:"cam-2",name:"לובי",floor:"קומה 0",state:"live",stream:"sub",fps:25,bitrateKbps:3072,firmware:"V5.8.10",lastEvent:"לפני 5 דק׳",recording:"motion",ptz:!1,audio:!0},{id:"cam-3",name:"מסדרון מזרחי",floor:"קומה 0",state:"offline",stream:"sub",fps:null,bitrateKbps:null,firmware:"V5.8.10",lastEvent:"לפני שעה",recording:"unknown",ptz:!1,audio:!1},{id:"cam-4",name:"אולם",floor:"קומה 0",state:"live",stream:"main",fps:25,bitrateKbps:5120,firmware:"V5.8.10",lastEvent:"לפני 12 דק׳",recording:"continuous",ptz:!0,audio:!1},{id:"cam-5",name:"חדר מדרגות",floor:"קומה 0",state:"stale",stream:"sub",fps:20,bitrateKbps:2048,firmware:"V5.8.9",lastEvent:"לפני 40 דק׳",recording:"continuous",ptz:!1,audio:!1},{id:"cam-6",name:"חניה מקורה",floor:"קומה 0",state:"forbidden",stream:"sub",fps:null,bitrateKbps:null,firmware:"—",lastEvent:"—",recording:"unknown",ptz:!1,audio:!1},{id:"cam-7",name:"מחסן",floor:"קומה 1-",state:"live",stream:"sub",fps:25,bitrateKbps:3072,firmware:"V5.8.10",lastEvent:"לפני 3 שעות",recording:"motion",ptz:!1,audio:!1},{id:"cam-8",name:"חדר מכונות",floor:"קומה 1-",state:"live",stream:"sub",fps:25,bitrateKbps:3072,firmware:"V5.8.10",lastEvent:"אתמול",recording:"continuous",ptz:!1,audio:!1},{id:"cam-9",name:"מקלט",floor:"קומה 1-",state:"offline",stream:"sub",fps:null,bitrateKbps:null,firmware:"V5.8.10",lastEvent:"לפני יומיים",recording:"unknown",ptz:!1,audio:!1},{id:"cam-10",name:"חצר אחורית",floor:"חוץ",state:"live",stream:"sub",fps:25,bitrateKbps:4096,firmware:"V5.8.10",lastEvent:"לפני 8 דק׳",recording:"continuous",ptz:!0,audio:!0}],We={"cam-1":"entrance","cam-2":"lobby","cam-3":"corridor","cam-4":"hall","cam-5":"corridor","cam-6":"parking","cam-7":"warehouse","cam-8":"warehouse","cam-9":"night","cam-10":"backyard"},Mi={person:"זיהוי אדם",vehicle:"זיהוי רכב",motion:"תנועה",line:"חציית קו",offline:"מצלמה מנותקת",door:"דלת נפתחה"},Xe=[{id:"ev-1",time:"היום 10:14",minuteOfDay:614,type:"person",title:"אדם זוהה",camera:"כניסה ראשית",floor:"קומה 0",source:"NVR",acked:!1,severity:"alert"},{id:"ev-2",time:"היום 09:42",minuteOfDay:582,type:"vehicle",title:"רכב זוהה",camera:"חצר אחורית",floor:"חוץ",source:"NVR",acked:!1,severity:"info"},{id:"ev-3",time:"היום 08:31",minuteOfDay:511,type:"motion",title:"תנועה",camera:"מחסן",floor:"קומה 1-",source:"NVR",acked:!0,severity:"info"},{id:"ev-4",time:"היום 08:12",minuteOfDay:492,type:"door",title:"דלת כניסה נפתחה",camera:"כניסה ראשית",floor:"קומה 0",source:"HA",acked:!0,severity:"info"},{id:"ev-5",time:"היום 07:55",minuteOfDay:475,type:"offline",title:"מסדרון מזרחי מנותק",camera:"מסדרון מזרחי",floor:"קומה 0",source:"NVR",acked:!1,severity:"critical"},{id:"ev-6",time:"היום 06:43",minuteOfDay:403,type:"line",title:"חציית קו",camera:"חניה מקורה",floor:"קומה 0",source:"NVR",acked:!0,severity:"alert"},{id:"ev-7",time:"אתמול 23:10",minuteOfDay:1390,type:"person",title:"אדם זוהה",camera:"לובי",floor:"קומה 0",source:"NVR",acked:!0,severity:"info"}],Us=[{startMin:0,endMin:190,kind:"continuous"},{startMin:205,endMin:460,kind:"continuous"},{startMin:470,endMin:474,kind:"motion"},{startMin:480,endMin:486,kind:"motion"},{startMin:492,endMin:640,kind:"continuous"},{startMin:660,endMin:1439,kind:"continuous"}],Ai=[{id:"u-1",name:"יוני",haUser:"joni",active:!0,lastSync:"לפני 20 שנ׳",groups:["מנהלי מערכת"],bindings:[{role:"מנהל מערכת VMS",scope:"כל ההתקנה"}],haAdmin:!0},{id:"u-2",name:"דנה",haUser:"dana",active:!0,lastSync:"לפני 20 שנ׳",groups:["עורכי קומה 2"],bindings:[{role:"עורך מפות",scope:"מבנה א · קומה 2"}],haAdmin:!1},{id:"u-3",name:"יוסי",haUser:"yossi",active:!0,lastSync:"לפני 20 שנ׳",groups:["מנהלי מבנה א"],bindings:[{role:"מנהל אתר/מבנה",scope:"מבנה א"}],haAdmin:!1},{id:"u-4",name:"codex",haUser:"codex",active:!0,lastSync:"לפני 20 שנ׳",groups:[],bindings:[],haAdmin:!1},{id:"u-5",name:"רון",haUser:"ron",active:!1,lastSync:"לפני 3 ימים",groups:["צופים"],bindings:[{role:"צופה",scope:"אתר הדגמה"}],haAdmin:!1}],lr=[{id:"g-1",name:"מנהלי מערכת",members:1,bindings:["מנהל מערכת VMS · כל ההתקנה"]},{id:"g-2",name:"עורכי קומה 2",members:1,bindings:["עורך מפות · מבנה א · קומה 2"]},{id:"g-3",name:"מנהלי מבנה א",members:1,bindings:["מנהל אתר/מבנה · מבנה א"]},{id:"g-4",name:"צופים",members:1,bindings:["צופה · אתר הדגמה"]}],dr=[{id:"viewer",name:"צופה",allowed:"מפה, מצב ישויות מורשה, שידור חי",denied:"היסטוריה, עריכה, ייצוא, שליטה"},{id:"operator",name:"מפעיל",allowed:"צפייה, Playback, סקירת אירועים וסימון טיפול",denied:"עריכת מפות, תפקידים, ייצוא, פעולות פיזיות"},{id:"editor",name:"עורך מפות ותצוגות",allowed:"צפייה, יבוא/עריכה/פרסום מפות, מיקומים ותצוגות",denied:"Playback, ייצוא, משתמשים, סודות, שליטה"},{id:"site_admin",name:"מנהל אתר / מבנה / קומה",allowed:"מפעיל + עורך, הגדרות תוכן מקומיות",denied:"הגדרות מערכת, תפקידים, סודות, כתיבה ל־NVR"},{id:"system_admin",name:"מנהל מערכת VMS",allowed:"הגדרות מוצר, מקורות, מדיניות, קבוצות ושיוכים",denied:"ניהול HA, שליטה פיזית, ייצוא ראיות ללא grant"}],cr=[{time:"10:24",user:"יוני",action:"צפייה חיה",resource:"כניסה ראשית",decision:"הותר",role:"מנהל מערכת · כל ההתקנה"},{time:"10:18",user:"דנה",action:"פרסום תוכנית",resource:"מבנה א · קומה 2",decision:"הותר",role:"עורך מפות · קומה 2"},{time:"10:11",user:"דנה",action:"עריכת תוכנית",resource:"מבנה א · קומה 3",decision:"נחסם: מחוץ להיקף",role:"עורך מפות · קומה 2"},{time:"09:55",user:"יוסי",action:"ייצוא קטע",resource:"לובי 09:10–09:20",decision:"נחסם: אין הרשאת ייצוא",role:"מנהל מבנה · מבנה א"},{time:"09:43",user:"codex",action:"כניסה דרך Ingress",resource:"—",decision:"הותר, ללא שיוך",role:"—"},{time:"09:30",user:"יוני",action:"הפעלת תאורה",resource:"light.lobby",decision:"הותר (HA אישר)",role:"מנהל מערכת"},{time:"08:12",user:"מערכת",action:"סנכרון משתמשים",resource:"HA bridge",decision:"5 משתמשים, 0 שינויים",role:"—"}],pr=[{id:"job-1",title:"ייצוא: כניסה ראשית 09:10–09:25",status:"הושלם",progress:100,size:"182 MB",hash:"sha256 ✓"},{id:"job-2",title:"ייצוא: לובי 23:00–23:40",status:"בתהליך",progress:62,size:"—",hash:"—"},{id:"job-3",title:"תמונות מקדימות: קומה 0",status:"ממתין",progress:0,size:"—",hash:"—"},{id:"job-4",title:"ייצוא: חצר אחורית 02:00–04:00",status:"נכשל: פער בהקלטה",progress:35,size:"—",hash:"—"}],Pi=[{id:"case-1",title:"כניסה לא מורשית — 13.09",status:"פתוח",owner:"יוני",clips:3,notes:2,preserved:2,missing:1},{id:"case-2",title:"נזק לרכב בחניה",status:"בבדיקה",owner:"יוסי",clips:2,notes:1,preserved:2,missing:0},{id:"case-3",title:"דלת מקלט פתוחה בלילה",status:"סגור",owner:"יוני",clips:1,notes:3,preserved:1,missing:0}],Ii=[{id:"r-1",name:"אדם בלילה",trigger:"זיהוי אדם",scope:"חוץ · 22:00–06:00",action:"התראה + פתיחת מצלמות",enabled:!0,last:"אתמול 23:10"},{id:"r-2",name:"רכב באזור מוגבל",trigger:"זיהוי רכב",scope:"חניה מקורה",action:"התראה",enabled:!0,last:"היום 09:42"},{id:"r-3",name:"דלת נשארה פתוחה",trigger:"דלת > 60 שנ׳",scope:"כל הדלתות",action:"התראה + הקלטה",enabled:!0,last:"—"},{id:"r-4",name:"מצלמה מנותקת",trigger:"ניתוק",scope:"כל האתר",action:"התראה מיידית",enabled:!1,last:"היום 07:55"}],hr=[{name:"NVR (הקלטה)",state:"live",detail:"10/10 ערוצים, דיסק תקין"},{name:"go2rtc (מדיה)",state:"live",detail:"גרסה ‎1.9.x‎ · 4 זרמים פעילים"},{name:"גשר Home Assistant",state:"stale",detail:"סנכרון אחרון לפני 4 דק׳"},{name:"מסד נתונים",state:"live",detail:"WAL · גיבוי אחרון אתמול 02:00"},{name:"תור עבודות",state:"partial",detail:"1 בתהליך · 1 נכשל"}],vo=["live","explore","investigate","system"];function Kt(e=window.location.hash){const t=e.replace(/^#/,"")||"/explore/floors/f0",[s,i=""]=t.split("?"),a=s.startsWith("/")?s:`/${s}`,n=a.split("/").filter(Boolean),o=n[0];return{path:a,segments:n,params:new URLSearchParams(i),mode:o&&vo.includes(o)?o:null}}function b(e,t){const s=t?`?${new URLSearchParams(t).toString()}`:"";window.location.hash=`#${e}${s}`}function go(e){const t=()=>e(Kt());return window.addEventListener("hashchange",t),e(Kt()),()=>window.removeEventListener("hashchange",t)}const Ei=new Set;let mt={mode:"loading",me:null,error:null};function Is(e){mt=e,Ei.forEach(t=>t(mt))}function ur(e){return Ei.add(e),e(mt),()=>Ei.delete(e)}async function bo(){try{const e=await z("me");Is({mode:e.has_access?"api":"no_access",me:e,error:null})}catch(e){e instanceof xe&&e.status===401?Is({mode:"unauthenticated",me:null,error:e.body.user_message}):e instanceof xe?Is({mode:"demo",me:null,error:e.body.user_message}):Is({mode:"demo",me:null,error:null})}return mt}const g=()=>mt.mode==="api";function yo(e){const t=ut.find(i=>i.id===e)??ut[0],s=ns.filter(i=>i.floorId===t.id);return{source:"demo",floorId:t.id,floorName:t.name,buildingName:va.building,siteName:va.name,width:t.planWidth||1200,height:t.planHeight||800,imageUrl:null,planSvg:t.hasPlan?or(t.id):null,planStatus:t.hasPlan?"published":"none",planVersionId:t.hasPlan?`demo-${t.id}`:null,needsAlignment:!1,renderMode:"source",stylizedAvailable:!1,planPublishedAt:null,planArchivedAt:null,at:null,history:null,historyFrom:null,haHistory:null,anchors:s.map((i,a)=>({id:`demo-anchor-${i.id}`,floor_id:t.id,plan_version_id:`demo-${t.id}`,resource_type:"camera",resource_id:i.id,position:{x:i.x,y:i.y},rotation_degrees:i.rotation,field_of_view_degrees:i.fov,coverage_radius:null,coverage_polygon:null,layer_id:"cameras",label:i.name,revision:1,effective_from:"",effective_to:null,updated_at:"",camera:{id:i.id,recorder_id:"demo",channel:a+1,name:i.name,name_source:i.name,alias:null,enabled:!0,sort_order:a,main_track:null,sub_track:null,status:i.state==="offline"?"offline":"online",last_seen_at:null}})),zones:[],cameras:[],permissions:{edit:!0,publish:!0,import:!0}}}async function bs(e,t=!1,s){if(!g())return yo(e);const i=new URLSearchParams;t&&i.set("draft","true"),s&&i.set("at",s);const a=i.toString(),n=await z(`floors/${e}/map${a?`?${a}`:""}`);return{source:"api",floorId:n.floor.id,floorName:n.floor.name,buildingName:n.building.name,siteName:n.site.name,width:n.plan?.width_px??1200,height:n.plan?.height_px??800,imageUrl:n.plan?Qe(n.plan.image_url):null,planSvg:null,planStatus:n.plan?n.plan.status==="published"?"published":"draft":"none",planVersionId:n.plan?.id??null,needsAlignment:n.needs_alignment,anchors:n.anchors,zones:n.zones??[],cameras:n.cameras,permissions:n.permissions,renderMode:n.plan?.render_mode==="stylized"?"stylized":"source",stylizedAvailable:!!n.plan?.stylized_url,planPublishedAt:n.plan?.published_at??null,planArchivedAt:n.plan?.archived_at??null,at:n.at??null,history:n.history??null,historyFrom:n.history_from??null,haHistory:n.ha_history??null}}function os(e,t){const s=e.camera;return s?s.status==="online"?"live":s.status==="offline"?"offline":t??"unknown":t??"unknown"}const $o=e=>z(`floors/${e}/plan-assets`),xo=(e,t)=>{const s=new FormData;return s.append("file",t,t.name),si(`floors/${e}/plan-assets`,s)},ko=e=>z(`floors/${e}/plan-versions`),_o=(e,t)=>A(`floors/${e}/plan-versions`,t),Ci=e=>A(`plan-versions/${e}/publish`),zo=(e,t)=>z(`plan-versions/${e}/diff`),So=(e,t,s)=>A(`plan-versions/${e}/rollback`,{revision:t,expected_published_id:s});function ls(e){return e.resource_type==="camera"?e.camera?.name??e.label??e.resource_id:e.label??e.entity?.name??e.resource_id}const ga=(e,t)=>A(`floors/${e}/anchors`,t),mr=(e,t)=>Be(`map-anchors/${e}`,t),Mo=e=>he(`map-anchors/${e}`),Ee=()=>z("cameras"),Ao=()=>A("cameras/sync"),Po=e=>A("cameras",e),Io=(e,t)=>Be(`cameras/${e}`,t),Eo=e=>z(`plan-assets/${e}/dxf`),Co=(e,t)=>Xt(`plan-assets/${e}/dxf`,t);function To(){return{source:"demo",sites:Si.map((t,s)=>({id:t.id,name:t.name,address:t.address,timezone:"Asia/Jerusalem",sort_order:s,updated_at:"",buildings:wo.filter(i=>i.siteId===t.id).map((i,a)=>({id:i.id,site_id:t.id,name:i.name,sort_order:a,updated_at:"",floors:i.floors.map((n,o)=>{const l=ut.find(p=>p.id===n.id);return{id:n.id,building_id:i.id,name:n.name,level:-o,sort_order:o,ha_area_id:null,has_plan:n.hasPlan,published_version_id:n.hasPlan?`demo-${n.id}`:null,plan_width_px:l?.planWidth??null,plan_height_px:l?.planHeight??null,draft_version_id:null,anchor_count:n.cameras+n.entities,camera_count:n.cameras,updated_at:""}})}))})),canCreateSite:!0}}async function gt(){if(!g())return To();const e=await z("sites?tree=true");return{source:"api",sites:e.sites,canCreateSite:e.can_create_site}}const Do=e=>A("sites",e),Oo=(e,t)=>Be(`sites/${e}`,t),Ro=e=>he(`sites/${e}`),fr=(e,t)=>A(`sites/${e}/buildings`,t),No=(e,t)=>Be(`buildings/${e}`,t),Lo=e=>he(`buildings/${e}`),Bo=(e,t)=>A(`buildings/${e}/floors`,t),Ho=(e,t)=>Be(`floors/${e}`,t),Vo=(e,t=!1)=>he(`floors/${e}${t?"?force=true":""}`);function jo(e,t,s){const i=new FormData;return i.append("file",s,s.name),si(`${e}s/${t}/image`,i)}const Fo=(e,t)=>Dt(`${e}s/${t}/image`,{method:"DELETE"}),ba=e=>ce(e.replace(/^api\/v1\//,""));function wr(e,t){for(const s of e.sites)for(const i of s.buildings??[]){const a=(i.floors??[]).find(n=>n.id===t);if(a)return{site:s,building:i,floor:a}}return null}function vr(e){for(const t of e.sites)for(const s of t.buildings??[])for(const i of s.floors??[])return i;return null}function It(e){return String(e??"").replace(/(^|[^\w])(-\d)/g,"$1‎$2")}function Uo(e){return e==null?"":`‎${e}`}const Ti=[{id:"room",label:"חדר"},{id:"zone",label:"אזור"},{id:"corridor",label:"מסדרון"},{id:"outdoor",label:"חוץ"},{id:"service",label:"שירות / טכני"}],Wo=e=>Ti.find(t=>t.id===e)?.label??e,Zo=e=>z(`floors/${e}/zones`),qo=(e,t)=>A(`floors/${e}/zones`,t),Ko=(e,t)=>Be(`zones/${e}`,t),Go=e=>he(`zones/${e}`),Yo=(e,t="medium")=>A(`floors/${e}/zones/detect`,{strength:t}),Jo=(e,t,s)=>A(`floors/${e}/zones/accept`,{candidates:t,replace_auto:s});function ds(e,t){let s=!1;for(let i=0,a=t.length-1;i<t.length;a=i++){const n=t[i],o=t[a];n.y>e.y!=o.y>e.y&&e.x<(o.x-n.x)*(e.y-n.y)/(o.y-n.y)+n.x&&(s=!s)}return s}const gr=()=>z("views"),br=e=>A("views",e),Xo=(e,t)=>Xt(`views/${e}`,t),Qo=e=>he(`views/${e}`),yr=e=>`#/live/wall?cameras=${encodeURIComponent(e.cameras.join(","))}`,el=e=>`#/kiosk/all?cameras=${encodeURIComponent(e.cameras.join(","))}&cols=${e.cols}&rows=${e.rows}`;var tl=Object.defineProperty,sl=Object.getOwnPropertyDescriptor,Ss=(e,t,s,i)=>{for(var a=i>1?void 0:i?sl(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&tl(t,s,a),a};let Et=class extends ${constructor(){super(...arguments),this.checked=!1,this.disabled=!1,this.label="",this.labelHidden=!1}flip(){this.disabled||(this.checked=!this.checked,this.dispatchEvent(new CustomEvent("change",{detail:{checked:this.checked},bubbles:!0,composed:!0})))}render(){return r`<button type="button" role="switch" aria-checked=${this.checked} aria-label=${this.label} ?disabled=${this.disabled} @click=${this.flip}></button>${this.label&&!this.labelHidden?r`<span>${this.label}</span>`:""}`}};Et.styles=k`
    :host {
      display: inline-flex;
      align-items: center;
      gap: var(--sw-s-2);
  ...
  `;Ss([m({type:Boolean,reflect:!0})],Et.prototype,"checked",2);Ss([m({type:Boolean,reflect:!0})],Et.prototype,"disabled",2);Ss([m()],Et.prototype,"label",2);Ss([m({type:Boolean})],Et.prototype,"labelHidden",2);Et=Ss([_("sw-toggle")],Et);function $r(e={}){const t=new URLSearchParams;e.domain&&t.set("domain",e.domain),e.q&&t.set("q",e.q),e.area&&t.set("area",e.area),e.placed!==void 0&&t.set("placed",String(e.placed)),e.includeDisabled&&t.set("include_disabled","true"),e.limit&&t.set("limit",String(e.limit));const s=t.toString();return z(`ha/entities${s?`?${s}`:""}`)}const il=()=>z("ha/status"),al=(e=!1)=>z(`ha/bridge/pairing${e?"?regenerate=true":""}`),ya=e=>z(`ha/actions/${e}`),rl=()=>A("ha/bridge/install");function nl(e,t,s={},i=!1){const a={allowed_action_id:t,arguments:s,expected_state_version:null,confirmation_grant:i?"confirmed":null,client_request_id:crypto.randomUUID(),expires_at:new Date(Date.now()+6e4).toISOString().replace(/\.\d{3}Z$/,"Z")};return A(`ha/entities/${encodeURIComponent(e)}/actions`,a)}async function ol(e,t,s){let i=await ya(e);t(i);for(let a=0;a<16&&i.status==="pending";a++)await new Promise(n=>setTimeout(n,1500)),i=await ya(e),t(i);return i}const ll={ha_unauthorized:"Home Assistant דחה את הפעולה: למשתמש שלך אין הרשאה לישות זו ב־Home Assistant",ha_unknown_user:"Home Assistant אינו מכיר את המשתמש שמאחורי ההפעלה הזו",bridge_not_paired:"גשר SMPLWISE אינו מצומד",bridge_error:"הגשר החזיר שגיאה",ha_unavailable:"Home Assistant אינו זמין",service_not_allowed:"הגשר סירב: השירות אינו ברשימת הפעולות המאושרות (גשר ישן? מאז 0.2.1 נוספו climate / media / number / select / alarm — הפעל את Home Assistant מחדש כדי לטעון את הגרסה החדשה)",unknown_user:"Home Assistant אינו מכיר את המשתמש"},dl={pending:"נשלח · ממתין לעדכון מ־Home Assistant",confirmed:"אושר · המצב התעדכן",unknown:"לא ידוע · לא התקבל עדכון מצב",failed:"נכשל",denied:"נדחה · אין הרשאה ב־Home Assistant"},cl=new Set(["on","open","opening","unlocked","unlocking","playing","home","heat","cool","heat_cool","dry","fan_only","cleaning","active","detected","problem","running"]),Es={on:"דולק",off:"כבוי",locked:"נעול",unlocked:"פתוח",locking:"נועל…",unlocking:"פותח…",jammed:"תקוע",open:"פתוח",closed:"סגור",opening:"נפתח…",closing:"נסגר…",unavailable:"לא זמין",unknown:"לא ידוע",idle:"לא פעיל",home:"בבית",not_home:"מחוץ לבית",playing:"מנגן",paused:"מושהה",standby:"המתנה",heat:"חימום",cool:"קירור",auto:"אוטומטי",dry:"ייבוש",fan_only:"מאוורר",docked:"בתחנה",cleaning:"מנקה",returning:"חוזר"},pl={motion:["תנועה","ללא תנועה"],occupancy:["נוכחות","ללא נוכחות"],presence:["נוכח","לא נוכח"],door:["פתוחה","סגורה"],window:["פתוח","סגור"],opening:["פתוח","סגור"],garage_door:["פתוח","סגור"],lock:["פתוח","נעול"],connectivity:["מחובר","מנותק"],power:["פועל","כבוי"],problem:["תקלה","תקין"],safety:["לא בטוח","בטוח"],smoke:["עשן","ללא עשן"],moisture:["רטוב","יבש"],battery:["סוללה חלשה","סוללה תקינה"],running:["פועל","לא פועל"],sound:["רעש","שקט"],vibration:["רטט","ללא רטט"],update:["עדכון זמין","מעודכן"]};function ft(e){const t=e.state;if(t==null)return"לא ידוע";if(t==="unavailable"||t==="unknown")return Es[t];if(e.domain==="binary_sensor"){const s=pl[e.device_class??""];return s?t==="on"?s[0]:s[1]:t==="on"?"פעיל":"לא פעיל"}if(e.domain==="sensor"||e.domain==="number"||e.domain==="input_number"){const s=Number(t);return!Number.isNaN(s)&&t.trim()!==""?`${Number.isInteger(s)?s:s.toFixed(Math.min(2,(t.split(".")[1]??"").length))}${e.unit?` ${e.unit}`:""}`:t}return e.domain==="light"&&t==="on"&&typeof e.attributes.brightness=="number"?`דולק · ${Math.round(e.attributes.brightness/255*100)}%`:e.domain==="cover"&&typeof e.attributes.current_position=="number"&&(t==="open"||t==="closed")?`${Es[t]} · ${e.attributes.current_position}%`:e.domain==="climate"&&typeof e.attributes.current_temperature=="number"?`${Es[t]??t} · ${e.attributes.current_temperature}°`:Es[t]??t}function Di(e){return!e||e.removed_at?"unknown":e.state==="unavailable"||!e.available?"offline":e.fresh?e.state===null||e.state==="unknown"?"unknown":cl.has(e.state)?"live":"neutral":"stale"}function ai(e,t){return e==="doors"||t==="lock"||t==="cover"?"lock":e==="lights"||t==="light"||t==="switch"||t==="fan"?"light":"binary_sensor"}function ys(e){return{light:"תאורה",switch:"מתג",lock:"מנעול",cover:"תריס / שער",binary_sensor:"חיישן בינארי",sensor:"חיישן",fan:"מאוורר",climate:"אקלים",camera:"מצלמת HA",button:"כפתור",script:"סקריפט",scene:"סצנה",automation:"אוטומציה",media_player:"נגן",event:"אירוע",number:"מספר",select:"בחירה",input_boolean:"דגל",alarm_control_panel:"אזעקה",siren:"צופר",vacuum:"שואב",weather:"מזג אוויר",sun:"שמש"}[e]??e}function Oe(e){if(!e)return"—";const t=new Date(e);return Number.isNaN(t.getTime())?e:t.toLocaleString("he-IL",{dateStyle:"short",timeStyle:"medium"})}function xr(e,t){let s=null,i=!1,a=2e3;const n=(()=>{const l=new URL(ce("ha/ws"));return l.protocol=l.protocol==="https:"?"wss:":"ws:",l.toString()})(),o=()=>{if(!i){try{s=new WebSocket(n)}catch{return}s.onopen=()=>{a=2e3},s.onmessage=l=>{try{const p=JSON.parse(l.data);p.type==="entity_state_changed"?e({type:"entity_state_changed",entity:p.payload.entity}):p.type==="ha_sync_state"?e({type:"ha_sync_state",connected:!!p.payload.connected}):p.type==="heartbeat"&&e({type:"heartbeat",sync:p.payload.sync})}catch{}},s.onclose=l=>{!i&&l.code!==4403&&l.code!==4401&&(window.setTimeout(o,a),a=Math.min(3e4,a*2))}}};return o(),()=>{i=!0,s?.close()}}var hl=Object.defineProperty,ul=Object.getOwnPropertyDescriptor,B=(e,t,s,i)=>{for(var a=i>1?void 0:i?ul(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&hl(t,s,a),a};const ml={off:"כבוי",heat:"חימום",cool:"קירור",heat_cool:"חימום/קירור",auto:"אוטומטי",dry:"ייבוש",fan_only:"מאוורר בלבד"},fl=[{id:"cameras",icon:"camera",label:()=>y("floor.cameras")},{id:"doors",icon:"door",label:()=>y("floor.doors")},{id:"lights",icon:"light",label:()=>y("floor.lights")},{id:"sensors",icon:"sensor",label:()=>y("floor.sensors")},{id:"zones",icon:"map",label:()=>"חדרים ואזורים"}],$a=["entrance","lobby","corridor","hall","parking","warehouse","backyard","driveway","night"];let D=class extends ${constructor(){super(...arguments),this.floorId="f0",this.screenState="ready",this.focusZone="",this.focusCamera="",this.focusEntity="",this.selectedZoneId=null,this.bundle=null,this.tree=null,this.loadError="",this.noFloors=!1,this.selectedId=null,this.anchor=null,this.layers=new Set(["cameras","doors","lights","sensors","zones"]),this.pinned=!1,this.panel=!1,this.multi=!1,this.sideList=(()=>{try{return localStorage.getItem("sw.map.sidelist")==="1"}catch{return!1}})(),this.saveView=null,this.savedView=null,this.picked=[],this.narrow=!1,this.syncConnected=!0,this.action=null,this.confirmSpec=null,this.stopWs=null,this.mq=window.matchMedia("(max-width: 767px)"),this.onMq=()=>this.narrow=this.mq.matches,this.onKey=e=>{if(e.key==="Escape"&&!this.confirmSpec)if(this.selectedId){const t=this.selectedId;this.close(),this.canvas?.focusMarker(t)}else this.panel&&(this.panel=!1)},this.actionArgs={},this.renaming=null,this.notice=""}connectedCallback(){super.connectedCallback(),this.narrow=this.mq.matches,this.mq.addEventListener("change",this.onMq),window.addEventListener("keydown",this.onKey),this.load()}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("keydown",this.onKey),this.mq.removeEventListener("change",this.onMq),this.stopWs?.(),this.stopWs=null}startWs(){this.stopWs||!g()||(this.stopWs=xr(e=>{const t=this.bundle;if(e.type==="entity_state_changed"&&t){if(!t.anchors.some(s=>s.resource_type==="ha_entity"&&s.resource_id===e.entity.entity_id))return;this.bundle={...t,anchors:t.anchors.map(s=>s.resource_type==="ha_entity"&&s.resource_id===e.entity.entity_id?{...s,entity:{...s.entity??{},...e.entity,actions:s.entity?.actions}}:s)}}else e.type==="ha_sync_state"?this.syncConnected=e.connected:e.type==="heartbeat"&&(this.syncConnected=e.sync.connected)}))}updated(e){e.has("floorId")&&e.get("floorId")!==void 0?(this.selectedId=null,this.anchor=null,this.selectedZoneId=null,this.load()):(e.has("focusZone")||e.has("focusCamera")||e.has("focusEntity"))&&this.bundle&&this.applyFocus()}async applyFocus(){const e=this.bundle;if(!e||!this.focusZone&&!this.focusCamera&&!this.focusEntity)return;await this.updateComplete;const t=this.canvas;if(!t)return;const s=this.focusZone?e.zones.find(a=>a.id===this.focusZone):null;if(s){const a=s.polygon.map(o=>o.x),n=s.polygon.map(o=>o.y);this.selectedZoneId=s.id,t.zoomToBox(Math.min(...a),Math.min(...n),Math.max(...a),Math.max(...n))}const i=this.focusCamera?e.anchors.find(a=>a.resource_type==="camera"&&a.resource_id===this.focusCamera):this.focusEntity?e.anchors.find(a=>a.resource_type==="ha_entity"&&a.resource_id===this.focusEntity):null;if(i){t.zoomToBox(i.position.x-.15,i.position.y-.15,i.position.x+.15,i.position.y+.15,48,2.2),await this.updateComplete;const a=t.toScreen(i.position.x,i.position.y);this.selectedId=i.id,this.anchor={x:a.x,y:a.y}}}async load(){this.loadError="";try{const e=this.tree??await gt();if(this.tree=e,g()&&!wr(e,this.floorId)){const t=vr(e);if(t&&t.id!==this.floorId){b(`/explore/floors/${t.id}`);return}if(!t){this.noFloors=!0,this.bundle=null;return}}this.noFloors=!1,this.restoreLayers(),this.bundle=await bs(this.floorId),this.bundle.source==="api"&&this.startWs(),this.applyFocus()}catch(e){this.loadError=w(e),this.bundle=null}}get floors(){return this.tree?.source==="api"?this.tree.sites.flatMap(e=>(e.buildings??[]).flatMap(t=>(t.floors??[]).map(s=>({id:s.id,name:`${t.name} · ${s.name}`,cameraCount:s.camera_count,hasPlan:s.has_plan})))):ut.map(e=>({id:e.id,name:e.name,cameraCount:e.cameraCount,hasPlan:e.hasPlan}))}get markers(){const e=this.bundle;if(!e)return[];const t=this.screenState==="stale";if(e.source==="demo"){const s=this.layers.has("cameras")?ns.filter(a=>a.floorId===e.floorId).map(a=>({id:a.id,kind:"camera",label:a.name,x:a.x,y:a.y,rotation:a.rotation,fov:a.fov,state:a.state})):[],i=Ls.filter(a=>a.floorId===e.floorId).filter(a=>a.domain==="lock"&&this.layers.has("doors")||a.domain==="light"&&this.layers.has("lights")||a.domain==="binary_sensor"&&this.layers.has("sensors")).map(a=>({id:a.id,kind:a.domain,label:a.name,x:a.x,y:a.y,state:t?"stale":"neutral"}));return[...s,...i]}return e.anchors.filter(s=>s.resource_type==="camera"?this.layers.has("cameras"):this.layers.has(s.layer_id==="doors"?"doors":s.layer_id==="lights"?"lights":"sensors")).map(s=>({id:s.id,kind:s.resource_type==="camera"?"camera":ai(s.layer_id,s.entity?.domain),label:ls(s),x:s.position.x,y:s.position.y,rotation:s.rotation_degrees,fov:s.field_of_view_degrees??void 0,radius:s.coverage_radius??void 0,polygon:s.coverage_polygon?s.coverage_polygon.map(([i,a])=>({x:i,y:a})):void 0,state:s.resource_type==="camera"?os(s):t?"stale":this.entityTone(s.entity)}))}layerCounts(){const e=this.bundle,t={cameras:0,doors:0,lights:0,sensors:0,zones:e?.zones.length??0};if(!e)return t;if(e.source==="demo"){t.cameras=ns.filter(s=>s.floorId===e.floorId).length;for(const s of Ls.filter(i=>i.floorId===e.floorId))s.domain==="lock"?t.doors++:s.domain==="light"?t.lights++:t.sensors++;return t}for(const s of e.anchors)s.resource_type==="camera"?t.cameras++:s.layer_id==="doors"?t.doors++:s.layer_id==="lights"?t.lights++:t.sensors++;return t}zoneOf(e){return this.bundle?.zones.find(s=>ds(e.position,s.polygon))?.name??null}toggleLayer(e){const t=new Set(this.layers);t.has(e)?t.delete(e):t.add(e),this.setLayers(t)}setLayers(e){this.layers=e;try{localStorage.setItem(`sw.floor.layers.${this.floorId}`,JSON.stringify([...e]))}catch{}}restoreLayers(){try{const e=localStorage.getItem(`sw.floor.layers.${this.floorId}`);if(!e)return;const t=JSON.parse(e);Array.isArray(t)&&(this.layers=new Set(t.filter(s=>["cameras","doors","lights","sensors","zones"].includes(s))))}catch{}}cameraAnchors(){return(this.bundle?.anchors??[]).filter(e=>e.resource_type==="camera"&&this.layers.has("cameras"))}togglePick(e){this.picked=this.picked.includes(e)?this.picked.filter(t=>t!==e):[...this.picked,e]}pickedCameraIds(){const e=new Map((this.bundle?.anchors??[]).map(t=>[t.id,t.resource_id]));return this.picked.map(t=>e.get(t)).filter(t=>!!t)}setMulti(e){this.multi=e,this.picked=[],this.saveView=null,this.savedView=null,e&&this.close()}addPicks(e){const t=new Set(this.cameraAnchors().map(i=>i.id)),s=e.filter(i=>t.has(i)&&!this.picked.includes(i));s.length&&(this.picked=[...this.picked,...s])}pickZone(e){const t=this.bundle?.zones.find(a=>a.id===e);if(!t)return;const s=this.cameraAnchors().filter(a=>ds(a.position,t.polygon)).map(a=>a.id);if(!s.length)return;const i=s.every(a=>this.picked.includes(a));this.picked=i?this.picked.filter(a=>!s.includes(a)):[...this.picked,...s.filter(a=>!this.picked.includes(a))]}roomChips(){const e=this.bundle;if(!e)return c;const t=this.cameraAnchors(),s=e.zones.map(i=>({z:i,ids:t.filter(a=>ds(a.position,i.polygon)).map(a=>a.id)})).filter(i=>i.ids.length);return s.length?r`<span class="roomchips" data-room-chips>${s.map(i=>r`<sw-chip icon="layers" data-room-chip=${i.z.id} ?selected=${i.ids.every(a=>this.picked.includes(a))} @click=${()=>this.pickZone(i.z.id)}>${i.z.name} (${i.ids.length})</sw-chip>`)}</span>`:c}toggleSideList(){this.sideList=!this.sideList;try{localStorage.setItem("sw.map.sidelist",this.sideList?"1":"0")}catch{}}async jumpTo(e){if(e.resource_type==="camera"?(this.focusCamera=e.resource_id,this.focusEntity=""):(this.focusEntity=e.resource_id,this.focusCamera=""),this.focusZone="",this.multi&&e.resource_type==="camera"){this.togglePick(e.id);return}await this.applyFocus()}renderSideList(){const e=this.bundle;if(!e||!this.sideList||e.source!=="api")return c;const t=e.anchors.filter(o=>o.resource_type==="camera"),s=e.anchors.filter(o=>o.resource_type==="ha_entity"),i={light:"תאורה",switch:"מפסקים",lock:"מנעולים",binary_sensor:"חיישנים",sensor:"חיישנים",cover:"תריסים",climate:"מיזוג",media_player:"מדיה",alarm_control_panel:"אזעקה"},a=new Map;for(const o of s){const l=o.entity?.domain??o.resource_id.split(".")[0];a.set(l,[...a.get(l)??[],o])}const n=o=>o.camera?o.camera.status==="online"?"#22c55e":o.camera.status==="offline"?"#ef4444":"var(--sw-text-3)":o.entity?.state==="on"||o.entity?.state==="unlocked"||o.entity?.state==="open"?"var(--sw-accent)":"var(--sw-text-3)";return r`<div class="sidelist" data-sidelist>
      ...
      <div class="body">
        ...
        ${this.floors.map(o=>r`<button class="it ${o.id===this.floorId?"on":""}" data-side-floor=${o.id} @click=${()=>{o.id!==this.floorId&&b(`/explore/floors/${o.id}`)}}>
          <sw-icon name="building" size=${12}></sw-icon><span class="nm">${It(o.name)}</span><span class="st">${o.cameraCount} מצלמות${o.hasPlan?"":" · אין תוכנית"}</span></button>`)}
    ...
    `}async saveRename(e){const t=this.renaming;if(!(!t||t.id!==e.id||t.busy)){this.renaming={...t,busy:!0};try{const s=await mr(e.id,{revision:e.revision,label:t.value.trim()||null});this.bundle&&(this.bundle={...this.bundle,anchors:this.bundle.anchors.map(i=>i.id===e.id?{...i,label:s.label,revision:s.revision}:i)}),this.renaming=null,this.notice=s.label?`השם „${s.label}“ נשמר`:"חזרה לשם מ־Home Assistant"}catch(s){this.notice=w(s),this.renaming={...t,busy:!1}}}}entityActions(e){return(e.entity?.actions??[]).length?r`<div class="eactions" data-entity-actions>${this.entityFooter(e)}</div>`:c}entityFooter(e){const t=e.entity,s=!!(this.action&&t&&this.action.entityId===t.entity_id&&this.action.busy),i=t?.actions??[];return r`${i.map(a=>r`<span class="actrow" data-action-row=${a.id}>${t&&a.argument_specs?.length?a.argument_specs.map(n=>this.renderArg(t,a,n)):c}<sw-button size="sm" variant=${a.risk==="sensitive"||a.sensitive?"danger":"primary"} ?disabled=${s||this.screenState==="stale"||t?.state==="unavailable"||a.granted===!1} title=${a.granted===!1?`נדרשת הרשאה נפרדת: ${a.grant??""}`:a.risk_label?`פעולה ${a.risk_label}`:""} data-action=${a.id} data-risk=${a.risk??(a.sensitive?"attention":"routine")} data-granted=${a.granted===!1?"no":"yes"} @click=${()=>t&&this.trigger(t.entity_id,a)}>${a.label}</sw-button></span>`)}`}renderConfirm(){const e=this.confirmSpec;if(!e)return c;const t=this.bundle?.anchors.find(s=>s.resource_type==="ha_entity"&&s.resource_id===e.entityId)?.entity;return r`<sw-dialog open heading=${y("entity.confirm")} subheading=${t?.name??e.entityId} @close=${()=>this.confirmSpec=null}>
      ...
      ${i?r`<sw-camera-tile name="" state=${e.state} scene=${We[e.id]??"lobby"} @click=${()=>b(`/live/cameras/${e.id}`)}></sw-camera-tile>`:r`<div class="off"><div><sw-icon name=${e.state==="forbidden"?"lock":"offline"} size=${22}></sw-icon><div>${s}</div></div></div>`}
    ...
    `}apiCameraBody(e,t){const s=e.camera,i=os(e),a=$a[((s?.channel??1)-1)%$a.length],n=i==="live"&&!!s&&s.can_view_live!==!1,o=this.zoneOf(e),l=o?`${t} / ${o}`:`${t} · ערוץ ${s?.channel??"?"}`;return r`
      ${i==="offline"?r`<div class="off"><div><sw-icon name="offline" size=${22}></sw-icon><div>${y("camera.offlineReason")}</div></div></div>`:r`<sw-camera-tile name="" state=${i==="live"?"live":"unknown"} scene=${a} poster=${s?Ue(s.id,Date.now()):""} ?live=${n} .cameraId=${n?s.id:""} data-live=${n?"1":"0"} @click=${()=>s&&b(`/live/cameras/${s.id}`)}></sw-camera-tile>`}
    ...
    `}renderCard(){const e=this.bundle;if(!this.selectedId||!e)return c;let t="",s="",i=c,a=c;if(e.source==="demo"){const l=ns.find(u=>u.id===this.selectedId),p=l?void 0:Ls.find(u=>u.id===this.selectedId);if(!l&&!p)return c;t=l?l.name:p.name,s=l?`${e.floorName} · ${l.source}`:`${e.floorName} · ${y(p.domain==="lock"?"entity.door":p.domain==="light"?"entity.light":"entity.sensor")}`,i=l?this.demoCameraBody(l,e.floorName):this.demoEntityBody(p);const f=l?l.state==="live"||l.state==="stale":!1;a=l?r`<sw-button variant="primary" size="sm" icon="expand" ?disabled=${!f} @click=${()=>b(`/live/cameras/${l.id}`)}>צפייה חיה</sw-button>
      ...
      <div class="head">
        ...
        <div class="tools">
          <div class="layers" role="group" aria-label=${y("floor.layers")}>
            ${fl.map(n=>r`<button class=${this.layers.has(n.id)?"on":""} title=${n.label()} aria-label=${n.label()} aria-pressed=${this.layers.has(n.id)} @click=${()=>this.toggleLayer(n.id)}><sw-icon name=${n.icon} size=${14}></sw-icon></button>`)}
          </div>
          ...
          <sw-field style="min-inline-size:280px"><select aria-label=${y("floor.switcher")} @change=${n=>b(`/explore/floors/${n.target.value}`)}>${t.map(n=>r`<option value=${n.id} ?selected=${n.id===this.floorId}>${It(n.name)} · ${n.cameraCount} מצלמות${n.hasPlan?"":" · אין תוכנית"}</option>`)}</select></sw-field>
  ...
  `;B([m()],D.prototype,"floorId",2);B([m()],D.prototype,"screenState",2);B([m()],D.prototype,"focusZone",2);B([m()],D.prototype,"focusCamera",2);B([m()],D.prototype,"focusEntity",2);B([d()],D.prototype,"selectedZoneId",2);B([d()],D.prototype,"bundle",2);B([d()],D.prototype,"tree",2);B([d()],D.prototype,"loadError",2);B([d()],D.prototype,"noFloors",2);B([d()],D.prototype,"selectedId",2);B([d()],D.prototype,"anchor",2);B([d()],D.prototype,"layers",2);B([d()],D.prototype,"pinned",2);B([d()],D.prototype,"panel",2);B([d()],D.prototype,"multi",2);B([d()],D.prototype,"sideList",2);B([d()],D.prototype,"saveView",2);B([d()],D.prototype,"savedView",2);B([d()],D.prototype,"picked",2);B([d()],D.prototype,"narrow",2);B([d()],D.prototype,"syncConnected",2);B([d()],D.prototype,"action",2);B([d()],D.prototype,"confirmSpec",2);B([Yt("sw-plan-canvas")],D.prototype,"canvas",2);B([Yt(".stage")],D.prototype,"stage",2);B([d()],D.prototype,"actionArgs",2);B([d()],D.prototype,"renaming",2);B([d()],D.prototype,"notice",2);D=B([_("explore-floor-map")],D);var wl=Object.defineProperty,vl=Object.getOwnPropertyDescriptor,es=(e,t,s,i)=>{for(var a=i>1?void 0:i?vl(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&wl(t,s,a),a};let wt=class extends ${constructor(){super(...arguments),this.heading="",this.subheading="",this.crumbs="",this.wide=!1,this.flush=!1}render(){const e=this.crumbs?this.crumbs.split("|").map(t=>t.trim()):[];return r`
      <header>
        <div>
  ...
  `;es([m()],wt.prototype,"heading",2);es([m()],wt.prototype,"subheading",2);es([m()],wt.prototype,"crumbs",2);es([m({type:Boolean,reflect:!0})],wt.prototype,"wide",2);es([m({type:Boolean,reflect:!0})],wt.prototype,"flush",2);wt=es([_("sw-page")],wt);var gl=Object.defineProperty,bl=Object.getOwnPropertyDescriptor,Ms=(e,t,s,i)=>{for(var a=i>1?void 0:i?bl(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&gl(t,s,a),a};let Ct=class extends ${constructor(){super(...arguments),this.heading="",this.subheading="",this.flush=!1,this.interactive=!1}render(){return r`
  ...
  `;Ms([m()],Ct.prototype,"heading",2);Ms([m()],Ct.prototype,"subheading",2);Ms([m({type:Boolean,reflect:!0})],Ct.prototype,"flush",2);Ms([m({type:Boolean,reflect:!0})],Ct.prototype,"interactive",2);Ct=Ms([_("sw-card")],Ct);var yl=Object.defineProperty,$l=Object.getOwnPropertyDescriptor,rt=(e,t,s,i)=>{for(var a=i>1?void 0:i?$l(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&yl(t,s,a),a};const xl=["house","building","warehouse"];let Ne=class extends ${constructor(){super(...arguments),this.tab="all",this.tree=null,this.dialog=null,this.notice="",this.formName="",this.formAddress="",this.busy=!1,this.error=""}connectedCallback(){super.connectedCallback(),this.reload()}async reload(){try{this.tree=await gt()}catch(e){this.error=w(e)}}open(e){this.formName=e&&e.kind==="edit-site"?e.site.name:e&&e.kind==="edit-building"?e.building.name:"",this.formAddress=e&&e.kind==="edit-site"?e.site.address:"",this.error="",this.dialog=e}pickImage(e,t){const s=document.createElement("input");s.type="file",s.accept="image/png,image/jpeg",s.addEventListener("change",async()=>{const i=s.files?.[0];if(i){this.busy=!0;try{await jo(e,t,i),this.notice="התמונה נשמרה.",await this.reload()}catch(a){this.notice=w(a)}finally{this.busy=!1}}}),s.click()}async removeImage(e,t){this.busy=!0;try{await Fo(e,t),await this.reload()}catch(s){this.notice=w(s)}finally{this.busy=!1}}renderMenu(e,t,s){const i=s?!!s.image_url:!!t.image_url,a=s?s.id:t.id;return r`<span class="menu" @click=${o=>o.stopPropagation()}>
    ...
    </span>`}async submit(){const e=this.dialog;if(e){this.busy=!0,this.error="";try{if(e.kind==="site"){const t=await Do({name:this.formName.trim(),address:this.formAddress.trim()});this.dialog=null,await this.reload(),this.open({kind:"building",site:t})}else if(e.kind==="building"){const t=await fr(e.site.id,{name:this.formName.trim()});this.dialog=null,b(`/explore/buildings/${t.id}/floors`)}else e.kind==="edit-site"?(await Oo(e.site.id,{name:this.formName.trim(),address:this.formAddress.trim()}),this.dialog=null,await this.reload()):e.kind==="edit-building"?(await No(e.building.id,{name:this.formName.trim()}),this.dialog=null,await this.reload()):e.kind==="delete-site"?(await Ro(e.site.id),this.dialog=null,await this.reload()):e.kind==="delete-building"&&(await Lo(e.building.id),this.dialog=null,await this.reload())}catch(t){this.error=w(t)}finally{this.busy=!1}}}openSite(e){const t=e.buildings?.[0];t?b(`/explore/buildings/${t.id}/floors`):this.open({kind:"building",site:e})}renderSites(e){return r`<div class="grid">
      ${e.sites.map((t,s)=>{const i=t.buildings??[],a=i.reduce((n,o)=>n+(o.floors??[]).reduce((l,p)=>l+p.camera_count,0),0);return r`<sw-card flush interactive data-site-card=${t.id} @click=${()=>this.openSite(t)}>
          <div class="pic">${t.image_url?r`<img class="photo" src=${ba(t.image_url)} alt="" />`:r`<sw-scene kind=${xl[s%3]}></sw-scene>${e.source==="demo"?r`<span class="demo">דמו</span>`:r`<span class="demo">איור</span>`}`}</div>
          <div class="info">
      ...
      ${t.map(({s,b:i},a)=>r`<sw-card class="brow" data-building-card=${i.id} @click=${()=>b(`/explore/buildings/${i.id}/floors`)}>
          ${i.image_url?r`<img class="photo small" src=${ba(i.image_url)} alt="" />`:r`<sw-scene kind=${a%2?"house":"building"}></sw-scene>`}
  ...
  `;rt([d()],Ne.prototype,"tab",2);rt([d()],Ne.prototype,"tree",2);rt([d()],Ne.prototype,"dialog",2);rt([d()],Ne.prototype,"notice",2);rt([d()],Ne.prototype,"formName",2);rt([d()],Ne.prototype,"formAddress",2);rt([d()],Ne.prototype,"busy",2);rt([d()],Ne.prototype,"error",2);Ne=rt([_("explore-sites")],Ne);var kl=Object.defineProperty,_l=Object.getOwnPropertyDescriptor,As=(e,t,s,i)=>{for(var a=i>1?void 0:i?_l(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&kl(t,s,a),a};let Tt=class extends ${constructor(){super(...arguments),this.rooms=[],this.selected=!1,this.empty=!1,this.width=132}iso(e,t){return{x:60+(e-t)*58,y:6+(e+t)*26}}poly(e){return e.map(t=>`${t.x.toFixed(1)},${t.y.toFixed(1)}`).join(" ")}render(){this.style.setProperty("--w",`${this.width}px`);const e=[this.iso(0,0),this.iso(1,0),this.iso(1,1),this.iso(0,1)],t=7,s=[this.iso(1,0),this.iso(1,1),{x:this.iso(1,1).x,y:this.iso(1,1).y+t},{x:this.iso(1,0).x,y:this.iso(1,0).y+t}],i=[this.iso(0,1),this.iso(1,1),{x:this.iso(1,1).x,y:this.iso(1,1).y+t},{x:this.iso(0,1).x,y:this.iso(0,1).y+t}];return r`<svg viewBox="0 0 120 72" aria-hidden="true">
  ...
  `;As([m({attribute:!1})],Tt.prototype,"rooms",2);As([m({type:Boolean,reflect:!0})],Tt.prototype,"selected",2);As([m({type:Boolean,reflect:!0})],Tt.prototype,"empty",2);As([m({type:Number})],Tt.prototype,"width",2);Tt=As([_("sw-floor-iso")],Tt);var zl=Object.defineProperty,Sl=Object.getOwnPropertyDescriptor,qe=(e,t,s,i)=>{for(var a=i>1?void 0:i?Sl(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&zl(t,s,a),a};let Me=class extends ${constructor(){super(...arguments),this.buildingId="bld-a",this.tree=null,this.selected=null,this.tab="floors",this.dialog=null,this.busy=!1,this.error="",this.formName="",this.formLevel=0}connectedCallback(){super.connectedCallback(),this.reload()}updated(e){e.has("buildingId")&&e.get("buildingId")!==void 0&&(this.selected=null)}async reload(){try{this.tree=await gt(),this.error=""}catch(e){this.error=w(e)}}get context(){if(!this.tree)return null;for(const s of this.tree.sites)for(const i of s.buildings??[])if(i.id===this.buildingId)return{site:s,building:i};const e=this.tree.sites[0],t=e?.buildings?.[0];return e&&t?{site:e,building:t}:null}async run(e){this.busy=!0,this.error="";try{await e(),this.dialog=null,await this.reload()}catch(t){t instanceof xe&&t.code==="has_anchors"&&this.dialog?.kind==="delete"?(this.dialog={...this.dialog,force:!0},this.error=`${t.body.user_message} (${t.body.details.anchors??""} פריטים)`):this.error=w(t)}finally{this.busy=!1}}openDialog(e){this.error="",this.formName=e?.kind==="rename"?e.floor.name:"",this.formLevel=e?.kind==="rename"?e.floor.level:0,this.dialog=e}renderDialog(e){const t=this.dialog;if(!t)return c;const s=this.tree?.source==="demo",i=r`<sw-field label="שם"><input .value=${this.formName} @input=${l=>this.formName=l.target.value} placeholder="למשל: קומה 1" autofocus /></sw-field>`,a=r`<sw-field label="מפלס (0 = קרקע, שלילי = מרתף)" hint="קובע את סדר התצוגה בין הקומות"><input type="number" data-ltr .value=${String(this.formLevel)} @input=${l=>this.formLevel=Number(l.target.value)} /></sw-field>`,n=this.error?r`<div class="err">${this.error}</div>`:c,o=s?r`<div class="err">נתוני הדגמה: אין שרת מחובר, השינוי לא יישמר.</div>`:c;switch(t.kind){case"floor":return r`<sw-dialog open heading="קומה חדשה" subheading=${`${e.name}`} @close=${()=>this.dialog=null}>
          ...
          ${n}${o}
          <sw-button slot="footer" variant="ghost" @click=${()=>this.dialog=null}>ביטול</sw-button>
          <sw-button slot="footer" variant="danger" ?disabled=${this.busy||s} @click=${()=>this.run(async()=>{await Vo(t.floor.id,t.force),this.selected===t.floor.id&&(this.selected=null)})}>${t.force?"מחק כולל הפריטים":"מחק קומה"}</sw-button>
          ...
          ${i}${n}${o}
          <sw-button slot="footer" variant="ghost" @click=${()=>this.dialog=null}>ביטול</sw-button>
          <sw-button slot="footer" variant="primary" ?disabled=${!this.formName.trim()||this.busy||s} @click=${()=>this.run(async()=>{const l=await fr(this.context.site.id,{name:this.formName.trim()});b(`/explore/buildings/${l.id}/floors`)})}>הוסף מבנה</sw-button>
      ...
      <sw-page heading=${s.name} subheading=${`${t.address||t.name} · ${i.length} קומות${o.source==="demo"?" · נתוני הדגמה":""}`} crumbs=${`אתרים | ${t.name} | ${s.name}`}>
        ...
        ${this.tab==="floors"?r`<div class="list">
              ...
              ${i.map(l=>r`<button class="floor ${a?.id===l.id?"on":""}" @click=${()=>a?.id===l.id?b(`/explore/floors/${l.id}`):this.selected=l.id} aria-pressed=${a?.id===l.id}>
                  <div class="txt">
                    <div class="title">${It(l.name)}</div>
                    <div class="counts">${l.camera_count} מצלמות · ${l.anchor_count} פריטים במפה · מפלס ${Uo(l.level)}${l.has_plan?"":" · אין תוכנית עדיין"}${l.draft_version_id?" · טיוטה ממתינה לפרסום":""}</div>
                  </div>
                  <sw-floor-iso .rooms=${o.source==="demo"?zi(l.id):[]} ?selected=${a?.id===l.id} ?empty=${!l.has_plan} width=${128}></sw-floor-iso>
            ...
            </div>`:this.tab==="cameras"?r`<div class="cams">${i.map(l=>r`<sw-card heading=${It(l.name)} subheading="${l.camera_count} מצלמות" interactive @click=${()=>b(`/explore/floors/${l.id}`)}></sw-card>`)}</div>`:r`<sw-card heading="פרטי המבנה">
                <dl>
  ...
  `;qe([m()],Me.prototype,"buildingId",2);qe([d()],Me.prototype,"tree",2);qe([d()],Me.prototype,"selected",2);qe([d()],Me.prototype,"tab",2);qe([d()],Me.prototype,"dialog",2);qe([d()],Me.prototype,"busy",2);qe([d()],Me.prototype,"error",2);qe([d()],Me.prototype,"formName",2);qe([d()],Me.prototype,"formLevel",2);Me=qe([_("explore-floors")],Me);var Ml=Object.defineProperty,Al=Object.getOwnPropertyDescriptor,Ji=(e,t,s,i)=>{for(var a=i>1?void 0:i?Al(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&Ml(t,s,a),a};let $s=class extends ${constructor(){super(...arguments),this.steps=[],this.current=0}render(){return r`${this.steps.map((e,t)=>r`
  ...
  `;Ji([m({attribute:!1})],$s.prototype,"steps",2);Ji([m({type:Number})],$s.prototype,"current",2);$s=Ji([_("sw-steps")],$s);var Pl=Object.defineProperty,Il=Object.getOwnPropertyDescriptor,te=(e,t,s,i)=>{for(var a=i>1?void 0:i?Il(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&Pl(t,s,a),a};const hi=["קובץ","עמוד","חיתוך וסיבוב","שם והערות","שמירה ופרסום"];function xa(e){return e>=1024*1024?`${(e/1024/1024).toFixed(1)} MB`:`${Math.max(1,Math.round(e/1024))} KB`}let G=class extends ${constructor(){super(...arguments),this.floorId="",this.step=0,this.tree=null,this.assets=[],this.asset=null,this.page=1,this.rotation=0,this.crop={x:0,y:0,w:1,h:1},this.notes="",this.version=null,this.busy=!1,this.error="",this.dragOver=!1,this.dxf=null,this.dxfLayers=null,this.dxfUnits=null,this.dxfBusy=!1,this.previewBust=0,this.startCrop=e=>{if(e.button!==0)return;const t=e.currentTarget,s=t.getBoundingClientRect(),i=l=>({x:Math.min(1,Math.max(0,(l.clientX-s.left)/s.width)),y:Math.min(1,Math.max(0,(l.clientY-s.top)/s.height))}),a=i(e);t.setPointerCapture(e.pointerId),e.preventDefault();const n=l=>{const p=i(l),f=Math.min(a.x,p.x),u=Math.min(a.y,p.y),v=Math.abs(p.x-a.x),S=Math.abs(p.y-a.y);v>.01&&S>.01&&(this.crop={x:+f.toFixed(4),y:+u.toFixed(4),w:+v.toFixed(4),h:+S.toFixed(4)})},o=()=>{t.removeEventListener("pointermove",n),t.removeEventListener("pointerup",o),t.removeEventListener("pointercancel",o),(this.crop.w<.02||this.crop.h<.02)&&(this.crop={x:0,y:0,w:1,h:1})};t.addEventListener("pointermove",n),t.addEventListener("pointerup",o),t.addEventListener("pointercancel",o)}}connectedCallback(){super.connectedCallback(),this.init()}async init(){try{this.tree=await gt(),g()&&this.floorId&&(this.assets=(await $o(this.floorId)).assets)}catch(e){this.error=w(e)}}get floor(){return this.tree&&this.floorId?wr(this.tree,this.floorId):null}updated(e){if(e.has("asset")&&g()){const t=this.asset;t&&t.kind==="dxf"&&(!this.dxf||this.dxf.asset_id!==t.id)?this.loadDxf(t.id):(!t||t.kind!=="dxf")&&(this.dxf=null)}}async loadDxf(e){try{const t=await Eo(e);this.dxf=t,this.dxfLayers=t.options.layers,this.dxfUnits=t.options.units??(t.info?.units&&t.info.units!=="unitless"?t.info.units:null)}catch(t){this.error=w(t)}}toggleDxfLayer(e){const t=this.dxf?.info?.layers.filter(i=>i.drawable>0).map(i=>i.name)??[],s=this.dxfLayers??t;this.dxfLayers=s.includes(e)?s.filter(i=>i!==e):[...s,e]}async applyDxf(){if(this.dxf){this.dxfBusy=!0,this.error="";try{const e=this.dxf.info?.layers.filter(s=>s.drawable>0).map(s=>s.name)??[],t=this.dxfLayers&&this.dxfLayers.length!==e.length?this.dxfLayers:null;this.dxf=await Co(this.dxf.asset_id,{layers:t,units:this.dxfUnits}),this.dxfLayers=this.dxf.options.layers,this.previewBust=Date.now()}catch(e){this.error=w(e)}finally{this.dxfBusy=!1}}}renderDxf(){const e=this.dxf;if(!e||!e.info)return c;const t=e.info.layers.filter(l=>l.drawable>0).map(l=>l.name),s=this.dxfLayers??t,i=e.info.extent,a=Object.entries(e.render?.skipped??e.info.unsupported),n=e.render?.meters_per_px,o=e.render?.units&&e.render.units!=="unitless";return r`<sw-card heading="DXF · שכבות, יחידות וקנה מידה" subheading=${`${e.adapter.library} (${e.adapter.license}) · המקור נשמר כפי שהועלה; התצוגה נגזרת ממנו`} data-dxf>
    ...
    </sw-card>`}async onFile(e){if(!(!e||!this.floorId)){this.busy=!0,this.error="";try{this.asset=await xo(this.floorId,e),this.page=1,this.rotation=0,this.crop={x:0,y:0,w:1,h:1},this.version=null,this.step=this.asset.page_count>1?1:2,this.assets=[this.asset,...this.assets.filter(t=>t.id!==this.asset.id)]}catch(t){this.error=w(t)}finally{this.busy=!1}}}async save(){if(!(!this.asset||!this.floorId)){this.busy=!0,this.error="";try{const e=this.crop.x===0&&this.crop.y===0&&this.crop.w===1&&this.crop.h===1;this.version=await _o(this.floorId,{asset_id:this.asset.id,page:this.page,rotation:this.rotation,crop:e?null:this.crop,notes:this.notes})}catch(e){this.error=w(e)}finally{this.busy=!1}}}async publish(){if(this.version){this.busy=!0,this.error="";try{this.version=await Ci(this.version.id)}catch(e){this.error=w(e)}finally{this.busy=!1}}}setCrop(e,t){const s=Math.max(0,Math.min(100,t))/100,i={...this.crop,[e]:s};i.x+i.w>1&&(i.w=1-i.x),i.y+i.h>1&&(i.h=1-i.y),i.w<=.02&&(i.w=.02),i.h<=.02&&(i.h=.02),this.crop=i}previewUrl(){const e=this.asset?.pages.find(s=>s.page===this.page)??this.asset?.pages[0];if(!e)return"";const t=Qe(e.preview_url)+(this.previewBust?`${e.preview_url.includes("?")?"&":"?"}v=${this.previewBust}`:"");return this.rotation?`${t}${t.includes("?")?"&":"?"}rotation=${this.rotation}`:t}renderStep(){const e=this.asset;switch(this.step){case 0:return r`
  ...
  `;te([m()],G.prototype,"floorId",2);te([d()],G.prototype,"step",2);te([d()],G.prototype,"tree",2);te([d()],G.prototype,"assets",2);te([d()],G.prototype,"asset",2);te([d()],G.prototype,"page",2);te([d()],G.prototype,"rotation",2);te([d()],G.prototype,"crop",2);te([d()],G.prototype,"notes",2);te([d()],G.prototype,"version",2);te([d()],G.prototype,"busy",2);te([d()],G.prototype,"error",2);te([d()],G.prototype,"dragOver",2);te([d()],G.prototype,"dxf",2);te([d()],G.prototype,"dxfLayers",2);te([d()],G.prototype,"dxfUnits",2);te([d()],G.prototype,"dxfBusy",2);te([d()],G.prototype,"previewBust",2);G=te([_("explore-plan-import")],G);const ui={white:"לבן",tint:"גוון לכל חדר",none:"ללא מילוי"};async function El(e,t){const s=await A(`plan-versions/${e}/stylize`,t);return{...s,source_url:Qe(s.source_url)+`?v=${Date.now()}`,stylized_url:Qe(s.stylized_url)+`?v=${Date.now()}`}}const Cl=(e,t)=>Be(`plan-versions/${e}`,{render_mode:t});var Tl=Object.defineProperty,Dl=Object.getOwnPropertyDescriptor,T=(e,t,s,i)=>{for(var a=i>1?void 0:i?Dl(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&Tl(t,s,a),a};const Cs=["#2767ED","#22A06B","#F59E0B","#8B5CF6","#0EA5E9","#EC4899","#14B8A6","#F97316"],Ol=[{id:"select",icon:"target",label:"בחירה וגרירה",ready:!0},{id:"camera",icon:"camera",label:"הוספת מצלמה",ready:!0},{id:"lights",icon:"light",label:"הוספת תאורה (מפסקים)",ready:!0},{id:"entity",icon:"plus",label:"ישות HA אחרת",ready:!0},{id:"zones",icon:"map",label:"חדרים ואזורים",ready:!0},{id:"layers",icon:"layers",label:"שכבות",ready:!0}],ka=[{id:"cameras",label:"מצלמות"},{id:"doors",label:"דלתות ומנעולים"},{id:"lights",label:"תאורה ומתגים"},{id:"sensors",label:"חיישנים"}],Rl={asset:"קובץ",page:"עמוד",rotation:"סיבוב",crop:"חיתוך",width_px:"רוחב",height_px:"גובה"},mi=e=>e?new Intl.DateTimeFormat("he-IL",{dateStyle:"short",timeStyle:"short"}).format(new Date(e)):"";let E=class extends ${constructor(){super(...arguments),this.floorId="",this.presetEntity="",this.bundle=null,this.anchors=[],this.dirty=new Set,this.undo=[],this.redo=[],this.selectedId=null,this.tool="select",this.layers=new Set(["cameras","doors","lights","sensors"]),this.placing=null,this.entQ="",this.entResults=null,this.entBusy=!1,this.lightsAll=!1,this.busy=!1,this.error="",this.info="",this.stylizing=!1,this.stylized=null,this.stylizeOpts={strength:"medium",keepLines:!1,roomFill:"white"},this.zones=[],this.versions=[],this.diff=null,this.selectedZoneId=null,this.candidates=null,this.detecting=!1,this.detectStrength="medium",this.replaceAuto=!0,this.drawing=null,this.showZones=!0,this.zoneBusy=!1,this.entTimer=0,this.onKey=e=>this.handleKey(e)}connectedCallback(){super.connectedCallback(),this.load(),window.addEventListener("keydown",this.onKey),this.presetEntity&&(this.tool="entity",this.entQ=this.presetEntity,this.searchEntities())}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("keydown",this.onKey)}async load(){this.error="";try{const e=await bs(this.floorId||"f0",!0);this.bundle=e,this.anchors=e.anchors.map(t=>({...t,position:{...t.position}})),this.zones=e.zones,this.loadVersions(),this.selectedZoneId&&!this.zones.some(t=>t.id===this.selectedZoneId)&&(this.selectedZoneId=null),this.dirty=new Set,this.undo=[],this.redo=[],this.selectedId&&!this.anchors.some(t=>t.id===this.selectedId)&&(this.selectedId=null)}catch(e){this.error=w(e)}}get selected(){return this.anchors.find(e=>e.id===this.selectedId)}layerOf(e){return e.resource_type==="camera"?"cameras":e.layer_id==="doors"?"doors":e.layer_id==="lights"?"lights":"sensors"}get markers(){return this.anchors.filter(e=>this.layers.has(this.layerOf(e))).map(e=>({id:e.id,kind:e.resource_type==="camera"?"camera":ai(e.layer_id,e.entity?.domain),label:this.anchorName(e),x:e.position.x,y:e.position.y,rotation:e.rotation_degrees,fov:e.field_of_view_degrees??void 0,radius:e.coverage_radius??void 0,polygon:e.coverage_polygon?e.coverage_polygon.map(([t,s])=>({x:t,y:s})):void 0,state:e.resource_type==="camera"?this.bundle?.source==="demo"?"live":os(e):"neutral"}))}anchorName(e){return e.resource_type==="camera"?e.camera?.name??e.label??e.resource_id:e.label??e.entity?.name??e.resource_id}get selectedZone(){return this.zones.find(e=>e.id===this.selectedZoneId)}get planZones(){if(!this.showZones)return[];const e=this.zones.map(s=>({id:s.id,name:s.name,kind:s.kind,color:s.color,polygon:s.polygon})),t=(this.candidates??[]).map((s,i)=>({id:`cand-${i}`,name:s.include?s.name:"",color:s.include?Cs[i%Cs.length]:"#9AA3B5",polygon:s.polygon,candidate:!0}));return[...e,...t]}async detect(){const e=this.bundle;if(e){if(e.source==="demo"){this.info="נתוני הדגמה: הזיהוי עובד מול השרת.";return}this.detecting=!0,this.error="";try{const t=await Yo(e.floorId,this.detectStrength);this.candidates=t.rooms.map((s,i)=>({polygon:s.polygon,name:`חדר ${i+1}`,kind:"room",include:!0})),this.selectedZoneId=null,this.selectedId=null,this.info=t.rooms.length?`${t.rooms.length} חדרים זוהו · תן שמות ושמור`:"לא זוהו חדרים סגורים; נסה עוצמה אחרת או צייר אזור ידנית",setTimeout(()=>this.info="",5e3)}catch(t){this.error=w(t)}finally{this.detecting=!1}}}setCandidate(e,t){this.candidates&&(this.candidates=this.candidates.map((s,i)=>i===e?{...s,...t}:s))}async acceptCandidates(){const e=this.bundle,t=(this.candidates??[]).filter(s=>s.include);if(!(!e||!t.length)){this.zoneBusy=!0,this.error="";try{const s=await Jo(e.floorId,t.map(i=>({polygon:i.polygon,name:i.name,kind:i.kind})),this.replaceAuto);this.candidates=null,this.zones=s.zones,this.info=`${s.created.length} חדרים נשמרו`,setTimeout(()=>this.info="",3e3)}catch(s){this.error=w(s)}finally{this.zoneBusy=!1}}}startDrawing(){this.drawing=[],this.placing=null,this.candidates=null,this.selectedZoneId=null,this.selectedId=null}addDraftPoint(e,t){const s=this.drawing,i=this.bundle;if(!(!s||!i)){if(s.length>=3){const a=this.canvas?.zoom??1;if(Math.hypot((e-s[0].x)*i.width*a,(t-s[0].y)*i.height*a)<12){this.finishDrawing();return}}this.drawing=[...s,{x:+e.toFixed(4),y:+t.toFixed(4)}]}}async finishDrawing(){const e=this.drawing,t=this.bundle;if(!(!e||!t||e.length<3)){if(t.source==="demo"){this.info="נתוני הדגמה: השמירה עובדת מול השרת.",this.drawing=null;return}this.zoneBusy=!0,this.error="";try{const s=await qo(t.floorId,{name:`אזור ${this.zones.length+1}`,kind:"zone",polygon:e});this.drawing=null,this.zones=[...this.zones,s],this.selectedZoneId=s.id,this.info="האזור נוצר · תן לו שם",setTimeout(()=>this.info="",3e3)}catch(s){this.error=w(s)}finally{this.zoneBusy=!1}}}async patchZone(e,t){if(this.bundle?.source!=="demo"){this.zoneBusy=!0,this.error="";try{const s=await Ko(e.id,{revision:e.revision,...t});this.zones=this.zones.map(i=>i.id===s.id?s:i)}catch(s){s instanceof xe&&s.status===409?(this.error="האזור השתנה בינתיים על ידי עורך אחר; נטען מחדש בלי לדרוס.",await this.load()):this.error=w(s)}finally{this.zoneBusy=!1}}}async removeZone(e){if(this.bundle?.source!=="demo"&&window.confirm(`למחוק את "${e.name}"? המצלמות והישויות בקומה לא מושפעות.`)){this.zoneBusy=!0,this.error="";try{await Go(e.id),this.zones=this.zones.filter(t=>t.id!==e.id),this.selectedZoneId===e.id&&(this.selectedZoneId=null)}catch(t){this.error=w(t)}finally{this.zoneBusy=!1}}}snapshot(){this.undo=[...this.undo.slice(-40),this.anchors.map(e=>({...e,position:{...e.position}}))],this.redo=[]}apply(e,t){this.snapshot(),this.anchors=this.anchors.map(s=>s.id===e?{...s,...t,position:t.position??s.position}:s),this.dirty=new Set(this.dirty).add(e)}nudge(e,t){const s=this.selected;s&&this.apply(s.id,{position:{x:+Math.min(1,Math.max(0,s.position.x+e)).toFixed(4),y:+Math.min(1,Math.max(0,s.position.y+t)).toFixed(4)}})}doUndo(){const e=this.undo[this.undo.length-1];e&&(this.redo=[...this.redo,this.anchors],this.undo=this.undo.slice(0,-1),this.anchors=e,this.dirty=new Set(this.anchors.map(t=>t.id)))}doRedo(){const e=this.redo[this.redo.length-1];e&&(this.undo=[...this.undo,this.anchors],this.redo=this.redo.slice(0,-1),this.anchors=e,this.dirty=new Set(this.anchors.map(t=>t.id)))}handleKey(e){const t=e.composedPath()[0],s=t&&(t.tagName==="INPUT"||t.tagName==="TEXTAREA"||t.tagName==="SELECT"||t.isContentEditable);if(e.key==="Escape"){this.drawing?this.drawing=null:this.placing?this.placing=null:this.candidates?this.candidates=null:(this.selectedId=null,this.selectedZoneId=null);return}if(s)return;if(e.key==="Enter"&&this.drawing){e.preventDefault(),this.finishDrawing();return}if((e.key==="Delete"||e.key==="Backspace")&&!this.selected&&this.selectedZone){e.preventDefault(),this.removeZone(this.selectedZone);return}if((e.ctrlKey||e.metaKey)&&e.key.toLowerCase()==="z"){e.preventDefault(),e.shiftKey?this.doRedo():this.doUndo();return}if((e.ctrlKey||e.metaKey)&&e.key.toLowerCase()==="y"){e.preventDefault(),this.doRedo();return}if((e.ctrlKey||e.metaKey)&&e.key.toLowerCase()==="s"){e.preventDefault(),this.save();return}if(!this.selected)return;const i=e.shiftKey?.01:.002;e.key==="ArrowLeft"?(e.preventDefault(),this.nudge(-i,0)):e.key==="ArrowRight"?(e.preventDefault(),this.nudge(i,0)):e.key==="ArrowUp"?(e.preventDefault(),this.nudge(0,-i)):e.key==="ArrowDown"?(e.preventDefault(),this.nudge(0,i)):(e.key==="Delete"||e.key==="Backspace")&&(e.preventDefault(),this.removeSelected())}async save(){if(!this.bundle||this.bundle.source==="demo")return this.info="נתוני הדגמה: השינויים נשמרים רק במסך זה.",this.dirty=new Set,!0;if(!this.dirty.size)return!0;this.busy=!0,this.error="";let e=!1;try{for(const t of this.dirty){const s=this.anchors.find(i=>i.id===t);if(s)try{const i=await mr(t,{revision:s.revision,x:s.position.x,y:s.position.y,rotation_degrees:s.rotation_degrees,field_of_view_degrees:s.field_of_view_degrees,label:s.label,coverage_radius:s.coverage_radius??null,coverage_polygon:s.coverage_polygon??null});this.anchors=this.anchors.map(a=>a.id===t?{...a,revision:i.revision}:a)}catch(i){if(i instanceof xe&&i.code==="stale_revision")e=!0;else throw i}}return e?(this.error="חלק מהפריטים השתנו בינתיים על ידי עורך אחר; המפה נטענה מחדש בלי לדרוס את השינוי שלו.",await this.load(),!1):(this.dirty=new Set,this.info="המיקומים נשמרו",setTimeout(()=>this.info="",2500),!0)}catch(t){return this.error=w(t),!1}finally{this.busy=!1}}async place(e,t){const s=this.placing;if(!(!s||!this.bundle)){if(this.bundle.source==="demo"){this.info="נתוני הדגמה: הוספה עובדת מול השרת.",this.placing=null;return}if(!(this.dirty.size&&!await this.save())){this.busy=!0,this.error="";try{const i=s.kind==="camera"?await ga(this.bundle.floorId,{resource_type:"camera",resource_id:s.camera.id,x:e,y:t,rotation_degrees:0,field_of_view_degrees:90}):await ga(this.bundle.floorId,{resource_type:"ha_entity",resource_id:s.entity.entity_id,x:e,y:t,rotation_degrees:0,field_of_view_degrees:null});this.placing=null,await this.load(),this.selectedId=i.id,this.tool="select",this.info=`${this.anchorName(i)} הוצב · גרור לדיוק, קבע כיוון בידיות`,setTimeout(()=>this.info="",4e3)}catch(i){this.error=w(i)}finally{this.busy=!1}}}}async removeSelected(){const e=this.selected;if(!(!e||!this.bundle)){if(this.bundle.source==="demo"){this.info="נתוני הדגמה: הסרה עובדת מול השרת.";return}if(window.confirm(`להסיר את "${this.anchorName(e)}" מהמפה? המקור עצמו לא נמחק.`)){this.busy=!0,this.error="";try{await Mo(e.id),this.selectedId=null,await this.load()}catch(t){this.error=w(t)}finally{this.busy=!1}}}}async loadVersions(){const e=this.bundle;if(!e||e.source==="demo"||!e.permissions.edit){this.versions=[];return}try{this.versions=(await ko(e.floorId)).versions}catch{this.versions=[]}}async publish(){if(!this.bundle?.planVersionId||this.dirty.size&&!await this.save())return;const e=this.versions.find(t=>t.id===this.bundle?.planVersionId);if(!e){await this.publishNow(this.bundle.planVersionId);return}await this.openDiff("publish",e)}async publishNow(e){this.busy=!0,this.error="";try{await Ci(e),this.info="הגרסה פורסמה; הצופים רואים אותה עכשיו",await this.load()}catch(t){this.error=w(t)}finally{this.busy=!1}}async openDiff(e,t){this.diff={mode:e,version:t,data:null,error:""};try{const s=await zo(t.id);this.diff?.version.id===t.id&&(this.diff={mode:e,version:t,data:s,error:""})}catch(s){this.diff={mode:e,version:t,data:null,error:w(s)}}}async confirmDiff(){const e=this.diff;if(!(!e?.data||e.mode==="compare")){this.busy=!0,this.error="";try{e.mode==="publish"?(await Ci(e.version.id),this.info="הגרסה פורסמה; הצופים רואים אותה עכשיו"):(await So(e.version.id,e.version.revision,e.data.from?.id??null),this.info="הגרסה שוחזרה ופורסמה מחדש; העוגנים נשמרו"),this.diff=null,await this.load(),setTimeout(()=>this.info="",4e3)}catch(t){this.diff={...e,error:w(t)},t instanceof xe&&t.status===409&&this.loadVersions()}finally{this.busy=!1}}}async searchEntities(){if(this.bundle?.source!=="demo"){this.entBusy=!0;try{const e=this.tool==="lights",t=await $r({q:this.entQ||void 0,domain:e&&!this.lightsAll?"switch":void 0,limit:e?200:40});this.entResults=e?t.entities.filter(s=>s.domain==="switch"||this.lightsAll&&s.domain==="light").slice(0,60):t.entities}catch(e){this.error=w(e),this.entResults=[]}finally{this.entBusy=!1}}}onEntQuery(e){this.entQ=e,window.clearTimeout(this.entTimer),this.entTimer=window.setTimeout(()=>void this.searchEntities(),250)}async stylize(e,t){if(!this.bundle?.planVersionId||this.bundle.source==="demo")return;const s=this.stylizeOpts;(e!==void 0||t!==void 0)&&(this.stylizeOpts={...s,strength:e??s.strength,keepLines:t??s.keepLines}),this.stylizing=!0,this.error="";try{this.stylized=await El(this.bundle.planVersionId,{strength:this.stylizeOpts.strength,keep_lines:this.stylizeOpts.keepLines,room_fill:this.stylizeOpts.roomFill})}catch(i){this.error=w(i)}finally{this.stylizing=!1}}async useRender(e){if(this.bundle?.planVersionId){this.busy=!0,this.error="";try{await Cl(this.bundle.planVersionId,e),this.stylized=null,await this.load(),this.info=e==="stylized"?"המפה מציגה עכשיו את שפת SMPLWISE":"המפה מציגה את תוכנית המקור",setTimeout(()=>this.info="",3e3)}catch(t){this.error=w(t)}finally{this.busy=!1}}}pickTool(e){this.tool=e,this.placing=null,(e==="entity"||e==="lights")&&(this.entResults=null,this.searchEntities())}renderCoverage(e){const t=e.coverage_polygon,s=e.coverage_radius??0,i=Math.round((s||.1)*100),a=()=>{const n=e.field_of_view_degrees??90,o=s||.1,l=this.bundle&&this.bundle.height?this.bundle.width/this.bundle.height:1,p=[[e.position.x,e.position.y]],f=Math.max(3,Math.round(n/15));for(let u=0;u<=f;u++){const v=(e.rotation_degrees-n/2+n*u/f-90)*Math.PI/180;p.push([+Math.max(0,Math.min(1,e.position.x+Math.cos(v)*o)).toFixed(4),+Math.max(0,Math.min(1,e.position.y+Math.sin(v)*o*l)).toFixed(4)])}this.apply(e.id,{coverage_polygon:p})};return r`<div class="row" data-coverage style="flex-direction:column;align-items:stretch;gap:6px">
      ...
      ${t?r`<div class="kv"><span class="k">מצב עכשיו</span><span>${ft(t)}</span></div><div class="kv"><span class="k">סוג</span><span>${ys(t.domain)}</span></div>`:c}
      <sw-field label="שכבה" style="margin-block-start:8px"><select @change=${s=>this.apply(e.id,{layer_id:s.target.value})}>${ka.filter(s=>s.id!=="cameras").map(s=>r`<option value=${s.id} ?selected=${e.layer_id===s.id}>${s.label}</option>`)}</select></sw-field>
      <div class="two">
      ...
      <div class="two">
        <sw-field label="סוג"><select @change=${i=>this.patchZone(e,{kind:i.target.value})}>${Ti.map(i=>r`<option value=${i.id} ?selected=${e.kind===i.id}>${i.label}</option>`)}</select></sw-field>
      ...
      ${t?r`<div class="note">${t.length} חדרים זוהו · סמן, תן שם ושמור. הפוליגונים מוצגים במפה בקו מקווקו.</div>
            <div class="candlist">${t.map((i,a)=>r`<div class="cand" data-candidate><input type="checkbox" .checked=${i.include} aria-label="כלול" @change=${n=>this.setCandidate(a,{include:n.target.checked})} /><i class="sw" style="background:${Cs[a%Cs.length]}"></i><input class="name" .value=${i.name} placeholder="שם החדר" aria-label="שם החדר" @input=${n=>this.setCandidate(a,{name:n.target.value})} /><select aria-label="סוג" @change=${n=>this.setCandidate(a,{kind:n.target.value})}>${Ti.map(n=>r`<option value=${n.id} ?selected=${i.kind===n.id}>${n.label}</option>`)}</select></div>`)}</div>
      ...
      ${t?r`<div class="compare">
              <div><div class="note">${t.from?`מפורסמת · ${mi(t.from.published_at??t.from.created_at)}`:"אין גרסה מפורסמת"}</div>${t.from?r`<img src=${Qe(t.from.image_url)} alt="הגרסה המפורסמת" />`:r`<div class="note">—</div>`}</div>
              <div><div class="note">${e.mode==="rollback"?"לשחזור":"חדשה"} · ${mi(t.to.published_at??t.to.created_at)}</div><img src=${Qe(t.to.image_url)} alt="הגרסה החדשה" /></div>
            </div>
            <div class="dsum" data-diff-summary>
              ${t.from?t.geometry.same?r`<sw-badge kind="recorded" label="גאומטריה זהה"></sw-badge>`:r`<sw-badge kind="partial" label=${`שינוי: ${t.geometry.changes.map(a=>Rl[a.field]??a.field).join(", ")}`}></sw-badge>`:r`<sw-badge kind="neutral" label="פרסום ראשון"></sw-badge>`}
        ...
        ${e.planStatus==="none"?r`<sw-state-panel state="empty" heading="לקומה אין תוכנית" hint="העלה תוכנית קודם; אחר כך אפשר להציב מצלמות וישויות."><div style="margin-block-start:10px"><sw-button variant="primary" icon="upload" @click=${()=>b(`/explore/floors/${e.floorId}/import`)}>העלאת תוכנית</sw-button></div></sw-state-panel>`:r`<div class="layout">
              <div class="mapwrap">
                ...
                <div class="rail" role="toolbar" aria-label="כלי עריכה">
                  ${Ol.map(n=>r`<button class=${n.id===this.tool?"on":""} data-tool=${n.id} ?disabled=${!n.ready} title=${n.label} aria-label=${n.label} aria-pressed=${n.id===this.tool} @click=${()=>this.pickTool(n.id)}><sw-icon .name=${n.icon} size=${18}></sw-icon></button>`)}
                  <hr />
  ...
  `;T([m()],E.prototype,"floorId",2);T([m()],E.prototype,"presetEntity",2);T([d()],E.prototype,"bundle",2);T([d()],E.prototype,"anchors",2);T([d()],E.prototype,"dirty",2);T([d()],E.prototype,"undo",2);T([d()],E.prototype,"redo",2);T([d()],E.prototype,"selectedId",2);T([d()],E.prototype,"tool",2);T([d()],E.prototype,"layers",2);T([d()],E.prototype,"placing",2);T([d()],E.prototype,"entQ",2);T([d()],E.prototype,"entResults",2);T([d()],E.prototype,"entBusy",2);T([d()],E.prototype,"lightsAll",2);T([d()],E.prototype,"busy",2);T([d()],E.prototype,"error",2);T([d()],E.prototype,"info",2);T([d()],E.prototype,"stylizing",2);T([d()],E.prototype,"stylized",2);T([d()],E.prototype,"stylizeOpts",2);T([d()],E.prototype,"zones",2);T([d()],E.prototype,"versions",2);T([d()],E.prototype,"diff",2);T([d()],E.prototype,"selectedZoneId",2);T([d()],E.prototype,"candidates",2);T([d()],E.prototype,"detecting",2);T([d()],E.prototype,"detectStrength",2);T([d()],E.prototype,"replaceAuto",2);T([d()],E.prototype,"drawing",2);T([d()],E.prototype,"showZones",2);T([d()],E.prototype,"zoneBusy",2);T([Yt("sw-plan-canvas")],E.prototype,"canvas",2);E=T([_("explore-plan-editor")],E);var Nl=Object.defineProperty,Ll=Object.getOwnPropertyDescriptor,Ot=(e,t,s,i)=>{for(var a=i>1?void 0:i?Ll(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&Nl(t,s,a),a};let tt=class extends ${constructor(){super(...arguments),this.columns=[],this.rows=[],this.rowKey="id",this.selected=null,this.emptyText="אין שורות להצגה",this.dense=!1}pick(e){const t=String(e[this.rowKey]??"");this.dispatchEvent(new CustomEvent("row-select",{detail:{id:t,row:e},bubbles:!0,composed:!0}))}render(){return this.rows.length?r`
    ...
    `:r`<div class="empty">${this.emptyText}</div>`}};tt.styles=k`
    :host {
      display: block;
      background: var(--sw-surface);
      border: 1px solid var(--sw-border);
  ...
  `;He([d()],ke.prototype,"selected",2);He([d()],ke.prototype,"domain",2);He([d()],ke.prototype,"q",2);He([d()],ke.prototype,"area",2);He([d()],ke.prototype,"onlyPlaced",2);He([d()],ke.prototype,"cat",2);He([d()],ke.prototype,"error",2);He([d()],ke.prototype,"loading",2);He([d()],ke.prototype,"sync",2);He([d()],ke.prototype,"firstFloorId",2);ke=He([_("explore-entities")],ke);var jl=Object.defineProperty,Fl=Object.getOwnPropertyDescriptor,kr=(e,t,s,i)=>{for(var a=i>1?void 0:i?Fl(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&jl(t,s,a),a};const fi=[{id:"d1",name:"כניסה ראשית",kind:"דלת זכוכית",lock:"נעול",contact:"סגור",relay:"לא פעיל",ringing:!1,scene:"entrance"},{id:"d2",name:"לובי",kind:"דלת פנימית",lock:"פתוח",contact:"פתוח",relay:"לא פעיל",ringing:!1,scene:"lobby"},{id:"d3",name:"אינטרקום M2",kind:"עמדת דלת",lock:"נעול",contact:"סגור",relay:"לא פעיל",ringing:!0,scene:"entrance"},{id:"d4",name:"מחסן",kind:"דלת שירות",lock:"נעול",contact:"סגור",relay:"לא פעיל",ringing:!1,scene:"warehouse"}];let Ws=class extends ${constructor(){super(...arguments),this.selected="d1"}render(){if(g())return r`<sw-page heading="דלתות ואינטרקום" subheading="V1 · מצלמה, צלצול, מגע דלת וממסר הם ארבעה נתונים שונים">
  ...
  `;kr([d()],Ws.prototype,"selected",2);Ws=kr([_("explore-access")],Ws);var Ul=Object.defineProperty,Wl=Object.getOwnPropertyDescriptor,Rt=(e,t,s,i)=>{for(var a=i>1?void 0:i?Wl(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&Ul(t,s,a),a};let st=class extends ${constructor(){super(...arguments),this.label="",this.value="",this.detail="",this.icon="info",this.tone="neutral",this.badge=""}render(){return r`
  ...
  `;Rt([m()],st.prototype,"label",2);Rt([m()],st.prototype,"value",2);Rt([m()],st.prototype,"detail",2);Rt([m()],st.prototype,"icon",2);Rt([m({reflect:!0})],st.prototype,"tone",2);Rt([m()],st.prototype,"badge",2);st=Rt([_("sw-kpi")],st);function ri(e={}){const t=new URLSearchParams;e.date&&t.set("date",e.date),e.from&&e.to&&(t.set("from",e.from),t.set("to",e.to)),e.acked&&t.set("acked","true"),e.cameraId&&t.set("camera_id",e.cameraId),e.type&&t.set("type",e.type),e.unacked&&t.set("unacked","true"),e.limit&&t.set("limit",String(e.limit)),e.floorId&&t.set("floor_id",e.floorId),e.zoneId&&t.set("zone_id",e.zoneId),e.buildingId&&t.set("building_id",e.buildingId),e.siteId&&t.set("site_id",e.siteId),e.source&&t.set("source",e.source),e.severity&&t.set("severity",e.severity);const s=t.toString();return z(`events${s?`?${s}`:""}`)}const Zl=()=>z("events/summary"),ql=(e,t)=>z(`cameras/${e}/events?date=${t}`),_r=e=>A(`events/${e}/ack`),_a=e=>A("events/ack-many",{event_ids:e}),za={camera:"לפי מצלמה",all:"כל המצלמות יחד",zone:"לפי חדר",floor:"לפי קומה"};function Kl(e={}){const t=new URLSearchParams;e.date&&t.set("date",e.date),e.cameraId&&t.set("camera_id",e.cameraId),e.gap&&t.set("gap",String(e.gap)),e.by&&t.set("by",e.by),e.limit&&t.set("limit",String(e.limit));const s=t.toString();return z(`events/windows${s?`?${s}`:""}`)}const Gl=e=>z(`events/${e}`),zt=(e,t=0)=>ce(`events/${e}/thumbnail${t?`?v=${t}`:""}`);async function zr(e){try{const t=await fetch(zt(e),{credentials:"include",cache:"no-store"});return t.status===200?"ready":t.status===202?"pending":"unavailable"}catch{return"pending"}}const K={motion:"תנועה",person:"אדם",vehicle:"רכב",line:"חציית קו",field:"חדירה לאזור",offline:"אובדן וידאו",tamper:"חבלה במצלמה",door:"דלת",io:"כניסת חיווי",storage:"אחסון",system:"מערכת",coverage_gap:"פער בקליטת אירועים",manual:"הקלטה ידנית",other:"אחר"},Bs={motion:"#ef4444",person:"#2f6bff",vehicle:"#22c55e",line:"#f59e0b",field:"#f59e0b",offline:"#6b7280",tamper:"#b45309",door:"#8b5cf6",io:"#8b5cf6",storage:"#6b7280",system:"#6b7280",coverage_gap:"#6b7280",manual:"#2f6bff",other:"#6b7280"};function Yl(e){return e==="person"||e==="vehicle"||e==="motion"||e==="line"||e==="offline"||e==="door"?e:e==="field"?"line":e==="io"?"door":e==="tamper"||e==="coverage_gap"||e==="storage"||e==="system"?"offline":"motion"}function Jl(e,t){let s=null,i=!1,a=2e3;const n=(()=>{const l=new URL(ce("events/ws"));return l.protocol=l.protocol==="https:"?"wss:":"ws:",l.toString()})(),o=()=>{if(!i){try{s=new WebSocket(n)}catch{return}s.onopen=()=>{a=2e3,t?.(null,!0)},s.onmessage=l=>{try{const p=JSON.parse(l.data);p.type==="event_added"||p.type==="event_updated"?e(p.payload):p.type==="heartbeat"&&t?.(p.payload.ingest,!0)}catch{}},s.onclose=()=>{t?.(null,!1),i||(window.setTimeout(o,a),a=Math.min(3e4,a*2))}}};return o(),()=>{i=!0,s?.close()}}const Xl={measured:"נמדד",inferred:"נגזר",command:"פקודה",availability:"זמינות"},Ql=(e,t=120)=>z(`events/${e}/correlation?window=${t}`),ed=(e=90)=>z(`events/facets?days=${e}`),Sa={alertstream:"אירוע NVR",recording:"נגזר מהקלטה",system:"מערכת",ha:"חיישן HA"},td=(e,t=90)=>z(`events/${e}/route?window=${t}`),Sr=(e=!1)=>z(`storage${e?"?fresh=true":""}`);function kt(e){return e==null?"—":e>=1024*1024?`${(e/1024/1024).toFixed(2)} TB`:e>=1024?`${(e/1024).toFixed(0)} GB`:`${e} MB`}const cs={ok:"תקין",warn:"לתשומת לב",error:"שגיאה"},Ma={ok:"live",warn:"stale",error:"offline"},Mr=(e=!1)=>z(`health/report${e?"?fresh=1":""}`),Xi=()=>z("health/summary");function sd(e){return e<3600?`${Math.floor(e/60)} דק׳`:e<86400?`${Math.floor(e/3600)} שע׳ ${Math.floor(e%3600/60)} דק׳`:`${Math.floor(e/86400)} ימים ${Math.floor(e%86400/3600)} שע׳`}let Hs=null,Ds=null;const id={"media.transport_default":"mse","media.max_live_sessions":8,"media.wall_profile":"sub","snapshots.max_age_s":60};async function Ve(e=!1){return g()?Hs&&!e?Hs:(Ds||(Ds=ar().then(t=>Hs=t.settings).finally(()=>Ds=null)),Ds):id}function Aa(){Hs=null}function Qi(e){return rr()||e?.["media.transport_default"]||"mse"}var ad=Object.defineProperty,rd=Object.getOwnPropertyDescriptor,Ce=(e,t,s,i)=>{for(var a=i>1?void 0:i?rd(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&ad(t,s,a),a};function nd(e){return e<5?"לילה טוב":e<12?"בוקר טוב":e<17?"צהריים טובים":e<21?"ערב טוב":"לילה טוב"}const od={person:"var(--sw-accent)",vehicle:"var(--sw-live)",motion:"var(--sw-danger)",line:"var(--sw-stale)",offline:"var(--sw-offline)",door:"var(--sw-purple)"},ld={"כניסה ראשית":"entrance","חצר אחורית":"backyard",מחסן:"warehouse",לובי:"lobby","חניה מקורה":"parking"};let ve=class extends ${constructor(){super(...arguments),this.cams=null,this.recorder=null,this.sites=null,this.summary=null,this.recent=[],this.storage=null,this.health=null,this.raw=null,this.tz="Asia/Jerusalem",this.now=new Date,this.loaded=!1,this.timer=0,this.clockTimer=0}connectedCallback(){super.connectedCallback(),g()&&(this.load(),this.timer=window.setInterval(()=>void this.load(),6e4),this.clockTimer=window.setInterval(()=>this.now=new Date,3e4))}disconnectedCallback(){window.clearInterval(this.timer),window.clearInterval(this.clockTimer),super.disconnectedCallback()}async load(){this.loadStorage();const[e,t,s,i,a,n,o]=await Promise.allSettled([Ve(),Ee(),z("sites?tree=true"),Zl(),ri({limit:6}),Xi(),z("health")]);e.status==="fulfilled"&&(this.tz=e.value["time.zone"]??this.tz),t.status==="fulfilled"?(this.cams=t.value.cameras.filter(l=>l.enabled),this.recorder=t.value.recorder):this.cams===null&&(this.cams=[]),s.status==="fulfilled"?this.sites=s.value.sites:this.sites===null&&(this.sites=[]),i.status==="fulfilled"&&(this.summary=i.value),a.status==="fulfilled"&&(this.recent=a.value.events),n.status==="fulfilled"&&(this.health=n.value),o.status==="fulfilled"&&(this.raw=o.value),this.loaded=!0,this.now=new Date}async loadStorage(){try{this.storage=await Sr()}catch{this.storage=null}}fmtTime(e){return new Date(e).toLocaleTimeString("he-IL",{hour:"2-digit",minute:"2-digit",timeZone:this.tz})}spots(){const e=[],t=this.cams??[];for(const a of t.filter(n=>n.status==="offline"))e.push({kind:"critical",title:`מצלמה מנותקת: ${a.name}`,meta:`ערוץ ${a.channel}${a.last_seen_at?` · נראתה לאחרונה ${this.fmtTime(a.last_seen_at)}`:""}`,why:"מוצג כי ה־NVR מדווח שהערוץ אינו מחובר",link:`#/live/cameras/${a.id}`});for(const a of(this.health?.items??[]).filter(n=>n.status!=="ok"))e.push({kind:a.status==="error"?"critical":"alert",title:a.label,meta:`בדיקת מערכת · ${cs[a.status]}`,why:"מוצג כי בדיקת הבריאות של ה־Add-on מדווחת על כך",link:"#/system/diagnostics"});const s=this.summary?.today.unacked??0;if(s>0){const a=Object.entries(this.summary?.today.by_type??{}).sort((n,o)=>o[1]-n[1]).slice(0,3).map(([n,o])=>`${K[n]??n} ${o}`).join(" · ");e.push({kind:"alert",title:`${s} אירועים שלא נבדקו היום`,meta:a,why:"מוצג כי אירועים ממתינים לסימון טיפול במרכז האירועים",link:"#/investigate/events"})}const i=this.raw?.events.ingest;return i?.connected&&!i.events_stored&&!i.last_event_at&&e.push({kind:"info",title:"ה־NVR לא שלח התראות מאז ההפעלה",meta:"אירועי תנועה נגזרים מההקלטות כל 10 דקות",why:'מוצג כי זרם ההתראות מחובר אך ריק — ב־NVR יש להפעיל "Notify Surveillance Center" ב־linkage של זיהוי התנועה',link:"#/system/setup"}),this.raw?.home_assistant.configured&&!this.raw.home_assistant.connected&&e.push({kind:"alert",title:"אין חיבור ל־Home Assistant",meta:this.raw.home_assistant.last_error??"",why:"מוצג כי מצבי הישויות והדלתות עלולים להיות מיושנים",link:"#/system/setup"}),e}renderApi(){const e=mt.me?.user,t=e?.display_name||e?.username||"",s=Number(this.now.toLocaleString("en-GB",{hour:"numeric",hour12:!1,timeZone:this.tz})),i=this.cams??[],a=i.filter(M=>M.status==="online").length,n=this.sites??[],o=n.flatMap(M=>(M.buildings??[]).flatMap(se=>se.floors??[])),l=this.health,p=l?l.status==="ok"?"live":l.status==="warn"?"stale":"offline":"neutral",f=l?.items.find(M=>M.status!=="ok"),u=this.loaded?this.spots():[],v=this.storage,S=v?.totals??null,x=S?.used_pct??null,R=34,Y=2*Math.PI*R,Lt=i.filter(M=>M.status==="online").slice(0,2);return r`
      <sw-page heading=${`${nd(s)}${t?`, ${t}`:""}`} subheading=${l?`מצב המערכת: ${cs[l.status]}${f?` · ${f.label}`:" · כל הבדיקות תקינות"}`:"קורא את מצב המערכת…"}>
        ...
        <div class="kpis" data-overview-kpis>
          ...
          <sw-kpi icon="building" value=${String(n.length)} label="אתרים" detail=${`${o.length} קומות · ${o.filter(M=>M.has_plan).length} עם תוכנית`} tone="neutral"></sw-kpi>
        ...
        ${Lt.length?r`<div class="fav" data-overview-favorites>
              ${Lt.map(M=>r`<sw-camera-tile name=${M.name} state="live" cameraId=${M.id} poster=${Ue(M.id)} noDemo @click=${()=>b(`/live/cameras/${M.id}`)}></sw-camera-tile>`)}
            </div>`:c}
        <div class="row2">
          ${v&&S?r`<sw-card heading="אחסון" subheading=${v.cached?"מהמטמון · נמדד מול ה־NVR":"נמדד מול ה־NVR"}>
                <div class="donut">
                  <svg viewBox="0 0 84 84" role="img" aria-label=${`אחסון בשימוש ${x??0}%`}>
                    ${h`<circle cx="42" cy="42" r=${R} fill="none" stroke="var(--sw-surface-3)" stroke-width="9" />
                    <circle cx="42" cy="42" r=${R} fill="none" stroke="var(--sw-accent)" stroke-width="9" stroke-linecap="round" stroke-dasharray=${`${Y*(x??0)/100} ${Y}`} transform="rotate(-90 42 42)" />
                    <text x="42" y="47" text-anchor="middle" font-size="15" font-weight="700" fill="var(--sw-text)" font-family="var(--sw-font)">${x??0}%</text>`}
                  </svg>
                  <div class="txt">
                    <div class="big">${kt(S.used_mb)} מתוך ${kt(S.capacity_mb)}</div>
                    <div class="bar"><i style=${`inline-size:${x??0}%`}></i></div>
                    <div class="muted">${v.retention.measured_days_min!==null?`הקלטה ישנה ביותר ≈ ${v.retention.measured_days_min}${v.retention.measured_days_max!==null&&v.retention.measured_days_max!==v.retention.measured_days_min?`–${v.retention.measured_days_max}`:""} ימים (נמדד)`:v.retention.measured_reason}${v.work_mode?` · ${v.work_mode}`:""} · ${S.disks} דיסקים</div>
                  </div>
                </div>
              </sw-card>`:c}
          <sw-card heading="אתרים ומבנים" subheading=${n.length?`${n.length} אתרים · ${o.length} קומות`:"עדיין לא הוגדרו אתרים"}>
            ${n.map(M=>{const se=(M.buildings??[]).flatMap(ss=>ss.floors??[]),li=se.filter(ss=>ss.has_plan).length,Vr=se.reduce((ss,jr)=>ss+jr.camera_count,0);return r`<div class="hrow" @click=${()=>b("/explore/sites")} style="cursor:pointer"><span>${M.name}<div class="muted">${(M.buildings??[]).length} מבנים · ${se.length} קומות · ${Vr} מצלמות מוצבות · ${li}/${se.length} תוכניות</div></span><span class="status"><i style=${`--c:${se.length&&li===se.length?"var(--sw-live)":"var(--sw-stale)"}`}></i>${se.length&&li===se.length?"תוכניות מפורסמות":"חסרות תוכניות"}</span></div>`})}
        ...
        <div class="row3">
          <sw-card heading="אירועים אחרונים" subheading=${this.summary?`${this.summary.today.total} היום · ${this.summary.today.measured} נמדדו · ${this.summary.today.inferred} נגזרו מהקלטה`:""}>
            ...
            ${this.recent.length?this.recent.map(M=>r`<div class="ev" data-overview-event @click=${()=>b(`/investigate/events/${M.id}`)}>
                    ${M.thumbnail==="ready"?r`<img class="thumb" src=${zt(M.id)} alt="" loading="lazy" />`:r`<div class="none"><sw-icon name=${M.type==="offline"||M.type==="coverage_gap"?"offline":M.type==="door"||M.type==="io"?"door":M.type==="person"?"user":M.type==="vehicle"?"route":"bell"} size=${14}></sw-icon></div>`}
                    <div class="txt"><b style=${`--tone:${Bs[M.type]??"#6b7280"}`}><i></i>${K[M.type]??M.type}${M.acked_at?"":" · לבדיקה"}</b><small>${M.camera_name??M.details?.name??"ללא מצלמה"} · ${M.confidence==="inferred"?"נגזר מהקלטה":M.source==="ha"?"חיישן HA":"התראה"}</small></div>
                    <time>${this.fmtTime(M.occurred_at)}</time>
    ...
    `}render(){if(g())return this.renderApi();const e=q.filter(l=>l.state==="live"||l.state==="stale").length,t=Xe.filter(l=>!l.acked),s=[{kind:"critical",title:"מצלמה מנותקת: מסדרון מזרחי",meta:"קומה 0 · מאז 07:55",why:"מוצג כי אין הקלטה ממצלמה זו כבר שעתיים",link:"#/system/devices"},{kind:"alert",title:`${t.length} אירועים שלא נבדקו`,meta:"אדם בכניסה הראשית 10:14, רכב בחצר 09:42",why:"מוצג כי אירועי אדם/רכב מחכים לסימון טיפול",link:"#/investigate/events"},{kind:"alert",title:"החיבור ל־Home Assistant לא רענן",meta:"סנכרון אחרון לפני 4 דק׳",why:"מוצג כי מצבי הישויות עלולים להיות מיושנים",link:"#/system/diagnostics"}],i=.68,a=34,n=2*Math.PI*a,o=q.filter(l=>l.state==="live").slice(0,2);return r`
      <sw-page heading="בוקר טוב, יוני" subheading="המערכת פועלת · גשר Home Assistant לא רענן · נתוני הדגמה">
        ...
        <div class="kpis">
          ...
          <sw-kpi icon="building" value=${String(Si.length)} label="אתרים" detail="פעילים" tone="neutral"></sw-kpi>
          <sw-kpi icon="bell" value=${String(Xe.length)} label="אירועים" detail="ב־24 השעות" tone="neutral" badge=${`${t.length} חדשים`}></sw-kpi>
          <sw-kpi icon="shield" tone="stale" value="חלקי" label="מצב מערכת" detail="גשר HA לא רענן"></sw-kpi>
        </div>
        <div class="fav">
          ${o.map(l=>r`<sw-camera-tile name=${l.name} state=${l.state} scene=${We[l.id]??"lobby"} @click=${()=>b(`/live/cameras/${l.id}`)}></sw-camera-tile>`)}
        </div>
        <div class="row2">
          ...
          <sw-card heading="בריאות האתרים">
            ${Si.map(l=>r`<div class="hrow"><span>${l.name}<div class="muted">${l.online}/${l.cameras} מצלמות · ${l.alerts} התראות</div></span><span class="status"><i style="--c:${l.health==="live"?"var(--sw-live)":l.health==="offline"?"var(--sw-danger)":"var(--sw-stale)"}"></i>${l.health==="live"?"מחובר":l.health==="offline"?"מנותק":"חלקי"}</span></div>`)}
            ${hr.slice(0,2).map(l=>r`<div class="hrow"><span>${l.name}<div class="muted">${l.detail}</div></span><span class="status"><i style="--c:${l.state==="live"?"var(--sw-live)":"var(--sw-stale)"}"></i>${l.state==="live"?"מחובר":"לא רענן"}</span></div>`)}
          </sw-card>
        </div>
        <div class="row3">
          <sw-card heading="אירועים אחרונים">
            <a slot="actions" class="seeall" href="#/investigate/events">הצג הכל</a>
            ${Xe.slice(0,5).map(l=>r`<div class="ev" @click=${()=>b("/investigate/events")}>
                ${l.type==="offline"||l.type==="door"?r`<div class="none"><sw-icon name=${l.type==="offline"?"offline":"door"} size=${14}></sw-icon></div>`:r`<sw-scene kind=${ld[l.camera]??"lobby"}></sw-scene>`}
                <div class="txt"><b style="--tone:${od[l.type]}"><i></i>${Mi[l.type]}</b><small>${l.camera} · ${l.floor}</small></div>
                <time>${l.time}</time>
              </div>`)}
          </sw-card>
          <sw-card heading="דורש תשומת לב" subheading="כל פריט מסביר מדוע הוא מוצג">
  ...
  `;Ce([d()],ve.prototype,"cams",2);Ce([d()],ve.prototype,"recorder",2);Ce([d()],ve.prototype,"sites",2);Ce([d()],ve.prototype,"summary",2);Ce([d()],ve.prototype,"recent",2);Ce([d()],ve.prototype,"storage",2);Ce([d()],ve.prototype,"health",2);Ce([d()],ve.prototype,"raw",2);Ce([d()],ve.prototype,"tz",2);Ce([d()],ve.prototype,"now",2);Ce([d()],ve.prototype,"loaded",2);ve=Ce([_("live-overview")],ve);var dd=Object.defineProperty,cd=Object.getOwnPropertyDescriptor,Ke=(e,t,s,i)=>{for(var a=i>1?void 0:i?cd(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&dd(t,s,a),a};const wi=[1,2,4,6,8,9,12,16,20,25,32],Pa="sw.wall.count",Ia=[{id:"all",label:"כל המצלמות"},{id:"outside",label:"חוץ"},{id:"inside",label:"פנים"},{id:"night",label:"לילה"}];let Ae=class extends ${constructor(){super(...arguments),this.cameras="",this.count=4,this.stream="auto",this.view="all",this.cams=null,this.settings=null,this.error="",this.posterBust=Date.now(),this.box={w:0,h:0},this.measure=()=>{const e=this.renderRoot.querySelector(".grid");if(!e)return;const t=Math.round(e.clientWidth),s=Math.round(window.innerHeight-e.getBoundingClientRect().top-56);(t!==this.box.w||s!==this.box.h)&&(this.box={w:t,h:s})}}bestFit(e){const{w:t,h:s}=this.box;if(!t||s<120||e<1)return null;const i=12;let a={cols:1,tile:0};for(let n=1;n<=e;n++){const o=Math.ceil(e/n),l=Math.min((t-i*(n-1))/n,(s-i*(o-1))/o*(16/9));l>a.tile&&(a={cols:n,tile:l})}return a.tile>80?{cols:a.cols,tile:Math.floor(a.tile)}:null}firstUpdated(){this.ro=new ResizeObserver(()=>this.measure()),this.ro.observe(this),window.addEventListener("resize",this.measure)}updated(){this.measure()}connectedCallback(){super.connectedCallback(),this.load(),this.posterTimer=window.setInterval(()=>this.posterBust=Date.now(),6e4)}disconnectedCallback(){super.disconnectedCallback(),window.clearInterval(this.posterTimer),this.ro?.disconnect(),window.removeEventListener("resize",this.measure)}setCount(e){this.count=e;try{localStorage.setItem(Pa,String(e))}catch{}}async load(){if(g())try{const[e,t]=await Promise.all([Ee(),Ve()]);this.cams=e.cameras.filter(n=>n.enabled),this.settings=t;let s=0;try{s=Number(localStorage.getItem(Pa)??0)}catch{}const i=Number(t["ui.wall_count"]??0),a=wi.includes(s)?s:wi.includes(i)?i:0;a&&(this.count=a)}catch(e){this.error=w(e)}}renderApi(){const e=this.cams;if(this.error)return r`<sw-state-panel state="error" hint=${this.error} actionLabel="נסה שוב" @action=${()=>this.load()}></sw-state-panel>`;if(!e)return r`<sw-state-panel state="loading"></sw-state-panel>`;if(!e.length)return r`<sw-state-panel state="empty" heading="אין מצלמות זמינות" hint="המצלמות מתגלות אוטומטית מה־NVR בהפעלה ובכל 10 דקות. אם הרשימה ריקה: בדוק את פרטי ה־NVR בהגדרות ה־Add-on ואת יומן ה־Add-on, או הרץ סנכרון ידני; ייתכן גם שאין לך הרשאה למצלמות."><div style="margin-block-start:10px"><sw-button @click=${()=>b("/system/devices")}>למצלמות</sw-button></div></sw-state-panel>`;const t=this.cameras?this.cameras.split(",").filter(Boolean):[],s=t.length?e.filter(u=>t.includes(u.id)):e,i=t.length?Math.max(1,s.length):this.count,a=s.slice(0,i),n=window.innerWidth>=768?this.bestFit(a.length):null,o=n?n.cols:i===1?1:i===2||i<=4?2:i<=9?3:i<=16?4:i<=25?5:6,l=this.settings?.["media.max_live_sessions"]??8,p=this.stream==="auto"?this.settings?.["media.wall_profile"]??"sub":this.stream,f=Qi(this.settings);return r`
    ...
    `}renderDemo(){const e=q.slice(0,this.count),t=this.count===1?1:this.count===2||this.count<=4?2:this.count<=9?3:4;return r`
      <div class="grid" style="--cols:${t}">
        ${e.map(s=>r`<sw-camera-tile name=${s.name} meta=${`${s.floor} · ${this.stream==="auto"?this.count>4?"משני":"ראשי":this.stream==="main"?"ראשי":"משני"}`} state=${s.state} scene=${We[s.id]??"lobby"} ?compact=${this.count>=9} @click=${()=>b(`/live/cameras/${s.id}`)}></sw-camera-tile>`)}
      </div>
    ...
    `}render(){const e=g(),t=e?this.cams?.length??0:q.length;return r`
      <sw-page heading="כל המצלמות" subheading="${t} מצלמות${e?"":` · תצוגה: ${Ia.find(s=>s.id===this.view)?.label} · נתוני הדגמה`}" wide>
        ${e?c:r`<sw-field slot="actions"><select aria-label="תצוגה" @change=${s=>this.view=s.target.value}>${Ia.map(s=>r`<option value=${s.id} ?selected=${s.id===this.view}>${s.label}</option>`)}</select></sw-field>`}
        ...
        <div slot="actions" class="layouts" role="group" aria-label="פריסה">
          ${wi.map(s=>r`<button class=${s===this.count&&!this.cameras?"on":""} @click=${()=>{this.setCount(s),this.cameras&&b("/live/wall")}} aria-pressed=${s===this.count&&!this.cameras}>${s}</button>`)}
        </div>
  ...
  `;Ke([m()],Ae.prototype,"cameras",2);Ke([d()],Ae.prototype,"count",2);Ke([d()],Ae.prototype,"stream",2);Ke([d()],Ae.prototype,"view",2);Ke([d()],Ae.prototype,"cams",2);Ke([d()],Ae.prototype,"settings",2);Ke([d()],Ae.prototype,"error",2);Ke([d()],Ae.prototype,"posterBust",2);Ke([d()],Ae.prototype,"box",2);Ae=Ke([_("live-wall")],Ae);const pd=()=>z("nvr/notify"),hd=e=>Xt("nvr/notify",e),ud=(e=20)=>z(`nvr/changes?limit=${e}`),md=e=>A(`nvr/changes/${e}/rollback`),fd=e=>z(`cameras/${e}/record`),wd=(e,t)=>A(`cameras/${e}/record/start`,{minutes:t}),vd=e=>A(`cameras/${e}/record/stop`),gd=(e,t)=>Xt(`cameras/${e}/motion`,t);var bd=Object.defineProperty,yd=Object.getOwnPropertyDescriptor,F=(e,t,s,i)=>{for(var a=i>1?void 0:i?yd(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&bd(t,s,a),a};let N=class extends ${constructor(){super(...arguments),this.cameraId="cam-1",this.cam=null,this.zones=null,this.zonesBusy=!1,this.zonesError="",this.motionEdit=null,this.motionConfirm=!1,this.motionBusy=!1,this.motionMsg="",this.paintValue=null,this.rec=null,this.recMinutes=10,this.recBusy=!1,this.recMsg="",this.recTimer=0,this.zoneLayers={motion:!0,privacy:!0,intrusion:!0,lines:!0},this.caps=null,this.capsError="",this.cams=[],this.settings=null,this.error="",this.loading=!0,this.profile="main",this.transport="auto",this.playerStatus="",this.playerTransport="",this.posterBust=Date.now(),this.ptzMode="presets"}async loadRecord(){if(!(!this.cam||!g())){try{this.rec=await fd(this.cam.id)}catch{this.rec=null}window.clearTimeout(this.recTimer),this.rec?.active&&(this.recTimer=window.setTimeout(()=>void this.loadRecord(),15e3))}}async toggleRecord(){if(!(!this.cam||this.recBusy)){this.recBusy=!0,this.recMsg="";try{if(this.rec?.active)await vd(this.cam.id),this.recMsg="ההקלטה הידנית נעצרה.";else{const e=await wd(this.cam.id,this.recMinutes);this.recMsg=`הקלטה ידנית החלה · תיעצר אוטומטית ב־${new Date(e.stop_at).toLocaleTimeString("he-IL",{hour:"2-digit",minute:"2-digit"})}.`}await this.loadRecord()}catch(e){this.recMsg=w(e)}finally{this.recBusy=!1}}}renderRecord(){const e=this.rec;if(!e||!e.can_write)return c;const t=e.active,s=t?`${Math.floor(t.remaining_s/60)}:${String(t.remaining_s%60).padStart(2,"0")}`:"";return r`<div class="note" style="margin-block-start:8px;display:flex;flex-wrap:wrap;gap:8px;align-items:center" data-manual-record data-active=${t?"yes":"no"}>
    ...
    </div>`}connectedCallback(){super.connectedCallback(),this.load()}updated(e){e.has("cameraId")&&e.get("cameraId")!==void 0&&this.load(),e.has("cam")&&this.cam&&g()&&!this.zonesBusy&&(!this.zones||this.zones.camera_id!==this.cam.id)&&(this.loadRecord(),this.zonesError="",this.loadZones()),e.has("cam")&&this.cam&&g()&&(!this.caps||this.caps.camera_id!==this.cam.id)&&this.loadCaps()}async loadZones(e=!1){if(this.cam){this.zonesBusy=!0,this.zonesError="";try{this.zones=await qn(this.cam.id,e)}catch(t){this.zonesError=w(t)}finally{this.zonesBusy=!1}}}async loadCaps(e=!1){if(this.cam){this.capsError="";try{this.caps=await Kn(this.cam.id,e)}catch(t){this.capsError=w(t)}}}renderCaps(){const e=this.caps;if(this.capsError&&!e)return r`<div class="note" data-caps>יכולות המצלמה לא נקראו מה־NVR: ${this.capsError}</div>`;if(!e)return r`<div class="note" data-caps>קורא יכולות מה־NVR…</div>`;const t=e.ptz.state==="supported"?"live":e.ptz.state==="unsupported"?"neutral":"unknown",s=e.ptz.state==="supported"?`PTZ: נתמך${e.ptz.preset_count!==null?` · ${e.ptz.preset_count} presets`:""}`:e.ptz.state==="unsupported"?"PTZ: לא נתמך במצלמה זו":"PTZ: לא ידוע",i=e.audio.state==="available"?"live":e.audio.state==="disabled"?"stale":e.audio.state==="unsupported"?"neutral":"unknown",a=e.audio.state==="available"?`שמע דו־כיווני: ערוץ פעיל${e.audio.codec?` (${e.audio.codec})`:""}`:e.audio.state==="disabled"?"שמע דו־כיווני: ערוץ קיים אך כבוי במכשיר":e.audio.state==="unsupported"?"שמע דו־כיווני: אין ערוץ למצלמה זו":"שמע דו־כיווני: לא ידוע";return r`<div class="note" style="margin-block-start:8px;display:flex;flex-wrap:wrap;gap:6px;align-items:center" data-caps data-ptz=${e.ptz.state} data-audio=${e.audio.state}>
      ...
      </div>`}async load(){this.loading=!0,this.error="";try{if(g()){const[e,t]=await Promise.all([Ee(),Ve()]);this.cams=e.cameras,this.cam=e.cameras.find(s=>s.id===this.cameraId)??null,this.settings=t,this.transport=Qi(t)}}catch(e){this.error=w(e)}finally{this.loading=!1}}setTransport(e){Zn(e===(this.settings?.["media.transport_default"]??"mse")?"":e),this.transport=e}onPlayer(e){this.playerStatus=e.detail.status,this.playerTransport=e.detail.transport??""}renderApi(){const e=this.cam;if(this.loading)return r`<sw-state-panel state="loading"></sw-state-panel>`;if(this.error)return r`<sw-state-panel state="error" hint=${this.error} actionLabel="נסה שוב" @action=${()=>this.load()}></sw-state-panel>`;if(!e)return r`<sw-state-panel state="forbidden" heading="המצלמה לא זמינה" hint="המצלמה לא נמצאה או שאין לך הרשאת צפייה בה."></sw-state-panel>`;const t=e.can_view_live!==!1&&e.status!=="offline",s=Ue(e.id,this.posterBust),i=e.stream;return r`
      ...
      <div class="controls">
        <div class="round" role="group" aria-label="פקדי מצלמה">
          ...
          ${rr()?r`<span class="note">ברירת המחדל של המערכת: ${this.settings?.["media.transport_default"]??"mse"}</span>`:c}
        </div>
      ...
      <div class="grid">
        ...
        <sw-card heading="מצלמות נוספות">
          <div class="tiles">
            ${this.cams.filter(a=>a.id!==e.id).slice(0,4).map(a=>r`<sw-camera-tile compact name=${a.name} state=${a.status==="online"?"live":a.status==="offline"?"offline":"unknown"} poster=${a.status==="offline"?"":Ue(a.id)} @click=${()=>b(`/live/cameras/${a.id}`)}></sw-camera-tile>`)}
          </div>
        </sw-card>
      </div>
    `}renderDemo(){const e=q.find(i=>i.id===this.cameraId)??q[0],t=e.state==="live"||e.state==="stale",s=We[e.id]??"lobby";return r`
      ...
      <div class="grid">
        ...
        <sw-card heading="מצלמות באותה קומה">
          <div class="tiles">
            ${q.filter(i=>i.floor===e.floor&&i.id!==e.id).slice(0,4).map(i=>r`<sw-camera-tile compact name=${i.name} state=${i.state} scene=${We[i.id]??"lobby"} @click=${()=>b(`/live/cameras/${i.id}`)}></sw-camera-tile>`)}
          </div>
        </sw-card>
      </div>
  ...
  `;F([m()],N.prototype,"cameraId",2);F([d()],N.prototype,"cam",2);F([d()],N.prototype,"zones",2);F([d()],N.prototype,"zonesBusy",2);F([d()],N.prototype,"zonesError",2);F([d()],N.prototype,"motionEdit",2);F([d()],N.prototype,"motionConfirm",2);F([d()],N.prototype,"motionBusy",2);F([d()],N.prototype,"motionMsg",2);F([d()],N.prototype,"rec",2);F([d()],N.prototype,"recMinutes",2);F([d()],N.prototype,"recBusy",2);F([d()],N.prototype,"recMsg",2);F([d()],N.prototype,"zoneLayers",2);F([d()],N.prototype,"caps",2);F([d()],N.prototype,"capsError",2);F([d()],N.prototype,"cams",2);F([d()],N.prototype,"settings",2);F([d()],N.prototype,"error",2);F([d()],N.prototype,"loading",2);F([d()],N.prototype,"profile",2);F([d()],N.prototype,"transport",2);F([d()],N.prototype,"playerStatus",2);F([d()],N.prototype,"playerTransport",2);F([d()],N.prototype,"posterBust",2);F([d()],N.prototype,"ptzMode",2);F([Yt("sw-live-player")],N.prototype,"player",2);N=F([_("live-camera")],N);var $d=Object.defineProperty,xd=Object.getOwnPropertyDescriptor,Ge=(e,t,s,i)=>{for(var a=i>1?void 0:i?xd(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&$d(t,s,a),a};const kd={name:"",cameras:[],cols:2,rows:2,shared:!1,kiosk:!1},_d=[{name:"כל המצלמות",layout:9,scope:"משותפת",mobile:"4 · משני",owner:"יוני",kiosk:!0},{name:"חוץ",layout:4,scope:"משותפת",mobile:"2 · משני",owner:"יוני",kiosk:!1},{name:"פנים",layout:6,scope:"משותפת",mobile:"ללא",owner:"יוסי",kiosk:!1},{name:"לילה",layout:4,scope:"אישית",mobile:"4 · משני",owner:"דנה",kiosk:!1}];let Pe=class extends ${constructor(){super(...arguments),this.views=null,this.cams=[],this.canShare=!1,this.canManageAll=!1,this.editing=null,this.confirmDelete=null,this.busy=!1,this.error="",this.formError=""}connectedCallback(){super.connectedCallback(),g()&&this.load()}async load(){try{const[e,t]=await Promise.all([gr(),Ee()]);this.views=e.views,this.canShare=e.can_share,this.canManageAll=e.can_manage_all,this.cams=t.cameras.filter(s=>s.enabled&&s.can_view_live!==!1),this.error=""}catch(e){this.error=w(e),this.views=this.views??[]}}canEdit(e){return this.canManageAll||e.owner_user_id===mt.me?.user.id}open(e){this.formError="",this.editing=e?{id:e.id,name:e.name,cameras:[...e.cameras],cols:e.cols,rows:e.rows,shared:e.shared,kiosk:e.kiosk}:{...kd,cameras:[]}}toggleCamera(e){if(!this.editing)return;const t=this.editing.cameras.includes(e);!t&&this.editing.cameras.length>=16||(this.editing={...this.editing,cameras:t?this.editing.cameras.filter(s=>s!==e):[...this.editing.cameras,e]})}async save(){const e=this.editing;if(e){if(!e.name.trim()){this.formError="לתצוגה צריך שם.";return}if(!e.cameras.length){this.formError="בחר לפחות מצלמה אחת.";return}this.busy=!0;try{const t={name:e.name.trim(),cameras:e.cameras,cols:e.cols,rows:e.rows,shared:e.shared,kiosk:e.kiosk};e.id?await Xo(e.id,t):await br(t),this.editing=null,await this.load()}catch(t){this.formError=w(t)}finally{this.busy=!1}}}async removeView(){const e=this.confirmDelete;if(e){this.busy=!0;try{await Qo(e.id),this.confirmDelete=null,await this.load()}catch(t){this.error=w(t)}finally{this.busy=!1}}}renderEditor(){const e=this.editing;return r`<sw-dialog open heading=${e.id?"עריכת תצוגה":"תצוגה חדשה"} subheading="שם, מצלמות ופריסה · תצוגה משותפת נראית לכל המשתמשים" data-view-dialog @close=${()=>this.editing=null}>
      <div class="form">
        ...
        ${e===null?r`<sw-state-panel state="loading" heading="טוען תצוגות…"></sw-state-panel>`:e.length?r`<div class="grid" data-views>
                ${e.map(t=>r`<sw-card data-view=${t.id}>
                    <div class="thumb" style=${`grid-template-columns:repeat(${Math.min(2,Math.max(1,t.cameras.length))}, 1fr)`}>
                      ${t.cameras.slice(0,4).map(s=>r`<img src=${Ue(s)} alt="" loading="lazy" @error=${i=>i.target.style.visibility="hidden"} />`)}
                    ...
                    <div class="foot">
                      ...
                      <a href=${el(t)} target="_blank" rel="noopener"><sw-button size="sm" icon="layers" data-view-kiosk-open ?disabled=${!t.cameras.length}>קיוסק</sw-button></a>
                      <span class="grow"></span>
    ...
    `}render(){return g()?this.renderApi():r`
      <sw-page heading="תצוגות שמורות" subheading="תבניות 1 / 2 / 4 / 6 / 9 / 12 / 16 / מותאם, אישיות או משותפות, עם התאמה למובייל · נתוני הדגמה">
        ...
        <div class="grid">
          ${_d.map(e=>{const t=Math.ceil(Math.sqrt(e.layout));return r`<sw-card heading=${e.name}>
              <sw-badge slot="actions" kind="neutral" label=${e.scope}></sw-badge>
              <div class="thumb" style="grid-template-columns:repeat(${t},1fr)">${q.filter(s=>s.state==="live").slice(0,e.layout).map(s=>r`<sw-scene kind=${We[s.id]??"lobby"}></sw-scene>`)}</div>
              <dl>
  ...
  `;Ge([d()],Pe.prototype,"views",2);Ge([d()],Pe.prototype,"cams",2);Ge([d()],Pe.prototype,"canShare",2);Ge([d()],Pe.prototype,"canManageAll",2);Ge([d()],Pe.prototype,"editing",2);Ge([d()],Pe.prototype,"confirmDelete",2);Ge([d()],Pe.prototype,"busy",2);Ge([d()],Pe.prototype,"error",2);Ge([d()],Pe.prototype,"formError",2);Pe=Ge([_("live-views")],Pe);var zd=Object.defineProperty,Sd=Object.getOwnPropertyDescriptor,nt=(e,t,s,i)=>{for(var a=i>1?void 0:i?Sd(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&zd(t,s,a),a};const Ar="sw.kiosk.layout",Md=[[2,2],[3,2],[3,3],[4,3],[4,4],[5,4],[6,4]];function Pr(e){try{const i=localStorage.getItem(Ar);if(i){const[a,n]=i.split("x").map(Number);if(a>=1&&n>=1)return{cols:a,rows:n}}}catch{}const t=Number(e?.["ui.kiosk_cols"]??0),s=Number(e?.["ui.kiosk_rows"]??0);return{cols:t>=1?t:3,rows:s>=1?s:2}}function vi(e=Pr()){const t=Kt().params,s=Math.min(6,Math.max(1,Number(t.get("cols")??e.cols)||e.cols)),i=Math.min(5,Math.max(1,Number(t.get("rows")??e.rows)||e.rows));return{cameras:(t.get("cameras")??"").split(",").map(a=>a.trim()).filter(Boolean),cols:s,rows:i,rotate:Math.max(0,Number(t.get("rotate")??0)||0)}}let Le=class extends ${constructor(){super(...arguments),this.cams=null,this.settings=null,this.clock="",this.page=0,this.health=null,this.disconnected=!1,this.view=vi(),this.failures=0,this.onHash=()=>{this.view=vi(),this.page=this.restorePage(),this.startRotation()},this.started=0,this.staggerTimer=0}setLayout(e){const[t,s]=e.split("x").map(Number);if(!(t>=1&&s>=1))return;try{localStorage.setItem(Ar,`${t}x${s}`)}catch{}const i=new URLSearchParams(Kt().params);i.set("cols",String(t)),i.set("rows",String(s)),window.location.replace(`#/kiosk/all?${i.toString()}`)}get pageKey(){return`sw.kiosk.page:${this.view.cameras.join(",")}|${this.view.cols}x${this.view.rows}`}restorePage(){try{const e=Number(localStorage.getItem(this.pageKey)??"0");return Number.isFinite(e)&&e>=0?e:0}catch{return 0}}setPage(e){this.page=e;try{localStorage.setItem(this.pageKey,String(e%Math.max(1,this.pages)))}catch{}}connectedCallback(){super.connectedCallback(),this.page=this.restorePage(),this.tick(),this.timer=window.setInterval(()=>this.tick(),1e3),this.unsubscribe=ur(e=>{e.mode==="api"&&this.cams===null?this.load():e.mode!=="loading"&&this.requestUpdate()}),window.addEventListener("hashchange",this.onHash),this.startRotation(),this.pollHealth(),this.healthTimer=window.setInterval(()=>void this.pollHealth(),15e3)}disconnectedCallback(){window.clearTimeout(this.staggerTimer),super.disconnectedCallback(),window.clearInterval(this.timer),window.clearInterval(this.rotateTimer),window.clearInterval(this.healthTimer),window.removeEventListener("hashchange",this.onHash),this.unsubscribe?.()}startRotation(){window.clearInterval(this.rotateTimer),this.view.rotate>0&&(this.rotateTimer=window.setInterval(()=>{this.setPage(this.page+1),this.stagger()},this.view.rotate*1e3)),this.stagger()}async pollHealth(){if(g())try{this.health=await Xi(),(this.disconnected||this.failures>=3)&&this.load(),this.failures=0,this.disconnected=!1}catch{this.failures+=1,this.failures>=3&&(this.disconnected=!0)}}get pageSize(){return this.view.cols*this.view.rows}stagger(){window.clearTimeout(this.staggerTimer),this.started=0;const e=()=>{this.started<this.pageSize&&(this.started+=1,this.staggerTimer=window.setTimeout(e,400))};e()}get selected(){const e=(this.cams??[]).filter(t=>this.view.cameras.length===0||this.view.cameras.includes(t.id));return this.view.cameras.length?this.view.cameras.map(t=>e.find(s=>s.id===t)).filter(t=>!!t):e}get pages(){return Math.max(1,Math.ceil(this.selected.length/this.pageSize))}tick(){const e=new Date;this.clock=`${e.toLocaleDateString("he-IL",{weekday:"long",day:"2-digit",month:"2-digit",year:"numeric"})} · ${e.toLocaleTimeString("he-IL")}`}async load(){if(g())try{const[e,t]=await Promise.all([Ee(),Ve()]);this.cams=e.cameras.filter(s=>s.enabled),this.settings=t,this.view=vi(Pr(t))}catch{this.cams=[]}}render(){const t=g(),s=this.page%this.pages,i=t?this.selected.slice(s*this.pageSize,(s+1)*this.pageSize):[],a=q.filter(l=>l.state!=="forbidden").slice(0,9),n=t?i.filter(l=>l.status==="online").length:7,o=this.settings?.["media.max_live_sessions"]??8;return r`
      <header>
        ...
        ${t?r`<select class="layout" data-kiosk-layout aria-label="פריסה" @change=${l=>this.setLayout(l.target.value)}>
          ${Md.map(([l,p])=>r`<option value=${`${l}x${p}`} ?selected=${l===this.view.cols&&p===this.view.rows}>${l}×${p} · ${l*p} מצלמות בעמוד</option>`)}
        </select>`:c}
  ...
  `;nt([d()],Le.prototype,"cams",2);nt([d()],Le.prototype,"settings",2);nt([d()],Le.prototype,"clock",2);nt([d()],Le.prototype,"page",2);nt([d()],Le.prototype,"health",2);nt([d()],Le.prototype,"disconnected",2);nt([d()],Le.prototype,"view",2);nt([d()],Le.prototype,"started",2);Le=nt([_("kiosk-wall")],Le);var Ad=Object.defineProperty,Pd=Object.getOwnPropertyDescriptor,Te=(e,t,s,i)=>{for(var a=i>1?void 0:i?Pd(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&Ad(t,s,a),a};const Id={preserved:"#16a34a",preserving:"#d97706",nvr:"#7c3aed"},Os=[{label:"יום",minutes:1440},{label:"6 שע׳",minutes:360},{label:"שעה",minutes:60},{label:"10 דק׳",minutes:10},{label:"דקה",minutes:1}];function Oi(e){return String(e).padStart(2,"0")}function Se(e){const t=(e%1440+1440)%1440;return`${Oi(Math.floor(t/60))}:${Oi(Math.floor(t%60))}`}function Je(e){const t=(e%1440+1440)%1440,s=Math.min(59,Math.round(t%1*60));return`${Se(t)}:${Oi(s)}`}const Ed={motion:"#ef4444",person:"#2f6bff",vehicle:"#22c55e",line:"#f59e0b",offline:"#6b7280",door:"#8b5cf6"};let ge=class extends ${constructor(){super(...arguments),this.segments=[],this.events=[],this.bookmarks=[],this.cursor=615,this.windowMinutes=360,this.precision="estimated",this.follow=!0,this.limit=1440,this.hover=null,this.lastHoverBucket=-1,this.viewStart=-1,this.dragging=!1}get start(){const e=Math.max(0,1440-this.windowMinutes);return this.viewStart>=0&&!this.follow?Math.max(0,Math.min(e,this.viewStart)):Math.max(0,Math.min(e,this.cursor-this.windowMinutes/2))}get step(){return this.windowMinutes>=360?1:this.windowMinutes>=60?1/6:1/60}snap(e){const t=this.step;return Math.max(0,Math.min(this.limit,Math.round(e/t)*t))}x(e,t){return(e-this.start)/this.windowMinutes*t}minuteAt(e){const t=e.currentTarget.getBoundingClientRect();return this.start+(e.clientX-t.left)/t.width*this.windowMinutes}onMove(e){const t=this.minuteAt(e);if(this.hover=t,!this.dragging){const s=Math.floor(t*6);if(s!==this.lastHoverBucket){this.lastHoverBucket=s;const i=e.currentTarget.getBoundingClientRect();this.dispatchEvent(new CustomEvent("hover",{detail:{minute:t,x:e.clientX-i.left,width:i.width},bubbles:!0,composed:!0}))}}if(this.dragging){const s=this.snap(t);this.cursor=s,this.dispatchEvent(new CustomEvent("scrub",{detail:{minute:s},bubbles:!0,composed:!0}))}}onDown(e){e.button===0&&(e.currentTarget.setPointerCapture(e.pointerId),this.dragging=!0,this.viewStart=this.start,this.follow=!1)}onUp(e){if(!this.dragging)return;this.dragging=!1;const t=this.snap(this.minuteAt(e));this.cursor=t,this.follow=!0,this.dispatchEvent(new CustomEvent("seek",{detail:{minute:t,alt:e.altKey},bubbles:!0,composed:!0}))}onWheel(e){e.preventDefault();const t=Os.findIndex(i=>i.minutes===this.windowMinutes),s=Math.max(0,Math.min(Os.length-1,t+(e.deltaY>0?-1:1)));s!==t&&this.setWindow(Os[s].minutes,this.minuteAt(e))}setWindow(e,t=this.cursor){const s=Math.max(0,Math.min(1,(t-this.start)/this.windowMinutes));this.windowMinutes=e,this.viewStart=t-s*e,this.follow=!1,this.dispatchEvent(new CustomEvent("window-change",{detail:{minutes:e},bubbles:!0,composed:!0}))}buckets(e){const t=[],s=this.windowMinutes/e;for(let i=0;i<e;i++){const a=this.start+i*s,n=a+s;let o=0;for(const l of this.segments)l.endMin>a&&l.startMin<n&&(o=Math.max(o,l.kind==="motion"?2:1));o&&this.events.some(l=>l.minute>=a-s&&l.minute<=n+s)&&(o=3),t.push(o)}return t}tickEvery(){const e=this.windowMinutes;return e<=1?10/60:e<=10?1:e<=60?10:e<=360?60:180}label(e){return this.windowMinutes<=10?Je(e):Se(e)}render(){const n=this.tickEvery(),o=[];for(let x=Math.ceil(this.start/n-1e-9)*n;x<=this.start+this.windowMinutes+1e-9;x+=n)o.push(x);const l=[0,12,26,36],p={verified:"זמן מאומת",keyframe_limited:"דיוק לפי keyframe",estimated:"זמן משוער",unknown:"דיוק לא ידוע"}[this.precision],f=this.x(this.cursor,1e3),u=this.label(this.cursor),v=u.length>5?62:48,S=this.limit<this.start+this.windowMinutes?Math.max(0,this.x(this.limit,1e3)):null;return r`
      ...
      <svg
        ...
        ${this.buckets(160).map((x,R)=>{if(!x)return c;const Y=l[x];return h`<rect x=${R*6.25+1} y=${58-Y} width=${Math.max(2,6.25-2)} height=${Y} rx="1.5" fill="var(--sw-accent)" opacity=${x===1?.45:x===2?.8:1} />`})}
        ${o.map(x=>h`<line x1=${this.x(x,1e3)} x2=${this.x(x,1e3)} y1=${58} y2=${63} stroke="var(--sw-border-strong)" /><text x=${this.x(x,1e3)} y=${78} font-size="10.5" text-anchor="middle" fill="var(--sw-text-3)" font-family="var(--sw-font)">${this.label(x)}</text>`)}
        ${this.events.map(x=>{const R=this.x(x.minute,1e3);return R<0||R>1e3?c:h`<g><circle cx=${R} cy=${58-l[3]-8} r="3.5" fill=${Ed[x.kind]} /><title>${x.label} · ${Se(x.minute)}</title></g>`})}
        ${this.bookmarks.map(x=>{const R=this.x(x.minute,1e3),Y=this.x(x.endMinute,1e3);if(Y<0||R>1e3)return c;const Lt=Id[x.preservation],M=se=>{se.stopPropagation(),this.cursor=x.minute,this.follow=!0,this.dispatchEvent(new CustomEvent("seek",{detail:{minute:x.minute,alt:!1},bubbles:!0,composed:!0})),this.dispatchEvent(new CustomEvent("bookmark-click",{detail:{id:x.id,minute:x.minute},bubbles:!0,composed:!0}))};return h`<g class="bm" data-bookmark=${x.id} role="button" tabindex="0" aria-label=${x.label} @pointerdown=${se=>se.stopPropagation()} @click=${M} @keydown=${se=>(se.key==="Enter"||se.key===" ")&&M(se)}>
            <rect x=${Math.max(0,R)} y="13" width=${Math.max(2,Math.min(1e3,Y)-Math.max(0,R))} height="3" rx="1.5" fill=${Lt} opacity="0.55" />
            <line x1=${R} x2=${R} y1="3" y2=${58} stroke=${Lt} stroke-dasharray="2 3" opacity="0.6" />
            <polygon points=${`${R},2 ${R+9},6 ${R},10`} fill=${Lt} />
            <title>${x.label} · ${Se(x.minute)}</title>
          </g>`})}
  ...
  `;Te([m({attribute:!1})],ge.prototype,"segments",2);Te([m({attribute:!1})],ge.prototype,"events",2);Te([m({attribute:!1})],ge.prototype,"bookmarks",2);Te([m({type:Number})],ge.prototype,"cursor",2);Te([m({type:Number})],ge.prototype,"windowMinutes",2);Te([m()],ge.prototype,"precision",2);Te([m({type:Boolean})],ge.prototype,"follow",2);Te([m({type:Number})],ge.prototype,"limit",2);Te([d()],ge.prototype,"hover",2);Te([d()],ge.prototype,"viewStart",2);Te([d()],ge.prototype,"dragging",2);ge=Te([_("sw-timeline")],ge);const ps={open:"פתוח",in_review:"בבדיקה",closed:"סגור"},Cd={preserved:"עותק שמור",preserving:"מעתיק מה־NVR…",nvr_only:"סימנייה ל־NVR בלבד",missing:"חסר: ה־NVR כבר לא מחזיק את הקטע",unknown:"לא נבדק מול ה־NVR",none:""};function Ir(e={}){const t=new URLSearchParams;e.status&&t.set("status",e.status),e.q&&t.set("q",e.q);const s=t.toString();return z(`cases${s?`?${s}`:""}`)}const Er=e=>A("cases",e),Td=(e,t=!0)=>z(`cases/${e}${t?"":"?check=false"}`),Dd=(e,t)=>Be(`cases/${e}`,t),Od=e=>he(`cases/${e}`),Ri=(e,t)=>A(`cases/${e}/items`,t),Rd=(e,t)=>he(`cases/${e}/items/${t}`),Nd=(e,t)=>A(`cases/${e}/items/${t}/preserve`),Ea={preserved:"עותק שמור",preserving:"מעתיק מה־NVR…",nvr:"סימנייה ל־NVR"},Ca=(e,t)=>z(`cases/bookmarks?camera_id=${encodeURIComponent(e)}&date=${encodeURIComponent(t)}`),Ta=e=>e.toISOString().replace(/\.\d{3}Z$/,"Z"),Ni=(e,t=15,s=45)=>({from_at:Ta(new Date(e.getTime()-t*1e3)),to_at:Ta(new Date(e.getTime()+s*1e3))}),Ld=()=>z("evidence/signing"),Bd=()=>A("evidence/signing/rotate"),Hd=e=>A(`cases/${e}/bundle`),Vd=e=>z(`cases/${e}/bundles`),jd=(e,t)=>ce(`cases/${e}/bundles/${t}`),Fd=(e,t)=>ce(`cases/${e}/items/${t}/file`);function Ud(e){const t=new FormData;return t.append("file",e,e.name),si("cases/bundles/verify",t)}var Wd=Object.defineProperty,Zd=Object.getOwnPropertyDescriptor,De=(e,t,s,i)=>{for(var a=i>1?void 0:i?Zd(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&Wd(t,s,a),a};let be=class extends ${constructor(){super(...arguments),this.item=null,this.subheading="",this.cases=[],this.loading=!1,this.error="",this.picked="",this.newTitle="",this.note="",this.busy=!1,this.done=null,this.canManage=!0}updated(e){e.has("item")&&this.item&&this.load()}async load(){this.loading=!0,this.error="",this.done=null,this.note="";try{const e=await Ir({status:"open"});this.cases=e.cases,this.canManage=e.can_manage,this.picked=e.cases[0]?.id??"new"}catch(e){this.error=w(e)}finally{this.loading=!1}}close(){this.item=null,this.dispatchEvent(new CustomEvent("close",{bubbles:!0,composed:!0}))}async confirm(){const e=this.item;if(e){this.busy=!0,this.error="";try{let t=this.picked,s=this.cases.find(a=>a.id===t)?.title??"";if(t==="new"){if(!this.newTitle.trim()){this.error="תן שם לתיק החדש.";return}const a=await Er({title:this.newTitle.trim()});t=a.id,s=a.title}const i=await Ri(t,{...e,note:this.note.trim()||e.note});this.done={id:t,title:s},this.dispatchEvent(new CustomEvent("added",{detail:{caseId:t,item:i},bubbles:!0,composed:!0}))}catch(t){this.error=w(t)}finally{this.busy=!1}}}render(){const e=this.item;if(!e)return c;const t=e.kind==="event"?"האירוע":e.kind==="clip"?"הקטע":"ההערה";return r`<sw-dialog open heading="הוסף לתיק" subheading=${this.subheading} data-case-picker @close=${()=>this.close()}>
  ...
  `;De([m({attribute:!1})],be.prototype,"item",2);De([m()],be.prototype,"subheading",2);De([d()],be.prototype,"cases",2);De([d()],be.prototype,"loading",2);De([d()],be.prototype,"error",2);De([d()],be.prototype,"picked",2);De([d()],be.prototype,"newTitle",2);De([d()],be.prototype,"note",2);De([d()],be.prototype,"busy",2);De([d()],be.prototype,"done",2);De([d()],be.prototype,"canManage",2);be=De([_("sw-case-picker")],be);const Cr=(e,t)=>z(`cameras/${e}/recordings?date=${t}`),hs=new Set,us=new Set;function qd(){if(!(!hs.size&&!us.size)){for(const e of us)navigator.sendBeacon?.(ce(`playback/groups/${e}/close`),"");for(const e of hs)navigator.sendBeacon?.(ce(`playback/sessions/${e}/close`),"");hs.clear(),us.clear()}}typeof window<"u"&&window.addEventListener("pagehide",qd);const ea=async(e,t)=>{const s=await A("playback/sessions",{camera_id:e,start_at:t});return hs.add(s.id),s},Da=(e,t)=>A(`playback/sessions/${e}/seek`,{start_at:t}),xs=e=>(hs.delete(e),he(`playback/sessions/${e}`));function Zs(e){const t=new URL(ce(`playback/sessions/${e.id}/ws?generation=${e.generation}`));return t.protocol=t.protocol==="https:"?"wss:":"ws:",t.toString()}function et(e,t){const s=new Intl.DateTimeFormat("en-CA",{timeZone:t,year:"numeric",month:"2-digit",day:"2-digit"}).formatToParts(e),i=a=>s.find(n=>n.type===a)?.value??"";return`${i("year")}-${i("month")}-${i("day")}`}function Q(e,t){const s=new Intl.DateTimeFormat("en-GB",{timeZone:t,hour:"2-digit",minute:"2-digit",second:"2-digit",hourCycle:"h23"}).formatToParts(e),i=a=>Number(s.find(n=>n.type===a)?.value??0);return i("hour")*60+i("minute")+i("second")/60}function Fe(e,t,s){const[i,a,n]=e.split("-").map(Number),o=Date.UTC(i,a-1,n,Math.floor(t/60),Math.floor(t%60),Math.round(t%1*60)),l=f=>{const u=new Intl.DateTimeFormat("en-US",{timeZone:s,hour12:!1,year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit",second:"2-digit"}).formatToParts(new Date(f)),v=x=>Number(u.find(R=>R.type===x)?.value??0);return Date.UTC(v("year"),v("month")-1,v("day"),v("hour")%24,v("minute"),v("second"))-f};let p=o-l(o);return p=o-l(p),new Date(p)}const Kd=async(e,t)=>{const s=await A("playback/groups",{camera_ids:e,start_at:t});return us.add(s.id),s},Gd=(e,t)=>A(`playback/groups/${e}/seek`,{start_at:t}),Yd=e=>(us.delete(e),he(`playback/groups/${e}`)),Jd=(e,t)=>A(`playback/groups/${e}/sync`,{p95_s:t.p95,quality:t.quality,samples:t.samples,partial:t.partial,members:t.members}),ni=(e,t)=>ce(`cameras/${e}/frame?at=${encodeURIComponent(t)}`),Tr=(e,t,s)=>({camera_id:e,from_at:t,to_at:s}),Xd=(e,t,s)=>A("exports/estimate",Tr(e,t,s)),Qd=(e,t,s)=>A("exports",Tr(e,t,s)),ec=()=>z("exports"),tc=e=>A(`exports/${e}/cancel`),sc=e=>he(`exports/${e}`),Dr=e=>ce(`exports/${e}/download`),ic=e=>ce(`exports/${e}/manifest`);function Vt(e){return e==null?"—":e<1024*1024?`${Math.round(e/1024)} KB`:e<1024*1024*1024?`${(e/1024/1024).toFixed(1)} MB`:`${(e/1024/1024/1024).toFixed(2)} GB`}var ac=Object.defineProperty,rc=Object.getOwnPropertyDescriptor,I=(e,t,s,i)=>{for(var a=i>1?void 0:i?rc(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&ac(t,s,a),a};const $t=["closed","expired","failed"];function as(e){return Je(Math.max(0,Math.min(1439.983,e)))}function gi(e){const[t=0,s=0,i=0]=e.split(":").map(Number);return t*60+s+i/60}function nc(e){const t=e.map(s=>Math.abs(s)).sort((s,i)=>s-i);return t[Math.min(t.length-1,Math.max(0,Math.ceil(.95*t.length)-1))]}let P=class extends ${constructor(){super(...arguments),this.cameraId="",this.at="",this.extraParam="",this.demoCamera="cam-10",this.cursor=615,this.generation=3,this.playing=!0,this.speed=1,this.filter="all",this.cams=null,this.tz="Asia/Jerusalem",this.date="",this.rec=null,this.dayEvents=[],this.bookmarks=[],this.activeBookmark=null,this.loadingRec=!1,this.session=null,this.group=null,this.extra=[],this.casePick=null,this.preview=null,this.previewTimer=0,this.busy=!1,this.error="",this.notice="",this.tileStatus={},this.drifts={},this.clock=null,this.barrier="none",this.syncStats=null,this.clockPausedAt=0,this.driftSamples={},this.lateSince={},this.resyncAt={},this.resyncs={},this.nudges={},this.groupStartedAt=0,this.lastReport=0,this.seekSentAt={},this.firstPlayAt={},this.startLatency={},this.paused=!1,this.scrubbing=!1,this.position=null,this.exportOpen=!1,this.exportFrom="",this.exportTo="",this.estimate=null,this.exportJob=null,this.exportBusy=!1,this.exportError="",this.onTlHover=e=>{if(!this.cameraId||!g())return;window.clearTimeout(this.previewTimer);const t=e.detail;this.previewTimer=window.setTimeout(()=>{const s=Fe(this.date,t.minute,this.tz).toISOString().replace(/\.\d{3}Z$/,"Z");this.preview={minute:t.minute,x:t.x,width:t.width,url:ni(this.cameraId,s),failed:!1}},250)},this.onTlHoverEnd=()=>{window.clearTimeout(this.previewTimer),this.preview=null}}connectedCallback(){super.connectedCallback(),g()&&(this.init(),this.ticker=window.setInterval(()=>this.tick(),500))}disconnectedCallback(){super.disconnectedCallback(),window.clearInterval(this.ticker),this.endSession()}updated(e){g()&&e.has("cameraId")&&e.get("cameraId")!==void 0&&this.cams&&this.selectCamera(this.cameraId,!0)}get members(){return[this.cameraId,...this.extra.filter(e=>e!==this.cameraId)]}get groupMode(){return this.extra.filter(e=>e!==this.cameraId).length>0}get masterSession(){return this.groupMode?this.group?.sessions.find(e=>e.camera_id===this.cameraId)??this.group?.sessions[0]??null:this.session}get live(){const e=this.masterSession;return!!e&&!$t.includes(e.state)&&(this.groupMode?!!this.group:!0)}async init(){try{const[e,t]=await Promise.all([Ve(),Ee()]);this.tz=e["time.zone"]??"Asia/Jerusalem",this.cams=t.cameras.filter(n=>n.enabled);const s=this.cams.find(n=>n.id===this.cameraId)??this.cams[0],i=this.at?new Date(this.at):null,a=!!i&&!Number.isNaN(i.getTime());if(this.date=et(a?i:new Date,this.tz),s)if(this.cameraId=s.id,this.extraParam&&(this.extra=this.extraParam.split(",").filter(n=>n&&n!==s.id&&this.cams.some(o=>o.id===n)).slice(0,3)),await this.loadRecordings(),a)this.cursor=Q(i,this.tz),await this.startAt(i);else{const n=this.rec?.segments.at(-1);this.cursor=n?this.insideLast(n):Math.max(0,Q(new Date,this.tz)-5)}}catch(e){this.error=w(e)}}async selectCamera(e,t=!1){!e||!t&&e===this.cameraId||(await this.endSession(),this.cameraId=e,this.extra=this.extra.filter(s=>s!==e),this.error="",this.notice="",await this.loadRecordings())}async setDate(e){if(!e||e===this.date)return;await this.endSession(),this.date=e,await this.loadRecordings();const t=this.rec?.segments.at(-1);this.cursor=t?this.insideLast(t):540}insideLast(e){const t=Q(new Date(e.start_at),this.tz),s=Q(new Date(e.end_at),this.tz);return Math.max(0,t,s-5)}async loadRecordings(){if(!(!this.cameraId||!this.date)){this.loadingRec=!0,this.rec=null;try{const[e,t,s]=await Promise.all([Cr(this.cameraId,this.date),ql(this.cameraId,this.date).catch(()=>({events:[]})),Ca(this.cameraId,this.date).catch(()=>({bookmarks:[]}))]);this.rec=e,this.dayEvents=t.events,this.bookmarks=s.bookmarks,this.activeBookmark=null,this.error=""}catch(e){this.error=w(e)}finally{this.loadingRec=!1}}}get markers(){return this.dayEvents.map(e=>({minute:Q(new Date(e.occurred_at),this.tz),kind:Yl(e.type),label:`${K[e.type]??e.type}${e.confidence==="inferred"?" (מהקלטה)":""}${e.count>1?` ×${e.count}`:""}`}))}get bookmarkMarkers(){return this.bookmarks.map(e=>({id:e.id,minute:Q(new Date(e.from_at),this.tz),endMinute:Q(new Date(e.to_at),this.tz),label:`תיק „${e.case_title}”${e.note?` · ${e.note}`:""} · ${Ea[e.preservation]}`,preservation:e.preservation}))}async loadBookmarks(){if(!(!this.cameraId||!this.date))try{this.bookmarks=(await Ca(this.cameraId,this.date)).bookmarks}catch{}}bookmarkAt(e){this.cameraId&&(this.casePick={kind:"clip",camera_id:this.cameraId,...Ni(Fe(this.date,e,this.tz),10,20),note:"סימנייה"})}get segmentsMin(){return this.rec?this.rec.segments.map(e=>{const t=Q(new Date(e.start_at),this.tz);let s=Q(new Date(e.end_at),this.tz);return s<t&&(s=1440),{startMin:t,endMin:s,kind:e.kind==="continuous"?"continuous":"motion"}}):[]}inRecording(e){return this.segmentsMin.some(t=>e>=t.startMin&&e<=t.endMin)}get limitMinute(){return this.date===et(new Date,this.tz)?Q(new Date,this.tz):1440}cameraName(e){return this.cams?.find(t=>t.id===e)?.name??e}async startAt(e){if(!(!this.cameraId||this.busy)){this.busy=!0,this.error="",this.notice="",this.scrubbing=!1;try{const t=e.toISOString().replace(/\.\d{3}Z$/,"Z");if(this.groupMode){const s=performance.now(),i=this.group&&this.group.sessions.some(n=>!$t.includes(n.state))?await Gd(this.group.id,t):await Kd(this.members,t);this.group=i;for(const n of i.sessions)this.seekSentAt[n.camera_id]=s,delete this.firstPlayAt[n.camera_id];this.session=null,this.position=new Date(i.requested_at);const a=Object.keys(i.missing);a.length&&(this.notice=`ללא הקלטה בזמן הזה: ${a.map(n=>this.cameraName(n)).join(", ")}`)}else{const s=this.session&&!$t.includes(this.session.state)?await Da(this.session.id,t):await ea(this.cameraId,t);this.session=s,this.group=null,this.position=new Date(s.requested_at),s.moved_to_next_segment&&(this.notice=`אין הקלטה בזמן שנבחר; הניגון התחיל בקטע הבא (${this.fmt(new Date(s.requested_at))}).`)}if(this.cursor=Q(this.position,this.tz),this.paused=!1,this.tileStatus={},this.drifts={},this.resetClock(),!this.isConnected){await this.endSession();return}}catch(t){if(t instanceof xe&&t.body.code==="no_recording")this.notice="אין הקלטה בזמן הזה ובשש השעות שאחריו: פער בכיסוי, לא מדלגים ל־Live.",this.position=e;else if(t instanceof xe&&(t.body.code==="session_over"||t.body.code==="not_found")){this.session=null,this.group=null,this.busy=!1,await this.startAt(e);return}else this.error=w(t)}finally{this.busy=!1}}}async endSession(){const e=this.session,t=this.group;this.session=null,this.group=null,this.tileStatus={},this.drifts={},this.resetClock();try{t?await Yd(t.id):e&&!$t.includes(e.state)&&await xs(e.id)}catch{}}async toggleExtra(e){const t=this.extra.includes(e)?this.extra.filter(i=>i!==e):[...this.extra,e].slice(-3),s=this.currentInstant();await this.endSession(),this.extra=t,s&&await this.startAt(s)}players(){return Array.from(this.renderRoot.querySelectorAll("sw-live-player"))}masterPlayer(){return this.players().find(e=>e.dataset.camera===this.cameraId)??this.players()[0]}currentInstant(){const e=this.masterSession;if(!e)return this.position;if(this.groupMode&&this.clock)return new Date(this.clockNow());const t=new Date(e.requested_at).getTime();return new Date(t+(this.masterPlayer()?.mediaTime??0)*1e3)}tick(){if(!this.masterSession||this.paused||this.scrubbing)return;if(this.groupMode&&this.group){this.tickGroup();return}const t=this.masterPlayer();if(!t||t.status!=="playing")return;const s=this.currentInstant();s&&(this.position=s,this.cursor=Q(s,this.tz),t.stale&&t.bufferAhead<.4&&!this.busy&&this.startAt(s))}resetClock(){this.clock=null,this.clockPausedAt=0,this.barrier=this.groupMode?"waiting":"none",this.driftSamples={},this.lateSince={},this.resyncAt={},this.resyncs={},this.nudges={};for(const e of this.players())e.rate=1;this.groupMode&&(this.speed=1),this.syncStats=null,this.groupStartedAt=performance.now(),this.lastReport=0}clockNow(){const e=this.clock;return e.baseMs+((this.paused&&this.clockPausedAt?this.clockPausedAt:performance.now())-e.startedAt)}tickGroup(){const e=this.group,t=performance.now(),s=this.players().map(l=>{const p=l.dataset.camera??"",f=e.sessions.find(u=>u.camera_id===p);return{cid:p,p:l,sess:f,at:f?new Date(f.requested_at).getTime()+l.mediaTime*1e3:NaN}}).filter(l=>l.sess&&!$t.includes(l.sess.state)),i=s.filter(l=>l.p.status==="playing");if(!this.clock){const l=s.length>0&&i.length===s.length,p=t-this.groupStartedAt>12e3&&i.length>0;if(!l&&!p){this.barrier="waiting";return}const f=i.find(u=>u.cid===this.cameraId)??i[0];this.clock={baseMs:f.at,startedAt:t},this.barrier="passed",this.driftSamples={},this.lateSince={}}let a=this.clockNow();if(i.length>=3){const l=i.map(p=>p.at).sort((p,f)=>p-f);a=l[Math.floor(l.length/2)]}else i.length&&(a=(i.find(l=>l.cid===this.cameraId)??i[0]).at);this.clock={baseMs:a,startedAt:t};const n=new Date(a);this.position=n,this.cursor=Q(n,this.tz);const o={};for(const l of s){if(l.p.status!=="playing"){o[l.cid]=NaN,this.lateSince[l.cid]||(this.lateSince[l.cid]=t);continue}delete this.lateSince[l.cid];const p=(l.at-a)/1e3;o[l.cid]=p;const f=this.driftSamples[l.cid]??=[];if(f.push(p),f.length>40&&f.shift(),f.length>=2&&Math.abs(p)>.25&&Math.abs(p)<=3){const u=p<0?Math.abs(p)>1?1.15:1.05:Math.abs(p)>1?.85:.95;l.p.rate!==u&&(this.nudges[l.cid]=(this.nudges[l.cid]??0)+1),l.p.rate=u}else(Math.abs(p)<=.25||Math.abs(p)>3)&&(l.p.rate=1);l.cid!==this.cameraId&&f.length>=4&&f.slice(-4).every(u=>Math.abs(u)>3)&&(this.resyncs[l.cid]??0)<2&&t-(this.resyncAt[l.cid]??0)>2e4&&this.resyncMember(l.cid,a)}this.drifts=o,this.syncStats=this.computeSync(s.map(l=>l.cid),t),t-this.lastReport>5e3&&this.syncStats.samples>=4&&(this.lastReport=t,Jd(e.id,this.syncStats).catch(()=>{}))}computeSync(e,t){const s={};let i=null,a=0;for(const p of e){const f=this.driftSamples[p]??[],u=f.length?nc(f):null,v=this.lateSince[p]?t-this.lateSince[p]>8e3:!1;s[p]={p95:u,samples:f.length,last:f.length?f[f.length-1]:null,resyncs:this.resyncs[p]??0,state:v?"late":f.length?"measured":"waiting",latency_ms:this.startLatency[p]??null,nudges:this.nudges[p]??0},a+=f.length,u!==null&&(i=i===null?u:Math.max(i,u))}const n=Object.keys(this.group?.missing??{}),o=Object.values(s).some(p=>p.state==="late"),l=this.barrier!=="passed"||i===null?"waiting":i<=.5?"synced":i<=2?"slight":"out_of_sync";return{p95:i,quality:l,samples:a,partial:n.length>0||o,missing:n,members:s}}async resyncMember(e,t){const s=this.group,i=s?.sessions.find(n=>n.camera_id===e);if(!s||!i||$t.includes(i.state))return;this.resyncAt[e]=performance.now(),this.resyncs[e]=(this.resyncs[e]??0)+1,this.driftSamples[e]=[];const a=Math.min(this.startLatency[e]??4e3,15e3);try{const n=await Da(i.id,new Date(t+a).toISOString().replace(/\.\d{3}Z$/,"Z"));this.group===s&&(this.group={...s,sessions:s.sessions.map(o=>o.id===n.id?n:o)}),this.seekSentAt[e]=performance.now(),delete this.firstPlayAt[e]}catch{}}syncLabel(){const e=this.syncStats;if(this.barrier==="waiting"||!e||e.quality==="waiting")return"סנכרון: ממתין לחסם הפתיחה";const t=e.p95===null?"—":`${e.p95.toFixed(2)} ש׳`;return`סנכרון: ${{synced:"מסונכרן",slight:"סטייה קלה",out_of_sync:"לא מסונכרן",waiting:""}[e.quality]} · p95 ${t}${e.partial?" · חלקי":""}`}async onSeek(e){const t=e.detail.minute,s=Fe(this.date,t,this.tz);if(s.getTime()>Date.now()){this.notice="לא ניתן לנגן זמן עתידי.",this.scrubbing=!1;return}this.cursor=t,e.detail.alt&&this.bookmarkAt(t),await this.startAt(s)}onScrub(e){this.scrubbing=!0,this.cursor=e.detail.minute,this.position=Fe(this.date,e.detail.minute,this.tz)}async nudge(e){const t=this.currentInstant();t&&await this.startAt(new Date(t.getTime()+e*1e3))}setSpeed(e){if(this.groupMode||e>1)return;this.speed=e;const t=this.masterPlayer();t&&(t.rate=e)}stepFrame(e){const t=this.masterPlayer(),s=this.cams?.find(n=>n.id===this.cameraId),i=s?.stream?.fps&&s.stream.fps>0?s.stream.fps:25;if(!t)return;if(!t.stepFrame(e,i)){this.notice="הפריים המבוקש מחוץ למאגר שכבר הגיע מה־NVR — השתמש בקפיצה של 10 שניות או בציר הזמן.";return}this.notice="";const a=this.currentInstant();a&&(this.position=a,this.cursor=Q(a,this.tz))}togglePause(){const e=this.players();if(e.length){if(this.paused){const t=this.masterPlayer();if(!this.groupMode&&t?.stale&&this.position){this.startAt(this.position);return}e.forEach(s=>s.resume()),this.clock&&this.clockPausedAt&&(this.clock={...this.clock,startedAt:this.clock.startedAt+(performance.now()-this.clockPausedAt)}),this.clockPausedAt=0}else e.forEach(t=>t.pause()),this.clockPausedAt=performance.now();this.paused=!this.paused}}onTilePlayer(e,t){if(this.tileStatus={...this.tileStatus,[e]:t.detail.status},t.detail.status==="playing"&&this.seekSentAt[e]&&!this.firstPlayAt[e]&&(this.firstPlayAt[e]=performance.now(),this.startLatency[e]=this.firstPlayAt[e]-this.seekSentAt[e]),e===this.cameraId){if(this.masterSession&&t.detail.status==="playing"&&(this.session&&(this.session={...this.session,state:"playing"}),!this.groupMode&&this.speed!==1)){const s=this.masterPlayer();s&&s.rate!==this.speed&&(s.rate=this.speed)}if(t.detail.status==="ended"){const s=this.currentInstant(),i=this.masterSession;s&&i&&new Date(i.playback_end_at).getTime()-s.getTime()<5e3&&this.startAt(new Date(new Date(i.playback_end_at).getTime()+1e3))}}}fmt(e){return new Intl.DateTimeFormat("he-IL",{timeZone:this.tz,hour:"2-digit",minute:"2-digit",second:"2-digit",hourCycle:"h23"}).format(e)}openExport(){const e=Math.floor(this.cursor*60)/60;this.exportFrom=as(Math.max(0,e-1)),this.exportTo=as(Math.min(this.limitMinute,e+1)),this.estimate=null,this.exportJob=null,this.exportError="",this.exportOpen=!0}exportRange(){const e=Fe(this.date,gi(this.exportFrom),this.tz),t=Fe(this.date,gi(this.exportTo),this.tz);return t.getTime()<=e.getTime()?(this.exportError="זמן הסיום חייב להיות אחרי ההתחלה.",null):[e.toISOString().replace(/\.\d{3}Z$/,"Z"),t.toISOString().replace(/\.\d{3}Z$/,"Z")]}async runEstimate(){const e=this.exportRange();if(e){this.exportBusy=!0,this.exportError="";try{this.estimate=await Xd(this.cameraId,e[0],e[1])}catch(t){this.exportError=w(t)}finally{this.exportBusy=!1}}}async runExport(){const e=this.exportRange();if(e){this.exportBusy=!0,this.exportError="";try{this.exportJob=await Qd(this.cameraId,e[0],e[1])}catch(t){this.exportError=w(t)}finally{this.exportBusy=!1}}}renderExportDialog(){const e=this.estimate,t=this.exportJob;return r`<sw-dialog ?open=${this.exportOpen} heading="ייצוא קטע" subheading=${`${this.cameraName(this.cameraId)} · ${this.date} · ${this.tz}`} @close=${()=>this.exportOpen=!1}>
      <div class="dlg">
        ${t?r`<div class="est"><strong>עבודת הייצוא נוצרה</strong><span>${t.files.length} קבצים · משוער ${Vt(t.estimate_bytes)} · מצב: ${t.state}</span><span>ההתקדמות וההורדה במסך "ייצוא".</span></div>`:r`
              <div class="row">
              ...
              ${e?r`<div class="est">
                    <span>${e.files} קבצי NVR בטווח · נפח משוער ${Vt(e.estimate_bytes)} (מקסימום ${Vt(e.max_bytes)}) · כיסוי ${e.coverage==="complete"?"מלא":"חלקי"}</span>
      ...
      <div class="filters">
        ...
        ${this.activeBookmark?r`<sw-chip selected icon="case" data-bookmark-active @click=${()=>b(`/investigate/cases/${this.activeBookmark.case_id}`)}>תיק „${this.activeBookmark.case_title}”${this.activeBookmark.note?` · ${this.activeBookmark.note}`:""} · ${Ea[this.activeBookmark.preservation]} · פתח</sw-chip>`:c}
        ...
        ${this.error?r`<span class="err">${this.error}</span>`:c}
        <span class="grow"></span>
        <sw-button size="sm" icon="case" data-add-to-case title="סימנייה בנקודה הנוכחית · Alt+לחיצה על הציר מסמנת נקודה אחרת" ?disabled=${!this.cameraId} @click=${()=>this.casePick={kind:"clip",camera_id:this.cameraId,...Ni(Fe(this.date,this.cursor,this.tz))}}>הוסף לתיק</sw-button>
      ...
      <div class="tlwrap">
        ...
        ${this.preview?r`<div class="tlpreview" data-tl-preview style="left:${Math.max(104,Math.min(this.preview.width-104,this.preview.x))}px">
              ...
              <span>${Je(this.preview.minute)}</span>
            </div>`:c}
      </div>
      <sw-case-picker .item=${this.casePick} subheading=${`${this.cams?.find(o=>o.id===this.cameraId)?.name??""} · ${this.date} ${Je(this.cursor)}`} @added=${()=>void this.loadBookmarks()} @close=${()=>this.casePick=null}></sw-case-picker>
      <div class="session">
    ...
    `}seekDemo(e){this.cursor=e.detail.minute,this.generation+=1}renderDemo(){const e=q.find(i=>i.id===this.demoCamera)??q[0],t=!Us.some(i=>this.cursor>=i.startMin&&this.cursor<=i.endMin),s=Xe.filter(i=>i.minuteOfDay<1440).filter(i=>this.filter==="all"||i.type===this.filter).map(i=>({minute:i.minuteOfDay,kind:i.type,label:i.title}));return r`
      <div class="video ${t?"gap":""}">
        ${t?r`<div class="center"><div><sw-icon name="offline" size=${32}></sw-icon><span>אין הקלטה בזמן הזה: פער בכיסוי, לא מדלגים ל־Live</span></div></div>`:r`<sw-scene kind=${We[e.id]??"lobby"}></sw-scene><div class="shade"></div><span class="demo">דמו · אין שרת מחובר</span>`}
      ...
      <sw-timeline .segments=${Us} .events=${s} .cursor=${this.cursor} precision="estimated" @seek=${this.seekDemo}></sw-timeline>
      <div class="filters">
    ...
    `}render(){const e=g(),t=e?this.cams?.find(o=>o.id===this.cameraId):q.find(o=>o.id===this.demoCamera)??q[0],s=t?.name??"הקלטות",i=e?`${this.date} ${as(this.cursor)} · אזור זמן ${this.tz}`:`14.09.2026 ${Se(this.cursor)} · אזור זמן האתר Asia/Jerusalem · נתוני הדגמה`,a=e?"הקלטות":`הקלטות | ${t?.floor??""}`,n=e?et(new Date,this.tz):"2026-09-14";return r`
      <sw-page heading=${s} subheading=${i} crumbs=${a} wide>
        <div slot="actions" class="pick">
          ...
          <sw-field style="inline-size:132px"><input type="time" step="1" .value=${e?as(this.cursor):Se(this.cursor)} data-ltr aria-label="שעה" @change=${o=>{const l=o.target.value;if(e)this.onSeek(new CustomEvent("seek",{detail:{minute:gi(l)}}));else{const[p,f]=l.split(":").map(Number);this.cursor=p*60+f,this.generation+=1}}} /></sw-field>
        </div>
  ...
  `;I([m()],P.prototype,"cameraId",2);I([m()],P.prototype,"at",2);I([m()],P.prototype,"extraParam",2);I([d()],P.prototype,"demoCamera",2);I([d()],P.prototype,"cursor",2);I([d()],P.prototype,"generation",2);I([d()],P.prototype,"playing",2);I([d()],P.prototype,"speed",2);I([d()],P.prototype,"filter",2);I([d()],P.prototype,"cams",2);I([d()],P.prototype,"tz",2);I([d()],P.prototype,"date",2);I([d()],P.prototype,"rec",2);I([d()],P.prototype,"dayEvents",2);I([d()],P.prototype,"bookmarks",2);I([d()],P.prototype,"activeBookmark",2);I([d()],P.prototype,"loadingRec",2);I([d()],P.prototype,"session",2);I([d()],P.prototype,"group",2);I([d()],P.prototype,"extra",2);I([d()],P.prototype,"casePick",2);I([d()],P.prototype,"preview",2);I([d()],P.prototype,"busy",2);I([d()],P.prototype,"error",2);I([d()],P.prototype,"notice",2);I([d()],P.prototype,"tileStatus",2);I([d()],P.prototype,"drifts",2);I([d()],P.prototype,"clock",2);I([d()],P.prototype,"barrier",2);I([d()],P.prototype,"syncStats",2);I([d()],P.prototype,"paused",2);I([d()],P.prototype,"scrubbing",2);I([d()],P.prototype,"position",2);I([d()],P.prototype,"exportOpen",2);I([d()],P.prototype,"exportFrom",2);I([d()],P.prototype,"exportTo",2);I([d()],P.prototype,"estimate",2);I([d()],P.prototype,"exportJob",2);I([d()],P.prototype,"exportBusy",2);I([d()],P.prototype,"exportError",2);P=I([_("investigate-playback")],P);var oc=Object.defineProperty,lc=Object.getOwnPropertyDescriptor,bt=(e,t,s,i)=>{for(var a=i>1?void 0:i?lc(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&oc(t,s,a),a};const Oa="sw.sync.recent";function bi(e){const t=s=>String(s).padStart(2,"0");return`${e.getFullYear()}-${t(e.getMonth()+1)}-${t(e.getDate())}T${t(e.getHours())}:${t(e.getMinutes())}:${t(e.getSeconds())}`}let Ze=class extends ${constructor(){super(...arguments),this.cursor=615,this.playing=!1,this.cams=null,this.picked=[],this.when=bi(new Date(Date.now()-10*6e4)),this.recent=[],this.error=""}connectedCallback(){if(super.connectedCallback(),!!g()){try{this.recent=JSON.parse(localStorage.getItem(Oa)??"[]")}catch{this.recent=[]}this.load()}}async load(){try{const e=await Ee();this.cams=e.cameras.filter(t=>t.enabled&&t.can_view_live!==!1),this.error=""}catch(e){this.error=w(e),this.cams=[]}}toggle(e){this.picked=this.picked.includes(e)?this.picked.filter(t=>t!==e):this.picked.length>=4?this.picked:[...this.picked,e]}launch(e=this.picked,t){if(e.length<2)return;const s=t??new Date(this.when).toISOString(),i={cameras:e,at:s,opened:new Date().toISOString()},a=this.recent.filter(n=>n.cameras.join(",")!==e.join(","));this.recent=[i,...a].slice(0,6);try{localStorage.setItem(Oa,JSON.stringify(this.recent))}catch{}b("/investigate/playback",{camera:e[0],extra:e.slice(1).join(","),t:s})}name(e){return this.cams?.find(t=>t.id===e)?.name??e}renderApi(){const e=this.cams;return r`
        ...
        ${e===null?r`<sw-state-panel state="loading" heading="טוען מצלמות…"></sw-state-panel>`:r`
            <sw-card heading="מצלמות להשוואה" subheading=${`${this.picked.length} מתוך 4 · הראשונה שנבחרת היא המובילה (שעון הייחוס)`}>
              ...
              ${this.picked.length?r`<div class="picks">${this.picked.map((t,s)=>r`<div class="pick" data-sync-pick=${t}>
                    <img src=${Ue(t)} alt="" loading="lazy" @error=${i=>i.target.style.visibility="hidden"} />
            ...
            <sw-card heading="זמן התחלה" subheading="זמן מקומי של הדפדפן; ההקלטה נפתחת מהפריים הקרוב ביותר">
              <div class="transport">
                ...
                <sw-button size="sm" @click=${()=>this.when=bi(new Date(Date.now()-10*6e4))}>לפני 10 דק׳</sw-button>
                <sw-button size="sm" @click=${()=>this.when=bi(new Date(Date.now()-60*6e4))}>לפני שעה</sw-button>
                <span class="grow"></span>
      ...
      <sw-page heading="מרכז שליטה" subheading="ניטור חי עם ניגון מסונכרן · 4 מקורות · שעון ייחוס אחד · נתוני הדגמה" wide>
        ...
        <div class="grid">
          ${e.map(t=>r`<div class="tile">
              ...
              <sw-camera-tile name=${t.cam.name} state=${t.state} scene=${We[t.cam.id]??"lobby"}></sw-camera-tile>
            </div>`)}
        </div>
        <div class="transport">
        ...
        <sw-timeline .segments=${Us} .events=${Xe.slice(0,4).map(t=>({minute:t.minuteOfDay,kind:t.type,label:t.title}))} .cursor=${this.cursor} precision="estimated" @seek=${t=>this.cursor=t.detail.minute}></sw-timeline>
        <div class="filters">
  ...
  `;bt([d()],Ze.prototype,"cursor",2);bt([d()],Ze.prototype,"playing",2);bt([d()],Ze.prototype,"cams",2);bt([d()],Ze.prototype,"picked",2);bt([d()],Ze.prototype,"when",2);bt([d()],Ze.prototype,"recent",2);bt([d()],Ze.prototype,"error",2);Ze=bt([_("investigate-sync")],Ze);var dc=Object.defineProperty,cc=Object.getOwnPropertyDescriptor,de=(e,t,s,i)=>{for(var a=i>1?void 0:i?cc(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&dc(t,s,a),a};const yi=10;function pc(e){return e==="person"||e==="vehicle"||e==="motion"||e==="line"||e==="offline"||e==="door"?e:"motion"}let ee=class extends ${constructor(){super(...arguments),this.floorId="f0",this.at="",this.camera="",this.minute=615,this.tz="Asia/Jerusalem",this.date="",this.tree=null,this.bundle=null,this.events=[],this.recordings=new Map,this.selectedId=null,this.loading=!1,this.error="",this.frameAt="",this.frameFailed=!1,this.casePick=null,this.frameTimer=0}connectedCallback(){super.connectedCallback(),g()&&this.init()}updated(e){g()&&(e.has("floorId")&&e.get("floorId")!==void 0||e.has("at")&&e.get("at")!==void 0)&&this.init()}async init(){this.loading=!0,this.error="";try{const[e,t]=await Promise.all([Ve(),this.tree?Promise.resolve(this.tree):gt()]);if(this.tz=e["time.zone"]??this.tz,this.tree=t,g()&&this.floors.length&&!this.floors.some(i=>i.id===this.floorId)){const i=new URLSearchParams(window.location.hash.split("?")[1]??"").toString();window.location.replace(`#/investigate/floors/${this.floors[0].id}/history${i?`?${i}`:""}`);return}const s=this.at?new Date(this.at):new Date;if(this.date=et(s,this.tz),this.minute=Q(s,this.tz),this.bundle=await bs(this.floorId,!1,this.instant.toISOString().replace(/\.\d{3}Z$/,"Z")),this.scheduleFrame(),this.camera){const i=this.bundle.anchors.find(a=>a.resource_type==="camera"&&a.resource_id===this.camera);this.selectedId=i?.id??null}await this.loadDay()}catch(e){this.error=w(e)}finally{this.loading=!1}}async loadDay(){const e=this.bundle;if(!e)return;const t=e.anchors.filter(n=>n.resource_type==="camera").map(n=>n.resource_id),[s,i]=await Promise.all([ri({date:this.date,limit:1e3}).then(n=>n.events.filter(o=>o.camera_id&&t.includes(o.camera_id))).catch(()=>[]),Promise.allSettled(t.map(n=>Cr(n,this.date)))]);this.events=s;const a=new Map;t.forEach((n,o)=>{const l=i[o];a.set(n,l.status==="fulfilled"?l.value:null)}),this.recordings=a}get instant(){return Fe(this.date,this.minute,this.tz)}segmentsFor(e){const t=this.recordings.get(e);return t?t.segments.map(s=>{const i=Q(new Date(s.start_at),this.tz);let a=Q(new Date(s.end_at),this.tz);return a<i&&(a=1440),{startMin:i,endMin:a,kind:s.kind==="continuous"?"continuous":"motion"}}):null}coverageAt(e){const t=this.segmentsFor(e);if(!t)return{state:"unknown"};const s=t.find(i=>this.minute>=i.startMin&&this.minute<=i.endMin);return s?{state:"historic",segment:s}:{state:"unknown"}}eventsNear(e,t=yi){const s=this.instant.getTime();return this.events.filter(i=>(!e||i.camera_id===e)&&Math.abs(new Date(i.occurred_at).getTime()-s)<=t*60*1e3).sort((i,a)=>Math.abs(new Date(i.occurred_at).getTime()-s)-Math.abs(new Date(a.occurred_at).getTime()-s))}get apiMarkers(){const e=this.bundle;return e?e.anchors.map(t=>{if(t.resource_type==="camera"){const a=this.coverageAt(t.resource_id),n=this.eventsNear(t.resource_id,5).length,o=t.camera?.name??t.label??t.resource_id;return{id:t.id,kind:"camera",label:n?`${o} · ${n} אירועים`:o,x:t.position.x,y:t.position.y,rotation:t.rotation_degrees,fov:t.field_of_view_degrees??void 0,radius:t.coverage_radius??void 0,polygon:t.coverage_polygon?t.coverage_polygon.map(([l,p])=>({x:l,y:p})):void 0,state:a.state}}const s=t.entity?.state_at,i=ls(t);return{id:t.id,kind:ai(t.layer_id,t.entity?.domain),label:s?.known&&s.state?`${i} · ${ft({...t.entity??{domain:"",unit:null,device_class:null,attributes:{}},state:s.state})}`:i,x:t.position.x,y:t.position.y,state:s?.known?"historic":"unknown"}}):[]}get selectedAnchor(){return this.bundle?.anchors.find(e=>e.id===this.selectedId)??null}get limitMinute(){return this.date===et(new Date,this.tz)?Q(new Date,this.tz):1440}setMinute(e){this.minute=Math.max(0,Math.min(this.limitMinute,e)),this.scheduleFrame()}scheduleFrame(){window.clearTimeout(this.frameTimer),this.frameTimer=window.setTimeout(()=>{this.frameAt=this.instant.toISOString().replace(/\.\d{3}Z$/,"Z"),this.frameFailed=!1,this.ensureVersion()},600)}async ensureVersion(){const e=this.bundle;if(!e||e.source!=="api"||!e.at)return;const t=this.instant.toISOString().replace(/\.\d{3}Z$/,"Z");if(!(e.history==="current"?!e.historyFrom||t<e.historyFrom:(!e.planPublishedAt||e.planPublishedAt<=t)&&(!e.planArchivedAt||t<e.planArchivedAt)))try{const i=await bs(this.floorId,!1,t),a=e.anchors.map(n=>n.resource_id).sort().join(",");this.bundle=i,this.selectedId&&!i.anchors.some(n=>n.id===this.selectedId)&&(this.selectedId=null),i.anchors.map(n=>n.resource_id).sort().join(",")!==a&&await this.loadDay()}catch{}}renderEntityStates(e){const t=e.anchors.filter(a=>a.resource_type==="ha_entity");if(!t.length)return r`אין ישויות מוצבות בקומה`;const s=t.filter(a=>a.entity?.state_at?.known),i=e.haHistory;return r`${s.length} מתוך ${t.length} ידועות בזמן זה${i?.from?r` <span class="note">(היסטוריה מקומית מ־<span class="ltr">${this.fmtWhen(i.from)}</span>, ${i.retention_days} ימים)</span>`:r` <span class="note">(אין עדיין היסטוריה מקומית)</span>`}
      ...
      <sw-card heading="בנקודת הזמן שנבחרה" subheading="זמן ונתונים מאותו רגע" data-history-panel>
        ...
        <div style="display:flex;gap:8px;flex-wrap:wrap;margin-block-start:10px">
          ...
          <sw-button size="sm" icon="case" data-add-to-case ?disabled=${!s} title=${s?"קטע של המצלמה הנבחרת סביב הזמן שנבחר (15 שניות לפני, 45 אחרי)":"בחר מצלמה במפה"} @click=${()=>{s&&(this.casePick={kind:"clip",camera_id:s.resource_id,...Ni(this.instant)})}}>הוסף לתיק</sw-button>
        </div>
      </sw-card>
      <sw-case-picker .item=${this.casePick} subheading=${s?`${s.camera?.name??s.resource_id} · ${this.date} ${Je(this.minute)}`:""} @close=${()=>this.casePick=null}></sw-case-picker>
      <sw-card heading="אירועים סביב הזמן" subheading=${`±${yi} דקות · מצלמות הקומה`}>
    ...
    </div>`}renderApi(){const e=this.bundle;if(this.error&&!e)return r`<div class="head"><h1>מפה היסטורית</h1></div><sw-state-panel state="error" hint=${this.error}></sw-state-panel>`;if(!e)return r`<div class="head"><h1>מפה היסטורית</h1></div><sw-state-panel state="loading"></sw-state-panel>`;const t=this.selectedAnchor,s=t?.resource_type==="camera"?this.segmentsFor(t.resource_id)??[]:Array.from(this.recordings.keys()).flatMap(a=>this.segmentsFor(a)??[]),i=(t?.resource_type==="camera"?this.events.filter(a=>a.camera_id===t.resource_id):this.events).map(a=>({minute:Q(new Date(a.occurred_at),this.tz),kind:pc(a.type),label:`${K[a.type]??a.type}${a.count>1?` ×${a.count}`:""}`}));return r`
      <div class="head">
        <div><h1>המפה בזמן שנבחר · ${e.floorName}</h1><div class="sub">${e.buildingName} · <span class="ltr">${this.date} ${Je(this.minute)}</span> · ${this.tz}</div></div>
        <span class="grow"></span>
        ${this.floors.length>1?r`<sw-field><select aria-label="קומה" @change=${a=>b(`/investigate/floors/${a.target.value}`,{t:this.instant.toISOString()})}>${this.floors.map(a=>r`<option value=${a.id} ?selected=${a.id===this.floorId}>${It(a.name)}</option>`)}</select></sw-field>`:c}
      ...
      <div class="layout">
        <div class="stage">
          ...
          <div class="hist">מצב היסטורי · <span class="ltr">${Je(this.minute)}</span></div>
      ...
      <div class="tl">
        <div class="tlbar">
          ...
          <span class="time">${this.date} ${Je(this.minute)}</span>
          ...
          <span class="grow"></span>
          <sw-field><input type="date" .value=${this.date} max=${et(new Date,this.tz)} data-ltr aria-label="תאריך" @change=${a=>this.setDate(a.target.value)} /></sw-field>
    ...
    `}get demoMarkers(){const e=i=>i==="cam-3"||this.minute>=190&&this.minute<=205?"unknown":"historic",t=ns.filter(i=>i.floorId===this.floorId).map(i=>({id:i.id,kind:"camera",label:i.name,x:i.x,y:i.y,rotation:i.rotation,fov:i.fov,state:i.state==="forbidden"?"forbidden":e(i.id)})),s=Ls.filter(i=>i.floorId===this.floorId).map((i,a)=>({id:i.id,kind:i.domain,label:i.name,x:i.x,y:i.y,state:a%2?"unknown":"historic"}));return[...t,...s]}renderDemo(){const e=ut.find(t=>t.id===this.floorId)??ut[0];return r`
      <div class="head">
        <div><h1>מפה היסטורית · ${It(e.name)}</h1><div class="sub">מצב המפה בזמן נבחר · פעולות פיזיות כבויות בחקירה · נתוני הדגמה</div></div>
        <span class="grow"></span>
      ...
      <div class="stage alone">
        <sw-plan-canvas .planWidth=${e.planWidth} .planHeight=${e.planHeight} .plan=${or(e.id)} .markers=${this.demoMarkers}></sw-plan-canvas>
        <div class="legend"><span>כחול = יש הקלטה בזמן זה</span><span>מקווקו = לא ידוע / פער</span><span>ישות: מצב ידוע אחרון</span></div>
      </div>
    `}render(){return g()?this.renderApi():this.renderDemo()}};ee.styles=k`
    :host {
      display: flex;
      flex-direction: column;
      min-block-size: 100%;
  ...
  `;de([m()],ee.prototype,"floorId",2);de([m()],ee.prototype,"at",2);de([m()],ee.prototype,"camera",2);de([d()],ee.prototype,"minute",2);de([d()],ee.prototype,"tz",2);de([d()],ee.prototype,"date",2);de([d()],ee.prototype,"tree",2);de([d()],ee.prototype,"bundle",2);de([d()],ee.prototype,"events",2);de([d()],ee.prototype,"recordings",2);de([d()],ee.prototype,"selectedId",2);de([d()],ee.prototype,"loading",2);de([d()],ee.prototype,"error",2);de([d()],ee.prototype,"frameAt",2);de([d()],ee.prototype,"frameFailed",2);de([d()],ee.prototype,"casePick",2);ee=de([_("investigate-history-map")],ee);var hc=Object.defineProperty,uc=Object.getOwnPropertyDescriptor,U=(e,t,s,i)=>{for(var a=i>1?void 0:i?uc(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&hc(t,s,a),a};const mc={person:"#2f6bff",vehicle:"#22c55e",motion:"#ef4444",line:"#f59e0b",offline:"#6b7280",door:"#8b5cf6"},Ra={"כניסה ראשית":"entrance","חצר אחורית":"backyard",מחסן:"warehouse",לובי:"lobby","חניה מקורה":"parking","מסדרון מזרחי":"corridor"},fc={info:"מידע",alert:"התראה",critical:"קריטי"};let L=class extends ${constructor(){super(...arguments),this.cameraId="",this.date="",this.initialMode="",this.selected=null,this.filter="all",this.cams=null,this.tz="Asia/Jerusalem",this.type="",this.events=null,this.ingest=null,this.live=!1,this.error="",this.busy=!1,this.thumbVersion=new Map,this.player=null,this.mode="raw",this.windows=null,this.windowGap=180,this.windowBy="camera",this.selectedWindow=null,this.windowsBusy=!1,this.facets=null,this.placeFloor="",this.placeZone="",this.source="",this.unsupported=[],this.thumbTimers=new Map,this.thumbInFlight=0,this.rowPreview=null,this.rowPreviewTimer=0,this.windowColumns=[{key:"thumb",label:"",width:"72px",render:e=>this.renderWindowThumb(e)},{key:"title",label:"חלון אירוע",render:e=>{const t=e;return r`<span class="ty" style="--tone:${Bs[t.dominant_type]??"#6b7280"}"><i></i>${K[t.dominant_type]??t.dominant_type}${t.count>1?r` <span class="sub">×${String(t.count)}</span>`:c}</span><div class="sub">${Object.entries(t.types).map(([s,i])=>`${K[s]??s} ${i}`).join(" · ")} · ${t.confidence==="inferred"?"נגזר מהקלטה":"התראות מה־NVR"}</div>`}},{key:"camera_name",label:"מצלמה / קבוצה",render:e=>{const t=e;return r`${t.camera_name??(t.channel?`ערוץ ${t.channel}`:"מערכת")}${t.group&&t.group!=="camera"&&t.camera_names?.length?r`<div class="sub">${t.camera_names.join(" · ")}</div>`:c}`}},{key:"start",label:"זמן",render:e=>{const t=e;return r`${this.fmt(t.start)}${t.end!==t.start?r` – ${this.fmt(t.end)}`:c}<div class="sub">${this.fmtDate(t.start)}</div>`}},{key:"acked",label:"מצב",render:e=>{const t=e;return r`<sw-badge kind=${t.acked?"live":t.acked_count?"stale":"neutral"} label=${t.acked?"טופל":t.acked_count?`בטיפול ${t.acked_count}/${t.count}`:"חדש"}></sw-badge>`}}],this.apiColumns=[{key:"thumb",label:"",width:"72px",render:e=>this.renderThumb(e)},{key:"type",label:"אירוע",render:e=>r`<span class="ty" style="--tone:${Bs[e.type]??"#6b7280"}"><i></i>${K[e.type]??String(e.type)}${Number(e.count)>1?r` <span class="sub">×${String(e.count)}</span>`:c}</span><div class="sub">${e.source==="ha"?"חיישן HA":e.source==="system"?"מערכת":e.confidence==="inferred"?"נגזר מהקלטה":"התראה מה־NVR"} · ${e.acked_at?`טופל · ${String(e.acked_by_username??"")}`:"ממתין לטיפול"}</div>`},{key:"camera_name",label:"מצלמה",render:e=>r`${String(e.camera_name??(e.channel?`ערוץ ${String(e.channel)}`:"מערכת"))}<div class="sub ltr">${String(e.raw_type)}</div>`},{key:"occurred_at",label:"זמן",render:e=>r`${this.fmt(String(e.occurred_at))}<div class="sub">${this.fmtDate(String(e.occurred_at))}${e.ended_at?` · עד ${this.fmt(String(e.ended_at))}`:""}</div>`},{key:"severity",label:"חומרה",render:e=>r`<sw-badge kind=${e.severity==="critical"?"error":e.severity==="alert"?"stale":"neutral"} label=${fc[e.severity]??String(e.severity)}></sw-badge>`}],this.columns=[{key:"thumb",label:"תמונה",width:"80px",render:e=>e.type==="offline"||e.type==="door"?r`<div class="thumb none"><sw-icon name=${e.type==="offline"?"offline":"door"} size=${14}></sw-icon></div>`:r`<sw-scene class="thumb" kind=${Ra[String(e.camera)]??"lobby"}></sw-scene>`},{key:"title",label:"אירוע",render:e=>r`<span class="ty" style="--tone:${mc[e.type]}"><i></i>${Mi[e.type]}</span><div class="sub">${String(e.title)} · ${e.acked?"טופל":"ממתין לטיפול"}</div>`},{key:"camera",label:"מצלמה",render:e=>r`${String(e.camera)}<div class="sub">${String(e.floor)}</div>`},{key:"time",label:"זמן",render:e=>r`${String(e.time)}<div class="sub ltr">${String(e.source)}</div>`},{key:"severity",label:"חומרה",render:e=>r`<sw-badge kind=${e.severity==="critical"?"error":e.severity==="alert"?"stale":"neutral"} label=${{info:"מידע",alert:"התראה",critical:"קריטי"}[e.severity]}></sw-badge>`},{key:"more",label:"",width:"40px",render:()=>r`<sw-button variant="ghost" size="sm" iconOnly icon="more" label="עוד"></sw-button>`}]}connectedCallback(){super.connectedCallback(),g()&&(this.init(),this.unsubscribe=Jl(e=>this.onPushed(e),(e,t)=>{this.live=t,e&&(this.ingest=e)}))}disconnectedCallback(){super.disconnectedCallback(),this.unsubscribe?.();for(const e of this.thumbTimers.values())window.clearTimeout(e);this.thumbTimers.clear(),this.stopPlayer()}hoverStart(e,t){if(!e.camera_id||t.pointerType==="touch")return;window.clearTimeout(this.rowPreviewTimer);const s=t.clientX,i=t.clientY;this.rowPreviewTimer=window.setTimeout(()=>{const a=new Date(e.occurred_at).getTime(),n=[-5,0,5].map(o=>{const l=new Date(a+o*1e3).toISOString().replace(/\.\d{3}Z$/,"Z");return{at:l,url:ni(e.camera_id,l),label:o===0?this.fmt(e.occurred_at):`${o>0?"+":""}${o} ש׳`,failed:!1}});this.rowPreview={id:e.id,x:s,y:i,frames:n,camera:e.camera_name??""}},250)}hoverEnd(){window.clearTimeout(this.rowPreviewTimer),this.rowPreview=null}renderRowPreview(){const e=this.rowPreview;if(!e)return c;const t=Math.max(16,Math.min(window.innerWidth-388,e.x-186)),s=e.y+18+230>window.innerHeight?e.y-18-230:e.y+18;return r`<div class="rowpreview" data-row-preview style="left:${t}px;top:${s}px">
      ...
      <div class="wlist" data-window-events>
        ${t.map(s=>r`<a class="wrow" href=${`#/investigate/events/${s.id}`}><span class="ty" style="--tone:${Bs[s.type]??"#6b7280"}"><i></i>${K[s.type]??s.type}</span><span class="ltr">${this.fmt(s.occurred_at)}</span><span class="sub">${s.acked_at?"טופל":"ממתין"}</span></a>`)}
    ...
    </sw-drawer>`}onPushed(e){if(!this.events)return;const t=et(new Date(e.occurred_at),this.tz);if(this.date&&t!==this.date||this.cameraId&&e.camera_id!==this.cameraId||this.type&&e.type!==this.type)return;const s=this.cams?.find(n=>n.id===e.camera_id)?.name??null,i={...e,camera_name:e.camera_name??s};(e.thumbnail==="ready"||e.thumbnail==="unavailable")&&(this.cancelPoll(e.id),e.thumbnail==="ready"&&(this.thumbVersion=new Map(this.thumbVersion).set(e.id,Date.now())));const a=this.events.findIndex(n=>n.id===e.id);this.events=a>=0?this.events.map((n,o)=>o===a?{...n,...i}:n):[i,...this.events]}fmt(e){return new Intl.DateTimeFormat("he-IL",{timeZone:this.tz,hour:"2-digit",minute:"2-digit",second:"2-digit",hourCycle:"h23"}).format(new Date(e))}fmtDate(e){return new Intl.DateTimeFormat("he-IL",{timeZone:this.tz,day:"2-digit",month:"2-digit"}).format(new Date(e))}async ack(e){this.busy=!0;try{const t=await _r(e.id);this.events=(this.events??[]).map(s=>s.id===e.id?{...s,...t}:s)}catch(t){this.error=w(t)}finally{this.busy=!1}}renderApi(){if(this.error&&!this.events)return r`<sw-state-panel state="error" hint=${this.error} actionLabel="נסה שוב" @action=${()=>this.init()}></sw-state-panel>`;if(!this.events)return r`<sw-state-panel state="loading"></sw-state-panel>`;const e=this.events.find(i=>i.id===this.selected)??null,t=this.ingest,s=this.events.filter(i=>!i.acked_at).length;return r`
      ...
      <div class="filters">
        ...
        <sw-field><input type="date" .value=${this.date} max=${et(new Date,this.tz)} data-ltr aria-label="תאריך" @change=${i=>{this.date=i.target.value,this.load()}} /></sw-field>
        ...
        <sw-field><select aria-label="מקור" data-filter-source @change=${i=>{this.source=i.target.value,this.load()}}><option value="" ?selected=${!this.source}>כל המקורות</option>${Object.entries(Sa).map(([i,a])=>r`<option value=${i} ?selected=${i===this.source}>${a}</option>`)}</select></sw-field>
        <span class="grow"></span>
      ...
      <div class="stage">
        ${this.mode==="windows"?this.windows===null||this.windowsBusy&&!this.windows.length?r`<sw-state-panel state="loading"></sw-state-panel>`:this.windows.length?r`<div class="banner" style="margin-block-end:8px"><sw-icon name="info" size=${14}></sw-icon><span>${this.windowBy==="camera"?"התראות סמוכות באותה מצלמה":this.windowBy==="all"?"התראות סמוכות מכל המצלמות":this.windowBy==="zone"?"התראות סמוכות באותו חדר":"התראות סמוכות באותה קומה"} הופכות לחלון אירוע אחד (מרווח עד ${Math.round(this.windowGap/60)} דק׳). האירועים המקוריים נשמרים לצפייה.</span><span class="grow"></span>
                  <sw-field><select aria-label="קיבוץ" data-window-by @change=${i=>{this.windowBy=i.target.value,this.loadWindows()}}>${Object.keys(za).map(i=>r`<option value=${i} ?selected=${this.windowBy===i}>${za[i]}</option>`)}</select></sw-field>
    ...
    `}renderDemo(){const e=Xe.filter(s=>this.filter==="all"||!s.acked),t=Xe.find(s=>s.id===this.selected);return r`
      <div class="filters">
        ...
        <span class="grow"></span>
        <sw-chip ?selected=${this.filter==="all"} @click=${()=>this.filter="all"} count=${Xe.length}>הכל</sw-chip>
        <sw-chip ?selected=${this.filter==="unacked"} @click=${()=>this.filter="unacked"} count=${Xe.filter(s=>!s.acked).length}>ללא טיפול</sw-chip>
      </div>
      <div class="stage">
        <sw-table .columns=${this.columns} .rows=${e} .selected=${this.selected} @row-select=${s=>this.selected=s.detail.id}></sw-table>
        ${t?r`<sw-drawer open heading=${Mi[t.type]} subheading=${`${t.camera} · ${t.time}`} @close=${()=>this.selected=null}>
              <div class="preview">${t.type==="offline"||t.type==="door"?"אין תמונה לאירוע זה":r`<sw-scene kind=${Ra[t.camera]??"lobby"}></sw-scene><span class="demo">דמו · תמונת אירוע מה־NVR (T044)</span>`}</div>
              <dl>
  ...
  `;U([m()],L.prototype,"cameraId",2);U([m()],L.prototype,"date",2);U([m()],L.prototype,"initialMode",2);U([d()],L.prototype,"selected",2);U([d()],L.prototype,"filter",2);U([d()],L.prototype,"cams",2);U([d()],L.prototype,"tz",2);U([d()],L.prototype,"type",2);U([d()],L.prototype,"events",2);U([d()],L.prototype,"ingest",2);U([d()],L.prototype,"live",2);U([d()],L.prototype,"error",2);U([d()],L.prototype,"busy",2);U([d()],L.prototype,"thumbVersion",2);U([d()],L.prototype,"player",2);U([d()],L.prototype,"mode",2);U([d()],L.prototype,"windows",2);U([d()],L.prototype,"windowGap",2);U([d()],L.prototype,"windowBy",2);U([d()],L.prototype,"selectedWindow",2);U([d()],L.prototype,"windowsBusy",2);U([d()],L.prototype,"facets",2);U([d()],L.prototype,"placeFloor",2);U([d()],L.prototype,"placeZone",2);U([d()],L.prototype,"source",2);U([d()],L.prototype,"unsupported",2);U([d()],L.prototype,"rowPreview",2);L=U([_("investigate-events")],L);var wc=Object.defineProperty,vc=Object.getOwnPropertyDescriptor,we=(e,t,s,i)=>{for(var a=i>1?void 0:i?vc(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&wc(t,s,a),a};const gc={measured:"recorded",inferred:"unknown",command:"partial",availability:"stale"},Na={alertstream:"אירוע NVR",recording:"נגזר מהקלטה",system:"מערכת",ha:"חיישן HA"},La=600*1e3;let le=class extends ${constructor(){super(...arguments),this.eventId="",this.ev=null,this.error="",this.tz="Asia/Jerusalem",this.session=null,this.playerError="",this.bundle=null,this.nearby=[],this.corr=null,this.corrError="",this.route=null,this.busy=!1,this.thumbVersion=0,this.casePick=null,this.pollTimer=0}connectedCallback(){super.connectedCallback(),this.load()}disconnectedCallback(){super.disconnectedCallback(),window.clearTimeout(this.pollTimer),this.stopPlayer()}updated(e){e.has("eventId")&&e.get("eventId")!==void 0&&this.load()}async load(){if(g()){this.error="",await this.stopPlayer();try{const e=await Gl(this.eventId);this.ev=e,this.tz=e.timezone||this.tz,e.location?.has_plan?this.loadMap(e.location.floor_id):this.bundle=null,this.loadNearby(e),this.loadCorrelation(e.id),this.loadRoute(e.id),e.camera_id&&this.play(e),e.thumbnail==="pending"&&this.pollThumb(e.id)}catch(e){this.error=w(e),this.ev=null}}}async loadRoute(e){this.route=null;try{this.route=await td(e)}catch{this.route=null}}renderRoute(){const e=this.route;return!e||!e.spatial?c:r`<sw-card heading="המשך מסלול מוצע" subheading="השערה לפי טופולוגיית המפה · ±${Math.round((new Date(e.window.to).getTime()-new Date(e.window.from).getTime())/1e3)} שניות" style="margin-block-start:12px" data-route>
    ...
    </sw-card>`}async loadCorrelation(e){this.corr=null,this.corrError="";try{this.corr=await Ql(e)}catch(t){this.corrError=w(t)}}async loadMap(e){try{this.bundle=await bs(e)}catch{this.bundle=null}}async loadNearby(e){try{const t=new Date(e.occurred_at).getTime(),s=a=>new Date(a).toISOString().replace(/\.\d{3}Z$/,"Z"),i=await ri({from:s(t-La),to:s(t+La),limit:30});this.nearby=i.events.filter(a=>a.id!==e.id).slice(0,6)}catch{this.nearby=[]}}pollThumb(e){window.clearTimeout(this.pollTimer),this.pollTimer=window.setTimeout(async()=>{const t=await zr(e).catch(()=>"unavailable");this.ev?.id===e&&(t==="pending"?this.pollThumb(e):(this.ev={...this.ev,thumbnail:t},t==="ready"&&(this.thumbVersion=Date.now())))},1500)}async play(e){if(e.camera_id){this.playerError="";try{const t=new Date(new Date(e.occurred_at).getTime()-2e3).toISOString().replace(/\.\d{3}Z$/,"Z"),s=await ea(e.camera_id,t);this.ev?.id===e.id?this.session=s:await xs(s.id).catch(()=>{})}catch(t){this.playerError=w(t)}}}async stopPlayer(){const e=this.session;this.session=null,e&&await xs(e.id).catch(()=>{})}async ack(){const e=this.ev;if(!(!e||e.acked_at)){this.busy=!0;try{const t=await _r(e.id);this.ev={...e,acked_at:t.acked_at,acked_by_username:t.acked_by_username}}catch(t){this.error=w(t)}finally{this.busy=!1}}}fmt(e,t=!1){const s=new Date(e),i=new Intl.DateTimeFormat("he-IL",{timeZone:this.tz,hour:"2-digit",minute:"2-digit",second:"2-digit",hourCycle:"h23"}).format(s);return t?`${new Intl.DateTimeFormat("he-IL",{timeZone:this.tz,day:"2-digit",month:"2-digit",year:"numeric"}).format(s)} · ${i}`:i}renderCorrelation(){const e=this.corr,t=e?`±${e.window_s} שניות · ${e.spatial?`סביבת ${e.location?.zone??"המיקום על התוכנית"} (${e.location?.floor_name??""})`:"לפי זמן בלבד"}`:this.corrError?"לא נטען":"טוען…";return r`<sw-card heading="קורלציה דלת–מצלמה–חיישן" subheading=${t} style="margin-block-start:12px" data-correlation>
      ${e?r`${e.entities.length?r`<div class="note" style="margin:0 0 6px" data-correlation-entities>בסביבה: ${e.entities.map(s=>`${s.name}${s.state_missing?" (ללא מצב)":s.state?` · ${s.state}`:""}`).join(" · ")}</div>`:r`<div class="note" style="margin:0 0 6px" data-correlation-entities>אין חיישנים או מנעולים מוצבים בסביבה.</div>`}
            ${e.links.length?r`<div class="corr" data-correlation-links>${e.links.map(s=>r`<div class="link" data-correlation-link data-certainty=${s.certainty}>
                    ...
                    <sw-badge kind=${gc[s.certainty]} label=${Xl[s.certainty]}></sw-badge>
      ...
      <sw-page heading=${`${t} · ${s}`} subheading=${`${Na[e.source]??e.source} · ${this.fmt(e.occurred_at,!0)}`} crumbs=${`חקירה | אירועים | ${t}`} wide>
          ...
          <div>
            <sw-card heading="הקשר האירוע" data-context>
              <dl class="meta">
                ...
                <dt>מקור</dt><dd>${Na[e.source]??e.source}${e.camera_id?r` / ${s}`:c} <span class="note" style="margin:0">raw <span class="ltr">${e.raw_type}</span></span></dd>
  ...
  `;we([m()],le.prototype,"eventId",2);we([d()],le.prototype,"ev",2);we([d()],le.prototype,"error",2);we([d()],le.prototype,"tz",2);we([d()],le.prototype,"session",2);we([d()],le.prototype,"playerError",2);we([d()],le.prototype,"bundle",2);we([d()],le.prototype,"nearby",2);we([d()],le.prototype,"corr",2);we([d()],le.prototype,"corrError",2);we([d()],le.prototype,"route",2);we([d()],le.prototype,"busy",2);we([d()],le.prototype,"thumbVersion",2);we([d()],le.prototype,"casePick",2);le=we([_("investigate-event-detail")],le);var bc=Object.getOwnPropertyDescriptor,yc=(e,t,s,i)=>{for(var a=i>1?void 0:i?bc(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=o(a)||a);return a};const $c=[{id:"rv-1",title:"כניסה ראשית · 10:12–10:16",primary:"כניסה ראשית",scene:"entrance",related:["לובי"],events:3,severity:"alert",status:"חדש"},{id:"rv-2",title:"חצר אחורית · 09:40–09:44",primary:"חצר אחורית",scene:"backyard",related:[],events:2,severity:"info",status:"בבדיקה"},{id:"rv-3",title:"חניה מקורה · 06:41–06:45",primary:"חניה מקורה",scene:"parking",related:["כניסה ראשית"],events:1,severity:"alert",status:"טופל"},{id:"rv-4",title:"לובי · אתמול 23:08–23:12",primary:"לובי",scene:"lobby",related:[],events:4,severity:"info",status:"false positive"}];let Li=class extends ${render(){return r`
  ...
  `;Li=yc([_("investigate-reviews")],Li);var xc=Object.defineProperty,kc=Object.getOwnPropertyDescriptor,H=(e,t,s,i)=>{for(var a=i>1?void 0:i?kc(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&xc(t,s,a),a};const _c={open:"stale",in_review:"recorded",closed:"neutral"},zc={preserved:"recorded",preserving:"partial",nvr_only:"stale",missing:"error",unknown:"unknown",none:"neutral"},Sc=(e,t)=>new Intl.DateTimeFormat("he-IL",{timeZone:t,dateStyle:"short",timeStyle:"short"}).format(new Date(e)),Mc=[{key:"title",label:"תיק",render:e=>r`<strong>${String(e.title)}</strong>${e.tags?r`<div style="font-size:11px;color:var(--sw-text-3)">${String(e.tags)}</div>`:c}`},{key:"status",label:"סטטוס",render:e=>r`<sw-badge kind=${_c[e.status]} label=${ps[e.status]}></sw-badge>`},{key:"owner",label:"בעלים"},{key:"items",label:"פריטים"},{key:"preserved",label:"עותקים שמורים",render:e=>r`${String(e.preserved)} מתוך ${String(e.clips)}`},{key:"updated",label:"עודכן",ltr:!0,render:e=>Sc(String(e.updated))}],Ac=[{key:"title",label:"תיק",render:e=>r`<strong>${String(e.title)}</strong>`},{key:"status",label:"סטטוס",render:e=>r`<sw-badge kind=${e.status==="פתוח"?"stale":e.status==="סגור"?"neutral":"recorded"} label=${String(e.status)}></sw-badge>`},{key:"owner",label:"בעלים"},{key:"clips",label:"קטעים"},{key:"notes",label:"הערות"},{key:"preserved",label:"ראיות שמורות",render:e=>r`${e.preserved} שמורות${Number(e.missing)?r` · <span style="color:var(--sw-danger)">${e.missing} חסרות</span>`:""}`},{key:"more",label:"",width:"40px",render:()=>r`<sw-button variant="ghost" size="sm" iconOnly icon="more" label="עוד"></sw-button>`}];let ye=class extends ${constructor(){super(...arguments),this.cases=[],this.canManage=!1,this.loading=!1,this.error="",this.status="all",this.q="",this.creating=!1,this.newTitle="",this.newDesc="",this.newTags="",this.busy=!1,this.qTimer=0}connectedCallback(){super.connectedCallback(),g()&&this.load()}async load(){this.loading=!0,this.error="";try{const e=await Ir({status:this.status==="all"?void 0:this.status,q:this.q||void 0});this.cases=e.cases,this.canManage=e.can_manage}catch(e){this.error=w(e)}finally{this.loading=!1}}setStatus(e){this.status=e,this.load()}onQuery(e){this.q=e,window.clearTimeout(this.qTimer),this.qTimer=window.setTimeout(()=>void this.load(),250)}async create(){if(this.newTitle.trim()){this.busy=!0,this.error="";try{const e=await Er({title:this.newTitle.trim(),description:this.newDesc,tags:this.newTags.split(",").map(t=>t.trim()).filter(Boolean)});this.creating=!1,this.newTitle=this.newDesc=this.newTags="",b(`/investigate/cases/${e.id}`)}catch(e){this.error=w(e)}finally{this.busy=!1}}}renderApi(){const e=this.cases.map(t=>({id:t.id,title:t.title,status:t.status,owner:t.owner_username,items:t.counts.items,clips:t.counts.events+t.counts.clips,preserved:t.counts.preserved,updated:t.updated_at,tags:t.tags.join(" · ")}));return r`
      <sw-page heading="תיקים" subheading="קישור להקלטה אינו שימור: ראיה נחשבת שמורה רק אחרי העתקה מאומתת מה־NVR">
        ...
        ${this.error?r`<div class="err">${this.error}</div>`:c}
        ${this.loading&&!this.cases.length?r`<sw-state-panel state="loading"></sw-state-panel>`:this.cases.length?r`<sw-table data-cases-table .columns=${Mc} .rows=${e} @row-select=${t=>b(`/investigate/cases/${t.detail.id}`)}></sw-table>`:r`<sw-state-panel state="empty" heading="אין תיקים עדיין" hint="פתח תיק מדף אירוע, מהנגן או מהמפה ההיסטורית (הוסף לתיק), או כאן."></sw-state-panel>`}
    ...
    `}render(){return g()?this.renderApi():r`
      <sw-page heading="תיקים" subheading="קישור להקלטה אינו שימור: ראיה נחשבת שמורה רק אחרי העתקה מאומתת ו־hash · נתוני הדגמה">
        ...
        <sw-table .columns=${Ac} .rows=${Pi} @row-select=${e=>b(`/investigate/cases/${e.detail.id}`)}></sw-table>
      </sw-page>
    `}};ye.styles=k`
    .bar {
      display: flex;
  ...
  `;H([d()],ye.prototype,"cases",2);H([d()],ye.prototype,"canManage",2);H([d()],ye.prototype,"loading",2);H([d()],ye.prototype,"error",2);H([d()],ye.prototype,"status",2);H([d()],ye.prototype,"q",2);H([d()],ye.prototype,"creating",2);H([d()],ye.prototype,"newTitle",2);H([d()],ye.prototype,"newDesc",2);H([d()],ye.prototype,"newTags",2);H([d()],ye.prototype,"busy",2);ye=H([_("investigate-cases")],ye);let X=class extends ${constructor(){super(...arguments),this.caseId="case-1",this.tab="details",this.data=null,this.error="",this.info="",this.busy=!1,this.tz="Asia/Jerusalem",this.noteText="",this.editing=!1,this.editTitle="",this.editDesc="",this.editTags="",this.confirmDelete=!1,this.bundles=[],this.verifyResult=null,this.cams=[],this.snapCam="",this.loadedFor="",this.pollTimer=0}updated(e){e.has("caseId")&&g()&&this.loadedFor!==this.caseId&&this.load()}disconnectedCallback(){super.disconnectedCallback(),window.clearTimeout(this.pollTimer)}async load(){const e=this.caseId;this.loadedFor=e,this.error="";try{const[t,s]=await Promise.all([Ve(),Td(e)]);this.tz=t["time.zone"]??this.tz,this.data=s,this.bundles=(await Vd(e).catch(()=>({bundles:[]}))).bundles,this.cams.length||(this.cams=(await Ee().catch(()=>({cameras:[]}))).cameras.filter(i=>i.enabled),!this.snapCam&&this.cams[0]&&(this.snapCam=this.cams[0].id)),window.clearTimeout(this.pollTimer),s.items.some(i=>i.preservation==="preserving")&&(this.pollTimer=window.setTimeout(()=>void this.load(),5e3))}catch(t){this.error=w(t)}}fmt(e){return new Intl.DateTimeFormat("he-IL",{timeZone:this.tz,dateStyle:"short",timeStyle:"medium"}).format(new Date(e))}async run(e,t=""){this.busy=!0,this.error="";try{await e(),this.info=t,await this.load(),t&&setTimeout(()=>this.info="",4e3)}catch(s){this.error=w(s),s instanceof xe&&s.status===409&&await this.load()}finally{this.busy=!1}}patchCase(e){const t=this.data;t&&this.run(async()=>{await Dd(t.id,{revision:t.revision,...e})})}async verify(e){if(e){this.verifyResult=null,this.busy=!0,this.error="";try{this.verifyResult=await Ud(e)}catch(t){this.error=w(t)}finally{this.busy=!1}}}renderBundleCard(e){const t=this.verifyResult;return r`<sw-card heading="חבילת ראיות" subheading="ZIP עם הקטעים השמורים, התמונות, ההערות, manifest עם SHA-256 לכל קובץ ודוח קריא" data-bundle>
      ${e.can_manage?r`<sw-button size="sm" variant="primary" icon="download" data-bundle-create ?disabled=${this.busy} @click=${()=>void this.run(async()=>{await Hd(e.id)},'החבילה נוצרה; פריטים שאינם עותק שמור מופיעים בה כ"לא נכללו"')}>צור חבילת ראיות</sw-button>`:c}
      ${this.bundles.length?r`<div class="items" style="margin-block-start:8px">${this.bundles.map(s=>r`<div class="item" data-bundle-row style="grid-template-columns:minmax(0,1fr) auto"><div class="body"><strong class="ltr">${s.name}</strong><span class="meta">${Vt(s.bytes)} · ${this.fmt(s.created_at)}${s.signed?` · חתום · מפתח ${s.signed}`:" · ללא חתימה"}</span></div><div class="acts"><a href=${jd(e.id,s.name)} download><sw-button size="sm" icon="download">הורדה</sw-button></a></div></div>`)}</div>`:r`<div class="hint" style="margin-block-start:6px">עדיין לא נוצרה חבילה לתיק הזה.</div>`}
    ...
    </sw-card>`}renderItem(e,t){const s=e.kind==="event"?`אירוע · ${K[e.event?.type??"other"]??e.event?.type??""}`:e.kind==="clip"?"קטע הקלטה":e.kind==="snapshot"?"תמונה":"הערה",i=e.preservation,a=e.kind==="event"&&e.event?e.event.occurred_at:e.from_at,n=e.kind==="note"?r`<div class="thumb"><sw-icon name="edit" size=${18}></sw-icon></div>`:e.kind==="snapshot"?r`<img class="thumb" src=${Fd(t.id,e.id)} alt="תמונה מהמצלמה" />`:e.kind==="event"&&e.event?.thumbnail==="ready"&&e.event_id?r`<img class="thumb" src=${zt(e.event_id)} alt="" />`:e.camera_id&&a?r`<img class="thumb" src=${ni(e.camera_id,a)} alt="" @error=${o=>o.target.style.visibility="hidden"} />`:r`<div class="thumb"></div>`;return r`<div class="item" data-case-item data-kind=${e.kind} data-preservation=${i}>
      ${n}
      <div class="body">
        <div class="head"><strong>${s}</strong>${e.camera_name?r`<span>· ${e.camera_name}</span>`:c}${i!=="none"?r`<sw-badge kind=${zc[i]} label=${Cd[i]}></sw-badge>`:c}</div>
      ...
      <div class="acts">
        ...
        ${t.can_manage&&e.kind!=="note"&&(i==="nvr_only"||i==="unknown")?r`<sw-button size="sm" icon="download" data-item-preserve ?disabled=${this.busy} @click=${()=>void this.run(()=>Nd(t.id,e.id).then(()=>{}),"עבודת שימור נוצרה; הפריט יסומן כשמור כשההעתקה תסתיים")}>שמור עותק</sw-button>`:c}
        ${e.export?.download_ready?r`<a href=${Dr(e.export.id)} download><sw-button size="sm" variant="ghost" icon="download">הורדה</sw-button></a>`:c}
        ${t.can_manage?r`<sw-button size="sm" variant="ghost" iconOnly icon="close" label="הסר מהתיק" data-item-remove ?disabled=${this.busy} @click=${()=>void this.run(()=>Rd(t.id,e.id).then(()=>{}))}></sw-button>`:c}
      </div>
      ...
      <sw-page heading=${e.title} subheading=${`${ps[e.status]} · בעלים: ${e.owner_username} · ${t.items} פריטים · ${t.preserved} עותקים שמורים · עודכן ${this.fmt(e.updated_at)}`} crumbs="חקירה | תיקים" wide>
        ...
        <div class="wrap">
          ...
          <sw-card heading="ראיות והערות" subheading=${e.checked?"מצב השימור נבדק מול ה־NVR עכשיו":"מצב השימור לא נבדק מול ה־NVR"}>
            ...
            ${e.can_manage&&e.status!=="closed"?r`<div class="composer"><sw-field label="הערה חדשה"><textarea rows="2" data-note-text .value=${this.noteText} @input=${s=>this.noteText=s.target.value}></textarea></sw-field><sw-button size="sm" icon="plus" data-note-add ?disabled=${this.busy||!this.noteText.trim()} @click=${()=>void this.run(async()=>{await Ri(e.id,{kind:"note",note:this.noteText.trim()}),this.noteText=""})}>הוסף הערה</sw-button></div>
                  <div class="composer"><sw-field label="תמונה ממצלמה לתיק (עותק שמור מיידי)"><select aria-label="מצלמה לצילום" data-snapshot-camera @change=${s=>this.snapCam=s.target.value}>${this.cams.map(s=>r`<option value=${s.id} ?selected=${s.id===this.snapCam}>${s.name}</option>`)}</select></sw-field><sw-button size="sm" icon="camera" data-snapshot-add ?disabled=${this.busy||!this.snapCam} @click=${()=>void this.run(async()=>{await Ri(e.id,{kind:"snapshot",camera_id:this.snapCam})},"התמונה נשמרה בתיק עם ה־hash שלה")}>צלם תמונה לתיק</sw-button></div>`:c}
          </sw-card>
        ...
        ${this.confirmDelete?r`<sw-dialog open heading="מחיקת תיק" subheading="הפריטים בתיק יימחקו; ההקלטות ב־NVR והעותקים שיוצאו נשארים" @close=${()=>this.confirmDelete=!1}>
              ...
              <sw-button slot="footer" variant="danger" icon="trash" data-case-delete-confirm ?disabled=${this.busy} @click=${()=>{this.confirmDelete=!1,this.run(async()=>{await Od(e.id),b("/investigate/cases")})}}>מחק תיק</sw-button>
            </sw-dialog>`:c}
      </sw-page>
    `}render(){if(g())return this.renderApi();const e=Pi.find(t=>t.id===this.caseId)??Pi[0];return r`
  ...
  `;H([m()],X.prototype,"caseId",2);H([d()],X.prototype,"tab",2);H([d()],X.prototype,"data",2);H([d()],X.prototype,"error",2);H([d()],X.prototype,"info",2);H([d()],X.prototype,"busy",2);H([d()],X.prototype,"tz",2);H([d()],X.prototype,"noteText",2);H([d()],X.prototype,"editing",2);H([d()],X.prototype,"editTitle",2);H([d()],X.prototype,"editDesc",2);H([d()],X.prototype,"editTags",2);H([d()],X.prototype,"confirmDelete",2);H([d()],X.prototype,"bundles",2);H([d()],X.prototype,"verifyResult",2);H([d()],X.prototype,"cams",2);H([d()],X.prototype,"snapCam",2);X=H([_("investigate-case-detail")],X);var Pc=Object.defineProperty,Ic=Object.getOwnPropertyDescriptor,oi=(e,t,s,i)=>{for(var a=i>1?void 0:i?Ic(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&Pc(t,s,a),a};const Ba={queued:"ממתין",running:"מוריד",done:"הושלם",partial:"חלקי",failed:"נכשל",cancelled:"בוטל",interrupted:"הופסק"},Ec={queued:"neutral",running:"live",done:"recorded",partial:"partial",failed:"error",cancelled:"unknown",interrupted:"stale"};let Gt=class extends ${constructor(){super(...arguments),this.jobs=null,this.ffmpeg=!0,this.error=""}connectedCallback(){super.connectedCallback(),g()&&(this.load(),this.timer=window.setInterval(()=>this.poll(),3e3))}disconnectedCallback(){super.disconnectedCallback(),window.clearInterval(this.timer)}async load(){try{const e=await ec();this.jobs=e.jobs,this.ffmpeg=e.ffmpeg,this.error=""}catch(e){this.error=w(e)}}poll(){this.jobs?.some(e=>e.state==="queued"||e.state==="running")&&this.load()}fmt(e,t){return new Intl.DateTimeFormat("he-IL",{timeZone:t,day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit",second:"2-digit",hourCycle:"h23"}).format(new Date(e))}async cancel(e){try{await tc(e.id),await this.load()}catch(t){this.error=w(t)}}async removeJob(e){try{await sc(e.id),await this.load()}catch(t){this.error=w(t)}}renderApi(){return this.error&&!this.jobs?r`<sw-state-panel state="error" hint=${this.error} actionLabel="נסה שוב" @action=${()=>this.load()}></sw-state-panel>`:this.jobs?this.jobs.length?r`
      ...
      <sw-card>
        ${this.jobs.map(e=>{const t=Math.round((e.progress??0)*100),s=e.files.filter(i=>i.state==="downloaded"||i.state==="remuxed").length;return r`<div class="job">
            <div>
              <div class="title"><strong>${e.camera_name}</strong><sw-badge kind=${Ec[e.state]} label=${Ba[e.state]}></sw-badge></div>
              <div class="meta"><span class="ltr">${this.fmt(e.requested_from,e.timezone)} → ${this.fmt(e.requested_to,e.timezone)}</span> · ${e.files.length} קבצים (${s} ירדו) · משוער ${Vt(e.estimate_bytes)}${e.actual_from?r` · בפועל <span class="ltr">${this.fmt(e.actual_from,e.timezone)} → ${this.fmt(e.actual_to??e.actual_from,e.timezone)}</span>`:c}</div>
            ...
            <div><div class="bar ${e.state==="failed"?"fail":e.state==="partial"?"partial":""}"><i style="inline-size:${t}%"></i></div><div class="meta">${Ba[e.state]} · ${t}%${e.state==="running"?` · ${Vt(e.files.reduce((i,a)=>i+a.bytes,0))}`:""}</div></div>
            <div class="actions">
              ${e.download_ready?r`<a href=${Dr(e.id)} download=${e.output_name??""}><sw-button size="sm" icon="download">הורדה</sw-button></a><a href=${ic(e.id)} target="_blank" rel="noopener"><sw-button size="sm" variant="ghost" icon="list">מניפסט</sw-button></a>`:c}
  ...
  `;oi([d()],Gt.prototype,"jobs",2);oi([d()],Gt.prototype,"ffmpeg",2);oi([d()],Gt.prototype,"error",2);Gt=oi([_("investigate-exports")],Gt);const Cc={zone:"חדר / אזור",camera:"מצלמה",floor:"קומה",building:"מבנה",entity:"ישות HA"},Tc={zone:"map",camera:"camera",floor:"floor",building:"building",entity:"light"},Dc=(e,t=8)=>z(`search?q=${encodeURIComponent(e)}&limit=${t}`),Oc=(e,t=30)=>z(`search/semantic?q=${encodeURIComponent(e)}&limit=${t}`),Rc=()=>z("search/providers"),Nc={person:"אדם",vehicle:"רכב",motion:"תנועה",door:"דלת",line:"חציית קו",field:"חדירה"};var Lc=Object.defineProperty,Bc=Object.getOwnPropertyDescriptor,Nt=(e,t,s,i)=>{for(var a=i>1?void 0:i?Bc(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&Lc(t,s,a),a};const Hc=[{scene:"entrance",when:"14.09.2026 10:14",cam:"כניסה ראשית",why:"NVR: זיהוי אדם (Smart)"},{scene:"lobby",when:"14.09.2026 10:13",cam:"לובי",why:"NVR: תנועה + סמיכות במפה לכניסה"},{scene:"parking",when:"14.09.2026 06:43",cam:"חניה מקורה",why:"NVR: חציית קו"},{scene:"entrance",when:"14.09.2026 08:12",cam:"כניסה ראשית",why:"HA: דלת נפתחה + תנועה"},{scene:"corridor",when:"13.09.2026 23:10",cam:"מסדרון מזרחי",why:"NVR: זיהוי אדם"},{scene:"backyard",when:"13.09.2026 18:03",cam:"חצר אחורית",why:"NVR: תנועה"}];let it=class extends ${constructor(){super(...arguments),this.by="person",this.q="",this.answer=null,this.providers=null,this.busy=!1,this.error=""}connectedCallback(){super.connectedCallback(),g()&&this.loadProviders()}async loadProviders(){try{this.providers=await Rc()}catch(e){this.error=w(e)}}async run(){const e=this.q.trim();if(e){this.busy=!0,this.error="";try{this.answer=await Oc(e)}catch(t){this.error=w(t)}finally{this.busy=!1}}}fmt(e){try{return new Date(e).toLocaleString("he-IL",{day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit"})}catch{return e}}renderApi(){const e=this.answer,t=this.providers,s=t?.providers.find(n=>n.id==="local"),i=t?.providers.find(n=>n.id==="external"),a={person:"אדם",vehicle:"רכב",motion:"תנועה",line:"חציית קו",field:"חדירה",door:"דלת",offline:"ניתוק",coverage_gap:"פער כיסוי",other:"אחר"};return r`
      <sw-page heading="חיפוש AI" subheading="שאלה חופשית → מסננים של מרכז האירועים (סוג, מקום, זמן) · baseline מקומי ללא רשת · ספק חיצוני רק ב־opt-in">
        ...
        <div class="wrap">
          ...
          ${e?r`<sw-card heading="כך פורשה השאלה" subheading=${`${e.provider.name} · ${e.provider.model_version} · ללא רשת`} data-semantic-parsed>
                  <div class="chips">
                    ${e.parsed.objects.map(n=>r`<sw-chip selected icon="target">${Nc[n]??n}</sw-chip>`)}
    ...
    `}render(){return g()?this.renderApi():r`
      <sw-page heading="חיפוש AI" subheading="מצא בדיוק את מה שאתה מחפש · חיפוש סמנטי רק עם אינדקס אמיתי · נתוני הדגמה">
        ...
        <div class="wrap">
          ...
          <div class="results">
            ${Hc.map(e=>r`<div class="res" @click=${()=>window.location.hash="#/investigate/playback"}><div class="pic"><sw-scene kind=${e.scene}></sw-scene><span class="demo">דמו</span></div><div class="cap">${e.when}<small>${e.cam} · ${e.why}</small></div></div>`)}
          </div>
        </div>
      </sw-page>
    `}};it.styles=k`
  ...
  `;Nt([d()],it.prototype,"by",2);Nt([d()],it.prototype,"q",2);Nt([d()],it.prototype,"answer",2);Nt([d()],it.prototype,"providers",2);Nt([d()],it.prototype,"busy",2);Nt([d()],it.prototype,"error",2);it=Nt([_("investigate-search")],it);const Vc=()=>({name:"",description:"",enabled:!0,owner:"local",ha_automation_id:null,trigger:{types:[],sources:[],severity_min:"info"},scope:{site_ids:[],building_ids:[],floor_ids:[],zone_ids:[],camera_ids:[],entity_ids:[]},window:{days:[],from:null,to:null},cooldown_s:300,actions:[{kind:"notify",message:""}]}),jc=()=>z("rules"),Fc=e=>A("rules",e),Ha=(e,t)=>Be(`rules/${e}`,t),Uc=e=>he(`rules/${e}`),Va=(e,t=24)=>A("rules/dry-run",{rule:e,hours:t}),Wc=(e=!1)=>z(`rules/alerts${e?"?unacked=true":""}`),Zc=e=>A(`rules/alerts/${e}/ack`),ja={mon:"ב׳",tue:"ג׳",wed:"ד׳",thu:"ה׳",fri:"ו׳",sat:"ש׳",sun:"א׳"},qc={alertstream:"התראת NVR",recording:"נגזר מהקלטה",system:"מערכת",ha:"חיישן HA"};var Kc=Object.defineProperty,Gc=Object.getOwnPropertyDescriptor,ae=(e,t,s,i)=>{for(var a=i>1?void 0:i?Gc(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&Kc(t,s,a),a};const Fa={"r-1":{icon:"user",bg:"#eaf0ff",fg:"#2f6bff"},"r-2":{icon:"move",bg:"#e8f8ee",fg:"#16a34a"},"r-3":{icon:"door",bg:"#fff4e0",fg:"#d97706"},"r-4":{icon:"offline",bg:"#fdecec",fg:"#ef4444"}};let ie=class extends ${constructor(){super(...arguments),this.tab="rules",this.rules=[],this.alerts=[],this.unacked=0,this.meta={types:[],sources:[],days:[]},this.error="",this.busy=!1,this.loading=!1,this.editing=null,this.dry=null,this.dryBusy=!1,this.tree=null,this.cams=[],this.zones=[],this.confirmDelete=null,this.tz="Asia/Jerusalem"}connectedCallback(){super.connectedCallback(),g()&&this.load()}async load(){this.loading=!0,this.error="";try{const[e,t]=await Promise.all([jc(),Wc()]);if(this.rules=e.rules,this.meta={types:e.types,sources:e.sources,days:e.days},this.alerts=t.alerts,this.unacked=t.unacked,!this.tree){const[s,i]=await Promise.all([gt(),Ee()]);this.tree=s,this.cams=i.cameras.filter(a=>a.enabled)}}catch(e){this.error=w(e)}finally{this.loading=!1}}fmt(e){return e?new Intl.DateTimeFormat("he-IL",{timeZone:this.tz,dateStyle:"short",timeStyle:"short"}).format(new Date(e)):"—"}get floors(){return(this.tree?.sites??[]).flatMap(e=>(e.buildings??[]).flatMap(t=>(t.floors??[]).map(s=>({id:s.id,name:`${t.name} · ${s.name}`}))))}async run(e){this.busy=!0,this.error="";try{await e(),await this.load()}catch(t){this.error=w(t),t instanceof xe&&t.status===409&&await this.load()}finally{this.busy=!1}}openEditor(e){if(this.dry=null,this.zones=[],e){const{id:t,revision:s,alerts:i,created_by_username:a,updated_by_username:n,created_at:o,updated_at:l,last_fired_at:p,...f}=e;this.editing={id:t,revision:s,body:JSON.parse(JSON.stringify(f))},f.scope.floor_ids.length===1&&this.loadZones(f.scope.floor_ids[0])}else this.editing={id:null,revision:0,body:Vc()}}async loadZones(e){try{this.zones=(await Zo(e)).zones}catch{this.zones=[]}}edit(e){if(!this.editing)return;const t=JSON.parse(JSON.stringify(this.editing.body));e(t),this.editing={...this.editing,body:t}}toggleIn(e,t){const s=e.indexOf(t);s>=0?e.splice(s,1):e.push(t)}async dryRun(){if(this.editing){this.dryBusy=!0,this.error="";try{this.dry=this.editing.id?await Va({...this.editing.body},24):await Va(this.editing.body,24)}catch(e){this.error=w(e)}finally{this.dryBusy=!1}}}save(){const e=this.editing;!e||!e.body.name.trim()||this.run(async()=>{e.id?await Ha(e.id,{...e.body,revision:e.revision}):await Fc(e.body),this.editing=null,this.dry=null})}summary(e){const t=e.trigger.types.length?e.trigger.types.map(a=>K[a]??a).join(", "):"כל הסוגים",s=e.scope.floor_ids.length||e.scope.zone_ids.length||e.scope.camera_ids.length||e.scope.building_ids.length||e.scope.site_ids.length?[e.scope.floor_ids.length?`${e.scope.floor_ids.length} קומות`:"",e.scope.zone_ids.length?`${e.scope.zone_ids.length} אזורים`:"",e.scope.camera_ids.length?`${e.scope.camera_ids.length} מצלמות`:""].filter(Boolean).join(" · "):"כל המתקן",i=e.window.from||e.window.to||e.window.days.length?`${e.window.days.map(a=>ja[a]??a).join("")||"כל יום"} ${e.window.from??"00:00"}–${e.window.to??"24:00"}`:"תמיד";return`${t} · ${s} · ${i} · השהיה ${e.cooldown_s} שנ׳ · ${e.owner==="ha"?`בבעלות HA (${e.ha_automation_id})`:"התראה במערכת"}`}renderEditor(){const e=this.editing;if(!e)return c;const t=e.body,s=this.dry;return r`<sw-dialog open heading=${e.id?"עריכת חוק":"חוק חדש"} subheading="Trigger → היקף → חלון זמן → השהיה → התראה במערכת · הרצה יבשה לפני שמירה" data-rule-dialog @close=${()=>this.editing=null}>
      ${this.error?r`<div class="err">${this.error}</div>`:c}
      ...
      <sw-field label="מקורות (ריק = הכל)"><div class="chips">${this.meta.sources.map(i=>r`<sw-chip ?selected=${t.trigger.sources.includes(i)} @click=${()=>this.edit(a=>this.toggleIn(a.trigger.sources,i))}>${qc[i]??i}</sw-chip>`)}</div></sw-field>
      <div class="two">
      ...
      <sw-field label="ימים (ריק = כל יום)"><div class="chips">${this.meta.days.map(i=>r`<sw-chip ?selected=${t.window.days.includes(i)} @click=${()=>this.edit(a=>this.toggleIn(a.window.days,i))}>${ja[i]??i}</sw-chip>`)}</div></sw-field>
      <div class="two">
      ...
      <sw-page heading="התראות וחוקי אוטומציה" subheading="Trigger → היקף → חלון זמן → השהיה → התראה במערכת · הרצה יבשה לפני הפעלה · אין פקודות למכשירים">
        ...
        ${this.tab==="rules"?this.loading&&!this.rules.length?r`<sw-state-panel state="loading"></sw-state-panel>`:this.rules.length?r`<div class="list">${this.rules.map(e=>r`<sw-card flush class="rule" data-rule-row data-rule-id=${e.id} style="--bg:#eaf0ff;--fg:#2f6bff">
                  ...
                  ${e.acked_at?r`<span class="last">טופל · ${e.acked_by_username??""}</span>`:r`<sw-button size="sm" icon="check" data-alert-ack ?disabled=${this.busy} @click=${()=>void this.run(async()=>{await Zc(e.id)})}>סמן כטופל</sw-button>`}
        ...
        ${this.confirmDelete?r`<sw-dialog open heading="מחיקת חוק" subheading=${this.confirmDelete.name} @close=${()=>this.confirmDelete=null}>
              ...
              <sw-button slot="footer" variant="danger" icon="trash" data-rule-delete-confirm @click=${()=>{const e=this.confirmDelete;this.confirmDelete=null,this.run(async()=>{await Uc(e.id)})}}>מחק</sw-button>
            </sw-dialog>`:c}
      </sw-page>
    `}render(){return g()?this.renderApi():r`
      <sw-page heading="התראות וחוקי אוטומציה" subheading="Trigger → היקף → תנאים → פעולה · בדיקה יבשה לפני הפעלה · נתוני הדגמה">
        ...
        <sw-tabs .items=${[{id:"rules",label:"חוקים",count:Ii.length},{id:"notif",label:"התראות"},{id:"sched",label:"לוחות זמנים"},{id:"trig",label:"Triggers"}]} .active=${this.tab} @change=${e=>this.tab=e.detail.id}></sw-tabs>
        ${this.tab==="rules"?r`<div class="list">
              ${Ii.map(e=>{const t=Fa[e.id]??Fa["r-1"];return r`<sw-card flush class="rule" style="--bg:${t.bg};--fg:${t.fg}">
  ...
  `;ae([d()],ie.prototype,"tab",2);ae([d()],ie.prototype,"rules",2);ae([d()],ie.prototype,"alerts",2);ae([d()],ie.prototype,"unacked",2);ae([d()],ie.prototype,"meta",2);ae([d()],ie.prototype,"error",2);ae([d()],ie.prototype,"busy",2);ae([d()],ie.prototype,"loading",2);ae([d()],ie.prototype,"editing",2);ae([d()],ie.prototype,"dry",2);ae([d()],ie.prototype,"dryBusy",2);ae([d()],ie.prototype,"tree",2);ae([d()],ie.prototype,"cams",2);ae([d()],ie.prototype,"zones",2);ae([d()],ie.prototype,"confirmDelete",2);ie=ae([_("investigate-rules")],ie);let qs=class extends ${constructor(){super(...arguments),this.ruleId="r-1"}render(){const e=Ii.find(t=>t.id===this.ruleId)??{name:"חוק חדש",trigger:"זיהוי אדם",scope:"חוץ",action:"התראה"};return r`
  ...
  `;ae([m()],qs.prototype,"ruleId",2);qs=ae([_("investigate-rule-editor")],qs);const Yc=()=>z("identity/users"),Jc=()=>A("identity/sync"),Rs=()=>z("access/roles"),Xc=e=>A("access/bindings",e),Qc=e=>he(`access/bindings/${e}`),ep=()=>z("access/groups"),tp=e=>A("access/groups",{name:e}),sp=e=>he(`access/groups/${e}`),ip=(e,t)=>Xt(`access/groups/${e}/members`,{user_ids:t}),ap=e=>A("access/preview",e),Ua=(e={})=>{const t=new URLSearchParams;e.prefix&&t.set("prefix",e.prefix),e.actor&&t.set("actor",e.actor),e.resourceId&&t.set("resource_id",e.resourceId),e.limit&&t.set("limit",String(e.limit));const s=t.toString();return z(`audit${s?`?${s}`:""}`)},Wa={verified:"מסונכרן",stale:"סנכרון מיושן",removed:"מושבת / נמחק ב־HA",unavailable:"לא בספריית HA",unknown:"טרם סונכרן",dev:"משתמש פיתוח"},rp={"rbac.bind":"שיוך תפקיד","rbac.unbind":"ביטול שיוך","rbac.group_create":"יצירת קבוצה","rbac.group_members":"שינוי חברי קבוצה","rbac.group_delete":"מחיקת קבוצה","rbac.bootstrap_admin":"מנהל ראשון (bootstrap)","identity.user_disabled":"משתמש הושבת (HA)","identity.user_enabled":"משתמש הופעל (HA)","identity.sync":"סנכרון ספרייה"};function lt(e){if(!e)return"—";const t=new Date(e);return Number.isNaN(t.getTime())?e:t.toLocaleString("he-IL",{dateStyle:"short",timeStyle:"short"})}const np=e=>A("access/roles",e),op=(e,t)=>Be(`access/roles/${e}`,t),lp=e=>he(`access/roles/${e}`),dp=e=>A("access/roles/preview",e),cp=e=>Xt("access/delegation",{delegable_roles:e});var pp=Object.defineProperty,hp=Object.getOwnPropertyDescriptor,Z=(e,t,s,i)=>{for(var a=i>1?void 0:i?hp(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&pp(t,s,a),a};const up=[{id:"users",label:"משתמשים",count:Ai.length},{id:"groups",label:"קבוצות",count:lr.length},{id:"roles",label:"תפקידים",count:dr.length},{id:"effective",label:"הרשאות אפקטיביות"},{id:"audit",label:"אודיט הרשאות"}];let W=class extends ${constructor(){super(...arguments),this.tab="users",this.selected=null,this.assigning=!1,this.step=0,this.directory=null,this.roles=null,this.groups=null,this.tree=null,this.audit=null,this.selectedGroup=null,this.wizard=null,this.members=null,this.newGroup="",this.preview=null,this.previewUser="",this.previewScope="installation:*",this.busy=!1,this.error="",this.message="",this.forbidden=!1,this.roleEdit=null,this.roleImpact=null,this.roleDelete=null,this.roleImpactTimer=0,this.userColumns=[{key:"name",label:"שם",render:e=>r`<div class="who"><sw-avatar name=${String(e.name)} size=${30}></sw-avatar><div><strong>${String(e.name)}</strong>${e.haAdmin?r` <sw-badge kind="neutral" label="מנהל HA · מידע בלבד"></sw-badge>`:""}<div class="ltr sub">${String(e.haUser)}@ha.local</div></div></div>`},{key:"role",label:"תפקיד",render:e=>{const t=e.bindings[0];return t?r`<span class="pillsel">${t.role}<sw-icon name="chevronDown" size=${11}></sw-icon></span>`:r`<span class="pillsel" style="color:var(--sw-text-3)">ללא שיוך<sw-icon name="chevronDown" size=${11}></sw-icon></span>`}},{key:"scope",label:"היקף גישה",render:e=>{const t=e.bindings[0];return t?r`<span class="pillsel">${t.scope}<sw-icon name="chevronDown" size=${11}></sw-icon></span>`:r`<span class="sub">—</span>`}},{key:"active",label:"מצב",render:e=>r`<span class="status ${e.active?"":"off"}"><i></i>${e.active?"פעיל":"מושבת ב־HA"}</span>`},{key:"lastSync",label:"סנכרון"},{key:"more",label:"",width:"40px",render:()=>r`<sw-button variant="ghost" size="sm" iconOnly icon="more" label="עוד"></sw-button>`}]}connectedCallback(){super.connectedCallback(),g()&&this.load()}async load(){this.error="";try{const[e,t,s,i]=await Promise.all([Yc(),Rs(),ep(),gt()]);this.directory=e,this.roles=t,this.groups=s.groups,this.tree=i,this.forbidden=!1,this.previewUser||(this.previewUser=mt.me?.user.id??"")}catch(e){const t=w(e);this.error=t,this.forbidden=/403|הרשאה|forbidden/i.test(t)&&!this.directory}}async loadAudit(){try{const[e,t]=await Promise.all([Ua({prefix:"rbac.",limit:100}),Ua({prefix:"identity.",limit:50})]);this.audit=[...e.rows,...t.rows].sort((s,i)=>s.at<i.at?1:-1).slice(0,150)}catch(e){this.error=w(e),this.audit=[]}}flash(e){this.message=e,setTimeout(()=>this.message="",3500)}get scopeOptions(){const e=[{type:"installation",id:"*",name:"כל ההתקנה"}];for(const t of this.tree?.sites??[]){e.push({type:"site",id:t.id,name:`אתר · ${t.name}`});for(const s of t.buildings??[]){e.push({type:"building",id:s.id,name:`${t.name} · ${s.name}`});for(const i of s.floors??[])e.push({type:"floor",id:i.id,name:`${t.name} · ${s.name} · ${i.name}`})}}return e}userName(e){return this.directory?.users.find(t=>t.id===e)?.name??e}label(e){return this.roles?.labels[e]??e}startWizard(e,t,s){this.wizard={subjectKind:e,subjectId:t,subjectName:s,roleId:"viewer",scopeKey:"installation:*"}}async saveWizard(){const e=this.wizard;if(!e)return;const[t,s]=e.scopeKey.split(":");this.busy=!0,this.error="";try{const i=await Xc({subject_kind:e.subjectKind,subject_id:e.subjectId,role_id:e.roleId,scope_type:t,scope_id:s});this.flash(`שויך: ${i.role_name} · ${i.scope_name} (רוויזיה ${i.revision})`),this.wizard=null,await this.load()}catch(i){this.error=w(i)}finally{this.busy=!1}}async revoke(e){this.busy=!0,this.error="";try{await Qc(e.id),this.flash(`בוטל: ${e.role_name} · ${e.scope_name}`),await this.load()}catch(t){this.error=w(t)}finally{this.busy=!1}}async sync(){this.busy=!0,this.error="";try{const e=await Jc();this.flash(e.requested?"הספרייה נדחפה מ־Home Assistant":e.note??"הספרייה מתעדכנת אוטומטית כל דקה"),await this.load()}catch(e){this.error=w(e)}finally{this.busy=!1}}async addGroup(){const e=this.newGroup.trim();if(e){this.busy=!0,this.error="";try{const t=await tp(e);this.newGroup="",this.flash(`נוצרה קבוצה "${t.name}"`),await this.load(),this.selectedGroup=t.id}catch(t){this.error=w(t)}finally{this.busy=!1}}}async saveMembers(e){if(this.members){this.busy=!0,this.error="";try{await ip(e.id,[...this.members]),this.members=null,this.flash("חברי הקבוצה עודכנו"),await this.load()}catch(t){this.error=w(t)}finally{this.busy=!1}}}async removeGroup(e){this.busy=!0,this.error="";try{await sp(e.id),this.selectedGroup=null,this.flash(`הקבוצה "${e.name}" נמחקה והשיוכים שלה בוטלו`),await this.load()}catch(t){this.error=w(t)}finally{this.busy=!1}}async runPreview(){if(!this.previewUser)return;const[e,t]=this.previewScope.split(":");this.busy=!0,this.error="";try{this.preview=await ap({user_id:this.previewUser,scope_type:e,scope_id:t})}catch(s){this.error=w(s)}finally{this.busy=!1}}renderBindingRow(e,t){return r`<div class="bind">
      ...
      <div class="stage">
        ...
        ${i?r`<sw-drawer open heading=${i.name} subheading=${`Home Assistant · ${i.username||i.id} · ${i.active?"פעיל":"ללא גישה"}`} @close=${()=>{this.selected=null,this.wizard=null}}>
              ${this.wizard&&this.wizard.subjectKind==="user"?this.renderWizard():r`<dl>
                    ...
                    <dt>סנכרון</dt><dd>${Wa[i.sync_status]}${i.synced_at?` · ${lt(i.synced_at)}`:""}</dd>
    ...
    `}renderUsers(){const e=Ai.find(t=>t.id===this.selected);return r`
      <div class="stage">
        <sw-table .columns=${this.userColumns} .rows=${Ai} .selected=${this.selected} @row-select=${t=>{this.selected=t.detail.id,this.assigning=!1}}></sw-table>
    ...
    `}renderAudit(){return r`<sw-table dense .columns=${[{key:"time",label:"זמן"},{key:"user",label:"משתמש",render:t=>r`<div class="who"><sw-avatar name=${String(t.user)} size=${24}></sw-avatar>${String(t.user)}</div>`},{key:"action",label:"פעולה"},{key:"resource",label:"משאב"},{key:"decision",label:"החלטה",render:t=>r`<sw-badge kind=${String(t.decision).startsWith("נחסם")?"forbidden":"live"} label=${String(t.decision)}></sw-badge>`},{key:"role",label:"תפקיד/היקף ששימשו"}]} .rows=${cr.filter(t=>t.action.includes("תוכנית")||t.action.includes("סנכרון")||t.action.includes("Ingress"))}></sw-table>`}render(){return g()?this.renderApi():r`
      <sw-page heading="משתמשים והרשאות" subheading="זהות מ־Home Assistant · הרשאות בתוך SMPLWISE בלבד · נתוני הדגמה">
        ...
        <sw-tabs .items=${up} .active=${this.tab} @change=${e=>this.tab=e.detail.id}></sw-tabs>
        <div class="notice"><sw-icon name="shield" size=${14}></sw-icon>שיוך כאן אינו משנה דבר ב־Home Assistant: לא קבוצות HA, לא דגל מנהל, לא סיסמאות. אין "הוספת משתמש" — משתמשים נוצרים ב־HA בלבד.</div>
...
`)],{type:"text/csv;charset=utf-8"}),a=document.createElement("a");a.href=URL.createObjectURL(i),a.download=`audit-${new Date().toISOString().slice(0,10)}.csv`,a.click(),setTimeout(()=>URL.revokeObjectURL(a.href),2e3)}renderApi(){const e=this.rows;return r`
      <sw-page heading="יומן אודיט" subheading="מי צפה, שינה, ייצא או שלח פעולה · actor, פעולה, החלטה, משאב, סיבה, request_id, permission_revision · אין סיסמאות או טוקנים ביומן">
        ...
        <div class="filters" data-audit-filters>
          <sw-field><select aria-label="פעולה" .value=${this.family} @change=${t=>{this.family=t.target.value,this.load()}}>${vp.map(t=>r`<option value=${t.id} ?selected=${t.id===this.family}>${t.label}</option>`)}</select></sw-field>
        ...
        ${e===null?r`<sw-state-panel state="loading" heading="טוען יומן…"></sw-state-panel>`:e.length?r`<sw-table data-audit-table .columns=${bp} .rows=${e}></sw-table>`:this.error?c:r`<sw-state-panel state="empty" heading="אין רשומות לסינון הזה" hint="נסה משפחת פעולות אחרת או נקה את שם המשתמש"></sw-state-panel>`}
    ...
    `}render(){return g()?this.renderApi():r`
      <sw-page heading="יומן אודיט" subheading="מי צפה, שינה, ייצא או שלח פעולה · actor, מקור זהות, תפקיד והיקף, החלטה, request_id, permission_revision · נתוני הדגמה">
        ...
        <sw-table .columns=${wp} .rows=${cr}></sw-table>
        <div class="pager">
  ...
  `;ts([d()],vt.prototype,"rows",2);ts([d()],vt.prototype,"error",2);ts([d()],vt.prototype,"family",2);ts([d()],vt.prototype,"actor",2);ts([d()],vt.prototype,"limit",2);vt=ts([_("system-audit")],vt);var yp=Object.defineProperty,$p=Object.getOwnPropertyDescriptor,ze=(e,t,s,i)=>{for(var a=i>1?void 0:i?$p(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&yp(t,s,a),a};const xp=[{key:"nvr_host",label:"כתובת ה־NVR"},{key:"nvr_http_port",label:"פורט ISAPI (HTTP)"},{key:"nvr_rtsp_port",label:"פורט RTSP"},{key:"nvr_username",label:"משתמש NVR (קריאה)"},{key:"nvr_password",label:"סיסמת NVR"},{key:"go2rtc_url",label:"כתובת go2rtc"},{key:"go2rtc_api_username",label:"משתמש go2rtc (אם מוגן)"},{key:"go2rtc_api_password",label:"סיסמת go2rtc"},{key:"bootstrap_admin_username",label:"שם משתמש HA של המנהל הראשון"},{key:"log_level",label:"רמת לוג"}];function xt(e){if(!e)return"—";const t=new Date(e);return Number.isNaN(t.getTime())?String(e):t.toLocaleString("he-IL",{day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit",second:"2-digit"})}const $i=["גילוי","NVR","go2rtc","גשר HA","מנהל ראשון","שעון","סיום"];let ue=class extends ${constructor(){super(...arguments),this.step=0,this.raw=null,this.report=null,this.recorder=null,this.error="",this.busy=!1,this.notify=null,this.notifyError="",this.notifyPlan=null,this.notifyBusy=!1,this.notifyResult="",this.changes=[]}connectedCallback(){super.connectedCallback(),g()&&this.load()}async load(){this.loadNvr(),this.busy=!0;try{this.raw=await z("health"),this.error=""}catch(e){this.error=w(e)}try{this.recorder=(await Ee()).recorder}catch{this.recorder=null}try{this.report=await Mr()}catch{this.report=null}this.busy=!1}check(e){return this.report?.checks.find(t=>t.id===e)??null}row(e,t,s=""){return r`<div class="check"><span>${e}</span><span class=${`val ${s}`}>${t==null||t===""?"—":String(t)}</span></div>`}async loadNvr(){if(g())try{const[e,t]=await Promise.all([pd(),ud(10)]);this.notify=e,this.changes=t.changes,this.notifyError=""}catch(e){this.notifyError=w(e)}}planNotify(e,t,s){const i=e?e.length:this.notify?.channels.length??0;this.notifyResult="",this.notifyPlan={channels:e,smart:t,enabled:s,label:`${s?"הפעלת":"כיבוי"} Notify Surveillance Center ב־${i} ערוצים${t?" · תנועה + אירועים חכמים":" · זיהוי תנועה"}`}}async runNotify(){const e=this.notifyPlan;if(!(!e||this.notifyBusy)){this.notifyBusy=!0;try{const t=await hd({channels:e.channels,smart:e.smart,enabled:e.enabled});this.notifyResult=`בוצע: ${t.applied} שינויים · ${t.unchanged} כבר היו כך · ${t.skipped} דולגו (סוג אירוע שלא מוגדר בערוץ) · ${t.failed} נכשלו`,this.notifyPlan=null,await this.loadNvr()}catch(t){this.notifyResult=w(t)}finally{this.notifyBusy=!1}}}async rollback(e){if(!this.notifyBusy){this.notifyBusy=!0;try{await md(e.id),this.notifyResult=`השינוי ${e.target} הוחזר למצב הקודם.`,await this.loadNvr()}catch(t){this.notifyResult=w(t)}finally{this.notifyBusy=!1}}}renderNotifyCard(){const e=this.notify,t=s=>s===null?"—":s?"✓":"✗";return r`<sw-card heading="התראות מה־NVR (Notify Surveillance Center)" subheading="אילו ערוצים מודיעים ל־VMS על תנועה ועל אירועים חכמים · כתיבה מאושרת ל־NVR, עם החזר" data-nvr-notify>
        ...
        ${e?r`<div class="two" data-connections>
            ...
            <sw-card heading="איפה מגדירים" subheading="הערכים אינם מוצגים כאן ואינם נשמרים ב־VMS; שינוי דורש הפעלה מחדש של ה־Add-on">
              <div class="opts" data-connection-options>
                ${xp.map(t=>r`<div class="check"><span>${t.label}</span><span class="val ltr">${t.key}</span></div>`)}
              </div>
    ...
    `}renderStep(){switch(this.step){case 0:return r`<sw-card heading="גילוי מכשירים" subheading="חיפוש NVR ומצלמות ברשת המקומית · קריאה בלבד, ללא שינוי תצורה במכשיר">
      ...
      <sw-page heading="אשף התקנה" subheading="גילוי NVR ומצלמות, בדיקת זרמים, שמות וקומות · בדיקות קריאה בלבד · נתוני הדגמה">
        <div class="wrap">
          <sw-card><sw-steps .steps=${$i} .current=${this.step}></sw-steps></sw-card>
          ${this.renderStep()}
          <div class="foot">
            ...
            <div style="display:flex;gap:8px">
              ...
              <sw-button variant="primary" @click=${()=>this.step=Math.min($i.length-1,this.step+1)}>${this.step===$i.length-1?"סיום":"הבא"}</sw-button>
            </div>
          </div>
        </div>
      </sw-page>
  ...
  `;ze([d()],ue.prototype,"step",2);ze([d()],ue.prototype,"raw",2);ze([d()],ue.prototype,"report",2);ze([d()],ue.prototype,"recorder",2);ze([d()],ue.prototype,"error",2);ze([d()],ue.prototype,"busy",2);ze([d()],ue.prototype,"notify",2);ze([d()],ue.prototype,"notifyError",2);ze([d()],ue.prototype,"notifyPlan",2);ze([d()],ue.prototype,"notifyBusy",2);ze([d()],ue.prototype,"notifyResult",2);ze([d()],ue.prototype,"changes",2);ue=ze([_("system-setup")],ue);var kp=Object.defineProperty,_p=Object.getOwnPropertyDescriptor,$e=(e,t,s,i)=>{for(var a=i>1?void 0:i?_p(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&kp(t,s,a),a};const Za=["entrance","lobby","corridor","hall","parking","warehouse","backyard","driveway","night"];let pe=class extends ${constructor(){super(...arguments),this.selected=null,this.filter="all",this.cameras=null,this.recorder=null,this.canSync=!1,this.discovery=null,this.busy=!1,this.message="",this.error="",this.dialog=!1,this.formChannel=1,this.formAlias="",this.alias="",this.columns=[{key:"name",label:"מצלמה",render:e=>r`<div class="cam">${e.api&&e.api.status==="online"?r`<img class="snap" src=${Ue(String(e.id))} alt="" loading="lazy" style="inline-size:64px;block-size:40px;object-fit:cover;border-radius:5px;flex-shrink:0;background:var(--sw-surface-3);display:block" @error=${t=>t.target.style.visibility="hidden"} />`:e.scene?r`<sw-scene kind=${e.scene}></sw-scene>`:r`<div class="none"></div>`}<div><b>${String(e.name)}</b><small>${String(e.sub)}</small></div></div>`},{key:"state",label:"מצב",render:e=>r`<span class="status"><i style="--c:${e.state==="live"?"var(--sw-live)":e.state==="offline"?"var(--sw-danger)":e.state==="unknown"?"var(--sw-unknown)":"var(--sw-stale)"}"></i>${e.state==="live"?"מחוברת":e.state==="offline"?"מנותקת":e.state==="stale"?"לא מעודכן":e.state==="forbidden"?"ללא הרשאה":"לא נבדק"}</span>`},{key:"fps",label:"FPS",ltr:!0},{key:"bitrate",label:"קצב",ltr:!0},{key:"firmware",label:"זרם ראשי",ltr:!0},{key:"lastEvent",label:"נראתה לאחרונה"},{key:"net",label:"רשת",render:e=>this.net(e.state==="live"?4:e.state==="stale"?2:0)},{key:"more",label:"",width:"40px",render:()=>r`<sw-button variant="ghost" size="sm" iconOnly icon="more" label="עוד"></sw-button>`}]}connectedCallback(){super.connectedCallback(),this.reload()}async reload(){if(!g()){this.cameras=null;return}try{const e=await Ee();this.cameras=e.cameras,this.recorder=e.recorder,this.canSync=e.can_sync,z("health").then(t=>this.discovery=t.discovery).catch(()=>{})}catch(e){this.error=w(e)}}async sync(){this.busy=!0,this.error="",this.message="";try{const e=await Ao();this.message=`סנכרון הושלם: ${e.channels} ערוצים (${e.created} חדשים, ${e.updated} עודכנו)${e.recorder.model?` · ${e.recorder.model}`:""}`,await this.reload()}catch(e){this.error=w(e)}finally{this.busy=!1}}async register(){this.busy=!0,this.error="";try{await Po({channel:this.formChannel,alias:this.formAlias.trim()}),this.dialog=!1,await this.reload()}catch(e){this.error=w(e)}finally{this.busy=!1}}async saveAlias(e){this.busy=!0,this.error="";try{await Io(e,{alias:this.alias.trim()||void 0}),await this.reload(),this.message="הכינוי נשמר (שם ה־NVR לא השתנה)"}catch(t){this.error=w(t)}finally{this.busy=!1}}get rows(){return this.cameras?this.cameras.map(e=>({id:e.id,name:e.name,sub:`ערוץ ${e.channel}${e.name_source&&e.alias?` · NVR: ${e.name_source}`:""}`,state:e.status==="online"?"live":e.status==="offline"?"offline":"unknown",fps:e.stream?.fps?String(e.stream.fps):"—",bitrate:e.stream?.bitrate_kbps?`${(e.stream.bitrate_kbps/1024).toFixed(1)} Mbps`:"—",firmware:e.stream?.resolution?`${e.stream.resolution} ${e.stream.codec??""}`.trim():"—",lastEvent:e.last_seen_at?e.last_seen_at.replace("T"," ").replace("Z",""):"לא נבדק",scene:e.status==="online"?Za[(e.channel-1)%Za.length]:null,channel:e.channel,api:e})):q.map(e=>({id:e.id,name:e.name,sub:`${e.floor} · ערוץ ${e.id.replace("cam-","")}`,state:e.state,fps:e.fps?String(e.fps):"—",bitrate:e.bitrateKbps?`${(e.bitrateKbps/1024).toFixed(1)} Mbps`:"—",firmware:e.firmware,lastEvent:e.lastEvent,scene:e.state==="offline"||e.state==="forbidden"?null:We[e.id]??"lobby",channel:Number(e.id.replace("cam-",""))}))}net(e){return h`<svg class="net" viewBox="0 0 22 14" aria-label="רשת">${[0,1,2,3].map(t=>h`<rect x=${t*5.5} y=${11-t*3} width="4" height=${3+t*3} rx="1" fill=${t<e?e>=3?"#22c55e":"#f59e0b":"var(--sw-border-strong)"} />`)}</svg>`}render(){const e=this.rows,t=e.filter(a=>this.filter==="all"?!0:this.filter==="online"?a.state==="live":this.filter==="offline"?a.state==="offline":a.state==="stale"||a.state==="forbidden"||a.state==="unknown"),s=e.find(a=>a.id===this.selected),i=!!this.cameras;return r`
  ...
  `;$e([d()],pe.prototype,"selected",2);$e([d()],pe.prototype,"filter",2);$e([d()],pe.prototype,"cameras",2);$e([d()],pe.prototype,"recorder",2);$e([d()],pe.prototype,"canSync",2);$e([d()],pe.prototype,"discovery",2);$e([d()],pe.prototype,"busy",2);$e([d()],pe.prototype,"message",2);$e([d()],pe.prototype,"error",2);$e([d()],pe.prototype,"dialog",2);$e([d()],pe.prototype,"formChannel",2);$e([d()],pe.prototype,"formAlias",2);$e([d()],pe.prototype,"alias",2);pe=$e([_("system-devices")],pe);const ta="sw.design.override",sa="sw.design.last",ms={a:"SW A",b:"SW B"};let Ps="b";const Bi=new Set;function Ks(e){try{return localStorage.getItem(e)}catch{return null}}function Or(e,t){try{t===null?localStorage.removeItem(e):localStorage.setItem(e,t)}catch{}}function zp(){try{const s=new URLSearchParams(window.location.search).get("design");if(s==="a"||s==="b")return s}catch{}const e=Ks(ta);if(e==="a"||e==="b")return e;const t=Ks(sa);return t==="a"||t==="b"?t:"b"}Ps=zp();function Hi(){const e=Ks(ta);return e==="a"||e==="b"?e:null}function Sp(e){Or(ta,e),Nr()}function Rr(){return Ps}function Mp(e){return Bi.add(e),e(Ps),()=>Bi.delete(e)}function dt(e){Ps=e,document.documentElement.dataset.design=e,Or(sa,e),Bi.forEach(t=>t(e))}function Ap(e){try{const t=e?JSON.parse(e):{};return{a:(t.a||ms.a).slice(0,24),b:(t.b||ms.b).slice(0,24)}}catch{return{...ms}}}async function Nr(){const e=new URLSearchParams(window.location.search).get("design");if(e==="a"||e==="b")return dt(e),e;const t=Hi();if(t)return dt(t),t;if(!g())return dt("b"),"b";const s=Ks(sa);(s==="a"||s==="b")&&dt(s);try{const a=(await Ve())["ui.design"]==="b"?"b":"a";return dt(a),a}catch{return dt(s==="b"?"b":"a"),Ps}}const Pp={manual:"ידני",upload:"הועלה","auto-pre-upgrade":"אוטומטי · לפני עדכון","auto-daily":"אוטומטי · יומי"},xi={sites:"אתרים",buildings:"מבנים",floors:"קומות",plan_assets:"קבצי תוכנית",plan_versions:"גרסאות תוכנית",map_anchors:"עוגנים",cameras:"מצלמות",spatial_zones:"אזורים",settings:"הגדרות",users:"משתמשים",bindings:"הרשאות",groups:"קבוצות"},Ip=()=>z("backups"),Ep=(e={})=>A("backups",e),Cp=e=>he(`backups/${encodeURIComponent(e)}`),Tp=(e,t)=>A(`backups/${encodeURIComponent(e)}/restore`,t),Dp=e=>ce(`backups/${encodeURIComponent(e)}/download`);function Op(e){const t=new FormData;return t.append("file",e,e.name),si("backups/upload",t)}function qa(e){return e<1024?`${e} B`:e<1024*1024?`${(e/1024).toFixed(0)} KB`:`${(e/1024/1024).toFixed(1)} MB`}var Rp=Object.defineProperty,Np=Object.getOwnPropertyDescriptor,V=(e,t,s,i)=>{for(var a=i>1?void 0:i?Np(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&Rp(t,s,a),a};const Ka=[{id:"general",label:"כללי"},{id:"media",label:"וידאו ומדיה"},{id:"ha",label:"גשר Home Assistant"},{id:"health",label:"בריאות ועבודות"},{id:"backup",label:"גיבוי ושחזור"},{id:"support",label:"תמיכה"}];let O=class extends ${constructor(){super(...arguments),this.tab="general",this.settings=null,this.canEdit=!1,this.draft={},this.streams=null,this.go2rtc=null,this.foreign=0,this.sessions=[],this.busy=!1,this.message="",this.error="",this.version="",this.ha=null,this.pairing=null,this.showCode=!1,this.regenArmed=!1,this.copied=!1,this.report=null,this.reportBusy=!1,this.backups=null,this.backupPolicy={},this.backupBusy=!1,this.backupNote="",this.backupMsg="",this.restoreTarget=null,this.restoreMode="replace",this.restoreAccess=!1,this.restoreConfirm="",this.health=null}connectedCallback(){super.connectedCallback();const e=Kt().params.get("tab");e&&Ka.some(t=>t.id===e)&&(this.tab=e,e==="health"&&this.loadReport(),e==="backup"&&this.loadBackups(),e==="media"&&this.loadMedia(),e==="ha"&&this.loadHa()),this.loadSettings()}async loadSettings(){if(g())try{const[e,t]=await Promise.all([ar(),z("health").catch(()=>null)]);this.settings=e.settings,this.canEdit=e.can_edit,this.draft={},this.version=t?.version??"",this.health=t??null}catch(e){this.error=w(e)}}async loadMedia(){if(!(!g()||!this.canEdit))try{const[e,t]=await Promise.all([Fn(),Un()]);this.streams=e.streams,this.go2rtc=e.go2rtc,this.foreign=e.foreign_streams,this.sessions=t.sessions,this.error=""}catch(e){this.streams=[],this.error=w(e)}}async loadHa(e=!1){if(g()){this.error="";try{this.ha=await il(),this.canEdit&&(this.pairing=await al(e)),e&&(this.regenArmed=!1,this.showCode=!0,this.message="נוצר קוד צימוד חדש; יש להגדיר מחדש את האינטגרציה ב־Home Assistant.",setTimeout(()=>this.message="",4e3))}catch(t){this.error=w(t)}}}async copyCode(){if(this.pairing)try{await navigator.clipboard.writeText(this.pairing.pairing_code),this.copied=!0,setTimeout(()=>this.copied=!1,2e3)}catch{this.showCode=!0}}async installBridgeNow(){this.busy=!0,this.error="";try{const e=await rl();this.message=e.state==="installed_pending"?"האינטגרציה הועתקה ל־Home Assistant; הפעל מחדש את Home Assistant ואשר את הגשר שהתגלה.":e.state==="active"?"האינטגרציה פעילה.":e.state==="not_available"?"תיקיית ההגדרות של Home Assistant אינה נגישה ל־Add-on.":`מצב: ${e.state}`,await this.loadHa(),setTimeout(()=>this.message="",6e3)}catch(e){this.error=w(e)}finally{this.busy=!1}}integrationText(e){switch(e.state){case"active":return`פעילה ב־Home Assistant (גרסה ${e.active_version??"?"})`;case"installed_pending":return`הועתקה לתיקיית ההגדרות של HA (גרסה ${e.installed_version??"?"}) ב־${Oe(e.installed_at)} · הפעל מחדש את Home Assistant ואז אשר את "SMPLWISE Bridge" שהתגלה בהגדרות → מכשירים ושירותים`;case"update_pending":return`עודכנה לגרסה ${e.installed_version??"?"} אך Home Assistant עדיין מריץ ${e.active_version??"?"} · נדרש Restart ל־Home Assistant`;case"not_installed":return"טרם הועתקה";case"error":return`ההעתקה נכשלה (${e.last_error??""})`;default:return e.last_error==="ha_config_not_mapped"?"ה־Add-on לא רואה את תיקיית ההגדרות של Home Assistant (המיפוי homeassistant_config לא ניתן) · התקנה ידנית לפי השלבים למטה":e.last_error==="source_missing"?"קבצי האינטגרציה חסרים בתמונת ה־Add-on · התקנה ידנית לפי השלבים למטה":`ההתקנה האוטומטית נכשלה (${e.last_error??"סיבה לא ידועה"}) · התקנה ידנית לפי השלבים למטה`}}renderIntegration(e){const t=e.integration;if(!t)return c;const s=t.state==="active"?"live":t.state==="installed_pending"||t.state==="update_pending"?"stale":t.state==="error"?"error":"unknown",i=t.state==="active"?"פעילה":t.state==="installed_pending"?"ממתינה ל־Restart":t.state==="update_pending"?"עדכון ממתין":t.state==="error"?"שגיאה":t.state==="not_installed"?"לא הותקנה":"לא זמין";return r`<div class="row"><span class="lbl">התקנת האינטגרציה ב־Home Assistant<span class="muted">${this.integrationText(t)}${t.discovery_posted_at?` · הוכרזה ל־Supervisor ${Oe(t.discovery_posted_at)}`:""}</span></span><span style="display:flex;gap:8px;align-items:center"><sw-badge kind=${s} label=${i}></sw-badge>${this.canEdit&&t.state!=="not_available"?r`<sw-button size="sm" ?disabled=${this.busy} @click=${()=>this.installBridgeNow()}>התקן / עדכן</sw-button>`:c}</span></div>`}renderHa(){if(!g())return r`<div class="sections"><sw-card heading="גשר Home Assistant"><div class="muted">נתוני הדגמה — הסטטוס והצימוד זמינים מול השרת.</div></sw-card></div>`;const e=this.ha,t=e?.sync,s=this.pairing;return r`<div class="sections">
    ...
    </div>`}set(e,t){this.draft={...this.draft,[e]:t}}value(e){return this.draft[e]??this.settings?.[e]}async save(){if(Object.keys(this.draft).length){this.busy=!0,this.error="";try{const e=await Vn(this.draft);this.settings=e.settings,this.draft={},Aa(),this.message="ההגדרות נשמרו",setTimeout(()=>this.message="",2500)}catch(e){this.error=w(e)}finally{this.busy=!1}}}async sync(){this.busy=!0,this.error="";try{const e=await jn();this.message=`זרמים: ${e.created} נוצרו, ${e.updated} עודכנו, ${e.unchanged} ללא שינוי · ${e.foreign_streams_untouched} זרמים זרים לא נגעו`,await this.loadMedia()}catch(e){this.error=w(e)}finally{this.busy=!1}}renderDesign(){if(!g())return c;const e=Ap(this.value("ui.design_names")),t=this.value("ui.design")??"a",s=Hi(),i="ui.design"in this.draft||"ui.design_names"in this.draft,a=(n,o)=>this.set("ui.design_names",JSON.stringify({...e,[n]:o.slice(0,24)}));return r`<sw-card heading="עיצוב הממשק" subheading=${`פעיל עכשיו בדפדפן הזה: ${e[Rr()]}${s?" (עקיפה מקומית)":""}`}>
    ...
    </sw-card>`}async saveDesign(){await this.save(),!Hi()&&this.settings&&dt(this.settings["ui.design"]==="b"?"b":"a")}renderGeneral(){return r`<div class="sections">
      ${this.renderDesign()}
      ...
      <sw-card heading="בריאות המערכת" subheading="מצב נפרד לכל רכיב, לא נורה אחת">
        <div class="hsum"><sw-badge kind=${Ma[e.status]} label=${e.status==="ok"?"הכל תקין":e.status==="warn"?"יש מה לבדוק":"יש תקלה"}></sw-badge><span>גרסה <span class="ltr">${e.version}</span> · פעיל ${sd(e.uptime_s)} · נבדק <span class="ltr" data-health-checked>${t}</span></span><span class="grow"></span><sw-button size="sm" icon="refresh" ?disabled=${this.reportBusy} @click=${()=>this.loadReport(!0)}>${this.reportBusy?"בודק…":"בדוק עכשיו"}</sw-button></div>
        <div class="hgrid">${e.checks.map(s=>r`<div class="hcard ${s.status}" data-health-card=${s.id}><div class="hh"><span>${s.label}</span><sw-badge kind=${Ma[s.status]} label=${cs[s.status]}></sw-badge></div><div class="hd">${s.detail}</div></div>`)}</div>
      ...
      <sw-card heading="מצבים נפרדים, לא נורה אחת">${hr.map(e=>r`<div class="row"><span class="lbl">${e.name}<span class="muted">${e.detail}</span></span><sw-badge kind=${e.state}></sw-badge></div>`)}
      ...
      <sw-card heading="תור עבודות">${pr.map(e=>r`<div class="row"><span class="lbl">${e.title}<span class="muted">${e.status}</span></span><span style="display:flex;align-items:center;gap:10px"><span class="bar ${e.status.startsWith("נכשל")?"fail":""}"><i style="--p:${e.progress}%"></i></span><span class="ltr">${e.progress}%</span></span></div>`)}</sw-card>
    </div>`}async loadBackups(){if(g())try{const e=await Ip();this.backups=e.backups,this.backupPolicy=e.policy}catch(e){this.error=w(e),this.backups=[]}}async createBackup(){this.backupBusy=!0,this.backupMsg="";try{const e=await Ep({note:this.backupNote.trim()});this.backupNote="",this.backupMsg=`הגיבוי ${e.name} נוצר (${qa(e.bytes)})`,await this.loadBackups()}catch(e){this.error=w(e)}finally{this.backupBusy=!1}}async onBackupFile(e){if(e){this.backupBusy=!0,this.backupMsg="";try{const t=await Op(e);this.backupMsg=`הקובץ הועלה כ־${t.name}; עכשיו אפשר לשחזר ממנו`,await this.loadBackups()}catch(t){this.error=w(t)}finally{this.backupBusy=!1}}}async removeBackup(e){if(window.confirm(`למחוק את הגיבוי ${e.name}?`)){this.backupBusy=!0;try{await Cp(e.name),await this.loadBackups()}catch(t){this.error=w(t)}finally{this.backupBusy=!1}}}openRestore(e){this.restoreTarget=e,this.restoreMode="replace",this.restoreAccess=!1,this.restoreConfirm=""}async doRestore(){const e=this.restoreTarget;if(!(!e||this.restoreConfirm!=="RESTORE")){this.backupBusy=!0,this.error="";try{const t=await Tp(e.name,{mode:this.restoreMode,scope:this.restoreAccess?"project+access":"project",confirm:this.restoreConfirm}),s=Object.entries(t.tables).filter(([i])=>xi[i]).map(([i,a])=>`${a} ${xi[i]}`);this.backupMsg=`שוחזר מ־${e.name} (${t.mode==="replace"?"החלפה":"מיזוג"}): ${s.join(", ")} · ${t.files} קבצים`,this.restoreTarget=null,Aa(),await this.loadBackups()}catch(t){this.error=w(t)}finally{this.backupBusy=!1}}}fmtWhen(e){return new Intl.DateTimeFormat("he-IL",{day:"2-digit",month:"2-digit",year:"numeric",hour:"2-digit",minute:"2-digit",hourCycle:"h23"}).format(new Date(e))}renderBackupRow(e){const t=["sites","floors","plan_versions","map_anchors","spatial_zones","cameras"].filter(s=>e.tables[s]!==void 0).map(s=>`${e.tables[s]} ${xi[s]}`).join(" · ");return r`<div class="brow" data-backup-row>
      <div>
        <div class="name"><span class="ltr">${e.name}</span><sw-badge kind=${e.kind.startsWith("auto")?"neutral":e.kind==="upload"?"stale":"live"} label=${Pp[e.kind]??e.kind}></sw-badge>${e.valid?c:r`<sw-badge kind="error" label="קובץ לא תקין"></sw-badge>`}</div>
        <div class="sub">${this.fmtWhen(e.created_at)} · ${qa(e.bytes)} · גרסה ${e.app_version??"?"}${e.note?` · ${e.note}`:""}</div>
        ${t?r`<div class="sub">${t} · ${e.files} קבצי תוכנית</div>`:c}
      </div>
      <div class="acts">
        <a href=${Dp(e.name)} download=${e.name} data-backup-download><sw-button size="sm" icon="download">הורד</sw-button></a>
    ...
    ${this.restoreTarget?this.renderRestoreDialog(this.restoreTarget):c}`}renderSupport(){return r`<div class="sections"><sw-card heading="חבילת תמיכה מצונזרת">
      ...
      <sw-page heading="הגדרות המערכת" subheading=${g()?"תעבורת וידאו, go2rtc, מכסות ובריאות":"אזור זמן, מדיניות אחסון, אינטגרציות ובריאות · נתוני הדגמה"}>
        <sw-tabs underline .items=${Ka} .active=${this.tab} @change=${e=>{this.tab=e.detail.id,this.tab==="media"&&this.loadMedia(),this.tab==="ha"&&this.loadHa(),this.tab==="backup"&&this.loadBackups(),this.tab==="health"&&this.loadReport()}}></sw-tabs>
  ...
  `;V([d()],O.prototype,"tab",2);V([d()],O.prototype,"settings",2);V([d()],O.prototype,"canEdit",2);V([d()],O.prototype,"draft",2);V([d()],O.prototype,"streams",2);V([d()],O.prototype,"go2rtc",2);V([d()],O.prototype,"foreign",2);V([d()],O.prototype,"sessions",2);V([d()],O.prototype,"busy",2);V([d()],O.prototype,"message",2);V([d()],O.prototype,"error",2);V([d()],O.prototype,"version",2);V([d()],O.prototype,"ha",2);V([d()],O.prototype,"pairing",2);V([d()],O.prototype,"showCode",2);V([d()],O.prototype,"regenArmed",2);V([d()],O.prototype,"copied",2);V([d()],O.prototype,"report",2);V([d()],O.prototype,"reportBusy",2);V([d()],O.prototype,"backups",2);V([d()],O.prototype,"backupPolicy",2);V([d()],O.prototype,"backupBusy",2);V([d()],O.prototype,"backupNote",2);V([d()],O.prototype,"backupMsg",2);V([d()],O.prototype,"restoreTarget",2);V([d()],O.prototype,"restoreMode",2);V([d()],O.prototype,"restoreAccess",2);V([d()],O.prototype,"restoreConfirm",2);V([d()],O.prototype,"health",2);O=V([_("system-diagnostics")],O);var Lp=Object.defineProperty,Bp=Object.getOwnPropertyDescriptor,Ye=(e,t,s,i)=>{for(var a=i>1?void 0:i?Bp(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&Lp(t,s,a),a};const Hp=[{name:"כניסה ראשית",gb:320},{name:"אולם",gb:410},{name:"חצר אחורית",gb:380},{name:"לובי",gb:180},{name:"מחסן",gb:96}];let Ie=class extends ${constructor(){super(...arguments),this.range="30D",this.data=null,this.error="",this.loading=!1,this.tz="Asia/Jerusalem",this.signing=null,this.signingError="",this.signingBusy=!1,this.rotateConfirm=!1}connectedCallback(){super.connectedCallback(),g()&&(this.load(),this.loadSigning())}async load(e=!1){this.loading=!0,this.error="";try{const[t,s]=await Promise.all([Ve(),Sr(e)]);this.tz=t["time.zone"]??this.tz,this.data=s}catch(t){this.error=w(t)}finally{this.loading=!1}}fmt(e){return e?new Intl.DateTimeFormat("he-IL",{timeZone:this.tz,dateStyle:"short",timeStyle:"short"}).format(new Date(e)):"—"}async loadSigning(){try{this.signing=await Ld(),this.signingError=""}catch(e){this.signingError=w(e)}}async rotateKey(){this.signingBusy=!0;try{this.signing=await Bd(),this.rotateConfirm=!1}catch(e){this.signingError=w(e)}finally{this.signingBusy=!1}}renderSigning(){const e=this.signing,t=s=>s?s.replace("T"," ").replace("Z"," UTC"):"—";return r`<sw-card heading="חתימת ראיות" subheading="כל חבילת ראיות חתומה ב־Ed25519 במפתח הפעיל של המתקן; החלק הפרטי נשאר ב־/data/keys ואינו נכלל בגיבוי" data-signing>
      ...
      <sw-page heading="אנליטיקת אחסון" subheading="Beta · ניטור שימוש, תכנון קדימה ושליטה · נתון נמדד לעומת אומדן מסומן · אין format או RAID · נתוני הדגמה">
        ...
        <div class="grid">
          <sw-card heading="שימוש באחסון לפי מצלמה" subheading="נמדד · לפני retention">
            ${Hp.map(u=>r`<div class="cam"><span>${u.name}</span><span class="bar"><i style="--p:${u.gb/f*100}%"></i></span><span class="gb ltr">${u.gb} GB</span></div>`)}
  ...
  `;Ye([d()],Ie.prototype,"range",2);Ye([d()],Ie.prototype,"data",2);Ye([d()],Ie.prototype,"error",2);Ye([d()],Ie.prototype,"loading",2);Ye([d()],Ie.prototype,"tz",2);Ye([d()],Ie.prototype,"signing",2);Ye([d()],Ie.prototype,"signingError",2);Ye([d()],Ie.prototype,"signingBusy",2);Ye([d()],Ie.prototype,"rotateConfirm",2);Ie=Ye([_("system-storage")],Ie);var Vp=Object.getOwnPropertyDescriptor,jp=(e,t,s,i)=>{for(var a=i>1?void 0:i?Vp(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=o(a)||a);return a};const Fp=[{mode:"סקירה ומצלמות",items:[{sc:"SC01",name:"סקירה (Dashboard)",route:"#/live",phase:"PILOT",board:"1:01 · 2:15"},{sc:"SC07",name:"כל המצלמות (Grid)",route:"#/live/wall",phase:"PILOT",board:"1:06"},{sc:"SC08",name:"מצלמה בודדת",route:"#/live/cameras/cam-4",phase:"PILOT",board:"1:05"},{sc:"SC09",name:"תצוגות שמורות",route:"#/live/views",phase:"PILOT",board:"legacy"},{sc:"SC27",name:"בריאות מצלמות",route:"#/system/devices",phase:"PILOT",board:"2:12"},{sc:"SC31",name:"קיוסק / תצוגת קיר",route:"#/kiosk/all",phase:"BETA",board:"3:24"}]},{mode:"אתרים ומפות",items:[{sc:"SC02",name:"אתרים ומבנים",route:"#/explore/sites",phase:"PILOT",board:"1:02 · 3:17"},{sc:"SC03",name:"דפדפן קומות",route:"#/explore/buildings/bld-a/floors",phase:"PILOT",board:"1:03"},{sc:"SC04",name:"מפת קומה חיה",route:"#/explore/floors/f0",phase:"PILOT",board:"1:04"},{sc:"SC05",name:"ייבוא ותיקון תוכנית",route:"#/explore/floors/f-2/import",phase:"PILOT",board:"2:13"},{sc:"SC06",name:"עורך תוכנית ועוגנים",route:"#/explore/floors/f0/edit",phase:"PILOT",board:"2:13"},{sc:"SC10",name:"קטלוג ישויות HA",route:"#/explore/entities",phase:"PILOT",board:"new"},{sc:"SC23",name:"דלתות ואינטרקום",route:"#/explore/access/d1",phase:"V1",board:"3:18"}]},{mode:"אירועים והקלטות",items:[{sc:"SC14",name:"מרכז אירועים",route:"#/investigate/events",phase:"PILOT",board:"1:08"},{sc:"SC12",name:"הקלטות / ציר זמן",route:"#/investigate/playback",phase:"PILOT",board:"1:07 · 2:16"},{sc:"SC13",name:"מרכז שליטה / ניגון מסונכרן",route:"#/investigate/playback/sync",phase:"BETA",board:"2:14"},{sc:"SC11",name:"מפה היסטורית",route:"#/investigate/floors/f0/history",phase:"PILOT",board:"new"},{sc:"SC15",name:"תור Review",route:"#/investigate/reviews",phase:"BETA",board:"legacy"},{sc:"SC16",name:"תיקים",route:"#/investigate/cases",phase:"BETA",board:"2:10"},{sc:"SC17",name:"סקירת אירוע / תיק",route:"#/investigate/cases/case-1",phase:"BETA",board:"2:10"},{sc:"SC18",name:"ייצוא והורדות",route:"#/investigate/exports",phase:"BETA",board:"2:10"},{sc:"SC19",name:"חיפוש AI",route:"#/investigate/search",phase:"BETA",board:"2:09"},{sc:"SC21",name:"התראות וחוקים",route:"#/investigate/rules",phase:"BETA",board:"3:19"},{sc:"SC22",name:"עורך חוק",route:"#/investigate/rules/r-1",phase:"BETA",board:"3:19"}]},{mode:"הגדרות",items:[{sc:"SC28",name:"הגדרות המערכת",route:"#/system/diagnostics",phase:"PILOT",board:"3:23"},{sc:"SC24",name:"משתמשים והרשאות",route:"#/system/access",phase:"PILOT",board:"3:20"},{sc:"SC25",name:"יומן אודיט",route:"#/system/audit",phase:"PILOT",board:"3:21"},{sc:"SC20",name:"אנליטיקת אחסון",route:"#/system/storage",phase:"BETA",board:"2:11"},{sc:"SC26",name:"אשף התקנה",route:"#/system/setup",phase:"PILOT",board:"3:22"}]}],Up={PILOT:"live",BETA:"recorded",V1:"neutral"};let Vi=class extends ${render(){return r`
      <sw-page heading="כל המסכים (סקירת עיצוב)" subheading="29 מסכים על נתוני הדגמה · SC29/SC30 הם אותם מסכים ברוחב טלפון · SC32 (Lovelace) הוא עטיפה של אותם רכיבים">
        ...
        <div class="groups">
          ${Fp.map(e=>r`<sw-card heading=${e.mode}>
              ${e.items.map(t=>r`<a href=${t.route}><span class="sc">${t.sc}</span><span class="name">${t.name}</span><span class="board">${t.board}</span><sw-badge kind=${Up[t.phase]} label=${t.phase}></sw-badge><sw-icon name="chevron" size=${12}></sw-icon></a>`)}
            </sw-card>`)}
        </div>
      </sw-page>
    `}};Vi.styles=k`
  ...
  `;Vi=jp([_("screens-index")],Vi);var Wp=Object.getOwnPropertyDescriptor,Zp=(e,t,s,i)=>{for(var a=i>1?void 0:i?Wp(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=o(a)||a);return a};const qp=[["--sw-bg","רקע"],["--sw-surface","משטח"],["--sw-surface-3","משטח 3"],["--sw-border","גבול"],["--sw-text","טקסט"],["--sw-text-2","טקסט משני"],["--sw-text-3","טקסט שלישי"],["--sw-accent","כחול"],["--sw-accent-soft","כחול רך"],["--sw-live","חי"],["--sw-offline","מנותק"],["--sw-stale","מיושן"],["--sw-danger","שגיאה"],["--sw-purple","סגול (דלת)"]],Kp=["live","recorded","historic","offline","stale","partial","unknown","forbidden","error"],Gp=["loading","empty","error","forbidden","stale","partial"],Yp=["entrance","lobby","corridor","hall","parking","warehouse","backyard","driveway","night","building","house"],Jp=["dashboard","building","camera","bell","history","system","search","user","play","pause","back10","forward10","aperture","volume","mic","expand","close","chevron","chevronDown","warning","info","lock","unlock","offline","refresh","layers","floor","plus","minus","fit","door","light","sensor","check","clock","download","pin","more","map","upload","list","target","filter","users","shield","storage","edit","case","rule","link","grid","home","star","calendar","trash","eye","cpu","activity","image","wifi","signal","move","bookmark","route"];let ji=class extends ${render(){return r`
      ...
      <h3>צבעים</h3>
      <div class="swatches">
        ${qp.map(([e,t])=>r`<div class="swatch"><div class="c" style="background:var(${e})"></div><div class="n"><span>${t}</span><span class="ltr">${e}</span></div></div>`)}
      </div>
      ...
      <div class="scenes">${Yp.map(e=>r`<div><sw-scene kind=${e}></sw-scene><span>${e}</span></div>`)}</div>
      ...
      <div class="row">${Kp.map(e=>r`<sw-badge kind=${e}></sw-badge>`)}</div>

      <h3>ציר זמן, שלבים, קומות איזומטריות</h3>
      <sw-timeline .segments=${Us} .events=${[{minute:614,kind:"person",label:"אדם"},{minute:582,kind:"vehicle",label:"רכב"}]} .cursor=${615}></sw-timeline>
      <div class="row" style="margin-block-start:10px">
        ...
        <sw-floor-iso .rooms=${zi("f0")} selected></sw-floor-iso>
        <sw-floor-iso .rooms=${zi("f-1")}></sw-floor-iso>
        <sw-floor-iso empty></sw-floor-iso>
      </div>

      <h3>מצבי מסך</h3>
      <div class="grid">
        ${Gp.map(e=>r`<div class="panel"><sw-state-panel state=${e} actionLabel=${e==="error"?"נסה שוב":""}></sw-state-panel></div>`)}
      </div>
  ...
  `;ji=Zp([_("styleguide-screen")],ji);const Ga=[{id:"overview",icon:"dashboard",label:"סקירה",href:"#/live"},{id:"sites",icon:"building",label:"אתרים",href:"#/explore/sites"},{id:"cameras",icon:"camera",label:"מצלמות",href:"#/live/wall"},{id:"events",icon:"bell",label:"אירועים",href:"#/investigate/events"},{id:"playback",icon:"history",label:"הקלטות",href:"#/investigate/playback"},{id:"settings",icon:"system",label:"הגדרות",href:"#/system/diagnostics"}],Xp={overview:[],sites:[{id:"sites",label:"אתרים ומבנים",href:"#/explore/sites"},{id:"floors",label:"מפת קומה",href:"#/explore/floors/f0"},{id:"entities",label:"ישויות HA",href:"#/explore/entities"},{id:"access",label:"דלתות ואינטרקום",href:"#/explore/access/d1"}],cameras:[{id:"wall",label:"כל המצלמות",href:"#/live/wall"},{id:"views",label:"תצוגות שמורות",href:"#/live/views"},{id:"devices",label:"בריאות מצלמות",href:"#/system/devices"}],events:[{id:"events",label:"מרכז אירועים",href:"#/investigate/events"},{id:"reviews",label:"Review",href:"#/investigate/reviews"},{id:"search",label:"חיפוש",href:"#/investigate/search"},{id:"cases",label:"תיקים",href:"#/investigate/cases"},{id:"rules",label:"חוקים והתראות",href:"#/investigate/rules"},{id:"exports",label:"ייצוא",href:"#/investigate/exports"}],playback:[{id:"playback",label:"הקלטות",href:"#/investigate/playback"},{id:"sync",label:"ניגון מסונכרן",href:"#/investigate/playback/sync"},{id:"history",label:"מפה היסטורית",href:"#/investigate/floors/f0/history"}],settings:[{id:"general",label:"כללי",href:"#/system/diagnostics"},{id:"access",label:"משתמשים והרשאות",href:"#/system/access"},{id:"audit",label:"אודיט",href:"#/system/audit"},{id:"storage",label:"אחסון",href:"#/system/storage"},{id:"setup",label:"אשף התקנה",href:"#/system/setup"}]};function Lr(e){if(!e?.mode)return null;const t=e.segments;switch(e.mode){case"live":return t.length===1?"overview":"cameras";case"explore":return"sites";case"investigate":return!t[1]||t[1]==="playback"||t[1]==="floors"?"playback":"events";case"system":return t[1]==="devices"?"cameras":"settings";default:return null}}function Qp(e){const t=Lr(e);if(!t||!e)return"";const s=e.segments;switch(t){case"sites":return s[1]==="buildings"||s[1]==="floors"?"floors":s[1]==="entities"?"entities":s[1]==="access"?"access":"sites";case"cameras":return e.mode==="system"?"devices":s[1]==="views"?"views":"wall";case"events":return s[1]??"events";case"playback":return s[1]==="floors"?"history":s[2]==="sync"?"sync":"playback";case"settings":return!s[1]||s[1]==="diagnostics"?"general":s[1];default:return""}}const Fi=[{id:"live",icon:"camera",label:"לייב",href:"#/live"},{id:"explore",icon:"map",label:"מפה",href:"#/explore/sites"},{id:"investigate",icon:"search",label:"חקירה",href:"#/investigate/events"},{id:"system",icon:"system",label:"מערכת",href:"#/system/diagnostics"}],Br={live:[{id:"overview",label:"תמונת מצב",href:"#/live"},{id:"wall",label:"כל המצלמות",href:"#/live/wall"},{id:"views",label:"תצוגות שמורות",href:"#/live/views"},{id:"devices",label:"בריאות מצלמות",href:"#/system/devices"}],explore:[{id:"sites",label:"אתרים ומבנים",href:"#/explore/sites"},{id:"floors",label:"מפת קומה",href:"#/explore/floors/f0"},{id:"entities",label:"ישויות HA",href:"#/explore/entities"},{id:"access",label:"דלתות ואינטרקום",href:"#/explore/access/d1"}],investigate:[{id:"events",label:"מרכז אירועים",href:"#/investigate/events"},{id:"playback",label:"הקלטות",href:"#/investigate/playback"},{id:"sync",label:"ניגון מסונכרן",href:"#/investigate/playback/sync"},{id:"history",label:"מפה היסטורית",href:"#/investigate/floors/f0/history"},{id:"reviews",label:"Review",href:"#/investigate/reviews"},{id:"search",label:"חיפוש",href:"#/investigate/search"},{id:"cases",label:"תיקים",href:"#/investigate/cases"},{id:"rules",label:"חוקים והתראות",href:"#/investigate/rules"},{id:"exports",label:"ייצוא",href:"#/investigate/exports"}],system:[{id:"general",label:"כללי",href:"#/system/diagnostics"},{id:"access",label:"משתמשים והרשאות",href:"#/system/access"},{id:"audit",label:"אודיט",href:"#/system/audit"},{id:"storage",label:"אחסון",href:"#/system/storage"},{id:"setup",label:"אשף התקנה",href:"#/system/setup"}]};function ia(e){return e?.mode?e.mode==="system"&&e.segments[1]==="devices"?"live":e.mode:null}function Hr(e){const t=ia(e);if(!t||!e)return"";const s=e.segments;switch(t){case"live":return e.mode==="system"?"devices":s[1]==="views"?"views":s[1]==="wall"||s[1]==="cameras"?"wall":"overview";case"explore":return s[1]==="buildings"||s[1]==="floors"?"floors":s[1]==="entities"?"entities":s[1]==="access"?"access":"sites";case"investigate":return s[1]==="floors"?"history":s[1]==="playback"?s[2]==="sync"?"sync":"playback":s[1]??"events";case"system":return!s[1]||s[1]==="diagnostics"?"general":s[1];default:return""}}function eh(e,t=!1){const s=ia(e);if(!s)return[];const i=Fi.find(o=>o.id===s),a=Br[s].find(o=>o.id===Hr(e)),n=a?t&&Gs[a.href??""]?Gs[a.href??""]:a.label:"";return[i?.label??"",n].filter(Boolean)}const th=new Set(["#/explore/access/d1"]),Gs={"#/investigate/reviews":"Review · חלונות","#/investigate/playback/sync":"ניגון מסונכרן","#/system/setup":"חיבורים"},Ht=new Set,ki={explore:"/explore/floors/f0",live:"/live",wall:"/live/wall",events:"/investigate/events",playback:"/investigate/playback"},sh=["#/explore/sites","#/explore/floors/f0","#/explore/entities"];function Ya(e,t){return t?e.filter(s=>!th.has(s.href??"")&&!Ht.has(s.href??"")).map(s=>Gs[s.href??""]?{...s,label:Gs[s.href??""]}:s):e}function ih(e,t){return t&&/^\/investigate\/rules\/[^/]+$/.test(e)?"/investigate/rules":null}var ah=Object.defineProperty,rh=Object.getOwnPropertyDescriptor,je=(e,t,s,i)=>{for(var a=i>1?void 0:i?rh(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&ah(t,s,a),a};let _e=class extends ${constructor(){super(...arguments),this.route=null,this.session={mode:"loading",me:null,error:null},this.design=Rr(),this.sys=null,this.sysTimer=0,this.searchQ="",this.searchResults=[],this.searchOpen=!1,this.searchIndex=-1,this.searchBusy=!1,this.searchTimer=0,this.searchSeq=0,this.landedDefault=["","#","#/","#/explore/floors/f0"].includes(window.location.hash),this.startResolved=!1,this.onGlobalKey=e=>{if((e.ctrlKey||e.metaKey)&&e.key.toLowerCase()==="k"){e.preventDefault();const t=this.renderRoot.querySelector(".search input");t?.focus(),t?.select(),this.searchQ.trim()&&this.searchResults.length&&(this.searchOpen=!0)}}}connectedCallback(){super.connectedCallback(),this.stopSession=ur(e=>{this.session=e,e.mode!=="loading"&&Nr(),e.mode==="api"&&this.route&&this.redirectDemo(this.route),e.mode==="api"&&!this.sysTimer&&(Ve().then(t=>{Ht.clear(),String(t["ui.hide_search"]??"false")==="true"&&Ht.add("#/investigate/search");const s=String(t["ui.hide_map"]??"false")==="true";if(s)for(const n of sh)Ht.add(n);const i=ki[String(t["ui.start_route"]??"explore")]??ki.explore,a=s&&i.startsWith("/explore")?"/live/wall":i;this.landedDefault&&a!==ki.explore&&(this.landedDefault=!1,window.location.replace(`#${a}`),this.route=Kt(`#${a}`)),this.requestUpdate()}).catch(()=>{}).finally(()=>this.startResolved=!0),this.pollSummary(),this.sysTimer=window.setInterval(()=>void this.pollSummary(),6e4))}),this.stopDesign=Mp(e=>{this.design=e,this.setAttribute("data-design",e)}),bo(),window.addEventListener("keydown",this.onGlobalKey),this.stopRouter=go(e=>{if(this.route=e,!this.redirectDemo(e)){if(this.toggleAttribute("data-kiosk",e.segments[0]==="kiosk"),e.params.get("embed")==="1")try{sessionStorage.setItem("sw-embed","1")}catch{}this.toggleAttribute("data-embed",this.embedded(e))}})}disconnectedCallback(){super.disconnectedCallback(),this.stopRouter?.(),this.stopSession?.(),this.stopDesign?.(),window.removeEventListener("keydown",this.onGlobalKey),window.clearInterval(this.sysTimer),this.sysTimer=0}async pollSummary(){try{this.sys=await Xi()}catch{}}renderSysPill(e){const t=this.sys;if(!t)return e?r`<span class="status-a" data-sys-pill data-status="unknown"><i></i>מערכת מקומית</span>`:c;const s=t.items.find(n=>n.status==="error")??t.items[0],i=t.status==="ok"?"מערכת תקינה":t.status==="warn"?"יש מה לבדוק":`תקלה: ${s?.label.split(" — ")[0]??""}`,a=t.items.length?t.items.map(n=>`• ${n.label}`).join(`
`):"כל הרכיבים שהתוסף רואה עובדים";return r`<button class="status-a sys ${t.status} ${e?"":"b"}" data-sys-pill data-status=${t.status} title=${a} aria-label=${`מצב המערכת: ${i}`} @click=${()=>window.location.hash="#/system/diagnostics?tab=health"}><i></i>${i}</button>`}renderSysBanner(){const e=this.sys;if(!e||e.status!=="error")return c;const t=e.items.filter(s=>s.status==="error");return r`<div class="sysbanner" role="alert" data-sys-banner><sw-icon name="warning" size=${16}></sw-icon><span>${t.map(s=>s.label).join(" · ")}</span><a href="#/system/diagnostics?tab=health">לבריאות המערכת</a></div>`}onSearchInput(e){const t=e.target.value;if(this.searchQ=t,window.clearTimeout(this.searchTimer),!t.trim()){this.searchResults=[],this.searchOpen=!1;return}this.searchTimer=window.setTimeout(()=>void this.runSearch(t),180)}async runSearch(e){if(!g()){this.searchResults=[],this.searchOpen=!0;return}const t=++this.searchSeq;this.searchBusy=!0;try{const s=await Dc(e,6);if(t!==this.searchSeq)return;this.searchResults=s.results,this.searchIndex=s.results.length?0:-1,this.searchOpen=!0}catch{t===this.searchSeq&&(this.searchResults=[],this.searchOpen=!0)}finally{t===this.searchSeq&&(this.searchBusy=!1)}}onSearchKey(e){if(e.key==="Escape"){this.closeSearch(),e.target.blur();return}if(!this.searchOpen||!this.searchResults.length){e.key==="Enter"&&this.searchQ.trim()&&this.runSearch(this.searchQ);return}if(e.key==="ArrowDown")e.preventDefault(),this.searchIndex=(this.searchIndex+1)%this.searchResults.length;else if(e.key==="ArrowUp")e.preventDefault(),this.searchIndex=(this.searchIndex-1+this.searchResults.length)%this.searchResults.length;else if(e.key==="Enter"){e.preventDefault();const t=this.searchResults[this.searchIndex]??this.searchResults[0];t&&this.openResult(t)}}openResult(e){this.closeSearch();const t=this.renderRoot.querySelector(".search input");t&&(t.value="",t.blur()),this.searchQ="",this.searchResults=[],window.location.hash=`#${e.route}`}closeSearch(){this.searchOpen=!1,this.searchIndex=-1}redirectDemo(e){if(this.enforceKiosk(e))return!0;const t=ih(e.path,this.session.mode==="api");return t?(window.location.replace(`#${t}`),!0):!1}get kioskOnly(){const e=(this.session.me?.bindings??[]).filter(t=>t.effect!=="deny");return this.session.mode==="api"&&e.length>0&&e.every(t=>t.role_id==="kiosk")}enforceKiosk(e){return!this.kioskOnly||e.segments[0]==="kiosk"?!1:(window.location.replace("#/kiosk/all"),!0)}get gated(){return this.session.mode==="no_access"||this.session.mode==="unauthenticated"}renderSearch(e){if(this.gated)return c;const t=this.searchOpen&&!!this.searchQ.trim();return r`<span class="searchwrap ${e?"a":""}">
      ...
      <header class="topbar">
        <div class="crumbs-a">${i.map((o,l)=>r`${l?r`<sw-icon name="chevron" size=${12}></sw-icon>`:c}<span class=${l===0?"strong":""}>${It(o)}</span>`)}</div>
        ${this.renderSearch(!0)}
        <span class="spacer"></span>
      ...
      <main>
        ${this.renderGate()||r`
          <div class="subnav">${t.length>1&&!s?r`<sw-tabs .items=${t} .active=${Hr(this.route)}></sw-tabs>`:c}</div>
          <div class="screen">${this.session.mode==="loading"?c:this.renderScreen()}</div>`}
      </main>
      <nav class="bottom" aria-label="ניווט ראשי">
        ${Fi.filter(o=>!Ht.has(o.href)).map(o=>r`<a class=${ot({active:e===o.id})} href=${o.href}><sw-icon .name=${o.icon} size=${20}></sw-icon>${o.label}</a>`)}
      </nav>
    `}embedded(e=this.route){if(e?.params.get("embed")==="1")return!0;try{return sessionStorage.getItem("sw-embed")==="1"}catch{return!1}}render(){if(this.route?.segments[0]==="kiosk")return r`<main style="block-size:100dvh">${this.renderScreen()}</main>`;if(this.embedded())return r`<main class="embed" style="block-size:100dvh;overflow:auto">${this.renderScreen()}</main>`;if(this.design==="a")return this.renderA();const t=Lr(this.route),s=t?Ya(Xp[t],this.session.mode==="api"):[],i=this.route?.segments[3]==="edit"||this.route?.segments[3]==="import";return r`
      <nav class="rail" aria-label="ניווט ראשי">
        <div class="brand">
          <img src="${"./"}brand/smplwise-mark.png" alt="SmplWise" />
          <span class="name">SmplWise</span>
        </div>
        ${Ga.map(a=>r`<a class=${ot({item:!0,active:t===a.id})} href=${a.href} title=${a.label} aria-current=${t===a.id?"page":"false"}>
      ...
      <main>
        ${this.renderGate()||r`
          <div class="subnav">${s.length>1&&!i?r`<sw-tabs .items=${s} .active=${Qp(this.route)}></sw-tabs>`:c}</div>
          <div class="screen">${this.session.mode==="loading"?c:this.renderScreen()}</div>`}
      </main>
      <nav class="bottom" aria-label="ניווט ראשי">
        ${Ga.slice(0,4).map(a=>r`<a class=${ot({active:t===a.id})} href=${a.href}><sw-icon .name=${a.icon} size=${20}></sw-icon>${a.label}</a>`)}
  ...
  `;je([d()],_e.prototype,"route",2);je([d()],_e.prototype,"session",2);je([d()],_e.prototype,"design",2);je([d()],_e.prototype,"sys",2);je([d()],_e.prototype,"searchQ",2);je([d()],_e.prototype,"searchResults",2);je([d()],_e.prototype,"searchOpen",2);je([d()],_e.prototype,"searchIndex",2);je([d()],_e.prototype,"searchBusy",2);je([d()],_e.prototype,"startResolved",2);_e=je([_("sw-app")],_e);
//# sourceMappingURL=index-ETSY3Kdc.js.map
