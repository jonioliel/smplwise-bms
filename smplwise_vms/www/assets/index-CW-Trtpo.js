 ...
 */const Qs=globalThis,ga=Qs.ShadowRoot&&(Qs.ShadyCSS===void 0||Qs.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,wa=Symbol(),Na=new WeakMap;let Gr=class{constructor(t,s,i){if(this._$cssResult$=!0,i!==wa)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=t,this.t=s}get styleSheet(){let t=this.o;const s=this.t;if(ga&&t===void 0){const i=s!==void 0&&s.length===1;i&&(t=Na.get(s)),t===void 0&&((this.o=t=new CSSStyleSheet).replaceSync(this.cssText),i&&Na.set(s,t))}return t}toString(){return this.cssText}};const Kn=e=>new Gr(typeof e=="string"?e:e+"",void 0,wa),M=(e,...t)=>{const s=e.length===1?e[0]:t.reduce((i,a,n)=>i+(o=>{if(o._$cssResult$===!0)return o.cssText;if(typeof o=="number")return o;throw Error("Value passed to 'css' function must be a 'css' function result: "+o+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(a)+e[n+1],e[0]);return new Gr(s,e,wa)},Gn=(e,t)=>{if(ga)e.adoptedStyleSheets=t.map(s=>s instanceof CSSStyleSheet?s:s.styleSheet);else for(const s of t){const i=document.createElement("style"),a=Qs.litNonce;a!==void 0&&i.setAttribute("nonce",a),i.textContent=s.cssText,e.appendChild(i)}},Ba=ga?e=>e:e=>e instanceof CSSStyleSheet?(t=>{let s="";for(const i of t.cssRules)s+=i.cssText;return Kn(s)})(e):e;/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const{is:Yn,defineProperty:Jn,getOwnPropertyDescriptor:Xn,getOwnPropertyNames:Qn,getOwnPropertySymbols:eo,getPrototypeOf:to}=Object,gi=globalThis,La=gi.trustedTypes,so=La?La.emptyScript:"",io=gi.reactiveElementPolyfillSupport,vs=(e,t)=>e,ii={toAttribute(e,t){switch(t){case Boolean:e=e?so:null;break;case Object:case Array:e=e==null?e:JSON.stringify(e)}return e},fromAttribute(e,t){let s=e;switch(t){case Boolean:s=e!==null;break;case Number:s=e===null?null:Number(e);break;case Object:case Array:try{s=JSON.parse(e)}catch{s=null}}return s}},va=(e,t)=>!Yn(e,t),Va={attribute:!0,type:String,converter:ii,reflect:!1,useDefault:!1,hasChanged:va};Symbol.metadata??=Symbol("metadata"),gi.litPropertyMetadata??=new WeakMap;let Gt=class extends HTMLElement{static addInitializer(t){this._$Ei(),(this.l??=[]).push(t)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(t,s=Va){if(s.state&&(s.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(t)&&((s=Object.create(s)).wrapped=!0),this.elementProperties.set(t,s),!s.noAccessor){const i=Symbol(),a=this.getPropertyDescriptor(t,i,s);a!==void 0&&Jn(this.prototype,t,a)}}static getPropertyDescriptor(t,s,i){const{get:a,set:n}=Xn(this.prototype,t)??{get(){return this[s]},set(o){this[s]=o}};return{get:a,set(o){const l=a?.call(this);n?.call(this,o),this.requestUpdate(t,l,i)},configurable:!0,enumerable:!0}}static getPropertyOptions(t){return this.elementProperties.get(t)??Va}static _$Ei(){if(this.hasOwnProperty(vs("elementProperties")))return;const t=to(this);t.finalize(),t.l!==void 0&&(this.l=[...t.l]),this.elementProperties=new Map(t.elementProperties)}static finalize(){if(this.hasOwnProperty(vs("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(vs("properties"))){const s=this.properties,i=[...Qn(s),...eo(s)];for(const a of i)this.createProperty(a,s[a])}const t=this[Symbol.metadata];if(t!==null){const s=litPropertyMetadata.get(t);if(s!==void 0)for(const[i,a]of s)this.elementProperties.set(i,a)}this._$Eh=new Map;for(const[s,i]of this.elementProperties){const a=this._$Eu(s,i);a!==void 0&&this._$Eh.set(a,s)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(t){const s=[];if(Array.isArray(t)){const i=new Set(t.flat(1/0).reverse());for(const a of i)s.unshift(Ba(a))}else t!==void 0&&s.push(Ba(t));return s}static _$Eu(t,s){const i=s.attribute;return i===!1?void 0:typeof i=="string"?i:typeof t=="string"?t.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise(t=>this.enableUpdating=t),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach(t=>t(this))}addController(t){(this._$EO??=new Set).add(t),this.renderRoot!==void 0&&this.isConnected&&t.hostConnected?.()}removeController(t){this._$EO?.delete(t)}_$E_(){const t=new Map,s=this.constructor.elementProperties;for(const i of s.keys())this.hasOwnProperty(i)&&(t.set(i,this[i]),delete this[i]);t.size>0&&(this._$Ep=t)}createRenderRoot(){const t=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return Gn(t,this.constructor.elementStyles),t}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this._$EO?.forEach(t=>t.hostConnected?.())}enableUpdating(t){}disconnectedCallback(){this._$EO?.forEach(t=>t.hostDisconnected?.())}attributeChangedCallback(t,s,i){this._$AK(t,i)}_$ET(t,s){const i=this.constructor.elementProperties.get(t),a=this.constructor._$Eu(t,i);if(a!==void 0&&i.reflect===!0){const n=(i.converter?.toAttribute!==void 0?i.converter:ii).toAttribute(s,i.type);this._$Em=t,n==null?this.removeAttribute(a):this.setAttribute(a,n),this._$Em=null}}_$AK(t,s){const i=this.constructor,a=i._$Eh.get(t);if(a!==void 0&&this._$Em!==a){const n=i.getPropertyOptions(a),o=typeof n.converter=="function"?{fromAttribute:n.converter}:n.converter?.fromAttribute!==void 0?n.converter:ii;this._$Em=a;const l=o.fromAttribute(s,n.type);this[a]=l??this._$Ej?.get(a)??l,this._$Em=null}}requestUpdate(t,s,i,a=!1,n){if(t!==void 0){const o=this.constructor;if(a===!1&&(n=this[t]),i??=o.getPropertyOptions(t),!((i.hasChanged??va)(n,s)||i.useDefault&&i.reflect&&n===this._$Ej?.get(t)&&!this.hasAttribute(o._$Eu(t,i))))return;this.C(t,s,i)}this.isUpdatePending===!1&&(this._$ES=this._$EP())}C(t,s,{useDefault:i,reflect:a,wrapped:n},o){i&&!(this._$Ej??=new Map).has(t)&&(this._$Ej.set(t,o??s??this[t]),n!==!0||o!==void 0)||(this._$AL.has(t)||(this.hasUpdated||i||(s=void 0),this._$AL.set(t,s)),a===!0&&this._$Em!==t&&(this._$Eq??=new Set).add(t))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(s){Promise.reject(s)}const t=this.scheduleUpdate();return t!=null&&await t,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),this._$Ep){for(const[a,n]of this._$Ep)this[a]=n;this._$Ep=void 0}const i=this.constructor.elementProperties;if(i.size>0)for(const[a,n]of i){const{wrapped:o}=n,l=this[a];o!==!0||this._$AL.has(a)||l===void 0||this.C(a,void 0,n,l)}}let t=!1;const s=this._$AL;try{t=this.shouldUpdate(s),t?(this.willUpdate(s),this._$EO?.forEach(i=>i.hostUpdate?.()),this.update(s)):this._$EM()}catch(i){throw t=!1,this._$EM(),i}t&&this._$AE(s)}willUpdate(t){}_$AE(t){this._$EO?.forEach(s=>s.hostUpdated?.()),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(t)),this.updated(t)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(t){return!0}update(t){this._$Eq&&=this._$Eq.forEach(s=>this._$ET(s,this[s])),this._$EM()}updated(t){}firstUpdated(t){}};Gt.elementStyles=[],Gt.shadowRootOptions={mode:"open"},Gt[vs("elementProperties")]=new Map,Gt[vs("finalized")]=new Map,io?.({ReactiveElement:Gt}),(gi.reactiveElementVersions??=[]).push("2.1.2");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const ba=globalThis,Ha=e=>e,ai=ba.trustedTypes,ja=ai?ai.createPolicy("lit-html",{createHTML:e=>e}):void 0,Yr="$lit$",bt=`lit$${Math.random().toFixed(9).slice(2)}$`,Jr="?"+bt,ao=`<${Jr}>`,Rt=document,Is=()=>Rt.createComment(""),Cs=e=>e===null||typeof e!="object"&&typeof e!="function",ya=Array.isArray,ro=e=>ya(e)||typeof e?.[Symbol.iterator]=="function",Ai=`[ 	
\f\r]`,us=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,Fa=/-->/g,Wa=/>/g,At=RegExp(`>|${Ai}(?:([^\\s"'>=/]+)(${Ai}*=${Ai}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),Ua=/'/g,Za=/"/g,Xr=/^(?:script|style|textarea|title)$/i,Qr=e=>(t,...s)=>({_$litType$:e,strings:t,values:s}),r=Qr(1),u=Qr(2),Nt=Symbol.for("lit-noChange"),d=Symbol.for("lit-nothing"),qa=new WeakMap,Tt=Rt.createTreeWalker(Rt,129);function en(e,t){if(!ya(e)||!e.hasOwnProperty("raw"))throw Error("invalid template strings array");return ja!==void 0?ja.createHTML(t):t}const no=(e,t)=>{const s=e.length-1,i=[];let a,n=t===2?"<svg>":t===3?"<math>":"",o=us;for(let l=0;l<s;l++){const p=e[l];let h,m,g=-1,v=0;for(;v<p.length&&(o.lastIndex=v,m=o.exec(p),m!==null);)v=o.lastIndex,o===us?m[1]==="!--"?o=Fa:m[1]!==void 0?o=Wa:m[2]!==void 0?(Xr.test(m[2])&&(a=RegExp("</"+m[2],"g")),o=At):m[3]!==void 0&&(o=At):o===At?m[0]===">"?(o=a??us,g=-1):m[1]===void 0?g=-2:(g=o.lastIndex-m[2].length,h=m[1],o=m[3]===void 0?At:m[3]==='"'?Za:Ua):o===Za||o===Ua?o=At:o===Fa||o===Wa?o=us:(o=At,a=void 0);const b=o===At&&e[l+1].startsWith("/>")?" ":"";n+=o===us?p+ao:g>=0?(i.push(h),p.slice(0,g)+Yr+p.slice(g)+bt+b):p+bt+(g===-2?l:b)}return[en(e,n+(e[s]||"<?>")+(t===2?"</svg>":t===3?"</math>":"")),i]};class Ds{constructor({strings:t,_$litType$:s},i){let a;this.parts=[];let n=0,o=0;const l=t.length-1,p=this.parts,[h,m]=no(t,s);if(this.el=Ds.createElement(h,i),Tt.currentNode=this.el.content,s===2||s===3){const g=this.el.content.firstChild;g.replaceWith(...g.childNodes)}for(;(a=Tt.nextNode())!==null&&p.length<l;){if(a.nodeType===1){if(a.hasAttributes())for(const g of a.getAttributeNames())if(g.endsWith(Yr)){const v=m[o++],b=a.getAttribute(g).split(bt),S=/([.?@])?(.*)/.exec(v);p.push({type:1,index:n,name:S[2],strings:b,ctor:S[1]==="."?lo:S[1]==="?"?co:S[1]==="@"?po:wi}),a.removeAttribute(g)}else g.startsWith(bt)&&(p.push({type:6,index:n}),a.removeAttribute(g));if(Xr.test(a.tagName)){const g=a.textContent.split(bt),v=g.length-1;if(v>0){a.textContent=ai?ai.emptyScript:"";for(let b=0;b<v;b++)a.append(g[b],Is()),Tt.nextNode(),p.push({type:2,index:++n});a.append(g[v],Is())}}}else if(a.nodeType===8)if(a.data===Jr)p.push({type:2,index:n});else{let g=-1;for(;(g=a.data.indexOf(bt,g+1))!==-1;)p.push({type:7,index:n}),g+=bt.length-1}n++}}static createElement(t,s){const i=Rt.createElement("template");return i.innerHTML=t,i}}function Qt(e,t,s=e,i){if(t===Nt)return t;let a=i!==void 0?s._$Co?.[i]:s._$Cl;const n=Cs(t)?void 0:t._$litDirective$;return a?.constructor!==n&&(a?._$AO?.(!1),n===void 0?a=void 0:(a=new n(e),a._$AT(e,s,i)),i!==void 0?(s._$Co??=[])[i]=a:s._$Cl=a),a!==void 0&&(t=Qt(e,a._$AS(e,t.values),a,i)),t}class oo{constructor(t,s){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=s}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){const{el:{content:s},parts:i}=this._$AD,a=(t?.creationScope??Rt).importNode(s,!0);Tt.currentNode=a;let n=Tt.nextNode(),o=0,l=0,p=i[0];for(;p!==void 0;){if(o===p.index){let h;p.type===2?h=new Ls(n,n.nextSibling,this,t):p.type===1?h=new p.ctor(n,p.name,p.strings,this,t):p.type===6&&(h=new ho(n,this,t)),this._$AV.push(h),p=i[++l]}o!==p?.index&&(n=Tt.nextNode(),o++)}return Tt.currentNode=Rt,a}p(t){let s=0;for(const i of this._$AV)i!==void 0&&(i.strings!==void 0?(i._$AI(t,i,s),s+=i.strings.length-2):i._$AI(t[s])),s++}}class Ls{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(t,s,i,a){this.type=2,this._$AH=d,this._$AN=void 0,this._$AA=t,this._$AB=s,this._$AM=i,this.options=a,this._$Cv=a?.isConnected??!0}get parentNode(){let t=this._$AA.parentNode;const s=this._$AM;return s!==void 0&&t?.nodeType===11&&(t=s.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,s=this){t=Qt(this,t,s),Cs(t)?t===d||t==null||t===""?(this._$AH!==d&&this._$AR(),this._$AH=d):t!==this._$AH&&t!==Nt&&this._(t):t._$litType$!==void 0?this.$(t):t.nodeType!==void 0?this.T(t):ro(t)?this.k(t):this._(t)}O(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.O(t))}_(t){this._$AH!==d&&Cs(this._$AH)?this._$AA.nextSibling.data=t:this.T(Rt.createTextNode(t)),this._$AH=t}$(t){const{values:s,_$litType$:i}=t,a=typeof i=="number"?this._$AC(t):(i.el===void 0&&(i.el=Ds.createElement(en(i.h,i.h[0]),this.options)),i);if(this._$AH?._$AD===a)this._$AH.p(s);else{const n=new oo(a,this),o=n.u(this.options);n.p(s),this.T(o),this._$AH=n}}_$AC(t){let s=qa.get(t.strings);return s===void 0&&qa.set(t.strings,s=new Ds(t)),s}k(t){ya(this._$AH)||(this._$AH=[],this._$AR());const s=this._$AH;let i,a=0;for(const n of t)a===s.length?s.push(i=new Ls(this.O(Is()),this.O(Is()),this,this.options)):i=s[a],i._$AI(n),a++;a<s.length&&(this._$AR(i&&i._$AB.nextSibling,a),s.length=a)}_$AR(t=this._$AA.nextSibling,s){for(this._$AP?.(!1,!0,s);t!==this._$AB;){const i=Ha(t).nextSibling;Ha(t).remove(),t=i}}setConnected(t){this._$AM===void 0&&(this._$Cv=t,this._$AP?.(t))}}class wi{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,s,i,a,n){this.type=1,this._$AH=d,this._$AN=void 0,this.element=t,this.name=s,this._$AM=a,this.options=n,i.length>2||i[0]!==""||i[1]!==""?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=d}_$AI(t,s=this,i,a){const n=this.strings;let o=!1;if(n===void 0)t=Qt(this,t,s,0),o=!Cs(t)||t!==this._$AH&&t!==Nt,o&&(this._$AH=t);else{const l=t;let p,h;for(t=n[0],p=0;p<n.length-1;p++)h=Qt(this,l[i+p],s,p),h===Nt&&(h=this._$AH[p]),o||=!Cs(h)||h!==this._$AH[p],h===d?t=d:t!==d&&(t+=(h??"")+n[p+1]),this._$AH[p]=h}o&&!a&&this.j(t)}j(t){t===d?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}}class lo extends wi{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===d?void 0:t}}class co extends wi{constructor(){super(...arguments),this.type=4}j(t){this.element.toggleAttribute(this.name,!!t&&t!==d)}}class po extends wi{constructor(t,s,i,a,n){super(t,s,i,a,n),this.type=5}_$AI(t,s=this){if((t=Qt(this,t,s,0)??d)===Nt)return;const i=this._$AH,a=t===d&&i!==d||t.capture!==i.capture||t.once!==i.once||t.passive!==i.passive,n=t!==d&&(i===d||a);a&&this.element.removeEventListener(this.name,this,i),n&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,t):this._$AH.handleEvent(t)}}class ho{constructor(t,s,i){this.element=t,this.type=6,this._$AN=void 0,this._$AM=s,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(t){Qt(this,t)}}const uo=ba.litHtmlPolyfillSupport;uo?.(Ds,Ls),(ba.litHtmlVersions??=[]).push("3.3.3");const mo=(e,t,s)=>{const i=s?.renderBefore??t;let a=i._$litPart$;if(a===void 0){const n=s?.renderBefore??null;i._$litPart$=a=new Ls(t.insertBefore(Is(),n),n,void 0,s??{})}return a._$AI(e),a};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const $a=globalThis;let z=class extends Gt{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){const t=super.createRenderRoot();return this.renderOptions.renderBefore??=t.firstChild,t}update(t){const s=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=mo(s,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return Nt}};z._$litElement$=!0,z.finalized=!0,$a.litElementHydrateSupport?.({LitElement:z});const fo=$a.litElementPolyfillSupport;fo?.({LitElement:z});($a.litElementVersions??=[]).push("4.2.2");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function os(e,t){return(s,i,a)=>{const n=o=>o.renderRoot?.querySelector(e)??null;return vo(s,i,{get(){return n(this)}})}}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 */const gt=yo(class extends $o{constructor(e){if(super(e),e.type!==bo.ATTRIBUTE||e.name!=="class"||e.strings?.length>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(e){return" "+Object.keys(e).filter(t=>e[t]).join(" ")+" "}update(e,[t]){if(this.st===void 0){this.st=new Set,e.strings!==void 0&&(this.nt=new Set(e.strings.join(" ").split(/\s/).filter(i=>i!=="")));for(const i in t)t[i]&&!this.nt?.has(i)&&this.st.add(i);return this.render(t)}const s=e.element.classList;for(const i of this.st)i in t||(s.remove(i),this.st.delete(i));for(const i in t){const a=!!t[i];a===this.st.has(i)||this.nt?.has(i)||(a?(s.add(i),this.st.add(i)):(s.remove(i),this.st.delete(i)))}return Nt}});var xo=Object.defineProperty,ko=Object.getOwnPropertyDescriptor,vi=(e,t,s,i)=>{for(var a=i>1?void 0:i?ko(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&xo(t,s,a),a};const Ka={live:u`<circle cx="12" cy="12" r="3"/><path d="M6.3 6.3a8 8 0 0 0 0 11.4M17.7 6.3a8 8 0 0 1 0 11.4M3.5 3.5a12 12 0 0 0 0 17M20.5 3.5a12 12 0 0 1 0 17"/>`,explore:u`<path d="M3 6.5 9 4l6 2.5 6-2.5v13.5L15 20l-6-2.5L3 20z"/><path d="M9 4v13.5M15 6.5V20"/>`,investigate:u`<circle cx="11" cy="11" r="6.5"/><path d="m20 20-4.3-4.3M11 8v3l2 1.5"/>`,system:u`<circle cx="12" cy="12" r="3"/><path d="M19.4 15a1.7 1.7 0 0 0 .3 1.8l.1.1a2 2 0 1 1-2.8 2.8l-.1-.1a1.7 1.7 0 0 0-1.8-.3 1.7 1.7 0 0 0-1 1.5V21a2 2 0 1 1-4 0v-.1a1.7 1.7 0 0 0-1.1-1.5 1.7 1.7 0 0 0-1.8.3l-.1.1a2 2 0 1 1-2.8-2.8l.1-.1a1.7 1.7 0 0 0 .3-1.8 1.7 1.7 0 0 0-1.5-1H3a2 2 0 1 1 0-4h.1a1.7 1.7 0 0 0 1.5-1.1 1.7 1.7 0 0 0-.3-1.8l-.1-.1a2 2 0 1 1 2.8-2.8l.1.1a1.7 1.7 0 0 0 1.8.3H9a1.7 1.7 0 0 0 1-1.5V3a2 2 0 1 1 4 0v.1a1.7 1.7 0 0 0 1 1.5 1.7 1.7 0 0 0 1.8-.3l.1-.1a2 2 0 1 1 2.8 2.8l-.1.1a1.7 1.7 0 0 0-.3 1.8V9a1.7 1.7 0 0 0 1.5 1H21a2 2 0 1 1 0 4h-.1a1.7 1.7 0 0 0-1.5 1z"/>`,camera:u`<path d="M3 8.5A1.5 1.5 0 0 1 4.5 7H8l1.5-2h5L16 7h3.5A1.5 1.5 0 0 1 21 8.5v9a1.5 1.5 0 0 1-1.5 1.5h-15A1.5 1.5 0 0 1 3 17.5z"/><circle cx="12" cy="13" r="3.5"/>`,search:u`<circle cx="11" cy="11" r="6.5"/><path d="m20 20-4.3-4.3"/>`,bell:u`<path d="M6 16V11a6 6 0 0 1 12 0v5l1.5 2h-15z"/><path d="M10 20a2 2 0 0 0 4 0"/>`,user:u`<circle cx="12" cy="8" r="4"/><path d="M4 21a8 8 0 0 1 16 0"/>`,play:u`<path d="M7 5v14l11-7z"/>`,expand:u`<path d="M15 4h5v5M9 20H4v-5M20 4l-6 6M4 20l6-6"/>`,close:u`<path d="M6 6l12 12M18 6 6 18"/>`,chevron:u`<path d="m9 6 6 6-6 6"/>`,chevronBack:u`<path d="m15 6-6 6 6 6"/>`,warning:u`<path d="M12 3 2.5 20h19z"/><path d="M12 9v5M12 17h.01"/>`,info:u`<circle cx="12" cy="12" r="9"/><path d="M12 11v5M12 8h.01"/>`,lock:u`<rect x="5" y="11" width="14" height="10" rx="2"/><path d="M8 11V7a4 4 0 0 1 8 0v4"/>`,unlock:u`<rect x="5" y="11" width="14" height="10" rx="2"/><path d="M8 11V7a4 4 0 0 1 7.5-2"/>`,offline:u`<path d="M2 8.5a15 15 0 0 1 20 0M5.5 12a10 10 0 0 1 13 0M9 15.5a5 5 0 0 1 6 0"/><path d="M12 19h.01"/><path d="M3 3l18 18"/>`,refresh:u`<path d="M20 12a8 8 0 1 1-2.3-5.7"/><path d="M20 4v5h-5"/>`,layers:u`<path d="m12 3 9 5-9 5-9-5z"/><path d="m3 13 9 5 9-5M3 17.5l9 5 9-5"/>`,floor:u`<path d="M4 6h16M4 12h16M4 18h16"/><path d="M8 3v18"/>`,plus:u`<path d="M12 5v14M5 12h14"/>`,minus:u`<path d="M5 12h14"/>`,fit:u`<path d="M4 9V4h5M20 9V4h-5M4 15v5h5M20 15v5h-5"/>`,door:u`<rect x="6" y="3" width="12" height="18" rx="1"/><path d="M14 12h.01"/>`,light:u`<path d="M9 18h6M10 21h4"/><path d="M12 3a6 6 0 0 0-3.5 10.9c.8.6 1.5 1.6 1.5 2.6h4c0-1 .7-2 1.5-2.6A6 6 0 0 0 12 3z"/>`,sensor:u`<circle cx="12" cy="12" r="2"/><path d="M7.8 7.8a6 6 0 0 0 0 8.4M16.2 7.8a6 6 0 0 1 0 8.4M4.9 4.9a10 10 0 0 0 0 14.2M19.1 4.9a10 10 0 0 1 0 14.2"/>`,check:u`<path d="m5 12 5 5 9-10"/>`,clock:u`<circle cx="12" cy="12" r="9"/><path d="M12 7v5l3 2"/>`,download:u`<path d="M12 4v11M7 10l5 5 5-5M4 20h16"/>`,pin:u`<path d="M9 4h6l-1 6 3 3v2H7v-2l3-3z"/><path d="M12 15v6"/>`,more:u`<circle cx="6" cy="12" r="1.3"/><circle cx="12" cy="12" r="1.3"/><circle cx="18" cy="12" r="1.3"/>`,building:u`<rect x="4" y="3" width="16" height="18" rx="1"/><path d="M9 7h2M13 7h2M9 11h2M13 11h2M9 15h2M13 15h2M10 21v-3h4v3"/>`,map:u`<path d="M3 6.5 9 4l6 2.5 6-2.5v13.5L15 20l-6-2.5L3 20z"/>`,upload:u`<path d="M12 16V5M7 10l5-5 5 5M4 20h16"/>`,list:u`<path d="M8 6h13M8 12h13M8 18h13M3 6h.01M3 12h.01M3 18h.01"/>`,history:u`<path d="M3 12a9 9 0 1 0 3-6.7"/><path d="M3 4v5h5M12 8v4l3 2"/>`,target:u`<circle cx="12" cy="12" r="8"/><circle cx="12" cy="12" r="3"/><path d="M12 2v4M12 18v4M2 12h4M18 12h4"/>`,filter:u`<path d="M4 5h16l-6 8v6l-4-2v-4z"/>`,users:u`<circle cx="9" cy="8" r="3.5"/><path d="M2.5 20a6.5 6.5 0 0 1 13 0"/><circle cx="17" cy="9" r="2.5"/><path d="M15.5 14.5A5 5 0 0 1 21.5 20"/>`,shield:u`<path d="M12 3 4 6v6c0 4.5 3.4 7.7 8 9 4.6-1.3 8-4.5 8-9V6z"/><path d="m9 12 2 2 4-4"/>`,storage:u`<rect x="3" y="4" width="18" height="6" rx="1.5"/><rect x="3" y="14" width="18" height="6" rx="1.5"/><path d="M7 7h.01M7 17h.01"/>`,edit:u`<path d="M4 20h4l10.5-10.5a2 2 0 0 0 0-2.8l-1.2-1.2a2 2 0 0 0-2.8 0L4 16z"/><path d="m13 7 4 4"/>`,pause:u`<path d="M8 5v14M16 5v14"/>`,skip:u`<path d="M5 5v14l8-7zM15 5h2v14h-2z"/>`,case:u`<rect x="3" y="7" width="18" height="13" rx="2"/><path d="M8 7V5a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2M3 12h18"/>`,rule:u`<path d="M4 6h10M4 12h16M4 18h7"/><circle cx="18" cy="6" r="2"/><circle cx="15" cy="18" r="2"/>`,link:u`<path d="M10 14a4 4 0 0 0 5.7 0l3-3a4 4 0 0 0-5.7-5.7l-1 1"/><path d="M14 10a4 4 0 0 0-5.7 0l-3 3a4 4 0 0 0 5.7 5.7l1-1"/>`,grid:u`<rect x="3" y="3" width="7" height="7" rx="1.5"/><rect x="14" y="3" width="7" height="7" rx="1.5"/><rect x="3" y="14" width="7" height="7" rx="1.5"/><rect x="14" y="14" width="7" height="7" rx="1.5"/>`,dashboard:u`<rect x="3" y="3" width="8" height="10" rx="1.5"/><rect x="13" y="3" width="8" height="6" rx="1.5"/><rect x="13" y="11" width="8" height="10" rx="1.5"/><rect x="3" y="15" width="8" height="6" rx="1.5"/>`,home:u`<path d="M3 11 12 4l9 7"/><path d="M5 10v10h14V10"/><path d="M10 20v-6h4v6"/>`,star:u`<path d="m12 3 2.8 5.7 6.2.9-4.5 4.4 1 6.2-5.5-2.9L6.5 20.2l1-6.2L3 9.6l6.2-.9z"/>`,aperture:u`<circle cx="12" cy="12" r="9"/><path d="m14.3 4.5-5 8.6M20.7 9.5H10.8M18.4 17.5l-5-8.6M9.7 19.5l5-8.6M3.3 14.5h9.9M5.6 6.5l5 8.6"/>`,volume:u`<path d="M4 9.5v5h3.5L12 18.5v-13L7.5 9.5z"/><path d="M15.5 8.5a5 5 0 0 1 0 7M18.5 5.5a9 9 0 0 1 0 13"/>`,mic:u`<rect x="9" y="3" width="6" height="11" rx="3"/><path d="M5.5 11a6.5 6.5 0 0 0 13 0M12 17.5V21M9 21h6"/>`,back10:u`<path d="M4 12a8 8 0 1 0 2.3-5.7"/><path d="M4 4v5h5"/><path d="M10.5 15.5V10l-1.5 1"/><rect x="13.5" y="10" width="3.5" height="5.5" rx="1.7"/>`,forward10:u`<path d="M20 12a8 8 0 1 1-2.3-5.7"/><path d="M20 4v5h-5"/><path d="M10.5 15.5V10l-1.5 1"/><rect x="13.5" y="10" width="3.5" height="5.5" rx="1.7"/>`,chevronDown:u`<path d="m6 9 6 6 6-6"/>`,stairs:u`<path d="M3 20h4v-4h4v-4h4V8h5"/>`,wall:u`<path d="M3 5h18v4H3zM3 15h18v4H3zM8 9v6M16 9v6"/>`,ruler:u`<path d="M3 16 16 3l5 5L8 21z"/><path d="m7 12 2 2M10 9l2 2M13 6l2 2"/>`,scale:u`<path d="M4 20h16M4 20V8M20 20V8M4 8l8-4 8 4M8 14h8"/>`,elevator:u`<rect x="4" y="3" width="16" height="18" rx="1.5"/><path d="M12 3v18M8 10l1.5-2 1.5 2M14.5 14l1.5 2 1.5-2"/>`,menu:u`<path d="M4 7h16M4 12h16M4 17h16"/>`,calendar:u`<rect x="3" y="5" width="18" height="16" rx="2"/><path d="M3 10h18M8 3v4M16 3v4"/>`,trash:u`<path d="M4 7h16M9 7V4h6v3M6 7l1 13h10l1-13"/>`,eye:u`<path d="M2 12s3.5-6 10-6 10 6 10 6-3.5 6-10 6S2 12 2 12z"/><circle cx="12" cy="12" r="3"/>`,cpu:u`<rect x="6" y="6" width="12" height="12" rx="2"/><rect x="9" y="9" width="6" height="6"/><path d="M9 2v4M15 2v4M9 18v4M15 18v4M2 9h4M2 15h4M18 9h4M18 15h4"/>`,activity:u`<path d="M3 12h4l3-8 4 16 3-8h4"/>`,image:u`<rect x="3" y="4" width="18" height="16" rx="2"/><circle cx="8.5" cy="9.5" r="1.5"/><path d="m21 16-5-5-9 9"/>`,wifi:u`<path d="M2 8.5a15 15 0 0 1 20 0M5.5 12a10 10 0 0 1 13 0M9 15.5a5 5 0 0 1 6 0"/><path d="M12 19h.01"/>`,signal:u`<path d="M4 18v-3M9 18v-7M14 18V7M19 18V4"/>`,move:u`<path d="M12 3v18M3 12h18M8 7l4-4 4 4M8 17l4 4 4-4M7 8l-4 4 4 4M17 8l4 4-4 4"/>`,bookmark:u`<path d="M6 3h12v18l-6-4-6 4z"/>`,route:u`<circle cx="6" cy="18" r="2.5"/><circle cx="18" cy="6" r="2.5"/><path d="M8 17c5-1 3-9 8-10"/>`,logout:u`<path d="M10 4H5v16h5M14 8l4 4-4 4M18 12H9"/>`};let es=class extends z{constructor(){super(...arguments),this.name="info",this.size=20,this.flip=!1}render(){this.style.setProperty("--sw-icon-size",`${this.size}px`);const e=this.name==="chevron"||this.name==="chevronBack";return r`<svg viewBox="0 0 24 24" aria-hidden="true" ?data-dir=${e}>${Ka[this.name]??Ka.info}</svg>`}};es.styles=M`
  ...
  `;vi([f()],es.prototype,"name",2);vi([f({type:Number})],es.prototype,"size",2);vi([f({type:Boolean,reflect:!0})],es.prototype,"flip",2);es=vi([E("sw-icon")],es);var _o=Object.defineProperty,zo=Object.getOwnPropertyDescriptor,ut=(e,t,s,i)=>{for(var a=i>1?void 0:i?zo(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&_o(t,s,a),a};let Ue=class extends z{constructor(){super(...arguments),this.variant="secondary",this.size="md",this.disabled=!1,this.iconOnly=!1,this.round=!1,this.label="",this.type="button"}render(){return r`
  ...
  `;bi([f({reflect:!0})],ts.prototype,"kind",2);bi([f()],ts.prototype,"label",2);bi([f({type:Boolean,reflect:!0})],ts.prototype,"onImage",2);ts=bi([E("sw-badge")],ts);var Po=Object.defineProperty,Io=Object.getOwnPropertyDescriptor,Vs=(e,t,s,i)=>{for(var a=i>1?void 0:i?Io(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&Po(t,s,a),a};let Bt=class extends z{constructor(){super(...arguments),this.items=[],this.active="",this.segmented=!1,this.underline=!1}choose(e){this.active=e.id,this.dispatchEvent(new CustomEvent("change",{detail:{id:e.id},bubbles:!0,composed:!0}))}render(){return r`${this.items.map(e=>e.href?r`<a href=${e.href} class=${e.id===this.active?"on":""} aria-current=${e.id===this.active?"page":"false"}>${e.label}${e.count!==void 0?r`<span class="count">(${e.count})</span>`:""}</a>`:r`<button type="button" class=${e.id===this.active?"on":""} aria-pressed=${e.id===this.active} @click=${()=>this.choose(e)}>${e.label}${e.count!==void 0?r`<span class="count">(${e.count})</span>`:""}</button>`)}`}};Bt.styles=M`
    :host {
      display: inline-flex;
      gap: 2px;
      overflow-x: auto;
  ...
  `;Vs([f({attribute:!1})],Bt.prototype,"items",2);Vs([f()],Bt.prototype,"active",2);Vs([f({type:Boolean,reflect:!0})],Bt.prototype,"segmented",2);Vs([f({type:Boolean,reflect:!0})],Bt.prototype,"underline",2);Bt=Vs([E("sw-tabs")],Bt);var Co=Object.defineProperty,Do=Object.getOwnPropertyDescriptor,xa=(e,t,s,i)=>{for(var a=i>1?void 0:i?Do(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&Co(t,s,a),a};let Ts=class extends z{constructor(){super(...arguments),this.name="",this.size=32}render(){this.style.setProperty("--sz",`${this.size}px`);const e=this.name.trim().split(/\s+/),t=e.length>1?e[0][0]+e[1][0]:this.name.slice(0,2);return r`${t}`}};Ts.styles=M`
    :host {
      display: inline-grid;
      place-items: center;
  ...
  `;xa([f()],Ts.prototype,"name",2);xa([f({type:Number})],Ts.prototype,"size",2);Ts=xa([E("sw-avatar")],Ts);var To=Object.defineProperty,Oo=Object.getOwnPropertyDescriptor,Hs=(e,t,s,i)=>{for(var a=i>1?void 0:i?Oo(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&To(t,s,a),a};let Lt=class extends z{constructor(){super(...arguments),this.selected=!1,this.dot=""}render(){return r`
  ...
  `;Hs([f({type:Boolean,reflect:!0})],Lt.prototype,"selected",2);Hs([f()],Lt.prototype,"icon",2);Hs([f({type:Number})],Lt.prototype,"count",2);Hs([f()],Lt.prototype,"dot",2);Lt=Hs([E("sw-chip")],Lt);var Ro=Object.defineProperty,No=Object.getOwnPropertyDescriptor,yi=(e,t,s,i)=>{for(var a=i>1?void 0:i?No(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&Ro(t,s,a),a};let ss=class extends z{constructor(){super(...arguments),this.open=!1,this.heading="",this.subheading=""}close(){this.open=!1,this.dispatchEvent(new CustomEvent("close",{bubbles:!0,composed:!0}))}render(){return r`
  ...
  `;ls([f()],$t.prototype,"heading",2);ls([f({type:Number})],$t.prototype,"x",2);ls([f({type:Number})],$t.prototype,"y",2);ls([f({type:Number})],$t.prototype,"stageWidth",2);ls([f({type:Number})],$t.prototype,"stageHeight",2);$t=ls([E("sw-popover")],$t);var Vo=Object.defineProperty,Ho=Object.getOwnPropertyDescriptor,$i=(e,t,s,i)=>{for(var a=i>1?void 0:i?Ho(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&Vo(t,s,a),a};let is=class extends z{constructor(){super(...arguments),this.label="",this.hint="",this.inline=!1}render(){return r`
  ...
  `;xe([f()],ue.prototype,"cameraId",2);xe([f()],ue.prototype,"profile",2);xe([f()],ue.prototype,"mode",2);xe([f()],ue.prototype,"poster",2);xe([f({type:Boolean})],ue.prototype,"active",2);xe([f({type:Boolean,reflect:!0})],ue.prototype,"compact",2);xe([f()],ue.prototype,"wsUrl",2);xe([f({type:Boolean})],ue.prototype,"retry",2);xe([f({type:Boolean})],ue.prototype,"recorded",2);xe([c()],ue.prototype,"status",2);xe([c()],ue.prototype,"transport",2);xe([c()],ue.prototype,"error",2);xe([c()],ue.prototype,"muted",2);xe([os("video")],ue.prototype,"video",2);ue=xe([E("sw-live-player")],ue);var ll=Object.defineProperty,dl=Object.getOwnPropertyDescriptor,ke=(e,t,s,i)=>{for(var a=i>1?void 0:i?dl(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&ll(t,s,a),a};let me=class extends z{constructor(){super(...arguments),this.name="",this.meta="",this.state="unknown",this.scene="lobby",this.selected=!1,this.compact=!1,this.dark=!1,this.noDemo=!1,this.stamp="",this.poster="",this.cameraId="",this.live=!1,this.profile="sub",this.transport="auto"}offMessage(){return this.state==="forbidden"?"אין הרשאת צפייה":this.state==="offline"?"המצלמה מנותקת":"מצב לא ידוע"}render(){if(this.state==="offline"||this.state==="forbidden"||this.state==="unknown")return r`<div class="off">
  ...
  `;ke([f()],me.prototype,"name",2);ke([f()],me.prototype,"meta",2);ke([f({reflect:!0})],me.prototype,"state",2);ke([f({reflect:!0})],me.prototype,"scene",2);ke([f({type:Boolean,reflect:!0})],me.prototype,"selected",2);ke([f({type:Boolean,reflect:!0})],me.prototype,"compact",2);ke([f({type:Boolean,reflect:!0})],me.prototype,"dark",2);ke([f({type:Boolean,reflect:!0})],me.prototype,"noDemo",2);ke([f()],me.prototype,"stamp",2);ke([f()],me.prototype,"poster",2);ke([f()],me.prototype,"cameraId",2);ke([f({type:Boolean})],me.prototype,"live",2);ke([f()],me.prototype,"profile",2);ke([f()],me.prototype,"transport",2);me=ke([E("sw-camera-tile")],me);var cl=Object.defineProperty,pl=Object.getOwnPropertyDescriptor,ds=(e,t,s,i)=>{for(var a=i>1?void 0:i?pl(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&cl(t,s,a),a};const hl={loading:{icon:"clock",title:()=>x("states.loading"),hint:()=>"",tone:"neutral"},empty:{icon:"map",title:()=>x("states.empty"),hint:()=>"",tone:"neutral"},error:{icon:"warning",title:()=>x("states.error"),hint:()=>x("states.errorHint"),tone:"danger"},forbidden:{icon:"lock",title:()=>x("states.forbidden"),hint:()=>x("states.forbiddenHint"),tone:"forbidden"},stale:{icon:"offline",title:()=>x("states.stale"),hint:()=>x("states.staleHint"),tone:"stale"},partial:{icon:"info",title:()=>x("states.partial"),hint:()=>"",tone:"stale"}};let xt=class extends z{constructor(){super(...arguments),this.state="empty",this.heading="",this.hint="",this.actionLabel="",this.compact=!1}render(){const e=this.state==="error"&&/אין (לך )?הרשא/.test(this.hint),t=hl[e?"forbidden":this.state],s=this.hint||t.hint();return r`
  ...
  `;ds([f({reflect:!0})],xt.prototype,"state",2);ds([f()],xt.prototype,"heading",2);ds([f()],xt.prototype,"hint",2);ds([f()],xt.prototype,"actionLabel",2);ds([f({type:Boolean,reflect:!0})],xt.prototype,"compact",2);xt=ds([E("sw-state-panel")],xt);var ul=Object.defineProperty,ml=Object.getOwnPropertyDescriptor,ki=(e,t,s,i)=>{for(var a=i>1?void 0:i?ml(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&ul(t,s,a),a};let as=class extends z{constructor(){super(...arguments),this.open=!1,this.heading="",this.subheading="",this.onKey=e=>{e.key==="Escape"&&this.open&&this.close()}}close(){this.open=!1,this.dispatchEvent(new CustomEvent("close",{bubbles:!0,composed:!0}))}updated(e){!e.has("open")||!this.open||requestAnimationFrame(()=>{const t=i=>{for(const a of i.querySelectorAll("[autofocus], input, textarea, select, sw-button, button"))if(!(a.hasAttribute("disabled")||a.type==="hidden"||a.slot==="footer"))return a.tagName==="SW-BUTTON"?a.shadowRoot?.querySelector("button")??a:a;for(const a of i.querySelectorAll("*")){const n=a.shadowRoot&&t(a.shadowRoot);if(n)return n}return null},s=t(this)??this.renderRoot.querySelector(".box");s&&(!s.hasAttribute("tabindex")&&!s.matches("input, textarea, select, button, a[href]")&&s.setAttribute("tabindex","-1"),s.focus({preventScroll:!0}))})}connectedCallback(){super.connectedCallback(),window.addEventListener("keydown",this.onKey)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("keydown",this.onKey)}render(){return r`<div class="backdrop" @click=${e=>e.target===e.currentTarget&&this.close()}>
  ...
  `;js([f({type:Boolean,reflect:!0})],Ht.prototype,"checked",2);js([f({type:Boolean,reflect:!0})],Ht.prototype,"disabled",2);js([f()],Ht.prototype,"label",2);js([f({type:Boolean})],Ht.prototype,"labelHidden",2);Ht=js([E("sw-toggle")],Ht);function _n(e={}){const t=new URLSearchParams;e.domain&&t.set("domain",e.domain),e.q&&t.set("q",e.q),e.area&&t.set("area",e.area),e.placed!==void 0&&t.set("placed",String(e.placed)),e.includeDisabled&&t.set("include_disabled","true"),e.limit&&t.set("limit",String(e.limit));const s=t.toString();return k(`ha/entities${s?`?${s}`:""}`)}const gd=()=>k("ha/status"),wd=(e=!1)=>k(`ha/bridge/pairing${e?"?regenerate=true":""}`),rr=e=>k(`ha/actions/${e}`),vd=()=>A("ha/bridge/install");function bd(e,t,s={},i=!1){const a={allowed_action_id:t,arguments:s,expected_state_version:null,confirmation_grant:i?"confirmed":null,client_request_id:crypto.randomUUID(),expires_at:new Date(Date.now()+6e4).toISOString().replace(/\.\d{3}Z$/,"Z")};return A(`ha/entities/${encodeURIComponent(e)}/actions`,a)}async function yd(e,t,s){let i=await rr(e);t(i);for(let a=0;a<16&&i.status==="pending";a++)await new Promise(n=>setTimeout(n,1500)),i=await rr(e),t(i);return i}const $d={ha_unauthorized:"Home Assistant דחה את הפעולה: למשתמש שלך אין הרשאה לישות זו ב־Home Assistant",ha_unknown_user:"Home Assistant אינו מכיר את המשתמש שמאחורי ההפעלה הזו",bridge_not_paired:"גשר SMPLWISE אינו מצומד",bridge_error:"הגשר החזיר שגיאה",ha_unavailable:"Home Assistant אינו זמין",service_not_allowed:"הגשר סירב: השירות אינו ברשימת הפעולות המאושרות (גשר ישן? מאז 0.2.1 נוספו climate / media / number / select / alarm — הפעל את Home Assistant מחדש כדי לטעון את הגרסה החדשה)",unknown_user:"Home Assistant אינו מכיר את המשתמש"},xd={pending:"נשלח · ממתין לעדכון מ־Home Assistant",confirmed:"אושר · המצב התעדכן",unknown:"לא ידוע · לא התקבל עדכון מצב",failed:"נכשל",denied:"נדחה · אין הרשאה ב־Home Assistant"},kd=new Set(["on","open","opening","unlocked","unlocking","playing","home","heat","cool","heat_cool","dry","fan_only","cleaning","active","detected","problem","running"]),qs={on:"דולק",off:"כבוי",locked:"נעול",unlocked:"פתוח",locking:"נועל…",unlocking:"פותח…",jammed:"תקוע",open:"פתוח",closed:"סגור",opening:"נפתח…",closing:"נסגר…",unavailable:"לא זמין",unknown:"לא ידוע",idle:"לא פעיל",home:"בבית",not_home:"מחוץ לבית",playing:"מנגן",paused:"מושהה",standby:"המתנה",heat:"חימום",cool:"קירור",auto:"אוטומטי",dry:"ייבוש",fan_only:"מאוורר",docked:"בתחנה",cleaning:"מנקה",returning:"חוזר"},_d={motion:["תנועה","ללא תנועה"],occupancy:["נוכחות","ללא נוכחות"],presence:["נוכח","לא נוכח"],door:["פתוחה","סגורה"],window:["פתוח","סגור"],opening:["פתוח","סגור"],garage_door:["פתוח","סגור"],lock:["פתוח","נעול"],connectivity:["מחובר","מנותק"],power:["פועל","כבוי"],problem:["תקלה","תקין"],safety:["לא בטוח","בטוח"],smoke:["עשן","ללא עשן"],moisture:["רטוב","יבש"],battery:["סוללה חלשה","סוללה תקינה"],running:["פועל","לא פועל"],sound:["רעש","שקט"],vibration:["רטט","ללא רטט"],update:["עדכון זמין","מעודכן"]};function _t(e){const t=e.state;if(t==null)return"לא ידוע";if(t==="unavailable"||t==="unknown")return qs[t];if(e.domain==="binary_sensor"){const s=_d[e.device_class??""];return s?t==="on"?s[0]:s[1]:t==="on"?"פעיל":"לא פעיל"}if(e.domain==="sensor"||e.domain==="number"||e.domain==="input_number"){const s=Number(t);return!Number.isNaN(s)&&t.trim()!==""?`${Number.isInteger(s)?s:s.toFixed(Math.min(2,(t.split(".")[1]??"").length))}${e.unit?` ${e.unit}`:""}`:t}return e.domain==="light"&&t==="on"&&typeof e.attributes.brightness=="number"?`דולק · ${Math.round(e.attributes.brightness/255*100)}%`:e.domain==="cover"&&typeof e.attributes.current_position=="number"&&(t==="open"||t==="closed")?`${qs[t]} · ${e.attributes.current_position}%`:e.domain==="climate"&&typeof e.attributes.current_temperature=="number"?`${qs[t]??t} · ${e.attributes.current_temperature}°`:qs[t]??t}function na(e){return!e||e.removed_at?"unknown":e.state==="unavailable"||!e.available?"offline":e.fresh?e.state===null||e.state==="unknown"?"unknown":kd.has(e.state)?"live":"neutral":"stale"}function _i(e,t){return e==="doors"||t==="lock"||t==="cover"?"lock":e==="lights"||t==="light"||t==="switch"||t==="fan"?"light":"binary_sensor"}function Rs(e){return{light:"תאורה",switch:"מתג",lock:"מנעול",cover:"תריס / שער",binary_sensor:"חיישן בינארי",sensor:"חיישן",fan:"מאוורר",climate:"אקלים",camera:"מצלמת HA",button:"כפתור",script:"סקריפט",scene:"סצנה",automation:"אוטומציה",media_player:"נגן",event:"אירוע",number:"מספר",select:"בחירה",input_boolean:"דגל",alarm_control_panel:"אזעקה",siren:"צופר",vacuum:"שואב",weather:"מזג אוויר",sun:"שמש"}[e]??e}function Fe(e){if(!e)return"—";const t=new Date(e);return Number.isNaN(t.getTime())?e:t.toLocaleString("he-IL",{dateStyle:"short",timeStyle:"medium"})}function zn(e,t){let s=null,i=!1,a=2e3;const n=(()=>{const l=new URL(ge("ha/ws"));return l.protocol=l.protocol==="https:"?"wss:":"ws:",l.toString()})(),o=()=>{if(!i){try{s=new WebSocket(n)}catch{return}s.onopen=()=>{a=2e3},s.onmessage=l=>{try{const p=JSON.parse(l.data);p.type==="entity_state_changed"?e({type:"entity_state_changed",entity:p.payload.entity}):p.type==="ha_sync_state"?e({type:"ha_sync_state",connected:!!p.payload.connected}):p.type==="heartbeat"&&e({type:"heartbeat",sync:p.payload.sync})}catch{}},s.onclose=l=>{!i&&l.code!==4403&&l.code!==4401&&(window.setTimeout(o,a),a=Math.min(3e4,a*2))}}};return o(),()=>{i=!0,s?.close()}}const li=new Map,ws=new Map;function za(e,t={}){const s=new URLSearchParams;t.draft&&s.set("draft","true"),t.at&&s.set("at",t.at);const i=s.toString();return k(`plan-versions/${e}/geometry${i?`?${i}`:""}`)}async function Sa(e){const t=e.geometryRef;if(e.source!=="api"||!t||!e.planVersionId)return null;const s=li.get(t.doc_hash);if(s)return s;try{const i=await za(e.planVersionId,t.status==="draft"?{draft:!0}:t.published_at?{at:t.published_at}:{});return li.set(i.geometry.doc_hash,i.doc),i.doc}catch{return null}}async function zd(e,t){let s=ws.get(e);if(!s){const n=k(`plan-versions/${e}/geometry/timeline`).then(o=>o.timeline).catch(()=>(ws.get(e)===n&&ws.delete(e),[]));s=n,ws.set(e,s)}const i=(await s).find(n=>n.published_at<=t&&(!n.archived_at||t<n.archived_at));if(!i)return null;const a=li.get(i.doc_hash);if(a)return a;try{const n=await za(e,{at:i.published_at});return li.set(n.geometry.doc_hash,n.doc),n.doc}catch{return null}}const Sd=(e,t,s)=>Me(`plan-versions/${e}/geometry`,{doc:t,base_revision:s});async function Md(e){const t=await A(`plan-versions/${e}/geometry/publish`);return ws.delete(e),t}const Ed=e=>k(`plan-versions/${e}/geometry/diff`),Ad=(e,t)=>A(`plan-versions/${e}/geometry/copy-from`,{from_version_id:t}),Pd=(e,t)=>Be(`plan-versions/${e}/calibration`,{pairs:t});function nr(e,t,s={}){return Qe(`api/v1/plan-versions/${e}/export.${t}${s.draft?"?draft=true":""}`)}var Id=Object.defineProperty,Cd=Object.getOwnPropertyDescriptor,F=(e,t,s,i)=>{for(var a=i>1?void 0:i?Cd(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&Id(t,s,a),a};const Dd={off:"כבוי",heat:"חימום",cool:"קירור",heat_cool:"חימום/קירור",auto:"אוטומטי",dry:"ייבוש",fan_only:"מאוורר בלבד"},or=[{id:"cameras",icon:"camera",label:()=>x("floor.cameras")},{id:"doors",icon:"door",label:()=>x("floor.doors")},{id:"lights",icon:"light",label:()=>x("floor.lights")},{id:"sensors",icon:"sensor",label:()=>x("floor.sensors")},{id:"zones",icon:"map",label:()=>"חדרים ואזורים"},{id:"structure",icon:"wall",label:()=>"מבנה"}],lr=["entrance","lobby","corridor","hall","parking","warehouse","backyard","driveway","night"];function Td(e){const t=e.match(/-?\d+/);return t?t[0]:/קרקע/.test(e)?"ק":/גג/.test(e)?"גג":/מרתף/.test(e)?"מ":(e.split(/[\s–-]+/).filter(Boolean).pop()??e).slice(0,4)}let V=class extends z{constructor(){super(...arguments),this.floorId="f0",this.screenState="ready",this.focusZone="",this.focusCamera="",this.focusEntity="",this.selectedZoneId=null,this.bundle=null,this.tree=null,this.loadError="",this.noFloors=!1,this.selectedId=null,this.anchor=null,this.layers=new Set(["cameras","doors","lights","sensors","zones","structure"]),this.geometry=null,this.geomSeq=0,this.pinned=!1,this.panel=!1,this.multi=!1,this.sideList=(()=>{try{return localStorage.getItem("sw.map.sidelist")==="1"}catch{return!1}})(),this.jumpZoom=(()=>{try{return localStorage.getItem("sw.map.jumpzoom")==="1"}catch{return!1}})(),this.focusZoom=!0,this.saveView=null,this.savedView=null,this.picked=[],this.narrow=!1,this.syncConnected=!0,this.action=null,this.confirmSpec=null,this.stopWs=null,this.mq=window.matchMedia("(max-width: 767px)"),this.onMq=()=>this.narrow=this.mq.matches,this.onKey=e=>{if(e.key==="Escape"&&!this.confirmSpec)if(this.selectedId){const t=this.selectedId;this.close(),this.canvas?.focusMarker(t)}else this.panel&&(this.panel=!1)},this.actionArgs={},this.renaming=null,this.notice=""}connectedCallback(){super.connectedCallback(),this.narrow=this.mq.matches,this.mq.addEventListener("change",this.onMq),window.addEventListener("keydown",this.onKey),this.load()}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("keydown",this.onKey),this.mq.removeEventListener("change",this.onMq),this.stopWs?.(),this.stopWs=null}startWs(){this.stopWs||!y()||(this.stopWs=zn(e=>{const t=this.bundle;if(e.type==="entity_state_changed"&&t){if(!t.anchors.some(s=>s.resource_type==="ha_entity"&&s.resource_id===e.entity.entity_id))return;this.bundle={...t,anchors:t.anchors.map(s=>s.resource_type==="ha_entity"&&s.resource_id===e.entity.entity_id?{...s,entity:{...s.entity??{},...e.entity,actions:s.entity?.actions}}:s)}}else e.type==="ha_sync_state"?this.syncConnected=e.connected:e.type==="heartbeat"&&(this.syncConnected=e.sync.connected)}))}updated(e){e.has("floorId")&&e.get("floorId")!==void 0?(this.selectedId=null,this.anchor=null,this.selectedZoneId=null,this.load()):(e.has("focusZone")||e.has("focusCamera")||e.has("focusEntity"))&&this.bundle&&this.applyFocus()}async applyFocus(){const e=this.bundle;if(!e||!this.focusZone&&!this.focusCamera&&!this.focusEntity)return;await this.updateComplete;const t=this.canvas;if(!t)return;const s=this.focusZone?e.zones.find(a=>a.id===this.focusZone):null;if(s){const a=s.polygon.map(o=>o.x),n=s.polygon.map(o=>o.y);this.selectedZoneId=s.id,t.zoomToBox(Math.min(...a),Math.min(...n),Math.max(...a),Math.max(...n))}const i=this.focusCamera?e.anchors.find(a=>a.resource_type==="camera"&&a.resource_id===this.focusCamera):this.focusEntity?e.anchors.find(a=>a.resource_type==="ha_entity"&&a.resource_id===this.focusEntity):null;if(i){this.focusZoom?t.zoomToBox(i.position.x-.15,i.position.y-.15,i.position.x+.15,i.position.y+.15,48,2.2):t.centerOn(i.position.x,i.position.y),await this.updateComplete;const a=t.toScreen(i.position.x,i.position.y);this.selectedId=i.id,this.anchor={x:a.x,y:a.y}}}async load(){this.loadError="";try{const e=this.tree??await Mt();if(this.tree=e,y()&&!bn(e,this.floorId)){const s=yn(e);if(s&&s.id!==this.floorId){$(`/explore/floors/${s.id}`);return}if(!s){this.noFloors=!0,this.bundle=null;return}}this.noFloors=!1,this.restoreLayers(),this.bundle=await Os(this.floorId);const t=++this.geomSeq;this.geometry=null,Sa(this.bundle).then(s=>{t===this.geomSeq&&(this.geometry=s)}),this.bundle.source==="api"&&this.startWs(),this.applyFocus()}catch(e){this.loadError=w(e),this.bundle=null}}get buildingFloors(){if(this.tree?.source!=="api")return[];for(const e of this.tree.sites)for(const t of e.buildings??[]){const s=t.floors??[];if(!s.some(a=>a.id===this.floorId))continue;const i=s.map(a=>Td(a.name));return s.map((a,n)=>({id:a.id,name:a.name,hasPlan:a.has_plan,short:i.filter(o=>o===i[n]).length>1?`${i[n]}${n+1}`:i[n]}))}return[]}get floors(){return this.tree?.source==="api"?this.tree.sites.flatMap(e=>(e.buildings??[]).flatMap(t=>(t.floors??[]).map(s=>({id:s.id,name:`${t.name} · ${s.name}`,cameraCount:s.camera_count,hasPlan:s.has_plan})))):kt.map(e=>({id:e.id,name:e.name,cameraCount:e.cameraCount,hasPlan:e.hasPlan}))}get markers(){const e=this.bundle;if(!e)return[];const t=this.screenState==="stale";if(e.source==="demo"){const s=this.layers.has("cameras")?ys.filter(a=>a.floorId===e.floorId).map(a=>({id:a.id,kind:"camera",label:a.name,x:a.x,y:a.y,rotation:a.rotation,fov:a.fov,state:a.state})):[],i=ei.filter(a=>a.floorId===e.floorId).filter(a=>a.domain==="lock"&&this.layers.has("doors")||a.domain==="light"&&this.layers.has("lights")||a.domain==="binary_sensor"&&this.layers.has("sensors")).map(a=>({id:a.id,kind:a.domain,label:a.name,x:a.x,y:a.y,state:t?"stale":"neutral"}));return[...s,...i]}return e.anchors.filter(s=>s.resource_type==="camera"?this.layers.has("cameras"):this.layers.has(s.layer_id==="doors"?"doors":s.layer_id==="lights"?"lights":"sensors")).map(s=>({id:s.id,kind:s.resource_type==="camera"?"camera":_i(s.layer_id,s.entity?.domain),label:xs(s),x:s.position.x,y:s.position.y,rotation:s.rotation_degrees,fov:s.field_of_view_degrees??void 0,radius:s.coverage_radius??void 0,polygon:s.coverage_polygon?s.coverage_polygon.map(([i,a])=>({x:i,y:a})):void 0,labelPos:s.label_pos??void 0,state:s.resource_type==="camera"?$s(s):t?"stale":this.entityTone(s.entity)}))}layerCounts(){const e=this.bundle,t={cameras:0,doors:0,lights:0,sensors:0,zones:e?.zones.length??0,structure:this.geometry?.walls.length??0};if(!e)return t;if(e.source==="demo"){t.cameras=ys.filter(s=>s.floorId===e.floorId).length;for(const s of ei.filter(i=>i.floorId===e.floorId))s.domain==="lock"?t.doors++:s.domain==="light"?t.lights++:t.sensors++;return t}for(const s of e.anchors)s.resource_type==="camera"?t.cameras++:s.layer_id==="doors"?t.doors++:s.layer_id==="lights"?t.lights++:t.sensors++;return t}zoneOf(e){return this.bundle?.zones.find(s=>ks(e.position,s.polygon))?.name??null}toggleLayer(e){const t=new Set(this.layers);t.has(e)?t.delete(e):t.add(e),this.setLayers(t)}setLayers(e){this.layers=e;try{const t=[...e];e.has("structure")||t.push("-structure"),localStorage.setItem(`sw.floor.layers.${this.floorId}`,JSON.stringify(t))}catch{}}restoreLayers(){try{const e=localStorage.getItem(`sw.floor.layers.${this.floorId}`);if(!e)return;const t=JSON.parse(e);if(!Array.isArray(t))return;const s=new Set(t.filter(i=>or.some(a=>a.id===i)));t.includes("-structure")||s.add("structure"),this.layers=s}catch{}}cameraAnchors(){return(this.bundle?.anchors??[]).filter(e=>e.resource_type==="camera"&&this.layers.has("cameras"))}togglePick(e){this.picked=this.picked.includes(e)?this.picked.filter(t=>t!==e):[...this.picked,e]}pickedCameraIds(){const e=new Map((this.bundle?.anchors??[]).map(t=>[t.id,t.resource_id]));return this.picked.map(t=>e.get(t)).filter(t=>!!t)}setMulti(e){this.multi=e,this.picked=[],this.saveView=null,this.savedView=null,e&&this.close()}addPicks(e){const t=new Set(this.cameraAnchors().map(i=>i.id)),s=e.filter(i=>t.has(i)&&!this.picked.includes(i));s.length&&(this.picked=[...this.picked,...s])}pickZone(e){const t=this.bundle?.zones.find(a=>a.id===e);if(!t)return;const s=this.cameraAnchors().filter(a=>ks(a.position,t.polygon)).map(a=>a.id);if(!s.length)return;const i=s.every(a=>this.picked.includes(a));this.picked=i?this.picked.filter(a=>!s.includes(a)):[...this.picked,...s.filter(a=>!this.picked.includes(a))]}roomChips(){const e=this.bundle;if(!e)return d;const t=this.cameraAnchors(),s=e.zones.map(i=>({z:i,ids:t.filter(a=>ks(a.position,i.polygon)).map(a=>a.id)})).filter(i=>i.ids.length);return s.length?r`<span class="roomchips" data-room-chips>${s.map(i=>r`<sw-chip icon="layers" data-room-chip=${i.z.id} ?selected=${i.ids.every(a=>this.picked.includes(a))} @click=${()=>this.pickZone(i.z.id)}>${i.z.name} (${i.ids.length})</sw-chip>`)}</span>`:d}toggleSideList(){this.sideList=!this.sideList;try{localStorage.setItem("sw.map.sidelist",this.sideList?"1":"0")}catch{}}async jumpTo(e){if(e.resource_type==="camera"?(this.focusCamera=e.resource_id,this.focusEntity=""):(this.focusEntity=e.resource_id,this.focusCamera=""),this.focusZone="",this.multi&&e.resource_type==="camera"){this.togglePick(e.id);return}this.focusZoom=this.jumpZoom,await this.applyFocus(),window.setTimeout(()=>this.focusZoom=!0,900)}setJumpZoom(e){this.jumpZoom=e;try{localStorage.setItem("sw.map.jumpzoom",e?"1":"0")}catch{}}renderSideList(){const e=this.bundle;if(!e||!this.sideList||e.source!=="api")return d;const t=e.anchors.filter(o=>o.resource_type==="camera"),s=e.anchors.filter(o=>o.resource_type==="ha_entity"),i={light:"תאורה",switch:"מפסקים",lock:"מנעולים",binary_sensor:"חיישנים",sensor:"חיישנים",cover:"תריסים",climate:"מיזוג",media_player:"מדיה",alarm_control_panel:"אזעקה"},a=new Map;for(const o of s){const l=o.entity?.domain??o.resource_id.split(".")[0];a.set(l,[...a.get(l)??[],o])}const n=o=>o.camera?o.camera.status==="online"?"#22c55e":o.camera.status==="offline"?"#ef4444":"var(--sw-text-3)":o.entity?.state==="on"||o.entity?.state==="unlocked"||o.entity?.state==="open"?"var(--sw-accent)":"var(--sw-text-3)";return r`<div class="sidelist" data-sidelist>
      ...
      <div class="body">
        ...
        ${this.floors.map(o=>r`<button class="it ${o.id===this.floorId?"on":""}" data-side-floor=${o.id} @click=${()=>{o.id!==this.floorId&&$(`/explore/floors/${o.id}`)}}>
          <sw-icon name="building" size=${12}></sw-icon><span class="nm">${Vt(o.name)}</span><span class="st">${o.cameraCount} מצלמות${o.hasPlan?"":" · אין תוכנית"}</span></button>`)}
        ...
        ${[...a.entries()].map(([o,l])=>r`<div class="grp">${i[o]??o} (${l.length})</div>
          ${l.map(p=>r`<button class="it ${this.selectedId===p.id?"on":""}" data-side-entity=${p.resource_id} @click=${()=>this.jumpTo(p)}>
            <span class="dot" style="--dot:${n(p)}"></span><span class="nm">${xs(p)}</span><span class="st">${p.entity?_t(p.entity):""}</span></button>`)}`)}
      ...
      ${s.actions===void 0?r`<div class="note">${x("entity.noControl")}</div>`:s.actions.length===0?r`<div class="note">קריאה בלבד — אין פעולות מותרות ל־${Rs(s.domain)}.</div>`:d}
    ...
    `}apiCameraBody(e,t){const s=e.camera,i=$s(e),a=lr[((s?.channel??1)-1)%lr.length],n=i==="live"&&!!s&&s.can_view_live!==!1,o=this.zoneOf(e),l=o?`${t} / ${o}`:`${t} · ערוץ ${s?.channel??"?"}`;return r`
    ...
    `}renderCard(){const e=this.bundle;if(!this.selectedId||!e)return d;let t="",s="",i=d,a=d;if(e.source==="demo"){const l=ys.find(m=>m.id===this.selectedId),p=l?void 0:ei.find(m=>m.id===this.selectedId);if(!l&&!p)return d;t=l?l.name:p.name,s=l?`${e.floorName} · ${l.source}`:`${e.floorName} · ${x(p.domain==="lock"?"entity.door":p.domain==="light"?"entity.light":"entity.sensor")}`,i=l?this.demoCameraBody(l,e.floorName):this.demoEntityBody(p);const h=l?l.state==="live"||l.state==="stale":!1;a=l?r`<sw-button variant="primary" size="sm" icon="expand" ?disabled=${!h} @click=${()=>$(`/live/cameras/${l.id}`)}>צפייה חיה</sw-button>
            <sw-button size="sm" icon="history" ?disabled=${l.state==="forbidden"} @click=${()=>$("/investigate/playback")}>${x("camera.recordings")}</sw-button>
            <sw-button variant="ghost" size="sm" iconOnly icon="pin" label=${this.pinned?x("camera.unpin"):x("camera.pin")} @click=${()=>this.pinned=!this.pinned}></sw-button>`:r`<sw-button variant="primary" size="sm" ?disabled=${!p.controllable||this.screenState==="stale"}>${x("entity.control")}</sw-button><sw-button variant="ghost" size="sm">${x("entity.openInHa")}</sw-button>`}else{const l=e.anchors.find(p=>p.id===this.selectedId);if(!l)return d;t=xs(l),s=`${e.buildingName} · ${e.floorName}`,i=l.resource_type==="camera"?this.apiCameraBody(l,e.floorName):this.apiEntityBody(l,e.floorName),a=r`${l.resource_type==="camera"?r`<sw-button variant="primary" size="sm" icon="expand" ?disabled=${$s(l)==="offline"} @click=${()=>l.camera&&$(`/live/cameras/${l.camera.id}`)}>צפייה מלאה</sw-button>
      ...
      <div class="head">
        ...
        <div class="tools">
          <div class="layers" role="group" aria-label=${x("floor.layers")}>
            ${or.map(n=>r`<button class=${this.layers.has(n.id)?"on":""} title=${n.label()} aria-label=${n.label()} aria-pressed=${this.layers.has(n.id)} @click=${()=>this.toggleLayer(n.id)}><sw-icon name=${n.icon} size=${14}></sw-icon></button>`)}
          </div>
          ...
          <sw-field style="min-inline-size:280px"><select aria-label=${x("floor.switcher")} @change=${n=>$(`/explore/floors/${n.target.value}`)}>${t.map(n=>r`<option value=${n.id} ?selected=${n.id===this.floorId}>${Vt(n.name)} · ${n.cameraCount} מצלמות${n.hasPlan?"":" · אין תוכנית"}</option>`)}</select></sw-field>
  ...
  `;Ut([f()],dt.prototype,"heading",2);Ut([f()],dt.prototype,"subheading",2);Ut([f()],dt.prototype,"crumbs",2);Ut([f()],dt.prototype,"backHref",2);Ut([f({type:Boolean,reflect:!0})],dt.prototype,"wide",2);Ut([f({type:Boolean,reflect:!0})],dt.prototype,"flush",2);dt=Ut([E("sw-page")],dt);var Nd=Object.defineProperty,Bd=Object.getOwnPropertyDescriptor,Fs=(e,t,s,i)=>{for(var a=i>1?void 0:i?Bd(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&Nd(t,s,a),a};let jt=class extends z{constructor(){super(...arguments),this.heading="",this.subheading="",this.flush=!1,this.interactive=!1}render(){return r`
  ...
  `;Fs([f()],jt.prototype,"heading",2);Fs([f()],jt.prototype,"subheading",2);Fs([f({type:Boolean,reflect:!0})],jt.prototype,"flush",2);Fs([f({type:Boolean,reflect:!0})],jt.prototype,"interactive",2);jt=Fs([E("sw-card")],jt);var Ld=Object.defineProperty,Vd=Object.getOwnPropertyDescriptor,mt=(e,t,s,i)=>{for(var a=i>1?void 0:i?Vd(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&Ld(t,s,a),a};const Hd=["house","building","warehouse"];let Ze=class extends z{constructor(){super(...arguments),this.tab="all",this.tree=null,this.dialog=null,this.notice="",this.formName="",this.formAddress="",this.busy=!1,this.error=""}connectedCallback(){super.connectedCallback(),this.reload()}async reload(){try{this.tree=await Mt()}catch(e){this.error=w(e)}}open(e){this.formName=e&&e.kind==="edit-site"?e.site.name:e&&e.kind==="edit-building"?e.building.name:"",this.formAddress=e&&e.kind==="edit-site"?e.site.address:"",this.error="",this.dialog=e}pickImage(e,t){const s=document.createElement("input");s.type="file",s.accept="image/png,image/jpeg",s.addEventListener("change",async()=>{const i=s.files?.[0];if(i){this.busy=!0;try{await td(e,t,i),this.notice="התמונה נשמרה.",await this.reload()}catch(a){this.notice=w(a)}finally{this.busy=!1}}}),s.click()}async removeImage(e,t){this.busy=!0;try{await sd(e,t),await this.reload()}catch(s){this.notice=w(s)}finally{this.busy=!1}}renderMenu(e,t,s){const i=s?!!s.image_url:!!t.image_url,a=s?s.id:t.id;return r`<span class="menu" @click=${o=>o.stopPropagation()}>
      ...
      ${e.sites.map((t,s)=>{const i=t.buildings??[],a=i.reduce((n,o)=>n+(o.floors??[]).reduce((l,p)=>l+p.camera_count,0),0);return r`<sw-card flush interactive data-site-card=${t.id} @click=${()=>this.openSite(t)}>
          <div class="pic">${t.image_url?r`<img class="photo" src=${ar(t.image_url)} alt="" />`:r`<sw-scene kind=${Hd[s%3]}></sw-scene>${e.source==="demo"?r`<span class="demo">דמו</span>`:r`<span class="demo">איור</span>`}`}</div>
          <div class="info">
      ...
      ${t.map(({s,b:i},a)=>r`<sw-card class="brow" data-building-card=${i.id} @click=${()=>$(`/explore/buildings/${i.id}/floors`)}>
          ${i.image_url?r`<img class="photo small" src=${ar(i.image_url)} alt="" />`:r`<sw-scene kind=${a%2?"house":"building"}></sw-scene>`}
  ...
  `;mt([c()],Ze.prototype,"tab",2);mt([c()],Ze.prototype,"tree",2);mt([c()],Ze.prototype,"dialog",2);mt([c()],Ze.prototype,"notice",2);mt([c()],Ze.prototype,"formName",2);mt([c()],Ze.prototype,"formAddress",2);mt([c()],Ze.prototype,"busy",2);mt([c()],Ze.prototype,"error",2);Ze=mt([E("explore-sites")],Ze);var jd=Object.defineProperty,Fd=Object.getOwnPropertyDescriptor,Ws=(e,t,s,i)=>{for(var a=i>1?void 0:i?Fd(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&jd(t,s,a),a};let Ft=class extends z{constructor(){super(...arguments),this.rooms=[],this.selected=!1,this.empty=!1,this.width=132}iso(e,t){return{x:60+(e-t)*58,y:6+(e+t)*26}}poly(e){return e.map(t=>`${t.x.toFixed(1)},${t.y.toFixed(1)}`).join(" ")}render(){this.style.setProperty("--w",`${this.width}px`);const e=[this.iso(0,0),this.iso(1,0),this.iso(1,1),this.iso(0,1)],t=7,s=[this.iso(1,0),this.iso(1,1),{x:this.iso(1,1).x,y:this.iso(1,1).y+t},{x:this.iso(1,0).x,y:this.iso(1,0).y+t}],i=[this.iso(0,1),this.iso(1,1),{x:this.iso(1,1).x,y:this.iso(1,1).y+t},{x:this.iso(0,1).x,y:this.iso(0,1).y+t}];return r`<svg viewBox="0 0 120 72" aria-hidden="true">
      ...
      <sw-page heading=${s.name} subheading=${`${t.address||t.name} · ${i.length} קומות${o.source==="demo"?" · נתוני הדגמה":""}`} crumbs=${`אתרים | ${t.name} | ${s.name}`}>
        ...
        ${this.tab==="floors"?r`<div class="list">
              ...
              ${i.map(l=>r`<button class="floor ${a?.id===l.id?"on":""}" @click=${()=>a?.id===l.id?$(`/explore/floors/${l.id}`):this.selected=l.id} aria-pressed=${a?.id===l.id}>
                  ...
                  <sw-floor-iso .rooms=${o.source==="demo"?Xi(l.id):[]} ?selected=${a?.id===l.id} ?empty=${!l.has_plan} width=${128}></sw-floor-iso>
            ...
            </div>`:this.tab==="cameras"?r`<div class="cams">${i.map(l=>r`<sw-card heading=${Vt(l.name)} subheading="${l.camera_count} מצלמות" interactive @click=${()=>$(`/explore/floors/${l.id}`)}></sw-card>`)}</div>`:r`<sw-card heading="פרטי המבנה">
                <dl>
  ...
  `;Ma([f({attribute:!1})],Ns.prototype,"steps",2);Ma([f({type:Number})],Ns.prototype,"current",2);Ns=Ma([E("sw-steps")],Ns);var Kd=Object.defineProperty,Gd=Object.getOwnPropertyDescriptor,ne=(e,t,s,i)=>{for(var a=i>1?void 0:i?Gd(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&Kd(t,s,a),a};const Oi=["קובץ","עמוד","חיתוך וסיבוב","שם והערות","שמירה ופרסום"];function dr(e){return e>=1024*1024?`${(e/1024/1024).toFixed(1)} MB`:`${Math.max(1,Math.round(e/1024))} KB`}let te=class extends z{constructor(){super(...arguments),this.floorId="",this.step=0,this.tree=null,this.assets=[],this.asset=null,this.page=1,this.rotation=0,this.crop={x:0,y:0,w:1,h:1},this.notes="",this.version=null,this.busy=!1,this.error="",this.dragOver=!1,this.dxf=null,this.dxfLayers=null,this.dxfUnits=null,this.dxfBusy=!1,this.previewBust=0,this.startCrop=e=>{if(e.button!==0)return;const t=e.currentTarget,s=t.getBoundingClientRect(),i=l=>({x:Math.min(1,Math.max(0,(l.clientX-s.left)/s.width)),y:Math.min(1,Math.max(0,(l.clientY-s.top)/s.height))}),a=i(e);t.setPointerCapture(e.pointerId),e.preventDefault();const n=l=>{const p=i(l),h=Math.min(a.x,p.x),m=Math.min(a.y,p.y),g=Math.abs(p.x-a.x),v=Math.abs(p.y-a.y);g>.01&&v>.01&&(this.crop={x:+h.toFixed(4),y:+m.toFixed(4),w:+g.toFixed(4),h:+v.toFixed(4)})},o=()=>{t.removeEventListener("pointermove",n),t.removeEventListener("pointerup",o),t.removeEventListener("pointercancel",o),(this.crop.w<.02||this.crop.h<.02)&&(this.crop={x:0,y:0,w:1,h:1})};t.addEventListener("pointermove",n),t.addEventListener("pointerup",o),t.addEventListener("pointercancel",o)}}connectedCallback(){super.connectedCallback(),this.init()}async init(){try{this.tree=await Mt(),y()&&this.floorId&&(this.assets=(await Tl(this.floorId)).assets)}catch(e){this.error=w(e)}}get floor(){return this.tree&&this.floorId?bn(this.tree,this.floorId):null}updated(e){if(e.has("asset")&&y()){const t=this.asset;t&&t.kind==="dxf"&&(!this.dxf||this.dxf.asset_id!==t.id)?this.loadDxf(t.id):(!t||t.kind!=="dxf")&&(this.dxf=null)}}async loadDxf(e){try{const t=await Wl(e);this.dxf=t,this.dxfLayers=t.options.layers,this.dxfUnits=t.options.units??(t.info?.units&&t.info.units!=="unitless"?t.info.units:null)}catch(t){this.error=w(t)}}toggleDxfLayer(e){const t=this.dxf?.info?.layers.filter(i=>i.drawable>0).map(i=>i.name)??[],s=this.dxfLayers??t;this.dxfLayers=s.includes(e)?s.filter(i=>i!==e):[...s,e]}async applyDxf(){if(this.dxf){this.dxfBusy=!0,this.error="";try{const e=this.dxf.info?.layers.filter(s=>s.drawable>0).map(s=>s.name)??[],t=this.dxfLayers&&this.dxfLayers.length!==e.length?this.dxfLayers:null;this.dxf=await Ul(this.dxf.asset_id,{layers:t,units:this.dxfUnits}),this.dxfLayers=this.dxf.options.layers,this.previewBust=Date.now()}catch(e){this.error=w(e)}finally{this.dxfBusy=!1}}}renderDxf(){const e=this.dxf;if(!e||!e.info)return d;const t=e.info.layers.filter(l=>l.drawable>0).map(l=>l.name),s=this.dxfLayers??t,i=e.info.extent,a=Object.entries(e.render?.skipped??e.info.unsupported),n=e.render?.meters_per_px,o=e.render?.units&&e.render.units!=="unitless";return r`<sw-card heading="DXF · שכבות, יחידות וקנה מידה" subheading=${`${e.adapter.library} (${e.adapter.license}) · המקור נשמר כפי שהועלה; התצוגה נגזרת ממנו`} data-dxf>
    ...
    </sw-card>`}async onFile(e){if(!(!e||!this.floorId)){this.busy=!0,this.error="";try{this.asset=await Ol(this.floorId,e),this.page=1,this.rotation=0,this.crop={x:0,y:0,w:1,h:1},this.version=null,this.step=this.asset.page_count>1?1:2,this.assets=[this.asset,...this.assets.filter(t=>t.id!==this.asset.id)]}catch(t){this.error=w(t)}finally{this.busy=!1}}}async save(){if(!(!this.asset||!this.floorId)){this.busy=!0,this.error="";try{const e=this.crop.x===0&&this.crop.y===0&&this.crop.w===1&&this.crop.h===1;this.version=await Nl(this.floorId,{asset_id:this.asset.id,page:this.page,rotation:this.rotation,crop:e?null:this.crop,notes:this.notes})}catch(e){this.error=w(e)}finally{this.busy=!1}}}async publish(){if(this.version){this.busy=!0,this.error="";try{this.version=await fn(this.version.id)}catch(e){this.error=w(e)}finally{this.busy=!1}}}setCrop(e,t){const s=Math.max(0,Math.min(100,t))/100,i={...this.crop,[e]:s};i.x+i.w>1&&(i.w=1-i.x),i.y+i.h>1&&(i.h=1-i.y),i.w<=.02&&(i.w=.02),i.h<=.02&&(i.h=.02),this.crop=i}previewUrl(){const e=this.asset?.pages.find(s=>s.page===this.page)??this.asset?.pages[0];if(!e)return"";const t=Qe(e.preview_url)+(this.previewBust?`${e.preview_url.includes("?")?"&":"?"}v=${this.previewBust}`:"");return this.rotation?`${t}${t.includes("?")?"&":"?"}rotation=${this.rotation}`:t}renderStep(){const e=this.asset;switch(this.step){case 0:return r`
                ...
                <div class="layout">
                  ...
                  <div class="side">
                    ...
                    <div class="foot">
                      ...
                      ${this.step<Oi.length-1?r`<sw-button variant="primary" ?disabled=${!t||this.busy} @click=${()=>this.step=Math.min(Oi.length-1,this.step+1)}>הבא</sw-button>`:d}
                    </div>
                  </div>
                </div>`:this.renderDemo()}
      </sw-page>
  ...
  `;ne([f()],te.prototype,"floorId",2);ne([c()],te.prototype,"step",2);ne([c()],te.prototype,"tree",2);ne([c()],te.prototype,"assets",2);ne([c()],te.prototype,"asset",2);ne([c()],te.prototype,"page",2);ne([c()],te.prototype,"rotation",2);ne([c()],te.prototype,"crop",2);ne([c()],te.prototype,"notes",2);ne([c()],te.prototype,"version",2);ne([c()],te.prototype,"busy",2);ne([c()],te.prototype,"error",2);ne([c()],te.prototype,"dragOver",2);ne([c()],te.prototype,"dxf",2);ne([c()],te.prototype,"dxfLayers",2);ne([c()],te.prototype,"dxfUnits",2);ne([c()],te.prototype,"dxfBusy",2);ne([c()],te.prototype,"previewBust",2);te=ne([E("explore-plan-import")],te);const Ri={white:"לבן",tint:"גוון לכל חדר",none:"ללא מילוי"};async function Yd(e,t){const s=await A(`plan-versions/${e}/stylize`,t);return{...s,source_url:Qe(s.source_url)+`?v=${Date.now()}`,stylized_url:Qe(s.stylized_url)+`?v=${Date.now()}`}}const Jd=(e,t)=>Be(`plan-versions/${e}`,{render_mode:t});let ti=null,Ks=null;const Xd={"media.transport_default":"mse","media.max_live_sessions":8,"media.wall_profile":"sub","snapshots.max_age_s":60};async function Ve(e=!1){return y()?ti&&!e?ti:(Ks||(Ks=sn().then(t=>ti=t.settings).finally(()=>Ks=null)),Ks):Xd}function cr(){ti=null}function Ea(e){return an()||e?.["media.transport_default"]||"mse"}const Qd={load:e=>za(e,{draft:!0}),save:(e,t,s)=>Sd(e,t,s)};class ec{constructor(t,s=Qd,i=2e3){this.host=t,this.api=s,this.delayMs=i,this.doc=null,this.revision=0,this.hash=null,this.publishedHash=null,this.issues=[],this.copyCandidates=[],this.saveState="idle",this.error="",this.versionId=null,this.undoStack=[],this.redoStack=[],this.dirty=!1,this.inflight=null,this.conflicted=!1,this.loadToken=0,this.loaded=0,t.addController(this)}hostConnected(){}hostDisconnected(){clearTimeout(this.timer)}get canUndo(){return this.undoStack.length>0}get canRedo(){return this.redoStack.length>0}get hasConflict(){return this.conflicted}get pendingPublish(){const t=this.doc;return!t||!this.hash||this.hash===this.publishedHash?!1:this.publishedHash!==null||t.walls.length>0||t.openings.length>0||t.labels.length>0||t.objects.length>0||t.connectors.length>0}async load(t){clearTimeout(this.timer);const s=++this.loadToken;let i;try{i=await this.api.load(t)}catch(a){if(s===this.loadToken)throw a;return}s===this.loadToken&&(this.loaded=s,this.versionId=t,this.apply(i),this.doc=i.doc,this.copyCandidates=i.copy_candidates??[],this.undoStack=[],this.redoStack=[],this.dirty=!1,this.conflicted=!1,this.saveState="idle",this.error="",this.host.requestUpdate())}commit(t){this.doc&&(this.undoStack=[...this.undoStack.slice(-59),this.doc],this.redoStack=[],this.change(t))}undo(){const t=this.undoStack.pop();!t||!this.doc||(this.redoStack.push(this.doc),this.change(t))}redo(){const t=this.redoStack.pop();!t||!this.doc||(this.undoStack.push(this.doc),this.change(t))}async flush(){clearTimeout(this.timer);let t=!1;for(;;){if(this.inflight){await this.inflight;continue}if(!this.dirty||this.conflicted||t&&this.saveState==="error")break;t=!0,this.inflight=this.saveOnce(),await this.inflight,this.inflight=null}return!this.dirty&&this.saveState!=="error"}change(t){this.doc=t,this.dirty=!0,clearTimeout(this.timer),this.conflicted||(this.saveState!=="saving"&&(this.saveState="pending"),this.timer=setTimeout(()=>void this.flush(),this.delayMs)),this.host.requestUpdate()}apply(t){this.revision=t.geometry.revision,this.hash=t.geometry.doc_hash,this.publishedHash=t.published_hash,this.issues=t.issues}async saveOnce(){const t=this.doc,s=this.versionId,i=this.loaded;if(!t||!s){this.dirty=!1;return}this.dirty=!1,this.saveState="saving",this.host.requestUpdate();try{const a=await this.api.save(s,t,this.revision);if(i!==this.loaded)return;this.apply(a),this.saveState=this.dirty?"pending":"saved",this.error=""}catch(a){if(i!==this.loaded)return;this.dirty=!0,a instanceof fe&&a.code==="stale_revision"&&(this.conflicted=!0),this.saveState="error",this.error=this.conflicted?"טיוטת המבנה נערכה במקום אחר; טען מחדש את העורך כדי לא לדרוס שינוי.":w(a)}finally{this.host.requestUpdate()}}}function Aa(){const e=new Uint8Array(8);return crypto.getRandomValues(e),Array.from(e,t=>t.toString(16).padStart(2,"0")).join("")}const di=e=>Math.round(e*1e5)/1e5,zi=e=>[di(Math.min(1,Math.max(0,e[0]))),di(Math.min(1,Math.max(0,e[1])))];function Sn(e){return e.levels.find(t=>t.is_default)?.id??fl}function Mn(e){const t=e==="door"?"right":"none";return{kind:e,...wl[e],swing:t}}function tc(e,t,s){const i=Aa(),a={id:i,level_id:Sn(e),polyline:t.map(zi),thickness_m:s.thickness_m,height_m:null,base_z_m:0,kind:s.kind,confidence:1,source:"manual",locked:!1,external_ids:{}};return{doc:{...e,walls:[...e.walls,a]},id:i}}function sc(e,t,s,i){const a={id:Aa(),wall_id:t,t:di(Math.min(1,Math.max(0,s))),...Mn(i),hinge:"start",anchor_ref:null,confidence:1,source:"manual",external_ids:{}};return{doc:{...e,openings:[...e.openings,a]},id:a.id}}function ic(e,t,s){return{...e,walls:e.walls.map(i=>i.id===t?{...i,...s,id:i.id}:i)}}function pr(e,t,s){return{...e,openings:e.openings.map(i=>i.id===t?{...i,...s,id:i.id,t:s.t===void 0?i.t:di(Math.min(1,Math.max(0,s.t)))}:i)}}function Ni(e,t,s,i){return{...e,walls:e.walls.map(a=>a.id===t?{...a,polyline:a.polyline.map((n,o)=>o===s?zi(i):n)}:a)}}function hr(e,t){return e.walls.some(s=>s.id===t)?{...e,walls:e.walls.filter(s=>s.id!==t),openings:e.openings.filter(s=>s.wall_id!==t)}:{...e,openings:e.openings.filter(s=>s.id!==t),labels:e.labels.filter(s=>s.id!==t)}}function ac(e,t,s){const i={id:Aa(),text:s,position:zi(t),level_id:Sn(e),size:14};return{doc:{...e,labels:[...e.labels,i]},id:i.id}}function ur(e,t,s){return{...e,labels:e.labels.map(i=>i.id===t?{...i,...s,id:i.id,position:s.position?zi(s.position):i.position}:i)}}const Bi=[{id:"select",label:"בחירה",hint:"לחץ על קיר, פתח או תווית כדי לערוך. גרור פתח לאורך הקיר, תווית למקומה ופינה של קיר נבחר."},{id:"wall",label:"קיר",hint:"לחץ נקודה אחר נקודה. Enter או לחיצה חוזרת על הנקודה האחרונה מסיימים, לחיצה על הנקודה הראשונה סוגרת מתאר, Shift מבטל הצמדה לזוויות, Backspace מוחק נקודה."},{id:"door",label:"דלת",hint:"לחץ על קיר כדי להציב דלת. כיוון הפתיחה והציר נקבעים כאן בפאנל."},{id:"window",label:"חלון",hint:"לחץ על קיר כדי להציב חלון."},{id:"passage",label:"מעבר",hint:"פתח בלי דלת בקיר."},{id:"label",label:"תווית",hint:"לחץ במקום התווית ואז הקלד את הטקסט כאן בפאנל."}],_s={exterior:"חיצוני",interior:"פנימי",partition:"מחיצה",railing:"מעקה",low:"קיר נמוך"},Gs={door:"דלת",window:"חלון",passage:"מעבר"},mr={right:"לצד ימין של הקיר",left:"לצד שמאל של הקיר",double:"כנף כפולה",sliding:"הזזה",none:"ללא כנף"},fr={start:"בצד תחילת הקיר",end:"בצד סוף הקיר"},rc={idle:"טיוטת המבנה",pending:"שינויים ממתינים לשמירה…",saving:"שומר…",saved:"הטיוטה נשמרה · הצופים יראו אותה אחרי פרסום",error:"השמירה נכשלה"},nc={walls:"קירות",openings:"פתחים",labels:"תוויות",levels:"מפלסים",rooms:"חדרים",objects:"עצמים",circuits:"מעגלי תאורה",connectors:"מחברים",groups:"קבוצות"};function ci(e,t,s=!0){return t&&!s?"לא מכויל":`${t?"≈":""}${e<10?e.toFixed(2):e.toFixed(1)} מ׳`}function lt(e,t,s){return e===1?t:`${e} ${s}`}function Pa(e){return`1 מ׳ = ${(1/e).toFixed(1)} פיקסלים בתוכנית`}function oc(e,t,s=!0){return t&&!s?"לא מכויל":`${t?"≈":""}${e<100?e.toFixed(1):e.toFixed(0)} מ״ר`}const Jt=e=>parseFloat(e.target.value);function lc(e,t){const{scale:s,estimated:i}=bs(e.doc),a=e.issues.filter(p=>p.severity==="error"),n=e.issues.filter(p=>p.severity==="warning"),o=Bi.find(p=>p.id===e.mode)??Bi[0],l=!e.doc.walls.length&&!e.doc.openings.length&&!e.doc.labels.length;return r`<sw-card heading="מבנה" subheading=${rc[e.saveState]} data-studio-panel data-studio-save=${e.saveState}>
    <div class="modes" role="group" aria-label="כלי ציור">
      ${Bi.map(p=>r`<button class=${p.id===e.mode?"on":""} data-studio-mode=${p.id} aria-pressed=${p.id===e.mode} @click=${()=>t.setMode(p.id)}>${p.label}</button>`)}
    </div>
    <div class="note">${o.hint}</div>
    ${e.mode==="wall"?dc(e.wallDefaults,t):d}
    <div class="row"><span class="lbl">קנה מידה<span class="muted" data-studio-scale>${i?e.showEstimates?"לא מכויל: מידות משוערות (≈)":"לא מכויל: מידות מוסתרות עד הכיול":Pa(s)}</span></span><sw-button size="sm" icon="scale" data-studio-calibrate @click=${()=>t.calibrate()}>${i?"כיול":"כיול מחדש"}</sw-button></div>
    ...
    ${e.kind==="door"?r`<div class="two">
          <sw-field label="כיוון פתיחה"><select aria-label="כיוון פתיחה" @change=${s=>t.patchOpening(e.id,{swing:s.target.value})}>
            ${Object.keys(mr).map(s=>r`<option value=${s} ?selected=${e.swing===s}>${mr[s]}</option>`)}
          </select></sw-field>
          <sw-field label="ציר"><select aria-label="ציר" @change=${s=>t.patchOpening(e.id,{hinge:s.target.value})}>
            ${Object.keys(fr).map(s=>r`<option value=${s} ?selected=${e.hinge===s}>${fr[s]}</option>`)}
          </select></sw-field>
        </div>`:d}
    <div class="btns"><sw-button size="sm" variant="ghost" icon="trash" data-geom-delete @click=${()=>t.remove(e.id)}>מחק ${Gs[e.kind]}</sw-button></div>
    ...
    <sw-field label="גודל"><input type="number" min="6" max="200" step="1" data-ltr .value=${String(e.size)}
      @change=${s=>{const i=Jt(s);i>=6&&i<=200&&t.patchLabel(e.id,{size:i})}} /></sw-field>
  ...
  </sw-card>`}function wc(e,t,s,i,a,n,o){const l=e.length>1?_a(e,t,s)*i:0;return r`<sw-card heading="מדידה" subheading=${a?n?"לא מכויל: הערכים משוערים (≈)":"לא מכויל: המידות מוסתרות עד הכיול (הגדרות)":"לפי הכיול של גרסת התוכנית"} data-measure-panel>
    <div class="note">לחץ נקודות על התוכנית. Shift מבטל הצמדה לזוויות, Esc מנקה.</div>
    <div class="measure-val" data-measure-distance>${e.length>1?ci(l,a,n):"—"}</div>
    ${e.length>=3?r`<div class="note">שטח המצולע <span class="measure-val" data-measure-area>${oc(xl(e,t,s,i),a,n)}</span> · היקף ${ci(kl(e,t,s,i),a,n)}</div>`:d}
...
`;var bc=Object.defineProperty,yc=Object.getOwnPropertyDescriptor,R=(e,t,s,i)=>{for(var a=i>1?void 0:i?yc(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&bc(t,s,a),a};const Ys=["#2767ED","#22A06B","#F59E0B","#8B5CF6","#0EA5E9","#EC4899","#14B8A6","#F97316"],$c=[{id:"select",icon:"target",label:"בחירה וגרירה",ready:!0},{id:"camera",icon:"camera",label:"הוספת מצלמה",ready:!0},{id:"lights",icon:"light",label:"הוספת תאורה (מפסקים)",ready:!0},{id:"entity",icon:"plus",label:"ישות HA אחרת",ready:!0},{id:"zones",icon:"map",label:"חדרים ואזורים",ready:!0},{id:"structure",icon:"wall",label:"מבנה: קירות, דלתות וחלונות",ready:!0},{id:"calibrate",icon:"scale",label:"כיול קנה מידה",ready:!0},{id:"measure",icon:"ruler",label:"מדידת מרחק ושטח",ready:!0},{id:"layers",icon:"layers",label:"שכבות",ready:!0}],gr=["structure","calibrate","measure"],Pt={a:null,b:null,metres:"",result:"",warning:""},Li=(e,t)=>`${lt(e,"קיר אחד","קירות")}, ${lt(t,"פתח אחד","פתחים")}`,wr=[{id:"cameras",label:"מצלמות"},{id:"doors",label:"דלתות ומנעולים"},{id:"lights",label:"תאורה ומתגים"},{id:"sensors",label:"חיישנים"}],xc={asset:"קובץ",page:"עמוד",rotation:"סיבוב",crop:"חיתוך",width_px:"רוחב",height_px:"גובה"},Vi=e=>e?new Intl.DateTimeFormat("he-IL",{dateStyle:"short",timeStyle:"short"}).format(new Date(e)):"";let T=class extends z{constructor(){super(...arguments),this.floorId="",this.presetEntity="",this.bundle=null,this.anchors=[],this.dirty=new Set,this.undo=[],this.redo=[],this.selectedId=null,this.tool="select",this.layers=new Set(["cameras","doors","lights","sensors"]),this.placing=null,this.entQ="",this.entResults=null,this.entBusy=!1,this.lightsAll=!1,this.busy=!1,this.error="",this.info="",this.stylizing=!1,this.stylized=null,this.stylizeOpts={strength:"medium",keepLines:!1,roomFill:"white"},this.zones=[],this.versions=[],this.diff=null,this.selectedZoneId=null,this.candidates=null,this.detecting=!1,this.detectStrength="medium",this.replaceAuto=!0,this.drawing=null,this.showZones=!0,this.zoneBusy=!1,this.studio=new ec(this),this.studioVersion=null,this.studioMode="wall",this.wallDefaults={thickness_m:.2,kind:"interior"},this.geomSel=null,this.wallDraft=null,this.lastDrawClick=null,this.hover=null,this.calib={...Pt},this.measurePts=[],this.geomDiff=null,this.showEstimates=!0,this.entTimer=0,this.onKey=e=>this.handleKey(e)}connectedCallback(){super.connectedCallback(),this.load(),window.addEventListener("keydown",this.onKey),this.presetEntity&&(this.tool="entity",this.entQ=this.presetEntity,this.searchEntities())}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("keydown",this.onKey),this.studio.flush()}async realign(e){if(!(!this.bundle||this.busy)){this.busy=!0;try{const t=await Vl(this.bundle.floorId,e);this.error=t.moved||!t.skipped?"":`${t.skipped} פריטים לא ניתנים ליישור אוטומטי (שרטוט אחר) — בדוק אותם ולחץ "אשר מיקומים".`,await this.load()}catch(t){this.error=w(t)}finally{this.busy=!1}}}async load(){this.error="";try{const e=await Os(this.floorId||"f0",!0);this.bundle=e,this.loadStudio(e),Ve().then(t=>{this.showEstimates=t["plan.estimates"]!=="false"}).catch(()=>{}),this.anchors=e.anchors.map(t=>({...t,position:{...t.position}})),this.zones=e.zones,this.loadVersions(),this.selectedZoneId&&!this.zones.some(t=>t.id===this.selectedZoneId)&&(this.selectedZoneId=null),this.dirty=new Set,this.undo=[],this.redo=[],this.selectedId&&!this.anchors.some(t=>t.id===this.selectedId)&&(this.selectedId=null)}catch(e){this.error=w(e)}}get selected(){return this.anchors.find(e=>e.id===this.selectedId)}layerOf(e){return e.resource_type==="camera"?"cameras":e.layer_id==="doors"?"doors":e.layer_id==="lights"?"lights":"sensors"}get markers(){return this.anchors.filter(e=>this.layers.has(this.layerOf(e))).map(e=>({id:e.id,kind:e.resource_type==="camera"?"camera":_i(e.layer_id,e.entity?.domain),label:this.anchorName(e),x:e.position.x,y:e.position.y,rotation:e.rotation_degrees,fov:e.field_of_view_degrees??void 0,radius:e.coverage_radius??void 0,polygon:e.coverage_polygon?e.coverage_polygon.map(([t,s])=>({x:t,y:s})):void 0,labelPos:e.label_pos??void 0,state:e.resource_type==="camera"?this.bundle?.source==="demo"?"live":$s(e):"neutral"}))}anchorName(e){return e.resource_type==="camera"?e.camera?.name??e.label??e.resource_id:e.label??e.entity?.name??e.resource_id}get selectedZone(){return this.zones.find(e=>e.id===this.selectedZoneId)}get planZones(){if(!this.showZones)return[];const e=this.zones.map(s=>({id:s.id,name:s.name,kind:s.kind,color:s.color,polygon:s.polygon,labelPos:s.label_pos})),t=(this.candidates??[]).map((s,i)=>({id:`cand-${i}`,name:s.include?s.name:"",color:s.include?Ys[i%Ys.length]:"#9AA3B5",polygon:s.polygon,candidate:!0}));return[...e,...t]}async detect(){const e=this.bundle;if(e){if(e.source==="demo"){this.info="נתוני הדגמה: הזיהוי עובד מול השרת.";return}this.detecting=!0,this.error="";try{const t=await dd(e.floorId,this.detectStrength);this.candidates=t.rooms.map((s,i)=>({polygon:s.polygon,name:`חדר ${i+1}`,kind:"room",include:!0})),this.selectedZoneId=null,this.selectedId=null,this.info=t.rooms.length?`${t.rooms.length} חדרים זוהו · תן שמות ושמור`:"לא זוהו חדרים סגורים; נסה עוצמה אחרת או צייר אזור ידנית",setTimeout(()=>this.info="",5e3)}catch(t){this.error=w(t)}finally{this.detecting=!1}}}setCandidate(e,t){this.candidates&&(this.candidates=this.candidates.map((s,i)=>i===e?{...s,...t}:s))}async acceptCandidates(){const e=this.bundle,t=(this.candidates??[]).filter(s=>s.include);if(!(!e||!t.length)){this.zoneBusy=!0,this.error="";try{const s=await cd(e.floorId,t.map(i=>({polygon:i.polygon,name:i.name,kind:i.kind})),this.replaceAuto);this.candidates=null,this.zones=s.zones,this.info=`${s.created.length} חדרים נשמרו`,setTimeout(()=>this.info="",3e3)}catch(s){this.error=w(s)}finally{this.zoneBusy=!1}}}startDrawing(){this.drawing=[],this.placing=null,this.candidates=null,this.selectedZoneId=null,this.selectedId=null}addDraftPoint(e,t){const s=this.drawing,i=this.bundle;if(!(!s||!i)){if(s.length>=3){const a=this.canvas?.zoom??1;if(Math.hypot((e-s[0].x)*i.width*a,(t-s[0].y)*i.height*a)<12){this.finishDrawing();return}}this.drawing=[...s,{x:+e.toFixed(4),y:+t.toFixed(4)}]}}async finishDrawing(){const e=this.drawing,t=this.bundle;if(!(!e||!t||e.length<3)){if(t.source==="demo"){this.info="נתוני הדגמה: השמירה עובדת מול השרת.",this.drawing=null;return}this.zoneBusy=!0,this.error="";try{const s=await nd(t.floorId,{name:`אזור ${this.zones.length+1}`,kind:"zone",polygon:e});this.drawing=null,this.zones=[...this.zones,s],this.selectedZoneId=s.id,this.info="האזור נוצר · תן לו שם",setTimeout(()=>this.info="",3e3)}catch(s){this.error=w(s)}finally{this.zoneBusy=!1}}}async patchZone(e,t){if(this.bundle?.source!=="demo"){this.zoneBusy=!0,this.error="";try{const s=await od(e.id,{revision:e.revision,...t});this.zones=this.zones.map(i=>i.id===s.id?s:i)}catch(s){s instanceof fe&&s.status===409?(this.error="האזור השתנה בינתיים על ידי עורך אחר; נטען מחדש בלי לדרוס.",await this.load()):this.error=w(s)}finally{this.zoneBusy=!1}}}async removeZone(e){if(this.bundle?.source!=="demo"&&window.confirm(`למחוק את "${e.name}"? המצלמות והישויות בקומה לא מושפעות.`)){this.zoneBusy=!0,this.error="";try{await ld(e.id),this.zones=this.zones.filter(t=>t.id!==e.id),this.selectedZoneId===e.id&&(this.selectedZoneId=null)}catch(t){this.error=w(t)}finally{this.zoneBusy=!1}}}snapshot(){this.undo=[...this.undo.slice(-40),this.anchors.map(e=>({...e,position:{...e.position}}))],this.redo=[]}apply(e,t){this.snapshot(),this.anchors=this.anchors.map(s=>s.id===e?{...s,...t,position:t.position??s.position}:s),this.dirty=new Set(this.dirty).add(e)}nudge(e,t){const s=this.selected;s&&this.apply(s.id,{position:{x:+Math.min(1,Math.max(0,s.position.x+e)).toFixed(4),y:+Math.min(1,Math.max(0,s.position.y+t)).toFixed(4)}})}doUndo(){const e=this.undo[this.undo.length-1];e&&(this.redo=[...this.redo,this.anchors],this.undo=this.undo.slice(0,-1),this.anchors=e,this.dirty=new Set(this.anchors.map(t=>t.id)))}doRedo(){const e=this.redo[this.redo.length-1];e&&(this.undo=[...this.undo,this.anchors],this.redo=this.redo.slice(0,-1),this.anchors=e,this.dirty=new Set(this.anchors.map(t=>t.id)))}handleKey(e){const t=e.composedPath()[0],s=t&&(t.tagName==="INPUT"||t.tagName==="TEXTAREA"||t.tagName==="SELECT"||t.isContentEditable);if(e.key==="Escape"){this.wallDraft?(this.wallDraft=null,this.hover=null):this.tool==="measure"&&this.measurePts.length?this.measurePts=[]:this.tool==="calibrate"&&this.calib.a?this.calib={...Pt}:this.drawing?this.drawing=null:this.placing?this.placing=null:this.candidates?this.candidates=null:(this.selectedId=null,this.selectedZoneId=null,this.geomSel=null);return}if(s||this.studioOn&&this.handleStudioKey(e))return;if(e.key==="Enter"&&this.drawing){e.preventDefault(),this.finishDrawing();return}if((e.key==="Delete"||e.key==="Backspace")&&!this.selected&&this.selectedZone){e.preventDefault(),this.removeZone(this.selectedZone);return}if((e.ctrlKey||e.metaKey)&&e.key.toLowerCase()==="z"){e.preventDefault(),e.shiftKey?this.doRedo():this.doUndo();return}if((e.ctrlKey||e.metaKey)&&e.key.toLowerCase()==="y"){e.preventDefault(),this.doRedo();return}if((e.ctrlKey||e.metaKey)&&e.key.toLowerCase()==="s"){e.preventDefault(),this.save();return}if(!this.selected)return;const i=e.shiftKey?.01:.002;e.key==="ArrowLeft"?(e.preventDefault(),this.nudge(-i,0)):e.key==="ArrowRight"?(e.preventDefault(),this.nudge(i,0)):e.key==="ArrowUp"?(e.preventDefault(),this.nudge(0,-i)):e.key==="ArrowDown"?(e.preventDefault(),this.nudge(0,i)):(e.key==="Delete"||e.key==="Backspace")&&(e.preventDefault(),this.removeSelected())}async save(){if(!this.bundle||this.bundle.source==="demo")return this.info="נתוני הדגמה: השינויים נשמרים רק במסך זה.",this.dirty=new Set,!0;if(!this.dirty.size)return!0;this.busy=!0,this.error="";let e=!1;try{for(const t of this.dirty){const s=this.anchors.find(i=>i.id===t);if(s)try{const i=await gn(t,{revision:s.revision,x:s.position.x,y:s.position.y,rotation_degrees:s.rotation_degrees,field_of_view_degrees:s.field_of_view_degrees,label:s.label,coverage_radius:s.coverage_radius??null,coverage_polygon:s.coverage_polygon??null,label_pos:s.label_pos??"auto"});this.anchors=this.anchors.map(a=>a.id===t?{...a,revision:i.revision}:a)}catch(i){if(i instanceof fe&&i.code==="stale_revision")e=!0;else throw i}}return e?(this.error="חלק מהפריטים השתנו בינתיים על ידי עורך אחר; המפה נטענה מחדש בלי לדרוס את השינוי שלו.",await this.load(),!1):(this.dirty=new Set,this.info="המיקומים נשמרו",setTimeout(()=>this.info="",2500),!0)}catch(t){return this.error=w(t),!1}finally{this.busy=!1}}async place(e,t){const s=this.placing;if(!(!s||!this.bundle)){if(this.bundle.source==="demo"){this.info="נתוני הדגמה: הוספה עובדת מול השרת.",this.placing=null;return}if(!(this.dirty.size&&!await this.save())){this.busy=!0,this.error="";try{const i=s.kind==="camera"?await ir(this.bundle.floorId,{resource_type:"camera",resource_id:s.camera.id,x:e,y:t,rotation_degrees:0,field_of_view_degrees:90}):await ir(this.bundle.floorId,{resource_type:"ha_entity",resource_id:s.entity.entity_id,x:e,y:t,rotation_degrees:0,field_of_view_degrees:null});this.placing=null,await this.load(),this.selectedId=i.id,this.tool="select",this.info=`${this.anchorName(i)} הוצב · גרור לדיוק, קבע כיוון בידיות`,setTimeout(()=>this.info="",4e3)}catch(i){this.error=w(i)}finally{this.busy=!1}}}}async removeSelected(){const e=this.selected;if(!(!e||!this.bundle)){if(this.bundle.source==="demo"){this.info="נתוני הדגמה: הסרה עובדת מול השרת.";return}if(window.confirm(`להסיר את "${this.anchorName(e)}" מהמפה? המקור עצמו לא נמחק.`)){this.busy=!0,this.error="";try{await Hl(e.id),this.selectedId=null,await this.load()}catch(t){this.error=w(t)}finally{this.busy=!1}}}}async loadVersions(){const e=this.bundle;if(!e||e.source==="demo"||!e.permissions.edit){this.versions=[];return}try{this.versions=(await Rl(e.floorId)).versions}catch{this.versions=[]}}async publish(){const e=this.bundle;if(!e?.planVersionId||this.dirty.size&&!await this.save())return;if(!await this.studio.flush()){this.error=this.studio.error;return}if(this.error="",e.planStatus==="published"){await this.openGeomDiff(e.planVersionId);return}let t=this.versions.find(s=>s.id===e.planVersionId);if(t||(await this.loadVersions(),t=this.versions.find(s=>s.id===e.planVersionId)),!t){this.error="לא נמצאה טיוטה לפרסום — טען מחדש";return}await this.openDiff("publish",t)}async openGeomDiff(e){this.geomDiff={versionId:e,data:null,error:""};try{const t=await Ed(e);this.geomDiff?.versionId===e&&(this.geomDiff={versionId:e,data:t,error:""})}catch(t){this.geomDiff?.versionId===e&&(this.geomDiff={versionId:e,data:null,error:w(t)})}}async confirmGeomPublish(){const e=this.bundle,t=this.geomDiff;if(!(!e||!t?.data)){this.busy=!0;try{const s=await Md(t.versionId);this.geomDiff=null,this.info=s.unchanged?"אין שינוי לפרסום":"המבנה פורסם; הצופים רואים אותו עכשיו",setTimeout(()=>this.info="",4e3),await this.loadStudio(e,!0)}catch(s){this.geomDiff={...t,error:w(s)}}finally{this.busy=!1}}}async openDiff(e,t){this.diff={mode:e,version:t,data:null,error:""};try{const s=await Bl(t.id);this.diff?.version.id===t.id&&(this.diff={mode:e,version:t,data:s,error:""})}catch(s){this.diff?.version.id===t.id&&(this.diff={mode:e,version:t,data:null,error:w(s)})}}async confirmDiff(){const e=this.diff;if(!e?.data||e.mode==="compare")return;const t=e.version.id===this.bundle?.planVersionId;this.busy=!0,this.error="";try{if(t&&!await this.studio.flush()){this.diff={...e,error:this.studio.error};return}e.mode==="publish"?(await fn(e.version.id),this.info="הגרסה פורסמה; הצופים רואים אותה עכשיו"):(await Ll(e.version.id,e.version.revision,e.data.from?.id??null),this.info="הגרסה שוחזרה ופורסמה מחדש; העוגנים נשמרו"),this.diff=null,await this.load(),this.bundle&&await this.loadStudio(this.bundle,!0),setTimeout(()=>this.info="",4e3)}catch(s){this.diff={...e,error:w(s)},s instanceof fe&&s.status===409&&this.loadVersions(),t&&s instanceof fe&&s.code==="geometry_invalid"&&(this.pickTool("structure"),this.studioMode="select")}finally{this.busy=!1}}async searchEntities(){if(this.bundle?.source!=="demo"){this.entBusy=!0;try{const e=this.tool==="lights",t=await _n({q:this.entQ||void 0,domain:e&&!this.lightsAll?"switch":void 0,limit:e?200:40});this.entResults=e?t.entities.filter(s=>s.domain==="switch"||this.lightsAll&&s.domain==="light").slice(0,60):t.entities}catch(e){this.error=w(e),this.entResults=[]}finally{this.entBusy=!1}}}onEntQuery(e){this.entQ=e,window.clearTimeout(this.entTimer),this.entTimer=window.setTimeout(()=>void this.searchEntities(),250)}async stylize(e,t){if(!this.bundle?.planVersionId||this.bundle.source==="demo")return;const s=this.stylizeOpts;(e!==void 0||t!==void 0)&&(this.stylizeOpts={...s,strength:e??s.strength,keepLines:t??s.keepLines}),this.stylizing=!0,this.error="";try{this.stylized=await Yd(this.bundle.planVersionId,{strength:this.stylizeOpts.strength,keep_lines:this.stylizeOpts.keepLines,room_fill:this.stylizeOpts.roomFill})}catch(i){this.error=w(i)}finally{this.stylizing=!1}}async useRender(e){if(this.bundle?.planVersionId){this.busy=!0,this.error="";try{await Jd(this.bundle.planVersionId,e),this.stylized=null,await this.load(),this.info=e==="stylized"?"המפה מציגה עכשיו את שפת SMPLWISE":"המפה מציגה את תוכנית המקור",setTimeout(()=>this.info="",3e3)}catch(t){this.error=w(t)}finally{this.busy=!1}}}pickTool(e){this.tool=e,this.placing=null,this.wallDraft=null,this.hover=null,e!=="structure"&&(this.geomSel=null),e!=="measure"&&(this.measurePts=[]),e!=="calibrate"&&(this.calib={...Pt}),(e==="entity"||e==="lights")&&(this.entResults=null,this.searchEntities())}async loadStudio(e,t=!1){if(e.source!=="api"||!e.planVersionId||!e.permissions.structure||!t&&this.studioVersion===e.planVersionId)return!1;this.studioVersion=e.planVersionId;try{return!await this.studio.flush()&&!(t&&this.studio.hasConflict)?(this.studioVersion=null,this.error=this.studio.error,!1):(await this.studio.load(e.planVersionId),this.geomSel=null,this.wallDraft=null,this.calib={...Pt},this.measurePts=[],!0)}catch(s){return this.studioVersion=null,this.error=w(s),!1}}get studioOn(){return gr.includes(this.tool)&&!!this.studio.doc}get studioPlacing(){return this.studioOn&&(this.tool!=="structure"||this.studioMode!=="select")}get issueIds(){return this.studio.issues.filter(e=>e.severity==="error"&&e.id).map(e=>e.id)}edit(e){const t=this.studio.doc;if(!t)return;const s=e(t);s===t||JSON.stringify(s)===JSON.stringify(t)||this.studio.commit(s)}snap(e,t,s){const i=this.bundle,a=this.studio.doc;return!i||!a?e:Xa(e,t,a.walls,i.width,i.height,{tolPx:10/(this.canvas?.zoom??1),free:s})}snapDraw(e,t,s){const i=this.bundle,a=t.length>=3?t[0]:null;return i&&a&&Math.hypot((e[0]-a[0])*i.width,(e[1]-a[1])*i.height)*(this.canvas?.zoom??1)<=10?a:this.snap(e,t.at(-1)??null,s)}onPlanHover(e,t,s){const i=this.bundle,a=this.studio.doc;if(!i||!a||!this.studioPlacing){this.hover=null;return}const n=[e,t];if(this.tool==="calibrate")this.hover=this.snap(n,null,!0);else if(this.tool==="measure")this.hover=this.snap(n,this.measurePts.at(-1)??null,s);else if(this.studioMode==="wall")this.hover=this.snapDraw(n,this.wallDraft??[],s);else if(this.studioMode==="label")this.hover=n;else{const o=Ii(n,a.walls,i.width,i.height,14/(this.canvas?.zoom??1));this.hover=o?Ci(o.wall,o.t,i.width,i.height):null}}studioClick(e,t,s){const i=this.bundle,a=this.studio.doc;if(!i||!a)return;const n=[e,t];if(this.tool==="calibrate"){const m=this.snap(n,null,!0),g=this.calib;this.calib=!g.a||g.b?{...Pt,a:m}:{...g,b:m};return}if(this.tool==="measure"){this.measurePts=[...this.measurePts,this.snap(n,this.measurePts.at(-1)??null,s)];return}const o=this.studioMode,l=this.canvas?.zoom??1;if(o==="wall"){const m=this.wallDraft??[],g=this.snapDraw(n,m,s),v=b=>!!b&&Math.hypot((b[0]-n[0])*i.width,(b[1]-n[1])*i.height)*l<8;if(m.length&&(v(m[m.length-1])||v(this.lastDrawClick))){this.finishWall();return}if(m.length>=3&&g===m[0]){this.wallDraft=[...m,m[0]],this.finishWall();return}this.wallDraft=[...m,g],this.lastDrawClick=n;return}if(o==="label"){const m=ac(a,n,"תווית");this.studio.commit(m.doc),this.geomSel={id:m.id,kind:"label"};return}if(o==="select")return;const p=Ii(n,a.walls,i.width,i.height,14/l);if(!p){this.info="לחץ על קיר כדי להציב פתח",setTimeout(()=>this.info="",2500);return}const h=sc(a,p.wall.id,p.t,o);this.studio.commit(h.doc),this.geomSel={id:h.id,kind:"opening"}}finishWall(){const e=this.wallDraft;this.wallDraft=null,this.hover=null;const t=this.studio.doc;if(!t||!e||e.length<2)return;const s=tc(t,e,this.wallDefaults);this.studio.commit(s.doc),this.geomSel={id:s.id,kind:"wall"}}onGeomSelect(e,t){this.geomSel={id:e,kind:t},this.selectedId=null,this.selectedZoneId=null}onGeomDrag(e){const t=this.bundle,s=this.studio.doc;if(!t||!s)return;const i=[e.x,e.y];if(e.kind==="vertex"){const a=s.walls.find(S=>S.id===e.id);if(!a)return;const n=a.polyline,o=n.length-1,l=nn(n),p=l&&e.index===o?0:e.index,h=l?o:n.length,m=l?[(p+h-1)%h,p,(p+1)%h]:[p-1,p,p+1],g={...a,polyline:n.slice(0,h).filter((S,N)=>!m.includes(N))},v=[...s.walls.filter(S=>S.id!==e.id),g],b=Xa(i,p>0?n[p-1]:null,v,t.width,t.height,{tolPx:10/(this.canvas?.zoom??1),free:!0});this.edit(S=>l&&p===0?Ni(Ni(S,e.id,0,b),e.id,o,b):Ni(S,e.id,p,b)),this.geomSel={id:e.id,kind:"wall"}}else if(e.kind==="opening"){const a=s.openings.find(o=>o.id===e.id),n=a?Ii(i,s.walls,t.width,t.height,Number.POSITIVE_INFINITY,a.wall_id):null;n&&this.edit(o=>pr(o,e.id,{t:n.t})),this.geomSel={id:e.id,kind:"opening"}}else this.edit(a=>ur(a,e.id,{position:i})),this.geomSel={id:e.id,kind:"label"}}handleStudioKey(e){const t=e.ctrlKey||e.metaKey,s=e.key.toLowerCase();if(e.key==="Enter"&&this.wallDraft)return e.preventDefault(),this.finishWall(),!0;if((e.key==="Backspace"||e.key==="Delete")&&this.wallDraft)return e.preventDefault(),this.wallDraft=this.wallDraft.length>1?this.wallDraft.slice(0,-1):null,this.lastDrawClick=null,!0;if((e.key==="Delete"||e.key==="Backspace")&&this.geomSel){e.preventDefault();const i=this.geomSel.id;return this.edit(a=>hr(a,i)),this.geomSel=null,!0}return t&&(s==="z"||s==="y")?(e.preventDefault(),s==="y"||e.shiftKey?this.studio.redo():this.studio.undo(),this.geomSel=null,!0):t&&s==="s"?(e.preventDefault(),this.studio.flush(),!0):!1}focusGeom(e){const t=this.bundle,s=this.studio.doc;if(!t||!s)return;const i=s.walls.find(p=>p.id===e),a=s.openings.find(p=>p.id===e),n=s.labels.find(p=>p.id===e),o=a?s.walls.find(p=>p.id===a.wall_id):void 0,l=i?Ci(i,.5,t.width,t.height):a&&o?Ci(o,a.t,t.width,t.height):n?n.position:null;this.tool="structure",this.studioMode="select",this.wallDraft=null,this.geomSel=i?{id:e,kind:"wall"}:a?{id:e,kind:"opening"}:n?{id:e,kind:"label"}:null,l&&this.canvas?.centerOn(Math.min(1,Math.max(0,l[0])),Math.min(1,Math.max(0,l[1])))}async copyStructure(e){const t=this.bundle;if(t?.planVersionId){this.busy=!0,this.error="";try{if(!await this.studio.flush()){this.error=this.studio.error;return}await Ad(t.planVersionId,e),await this.loadStudio(t,!0)&&(this.info="המבנה הועתק לטיוטה; בדוק מיקומים ופרסם",setTimeout(()=>this.info="",4e3))}catch(s){this.error=w(s)}finally{this.busy=!1}}}exportJson(){const e=this.studio.doc;if(!e)return;const t=URL.createObjectURL(new Blob([JSON.stringify(e,null,2)],{type:"application/json"})),s=document.createElement("a");s.href=t,s.download=`plan-structure-${e.plan_version_id}.json`,s.click(),setTimeout(()=>URL.revokeObjectURL(t),1e3)}renderStructurePanel(e){const t=this.studio.doc,s=e.planVersionId;return!t||!s?r`<sw-card heading="מבנה"><div class="note">${e.source==="demo"?"נתוני הדגמה: ציור המבנה עובד מול השרת.":this.error||"טוען את טיוטת המבנה…"}</div></sw-card>`:lc({doc:t,W:e.width,H:e.height,mode:this.studioMode,wallDefaults:this.wallDefaults,sel:this.geomSel,saveState:this.studio.saveState,saveError:this.studio.error,conflict:this.studio.hasConflict,issues:this.studio.issues,copyCandidates:this.studio.copyCandidates,exportSvg:nr(s,"svg",{draft:!0}),exportPng:nr(s,"png",{draft:!0}),busy:this.busy,showEstimates:this.showEstimates},{setMode:i=>{this.studioMode=i,this.wallDraft=null,this.hover=null},setWallDefaults:i=>{this.wallDefaults=i},patchWall:(i,a)=>this.edit(n=>ic(n,i,a)),patchOpening:(i,a)=>this.edit(n=>pr(n,i,a)),patchLabel:(i,a)=>this.edit(n=>ur(n,i,a)),remove:i=>{this.edit(a=>hr(a,i)),this.geomSel=null},focus:i=>this.focusGeom(i),copyFrom:i=>void this.copyStructure(i),exportJson:()=>this.exportJson(),reload:()=>void this.loadStudio(e,!0),calibrate:()=>this.pickTool("calibrate"),retry:async()=>{await this.studio.flush()&&this.loadStudio(e)}})}get rulers(){const e=this.bundle,t=this.studio.doc;if(!e||!t)return[];const{scale:s,estimated:i}=bs(t),a=(n,o)=>ci($l(n,o,e.width,e.height,s),i,this.showEstimates);if(this.tool==="calibrate"){const{a:n,b:o,metres:l}=this.calib,p=o??this.hover;return!n||!p?[]:[{a:n,b:p,label:o?parseFloat(l)>0?`${l} מ׳`:"? מ׳":"",tone:o?"accent":"muted"}]}if(this.tool==="measure"){const n=this.measurePts,o=this.hover&&n.length?[...n,this.hover]:n,l=[];for(let p=1;p<o.length;p++)l.push({a:o[p-1],b:o[p],label:a(o[p-1],o[p]),tone:p>n.length-1?"muted":"accent"});return n.length>=3&&l.push({a:n[n.length-1],b:n[0],label:"",tone:"muted"}),l}return[]}async saveCalibration(){const e=this.bundle,{a:t,b:s,metres:i}=this.calib,a=parseFloat(i);if(!(!e?.planVersionId||!t||!s||!(a>0))){this.busy=!0,this.error="";try{if(!await this.studio.flush()){this.error=this.studio.error;return}const n=await Pd(e.planVersionId,[{a:t,b:s,metres:a}]);await this.loadStudio(e,!0),this.calib={...Pt,result:`קנה המידה נשמר: ${Pa(n.scale_m_per_px)}`,warning:n.warning??""}}catch(n){this.error=w(n)}finally{this.busy=!1}}}renderCalibrate(e){const t=this.studio.doc;if(!t)return r`<sw-card heading="כיול קנה מידה"><div class="note">${e.source==="demo"?"נתוני הדגמה: הכיול עובד מול השרת.":"טוען…"}</div></sw-card>`;const{scale:s,estimated:i}=bs(t),a=this.calib,n=a.a&&a.b?Math.hypot((a.b[0]-a.a[0])*e.width,(a.b[1]-a.a[1])*e.height):null;return gc({a:a.a,b:a.b,metres:a.metres,pixels:n,scale:s,estimated:i,showEstimates:this.showEstimates,result:a.result,warning:a.warning,busy:this.busy},o=>{this.calib={...this.calib,metres:o}},()=>void this.saveCalibration(),()=>{this.calib={...Pt}})}renderMeasure(e){const t=this.studio.doc;if(!t)return r`<sw-card heading="מדידה"><div class="note">${e.source==="demo"?"נתוני הדגמה: המדידה עובדת מול השרת.":"טוען…"}</div></sw-card>`;const{scale:s,estimated:i}=bs(t);return wc(this.measurePts,e.width,e.height,s,i,this.showEstimates,()=>{this.measurePts=[]})}renderCoverage(e){const t=e.coverage_polygon,s=e.coverage_radius??0,i=Math.round((s||.1)*100),a=()=>{const n=e.field_of_view_degrees??90,o=s||.1,l=this.bundle&&this.bundle.height?this.bundle.width/this.bundle.height:1,p=[[e.position.x,e.position.y]],h=Math.max(3,Math.round(n/15));for(let m=0;m<=h;m++){const g=(e.rotation_degrees-n/2+n*m/h-90)*Math.PI/180;p.push([+Math.max(0,Math.min(1,e.position.x+Math.cos(g)*o)).toFixed(4),+Math.max(0,Math.min(1,e.position.y+Math.sin(g)*o*l)).toFixed(4)])}this.apply(e.id,{coverage_polygon:p})};return r`<div class="row" data-coverage style="flex-direction:column;align-items:stretch;gap:6px">
      ...
      ${t?r`<div class="kv"><span class="k">מצב עכשיו</span><span>${_t(t)}</span></div><div class="kv"><span class="k">סוג</span><span>${Rs(t.domain)}</span></div>`:d}
      <sw-field label="שכבה" style="margin-block-start:8px"><select @change=${s=>this.apply(e.id,{layer_id:s.target.value})}>${wr.filter(s=>s.id!=="cameras").map(s=>r`<option value=${s.id} ?selected=${e.layer_id===s.id}>${s.label}</option>`)}</select></sw-field>
      <div class="two">
      ...
      ${t?r`<div class="note">${t.length} חדרים זוהו · סמן, תן שם ושמור. הפוליגונים מוצגים במפה בקו מקווקו.</div>
            <div class="candlist">${t.map((i,a)=>r`<div class="cand" data-candidate><input type="checkbox" .checked=${i.include} aria-label="כלול" @change=${n=>this.setCandidate(a,{include:n.target.checked})} /><i class="sw" style="background:${Ys[a%Ys.length]}"></i><input class="name" .value=${i.name} placeholder="שם החדר" aria-label="שם החדר" @input=${n=>this.setCandidate(a,{name:n.target.value})} /><select aria-label="סוג" @change=${n=>this.setCandidate(a,{kind:n.target.value})}>${ra.map(n=>r`<option value=${n.id} ?selected=${i.kind===n.id}>${n.label}</option>`)}</select></div>`)}</div>
      ...
      ${e.planStatus==="none"?d:r`<div class="row"><span class="lbl">תצוגת המפה<span class="muted">${e.renderMode==="stylized"?"שפת SMPLWISE (עיבוד אוטומטי של המקור)":"תוכנית המקור כפי שהועלתה"}</span></span>${e.renderMode==="stylized"?r`<sw-button size="sm" ?disabled=${this.busy} @click=${()=>this.useRender("source")}>הצג מקור</sw-button>`:e.stylizedAvailable?r`<sw-button size="sm" ?disabled=${this.busy} @click=${()=>this.useRender("stylized")}>הצג שפת SMPLWISE</sw-button>`:d}</div>
          ...
          <div class="two" data-stylize-opts>
            ...
            <sw-field label="מילוי חדרים"><select aria-label="מילוי חדרים" @change=${s=>this.stylizeOpts={...this.stylizeOpts,roomFill:s.target.value}}>${Object.keys(Ri).map(s=>r`<option value=${s} ?selected=${this.stylizeOpts.roomFill===s}>${Ri[s]}</option>`)}</select></sw-field>
          </div>
      ...
      ${t?r`<div class="compare">
              <div><div class="note">${t.from?`מפורסמת · ${Vi(t.from.published_at??t.from.created_at)}`:"אין גרסה מפורסמת"}</div>${t.from?r`<img src=${Qe(t.from.image_url)} alt="הגרסה המפורסמת" />`:r`<div class="note">—</div>`}</div>
              <div><div class="note">${e.mode==="rollback"?"לשחזור":"חדשה"} · ${Vi(t.to.published_at??t.to.created_at)}</div><img src=${Qe(t.to.image_url)} alt="הגרסה החדשה" /></div>
            </div>
            ...
            ${i?r`<div class="note" data-diff-structure>המבנה של הטיוטה (${Li(i.walls.length,i.openings.length)}) יפורסם יחד עם הגרסה${a?"; יש בו שגיאות שחוסמות את הפרסום עד לתיקון: ראה את הסימון האדום על המפה ואת רשימת הבעיות של המבנה":""}.</div>`:d}
      ...
      ${t?r`<div class="ditems" data-geom-diff-rows>
            ...
            <div class="note">${t.published_counts?`כעת: ${Li(t.published_counts.walls,t.published_counts.openings)}`:"פרסום ראשון של מבנה"} · אחרי הפרסום: ${Li(t.counts.walls,t.counts.openings)}</div>
            ${s.length?r`<div class="err" data-geom-diff-error>${lt(s.length,"שגיאה חוסמת אחת","שגיאות חוסמות")} בטיוטה: הפרסום חסום עד לתיקון. ראה את הסימון האדום על המפה ואת רשימת הבעיות של המבנה.</div>`:d}`:e.error?d:r`<div class="note">טוען השוואה…</div>`}
        ...
        ${e.planStatus==="none"?r`<sw-state-panel state="empty" heading="לקומה אין תוכנית" hint="העלה תוכנית קודם; אחר כך אפשר להציב מצלמות וישויות."><div style="margin-block-start:10px"><sw-button variant="primary" icon="upload" @click=${()=>$(`/explore/floors/${e.floorId}/import`)}>העלאת תוכנית</sw-button></div></sw-state-panel>`:r`<div class="layout">
              <div class="mapwrap">
                ...
                <div class="rail" role="toolbar" aria-label="כלי עריכה">
                  ${$c.map(n=>r`<button class=${n.id===this.tool?"on":""} data-tool=${n.id} ?disabled=${!n.ready||gr.includes(n.id)&&!e.permissions.structure} title=${n.label} aria-label=${n.label} aria-pressed=${n.id===this.tool} @click=${()=>this.pickTool(n.id)}><sw-icon .name=${n.icon} size=${18}></sw-icon></button>`)}
                  <hr />
  ...
  `,vc];R([f()],T.prototype,"floorId",2);R([f()],T.prototype,"presetEntity",2);R([c()],T.prototype,"bundle",2);R([c()],T.prototype,"anchors",2);R([c()],T.prototype,"dirty",2);R([c()],T.prototype,"undo",2);R([c()],T.prototype,"redo",2);R([c()],T.prototype,"selectedId",2);R([c()],T.prototype,"tool",2);R([c()],T.prototype,"layers",2);R([c()],T.prototype,"placing",2);R([c()],T.prototype,"entQ",2);R([c()],T.prototype,"entResults",2);R([c()],T.prototype,"entBusy",2);R([c()],T.prototype,"lightsAll",2);R([c()],T.prototype,"busy",2);R([c()],T.prototype,"error",2);R([c()],T.prototype,"info",2);R([c()],T.prototype,"stylizing",2);R([c()],T.prototype,"stylized",2);R([c()],T.prototype,"stylizeOpts",2);R([c()],T.prototype,"zones",2);R([c()],T.prototype,"versions",2);R([c()],T.prototype,"diff",2);R([c()],T.prototype,"selectedZoneId",2);R([c()],T.prototype,"candidates",2);R([c()],T.prototype,"detecting",2);R([c()],T.prototype,"detectStrength",2);R([c()],T.prototype,"replaceAuto",2);R([c()],T.prototype,"drawing",2);R([c()],T.prototype,"showZones",2);R([c()],T.prototype,"zoneBusy",2);R([os("sw-plan-canvas")],T.prototype,"canvas",2);R([c()],T.prototype,"studioMode",2);R([c()],T.prototype,"wallDefaults",2);R([c()],T.prototype,"geomSel",2);R([c()],T.prototype,"wallDraft",2);R([c()],T.prototype,"hover",2);R([c()],T.prototype,"calib",2);R([c()],T.prototype,"measurePts",2);R([c()],T.prototype,"geomDiff",2);R([c()],T.prototype,"showEstimates",2);T=R([E("explore-plan-editor")],T);var kc=Object.defineProperty,_c=Object.getOwnPropertyDescriptor,Zt=(e,t,s,i)=>{for(var a=i>1?void 0:i?_c(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&kc(t,s,a),a};let ct=class extends z{constructor(){super(...arguments),this.columns=[],this.rows=[],this.rowKey="id",this.selected=null,this.emptyText="אין שורות להצגה",this.dense=!1}pick(e){const t=String(e[this.rowKey]??"");this.dispatchEvent(new CustomEvent("row-select",{detail:{id:t,row:e},bubbles:!0,composed:!0}))}render(){return this.rows.length?r`
    ...
    `:r`<div class="empty">${this.emptyText}</div>`}};ct.styles=M`
    :host {
      display: block;
      background: var(--sw-surface);
      border: 1px solid var(--sw-border);
  ...
  `;Zt([f({attribute:!1})],ct.prototype,"columns",2);Zt([f({attribute:!1})],ct.prototype,"rows",2);Zt([f()],ct.prototype,"rowKey",2);Zt([f()],ct.prototype,"selected",2);Zt([f()],ct.prototype,"emptyText",2);Zt([f({type:Boolean,reflect:!0})],ct.prototype,"dense",2);ct=Zt([E("sw-table")],ct);var zc=Object.defineProperty,Sc=Object.getOwnPropertyDescriptor,Ke=(e,t,s,i)=>{for(var a=i>1?void 0:i?Sc(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&zc(t,s,a),a};const Js=[{id:"lock.main_door",name:"דלת כניסה",domain:"lock",area:"לובי",state:"נעול",fresh:"live",placed:!0,actions:"נעילה / פתיחה (grant נפרד)"},{id:"light.lobby",name:"תאורת לובי",domain:"light",area:"לובי",state:"דולק · 80%",fresh:"live",placed:!0,actions:"הדלקה / כיבוי / עמעום"},{id:"binary_sensor.hall_motion",name:"תנועה באולם",domain:"binary_sensor",area:"אולם",state:"ללא תנועה",fresh:"live",placed:!0,actions:"קריאה בלבד"},{id:"climate.hall",name:"מזגן אולם",domain:"climate",area:"אולם",state:"קירור · 23°",fresh:"stale",placed:!1,actions:"יעד טמפרטורה (allowlist)"},{id:"cover.parking_gate",name:"שער חניה",domain:"cover",area:"חניה",state:"סגור",fresh:"live",placed:!1,actions:"פתיחה / סגירה (רגיש)"},{id:"script.night_mode",name:"מצב לילה",domain:"script",area:"—",state:"—",fresh:"unknown",placed:!1,actions:"חסום עד allowlist"},{id:"sensor.power_main",name:"צריכת חשמל",domain:"sensor",area:"חדר מכונות",state:"4.2 kW",fresh:"live",placed:!1,actions:"קריאה בלבד"},{id:"camera.intercom_m2",name:"אינטרקום M2",domain:"camera",area:"כניסה",state:"זמין",fresh:"live",placed:!1,actions:"צפייה (provider נפרד)"}];function Mc(e){return e==="lock"||e==="cover"?"lock":e==="light"||e==="switch"||e==="fan"?"light":e==="camera"?"camera":e==="climate"||e==="script"||e==="scene"||e==="button"||e==="automation"?"activity":"sensor"}let Ae=class extends z{constructor(){super(...arguments),this.selected=null,this.domain="all",this.q="",this.area="",this.onlyPlaced=!1,this.cat=null,this.error="",this.loading=!1,this.sync=null,this.firstFloorId=null,this.stopWs=null,this.searchTimer=0,this.columns=[{key:"name",label:"ישות",render:e=>r`<span style="display:inline-flex;align-items:center;gap:8px"><span style="display:grid;place-items:center;inline-size:26px;block-size:26px;border-radius:7px;background:var(--sw-accent-soft);color:var(--sw-accent)"><sw-icon name=${Mc(String(e.domain))} size=${13}></sw-icon></span><span><strong>${String(e.name)}</strong><div class="ltr" style="font-size:var(--sw-fs-xs);color:var(--sw-text-3)">${String(e.id)}</div></span></span>`},{key:"domain",label:"Domain",ltr:!0},{key:"area",label:"אזור HA"},{key:"state",label:"מצב"},{key:"fresh",label:"רעננות",render:e=>r`<sw-badge kind=${e.fresh} label=${e.fresh==="live"||e.fresh==="neutral"?"עדכני":e.fresh==="stale"?"מיושן":e.fresh==="offline"?"לא זמין":"לא ידוע"}></sw-badge>`},{key:"placed",label:"במפה",render:e=>e.placed?r`<sw-badge kind="recorded" label="מוצב"></sw-badge>`:r`<span style="color:var(--sw-text-3)">לא</span>`}]}connectedCallback(){super.connectedCallback(),y()&&(this.load(),Mt().then(e=>this.firstFloorId=yn(e)?.id??null).catch(()=>{}),this.stopWs=zn(e=>{if(e.type==="entity_state_changed"&&this.cat){const t=this.cat.entities.findIndex(s=>s.entity_id===e.entity.entity_id);if(t>=0){const s=[...this.cat.entities];s[t]={...s[t],...e.entity,placements:s[t].placements,actions:s[t].actions},this.cat={...this.cat,entities:s}}}else e.type==="heartbeat"?this.sync=e.sync:e.type==="ha_sync_state"&&this.sync&&(this.sync={...this.sync,connected:e.connected})}))}disconnectedCallback(){super.disconnectedCallback(),this.stopWs?.(),this.stopWs=null}async load(){this.loading=!0,this.error="";try{this.cat=await _n({domain:this.domain==="all"?void 0:this.domain,q:this.q||void 0,area:this.area||void 0,placed:this.onlyPlaced?!0:void 0,limit:800}),this.sync=this.cat.sync}catch(e){this.error=w(e)}finally{this.loading=!1}}onSearch(e){this.q=e,window.clearTimeout(this.searchTimer),this.searchTimer=window.setTimeout(()=>void this.load(),250)}toRow(e){return{id:e.entity_id,name:e.name||e.original_name||e.entity_id,domain:e.domain,area:e.area_name??"—",state:_t(e),fresh:na(e),placed:!!e.placements?.length,actions:e.actions?.length?e.actions.map(t=>`${t.label}${t.sensitive?" (רגיש)":""}`).join(" / "):"קריאה בלבד"}}renderApiDrawer(e){const t=na(e),s=Object.entries(e.attributes).filter(([i])=>i!=="friendly_name"&&i!=="icon").slice(0,14);return r`<sw-drawer open heading=${e.name||e.original_name||e.entity_id} subheading=${e.entity_id} @close=${()=>this.selected=null}>
    ...
    `}render(){if(y())return this.renderApi();const e=["all",...new Set(Js.map(i=>i.domain))],t=Js.filter(i=>this.domain==="all"||i.domain===this.domain),s=Js.find(i=>i.id===this.selected);return r`
      <sw-page heading="קטלוג ישויות Home Assistant" subheading="${Js.length} ישויות מורשות לחיבור · הצבה על המפה ושליטה הן הרשאות נפרדות · נתוני הדגמה">
  ...
  `;Ke([c()],Ae.prototype,"selected",2);Ke([c()],Ae.prototype,"domain",2);Ke([c()],Ae.prototype,"q",2);Ke([c()],Ae.prototype,"area",2);Ke([c()],Ae.prototype,"onlyPlaced",2);Ke([c()],Ae.prototype,"cat",2);Ke([c()],Ae.prototype,"error",2);Ke([c()],Ae.prototype,"loading",2);Ke([c()],Ae.prototype,"sync",2);Ke([c()],Ae.prototype,"firstFloorId",2);Ae=Ke([E("explore-entities")],Ae);var Ec=Object.defineProperty,Ac=Object.getOwnPropertyDescriptor,En=(e,t,s,i)=>{for(var a=i>1?void 0:i?Ac(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&Ec(t,s,a),a};const Hi=[{id:"d1",name:"כניסה ראשית",kind:"דלת זכוכית",lock:"נעול",contact:"סגור",relay:"לא פעיל",ringing:!1,scene:"entrance"},{id:"d2",name:"לובי",kind:"דלת פנימית",lock:"פתוח",contact:"פתוח",relay:"לא פעיל",ringing:!1,scene:"lobby"},{id:"d3",name:"אינטרקום M2",kind:"עמדת דלת",lock:"נעול",contact:"סגור",relay:"לא פעיל",ringing:!0,scene:"entrance"},{id:"d4",name:"מחסן",kind:"דלת שירות",lock:"נעול",contact:"סגור",relay:"לא פעיל",ringing:!1,scene:"warehouse"}];let pi=class extends z{constructor(){super(...arguments),this.selected="d1"}render(){if(y())return r`<sw-page heading="דלתות ואינטרקום" subheading="V1 · מצלמה, צלצול, מגע דלת וממסר הם ארבעה נתונים שונים">
      ...
      </sw-page>`;const e=Hi.find(t=>t.id===this.selected)??Hi[0];return r`
      <sw-page heading="דלתות ואינטרקום" subheading="V1 · מצלמה, צלצול, מגע דלת וממסר הם ארבעה נתונים שונים · נתוני הדגמה">
        ...
        <div class="layout">
          <div class="list">
            ${Hi.map(t=>r`<button class="door ${t.id===this.selected?"on":""}" @click=${()=>this.selected=t.id} aria-pressed=${t.id===this.selected}>
  ...
  `;En([c()],pi.prototype,"selected",2);pi=En([E("explore-access")],pi);var Pc=Object.defineProperty,Ic=Object.getOwnPropertyDescriptor,qt=(e,t,s,i)=>{for(var a=i>1?void 0:i?Ic(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&Pc(t,s,a),a};let pt=class extends z{constructor(){super(...arguments),this.label="",this.value="",this.detail="",this.icon="info",this.tone="neutral",this.badge=""}render(){return r`
  ...
  `;qt([f()],pt.prototype,"label",2);qt([f()],pt.prototype,"value",2);qt([f()],pt.prototype,"detail",2);qt([f()],pt.prototype,"icon",2);qt([f({reflect:!0})],pt.prototype,"tone",2);qt([f()],pt.prototype,"badge",2);pt=qt([E("sw-kpi")],pt);function Si(e={}){const t=new URLSearchParams;e.date&&t.set("date",e.date),e.from&&e.to&&(t.set("from",e.from),t.set("to",e.to)),e.acked&&t.set("acked","true"),e.cameraId&&t.set("camera_id",e.cameraId),e.type&&t.set("type",e.type),e.unacked&&t.set("unacked","true"),e.limit&&t.set("limit",String(e.limit)),e.floorId&&t.set("floor_id",e.floorId),e.zoneId&&t.set("zone_id",e.zoneId),e.buildingId&&t.set("building_id",e.buildingId),e.siteId&&t.set("site_id",e.siteId),e.source&&t.set("source",e.source),e.severity&&t.set("severity",e.severity),e.query&&t.set("q",e.query);const s=t.toString();return k(`events${s?`?${s}`:""}`)}const Cc=()=>k("events/summary"),Dc=(e,t)=>k(`cameras/${e}/events?date=${t}`),An=e=>A(`events/${e}/ack`),vr=e=>A("events/ack-many",{event_ids:e}),br={camera:"לפי מצלמה",all:"כל המצלמות יחד",zone:"לפי חדר",floor:"לפי קומה"};function Tc(e={}){const t=new URLSearchParams;e.date&&t.set("date",e.date),e.cameraId&&t.set("camera_id",e.cameraId),e.gap&&t.set("gap",String(e.gap)),e.by&&t.set("by",e.by),e.limit&&t.set("limit",String(e.limit));const s=t.toString();return k(`events/windows${s?`?${s}`:""}`)}const Oc=e=>k(`events/${e}`),Ot=(e,t=0)=>ge(`events/${e}/thumbnail${t?`?v=${t}`:""}`);async function Pn(e){try{const t=await fetch(Ot(e),{credentials:"include",cache:"no-store"});return t.status===200?"ready":t.status===202?"pending":"unavailable"}catch{return"pending"}}const ee={motion:"תנועה",person:"אדם",vehicle:"רכב",line:"חציית קו",field:"חדירה לאזור",offline:"אובדן וידאו",tamper:"חבלה במצלמה",door:"דלת",io:"כניסת חיווי",storage:"אחסון",system:"מערכת",coverage_gap:"פער בקליטת אירועים",manual:"הקלטה ידנית",other:"אחר"},si={motion:"#ef4444",person:"#2f6bff",vehicle:"#22c55e",line:"#f59e0b",field:"#f59e0b",offline:"#6b7280",tamper:"#b45309",door:"#8b5cf6",io:"#8b5cf6",storage:"#6b7280",system:"#6b7280",coverage_gap:"#6b7280",manual:"#2f6bff",other:"#6b7280"};function Rc(e){return e==="person"||e==="vehicle"||e==="motion"||e==="line"||e==="offline"||e==="door"?e:e==="field"?"line":e==="io"?"door":e==="tamper"||e==="coverage_gap"||e==="storage"||e==="system"?"offline":"motion"}function Nc(e,t){let s=null,i=!1,a=2e3;const n=(()=>{const l=new URL(ge("events/ws"));return l.protocol=l.protocol==="https:"?"wss:":"ws:",l.toString()})(),o=()=>{if(!i){try{s=new WebSocket(n)}catch{return}s.onopen=()=>{a=2e3,t?.(null,!0)},s.onmessage=l=>{try{const p=JSON.parse(l.data);p.type==="event_added"||p.type==="event_updated"?e(p.payload):p.type==="heartbeat"&&t?.(p.payload.ingest,!0)}catch{}},s.onclose=()=>{t?.(null,!1),i||(window.setTimeout(o,a),a=Math.min(3e4,a*2))}}};return o(),()=>{i=!0,s?.close()}}const Bc={measured:"נמדד",inferred:"נגזר",command:"פקודה",availability:"זמינות"},Lc=(e,t=120)=>k(`events/${e}/correlation?window=${t}`),Vc=(e=90)=>k(`events/facets?days=${e}`),yr={alertstream:"אירוע NVR",recording:"נגזר מהקלטה",system:"מערכת",ha:"חיישן HA"},Hc=(e,t=90)=>k(`events/${e}/route?window=${t}`),In=(e=!1)=>k(`storage${e?"?fresh=true":""}`);function Dt(e){return e==null?"—":e>=1024*1024?`${(e/1024/1024).toFixed(2)} TB`:e>=1024?`${(e/1024).toFixed(0)} GB`:`${e} MB`}const zs={ok:"תקין",warn:"לתשומת לב",error:"שגיאה"},$r={ok:"live",warn:"stale",error:"offline"},Cn=(e=!1)=>k(`health/report${e?"?fresh=1":""}`),Ia=()=>k("health/summary");function jc(e){return e<3600?`${Math.floor(e/60)} דק׳`:e<86400?`${Math.floor(e/3600)} שע׳ ${Math.floor(e%3600/60)} דק׳`:`${Math.floor(e/86400)} ימים ${Math.floor(e%86400/3600)} שע׳`}var Fc=Object.defineProperty,Wc=Object.getOwnPropertyDescriptor,Ce=(e,t,s,i)=>{for(var a=i>1?void 0:i?Wc(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&Fc(t,s,a),a};function Uc(e){return e<5?"לילה טוב":e<12?"בוקר טוב":e<17?"צהריים טובים":e<21?"ערב טוב":"לילה טוב"}const Zc={person:"var(--sw-accent)",vehicle:"var(--sw-live)",motion:"var(--sw-danger)",line:"var(--sw-stale)",offline:"var(--sw-offline)",door:"var(--sw-purple)"},qc={"כניסה ראשית":"entrance","חצר אחורית":"backyard",מחסן:"warehouse",לובי:"lobby","חניה מקורה":"parking"};let $e=class extends z{constructor(){super(...arguments),this.cams=null,this.recorder=null,this.sites=null,this.summary=null,this.summaryDenied=!1,this.recent=[],this.storage=null,this.health=null,this.raw=null,this.tz="Asia/Jerusalem",this.now=new Date,this.loaded=!1,this.timer=0,this.clockTimer=0}connectedCallback(){super.connectedCallback(),y()&&(this.load(),this.timer=window.setInterval(()=>void this.load(),6e4),this.clockTimer=window.setInterval(()=>this.now=new Date,3e4))}disconnectedCallback(){window.clearInterval(this.timer),window.clearInterval(this.clockTimer),super.disconnectedCallback()}async load(){this.loadStorage();const[e,t,s,i,a,n,o]=await Promise.allSettled([Ve(),Le(),k("sites?tree=true"),Cc(),Si({limit:6}),Ia(),k("health")]);e.status==="fulfilled"&&(this.tz=e.value["time.zone"]??this.tz),t.status==="fulfilled"?(this.cams=t.value.cameras.filter(l=>l.enabled),this.recorder=t.value.recorder):this.cams===null&&(this.cams=[]),s.status==="fulfilled"?this.sites=s.value.sites:this.sites===null&&(this.sites=[]),i.status==="fulfilled"?this.summary=i.value:this.summaryDenied=i.reason instanceof fe&&i.reason.status===403,a.status==="fulfilled"&&(this.recent=a.value.events),n.status==="fulfilled"&&(this.health=n.value),o.status==="fulfilled"&&(this.raw=o.value),this.loaded=!0,this.now=new Date}async loadStorage(){try{this.storage=await In()}catch{this.storage=null}}fmtTime(e){return new Date(e).toLocaleTimeString("he-IL",{hour:"2-digit",minute:"2-digit",timeZone:this.tz})}spots(){const e=[],t=this.cams??[];for(const a of t.filter(n=>n.status==="offline"))e.push({kind:"critical",title:`מצלמה מנותקת: ${a.name}`,meta:`ערוץ ${a.channel}${a.last_seen_at?` · נראתה לאחרונה ${this.fmtTime(a.last_seen_at)}`:""}`,why:"מוצג כי ה־NVR מדווח שהערוץ אינו מחובר",link:`#/live/cameras/${a.id}`});for(const a of(this.health?.items??[]).filter(n=>n.status!=="ok"))e.push({kind:a.status==="error"?"critical":"alert",title:a.label,meta:`בדיקת מערכת · ${zs[a.status]}`,why:"מוצג כי בדיקת הבריאות של ה־Add-on מדווחת על כך",link:"#/system/diagnostics"});const s=this.summary?.today.unacked??0;if(s>0){const a=Object.entries(this.summary?.today.by_type??{}).sort((n,o)=>o[1]-n[1]).slice(0,3).map(([n,o])=>`${ee[n]??n} ${o}`).join(" · ");e.push({kind:"alert",title:`${s} אירועים שלא נבדקו היום`,meta:a,why:"מוצג כי אירועים ממתינים לסימון טיפול במרכז האירועים",link:"#/investigate/events"})}const i=this.raw?.events.ingest;return i?.connected&&!i.events_stored&&!i.last_event_at&&e.push({kind:"info",title:"ה־NVR לא שלח התראות מאז ההפעלה",meta:"אירועי תנועה נגזרים מההקלטות כל 10 דקות",why:'מוצג כי זרם ההתראות מחובר אך ריק — ב־NVR יש להפעיל "Notify Surveillance Center" ב־linkage של זיהוי התנועה',link:"#/system/setup"}),this.raw?.home_assistant.configured&&!this.raw.home_assistant.connected&&e.push({kind:"alert",title:"אין חיבור ל־Home Assistant",meta:this.raw.home_assistant.last_error??"",why:"מוצג כי מצבי הישויות והדלתות עלולים להיות מיושנים",link:"#/system/setup"}),e}renderApi(){const e=Te.me?.user,t=e?.display_name||e?.username||"",s=Number(this.now.toLocaleString("en-GB",{hour:"numeric",hour12:!1,timeZone:this.tz})),i=this.cams??[],a=i.filter(_=>_.status==="online").length,n=this.sites??[],o=n.flatMap(_=>(_.buildings??[]).flatMap(I=>I.floors??[])),l=this.health,p=l?l.status==="ok"?"live":l.status==="warn"?"stale":"offline":"neutral",h=l?.items.find(_=>_.status!=="ok"),m=this.loaded?this.spots():[],g=this.storage,v=g?.totals??null,b=v?.used_pct??null,S=34,N=2*Math.PI*S,q=i.filter(_=>_.status==="online").slice(0,2);return r`
      <sw-page heading=${`${Uc(s)}${t?`, ${t}`:""}`} subheading=${l?`מצב המערכת: ${zs[l.status]}${h?` · ${h.label}`:" · כל הבדיקות תקינות"}`:"קורא את מצב המערכת…"}>
        ...
        <div class="kpis" data-overview-kpis>
          ...
          <sw-kpi icon="shield" tone=${p} value=${l?zs[l.status]:"…"} label="מצב מערכת" detail=${h?h.label:"NVR, go2rtc, HA ואחסון"}></sw-kpi>
        </div>
        ...
        <div class="row2">
          ${g&&v?r`<sw-card heading="אחסון" subheading=${g.cached?"מהמטמון · נמדד מול ה־NVR":"נמדד מול ה־NVR"}>
                <div class="donut">
                  ...
                  <div class="txt">
                    <div class="big">${Dt(v.used_mb)} מתוך ${Dt(v.capacity_mb)}</div>
          ...
          <sw-card heading="אתרים ומבנים" subheading=${n.length?`${n.length} אתרים · ${o.length} קומות`:"עדיין לא הוגדרו אתרים"}>
            ${n.map(_=>{const I=(_.buildings??[]).flatMap(hs=>hs.floors??[]),Q=I.filter(hs=>hs.has_plan).length,ye=I.reduce((hs,qn)=>hs+qn.camera_count,0);return r`<div class="hrow" @click=${()=>$("/explore/sites")} style="cursor:pointer"><span>${_.name}<div class="muted">${(_.buildings??[]).length} מבנים · ${I.length} קומות · ${ye} מצלמות מוצבות · ${Q}/${I.length} תוכניות</div></span><span class="status"><i style=${`--c:${I.length&&Q===I.length?"var(--sw-live)":"var(--sw-stale)"}`}></i>${I.length&&Q===I.length?"תוכניות מפורסמות":"חסרות תוכניות"}</span></div>`})}
        ...
        <div class="row3">
          <sw-card heading="אירועים אחרונים" subheading=${this.summary?`${this.summary.today.total} היום · ${this.summary.today.measured} נמדדו · ${this.summary.today.inferred} נגזרו מהקלטה`:""}>
            ...
            ${this.recent.length?this.recent.map(_=>r`<div class="ev" data-overview-event @click=${()=>$(`/investigate/events/${_.id}`)}>
                    ${_.thumbnail==="ready"?r`<img class="thumb" src=${Ot(_.id)} alt="" loading="lazy" />`:r`<div class="none"><sw-icon name=${_.type==="offline"||_.type==="coverage_gap"?"offline":_.type==="door"||_.type==="io"?"door":_.type==="person"?"user":_.type==="vehicle"?"route":"bell"} size=${14}></sw-icon></div>`}
                    <div class="txt"><b style=${`--tone:${si[_.type]??"#6b7280"}`}><i></i>${ee[_.type]??_.type}${_.acked_at?"":" · לבדיקה"}</b><small>${_.camera_name??_.details?.name??"ללא מצלמה"} · ${_.confidence==="inferred"?"נגזר מהקלטה":_.source==="ha"?"חיישן HA":"התראה"}</small></div>
    ...
    `}render(){if(y())return this.renderApi();const e=X.filter(l=>l.state==="live"||l.state==="stale").length,t=ot.filter(l=>!l.acked),s=[{kind:"critical",title:"מצלמה מנותקת: מסדרון מזרחי",meta:"קומה 0 · מאז 07:55",why:"מוצג כי אין הקלטה ממצלמה זו כבר שעתיים",link:"#/system/devices"},{kind:"alert",title:`${t.length} אירועים שלא נבדקו`,meta:"אדם בכניסה הראשית 10:14, רכב בחצר 09:42",why:"מוצג כי אירועי אדם/רכב מחכים לסימון טיפול",link:"#/investigate/events"},{kind:"alert",title:"החיבור ל־Home Assistant לא רענן",meta:"סנכרון אחרון לפני 4 דק׳",why:"מוצג כי מצבי הישויות עלולים להיות מיושנים",link:"#/system/diagnostics"}],i=.68,a=34,n=2*Math.PI*a,o=X.filter(l=>l.state==="live").slice(0,2);return r`
      <sw-page heading="בוקר טוב, יוני" subheading="המערכת פועלת · גשר Home Assistant לא רענן · נתוני הדגמה">
        ...
        <div class="kpis">
          ...
          <sw-kpi icon="building" value=${String(Qi.length)} label="אתרים" detail="פעילים" tone="neutral"></sw-kpi>
        ...
        <div class="row2">
          ...
          <sw-card heading="בריאות האתרים">
            ${Qi.map(l=>r`<div class="hrow"><span>${l.name}<div class="muted">${l.online}/${l.cameras} מצלמות · ${l.alerts} התראות</div></span><span class="status"><i style="--c:${l.health==="live"?"var(--sw-live)":l.health==="offline"?"var(--sw-danger)":"var(--sw-stale)"}"></i>${l.health==="live"?"מחובר":l.health==="offline"?"מנותק":"חלקי"}</span></div>`)}
            ${un.slice(0,2).map(l=>r`<div class="hrow"><span>${l.name}<div class="muted">${l.detail}</div></span><span class="status"><i style="--c:${l.state==="live"?"var(--sw-live)":"var(--sw-stale)"}"></i>${l.state==="live"?"מחובר":"לא רענן"}</span></div>`)}
          </sw-card>
        </div>
        <div class="row3">
          <sw-card heading="אירועים אחרונים">
            ...
            ${ot.slice(0,5).map(l=>r`<div class="ev" @click=${()=>$("/investigate/events")}>
                ...
                <div class="txt"><b style="--tone:${Zc[l.type]}"><i></i>${ea[l.type]}</b><small>${l.camera} · ${l.floor}</small></div>
                <time>${l.time}</time>
              </div>`)}
          </sw-card>
          <sw-card heading="דורש תשומת לב" subheading="כל פריט מסביר מדוע הוא מוצג">
  ...
  `;Ce([c()],$e.prototype,"cams",2);Ce([c()],$e.prototype,"recorder",2);Ce([c()],$e.prototype,"sites",2);Ce([c()],$e.prototype,"summary",2);Ce([c()],$e.prototype,"summaryDenied",2);Ce([c()],$e.prototype,"recent",2);Ce([c()],$e.prototype,"storage",2);Ce([c()],$e.prototype,"health",2);Ce([c()],$e.prototype,"raw",2);Ce([c()],$e.prototype,"tz",2);Ce([c()],$e.prototype,"now",2);Ce([c()],$e.prototype,"loaded",2);$e=Ce([E("live-overview")],$e);var Kc=Object.defineProperty,Gc=Object.getOwnPropertyDescriptor,Ge=(e,t,s,i)=>{for(var a=i>1?void 0:i?Gc(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&Kc(t,s,a),a};const ji=[1,2,4,6,8,9,12,16,20,25,32],xr="sw.wall.count",kr=[{id:"all",label:"כל המצלמות"},{id:"outside",label:"חוץ"},{id:"inside",label:"פנים"},{id:"night",label:"לילה"}];let Pe=class extends z{constructor(){super(...arguments),this.cameras="",this.count=4,this.stream="auto",this.view="all",this.cams=null,this.settings=null,this.error="",this.posterBust=Date.now(),this.colsOverride=(()=>{try{return Number(localStorage.getItem("sw.wall.cols")??0)||0}catch{return 0}})(),this.box={w:0,h:0},this.measure=()=>{const e=this.renderRoot.querySelector(".grid");if(!e)return;const t=Math.round(e.clientWidth),s=Math.round(window.innerHeight-e.getBoundingClientRect().top-56);(t!==this.box.w||s!==this.box.h)&&(this.box={w:t,h:s})}}setCols(e){this.colsOverride=e;try{localStorage.setItem("sw.wall.cols",String(e))}catch{}}bestFit(e){const{w:t,h:s}=this.box;if(!t||s<120||e<1)return null;const i=12;let a={cols:1,tile:0};for(let n=1;n<=e;n++){const o=Math.ceil(e/n),l=Math.min((t-i*(n-1))/n,(s-i*(o-1))/o*(16/9));l>a.tile&&(a={cols:n,tile:l})}return a.tile>80?{cols:a.cols,tile:Math.floor(a.tile)}:null}firstUpdated(){this.ro=new ResizeObserver(()=>this.measure()),this.ro.observe(this),window.addEventListener("resize",this.measure)}updated(){this.measure()}connectedCallback(){super.connectedCallback(),this.load(),this.posterTimer=window.setInterval(()=>this.posterBust=Date.now(),6e4)}disconnectedCallback(){super.disconnectedCallback(),window.clearInterval(this.posterTimer),this.ro?.disconnect(),window.removeEventListener("resize",this.measure)}setCount(e){this.count=e;try{localStorage.setItem(xr,String(e))}catch{}}async load(){if(y())try{const[e,t]=await Promise.all([Le(),Ve()]);this.cams=e.cameras.filter(n=>n.enabled),this.settings=t;let s=0;try{s=Number(localStorage.getItem(xr)??0)}catch{}const i=Number(t["ui.wall_count"]??0),a=ji.includes(s)?s:ji.includes(i)?i:0;a&&(this.count=a)}catch(e){this.error=w(e)}}renderApi(){const e=this.cams;if(this.error)return r`<sw-state-panel state="error" hint=${this.error} actionLabel="נסה שוב" @action=${()=>this.load()}></sw-state-panel>`;if(!e)return r`<sw-state-panel state="loading"></sw-state-panel>`;if(!e.length)return r`<sw-state-panel state="empty" heading="אין מצלמות זמינות" hint="המצלמות מתגלות אוטומטית מה־NVR בהפעלה ובכל 10 דקות. אם הרשימה ריקה: בדוק את פרטי ה־NVR בהגדרות ה־Add-on ואת יומן ה־Add-on, או הרץ סנכרון ידני; ייתכן גם שאין לך הרשאה למצלמות."><div style="margin-block-start:10px"><sw-button @click=${()=>$("/system/devices")}>למצלמות</sw-button></div></sw-state-panel>`;const t=this.cameras?this.cameras.split(",").filter(Boolean):[],s=t.length?e.filter(g=>t.includes(g.id)):e,i=t.length?Math.max(1,s.length):this.count,a=s.slice(0,i),n=window.innerWidth>=768?this.bestFit(a.length):null,o=this.colsOverride?Math.min(this.colsOverride,Math.max(1,a.length)):n?n.cols:i===1?1:i===2||i<=4?2:i<=9?3:i<=16?4:i<=25?5:6;let l=n&&!this.colsOverride?n:null;if(this.box.w&&(this.colsOverride||!l)){const g=Math.ceil(a.length/o),v=Math.min((this.box.w-12*(o-1))/o,this.box.h>120?(this.box.h-12*(g-1))/g*(16/9):1/0);v>80&&Number.isFinite(v)&&(l={cols:o,tile:Math.floor(v)})}const p=this.settings?.["media.max_live_sessions"]??8,h=this.stream==="auto"?this.settings?.["media.wall_profile"]??"sub":this.stream,m=Ea(this.settings);return r`
    ...
    `}openKiosk(){const e=`${window.location.origin}${window.location.pathname}${window.location.search}#/kiosk/all`;window.open(e,"_blank","noopener")}render(){const e=y(),t=e?this.cams?.length??0:X.length;return r`
      <sw-page heading="כל המצלמות" subheading="${t} מצלמות${e?"":` · תצוגה: ${kr.find(s=>s.id===this.view)?.label} · נתוני הדגמה`}" wide>
        ${e?d:r`<sw-field slot="actions"><select aria-label="תצוגה" @change=${s=>this.view=s.target.value}>${kr.map(s=>r`<option value=${s.id} ?selected=${s.id===this.view}>${s.label}</option>`)}</select></sw-field>`}
        ...
        <div slot="actions" class="layouts" role="group" aria-label="פריסה">
          ${ji.map(s=>r`<button class=${s===this.count&&!this.cameras?"on":""} @click=${()=>{this.setCount(s),this.cameras&&$("/live/wall")}} aria-pressed=${s===this.count&&!this.cameras}>${s}</button>`)}
        </div>
  ...
  `;Ge([f()],Pe.prototype,"cameras",2);Ge([c()],Pe.prototype,"count",2);Ge([c()],Pe.prototype,"stream",2);Ge([c()],Pe.prototype,"view",2);Ge([c()],Pe.prototype,"cams",2);Ge([c()],Pe.prototype,"settings",2);Ge([c()],Pe.prototype,"error",2);Ge([c()],Pe.prototype,"posterBust",2);Ge([c()],Pe.prototype,"colsOverride",2);Ge([c()],Pe.prototype,"box",2);Pe=Ge([E("live-wall")],Pe);const Yc=()=>k("nvr/notify"),Jc=e=>Me("nvr/notify",e),_r=(e=20)=>k(`nvr/changes?limit=${e}`),Xc=e=>A(`nvr/changes/${e}/rollback`),Qc=e=>k(`cameras/${e}/record`),ep=(e,t)=>A(`cameras/${e}/record/start`,{minutes:t}),tp=e=>A(`cameras/${e}/record/stop`),sp=(e,t)=>Me(`cameras/${e}/motion`,t),ip=()=>k("nvr/system"),ap=e=>Me("nvr/time",e),rp=e=>Me("nvr/ntp",e),np=e=>A(`nvr/outputs/${e}/pulse`),op=(e,t="short")=>A(`nvr/storage/${e}/smart-test`,{kind:t}),lp=e=>A("nvr/reboot",{confirm:e}),dp=()=>k("nvr/connection"),cp=e=>Me("nvr/connection",e),pp=e=>k(`cameras/${e}/osd`),Fi=(e,t)=>Me(`cameras/${e}/osd`,t),hp=e=>k(`cameras/${e}/schedules`),up=(e,t,s)=>Me(`cameras/${e}/schedules/${t}`,{days:s}),mp=(e,t)=>Me(`cameras/${e}/record-schedule`,t),fp=e=>k(`cameras/${e}/smart`),gp=(e,t)=>Me(`cameras/${e}/smart`,t),wp=(e,t)=>A(`cameras/${e}/osd/name`,{});var vp=Object.defineProperty,bp=Object.getOwnPropertyDescriptor,cs=(e,t,s,i)=>{for(var a=i>1?void 0:i?bp(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&vp(t,s,a),a};const yp=[6,0,1,2,3,4,5],zr=["א׳","ב׳","ג׳","ד׳","ה׳","ו׳","ש׳"],Yt=e=>String(e).padStart(2,"0"),Sr=e=>Number(e.slice(0,2))+Number(e.slice(3,5))/60;function $p(e){return Array.from({length:7},(t,s)=>{const i=Array.from({length:24},()=>"");for(const a of e[s]??[]){const n=Math.floor(Sr(a.begin)),o=Math.min(24,Math.ceil(Sr(a.end)));for(let l=n;l<o;l++)i[l]=a.mode??"on"}return i})}function xp(e,t){return e.map(s=>{const i=[];let a=0;for(;a<24;){const n=s[a];if(!n){a++;continue}let o=a;for(;o<24&&s[o]===n;)o++;i.push(t?{begin:`${Yt(a)}:00:00`,end:`${Yt(o)}:00:00`,mode:n}:{begin:`${Yt(a)}:00:00`,end:`${Yt(o)}:00:00`}),a=o}return i})}let zt=class extends z{constructor(){super(...arguments),this.days=Array.from({length:7},()=>[]),this.modes=[{id:"on",label:"פעיל",color:"var(--sw-accent)"}],this.mode="on",this.editable=!1,this.painting=null,this.cells=[],this.lastDays=null,this.end=()=>{this.painting=null},this.onDown=e=>{if(!this.editable||e.button!==0)return;const t=this.cellAt(e);t&&(e.preventDefault(),e.currentTarget.setPointerCapture(e.pointerId),this.paint(t[0],t[1],!0))},this.onMove=e=>{if(this.painting===null||!e.buttons)return;const t=this.cellAt(e);t&&this.paint(t[0],t[1],!1)}}sync(){this.lastDays!==this.days&&(this.cells=$p(this.days),this.lastDays=this.days)}colorOf(e){return this.modes.find(t=>t.id===e)?.color??"var(--sw-accent)"}paint(e,t,s){if(!this.editable||(s&&(this.painting=this.cells[e][t]===this.mode?"":this.mode),this.painting===null)||this.cells[e][t]===this.painting)return;this.cells=this.cells.map((a,n)=>n===e?a.map((o,l)=>l===t?this.painting:o):a);const i=xp(this.cells,this.modes.length>1||this.modes[0]?.id!=="on");this.lastDays=i,this.days=i,this.dispatchEvent(new CustomEvent("change",{detail:{days:i},bubbles:!0,composed:!0}))}cellAt(e){const t=this.renderRoot,i=(t.elementFromPoint?t.elementFromPoint(e.clientX,e.clientY):null)?.dataset?.cell;if(!i)return null;const[a,n]=i.split("-").map(Number);return Number.isFinite(a)&&Number.isFinite(n)?[a,n]:null}connectedCallback(){super.connectedCallback(),window.addEventListener("pointerup",this.end)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("pointerup",this.end)}renderLegend(){const e=this.editable&&this.modes.length>1;return r`<div class="legend" data-week-legend>
      ...
      <div class="grid" role="grid" aria-label="לוח שבועי" @pointerdown=${this.onDown} @pointermove=${this.onMove} @pointerup=${this.end} @pointercancel=${this.end}>
        ...
        ${yp.map((e,t)=>r`
          <span class="d">${zr[t]}</span>
          ${this.cells[e].map((s,i)=>r`<div class="c ${s?"on":""}" data-cell=${`${e}-${i}`} data-mode=${s} style=${s?`--cell:${this.colorOf(s)}`:""} title=${`${zr[t]} ${Yt(i)}:00–${Yt(i+1)}:00${s?` · ${this.modes.find(a=>a.id===s)?.label??s}`:""}`}></div>`)}
        `)}
      </div>
      ${this.renderLegend()}
    `}};zt.styles=M`
  ...
  `;cs([f({attribute:!1})],zt.prototype,"days",2);cs([f({attribute:!1})],zt.prototype,"modes",2);cs([f()],zt.prototype,"mode",2);cs([f({type:Boolean})],zt.prototype,"editable",2);cs([c()],zt.prototype,"painting",2);zt=cs([E("sw-week-grid")],zt);var kp=Object.defineProperty,_p=Object.getOwnPropertyDescriptor,C=(e,t,s,i)=>{for(var a=i>1?void 0:i?_p(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&kp(t,s,a),a};let P=class extends z{constructor(){super(...arguments),this.cameraId="cam-1",this.cam=null,this.zones=null,this.zonesBusy=!1,this.zonesError="",this.motionEdit=null,this.motionConfirm=!1,this.motionBusy=!1,this.motionMsg="",this.paintValue=null,this.rec=null,this.osd=null,this.sched=null,this.schedError="",this.schedTab="motion",this.schedEdit=null,this.schedBusy=!1,this.schedMsg="",this.schedConfirm=!1,this.smart=null,this.smartEdit=null,this.smartBusy=!1,this.smartMsg="",this.osdMsg="",this.renameTo=null,this.renameBusy=!1,this.renameMsg="",this.osdBusy=!1,this.recMinutes=10,this.recBusy=!1,this.recMsg="",this.recTimer=0,this.zoneLayers={motion:!0,privacy:!0,intrusion:!0,lines:!0},this.caps=null,this.capsError="",this.cams=[],this.canConfigure=!1,this.settings=null,this.error="",this.loading=!0,this.profile="main",this.transport="auto",this.playerStatus="",this.playerTransport="",this.posterBust=Date.now(),this.ptzMode="presets"}async loadSchedules(){if(!(!this.cam||!y())){if(!sr()){this.sched=null,this.smart=null,this.schedError="לוחות הזמנים וחוקי ה־smart של ה־NVR נקראים עם הרשאת ניהול NVR.";return}try{this.sched=await hp(this.cam.id),this.schedError="",!this.sched.arming[this.schedTab]&&this.schedTab!=="record"&&(this.schedTab=Object.keys(this.sched.arming)[0]??"record")}catch(e){this.schedError=w(e)}try{this.smart=await fp(this.cam.id)}catch{this.smart=null}}}startSchedEdit(){const e=this.sched;if(!e)return;const t=this.schedTab,s=(t==="record"?e.record?.days:e.arming[t])??Array.from({length:7},()=>[]);this.schedMsg="",this.schedEdit={kind:t,days:s.map(i=>i.map(a=>({...a}))),schedule_enabled:e.record?.schedule_enabled??null,enabled:e.record?.enabled}}schedDiff(){const e=this.schedEdit,t=this.sched;if(!e||!t)return 0;const s=(e.kind==="record"?t.record?.days:t.arming[e.kind])??[],i=a=>a.map(n=>n.map(o=>`${o.begin}-${o.end}-${o.mode??""}`).join(",")).join("|");return i(s)===i(e.days)?0:1}async saveSched(){const e=this.schedEdit;if(!(!e||!this.cam||this.schedBusy)){this.schedBusy=!0,this.schedConfirm=!1;try{const t=e.kind==="record"?await mp(this.cam.id,{days:e.days,...e.schedule_enabled!==null&&e.schedule_enabled!==this.sched?.record?.schedule_enabled?{schedule_enabled:e.schedule_enabled??void 0}:{}}):await up(this.cam.id,e.kind,e.days);this.schedMsg=t.status==="unchanged"?"ה־NVR כבר היה במצב הזה — לא נכתב דבר.":"הלוח נכתב ל־NVR ונרשם (ניתן להחזרה מרשימת השינויים בהגדרות › חיבורים).",this.schedEdit=null,await this.loadSchedules()}catch(t){this.schedMsg=w(t)}finally{this.schedBusy=!1}}}renderSchedules(){const e=this.sched;if(this.schedError&&!e)return r`<div class="note">${this.schedError}</div>`;if(!e)return r`<div class="note">קורא לוחות מה־NVR…</div>`;const t=[{id:"motion",label:"זיהוי תנועה",ok:!!e.arming.motion},{id:"line",label:"חציית קו",ok:!!e.arming.line},{id:"field",label:"פריצה לאזור",ok:!!e.arming.field},{id:"record",label:"לוח הקלטה",ok:!!e.record}],s=this.schedTab,i=this.schedEdit?.kind===s?this.schedEdit:null,a=i?i.days:s==="record"?e.record?.days:e.arming[s],n=[{id:"CMR",label:"רציף",color:"#2f6bff"},{id:"MOTION",label:"תנועה",color:"#16a34a"},{id:"EDR",label:"אירוע",color:"#f59e0b"},{id:"ALARM",label:"אזעקה",color:"#dc2626"}],o=s==="record"?e.can.schedule:e.can.events,l=t.find(p=>p.id===s)?.label??"";return r`<div class="note">${t.length} לוחות בכרטיס הזה, כולל <strong>לוח הקלטה</strong> (מתי הערוץ מקליט בפועל) — לא רק לוחות הזיהוי.</div>
    ...
    `}renderSmartEditor(){const e=this.smartEdit,t=s=>({any:"שני הכיוונים","left-right":"שמאל → ימין","right-left":"ימין → שמאל"})[s]??s;return r`<div class="legend" data-smart-editor style="display:grid;gap:8px;margin-block-start:8px">
    ...
    </sw-dialog>`}async loadOsd(){if(!(!this.cam||!y())){if(!sr()){this.osd=null;return}try{this.osd=await pp(this.cam.id)}catch{this.osd=null}}}async osdAction(e,t){if(!this.osdBusy){this.osdBusy=!0,this.osdMsg="";try{await t(),this.osdMsg=`${e}: נכתב ל־NVR ונרשם.`,await this.loadOsd()}catch(s){this.osdMsg=`${e}: ${w(s)}`}finally{this.osdBusy=!1}}}renderOsd(){const e=this.osd;if(!e||!e.can_write)return d;const t=(e.nvr_name??"")===e.vms_name;return r`<div class="note" style="margin-block-start:8px;display:flex;flex-wrap:wrap;gap:8px;align-items:center" data-osd>
      ...
      ${e.channel_name?r`<label style="display:inline-flex;gap:4px;align-items:center"><input type="checkbox" data-osd-name-enabled .checked=${e.channel_name.enabled} ?disabled=${this.osdBusy} @change=${s=>this.osdAction("שם על התמונה",()=>Fi(this.cam.id,{name_enabled:s.target.checked}))} /> שם על התמונה</label>`:d}
      ${e.datetime?r`<label style="display:inline-flex;gap:4px;align-items:center"><input type="checkbox" data-osd-datetime-enabled .checked=${e.datetime.enabled} ?disabled=${this.osdBusy} @change=${s=>this.osdAction("חותמת זמן",()=>Fi(this.cam.id,{datetime_enabled:s.target.checked}))} /> חותמת זמן</label>
        <sw-field><select aria-label="פורמט תאריך" data-osd-date-style ?disabled=${this.osdBusy} @change=${s=>this.osdAction("פורמט תאריך",()=>Fi(this.cam.id,{date_style:s.target.value}))}>${e.date_styles.map(s=>r`<option value=${s} ?selected=${s===e.datetime.date_style}>${s}</option>`)}</select></sw-field>`:d}
      ...
      </div>`}async load(){this.loading=!0,this.error="";try{if(y()){const[e,t]=await Promise.all([Le(),Ve()]);this.cams=e.cameras,this.cam=e.cameras.find(s=>s.id===this.cameraId)??null,this.canConfigure=e.can_sync,this.settings=t,this.transport=Ea(t)}}catch(e){this.error=w(e)}finally{this.loading=!1}}setTransport(e){Jo(e===(this.settings?.["media.transport_default"]??"mse")?"":e),this.transport=e}onPlayer(e){this.playerStatus=e.detail.status,this.playerTransport=e.detail.transport??""}renderApi(){const e=this.cam;if(this.loading)return r`<sw-state-panel state="loading"></sw-state-panel>`;if(this.error)return r`<sw-state-panel state="error" hint=${this.error} actionLabel="נסה שוב" @action=${()=>this.load()}></sw-state-panel>`;if(!e)return r`<sw-state-panel state="forbidden" heading="המצלמה לא זמינה" hint="המצלמה לא נמצאה או שאין לך הרשאת צפייה בה."></sw-state-panel>`;const t=e.can_view_live!==!1&&e.status!=="offline",s=et(e.id,this.posterBust),i=e.stream;return r`
      ...
      <div class="controls">
        <div class="round" role="group" aria-label="פקדי מצלמה">
          ...
          ${an()?r`<span class="note">ברירת המחדל של המערכת: ${this.settings?.["media.transport_default"]??"mse"}</span>`:d}
        </div>
  ...
  `;at([c()],Re.prototype,"views",2);at([c()],Re.prototype,"cams",2);at([c()],Re.prototype,"canShare",2);at([c()],Re.prototype,"canManageAll",2);at([c()],Re.prototype,"editing",2);at([c()],Re.prototype,"confirmDelete",2);at([c()],Re.prototype,"busy",2);at([c()],Re.prototype,"error",2);at([c()],Re.prototype,"formError",2);Re=at([E("live-views")],Re);var Ap=Object.defineProperty,Pp=Object.getOwnPropertyDescriptor,ft=(e,t,s,i)=>{for(var a=i>1?void 0:i?Pp(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&Ap(t,s,a),a};const Dn="sw.kiosk.layout",Ip=[[2,2],[3,2],[3,3],[4,3],[4,4],[5,4],[6,4]];function Tn(e){try{const i=localStorage.getItem(Dn);if(i){const[a,n]=i.split("x").map(Number);if(a>=1&&n>=1)return{cols:a,rows:n}}}catch{}const t=Number(e?.["ui.kiosk_cols"]??0),s=Number(e?.["ui.kiosk_rows"]??0);return{cols:t>=1?t:3,rows:s>=1?s:2}}function Wi(e=Tn()){const t=rs().params,s=Math.min(6,Math.max(1,Number(t.get("cols")??e.cols)||e.cols)),i=Math.min(5,Math.max(1,Number(t.get("rows")??e.rows)||e.rows));return{cameras:(t.get("cameras")??"").split(",").map(a=>a.trim()).filter(Boolean),cols:s,rows:i,rotate:Math.max(0,Number(t.get("rotate")??0)||0)}}let qe=class extends z{constructor(){super(...arguments),this.cams=null,this.settings=null,this.clock="",this.page=0,this.health=null,this.disconnected=!1,this.view=Wi(),this.failures=0,this.onHash=()=>{this.view=Wi(),this.page=this.restorePage(),this.startRotation()},this.started=0,this.staggerTimer=0}setLayout(e){const[t,s]=e.split("x").map(Number);if(!(t>=1&&s>=1))return;try{localStorage.setItem(Dn,`${t}x${s}`)}catch{}const i=new URLSearchParams(rs().params);i.set("cols",String(t)),i.set("rows",String(s)),window.location.replace(`#/kiosk/all?${i.toString()}`)}get pageKey(){return`sw.kiosk.page:${this.view.cameras.join(",")}|${this.view.cols}x${this.view.rows}`}restorePage(){try{const e=Number(localStorage.getItem(this.pageKey)??"0");return Number.isFinite(e)&&e>=0?e:0}catch{return 0}}setPage(e){this.page=e;try{localStorage.setItem(this.pageKey,String(e%Math.max(1,this.pages)))}catch{}}connectedCallback(){super.connectedCallback(),this.page=this.restorePage(),this.tick(),this.timer=window.setInterval(()=>this.tick(),1e3),this.unsubscribe=mn(e=>{e.mode==="api"&&this.cams===null?this.load():e.mode!=="loading"&&this.requestUpdate()}),window.addEventListener("hashchange",this.onHash),this.startRotation(),this.pollHealth(),this.healthTimer=window.setInterval(()=>void this.pollHealth(),15e3)}disconnectedCallback(){window.clearTimeout(this.staggerTimer),super.disconnectedCallback(),window.clearInterval(this.timer),window.clearInterval(this.rotateTimer),window.clearInterval(this.healthTimer),window.removeEventListener("hashchange",this.onHash),this.unsubscribe?.()}startRotation(){window.clearInterval(this.rotateTimer),this.view.rotate>0&&(this.rotateTimer=window.setInterval(()=>{this.setPage(this.page+1),this.stagger()},this.view.rotate*1e3)),this.stagger()}async pollHealth(){if(y())try{this.health=await Ia(),(this.disconnected||this.failures>=3)&&this.load(),this.failures=0,this.disconnected=!1}catch{this.failures+=1,this.failures>=3&&(this.disconnected=!0)}}get pageSize(){return this.view.cols*this.view.rows}stagger(){window.clearTimeout(this.staggerTimer),this.started=0;const e=()=>{this.started<this.pageSize&&(this.started+=1,this.staggerTimer=window.setTimeout(e,400))};e()}get selected(){const e=(this.cams??[]).filter(t=>this.view.cameras.length===0||this.view.cameras.includes(t.id));return this.view.cameras.length?this.view.cameras.map(t=>e.find(s=>s.id===t)).filter(t=>!!t):e}get pages(){return Math.max(1,Math.ceil(this.selected.length/this.pageSize))}tick(){const e=new Date;this.clock=`${e.toLocaleDateString("he-IL",{weekday:"long",day:"2-digit",month:"2-digit",year:"numeric"})} · ${e.toLocaleTimeString("he-IL")}`}async load(){if(y())try{const[e,t]=await Promise.all([Le(),Ve()]);this.cams=e.cameras.filter(s=>s.enabled),this.settings=t,this.view=Wi(Tn(t))}catch{this.cams=[]}}render(){const t=y(),s=this.page%this.pages,i=t?this.selected.slice(s*this.pageSize,(s+1)*this.pageSize):[],a=X.filter(l=>l.state!=="forbidden").slice(0,9),n=t?i.filter(l=>l.status==="online").length:7,o=this.settings?.["media.max_live_sessions"]??8;return r`
      <header>
        ...
        ${t&&this.health?r`<span class="pill" data-kiosk-health data-status=${this.health.status}>מערכת: ${zs[this.health.status]}${this.health.items.filter(l=>l.status!=="ok").length?` · ${this.health.items.filter(l=>l.status!=="ok").map(l=>l.label).join(", ")}`:""}</span>`:d}
  ...
  `;je([f({attribute:!1})],ze.prototype,"item",2);je([f()],ze.prototype,"subheading",2);je([c()],ze.prototype,"cases",2);je([c()],ze.prototype,"loading",2);je([c()],ze.prototype,"error",2);je([c()],ze.prototype,"picked",2);je([c()],ze.prototype,"newTitle",2);je([c()],ze.prototype,"note",2);je([c()],ze.prototype,"busy",2);je([c()],ze.prototype,"done",2);je([c()],ze.prototype,"canManage",2);ze=je([E("sw-case-picker")],ze);const Nn=(e,t)=>k(`cameras/${e}/recordings?date=${t}`),Ms=new Set,Es=new Set;function Jp(){if(!(!Ms.size&&!Es.size)){for(const e of Es)navigator.sendBeacon?.(ge(`playback/groups/${e}/close`),"");for(const e of Ms)navigator.sendBeacon?.(ge(`playback/sessions/${e}/close`),"");Ms.clear(),Es.clear()}}typeof window<"u"&&window.addEventListener("pagehide",Jp);const Ca=async(e,t)=>{const s=await A("playback/sessions",{camera_id:e,start_at:t});return Ms.add(s.id),s},Pr=(e,t)=>A(`playback/sessions/${e}/seek`,{start_at:t}),Bs=e=>(Ms.delete(e),ve(`playback/sessions/${e}`));function hi(e){const t=new URL(ge(`playback/sessions/${e.id}/ws?generation=${e.generation}`));return t.protocol=t.protocol==="https:"?"wss:":"ws:",t.toString()}function Xe(e,t){const s=new Intl.DateTimeFormat("en-CA",{timeZone:t,year:"numeric",month:"2-digit",day:"2-digit"}).formatToParts(e),i=a=>s.find(n=>n.type===a)?.value??"";return`${i("year")}-${i("month")}-${i("day")}`}function re(e,t){const s=new Intl.DateTimeFormat("en-GB",{timeZone:t,hour:"2-digit",minute:"2-digit",second:"2-digit",hourCycle:"h23"}).formatToParts(e),i=a=>Number(s.find(n=>n.type===a)?.value??0);return i("hour")*60+i("minute")+i("second")/60}function Je(e,t,s){const[i,a,n]=e.split("-").map(Number),o=Date.UTC(i,a-1,n,Math.floor(t/60),Math.floor(t%60),Math.round(t%1*60)),l=h=>{const m=new Intl.DateTimeFormat("en-US",{timeZone:s,hour12:!1,year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit",second:"2-digit"}).formatToParts(new Date(h)),g=b=>Number(m.find(S=>S.type===b)?.value??0);return Date.UTC(g("year"),g("month")-1,g("day"),g("hour")%24,g("minute"),g("second"))-h};let p=o-l(o);return p=o-l(p),new Date(p)}const Xp=async(e,t)=>{const s=await A("playback/groups",{camera_ids:e,start_at:t});return Es.add(s.id),s},Qp=(e,t)=>A(`playback/groups/${e}/seek`,{start_at:t}),eh=e=>(Es.delete(e),ve(`playback/groups/${e}`)),th=(e,t)=>A(`playback/groups/${e}/sync`,{p95_s:t.p95,quality:t.quality,samples:t.samples,partial:t.partial,members:t.members}),Mi=(e,t)=>ge(`cameras/${e}/frame?at=${encodeURIComponent(t)}`),Bn=(e,t,s)=>({camera_id:e,from_at:t,to_at:s}),Ir=(e,t,s)=>A("exports/estimate",Bn(e,t,s)),sh=(e,t,s)=>A("exports",Bn(e,t,s)),ih=()=>k("exports"),ah=e=>A(`exports/${e}/cancel`),rh=e=>ve(`exports/${e}`),Ln=e=>ge(`exports/${e}/download`),nh=e=>ge(`exports/${e}/manifest`);function Xt(e){return e==null?"—":e<1024*1024?`${Math.round(e/1024)} KB`:e<1024*1024*1024?`${(e/1024/1024).toFixed(1)} MB`:`${(e/1024/1024/1024).toFixed(2)} GB`}var oh=Object.defineProperty,lh=Object.getOwnPropertyDescriptor,B=(e,t,s,i)=>{for(var a=i>1?void 0:i?lh(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&oh(t,s,a),a};const It=["closed","expired","failed"];function fs(e){return nt(Math.max(0,Math.min(1439.983,e)))}function Ui(e){const[t=0,s=0,i=0]=e.split(":").map(Number);return t*60+s+i/60}function dh(e){const t=e.map(s=>Math.abs(s)).sort((s,i)=>s-i);return t[Math.min(t.length-1,Math.max(0,Math.ceil(.95*t.length)-1))]}let O=class extends z{constructor(){super(...arguments),this.cameraId="",this.at="",this.extraParam="",this.demoCamera="cam-10",this.cursor=615,this.generation=3,this.playing=!0,this.speed=1,this.filter="all",this.cams=null,this.tz="Asia/Jerusalem",this.date="",this.rec=null,this.dayEvents=[],this.bookmarks=[],this.activeBookmark=null,this.loadingRec=!1,this.session=null,this.group=null,this.extra=[],this.casePick=null,this.preview=null,this.previewTimer=0,this.busy=!1,this.error="",this.notice="",this.tileStatus={},this.drifts={},this.clock=null,this.barrier="none",this.syncStats=null,this.clockPausedAt=0,this.driftSamples={},this.lateSince={},this.resyncAt={},this.resyncs={},this.nudges={},this.groupStartedAt=0,this.lastReport=0,this.seekSentAt={},this.firstPlayAt={},this.startLatency={},this.paused=!1,this.scrubbing=!1,this.position=null,this.exportOpen=!1,this.exportFrom="",this.exportTo="",this.estimate=null,this.exportJob=null,this.exportBusy=!1,this.exportError="",this.onTlHover=e=>{if(!this.cameraId||!y())return;window.clearTimeout(this.previewTimer);const t=e.detail;this.previewTimer=window.setTimeout(()=>{const s=Je(this.date,t.minute,this.tz).toISOString().replace(/\.\d{3}Z$/,"Z");this.preview={minute:t.minute,x:t.x,width:t.width,url:Mi(this.cameraId,s),failed:!1}},250)},this.onTlHoverEnd=()=>{window.clearTimeout(this.previewTimer),this.preview=null}}connectedCallback(){super.connectedCallback(),y()&&(this.init(),this.ticker=window.setInterval(()=>this.tick(),500))}disconnectedCallback(){super.disconnectedCallback(),window.clearInterval(this.ticker),this.endSession()}updated(e){y()&&e.has("cameraId")&&e.get("cameraId")!==void 0&&this.cams&&this.selectCamera(this.cameraId,!0)}get members(){return[this.cameraId,...this.extra.filter(e=>e!==this.cameraId)]}get groupMode(){return this.extra.filter(e=>e!==this.cameraId).length>0}get masterSession(){return this.groupMode?this.group?.sessions.find(e=>e.camera_id===this.cameraId)??this.group?.sessions[0]??null:this.session}get live(){const e=this.masterSession;return!!e&&!It.includes(e.state)&&(this.groupMode?!!this.group:!0)}async init(){try{const[e,t]=await Promise.all([Ve(),Le()]);this.tz=e["time.zone"]??"Asia/Jerusalem",this.cams=t.cameras.filter(n=>n.enabled);const s=this.cams.find(n=>n.id===this.cameraId)??this.cams[0],i=this.at?new Date(this.at):null,a=!!i&&!Number.isNaN(i.getTime());if(this.date=Xe(a?i:new Date,this.tz),s)if(this.cameraId=s.id,this.extraParam&&(this.extra=this.extraParam.split(",").filter(n=>n&&n!==s.id&&this.cams.some(o=>o.id===n)).slice(0,3)),await this.loadRecordings(),a)this.cursor=re(i,this.tz),await this.startAt(i);else{const n=this.rec?.segments.at(-1);this.cursor=n?this.insideLast(n):Math.max(0,re(new Date,this.tz)-5)}}catch(e){this.error=w(e)}}async selectCamera(e,t=!1){!e||!t&&e===this.cameraId||(await this.endSession(),this.cameraId=e,this.extra=this.extra.filter(s=>s!==e),this.error="",this.notice="",await this.loadRecordings())}async setDate(e){if(!e||e===this.date)return;await this.endSession(),this.date=e,await this.loadRecordings();const t=this.rec?.segments.at(-1);this.cursor=t?this.insideLast(t):540}insideLast(e){const t=re(new Date(e.start_at),this.tz),s=re(new Date(e.end_at),this.tz);return Math.max(0,t,s-5)}async loadRecordings(){if(!(!this.cameraId||!this.date)){this.loadingRec=!0,this.rec=null;try{const[e,t,s]=await Promise.all([Nn(this.cameraId,this.date).then(i=>({ok:!0,r:i}),i=>({ok:!1,e:i})),Dc(this.cameraId,this.date).catch(()=>({events:[]})),Er(this.cameraId,this.date).catch(()=>({bookmarks:[]}))]);if(this.dayEvents=t.events,this.bookmarks=s.bookmarks,this.activeBookmark=null,!e.ok)throw e.e;this.rec=e.r,this.error=""}catch(e){this.error=w(e)}finally{this.loadingRec=!1}}}get markers(){return this.dayEvents.map(e=>({minute:re(new Date(e.occurred_at),this.tz),kind:Rc(e.type),label:`${ee[e.type]??e.type}${e.confidence==="inferred"?" (מהקלטה)":""}${e.count>1?` ×${e.count}`:""}`}))}get bookmarkMarkers(){return this.bookmarks.map(e=>({id:e.id,minute:re(new Date(e.from_at),this.tz),endMinute:re(new Date(e.to_at),this.tz),label:`תיק „${e.case_title}”${e.note?` · ${e.note}`:""} · ${Mr[e.preservation]}`,preservation:e.preservation}))}async loadBookmarks(){if(!(!this.cameraId||!this.date))try{this.bookmarks=(await Er(this.cameraId,this.date)).bookmarks}catch{}}bookmarkAt(e){this.cameraId&&(this.casePick={kind:"clip",camera_id:this.cameraId,...da(Je(this.date,e,this.tz),10,20),note:"סימנייה"})}get segmentsMin(){return this.rec?this.rec.segments.map(e=>{const t=re(new Date(e.start_at),this.tz);let s=re(new Date(e.end_at),this.tz);return s<t&&(s=1440),{startMin:t,endMin:s,kind:e.kind==="continuous"?"continuous":"motion"}}):[]}inRecording(e){return this.segmentsMin.some(t=>e>=t.startMin&&e<=t.endMin)}get limitMinute(){return this.date===Xe(new Date,this.tz)?re(new Date,this.tz):1440}cameraName(e){return this.cams?.find(t=>t.id===e)?.name??e}async startAt(e){if(!(!this.cameraId||this.busy)){this.busy=!0,this.error="",this.notice="",this.scrubbing=!1;try{const t=e.toISOString().replace(/\.\d{3}Z$/,"Z");if(this.groupMode){const s=performance.now(),i=this.group&&this.group.sessions.some(n=>!It.includes(n.state))?await Qp(this.group.id,t):await Xp(this.members,t);this.group=i;for(const n of i.sessions)this.seekSentAt[n.camera_id]=s,delete this.firstPlayAt[n.camera_id];this.session=null,this.position=new Date(i.requested_at);const a=Object.keys(i.missing);a.length&&(this.notice=`ללא הקלטה בזמן הזה: ${a.map(n=>this.cameraName(n)).join(", ")}`)}else{const s=this.session&&!It.includes(this.session.state)?await Pr(this.session.id,t):await Ca(this.cameraId,t);this.session=s,this.group=null,this.position=new Date(s.requested_at),s.moved_to_next_segment&&(this.notice=`אין הקלטה בזמן שנבחר; הניגון התחיל בקטע הבא (${this.fmt(new Date(s.requested_at))}).`)}if(this.cursor=re(this.position,this.tz),this.paused=!1,this.tileStatus={},this.drifts={},this.resetClock(),!this.isConnected){await this.endSession();return}}catch(t){if(t instanceof fe&&t.body.code==="no_recording")this.notice="אין הקלטה בזמן הזה ובשש השעות שאחריו: פער בכיסוי, לא מדלגים ל־Live.",this.position=e;else if(t instanceof fe&&(t.body.code==="session_over"||t.body.code==="not_found")){this.session=null,this.group=null,this.busy=!1,await this.startAt(e);return}else this.error=w(t)}finally{this.busy=!1}}}async endSession(){const e=this.session,t=this.group;this.session=null,this.group=null,this.tileStatus={},this.drifts={},this.resetClock();try{t?await eh(t.id):e&&!It.includes(e.state)&&await Bs(e.id)}catch{}}async toggleExtra(e){const t=this.extra.includes(e)?this.extra.filter(i=>i!==e):[...this.extra,e].slice(-3),s=this.currentInstant();await this.endSession(),this.extra=t,s&&await this.startAt(s)}players(){return Array.from(this.renderRoot.querySelectorAll("sw-live-player"))}masterPlayer(){return this.players().find(e=>e.dataset.camera===this.cameraId)??this.players()[0]}currentInstant(){const e=this.masterSession;if(!e)return this.position;if(this.groupMode&&this.clock)return new Date(this.clockNow());const t=new Date(e.requested_at).getTime();return new Date(t+(this.masterPlayer()?.mediaTime??0)*1e3)}tick(){if(!this.masterSession||this.paused||this.scrubbing)return;if(this.groupMode&&this.group){this.tickGroup();return}const t=this.masterPlayer();if(!t||t.status!=="playing")return;const s=this.currentInstant();s&&(this.position=s,this.cursor=re(s,this.tz),t.stale&&t.bufferAhead<.4&&!this.busy&&this.startAt(s))}resetClock(){this.clock=null,this.clockPausedAt=0,this.barrier=this.groupMode?"waiting":"none",this.driftSamples={},this.lateSince={},this.resyncAt={},this.resyncs={},this.nudges={};for(const e of this.players())e.rate=1;this.groupMode&&(this.speed=1),this.syncStats=null,this.groupStartedAt=performance.now(),this.lastReport=0}clockNow(){const e=this.clock;return e.baseMs+((this.paused&&this.clockPausedAt?this.clockPausedAt:performance.now())-e.startedAt)}tickGroup(){const e=this.group,t=performance.now(),s=this.players().map(l=>{const p=l.dataset.camera??"",h=e.sessions.find(m=>m.camera_id===p);return{cid:p,p:l,sess:h,at:h?new Date(h.requested_at).getTime()+l.mediaTime*1e3:NaN}}).filter(l=>l.sess&&!It.includes(l.sess.state)),i=s.filter(l=>l.p.status==="playing");if(!this.clock){const l=s.length>0&&i.length===s.length,p=t-this.groupStartedAt>12e3&&i.length>0;if(!l&&!p){this.barrier="waiting";return}const h=i.find(m=>m.cid===this.cameraId)??i[0];this.clock={baseMs:h.at,startedAt:t},this.barrier="passed",this.driftSamples={},this.lateSince={}}let a=this.clockNow();if(i.length>=3){const l=i.map(p=>p.at).sort((p,h)=>p-h);a=l[Math.floor(l.length/2)]}else i.length&&(a=(i.find(l=>l.cid===this.cameraId)??i[0]).at);this.clock={baseMs:a,startedAt:t};const n=new Date(a);this.position=n,this.cursor=re(n,this.tz);const o={};for(const l of s){if(l.p.status!=="playing"){o[l.cid]=NaN,this.lateSince[l.cid]||(this.lateSince[l.cid]=t);continue}delete this.lateSince[l.cid];const p=(l.at-a)/1e3;o[l.cid]=p;const h=this.driftSamples[l.cid]??=[];if(h.push(p),h.length>40&&h.shift(),h.length>=2&&Math.abs(p)>.25&&Math.abs(p)<=3){const m=p<0?Math.abs(p)>1?1.15:1.05:Math.abs(p)>1?.85:.95;l.p.rate!==m&&(this.nudges[l.cid]=(this.nudges[l.cid]??0)+1),l.p.rate=m}else(Math.abs(p)<=.25||Math.abs(p)>3)&&(l.p.rate=1);l.cid!==this.cameraId&&h.length>=4&&h.slice(-4).every(m=>Math.abs(m)>3)&&(this.resyncs[l.cid]??0)<2&&t-(this.resyncAt[l.cid]??0)>2e4&&this.resyncMember(l.cid,a)}this.drifts=o,this.syncStats=this.computeSync(s.map(l=>l.cid),t),t-this.lastReport>5e3&&this.syncStats.samples>=4&&(this.lastReport=t,th(e.id,this.syncStats).catch(()=>{}))}computeSync(e,t){const s={};let i=null,a=0;for(const p of e){const h=this.driftSamples[p]??[],m=h.length?dh(h):null,g=this.lateSince[p]?t-this.lateSince[p]>8e3:!1;s[p]={p95:m,samples:h.length,last:h.length?h[h.length-1]:null,resyncs:this.resyncs[p]??0,state:g?"late":h.length?"measured":"waiting",latency_ms:this.startLatency[p]??null,nudges:this.nudges[p]??0},a+=h.length,m!==null&&(i=i===null?m:Math.max(i,m))}const n=Object.keys(this.group?.missing??{}),o=Object.values(s).some(p=>p.state==="late"),l=this.barrier!=="passed"||i===null?"waiting":i<=.5?"synced":i<=2?"slight":"out_of_sync";return{p95:i,quality:l,samples:a,partial:n.length>0||o,missing:n,members:s}}async resyncMember(e,t){const s=this.group,i=s?.sessions.find(n=>n.camera_id===e);if(!s||!i||It.includes(i.state))return;this.resyncAt[e]=performance.now(),this.resyncs[e]=(this.resyncs[e]??0)+1,this.driftSamples[e]=[];const a=Math.min(this.startLatency[e]??4e3,15e3);try{const n=await Pr(i.id,new Date(t+a).toISOString().replace(/\.\d{3}Z$/,"Z"));this.group===s&&(this.group={...s,sessions:s.sessions.map(o=>o.id===n.id?n:o)}),this.seekSentAt[e]=performance.now(),delete this.firstPlayAt[e]}catch{}}syncLabel(){const e=this.syncStats;if(this.barrier==="waiting"||!e||e.quality==="waiting")return"סנכרון: ממתין לחסם הפתיחה";const t=e.p95===null?"—":`${e.p95.toFixed(2)} ש׳`;return`סנכרון: ${{synced:"מסונכרן",slight:"סטייה קלה",out_of_sync:"לא מסונכרן",waiting:""}[e.quality]} · p95 ${t}${e.partial?" · חלקי":""}`}async onSeek(e){const t=e.detail.minute,s=Je(this.date,t,this.tz);if(s.getTime()>Date.now()){this.notice="לא ניתן לנגן זמן עתידי.",this.scrubbing=!1;return}this.cursor=t,e.detail.alt&&this.bookmarkAt(t),await this.startAt(s)}onScrub(e){this.scrubbing=!0,this.cursor=e.detail.minute,this.position=Je(this.date,e.detail.minute,this.tz)}async nudge(e){const t=this.currentInstant();t&&await this.startAt(new Date(t.getTime()+e*1e3))}setSpeed(e){if(this.groupMode||e>1)return;this.speed=e;const t=this.masterPlayer();t&&(t.rate=e)}stepFrame(e){const t=this.masterPlayer(),s=this.cams?.find(n=>n.id===this.cameraId),i=s?.stream?.fps&&s.stream.fps>0?s.stream.fps:25;if(!t)return;if(!t.stepFrame(e,i)){this.notice="הפריים המבוקש מחוץ למאגר שכבר הגיע מה־NVR — השתמש בקפיצה של 10 שניות או בציר הזמן.";return}this.notice="";const a=this.currentInstant();a&&(this.position=a,this.cursor=re(a,this.tz))}togglePause(){const e=this.players();if(e.length){if(this.paused){const t=this.masterPlayer();if(!this.groupMode&&t?.stale&&this.position){this.startAt(this.position);return}e.forEach(s=>s.resume()),this.clock&&this.clockPausedAt&&(this.clock={...this.clock,startedAt:this.clock.startedAt+(performance.now()-this.clockPausedAt)}),this.clockPausedAt=0}else e.forEach(t=>t.pause()),this.clockPausedAt=performance.now();this.paused=!this.paused}}onTilePlayer(e,t){if(this.tileStatus={...this.tileStatus,[e]:t.detail.status},t.detail.status==="playing"&&this.seekSentAt[e]&&!this.firstPlayAt[e]&&(this.firstPlayAt[e]=performance.now(),this.startLatency[e]=this.firstPlayAt[e]-this.seekSentAt[e]),e===this.cameraId){if(this.masterSession&&t.detail.status==="playing"&&(this.session&&(this.session={...this.session,state:"playing"}),!this.groupMode&&this.speed!==1)){const s=this.masterPlayer();s&&s.rate!==this.speed&&(s.rate=this.speed)}if(t.detail.status==="ended"){const s=this.currentInstant(),i=this.masterSession;s&&i&&new Date(i.playback_end_at).getTime()-s.getTime()<5e3&&this.startAt(new Date(new Date(i.playback_end_at).getTime()+1e3))}}}fmt(e){return new Intl.DateTimeFormat("he-IL",{timeZone:this.tz,hour:"2-digit",minute:"2-digit",second:"2-digit",hourCycle:"h23"}).format(e)}openExport(){const e=Math.floor(this.cursor*60)/60;this.exportFrom=fs(Math.max(0,e-1)),this.exportTo=fs(Math.min(this.limitMinute,e+1)),this.estimate=null,this.exportJob=null,this.exportError="",this.exportOpen=!0}exportRange(){const e=Je(this.date,Ui(this.exportFrom),this.tz),t=Je(this.date,Ui(this.exportTo),this.tz);return t.getTime()<=e.getTime()?(this.exportError="זמן הסיום חייב להיות אחרי ההתחלה.",null):[e.toISOString().replace(/\.\d{3}Z$/,"Z"),t.toISOString().replace(/\.\d{3}Z$/,"Z")]}async runEstimate(){const e=this.exportRange();if(e){this.exportBusy=!0,this.exportError="";try{this.estimate=await Ir(this.cameraId,e[0],e[1])}catch(t){this.exportError=w(t)}finally{this.exportBusy=!1}}}async runExport(){const e=this.exportRange();if(e){this.exportBusy=!0,this.exportError="";try{const t=this.estimate??await Ir(this.cameraId,e[0],e[1]);if(this.estimate=t,!t.files){this.exportError="אין קבצים מוקלטים בטווח שנבחר.";return}this.exportJob=await sh(this.cameraId,e[0],e[1])}catch(t){this.exportError=w(t)}finally{this.exportBusy=!1}}}renderExportDialog(){const e=this.estimate,t=this.exportJob;return r`<sw-dialog ?open=${this.exportOpen} heading="ייצוא קטע" subheading=${`${this.cameraName(this.cameraId)} · ${this.date} · ${this.tz}`} @close=${()=>this.exportOpen=!1}>
      <div class="dlg">
        ${t?r`<div class="est"><strong>עבודת הייצוא נוצרה</strong><span>${t.files.length} קבצים · משוער ${Xt(t.estimate_bytes)} · מצב: ${t.state}</span><span>ה־NVR עדיין מכין את הקובץ; "מעקב והורדה" למטה עובר למסך שבו כפתור ההורדה יופיע ברגע שהוא מוכן.</span></div>`:r`
              ...
              ${e?r`<div class="est">
                    <span>${e.files} קבצי NVR בטווח · נפח משוער ${Xt(e.estimate_bytes)} (מקסימום ${Xt(e.max_bytes)}) · כיסוי ${e.coverage==="complete"?"מלא":"חלקי"}</span>
      ...
      <div class="filters">
        ...
        ${this.activeBookmark?r`<sw-chip selected icon="case" data-bookmark-active @click=${()=>$(`/investigate/cases/${this.activeBookmark.case_id}`)}>תיק „${this.activeBookmark.case_title}”${this.activeBookmark.note?` · ${this.activeBookmark.note}`:""} · ${Mr[this.activeBookmark.preservation]} · פתח</sw-chip>`:d}
        ...
        ${this.error?r`<span class="err">${this.error}</span>`:d}
        <span class="grow"></span>
        <sw-button size="sm" icon="case" data-add-to-case title="סימנייה בנקודה הנוכחית · Alt+לחיצה על הציר מסמנת נקודה אחרת" ?disabled=${!this.cameraId} @click=${()=>this.casePick={kind:"clip",camera_id:this.cameraId,...da(Je(this.date,this.cursor,this.tz))}}>הוסף לתיק</sw-button>
    ...
    `}seekDemo(e){this.cursor=e.detail.minute,this.generation+=1}renderDemo(){const e=X.find(i=>i.id===this.demoCamera)??X[0],t=!oi.some(i=>this.cursor>=i.startMin&&this.cursor<=i.endMin),s=ot.filter(i=>i.minuteOfDay<1440).filter(i=>this.filter==="all"||i.type===this.filter).map(i=>({minute:i.minuteOfDay,kind:i.type,label:i.title}));return r`
      ...
      <sw-timeline .segments=${oi} .events=${s} .cursor=${this.cursor} precision="estimated" @seek=${this.seekDemo}></sw-timeline>
      <div class="filters">
    ...
    `}render(){const e=y(),t=e?this.cams?.find(o=>o.id===this.cameraId):X.find(o=>o.id===this.demoCamera)??X[0],s=t?.name??"הקלטות",i=e?`${this.date} ${fs(this.cursor)} · אזור זמן ${this.tz}`:`14.09.2026 ${De(this.cursor)} · אזור זמן האתר Asia/Jerusalem · נתוני הדגמה`,a=e?"הקלטות":`הקלטות | ${t?.floor??""}`,n=e?Xe(new Date,this.tz):"2026-09-14";return r`
      <sw-page heading=${s} subheading=${i} crumbs=${a} wide>
        <div slot="actions" class="pick">
          ...
          <sw-field style="inline-size:132px"><input type="time" step="1" .value=${e?fs(this.cursor):De(this.cursor)} data-ltr aria-label="שעה" @change=${o=>{const l=o.target.value;if(e)this.onSeek(new CustomEvent("seek",{detail:{minute:Ui(l)}}));else{const[p,h]=l.split(":").map(Number);this.cursor=p*60+h,this.generation+=1}}} /></sw-field>
        </div>
  ...
  `;B([f()],O.prototype,"cameraId",2);B([f()],O.prototype,"at",2);B([f()],O.prototype,"extraParam",2);B([c()],O.prototype,"demoCamera",2);B([c()],O.prototype,"cursor",2);B([c()],O.prototype,"generation",2);B([c()],O.prototype,"playing",2);B([c()],O.prototype,"speed",2);B([c()],O.prototype,"filter",2);B([c()],O.prototype,"cams",2);B([c()],O.prototype,"tz",2);B([c()],O.prototype,"date",2);B([c()],O.prototype,"rec",2);B([c()],O.prototype,"dayEvents",2);B([c()],O.prototype,"bookmarks",2);B([c()],O.prototype,"activeBookmark",2);B([c()],O.prototype,"loadingRec",2);B([c()],O.prototype,"session",2);B([c()],O.prototype,"group",2);B([c()],O.prototype,"extra",2);B([c()],O.prototype,"casePick",2);B([c()],O.prototype,"preview",2);B([c()],O.prototype,"busy",2);B([c()],O.prototype,"error",2);B([c()],O.prototype,"notice",2);B([c()],O.prototype,"tileStatus",2);B([c()],O.prototype,"drifts",2);B([c()],O.prototype,"clock",2);B([c()],O.prototype,"barrier",2);B([c()],O.prototype,"syncStats",2);B([c()],O.prototype,"paused",2);B([c()],O.prototype,"scrubbing",2);B([c()],O.prototype,"position",2);B([c()],O.prototype,"exportOpen",2);B([c()],O.prototype,"exportFrom",2);B([c()],O.prototype,"exportTo",2);B([c()],O.prototype,"estimate",2);B([c()],O.prototype,"exportJob",2);B([c()],O.prototype,"exportBusy",2);B([c()],O.prototype,"exportError",2);O=B([E("investigate-playback")],O);var ch=Object.defineProperty,ph=Object.getOwnPropertyDescriptor,Et=(e,t,s,i)=>{for(var a=i>1?void 0:i?ph(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&ch(t,s,a),a};const Cr="sw.sync.recent";function Zi(e){const t=s=>String(s).padStart(2,"0");return`${e.getFullYear()}-${t(e.getMonth()+1)}-${t(e.getDate())}T${t(e.getHours())}:${t(e.getMinutes())}:${t(e.getSeconds())}`}let st=class extends z{constructor(){super(...arguments),this.cursor=615,this.playing=!1,this.cams=null,this.picked=[],this.when=Zi(new Date(Date.now()-10*6e4)),this.recent=[],this.error=""}connectedCallback(){if(super.connectedCallback(),!!y()){try{this.recent=JSON.parse(localStorage.getItem(Cr)??"[]")}catch{this.recent=[]}this.load()}}async load(){try{const e=await Le();this.cams=e.cameras.filter(t=>t.enabled&&t.can_view_live!==!1),this.error=""}catch(e){this.error=w(e),this.cams=[]}}toggle(e){this.picked=this.picked.includes(e)?this.picked.filter(t=>t!==e):this.picked.length>=4?this.picked:[...this.picked,e]}launch(e=this.picked,t){if(e.length<2)return;const s=t??new Date(this.when).toISOString(),i={cameras:e,at:s,opened:new Date().toISOString()},a=this.recent.filter(n=>n.cameras.join(",")!==e.join(","));this.recent=[i,...a].slice(0,6);try{localStorage.setItem(Cr,JSON.stringify(this.recent))}catch{}$("/investigate/playback",{camera:e[0],extra:e.slice(1).join(","),t:s})}name(e){return this.cams?.find(t=>t.id===e)?.name??e}renderApi(){const e=this.cams;return r`
        ...
        ${e===null?r`<sw-state-panel state="loading" heading="טוען מצלמות…"></sw-state-panel>`:r`
            ...
            <sw-card heading="זמן התחלה" subheading="זמן מקומי של הדפדפן; ההקלטה נפתחת מהפריים הקרוב ביותר">
              <div class="transport">
                ...
                <sw-button size="sm" @click=${()=>this.when=Zi(new Date(Date.now()-10*6e4))}>לפני 10 דק׳</sw-button>
                <sw-button size="sm" @click=${()=>this.when=Zi(new Date(Date.now()-60*6e4))}>לפני שעה</sw-button>
                <span class="grow"></span>
    ...
    `}render(){if(y())return this.renderApi();const e=[{cam:X[0],drift:"+0.2s",state:"recorded"},{cam:X[9],drift:"-0.4s",state:"recorded"},{cam:X[3],drift:"gap",state:"unknown"},{cam:X[1],drift:"buffering",state:"stale"}];return r`
      <sw-page heading="מרכז שליטה" subheading="ניטור חי עם ניגון מסונכרן · 4 מקורות · שעון ייחוס אחד · נתוני הדגמה" wide>
        ...
        <sw-timeline .segments=${oi} .events=${ot.slice(0,4).map(t=>({minute:t.minuteOfDay,kind:t.type,label:t.title}))} .cursor=${this.cursor} precision="estimated" @seek=${t=>this.cursor=t.detail.minute}></sw-timeline>
        <div class="filters">
  ...
  `;Et([c()],st.prototype,"cursor",2);Et([c()],st.prototype,"playing",2);Et([c()],st.prototype,"cams",2);Et([c()],st.prototype,"picked",2);Et([c()],st.prototype,"when",2);Et([c()],st.prototype,"recent",2);Et([c()],st.prototype,"error",2);st=Et([E("investigate-sync")],st);var hh=Object.defineProperty,uh=Object.getOwnPropertyDescriptor,de=(e,t,s,i)=>{for(var a=i>1?void 0:i?uh(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&hh(t,s,a),a};const qi=10;function mh(e){return e==="person"||e==="vehicle"||e==="motion"||e==="line"||e==="offline"||e==="door"?e:"motion"}let ie=class extends z{constructor(){super(...arguments),this.floorId="f0",this.at="",this.camera="",this.minute=615,this.tz="Asia/Jerusalem",this.date="",this.tree=null,this.bundle=null,this.events=[],this.recordings=new Map,this.selectedId=null,this.loading=!1,this.error="",this.frameAt="",this.frameFailed=!1,this.casePick=null,this.geometry=null,this.geomSeq=0,this.frameTimer=0}connectedCallback(){super.connectedCallback(),y()&&this.init()}updated(e){y()&&(e.has("floorId")&&e.get("floorId")!==void 0||e.has("at")&&e.get("at")!==void 0)&&this.init()}async init(){this.loading=!0,this.error="";try{const[e,t]=await Promise.all([Ve(),this.tree?Promise.resolve(this.tree):Mt()]);if(this.tz=e["time.zone"]??this.tz,this.tree=t,y()&&this.floors.length&&!this.floors.some(i=>i.id===this.floorId)){const i=new URLSearchParams(window.location.hash.split("?")[1]??"").toString();window.location.replace(`#/investigate/floors/${this.floors[0].id}/history${i?`?${i}`:""}`);return}const s=this.at?new Date(this.at):new Date;if(this.date=Xe(s,this.tz),this.minute=re(s,this.tz),this.bundle=await Os(this.floorId,!1,this.instant.toISOString().replace(/\.\d{3}Z$/,"Z")),this.geometry=null,this.updateGeometry(),this.scheduleFrame(),this.camera){const i=this.bundle.anchors.find(a=>a.resource_type==="camera"&&a.resource_id===this.camera);this.selectedId=i?.id??null}await this.loadDay()}catch(e){this.error=w(e)}finally{this.loading=!1}}async loadDay(){const e=this.bundle;if(!e)return;const t=e.anchors.filter(n=>n.resource_type==="camera").map(n=>n.resource_id),[s,i]=await Promise.all([Si({date:this.date,limit:1e3}).then(n=>n.events.filter(o=>o.camera_id&&t.includes(o.camera_id))).catch(()=>[]),Promise.allSettled(t.map(n=>Nn(n,this.date)))]);this.events=s;const a=new Map;t.forEach((n,o)=>{const l=i[o];a.set(n,l.status==="fulfilled"?l.value:null)}),this.recordings=a}get instant(){return Je(this.date,this.minute,this.tz)}segmentsFor(e){const t=this.recordings.get(e);return t?t.segments.map(s=>{const i=re(new Date(s.start_at),this.tz);let a=re(new Date(s.end_at),this.tz);return a<i&&(a=1440),{startMin:i,endMin:a,kind:s.kind==="continuous"?"continuous":"motion"}}):null}coverageAt(e){const t=this.segmentsFor(e);if(!t)return{state:"unknown"};const s=t.find(i=>this.minute>=i.startMin&&this.minute<=i.endMin);return s?{state:"historic",segment:s}:{state:"unknown"}}eventsNear(e,t=qi){const s=this.instant.getTime();return this.events.filter(i=>(!e||i.camera_id===e)&&Math.abs(new Date(i.occurred_at).getTime()-s)<=t*60*1e3).sort((i,a)=>Math.abs(new Date(i.occurred_at).getTime()-s)-Math.abs(new Date(a.occurred_at).getTime()-s))}get apiMarkers(){const e=this.bundle;return e?e.anchors.map(t=>{if(t.resource_type==="camera"){const a=this.coverageAt(t.resource_id),n=this.eventsNear(t.resource_id,5).length,o=t.camera?.name??t.label??t.resource_id;return{id:t.id,kind:"camera",label:n?`${o} · ${n} אירועים`:o,x:t.position.x,y:t.position.y,rotation:t.rotation_degrees,fov:t.field_of_view_degrees??void 0,radius:t.coverage_radius??void 0,polygon:t.coverage_polygon?t.coverage_polygon.map(([l,p])=>({x:l,y:p})):void 0,labelPos:t.label_pos??void 0,state:a.state}}const s=t.entity?.state_at,i=xs(t);return{id:t.id,kind:_i(t.layer_id,t.entity?.domain),label:s?.known&&s.state?`${i} · ${_t({...t.entity??{domain:"",unit:null,device_class:null,attributes:{}},state:s.state})}`:i,x:t.position.x,y:t.position.y,state:s?.known?"historic":"unknown"}}):[]}get selectedAnchor(){return this.bundle?.anchors.find(e=>e.id===this.selectedId)??null}get limitMinute(){return this.date===Xe(new Date,this.tz)?re(new Date,this.tz):1440}setMinute(e){this.minute=Math.max(0,Math.min(this.limitMinute,e)),this.scheduleFrame()}scheduleFrame(){window.clearTimeout(this.frameTimer),this.frameTimer=window.setTimeout(()=>{this.frameAt=this.instant.toISOString().replace(/\.\d{3}Z$/,"Z"),this.frameFailed=!1,this.ensureVersion()},600)}async updateGeometry(){const e=this.bundle,t=++this.geomSeq;if(!e||e.source!=="api"||!e.planVersionId){this.geometry=null;return}const s=this.instant.toISOString().replace(/\.\d{3}Z$/,"Z"),i=e.history==="exact"?await zd(e.planVersionId,s):await Sa(e);t===this.geomSeq&&(this.geometry=i)}async ensureVersion(){const e=this.bundle;if(!e||e.source!=="api"||!e.at)return;const t=this.instant.toISOString().replace(/\.\d{3}Z$/,"Z");if(e.history==="current"?!e.historyFrom||t<e.historyFrom:(!e.planPublishedAt||e.planPublishedAt<=t)&&(!e.planArchivedAt||t<e.planArchivedAt)){this.updateGeometry();return}try{const i=await Os(this.floorId,!1,t),a=e.anchors.map(n=>n.resource_id).sort().join(",");this.bundle=i,i.planVersionId!==e.planVersionId&&(this.geometry=null),this.updateGeometry(),this.selectedId&&!i.anchors.some(n=>n.id===this.selectedId)&&(this.selectedId=null),i.anchors.map(n=>n.resource_id).sort().join(",")!==a&&await this.loadDay()}catch{}}renderEntityStates(e){const t=e.anchors.filter(a=>a.resource_type==="ha_entity");if(!t.length)return r`אין ישויות מוצבות בקומה`;const s=t.filter(a=>a.entity?.state_at?.known),i=e.haHistory;return r`${s.length} מתוך ${t.length} ידועות בזמן זה${i?.from?r` <span class="note">(היסטוריה מקומית מ־<span class="ltr">${this.fmtWhen(i.from)}</span>, ${i.retention_days} ימים)</span>`:r` <span class="note">(אין עדיין היסטוריה מקומית)</span>`}
      ...
      <sw-card heading="בנקודת הזמן שנבחרה" subheading="זמן ונתונים מאותו רגע" data-history-panel>
        <dl>
          ...
          ${s&&this.frameAt?r`<dt>פריים</dt><dd><div class="frame" data-history-frame>${this.frameFailed?r`<span>אין פריים בהקלטה בזמן זה</span>`:r`<img src=${Mi(s.resource_id,this.frameAt)} alt="פריים מההקלטה בזמן שנבחר" @error=${()=>this.frameFailed=!0} />`}</div></dd>`:d}
        ...
        <div style="display:flex;gap:8px;flex-wrap:wrap;margin-block-start:10px">
          ...
          <sw-button size="sm" icon="case" data-add-to-case ?disabled=${!s} title=${s?"קטע של המצלמה הנבחרת סביב הזמן שנבחר (15 שניות לפני, 45 אחרי)":"בחר מצלמה במפה"} @click=${()=>{s&&(this.casePick={kind:"clip",camera_id:s.resource_id,...da(this.instant)})}}>הוסף לתיק</sw-button>
        </div>
      </sw-card>
      ...
      <sw-card heading="אירועים סביב הזמן" subheading=${`±${qi} דקות · מצלמות הקומה`}>
      ...
      <div class="head">
        ...
        <span class="grow"></span>
        ${this.floors.length>1?r`<sw-field><select aria-label="קומה" @change=${a=>$(`/investigate/floors/${a.target.value}`,{t:this.instant.toISOString()})}>${this.floors.map(a=>r`<option value=${a.id} ?selected=${a.id===this.floorId}>${Vt(a.name)}</option>`)}</select></sw-field>`:d}
    ...
    `}get demoMarkers(){const e=i=>i==="cam-3"||this.minute>=190&&this.minute<=205?"unknown":"historic",t=ys.filter(i=>i.floorId===this.floorId).map(i=>({id:i.id,kind:"camera",label:i.name,x:i.x,y:i.y,rotation:i.rotation,fov:i.fov,state:i.state==="forbidden"?"forbidden":e(i.id)})),s=ei.filter(i=>i.floorId===this.floorId).map((i,a)=>({id:i.id,kind:i.domain,label:i.name,x:i.x,y:i.y,state:a%2?"unknown":"historic"}));return[...t,...s]}renderDemo(){const e=kt.find(t=>t.id===this.floorId)??kt[0];return r`
      <div class="head">
        <div><h1>מפה היסטורית · ${Vt(e.name)}</h1><div class="sub">מצב המפה בזמן נבחר · פעולות פיזיות כבויות בחקירה · נתוני הדגמה</div></div>
        <span class="grow"></span>
      ...
      <div class="stage alone">
        <sw-plan-canvas .planWidth=${e.planWidth} .planHeight=${e.planHeight} .plan=${ln(e.id)} .markers=${this.demoMarkers}></sw-plan-canvas>
  ...
  `;de([f()],ie.prototype,"floorId",2);de([f()],ie.prototype,"at",2);de([f()],ie.prototype,"camera",2);de([c()],ie.prototype,"minute",2);de([c()],ie.prototype,"tz",2);de([c()],ie.prototype,"date",2);de([c()],ie.prototype,"tree",2);de([c()],ie.prototype,"bundle",2);de([c()],ie.prototype,"events",2);de([c()],ie.prototype,"recordings",2);de([c()],ie.prototype,"selectedId",2);de([c()],ie.prototype,"loading",2);de([c()],ie.prototype,"error",2);de([c()],ie.prototype,"frameAt",2);de([c()],ie.prototype,"frameFailed",2);de([c()],ie.prototype,"casePick",2);de([c()],ie.prototype,"geometry",2);ie=de([E("investigate-history-map")],ie);var fh=Object.defineProperty,gh=Object.getOwnPropertyDescriptor,W=(e,t,s,i)=>{for(var a=i>1?void 0:i?gh(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&fh(t,s,a),a};const wh={person:"#2f6bff",vehicle:"#22c55e",motion:"#ef4444",line:"#f59e0b",offline:"#6b7280",door:"#8b5cf6"},Dr={"כניסה ראשית":"entrance","חצר אחורית":"backyard",מחסן:"warehouse",לובי:"lobby","חניה מקורה":"parking","מסדרון מזרחי":"corridor"},vh={info:"מידע",alert:"התראה",critical:"קריטי"};let H=class extends z{constructor(){super(...arguments),this.cameraId="",this.date="",this.initialMode="",this.selected=null,this.filter="all",this.cams=null,this.tz="Asia/Jerusalem",this.type="",this.events=null,this.ingest=null,this.live=!1,this.error="",this.busy=!1,this.thumbVersion=new Map,this.player=null,this.mode="raw",this.windows=null,this.windowGap=180,this.windowBy="camera",this.selectedWindow=null,this.windowsBusy=!1,this.facets=null,this.placeFloor="",this.placeZone="",this.source="",this.unsupported=[],this.q="",this.rangeDays=1,this.qTimer=0,this.thumbTimers=new Map,this.thumbInFlight=0,this.rowPreview=null,this.rowPreviewTimer=0,this.windowColumns=[{key:"thumb",label:"",width:"72px",render:e=>this.renderWindowThumb(e)},{key:"title",label:"חלון אירוע",render:e=>{const t=e;return r`<span class="ty" style="--tone:${si[t.dominant_type]??"#6b7280"}"><i></i>${ee[t.dominant_type]??t.dominant_type}${t.count>1?r` <span class="sub">×${String(t.count)}</span>`:d}</span><div class="sub">${Object.entries(t.types).map(([s,i])=>`${ee[s]??s} ${i}`).join(" · ")} · ${t.confidence==="inferred"?"נגזר מהקלטה":"התראות מה־NVR"}</div>`}},{key:"camera_name",label:"מצלמה / קבוצה",render:e=>{const t=e;return r`${t.camera_name??(t.channel?`ערוץ ${t.channel}`:"מערכת")}${t.group&&t.group!=="camera"&&t.camera_names?.length?r`<div class="sub">${t.camera_names.join(" · ")}</div>`:d}`}},{key:"start",label:"זמן",render:e=>{const t=e;return r`${this.fmt(t.start)}${t.end!==t.start?r` – ${this.fmt(t.end)}`:d}<div class="sub">${this.fmtDate(t.start)}</div>`}},{key:"acked",label:"מצב",render:e=>{const t=e;return r`<sw-badge kind=${t.acked?"live":t.acked_count?"stale":"neutral"} label=${t.acked?"טופל":t.acked_count?`בטיפול ${t.acked_count}/${t.count}`:"חדש"}></sw-badge>`}}],this.apiColumns=[{key:"thumb",label:"",width:"72px",render:e=>this.renderThumb(e)},{key:"type",label:"אירוע",render:e=>r`<span class="ty" style="--tone:${si[e.type]??"#6b7280"}"><i></i>${ee[e.type]??String(e.type)}${Number(e.count)>1?r` <span class="sub">×${String(e.count)}</span>`:d}</span><div class="sub">${e.source==="ha"?"חיישן HA":e.source==="system"?"מערכת":e.confidence==="inferred"?"נגזר מהקלטה":"התראה מה־NVR"} · ${e.acked_at?`טופל · ${String(e.acked_by_username??"")}`:"ממתין לטיפול"}</div>`},{key:"camera_name",label:"מצלמה",render:e=>r`${String(e.camera_name??(e.channel?`ערוץ ${String(e.channel)}`:"מערכת"))}<div class="sub ltr">${String(e.raw_type)}</div>`},{key:"occurred_at",label:"זמן",render:e=>r`${this.fmt(String(e.occurred_at))}<div class="sub">${this.fmtDate(String(e.occurred_at))}${e.ended_at?` · עד ${this.fmt(String(e.ended_at))}`:""}</div>`},{key:"severity",label:"חומרה",render:e=>r`<sw-badge kind=${e.severity==="critical"?"error":e.severity==="alert"?"stale":"neutral"} label=${vh[e.severity]??String(e.severity)}></sw-badge>`}],this.columns=[{key:"thumb",label:"תמונה",width:"80px",render:e=>e.type==="offline"||e.type==="door"?r`<div class="thumb none"><sw-icon name=${e.type==="offline"?"offline":"door"} size=${14}></sw-icon></div>`:r`<sw-scene class="thumb" kind=${Dr[String(e.camera)]??"lobby"}></sw-scene>`},{key:"title",label:"אירוע",render:e=>r`<span class="ty" style="--tone:${wh[e.type]}"><i></i>${ea[e.type]}</span><div class="sub">${String(e.title)} · ${e.acked?"טופל":"ממתין לטיפול"}</div>`},{key:"camera",label:"מצלמה",render:e=>r`${String(e.camera)}<div class="sub">${String(e.floor)}</div>`},{key:"time",label:"זמן",render:e=>r`${String(e.time)}<div class="sub ltr">${String(e.source)}</div>`},{key:"severity",label:"חומרה",render:e=>r`<sw-badge kind=${e.severity==="critical"?"error":e.severity==="alert"?"stale":"neutral"} label=${{info:"מידע",alert:"התראה",critical:"קריטי"}[e.severity]}></sw-badge>`},{key:"more",label:"",width:"40px",render:()=>r`<sw-button variant="ghost" size="sm" iconOnly icon="more" label="עוד"></sw-button>`}]}connectedCallback(){super.connectedCallback(),y()&&(this.init(),this.unsubscribe=Nc(e=>this.onPushed(e),(e,t)=>{this.live=t,e&&(this.ingest=e)}))}disconnectedCallback(){super.disconnectedCallback(),this.unsubscribe?.();for(const e of this.thumbTimers.values())window.clearTimeout(e);this.thumbTimers.clear(),this.stopPlayer()}hoverStart(e,t){if(!e.camera_id||t.pointerType==="touch")return;window.clearTimeout(this.rowPreviewTimer);const s=t.clientX,i=t.clientY;this.rowPreviewTimer=window.setTimeout(()=>{const a=new Date(e.occurred_at).getTime(),n=[-5,0,5].map(o=>{const l=new Date(a+o*1e3).toISOString().replace(/\.\d{3}Z$/,"Z");return{at:l,url:Mi(e.camera_id,l),label:o===0?this.fmt(e.occurred_at):`${o>0?"+":""}${o} ש׳`,failed:!1}});this.rowPreview={id:e.id,x:s,y:i,frames:n,camera:e.camera_name??""}},250)}hoverEnd(){window.clearTimeout(this.rowPreviewTimer),this.rowPreview=null}renderRowPreview(){const e=this.rowPreview;if(!e)return d;const t=Math.max(16,Math.min(window.innerWidth-388,e.x-186)),s=e.y+18+230>window.innerHeight?e.y-18-230:e.y+18;return r`<div class="rowpreview" data-row-preview style="left:${t}px;top:${s}px">
      ...
      <div class="wlist" data-window-events>
        ${t.map(s=>r`<a class="wrow" href=${`#/investigate/events/${s.id}`}><span class="ty" style="--tone:${si[s.type]??"#6b7280"}"><i></i>${ee[s.type]??s.type}</span><span class="ltr">${this.fmt(s.occurred_at)}</span><span class="sub">${s.acked_at?"טופל":"ממתין"}</span></a>`)}
      ...
      <div class="filters">
        ...
        <sw-field><select aria-label="מקור" data-filter-source @change=${i=>{this.source=i.target.value,this.load()}}><option value="" ?selected=${!this.source}>כל המקורות</option>${Object.entries(yr).map(([i,a])=>r`<option value=${i} ?selected=${i===this.source}>${a}</option>`)}</select></sw-field>
        <span class="grow"></span>
      ...
      <div class="stage">
        ${this.mode==="windows"?this.windows===null||this.windowsBusy&&!this.windows.length?r`<sw-state-panel state="loading"></sw-state-panel>`:this.windows.length?r`<div class="banner" style="margin-block-end:8px"><sw-icon name="info" size=${14}></sw-icon><span>${this.windowBy==="camera"?"התראות סמוכות באותה מצלמה":this.windowBy==="all"?"התראות סמוכות מכל המצלמות":this.windowBy==="zone"?"התראות סמוכות באותו חדר":"התראות סמוכות באותה קומה"} הופכות לחלון אירוע אחד (מרווח עד ${Math.round(this.windowGap/60)} דק׳). האירועים המקוריים נשמרים לצפייה.</span><span class="grow"></span>
                  <sw-field><select aria-label="קיבוץ" data-window-by @change=${i=>{this.windowBy=i.target.value,this.loadWindows()}}>${Object.keys(br).map(i=>r`<option value=${i} ?selected=${this.windowBy===i}>${br[i]}</option>`)}</select></sw-field>
        ...
        ${e?r`<sw-drawer open heading=${ee[e.type]??e.type} subheading=${`${e.camera_name??(e.channel?`ערוץ ${e.channel}`:"מערכת")} · ${this.fmt(e.occurred_at)}`} @close=${()=>this.closeDrawer()}>
              <div class="big">
                ${this.player?.eventId===e.id&&this.player.session?r`<sw-live-player .wsUrl=${hi(this.player.session)} mode="mse" .retry=${!1}></sw-live-player>`:e.thumbnail==="ready"?r`<img src=${Ot(e.id,this.thumbVersion.get(e.id)??0)} alt="תמונת האירוע מההקלטה" />`:r`<div class="hint">${e.camera_id?e.thumbnail==="unavailable"?"אין פריים זמין בהקלטה בזמן האירוע":this.player?.eventId===e.id?"פותח את ההקלטה…":"מכין תמונה מההקלטה…":"אירוע ללא מצלמה"}</div>`}
    ...
    `}renderDemo(){const e=ot.filter(s=>this.filter==="all"||!s.acked),t=ot.find(s=>s.id===this.selected);return r`
      ...
      <div class="stage">
        ...
        ${t?r`<sw-drawer open heading=${ea[t.type]} subheading=${`${t.camera} · ${t.time}`} @close=${()=>this.selected=null}>
              <div class="preview">${t.type==="offline"||t.type==="door"?"אין תמונה לאירוע זה":r`<sw-scene kind=${Dr[t.camera]??"lobby"}></sw-scene><span class="demo">דמו · תמונת אירוע מה־NVR (T044)</span>`}</div>
              <dl>
        ...
        <div class="layout">
          <div>
            <div class="player" data-player>
              ${this.session?r`<sw-live-player .wsUrl=${hi(this.session)} mode="mse" .retry=${!1}></sw-live-player>`:e.thumbnail==="ready"?r`<img src=${Ot(e.id,this.thumbVersion)} alt="תמונת האירוע מההקלטה" />`:r`<div class="hint">${e.camera_id?this.playerError?`ההקלטה לא נפתחה: ${this.playerError}`:e.thumbnail==="unavailable"?"אין הקלטה זמינה בזמן האירוע":"פותח את ההקלטה…":"אירוע ללא מצלמה — אין וידאו"}</div>`}
          ...
          <div>
            <sw-card heading="הקשר האירוע" data-context>
              <dl class="meta">
                ...
                <dt>מקור</dt><dd>${Tr[e.source]??e.source}${e.camera_id?r` / ${s}`:d} <span class="note" style="margin:0">raw <span class="ltr">${e.raw_type}</span></span></dd>
  ...
  `;ca=kh([E("investigate-reviews")],ca);var zh=Object.defineProperty,Sh=Object.getOwnPropertyDescriptor,U=(e,t,s,i)=>{for(var a=i>1?void 0:i?Sh(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&zh(t,s,a),a};const Mh={open:"stale",in_review:"recorded",closed:"neutral"},Eh={preserved:"recorded",preserving:"partial",nvr_only:"stale",missing:"error",unknown:"unknown",none:"neutral"},Ah=(e,t)=>new Intl.DateTimeFormat("he-IL",{timeZone:t,dateStyle:"short",timeStyle:"short"}).format(new Date(e)),Ph=[{key:"title",label:"תיק",render:e=>r`<strong>${String(e.title)}</strong>${e.tags?r`<div style="font-size:11px;color:var(--sw-text-3)">${String(e.tags)}</div>`:d}`},{key:"status",label:"סטטוס",render:e=>r`<sw-badge kind=${Mh[e.status]} label=${Ss[e.status]}></sw-badge>`},{key:"owner",label:"בעלים"},{key:"items",label:"פריטים"},{key:"preserved",label:"עותקים שמורים",render:e=>r`${String(e.preserved)} מתוך ${String(e.clips)}`},{key:"updated",label:"עודכן",ltr:!0,render:e=>Ah(String(e.updated))}],Ih=[{key:"title",label:"תיק",render:e=>r`<strong>${String(e.title)}</strong>`},{key:"status",label:"סטטוס",render:e=>r`<sw-badge kind=${e.status==="פתוח"?"stale":e.status==="סגור"?"neutral":"recorded"} label=${String(e.status)}></sw-badge>`},{key:"owner",label:"בעלים"},{key:"clips",label:"קטעים"},{key:"notes",label:"הערות"},{key:"preserved",label:"ראיות שמורות",render:e=>r`${e.preserved} שמורות${Number(e.missing)?r` · <span style="color:var(--sw-danger)">${e.missing} חסרות</span>`:""}`},{key:"more",label:"",width:"40px",render:()=>r`<sw-button variant="ghost" size="sm" iconOnly icon="more" label="עוד"></sw-button>`}];let Se=class extends z{constructor(){super(...arguments),this.cases=[],this.canManage=!1,this.loading=!1,this.error="",this.status="all",this.q="",this.creating=!1,this.newTitle="",this.newDesc="",this.newTags="",this.busy=!1,this.qTimer=0}connectedCallback(){super.connectedCallback(),y()&&this.load()}async load(){this.loading=!0,this.error="";try{const e=await On({status:this.status==="all"?void 0:this.status,q:this.q||void 0});this.cases=e.cases,this.canManage=e.can_manage}catch(e){this.error=w(e)}finally{this.loading=!1}}setStatus(e){this.status=e,this.load()}onQuery(e){this.q=e,window.clearTimeout(this.qTimer),this.qTimer=window.setTimeout(()=>void this.load(),250)}async create(){if(this.newTitle.trim()){this.busy=!0,this.error="";try{const e=await Rn({title:this.newTitle.trim(),description:this.newDesc,tags:this.newTags.split(",").map(t=>t.trim()).filter(Boolean)});this.creating=!1,this.newTitle=this.newDesc=this.newTags="",$(`/investigate/cases/${e.id}`)}catch(e){this.error=w(e)}finally{this.busy=!1}}}renderApi(){const e=this.cases.map(t=>({id:t.id,title:t.title,status:t.status,owner:t.owner_username,items:t.counts.items,clips:t.counts.events+t.counts.clips,preserved:t.counts.preserved,updated:t.updated_at,tags:t.tags.join(" · ")}));return r`
      <sw-page heading="תיקים" subheading="קישור להקלטה אינו שימור: ראיה נחשבת שמורה רק אחרי העתקה מאומתת מה־NVR">
        ...
        <div class="bar">
          ${["all","open","in_review","closed"].map(t=>r`<sw-chip ?selected=${this.status===t} @click=${()=>this.setStatus(t)}>${t==="all"?"הכל":Ss[t]}</sw-chip>`)}
          <span class="grow"></span>
    ...
    `}render(){return y()?this.renderApi():r`
      <sw-page heading="תיקים" subheading="קישור להקלטה אינו שימור: ראיה נחשבת שמורה רק אחרי העתקה מאומתת ו־hash · נתוני הדגמה">
        ...
        <sw-table .columns=${Ih} .rows=${sa} @row-select=${e=>$(`/investigate/cases/${e.detail.id}`)}></sw-table>
      </sw-page>
    `}};Se.styles=M`
    .bar {
      display: flex;
  ...
  `;U([c()],Se.prototype,"cases",2);U([c()],Se.prototype,"canManage",2);U([c()],Se.prototype,"loading",2);U([c()],Se.prototype,"error",2);U([c()],Se.prototype,"status",2);U([c()],Se.prototype,"q",2);U([c()],Se.prototype,"creating",2);U([c()],Se.prototype,"newTitle",2);U([c()],Se.prototype,"newDesc",2);U([c()],Se.prototype,"newTags",2);U([c()],Se.prototype,"busy",2);Se=U([E("investigate-cases")],Se);let ae=class extends z{constructor(){super(...arguments),this.caseId="case-1",this.tab="details",this.data=null,this.error="",this.info="",this.busy=!1,this.tz="Asia/Jerusalem",this.noteText="",this.editing=!1,this.editTitle="",this.editDesc="",this.editTags="",this.confirmDelete=!1,this.bundles=[],this.verifyResult=null,this.cams=[],this.snapCam="",this.loadedFor="",this.pollTimer=0}updated(e){e.has("caseId")&&y()&&this.loadedFor!==this.caseId&&this.load()}disconnectedCallback(){super.disconnectedCallback(),window.clearTimeout(this.pollTimer)}async load(){const e=this.caseId;this.loadedFor=e,this.error="";try{const[t,s]=await Promise.all([Ve(),Np(e)]);this.tz=t["time.zone"]??this.tz,this.data=s,this.bundles=(await Up(e).catch(()=>({bundles:[]}))).bundles,this.cams.length||(this.cams=(await Le().catch(()=>({cameras:[]}))).cameras.filter(i=>i.enabled),!this.snapCam&&this.cams[0]&&(this.snapCam=this.cams[0].id)),window.clearTimeout(this.pollTimer),s.items.some(i=>i.preservation==="preserving")&&(this.pollTimer=window.setTimeout(()=>void this.load(),5e3))}catch(t){this.error=w(t)}}fmt(e){return new Intl.DateTimeFormat("he-IL",{timeZone:this.tz,dateStyle:"short",timeStyle:"medium"}).format(new Date(e))}async run(e,t=""){this.busy=!0,this.error="";try{await e(),this.info=t,await this.load(),t&&setTimeout(()=>this.info="",4e3)}catch(s){this.error=w(s),s instanceof fe&&s.status===409&&await this.load()}finally{this.busy=!1}}patchCase(e){const t=this.data;t&&this.run(async()=>{await Bp(t.id,{revision:t.revision,...e})})}async verify(e){if(e){this.verifyResult=null,this.busy=!0,this.error="";try{this.verifyResult=await Kp(e)}catch(t){this.error=w(t)}finally{this.busy=!1}}}renderBundleCard(e){const t=this.verifyResult;return r`<sw-card heading="חבילת ראיות" subheading="ZIP עם הקטעים השמורים, התמונות, ההערות, manifest עם SHA-256 לכל קובץ ודוח קריא" data-bundle>
      ...
      ${this.bundles.length?r`<div class="items" style="margin-block-start:8px">${this.bundles.map(s=>r`<div class="item" data-bundle-row style="grid-template-columns:minmax(0,1fr) auto"><div class="body"><strong class="ltr">${s.name}</strong><span class="meta">${Xt(s.bytes)} · ${this.fmt(s.created_at)}${s.signed?` · חתום · מפתח ${s.signed}`:" · ללא חתימה"}</span></div><div class="acts"><a href=${Zp(e.id,s.name)} download><sw-button size="sm" icon="download">הורדה</sw-button></a></div></div>`)}</div>`:r`<div class="hint" style="margin-block-start:6px">עדיין לא נוצרה חבילה לתיק הזה.</div>`}
      ...
      <sw-page heading=${e.title} subheading=${`${Ss[e.status]} · בעלים: ${e.owner_username} · ${t.items} פריטים · ${t.preserved} עותקים שמורים · עודכן ${this.fmt(e.updated_at)}`} crumbs="חקירה | תיקים" wide>
        ${e.can_manage?r`<sw-field slot="actions"><select aria-label="סטטוס" data-case-status ?disabled=${this.busy} @change=${s=>this.patchCase({status:s.target.value})}>${Object.keys(Ss).map(s=>r`<option value=${s} ?selected=${s===e.status}>${Ss[s]}</option>`)}</select></sw-field>
        ...
        <div class="wrap">
          ...
          <sw-card heading="ראיות והערות" subheading=${e.checked?"מצב השימור נבדק מול ה־NVR עכשיו":"מצב השימור לא נבדק מול ה־NVR"}>
            ...
            ${e.can_manage&&e.status!=="closed"?r`<div class="composer"><sw-field label="הערה חדשה"><textarea rows="2" data-note-text .value=${this.noteText} @input=${s=>this.noteText=s.target.value}></textarea></sw-field><sw-button size="sm" icon="plus" data-note-add ?disabled=${this.busy||!this.noteText.trim()} @click=${()=>void this.run(async()=>{await la(e.id,{kind:"note",note:this.noteText.trim()}),this.noteText=""})}>הוסף הערה</sw-button></div>
                  <div class="composer"><sw-field label="תמונה ממצלמה לתיק (עותק שמור מיידי)"><select aria-label="מצלמה לצילום" data-snapshot-camera @change=${s=>this.snapCam=s.target.value}>${this.cams.map(s=>r`<option value=${s.id} ?selected=${s.id===this.snapCam}>${s.name}</option>`)}</select></sw-field><sw-button size="sm" icon="camera" data-snapshot-add ?disabled=${this.busy||!this.snapCam} @click=${()=>void this.run(async()=>{await la(e.id,{kind:"snapshot",camera_id:this.snapCam})},"התמונה נשמרה בתיק עם ה־hash שלה")}>צלם תמונה לתיק</sw-button></div>`:d}
          </sw-card>
    ...
    `}render(){if(y())return this.renderApi();const e=sa.find(t=>t.id===this.caseId)??sa[0];return r`
  ...
  `;U([f()],ae.prototype,"caseId",2);U([c()],ae.prototype,"tab",2);U([c()],ae.prototype,"data",2);U([c()],ae.prototype,"error",2);U([c()],ae.prototype,"info",2);U([c()],ae.prototype,"busy",2);U([c()],ae.prototype,"tz",2);U([c()],ae.prototype,"noteText",2);U([c()],ae.prototype,"editing",2);U([c()],ae.prototype,"editTitle",2);U([c()],ae.prototype,"editDesc",2);U([c()],ae.prototype,"editTags",2);U([c()],ae.prototype,"confirmDelete",2);U([c()],ae.prototype,"bundles",2);U([c()],ae.prototype,"verifyResult",2);U([c()],ae.prototype,"cams",2);U([c()],ae.prototype,"snapCam",2);ae=U([E("investigate-case-detail")],ae);var Ch=Object.defineProperty,Dh=Object.getOwnPropertyDescriptor,Ei=(e,t,s,i)=>{for(var a=i>1?void 0:i?Dh(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&Ch(t,s,a),a};const Rr={queued:"ממתין",running:"מוריד",done:"הושלם",partial:"חלקי",failed:"נכשל",cancelled:"בוטל",interrupted:"הופסק"},Th={queued:"neutral",running:"live",done:"recorded",partial:"partial",failed:"error",cancelled:"unknown",interrupted:"stale"};let ns=class extends z{constructor(){super(...arguments),this.jobs=null,this.ffmpeg=!0,this.error=""}connectedCallback(){super.connectedCallback(),y()&&(this.load(),this.timer=window.setInterval(()=>this.poll(),3e3))}disconnectedCallback(){super.disconnectedCallback(),window.clearInterval(this.timer)}async load(){try{const e=await ih();this.jobs=e.jobs,this.ffmpeg=e.ffmpeg,this.error=""}catch(e){this.error=w(e)}}poll(){this.jobs?.some(e=>e.state==="queued"||e.state==="running")&&this.load()}fmt(e,t){return new Intl.DateTimeFormat("he-IL",{timeZone:t,day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit",second:"2-digit",hourCycle:"h23"}).format(new Date(e))}async cancel(e){try{await ah(e.id),await this.load()}catch(t){this.error=w(t)}}async removeJob(e){try{await rh(e.id),await this.load()}catch(t){this.error=w(t)}}renderApi(){return this.error&&!this.jobs?r`<sw-state-panel state="error" hint=${this.error} actionLabel="נסה שוב" @action=${()=>this.load()}></sw-state-panel>`:this.jobs?this.jobs.length?r`
      ...
      <sw-card>
        ${this.jobs.map(e=>{const t=Math.round((e.progress??0)*100),s=e.files.filter(i=>i.state==="downloaded"||i.state==="remuxed").length;return r`<div class="job">
            <div>
              <div class="title"><strong>${e.camera_name}</strong><sw-badge kind=${Th[e.state]} label=${Rr[e.state]}></sw-badge></div>
              <div class="meta"><span class="ltr">${this.fmt(e.requested_from,e.timezone)} → ${this.fmt(e.requested_to,e.timezone)}</span> · ${e.files.length} קבצים (${s} ירדו) · משוער ${Xt(e.estimate_bytes)}${e.actual_from?r` · בפועל <span class="ltr">${this.fmt(e.actual_from,e.timezone)} → ${this.fmt(e.actual_to??e.actual_from,e.timezone)}</span>`:d}</div>
            ...
            <div><div class="bar ${e.state==="failed"?"fail":e.state==="partial"?"partial":""}"><i style="inline-size:${t}%"></i></div><div class="meta">${Rr[e.state]} · ${t}%${e.state==="running"?` · ${Xt(e.files.reduce((i,a)=>i+a.bytes,0))}`:""}</div></div>
            <div class="actions">
  ...
  `;Kt([c()],ht.prototype,"by",2);Kt([c()],ht.prototype,"q",2);Kt([c()],ht.prototype,"answer",2);Kt([c()],ht.prototype,"providers",2);Kt([c()],ht.prototype,"busy",2);Kt([c()],ht.prototype,"error",2);ht=Kt([E("investigate-search")],ht);const Wh=()=>({name:"",description:"",enabled:!0,owner:"local",ha_automation_id:null,trigger:{types:[],sources:[],severity_min:"info"},scope:{site_ids:[],building_ids:[],floor_ids:[],zone_ids:[],camera_ids:[],entity_ids:[]},window:{days:[],from:null,to:null},cooldown_s:300,actions:[{kind:"notify",message:""}]}),Uh=()=>k("rules"),Zh=e=>A("rules",e),Nr=(e,t)=>Be(`rules/${e}`,t),qh=e=>ve(`rules/${e}`),Br=(e,t=24)=>A("rules/dry-run",{rule:e,hours:t}),Kh=(e=!1)=>k(`rules/alerts${e?"?unacked=true":""}`),Gh=e=>A(`rules/alerts/${e}/ack`),Lr={mon:"ב׳",tue:"ג׳",wed:"ד׳",thu:"ה׳",fri:"ו׳",sat:"ש׳",sun:"א׳"},Yh={alertstream:"התראת NVR",recording:"נגזר מהקלטה",system:"מערכת",ha:"חיישן HA"};var Jh=Object.defineProperty,Xh=Object.getOwnPropertyDescriptor,ce=(e,t,s,i)=>{for(var a=i>1?void 0:i?Xh(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&Jh(t,s,a),a};const Vr={"r-1":{icon:"user",bg:"#eaf0ff",fg:"#2f6bff"},"r-2":{icon:"move",bg:"#e8f8ee",fg:"#16a34a"},"r-3":{icon:"door",bg:"#fff4e0",fg:"#d97706"},"r-4":{icon:"offline",bg:"#fdecec",fg:"#ef4444"}},Qh=[{id:"person-night",label:"אדם בלילה",body:{name:"אדם בלילה",description:"זיהוי אדם בשעות הסגירה",trigger:{types:["person"],sources:[],severity_min:"info"},window:{days:[],from:"22:00",to:"06:00"},cooldown_s:300,actions:[{kind:"notify",message:"זוהה אדם בשעות הסגירה"}]}},{id:"camera-offline",label:"מצלמה מנותקת",body:{name:"מצלמה מנותקת",description:"התראה כשמצלמה יורדת מהרשת",trigger:{types:["offline"],sources:[],severity_min:"info"},window:{days:[],from:null,to:null},cooldown_s:1800,actions:[{kind:"notify",message:"מצלמה מנותקת"}]}},{id:"door-after-hours",label:"דלת נפתחה אחרי שעות",body:{name:"דלת נפתחה אחרי שעות",description:"פתיחת דלת מחוץ לשעות הפעילות",trigger:{types:["door"],sources:["ha"],severity_min:"info"},window:{days:[],from:"20:00",to:"07:00"},cooldown_s:600,actions:[{kind:"notify",message:"דלת נפתחה מחוץ לשעות הפעילות"}]}}];let le=class extends z{constructor(){super(...arguments),this.tab="rules",this.rules=[],this.alerts=[],this.unacked=0,this.meta={types:[],sources:[],days:[]},this.error="",this.busy=!1,this.loading=!1,this.editing=null,this.dry=null,this.dryBusy=!1,this.tree=null,this.cams=[],this.zones=[],this.confirmDelete=null,this.tz="Asia/Jerusalem"}connectedCallback(){super.connectedCallback(),y()&&this.load()}async load(){this.loading=!0,this.error="";try{const[e,t]=await Promise.all([Uh(),Kh()]);if(this.rules=e.rules,this.meta={types:e.types,sources:e.sources,days:e.days},this.alerts=t.alerts,this.unacked=t.unacked,!this.tree){const[s,i]=await Promise.all([Mt(),Le()]);this.tree=s,this.cams=i.cameras.filter(a=>a.enabled)}}catch(e){this.error=w(e)}finally{this.loading=!1}}fmt(e){return e?new Intl.DateTimeFormat("he-IL",{timeZone:this.tz,dateStyle:"short",timeStyle:"short"}).format(new Date(e)):"—"}get floors(){return(this.tree?.sites??[]).flatMap(e=>(e.buildings??[]).flatMap(t=>(t.floors??[]).map(s=>({id:s.id,name:`${t.name} · ${s.name}`}))))}async run(e){this.busy=!0,this.error="";try{await e(),await this.load()}catch(t){this.error=w(t),t instanceof fe&&t.status===409&&await this.load()}finally{this.busy=!1}}openEditor(e){if(this.dry=null,this.zones=[],e){const{id:t,revision:s,alerts:i,created_by_username:a,updated_by_username:n,created_at:o,updated_at:l,last_fired_at:p,...h}=e;this.editing={id:t,revision:s,body:JSON.parse(JSON.stringify(h))},h.scope.floor_ids.length===1&&this.loadZones(h.scope.floor_ids[0])}else this.editing={id:null,revision:0,body:Wh()}}async loadZones(e){try{this.zones=(await rd(e)).zones}catch{this.zones=[]}}edit(e){if(!this.editing)return;const t=JSON.parse(JSON.stringify(this.editing.body));e(t),this.editing={...this.editing,body:t}}toggleIn(e,t){const s=e.indexOf(t);s>=0?e.splice(s,1):e.push(t)}async dryRun(){if(this.editing){this.dryBusy=!0,this.error="";try{this.dry=this.editing.id?await Br({...this.editing.body},24):await Br(this.editing.body,24)}catch(e){this.error=w(e)}finally{this.dryBusy=!1}}}save(){const e=this.editing;!e||!e.body.name.trim()||this.run(async()=>{e.id?await Nr(e.id,{...e.body,revision:e.revision}):await Zh(e.body),this.editing=null,this.dry=null})}summary(e){const t=e.trigger.types.length?e.trigger.types.map(a=>ee[a]??a).join(", "):"כל הסוגים",s=e.scope.floor_ids.length||e.scope.zone_ids.length||e.scope.camera_ids.length||e.scope.building_ids.length||e.scope.site_ids.length?[e.scope.floor_ids.length?`${e.scope.floor_ids.length} קומות`:"",e.scope.zone_ids.length?`${e.scope.zone_ids.length} אזורים`:"",e.scope.camera_ids.length?`${e.scope.camera_ids.length} מצלמות`:""].filter(Boolean).join(" · "):"כל המתקן",i=e.window.from||e.window.to||e.window.days.length?`${e.window.days.map(a=>Lr[a]??a).join("")||"כל יום"} ${e.window.from??"00:00"}–${e.window.to??"24:00"}`:"תמיד";return`${t} · ${s} · ${i} · השהיה ${e.cooldown_s} שנ׳ · ${e.owner==="ha"?`בבעלות HA (${e.ha_automation_id})`:"התראה במערכת"}`}renderEditor(){const e=this.editing;if(!e)return d;const t=e.body,s=this.dry;return r`<sw-dialog open heading=${e.id?"עריכת חוק":"חוק חדש"} subheading="Trigger → היקף → חלון זמן → השהיה → התראה במערכת · הרצה יבשה לפני שמירה" data-rule-dialog @close=${()=>this.editing=null}>
      ${this.error?r`<div class="err">${this.error}</div>`:d}
      ...
      <sw-field label="ימים (ריק = כל יום)"><div class="chips">${this.meta.days.map(i=>r`<sw-chip ?selected=${t.window.days.includes(i)} @click=${()=>this.edit(a=>this.toggleIn(a.window.days,i))}>${Lr[i]??i}</sw-chip>`)}</div></sw-field>
      <div class="two">
    ...
    `}render(){return y()?this.renderApi():r`
      <sw-page heading="התראות וחוקי אוטומציה" subheading="Trigger → היקף → תנאים → פעולה · בדיקה יבשה לפני הפעלה · נתוני הדגמה">
        ...
        <sw-tabs .items=${[{id:"rules",label:"חוקים",count:ia.length},{id:"notif",label:"התראות"},{id:"sched",label:"לוחות זמנים"},{id:"trig",label:"Triggers"}]} .active=${this.tab} @change=${e=>this.tab=e.detail.id}></sw-tabs>
        ${this.tab==="rules"?r`<div class="list">
              ${ia.map(e=>{const t=Vr[e.id]??Vr["r-1"];return r`<sw-card flush class="rule" style="--bg:${t.bg};--fg:${t.fg}">
  ...
  `;ce([f()],ui.prototype,"ruleId",2);ui=ce([E("investigate-rule-editor")],ui);const eu=()=>k("identity/users"),tu=()=>A("identity/sync"),gs=()=>k("access/roles"),Hr=e=>A("access/bindings",e),su=e=>ve(`access/bindings/${e}`),iu=()=>k("access/groups"),au=e=>A("access/groups",{name:e}),ru=e=>ve(`access/groups/${e}`),nu=(e,t)=>Me(`access/groups/${e}/members`,{user_ids:t}),ou=e=>A("access/preview",e),jr=(e={})=>{const t=new URLSearchParams;e.prefix&&t.set("prefix",e.prefix),e.actor&&t.set("actor",e.actor),e.resourceId&&t.set("resource_id",e.resourceId),e.limit&&t.set("limit",String(e.limit));const s=t.toString();return k(`audit${s?`?${s}`:""}`)},Fr={verified:"מסונכרן",stale:"סנכרון מיושן",removed:"מושבת / נמחק ב־HA",unavailable:"לא בספריית HA",unknown:"טרם סונכרן",dev:"משתמש פיתוח"},lu={"rbac.bind":"שיוך תפקיד","rbac.unbind":"ביטול שיוך","rbac.group_create":"יצירת קבוצה","rbac.group_members":"שינוי חברי קבוצה","rbac.group_delete":"מחיקת קבוצה","rbac.bootstrap_admin":"מנהל ראשון (bootstrap)","identity.user_disabled":"משתמש הושבת (HA)","identity.user_enabled":"משתמש הופעל (HA)","identity.sync":"סנכרון ספרייה"};function wt(e){if(!e)return"—";const t=new Date(e);return Number.isNaN(t.getTime())?e:t.toLocaleString("he-IL",{dateStyle:"short",timeStyle:"short"})}const du=e=>A("access/roles",e),cu=(e,t)=>Be(`access/roles/${e}`,t),pu=e=>ve(`access/roles/${e}`),hu=e=>A("access/roles/preview",e),uu=e=>Me("access/delegation",{delegable_roles:e});var mu=Object.defineProperty,fu=Object.getOwnPropertyDescriptor,Y=(e,t,s,i)=>{for(var a=i>1?void 0:i?fu(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&mu(t,s,a),a};const gu=[{id:"users",label:"משתמשים",count:ta.length},{id:"groups",label:"קבוצות",count:dn.length},{id:"roles",label:"תפקידים",count:cn.length},{id:"effective",label:"הרשאות אפקטיביות"},{id:"audit",label:"אודיט הרשאות"}];let K=class extends z{constructor(){super(...arguments),this.tab="users",this.selected=null,this.assigning=!1,this.step=0,this.directory=null,this.roles=null,this.groups=null,this.tree=null,this.audit=null,this.selectedGroup=null,this.wizard=null,this.members=null,this.newGroup="",this.preview=null,this.previewUser="",this.previewScope="installation:*",this.busy=!1,this.error="",this.message="",this.forbidden=!1,this.roleEdit=null,this.roleImpact=null,this.roleDelete=null,this.roleImpactTimer=0,this.userColumns=[{key:"name",label:"שם",render:e=>r`<div class="who"><sw-avatar name=${String(e.name)} size=${30}></sw-avatar><div><strong>${String(e.name)}</strong>${e.haAdmin?r` <sw-badge kind="neutral" label="מנהל HA · מידע בלבד"></sw-badge>`:""}<div class="ltr sub">${String(e.haUser)}@ha.local</div></div></div>`},{key:"role",label:"תפקיד",render:e=>{const t=e.bindings[0];return t?r`<span class="pillsel">${t.role}<sw-icon name="chevronDown" size=${11}></sw-icon></span>`:r`<span class="pillsel" style="color:var(--sw-text-3)">ללא שיוך<sw-icon name="chevronDown" size=${11}></sw-icon></span>`}},{key:"scope",label:"היקף גישה",render:e=>{const t=e.bindings[0];return t?r`<span class="pillsel">${t.scope}<sw-icon name="chevronDown" size=${11}></sw-icon></span>`:r`<span class="sub">—</span>`}},{key:"active",label:"מצב",render:e=>r`<span class="status ${e.active?"":"off"}"><i></i>${e.active?"פעיל":"מושבת ב־HA"}</span>`},{key:"lastSync",label:"סנכרון"},{key:"more",label:"",width:"40px",render:()=>r`<sw-button variant="ghost" size="sm" iconOnly icon="more" label="עוד"></sw-button>`}]}connectedCallback(){super.connectedCallback(),y()&&this.load()}async load(){this.error="";try{const[e,t,s,i]=await Promise.all([eu(),gs(),iu(),Mt()]);this.directory=e,this.roles=t,this.groups=s.groups,this.tree=i,this.forbidden=!1,this.previewUser||(this.previewUser=Te.me?.user.id??"")}catch(e){const t=w(e);this.error=t,this.forbidden=/403|הרשאה|forbidden/i.test(t)&&!this.directory}}async loadAudit(){try{const[e,t]=await Promise.all([jr({prefix:"rbac.",limit:100}),jr({prefix:"identity.",limit:50})]);this.audit=[...e.rows,...t.rows].sort((s,i)=>s.at<i.at?1:-1).slice(0,150)}catch(e){this.error=w(e),this.audit=[]}}flash(e){this.message=e,setTimeout(()=>this.message="",3500)}get scopeOptions(){const e=[{type:"installation",id:"*",name:"כל ההתקנה"}];for(const t of this.tree?.sites??[]){e.push({type:"site",id:t.id,name:`אתר · ${t.name}`});for(const s of t.buildings??[]){e.push({type:"building",id:s.id,name:`${t.name} · ${s.name}`});for(const i of s.floors??[])e.push({type:"floor",id:i.id,name:`${t.name} · ${s.name} · ${i.name}`})}}return e}userName(e){return this.directory?.users.find(t=>t.id===e)?.name??e}label(e){return this.roles?.labels[e]??e}startWizard(e,t,s){this.wizard={subjectKind:e,subjectId:t,subjectName:s,roleId:"viewer",scopeKey:"installation:*",effect:"allow"}}async saveWizard(){const e=this.wizard;if(!e)return;const[t,s]=e.scopeKey.split(":");this.busy=!0,this.error="";try{const i=await Hr({subject_kind:e.subjectKind,subject_id:e.subjectId,role_id:e.roleId,scope_type:t,scope_id:s,effect:e.effect});this.flash(e.effect==="deny"?`נחסם: ${i.role_name} · ${i.scope_name} (רוויזיה ${i.revision})`:`שויך: ${i.role_name} · ${i.scope_name} (רוויזיה ${i.revision})`),this.wizard=null,await this.load()}catch(i){this.error=w(i)}finally{this.busy=!1}}async revoke(e){this.busy=!0,this.error="";try{await su(e.id),this.flash(`בוטל: ${e.role_name} · ${e.scope_name}`),await this.load()}catch(t){this.error=w(t)}finally{this.busy=!1}}async sync(){this.busy=!0,this.error="";try{const e=await tu();this.flash(e.requested?"הספרייה נדחפה מ־Home Assistant":e.note??"הספרייה מתעדכנת אוטומטית כל דקה"),await this.load()}catch(e){this.error=w(e)}finally{this.busy=!1}}async addGroup(){const e=this.newGroup.trim();if(e){this.busy=!0,this.error="";try{const t=await au(e);this.newGroup="",this.flash(`נוצרה קבוצה "${t.name}"`),await this.load(),this.selectedGroup=t.id}catch(t){this.error=w(t)}finally{this.busy=!1}}}async saveMembers(e){if(this.members){this.busy=!0,this.error="";try{await nu(e.id,[...this.members]),this.members=null,this.flash("חברי הקבוצה עודכנו"),await this.load()}catch(t){this.error=w(t)}finally{this.busy=!1}}}async removeGroup(e){this.busy=!0,this.error="";try{await ru(e.id),this.selectedGroup=null,this.flash(`הקבוצה "${e.name}" נמחקה והשיוכים שלה בוטלו`),await this.load()}catch(t){this.error=w(t)}finally{this.busy=!1}}async runPreview(){if(!this.previewUser)return;const[e,t]=this.previewScope.split(":");this.busy=!0,this.error="";try{this.preview=await ou({user_id:this.previewUser,scope_type:e,scope_id:t})}catch(s){this.error=w(s)}finally{this.busy=!1}}renderBindingRow(e,t){return r`<div class="bind">
      ...
      <div class="stage">
        ...
        ${i?r`<sw-drawer open heading=${i.name} subheading=${`Home Assistant · ${i.username||i.id} · ${i.active?"פעיל":"ללא גישה"}`} @close=${()=>{this.selected=null,this.wizard=null}}>
              ${this.wizard&&this.wizard.subjectKind==="user"?this.renderWizard():r`<dl>
                    ...
                    <dt>סנכרון</dt><dd>${Fr[i.sync_status]}${i.synced_at?` · ${wt(i.synced_at)}`:""}</dd>
    ...
    `}renderUsers(){const e=ta.find(t=>t.id===this.selected);return r`
      <div class="stage">
        <sw-table .columns=${this.userColumns} .rows=${ta} .selected=${this.selected} @row-select=${t=>{this.selected=t.detail.id,this.assigning=!1}}></sw-table>
...
`)],{type:"text/csv;charset=utf-8"}),a=document.createElement("a");a.href=URL.createObjectURL(i),a.download=`audit-${new Date().toISOString().slice(0,10)}.csv`,a.click(),setTimeout(()=>URL.revokeObjectURL(a.href),2e3)}renderApi(){const e=this.rows;return r`
    ...
    `}render(){return y()?this.renderApi():r`
      <sw-page heading="יומן אודיט" subheading="מי צפה, שינה, ייצא או שלח פעולה · actor, מקור זהות, תפקיד והיקף, החלטה, request_id, permission_revision · נתוני הדגמה">
        ...
        <sw-table .columns=${bu} .rows=${pn}></sw-table>
        <div class="pager">
  ...
  `;ps([c()],St.prototype,"rows",2);ps([c()],St.prototype,"error",2);ps([c()],St.prototype,"family",2);ps([c()],St.prototype,"actor",2);ps([c()],St.prototype,"limit",2);St=ps([E("system-audit")],St);var ku=Object.defineProperty,_u=Object.getOwnPropertyDescriptor,J=(e,t,s,i)=>{for(var a=i>1?void 0:i?_u(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&ku(t,s,a),a};const zu=[{key:"nvr_host",label:"כתובת ה־NVR"},{key:"nvr_http_port",label:"פורט ISAPI (HTTP)"},{key:"nvr_rtsp_port",label:"פורט RTSP"},{key:"nvr_username",label:"משתמש NVR (קריאה)"},{key:"nvr_password",label:"סיסמת NVR"},{key:"go2rtc_url",label:"כתובת go2rtc"},{key:"go2rtc_api_username",label:"משתמש go2rtc (אם מוגן)"},{key:"go2rtc_api_password",label:"סיסמת go2rtc"},{key:"bootstrap_admin_username",label:"שם משתמש HA של המנהל הראשון"},{key:"log_level",label:"רמת לוג"}];function Ct(e){if(!e)return"—";const t=new Date(e);return Number.isNaN(t.getTime())?String(e):t.toLocaleString("he-IL",{day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit",second:"2-digit"})}const Ki=["גילוי","NVR","go2rtc","גשר HA","מנהל ראשון","שעון","סיום"];let G=class extends z{constructor(){super(...arguments),this.step=0,this.raw=null,this.report=null,this.recorder=null,this.error="",this.busy=!1,this.notify=null,this.notifyError="",this.notifyPlan=null,this.notifyBusy=!1,this.notifyResult="",this.sys=null,this.sysError="",this.sysMsg="",this.sysBusy=!1,this.ntpForm=null,this.rebootWord="",this.rebootOpen=!1,this.connection=null,this.connForm=null,this.connMsg="",this.connBusy=!1,this.changes=[]}connectedCallback(){super.connectedCallback(),y()&&this.load()}async load(){this.loadNvr(),this.busy=!0;try{this.raw=await k("health"),this.error=""}catch(e){this.error=w(e)}try{this.recorder=(await Le()).recorder}catch{this.recorder=null}try{this.report=await Cn()}catch{this.report=null}this.busy=!1}check(e){return this.report?.checks.find(t=>t.id===e)??null}row(e,t,s=""){return r`<div class="check"><span>${e}</span><span class=${`val ${s}`}>${t==null||t===""?"—":String(t)}</span></div>`}sectionHead(e,t){return r`<div class="syshead"><sw-icon name=${e} size=${15}></sw-icon>${t}</div>`}async loadNvr(){if(y()){try{const[e,t]=await Promise.all([Yc(),_r(10)]);this.notify=e,this.changes=t.changes,this.notifyError=""}catch(e){this.notifyError=w(e)}this.loadSystem(),dp().then(e=>this.connection=e).catch(()=>this.connection=null)}}async loadSystem(){try{this.sys=await ip(),this.sysError=""}catch(e){this.sysError=w(e)}}async sysAction(e,t){if(!this.sysBusy){this.sysBusy=!0,this.sysMsg="";try{await t(),await Promise.all([this.loadSystem(),_r(10).then(s=>this.changes=s.changes)]),this.sysMsg=`${e}: בוצע ונרשם באודיט.`}catch(s){this.sysMsg=`${e}: ${w(s)}`}finally{this.sysBusy=!1}}}async saveConnection(){const e=this.connForm;if(!(!e||this.connBusy)){this.connBusy=!0,this.connMsg="";try{const t=await cp({host:e.host.trim(),http_port:e.http_port,rtsp_port:e.rtsp_port,user:e.user.trim(),...e.password?{password:e.password}:{}});this.connection=t,this.connForm=null,this.connMsg=t.restarting?`החיבור נבדק (${t.device.model} · ${t.device.firmware}) ונשמר ב־Add-on options; ה־Add-on מופעל מחדש כעת.`:`החיבור נבדק (${t.device.model} · ${t.device.firmware}) ונשמר; בתוקף מיד.`,this.loadSystem()}catch(t){this.connMsg=`לא נשמר: ${w(t)}`}finally{this.connBusy=!1}}}renderSystemCard(){const e=this.sys,t=a=>`${(a/1024).toFixed(0)} GB`,s=e?.time?.drift_s??null,i=s===null?"":Math.abs(s)<=2?"ok":Math.abs(s)<=30?"warn":"err";return r`<sw-card heading="מערכת ה־NVR" subheading="שעון ו־NTP, דיסקים ובדיקת S.M.A.R.T., יציאות אזעקה, הפעלה מחדש · כל כתיבה דורשת הרשאה רגישה ונרשמת" data-nvr-system>
      ...
      <sw-page heading="חיבורים" subheading="מצב החיבורים של ה־Add-on: NVR, go2rtc, Home Assistant ואחסון · קריאה בלבד · הערכים עצמם מוגדרים ב־Home Assistant › Add-ons › SMPLWISE VMS › Configuration">
        ...
        ${e?r`<div class="two" data-connections>
              ...
              <sw-card heading="NVR (Hikvision, ISAPI + RTSP)" subheading=${e.nvr_configured?"מוגדר · קריאה בלבד":"לא מוגדר"}>
                ...
                ${this.row("גילוי אחרון תקין",Ct(e.discovery.cameras_last_ok),e.discovery.cameras_last_error?"warn":"ok")}
                ${e.discovery.cameras_last_error?this.row("שגיאת גילוי",e.discovery.cameras_last_error,"err"):d}
                ${this.row("זרם התראות (alertStream)",e.events.ingest.connected?`מחובר · פעימה ${Ct(e.events.ingest.last_heartbeat_at)}`:`מנותק${e.events.ingest.last_error?` · ${e.events.ingest.last_error}`:""}`,e.events.ingest.connected?"ok":"err")}
                ...
                ${this.row("אירועים שנגזרו מהקלטות (ריצה אחרונה)",`${e.events.derive.derived} · ${Ct(e.events.derive.last_ok)}`,e.events.derive.last_error?"warn":"")}
              </sw-card>
              ...
              <sw-card heading="go2rtc (relay לווידאו)" subheading=${e.go2rtc_configured?"מוגדר":"לא מוגדר"}>
                ...
                ${this.row("סנכרון זרמים אחרון תקין",Ct(e.discovery.streams_last_ok),e.discovery.streams_last_error?"warn":"ok")}
              ...
              <sw-card heading="Home Assistant" subheading=${e.home_assistant.connected?`מחובר · HA ${e.home_assistant.ha_version??""}`:e.home_assistant.configured?"מוגדר, מנותק":"לא מוגדר"}>
                ...
                ${this.row("תמונת מצב אחרונה",Ct(e.home_assistant.last_snapshot_at))}
                ${this.row("עדכון ישות אחרון",Ct(e.home_assistant.last_event_at))}
                ${this.row("רישום (אזורים / קומות) עודכן",Ct(e.home_assistant.last_registry_at))}
    ...
    `}renderStep(){switch(this.step){case 0:return r`<sw-card heading="גילוי מכשירים" subheading="חיפוש NVR ומצלמות ברשת המקומית · קריאה בלבד, ללא שינוי תצורה במכשיר">
      ...
      <sw-page heading="אשף התקנה" subheading="גילוי NVR ומצלמות, בדיקת זרמים, שמות וקומות · בדיקות קריאה בלבד · נתוני הדגמה">
        <div class="wrap">
          <sw-card><sw-steps .steps=${Ki} .current=${this.step}></sw-steps></sw-card>
          ${this.renderStep()}
          <div class="foot">
            ...
            <div style="display:flex;gap:8px">
              ...
              <sw-button variant="primary" @click=${()=>this.step=Math.min(Ki.length-1,this.step+1)}>${this.step===Ki.length-1?"סיום":"הבא"}</sw-button>
            </div>
          </div>
        </div>
      </sw-page>
  ...
  `;Ee([c()],we.prototype,"selected",2);Ee([c()],we.prototype,"filter",2);Ee([c()],we.prototype,"cameras",2);Ee([c()],we.prototype,"recorder",2);Ee([c()],we.prototype,"canSync",2);Ee([c()],we.prototype,"discovery",2);Ee([c()],we.prototype,"busy",2);Ee([c()],we.prototype,"message",2);Ee([c()],we.prototype,"error",2);Ee([c()],we.prototype,"dialog",2);Ee([c()],we.prototype,"formChannel",2);Ee([c()],we.prototype,"formAlias",2);Ee([c()],we.prototype,"alias",2);we=Ee([E("system-devices")],we);const Da="sw.design.override",Ta="sw.design.last",As={a:"SW A",b:"SW B"};let Us="b";const pa=new Set;function mi(e){try{return localStorage.getItem(e)}catch{return null}}function Vn(e,t){try{t===null?localStorage.removeItem(e):localStorage.setItem(e,t)}catch{}}function Eu(){try{const s=new URLSearchParams(window.location.search).get("design");if(s==="a"||s==="b")return s}catch{}const e=mi(Da);if(e==="a"||e==="b")return e;const t=mi(Ta);return t==="a"||t==="b"?t:"b"}Us=Eu();function ha(){const e=mi(Da);return e==="a"||e==="b"?e:null}function Au(e){Vn(Da,e),jn()}function Hn(){return Us}function Pu(e){return pa.add(e),e(Us),()=>pa.delete(e)}function vt(e){Us=e,document.documentElement.dataset.design=e,Vn(Ta,e),pa.forEach(t=>t(e))}function Iu(e){try{const t=e?JSON.parse(e):{};return{a:(t.a||As.a).slice(0,24),b:(t.b||As.b).slice(0,24)}}catch{return{...As}}}async function jn(){const e=new URLSearchParams(window.location.search).get("design");if(e==="a"||e==="b")return vt(e),e;const t=ha();if(t)return vt(t),t;if(!y())return vt("b"),"b";const s=mi(Ta);(s==="a"||s==="b")&&vt(s);try{const a=(await Ve())["ui.design"]==="b"?"b":"a";return vt(a),a}catch{return vt(s==="b"?"b":"a"),Us}}const Cu={manual:"ידני",upload:"הועלה","auto-pre-upgrade":"אוטומטי · לפני עדכון","auto-daily":"אוטומטי · יומי"},Gi={sites:"אתרים",buildings:"מבנים",floors:"קומות",plan_assets:"קבצי תוכנית",plan_versions:"גרסאות תוכנית",map_anchors:"עוגנים",cameras:"מצלמות",spatial_zones:"אזורים",settings:"הגדרות",users:"משתמשים",bindings:"הרשאות",groups:"קבוצות"},Du=()=>k("backups"),Tu=(e={})=>A("backups",e),Ou=e=>ve(`backups/${encodeURIComponent(e)}`),Ru=(e,t)=>A(`backups/${encodeURIComponent(e)}/restore`,t),Nu=e=>ge(`backups/${encodeURIComponent(e)}/download`);function Bu(e){const t=new FormData;return t.append("file",e,e.name),xi("backups/upload",t)}function Ur(e){return e<1024?`${e} B`:e<1024*1024?`${(e/1024).toFixed(0)} KB`:`${(e/1024/1024).toFixed(1)} MB`}var Lu=Object.defineProperty,Vu=Object.getOwnPropertyDescriptor,Z=(e,t,s,i)=>{for(var a=i>1?void 0:i?Vu(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&Lu(t,s,a),a};const Zr=[{id:"general",label:"כללי"},{id:"media",label:"וידאו ומדיה"},{id:"ha",label:"גשר Home Assistant"},{id:"health",label:"בריאות ועבודות"},{id:"backup",label:"גיבוי ושחזור"},{id:"support",label:"תמיכה"}];let j=class extends z{constructor(){super(...arguments),this.tab="general",this.settings=null,this.canEdit=!1,this.draft={},this.streams=null,this.go2rtc=null,this.foreign=0,this.sessions=[],this.busy=!1,this.message="",this.error="",this.version="",this.ha=null,this.pairing=null,this.showCode=!1,this.regenArmed=!1,this.copied=!1,this.report=null,this.reportBusy=!1,this.backups=null,this.backupPolicy={},this.backupBusy=!1,this.backupNote="",this.backupMsg="",this.restoreTarget=null,this.restoreMode="replace",this.restoreAccess=!1,this.restoreConfirm="",this.health=null}connectedCallback(){super.connectedCallback();const e=rs().params.get("tab");e&&Zr.some(t=>t.id===e)&&(this.tab=e,e==="health"&&this.loadReport(),e==="backup"&&this.loadBackups(),e==="media"&&this.loadMedia(),e==="ha"&&this.loadHa()),this.loadSettings()}async loadSettings(){if(y())try{const[e,t]=await Promise.all([sn(),k("health").catch(()=>null)]);this.settings=e.settings,this.canEdit=e.can_edit,this.draft={},this.version=t?.version??"",this.health=t??null}catch(e){this.error=w(e)}}async loadMedia(){if(!(!y()||!this.canEdit))try{const[e,t]=await Promise.all([Ko(),Go()]);this.streams=e.streams,this.go2rtc=e.go2rtc,this.foreign=e.foreign_streams,this.sessions=t.sessions,this.error=""}catch(e){this.streams=[],this.error=w(e)}}async loadHa(e=!1){if(y()){this.error="";try{this.ha=await gd(),this.canEdit&&(this.pairing=await wd(e)),e&&(this.regenArmed=!1,this.showCode=!0,this.message="נוצר קוד צימוד חדש; יש להגדיר מחדש את האינטגרציה ב־Home Assistant.",setTimeout(()=>this.message="",4e3))}catch(t){this.error=w(t)}}}async copyCode(){if(this.pairing)try{await navigator.clipboard.writeText(this.pairing.pairing_code),this.copied=!0,setTimeout(()=>this.copied=!1,2e3)}catch{this.showCode=!0}}async installBridgeNow(){this.busy=!0,this.error="";try{const e=await vd();this.message=e.state==="installed_pending"?"האינטגרציה הועתקה ל־Home Assistant; הפעל מחדש את Home Assistant ואשר את הגשר שהתגלה.":e.state==="active"?"האינטגרציה פעילה.":e.state==="not_available"?"תיקיית ההגדרות של Home Assistant אינה נגישה ל־Add-on.":`מצב: ${e.state}`,await this.loadHa(),setTimeout(()=>this.message="",6e3)}catch(e){this.error=w(e)}finally{this.busy=!1}}integrationText(e){switch(e.state){case"active":return`פעילה ב־Home Assistant (גרסה ${e.active_version??"?"})`;case"installed_pending":return`הועתקה לתיקיית ההגדרות של HA (גרסה ${e.installed_version??"?"}) ב־${Fe(e.installed_at)} · הפעל מחדש את Home Assistant ואז אשר את "SMPLWISE Bridge" שהתגלה בהגדרות → מכשירים ושירותים`;case"update_pending":return`עודכנה לגרסה ${e.installed_version??"?"} אך Home Assistant עדיין מריץ ${e.active_version??"?"} · נדרש Restart ל־Home Assistant`;case"not_installed":return"טרם הועתקה";case"error":return`ההעתקה נכשלה (${e.last_error??""})`;default:return e.last_error==="ha_config_not_mapped"?"ה־Add-on לא רואה את תיקיית ההגדרות של Home Assistant (המיפוי homeassistant_config לא ניתן) · התקנה ידנית לפי השלבים למטה":e.last_error==="source_missing"?"קבצי האינטגרציה חסרים בתמונת ה־Add-on · התקנה ידנית לפי השלבים למטה":`ההתקנה האוטומטית נכשלה (${e.last_error??"סיבה לא ידועה"}) · התקנה ידנית לפי השלבים למטה`}}renderIntegration(e){const t=e.integration;if(!t)return d;const s=t.state==="active"?"live":t.state==="installed_pending"||t.state==="update_pending"?"stale":t.state==="error"?"error":"unknown",i=t.state==="active"?"פעילה":t.state==="installed_pending"?"ממתינה ל־Restart":t.state==="update_pending"?"עדכון ממתין":t.state==="error"?"שגיאה":t.state==="not_installed"?"לא הותקנה":"לא זמין";return r`<div class="row"><span class="lbl">התקנת האינטגרציה ב־Home Assistant<span class="muted">${this.integrationText(t)}${t.discovery_posted_at?` · הוכרזה ל־Supervisor ${Fe(t.discovery_posted_at)}`:""}</span></span><span style="display:flex;gap:8px;align-items:center"><sw-badge kind=${s} label=${i}></sw-badge>${this.canEdit&&t.state!=="not_available"?r`<sw-button size="sm" ?disabled=${this.busy} @click=${()=>this.installBridgeNow()}>התקן / עדכן</sw-button>`:d}</span></div>`}renderHa(){if(!y())return r`<div class="sections"><sw-card heading="גשר Home Assistant"><div class="muted">נתוני הדגמה — הסטטוס והצימוד זמינים מול השרת.</div></sw-card></div>`;const e=this.ha,t=e?.sync,s=this.pairing;return r`<div class="sections">
    ...
    </div>`}set(e,t){this.draft={...this.draft,[e]:t}}value(e){return this.draft[e]??this.settings?.[e]}async save(){if(Object.keys(this.draft).length){this.busy=!0,this.error="";try{const e=await Zo(this.draft);this.settings=e.settings,this.draft={},cr(),this.message="ההגדרות נשמרו",setTimeout(()=>this.message="",2500)}catch(e){this.error=w(e)}finally{this.busy=!1}}}async sync(){this.busy=!0,this.error="";try{const e=await qo();this.message=`זרמים: ${e.created} נוצרו, ${e.updated} עודכנו, ${e.unchanged} ללא שינוי · ${e.foreign_streams_untouched} זרמים זרים לא נגעו`,await this.loadMedia()}catch(e){this.error=w(e)}finally{this.busy=!1}}renderDesign(){if(!y())return d;const e=Iu(this.value("ui.design_names")),t=this.value("ui.design")??"a",s=ha(),i="ui.design"in this.draft||"ui.design_names"in this.draft,a=(n,o)=>this.set("ui.design_names",JSON.stringify({...e,[n]:o.slice(0,24)}));return r`<sw-card heading="עיצוב הממשק" subheading=${`פעיל עכשיו בדפדפן הזה: ${e[Hn()]}${s?" (עקיפה מקומית)":""}`}>
      ...
      <div class="row"><span class="lbl">שם העיצוב החדש<span class="muted">ברירת מחדל: ${As.a} · העיצוב מחבילת 50 המסכים</span></span><sw-field class="ctl"><input maxlength="24" ?disabled=${!this.canEdit} .value=${e.a} @change=${n=>a("a",n.target.value)} /></sw-field></div>
      <div class="row"><span class="lbl">שם העיצוב הקודם<span class="muted">ברירת מחדל: ${As.b} · הלוחות המקוריים</span></span><sw-field class="ctl"><input maxlength="24" ?disabled=${!this.canEdit} .value=${e.b} @change=${n=>a("b",n.target.value)} /></sw-field></div>
      <div class="row"><span class="lbl">בדפדפן הזה בלבד<span class="muted">עקיפה אישית שנשמרת במכשיר; לא משנה את ברירת המחדל</span></span><sw-field class="ctl"><select @change=${n=>{const o=n.target.value;Au(o==="a"||o==="b"?o:null),o!=="a"&&o!=="b"&&vt(t),this.requestUpdate()}}><option value="" ?selected=${!s}>לפי ברירת המחדל</option><option value="a" ?selected=${s==="a"}>${e.a}</option><option value="b" ?selected=${s==="b"}>${e.b}</option></select></sw-field></div>
    ...
    </sw-card>`}async saveDesign(){await this.save(),!ha()&&this.settings&&vt(this.settings["ui.design"]==="b"?"b":"a")}renderGeneral(){return r`<div class="sections">
      ${this.renderDesign()}
      ...
      <sw-card heading="בריאות המערכת" subheading="מצב נפרד לכל רכיב, לא נורה אחת">
        <div class="hsum"><sw-badge kind=${$r[e.status]} label=${e.status==="ok"?"הכל תקין":e.status==="warn"?"יש מה לבדוק":"יש תקלה"}></sw-badge><span>גרסה <span class="ltr">${e.version}</span> · פעיל ${jc(e.uptime_s)} · נבדק <span class="ltr" data-health-checked>${t}</span></span><span class="grow"></span><sw-button size="sm" icon="refresh" ?disabled=${this.reportBusy} @click=${()=>this.loadReport(!0)}>${this.reportBusy?"בודק…":"בדוק עכשיו"}</sw-button></div>
        <div class="hgrid">${e.checks.map(s=>r`<div class="hcard ${s.status}" data-health-card=${s.id}><div class="hh"><span>${s.label}</span><sw-badge kind=${$r[s.status]} label=${zs[s.status]}></sw-badge></div><div class="hd">${s.detail}</div></div>`)}</div>
      ...
      <sw-card heading="מצבים נפרדים, לא נורה אחת">${un.map(e=>r`<div class="row"><span class="lbl">${e.name}<span class="muted">${e.detail}</span></span><sw-badge kind=${e.state}></sw-badge></div>`)}
      ...
      <div>
        ...
        <div class="sub">${this.fmtWhen(e.created_at)} · ${Ur(e.bytes)} · גרסה ${e.app_version??"?"}${e.note?` · ${e.note}`:""}</div>
    ...
    ${this.restoreTarget?this.renderRestoreDialog(this.restoreTarget):d}`}renderSupport(){return r`<div class="sections"><sw-card heading="חבילת תמיכה מצונזרת">
      ...
      <sw-page heading="הגדרות המערכת" subheading=${y()?"תעבורת וידאו, go2rtc, מכסות ובריאות":"אזור זמן, מדיניות אחסון, אינטגרציות ובריאות · נתוני הדגמה"}>
        <sw-tabs underline .items=${Zr} .active=${this.tab} @change=${e=>{this.tab=e.detail.id,this.tab==="media"&&this.loadMedia(),this.tab==="ha"&&this.loadHa(),this.tab==="backup"&&this.loadBackups(),this.tab==="health"&&this.loadReport()}}></sw-tabs>
      ...
      <sw-page heading="אחסון ותוכנית הקלטה" subheading="קריאה בלבד מה־NVR · נמדד לעומת אומדן, עם הסיבה לכל מספר · אין format, RAID או מחיקה מכאן">
        ...
        ${e.nvr.configured?e.nvr.reachable?r`
                <div class="kpis" data-storage-kpis>
                  <sw-card flush class="kpi"><div><div class="v">${Dt(t?.used_mb)}</div><div class="l">בשימוש (נמדד מה־NVR)</div></div><div class="ic"><sw-icon name="storage" size=${16}></sw-icon></div></sw-card>
                  <sw-card flush class="kpi"><div><div class="v">${Dt(t?.capacity_mb)}</div><div class="l">קיבולת · ${t?.disks??0} דיסקים${t?.nas?` · ${t.nas} NAS`:""} · מצב ${e.work_mode??"?"}</div></div><div class="ic"><sw-icon name="cpu" size=${16}></sw-icon></div></sw-card>
                  <sw-card flush class="kpi"><div><div class="v">${t?.used_pct==null?"—":`${t.used_pct}%`}</div><div class="l">ניצולת · פנוי ${Dt(t?.free_mb)}</div></div><svg viewBox="0 0 40 40" aria-hidden="true">${u`<circle cx="20" cy="20" r=${i} fill="none" stroke="var(--sw-surface-3)" stroke-width="6" /><circle cx="20" cy="20" r=${i} fill="none" stroke="var(--sw-accent)" stroke-width="6" stroke-linecap="round" stroke-dasharray=${`${a*n/100} ${a}`} transform="rotate(-90 20 20)" />`}</svg></sw-card>
                </div>
                  ...
                  <div>
                    <sw-card heading="דיסקים" subheading=${`${t?.disks_ok??0} מתוך ${(t?.disks??0)+(t?.nas??0)} תקינים`}>
                      <div class="tbl disks" data-storage-disks>
                        ...
                        ${[...e.disks,...e.nas].map(l=>r`<div class="r" data-storage-disk><span>${l.name}${l.path?r`<small>${l.path}</small>`:d}</span><span>${l.kind}</span><span><sw-badge kind=${l.status==="ok"?"recorded":"error"} label=${l.status}></sw-badge></span><span class="num">${Dt(l.capacity_mb)}</span><span class="num">${Dt(l.free_mb)}</span><span>${l.property}</span></div>`)}
                      </div>
                    </sw-card>
                    ${this.renderSigning()}
  ...
  `;ua=Uu([E("screens-index")],ua);var Ku=Object.getOwnPropertyDescriptor,Gu=(e,t,s,i)=>{for(var a=i>1?void 0:i?Ku(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=o(a)||a);return a};const Yu=[["--sw-bg","רקע"],["--sw-surface","משטח"],["--sw-surface-3","משטח 3"],["--sw-border","גבול"],["--sw-text","טקסט"],["--sw-text-2","טקסט משני"],["--sw-text-3","טקסט שלישי"],["--sw-accent","כחול"],["--sw-accent-soft","כחול רך"],["--sw-live","חי"],["--sw-offline","מנותק"],["--sw-stale","מיושן"],["--sw-danger","שגיאה"],["--sw-purple","סגול (דלת)"]],Ju=["live","recorded","historic","offline","stale","partial","unknown","forbidden","error"],Xu=["loading","empty","error","forbidden","stale","partial"],Qu=["entrance","lobby","corridor","hall","parking","warehouse","backyard","driveway","night","building","house"],em=["dashboard","building","camera","bell","history","system","search","user","play","pause","back10","forward10","aperture","volume","mic","expand","close","chevron","chevronDown","warning","info","lock","unlock","offline","refresh","layers","floor","plus","minus","fit","door","light","sensor","check","clock","download","pin","more","map","upload","list","target","filter","users","shield","storage","edit","case","rule","link","grid","home","star","calendar","trash","eye","cpu","activity","image","wifi","signal","move","bookmark","route"];let ma=class extends z{render(){return r`
      ...
      <sw-timeline .segments=${oi} .events=${[{minute:614,kind:"person",label:"אדם"},{minute:582,kind:"vehicle",label:"רכב"}]} .cursor=${615}></sw-timeline>
      <div class="row" style="margin-block-start:10px">
        ...
        <sw-floor-iso .rooms=${Xi("f0")} selected></sw-floor-iso>
        <sw-floor-iso .rooms=${Xi("f-1")}></sw-floor-iso>
...
`):"כל הרכיבים שהתוסף רואה עובדים";return r`<button class="status-a sys ${t.status} ${e?"":"b"}" data-sys-pill data-status=${t.status} title=${a} aria-label=${`מצב המערכת: ${i}`} @click=${()=>window.location.hash="#/system/diagnostics?tab=health"}><i></i>${i}</button>`}renderSysBanner(){const e=this.sys;if(!e||e.status!=="error")return d;const t=e.items.filter(s=>s.status==="error");return r`<div class="sysbanner" role="alert" data-sys-banner><sw-icon name="warning" size=${16}></sw-icon><span>${t.map(s=>s.label).join(" · ")}</span><a href="#/system/diagnostics?tab=health">לבריאות המערכת</a></div>`}onSearchInput(e){const t=e.target.value;if(this.searchQ=t,window.clearTimeout(this.searchTimer),!t.trim()){this.searchResults=[],this.searchOpen=!1;return}this.searchTimer=window.setTimeout(()=>void this.runSearch(t),180)}async runSearch(e){if(!y()){this.searchResults=[],this.searchOpen=!0;return}const t=++this.searchSeq;this.searchBusy=!0;try{const s=await Nh(e,6);if(t!==this.searchSeq)return;this.searchResults=s.results,this.searchIndex=s.results.length?0:-1,this.searchOpen=!0}catch{t===this.searchSeq&&(this.searchResults=[],this.searchOpen=!0)}finally{t===this.searchSeq&&(this.searchBusy=!1)}}onSearchKey(e){if(e.key==="Escape"){this.closeSearch(),e.target.blur();return}if(!this.searchOpen||!this.searchResults.length){e.key==="Enter"&&this.searchQ.trim()&&this.runSearch(this.searchQ);return}if(e.key==="ArrowDown")e.preventDefault(),this.searchIndex=(this.searchIndex+1)%this.searchResults.length;else if(e.key==="ArrowUp")e.preventDefault(),this.searchIndex=(this.searchIndex-1+this.searchResults.length)%this.searchResults.length;else if(e.key==="Enter"){e.preventDefault();const t=this.searchResults[this.searchIndex]??this.searchResults[0];t&&this.openResult(t)}}openResult(e){this.closeSearch();const t=this.renderRoot.querySelector(".search input");t&&(t.value="",t.blur()),this.searchQ="",this.searchResults=[],window.location.hash=`#${e.route}`}closeSearch(){this.searchOpen=!1,this.searchIndex=-1}redirectDemo(e){if(this.enforceKiosk(e))return!0;const t=om(e.path,this.session.mode==="api");return t?(window.location.replace(`#${t}`),!0):!1}get kioskOnly(){const e=(this.session.me?.bindings??[]).filter(t=>t.effect!=="deny");return this.session.mode==="api"&&e.length>0&&e.every(t=>t.role_id==="kiosk")}enforceKiosk(e){return!this.kioskOnly||e.segments[0]==="kiosk"?!1:(window.location.replace("#/kiosk/all"),!0)}get gated(){return this.session.mode==="no_access"||this.session.mode==="unauthenticated"}renderSearch(e){if(this.gated)return d;const t=this.searchOpen&&!!this.searchQ.trim();return r`<span class="searchwrap ${e?"a":""}">
      ...
      <nav class="bottom" aria-label="ניווט ראשי">
        ${Kr(this.session.mode==="api",ms).map(o=>r`<a class=${gt({active:e===o.id})} href=${o.href}><sw-icon .name=${o.icon} size=${20}></sw-icon>${o.label}</a>`)}
      </nav>
    `}embedded(e=this.route){if(e?.params.get("embed")==="1")return!0;try{return sessionStorage.getItem("sw-embed")==="1"}catch{return!1}}render(){if(this.route?.segments[0]==="kiosk")return r`<main style="block-size:100dvh">${this.renderScreen()}</main>`;if(this.embedded())return r`<main class="embed" style="block-size:100dvh;overflow:auto">${this.renderScreen()}</main>`;if(this.design==="a")return this.renderA();const t=Fn(this.route),s=t?fa(tm[t],this.session.mode==="api",ms):[],i=this.route?.segments[3]==="edit"||this.route?.segments[3]==="import";return r`
      <nav class="rail" aria-label="ניווט ראשי">
        <div class="brand">
          <img src="${"./"}brand/smplwise-mark.png" alt="SmplWise" />
          <span class="name">SmplWise</span>
        </div>
        ${qr.filter(a=>this.session.mode!=="api"||Zn(a.href,ms)).map(a=>r`<a class=${gt({item:!0,active:t===a.id})} href=${a.href} title=${a.label} aria-current=${t===a.id?"page":"false"}>
            <sw-icon .name=${a.icon} size=${16}></sw-icon><span>${a.label}</span>
          </a>`)}
        <div class="grow"></div>
        ${this.gated?d:r`<a class=${gt({item:!0,small:!0,active:this.route?.segments[0]==="screens"})} href="#/screens" title="כל המסכים">
          <sw-icon name="list" size=${14}></sw-icon><span>כל המסכים</span>
        </a>
        <a class=${gt({item:!0,small:!0,active:this.route?.segments[0]==="styleguide"})} href="#/styleguide" title=${x("nav.styleguide")}>
      ...
      <nav class="bottom" aria-label="ניווט ראשי">
        ${qr.slice(0,4).map(a=>r`<a class=${gt({active:t===a.id})} href=${a.href}><sw-icon .name=${a.icon} size=${20}></sw-icon>${a.label}</a>`)}
...
//# sourceMappingURL=index-CW-Trtpo.js.map
