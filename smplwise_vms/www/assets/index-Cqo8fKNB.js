 ...
 */const ps=globalThis,mi=ps.ShadowRoot&&(ps.ShadyCSS===void 0||ps.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,wi=Symbol(),Pi=new WeakMap;let fa=class{constructor(t,s,i){if(this._$cssResult$=!0,i!==wi)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=t,this.t=s}get styleSheet(){let t=this.o;const s=this.t;if(mi&&t===void 0){const i=s!==void 0&&s.length===1;i&&(t=Pi.get(s)),t===void 0&&((this.o=t=new CSSStyleSheet).replaceSync(this.cssText),i&&Pi.set(s,t))}return t}toString(){return this.cssText}};const ar=e=>new fa(typeof e=="string"?e:e+"",void 0,wi),x=(e,...t)=>{const s=e.length===1?e[0]:t.reduce((i,a,n)=>i+(o=>{if(o._$cssResult$===!0)return o.cssText;if(typeof o=="number")return o;throw Error("Value passed to 'css' function must be a 'css' function result: "+o+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(a)+e[n+1],e[0]);return new fa(s,e,wi)},rr=(e,t)=>{if(mi)e.adoptedStyleSheets=t.map(s=>s instanceof CSSStyleSheet?s:s.styleSheet);else for(const s of t){const i=document.createElement("style"),a=ps.litNonce;a!==void 0&&i.setAttribute("nonce",a),i.textContent=s.cssText,e.appendChild(i)}},Ei=mi?e=>e:e=>e instanceof CSSStyleSheet?(t=>{let s="";for(const i of t.cssRules)s+=i.cssText;return ar(s)})(e):e;/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const{is:nr,defineProperty:or,getOwnPropertyDescriptor:lr,getOwnPropertyNames:dr,getOwnPropertySymbols:cr,getPrototypeOf:pr}=Object,_s=globalThis,Ci=_s.trustedTypes,hr=Ci?Ci.emptyScript:"",ur=_s.reactiveElementPolyfillSupport,Nt=(e,t)=>e,fs={toAttribute(e,t){switch(t){case Boolean:e=e?hr:null;break;case Object:case Array:e=e==null?e:JSON.stringify(e)}return e},fromAttribute(e,t){let s=e;switch(t){case Boolean:s=e!==null;break;case Number:s=e===null?null:Number(e);break;case Object:case Array:try{s=JSON.parse(e)}catch{s=null}}return s}},vi=(e,t)=>!nr(e,t),Ti={attribute:!0,type:String,converter:fs,reflect:!1,useDefault:!1,hasChanged:vi};Symbol.metadata??=Symbol("metadata"),_s.litPropertyMetadata??=new WeakMap;let wt=class extends HTMLElement{static addInitializer(t){this._$Ei(),(this.l??=[]).push(t)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(t,s=Ti){if(s.state&&(s.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(t)&&((s=Object.create(s)).wrapped=!0),this.elementProperties.set(t,s),!s.noAccessor){const i=Symbol(),a=this.getPropertyDescriptor(t,i,s);a!==void 0&&or(this.prototype,t,a)}}static getPropertyDescriptor(t,s,i){const{get:a,set:n}=lr(this.prototype,t)??{get(){return this[s]},set(o){this[s]=o}};return{get:a,set(o){const d=a?.call(this);n?.call(this,o),this.requestUpdate(t,d,i)},configurable:!0,enumerable:!0}}static getPropertyOptions(t){return this.elementProperties.get(t)??Ti}static _$Ei(){if(this.hasOwnProperty(Nt("elementProperties")))return;const t=pr(this);t.finalize(),t.l!==void 0&&(this.l=[...t.l]),this.elementProperties=new Map(t.elementProperties)}static finalize(){if(this.hasOwnProperty(Nt("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(Nt("properties"))){const s=this.properties,i=[...dr(s),...cr(s)];for(const a of i)this.createProperty(a,s[a])}const t=this[Symbol.metadata];if(t!==null){const s=litPropertyMetadata.get(t);if(s!==void 0)for(const[i,a]of s)this.elementProperties.set(i,a)}this._$Eh=new Map;for(const[s,i]of this.elementProperties){const a=this._$Eu(s,i);a!==void 0&&this._$Eh.set(a,s)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(t){const s=[];if(Array.isArray(t)){const i=new Set(t.flat(1/0).reverse());for(const a of i)s.unshift(Ei(a))}else t!==void 0&&s.push(Ei(t));return s}static _$Eu(t,s){const i=s.attribute;return i===!1?void 0:typeof i=="string"?i:typeof t=="string"?t.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise(t=>this.enableUpdating=t),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach(t=>t(this))}addController(t){(this._$EO??=new Set).add(t),this.renderRoot!==void 0&&this.isConnected&&t.hostConnected?.()}removeController(t){this._$EO?.delete(t)}_$E_(){const t=new Map,s=this.constructor.elementProperties;for(const i of s.keys())this.hasOwnProperty(i)&&(t.set(i,this[i]),delete this[i]);t.size>0&&(this._$Ep=t)}createRenderRoot(){const t=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return rr(t,this.constructor.elementStyles),t}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this._$EO?.forEach(t=>t.hostConnected?.())}enableUpdating(t){}disconnectedCallback(){this._$EO?.forEach(t=>t.hostDisconnected?.())}attributeChangedCallback(t,s,i){this._$AK(t,i)}_$ET(t,s){const i=this.constructor.elementProperties.get(t),a=this.constructor._$Eu(t,i);if(a!==void 0&&i.reflect===!0){const n=(i.converter?.toAttribute!==void 0?i.converter:fs).toAttribute(s,i.type);this._$Em=t,n==null?this.removeAttribute(a):this.setAttribute(a,n),this._$Em=null}}_$AK(t,s){const i=this.constructor,a=i._$Eh.get(t);if(a!==void 0&&this._$Em!==a){const n=i.getPropertyOptions(a),o=typeof n.converter=="function"?{fromAttribute:n.converter}:n.converter?.fromAttribute!==void 0?n.converter:fs;this._$Em=a;const d=o.fromAttribute(s,n.type);this[a]=d??this._$Ej?.get(a)??d,this._$Em=null}}requestUpdate(t,s,i,a=!1,n){if(t!==void 0){const o=this.constructor;if(a===!1&&(n=this[t]),i??=o.getPropertyOptions(t),!((i.hasChanged??vi)(n,s)||i.useDefault&&i.reflect&&n===this._$Ej?.get(t)&&!this.hasAttribute(o._$Eu(t,i))))return;this.C(t,s,i)}this.isUpdatePending===!1&&(this._$ES=this._$EP())}C(t,s,{useDefault:i,reflect:a,wrapped:n},o){i&&!(this._$Ej??=new Map).has(t)&&(this._$Ej.set(t,o??s??this[t]),n!==!0||o!==void 0)||(this._$AL.has(t)||(this.hasUpdated||i||(s=void 0),this._$AL.set(t,s)),a===!0&&this._$Em!==t&&(this._$Eq??=new Set).add(t))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(s){Promise.reject(s)}const t=this.scheduleUpdate();return t!=null&&await t,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),this._$Ep){for(const[a,n]of this._$Ep)this[a]=n;this._$Ep=void 0}const i=this.constructor.elementProperties;if(i.size>0)for(const[a,n]of i){const{wrapped:o}=n,d=this[a];o!==!0||this._$AL.has(a)||d===void 0||this.C(a,void 0,n,d)}}let t=!1;const s=this._$AL;try{t=this.shouldUpdate(s),t?(this.willUpdate(s),this._$EO?.forEach(i=>i.hostUpdate?.()),this.update(s)):this._$EM()}catch(i){throw t=!1,this._$EM(),i}t&&this._$AE(s)}willUpdate(t){}_$AE(t){this._$EO?.forEach(s=>s.hostUpdated?.()),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(t)),this.updated(t)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(t){return!0}update(t){this._$Eq&&=this._$Eq.forEach(s=>this._$ET(s,this[s])),this._$EM()}updated(t){}firstUpdated(t){}};wt.elementStyles=[],wt.shadowRootOptions={mode:"open"},wt[Nt("elementProperties")]=new Map,wt[Nt("finalized")]=new Map,ur?.({ReactiveElement:wt}),(_s.reactiveElementVersions??=[]).push("2.1.2");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const bi=globalThis,Oi=e=>e,ms=bi.trustedTypes,Di=ms?ms.createPolicy("lit-html",{createHTML:e=>e}):void 0,ma="$lit$",Ke=`lit$${Math.random().toFixed(9).slice(2)}$`,wa="?"+Ke,fr=`<${wa}>`,nt=document,Vt=()=>nt.createComment(""),Ft=e=>e===null||typeof e!="object"&&typeof e!="function",gi=Array.isArray,mr=e=>gi(e)||typeof e?.[Symbol.iterator]=="function",Os=`[ 	
\f\r]`,Tt=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,Ri=/-->/g,Ni=/>/g,at=RegExp(`>|${Os}(?:([^\\s"'>=/]+)(${Os}*=${Os}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),Bi=/'/g,Hi=/"/g,va=/^(?:script|style|textarea|title)$/i,ba=e=>(t,...s)=>({_$litType$:e,strings:t,values:s}),r=ba(1),p=ba(2),ot=Symbol.for("lit-noChange"),c=Symbol.for("lit-nothing"),Li=new WeakMap,rt=nt.createTreeWalker(nt,129);function ga(e,t){if(!gi(e)||!e.hasOwnProperty("raw"))throw Error("invalid template strings array");return Di!==void 0?Di.createHTML(t):t}const wr=(e,t)=>{const s=e.length-1,i=[];let a,n=t===2?"<svg>":t===3?"<math>":"",o=Tt;for(let d=0;d<s;d++){const u=e[d];let m,f,g=-1,S=0;for(;S<u.length&&(o.lastIndex=S,f=o.exec(u),f!==null);)S=o.lastIndex,o===Tt?f[1]==="!--"?o=Ri:f[1]!==void 0?o=Ni:f[2]!==void 0?(va.test(f[2])&&(a=RegExp("</"+f[2],"g")),o=at):f[3]!==void 0&&(o=at):o===at?f[0]===">"?(o=a??Tt,g=-1):f[1]===void 0?g=-2:(g=o.lastIndex-f[2].length,m=f[1],o=f[3]===void 0?at:f[3]==='"'?Hi:Bi):o===Hi||o===Bi?o=at:o===Ri||o===Ni?o=Tt:(o=at,a=void 0);const M=o===at&&e[d+1].startsWith("/>")?" ":"";n+=o===Tt?u+fr:g>=0?(i.push(m),u.slice(0,g)+ma+u.slice(g)+Ke+M):u+Ke+(g===-2?d:M)}return[ga(e,n+(e[s]||"<?>")+(t===2?"</svg>":t===3?"</math>":"")),i]};class Wt{constructor({strings:t,_$litType$:s},i){let a;this.parts=[];let n=0,o=0;const d=t.length-1,u=this.parts,[m,f]=wr(t,s);if(this.el=Wt.createElement(m,i),rt.currentNode=this.el.content,s===2||s===3){const g=this.el.content.firstChild;g.replaceWith(...g.childNodes)}for(;(a=rt.nextNode())!==null&&u.length<d;){if(a.nodeType===1){if(a.hasAttributes())for(const g of a.getAttributeNames())if(g.endsWith(ma)){const S=f[o++],M=a.getAttribute(g).split(Ke),K=/([.?@])?(.*)/.exec(S);u.push({type:1,index:n,name:K[2],strings:M,ctor:K[1]==="."?br:K[1]==="?"?gr:K[1]==="@"?yr:zs}),a.removeAttribute(g)}else g.startsWith(Ke)&&(u.push({type:6,index:n}),a.removeAttribute(g));if(va.test(a.tagName)){const g=a.textContent.split(Ke),S=g.length-1;if(S>0){a.textContent=ms?ms.emptyScript:"";for(let M=0;M<S;M++)a.append(g[M],Vt()),rt.nextNode(),u.push({type:2,index:++n});a.append(g[S],Vt())}}}else if(a.nodeType===8)if(a.data===wa)u.push({type:2,index:n});else{let g=-1;for(;(g=a.data.indexOf(Ke,g+1))!==-1;)u.push({type:7,index:n}),g+=Ke.length-1}n++}}static createElement(t,s){const i=nt.createElement("template");return i.innerHTML=t,i}}function gt(e,t,s=e,i){if(t===ot)return t;let a=i!==void 0?s._$Co?.[i]:s._$Cl;const n=Ft(t)?void 0:t._$litDirective$;return a?.constructor!==n&&(a?._$AO?.(!1),n===void 0?a=void 0:(a=new n(e),a._$AT(e,s,i)),i!==void 0?(s._$Co??=[])[i]=a:s._$Cl=a),a!==void 0&&(t=gt(e,a._$AS(e,t.values),a,i)),t}class vr{constructor(t,s){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=s}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){const{el:{content:s},parts:i}=this._$AD,a=(t?.creationScope??nt).importNode(s,!0);rt.currentNode=a;let n=rt.nextNode(),o=0,d=0,u=i[0];for(;u!==void 0;){if(o===u.index){let m;u.type===2?m=new Xt(n,n.nextSibling,this,t):u.type===1?m=new u.ctor(n,u.name,u.strings,this,t):u.type===6&&(m=new $r(n,this,t)),this._$AV.push(m),u=i[++d]}o!==u?.index&&(n=rt.nextNode(),o++)}return rt.currentNode=nt,a}p(t){let s=0;for(const i of this._$AV)i!==void 0&&(i.strings!==void 0?(i._$AI(t,i,s),s+=i.strings.length-2):i._$AI(t[s])),s++}}class Xt{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(t,s,i,a){this.type=2,this._$AH=c,this._$AN=void 0,this._$AA=t,this._$AB=s,this._$AM=i,this.options=a,this._$Cv=a?.isConnected??!0}get parentNode(){let t=this._$AA.parentNode;const s=this._$AM;return s!==void 0&&t?.nodeType===11&&(t=s.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,s=this){t=gt(this,t,s),Ft(t)?t===c||t==null||t===""?(this._$AH!==c&&this._$AR(),this._$AH=c):t!==this._$AH&&t!==ot&&this._(t):t._$litType$!==void 0?this.$(t):t.nodeType!==void 0?this.T(t):mr(t)?this.k(t):this._(t)}O(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.O(t))}_(t){this._$AH!==c&&Ft(this._$AH)?this._$AA.nextSibling.data=t:this.T(nt.createTextNode(t)),this._$AH=t}$(t){const{values:s,_$litType$:i}=t,a=typeof i=="number"?this._$AC(t):(i.el===void 0&&(i.el=Wt.createElement(ga(i.h,i.h[0]),this.options)),i);if(this._$AH?._$AD===a)this._$AH.p(s);else{const n=new vr(a,this),o=n.u(this.options);n.p(s),this.T(o),this._$AH=n}}_$AC(t){let s=Li.get(t.strings);return s===void 0&&Li.set(t.strings,s=new Wt(t)),s}k(t){gi(this._$AH)||(this._$AH=[],this._$AR());const s=this._$AH;let i,a=0;for(const n of t)a===s.length?s.push(i=new Xt(this.O(Vt()),this.O(Vt()),this,this.options)):i=s[a],i._$AI(n),a++;a<s.length&&(this._$AR(i&&i._$AB.nextSibling,a),s.length=a)}_$AR(t=this._$AA.nextSibling,s){for(this._$AP?.(!1,!0,s);t!==this._$AB;){const i=Oi(t).nextSibling;Oi(t).remove(),t=i}}setConnected(t){this._$AM===void 0&&(this._$Cv=t,this._$AP?.(t))}}class zs{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,s,i,a,n){this.type=1,this._$AH=c,this._$AN=void 0,this.element=t,this.name=s,this._$AM=a,this.options=n,i.length>2||i[0]!==""||i[1]!==""?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=c}_$AI(t,s=this,i,a){const n=this.strings;let o=!1;if(n===void 0)t=gt(this,t,s,0),o=!Ft(t)||t!==this._$AH&&t!==ot,o&&(this._$AH=t);else{const d=t;let u,m;for(t=n[0],u=0;u<n.length-1;u++)m=gt(this,d[i+u],s,u),m===ot&&(m=this._$AH[u]),o||=!Ft(m)||m!==this._$AH[u],m===c?t=c:t!==c&&(t+=(m??"")+n[u+1]),this._$AH[u]=m}o&&!a&&this.j(t)}j(t){t===c?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}}class br extends zs{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===c?void 0:t}}class gr extends zs{constructor(){super(...arguments),this.type=4}j(t){this.element.toggleAttribute(this.name,!!t&&t!==c)}}class yr extends zs{constructor(t,s,i,a,n){super(t,s,i,a,n),this.type=5}_$AI(t,s=this){if((t=gt(this,t,s,0)??c)===ot)return;const i=this._$AH,a=t===c&&i!==c||t.capture!==i.capture||t.once!==i.once||t.passive!==i.passive,n=t!==c&&(i===c||a);a&&this.element.removeEventListener(this.name,this,i),n&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,t):this._$AH.handleEvent(t)}}class $r{constructor(t,s,i){this.element=t,this.type=6,this._$AN=void 0,this._$AM=s,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(t){gt(this,t)}}const xr=bi.litHtmlPolyfillSupport;xr?.(Wt,Xt),(bi.litHtmlVersions??=[]).push("3.3.3");const kr=(e,t,s)=>{const i=s?.renderBefore??t;let a=i._$litPart$;if(a===void 0){const n=s?.renderBefore??null;i._$litPart$=a=new Xt(t.insertBefore(Vt(),n),n,void 0,s??{})}return a._$AI(e),a};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const yi=globalThis;let y=class extends wt{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){const t=super.createRenderRoot();return this.renderOptions.renderBefore??=t.firstChild,t}update(t){const s=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=kr(s,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return ot}};y._$litElement$=!0,y.finalized=!0,yi.litElementHydrateSupport?.({LitElement:y});const _r=yi.litElementPolyfillSupport;_r?.({LitElement:y});(yi.litElementVersions??=[]).push("4.2.2");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 */const Ue=Ar(class extends Pr{constructor(e){if(super(e),e.type!==Ir.ATTRIBUTE||e.name!=="class"||e.strings?.length>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(e){return" "+Object.keys(e).filter(t=>e[t]).join(" ")+" "}update(e,[t]){if(this.st===void 0){this.st=new Set,e.strings!==void 0&&(this.nt=new Set(e.strings.join(" ").split(/\s/).filter(i=>i!=="")));for(const i in t)t[i]&&!this.nt?.has(i)&&this.st.add(i);return this.render(t)}const s=e.element.classList;for(const i of this.st)i in t||(s.remove(i),this.st.delete(i));for(const i in t){const a=!!t[i];a===this.st.has(i)||this.nt?.has(i)||(a?(s.add(i),this.st.add(i)):(s.remove(i),this.st.delete(i)))}return ot}});var Er=Object.defineProperty,Cr=Object.getOwnPropertyDescriptor,Ss=(e,t,s,i)=>{for(var a=i>1?void 0:i?Cr(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&Er(t,s,a),a};const ji={live:p`<circle cx="12" cy="12" r="3"/><path d="M6.3 6.3a8 8 0 0 0 0 11.4M17.7 6.3a8 8 0 0 1 0 11.4M3.5 3.5a12 12 0 0 0 0 17M20.5 3.5a12 12 0 0 1 0 17"/>`,explore:p`<path d="M3 6.5 9 4l6 2.5 6-2.5v13.5L15 20l-6-2.5L3 20z"/><path d="M9 4v13.5M15 6.5V20"/>`,investigate:p`<circle cx="11" cy="11" r="6.5"/><path d="m20 20-4.3-4.3M11 8v3l2 1.5"/>`,system:p`<circle cx="12" cy="12" r="3"/><path d="M19.4 15a1.7 1.7 0 0 0 .3 1.8l.1.1a2 2 0 1 1-2.8 2.8l-.1-.1a1.7 1.7 0 0 0-1.8-.3 1.7 1.7 0 0 0-1 1.5V21a2 2 0 1 1-4 0v-.1a1.7 1.7 0 0 0-1.1-1.5 1.7 1.7 0 0 0-1.8.3l-.1.1a2 2 0 1 1-2.8-2.8l.1-.1a1.7 1.7 0 0 0 .3-1.8 1.7 1.7 0 0 0-1.5-1H3a2 2 0 1 1 0-4h.1a1.7 1.7 0 0 0 1.5-1.1 1.7 1.7 0 0 0-.3-1.8l-.1-.1a2 2 0 1 1 2.8-2.8l.1.1a1.7 1.7 0 0 0 1.8.3H9a1.7 1.7 0 0 0 1-1.5V3a2 2 0 1 1 4 0v.1a1.7 1.7 0 0 0 1 1.5 1.7 1.7 0 0 0 1.8-.3l.1-.1a2 2 0 1 1 2.8 2.8l-.1.1a1.7 1.7 0 0 0-.3 1.8V9a1.7 1.7 0 0 0 1.5 1H21a2 2 0 1 1 0 4h-.1a1.7 1.7 0 0 0-1.5 1z"/>`,camera:p`<path d="M3 8.5A1.5 1.5 0 0 1 4.5 7H8l1.5-2h5L16 7h3.5A1.5 1.5 0 0 1 21 8.5v9a1.5 1.5 0 0 1-1.5 1.5h-15A1.5 1.5 0 0 1 3 17.5z"/><circle cx="12" cy="13" r="3.5"/>`,search:p`<circle cx="11" cy="11" r="6.5"/><path d="m20 20-4.3-4.3"/>`,bell:p`<path d="M6 16V11a6 6 0 0 1 12 0v5l1.5 2h-15z"/><path d="M10 20a2 2 0 0 0 4 0"/>`,user:p`<circle cx="12" cy="8" r="4"/><path d="M4 21a8 8 0 0 1 16 0"/>`,play:p`<path d="M7 5v14l11-7z"/>`,expand:p`<path d="M15 4h5v5M9 20H4v-5M20 4l-6 6M4 20l6-6"/>`,close:p`<path d="M6 6l12 12M18 6 6 18"/>`,chevron:p`<path d="m9 6 6 6-6 6"/>`,warning:p`<path d="M12 3 2.5 20h19z"/><path d="M12 9v5M12 17h.01"/>`,info:p`<circle cx="12" cy="12" r="9"/><path d="M12 11v5M12 8h.01"/>`,lock:p`<rect x="5" y="11" width="14" height="10" rx="2"/><path d="M8 11V7a4 4 0 0 1 8 0v4"/>`,unlock:p`<rect x="5" y="11" width="14" height="10" rx="2"/><path d="M8 11V7a4 4 0 0 1 7.5-2"/>`,offline:p`<path d="M2 8.5a15 15 0 0 1 20 0M5.5 12a10 10 0 0 1 13 0M9 15.5a5 5 0 0 1 6 0"/><path d="M12 19h.01"/><path d="M3 3l18 18"/>`,refresh:p`<path d="M20 12a8 8 0 1 1-2.3-5.7"/><path d="M20 4v5h-5"/>`,layers:p`<path d="m12 3 9 5-9 5-9-5z"/><path d="m3 13 9 5 9-5M3 17.5l9 5 9-5"/>`,floor:p`<path d="M4 6h16M4 12h16M4 18h16"/><path d="M8 3v18"/>`,plus:p`<path d="M12 5v14M5 12h14"/>`,minus:p`<path d="M5 12h14"/>`,fit:p`<path d="M4 9V4h5M20 9V4h-5M4 15v5h5M20 15v5h-5"/>`,door:p`<rect x="6" y="3" width="12" height="18" rx="1"/><path d="M14 12h.01"/>`,light:p`<path d="M9 18h6M10 21h4"/><path d="M12 3a6 6 0 0 0-3.5 10.9c.8.6 1.5 1.6 1.5 2.6h4c0-1 .7-2 1.5-2.6A6 6 0 0 0 12 3z"/>`,sensor:p`<circle cx="12" cy="12" r="2"/><path d="M7.8 7.8a6 6 0 0 0 0 8.4M16.2 7.8a6 6 0 0 1 0 8.4M4.9 4.9a10 10 0 0 0 0 14.2M19.1 4.9a10 10 0 0 1 0 14.2"/>`,check:p`<path d="m5 12 5 5 9-10"/>`,clock:p`<circle cx="12" cy="12" r="9"/><path d="M12 7v5l3 2"/>`,download:p`<path d="M12 4v11M7 10l5 5 5-5M4 20h16"/>`,pin:p`<path d="M9 4h6l-1 6 3 3v2H7v-2l3-3z"/><path d="M12 15v6"/>`,more:p`<circle cx="6" cy="12" r="1.3"/><circle cx="12" cy="12" r="1.3"/><circle cx="18" cy="12" r="1.3"/>`,building:p`<rect x="4" y="3" width="16" height="18" rx="1"/><path d="M9 7h2M13 7h2M9 11h2M13 11h2M9 15h2M13 15h2M10 21v-3h4v3"/>`,map:p`<path d="M3 6.5 9 4l6 2.5 6-2.5v13.5L15 20l-6-2.5L3 20z"/>`,upload:p`<path d="M12 16V5M7 10l5-5 5 5M4 20h16"/>`,list:p`<path d="M8 6h13M8 12h13M8 18h13M3 6h.01M3 12h.01M3 18h.01"/>`,history:p`<path d="M3 12a9 9 0 1 0 3-6.7"/><path d="M3 4v5h5M12 8v4l3 2"/>`,target:p`<circle cx="12" cy="12" r="8"/><circle cx="12" cy="12" r="3"/><path d="M12 2v4M12 18v4M2 12h4M18 12h4"/>`,filter:p`<path d="M4 5h16l-6 8v6l-4-2v-4z"/>`,users:p`<circle cx="9" cy="8" r="3.5"/><path d="M2.5 20a6.5 6.5 0 0 1 13 0"/><circle cx="17" cy="9" r="2.5"/><path d="M15.5 14.5A5 5 0 0 1 21.5 20"/>`,shield:p`<path d="M12 3 4 6v6c0 4.5 3.4 7.7 8 9 4.6-1.3 8-4.5 8-9V6z"/><path d="m9 12 2 2 4-4"/>`,storage:p`<rect x="3" y="4" width="18" height="6" rx="1.5"/><rect x="3" y="14" width="18" height="6" rx="1.5"/><path d="M7 7h.01M7 17h.01"/>`,edit:p`<path d="M4 20h4l10.5-10.5a2 2 0 0 0 0-2.8l-1.2-1.2a2 2 0 0 0-2.8 0L4 16z"/><path d="m13 7 4 4"/>`,pause:p`<path d="M8 5v14M16 5v14"/>`,skip:p`<path d="M5 5v14l8-7zM15 5h2v14h-2z"/>`,case:p`<rect x="3" y="7" width="18" height="13" rx="2"/><path d="M8 7V5a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2M3 12h18"/>`,rule:p`<path d="M4 6h10M4 12h16M4 18h7"/><circle cx="18" cy="6" r="2"/><circle cx="15" cy="18" r="2"/>`,link:p`<path d="M10 14a4 4 0 0 0 5.7 0l3-3a4 4 0 0 0-5.7-5.7l-1 1"/><path d="M14 10a4 4 0 0 0-5.7 0l-3 3a4 4 0 0 0 5.7 5.7l1-1"/>`,grid:p`<rect x="3" y="3" width="7" height="7" rx="1.5"/><rect x="14" y="3" width="7" height="7" rx="1.5"/><rect x="3" y="14" width="7" height="7" rx="1.5"/><rect x="14" y="14" width="7" height="7" rx="1.5"/>`,dashboard:p`<rect x="3" y="3" width="8" height="10" rx="1.5"/><rect x="13" y="3" width="8" height="6" rx="1.5"/><rect x="13" y="11" width="8" height="10" rx="1.5"/><rect x="3" y="15" width="8" height="6" rx="1.5"/>`,home:p`<path d="M3 11 12 4l9 7"/><path d="M5 10v10h14V10"/><path d="M10 20v-6h4v6"/>`,star:p`<path d="m12 3 2.8 5.7 6.2.9-4.5 4.4 1 6.2-5.5-2.9L6.5 20.2l1-6.2L3 9.6l6.2-.9z"/>`,aperture:p`<circle cx="12" cy="12" r="9"/><path d="m14.3 4.5-5 8.6M20.7 9.5H10.8M18.4 17.5l-5-8.6M9.7 19.5l5-8.6M3.3 14.5h9.9M5.6 6.5l5 8.6"/>`,volume:p`<path d="M4 9.5v5h3.5L12 18.5v-13L7.5 9.5z"/><path d="M15.5 8.5a5 5 0 0 1 0 7M18.5 5.5a9 9 0 0 1 0 13"/>`,mic:p`<rect x="9" y="3" width="6" height="11" rx="3"/><path d="M5.5 11a6.5 6.5 0 0 0 13 0M12 17.5V21M9 21h6"/>`,back10:p`<path d="M4 12a8 8 0 1 0 2.3-5.7"/><path d="M4 4v5h5"/><path d="M10.5 15.5V10l-1.5 1"/><rect x="13.5" y="10" width="3.5" height="5.5" rx="1.7"/>`,forward10:p`<path d="M20 12a8 8 0 1 1-2.3-5.7"/><path d="M20 4v5h-5"/><path d="M10.5 15.5V10l-1.5 1"/><rect x="13.5" y="10" width="3.5" height="5.5" rx="1.7"/>`,chevronDown:p`<path d="m6 9 6 6 6-6"/>`,stairs:p`<path d="M3 20h4v-4h4v-4h4V8h5"/>`,elevator:p`<rect x="4" y="3" width="16" height="18" rx="1.5"/><path d="M12 3v18M8 10l1.5-2 1.5 2M14.5 14l1.5 2 1.5-2"/>`,menu:p`<path d="M4 7h16M4 12h16M4 17h16"/>`,calendar:p`<rect x="3" y="5" width="18" height="16" rx="2"/><path d="M3 10h18M8 3v4M16 3v4"/>`,trash:p`<path d="M4 7h16M9 7V4h6v3M6 7l1 13h10l1-13"/>`,eye:p`<path d="M2 12s3.5-6 10-6 10 6 10 6-3.5 6-10 6S2 12 2 12z"/><circle cx="12" cy="12" r="3"/>`,cpu:p`<rect x="6" y="6" width="12" height="12" rx="2"/><rect x="9" y="9" width="6" height="6"/><path d="M9 2v4M15 2v4M9 18v4M15 18v4M2 9h4M2 15h4M18 9h4M18 15h4"/>`,activity:p`<path d="M3 12h4l3-8 4 16 3-8h4"/>`,image:p`<rect x="3" y="4" width="18" height="16" rx="2"/><circle cx="8.5" cy="9.5" r="1.5"/><path d="m21 16-5-5-9 9"/>`,wifi:p`<path d="M2 8.5a15 15 0 0 1 20 0M5.5 12a10 10 0 0 1 13 0M9 15.5a5 5 0 0 1 6 0"/><path d="M12 19h.01"/>`,signal:p`<path d="M4 18v-3M9 18v-7M14 18V7M19 18V4"/>`,move:p`<path d="M12 3v18M3 12h18M8 7l4-4 4 4M8 17l4 4 4-4M7 8l-4 4 4 4M17 8l4 4-4 4"/>`,bookmark:p`<path d="M6 3h12v18l-6-4-6 4z"/>`,route:p`<circle cx="6" cy="18" r="2.5"/><circle cx="18" cy="6" r="2.5"/><path d="M8 17c5-1 3-9 8-10"/>`,logout:p`<path d="M10 4H5v16h5M14 8l4 4-4 4M18 12H9"/>`};let yt=class extends y{constructor(){super(...arguments),this.name="info",this.size=20,this.flip=!1}render(){this.style.setProperty("--sw-icon-size",`${this.size}px`);const e=this.name==="chevron";return r`<svg viewBox="0 0 24 24" aria-hidden="true" ?data-dir=${e}>${ji[this.name]??ji.info}</svg>`}};yt.styles=x`
  ...
  `;Ss([h()],yt.prototype,"name",2);Ss([h({type:Number})],yt.prototype,"size",2);Ss([h({type:Boolean,reflect:!0})],yt.prototype,"flip",2);yt=Ss([k("sw-icon")],yt);var Tr=Object.defineProperty,Or=Object.getOwnPropertyDescriptor,je=(e,t,s,i)=>{for(var a=i>1?void 0:i?Or(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&Tr(t,s,a),a};let ze=class extends y{constructor(){super(...arguments),this.variant="secondary",this.size="md",this.disabled=!1,this.iconOnly=!1,this.round=!1,this.label="",this.type="button"}render(){return r`
  ...
  `;Ms([h({reflect:!0})],$t.prototype,"kind",2);Ms([h()],$t.prototype,"label",2);Ms([h({type:Boolean,reflect:!0})],$t.prototype,"onImage",2);$t=Ms([k("sw-badge")],$t);var Hr=Object.defineProperty,Lr=Object.getOwnPropertyDescriptor,Qt=(e,t,s,i)=>{for(var a=i>1?void 0:i?Lr(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&Hr(t,s,a),a};let lt=class extends y{constructor(){super(...arguments),this.items=[],this.active="",this.segmented=!1,this.underline=!1}choose(e){this.active=e.id,this.dispatchEvent(new CustomEvent("change",{detail:{id:e.id},bubbles:!0,composed:!0}))}render(){return r`${this.items.map(e=>e.href?r`<a href=${e.href} class=${e.id===this.active?"on":""} aria-current=${e.id===this.active?"page":"false"}>${e.label}${e.count!==void 0?r`<span class="count">(${e.count})</span>`:""}</a>`:r`<button type="button" class=${e.id===this.active?"on":""} aria-pressed=${e.id===this.active} @click=${()=>this.choose(e)}>${e.label}${e.count!==void 0?r`<span class="count">(${e.count})</span>`:""}</button>`)}`}};lt.styles=x`
    :host {
      display: inline-flex;
      gap: 2px;
      overflow-x: auto;
  ...
  `;Qt([h({attribute:!1})],lt.prototype,"items",2);Qt([h()],lt.prototype,"active",2);Qt([h({type:Boolean,reflect:!0})],lt.prototype,"segmented",2);Qt([h({type:Boolean,reflect:!0})],lt.prototype,"underline",2);lt=Qt([k("sw-tabs")],lt);var jr=Object.defineProperty,Vr=Object.getOwnPropertyDescriptor,$i=(e,t,s,i)=>{for(var a=i>1?void 0:i?Vr(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&jr(t,s,a),a};let Ut=class extends y{constructor(){super(...arguments),this.name="",this.size=32}render(){this.style.setProperty("--sz",`${this.size}px`);const e=this.name.trim().split(/\s+/),t=e.length>1?e[0][0]+e[1][0]:this.name.slice(0,2);return r`${t}`}};Ut.styles=x`
    :host {
      display: inline-grid;
      place-items: center;
  ...
  `;$i([h()],Ut.prototype,"name",2);$i([h({type:Number})],Ut.prototype,"size",2);Ut=$i([k("sw-avatar")],Ut);var Fr=Object.defineProperty,Wr=Object.getOwnPropertyDescriptor,es=(e,t,s,i)=>{for(var a=i>1?void 0:i?Wr(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&Fr(t,s,a),a};let dt=class extends y{constructor(){super(...arguments),this.selected=!1,this.dot=""}render(){return r`
  ...
  `;es([h({type:Boolean,reflect:!0})],dt.prototype,"selected",2);es([h()],dt.prototype,"icon",2);es([h({type:Number})],dt.prototype,"count",2);es([h()],dt.prototype,"dot",2);dt=es([k("sw-chip")],dt);var Ur=Object.defineProperty,Zr=Object.getOwnPropertyDescriptor,Is=(e,t,s,i)=>{for(var a=i>1?void 0:i?Zr(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&Ur(t,s,a),a};let xt=class extends y{constructor(){super(...arguments),this.open=!1,this.heading="",this.subheading=""}close(){this.open=!1,this.dispatchEvent(new CustomEvent("close",{bubbles:!0,composed:!0}))}render(){return r`
  ...
  `;It([h()],Ge.prototype,"heading",2);It([h({type:Number})],Ge.prototype,"x",2);It([h({type:Number})],Ge.prototype,"y",2);It([h({type:Number})],Ge.prototype,"stageWidth",2);It([h({type:Number})],Ge.prototype,"stageHeight",2);Ge=It([k("sw-popover")],Ge);var Gr=Object.defineProperty,Jr=Object.getOwnPropertyDescriptor,As=(e,t,s,i)=>{for(var a=i>1?void 0:i?Jr(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&Gr(t,s,a),a};let kt=class extends y{constructor(){super(...arguments),this.label="",this.hint="",this.inline=!1}render(){return r`
  ...
  `;As([h()],kt.prototype,"label",2);As([h()],kt.prototype,"hint",2);As([h({type:Boolean,reflect:!0})],kt.prototype,"inline",2);kt=As([k("sw-field")],kt);var Yr=Object.defineProperty,Xr=Object.getOwnPropertyDescriptor,ya=(e,t,s,i)=>{for(var a=i>1?void 0:i?Xr(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&Yr(t,s,a),a};let Qr=0,ws=class extends y{constructor(){super(...arguments),this.kind="lobby",this.uid=`sc${Qr+=1}`}grad(e,t,s=!0){const i=`${e}-${this.uid}`;return p`<linearGradient id=${i} x1="0" y1="0" x2=${s?0:1} y2=${s?1:0}>${t.map(([a,n])=>p`<stop offset=${a} stop-color=${n} />`)}</linearGradient>`}url(e){return`url(#${e}-${this.uid})`}vignette(){const e=`vig-${this.uid}`;return p`<defs><radialGradient id=${e} cx="50%" cy="45%" r="72%"><stop offset="0.55" stop-color="#000" stop-opacity="0" /><stop offset="1" stop-color="#000" stop-opacity="0.38" /></radialGradient></defs><rect width="320" height="180" fill=${`url(#${e})`} />`}entrance(){return p`
  ...
  `;ce([h()],te.prototype,"cameraId",2);ce([h()],te.prototype,"profile",2);ce([h()],te.prototype,"mode",2);ce([h()],te.prototype,"poster",2);ce([h({type:Boolean})],te.prototype,"active",2);ce([h({type:Boolean,reflect:!0})],te.prototype,"compact",2);ce([h()],te.prototype,"wsUrl",2);ce([h({type:Boolean})],te.prototype,"retry",2);ce([l()],te.prototype,"status",2);ce([l()],te.prototype,"transport",2);ce([l()],te.prototype,"error",2);ce([l()],te.prototype,"muted",2);ce([Mt("video")],te.prototype,"video",2);te=ce([k("sw-live-player")],te);var mn=Object.defineProperty,wn=Object.getOwnPropertyDescriptor,ne=(e,t,s,i)=>{for(var a=i>1?void 0:i?wn(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&mn(t,s,a),a};let X=class extends y{constructor(){super(...arguments),this.name="",this.meta="",this.state="unknown",this.scene="lobby",this.selected=!1,this.compact=!1,this.dark=!1,this.noDemo=!1,this.stamp="",this.poster="",this.cameraId="",this.live=!1,this.profile="sub",this.transport="auto"}offMessage(){return this.state==="forbidden"?"אין הרשאת צפייה":this.state==="offline"?"המצלמה מנותקת":"מצב לא ידוע"}render(){if(this.state==="offline"||this.state==="forbidden"||this.state==="unknown")return r`<div class="off">
  ...
  `;ne([h()],X.prototype,"name",2);ne([h()],X.prototype,"meta",2);ne([h({reflect:!0})],X.prototype,"state",2);ne([h({reflect:!0})],X.prototype,"scene",2);ne([h({type:Boolean,reflect:!0})],X.prototype,"selected",2);ne([h({type:Boolean,reflect:!0})],X.prototype,"compact",2);ne([h({type:Boolean,reflect:!0})],X.prototype,"dark",2);ne([h({type:Boolean,reflect:!0})],X.prototype,"noDemo",2);ne([h()],X.prototype,"stamp",2);ne([h()],X.prototype,"poster",2);ne([h()],X.prototype,"cameraId",2);ne([h({type:Boolean})],X.prototype,"live",2);ne([h()],X.prototype,"profile",2);ne([h()],X.prototype,"transport",2);X=ne([k("sw-camera-tile")],X);var vn=Object.defineProperty,bn=Object.getOwnPropertyDescriptor,Pt=(e,t,s,i)=>{for(var a=i>1?void 0:i?bn(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&vn(t,s,a),a};const gn={loading:{icon:"clock",title:()=>v("states.loading"),hint:()=>"",tone:"neutral"},empty:{icon:"map",title:()=>v("states.empty"),hint:()=>"",tone:"neutral"},error:{icon:"warning",title:()=>v("states.error"),hint:()=>v("states.errorHint"),tone:"danger"},forbidden:{icon:"lock",title:()=>v("states.forbidden"),hint:()=>v("states.forbiddenHint"),tone:"forbidden"},stale:{icon:"offline",title:()=>v("states.stale"),hint:()=>v("states.staleHint"),tone:"stale"},partial:{icon:"info",title:()=>v("states.partial"),hint:()=>"",tone:"stale"}};let Je=class extends y{constructor(){super(...arguments),this.state="empty",this.heading="",this.hint="",this.actionLabel="",this.compact=!1}render(){const e=gn[this.state],t=this.hint||e.hint();return r`
  ...
  `;Pt([h({reflect:!0})],Je.prototype,"state",2);Pt([h()],Je.prototype,"heading",2);Pt([h()],Je.prototype,"hint",2);Pt([h()],Je.prototype,"actionLabel",2);Pt([h({type:Boolean,reflect:!0})],Je.prototype,"compact",2);Je=Pt([k("sw-state-panel")],Je);var yn=Object.defineProperty,$n=Object.getOwnPropertyDescriptor,Ps=(e,t,s,i)=>{for(var a=i>1?void 0:i?$n(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&yn(t,s,a),a};let _t=class extends y{constructor(){super(...arguments),this.open=!1,this.heading="",this.subheading="",this.onKey=e=>{e.key==="Escape"&&this.open&&this.close()}}close(){this.open=!1,this.dispatchEvent(new CustomEvent("close",{bubbles:!0,composed:!0}))}connectedCallback(){super.connectedCallback(),window.addEventListener("keydown",this.onKey)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("keydown",this.onKey)}render(){return r`<div class="backdrop" @click=${e=>e.target===e.currentTarget&&this.close()}>
  ...
  `;Ps([h({type:Boolean,reflect:!0})],_t.prototype,"open",2);Ps([h()],_t.prototype,"heading",2);Ps([h()],_t.prototype,"subheading",2);_t=Ps([k("sw-dialog")],_t);var xn=Object.defineProperty,kn=Object.getOwnPropertyDescriptor,H=(e,t,s,i)=>{for(var a=i>1?void 0:i?kn(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&xn(t,s,a),a};const Ds=.2,Rs=6,Vi={live:"var(--sw-accent)",recorded:"var(--sw-accent)",historic:"var(--sw-accent)",offline:"var(--sw-offline)",stale:"var(--sw-stale)",unknown:"var(--sw-unknown)",forbidden:"var(--sw-forbidden)",error:"var(--sw-danger)",neutral:"var(--sw-surface)",partial:"var(--sw-stale)"},_n={camera:p`<path d="M-7 -4.5A1.5 1.5 0 0 1 -5.5 -6H-2l1.5-2h5L6 -6h1.5A1.5 1.5 0 0 1 9 -4.5v9A1.5 1.5 0 0 1 7.5 6h-13A1.5 1.5 0 0 1 -7 4.5z" transform="translate(-1 0) scale(0.9)"/><circle cx="-1" cy="0" r="3"/>`,lock:p`<rect x="-6" y="-2" width="12" height="9" rx="2"/><path d="M-3.5 -2v-3a3.5 3.5 0 0 1 7 0v3"/>`,light:p`<path d="M-3 6h6M-2 8.5h4"/><path d="M0 -8a5 5 0 0 0-3 9c.7.5 1.2 1.3 1.2 2.2h3.6c0-.9.5-1.7 1.2-2.2A5 5 0 0 0 0 -8z"/>`,binary_sensor:p`<circle cx="0" cy="0" r="2"/><path d="M-4.5 -4.5a6.4 6.4 0 0 0 0 9M4.5 -4.5a6.4 6.4 0 0 1 0 9"/>`};function zn(e){let t=0,s=0,i=0;for(let a=0;a<e.length;a++){const n=e[a],o=e[(a+1)%e.length],d=n.x*o.y-o.x*n.y;t+=d,s+=(n.x+o.x)*d,i+=(n.y+o.y)*d}if(Math.abs(t)<1e-12){const a=e.length||1;return{x:e.reduce((n,o)=>n+o.x,0)/a,y:e.reduce((n,o)=>n+o.y,0)/a}}return{x:s/(3*t),y:i/(3*t)}}let T=class extends y{constructor(){super(...arguments),this.planWidth=1e3,this.planHeight=700,this.plan=null,this.markers=[],this.selectedId=null,this.selectedIds=[],this.dimEntities=!1,this.alwaysLabel=!1,this.imageUrl=null,this.editable=!1,this.placing=!1,this.coneRadius=140,this.zones=[],this.selectedZoneId=null,this.zoneLabels=!0,this.draftPoints=[],this.scale=1,this.tx=0,this.ty=0,this.hoverId=null,this.dragging=null,this.orienting=null,this.zoneDraft=null,this.lastVertexPress=null,this.pointers=new Map,this.lastPan=null,this.lastPinchDist=0,this.dragMoved=!1,this.fitted=!1,this.onWheel=e=>{e.preventDefault();const t=this.getBoundingClientRect();this.zoomBy(e.deltaY<0?1.15:1/1.15,e.clientX-t.left,e.clientY-t.top)},this.onMarkerPointerDown=(e,t)=>{if(!this.editable||t.button!==0)return;t.stopPropagation(),t.preventDefault(),this.dragging={id:e.id,x:e.x,y:e.y},this.viewport.setPointerCapture(t.pointerId);const s=a=>{const n=this.getBoundingClientRect(),o=this.toPlan(a.clientX-n.left,a.clientY-n.top);this.dragging={id:e.id,x:o.x,y:o.y}},i=a=>{this.viewport.removeEventListener("pointermove",s),this.viewport.removeEventListener("pointerup",i),this.viewport.removeEventListener("pointercancel",i);const n=this.getBoundingClientRect(),o=this.toPlan(a.clientX-n.left,a.clientY-n.top),d=Math.abs(o.x-e.x)>5e-4||Math.abs(o.y-e.y)>5e-4;this.dragging=null,d?(this.dragMoved=!0,setTimeout(()=>this.dragMoved=!1,0),this.dispatchEvent(new CustomEvent("marker-move",{detail:{id:e.id,x:o.x,y:o.y},bubbles:!0,composed:!0}))):this.select(e,a)};this.viewport.addEventListener("pointermove",s),this.viewport.addEventListener("pointerup",i),this.viewport.addEventListener("pointercancel",i)},this.onPointerDown=e=>{this.pointers.set(e.pointerId,{x:e.clientX,y:e.clientY}),this.dragMoved=!1,this.pointers.size===1?(this.lastPan={x:e.clientX,y:e.clientY},this.viewport.classList.add("dragging")):this.pointers.size===2&&(this.lastPinchDist=this.pinchDistance(),this.lastPan=null)},this.onPointerMove=e=>{if(this.pointers.has(e.pointerId)){if(this.pointers.set(e.pointerId,{x:e.clientX,y:e.clientY}),this.pointers.size===2){const t=this.pinchDistance();if(this.lastPinchDist>0){const[s,i]=[...this.pointers.values()],a=this.getBoundingClientRect();this.zoomBy(t/this.lastPinchDist,(s.x+i.x)/2-a.left,(s.y+i.y)/2-a.top)}this.lastPinchDist=t,this.dragMoved=!0;return}if(this.lastPan){const t=e.clientX-this.lastPan.x,s=e.clientY-this.lastPan.y;!this.dragMoved&&Math.abs(t)+Math.abs(s)>2&&(this.dragMoved=!0,this.viewport.hasPointerCapture(e.pointerId)||this.viewport.setPointerCapture(e.pointerId)),this.tx+=t,this.ty+=s,this.lastPan={x:e.clientX,y:e.clientY}}}},this.onPointerUp=e=>{if(this.pointers.delete(e.pointerId),this.pointers.size===0)this.lastPan=null,this.viewport.classList.remove("dragging");else if(this.pointers.size===1){const[t]=[...this.pointers.values()];this.lastPan={x:t.x,y:t.y}}},this.onBackgroundClick=e=>{if(!this.dragMoved){if(this.placing){const t=this.getBoundingClientRect(),s=this.toPlan(e.clientX-t.left,e.clientY-t.top);this.dispatchEvent(new CustomEvent("plan-click",{detail:{x:+s.x.toFixed(4),y:+s.y.toFixed(4)},bubbles:!0,composed:!0}));return}this.dispatchEvent(new CustomEvent("marker-select",{detail:{id:null},bubbles:!0,composed:!0}))}},this.onHandlePointerDown=(e,t,s)=>{if(!this.editable||s.button!==0)return;s.stopPropagation(),s.preventDefault();const i=this.getBoundingClientRect(),a=e.rotation??0,n=e.fov??90,o=t==="left"?a+n/2:a-n/2;this.orienting={id:e.id,rotation:a,fov:n},this.viewport.setPointerCapture(s.pointerId);const d=f=>{const g=this.bearingTo(e,f.clientX-i.left,f.clientY-i.top);if(t==="dir")return{rotation:Math.round(g),fov:n};let S=t==="left"?o-g:g-o;S=(S%360+360)%360;const M=Math.max(10,Math.min(180,Math.round(S))),K=t==="left"?o-M/2:o+M/2;return{rotation:Math.round((K%360+360)%360),fov:M}},u=f=>{this.orienting={id:e.id,...d(f)}},m=f=>{this.viewport.removeEventListener("pointermove",u),this.viewport.removeEventListener("pointerup",m),this.viewport.removeEventListener("pointercancel",m);const g=d(f);this.orienting=null,this.dragMoved=!0,setTimeout(()=>this.dragMoved=!1,0),(g.rotation!==a||g.fov!==n)&&this.dispatchEvent(new CustomEvent("marker-orient",{detail:{id:e.id,...g},bubbles:!0,composed:!0}))};this.viewport.addEventListener("pointermove",u),this.viewport.addEventListener("pointerup",m),this.viewport.addEventListener("pointercancel",m)}}connectedCallback(){super.connectedCallback(),this.resizeObserver=new ResizeObserver(()=>{this.fitted||this.fit()}),this.resizeObserver.observe(this)}disconnectedCallback(){super.disconnectedCallback(),this.resizeObserver?.disconnect()}updated(e){(e.has("planWidth")||e.has("planHeight"))&&(this.fitted=!1,this.fit()),(e.has("scale")||e.has("tx")||e.has("ty"))&&this.dispatchEvent(new CustomEvent("view-change",{bubbles:!0,composed:!0}))}get zoom(){return this.scale}focusMarker(e){const t=this.renderRoot.querySelector(`g.marker[data-id="${CSS.escape(e)}"]`);return t?.focus(),!!t}toScreen(e,t){return{x:this.tx+e*this.planWidth*this.scale,y:this.ty+t*this.planHeight*this.scale}}fit(){const e=this.clientWidth,t=this.clientHeight;if(!e||!t||!this.planWidth||!this.planHeight)return;const s=24,i=Math.min((e-s*2)/this.planWidth,(t-s*2)/this.planHeight);this.scale=Math.max(Ds,Math.min(Rs,i)),this.tx=(e-this.planWidth*this.scale)/2,this.ty=(t-this.planHeight*this.scale)/2,this.fitted=!0}zoomToBox(e,t,s,i,a=48){const n=this.clientWidth,o=this.clientHeight;if(!n||!o||!this.planWidth||!this.planHeight)return;const d=Math.max(1e-6,s-e)*this.planWidth,u=Math.max(1e-6,i-t)*this.planHeight,m=Math.max(Ds,Math.min(Rs,Math.min((n-a*2)/d,(o-a*2)/u,2.5)));this.scale=m,this.tx=n/2-(e+s)/2*this.planWidth*m,this.ty=o/2-(t+i)/2*this.planHeight*m,this.fitted=!0}zoomBy(e,t,s){const i=this.clientWidth,a=this.clientHeight,n=t??i/2,o=s??a/2,d=Math.max(Ds,Math.min(Rs,this.scale*e)),u=d/this.scale;this.tx=n-(n-this.tx)*u,this.ty=o-(o-this.ty)*u,this.scale=d,this.fitted=!0}toPlan(e,t){return{x:Math.min(1,Math.max(0,(e-this.tx)/this.scale/this.planWidth)),y:Math.min(1,Math.max(0,(t-this.ty)/this.scale/this.planHeight))}}pinchDistance(){const[e,t]=[...this.pointers.values()];return Math.hypot(e.x-t.x,e.y-t.y)}select(e,t){if(this.dragMoved)return;t.stopPropagation();const s=this.toScreen(e.x,e.y),i={id:e.id,sx:s.x,sy:s.y};this.dispatchEvent(new CustomEvent("marker-select",{detail:i,bubbles:!0,composed:!0}))}selectZone(e,t){this.dragMoved||this.placing||(t.stopPropagation(),this.dispatchEvent(new CustomEvent("zone-select",{detail:{id:e.id},bubbles:!0,composed:!0})))}onVertexPointerDown(e,t,s,i=!1){if(!this.editable||s.button!==0)return;if(s.stopPropagation(),s.preventDefault(),!i){const m=this.lastVertexPress,f=performance.now();if(m&&m.id===e.id&&m.index===t&&f-m.at<450){this.lastVertexPress=null,this.removeVertex(e,t,s);return}this.lastVertexPress={id:e.id,index:t,at:f}}const a=this.getBoundingClientRect();let n=e.polygon.map(m=>({x:m.x,y:m.y})),o=t;if(i){const m=n[t],f=n[(t+1)%n.length];n.splice(t+1,0,{x:+((m.x+f.x)/2).toFixed(4),y:+((m.y+f.y)/2).toFixed(4)}),o=t+1}this.zoneDraft={id:e.id,polygon:n},this.viewport.setPointerCapture(s.pointerId);const d=m=>{const f=this.toPlan(m.clientX-a.left,m.clientY-a.top);n=n.map((g,S)=>S===o?{x:+f.x.toFixed(4),y:+f.y.toFixed(4)}:g),this.zoneDraft={id:e.id,polygon:n}},u=()=>{this.viewport.removeEventListener("pointermove",d),this.viewport.removeEventListener("pointerup",u),this.viewport.removeEventListener("pointercancel",u);const m=i||n.some((f,g)=>f.x!==e.polygon[g].x||f.y!==e.polygon[g].y);this.zoneDraft=null,this.dragMoved=!0,setTimeout(()=>this.dragMoved=!1,0),m&&this.dispatchEvent(new CustomEvent("zone-edit",{detail:{id:e.id,polygon:n},bubbles:!0,composed:!0}))};this.viewport.addEventListener("pointermove",d),this.viewport.addEventListener("pointerup",u),this.viewport.addEventListener("pointercancel",u)}removeVertex(e,t,s){if(s.stopPropagation(),!this.editable||e.polygon.length<=3)return;const i=e.polygon.filter((a,n)=>n!==t);this.dispatchEvent(new CustomEvent("zone-edit",{detail:{id:e.id,polygon:i},bubbles:!0,composed:!0}))}renderZoneHandles(e,t){const s=1/this.scale,i=this.planWidth,a=this.planHeight;return p`<g class="zone-handles">
      ${t.map((n,o)=>{const d=t[(o+1)%t.length];return p`<circle class="vmid" cx=${((n.x+d.x)/2*i).toFixed(1)} cy=${((n.y+d.y)/2*a).toFixed(1)} r=${(4*s).toFixed(2)} stroke-width=${(1.2*s).toFixed(2)} role="button" aria-label="הוסף פינה"
      ...
      ${t.map((n,o)=>p`<circle class="vtx" data-vertex=${o} cx=${(n.x*i).toFixed(1)} cy=${(n.y*a).toFixed(1)} r=${(6*s).toFixed(2)} stroke-width=${(1.6*s).toFixed(2)} role="slider" aria-label=${`פינה ${o+1}`}
          @pointerdown=${d=>this.onVertexPointerDown(e,o,d)} @click=${d=>d.stopPropagation()} />`)}
    </g>`}renderZone(e){if(e.polygon.length<3)return c;const t=1/this.scale,s=this.zoneDraft?.id===e.id?this.zoneDraft.polygon:e.polygon,i=s.map(S=>`${(S.x*this.planWidth).toFixed(1)},${(S.y*this.planHeight).toFixed(1)}`).join(" "),a=zn(s),n=this.selectedZoneId===e.id,o=Math.max(36,e.name.length*7+18),d=s.map(S=>S.x),u=s.map(S=>S.y),m=(Math.max(...d)-Math.min(...d))*this.planWidth*this.scale,f=(Math.max(...u)-Math.min(...u))*this.planHeight*this.scale,g=n||e.candidate||m>=o+12&&f>=30;return p`
      <g class="zone ${n?"selected":""} ${e.candidate?"candidate":""}" style="--zc:${e.color}" role="button" tabindex="0" aria-label=${e.name} aria-pressed=${n}
        ...
        ${this.zoneLabels&&e.name&&g?p`<g transform="translate(${(a.x*this.planWidth).toFixed(1)} ${(a.y*this.planHeight).toFixed(1)}) scale(${t})">
    ...
    </g>`}bearingTo(e,t,s){const i=this.toScreen(e.x,e.y);return((Math.atan2(s-i.y,t-i.x)*180/Math.PI+90)%360+360)%360}renderHandles(e,t,s){const i=this.coneRadius,a=1/this.scale,n=(f,g)=>({x:Math.cos(T.rad(f))*g,y:Math.sin(T.rad(f))*g}),o=n(t-s/2,i),d=n(t+s/2,i),u=n(t,i*.72),m=7*a;return p`
      ...
      <rect class="handle" x=${(d.x-m).toFixed(1)} y=${(d.y-m).toFixed(1)} width=${(m*2).toFixed(1)} height=${(m*2).toFixed(1)} rx=${(1.5*a).toFixed(1)} role="slider" aria-label="קצה שדה ראייה" @pointerdown=${f=>this.onHandlePointerDown(e,"right",f)} @click=${f=>f.stopPropagation()} />
    ...
    `}static rad(e){return(e-90)*Math.PI/180}fovPath(e,t,s){const i=T.rad(e-t/2),a=T.rad(e+t/2),n=Math.cos(i)*s,o=Math.sin(i)*s,d=Math.cos(a)*s,u=Math.sin(a)*s;return`M0 0 L${n.toFixed(1)} ${o.toFixed(1)} A${s} ${s} 0 ${t>180?1:0} 1 ${d.toFixed(1)} ${u.toFixed(1)} Z`}renderMarker(e){const t=this.dragging?.id===e.id?this.dragging:e,s=this.orienting?.id===e.id?this.orienting:null,i=s?s.rotation:e.rotation??0,a=s?s.fov:e.fov,n=t.x*this.planWidth,o=t.y*this.planHeight,d=1/this.scale,u=e.kind==="camera",m=Vi[e.state]??Vi.neutral,f=this.selectedId===e.id||this.selectedIds.includes(e.id),g=this.alwaysLabel||f||this.hoverId===e.id,S=Math.max(44,e.label.length*6.5+16),M=this.dimEntities&&!u,K=u?13:11;return p`
      <g class="marker ${e.state} ${f?"selected":""} ${M?"dimmed":""} ${this.editable?"editable":""}"
        ...
        <g transform="scale(${d})">
          <circle class="halo" r=${K+9} />
          <circle class="pin" r=${K} fill=${m} />
          <g class="icon" transform="scale(${u?.85:.75})">${_n[e.kind]}</g>
          ...
          ${g?p`<g transform="translate(0 ${K+14})">
  ...
  `;H([h({type:Number})],T.prototype,"planWidth",2);H([h({type:Number})],T.prototype,"planHeight",2);H([h({attribute:!1})],T.prototype,"plan",2);H([h({attribute:!1})],T.prototype,"markers",2);H([h()],T.prototype,"selectedId",2);H([h({attribute:!1})],T.prototype,"selectedIds",2);H([h({type:Boolean})],T.prototype,"dimEntities",2);H([h({type:Boolean})],T.prototype,"alwaysLabel",2);H([h()],T.prototype,"imageUrl",2);H([h({type:Boolean})],T.prototype,"editable",2);H([h({type:Boolean})],T.prototype,"placing",2);H([h({type:Number})],T.prototype,"coneRadius",2);H([h({attribute:!1})],T.prototype,"zones",2);H([h()],T.prototype,"selectedZoneId",2);H([h({type:Boolean})],T.prototype,"zoneLabels",2);H([h({attribute:!1})],T.prototype,"draftPoints",2);H([l()],T.prototype,"scale",2);H([l()],T.prototype,"tx",2);H([l()],T.prototype,"ty",2);H([l()],T.prototype,"hoverId",2);H([l()],T.prototype,"dragging",2);H([l()],T.prototype,"orienting",2);H([l()],T.prototype,"zoneDraft",2);H([Mt(".viewport")],T.prototype,"viewport",2);T=H([k("sw-plan-canvas")],T);const Fi={name:"אתר הדגמה",building:"מבנה א"},Ye=[{id:"f0",name:"קומה 0",hasPlan:!0,planWidth:1200,planHeight:800,cameraCount:6,entityCount:4},{id:"f-1",name:"קומה 1-",hasPlan:!0,planWidth:900,planHeight:1100,cameraCount:3,entityCount:1},{id:"f-2",name:"קומה 2-",hasPlan:!1,planWidth:0,planHeight:0,cameraCount:2,entityCount:0}],Bt=[{id:"cam-1",name:"כניסה ראשית",floorId:"f0",x:.09,y:.52,rotation:20,fov:70,state:"live",source:"NVR ערוץ 1"},{id:"cam-2",name:"לובי",floorId:"f0",x:.34,y:.3,rotation:120,fov:80,state:"live",source:"NVR ערוץ 2"},{id:"cam-3",name:"מסדרון מזרחי",floorId:"f0",x:.62,y:.55,rotation:180,fov:60,state:"offline",source:"NVR ערוץ 3"},{id:"cam-4",name:"אולם",floorId:"f0",x:.82,y:.22,rotation:210,fov:90,state:"live",source:"NVR ערוץ 4"},{id:"cam-5",name:"חדר מדרגות",floorId:"f0",x:.9,y:.8,rotation:250,fov:60,state:"stale",source:"NVR ערוץ 5"},{id:"cam-6",name:"חניה",floorId:"f0",x:.4,y:.86,rotation:300,fov:75,state:"forbidden",source:"NVR ערוץ 6"},{id:"cam-7",name:"מחסן",floorId:"f-1",x:.3,y:.3,rotation:45,fov:70,state:"live",source:"NVR ערוץ 7"},{id:"cam-8",name:"חדר מכונות",floorId:"f-1",x:.7,y:.6,rotation:200,fov:70,state:"live",source:"NVR ערוץ 8"},{id:"cam-9",name:"מקלט",floorId:"f-1",x:.5,y:.85,rotation:270,fov:70,state:"offline",source:"NVR ערוץ 9"}],hs=[{id:"lock.main_door",name:"דלת כניסה",floorId:"f0",x:.05,y:.4,domain:"lock",state:"locked",stateLabelKey:"entity.locked",controllable:!1,lastChanged:"לפני 12 דק׳"},{id:"light.lobby",name:"תאורת לובי",floorId:"f0",x:.3,y:.42,domain:"light",state:"on",stateLabelKey:"entity.on",controllable:!0,lastChanged:"לפני שעה"},{id:"binary_sensor.hall_motion",name:"תנועה באולם",floorId:"f0",x:.7,y:.3,domain:"binary_sensor",state:"off",stateLabelKey:"entity.off",controllable:!1,lastChanged:"לפני 3 דק׳"},{id:"light.corridor",name:"תאורת מסדרון",floorId:"f0",x:.55,y:.66,domain:"light",state:"off",stateLabelKey:"entity.off",controllable:!0,lastChanged:"אתמול 22:10"},{id:"lock.shelter",name:"דלת מקלט",floorId:"f-1",x:.46,y:.9,domain:"lock",state:"locked",stateLabelKey:"entity.locked",controllable:!1,lastChanged:"לפני 2 שעות"}],_a={f0:[{x:40,y:40,w:300,h:260,label:"לובי",kind:"lobby"},{x:40,y:340,w:300,h:220,label:"משרדים",kind:"office"},{x:40,y:600,w:460,h:160,label:"חניה מקורה",kind:"parking"},{x:380,y:40,w:420,h:300,label:"אולם",kind:"hall"},{x:840,y:40,w:320,h:300,label:"אולם ב",kind:"meeting"},{x:380,y:380,w:300,h:180,label:"חדר ישיבות",kind:"meeting"},{x:720,y:380,w:440,h:180,label:"מסדרון מזרחי",kind:"corridor"},{x:540,y:600,w:620,h:160,label:"שירותים ומדרגות",kind:"stairs"}],"f-1":[{x:40,y:40,w:400,h:400,label:"מחסן",kind:"storage"},{x:480,y:40,w:380,h:400,label:"חדר מכונות",kind:"machines"},{x:40,y:480,w:820,h:200,label:"מסדרון",kind:"corridor"},{x:40,y:720,w:820,h:340,label:"מקלט",kind:"shelter"}]};function qs(e){const t=_a[e],s=Ye.find(i=>i.id===e);return!t||!s?.hasPlan?[]:t.map(i=>({x:i.x/s.planWidth,y:i.y/s.planHeight,w:i.w/s.planWidth,h:i.h/s.planHeight}))}const Y="var(--sw-map-furniture)",W="var(--sw-map-furniture-line)";function Sn(e){const t=e.x+e.w/2,s=e.y+e.h/2;switch(e.kind){case"lobby":return p`<rect x=${e.x+30} y=${e.y+e.h-70} width="130" height="30" rx="4" fill=${Y} stroke=${W} /><rect x=${e.x+170} y=${e.y+30} width="110" height="36" rx="10" fill=${Y} stroke=${W} /><circle cx=${e.x+22} cy=${e.y+22} r="10" fill="#dfe9d9" stroke="#b9cfae" /><circle cx=${e.x+e.w-22} cy=${e.y+22} r="10" fill="#dfe9d9" stroke="#b9cfae" />`;case"office":return p`${[0,1].map(i=>[0,1,2].map(a=>p`<rect x=${e.x+30+a*92} y=${e.y+36+i*92} width="56" height="28" rx="2" fill=${Y} stroke=${W} /><circle cx=${e.x+58+a*92} cy=${e.y+78+i*92} r="8" fill=${Y} stroke=${W} />`))}`;case"parking":return p`${[0,1,2,3,4,5,6,7].map(i=>p`<line x1=${e.x+30+i*56} y1=${e.y+20} x2=${e.x+30+i*56} y2=${e.y+e.h-20} stroke=${W} stroke-dasharray="6 6" />`)}${[1,3,4].map(i=>p`<rect x=${e.x+42+i*56} y=${e.y+36} width="30" height="70" rx="8" fill="#d5dce8" stroke=${W} />`)}`;case"hall":return p`${[0,1,2,3].map(i=>[0,1,2,3,4,5].map(a=>p`<rect x=${e.x+50+a*56} y=${e.y+60+i*52} width="26" height="16" rx="3" fill=${Y} stroke=${W} />`))}<rect x=${e.x+40} y=${e.y+20} width=${e.w-80} height="14" rx="2" fill=${Y} stroke=${W} />`;case"meeting":return p`<rect x=${t-80} y=${s-26} width="160" height="52" rx="12" fill=${Y} stroke=${W} />${[0,1,2].map(i=>p`<circle cx=${t-50+i*50} cy=${s-44} r="9" fill=${Y} stroke=${W} /><circle cx=${t-50+i*50} cy=${s+44} r="9" fill=${Y} stroke=${W} />`)}`;case"corridor":return p`<rect x=${e.x+30} y=${s-8} width="90" height="16" rx="3" fill=${Y} stroke=${W} />`;case"stairs":return p`<rect x=${e.x+e.w-130} y=${e.y+30} width="100" height="100" fill=${Y} stroke=${W} />${[1,2,3,4,5,6,7].map(i=>p`<line x1=${e.x+e.w-130} y1=${e.y+30+i*12.5} x2=${e.x+e.w-30} y2=${e.y+30+i*12.5} stroke=${W} />`)}${[0,1,2,3].map(i=>p`<rect x=${e.x+30+i*46} y=${e.y+30} width="36" height="46" fill=${Y} stroke=${W} />`)}`;case"storage":return p`${[0,1,2,3].map(i=>p`<rect x=${e.x+40+i*92} y=${e.y+40} width="30" height=${e.h-80} fill=${Y} stroke=${W} />`)}`;case"machines":return p`${[0,1,2].map(i=>p`<rect x=${e.x+40} y=${e.y+40+i*120} width="110" height="72" rx="4" fill=${Y} stroke=${W} /><circle cx=${e.x+240} cy=${e.y+76+i*120} r="26" fill=${Y} stroke=${W} />`)}`;case"shelter":return p`${[0,1,2,3].map(i=>p`<rect x=${e.x+60} y=${e.y+50+i*70} width="220" height="22" rx="3" fill=${Y} stroke=${W} /><rect x=${e.x+e.w-280} y=${e.y+50+i*70} width="220" height="22" rx="3" fill=${Y} stroke=${W} />`)}`;default:return""}}function za(e){const t=_a[e],s=Ye.find(i=>i.id===e);return!t||!s?null:p`
  ...
  `}const Ks=[{id:"site-a",name:"אתר הדגמה",address:"רחוב הדוגמה 1",buildings:2,cameras:10,online:9,alerts:2,health:"stale"},{id:"site-b",name:"סניף צפון",address:"שדרות הדגמה 20",buildings:1,cameras:6,online:6,alerts:0,health:"live"},{id:"site-c",name:"מחסן לוגיסטי",address:"אזור תעשייה",buildings:1,cameras:4,online:3,alerts:1,health:"offline"}],Mn=[{id:"bld-a",siteId:"site-a",name:"מבנה א",floors:[{id:"f0",name:"קומה 0",cameras:6,entities:4,hasPlan:!0},{id:"f-1",name:"קומה 1-",cameras:3,entities:1,hasPlan:!0},{id:"f-2",name:"קומה 2-",cameras:2,entities:0,hasPlan:!1}]},{id:"bld-b",siteId:"site-a",name:"מבנה ב",floors:[{id:"b-f0",name:"קרקע",cameras:1,entities:2,hasPlan:!1}]}],F=[{id:"cam-1",name:"כניסה ראשית",floor:"קומה 0",state:"live",stream:"sub",fps:25,bitrateKbps:3072,firmware:"V5.8.10",lastEvent:"לפני 2 דק׳",recording:"continuous",ptz:!1,audio:!1},{id:"cam-2",name:"לובי",floor:"קומה 0",state:"live",stream:"sub",fps:25,bitrateKbps:3072,firmware:"V5.8.10",lastEvent:"לפני 5 דק׳",recording:"motion",ptz:!1,audio:!0},{id:"cam-3",name:"מסדרון מזרחי",floor:"קומה 0",state:"offline",stream:"sub",fps:null,bitrateKbps:null,firmware:"V5.8.10",lastEvent:"לפני שעה",recording:"unknown",ptz:!1,audio:!1},{id:"cam-4",name:"אולם",floor:"קומה 0",state:"live",stream:"main",fps:25,bitrateKbps:5120,firmware:"V5.8.10",lastEvent:"לפני 12 דק׳",recording:"continuous",ptz:!0,audio:!1},{id:"cam-5",name:"חדר מדרגות",floor:"קומה 0",state:"stale",stream:"sub",fps:20,bitrateKbps:2048,firmware:"V5.8.9",lastEvent:"לפני 40 דק׳",recording:"continuous",ptz:!1,audio:!1},{id:"cam-6",name:"חניה מקורה",floor:"קומה 0",state:"forbidden",stream:"sub",fps:null,bitrateKbps:null,firmware:"—",lastEvent:"—",recording:"unknown",ptz:!1,audio:!1},{id:"cam-7",name:"מחסן",floor:"קומה 1-",state:"live",stream:"sub",fps:25,bitrateKbps:3072,firmware:"V5.8.10",lastEvent:"לפני 3 שעות",recording:"motion",ptz:!1,audio:!1},{id:"cam-8",name:"חדר מכונות",floor:"קומה 1-",state:"live",stream:"sub",fps:25,bitrateKbps:3072,firmware:"V5.8.10",lastEvent:"אתמול",recording:"continuous",ptz:!1,audio:!1},{id:"cam-9",name:"מקלט",floor:"קומה 1-",state:"offline",stream:"sub",fps:null,bitrateKbps:null,firmware:"V5.8.10",lastEvent:"לפני יומיים",recording:"unknown",ptz:!1,audio:!1},{id:"cam-10",name:"חצר אחורית",floor:"חוץ",state:"live",stream:"sub",fps:25,bitrateKbps:4096,firmware:"V5.8.10",lastEvent:"לפני 8 דק׳",recording:"continuous",ptz:!0,audio:!0}],Ae={"cam-1":"entrance","cam-2":"lobby","cam-3":"corridor","cam-4":"hall","cam-5":"corridor","cam-6":"parking","cam-7":"warehouse","cam-8":"warehouse","cam-9":"night","cam-10":"backyard"},Gs={person:"זיהוי אדם",vehicle:"זיהוי רכב",motion:"תנועה",line:"חציית קו",offline:"מצלמה מנותקת",door:"דלת נפתחה"},Re=[{id:"ev-1",time:"היום 10:14",minuteOfDay:614,type:"person",title:"אדם זוהה",camera:"כניסה ראשית",floor:"קומה 0",source:"NVR",acked:!1,severity:"alert"},{id:"ev-2",time:"היום 09:42",minuteOfDay:582,type:"vehicle",title:"רכב זוהה",camera:"חצר אחורית",floor:"חוץ",source:"NVR",acked:!1,severity:"info"},{id:"ev-3",time:"היום 08:31",minuteOfDay:511,type:"motion",title:"תנועה",camera:"מחסן",floor:"קומה 1-",source:"NVR",acked:!0,severity:"info"},{id:"ev-4",time:"היום 08:12",minuteOfDay:492,type:"door",title:"דלת כניסה נפתחה",camera:"כניסה ראשית",floor:"קומה 0",source:"HA",acked:!0,severity:"info"},{id:"ev-5",time:"היום 07:55",minuteOfDay:475,type:"offline",title:"מסדרון מזרחי מנותק",camera:"מסדרון מזרחי",floor:"קומה 0",source:"NVR",acked:!1,severity:"critical"},{id:"ev-6",time:"היום 06:43",minuteOfDay:403,type:"line",title:"חציית קו",camera:"חניה מקורה",floor:"קומה 0",source:"NVR",acked:!0,severity:"alert"},{id:"ev-7",time:"אתמול 23:10",minuteOfDay:1390,type:"person",title:"אדם זוהה",camera:"לובי",floor:"קומה 0",source:"NVR",acked:!0,severity:"info"}],vs=[{startMin:0,endMin:190,kind:"continuous"},{startMin:205,endMin:460,kind:"continuous"},{startMin:470,endMin:474,kind:"motion"},{startMin:480,endMin:486,kind:"motion"},{startMin:492,endMin:640,kind:"continuous"},{startMin:660,endMin:1439,kind:"continuous"}],Js=[{id:"u-1",name:"יוני",haUser:"joni",active:!0,lastSync:"לפני 20 שנ׳",groups:["מנהלי מערכת"],bindings:[{role:"מנהל מערכת VMS",scope:"כל ההתקנה"}],haAdmin:!0},{id:"u-2",name:"דנה",haUser:"dana",active:!0,lastSync:"לפני 20 שנ׳",groups:["עורכי קומה 2"],bindings:[{role:"עורך מפות",scope:"מבנה א · קומה 2"}],haAdmin:!1},{id:"u-3",name:"יוסי",haUser:"yossi",active:!0,lastSync:"לפני 20 שנ׳",groups:["מנהלי מבנה א"],bindings:[{role:"מנהל אתר/מבנה",scope:"מבנה א"}],haAdmin:!1},{id:"u-4",name:"codex",haUser:"codex",active:!0,lastSync:"לפני 20 שנ׳",groups:[],bindings:[],haAdmin:!1},{id:"u-5",name:"רון",haUser:"ron",active:!1,lastSync:"לפני 3 ימים",groups:["צופים"],bindings:[{role:"צופה",scope:"אתר הדגמה"}],haAdmin:!1}],Sa=[{id:"g-1",name:"מנהלי מערכת",members:1,bindings:["מנהל מערכת VMS · כל ההתקנה"]},{id:"g-2",name:"עורכי קומה 2",members:1,bindings:["עורך מפות · מבנה א · קומה 2"]},{id:"g-3",name:"מנהלי מבנה א",members:1,bindings:["מנהל אתר/מבנה · מבנה א"]},{id:"g-4",name:"צופים",members:1,bindings:["צופה · אתר הדגמה"]}],Ma=[{id:"viewer",name:"צופה",allowed:"מפה, מצב ישויות מורשה, שידור חי",denied:"היסטוריה, עריכה, ייצוא, שליטה"},{id:"operator",name:"מפעיל",allowed:"צפייה, Playback, סקירת אירועים וסימון טיפול",denied:"עריכת מפות, תפקידים, ייצוא, פעולות פיזיות"},{id:"editor",name:"עורך מפות ותצוגות",allowed:"צפייה, יבוא/עריכה/פרסום מפות, מיקומים ותצוגות",denied:"Playback, ייצוא, משתמשים, סודות, שליטה"},{id:"site_admin",name:"מנהל אתר / מבנה / קומה",allowed:"מפעיל + עורך, הגדרות תוכן מקומיות",denied:"הגדרות מערכת, תפקידים, סודות, כתיבה ל־NVR"},{id:"system_admin",name:"מנהל מערכת VMS",allowed:"הגדרות מוצר, מקורות, מדיניות, קבוצות ושיוכים",denied:"ניהול HA, שליטה פיזית, ייצוא ראיות ללא grant"}],Ia=[{time:"10:24",user:"יוני",action:"צפייה חיה",resource:"כניסה ראשית",decision:"הותר",role:"מנהל מערכת · כל ההתקנה"},{time:"10:18",user:"דנה",action:"פרסום תוכנית",resource:"מבנה א · קומה 2",decision:"הותר",role:"עורך מפות · קומה 2"},{time:"10:11",user:"דנה",action:"עריכת תוכנית",resource:"מבנה א · קומה 3",decision:"נחסם: מחוץ להיקף",role:"עורך מפות · קומה 2"},{time:"09:55",user:"יוסי",action:"ייצוא קטע",resource:"לובי 09:10–09:20",decision:"נחסם: אין הרשאת ייצוא",role:"מנהל מבנה · מבנה א"},{time:"09:43",user:"codex",action:"כניסה דרך Ingress",resource:"—",decision:"הותר, ללא שיוך",role:"—"},{time:"09:30",user:"יוני",action:"הפעלת תאורה",resource:"light.lobby",decision:"הותר (HA אישר)",role:"מנהל מערכת"},{time:"08:12",user:"מערכת",action:"סנכרון משתמשים",resource:"HA bridge",decision:"5 משתמשים, 0 שינויים",role:"—"}],Aa=[{id:"job-1",title:"ייצוא: כניסה ראשית 09:10–09:25",status:"הושלם",progress:100,size:"182 MB",hash:"sha256 ✓"},{id:"job-2",title:"ייצוא: לובי 23:00–23:40",status:"בתהליך",progress:62,size:"—",hash:"—"},{id:"job-3",title:"תמונות מקדימות: קומה 0",status:"ממתין",progress:0,size:"—",hash:"—"},{id:"job-4",title:"ייצוא: חצר אחורית 02:00–04:00",status:"נכשל: פער בהקלטה",progress:35,size:"—",hash:"—"}],Ys=[{id:"case-1",title:"כניסה לא מורשית — 13.09",status:"פתוח",owner:"יוני",clips:3,notes:2,preserved:2,missing:1},{id:"case-2",title:"נזק לרכב בחניה",status:"בבדיקה",owner:"יוסי",clips:2,notes:1,preserved:2,missing:0},{id:"case-3",title:"דלת מקלט פתוחה בלילה",status:"סגור",owner:"יוני",clips:1,notes:3,preserved:1,missing:0}],Xs=[{id:"r-1",name:"אדם בלילה",trigger:"זיהוי אדם",scope:"חוץ · 22:00–06:00",action:"התראה + פתיחת מצלמות",enabled:!0,last:"אתמול 23:10"},{id:"r-2",name:"רכב באזור מוגבל",trigger:"זיהוי רכב",scope:"חניה מקורה",action:"התראה",enabled:!0,last:"היום 09:42"},{id:"r-3",name:"דלת נשארה פתוחה",trigger:"דלת > 60 שנ׳",scope:"כל הדלתות",action:"התראה + הקלטה",enabled:!0,last:"—"},{id:"r-4",name:"מצלמה מנותקת",trigger:"ניתוק",scope:"כל האתר",action:"התראה מיידית",enabled:!1,last:"היום 07:55"}],Pa=[{name:"NVR (הקלטה)",state:"live",detail:"10/10 ערוצים, דיסק תקין"},{name:"go2rtc (מדיה)",state:"live",detail:"גרסה ‎1.9.x‎ · 4 זרמים פעילים"},{name:"גשר Home Assistant",state:"stale",detail:"סנכרון אחרון לפני 4 דק׳"},{name:"מסד נתונים",state:"live",detail:"WAL · גיבוי אחרון אתמול 02:00"},{name:"תור עבודות",state:"partial",detail:"1 בתהליך · 1 נכשל"}],In=["live","explore","investigate","system"];function bs(e=window.location.hash){const t=e.replace(/^#/,"")||"/explore/floors/f0",[s,i=""]=t.split("?"),a=s.startsWith("/")?s:`/${s}`,n=a.split("/").filter(Boolean),o=n[0];return{path:a,segments:n,params:new URLSearchParams(i),mode:o&&In.includes(o)?o:null}}function b(e,t){const s=t?`?${new URLSearchParams(t).toString()}`:"";window.location.hash=`#${e}${s}`}function An(e){const t=()=>e(bs());return window.addEventListener("hashchange",t),e(bs()),()=>window.removeEventListener("hashchange",t)}const Qs=new Set;let zt={mode:"loading",me:null,error:null};function as(e){zt=e,Qs.forEach(t=>t(zt))}function Ea(e){return Qs.add(e),e(zt),()=>Qs.delete(e)}async function Pn(){try{const e=await _("me");as({mode:e.has_access?"api":"no_access",me:e,error:null})}catch(e){e instanceof fe&&e.status===401?as({mode:"unauthenticated",me:null,error:e.body.user_message}):e instanceof fe?as({mode:"demo",me:null,error:e.body.user_message}):as({mode:"demo",me:null,error:null})}return zt}const $=()=>zt.mode==="api";function En(e){const t=Ye.find(i=>i.id===e)??Ye[0],s=Bt.filter(i=>i.floorId===t.id);return{source:"demo",floorId:t.id,floorName:t.name,buildingName:Fi.building,siteName:Fi.name,width:t.planWidth||1200,height:t.planHeight||800,imageUrl:null,planSvg:t.hasPlan?za(t.id):null,planStatus:t.hasPlan?"published":"none",planVersionId:t.hasPlan?`demo-${t.id}`:null,needsAlignment:!1,renderMode:"source",stylizedAvailable:!1,planPublishedAt:null,planArchivedAt:null,at:null,history:null,historyFrom:null,haHistory:null,anchors:s.map((i,a)=>({id:`demo-anchor-${i.id}`,floor_id:t.id,plan_version_id:`demo-${t.id}`,resource_type:"camera",resource_id:i.id,position:{x:i.x,y:i.y},rotation_degrees:i.rotation,field_of_view_degrees:i.fov,layer_id:"cameras",label:i.name,revision:1,effective_from:"",effective_to:null,updated_at:"",camera:{id:i.id,recorder_id:"demo",channel:a+1,name:i.name,name_source:i.name,alias:null,enabled:!0,sort_order:a,main_track:null,sub_track:null,status:i.state==="offline"?"offline":"online",last_seen_at:null}})),zones:[],cameras:[],permissions:{edit:!0,publish:!0,import:!0}}}async function qt(e,t=!1,s){if(!$())return En(e);const i=new URLSearchParams;t&&i.set("draft","true"),s&&i.set("at",s);const a=i.toString(),n=await _(`floors/${e}/map${a?`?${a}`:""}`);return{source:"api",floorId:n.floor.id,floorName:n.floor.name,buildingName:n.building.name,siteName:n.site.name,width:n.plan?.width_px??1200,height:n.plan?.height_px??800,imageUrl:n.plan?Ne(n.plan.image_url):null,planSvg:null,planStatus:n.plan?n.plan.status==="published"?"published":"draft":"none",planVersionId:n.plan?.id??null,needsAlignment:n.needs_alignment,anchors:n.anchors,zones:n.zones??[],cameras:n.cameras,permissions:n.permissions,renderMode:n.plan?.render_mode==="stylized"?"stylized":"source",stylizedAvailable:!!n.plan?.stylized_url,planPublishedAt:n.plan?.published_at??null,planArchivedAt:n.plan?.archived_at??null,at:n.at??null,history:n.history??null,historyFrom:n.history_from??null,haHistory:n.ha_history??null}}function Ht(e,t){const s=e.camera;return s?s.status==="online"?"live":s.status==="offline"?"offline":t??"unknown":t??"unknown"}const Cn=e=>_(`floors/${e}/plan-assets`),Tn=(e,t)=>{const s=new FormData;return s.append("file",t,t.name),xi(`floors/${e}/plan-assets`,s)},On=e=>_(`floors/${e}/plan-versions`),Dn=(e,t)=>z(`floors/${e}/plan-versions`,t),ei=e=>z(`plan-versions/${e}/publish`),Rn=(e,t)=>_(`plan-versions/${e}/diff`),Nn=(e,t,s)=>z(`plan-versions/${e}/rollback`,{revision:t,expected_published_id:s}),Wi=(e,t)=>z(`floors/${e}/anchors`,t),Bn=(e,t)=>Ve(`map-anchors/${e}`,t),Hn=e=>be(`map-anchors/${e}`),et=()=>_("cameras"),Ln=()=>z("cameras/sync"),jn=e=>z("cameras",e),Vn=(e,t)=>Ve(`cameras/${e}`,t);function Fn(){return{source:"demo",sites:Ks.map((t,s)=>({id:t.id,name:t.name,address:t.address,timezone:"Asia/Jerusalem",sort_order:s,updated_at:"",buildings:Mn.filter(i=>i.siteId===t.id).map((i,a)=>({id:i.id,site_id:t.id,name:i.name,sort_order:a,updated_at:"",floors:i.floors.map((n,o)=>{const d=Ye.find(u=>u.id===n.id);return{id:n.id,building_id:i.id,name:n.name,level:-o,sort_order:o,ha_area_id:null,has_plan:n.hasPlan,published_version_id:n.hasPlan?`demo-${n.id}`:null,plan_width_px:d?.planWidth??null,plan_height_px:d?.planHeight??null,draft_version_id:null,anchor_count:n.cameras+n.entities,camera_count:n.cameras,updated_at:""}})}))})),canCreateSite:!0}}async function tt(){if(!$())return Fn();const e=await _("sites?tree=true");return{source:"api",sites:e.sites,canCreateSite:e.can_create_site}}const Wn=e=>z("sites",e),Ca=(e,t)=>z(`sites/${e}/buildings`,t),Un=(e,t)=>z(`buildings/${e}/floors`,t),Zn=(e,t)=>Ve(`floors/${e}`,t),qn=(e,t=!1)=>be(`floors/${e}${t?"?force=true":""}`);function Ta(e,t){for(const s of e.sites)for(const i of s.buildings??[]){const a=(i.floors??[]).find(n=>n.id===t);if(a)return{site:s,building:i,floor:a}}return null}function Oa(e){for(const t of e.sites)for(const s of t.buildings??[])for(const i of s.floors??[])return i;return null}const ti=[{id:"room",label:"חדר"},{id:"zone",label:"אזור"},{id:"corridor",label:"מסדרון"},{id:"outdoor",label:"חוץ"},{id:"service",label:"שירות / טכני"}],Kn=e=>ti.find(t=>t.id===e)?.label??e,Gn=e=>_(`floors/${e}/zones`),Jn=(e,t)=>z(`floors/${e}/zones`,t),Yn=(e,t)=>Ve(`zones/${e}`,t),Xn=e=>be(`zones/${e}`),Qn=(e,t="medium")=>z(`floors/${e}/zones/detect`,{strength:t}),eo=(e,t,s)=>z(`floors/${e}/zones/accept`,{candidates:t,replace_auto:s});function si(e,t){let s=!1;for(let i=0,a=t.length-1;i<t.length;a=i++){const n=t[i],o=t[a];n.y>e.y!=o.y>e.y&&e.x<(o.x-n.x)*(e.y-n.y)/(o.y-n.y)+n.x&&(s=!s)}return s}function Da(e={}){const t=new URLSearchParams;e.domain&&t.set("domain",e.domain),e.q&&t.set("q",e.q),e.area&&t.set("area",e.area),e.placed!==void 0&&t.set("placed",String(e.placed)),e.includeDisabled&&t.set("include_disabled","true"),e.limit&&t.set("limit",String(e.limit));const s=t.toString();return _(`ha/entities${s?`?${s}`:""}`)}const to=()=>_("ha/status"),so=(e=!1)=>_(`ha/bridge/pairing${e?"?regenerate=true":""}`),Ui=e=>_(`ha/actions/${e}`),io=()=>z("ha/bridge/install");function ao(e,t,s={},i=!1){const a={allowed_action_id:t,arguments:s,expected_state_version:null,confirmation_grant:i?"confirmed":null,client_request_id:crypto.randomUUID(),expires_at:new Date(Date.now()+6e4).toISOString().replace(/\.\d{3}Z$/,"Z")};return z(`ha/entities/${encodeURIComponent(e)}/actions`,a)}async function ro(e,t,s){let i=await Ui(e);t(i);for(let a=0;a<16&&i.status==="pending";a++)await new Promise(n=>setTimeout(n,1500)),i=await Ui(e),t(i);return i}const no={ha_unauthorized:"Home Assistant דחה את הפעולה: למשתמש שלך אין הרשאה לישות זו ב־Home Assistant",ha_unknown_user:"Home Assistant אינו מכיר את המשתמש שמאחורי ההפעלה הזו",bridge_not_paired:"גשר SMPLWISE אינו מצומד",bridge_error:"הגשר החזיר שגיאה",ha_unavailable:"Home Assistant אינו זמין",service_not_allowed:"הגשר סירב: השירות אינו ברשימת הפעולות המאושרות",unknown_user:"Home Assistant אינו מכיר את המשתמש"},oo={pending:"נשלח · ממתין לעדכון מ־Home Assistant",confirmed:"אושר · המצב התעדכן",unknown:"לא ידוע · לא התקבל עדכון מצב",failed:"נכשל",denied:"נדחה · אין הרשאה ב־Home Assistant"},lo=new Set(["on","open","opening","unlocked","unlocking","playing","home","heat","cool","heat_cool","dry","fan_only","cleaning","active","detected","problem","running"]),rs={on:"דולק",off:"כבוי",locked:"נעול",unlocked:"פתוח",locking:"נועל…",unlocking:"פותח…",jammed:"תקוע",open:"פתוח",closed:"סגור",opening:"נפתח…",closing:"נסגר…",unavailable:"לא זמין",unknown:"לא ידוע",idle:"לא פעיל",home:"בבית",not_home:"מחוץ לבית",playing:"מנגן",paused:"מושהה",standby:"המתנה",heat:"חימום",cool:"קירור",auto:"אוטומטי",dry:"ייבוש",fan_only:"מאוורר",docked:"בתחנה",cleaning:"מנקה",returning:"חוזר"},co={motion:["תנועה","ללא תנועה"],occupancy:["נוכחות","ללא נוכחות"],presence:["נוכח","לא נוכח"],door:["פתוחה","סגורה"],window:["פתוח","סגור"],opening:["פתוח","סגור"],garage_door:["פתוח","סגור"],lock:["פתוח","נעול"],connectivity:["מחובר","מנותק"],power:["פועל","כבוי"],problem:["תקלה","תקין"],safety:["לא בטוח","בטוח"],smoke:["עשן","ללא עשן"],moisture:["רטוב","יבש"],battery:["סוללה חלשה","סוללה תקינה"],running:["פועל","לא פועל"],sound:["רעש","שקט"],vibration:["רטט","ללא רטט"],update:["עדכון זמין","מעודכן"]};function ct(e){const t=e.state;if(t==null)return"לא ידוע";if(t==="unavailable"||t==="unknown")return rs[t];if(e.domain==="binary_sensor"){const s=co[e.device_class??""];return s?t==="on"?s[0]:s[1]:t==="on"?"פעיל":"לא פעיל"}if(e.domain==="sensor"||e.domain==="number"||e.domain==="input_number"){const s=Number(t);return!Number.isNaN(s)&&t.trim()!==""?`${Number.isInteger(s)?s:s.toFixed(Math.min(2,(t.split(".")[1]??"").length))}${e.unit?` ${e.unit}`:""}`:t}return e.domain==="light"&&t==="on"&&typeof e.attributes.brightness=="number"?`דולק · ${Math.round(e.attributes.brightness/255*100)}%`:e.domain==="cover"&&typeof e.attributes.current_position=="number"&&(t==="open"||t==="closed")?`${rs[t]} · ${e.attributes.current_position}%`:e.domain==="climate"&&typeof e.attributes.current_temperature=="number"?`${rs[t]??t} · ${e.attributes.current_temperature}°`:rs[t]??t}function ii(e){return!e||e.removed_at?"unknown":e.state==="unavailable"||!e.available?"offline":e.fresh?e.state===null||e.state==="unknown"?"unknown":lo.has(e.state)?"live":"neutral":"stale"}function Es(e,t){return e==="doors"||t==="lock"||t==="cover"?"lock":e==="lights"||t==="light"||t==="switch"||t==="fan"?"light":"binary_sensor"}function Kt(e){return{light:"תאורה",switch:"מתג",lock:"מנעול",cover:"תריס / שער",binary_sensor:"חיישן בינארי",sensor:"חיישן",fan:"מאוורר",climate:"אקלים",camera:"מצלמת HA",button:"כפתור",script:"סקריפט",scene:"סצנה",automation:"אוטומציה",media_player:"נגן",event:"אירוע",number:"מספר",select:"בחירה",input_boolean:"דגל",alarm_control_panel:"אזעקה",siren:"צופר",vacuum:"שואב",weather:"מזג אוויר",sun:"שמש"}[e]??e}function ke(e){if(!e)return"—";const t=new Date(e);return Number.isNaN(t.getTime())?e:t.toLocaleString("he-IL",{dateStyle:"short",timeStyle:"medium"})}function Ra(e,t){let s=null,i=!1,a=2e3;const n=(()=>{const d=new URL(ve("ha/ws"));return d.protocol=d.protocol==="https:"?"wss:":"ws:",d.toString()})(),o=()=>{if(!i){try{s=new WebSocket(n)}catch{return}s.onopen=()=>{a=2e3},s.onmessage=d=>{try{const u=JSON.parse(d.data);u.type==="entity_state_changed"?e({type:"entity_state_changed",entity:u.payload.entity}):u.type==="ha_sync_state"?e({type:"ha_sync_state",connected:!!u.payload.connected}):u.type==="heartbeat"&&e({type:"heartbeat",sync:u.payload.sync})}catch{}},s.onclose=d=>{!i&&d.code!==4403&&d.code!==4401&&(window.setTimeout(o,a),a=Math.min(3e4,a*2))}}};return o(),()=>{i=!0,s?.close()}}var po=Object.defineProperty,ho=Object.getOwnPropertyDescriptor,j=(e,t,s,i)=>{for(var a=i>1?void 0:i?ho(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&po(t,s,a),a};const uo=[{id:"cameras",icon:"camera",label:()=>v("floor.cameras")},{id:"doors",icon:"door",label:()=>v("floor.doors")},{id:"lights",icon:"light",label:()=>v("floor.lights")},{id:"sensors",icon:"sensor",label:()=>v("floor.sensors")},{id:"zones",icon:"map",label:()=>"חדרים ואזורים"}],Zi=["entrance","lobby","corridor","hall","parking","warehouse","backyard","driveway","night"];let N=class extends y{constructor(){super(...arguments),this.floorId="f0",this.screenState="ready",this.focusZone="",this.focusCamera="",this.focusEntity="",this.selectedZoneId=null,this.bundle=null,this.tree=null,this.loadError="",this.noFloors=!1,this.selectedId=null,this.anchor=null,this.layers=new Set(["cameras","doors","lights","sensors","zones"]),this.pinned=!1,this.panel=!1,this.multi=!1,this.picked=[],this.narrow=!1,this.syncConnected=!0,this.action=null,this.confirmSpec=null,this.stopWs=null,this.mq=window.matchMedia("(max-width: 767px)"),this.onMq=()=>this.narrow=this.mq.matches,this.onKey=e=>{if(e.key==="Escape"&&!this.confirmSpec)if(this.selectedId){const t=this.selectedId;this.close(),this.canvas?.focusMarker(t)}else this.panel&&(this.panel=!1)}}connectedCallback(){super.connectedCallback(),this.narrow=this.mq.matches,this.mq.addEventListener("change",this.onMq),window.addEventListener("keydown",this.onKey),this.load()}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("keydown",this.onKey),this.mq.removeEventListener("change",this.onMq),this.stopWs?.(),this.stopWs=null}startWs(){this.stopWs||!$()||(this.stopWs=Ra(e=>{const t=this.bundle;if(e.type==="entity_state_changed"&&t){if(!t.anchors.some(s=>s.resource_type==="ha_entity"&&s.resource_id===e.entity.entity_id))return;this.bundle={...t,anchors:t.anchors.map(s=>s.resource_type==="ha_entity"&&s.resource_id===e.entity.entity_id?{...s,entity:{...s.entity??{},...e.entity,actions:s.entity?.actions}}:s)}}else e.type==="ha_sync_state"?this.syncConnected=e.connected:e.type==="heartbeat"&&(this.syncConnected=e.sync.connected)}))}updated(e){e.has("floorId")&&e.get("floorId")!==void 0?(this.selectedId=null,this.anchor=null,this.selectedZoneId=null,this.load()):(e.has("focusZone")||e.has("focusCamera")||e.has("focusEntity"))&&this.bundle&&this.applyFocus()}async applyFocus(){const e=this.bundle;if(!e||!this.focusZone&&!this.focusCamera&&!this.focusEntity)return;await this.updateComplete;const t=this.canvas;if(!t)return;const s=this.focusZone?e.zones.find(a=>a.id===this.focusZone):null;if(s){const a=s.polygon.map(o=>o.x),n=s.polygon.map(o=>o.y);this.selectedZoneId=s.id,t.zoomToBox(Math.min(...a),Math.min(...n),Math.max(...a),Math.max(...n))}const i=this.focusCamera?e.anchors.find(a=>a.resource_type==="camera"&&a.resource_id===this.focusCamera):this.focusEntity?e.anchors.find(a=>a.resource_type==="ha_entity"&&a.resource_id===this.focusEntity):null;if(i){t.zoomToBox(i.position.x-.12,i.position.y-.12,i.position.x+.12,i.position.y+.12),await this.updateComplete;const a=t.toScreen(i.position.x,i.position.y);this.selectedId=i.id,this.anchor={x:a.x,y:a.y}}}async load(){this.loadError="";try{const e=this.tree??await tt();if(this.tree=e,$()&&!Ta(e,this.floorId)){const t=Oa(e);if(t&&t.id!==this.floorId){b(`/explore/floors/${t.id}`);return}if(!t){this.noFloors=!0,this.bundle=null;return}}this.noFloors=!1,this.restoreLayers(),this.bundle=await qt(this.floorId),this.bundle.source==="api"&&this.startWs(),this.applyFocus()}catch(e){this.loadError=w(e),this.bundle=null}}get floors(){return this.tree?.source==="api"?this.tree.sites.flatMap(e=>(e.buildings??[]).flatMap(t=>(t.floors??[]).map(s=>({id:s.id,name:`${t.name} · ${s.name}`,cameraCount:s.camera_count,hasPlan:s.has_plan})))):Ye.map(e=>({id:e.id,name:e.name,cameraCount:e.cameraCount,hasPlan:e.hasPlan}))}get markers(){const e=this.bundle;if(!e)return[];const t=this.screenState==="stale";if(e.source==="demo"){const s=this.layers.has("cameras")?Bt.filter(a=>a.floorId===e.floorId).map(a=>({id:a.id,kind:"camera",label:a.name,x:a.x,y:a.y,rotation:a.rotation,fov:a.fov,state:a.state})):[],i=hs.filter(a=>a.floorId===e.floorId).filter(a=>a.domain==="lock"&&this.layers.has("doors")||a.domain==="light"&&this.layers.has("lights")||a.domain==="binary_sensor"&&this.layers.has("sensors")).map(a=>({id:a.id,kind:a.domain,label:a.name,x:a.x,y:a.y,state:t?"stale":"neutral"}));return[...s,...i]}return e.anchors.filter(s=>s.resource_type==="camera"?this.layers.has("cameras"):this.layers.has(s.layer_id==="doors"?"doors":s.layer_id==="lights"?"lights":"sensors")).map(s=>({id:s.id,kind:s.resource_type==="camera"?"camera":Es(s.layer_id,s.entity?.domain),label:s.camera?.name??s.entity?.name??s.label??s.resource_id,x:s.position.x,y:s.position.y,rotation:s.rotation_degrees,fov:s.field_of_view_degrees??void 0,state:s.resource_type==="camera"?Ht(s):t?"stale":this.entityTone(s.entity)}))}layerCounts(){const e=this.bundle,t={cameras:0,doors:0,lights:0,sensors:0,zones:e?.zones.length??0};if(!e)return t;if(e.source==="demo"){t.cameras=Bt.filter(s=>s.floorId===e.floorId).length;for(const s of hs.filter(i=>i.floorId===e.floorId))s.domain==="lock"?t.doors++:s.domain==="light"?t.lights++:t.sensors++;return t}for(const s of e.anchors)s.resource_type==="camera"?t.cameras++:s.layer_id==="doors"?t.doors++:s.layer_id==="lights"?t.lights++:t.sensors++;return t}zoneOf(e){return this.bundle?.zones.find(s=>si(e.position,s.polygon))?.name??null}toggleLayer(e){const t=new Set(this.layers);t.has(e)?t.delete(e):t.add(e),this.setLayers(t)}setLayers(e){this.layers=e;try{localStorage.setItem(`sw.floor.layers.${this.floorId}`,JSON.stringify([...e]))}catch{}}restoreLayers(){try{const e=localStorage.getItem(`sw.floor.layers.${this.floorId}`);if(!e)return;const t=JSON.parse(e);Array.isArray(t)&&(this.layers=new Set(t.filter(s=>["cameras","doors","lights","sensors","zones"].includes(s))))}catch{}}cameraAnchors(){return(this.bundle?.anchors??[]).filter(e=>e.resource_type==="camera"&&this.layers.has("cameras"))}togglePick(e){this.picked=this.picked.includes(e)?this.picked.filter(t=>t!==e):[...this.picked,e]}pickedCameraIds(){const e=new Map((this.bundle?.anchors??[]).map(t=>[t.id,t.resource_id]));return this.picked.map(t=>e.get(t)).filter(t=>!!t)}setMulti(e){this.multi=e,this.picked=[],e&&this.close()}openWall(){const e=this.pickedCameraIds();e.length&&b("/live/wall",{cameras:e.join(",")})}openSync(){const e=this.pickedCameraIds();e.length&&b("/investigate/playback",{camera:e[0],extra:e.slice(1,4).join(",")})}renderPickbar(){const e=this.bundle;if(!e)return c;const t=this.cameraAnchors(),s=i=>{const a=e.anchors.find(n=>n.id===i);return a?.camera?.name??a?.label??a?.resource_id??i};return r`<div class="pickbar" data-pickbar>
      ...
      ${a?r`<div class=${a.error||a.record?.status==="failed"||a.record?.status==="denied"?"warn":"note"}>${a.spec.label}: ${a.error?a.error:a.record?`${oo[a.record.status]}${a.record.error?` — ${no[a.record.error]??a.record.error}`:""}`:"שולח…"}</div>`:c}
    `}entityFooter(e){const t=e.entity,s=!!(this.action&&t&&this.action.entityId===t.entity_id&&this.action.busy),i=t?.actions??[];return r`${i.map(a=>r`<sw-button size="sm" variant=${a.sensitive?"danger":"primary"} ?disabled=${s||this.screenState==="stale"||t?.state==="unavailable"||a.granted===!1} title=${a.granted===!1?`נדרשת הרשאה נפרדת: ${a.grant??""}`:""} data-action=${a.id} data-granted=${a.granted===!1?"no":"yes"} @click=${()=>t&&this.trigger(t.entity_id,a)}>${a.label}</sw-button>`)}`}renderConfirm(){const e=this.confirmSpec;if(!e)return c;const t=this.bundle?.anchors.find(s=>s.resource_type==="ha_entity"&&s.resource_id===e.entityId)?.entity;return r`<sw-dialog open heading=${v("entity.confirm")} subheading=${t?.name??e.entityId} @close=${()=>this.confirmSpec=null}>
      ...
      ${i?r`<sw-camera-tile name="" state=${e.state} scene=${Ae[e.id]??"lobby"} @click=${()=>b(`/live/cameras/${e.id}`)}></sw-camera-tile>`:r`<div class="off"><div><sw-icon name=${e.state==="forbidden"?"lock":"offline"} size=${22}></sw-icon><div>${s}</div></div></div>`}
    ...
    `}apiCameraBody(e,t){const s=e.camera,i=Ht(e),a=Zi[((s?.channel??1)-1)%Zi.length],n=i==="live"&&!!s&&s.can_view_live!==!1,o=this.zoneOf(e),d=o?`${t} / ${o}`:`${t} · ערוץ ${s?.channel??"?"}`;return r`
      ${i==="offline"?r`<div class="off"><div><sw-icon name="offline" size=${22}></sw-icon><div>${v("camera.offlineReason")}</div></div></div>`:r`<sw-camera-tile name="" state=${i==="live"?"live":"unknown"} scene=${a} poster=${s?Zt(s.id,Date.now()):""} ?live=${n} .cameraId=${n?s.id:""} data-live=${n?"1":"0"} @click=${()=>s&&b(`/live/cameras/${s.id}`)}></sw-camera-tile>`}
      <div class="statusrow"><sw-badge kind=${i}></sw-badge><span data-where>${d}</span></div>
      <dl class="meta">
    ...
    `}renderCard(){const e=this.bundle;if(!this.selectedId||!e)return c;let t="",s="",i=c,a=c;if(e.source==="demo"){const d=Bt.find(f=>f.id===this.selectedId),u=d?void 0:hs.find(f=>f.id===this.selectedId);if(!d&&!u)return c;t=d?d.name:u.name,s=d?`${e.floorName} · ${d.source}`:`${e.floorName} · ${v(u.domain==="lock"?"entity.door":u.domain==="light"?"entity.light":"entity.sensor")}`,i=d?this.demoCameraBody(d,e.floorName):this.demoEntityBody(u);const m=d?d.state==="live"||d.state==="stale":!1;a=d?r`<sw-button variant="primary" size="sm" icon="expand" ?disabled=${!m} @click=${()=>b(`/live/cameras/${d.id}`)}>צפייה חיה</sw-button>
            <sw-button size="sm" icon="history" ?disabled=${d.state==="forbidden"} @click=${()=>b("/investigate/playback")}>${v("camera.recordings")}</sw-button>
            <sw-button variant="ghost" size="sm" iconOnly icon="pin" label=${this.pinned?v("camera.unpin"):v("camera.pin")} @click=${()=>this.pinned=!this.pinned}></sw-button>`:r`<sw-button variant="primary" size="sm" ?disabled=${!u.controllable||this.screenState==="stale"}>${v("entity.control")}</sw-button><sw-button variant="ghost" size="sm">${v("entity.openInHa")}</sw-button>`}else{const d=e.anchors.find(u=>u.id===this.selectedId);if(!d)return c;t=d.camera?.name??d.entity?.name??d.label??d.resource_id,s=`${e.buildingName} · ${e.floorName}`,i=d.resource_type==="camera"?this.apiCameraBody(d,e.floorName):this.apiEntityBody(d,e.floorName),a=r`${d.resource_type==="camera"?r`<sw-button variant="primary" size="sm" icon="expand" ?disabled=${Ht(d)==="offline"} @click=${()=>d.camera&&b(`/live/cameras/${d.camera.id}`)}>צפייה מלאה</sw-button>
            <sw-button size="sm" icon="history" ?disabled=${!d.camera} @click=${()=>d.camera&&b("/investigate/playback",{camera:d.camera.id})}>${v("camera.recordings")}</sw-button>`:this.entityFooter(d)}
      ...
      <div class="pnote"><sw-icon name="shield" size=${14}></sw-icon><span>מתג משנה תצוגה בלבד; ייבוא ישות אינו מעניק הרשאת שליטה בה.</span></div>
    </div>`}renderStage(){const e=this.bundle;if(this.loadError)return r`<div class="cover"><sw-state-panel state="error" hint=${this.loadError} actionLabel=${v("states.retry")} @action=${()=>this.load()}></sw-state-panel></div>`;if(this.noFloors)return r`<div class="cover"><sw-state-panel state="empty" heading="עדיין אין קומות" hint="צור אתר, מבנה וקומה ואז ייבא תוכנית קומה."><div style="margin-block-start:10px"><sw-button variant="primary" icon="building" @click=${()=>b("/explore/sites")}>לאתרים ומבנים</sw-button></div></sw-state-panel></div>`;if(!e)return r`<div class="cover"><sw-state-panel state="loading"></sw-state-panel></div>`;switch(this.screenState){case"loading":return r`<div class="cover"><sw-state-panel state="loading"></sw-state-panel></div>`;case"error":return r`<div class="cover"><sw-state-panel state="error" actionLabel=${v("states.retry")}></sw-state-panel></div>`;case"forbidden":return r`<div class="cover"><sw-state-panel state="forbidden"></sw-state-panel></div>`}return this.screenState==="empty"||e.planStatus==="none"?r`<div class="cover">
        <sw-state-panel state="empty" heading=${v("floor.noPlan")} hint=${e.permissions.import?v("floor.noPlanHint"):"עורך המפות של הקומה יכול להעלות תוכנית."}>
          <div style="display:flex;gap:8px;margin-block-start:10px;justify-content:center;flex-wrap:wrap">
            ${e.permissions.import?r`<sw-button variant="primary" icon="upload" @click=${()=>b(`/explore/floors/${e.floorId}/import`)}>${v("floor.uploadPlan")}</sw-button>`:c}
            <sw-button icon="list" @click=${()=>b("/live/wall")}>${v("floor.listView")}</sw-button>
          </div>
        </sw-state-panel>
      </div>`:r`
      ...
      <div class="head">
        ...
        <div class="tools">
          <div class="layers" role="group" aria-label=${v("floor.layers")}>
            ${uo.map(n=>r`<button class=${this.layers.has(n.id)?"on":""} title=${n.label()} aria-label=${n.label()} aria-pressed=${this.layers.has(n.id)} @click=${()=>this.toggleLayer(n.id)}><sw-icon name=${n.icon} size=${14}></sw-icon></button>`)}
          </div>
          ...
          <sw-field><select aria-label=${v("floor.switcher")} @change=${n=>b(`/explore/floors/${n.target.value}`)}>${t.map(n=>r`<option value=${n.id} ?selected=${n.id===this.floorId}>${n.name} · ${n.cameraCount} מצלמות${n.hasPlan?"":" · אין תוכנית"}</option>`)}</select></sw-field>
  ...
  `;j([h()],N.prototype,"floorId",2);j([h()],N.prototype,"screenState",2);j([h()],N.prototype,"focusZone",2);j([h()],N.prototype,"focusCamera",2);j([h()],N.prototype,"focusEntity",2);j([l()],N.prototype,"selectedZoneId",2);j([l()],N.prototype,"bundle",2);j([l()],N.prototype,"tree",2);j([l()],N.prototype,"loadError",2);j([l()],N.prototype,"noFloors",2);j([l()],N.prototype,"selectedId",2);j([l()],N.prototype,"anchor",2);j([l()],N.prototype,"layers",2);j([l()],N.prototype,"pinned",2);j([l()],N.prototype,"panel",2);j([l()],N.prototype,"multi",2);j([l()],N.prototype,"picked",2);j([l()],N.prototype,"narrow",2);j([l()],N.prototype,"syncConnected",2);j([l()],N.prototype,"action",2);j([l()],N.prototype,"confirmSpec",2);j([Mt("sw-plan-canvas")],N.prototype,"canvas",2);j([Mt(".stage")],N.prototype,"stage",2);N=j([k("explore-floor-map")],N);var fo=Object.defineProperty,mo=Object.getOwnPropertyDescriptor,Et=(e,t,s,i)=>{for(var a=i>1?void 0:i?mo(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&fo(t,s,a),a};let Xe=class extends y{constructor(){super(...arguments),this.heading="",this.subheading="",this.crumbs="",this.wide=!1,this.flush=!1}render(){const e=this.crumbs?this.crumbs.split("|").map(t=>t.trim()):[];return r`
      <header>
        <div>
  ...
  `;Et([h()],Xe.prototype,"heading",2);Et([h()],Xe.prototype,"subheading",2);Et([h()],Xe.prototype,"crumbs",2);Et([h({type:Boolean,reflect:!0})],Xe.prototype,"wide",2);Et([h({type:Boolean,reflect:!0})],Xe.prototype,"flush",2);Xe=Et([k("sw-page")],Xe);var wo=Object.defineProperty,vo=Object.getOwnPropertyDescriptor,ts=(e,t,s,i)=>{for(var a=i>1?void 0:i?vo(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&wo(t,s,a),a};let pt=class extends y{constructor(){super(...arguments),this.heading="",this.subheading="",this.flush=!1,this.interactive=!1}render(){return r`
  ...
  `;ts([h()],pt.prototype,"heading",2);ts([h()],pt.prototype,"subheading",2);ts([h({type:Boolean,reflect:!0})],pt.prototype,"flush",2);ts([h({type:Boolean,reflect:!0})],pt.prototype,"interactive",2);pt=ts([k("sw-card")],pt);var bo=Object.defineProperty,go=Object.getOwnPropertyDescriptor,st=(e,t,s,i)=>{for(var a=i>1?void 0:i?go(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&bo(t,s,a),a};const yo=["house","building","warehouse"];let Pe=class extends y{constructor(){super(...arguments),this.tab="all",this.tree=null,this.dialog=null,this.formName="",this.formAddress="",this.busy=!1,this.error=""}connectedCallback(){super.connectedCallback(),this.reload()}async reload(){try{this.tree=await tt()}catch(e){this.error=w(e)}}open(e){this.formName="",this.formAddress="",this.error="",this.dialog=e}async submit(){const e=this.dialog;if(e){this.busy=!0,this.error="";try{if(e.kind==="site"){const t=await Wn({name:this.formName.trim(),address:this.formAddress.trim()});this.dialog=null,await this.reload(),this.open({kind:"building",site:t})}else{const t=await Ca(e.site.id,{name:this.formName.trim()});this.dialog=null,b(`/explore/buildings/${t.id}/floors`)}}catch(t){this.error=w(t)}finally{this.busy=!1}}}openSite(e){const t=e.buildings?.[0];t?b(`/explore/buildings/${t.id}/floors`):this.open({kind:"building",site:e})}renderSites(e){return r`<div class="grid">
      ${e.sites.map((t,s)=>{const i=t.buildings??[],a=i.reduce((n,o)=>n+(o.floors??[]).reduce((d,u)=>d+u.camera_count,0),0);return r`<sw-card flush interactive @click=${()=>this.openSite(t)}>
          <div class="pic"><sw-scene kind=${yo[s%3]}></sw-scene>${e.source==="demo"?r`<span class="demo">דמו</span>`:r`<span class="demo">איור</span>`}</div>
          <div class="info">
  ...
  `;st([l()],Pe.prototype,"tab",2);st([l()],Pe.prototype,"tree",2);st([l()],Pe.prototype,"dialog",2);st([l()],Pe.prototype,"formName",2);st([l()],Pe.prototype,"formAddress",2);st([l()],Pe.prototype,"busy",2);st([l()],Pe.prototype,"error",2);Pe=st([k("explore-sites")],Pe);var $o=Object.defineProperty,xo=Object.getOwnPropertyDescriptor,ss=(e,t,s,i)=>{for(var a=i>1?void 0:i?xo(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&$o(t,s,a),a};let ht=class extends y{constructor(){super(...arguments),this.rooms=[],this.selected=!1,this.empty=!1,this.width=132}iso(e,t){return{x:60+(e-t)*58,y:6+(e+t)*26}}poly(e){return e.map(t=>`${t.x.toFixed(1)},${t.y.toFixed(1)}`).join(" ")}render(){this.style.setProperty("--w",`${this.width}px`);const e=[this.iso(0,0),this.iso(1,0),this.iso(1,1),this.iso(0,1)],t=7,s=[this.iso(1,0),this.iso(1,1),{x:this.iso(1,1).x,y:this.iso(1,1).y+t},{x:this.iso(1,0).x,y:this.iso(1,0).y+t}],i=[this.iso(0,1),this.iso(1,1),{x:this.iso(1,1).x,y:this.iso(1,1).y+t},{x:this.iso(0,1).x,y:this.iso(0,1).y+t}];return r`<svg viewBox="0 0 120 72" aria-hidden="true">
  ...
  `;ss([h({attribute:!1})],ht.prototype,"rooms",2);ss([h({type:Boolean,reflect:!0})],ht.prototype,"selected",2);ss([h({type:Boolean,reflect:!0})],ht.prototype,"empty",2);ss([h({type:Number})],ht.prototype,"width",2);ht=ss([k("sw-floor-iso")],ht);var ko=Object.defineProperty,_o=Object.getOwnPropertyDescriptor,Ce=(e,t,s,i)=>{for(var a=i>1?void 0:i?_o(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&ko(t,s,a),a};let ge=class extends y{constructor(){super(...arguments),this.buildingId="bld-a",this.tree=null,this.selected=null,this.tab="floors",this.dialog=null,this.busy=!1,this.error="",this.formName="",this.formLevel=0}connectedCallback(){super.connectedCallback(),this.reload()}updated(e){e.has("buildingId")&&e.get("buildingId")!==void 0&&(this.selected=null)}async reload(){try{this.tree=await tt(),this.error=""}catch(e){this.error=w(e)}}get context(){if(!this.tree)return null;for(const s of this.tree.sites)for(const i of s.buildings??[])if(i.id===this.buildingId)return{site:s,building:i};const e=this.tree.sites[0],t=e?.buildings?.[0];return e&&t?{site:e,building:t}:null}async run(e){this.busy=!0,this.error="";try{await e(),this.dialog=null,await this.reload()}catch(t){t instanceof fe&&t.code==="has_anchors"&&this.dialog?.kind==="delete"?(this.dialog={...this.dialog,force:!0},this.error=`${t.body.user_message} (${t.body.details.anchors??""} פריטים)`):this.error=w(t)}finally{this.busy=!1}}openDialog(e){this.error="",this.formName=e?.kind==="rename"?e.floor.name:"",this.formLevel=e?.kind==="rename"?e.floor.level:0,this.dialog=e}renderDialog(e){const t=this.dialog;if(!t)return c;const s=this.tree?.source==="demo",i=r`<sw-field label="שם"><input .value=${this.formName} @input=${d=>this.formName=d.target.value} placeholder="למשל: קומה 1" autofocus /></sw-field>`,a=r`<sw-field label="מפלס (0 = קרקע, שלילי = מרתף)" hint="קובע את סדר התצוגה בין הקומות"><input type="number" data-ltr .value=${String(this.formLevel)} @input=${d=>this.formLevel=Number(d.target.value)} /></sw-field>`,n=this.error?r`<div class="err">${this.error}</div>`:c,o=s?r`<div class="err">נתוני הדגמה: אין שרת מחובר, השינוי לא יישמר.</div>`:c;switch(t.kind){case"floor":return r`<sw-dialog open heading="קומה חדשה" subheading=${`${e.name}`} @close=${()=>this.dialog=null}>
          ${i}${a}${n}${o}
          <sw-button slot="footer" variant="ghost" @click=${()=>this.dialog=null}>ביטול</sw-button>
          <sw-button slot="footer" variant="primary" ?disabled=${!this.formName.trim()||this.busy||s} @click=${()=>this.run(async()=>{const d=await Un(e.id,{name:this.formName.trim(),level:this.formLevel});this.selected=d.id})}>הוסף קומה</sw-button>
        </sw-dialog>`;case"rename":return r`<sw-dialog open heading="עריכת קומה" subheading=${t.floor.name} @close=${()=>this.dialog=null}>
          ${i}${a}${n}${o}
          <sw-button slot="footer" variant="ghost" @click=${()=>this.dialog=null}>ביטול</sw-button>
          <sw-button slot="footer" variant="primary" ?disabled=${!this.formName.trim()||this.busy||s} @click=${()=>this.run(()=>Zn(t.floor.id,{name:this.formName.trim(),level:this.formLevel}))}>שמירה</sw-button>
          ...
          ${n}${o}
          <sw-button slot="footer" variant="ghost" @click=${()=>this.dialog=null}>ביטול</sw-button>
          <sw-button slot="footer" variant="danger" ?disabled=${this.busy||s} @click=${()=>this.run(async()=>{await qn(t.floor.id,t.force),this.selected===t.floor.id&&(this.selected=null)})}>${t.force?"מחק כולל הפריטים":"מחק קומה"}</sw-button>
          ...
          ${i}${n}${o}
          <sw-button slot="footer" variant="ghost" @click=${()=>this.dialog=null}>ביטול</sw-button>
          <sw-button slot="footer" variant="primary" ?disabled=${!this.formName.trim()||this.busy||s} @click=${()=>this.run(async()=>{const d=await Ca(this.context.site.id,{name:this.formName.trim()});b(`/explore/buildings/${d.id}/floors`)})}>הוסף מבנה</sw-button>
      ...
      </sw-page>`;const{site:t,building:s}=e,i=s.floors??[],a=i.find(d=>d.id===this.selected)??i[0]??null,n=i.reduce((d,u)=>d+u.camera_count,0),o=this.tree;return r`
      <sw-page heading=${s.name} subheading=${`${t.address||t.name} · ${i.length} קומות${o.source==="demo"?" · נתוני הדגמה":""}`} crumbs=${`אתרים | ${t.name} | ${s.name}`}>
        ...
        <sw-tabs .items=${[{id:"floors",label:"קומות",count:i.length},{id:"cameras",label:"מצלמות",count:n},{id:"details",label:"פרטים"}]} .active=${this.tab} @change=${d=>this.tab=d.detail.id}></sw-tabs>
        ${this.tab==="floors"?r`<div class="list">
              ...
              ${i.map(d=>r`<button class="floor ${a?.id===d.id?"on":""}" @click=${()=>a?.id===d.id?b(`/explore/floors/${d.id}`):this.selected=d.id} aria-pressed=${a?.id===d.id}>
                  <div class="txt">
                    <div class="title">${d.name}</div>
                    <div class="counts">${d.camera_count} מצלמות · ${d.anchor_count} פריטים במפה · מפלס ${d.level}${d.has_plan?"":" · אין תוכנית עדיין"}${d.draft_version_id?" · טיוטה ממתינה לפרסום":""}</div>
                  </div>
                  <sw-floor-iso .rooms=${o.source==="demo"?qs(d.id):[]} ?selected=${a?.id===d.id} ?empty=${!d.has_plan} width=${128}></sw-floor-iso>
            ...
            </div>`:this.tab==="cameras"?r`<div class="cams">${i.map(d=>r`<sw-card heading=${d.name} subheading="${d.camera_count} מצלמות" interactive @click=${()=>b(`/explore/floors/${d.id}`)}></sw-card>`)}</div>`:r`<sw-card heading="פרטי המבנה">
                <dl>
                  <dt>אתר</dt><dd>${t.name}</dd>
                  <dt>כתובת</dt><dd>${t.address||"—"}</dd>
                  <dt>אזור זמן</dt><dd><span class="ltr">${t.timezone}</span></dd>
                  <dt>קומות</dt><dd>${i.length} · ${i.filter(d=>d.has_plan).length} עם תוכנית מפורסמת</dd>
  ...
  `;Ce([h()],ge.prototype,"buildingId",2);Ce([l()],ge.prototype,"tree",2);Ce([l()],ge.prototype,"selected",2);Ce([l()],ge.prototype,"tab",2);Ce([l()],ge.prototype,"dialog",2);Ce([l()],ge.prototype,"busy",2);Ce([l()],ge.prototype,"error",2);Ce([l()],ge.prototype,"formName",2);Ce([l()],ge.prototype,"formLevel",2);ge=Ce([k("explore-floors")],ge);var zo=Object.defineProperty,So=Object.getOwnPropertyDescriptor,ki=(e,t,s,i)=>{for(var a=i>1?void 0:i?So(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&zo(t,s,a),a};let Gt=class extends y{constructor(){super(...arguments),this.steps=[],this.current=0}render(){return r`${this.steps.map((e,t)=>r`
  ...
  `;ki([h({attribute:!1})],Gt.prototype,"steps",2);ki([h({type:Number})],Gt.prototype,"current",2);Gt=ki([k("sw-steps")],Gt);var Mo=Object.defineProperty,Io=Object.getOwnPropertyDescriptor,pe=(e,t,s,i)=>{for(var a=i>1?void 0:i?Io(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&Mo(t,s,a),a};const Ns=["קובץ","עמוד","חיתוך וסיבוב","שם והערות","שמירה ופרסום"];let se=class extends y{constructor(){super(...arguments),this.floorId="",this.step=0,this.tree=null,this.assets=[],this.asset=null,this.page=1,this.rotation=0,this.crop={x:0,y:0,w:1,h:1},this.notes="",this.version=null,this.busy=!1,this.error="",this.dragOver=!1,this.startCrop=e=>{if(e.button!==0)return;const t=e.currentTarget,s=t.getBoundingClientRect(),i=d=>({x:Math.min(1,Math.max(0,(d.clientX-s.left)/s.width)),y:Math.min(1,Math.max(0,(d.clientY-s.top)/s.height))}),a=i(e);t.setPointerCapture(e.pointerId),e.preventDefault();const n=d=>{const u=i(d),m=Math.min(a.x,u.x),f=Math.min(a.y,u.y),g=Math.abs(u.x-a.x),S=Math.abs(u.y-a.y);g>.01&&S>.01&&(this.crop={x:+m.toFixed(4),y:+f.toFixed(4),w:+g.toFixed(4),h:+S.toFixed(4)})},o=()=>{t.removeEventListener("pointermove",n),t.removeEventListener("pointerup",o),t.removeEventListener("pointercancel",o),(this.crop.w<.02||this.crop.h<.02)&&(this.crop={x:0,y:0,w:1,h:1})};t.addEventListener("pointermove",n),t.addEventListener("pointerup",o),t.addEventListener("pointercancel",o)}}connectedCallback(){super.connectedCallback(),this.init()}async init(){try{this.tree=await tt(),$()&&this.floorId&&(this.assets=(await Cn(this.floorId)).assets)}catch(e){this.error=w(e)}}get floor(){return this.tree&&this.floorId?Ta(this.tree,this.floorId):null}async onFile(e){if(!(!e||!this.floorId)){this.busy=!0,this.error="";try{this.asset=await Tn(this.floorId,e),this.page=1,this.rotation=0,this.crop={x:0,y:0,w:1,h:1},this.version=null,this.step=this.asset.page_count>1?1:2,this.assets=[this.asset,...this.assets.filter(t=>t.id!==this.asset.id)]}catch(t){this.error=w(t)}finally{this.busy=!1}}}async save(){if(!(!this.asset||!this.floorId)){this.busy=!0,this.error="";try{const e=this.crop.x===0&&this.crop.y===0&&this.crop.w===1&&this.crop.h===1;this.version=await Dn(this.floorId,{asset_id:this.asset.id,page:this.page,rotation:this.rotation,crop:e?null:this.crop,notes:this.notes})}catch(e){this.error=w(e)}finally{this.busy=!1}}}async publish(){if(this.version){this.busy=!0,this.error="";try{this.version=await ei(this.version.id)}catch(e){this.error=w(e)}finally{this.busy=!1}}}setCrop(e,t){const s=Math.max(0,Math.min(100,t))/100,i={...this.crop,[e]:s};i.x+i.w>1&&(i.w=1-i.x),i.y+i.h>1&&(i.h=1-i.y),i.w<=.02&&(i.w=.02),i.h<=.02&&(i.h=.02),this.crop=i}previewUrl(){const e=this.asset?.pages.find(s=>s.page===this.page)??this.asset?.pages[0];if(!e)return"";const t=Ne(e.preview_url);return this.rotation?`${t}${t.includes("?")?"&":"?"}rotation=${this.rotation}`:t}renderStep(){const e=this.asset;switch(this.step){case 0:return r`
      ...
      <sw-page heading=${e?`ייבוא תוכנית ל${e.floor.name}`:"ייבוא תוכנית"} subheading="המקור נשמר ללא שינוי; כל תיקון הוא שכבה נגזרת" crumbs=${e?`אתרים | ${e.site.name} | ${e.building.name} | ${e.floor.name}`:"אתרים"}>
        ${$()?!this.floorId||this.tree&&!e?r`<sw-state-panel state="empty" heading="בחר קומה" hint="ייבוא תוכנית מתחיל מדף הקומות."><div style="margin-block-start:10px"><sw-button variant="primary" @click=${()=>b("/explore/sites")}>לאתרים</sw-button></div></sw-state-panel>`:r`
  ...
  `;pe([h()],se.prototype,"floorId",2);pe([l()],se.prototype,"step",2);pe([l()],se.prototype,"tree",2);pe([l()],se.prototype,"assets",2);pe([l()],se.prototype,"asset",2);pe([l()],se.prototype,"page",2);pe([l()],se.prototype,"rotation",2);pe([l()],se.prototype,"crop",2);pe([l()],se.prototype,"notes",2);pe([l()],se.prototype,"version",2);pe([l()],se.prototype,"busy",2);pe([l()],se.prototype,"error",2);pe([l()],se.prototype,"dragOver",2);se=pe([k("explore-plan-import")],se);var Ao=Object.defineProperty,Po=Object.getOwnPropertyDescriptor,is=(e,t,s,i)=>{for(var a=i>1?void 0:i?Po(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&Ao(t,s,a),a};let ut=class extends y{constructor(){super(...arguments),this.checked=!1,this.disabled=!1,this.label="",this.labelHidden=!1}flip(){this.disabled||(this.checked=!this.checked,this.dispatchEvent(new CustomEvent("change",{detail:{checked:this.checked},bubbles:!0,composed:!0})))}render(){return r`<button type="button" role="switch" aria-checked=${this.checked} aria-label=${this.label} ?disabled=${this.disabled} @click=${this.flip}></button>${this.label&&!this.labelHidden?r`<span>${this.label}</span>`:""}`}};ut.styles=x`
    :host {
      display: inline-flex;
      align-items: center;
      gap: var(--sw-s-2);
  ...
  `;is([h({type:Boolean,reflect:!0})],ut.prototype,"checked",2);is([h({type:Boolean,reflect:!0})],ut.prototype,"disabled",2);is([h()],ut.prototype,"label",2);is([h({type:Boolean})],ut.prototype,"labelHidden",2);ut=is([k("sw-toggle")],ut);const Bs={white:"לבן",tint:"גוון לכל חדר",none:"ללא מילוי"};async function Eo(e,t){const s=await z(`plan-versions/${e}/stylize`,t);return{...s,source_url:Ne(s.source_url)+`?v=${Date.now()}`,stylized_url:Ne(s.stylized_url)+`?v=${Date.now()}`}}const Co=(e,t)=>Ve(`plan-versions/${e}`,{render_mode:t});var To=Object.defineProperty,Oo=Object.getOwnPropertyDescriptor,E=(e,t,s,i)=>{for(var a=i>1?void 0:i?Oo(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&To(t,s,a),a};const ns=["#2767ED","#22A06B","#F59E0B","#8B5CF6","#0EA5E9","#EC4899","#14B8A6","#F97316"],Do=[{id:"select",icon:"target",label:"בחירה וגרירה",ready:!0},{id:"camera",icon:"camera",label:"הוספת מצלמה",ready:!0},{id:"entity",icon:"light",label:"הוספת ישות HA",ready:!0},{id:"zones",icon:"map",label:"חדרים ואזורים",ready:!0},{id:"layers",icon:"layers",label:"שכבות",ready:!0}],qi=[{id:"cameras",label:"מצלמות"},{id:"doors",label:"דלתות ומנעולים"},{id:"lights",label:"תאורה ומתגים"},{id:"sensors",label:"חיישנים"}],Ro={asset:"קובץ",page:"עמוד",rotation:"סיבוב",crop:"חיתוך",width_px:"רוחב",height_px:"גובה"},Hs=e=>e?new Intl.DateTimeFormat("he-IL",{dateStyle:"short",timeStyle:"short"}).format(new Date(e)):"";let P=class extends y{constructor(){super(...arguments),this.floorId="",this.presetEntity="",this.bundle=null,this.anchors=[],this.dirty=new Set,this.undo=[],this.redo=[],this.selectedId=null,this.tool="select",this.layers=new Set(["cameras","doors","lights","sensors"]),this.placing=null,this.entQ="",this.entResults=null,this.entBusy=!1,this.busy=!1,this.error="",this.info="",this.stylizing=!1,this.stylized=null,this.stylizeOpts={strength:"medium",keepLines:!1,roomFill:"white"},this.zones=[],this.versions=[],this.diff=null,this.selectedZoneId=null,this.candidates=null,this.detecting=!1,this.detectStrength="medium",this.replaceAuto=!0,this.drawing=null,this.showZones=!0,this.zoneBusy=!1,this.entTimer=0,this.onKey=e=>this.handleKey(e)}connectedCallback(){super.connectedCallback(),this.load(),window.addEventListener("keydown",this.onKey),this.presetEntity&&(this.tool="entity",this.entQ=this.presetEntity,this.searchEntities())}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("keydown",this.onKey)}async load(){this.error="";try{const e=await qt(this.floorId||"f0",!0);this.bundle=e,this.anchors=e.anchors.map(t=>({...t,position:{...t.position}})),this.zones=e.zones,this.loadVersions(),this.selectedZoneId&&!this.zones.some(t=>t.id===this.selectedZoneId)&&(this.selectedZoneId=null),this.dirty=new Set,this.undo=[],this.redo=[],this.selectedId&&!this.anchors.some(t=>t.id===this.selectedId)&&(this.selectedId=null)}catch(e){this.error=w(e)}}get selected(){return this.anchors.find(e=>e.id===this.selectedId)}layerOf(e){return e.resource_type==="camera"?"cameras":e.layer_id==="doors"?"doors":e.layer_id==="lights"?"lights":"sensors"}get markers(){return this.anchors.filter(e=>this.layers.has(this.layerOf(e))).map(e=>({id:e.id,kind:e.resource_type==="camera"?"camera":Es(e.layer_id,e.entity?.domain),label:e.camera?.name??e.entity?.name??e.label??e.resource_id,x:e.position.x,y:e.position.y,rotation:e.rotation_degrees,fov:e.field_of_view_degrees??void 0,state:e.resource_type==="camera"?this.bundle?.source==="demo"?"live":Ht(e):"neutral"}))}anchorName(e){return e.camera?.name??e.entity?.name??e.label??e.resource_id}get selectedZone(){return this.zones.find(e=>e.id===this.selectedZoneId)}get planZones(){if(!this.showZones)return[];const e=this.zones.map(s=>({id:s.id,name:s.name,kind:s.kind,color:s.color,polygon:s.polygon})),t=(this.candidates??[]).map((s,i)=>({id:`cand-${i}`,name:s.include?s.name:"",color:s.include?ns[i%ns.length]:"#9AA3B5",polygon:s.polygon,candidate:!0}));return[...e,...t]}async detect(){const e=this.bundle;if(e){if(e.source==="demo"){this.info="נתוני הדגמה: הזיהוי עובד מול השרת.";return}this.detecting=!0,this.error="";try{const t=await Qn(e.floorId,this.detectStrength);this.candidates=t.rooms.map((s,i)=>({polygon:s.polygon,name:`חדר ${i+1}`,kind:"room",include:!0})),this.selectedZoneId=null,this.selectedId=null,this.info=t.rooms.length?`${t.rooms.length} חדרים זוהו · תן שמות ושמור`:"לא זוהו חדרים סגורים; נסה עוצמה אחרת או צייר אזור ידנית",setTimeout(()=>this.info="",5e3)}catch(t){this.error=w(t)}finally{this.detecting=!1}}}setCandidate(e,t){this.candidates&&(this.candidates=this.candidates.map((s,i)=>i===e?{...s,...t}:s))}async acceptCandidates(){const e=this.bundle,t=(this.candidates??[]).filter(s=>s.include);if(!(!e||!t.length)){this.zoneBusy=!0,this.error="";try{const s=await eo(e.floorId,t.map(i=>({polygon:i.polygon,name:i.name,kind:i.kind})),this.replaceAuto);this.candidates=null,this.zones=s.zones,this.info=`${s.created.length} חדרים נשמרו`,setTimeout(()=>this.info="",3e3)}catch(s){this.error=w(s)}finally{this.zoneBusy=!1}}}startDrawing(){this.drawing=[],this.placing=null,this.candidates=null,this.selectedZoneId=null,this.selectedId=null}addDraftPoint(e,t){const s=this.drawing,i=this.bundle;if(!(!s||!i)){if(s.length>=3){const a=this.canvas?.zoom??1;if(Math.hypot((e-s[0].x)*i.width*a,(t-s[0].y)*i.height*a)<12){this.finishDrawing();return}}this.drawing=[...s,{x:+e.toFixed(4),y:+t.toFixed(4)}]}}async finishDrawing(){const e=this.drawing,t=this.bundle;if(!(!e||!t||e.length<3)){if(t.source==="demo"){this.info="נתוני הדגמה: השמירה עובדת מול השרת.",this.drawing=null;return}this.zoneBusy=!0,this.error="";try{const s=await Jn(t.floorId,{name:`אזור ${this.zones.length+1}`,kind:"zone",polygon:e});this.drawing=null,this.zones=[...this.zones,s],this.selectedZoneId=s.id,this.info="האזור נוצר · תן לו שם",setTimeout(()=>this.info="",3e3)}catch(s){this.error=w(s)}finally{this.zoneBusy=!1}}}async patchZone(e,t){if(this.bundle?.source!=="demo"){this.zoneBusy=!0,this.error="";try{const s=await Yn(e.id,{revision:e.revision,...t});this.zones=this.zones.map(i=>i.id===s.id?s:i)}catch(s){s instanceof fe&&s.status===409?(this.error="האזור השתנה בינתיים על ידי עורך אחר; נטען מחדש בלי לדרוס.",await this.load()):this.error=w(s)}finally{this.zoneBusy=!1}}}async removeZone(e){if(this.bundle?.source!=="demo"&&window.confirm(`למחוק את "${e.name}"? המצלמות והישויות בקומה לא מושפעות.`)){this.zoneBusy=!0,this.error="";try{await Xn(e.id),this.zones=this.zones.filter(t=>t.id!==e.id),this.selectedZoneId===e.id&&(this.selectedZoneId=null)}catch(t){this.error=w(t)}finally{this.zoneBusy=!1}}}snapshot(){this.undo=[...this.undo.slice(-40),this.anchors.map(e=>({...e,position:{...e.position}}))],this.redo=[]}apply(e,t){this.snapshot(),this.anchors=this.anchors.map(s=>s.id===e?{...s,...t,position:t.position??s.position}:s),this.dirty=new Set(this.dirty).add(e)}nudge(e,t){const s=this.selected;s&&this.apply(s.id,{position:{x:+Math.min(1,Math.max(0,s.position.x+e)).toFixed(4),y:+Math.min(1,Math.max(0,s.position.y+t)).toFixed(4)}})}doUndo(){const e=this.undo[this.undo.length-1];e&&(this.redo=[...this.redo,this.anchors],this.undo=this.undo.slice(0,-1),this.anchors=e,this.dirty=new Set(this.anchors.map(t=>t.id)))}doRedo(){const e=this.redo[this.redo.length-1];e&&(this.undo=[...this.undo,this.anchors],this.redo=this.redo.slice(0,-1),this.anchors=e,this.dirty=new Set(this.anchors.map(t=>t.id)))}handleKey(e){const t=e.composedPath()[0],s=t&&(t.tagName==="INPUT"||t.tagName==="TEXTAREA"||t.tagName==="SELECT"||t.isContentEditable);if(e.key==="Escape"){this.drawing?this.drawing=null:this.placing?this.placing=null:this.candidates?this.candidates=null:(this.selectedId=null,this.selectedZoneId=null);return}if(s)return;if(e.key==="Enter"&&this.drawing){e.preventDefault(),this.finishDrawing();return}if((e.key==="Delete"||e.key==="Backspace")&&!this.selected&&this.selectedZone){e.preventDefault(),this.removeZone(this.selectedZone);return}if((e.ctrlKey||e.metaKey)&&e.key.toLowerCase()==="z"){e.preventDefault(),e.shiftKey?this.doRedo():this.doUndo();return}if((e.ctrlKey||e.metaKey)&&e.key.toLowerCase()==="y"){e.preventDefault(),this.doRedo();return}if((e.ctrlKey||e.metaKey)&&e.key.toLowerCase()==="s"){e.preventDefault(),this.save();return}if(!this.selected)return;const i=e.shiftKey?.01:.002;e.key==="ArrowLeft"?(e.preventDefault(),this.nudge(-i,0)):e.key==="ArrowRight"?(e.preventDefault(),this.nudge(i,0)):e.key==="ArrowUp"?(e.preventDefault(),this.nudge(0,-i)):e.key==="ArrowDown"?(e.preventDefault(),this.nudge(0,i)):(e.key==="Delete"||e.key==="Backspace")&&(e.preventDefault(),this.removeSelected())}async save(){if(!this.bundle||this.bundle.source==="demo")return this.info="נתוני הדגמה: השינויים נשמרים רק במסך זה.",this.dirty=new Set,!0;if(!this.dirty.size)return!0;this.busy=!0,this.error="";let e=!1;try{for(const t of this.dirty){const s=this.anchors.find(i=>i.id===t);if(s)try{const i=await Bn(t,{revision:s.revision,x:s.position.x,y:s.position.y,rotation_degrees:s.rotation_degrees,field_of_view_degrees:s.field_of_view_degrees,label:s.label});this.anchors=this.anchors.map(a=>a.id===t?{...a,revision:i.revision}:a)}catch(i){if(i instanceof fe&&i.code==="stale_revision")e=!0;else throw i}}return e?(this.error="חלק מהפריטים השתנו בינתיים על ידי עורך אחר; המפה נטענה מחדש בלי לדרוס את השינוי שלו.",await this.load(),!1):(this.dirty=new Set,this.info="המיקומים נשמרו",setTimeout(()=>this.info="",2500),!0)}catch(t){return this.error=w(t),!1}finally{this.busy=!1}}async place(e,t){const s=this.placing;if(!(!s||!this.bundle)){if(this.bundle.source==="demo"){this.info="נתוני הדגמה: הוספה עובדת מול השרת.",this.placing=null;return}if(!(this.dirty.size&&!await this.save())){this.busy=!0,this.error="";try{const i=s.kind==="camera"?await Wi(this.bundle.floorId,{resource_type:"camera",resource_id:s.camera.id,x:e,y:t,rotation_degrees:0,field_of_view_degrees:90}):await Wi(this.bundle.floorId,{resource_type:"ha_entity",resource_id:s.entity.entity_id,x:e,y:t,rotation_degrees:0,field_of_view_degrees:null});this.placing=null,await this.load(),this.selectedId=i.id,this.tool="select",this.info=`${this.anchorName(i)} הוצב · גרור לדיוק, קבע כיוון בידיות`,setTimeout(()=>this.info="",4e3)}catch(i){this.error=w(i)}finally{this.busy=!1}}}}async removeSelected(){const e=this.selected;if(!(!e||!this.bundle)){if(this.bundle.source==="demo"){this.info="נתוני הדגמה: הסרה עובדת מול השרת.";return}if(window.confirm(`להסיר את "${this.anchorName(e)}" מהמפה? המקור עצמו לא נמחק.`)){this.busy=!0,this.error="";try{await Hn(e.id),this.selectedId=null,await this.load()}catch(t){this.error=w(t)}finally{this.busy=!1}}}}async loadVersions(){const e=this.bundle;if(!e||e.source==="demo"||!e.permissions.edit){this.versions=[];return}try{this.versions=(await On(e.floorId)).versions}catch{this.versions=[]}}async publish(){if(!this.bundle?.planVersionId||this.dirty.size&&!await this.save())return;const e=this.versions.find(t=>t.id===this.bundle?.planVersionId);if(!e){await this.publishNow(this.bundle.planVersionId);return}await this.openDiff("publish",e)}async publishNow(e){this.busy=!0,this.error="";try{await ei(e),this.info="הגרסה פורסמה; הצופים רואים אותה עכשיו",await this.load()}catch(t){this.error=w(t)}finally{this.busy=!1}}async openDiff(e,t){this.diff={mode:e,version:t,data:null,error:""};try{const s=await Rn(t.id);this.diff?.version.id===t.id&&(this.diff={mode:e,version:t,data:s,error:""})}catch(s){this.diff={mode:e,version:t,data:null,error:w(s)}}}async confirmDiff(){const e=this.diff;if(!(!e?.data||e.mode==="compare")){this.busy=!0,this.error="";try{e.mode==="publish"?(await ei(e.version.id),this.info="הגרסה פורסמה; הצופים רואים אותה עכשיו"):(await Nn(e.version.id,e.version.revision,e.data.from?.id??null),this.info="הגרסה שוחזרה ופורסמה מחדש; העוגנים נשמרו"),this.diff=null,await this.load(),setTimeout(()=>this.info="",4e3)}catch(t){this.diff={...e,error:w(t)},t instanceof fe&&t.status===409&&this.loadVersions()}finally{this.busy=!1}}}async searchEntities(){if(this.bundle?.source!=="demo"){this.entBusy=!0;try{const e=await Da({q:this.entQ||void 0,limit:40});this.entResults=e.entities}catch(e){this.error=w(e),this.entResults=[]}finally{this.entBusy=!1}}}onEntQuery(e){this.entQ=e,window.clearTimeout(this.entTimer),this.entTimer=window.setTimeout(()=>void this.searchEntities(),250)}async stylize(e,t){if(!this.bundle?.planVersionId||this.bundle.source==="demo")return;const s=this.stylizeOpts;(e!==void 0||t!==void 0)&&(this.stylizeOpts={...s,strength:e??s.strength,keepLines:t??s.keepLines}),this.stylizing=!0,this.error="";try{this.stylized=await Eo(this.bundle.planVersionId,{strength:this.stylizeOpts.strength,keep_lines:this.stylizeOpts.keepLines,room_fill:this.stylizeOpts.roomFill})}catch(i){this.error=w(i)}finally{this.stylizing=!1}}async useRender(e){if(this.bundle?.planVersionId){this.busy=!0,this.error="";try{await Co(this.bundle.planVersionId,e),this.stylized=null,await this.load(),this.info=e==="stylized"?"המפה מציגה עכשיו את שפת SMPLWISE":"המפה מציגה את תוכנית המקור",setTimeout(()=>this.info="",3e3)}catch(t){this.error=w(t)}finally{this.busy=!1}}}pickTool(e){this.tool=e,this.placing=null,e==="entity"&&this.entResults===null&&this.searchEntities()}renderCameraInspector(e){const t=e.camera,s=e.field_of_view_degrees??0;return r`<sw-card heading="הגדרות מצלמה" subheading="גרירה במפה, ידיות לכיוון ולשדה הראייה, או הזנה מדויקת">
      ...
      ${t?r`<div class="kv"><span class="k">מצב עכשיו</span><span>${ct(t)}</span></div><div class="kv"><span class="k">סוג</span><span>${Kt(t.domain)}</span></div>`:c}
      ...
      ${t?r`<div class="compare">
              <div><div class="note">${t.from?`מפורסמת · ${Hs(t.from.published_at??t.from.created_at)}`:"אין גרסה מפורסמת"}</div>${t.from?r`<img src=${Ne(t.from.image_url)} alt="הגרסה המפורסמת" />`:r`<div class="note">—</div>`}</div>
              <div><div class="note">${e.mode==="rollback"?"לשחזור":"חדשה"} · ${Hs(t.to.published_at??t.to.created_at)}</div><img src=${Ne(t.to.image_url)} alt="הגרסה החדשה" /></div>
            </div>
            <div class="dsum" data-diff-summary>
              ${t.from?t.geometry.same?r`<sw-badge kind="recorded" label="גאומטריה זהה"></sw-badge>`:r`<sw-badge kind="partial" label=${`שינוי: ${t.geometry.changes.map(a=>Ro[a.field]??a.field).join(", ")}`}></sw-badge>`:r`<sw-badge kind="neutral" label="פרסום ראשון"></sw-badge>`}
        ...
        ${e.planStatus==="none"?r`<sw-state-panel state="empty" heading="לקומה אין תוכנית" hint="העלה תוכנית קודם; אחר כך אפשר להציב מצלמות וישויות."><div style="margin-block-start:10px"><sw-button variant="primary" icon="upload" @click=${()=>b(`/explore/floors/${e.floorId}/import`)}>העלאת תוכנית</sw-button></div></sw-state-panel>`:r`<div class="layout">
              <div class="mapwrap">
                ...
                <div class="rail" role="toolbar" aria-label="כלי עריכה">
                  ${Do.map(n=>r`<button class=${n.id===this.tool?"on":""} ?disabled=${!n.ready} title=${n.label} aria-label=${n.label} aria-pressed=${n.id===this.tool} @click=${()=>this.pickTool(n.id)}><sw-icon .name=${n.icon} size=${18}></sw-icon></button>`)}
                  <hr />
                ...
                <sw-plan-canvas editable alwaysLabel .placing=${!!this.placing||!!this.drawing} .planWidth=${e.width} .planHeight=${e.height} .plan=${e.planSvg} .imageUrl=${e.imageUrl} .markers=${this.markers} .selectedId=${this.selectedId}
                  ...
                  @zone-edit=${n=>{const o=this.zones.find(d=>d.id===n.detail.id);o&&this.patchZone(o,{polygon:n.detail.polygon})}}
  ...
  `;E([h()],P.prototype,"floorId",2);E([h()],P.prototype,"presetEntity",2);E([l()],P.prototype,"bundle",2);E([l()],P.prototype,"anchors",2);E([l()],P.prototype,"dirty",2);E([l()],P.prototype,"undo",2);E([l()],P.prototype,"redo",2);E([l()],P.prototype,"selectedId",2);E([l()],P.prototype,"tool",2);E([l()],P.prototype,"layers",2);E([l()],P.prototype,"placing",2);E([l()],P.prototype,"entQ",2);E([l()],P.prototype,"entResults",2);E([l()],P.prototype,"entBusy",2);E([l()],P.prototype,"busy",2);E([l()],P.prototype,"error",2);E([l()],P.prototype,"info",2);E([l()],P.prototype,"stylizing",2);E([l()],P.prototype,"stylized",2);E([l()],P.prototype,"stylizeOpts",2);E([l()],P.prototype,"zones",2);E([l()],P.prototype,"versions",2);E([l()],P.prototype,"diff",2);E([l()],P.prototype,"selectedZoneId",2);E([l()],P.prototype,"candidates",2);E([l()],P.prototype,"detecting",2);E([l()],P.prototype,"detectStrength",2);E([l()],P.prototype,"replaceAuto",2);E([l()],P.prototype,"drawing",2);E([l()],P.prototype,"showZones",2);E([l()],P.prototype,"zoneBusy",2);E([Mt("sw-plan-canvas")],P.prototype,"canvas",2);P=E([k("explore-plan-editor")],P);var No=Object.defineProperty,Bo=Object.getOwnPropertyDescriptor,ft=(e,t,s,i)=>{for(var a=i>1?void 0:i?Bo(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&No(t,s,a),a};let He=class extends y{constructor(){super(...arguments),this.columns=[],this.rows=[],this.rowKey="id",this.selected=null,this.emptyText="אין שורות להצגה",this.dense=!1}pick(e){const t=String(e[this.rowKey]??"");this.dispatchEvent(new CustomEvent("row-select",{detail:{id:t,row:e},bubbles:!0,composed:!0}))}render(){return this.rows.length?r`
      <table>
        <thead>
    ...
    `:r`<div class="empty">${this.emptyText}</div>`}};He.styles=x`
    :host {
      display: block;
      background: var(--sw-surface);
      border: 1px solid var(--sw-border);
  ...
  `;ft([h({attribute:!1})],He.prototype,"columns",2);ft([h({attribute:!1})],He.prototype,"rows",2);ft([h()],He.prototype,"rowKey",2);ft([h()],He.prototype,"selected",2);ft([h()],He.prototype,"emptyText",2);ft([h({type:Boolean,reflect:!0})],He.prototype,"dense",2);He=ft([k("sw-table")],He);var Ho=Object.defineProperty,Lo=Object.getOwnPropertyDescriptor,Me=(e,t,s,i)=>{for(var a=i>1?void 0:i?Lo(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&Ho(t,s,a),a};const os=[{id:"lock.main_door",name:"דלת כניסה",domain:"lock",area:"לובי",state:"נעול",fresh:"live",placed:!0,actions:"נעילה / פתיחה (grant נפרד)"},{id:"light.lobby",name:"תאורת לובי",domain:"light",area:"לובי",state:"דולק · 80%",fresh:"live",placed:!0,actions:"הדלקה / כיבוי / עמעום"},{id:"binary_sensor.hall_motion",name:"תנועה באולם",domain:"binary_sensor",area:"אולם",state:"ללא תנועה",fresh:"live",placed:!0,actions:"קריאה בלבד"},{id:"climate.hall",name:"מזגן אולם",domain:"climate",area:"אולם",state:"קירור · 23°",fresh:"stale",placed:!1,actions:"יעד טמפרטורה (allowlist)"},{id:"cover.parking_gate",name:"שער חניה",domain:"cover",area:"חניה",state:"סגור",fresh:"live",placed:!1,actions:"פתיחה / סגירה (רגיש)"},{id:"script.night_mode",name:"מצב לילה",domain:"script",area:"—",state:"—",fresh:"unknown",placed:!1,actions:"חסום עד allowlist"},{id:"sensor.power_main",name:"צריכת חשמל",domain:"sensor",area:"חדר מכונות",state:"4.2 kW",fresh:"live",placed:!1,actions:"קריאה בלבד"},{id:"camera.intercom_m2",name:"אינטרקום M2",domain:"camera",area:"כניסה",state:"זמין",fresh:"live",placed:!1,actions:"צפייה (provider נפרד)"}];function jo(e){return e==="lock"||e==="cover"?"lock":e==="light"||e==="switch"||e==="fan"?"light":e==="camera"?"camera":e==="climate"||e==="script"||e==="scene"||e==="button"||e==="automation"?"activity":"sensor"}let me=class extends y{constructor(){super(...arguments),this.selected=null,this.domain="all",this.q="",this.area="",this.onlyPlaced=!1,this.cat=null,this.error="",this.loading=!1,this.sync=null,this.firstFloorId=null,this.stopWs=null,this.searchTimer=0,this.columns=[{key:"name",label:"ישות",render:e=>r`<span style="display:inline-flex;align-items:center;gap:8px"><span style="display:grid;place-items:center;inline-size:26px;block-size:26px;border-radius:7px;background:var(--sw-accent-soft);color:var(--sw-accent)"><sw-icon name=${jo(String(e.domain))} size=${13}></sw-icon></span><span><strong>${String(e.name)}</strong><div class="ltr" style="font-size:var(--sw-fs-xs);color:var(--sw-text-3)">${String(e.id)}</div></span></span>`},{key:"domain",label:"Domain",ltr:!0},{key:"area",label:"אזור HA"},{key:"state",label:"מצב"},{key:"fresh",label:"רעננות",render:e=>r`<sw-badge kind=${e.fresh} label=${e.fresh==="live"||e.fresh==="neutral"?"עדכני":e.fresh==="stale"?"מיושן":e.fresh==="offline"?"לא זמין":"לא ידוע"}></sw-badge>`},{key:"placed",label:"במפה",render:e=>e.placed?r`<sw-badge kind="recorded" label="מוצב"></sw-badge>`:r`<span style="color:var(--sw-text-3)">לא</span>`}]}connectedCallback(){super.connectedCallback(),$()&&(this.load(),tt().then(e=>this.firstFloorId=Oa(e)?.id??null).catch(()=>{}),this.stopWs=Ra(e=>{if(e.type==="entity_state_changed"&&this.cat){const t=this.cat.entities.findIndex(s=>s.entity_id===e.entity.entity_id);if(t>=0){const s=[...this.cat.entities];s[t]={...s[t],...e.entity,placements:s[t].placements,actions:s[t].actions},this.cat={...this.cat,entities:s}}}else e.type==="heartbeat"?this.sync=e.sync:e.type==="ha_sync_state"&&this.sync&&(this.sync={...this.sync,connected:e.connected})}))}disconnectedCallback(){super.disconnectedCallback(),this.stopWs?.(),this.stopWs=null}async load(){this.loading=!0,this.error="";try{this.cat=await Da({domain:this.domain==="all"?void 0:this.domain,q:this.q||void 0,area:this.area||void 0,placed:this.onlyPlaced?!0:void 0,limit:800}),this.sync=this.cat.sync}catch(e){this.error=w(e)}finally{this.loading=!1}}onSearch(e){this.q=e,window.clearTimeout(this.searchTimer),this.searchTimer=window.setTimeout(()=>void this.load(),250)}toRow(e){return{id:e.entity_id,name:e.name||e.original_name||e.entity_id,domain:e.domain,area:e.area_name??"—",state:ct(e),fresh:ii(e),placed:!!e.placements?.length,actions:e.actions?.length?e.actions.map(t=>`${t.label}${t.sensitive?" (רגיש)":""}`).join(" / "):"קריאה בלבד"}}renderApiDrawer(e){const t=ii(e),s=Object.entries(e.attributes).filter(([i])=>i!=="friendly_name"&&i!=="icon").slice(0,14);return r`<sw-drawer open heading=${e.name||e.original_name||e.entity_id} subheading=${e.entity_id} @close=${()=>this.selected=null}>
    ...
    </sw-drawer>`}renderApi(){const e=this.cat,t=this.sync,s=e?e.entities.map(d=>this.toRow(d)):[],i=e?Object.entries(e.domains).sort((d,u)=>u[1]-d[1]):[],a=e?.entities.find(d=>d.entity_id===this.selected),n=i.reduce((d,[,u])=>d+u,0),o=t?`${n} ישויות בקטלוג · ${t.connected?`סנכרון פעיל · HA ${t.ha_version??""}`:`הסנכרון מנותק${t.last_error?` · ${t.last_error}`:""}`}`:"טוען את הקטלוג…";return r`
      <sw-page heading="קטלוג ישויות Home Assistant" subheading=${o}>
        ...
        <div class="filters">
          <sw-field class="search"><input type="search" placeholder="חיפוש לפי שם, entity_id או אזור" .value=${this.q} @input=${d=>this.onSearch(d.target.value)} /></sw-field>
          <sw-field><select aria-label="אזור" @change=${d=>{this.area=d.target.value,this.load()}}><option value="">כל האזורים</option>${(e?.areas??[]).map(d=>r`<option value=${d.area_id} ?selected=${d.area_id===this.area}>${d.area_name??d.area_id}</option>`)}</select></sw-field>
        ...
        <div class="filters">
          ...
          ${i.map(([d,u])=>r`<sw-chip ?selected=${d===this.domain} count=${u} @click=${()=>{this.domain=d,this.load()}}><span class="ltr">${d}</span></sw-chip>`)}
        </div>
        <div class="stage">
          ${this.error?r`<sw-state-panel state="error" hint=${this.error} actionLabel="נסה שוב" @action=${()=>this.load()}></sw-state-panel>`:e?s.length?r`<sw-table .columns=${this.columns} .rows=${s} .selected=${this.selected} @row-select=${d=>this.selected=d.detail.id}></sw-table>`:r`<sw-state-panel state="empty" heading=${n?"אין ישויות שתואמות את הסינון":"הקטלוג ריק"} hint=${n?"נקה את החיפוש או בחר domain אחר.":t?.connected?"ההסנכרון פעיל אך טרם התקבלו מצבים.":"ה־Add-on לא מחובר ל־Home Assistant. בדוק בהגדרות → גשר Home Assistant."}></sw-state-panel>`:r`<sw-state-panel state="loading"></sw-state-panel>`}
  ...
  `;Me([l()],me.prototype,"selected",2);Me([l()],me.prototype,"domain",2);Me([l()],me.prototype,"q",2);Me([l()],me.prototype,"area",2);Me([l()],me.prototype,"onlyPlaced",2);Me([l()],me.prototype,"cat",2);Me([l()],me.prototype,"error",2);Me([l()],me.prototype,"loading",2);Me([l()],me.prototype,"sync",2);Me([l()],me.prototype,"firstFloorId",2);me=Me([k("explore-entities")],me);var Vo=Object.defineProperty,Fo=Object.getOwnPropertyDescriptor,Na=(e,t,s,i)=>{for(var a=i>1?void 0:i?Fo(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&Vo(t,s,a),a};const Ls=[{id:"d1",name:"כניסה ראשית",kind:"דלת זכוכית",lock:"נעול",contact:"סגור",relay:"לא פעיל",ringing:!1,scene:"entrance"},{id:"d2",name:"לובי",kind:"דלת פנימית",lock:"פתוח",contact:"פתוח",relay:"לא פעיל",ringing:!1,scene:"lobby"},{id:"d3",name:"אינטרקום M2",kind:"עמדת דלת",lock:"נעול",contact:"סגור",relay:"לא פעיל",ringing:!0,scene:"entrance"},{id:"d4",name:"מחסן",kind:"דלת שירות",lock:"נעול",contact:"סגור",relay:"לא פעיל",ringing:!1,scene:"warehouse"}];let gs=class extends y{constructor(){super(...arguments),this.selected="d1"}render(){const e=Ls.find(t=>t.id===this.selected)??Ls[0];return r`
      <sw-page heading="דלתות ואינטרקום" subheading="V1 · מצלמה, צלצול, מגע דלת וממסר הם ארבעה נתונים שונים · נתוני הדגמה">
        ...
        <div class="layout">
          <div class="list">
            ${Ls.map(t=>r`<button class="door ${t.id===this.selected?"on":""}" @click=${()=>this.selected=t.id} aria-pressed=${t.id===this.selected}>
  ...
  `;Na([l()],gs.prototype,"selected",2);gs=Na([k("explore-access")],gs);var Wo=Object.defineProperty,Uo=Object.getOwnPropertyDescriptor,mt=(e,t,s,i)=>{for(var a=i>1?void 0:i?Uo(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&Wo(t,s,a),a};let Le=class extends y{constructor(){super(...arguments),this.label="",this.value="",this.detail="",this.icon="info",this.tone="neutral",this.badge=""}render(){return r`
  ...
  `;mt([h()],Le.prototype,"label",2);mt([h()],Le.prototype,"value",2);mt([h()],Le.prototype,"detail",2);mt([h()],Le.prototype,"icon",2);mt([h({reflect:!0})],Le.prototype,"tone",2);mt([h()],Le.prototype,"badge",2);Le=mt([k("sw-kpi")],Le);var Zo=Object.getOwnPropertyDescriptor,qo=(e,t,s,i)=>{for(var a=i>1?void 0:i?Zo(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=o(a)||a);return a};const Ko={person:"var(--sw-accent)",vehicle:"var(--sw-live)",motion:"var(--sw-danger)",line:"var(--sw-stale)",offline:"var(--sw-offline)",door:"var(--sw-purple)"},Go={"כניסה ראשית":"entrance","חצר אחורית":"backyard",מחסן:"warehouse",לובי:"lobby","חניה מקורה":"parking"};let ai=class extends y{render(){const e=F.filter(d=>d.state==="live"||d.state==="stale").length,t=Re.filter(d=>!d.acked),s=[{kind:"critical",title:"מצלמה מנותקת: מסדרון מזרחי",meta:"קומה 0 · מאז 07:55",why:"מוצג כי אין הקלטה ממצלמה זו כבר שעתיים",link:"#/system/devices"},{kind:"alert",title:`${t.length} אירועים שלא נבדקו`,meta:"אדם בכניסה הראשית 10:14, רכב בחצר 09:42",why:"מוצג כי אירועי אדם/רכב מחכים לסימון טיפול",link:"#/investigate/events"},{kind:"alert",title:"החיבור ל־Home Assistant לא רענן",meta:"סנכרון אחרון לפני 4 דק׳",why:"מוצג כי מצבי הישויות עלולים להיות מיושנים",link:"#/system/diagnostics"}],i=.68,a=34,n=2*Math.PI*a,o=F.filter(d=>d.state==="live").slice(0,2);return r`
      <sw-page heading="בוקר טוב, יוני" subheading="המערכת פועלת · גשר Home Assistant לא רענן · נתוני הדגמה">
        ...
        <div class="fav">
          ${o.map(d=>r`<sw-camera-tile name=${d.name} state=${d.state} scene=${Ae[d.id]??"lobby"} @click=${()=>b(`/live/cameras/${d.id}`)}></sw-camera-tile>`)}
        </div>
        <div class="row2">
          ...
          <sw-card heading="בריאות האתרים">
            ${Ks.map(d=>r`<div class="hrow"><span>${d.name}<div class="muted">${d.online}/${d.cameras} מצלמות · ${d.alerts} התראות</div></span><span class="status"><i style="--c:${d.health==="live"?"var(--sw-live)":d.health==="offline"?"var(--sw-danger)":"var(--sw-stale)"}"></i>${d.health==="live"?"מחובר":d.health==="offline"?"מנותק":"חלקי"}</span></div>`)}
            ${Pa.slice(0,2).map(d=>r`<div class="hrow"><span>${d.name}<div class="muted">${d.detail}</div></span><span class="status"><i style="--c:${d.state==="live"?"var(--sw-live)":"var(--sw-stale)"}"></i>${d.state==="live"?"מחובר":"לא רענן"}</span></div>`)}
          </sw-card>
        </div>
        <div class="row3">
          <sw-card heading="אירועים אחרונים">
            <a slot="actions" class="seeall" href="#/investigate/events">הצג הכל</a>
            ${Re.slice(0,5).map(d=>r`<div class="ev" @click=${()=>b("/investigate/events")}>
                ${d.type==="offline"||d.type==="door"?r`<div class="none"><sw-icon name=${d.type==="offline"?"offline":"door"} size=${14}></sw-icon></div>`:r`<sw-scene kind=${Go[d.camera]??"lobby"}></sw-scene>`}
                <div class="txt"><b style="--tone:${Ko[d.type]}"><i></i>${Gs[d.type]}</b><small>${d.camera} · ${d.floor}</small></div>
                <time>${d.time}</time>
              </div>`)}
          </sw-card>
          <sw-card heading="דורש תשומת לב" subheading="כל פריט מסביר מדוע הוא מוצג">
            ${s.map(d=>r`<div class="spot ${d.kind}">
                <div class="ic"><sw-icon name=${d.kind==="critical"?"offline":"warning"} size=${15}></sw-icon></div>
                <div><div class="t">${d.title}</div><div class="muted">${d.meta}</div><div class="why">${d.why}</div></div>
                <div class="actions"><a href=${d.link}><sw-button size="sm">פתח</sw-button></a></div>
              </div>`)}
          </sw-card>
        </div>
      </sw-page>
  ...
  `;ai=qo([k("live-overview")],ai);let us=null,ls=null;const Jo={"media.transport_default":"mse","media.max_live_sessions":8,"media.wall_profile":"sub","snapshots.max_age_s":60};async function Fe(e=!1){return $()?us&&!e?us:(ls||(ls=xa().then(t=>us=t.settings).finally(()=>ls=null)),ls):Jo}function Ki(){us=null}function _i(e){return ka()||e?.["media.transport_default"]||"mse"}var Yo=Object.defineProperty,Xo=Object.getOwnPropertyDescriptor,We=(e,t,s,i)=>{for(var a=i>1?void 0:i?Xo(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&Yo(t,s,a),a};const Qo=[1,2,4,6,8,9,12,16],Gi=[{id:"all",label:"כל המצלמות"},{id:"outside",label:"חוץ"},{id:"inside",label:"פנים"},{id:"night",label:"לילה"}];let Se=class extends y{constructor(){super(...arguments),this.cameras="",this.count=4,this.stream="auto",this.view="all",this.cams=null,this.settings=null,this.error="",this.posterBust=Date.now()}connectedCallback(){super.connectedCallback(),this.load(),this.posterTimer=window.setInterval(()=>this.posterBust=Date.now(),6e4)}disconnectedCallback(){super.disconnectedCallback(),window.clearInterval(this.posterTimer)}async load(){if($())try{const[e,t]=await Promise.all([et(),Fe()]);this.cams=e.cameras.filter(s=>s.enabled),this.settings=t}catch(e){this.error=w(e)}}renderApi(){const e=this.cams;if(this.error)return r`<sw-state-panel state="error" hint=${this.error} actionLabel="נסה שוב" @action=${()=>this.load()}></sw-state-panel>`;if(!e)return r`<sw-state-panel state="loading"></sw-state-panel>`;if(!e.length)return r`<sw-state-panel state="empty" heading="אין מצלמות זמינות" hint="המצלמות מתגלות אוטומטית מה־NVR בהפעלה ובכל 10 דקות. אם הרשימה ריקה: בדוק את פרטי ה־NVR בהגדרות ה־Add-on ואת יומן ה־Add-on, או הרץ סנכרון ידני; ייתכן גם שאין לך הרשאה למצלמות."><div style="margin-block-start:10px"><sw-button @click=${()=>b("/system/devices")}>למצלמות</sw-button></div></sw-state-panel>`;const t=this.cameras?this.cameras.split(",").filter(Boolean):[],s=t.length?e.filter(m=>t.includes(m.id)):e,i=t.length?Math.max(1,s.length):this.count,a=s.slice(0,i),n=i===1?1:i===2||i<=4?2:i<=9?3:4,o=this.settings?.["media.max_live_sessions"]??8,d=this.stream==="auto"?this.settings?.["media.wall_profile"]??"sub":this.stream,u=_i(this.settings);return r`
      <div class="grid" style="--cols:${n}">
        ${a.map((m,f)=>r`<sw-camera-tile
            ...
            profile=${d}
            transport=${u}
            poster=${m.status==="offline"?"":Zt(m.id,this.posterBust)}
            ?compact=${i>=9}
      ...
      <div class="note">${a.length} מתוך ${e.length} מצלמות · פרופיל ${d==="sub"?"משני":"ראשי"} · תעבורה ${u} · מכסת זרמים ${o}${a.length>o?" — מעבר למכסה מוצג צילום בלבד":""} · צילומים מתרעננים כל דקה</div>
    `}renderDemo(){const e=F.slice(0,this.count),t=this.count===1?1:this.count===2||this.count<=4?2:this.count<=9?3:4;return r`
      <div class="grid" style="--cols:${t}">
        ${e.map(s=>r`<sw-camera-tile name=${s.name} meta=${`${s.floor} · ${this.stream==="auto"?this.count>4?"משני":"ראשי":this.stream==="main"?"ראשי":"משני"}`} state=${s.state} scene=${Ae[s.id]??"lobby"} ?compact=${this.count>=9} @click=${()=>b(`/live/cameras/${s.id}`)}></sw-camera-tile>`)}
      </div>
    ...
    `}render(){const e=$(),t=e?this.cams?.length??0:F.length;return r`
      <sw-page heading="כל המצלמות" subheading="${t} מצלמות${e?"":` · תצוגה: ${Gi.find(s=>s.id===this.view)?.label} · נתוני הדגמה`}" wide>
        ...
        <div slot="actions" class="layouts" role="group" aria-label="פריסה">
          ${Qo.map(s=>r`<button class=${s===this.count?"on":""} @click=${()=>this.count=s} aria-pressed=${s===this.count}>${s}</button>`)}
        </div>
  ...
  `;We([h()],Se.prototype,"cameras",2);We([l()],Se.prototype,"count",2);We([l()],Se.prototype,"stream",2);We([l()],Se.prototype,"view",2);We([l()],Se.prototype,"cams",2);We([l()],Se.prototype,"settings",2);We([l()],Se.prototype,"error",2);We([l()],Se.prototype,"posterBust",2);Se=We([k("live-wall")],Se);var el=Object.defineProperty,tl=Object.getOwnPropertyDescriptor,he=(e,t,s,i)=>{for(var a=i>1?void 0:i?tl(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&el(t,s,a),a};let ie=class extends y{constructor(){super(...arguments),this.cameraId="cam-1",this.cam=null,this.cams=[],this.settings=null,this.error="",this.loading=!0,this.profile="main",this.transport="auto",this.playerStatus="",this.playerTransport="",this.posterBust=Date.now(),this.ptzMode="presets"}connectedCallback(){super.connectedCallback(),this.load()}updated(e){e.has("cameraId")&&e.get("cameraId")!==void 0&&this.load()}async load(){this.loading=!0,this.error="";try{if($()){const[e,t]=await Promise.all([et(),Fe()]);this.cams=e.cameras,this.cam=e.cameras.find(s=>s.id===this.cameraId)??null,this.settings=t,this.transport=_i(t)}}catch(e){this.error=w(e)}finally{this.loading=!1}}setTransport(e){on(e===(this.settings?.["media.transport_default"]??"mse")?"":e),this.transport=e}onPlayer(e){this.playerStatus=e.detail.status,this.playerTransport=e.detail.transport??""}renderApi(){const e=this.cam;if(this.loading)return r`<sw-state-panel state="loading"></sw-state-panel>`;if(this.error)return r`<sw-state-panel state="error" hint=${this.error} actionLabel="נסה שוב" @action=${()=>this.load()}></sw-state-panel>`;if(!e)return r`<sw-state-panel state="forbidden" heading="המצלמה לא זמינה" hint="המצלמה לא נמצאה או שאין לך הרשאת צפייה בה."></sw-state-panel>`;const t=e.can_view_live!==!1&&e.status!=="offline",s=Zt(e.id,this.posterBust),i=e.stream;return r`
      ...
      <div class="grid">
        ...
        <sw-card heading="מצלמות נוספות">
          <div class="tiles">
            ${this.cams.filter(a=>a.id!==e.id).slice(0,4).map(a=>r`<sw-camera-tile compact name=${a.name} state=${a.status==="online"?"live":a.status==="offline"?"offline":"unknown"} poster=${a.status==="offline"?"":Zt(a.id)} @click=${()=>b(`/live/cameras/${a.id}`)}></sw-camera-tile>`)}
          </div>
        </sw-card>
      </div>
    `}renderDemo(){const e=F.find(i=>i.id===this.cameraId)??F[0],t=e.state==="live"||e.state==="stale",s=Ae[e.id]??"lobby";return r`
      ...
      <div class="grid">
        ...
        <sw-card heading="מצלמות באותה קומה">
          <div class="tiles">
            ${F.filter(i=>i.floor===e.floor&&i.id!==e.id).slice(0,4).map(i=>r`<sw-camera-tile compact name=${i.name} state=${i.state} scene=${Ae[i.id]??"lobby"} @click=${()=>b(`/live/cameras/${i.id}`)}></sw-camera-tile>`)}
          </div>
        </sw-card>
      </div>
  ...
  `;he([h()],ie.prototype,"cameraId",2);he([l()],ie.prototype,"cam",2);he([l()],ie.prototype,"cams",2);he([l()],ie.prototype,"settings",2);he([l()],ie.prototype,"error",2);he([l()],ie.prototype,"loading",2);he([l()],ie.prototype,"profile",2);he([l()],ie.prototype,"transport",2);he([l()],ie.prototype,"playerStatus",2);he([l()],ie.prototype,"playerTransport",2);he([l()],ie.prototype,"posterBust",2);he([l()],ie.prototype,"ptzMode",2);he([Mt("sw-live-player")],ie.prototype,"player",2);ie=he([k("live-camera")],ie);var sl=Object.getOwnPropertyDescriptor,il=(e,t,s,i)=>{for(var a=i>1?void 0:i?sl(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=o(a)||a);return a};const al=[{name:"כל המצלמות",layout:9,scope:"משותפת",mobile:"4 · משני",owner:"יוני",kiosk:!0},{name:"חוץ",layout:4,scope:"משותפת",mobile:"2 · משני",owner:"יוני",kiosk:!1},{name:"פנים",layout:6,scope:"משותפת",mobile:"ללא",owner:"יוסי",kiosk:!1},{name:"לילה",layout:4,scope:"אישית",mobile:"4 · משני",owner:"דנה",kiosk:!1}];let ri=class extends y{render(){return r`
      <sw-page heading="תצוגות שמורות" subheading="תבניות 1 / 2 / 4 / 6 / 9 / 12 / 16 / מותאם, אישיות או משותפות, עם התאמה למובייל · נתוני הדגמה">
        ...
        <div class="grid">
          ${al.map(e=>{const t=Math.ceil(Math.sqrt(e.layout));return r`<sw-card heading=${e.name}>
              <sw-badge slot="actions" kind="neutral" label=${e.scope}></sw-badge>
              <div class="thumb" style="grid-template-columns:repeat(${t},1fr)">${F.filter(s=>s.state==="live").slice(0,e.layout).map(s=>r`<sw-scene kind=${Ae[s.id]??"lobby"}></sw-scene>`)}</div>
              <dl>
  ...
  `;ri=il([k("live-views")],ri);const Ba={ok:"תקין",warn:"לתשומת לב",error:"שגיאה"},Ji={ok:"live",warn:"stale",error:"offline"},rl=(e=!1)=>_(`health/report${e?"?fresh=1":""}`),Ha=()=>_("health/summary");function nl(e){return e<3600?`${Math.floor(e/60)} דק׳`:e<86400?`${Math.floor(e/3600)} שע׳ ${Math.floor(e%3600/60)} דק׳`:`${Math.floor(e/86400)} ימים ${Math.floor(e%86400/3600)} שע׳`}var ol=Object.defineProperty,ll=Object.getOwnPropertyDescriptor,it=(e,t,s,i)=>{for(var a=i>1?void 0:i?ll(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&ol(t,s,a),a};function Yi(){const e=bs().params,t=Math.min(4,Math.max(1,Number(e.get("cols")??3)||3));return{cameras:(e.get("cameras")??"").split(",").map(s=>s.trim()).filter(Boolean),cols:t,rotate:Math.max(0,Number(e.get("rotate")??0)||0)}}let Ee=class extends y{constructor(){super(...arguments),this.cams=null,this.settings=null,this.clock="",this.page=0,this.health=null,this.disconnected=!1,this.view=Yi(),this.failures=0,this.onHash=()=>{this.view=Yi(),this.page=0,this.startRotation()}}connectedCallback(){super.connectedCallback(),this.tick(),this.timer=window.setInterval(()=>this.tick(),1e3),this.unsubscribe=Ea(e=>{e.mode==="api"&&this.cams===null?this.load():e.mode!=="loading"&&this.requestUpdate()}),window.addEventListener("hashchange",this.onHash),this.startRotation(),this.pollHealth(),this.healthTimer=window.setInterval(()=>void this.pollHealth(),15e3)}disconnectedCallback(){super.disconnectedCallback(),window.clearInterval(this.timer),window.clearInterval(this.rotateTimer),window.clearInterval(this.healthTimer),window.removeEventListener("hashchange",this.onHash),this.unsubscribe?.()}startRotation(){window.clearInterval(this.rotateTimer),this.view.rotate>0&&(this.rotateTimer=window.setInterval(()=>this.page=this.page+1,this.view.rotate*1e3))}async pollHealth(){if($())try{this.health=await Ha(),(this.disconnected||this.failures>=3)&&this.load(),this.failures=0,this.disconnected=!1}catch{this.failures+=1,this.failures>=3&&(this.disconnected=!0)}}get pageSize(){return this.view.cols*this.view.cols}get selected(){const e=(this.cams??[]).filter(t=>this.view.cameras.length===0||this.view.cameras.includes(t.id));return this.view.cameras.length?this.view.cameras.map(t=>e.find(s=>s.id===t)).filter(t=>!!t):e}get pages(){return Math.max(1,Math.ceil(this.selected.length/this.pageSize))}tick(){const e=new Date;this.clock=`${e.toLocaleDateString("he-IL",{weekday:"long",day:"2-digit",month:"2-digit",year:"numeric"})} · ${e.toLocaleTimeString("he-IL")}`}async load(){if($())try{const[e,t]=await Promise.all([et(),Fe()]);this.cams=e.cameras.filter(s=>s.enabled),this.settings=t}catch{this.cams=[]}}render(){const t=$(),s=this.page%this.pages,i=t?this.selected.slice(s*this.pageSize,(s+1)*this.pageSize):[],a=F.filter(d=>d.state!=="forbidden").slice(0,9),n=t?i.filter(d=>d.status==="online").length:7,o=this.settings?.["media.max_live_sessions"]??8;return r`
      <header>
        ...
        ${t&&this.health?r`<span class="pill" data-kiosk-health data-status=${this.health.status}>מערכת: ${Ba[this.health.status]}${this.health.items.filter(d=>d.status!=="ok").length?` · ${this.health.items.filter(d=>d.status!=="ok").map(d=>d.label).join(", ")}`:""}</span>`:c}
      ...
      <div class="grid" style=${`--cols:${t?this.view.cols:3}`}>
        ${t?i.map((d,u)=>r`<sw-camera-tile dark data-kiosk-tile name=${d.name} state=${this.disconnected?"unknown":d.status==="online"?"live":d.status==="offline"?"offline":"unknown"} ?live=${!this.disconnected&&d.status!=="offline"&&u<o} cameraId=${d.id} profile="sub" transport=${_i(this.settings)} poster=${d.status==="offline"?"":Zt(d.id)} noDemo></sw-camera-tile>`):a.map(d=>r`<sw-camera-tile dark name=${d.name} state=${d.state} scene=${Ae[d.id]??"lobby"} noDemo></sw-camera-tile>`)}
      </div>
      <div class="stats">
        ...
        <div class="stat"><div class="ic red"><sw-icon name="warning" size=${16}></sw-icon></div><div><b>${t?i.filter(d=>d.status==="offline").length:3}</b><span>${t?"מצלמות מנותקות":"התראות פתוחות"}</span></div></div>
  ...
  `;it([l()],Ee.prototype,"cams",2);it([l()],Ee.prototype,"settings",2);it([l()],Ee.prototype,"clock",2);it([l()],Ee.prototype,"page",2);it([l()],Ee.prototype,"health",2);it([l()],Ee.prototype,"disconnected",2);it([l()],Ee.prototype,"view",2);Ee=it([k("kiosk-wall")],Ee);var dl=Object.defineProperty,cl=Object.getOwnPropertyDescriptor,Ie=(e,t,s,i)=>{for(var a=i>1?void 0:i?cl(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&dl(t,s,a),a};const ds=[{label:"יום",minutes:1440},{label:"6 שע׳",minutes:360},{label:"שעה",minutes:60},{label:"10 דק׳",minutes:10},{label:"דקה",minutes:1}];function ni(e){return String(e).padStart(2,"0")}function _e(e){const t=(e%1440+1440)%1440;return`${ni(Math.floor(t/60))}:${ni(Math.floor(t%60))}`}function De(e){const t=(e%1440+1440)%1440,s=Math.min(59,Math.round(t%1*60));return`${_e(t)}:${ni(s)}`}const pl={motion:"#ef4444",person:"#2f6bff",vehicle:"#22c55e",line:"#f59e0b",offline:"#6b7280",door:"#8b5cf6"};let we=class extends y{constructor(){super(...arguments),this.segments=[],this.events=[],this.cursor=615,this.windowMinutes=360,this.precision="estimated",this.follow=!0,this.limit=1440,this.hover=null,this.lastHoverBucket=-1,this.viewStart=-1,this.dragging=!1}get start(){const e=Math.max(0,1440-this.windowMinutes);return this.viewStart>=0&&!this.follow?Math.max(0,Math.min(e,this.viewStart)):Math.max(0,Math.min(e,this.cursor-this.windowMinutes/2))}get step(){return this.windowMinutes>=360?1:this.windowMinutes>=60?1/6:1/60}snap(e){const t=this.step;return Math.max(0,Math.min(this.limit,Math.round(e/t)*t))}x(e,t){return(e-this.start)/this.windowMinutes*t}minuteAt(e){const t=e.currentTarget.getBoundingClientRect();return this.start+(e.clientX-t.left)/t.width*this.windowMinutes}onMove(e){const t=this.minuteAt(e);if(this.hover=t,!this.dragging){const s=Math.floor(t*6);if(s!==this.lastHoverBucket){this.lastHoverBucket=s;const i=e.currentTarget.getBoundingClientRect();this.dispatchEvent(new CustomEvent("hover",{detail:{minute:t,x:e.clientX-i.left,width:i.width},bubbles:!0,composed:!0}))}}if(this.dragging){const s=this.snap(t);this.cursor=s,this.dispatchEvent(new CustomEvent("scrub",{detail:{minute:s},bubbles:!0,composed:!0}))}}onDown(e){e.button===0&&(e.currentTarget.setPointerCapture(e.pointerId),this.dragging=!0,this.viewStart=this.start,this.follow=!1)}onUp(e){if(!this.dragging)return;this.dragging=!1;const t=this.snap(this.minuteAt(e));this.cursor=t,this.follow=!0,this.dispatchEvent(new CustomEvent("seek",{detail:{minute:t},bubbles:!0,composed:!0}))}onWheel(e){e.preventDefault();const t=ds.findIndex(i=>i.minutes===this.windowMinutes),s=Math.max(0,Math.min(ds.length-1,t+(e.deltaY>0?-1:1)));s!==t&&this.setWindow(ds[s].minutes,this.minuteAt(e))}setWindow(e,t=this.cursor){const s=Math.max(0,Math.min(1,(t-this.start)/this.windowMinutes));this.windowMinutes=e,this.viewStart=t-s*e,this.follow=!1,this.dispatchEvent(new CustomEvent("window-change",{detail:{minutes:e},bubbles:!0,composed:!0}))}buckets(e){const t=[],s=this.windowMinutes/e;for(let i=0;i<e;i++){const a=this.start+i*s,n=a+s;let o=0;for(const d of this.segments)d.endMin>a&&d.startMin<n&&(o=Math.max(o,d.kind==="motion"?2:1));o&&this.events.some(d=>d.minute>=a-s&&d.minute<=n+s)&&(o=3),t.push(o)}return t}tickEvery(){const e=this.windowMinutes;return e<=1?10/60:e<=10?1:e<=60?10:e<=360?60:180}label(e){return this.windowMinutes<=10?De(e):_e(e)}render(){const n=this.tickEvery(),o=[];for(let M=Math.ceil(this.start/n-1e-9)*n;M<=this.start+this.windowMinutes+1e-9;M+=n)o.push(M);const d=[0,12,26,36],u={verified:"זמן מאומת",keyframe_limited:"דיוק לפי keyframe",estimated:"זמן משוער",unknown:"דיוק לא ידוע"}[this.precision],m=this.x(this.cursor,1e3),f=this.label(this.cursor),g=f.length>5?62:48,S=this.limit<this.start+this.windowMinutes?Math.max(0,this.x(this.limit,1e3)):null;return r`
      <div class="bar">
        <span class="precision">${u} · לחיצה או גרירה = seek · גלגלת = זום</span>
        <div class="windows">
          ${ds.map(M=>r`<button class=${M.minutes===this.windowMinutes?"on":""} @click=${()=>this.setWindow(M.minutes)}>${M.label}</button>`)}
        </div>
      </div>
      <svg
        ...
        ${S!==null?p`<rect x=${S} y="14" width=${Math.max(0,1e3-S)} height=${44} fill="var(--sw-surface-3)" opacity="0.7" />`:c}
        ${this.buckets(160).map((M,K)=>{if(!M)return c;const xe=d[M];return p`<rect x=${K*6.25+1} y=${58-xe} width=${Math.max(2,6.25-2)} height=${xe} rx="1.5" fill="var(--sw-accent)" opacity=${M===1?.45:M===2?.8:1} />`})}
        ${o.map(M=>p`<line x1=${this.x(M,1e3)} x2=${this.x(M,1e3)} y1=${58} y2=${63} stroke="var(--sw-border-strong)" /><text x=${this.x(M,1e3)} y=${78} font-size="10.5" text-anchor="middle" fill="var(--sw-text-3)" font-family="var(--sw-font)">${this.label(M)}</text>`)}
        ${this.events.map(M=>{const K=this.x(M.minute,1e3);return K<0||K>1e3?c:p`<g><circle cx=${K} cy=${58-d[3]-8} r="3.5" fill=${pl[M.kind]} /><title>${M.label} · ${_e(M.minute)}</title></g>`})}
        ...
        ${m>=-60&&m<=1060?p`<g transform="translate(${m} 0)">
  ...
  `;Ie([h({attribute:!1})],we.prototype,"segments",2);Ie([h({attribute:!1})],we.prototype,"events",2);Ie([h({type:Number})],we.prototype,"cursor",2);Ie([h({type:Number})],we.prototype,"windowMinutes",2);Ie([h()],we.prototype,"precision",2);Ie([h({type:Boolean})],we.prototype,"follow",2);Ie([h({type:Number})],we.prototype,"limit",2);Ie([l()],we.prototype,"hover",2);Ie([l()],we.prototype,"viewStart",2);Ie([l()],we.prototype,"dragging",2);we=Ie([k("sw-timeline")],we);const Lt={open:"פתוח",in_review:"בבדיקה",closed:"סגור"},hl={preserved:"עותק שמור",preserving:"מעתיק מה־NVR…",nvr_only:"סימנייה ל־NVR בלבד",missing:"חסר: ה־NVR כבר לא מחזיק את הקטע",unknown:"לא נבדק מול ה־NVR",none:""};function La(e={}){const t=new URLSearchParams;e.status&&t.set("status",e.status),e.q&&t.set("q",e.q);const s=t.toString();return _(`cases${s?`?${s}`:""}`)}const ja=e=>z("cases",e),ul=(e,t=!0)=>_(`cases/${e}${t?"":"?check=false"}`),fl=(e,t)=>Ve(`cases/${e}`,t),ml=e=>be(`cases/${e}`),oi=(e,t)=>z(`cases/${e}/items`,t),wl=(e,t)=>be(`cases/${e}/items/${t}`),vl=(e,t)=>z(`cases/${e}/items/${t}/preserve`),Xi=e=>e.toISOString().replace(/\.\d{3}Z$/,"Z"),Va=(e,t=15,s=45)=>({from_at:Xi(new Date(e.getTime()-t*1e3)),to_at:Xi(new Date(e.getTime()+s*1e3))}),bl=e=>z(`cases/${e}/bundle`),gl=e=>_(`cases/${e}/bundles`),yl=(e,t)=>ve(`cases/${e}/bundles/${t}`),$l=(e,t)=>ve(`cases/${e}/items/${t}/file`);function xl(e){const t=new FormData;return t.append("file",e,e.name),xi("cases/bundles/verify",t)}var kl=Object.defineProperty,_l=Object.getOwnPropertyDescriptor,$e=(e,t,s,i)=>{for(var a=i>1?void 0:i?_l(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&kl(t,s,a),a};let le=class extends y{constructor(){super(...arguments),this.item=null,this.subheading="",this.cases=[],this.loading=!1,this.error="",this.picked="",this.newTitle="",this.note="",this.busy=!1,this.done=null,this.canManage=!0}updated(e){e.has("item")&&this.item&&this.load()}async load(){this.loading=!0,this.error="",this.done=null,this.note="";try{const e=await La({status:"open"});this.cases=e.cases,this.canManage=e.can_manage,this.picked=e.cases[0]?.id??"new"}catch(e){this.error=w(e)}finally{this.loading=!1}}close(){this.item=null,this.dispatchEvent(new CustomEvent("close",{bubbles:!0,composed:!0}))}async confirm(){const e=this.item;if(e){this.busy=!0,this.error="";try{let t=this.picked,s=this.cases.find(a=>a.id===t)?.title??"";if(t==="new"){if(!this.newTitle.trim()){this.error="תן שם לתיק החדש.";return}const a=await ja({title:this.newTitle.trim()});t=a.id,s=a.title}const i=await oi(t,{...e,note:this.note.trim()||e.note});this.done={id:t,title:s},this.dispatchEvent(new CustomEvent("added",{detail:{caseId:t,item:i},bubbles:!0,composed:!0}))}catch(t){this.error=w(t)}finally{this.busy=!1}}}render(){const e=this.item;if(!e)return c;const t=e.kind==="event"?"האירוע":e.kind==="clip"?"הקטע":"ההערה";return r`<sw-dialog open heading="הוסף לתיק" subheading=${this.subheading} data-case-picker @close=${()=>this.close()}>
  ...
  `;$e([h({attribute:!1})],le.prototype,"item",2);$e([h()],le.prototype,"subheading",2);$e([l()],le.prototype,"cases",2);$e([l()],le.prototype,"loading",2);$e([l()],le.prototype,"error",2);$e([l()],le.prototype,"picked",2);$e([l()],le.prototype,"newTitle",2);$e([l()],le.prototype,"note",2);$e([l()],le.prototype,"busy",2);$e([l()],le.prototype,"done",2);$e([l()],le.prototype,"canManage",2);le=$e([k("sw-case-picker")],le);const Fa=(e,t)=>_(`cameras/${e}/recordings?date=${t}`),zi=(e,t)=>z("playback/sessions",{camera_id:e,start_at:t}),zl=(e,t)=>z(`playback/sessions/${e}/seek`,{start_at:t}),Jt=e=>be(`playback/sessions/${e}`);function ys(e){const t=new URL(ve(`playback/sessions/${e.id}/ws?generation=${e.generation}`));return t.protocol=t.protocol==="https:"?"wss:":"ws:",t.toString()}function Be(e,t){const s=new Intl.DateTimeFormat("en-CA",{timeZone:t,year:"numeric",month:"2-digit",day:"2-digit"}).formatToParts(e),i=a=>s.find(n=>n.type===a)?.value??"";return`${i("year")}-${i("month")}-${i("day")}`}function re(e,t){const s=new Intl.DateTimeFormat("en-GB",{timeZone:t,hour:"2-digit",minute:"2-digit",second:"2-digit",hourCycle:"h23"}).formatToParts(e),i=a=>Number(s.find(n=>n.type===a)?.value??0);return i("hour")*60+i("minute")+i("second")/60}function Oe(e,t,s){const[i,a,n]=e.split("-").map(Number),o=Date.UTC(i,a-1,n,Math.floor(t/60),Math.floor(t%60),Math.round(t%1*60)),d=m=>{const f=new Intl.DateTimeFormat("en-US",{timeZone:s,hour12:!1,year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit",second:"2-digit"}).formatToParts(new Date(m)),g=M=>Number(f.find(K=>K.type===M)?.value??0);return Date.UTC(g("year"),g("month")-1,g("day"),g("hour")%24,g("minute"),g("second"))-m};let u=o-d(o);return u=o-d(u),new Date(u)}const Sl=(e,t)=>z("playback/groups",{camera_ids:e,start_at:t}),Ml=(e,t)=>z(`playback/groups/${e}/seek`,{start_at:t}),Il=e=>be(`playback/groups/${e}`),Si=(e,t)=>ve(`cameras/${e}/frame?at=${encodeURIComponent(t)}`),Wa=(e,t,s)=>({camera_id:e,from_at:t,to_at:s}),Al=(e,t,s)=>z("exports/estimate",Wa(e,t,s)),Pl=(e,t,s)=>z("exports",Wa(e,t,s)),El=()=>_("exports"),Cl=e=>z(`exports/${e}/cancel`),Tl=e=>be(`exports/${e}`),Ua=e=>ve(`exports/${e}/download`),Ol=e=>ve(`exports/${e}/manifest`);function vt(e){return e==null?"—":e<1024*1024?`${Math.round(e/1024)} KB`:e<1024*1024*1024?`${(e/1024/1024).toFixed(1)} MB`:`${(e/1024/1024/1024).toFixed(2)} GB`}function Mi(e={}){const t=new URLSearchParams;e.date&&t.set("date",e.date),e.from&&e.to&&(t.set("from",e.from),t.set("to",e.to)),e.acked&&t.set("acked","true"),e.cameraId&&t.set("camera_id",e.cameraId),e.type&&t.set("type",e.type),e.unacked&&t.set("unacked","true"),e.limit&&t.set("limit",String(e.limit)),e.floorId&&t.set("floor_id",e.floorId),e.zoneId&&t.set("zone_id",e.zoneId),e.buildingId&&t.set("building_id",e.buildingId),e.siteId&&t.set("site_id",e.siteId),e.source&&t.set("source",e.source),e.severity&&t.set("severity",e.severity);const s=t.toString();return _(`events${s?`?${s}`:""}`)}const Dl=(e,t)=>_(`cameras/${e}/events?date=${t}`),Za=e=>z(`events/${e}/ack`),Rl=e=>z("events/ack-many",{event_ids:e});function Nl(e={}){const t=new URLSearchParams;e.date&&t.set("date",e.date),e.cameraId&&t.set("camera_id",e.cameraId),e.gap&&t.set("gap",String(e.gap)),e.limit&&t.set("limit",String(e.limit));const s=t.toString();return _(`events/windows${s?`?${s}`:""}`)}const Bl=e=>_(`events/${e}`),bt=(e,t=0)=>ve(`events/${e}/thumbnail${t?`?v=${t}`:""}`);async function qa(e){try{const t=await fetch(bt(e),{credentials:"include",cache:"no-store"});return t.status===200?"ready":t.status===202?"pending":"unavailable"}catch{return"pending"}}const Z={motion:"תנועה",person:"אדם",vehicle:"רכב",line:"חציית קו",field:"חדירה לאזור",offline:"אובדן וידאו",tamper:"חבלה במצלמה",door:"דלת",io:"כניסת חיווי",storage:"אחסון",system:"מערכת",coverage_gap:"פער בקליטת אירועים",manual:"הקלטה ידנית",other:"אחר"},js={motion:"#ef4444",person:"#2f6bff",vehicle:"#22c55e",line:"#f59e0b",field:"#f59e0b",offline:"#6b7280",tamper:"#b45309",door:"#8b5cf6",io:"#8b5cf6",storage:"#6b7280",system:"#6b7280",coverage_gap:"#6b7280",manual:"#2f6bff",other:"#6b7280"};function Hl(e){return e==="person"||e==="vehicle"||e==="motion"||e==="line"||e==="offline"||e==="door"?e:e==="field"?"line":e==="io"?"door":e==="tamper"||e==="coverage_gap"||e==="storage"||e==="system"?"offline":"motion"}function Ll(e,t){let s=null,i=!1,a=2e3;const n=(()=>{const d=new URL(ve("events/ws"));return d.protocol=d.protocol==="https:"?"wss:":"ws:",d.toString()})(),o=()=>{if(!i){try{s=new WebSocket(n)}catch{return}s.onopen=()=>{a=2e3,t?.(null,!0)},s.onmessage=d=>{try{const u=JSON.parse(d.data);u.type==="event_added"||u.type==="event_updated"?e(u.payload):u.type==="heartbeat"&&t?.(u.payload.ingest,!0)}catch{}},s.onclose=()=>{t?.(null,!1),i||(window.setTimeout(o,a),a=Math.min(3e4,a*2))}}};return o(),()=>{i=!0,s?.close()}}const jl={measured:"נמדד",inferred:"נגזר",command:"פקודה",availability:"זמינות"},Vl=(e,t=120)=>_(`events/${e}/correlation?window=${t}`),Fl=(e=90)=>_(`events/facets?days=${e}`),Qi={alertstream:"אירוע NVR",recording:"נגזר מהקלטה",system:"מערכת",ha:"חיישן HA"},Wl=(e,t=90)=>_(`events/${e}/route?window=${t}`);var Ul=Object.defineProperty,Zl=Object.getOwnPropertyDescriptor,A=(e,t,s,i)=>{for(var a=i>1?void 0:i?Zl(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&Ul(t,s,a),a};const Ot=["closed","expired","failed"];function Dt(e){return De(Math.max(0,Math.min(1439.983,e)))}function Vs(e){const[t=0,s=0,i=0]=e.split(":").map(Number);return t*60+s+i/60}let I=class extends y{constructor(){super(...arguments),this.cameraId="",this.at="",this.extraParam="",this.demoCamera="cam-10",this.cursor=615,this.generation=3,this.playing=!0,this.speed=1,this.filter="all",this.cams=null,this.tz="Asia/Jerusalem",this.date="",this.rec=null,this.dayEvents=[],this.loadingRec=!1,this.session=null,this.group=null,this.extra=[],this.casePick=null,this.preview=null,this.previewTimer=0,this.busy=!1,this.error="",this.notice="",this.tileStatus={},this.drifts={},this.paused=!1,this.scrubbing=!1,this.position=null,this.exportOpen=!1,this.exportFrom="",this.exportTo="",this.estimate=null,this.exportJob=null,this.exportBusy=!1,this.exportError="",this.onTlHover=e=>{if(!this.cameraId||!$())return;window.clearTimeout(this.previewTimer);const t=e.detail;this.previewTimer=window.setTimeout(()=>{const s=Oe(this.date,t.minute,this.tz).toISOString().replace(/\.\d{3}Z$/,"Z");this.preview={minute:t.minute,x:t.x,width:t.width,url:Si(this.cameraId,s),failed:!1}},250)},this.onTlHoverEnd=()=>{window.clearTimeout(this.previewTimer),this.preview=null}}connectedCallback(){super.connectedCallback(),$()&&(this.init(),this.ticker=window.setInterval(()=>this.tick(),500))}disconnectedCallback(){super.disconnectedCallback(),window.clearInterval(this.ticker),this.endSession()}updated(e){$()&&e.has("cameraId")&&e.get("cameraId")!==void 0&&this.cams&&this.selectCamera(this.cameraId,!0)}get members(){return[this.cameraId,...this.extra.filter(e=>e!==this.cameraId)]}get groupMode(){return this.extra.filter(e=>e!==this.cameraId).length>0}get masterSession(){return this.groupMode?this.group?.sessions.find(e=>e.camera_id===this.cameraId)??this.group?.sessions[0]??null:this.session}get live(){const e=this.masterSession;return!!e&&!Ot.includes(e.state)&&(this.groupMode?!!this.group:!0)}async init(){try{const[e,t]=await Promise.all([Fe(),et()]);this.tz=e["time.zone"]??"Asia/Jerusalem",this.cams=t.cameras.filter(n=>n.enabled);const s=this.cams.find(n=>n.id===this.cameraId)??this.cams[0],i=this.at?new Date(this.at):null,a=!!i&&!Number.isNaN(i.getTime());if(this.date=Be(a?i:new Date,this.tz),s)if(this.cameraId=s.id,this.extraParam&&(this.extra=this.extraParam.split(",").filter(n=>n&&n!==s.id&&this.cams.some(o=>o.id===n)).slice(0,3)),await this.loadRecordings(),a)this.cursor=re(i,this.tz),await this.startAt(i);else{const n=this.rec?.segments.at(-1);this.cursor=n?Math.max(0,re(new Date(n.end_at),this.tz)-5):Math.max(0,re(new Date,this.tz)-5)}}catch(e){this.error=w(e)}}async selectCamera(e,t=!1){!e||!t&&e===this.cameraId||(await this.endSession(),this.cameraId=e,this.extra=this.extra.filter(s=>s!==e),this.error="",this.notice="",await this.loadRecordings())}async setDate(e){if(!e||e===this.date)return;await this.endSession(),this.date=e,await this.loadRecordings();const t=this.rec?.segments.at(-1);this.cursor=t?Math.max(0,re(new Date(t.end_at),this.tz)-5):540}async loadRecordings(){if(!(!this.cameraId||!this.date)){this.loadingRec=!0,this.rec=null;try{const[e,t]=await Promise.all([Fa(this.cameraId,this.date),Dl(this.cameraId,this.date).catch(()=>({events:[]}))]);this.rec=e,this.dayEvents=t.events,this.error=""}catch(e){this.error=w(e)}finally{this.loadingRec=!1}}}get markers(){return this.dayEvents.map(e=>({minute:re(new Date(e.occurred_at),this.tz),kind:Hl(e.type),label:`${Z[e.type]??e.type}${e.confidence==="inferred"?" (מהקלטה)":""}${e.count>1?` ×${e.count}`:""}`}))}get segmentsMin(){return this.rec?this.rec.segments.map(e=>{const t=re(new Date(e.start_at),this.tz);let s=re(new Date(e.end_at),this.tz);return s<t&&(s=1440),{startMin:t,endMin:s,kind:e.kind==="continuous"?"continuous":"motion"}}):[]}inRecording(e){return this.segmentsMin.some(t=>e>=t.startMin&&e<=t.endMin)}get limitMinute(){return this.date===Be(new Date,this.tz)?re(new Date,this.tz):1440}cameraName(e){return this.cams?.find(t=>t.id===e)?.name??e}async startAt(e){if(!(!this.cameraId||this.busy)){this.busy=!0,this.error="",this.notice="",this.scrubbing=!1;try{const t=e.toISOString().replace(/\.\d{3}Z$/,"Z");if(this.groupMode){const s=this.group&&this.group.sessions.some(a=>!Ot.includes(a.state))?await Ml(this.group.id,t):await Sl(this.members,t);this.group=s,this.session=null,this.position=new Date(s.requested_at);const i=Object.keys(s.missing);i.length&&(this.notice=`ללא הקלטה בזמן הזה: ${i.map(a=>this.cameraName(a)).join(", ")}`)}else{const s=this.session&&!Ot.includes(this.session.state)?await zl(this.session.id,t):await zi(this.cameraId,t);this.session=s,this.group=null,this.position=new Date(s.requested_at),s.moved_to_next_segment&&(this.notice=`אין הקלטה בזמן שנבחר; הניגון התחיל בקטע הבא (${this.fmt(new Date(s.requested_at))}).`)}this.cursor=re(this.position,this.tz),this.paused=!1,this.tileStatus={},this.drifts={}}catch(t){if(t instanceof fe&&t.body.code==="no_recording")this.notice="אין הקלטה בזמן הזה ובשש השעות שאחריו: פער בכיסוי, לא מדלגים ל־Live.",this.position=e;else if(t instanceof fe&&(t.body.code==="session_over"||t.body.code==="not_found")){this.session=null,this.group=null,this.busy=!1,await this.startAt(e);return}else this.error=w(t)}finally{this.busy=!1}}}async endSession(){const e=this.session,t=this.group;this.session=null,this.group=null,this.tileStatus={},this.drifts={};try{t?await Il(t.id):e&&!Ot.includes(e.state)&&await Jt(e.id)}catch{}}async toggleExtra(e){const t=this.extra.includes(e)?this.extra.filter(i=>i!==e):[...this.extra,e].slice(-3),s=this.currentInstant();await this.endSession(),this.extra=t,s&&await this.startAt(s)}players(){return Array.from(this.renderRoot.querySelectorAll("sw-live-player"))}masterPlayer(){return this.players().find(e=>e.dataset.camera===this.cameraId)??this.players()[0]}currentInstant(){const e=this.masterSession;if(!e)return this.position;const t=new Date(e.requested_at).getTime();return new Date(t+(this.masterPlayer()?.mediaTime??0)*1e3)}tick(){if(!this.masterSession||this.paused||this.scrubbing)return;const t=this.masterPlayer();if(!t||t.status!=="playing")return;const s=this.currentInstant();if(s&&(this.position=s,this.cursor=re(s,this.tz)),this.groupMode&&this.group){const i={};for(const a of this.players()){const n=a.dataset.camera??"",o=this.group.sessions.find(u=>u.camera_id===n);if(!o||n===this.cameraId)continue;const d=new Date(o.requested_at).getTime()+a.mediaTime*1e3;i[n]=a.status==="playing"&&s?(d-s.getTime())/1e3:NaN}this.drifts=i}}async onSeek(e){const t=e.detail.minute,s=Oe(this.date,t,this.tz);if(s.getTime()>Date.now()){this.notice="לא ניתן לנגן זמן עתידי.",this.scrubbing=!1;return}this.cursor=t,await this.startAt(s)}onScrub(e){this.scrubbing=!0,this.cursor=e.detail.minute,this.position=Oe(this.date,e.detail.minute,this.tz)}async nudge(e){const t=this.currentInstant();t&&await this.startAt(new Date(t.getTime()+e*1e3))}togglePause(){const e=this.players();e.length&&(this.paused?e.forEach(t=>t.resume()):e.forEach(t=>t.pause()),this.paused=!this.paused)}onTilePlayer(e,t){if(this.tileStatus={...this.tileStatus,[e]:t.detail.status},e===this.cameraId&&(this.masterSession&&t.detail.status==="playing"&&this.session&&(this.session={...this.session,state:"playing"}),t.detail.status==="ended")){const s=this.currentInstant(),i=this.masterSession;s&&i&&new Date(i.playback_end_at).getTime()-s.getTime()<5e3&&this.startAt(new Date(new Date(i.playback_end_at).getTime()+1e3))}}fmt(e){return new Intl.DateTimeFormat("he-IL",{timeZone:this.tz,hour:"2-digit",minute:"2-digit",second:"2-digit",hourCycle:"h23"}).format(e)}openExport(){const e=Math.floor(this.cursor*60)/60;this.exportFrom=Dt(Math.max(0,e-1)),this.exportTo=Dt(Math.min(this.limitMinute,e+1)),this.estimate=null,this.exportJob=null,this.exportError="",this.exportOpen=!0}exportRange(){const e=Oe(this.date,Vs(this.exportFrom),this.tz),t=Oe(this.date,Vs(this.exportTo),this.tz);return t.getTime()<=e.getTime()?(this.exportError="זמן הסיום חייב להיות אחרי ההתחלה.",null):[e.toISOString().replace(/\.\d{3}Z$/,"Z"),t.toISOString().replace(/\.\d{3}Z$/,"Z")]}async runEstimate(){const e=this.exportRange();if(e){this.exportBusy=!0,this.exportError="";try{this.estimate=await Al(this.cameraId,e[0],e[1])}catch(t){this.exportError=w(t)}finally{this.exportBusy=!1}}}async runExport(){const e=this.exportRange();if(e){this.exportBusy=!0,this.exportError="";try{this.exportJob=await Pl(this.cameraId,e[0],e[1])}catch(t){this.exportError=w(t)}finally{this.exportBusy=!1}}}renderExportDialog(){const e=this.estimate,t=this.exportJob;return r`<sw-dialog ?open=${this.exportOpen} heading="ייצוא קטע" subheading=${`${this.cameraName(this.cameraId)} · ${this.date} · ${this.tz}`} @close=${()=>this.exportOpen=!1}>
      <div class="dlg">
      ...
      <div class="filters">
        ...
        ${this.error?r`<span class="err">${this.error}</span>`:c}
        <span class="grow"></span>
        <sw-button size="sm" icon="case" data-add-to-case ?disabled=${!this.cameraId} @click=${()=>this.casePick={kind:"clip",camera_id:this.cameraId,...Va(Oe(this.date,this.cursor,this.tz))}}>הוסף לתיק</sw-button>
    ...
    `}seekDemo(e){this.cursor=e.detail.minute,this.generation+=1}renderDemo(){const e=F.find(i=>i.id===this.demoCamera)??F[0],t=!vs.some(i=>this.cursor>=i.startMin&&this.cursor<=i.endMin),s=Re.filter(i=>i.minuteOfDay<1440).filter(i=>this.filter==="all"||i.type===this.filter).map(i=>({minute:i.minuteOfDay,kind:i.type,label:i.title}));return r`
      <div class="video ${t?"gap":""}">
        ${t?r`<div class="center"><div><sw-icon name="offline" size=${32}></sw-icon><span>אין הקלטה בזמן הזה: פער בכיסוי, לא מדלגים ל־Live</span></div></div>`:r`<sw-scene kind=${Ae[e.id]??"lobby"}></sw-scene><div class="shade"></div><span class="demo">דמו · אין שרת מחובר</span>`}
    ...
    `}render(){const e=$(),t=e?this.cams?.find(o=>o.id===this.cameraId):F.find(o=>o.id===this.demoCamera)??F[0],s=t?.name??"הקלטות",i=e?`${this.date} ${Dt(this.cursor)} · אזור זמן ${this.tz}`:`14.09.2026 ${_e(this.cursor)} · אזור זמן האתר Asia/Jerusalem · נתוני הדגמה`,a=e?"הקלטות":`הקלטות | ${t?.floor??""}`,n=e?Be(new Date,this.tz):"2026-09-14";return r`
      <sw-page heading=${s} subheading=${i} crumbs=${a} wide>
        <div slot="actions" class="pick">
          ...
          <sw-field style="inline-size:110px"><input type="time" step="1" .value=${e?Dt(this.cursor):_e(this.cursor)} data-ltr aria-label="שעה" @change=${o=>{const d=o.target.value;if(e)this.onSeek(new CustomEvent("seek",{detail:{minute:Vs(d)}}));else{const[u,m]=d.split(":").map(Number);this.cursor=u*60+m,this.generation+=1}}} /></sw-field>
        </div>
  ...
  `;A([h()],I.prototype,"cameraId",2);A([h()],I.prototype,"at",2);A([h()],I.prototype,"extraParam",2);A([l()],I.prototype,"demoCamera",2);A([l()],I.prototype,"cursor",2);A([l()],I.prototype,"generation",2);A([l()],I.prototype,"playing",2);A([l()],I.prototype,"speed",2);A([l()],I.prototype,"filter",2);A([l()],I.prototype,"cams",2);A([l()],I.prototype,"tz",2);A([l()],I.prototype,"date",2);A([l()],I.prototype,"rec",2);A([l()],I.prototype,"dayEvents",2);A([l()],I.prototype,"loadingRec",2);A([l()],I.prototype,"session",2);A([l()],I.prototype,"group",2);A([l()],I.prototype,"extra",2);A([l()],I.prototype,"casePick",2);A([l()],I.prototype,"preview",2);A([l()],I.prototype,"busy",2);A([l()],I.prototype,"error",2);A([l()],I.prototype,"notice",2);A([l()],I.prototype,"tileStatus",2);A([l()],I.prototype,"drifts",2);A([l()],I.prototype,"paused",2);A([l()],I.prototype,"scrubbing",2);A([l()],I.prototype,"position",2);A([l()],I.prototype,"exportOpen",2);A([l()],I.prototype,"exportFrom",2);A([l()],I.prototype,"exportTo",2);A([l()],I.prototype,"estimate",2);A([l()],I.prototype,"exportJob",2);A([l()],I.prototype,"exportBusy",2);A([l()],I.prototype,"exportError",2);I=A([k("investigate-playback")],I);var ql=Object.defineProperty,Kl=Object.getOwnPropertyDescriptor,Ii=(e,t,s,i)=>{for(var a=i>1?void 0:i?Kl(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&ql(t,s,a),a};let Yt=class extends y{constructor(){super(...arguments),this.cursor=615,this.playing=!1}render(){const e=[{cam:F[0],drift:"+0.2s",state:"recorded"},{cam:F[9],drift:"-0.4s",state:"recorded"},{cam:F[3],drift:"gap",state:"unknown"},{cam:F[1],drift:"buffering",state:"stale"}];return r`
      <sw-page heading="מרכז שליטה" subheading="ניטור חי עם ניגון מסונכרן · 4 מקורות · שעון ייחוס אחד · נתוני הדגמה" wide>
        ...
        <div class="grid">
          ${e.map(t=>r`<div class="tile">
              ...
              <sw-camera-tile name=${t.cam.name} state=${t.state} scene=${Ae[t.cam.id]??"lobby"}></sw-camera-tile>
            </div>`)}
        </div>
        <div class="transport">
  ...
  `;Ii([l()],Yt.prototype,"cursor",2);Ii([l()],Yt.prototype,"playing",2);Yt=Ii([k("investigate-sync")],Yt);var Gl=Object.defineProperty,Jl=Object.getOwnPropertyDescriptor,ee=(e,t,s,i)=>{for(var a=i>1?void 0:i?Jl(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&Gl(t,s,a),a};const Fs=10;function Yl(e){return e==="person"||e==="vehicle"||e==="motion"||e==="line"||e==="offline"||e==="door"?e:"motion"}let q=class extends y{constructor(){super(...arguments),this.floorId="f0",this.at="",this.camera="",this.minute=615,this.tz="Asia/Jerusalem",this.date="",this.tree=null,this.bundle=null,this.events=[],this.recordings=new Map,this.selectedId=null,this.loading=!1,this.error="",this.frameAt="",this.frameFailed=!1,this.casePick=null,this.frameTimer=0}connectedCallback(){super.connectedCallback(),$()&&this.init()}updated(e){$()&&(e.has("floorId")&&e.get("floorId")!==void 0||e.has("at")&&e.get("at")!==void 0)&&this.init()}async init(){this.loading=!0,this.error="";try{const[e,t]=await Promise.all([Fe(),this.tree?Promise.resolve(this.tree):tt()]);this.tz=e["time.zone"]??this.tz,this.tree=t;const s=this.at?new Date(this.at):new Date;if(this.date=Be(s,this.tz),this.minute=re(s,this.tz),this.bundle=await qt(this.floorId,!1,this.instant.toISOString().replace(/\.\d{3}Z$/,"Z")),this.scheduleFrame(),this.camera){const i=this.bundle.anchors.find(a=>a.resource_type==="camera"&&a.resource_id===this.camera);this.selectedId=i?.id??null}await this.loadDay()}catch(e){this.error=w(e)}finally{this.loading=!1}}async loadDay(){const e=this.bundle;if(!e)return;const t=e.anchors.filter(n=>n.resource_type==="camera").map(n=>n.resource_id),[s,i]=await Promise.all([Mi({date:this.date,limit:1e3}).then(n=>n.events.filter(o=>o.camera_id&&t.includes(o.camera_id))).catch(()=>[]),Promise.allSettled(t.map(n=>Fa(n,this.date)))]);this.events=s;const a=new Map;t.forEach((n,o)=>{const d=i[o];a.set(n,d.status==="fulfilled"?d.value:null)}),this.recordings=a}get instant(){return Oe(this.date,this.minute,this.tz)}segmentsFor(e){const t=this.recordings.get(e);return t?t.segments.map(s=>{const i=re(new Date(s.start_at),this.tz);let a=re(new Date(s.end_at),this.tz);return a<i&&(a=1440),{startMin:i,endMin:a,kind:s.kind==="continuous"?"continuous":"motion"}}):null}coverageAt(e){const t=this.segmentsFor(e);if(!t)return{state:"unknown"};const s=t.find(i=>this.minute>=i.startMin&&this.minute<=i.endMin);return s?{state:"historic",segment:s}:{state:"unknown"}}eventsNear(e,t=Fs){const s=this.instant.getTime();return this.events.filter(i=>(!e||i.camera_id===e)&&Math.abs(new Date(i.occurred_at).getTime()-s)<=t*60*1e3).sort((i,a)=>Math.abs(new Date(i.occurred_at).getTime()-s)-Math.abs(new Date(a.occurred_at).getTime()-s))}get apiMarkers(){const e=this.bundle;return e?e.anchors.map(t=>{if(t.resource_type==="camera"){const a=this.coverageAt(t.resource_id),n=this.eventsNear(t.resource_id,5).length,o=t.camera?.name??t.label??t.resource_id;return{id:t.id,kind:"camera",label:n?`${o} · ${n} אירועים`:o,x:t.position.x,y:t.position.y,rotation:t.rotation_degrees,fov:t.field_of_view_degrees??void 0,state:a.state}}const s=t.entity?.state_at,i=t.entity?.name??t.label??t.resource_id;return{id:t.id,kind:Es(t.layer_id,t.entity?.domain),label:s?.known&&s.state?`${i} · ${ct({...t.entity??{domain:"",unit:null,device_class:null,attributes:{}},state:s.state})}`:i,x:t.position.x,y:t.position.y,state:s?.known?"historic":"unknown"}}):[]}get selectedAnchor(){return this.bundle?.anchors.find(e=>e.id===this.selectedId)??null}get limitMinute(){return this.date===Be(new Date,this.tz)?re(new Date,this.tz):1440}setMinute(e){this.minute=Math.max(0,Math.min(this.limitMinute,e)),this.scheduleFrame()}scheduleFrame(){window.clearTimeout(this.frameTimer),this.frameTimer=window.setTimeout(()=>{this.frameAt=this.instant.toISOString().replace(/\.\d{3}Z$/,"Z"),this.frameFailed=!1,this.ensureVersion()},600)}async ensureVersion(){const e=this.bundle;if(!e||e.source!=="api"||!e.at)return;const t=this.instant.toISOString().replace(/\.\d{3}Z$/,"Z");if(!(e.history==="current"?!e.historyFrom||t<e.historyFrom:(!e.planPublishedAt||e.planPublishedAt<=t)&&(!e.planArchivedAt||t<e.planArchivedAt)))try{const i=await qt(this.floorId,!1,t),a=e.anchors.map(n=>n.resource_id).sort().join(",");this.bundle=i,this.selectedId&&!i.anchors.some(n=>n.id===this.selectedId)&&(this.selectedId=null),i.anchors.map(n=>n.resource_id).sort().join(",")!==a&&await this.loadDay()}catch{}}renderEntityStates(e){const t=e.anchors.filter(a=>a.resource_type==="ha_entity");if(!t.length)return r`אין ישויות מוצבות בקומה`;const s=t.filter(a=>a.entity?.state_at?.known),i=e.haHistory;return r`${s.length} מתוך ${t.length} ידועות בזמן זה${i?.from?r` <span class="note">(היסטוריה מקומית מ־<span class="ltr">${this.fmtWhen(i.from)}</span>, ${i.retention_days} ימים)</span>`:r` <span class="note">(אין עדיין היסטוריה מקומית)</span>`}
      ...
      <sw-card heading="בנקודת הזמן שנבחרה" subheading="זמן ונתונים מאותו רגע" data-history-panel>
        ...
        <div style="display:flex;gap:8px;flex-wrap:wrap;margin-block-start:10px">
          ...
          <sw-button size="sm" icon="case" data-add-to-case ?disabled=${!s} title=${s?"קטע של המצלמה הנבחרת סביב הזמן שנבחר (15 שניות לפני, 45 אחרי)":"בחר מצלמה במפה"} @click=${()=>{s&&(this.casePick={kind:"clip",camera_id:s.resource_id,...Va(this.instant)})}}>הוסף לתיק</sw-button>
        </div>
      </sw-card>
      ...
      <div class="head">
        ...
        <span class="grow"></span>
        ${this.floors.length>1?r`<sw-field><select aria-label="קומה" @change=${a=>b(`/investigate/floors/${a.target.value}`,{t:this.instant.toISOString()})}>${this.floors.map(a=>r`<option value=${a.id} ?selected=${a.id===this.floorId}>${a.name}</option>`)}</select></sw-field>`:c}
    ...
    `}get demoMarkers(){const e=i=>i==="cam-3"||this.minute>=190&&this.minute<=205?"unknown":"historic",t=Bt.filter(i=>i.floorId===this.floorId).map(i=>({id:i.id,kind:"camera",label:i.name,x:i.x,y:i.y,rotation:i.rotation,fov:i.fov,state:i.state==="forbidden"?"forbidden":e(i.id)})),s=hs.filter(i=>i.floorId===this.floorId).map((i,a)=>({id:i.id,kind:i.domain,label:i.name,x:i.x,y:i.y,state:a%2?"unknown":"historic"}));return[...t,...s]}renderDemo(){const e=Ye.find(t=>t.id===this.floorId)??Ye[0];return r`
      <div class="head">
      ...
      <div class="stage alone">
        <sw-plan-canvas .planWidth=${e.planWidth} .planHeight=${e.planHeight} .plan=${za(e.id)} .markers=${this.demoMarkers}></sw-plan-canvas>
        <div class="legend"><span>כחול = יש הקלטה בזמן זה</span><span>מקווקו = לא ידוע / פער</span><span>ישות: מצב ידוע אחרון</span></div>
      </div>
    `}render(){return $()?this.renderApi():this.renderDemo()}};q.styles=x`
    :host {
      display: flex;
      flex-direction: column;
      min-block-size: 100%;
  ...
  `;ee([h()],q.prototype,"floorId",2);ee([h()],q.prototype,"at",2);ee([h()],q.prototype,"camera",2);ee([l()],q.prototype,"minute",2);ee([l()],q.prototype,"tz",2);ee([l()],q.prototype,"date",2);ee([l()],q.prototype,"tree",2);ee([l()],q.prototype,"bundle",2);ee([l()],q.prototype,"events",2);ee([l()],q.prototype,"recordings",2);ee([l()],q.prototype,"selectedId",2);ee([l()],q.prototype,"loading",2);ee([l()],q.prototype,"error",2);ee([l()],q.prototype,"frameAt",2);ee([l()],q.prototype,"frameFailed",2);ee([l()],q.prototype,"casePick",2);q=ee([k("investigate-history-map")],q);var Xl=Object.defineProperty,Ql=Object.getOwnPropertyDescriptor,L=(e,t,s,i)=>{for(var a=i>1?void 0:i?Ql(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&Xl(t,s,a),a};const ed={person:"#2f6bff",vehicle:"#22c55e",motion:"#ef4444",line:"#f59e0b",offline:"#6b7280",door:"#8b5cf6"},ea={"כניסה ראשית":"entrance","חצר אחורית":"backyard",מחסן:"warehouse",לובי:"lobby","חניה מקורה":"parking","מסדרון מזרחי":"corridor"},td={info:"מידע",alert:"התראה",critical:"קריטי"};let R=class extends y{constructor(){super(...arguments),this.cameraId="",this.date="",this.selected=null,this.filter="all",this.cams=null,this.tz="Asia/Jerusalem",this.type="",this.events=null,this.ingest=null,this.live=!1,this.error="",this.busy=!1,this.thumbVersion=new Map,this.player=null,this.mode="raw",this.windows=null,this.windowGap=180,this.selectedWindow=null,this.windowsBusy=!1,this.facets=null,this.placeFloor="",this.placeZone="",this.source="",this.unsupported=[],this.thumbTimers=new Map,this.thumbInFlight=0,this.windowColumns=[{key:"thumb",label:"",width:"72px",render:e=>this.renderWindowThumb(e)},{key:"title",label:"חלון אירוע",render:e=>{const t=e;return r`<span class="ty" style="--tone:${js[t.dominant_type]??"#6b7280"}"><i></i>${Z[t.dominant_type]??t.dominant_type}${t.count>1?r` <span class="sub">×${String(t.count)}</span>`:c}</span><div class="sub">${Object.entries(t.types).map(([s,i])=>`${Z[s]??s} ${i}`).join(" · ")} · ${t.confidence==="inferred"?"נגזר מהקלטה":"התראות מה־NVR"}</div>`}},{key:"camera_name",label:"מצלמה",render:e=>{const t=e;return r`${t.camera_name??(t.channel?`ערוץ ${t.channel}`:"מערכת")}`}},{key:"start",label:"זמן",render:e=>{const t=e;return r`${this.fmt(t.start)}${t.end!==t.start?r` – ${this.fmt(t.end)}`:c}<div class="sub">${this.fmtDate(t.start)}</div>`}},{key:"acked",label:"מצב",render:e=>{const t=e;return r`<sw-badge kind=${t.acked?"live":t.acked_count?"stale":"neutral"} label=${t.acked?"טופל":t.acked_count?`בטיפול ${t.acked_count}/${t.count}`:"חדש"}></sw-badge>`}}],this.apiColumns=[{key:"thumb",label:"",width:"72px",render:e=>this.renderThumb(e)},{key:"type",label:"אירוע",render:e=>r`<span class="ty" style="--tone:${js[e.type]??"#6b7280"}"><i></i>${Z[e.type]??String(e.type)}${Number(e.count)>1?r` <span class="sub">×${String(e.count)}</span>`:c}</span><div class="sub">${e.confidence==="inferred"?"נגזר מהקלטה":"התראה מה־NVR"} · ${e.acked_at?`טופל · ${String(e.acked_by_username??"")}`:"ממתין לטיפול"}</div>`},{key:"camera_name",label:"מצלמה",render:e=>r`${String(e.camera_name??(e.channel?`ערוץ ${String(e.channel)}`:"מערכת"))}<div class="sub ltr">${String(e.raw_type)}</div>`},{key:"occurred_at",label:"זמן",render:e=>r`${this.fmt(String(e.occurred_at))}<div class="sub">${this.fmtDate(String(e.occurred_at))}${e.ended_at?` · עד ${this.fmt(String(e.ended_at))}`:""}</div>`},{key:"severity",label:"חומרה",render:e=>r`<sw-badge kind=${e.severity==="critical"?"error":e.severity==="alert"?"stale":"neutral"} label=${td[e.severity]??String(e.severity)}></sw-badge>`}],this.columns=[{key:"thumb",label:"תמונה",width:"80px",render:e=>e.type==="offline"||e.type==="door"?r`<div class="thumb none"><sw-icon name=${e.type==="offline"?"offline":"door"} size=${14}></sw-icon></div>`:r`<sw-scene class="thumb" kind=${ea[String(e.camera)]??"lobby"}></sw-scene>`},{key:"title",label:"אירוע",render:e=>r`<span class="ty" style="--tone:${ed[e.type]}"><i></i>${Gs[e.type]}</span><div class="sub">${String(e.title)} · ${e.acked?"טופל":"ממתין לטיפול"}</div>`},{key:"camera",label:"מצלמה",render:e=>r`${String(e.camera)}<div class="sub">${String(e.floor)}</div>`},{key:"time",label:"זמן",render:e=>r`${String(e.time)}<div class="sub ltr">${String(e.source)}</div>`},{key:"severity",label:"חומרה",render:e=>r`<sw-badge kind=${e.severity==="critical"?"error":e.severity==="alert"?"stale":"neutral"} label=${{info:"מידע",alert:"התראה",critical:"קריטי"}[e.severity]}></sw-badge>`},{key:"more",label:"",width:"40px",render:()=>r`<sw-button variant="ghost" size="sm" iconOnly icon="more" label="עוד"></sw-button>`}]}connectedCallback(){super.connectedCallback(),$()&&(this.init(),this.unsubscribe=Ll(e=>this.onPushed(e),(e,t)=>{this.live=t,e&&(this.ingest=e)}))}disconnectedCallback(){super.disconnectedCallback(),this.unsubscribe?.();for(const e of this.thumbTimers.values())window.clearTimeout(e);this.thumbTimers.clear(),this.stopPlayer()}renderThumb(e){const t="inline-size:64px;block-size:40px;border-radius:6px;overflow:hidden;background:var(--sw-surface-3);display:grid;place-items:center;color:var(--sw-text-3)";return e.thumbnail==="ready"?r`<img class="thumb" src=${bt(e.id,this.thumbVersion.get(e.id)??0)} alt="" loading="lazy" style="inline-size:64px;block-size:40px;object-fit:cover;border-radius:6px;display:block;background:var(--sw-surface-3)" />`:(e.thumbnail==="pending"||e.thumbnail==="none")&&e.camera_id?(this.schedulePoll(e.id,3e3,0),r`<div class="thumb pending" style=${t} title="מכין תמונה מההקלטה…"><sw-icon name="camera" size=${14} style="opacity:.45"></sw-icon></div>`):r`<div class="thumb none" style=${t}><sw-icon name=${e.type==="offline"||e.type==="coverage_gap"?"offline":e.type==="person"?"user":e.type==="vehicle"?"route":e.type==="door"||e.type==="io"?"door":"bell"} size=${14}></sw-icon></div>`}schedulePoll(e,t,s){this.thumbTimers.has(e)||this.thumbTimers.set(e,window.setTimeout(()=>void this.poll(e,s),t))}cancelPoll(e){const t=this.thumbTimers.get(e);t!==void 0&&window.clearTimeout(t),this.thumbTimers.delete(e)}async poll(e,t){if(this.thumbTimers.delete(e),!this.isConnected||!this.events?.some(i=>i.id===e))return;if(this.thumbInFlight>=2){this.schedulePoll(e,1500,t);return}this.thumbInFlight++;let s;try{s=await qa(e)}finally{this.thumbInFlight--}if(s==="pending"){t<14&&this.schedulePoll(e,Math.min(15e3,3e3*1.35**t),t+1);return}this.setThumb(e,s)}setThumb(e,t){t==="ready"&&(this.thumbVersion=new Map(this.thumbVersion).set(e,Date.now())),this.events=(this.events??[]).map(s=>s.id===e?{...s,thumbnail:t}:s)}select(e){e!==this.player?.eventId&&this.stopPlayer(),this.selected=e}closeDrawer(){this.select(null)}async play(e){if(this.player?.eventId===e.id){await this.stopPlayer();return}if(await this.stopPlayer(),!!e.camera_id){this.player={eventId:e.id,session:null,error:""};try{const t=new Date(new Date(e.occurred_at).getTime()-2e3).toISOString().replace(/\.\d{3}Z$/,"Z"),s=await zi(e.camera_id,t);this.player?.eventId===e.id?this.player={eventId:e.id,session:s,error:""}:await Jt(s.id).catch(()=>{})}catch(t){this.player={eventId:e.id,session:null,error:w(t)}}}}async stopPlayer(){const e=this.player;this.player=null,e?.session&&await Jt(e.session.id).catch(()=>{})}async init(){try{try{localStorage.getItem("sw.events.mode")==="windows"&&(this.mode="windows")}catch{}const[e,t]=await Promise.all([Fe(),et()]);this.tz=e["time.zone"]??"Asia/Jerusalem",this.cams=t.cameras,this.loadFacets(),this.date||(this.date=Be(new Date,this.tz)),await this.load()}catch(e){this.error=w(e)}}async loadFacets(){try{this.facets=await Fl()}catch{this.facets=null}}get facetFloors(){const e=this.facets;return e?e.places.flatMap(t=>t.buildings.flatMap(s=>s.floors.map(i=>({...i,name:`${s.name} · ${i.name}`})))):[]}renderFacets(){const e=this.facets;if(!e)return c;const t=e.types.map(a=>`${Z[a.type]??a.type} (${a.count})`).join(" · "),s=e.sources.map(a=>`${Qi[a.source]??a.source} (${a.count})`).join(" · "),i=e.unavailable_types.filter(a=>["person","vehicle","line","field","door"].includes(a.type));return r`<div class="sub" data-facets style="margin:-4px 0 8px;line-height:1.6">
      ...
      <div class="wlist" data-window-events>
        ${t.map(s=>r`<a class="wrow" href=${`#/investigate/events/${s.id}`}><span class="ty" style="--tone:${js[s.type]??"#6b7280"}"><i></i>${Z[s.type]??s.type}</span><span class="ltr">${this.fmt(s.occurred_at)}</span><span class="sub">${s.acked_at?"טופל":"ממתין"}</span></a>`)}
      ...
      <div class="filters">
        ...
        <sw-field><select aria-label="סוג" @change=${i=>{this.type=i.target.value,this.load()}}><option value="" ?selected=${!this.type}>כל סוגי האירועים</option>${Object.keys(Z).map(i=>r`<option value=${i} ?selected=${i===this.type}>${Z[i]}</option>`)}</select></sw-field>
        ...
        <sw-field><select aria-label="מקור" data-filter-source @change=${i=>{this.source=i.target.value,this.load()}}><option value="" ?selected=${!this.source}>כל המקורות</option>${Object.entries(Qi).map(([i,a])=>r`<option value=${i} ?selected=${i===this.source}>${a}</option>`)}</select></sw-field>
        <span class="grow"></span>
    ...
    `}renderDemo(){const e=Re.filter(s=>this.filter==="all"||!s.acked),t=Re.find(s=>s.id===this.selected);return r`
      ...
      <div class="stage">
        ...
        ${t?r`<sw-drawer open heading=${Gs[t.type]} subheading=${`${t.camera} · ${t.time}`} @close=${()=>this.selected=null}>
              <div class="preview">${t.type==="offline"||t.type==="door"?"אין תמונה לאירוע זה":r`<sw-scene kind=${ea[t.camera]??"lobby"}></sw-scene><span class="demo">דמו · תמונת אירוע מה־NVR (T044)</span>`}</div>
              <dl>
  ...
  `;L([h()],R.prototype,"cameraId",2);L([h()],R.prototype,"date",2);L([l()],R.prototype,"selected",2);L([l()],R.prototype,"filter",2);L([l()],R.prototype,"cams",2);L([l()],R.prototype,"tz",2);L([l()],R.prototype,"type",2);L([l()],R.prototype,"events",2);L([l()],R.prototype,"ingest",2);L([l()],R.prototype,"live",2);L([l()],R.prototype,"error",2);L([l()],R.prototype,"busy",2);L([l()],R.prototype,"thumbVersion",2);L([l()],R.prototype,"player",2);L([l()],R.prototype,"mode",2);L([l()],R.prototype,"windows",2);L([l()],R.prototype,"windowGap",2);L([l()],R.prototype,"selectedWindow",2);L([l()],R.prototype,"windowsBusy",2);L([l()],R.prototype,"facets",2);L([l()],R.prototype,"placeFloor",2);L([l()],R.prototype,"placeZone",2);L([l()],R.prototype,"source",2);L([l()],R.prototype,"unsupported",2);R=L([k("investigate-events")],R);var sd=Object.defineProperty,id=Object.getOwnPropertyDescriptor,oe=(e,t,s,i)=>{for(var a=i>1?void 0:i?id(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&sd(t,s,a),a};const ad={measured:"recorded",inferred:"unknown",command:"partial",availability:"stale"},ta={alertstream:"אירוע NVR",recording:"נגזר מהקלטה",system:"מערכת",ha:"חיישן HA"},sa=600*1e3;let Q=class extends y{constructor(){super(...arguments),this.eventId="",this.ev=null,this.error="",this.tz="Asia/Jerusalem",this.session=null,this.playerError="",this.bundle=null,this.nearby=[],this.corr=null,this.corrError="",this.route=null,this.busy=!1,this.thumbVersion=0,this.casePick=null,this.pollTimer=0}connectedCallback(){super.connectedCallback(),this.load()}disconnectedCallback(){super.disconnectedCallback(),window.clearTimeout(this.pollTimer),this.stopPlayer()}updated(e){e.has("eventId")&&e.get("eventId")!==void 0&&this.load()}async load(){if($()){this.error="",await this.stopPlayer();try{const e=await Bl(this.eventId);this.ev=e,this.tz=e.timezone||this.tz,e.location?.has_plan?this.loadMap(e.location.floor_id):this.bundle=null,this.loadNearby(e),this.loadCorrelation(e.id),this.loadRoute(e.id),e.camera_id&&this.play(e),e.thumbnail==="pending"&&this.pollThumb(e.id)}catch(e){this.error=w(e),this.ev=null}}}async loadRoute(e){this.route=null;try{this.route=await Wl(e)}catch{this.route=null}}renderRoute(){const e=this.route;return!e||!e.spatial?c:r`<sw-card heading="המשך מסלול מוצע" subheading="השערה לפי טופולוגיית המפה · ±${Math.round((new Date(e.window.to).getTime()-new Date(e.window.from).getTime())/1e3)} שניות" style="margin-block-start:12px" data-route>
    ...
    </sw-card>`}async loadCorrelation(e){this.corr=null,this.corrError="";try{this.corr=await Vl(e)}catch(t){this.corrError=w(t)}}async loadMap(e){try{this.bundle=await qt(e)}catch{this.bundle=null}}async loadNearby(e){try{const t=new Date(e.occurred_at).getTime(),s=a=>new Date(a).toISOString().replace(/\.\d{3}Z$/,"Z"),i=await Mi({from:s(t-sa),to:s(t+sa),limit:30});this.nearby=i.events.filter(a=>a.id!==e.id).slice(0,6)}catch{this.nearby=[]}}pollThumb(e){window.clearTimeout(this.pollTimer),this.pollTimer=window.setTimeout(async()=>{const t=await qa(e).catch(()=>"unavailable");this.ev?.id===e&&(t==="pending"?this.pollThumb(e):(this.ev={...this.ev,thumbnail:t},t==="ready"&&(this.thumbVersion=Date.now())))},1500)}async play(e){if(e.camera_id){this.playerError="";try{const t=new Date(new Date(e.occurred_at).getTime()-2e3).toISOString().replace(/\.\d{3}Z$/,"Z"),s=await zi(e.camera_id,t);this.ev?.id===e.id?this.session=s:await Jt(s.id).catch(()=>{})}catch(t){this.playerError=w(t)}}}async stopPlayer(){const e=this.session;this.session=null,e&&await Jt(e.id).catch(()=>{})}async ack(){const e=this.ev;if(!(!e||e.acked_at)){this.busy=!0;try{const t=await Za(e.id);this.ev={...e,acked_at:t.acked_at,acked_by_username:t.acked_by_username}}catch(t){this.error=w(t)}finally{this.busy=!1}}}fmt(e,t=!1){const s=new Date(e),i=new Intl.DateTimeFormat("he-IL",{timeZone:this.tz,hour:"2-digit",minute:"2-digit",second:"2-digit",hourCycle:"h23"}).format(s);return t?`${new Intl.DateTimeFormat("he-IL",{timeZone:this.tz,day:"2-digit",month:"2-digit",year:"numeric"}).format(s)} · ${i}`:i}renderCorrelation(){const e=this.corr,t=e?`±${e.window_s} שניות · ${e.spatial?`סביבת ${e.location?.zone??"המיקום על התוכנית"} (${e.location?.floor_name??""})`:"לפי זמן בלבד"}`:this.corrError?"לא נטען":"טוען…";return r`<sw-card heading="קורלציה דלת–מצלמה–חיישן" subheading=${t} style="margin-block-start:12px" data-correlation>
      ${e?r`${e.entities.length?r`<div class="note" style="margin:0 0 6px" data-correlation-entities>בסביבה: ${e.entities.map(s=>`${s.name}${s.state_missing?" (ללא מצב)":s.state?` · ${s.state}`:""}`).join(" · ")}</div>`:r`<div class="note" style="margin:0 0 6px" data-correlation-entities>אין חיישנים או מנעולים מוצבים בסביבה.</div>`}
            ${e.links.length?r`<div class="corr" data-correlation-links>${e.links.map(s=>r`<div class="link" data-correlation-link data-certainty=${s.certainty}>
                    ...
                    <sw-badge kind=${ad[s.certainty]} label=${jl[s.certainty]}></sw-badge>
        ...
        <div class="layout">
          <div>
            <div class="player" data-player>
              ${this.session?r`<sw-live-player .wsUrl=${ys(this.session)} mode="mse" .retry=${!1}></sw-live-player>`:e.thumbnail==="ready"?r`<img src=${bt(e.id,this.thumbVersion)} alt="תמונת האירוע מההקלטה" />`:r`<div class="hint">${e.camera_id?this.playerError?`ההקלטה לא נפתחה: ${this.playerError}`:e.thumbnail==="unavailable"?"אין הקלטה זמינה בזמן האירוע":"פותח את ההקלטה…":"אירוע ללא מצלמה — אין וידאו"}</div>`}
          ...
          <div>
            <sw-card heading="הקשר האירוע" data-context>
              <dl class="meta">
                ...
                <dt>מקור</dt><dd>${ta[e.source]??e.source}${e.camera_id?r` / ${s}`:c} <span class="note" style="margin:0">raw <span class="ltr">${e.raw_type}</span></span></dd>
            ...
            <sw-card heading="אירועים קרובים" subheading="±10 דקות סביב האירוע" style="margin-block-start:12px">
              ${this.nearby.length?r`<div class="nearby">${this.nearby.map(o=>r`<a href=${`#/investigate/events/${o.id}`}><span>${Z[o.type]??o.type} · ${o.camera_name??(o.channel?`ערוץ ${o.channel}`:"מערכת")}</span><span class="ltr">${this.fmt(o.occurred_at)}</span></a>`)}</div>`:r`<div class="note" style="margin:0">אין אירועים נוספים בחלון הזה.</div>`}
            </sw-card>
          </div>
        </div>
  ...
  `;oe([h()],Q.prototype,"eventId",2);oe([l()],Q.prototype,"ev",2);oe([l()],Q.prototype,"error",2);oe([l()],Q.prototype,"tz",2);oe([l()],Q.prototype,"session",2);oe([l()],Q.prototype,"playerError",2);oe([l()],Q.prototype,"bundle",2);oe([l()],Q.prototype,"nearby",2);oe([l()],Q.prototype,"corr",2);oe([l()],Q.prototype,"corrError",2);oe([l()],Q.prototype,"route",2);oe([l()],Q.prototype,"busy",2);oe([l()],Q.prototype,"thumbVersion",2);oe([l()],Q.prototype,"casePick",2);Q=oe([k("investigate-event-detail")],Q);var rd=Object.getOwnPropertyDescriptor,nd=(e,t,s,i)=>{for(var a=i>1?void 0:i?rd(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=o(a)||a);return a};const od=[{id:"rv-1",title:"כניסה ראשית · 10:12–10:16",primary:"כניסה ראשית",scene:"entrance",related:["לובי"],events:3,severity:"alert",status:"חדש"},{id:"rv-2",title:"חצר אחורית · 09:40–09:44",primary:"חצר אחורית",scene:"backyard",related:[],events:2,severity:"info",status:"בבדיקה"},{id:"rv-3",title:"חניה מקורה · 06:41–06:45",primary:"חניה מקורה",scene:"parking",related:["כניסה ראשית"],events:1,severity:"alert",status:"טופל"},{id:"rv-4",title:"לובי · אתמול 23:08–23:12",primary:"לובי",scene:"lobby",related:[],events:4,severity:"info",status:"false positive"}];let li=class extends y{render(){return r`
  ...
  `;li=nd([k("investigate-reviews")],li);var ld=Object.defineProperty,dd=Object.getOwnPropertyDescriptor,O=(e,t,s,i)=>{for(var a=i>1?void 0:i?dd(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&ld(t,s,a),a};const cd={open:"stale",in_review:"recorded",closed:"neutral"},pd={preserved:"recorded",preserving:"partial",nvr_only:"stale",missing:"error",unknown:"unknown",none:"neutral"},hd=(e,t)=>new Intl.DateTimeFormat("he-IL",{timeZone:t,dateStyle:"short",timeStyle:"short"}).format(new Date(e)),ud=[{key:"title",label:"תיק",render:e=>r`<strong>${String(e.title)}</strong>${e.tags?r`<div style="font-size:11px;color:var(--sw-text-3)">${String(e.tags)}</div>`:c}`},{key:"status",label:"סטטוס",render:e=>r`<sw-badge kind=${cd[e.status]} label=${Lt[e.status]}></sw-badge>`},{key:"owner",label:"בעלים"},{key:"items",label:"פריטים"},{key:"preserved",label:"עותקים שמורים",render:e=>r`${String(e.preserved)} מתוך ${String(e.clips)}`},{key:"updated",label:"עודכן",ltr:!0,render:e=>hd(String(e.updated))}],fd=[{key:"title",label:"תיק",render:e=>r`<strong>${String(e.title)}</strong>`},{key:"status",label:"סטטוס",render:e=>r`<sw-badge kind=${e.status==="פתוח"?"stale":e.status==="סגור"?"neutral":"recorded"} label=${String(e.status)}></sw-badge>`},{key:"owner",label:"בעלים"},{key:"clips",label:"קטעים"},{key:"notes",label:"הערות"},{key:"preserved",label:"ראיות שמורות",render:e=>r`${e.preserved} שמורות${Number(e.missing)?r` · <span style="color:var(--sw-danger)">${e.missing} חסרות</span>`:""}`},{key:"more",label:"",width:"40px",render:()=>r`<sw-button variant="ghost" size="sm" iconOnly icon="more" label="עוד"></sw-button>`}];let de=class extends y{constructor(){super(...arguments),this.cases=[],this.canManage=!1,this.loading=!1,this.error="",this.status="all",this.q="",this.creating=!1,this.newTitle="",this.newDesc="",this.newTags="",this.busy=!1,this.qTimer=0}connectedCallback(){super.connectedCallback(),$()&&this.load()}async load(){this.loading=!0,this.error="";try{const e=await La({status:this.status==="all"?void 0:this.status,q:this.q||void 0});this.cases=e.cases,this.canManage=e.can_manage}catch(e){this.error=w(e)}finally{this.loading=!1}}setStatus(e){this.status=e,this.load()}onQuery(e){this.q=e,window.clearTimeout(this.qTimer),this.qTimer=window.setTimeout(()=>void this.load(),250)}async create(){if(this.newTitle.trim()){this.busy=!0,this.error="";try{const e=await ja({title:this.newTitle.trim(),description:this.newDesc,tags:this.newTags.split(",").map(t=>t.trim()).filter(Boolean)});this.creating=!1,this.newTitle=this.newDesc=this.newTags="",b(`/investigate/cases/${e.id}`)}catch(e){this.error=w(e)}finally{this.busy=!1}}}renderApi(){const e=this.cases.map(t=>({id:t.id,title:t.title,status:t.status,owner:t.owner_username,items:t.counts.items,clips:t.counts.events+t.counts.clips,preserved:t.counts.preserved,updated:t.updated_at,tags:t.tags.join(" · ")}));return r`
      <sw-page heading="תיקים" subheading="קישור להקלטה אינו שימור: ראיה נחשבת שמורה רק אחרי העתקה מאומתת מה־NVR">
        ...
        <div class="bar">
          ${["all","open","in_review","closed"].map(t=>r`<sw-chip ?selected=${this.status===t} @click=${()=>this.setStatus(t)}>${t==="all"?"הכל":Lt[t]}</sw-chip>`)}
          <span class="grow"></span>
        ...
        ${this.error?r`<div class="err">${this.error}</div>`:c}
        ${this.loading&&!this.cases.length?r`<sw-state-panel state="loading"></sw-state-panel>`:this.cases.length?r`<sw-table data-cases-table .columns=${ud} .rows=${e} @row-select=${t=>b(`/investigate/cases/${t.detail.id}`)}></sw-table>`:r`<sw-state-panel state="empty" heading="אין תיקים עדיין" hint="פתח תיק מדף אירוע, מהנגן או מהמפה ההיסטורית (הוסף לתיק), או כאן."></sw-state-panel>`}
    ...
    `}render(){return $()?this.renderApi():r`
      <sw-page heading="תיקים" subheading="קישור להקלטה אינו שימור: ראיה נחשבת שמורה רק אחרי העתקה מאומתת ו־hash · נתוני הדגמה">
        ...
        <sw-table .columns=${fd} .rows=${Ys} @row-select=${e=>b(`/investigate/cases/${e.detail.id}`)}></sw-table>
      </sw-page>
    `}};de.styles=x`
    .bar {
      display: flex;
  ...
  `;O([l()],de.prototype,"cases",2);O([l()],de.prototype,"canManage",2);O([l()],de.prototype,"loading",2);O([l()],de.prototype,"error",2);O([l()],de.prototype,"status",2);O([l()],de.prototype,"q",2);O([l()],de.prototype,"creating",2);O([l()],de.prototype,"newTitle",2);O([l()],de.prototype,"newDesc",2);O([l()],de.prototype,"newTags",2);O([l()],de.prototype,"busy",2);de=O([k("investigate-cases")],de);let U=class extends y{constructor(){super(...arguments),this.caseId="case-1",this.tab="details",this.data=null,this.error="",this.info="",this.busy=!1,this.tz="Asia/Jerusalem",this.noteText="",this.editing=!1,this.editTitle="",this.editDesc="",this.editTags="",this.confirmDelete=!1,this.bundles=[],this.verifyResult=null,this.cams=[],this.snapCam="",this.loadedFor="",this.pollTimer=0}updated(e){e.has("caseId")&&$()&&this.loadedFor!==this.caseId&&this.load()}disconnectedCallback(){super.disconnectedCallback(),window.clearTimeout(this.pollTimer)}async load(){const e=this.caseId;this.loadedFor=e,this.error="";try{const[t,s]=await Promise.all([Fe(),ul(e)]);this.tz=t["time.zone"]??this.tz,this.data=s,this.bundles=(await gl(e).catch(()=>({bundles:[]}))).bundles,this.cams.length||(this.cams=(await et().catch(()=>({cameras:[]}))).cameras.filter(i=>i.enabled),!this.snapCam&&this.cams[0]&&(this.snapCam=this.cams[0].id)),window.clearTimeout(this.pollTimer),s.items.some(i=>i.preservation==="preserving")&&(this.pollTimer=window.setTimeout(()=>void this.load(),5e3))}catch(t){this.error=w(t)}}fmt(e){return new Intl.DateTimeFormat("he-IL",{timeZone:this.tz,dateStyle:"short",timeStyle:"medium"}).format(new Date(e))}async run(e,t=""){this.busy=!0,this.error="";try{await e(),this.info=t,await this.load(),t&&setTimeout(()=>this.info="",4e3)}catch(s){this.error=w(s),s instanceof fe&&s.status===409&&await this.load()}finally{this.busy=!1}}patchCase(e){const t=this.data;t&&this.run(async()=>{await fl(t.id,{revision:t.revision,...e})})}async verify(e){if(e){this.verifyResult=null,this.busy=!0,this.error="";try{this.verifyResult=await xl(e)}catch(t){this.error=w(t)}finally{this.busy=!1}}}renderBundleCard(e){const t=this.verifyResult;return r`<sw-card heading="חבילת ראיות" subheading="ZIP עם הקטעים השמורים, התמונות, ההערות, manifest עם SHA-256 לכל קובץ ודוח קריא" data-bundle>
      ${e.can_manage?r`<sw-button size="sm" variant="primary" icon="download" data-bundle-create ?disabled=${this.busy} @click=${()=>void this.run(async()=>{await bl(e.id)},'החבילה נוצרה; פריטים שאינם עותק שמור מופיעים בה כ"לא נכללו"')}>צור חבילת ראיות</sw-button>`:c}
      ${this.bundles.length?r`<div class="items" style="margin-block-start:8px">${this.bundles.map(s=>r`<div class="item" data-bundle-row style="grid-template-columns:minmax(0,1fr) auto"><div class="body"><strong class="ltr">${s.name}</strong><span class="meta">${vt(s.bytes)} · ${this.fmt(s.created_at)}</span></div><div class="acts"><a href=${yl(e.id,s.name)} download><sw-button size="sm" icon="download">הורדה</sw-button></a></div></div>`)}</div>`:r`<div class="hint" style="margin-block-start:6px">עדיין לא נוצרה חבילה לתיק הזה.</div>`}
    ...
    </sw-card>`}renderItem(e,t){const s=e.kind==="event"?`אירוע · ${Z[e.event?.type??"other"]??e.event?.type??""}`:e.kind==="clip"?"קטע הקלטה":e.kind==="snapshot"?"תמונה":"הערה",i=e.preservation,a=e.kind==="event"&&e.event?e.event.occurred_at:e.from_at,n=e.kind==="note"?r`<div class="thumb"><sw-icon name="edit" size=${18}></sw-icon></div>`:e.kind==="snapshot"?r`<img class="thumb" src=${$l(t.id,e.id)} alt="תמונה מהמצלמה" />`:e.kind==="event"&&e.event?.thumbnail==="ready"&&e.event_id?r`<img class="thumb" src=${bt(e.event_id)} alt="" />`:e.camera_id&&a?r`<img class="thumb" src=${Si(e.camera_id,a)} alt="" @error=${o=>o.target.style.visibility="hidden"} />`:r`<div class="thumb"></div>`;return r`<div class="item" data-case-item data-kind=${e.kind} data-preservation=${i}>
      ${n}
      <div class="body">
        <div class="head"><strong>${s}</strong>${e.camera_name?r`<span>· ${e.camera_name}</span>`:c}${i!=="none"?r`<sw-badge kind=${pd[i]} label=${hl[i]}></sw-badge>`:c}</div>
      ...
      <div class="acts">
        ...
        ${t.can_manage&&e.kind!=="note"&&(i==="nvr_only"||i==="unknown")?r`<sw-button size="sm" icon="download" data-item-preserve ?disabled=${this.busy} @click=${()=>void this.run(()=>vl(t.id,e.id).then(()=>{}),"עבודת שימור נוצרה; הפריט יסומן כשמור כשההעתקה תסתיים")}>שמור עותק</sw-button>`:c}
        ${e.export?.download_ready?r`<a href=${Ua(e.export.id)} download><sw-button size="sm" variant="ghost" icon="download">הורדה</sw-button></a>`:c}
        ${t.can_manage?r`<sw-button size="sm" variant="ghost" iconOnly icon="close" label="הסר מהתיק" data-item-remove ?disabled=${this.busy} @click=${()=>void this.run(()=>wl(t.id,e.id).then(()=>{}))}></sw-button>`:c}
      </div>
      ...
      <sw-page heading=${e.title} subheading=${`${Lt[e.status]} · בעלים: ${e.owner_username} · ${t.items} פריטים · ${t.preserved} עותקים שמורים · עודכן ${this.fmt(e.updated_at)}`} crumbs="חקירה | תיקים" wide>
        ${e.can_manage?r`<sw-field slot="actions"><select aria-label="סטטוס" data-case-status ?disabled=${this.busy} @change=${s=>this.patchCase({status:s.target.value})}>${Object.keys(Lt).map(s=>r`<option value=${s} ?selected=${s===e.status}>${Lt[s]}</option>`)}</select></sw-field>
        ...
        ${this.confirmDelete?r`<sw-dialog open heading="מחיקת תיק" subheading="הפריטים בתיק יימחקו; ההקלטות ב־NVR והעותקים שיוצאו נשארים" @close=${()=>this.confirmDelete=!1}>
              ...
              <sw-button slot="footer" variant="danger" icon="trash" data-case-delete-confirm ?disabled=${this.busy} @click=${()=>{this.confirmDelete=!1,this.run(async()=>{await ml(e.id),b("/investigate/cases")})}}>מחק תיק</sw-button>
            </sw-dialog>`:c}
      </sw-page>
  ...
  `;O([h()],U.prototype,"caseId",2);O([l()],U.prototype,"tab",2);O([l()],U.prototype,"data",2);O([l()],U.prototype,"error",2);O([l()],U.prototype,"info",2);O([l()],U.prototype,"busy",2);O([l()],U.prototype,"tz",2);O([l()],U.prototype,"noteText",2);O([l()],U.prototype,"editing",2);O([l()],U.prototype,"editTitle",2);O([l()],U.prototype,"editDesc",2);O([l()],U.prototype,"editTags",2);O([l()],U.prototype,"confirmDelete",2);O([l()],U.prototype,"bundles",2);O([l()],U.prototype,"verifyResult",2);O([l()],U.prototype,"cams",2);O([l()],U.prototype,"snapCam",2);U=O([k("investigate-case-detail")],U);var md=Object.defineProperty,wd=Object.getOwnPropertyDescriptor,Cs=(e,t,s,i)=>{for(var a=i>1?void 0:i?wd(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&md(t,s,a),a};const ia={queued:"ממתין",running:"מוריד",done:"הושלם",partial:"חלקי",failed:"נכשל",cancelled:"בוטל",interrupted:"הופסק"},vd={queued:"neutral",running:"live",done:"recorded",partial:"partial",failed:"error",cancelled:"unknown",interrupted:"stale"};let St=class extends y{constructor(){super(...arguments),this.jobs=null,this.ffmpeg=!0,this.error=""}connectedCallback(){super.connectedCallback(),$()&&(this.load(),this.timer=window.setInterval(()=>this.poll(),3e3))}disconnectedCallback(){super.disconnectedCallback(),window.clearInterval(this.timer)}async load(){try{const e=await El();this.jobs=e.jobs,this.ffmpeg=e.ffmpeg,this.error=""}catch(e){this.error=w(e)}}poll(){this.jobs?.some(e=>e.state==="queued"||e.state==="running")&&this.load()}fmt(e,t){return new Intl.DateTimeFormat("he-IL",{timeZone:t,day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit",second:"2-digit",hourCycle:"h23"}).format(new Date(e))}async cancel(e){try{await Cl(e.id),await this.load()}catch(t){this.error=w(t)}}async removeJob(e){try{await Tl(e.id),await this.load()}catch(t){this.error=w(t)}}renderApi(){return this.error&&!this.jobs?r`<sw-state-panel state="error" hint=${this.error} actionLabel="נסה שוב" @action=${()=>this.load()}></sw-state-panel>`:this.jobs?this.jobs.length?r`
      ...
      <sw-card>
        ${this.jobs.map(e=>{const t=Math.round((e.progress??0)*100),s=e.files.filter(i=>i.state==="downloaded"||i.state==="remuxed").length;return r`<div class="job">
            <div>
              <div class="title"><strong>${e.camera_name}</strong><sw-badge kind=${vd[e.state]} label=${ia[e.state]}></sw-badge></div>
            ...
            <div><div class="bar ${e.state==="failed"?"fail":e.state==="partial"?"partial":""}"><i style="inline-size:${t}%"></i></div><div class="meta">${ia[e.state]} · ${t}%${e.state==="running"?` · ${vt(e.files.reduce((i,a)=>i+a.bytes,0))}`:""}</div></div>
            <div class="actions">
              ${e.download_ready?r`<a href=${Ua(e.id)} download=${e.output_name??""}><sw-button size="sm" icon="download">הורדה</sw-button></a><a href=${Ol(e.id)} target="_blank" rel="noopener"><sw-button size="sm" variant="ghost" icon="list">מניפסט</sw-button></a>`:c}
  ...
  `;Cs([l()],St.prototype,"jobs",2);Cs([l()],St.prototype,"ffmpeg",2);Cs([l()],St.prototype,"error",2);St=Cs([k("investigate-exports")],St);var bd=Object.defineProperty,gd=Object.getOwnPropertyDescriptor,Ka=(e,t,s,i)=>{for(var a=i>1?void 0:i?gd(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&bd(t,s,a),a};const yd=[{scene:"entrance",when:"14.09.2026 10:14",cam:"כניסה ראשית",why:"NVR: זיהוי אדם (Smart)"},{scene:"lobby",when:"14.09.2026 10:13",cam:"לובי",why:"NVR: תנועה + סמיכות במפה לכניסה"},{scene:"parking",when:"14.09.2026 06:43",cam:"חניה מקורה",why:"NVR: חציית קו"},{scene:"entrance",when:"14.09.2026 08:12",cam:"כניסה ראשית",why:"HA: דלת נפתחה + תנועה"},{scene:"corridor",when:"13.09.2026 23:10",cam:"מסדרון מזרחי",why:"NVR: זיהוי אדם"},{scene:"backyard",when:"13.09.2026 18:03",cam:"חצר אחורית",why:"NVR: תנועה"}];let $s=class extends y{constructor(){super(...arguments),this.by="person"}render(){return r`
      <sw-page heading="חיפוש AI" subheading="מצא בדיוק את מה שאתה מחפש · חיפוש סמנטי רק עם אינדקס אמיתי · נתוני הדגמה">
        ...
        <div class="wrap">
          ...
          <div class="results">
            ${yd.map(e=>r`<div class="res" @click=${()=>window.location.hash="#/investigate/playback"}><div class="pic"><sw-scene kind=${e.scene}></sw-scene><span class="demo">דמו</span></div><div class="cap">${e.when}<small>${e.cam} · ${e.why}</small></div></div>`)}
          </div>
        </div>
      </sw-page>
    `}};$s.styles=x`
  ...
  `;Ka([l()],$s.prototype,"by",2);$s=Ka([k("investigate-search")],$s);const $d=()=>({name:"",description:"",enabled:!0,owner:"local",ha_automation_id:null,trigger:{types:[],sources:[],severity_min:"info"},scope:{site_ids:[],building_ids:[],floor_ids:[],zone_ids:[],camera_ids:[],entity_ids:[]},window:{days:[],from:null,to:null},cooldown_s:300,actions:[{kind:"notify",message:""}]}),xd=()=>_("rules"),kd=e=>z("rules",e),aa=(e,t)=>Ve(`rules/${e}`,t),_d=e=>be(`rules/${e}`),ra=(e,t=24)=>z("rules/dry-run",{rule:e,hours:t}),zd=(e=!1)=>_(`rules/alerts${e?"?unacked=true":""}`),Sd=e=>z(`rules/alerts/${e}/ack`),na={mon:"ב׳",tue:"ג׳",wed:"ד׳",thu:"ה׳",fri:"ו׳",sat:"ש׳",sun:"א׳"},Md={alertstream:"התראת NVR",recording:"נגזר מהקלטה",system:"מערכת",ha:"חיישן HA"};var Id=Object.defineProperty,Ad=Object.getOwnPropertyDescriptor,J=(e,t,s,i)=>{for(var a=i>1?void 0:i?Ad(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&Id(t,s,a),a};const oa={"r-1":{icon:"user",bg:"#eaf0ff",fg:"#2f6bff"},"r-2":{icon:"move",bg:"#e8f8ee",fg:"#16a34a"},"r-3":{icon:"door",bg:"#fff4e0",fg:"#d97706"},"r-4":{icon:"offline",bg:"#fdecec",fg:"#ef4444"}};let G=class extends y{constructor(){super(...arguments),this.tab="rules",this.rules=[],this.alerts=[],this.unacked=0,this.meta={types:[],sources:[],days:[]},this.error="",this.busy=!1,this.loading=!1,this.editing=null,this.dry=null,this.dryBusy=!1,this.tree=null,this.cams=[],this.zones=[],this.confirmDelete=null,this.tz="Asia/Jerusalem"}connectedCallback(){super.connectedCallback(),$()&&this.load()}async load(){this.loading=!0,this.error="";try{const[e,t]=await Promise.all([xd(),zd()]);if(this.rules=e.rules,this.meta={types:e.types,sources:e.sources,days:e.days},this.alerts=t.alerts,this.unacked=t.unacked,!this.tree){const[s,i]=await Promise.all([tt(),et()]);this.tree=s,this.cams=i.cameras.filter(a=>a.enabled)}}catch(e){this.error=w(e)}finally{this.loading=!1}}fmt(e){return e?new Intl.DateTimeFormat("he-IL",{timeZone:this.tz,dateStyle:"short",timeStyle:"short"}).format(new Date(e)):"—"}get floors(){return(this.tree?.sites??[]).flatMap(e=>(e.buildings??[]).flatMap(t=>(t.floors??[]).map(s=>({id:s.id,name:`${t.name} · ${s.name}`}))))}async run(e){this.busy=!0,this.error="";try{await e(),await this.load()}catch(t){this.error=w(t),t instanceof fe&&t.status===409&&await this.load()}finally{this.busy=!1}}openEditor(e){if(this.dry=null,this.zones=[],e){const{id:t,revision:s,alerts:i,created_by_username:a,updated_by_username:n,created_at:o,updated_at:d,last_fired_at:u,...m}=e;this.editing={id:t,revision:s,body:JSON.parse(JSON.stringify(m))},m.scope.floor_ids.length===1&&this.loadZones(m.scope.floor_ids[0])}else this.editing={id:null,revision:0,body:$d()}}async loadZones(e){try{this.zones=(await Gn(e)).zones}catch{this.zones=[]}}edit(e){if(!this.editing)return;const t=JSON.parse(JSON.stringify(this.editing.body));e(t),this.editing={...this.editing,body:t}}toggleIn(e,t){const s=e.indexOf(t);s>=0?e.splice(s,1):e.push(t)}async dryRun(){if(this.editing){this.dryBusy=!0,this.error="";try{this.dry=this.editing.id?await ra({...this.editing.body},24):await ra(this.editing.body,24)}catch(e){this.error=w(e)}finally{this.dryBusy=!1}}}save(){const e=this.editing;!e||!e.body.name.trim()||this.run(async()=>{e.id?await aa(e.id,{...e.body,revision:e.revision}):await kd(e.body),this.editing=null,this.dry=null})}summary(e){const t=e.trigger.types.length?e.trigger.types.map(a=>Z[a]??a).join(", "):"כל הסוגים",s=e.scope.floor_ids.length||e.scope.zone_ids.length||e.scope.camera_ids.length||e.scope.building_ids.length||e.scope.site_ids.length?[e.scope.floor_ids.length?`${e.scope.floor_ids.length} קומות`:"",e.scope.zone_ids.length?`${e.scope.zone_ids.length} אזורים`:"",e.scope.camera_ids.length?`${e.scope.camera_ids.length} מצלמות`:""].filter(Boolean).join(" · "):"כל המתקן",i=e.window.from||e.window.to||e.window.days.length?`${e.window.days.map(a=>na[a]??a).join("")||"כל יום"} ${e.window.from??"00:00"}–${e.window.to??"24:00"}`:"תמיד";return`${t} · ${s} · ${i} · השהיה ${e.cooldown_s} שנ׳ · ${e.owner==="ha"?`בבעלות HA (${e.ha_automation_id})`:"התראה במערכת"}`}renderEditor(){const e=this.editing;if(!e)return c;const t=e.body,s=this.dry;return r`<sw-dialog open heading=${e.id?"עריכת חוק":"חוק חדש"} subheading="Trigger → היקף → חלון זמן → השהיה → התראה במערכת · הרצה יבשה לפני שמירה" data-rule-dialog @close=${()=>this.editing=null}>
      ${this.error?r`<div class="err">${this.error}</div>`:c}
      <sw-field label="שם"><input data-rule-name .value=${t.name} @input=${i=>this.edit(a=>a.name=i.target.value)} /></sw-field>
      <sw-field label="סוגי אירועים (ריק = הכל)"><div class="chips">${this.meta.types.map(i=>r`<sw-chip data-rule-type=${i} ?selected=${t.trigger.types.includes(i)} @click=${()=>this.edit(a=>this.toggleIn(a.trigger.types,i))}>${Z[i]??i}</sw-chip>`)}</div></sw-field>
      <sw-field label="מקורות (ריק = הכל)"><div class="chips">${this.meta.sources.map(i=>r`<sw-chip ?selected=${t.trigger.sources.includes(i)} @click=${()=>this.edit(a=>this.toggleIn(a.trigger.sources,i))}>${Md[i]??i}</sw-chip>`)}</div></sw-field>
      <div class="two">
      ...
      <sw-field label="ימים (ריק = כל יום)"><div class="chips">${this.meta.days.map(i=>r`<sw-chip ?selected=${t.window.days.includes(i)} @click=${()=>this.edit(a=>this.toggleIn(a.window.days,i))}>${na[i]??i}</sw-chip>`)}</div></sw-field>
      <div class="two">
      ...
      ${s?r`<div class="dry">${[...s.would_fire.map(i=>({...i,fire:!0})),...s.suppressed.map(i=>({...i,fire:!1}))].sort((i,a)=>i.occurred_at.localeCompare(a.occurred_at)).slice(0,40).map(i=>r`<div class="dryrow" data-dryrun-row data-fire=${i.fire?"true":"false"}><span class="ltr">${this.fmt(i.occurred_at)}</span><span>${Z[i.type]??i.type} · ${i.camera_name??"—"}</span><span class="hint">${i.fire?i.reasons.join(" · "):`נחסם: ${i.suppressed}`}</span></div>`)}${s.would_fire.length+s.suppressed.length>40?r`<div class="hint">מוצגות 40 הראשונות</div>`:c}<div class="hint">${s.note}</div></div>`:c}
      ...
      <sw-page heading="התראות וחוקי אוטומציה" subheading="Trigger → היקף → חלון זמן → השהיה → התראה במערכת · הרצה יבשה לפני הפעלה · אין פקודות למכשירים">
        ...
        ${this.tab==="rules"?this.loading&&!this.rules.length?r`<sw-state-panel state="loading"></sw-state-panel>`:this.rules.length?r`<div class="list">${this.rules.map(e=>r`<sw-card flush class="rule" data-rule-row data-rule-id=${e.id} style="--bg:#eaf0ff;--fg:#2f6bff">
                    ...
                    <sw-toggle ?checked=${e.enabled} ?disabled=${this.busy||e.owner==="ha"} labelHidden label="פעיל" data-rule-toggle @change=${t=>void this.run(async()=>{const{id:s,revision:i,alerts:a,created_by_username:n,updated_by_username:o,created_at:d,updated_at:u,last_fired_at:m,...f}=e;await aa(s,{...f,enabled:t.detail.checked,revision:i})})}></sw-toggle>
                  ...
                  ${e.acked_at?r`<span class="last">טופל · ${e.acked_by_username??""}</span>`:r`<sw-button size="sm" icon="check" data-alert-ack ?disabled=${this.busy} @click=${()=>void this.run(async()=>{await Sd(e.id)})}>סמן כטופל</sw-button>`}
        ...
        ${this.confirmDelete?r`<sw-dialog open heading="מחיקת חוק" subheading=${this.confirmDelete.name} @close=${()=>this.confirmDelete=null}>
              ...
              <sw-button slot="footer" variant="danger" icon="trash" data-rule-delete-confirm @click=${()=>{const e=this.confirmDelete;this.confirmDelete=null,this.run(async()=>{await _d(e.id)})}}>מחק</sw-button>
            </sw-dialog>`:c}
      </sw-page>
    `}render(){return $()?this.renderApi():r`
      <sw-page heading="התראות וחוקי אוטומציה" subheading="Trigger → היקף → תנאים → פעולה · בדיקה יבשה לפני הפעלה · נתוני הדגמה">
        ...
        ${this.tab==="rules"?r`<div class="list">
              ${Xs.map(e=>{const t=oa[e.id]??oa["r-1"];return r`<sw-card flush class="rule" style="--bg:${t.bg};--fg:${t.fg}">
  ...
  `;J([l()],G.prototype,"tab",2);J([l()],G.prototype,"rules",2);J([l()],G.prototype,"alerts",2);J([l()],G.prototype,"unacked",2);J([l()],G.prototype,"meta",2);J([l()],G.prototype,"error",2);J([l()],G.prototype,"busy",2);J([l()],G.prototype,"loading",2);J([l()],G.prototype,"editing",2);J([l()],G.prototype,"dry",2);J([l()],G.prototype,"dryBusy",2);J([l()],G.prototype,"tree",2);J([l()],G.prototype,"cams",2);J([l()],G.prototype,"zones",2);J([l()],G.prototype,"confirmDelete",2);G=J([k("investigate-rules")],G);let xs=class extends y{constructor(){super(...arguments),this.ruleId="r-1"}render(){const e=Xs.find(t=>t.id===this.ruleId)??{name:"חוק חדש",trigger:"זיהוי אדם",scope:"חוץ",action:"התראה"};return r`
  ...
  `;J([h()],xs.prototype,"ruleId",2);xs=J([k("investigate-rule-editor")],xs);const Pd=()=>_("identity/users"),Ed=()=>z("identity/sync"),cs=()=>_("access/roles"),Cd=e=>z("access/bindings",e),Td=e=>be(`access/bindings/${e}`),Od=()=>_("access/groups"),Dd=e=>z("access/groups",{name:e}),Rd=e=>be(`access/groups/${e}`),Nd=(e,t)=>$a(`access/groups/${e}/members`,{user_ids:t}),Bd=e=>z("access/preview",e),la=(e={})=>{const t=new URLSearchParams;e.prefix&&t.set("prefix",e.prefix),e.actor&&t.set("actor",e.actor),e.resourceId&&t.set("resource_id",e.resourceId),e.limit&&t.set("limit",String(e.limit));const s=t.toString();return _(`audit${s?`?${s}`:""}`)},da={verified:"מסונכרן",stale:"סנכרון מיושן",removed:"מושבת / נמחק ב־HA",unavailable:"לא בספריית HA",unknown:"טרם סונכרן",dev:"משתמש פיתוח"},Hd={"rbac.bind":"שיוך תפקיד","rbac.unbind":"ביטול שיוך","rbac.group_create":"יצירת קבוצה","rbac.group_members":"שינוי חברי קבוצה","rbac.group_delete":"מחיקת קבוצה","rbac.bootstrap_admin":"מנהל ראשון (bootstrap)","identity.user_disabled":"משתמש הושבת (HA)","identity.user_enabled":"משתמש הופעל (HA)","identity.sync":"סנכרון ספרייה"};function Ze(e){if(!e)return"—";const t=new Date(e);return Number.isNaN(t.getTime())?e:t.toLocaleString("he-IL",{dateStyle:"short",timeStyle:"short"})}const Ld=e=>z("access/roles",e),jd=(e,t)=>Ve(`access/roles/${e}`,t),Vd=e=>be(`access/roles/${e}`),Fd=e=>z("access/roles/preview",e),Wd=e=>$a("access/delegation",{delegable_roles:e});var Ud=Object.defineProperty,Zd=Object.getOwnPropertyDescriptor,V=(e,t,s,i)=>{for(var a=i>1?void 0:i?Zd(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&Ud(t,s,a),a};const qd=[{id:"users",label:"משתמשים",count:Js.length},{id:"groups",label:"קבוצות",count:Sa.length},{id:"roles",label:"תפקידים",count:Ma.length},{id:"effective",label:"הרשאות אפקטיביות"},{id:"audit",label:"אודיט הרשאות"}];let B=class extends y{constructor(){super(...arguments),this.tab="users",this.selected=null,this.assigning=!1,this.step=0,this.directory=null,this.roles=null,this.groups=null,this.tree=null,this.audit=null,this.selectedGroup=null,this.wizard=null,this.members=null,this.newGroup="",this.preview=null,this.previewUser="",this.previewScope="installation:*",this.busy=!1,this.error="",this.message="",this.forbidden=!1,this.roleEdit=null,this.roleImpact=null,this.roleDelete=null,this.roleImpactTimer=0,this.userColumns=[{key:"name",label:"שם",render:e=>r`<div class="who"><sw-avatar name=${String(e.name)} size=${30}></sw-avatar><div><strong>${String(e.name)}</strong>${e.haAdmin?r` <sw-badge kind="neutral" label="מנהל HA · מידע בלבד"></sw-badge>`:""}<div class="ltr sub">${String(e.haUser)}@ha.local</div></div></div>`},{key:"role",label:"תפקיד",render:e=>{const t=e.bindings[0];return t?r`<span class="pillsel">${t.role}<sw-icon name="chevronDown" size=${11}></sw-icon></span>`:r`<span class="pillsel" style="color:var(--sw-text-3)">ללא שיוך<sw-icon name="chevronDown" size=${11}></sw-icon></span>`}},{key:"scope",label:"היקף גישה",render:e=>{const t=e.bindings[0];return t?r`<span class="pillsel">${t.scope}<sw-icon name="chevronDown" size=${11}></sw-icon></span>`:r`<span class="sub">—</span>`}},{key:"active",label:"מצב",render:e=>r`<span class="status ${e.active?"":"off"}"><i></i>${e.active?"פעיל":"מושבת ב־HA"}</span>`},{key:"lastSync",label:"סנכרון"},{key:"more",label:"",width:"40px",render:()=>r`<sw-button variant="ghost" size="sm" iconOnly icon="more" label="עוד"></sw-button>`}]}connectedCallback(){super.connectedCallback(),$()&&this.load()}async load(){this.error="";try{const[e,t,s,i]=await Promise.all([Pd(),cs(),Od(),tt()]);this.directory=e,this.roles=t,this.groups=s.groups,this.tree=i,this.forbidden=!1,this.previewUser||(this.previewUser=zt.me?.user.id??"")}catch(e){const t=w(e);this.error=t,this.forbidden=/403|הרשאה|forbidden/i.test(t)&&!this.directory}}async loadAudit(){try{const[e,t]=await Promise.all([la({prefix:"rbac.",limit:100}),la({prefix:"identity.",limit:50})]);this.audit=[...e.rows,...t.rows].sort((s,i)=>s.at<i.at?1:-1).slice(0,150)}catch(e){this.error=w(e),this.audit=[]}}flash(e){this.message=e,setTimeout(()=>this.message="",3500)}get scopeOptions(){const e=[{type:"installation",id:"*",name:"כל ההתקנה"}];for(const t of this.tree?.sites??[]){e.push({type:"site",id:t.id,name:`אתר · ${t.name}`});for(const s of t.buildings??[]){e.push({type:"building",id:s.id,name:`${t.name} · ${s.name}`});for(const i of s.floors??[])e.push({type:"floor",id:i.id,name:`${t.name} · ${s.name} · ${i.name}`})}}return e}userName(e){return this.directory?.users.find(t=>t.id===e)?.name??e}label(e){return this.roles?.labels[e]??e}startWizard(e,t,s){this.wizard={subjectKind:e,subjectId:t,subjectName:s,roleId:"viewer",scopeKey:"installation:*"}}async saveWizard(){const e=this.wizard;if(!e)return;const[t,s]=e.scopeKey.split(":");this.busy=!0,this.error="";try{const i=await Cd({subject_kind:e.subjectKind,subject_id:e.subjectId,role_id:e.roleId,scope_type:t,scope_id:s});this.flash(`שויך: ${i.role_name} · ${i.scope_name} (רוויזיה ${i.revision})`),this.wizard=null,await this.load()}catch(i){this.error=w(i)}finally{this.busy=!1}}async revoke(e){this.busy=!0,this.error="";try{await Td(e.id),this.flash(`בוטל: ${e.role_name} · ${e.scope_name}`),await this.load()}catch(t){this.error=w(t)}finally{this.busy=!1}}async sync(){this.busy=!0,this.error="";try{const e=await Ed();this.flash(e.requested?"הספרייה נדחפה מ־Home Assistant":e.note??"הספרייה מתעדכנת אוטומטית כל דקה"),await this.load()}catch(e){this.error=w(e)}finally{this.busy=!1}}async addGroup(){const e=this.newGroup.trim();if(e){this.busy=!0,this.error="";try{const t=await Dd(e);this.newGroup="",this.flash(`נוצרה קבוצה "${t.name}"`),await this.load(),this.selectedGroup=t.id}catch(t){this.error=w(t)}finally{this.busy=!1}}}async saveMembers(e){if(this.members){this.busy=!0,this.error="";try{await Nd(e.id,[...this.members]),this.members=null,this.flash("חברי הקבוצה עודכנו"),await this.load()}catch(t){this.error=w(t)}finally{this.busy=!1}}}async removeGroup(e){this.busy=!0,this.error="";try{await Rd(e.id),this.selectedGroup=null,this.flash(`הקבוצה "${e.name}" נמחקה והשיוכים שלה בוטלו`),await this.load()}catch(t){this.error=w(t)}finally{this.busy=!1}}async runPreview(){if(!this.previewUser)return;const[e,t]=this.previewScope.split(":");this.busy=!0,this.error="";try{this.preview=await Bd({user_id:this.previewUser,scope_type:e,scope_id:t})}catch(s){this.error=w(s)}finally{this.busy=!1}}renderBindingRow(e,t){return r`<div class="bind">
      ...
      <div class="stage">
        ...
        ${i?r`<sw-drawer open heading=${i.name} subheading=${`Home Assistant · ${i.username||i.id} · ${i.active?"פעיל":"ללא גישה"}`} @close=${()=>{this.selected=null,this.wizard=null}}>
              ${this.wizard&&this.wizard.subjectKind==="user"?this.renderWizard():r`<dl>
                    ...
                    <dt>סנכרון</dt><dd>${da[i.sync_status]}${i.synced_at?` · ${Ze(i.synced_at)}`:""}</dd>
    ...
    `}renderGroupsApi(){const e=this.groups??[],t=this.directory,s=t.can_assign,i=[{key:"name",label:"קבוצה",render:o=>r`<strong>${String(o.name)}</strong>`},{key:"members",label:"חברים",render:o=>r`${o.members.length}`},{key:"bindings",label:"שיוכים (תפקיד · היקף)",render:o=>r`${o.bindings.map(d=>r`<div style="font-size:var(--sw-fs-xs)">${d.role_name} · ${d.scope_name}</div>`)}`}],a=e.find(o=>o.id===this.selectedGroup)??null,n=this.members??new Set(a?.members.map(o=>o.id)??[]);return r`
      ...
      <div class="stage">
        ...
        ${a?r`<sw-drawer open heading=${a.name} subheading=${`${a.members.length} חברים · ${a.bindings.length} שיוכים`} @close=${()=>{this.selectedGroup=null,this.members=null,this.wizard=null}}>
              ${this.wizard&&this.wizard.subjectKind==="group"?this.renderWizard():r`<div style="font-weight:600;font-size:var(--sw-fs-xs);margin-block-end:4px">שיוכים של הקבוצה</div>
                  ...
                  <div class="members">${t.users.map(o=>r`<label><input type="checkbox" ?disabled=${!s} .checked=${n.has(o.id)} @change=${d=>{const u=new Set(n);d.target.checked?u.add(o.id):u.delete(o.id),this.members=u}} /> ${o.name}<span class="hint">${o.active?"":" · ללא גישה"}</span></label>`)}</div>
    ...
    `}renderAudit(){return r`<sw-table dense .columns=${[{key:"time",label:"זמן"},{key:"user",label:"משתמש",render:t=>r`<div class="who"><sw-avatar name=${String(t.user)} size=${24}></sw-avatar>${String(t.user)}</div>`},{key:"action",label:"פעולה"},{key:"resource",label:"משאב"},{key:"decision",label:"החלטה",render:t=>r`<sw-badge kind=${String(t.decision).startsWith("נחסם")?"forbidden":"live"} label=${String(t.decision)}></sw-badge>`},{key:"role",label:"תפקיד/היקף ששימשו"}]} .rows=${Ia.filter(t=>t.action.includes("תוכנית")||t.action.includes("סנכרון")||t.action.includes("Ingress"))}></sw-table>`}render(){return $()?this.renderApi():r`
      <sw-page heading="משתמשים והרשאות" subheading="זהות מ־Home Assistant · הרשאות בתוך SMPLWISE בלבד · נתוני הדגמה">
        ...
        <sw-tabs .items=${qd} .active=${this.tab} @change=${e=>this.tab=e.detail.id}></sw-tabs>
        <div class="notice"><sw-icon name="shield" size=${14}></sw-icon>שיוך כאן אינו משנה דבר ב־Home Assistant: לא קבוצות HA, לא דגל מנהל, לא סיסמאות. אין "הוספת משתמש" — משתמשים נוצרים ב־HA בלבד.</div>
  ...
  `;V([l()],B.prototype,"tab",2);V([l()],B.prototype,"selected",2);V([l()],B.prototype,"assigning",2);V([l()],B.prototype,"step",2);V([l()],B.prototype,"directory",2);V([l()],B.prototype,"roles",2);V([l()],B.prototype,"groups",2);V([l()],B.prototype,"tree",2);V([l()],B.prototype,"audit",2);V([l()],B.prototype,"selectedGroup",2);V([l()],B.prototype,"wizard",2);V([l()],B.prototype,"members",2);V([l()],B.prototype,"newGroup",2);V([l()],B.prototype,"preview",2);V([l()],B.prototype,"previewUser",2);V([l()],B.prototype,"previewScope",2);V([l()],B.prototype,"busy",2);V([l()],B.prototype,"error",2);V([l()],B.prototype,"message",2);V([l()],B.prototype,"forbidden",2);V([l()],B.prototype,"roleEdit",2);V([l()],B.prototype,"roleImpact",2);V([l()],B.prototype,"roleDelete",2);B=V([k("system-access")],B);var Kd=Object.getOwnPropertyDescriptor,Gd=(e,t,s,i)=>{for(var a=i>1?void 0:i?Kd(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=o(a)||a);return a};const Jd=[{key:"time",label:"זמן",render:e=>r`14.09.2026 ${String(e.time)}`},{key:"user",label:"משתמש",render:e=>r`<span style="display:inline-flex;align-items:center;gap:8px"><sw-avatar name=${String(e.user)} size=${24}></sw-avatar>${String(e.user)}</span>`},{key:"action",label:"פעולה",render:e=>r`<span style=${String(e.decision).startsWith("נחסם")?"color:var(--sw-danger);font-weight:600":""}>${String(e.action)}</span>`},{key:"resource",label:"פרטים",render:e=>r`${String(e.resource)} <span style="color:var(--sw-text-3)">· ${String(e.decision)}</span>`},{key:"role",label:"תפקיד / היקף"},{key:"rev",label:"rev",ltr:!0,render:()=>r`7`}];let di=class extends y{render(){return r`
      <sw-page heading="יומן אודיט" subheading="מי צפה, שינה, ייצא או שלח פעולה · actor, מקור זהות, תפקיד והיקף, החלטה, request_id, permission_revision · נתוני הדגמה">
        ...
        <sw-table .columns=${Jd} .rows=${Ia}></sw-table>
        <div class="pager">
  ...
  `;di=Gd([k("system-audit")],di);var Yd=Object.defineProperty,Xd=Object.getOwnPropertyDescriptor,Ga=(e,t,s,i)=>{for(var a=i>1?void 0:i?Xd(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&Yd(t,s,a),a};const Ws=["גילוי","NVR","go2rtc","גשר HA","מנהל ראשון","שעון","סיום"];let ks=class extends y{constructor(){super(...arguments),this.step=0}renderStep(){switch(this.step){case 0:return r`<sw-card heading="גילוי מכשירים" subheading="חיפוש NVR ומצלמות ברשת המקומית · קריאה בלבד, ללא שינוי תצורה במכשיר">
          <div class="scan">
  ...
  `;Ga([l()],ks.prototype,"step",2);ks=Ga([k("system-setup")],ks);var Qd=Object.defineProperty,ec=Object.getOwnPropertyDescriptor,ue=(e,t,s,i)=>{for(var a=i>1?void 0:i?ec(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&Qd(t,s,a),a};const ca=["entrance","lobby","corridor","hall","parking","warehouse","backyard","driveway","night"];let ae=class extends y{constructor(){super(...arguments),this.selected=null,this.filter="all",this.cameras=null,this.recorder=null,this.canSync=!1,this.discovery=null,this.busy=!1,this.message="",this.error="",this.dialog=!1,this.formChannel=1,this.formAlias="",this.alias="",this.columns=[{key:"name",label:"מצלמה",render:e=>r`<div class="cam">${e.scene?r`<sw-scene kind=${e.scene}></sw-scene>`:r`<div class="none"></div>`}<div><b>${String(e.name)}</b><small>${String(e.sub)}</small></div></div>`},{key:"state",label:"מצב",render:e=>r`<span class="status"><i style="--c:${e.state==="live"?"var(--sw-live)":e.state==="offline"?"var(--sw-danger)":e.state==="unknown"?"var(--sw-unknown)":"var(--sw-stale)"}"></i>${e.state==="live"?"מחוברת":e.state==="offline"?"מנותקת":e.state==="stale"?"לא מעודכן":e.state==="forbidden"?"ללא הרשאה":"לא נבדק"}</span>`},{key:"fps",label:"FPS",ltr:!0},{key:"bitrate",label:"קצב",ltr:!0},{key:"firmware",label:"זרם ראשי",ltr:!0},{key:"lastEvent",label:"נראתה לאחרונה"},{key:"net",label:"רשת",render:e=>this.net(e.state==="live"?4:e.state==="stale"?2:0)},{key:"more",label:"",width:"40px",render:()=>r`<sw-button variant="ghost" size="sm" iconOnly icon="more" label="עוד"></sw-button>`}]}connectedCallback(){super.connectedCallback(),this.reload()}async reload(){if(!$()){this.cameras=null;return}try{const e=await et();this.cameras=e.cameras,this.recorder=e.recorder,this.canSync=e.can_sync,_("health").then(t=>this.discovery=t.discovery).catch(()=>{})}catch(e){this.error=w(e)}}async sync(){this.busy=!0,this.error="",this.message="";try{const e=await Ln();this.message=`סנכרון הושלם: ${e.channels} ערוצים (${e.created} חדשים, ${e.updated} עודכנו)${e.recorder.model?` · ${e.recorder.model}`:""}`,await this.reload()}catch(e){this.error=w(e)}finally{this.busy=!1}}async register(){this.busy=!0,this.error="";try{await jn({channel:this.formChannel,alias:this.formAlias.trim()}),this.dialog=!1,await this.reload()}catch(e){this.error=w(e)}finally{this.busy=!1}}async saveAlias(e){this.busy=!0,this.error="";try{await Vn(e,{alias:this.alias.trim()||void 0}),await this.reload(),this.message="הכינוי נשמר (שם ה־NVR לא השתנה)"}catch(t){this.error=w(t)}finally{this.busy=!1}}get rows(){return this.cameras?this.cameras.map(e=>({id:e.id,name:e.name,sub:`ערוץ ${e.channel}${e.name_source&&e.alias?` · NVR: ${e.name_source}`:""}`,state:e.status==="online"?"live":e.status==="offline"?"offline":"unknown",fps:e.stream?.fps?String(e.stream.fps):"—",bitrate:e.stream?.bitrate_kbps?`${(e.stream.bitrate_kbps/1024).toFixed(1)} Mbps`:"—",firmware:e.stream?.resolution?`${e.stream.resolution} ${e.stream.codec??""}`.trim():"—",lastEvent:e.last_seen_at?e.last_seen_at.replace("T"," ").replace("Z",""):"לא נבדק",scene:e.status==="online"?ca[(e.channel-1)%ca.length]:null,channel:e.channel,api:e})):F.map(e=>({id:e.id,name:e.name,sub:`${e.floor} · ערוץ ${e.id.replace("cam-","")}`,state:e.state,fps:e.fps?String(e.fps):"—",bitrate:e.bitrateKbps?`${(e.bitrateKbps/1024).toFixed(1)} Mbps`:"—",firmware:e.firmware,lastEvent:e.lastEvent,scene:e.state==="offline"||e.state==="forbidden"?null:Ae[e.id]??"lobby",channel:Number(e.id.replace("cam-",""))}))}net(e){return p`<svg class="net" viewBox="0 0 22 14" aria-label="רשת">${[0,1,2,3].map(t=>p`<rect x=${t*5.5} y=${11-t*3} width="4" height=${3+t*3} rx="1" fill=${t<e?e>=3?"#22c55e":"#f59e0b":"var(--sw-border-strong)"} />`)}</svg>`}render(){const e=this.rows,t=e.filter(a=>this.filter==="all"?!0:this.filter==="online"?a.state==="live":this.filter==="offline"?a.state==="offline":a.state==="stale"||a.state==="forbidden"||a.state==="unknown"),s=e.find(a=>a.id===this.selected),i=!!this.cameras;return r`
  ...
  `;ue([l()],ae.prototype,"selected",2);ue([l()],ae.prototype,"filter",2);ue([l()],ae.prototype,"cameras",2);ue([l()],ae.prototype,"recorder",2);ue([l()],ae.prototype,"canSync",2);ue([l()],ae.prototype,"discovery",2);ue([l()],ae.prototype,"busy",2);ue([l()],ae.prototype,"message",2);ue([l()],ae.prototype,"error",2);ue([l()],ae.prototype,"dialog",2);ue([l()],ae.prototype,"formChannel",2);ue([l()],ae.prototype,"formAlias",2);ue([l()],ae.prototype,"alias",2);ae=ue([k("system-devices")],ae);const Ja="sw.design.override",Ya="sw.design.last",jt={a:"SW A",b:"SW B"};let Ts="b";const ci=new Set;function Xa(e){try{return localStorage.getItem(e)}catch{return null}}function Qa(e,t){try{t===null?localStorage.removeItem(e):localStorage.setItem(e,t)}catch{}}function pi(){const e=Xa(Ja);return e==="a"||e==="b"?e:null}function tc(e){Qa(Ja,e),er()}function sc(){return Ts}function ic(e){return ci.add(e),e(Ts),()=>ci.delete(e)}function qe(e){Ts=e,document.documentElement.dataset.design=e,Qa(Ya,e),ci.forEach(t=>t(e))}function ac(e){try{const t=e?JSON.parse(e):{};return{a:(t.a||jt.a).slice(0,24),b:(t.b||jt.b).slice(0,24)}}catch{return{...jt}}}async function er(){const e=new URLSearchParams(window.location.search).get("design");if(e==="a"||e==="b")return qe(e),e;const t=pi();if(t)return qe(t),t;if(!$())return qe("b"),"b";const s=Xa(Ya);(s==="a"||s==="b")&&qe(s);try{const a=(await Fe())["ui.design"]==="b"?"b":"a";return qe(a),a}catch{return qe(s==="b"?"b":"a"),Ts}}const rc={manual:"ידני",upload:"הועלה","auto-pre-upgrade":"אוטומטי · לפני עדכון","auto-daily":"אוטומטי · יומי"},Us={sites:"אתרים",buildings:"מבנים",floors:"קומות",plan_assets:"קבצי תוכנית",plan_versions:"גרסאות תוכנית",map_anchors:"עוגנים",cameras:"מצלמות",spatial_zones:"אזורים",settings:"הגדרות",users:"משתמשים",bindings:"הרשאות",groups:"קבוצות"},nc=()=>_("backups"),oc=(e={})=>z("backups",e),lc=e=>be(`backups/${encodeURIComponent(e)}`),dc=(e,t)=>z(`backups/${encodeURIComponent(e)}/restore`,t),cc=e=>ve(`backups/${encodeURIComponent(e)}/download`);function pc(e){const t=new FormData;return t.append("file",e,e.name),xi("backups/upload",t)}function pa(e){return e<1024?`${e} B`:e<1024*1024?`${(e/1024).toFixed(0)} KB`:`${(e/1024/1024).toFixed(1)} MB`}var hc=Object.defineProperty,uc=Object.getOwnPropertyDescriptor,D=(e,t,s,i)=>{for(var a=i>1?void 0:i?uc(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&hc(t,s,a),a};const ha=[{id:"general",label:"כללי"},{id:"media",label:"וידאו ומדיה"},{id:"ha",label:"גשר Home Assistant"},{id:"health",label:"בריאות ועבודות"},{id:"backup",label:"גיבוי ושחזור"},{id:"support",label:"תמיכה"}];let C=class extends y{constructor(){super(...arguments),this.tab="general",this.settings=null,this.canEdit=!1,this.draft={},this.streams=null,this.go2rtc=null,this.foreign=0,this.sessions=[],this.busy=!1,this.message="",this.error="",this.version="",this.ha=null,this.pairing=null,this.showCode=!1,this.regenArmed=!1,this.copied=!1,this.report=null,this.reportBusy=!1,this.backups=null,this.backupPolicy={},this.backupBusy=!1,this.backupNote="",this.backupMsg="",this.restoreTarget=null,this.restoreMode="replace",this.restoreAccess=!1,this.restoreConfirm="",this.health=null}connectedCallback(){super.connectedCallback();const e=bs().params.get("tab");e&&ha.some(t=>t.id===e)&&(this.tab=e,e==="health"&&this.loadReport(),e==="backup"&&this.loadBackups(),e==="media"&&this.loadMedia(),e==="ha"&&this.loadHa()),this.loadSettings()}async loadSettings(){if($())try{const[e,t]=await Promise.all([xa(),_("health").catch(()=>null)]);this.settings=e.settings,this.canEdit=e.can_edit,this.draft={},this.version=t?.version??"",this.health=t??null}catch(e){this.error=w(e)}}async loadMedia(){if(!(!$()||!this.canEdit))try{const[e,t]=await Promise.all([an(),rn()]);this.streams=e.streams,this.go2rtc=e.go2rtc,this.foreign=e.foreign_streams,this.sessions=t.sessions,this.error=""}catch(e){this.streams=[],this.error=w(e)}}async loadHa(e=!1){if($()){this.error="";try{this.ha=await to(),this.canEdit&&(this.pairing=await so(e)),e&&(this.regenArmed=!1,this.showCode=!0,this.message="נוצר קוד צימוד חדש; יש להגדיר מחדש את האינטגרציה ב־Home Assistant.",setTimeout(()=>this.message="",4e3))}catch(t){this.error=w(t)}}}async copyCode(){if(this.pairing)try{await navigator.clipboard.writeText(this.pairing.pairing_code),this.copied=!0,setTimeout(()=>this.copied=!1,2e3)}catch{this.showCode=!0}}async installBridgeNow(){this.busy=!0,this.error="";try{const e=await io();this.message=e.state==="installed_pending"?"האינטגרציה הועתקה ל־Home Assistant; הפעל מחדש את Home Assistant ואשר את הגשר שהתגלה.":e.state==="active"?"האינטגרציה פעילה.":e.state==="not_available"?"תיקיית ההגדרות של Home Assistant אינה נגישה ל־Add-on.":`מצב: ${e.state}`,await this.loadHa(),setTimeout(()=>this.message="",6e3)}catch(e){this.error=w(e)}finally{this.busy=!1}}integrationText(e){switch(e.state){case"active":return`פעילה ב־Home Assistant (גרסה ${e.active_version??"?"})`;case"installed_pending":return`הועתקה לתיקיית ההגדרות של HA (גרסה ${e.installed_version??"?"}) ב־${ke(e.installed_at)} · הפעל מחדש את Home Assistant ואז אשר את "SMPLWISE Bridge" שהתגלה בהגדרות → מכשירים ושירותים`;case"update_pending":return`עודכנה לגרסה ${e.installed_version??"?"} אך Home Assistant עדיין מריץ ${e.active_version??"?"} · נדרש Restart ל־Home Assistant`;case"not_installed":return"טרם הועתקה";case"error":return`ההעתקה נכשלה (${e.last_error??""})`;default:return e.last_error==="ha_config_not_mapped"?"ה־Add-on לא רואה את תיקיית ההגדרות של Home Assistant (המיפוי homeassistant_config לא ניתן) · התקנה ידנית לפי השלבים למטה":e.last_error==="source_missing"?"קבצי האינטגרציה חסרים בתמונת ה־Add-on · התקנה ידנית לפי השלבים למטה":`ההתקנה האוטומטית נכשלה (${e.last_error??"סיבה לא ידועה"}) · התקנה ידנית לפי השלבים למטה`}}renderIntegration(e){const t=e.integration;if(!t)return c;const s=t.state==="active"?"live":t.state==="installed_pending"||t.state==="update_pending"?"stale":t.state==="error"?"error":"unknown",i=t.state==="active"?"פעילה":t.state==="installed_pending"?"ממתינה ל־Restart":t.state==="update_pending"?"עדכון ממתין":t.state==="error"?"שגיאה":t.state==="not_installed"?"לא הותקנה":"לא זמין";return r`<div class="row"><span class="lbl">התקנת האינטגרציה ב־Home Assistant<span class="muted">${this.integrationText(t)}${t.discovery_posted_at?` · הוכרזה ל־Supervisor ${ke(t.discovery_posted_at)}`:""}</span></span><span style="display:flex;gap:8px;align-items:center"><sw-badge kind=${s} label=${i}></sw-badge>${this.canEdit&&t.state!=="not_available"?r`<sw-button size="sm" ?disabled=${this.busy} @click=${()=>this.installBridgeNow()}>התקן / עדכן</sw-button>`:c}</span></div>`}renderHa(){if(!$())return r`<div class="sections"><sw-card heading="גשר Home Assistant"><div class="muted">נתוני הדגמה — הסטטוס והצימוד זמינים מול השרת.</div></sw-card></div>`;const e=this.ha,t=e?.sync,s=this.pairing;return r`<div class="sections">
      <sw-card heading="חיבור ל־Home Assistant" subheading="קריאה בלבד: מצבים, רישום ישויות, אזורים וקומות">
        ${e?r`
            ...
            <div class="row"><span class="lbl">רישום ישויות (registry)<span class="muted">עודכן ${ke(t?.last_registry_at)} · תמונת מצב ${ke(t?.last_snapshot_at)}</span></span><sw-button size="sm" @click=${()=>b("/explore/entities")}>לקטלוג</sw-button></div>`:r`<div class="muted">טוען…</div>`}
      </sw-card>
    ...
    </div>`}set(e,t){this.draft={...this.draft,[e]:t}}value(e){return this.draft[e]??this.settings?.[e]}async save(){if(Object.keys(this.draft).length){this.busy=!0,this.error="";try{const e=await tn(this.draft);this.settings=e.settings,this.draft={},Ki(),this.message="ההגדרות נשמרו",setTimeout(()=>this.message="",2500)}catch(e){this.error=w(e)}finally{this.busy=!1}}}async sync(){this.busy=!0,this.error="";try{const e=await sn();this.message=`זרמים: ${e.created} נוצרו, ${e.updated} עודכנו, ${e.unchanged} ללא שינוי · ${e.foreign_streams_untouched} זרמים זרים לא נגעו`,await this.loadMedia()}catch(e){this.error=w(e)}finally{this.busy=!1}}renderDesign(){if(!$())return c;const e=ac(this.value("ui.design_names")),t=this.value("ui.design")??"a",s=pi(),i="ui.design"in this.draft||"ui.design_names"in this.draft,a=(n,o)=>this.set("ui.design_names",JSON.stringify({...e,[n]:o.slice(0,24)}));return r`<sw-card heading="עיצוב הממשק" subheading=${`פעיל עכשיו בדפדפן הזה: ${e[sc()]}${s?" (עקיפה מקומית)":""}`}>
      ...
      <div class="row"><span class="lbl">שם העיצוב החדש<span class="muted">ברירת מחדל: ${jt.a} · העיצוב מחבילת 50 המסכים</span></span><sw-field class="ctl"><input maxlength="24" ?disabled=${!this.canEdit} .value=${e.a} @change=${n=>a("a",n.target.value)} /></sw-field></div>
      <div class="row"><span class="lbl">שם העיצוב הקודם<span class="muted">ברירת מחדל: ${jt.b} · הלוחות המקוריים</span></span><sw-field class="ctl"><input maxlength="24" ?disabled=${!this.canEdit} .value=${e.b} @change=${n=>a("b",n.target.value)} /></sw-field></div>
      <div class="row"><span class="lbl">בדפדפן הזה בלבד<span class="muted">עקיפה אישית שנשמרת במכשיר; לא משנה את ברירת המחדל</span></span><sw-field class="ctl"><select @change=${n=>{const o=n.target.value;tc(o==="a"||o==="b"?o:null),o!=="a"&&o!=="b"&&qe(t),this.requestUpdate()}}><option value="" ?selected=${!s}>לפי ברירת המחדל</option><option value="a" ?selected=${s==="a"}>${e.a}</option><option value="b" ?selected=${s==="b"}>${e.b}</option></select></sw-field></div>
    ...
    </div>`}async loadReport(e=!1){if($()){this.reportBusy=!0;try{this.report=await rl(e)}catch(t){this.error=w(t)}finally{this.reportBusy=!1}}}renderReport(){const e=this.report;if(!e)return r`<div class="sections"><sw-card heading="בריאות המערכת"><div class="muted">${this.reportBusy?"בודק…":"טוען…"}</div></sw-card></div>`;const t=new Intl.DateTimeFormat("he-IL",{hour:"2-digit",minute:"2-digit",second:"2-digit",hourCycle:"h23"}).format(new Date(e.checked_at));return r`<div class="sections">
      <sw-card heading="בריאות המערכת" subheading="מצב נפרד לכל רכיב, לא נורה אחת">
        <div class="hsum"><sw-badge kind=${Ji[e.status]} label=${e.status==="ok"?"הכל תקין":e.status==="warn"?"יש מה לבדוק":"יש תקלה"}></sw-badge><span>גרסה <span class="ltr">${e.version}</span> · פעיל ${nl(e.uptime_s)} · נבדק <span class="ltr" data-health-checked>${t}</span></span><span class="grow"></span><sw-button size="sm" icon="refresh" ?disabled=${this.reportBusy} @click=${()=>this.loadReport(!0)}>${this.reportBusy?"בודק…":"בדוק עכשיו"}</sw-button></div>
        <div class="hgrid">${e.checks.map(s=>r`<div class="hcard ${s.status}" data-health-card=${s.id}><div class="hh"><span>${s.label}</span><sw-badge kind=${Ji[s.status]} label=${Ba[s.status]}></sw-badge></div><div class="hd">${s.detail}</div></div>`)}</div>
      ...
      <sw-card heading="מצבים נפרדים, לא נורה אחת">${Pa.map(e=>r`<div class="row"><span class="lbl">${e.name}<span class="muted">${e.detail}</span></span><sw-badge kind=${e.state}></sw-badge></div>`)}
      ...
      <div>
        ...
        <div class="sub">${this.fmtWhen(e.created_at)} · ${pa(e.bytes)} · גרסה ${e.app_version??"?"}${e.note?` · ${e.note}`:""}</div>
        ${t?r`<div class="sub">${t} · ${e.files} קבצי תוכנית</div>`:c}
      </div>
      <div class="acts">
        <a href=${cc(e.name)} download=${e.name} data-backup-download><sw-button size="sm" icon="download">הורד</sw-button></a>
    ...
    ${this.restoreTarget?this.renderRestoreDialog(this.restoreTarget):c}`}renderSupport(){return r`<div class="sections"><sw-card heading="חבילת תמיכה מצונזרת">
      ...
      <sw-page heading="הגדרות המערכת" subheading=${$()?"תעבורת וידאו, go2rtc, מכסות ובריאות":"אזור זמן, מדיניות אחסון, אינטגרציות ובריאות · נתוני הדגמה"}>
        <sw-tabs underline .items=${ha} .active=${this.tab} @change=${e=>{this.tab=e.detail.id,this.tab==="media"&&this.loadMedia(),this.tab==="ha"&&this.loadHa(),this.tab==="backup"&&this.loadBackups(),this.tab==="health"&&this.loadReport()}}></sw-tabs>
  ...
  `;D([l()],C.prototype,"tab",2);D([l()],C.prototype,"settings",2);D([l()],C.prototype,"canEdit",2);D([l()],C.prototype,"draft",2);D([l()],C.prototype,"streams",2);D([l()],C.prototype,"go2rtc",2);D([l()],C.prototype,"foreign",2);D([l()],C.prototype,"sessions",2);D([l()],C.prototype,"busy",2);D([l()],C.prototype,"message",2);D([l()],C.prototype,"error",2);D([l()],C.prototype,"version",2);D([l()],C.prototype,"ha",2);D([l()],C.prototype,"pairing",2);D([l()],C.prototype,"showCode",2);D([l()],C.prototype,"regenArmed",2);D([l()],C.prototype,"copied",2);D([l()],C.prototype,"report",2);D([l()],C.prototype,"reportBusy",2);D([l()],C.prototype,"backups",2);D([l()],C.prototype,"backupPolicy",2);D([l()],C.prototype,"backupBusy",2);D([l()],C.prototype,"backupNote",2);D([l()],C.prototype,"backupMsg",2);D([l()],C.prototype,"restoreTarget",2);D([l()],C.prototype,"restoreMode",2);D([l()],C.prototype,"restoreAccess",2);D([l()],C.prototype,"restoreConfirm",2);D([l()],C.prototype,"health",2);C=D([k("system-diagnostics")],C);const fc=(e=!1)=>_(`storage${e?"?fresh=true":""}`);function Rt(e){return e==null?"—":e>=1024*1024?`${(e/1024/1024).toFixed(2)} TB`:e>=1024?`${(e/1024).toFixed(0)} GB`:`${e} MB`}var mc=Object.defineProperty,wc=Object.getOwnPropertyDescriptor,Ct=(e,t,s,i)=>{for(var a=i>1?void 0:i?wc(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&mc(t,s,a),a};const vc=[{name:"כניסה ראשית",gb:320},{name:"אולם",gb:410},{name:"חצר אחורית",gb:380},{name:"לובי",gb:180},{name:"מחסן",gb:96}];let Qe=class extends y{constructor(){super(...arguments),this.range="30D",this.data=null,this.error="",this.loading=!1,this.tz="Asia/Jerusalem"}connectedCallback(){super.connectedCallback(),$()&&this.load()}async load(e=!1){this.loading=!0,this.error="";try{const[t,s]=await Promise.all([Fe(),fc(e)]);this.tz=t["time.zone"]??this.tz,this.data=s}catch(t){this.error=w(t)}finally{this.loading=!1}}fmt(e){return e?new Intl.DateTimeFormat("he-IL",{timeZone:this.tz,dateStyle:"short",timeStyle:"short"}).format(new Date(e)):"—"}renderApi(){if(this.error&&!this.data)return r`<sw-page heading="אחסון ותוכנית הקלטה"><sw-state-panel state="error" hint=${this.error} actionLabel="נסה שוב" @action=${()=>this.load()}></sw-state-panel></sw-page>`;const e=this.data;if(!e)return r`<sw-page heading="אחסון ותוכנית הקלטה"><sw-state-panel state="loading"></sw-state-panel></sw-page>`;const t=e.totals,s=e.retention,i=16,a=2*Math.PI*i,n=t?.used_pct??0,o=s.measured_days_min==null?"—":s.measured_days_min===s.measured_days_max?`${s.measured_days_min}`:`${s.measured_days_min}–${s.measured_days_max}`;return r`
      <sw-page heading="אחסון ותוכנית הקלטה" subheading="קריאה בלבד מה־NVR · נמדד לעומת אומדן, עם הסיבה לכל מספר · אין format, RAID או מחיקה מכאן">
        ...
        ${e.nvr.configured?e.nvr.reachable?r`
                <div class="kpis" data-storage-kpis>
                  <sw-card flush class="kpi"><div><div class="v">${Rt(t?.used_mb)}</div><div class="l">בשימוש (נמדד מה־NVR)</div></div><div class="ic"><sw-icon name="storage" size=${16}></sw-icon></div></sw-card>
                  <sw-card flush class="kpi"><div><div class="v">${Rt(t?.capacity_mb)}</div><div class="l">קיבולת · ${t?.disks??0} דיסקים${t?.nas?` · ${t.nas} NAS`:""} · מצב ${e.work_mode??"?"}</div></div><div class="ic"><sw-icon name="cpu" size=${16}></sw-icon></div></sw-card>
                  <sw-card flush class="kpi"><div><div class="v">${t?.used_pct==null?"—":`${t.used_pct}%`}</div><div class="l">ניצולת · פנוי ${Rt(t?.free_mb)}</div></div><svg viewBox="0 0 40 40" aria-hidden="true">${p`<circle cx="20" cy="20" r=${i} fill="none" stroke="var(--sw-surface-3)" stroke-width="6" /><circle cx="20" cy="20" r=${i} fill="none" stroke="var(--sw-accent)" stroke-width="6" stroke-linecap="round" stroke-dasharray=${`${a*n/100} ${a}`} transform="rotate(-90 20 20)" />`}</svg></sw-card>
                </div>
                ...
                <div class="grid">
                  <sw-card heading="תוכנית הקלטה לפי מצלמה" subheading=${e.schedule_error??"נקרא מ־ISAPI record/tracks · pre/post בשניות · ההקלטה המוקדמת ביותר שנמצאה"}>
                    <div class="tbl cams" data-storage-cameras>
                      ...
                      ${e.cameras.map(d=>r`<div class="r" data-storage-camera><span>${d.name}<small>ערוץ ${d.channel}${d.track_id?` · track ${d.track_id}`:""}</small></span><span>${d.summary}${d.expiry&&d.expiry!=="P0DT0H"?r`<small>תפוגה ${d.expiry}</small>`:c}</span><span class="num">${d.pre_s??"—"} / ${d.post_s??"—"}</span><span class="num">${d.bitrate_kbps?`${d.bitrate_kbps} kbps`:"—"}${d.resolution?r`<small class="num">${d.resolution}${d.fps?` · ${d.fps} fps`:""}</small>`:c}</span><span>${this.fmt(d.oldest_recording_at)}<small>${d.retention_reason}</small></span><span class="num">${d.retention_days??"—"}</span></div>`)}
                    </div>
                  </sw-card>
                  <div>
                    <sw-card heading="דיסקים" subheading=${`${t?.disks_ok??0} מתוך ${(t?.disks??0)+(t?.nas??0)} תקינים`}>
                      <div class="tbl disks" data-storage-disks>
                        ...
                        ${[...e.disks,...e.nas].map(d=>r`<div class="r" data-storage-disk><span>${d.name}${d.path?r`<small>${d.path}</small>`:c}</span><span>${d.kind}</span><span><sw-badge kind=${d.status==="ok"?"recorded":"error"} label=${d.status}></sw-badge></span><span class="num">${Rt(d.capacity_mb)}</span><span class="num">${Rt(d.free_mb)}</span><span>${d.property}</span></div>`)}
                      </div>
                    </sw-card>
                    <sw-card heading="מה המערכת לא עושה ב־NVR" subheading="גבולות הפיילוט" data-storage-limits>
                      <ul class="limits">${e.limits.notes.map(d=>r`<li>${d}</li>`)}</ul>
    ...
    `}render(){if($())return this.renderApi();const e=[.3,.36,.45,.5,.58,.63,.7],t=600,s=200,i=f=>f/(e.length-1)*420,a=f=>170-f*150,n=e.map((f,g)=>`${g===0?"M":"L"}${i(g)} ${a(f)}`).join(" "),o=`M${i(e.length-1)} ${a(.7)} L520 ${a(.86)} L${t} ${a(1)}`,d=16,u=2*Math.PI*d,m=410;return r`
      <sw-page heading="אנליטיקת אחסון" subheading="Beta · ניטור שימוש, תכנון קדימה ושליטה · נתון נמדד לעומת אומדן מסומן · אין format או RAID · נתוני הדגמה">
        ...
        <div class="kpis">
          ...
          <sw-card flush class="kpi"><div><div class="v">68%</div><div class="l">ניצולת · ≈ 11 ימים נשמרים</div></div><svg viewBox="0 0 40 40" aria-hidden="true">${p`<circle cx="20" cy="20" r=${d} fill="none" stroke="var(--sw-surface-3)" stroke-width="6" /><circle cx="20" cy="20" r=${d} fill="none" stroke="var(--sw-accent)" stroke-width="6" stroke-linecap="round" stroke-dasharray=${`${u*.68} ${u}`} transform="rotate(-90 20 20)" />`}</svg></sw-card>
        </div>
        <sw-card heading="תחזית שימוש באחסון" subheading="עד הקו: נתון נמדד · אחרי הקו: אומדן (אינו תחזית פשוטה של דיסק מתמלא)">
          <svg class="trend" viewBox="0 0 ${t} ${s}" preserveAspectRatio="none" role="img" aria-label="תחזית אחסון">
            ${p`
              ...
              ${["ינו","פבר","מרץ","אפר","מאי","יונ","יול"].map((f,g)=>p`<text x=${i(g)} y="190" font-size="10" text-anchor="middle" fill="var(--sw-text-3)" font-family="var(--sw-font)">${f}</text>`)}
              ${["0.5 TB","1 TB","1.5 TB","1.9 TB"].map((f,g)=>p`<text x="4" y=${a(.25*(g+1))-3} font-size="9.5" fill="var(--sw-text-3)" font-family="var(--sw-font)">${f}</text>`)}
            `}
          </svg>
        </sw-card>
        <div class="grid">
          <sw-card heading="שימוש באחסון לפי מצלמה" subheading="נמדד · לפני retention">
            ${vc.map(f=>r`<div class="cam"><span>${f.name}</span><span class="bar"><i style="--p:${f.gb/m*100}%"></i></span><span class="gb ltr">${f.gb} GB</span></div>`)}
      ...
      <sw-page heading="כל המסכים (סקירת עיצוב)" subheading="29 מסכים על נתוני הדגמה · SC29/SC30 הם אותם מסכים ברוחב טלפון · SC32 (Lovelace) הוא עטיפה של אותם רכיבים">
        ...
        <div class="groups">
          ${yc.map(e=>r`<sw-card heading=${e.mode}>
              ${e.items.map(t=>r`<a href=${t.route}><span class="sc">${t.sc}</span><span class="name">${t.name}</span><span class="board">${t.board}</span><sw-badge kind=${$c[t.phase]} label=${t.phase}></sw-badge><sw-icon name="chevron" size=${12}></sw-icon></a>`)}
            </sw-card>`)}
        </div>
      </sw-page>
    `}};hi.styles=x`
  ...
  `;hi=gc([k("screens-index")],hi);var xc=Object.getOwnPropertyDescriptor,kc=(e,t,s,i)=>{for(var a=i>1?void 0:i?xc(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=o(a)||a);return a};const _c=[["--sw-bg","רקע"],["--sw-surface","משטח"],["--sw-surface-3","משטח 3"],["--sw-border","גבול"],["--sw-text","טקסט"],["--sw-text-2","טקסט משני"],["--sw-text-3","טקסט שלישי"],["--sw-accent","כחול"],["--sw-accent-soft","כחול רך"],["--sw-live","חי"],["--sw-offline","מנותק"],["--sw-stale","מיושן"],["--sw-danger","שגיאה"],["--sw-purple","סגול (דלת)"]],zc=["live","recorded","historic","offline","stale","partial","unknown","forbidden","error"],Sc=["loading","empty","error","forbidden","stale","partial"],Mc=["entrance","lobby","corridor","hall","parking","warehouse","backyard","driveway","night","building","house"],Ic=["dashboard","building","camera","bell","history","system","search","user","play","pause","back10","forward10","aperture","volume","mic","expand","close","chevron","chevronDown","warning","info","lock","unlock","offline","refresh","layers","floor","plus","minus","fit","door","light","sensor","check","clock","download","pin","more","map","upload","list","target","filter","users","shield","storage","edit","case","rule","link","grid","home","star","calendar","trash","eye","cpu","activity","image","wifi","signal","move","bookmark","route"];let ui=class extends y{render(){return r`
      ...
      <h3>צבעים</h3>
      <div class="swatches">
        ${_c.map(([e,t])=>r`<div class="swatch"><div class="c" style="background:var(${e})"></div><div class="n"><span>${t}</span><span class="ltr">${e}</span></div></div>`)}
      </div>
      ...
      <div class="scenes">${Mc.map(e=>r`<div><sw-scene kind=${e}></sw-scene><span>${e}</span></div>`)}</div>
      ...
      <div class="row">${zc.map(e=>r`<sw-badge kind=${e}></sw-badge>`)}</div>
      ...
      <h3>מצבי מסך</h3>
      <div class="grid">
        ${Sc.map(e=>r`<div class="panel"><sw-state-panel state=${e} actionLabel=${e==="error"?"נסה שוב":""}></sw-state-panel></div>`)}
      </div>

      <h3>אייקונים</h3>
      <div class="icons">${Ic.map(e=>r`<div class="icon"><sw-icon .name=${e} size=${18}></sw-icon><span class="ltr">${e}</span></div>`)}</div>
    `}};ui.styles=x`
    :host {
      display: block;
...
`):"כל הרכיבים שהתוסף רואה עובדים";return r`<button class="status-a sys ${t.status} ${e?"":"b"}" data-sys-pill data-status=${t.status} title=${a} aria-label=${`מצב המערכת: ${i}`} @click=${()=>window.location.hash="#/system/diagnostics?tab=health"}><i></i>${i}</button>`}renderSysBanner(){const e=this.sys;if(!e||e.status!=="error")return c;const t=e.items.filter(s=>s.status==="error");return r`<div class="sysbanner" role="alert" data-sys-banner><sw-icon name="warning" size=${16}></sw-icon><span>${t.map(s=>s.label).join(" · ")}</span><a href="#/system/diagnostics?tab=health">לבריאות המערכת</a></div>`}onSearchInput(e){const t=e.target.value;if(this.searchQ=t,window.clearTimeout(this.searchTimer),!t.trim()){this.searchResults=[],this.searchOpen=!1;return}this.searchTimer=window.setTimeout(()=>void this.runSearch(t),180)}async runSearch(e){if(!$()){this.searchResults=[],this.searchOpen=!0;return}const t=++this.searchSeq;this.searchBusy=!0;try{const s=await Ec(e,6);if(t!==this.searchSeq)return;this.searchResults=s.results,this.searchIndex=s.results.length?0:-1,this.searchOpen=!0}catch{t===this.searchSeq&&(this.searchResults=[],this.searchOpen=!0)}finally{t===this.searchSeq&&(this.searchBusy=!1)}}onSearchKey(e){if(e.key==="Escape"){this.closeSearch(),e.target.blur();return}if(!this.searchOpen||!this.searchResults.length){e.key==="Enter"&&this.searchQ.trim()&&this.runSearch(this.searchQ);return}if(e.key==="ArrowDown")e.preventDefault(),this.searchIndex=(this.searchIndex+1)%this.searchResults.length;else if(e.key==="ArrowUp")e.preventDefault(),this.searchIndex=(this.searchIndex-1+this.searchResults.length)%this.searchResults.length;else if(e.key==="Enter"){e.preventDefault();const t=this.searchResults[this.searchIndex]??this.searchResults[0];t&&this.openResult(t)}}openResult(e){this.closeSearch();const t=this.renderRoot.querySelector(".search input");t&&(t.value="",t.blur()),this.searchQ="",this.searchResults=[],window.location.hash=`#${e.route}`}closeSearch(){this.searchOpen=!1,this.searchIndex=-1}renderSearch(e){const t=this.searchOpen&&!!this.searchQ.trim();return r`<span class="searchwrap ${e?"a":""}">
      ...
      <header class="topbar">
        <div class="crumbs-a">${i.map((o,d)=>r`${d?r`<sw-icon name="chevron" size=${12}></sw-icon>`:c}<span class=${d===0?"strong":""}>${o}</span>`)}</div>
        ${this.renderSearch(!0)}
        <span class="spacer"></span>
      ...
      <main>
        ${this.renderGate()||r`
          <div class="subnav">${t.length>1&&!s?r`<sw-tabs .items=${t} .active=${ir(this.route)}></sw-tabs>`:c}</div>
    ...
    `}render(){if(this.route?.segments[0]==="kiosk")return r`<main style="block-size:100dvh">${this.renderScreen()}</main>`;if(this.design==="a")return this.renderA();const t=tr(this.route),s=t?Cc[t]:[],i=this.route?.segments[3]==="edit"||this.route?.segments[3]==="import";return r`
      <nav class="rail" aria-label="ניווט ראשי">
        <div class="brand">
          <img src="${"./"}brand/smplwise-mark.png" alt="SmplWise" />
          <span class="name">SmplWise</span>
        </div>
        ${ua.map(a=>r`<a class=${Ue({item:!0,active:t===a.id})} href=${a.href} title=${a.label} aria-current=${t===a.id?"page":"false"}>
      ...
      <main>
        ${this.renderGate()||r`
          <div class="subnav">${s.length>1&&!i?r`<sw-tabs .items=${s} .active=${Tc(this.route)}></sw-tabs>`:c}</div>
          <div class="screen">${this.session.mode==="loading"?c:this.renderScreen()}</div>`}
      </main>
      <nav class="bottom" aria-label="ניווט ראשי">
        ${ua.slice(0,4).map(a=>r`<a class=${Ue({active:t===a.id})} href=${a.href}><sw-icon .name=${a.icon} size=${20}></sw-icon>${a.label}</a>`)}
  ...
  `;Te([l()],ye.prototype,"route",2);Te([l()],ye.prototype,"session",2);Te([l()],ye.prototype,"design",2);Te([l()],ye.prototype,"sys",2);Te([l()],ye.prototype,"searchQ",2);Te([l()],ye.prototype,"searchResults",2);Te([l()],ye.prototype,"searchOpen",2);Te([l()],ye.prototype,"searchIndex",2);Te([l()],ye.prototype,"searchBusy",2);ye=Te([k("sw-app")],ye);
//# sourceMappingURL=index-Cqo8fKNB.js.map
