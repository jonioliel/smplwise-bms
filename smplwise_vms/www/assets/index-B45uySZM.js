 ...
 */const Os=globalThis,ji=Os.ShadowRoot&&(Os.ShadyCSS===void 0||Os.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,Fi=Symbol(),sa=new WeakMap;let Ga=class{constructor(t,s,i){if(this._$cssResult$=!0,i!==Fi)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=t,this.t=s}get styleSheet(){let t=this.o;const s=this.t;if(ji&&t===void 0){const i=s!==void 0&&s.length===1;i&&(t=sa.get(s)),t===void 0&&((this.o=t=new CSSStyleSheet).replaceSync(this.cssText),i&&sa.set(s,t))}return t}toString(){return this.cssText}};const Hr=e=>new Ga(typeof e=="string"?e:e+"",void 0,Fi),x=(e,...t)=>{const s=e.length===1?e[0]:t.reduce((i,a,n)=>i+(o=>{if(o._$cssResult$===!0)return o.cssText;if(typeof o=="number")return o;throw Error("Value passed to 'css' function must be a 'css' function result: "+o+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(a)+e[n+1],e[0]);return new Ga(s,e,Fi)},Vr=(e,t)=>{if(ji)e.adoptedStyleSheets=t.map(s=>s instanceof CSSStyleSheet?s:s.styleSheet);else for(const s of t){const i=document.createElement("style"),a=Os.litNonce;a!==void 0&&i.setAttribute("nonce",a),i.textContent=s.cssText,e.appendChild(i)}},ia=ji?e=>e:e=>e instanceof CSSStyleSheet?(t=>{let s="";for(const i of t.cssRules)s+=i.cssText;return Hr(s)})(e):e;/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const{is:jr,defineProperty:Fr,getOwnPropertyDescriptor:Ur,getOwnPropertyNames:Wr,getOwnPropertySymbols:Zr,getPrototypeOf:qr}=Object,Ks=globalThis,aa=Ks.trustedTypes,Kr=aa?aa.emptyScript:"",Gr=Ks.reactiveElementPolyfillSupport,is=(e,t)=>e,Ls={toAttribute(e,t){switch(t){case Boolean:e=e?Kr:null;break;case Object:case Array:e=e==null?e:JSON.stringify(e)}return e},fromAttribute(e,t){let s=e;switch(t){case Boolean:s=e!==null;break;case Number:s=e===null?null:Number(e);break;case Object:case Array:try{s=JSON.parse(e)}catch{s=null}}return s}},Ui=(e,t)=>!jr(e,t),ra={attribute:!0,type:String,converter:Ls,reflect:!1,useDefault:!1,hasChanged:Ui};Symbol.metadata??=Symbol("metadata"),Ks.litPropertyMetadata??=new WeakMap;let Lt=class extends HTMLElement{static addInitializer(t){this._$Ei(),(this.l??=[]).push(t)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(t,s=ra){if(s.state&&(s.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(t)&&((s=Object.create(s)).wrapped=!0),this.elementProperties.set(t,s),!s.noAccessor){const i=Symbol(),a=this.getPropertyDescriptor(t,i,s);a!==void 0&&Fr(this.prototype,t,a)}}static getPropertyDescriptor(t,s,i){const{get:a,set:n}=Ur(this.prototype,t)??{get(){return this[s]},set(o){this[s]=o}};return{get:a,set(o){const l=a?.call(this);n?.call(this,o),this.requestUpdate(t,l,i)},configurable:!0,enumerable:!0}}static getPropertyOptions(t){return this.elementProperties.get(t)??ra}static _$Ei(){if(this.hasOwnProperty(is("elementProperties")))return;const t=qr(this);t.finalize(),t.l!==void 0&&(this.l=[...t.l]),this.elementProperties=new Map(t.elementProperties)}static finalize(){if(this.hasOwnProperty(is("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(is("properties"))){const s=this.properties,i=[...Wr(s),...Zr(s)];for(const a of i)this.createProperty(a,s[a])}const t=this[Symbol.metadata];if(t!==null){const s=litPropertyMetadata.get(t);if(s!==void 0)for(const[i,a]of s)this.elementProperties.set(i,a)}this._$Eh=new Map;for(const[s,i]of this.elementProperties){const a=this._$Eu(s,i);a!==void 0&&this._$Eh.set(a,s)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(t){const s=[];if(Array.isArray(t)){const i=new Set(t.flat(1/0).reverse());for(const a of i)s.unshift(ia(a))}else t!==void 0&&s.push(ia(t));return s}static _$Eu(t,s){const i=s.attribute;return i===!1?void 0:typeof i=="string"?i:typeof t=="string"?t.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise(t=>this.enableUpdating=t),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach(t=>t(this))}addController(t){(this._$EO??=new Set).add(t),this.renderRoot!==void 0&&this.isConnected&&t.hostConnected?.()}removeController(t){this._$EO?.delete(t)}_$E_(){const t=new Map,s=this.constructor.elementProperties;for(const i of s.keys())this.hasOwnProperty(i)&&(t.set(i,this[i]),delete this[i]);t.size>0&&(this._$Ep=t)}createRenderRoot(){const t=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return Vr(t,this.constructor.elementStyles),t}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this._$EO?.forEach(t=>t.hostConnected?.())}enableUpdating(t){}disconnectedCallback(){this._$EO?.forEach(t=>t.hostDisconnected?.())}attributeChangedCallback(t,s,i){this._$AK(t,i)}_$ET(t,s){const i=this.constructor.elementProperties.get(t),a=this.constructor._$Eu(t,i);if(a!==void 0&&i.reflect===!0){const n=(i.converter?.toAttribute!==void 0?i.converter:Ls).toAttribute(s,i.type);this._$Em=t,n==null?this.removeAttribute(a):this.setAttribute(a,n),this._$Em=null}}_$AK(t,s){const i=this.constructor,a=i._$Eh.get(t);if(a!==void 0&&this._$Em!==a){const n=i.getPropertyOptions(a),o=typeof n.converter=="function"?{fromAttribute:n.converter}:n.converter?.fromAttribute!==void 0?n.converter:Ls;this._$Em=a;const l=o.fromAttribute(s,n.type);this[a]=l??this._$Ej?.get(a)??l,this._$Em=null}}requestUpdate(t,s,i,a=!1,n){if(t!==void 0){const o=this.constructor;if(a===!1&&(n=this[t]),i??=o.getPropertyOptions(t),!((i.hasChanged??Ui)(n,s)||i.useDefault&&i.reflect&&n===this._$Ej?.get(t)&&!this.hasAttribute(o._$Eu(t,i))))return;this.C(t,s,i)}this.isUpdatePending===!1&&(this._$ES=this._$EP())}C(t,s,{useDefault:i,reflect:a,wrapped:n},o){i&&!(this._$Ej??=new Map).has(t)&&(this._$Ej.set(t,o??s??this[t]),n!==!0||o!==void 0)||(this._$AL.has(t)||(this.hasUpdated||i||(s=void 0),this._$AL.set(t,s)),a===!0&&this._$Em!==t&&(this._$Eq??=new Set).add(t))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(s){Promise.reject(s)}const t=this.scheduleUpdate();return t!=null&&await t,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),this._$Ep){for(const[a,n]of this._$Ep)this[a]=n;this._$Ep=void 0}const i=this.constructor.elementProperties;if(i.size>0)for(const[a,n]of i){const{wrapped:o}=n,l=this[a];o!==!0||this._$AL.has(a)||l===void 0||this.C(a,void 0,n,l)}}let t=!1;const s=this._$AL;try{t=this.shouldUpdate(s),t?(this.willUpdate(s),this._$EO?.forEach(i=>i.hostUpdate?.()),this.update(s)):this._$EM()}catch(i){throw t=!1,this._$EM(),i}t&&this._$AE(s)}willUpdate(t){}_$AE(t){this._$EO?.forEach(s=>s.hostUpdated?.()),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(t)),this.updated(t)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(t){return!0}update(t){this._$Eq&&=this._$Eq.forEach(s=>this._$ET(s,this[s])),this._$EM()}updated(t){}firstUpdated(t){}};Lt.elementStyles=[],Lt.shadowRootOptions={mode:"open"},Lt[is("elementProperties")]=new Map,Lt[is("finalized")]=new Map,Gr?.({ReactiveElement:Lt}),(Ks.reactiveElementVersions??=[]).push("2.1.2");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Wi=globalThis,na=e=>e,Hs=Wi.trustedTypes,oa=Hs?Hs.createPolicy("lit-html",{createHTML:e=>e}):void 0,Ya="$lit$",ct=`lit$${Math.random().toFixed(9).slice(2)}$`,Ja="?"+ct,Yr=`<${Ja}>`,St=document,hs=()=>St.createComment(""),us=e=>e===null||typeof e!="object"&&typeof e!="function",Zi=Array.isArray,Jr=e=>Zi(e)||typeof e?.[Symbol.iterator]=="function",oi=`[ 	
\f\r]`,ts=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,la=/-->/g,da=/>/g,yt=RegExp(`>|${oi}(?:([^\\s"'>=/]+)(${oi}*=${oi}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),ca=/'/g,pa=/"/g,Xa=/^(?:script|style|textarea|title)$/i,Qa=e=>(t,...s)=>({_$litType$:e,strings:t,values:s}),r=Qa(1),h=Qa(2),Mt=Symbol.for("lit-noChange"),c=Symbol.for("lit-nothing"),ha=new WeakMap,_t=St.createTreeWalker(St,129);function er(e,t){if(!Zi(e)||!e.hasOwnProperty("raw"))throw Error("invalid template strings array");return oa!==void 0?oa.createHTML(t):t}const Xr=(e,t)=>{const s=e.length-1,i=[];let a,n=t===2?"<svg>":t===3?"<math>":"",o=ts;for(let l=0;l<s;l++){const p=e[l];let m,f,v=-1,M=0;for(;M<p.length&&(o.lastIndex=M,f=o.exec(p),f!==null);)M=o.lastIndex,o===ts?f[1]==="!--"?o=la:f[1]!==void 0?o=da:f[2]!==void 0?(Xa.test(f[2])&&(a=RegExp("</"+f[2],"g")),o=yt):f[3]!==void 0&&(o=yt):o===yt?f[0]===">"?(o=a??ts,v=-1):f[1]===void 0?v=-2:(v=o.lastIndex-f[2].length,m=f[1],o=f[3]===void 0?yt:f[3]==='"'?pa:ca):o===pa||o===ca?o=yt:o===la||o===da?o=ts:(o=yt,a=void 0);const _=o===yt&&e[l+1].startsWith("/>")?" ":"";n+=o===ts?p+Yr:v>=0?(i.push(m),p.slice(0,v)+Ya+p.slice(v)+ct+_):p+ct+(v===-2?l:_)}return[er(e,n+(e[s]||"<?>")+(t===2?"</svg>":t===3?"</math>":"")),i]};class ms{constructor({strings:t,_$litType$:s},i){let a;this.parts=[];let n=0,o=0;const l=t.length-1,p=this.parts,[m,f]=Xr(t,s);if(this.el=ms.createElement(m,i),_t.currentNode=this.el.content,s===2||s===3){const v=this.el.content.firstChild;v.replaceWith(...v.childNodes)}for(;(a=_t.nextNode())!==null&&p.length<l;){if(a.nodeType===1){if(a.hasAttributes())for(const v of a.getAttributeNames())if(v.endsWith(Ya)){const M=f[o++],_=a.getAttribute(v).split(ct),O=/([.?@])?(.*)/.exec(M);p.push({type:1,index:n,name:O[2],strings:_,ctor:O[1]==="."?en:O[1]==="?"?tn:O[1]==="@"?sn:Gs}),a.removeAttribute(v)}else v.startsWith(ct)&&(p.push({type:6,index:n}),a.removeAttribute(v));if(Xa.test(a.tagName)){const v=a.textContent.split(ct),M=v.length-1;if(M>0){a.textContent=Hs?Hs.emptyScript:"";for(let _=0;_<M;_++)a.append(v[_],hs()),_t.nextNode(),p.push({type:2,index:++n});a.append(v[M],hs())}}}else if(a.nodeType===8)if(a.data===Ja)p.push({type:2,index:n});else{let v=-1;for(;(v=a.data.indexOf(ct,v+1))!==-1;)p.push({type:7,index:n}),v+=ct.length-1}n++}}static createElement(t,s){const i=St.createElement("template");return i.innerHTML=t,i}}function Vt(e,t,s=e,i){if(t===Mt)return t;let a=i!==void 0?s._$Co?.[i]:s._$Cl;const n=us(t)?void 0:t._$litDirective$;return a?.constructor!==n&&(a?._$AO?.(!1),n===void 0?a=void 0:(a=new n(e),a._$AT(e,s,i)),i!==void 0?(s._$Co??=[])[i]=a:s._$Cl=a),a!==void 0&&(t=Vt(e,a._$AS(e,t.values),a,i)),t}class Qr{constructor(t,s){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=s}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){const{el:{content:s},parts:i}=this._$AD,a=(t?.creationScope??St).importNode(s,!0);_t.currentNode=a;let n=_t.nextNode(),o=0,l=0,p=i[0];for(;p!==void 0;){if(o===p.index){let m;p.type===2?m=new $s(n,n.nextSibling,this,t):p.type===1?m=new p.ctor(n,p.name,p.strings,this,t):p.type===6&&(m=new an(n,this,t)),this._$AV.push(m),p=i[++l]}o!==p?.index&&(n=_t.nextNode(),o++)}return _t.currentNode=St,a}p(t){let s=0;for(const i of this._$AV)i!==void 0&&(i.strings!==void 0?(i._$AI(t,i,s),s+=i.strings.length-2):i._$AI(t[s])),s++}}class $s{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(t,s,i,a){this.type=2,this._$AH=c,this._$AN=void 0,this._$AA=t,this._$AB=s,this._$AM=i,this.options=a,this._$Cv=a?.isConnected??!0}get parentNode(){let t=this._$AA.parentNode;const s=this._$AM;return s!==void 0&&t?.nodeType===11&&(t=s.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,s=this){t=Vt(this,t,s),us(t)?t===c||t==null||t===""?(this._$AH!==c&&this._$AR(),this._$AH=c):t!==this._$AH&&t!==Mt&&this._(t):t._$litType$!==void 0?this.$(t):t.nodeType!==void 0?this.T(t):Jr(t)?this.k(t):this._(t)}O(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.O(t))}_(t){this._$AH!==c&&us(this._$AH)?this._$AA.nextSibling.data=t:this.T(St.createTextNode(t)),this._$AH=t}$(t){const{values:s,_$litType$:i}=t,a=typeof i=="number"?this._$AC(t):(i.el===void 0&&(i.el=ms.createElement(er(i.h,i.h[0]),this.options)),i);if(this._$AH?._$AD===a)this._$AH.p(s);else{const n=new Qr(a,this),o=n.u(this.options);n.p(s),this.T(o),this._$AH=n}}_$AC(t){let s=ha.get(t.strings);return s===void 0&&ha.set(t.strings,s=new ms(t)),s}k(t){Zi(this._$AH)||(this._$AH=[],this._$AR());const s=this._$AH;let i,a=0;for(const n of t)a===s.length?s.push(i=new $s(this.O(hs()),this.O(hs()),this,this.options)):i=s[a],i._$AI(n),a++;a<s.length&&(this._$AR(i&&i._$AB.nextSibling,a),s.length=a)}_$AR(t=this._$AA.nextSibling,s){for(this._$AP?.(!1,!0,s);t!==this._$AB;){const i=na(t).nextSibling;na(t).remove(),t=i}}setConnected(t){this._$AM===void 0&&(this._$Cv=t,this._$AP?.(t))}}class Gs{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,s,i,a,n){this.type=1,this._$AH=c,this._$AN=void 0,this.element=t,this.name=s,this._$AM=a,this.options=n,i.length>2||i[0]!==""||i[1]!==""?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=c}_$AI(t,s=this,i,a){const n=this.strings;let o=!1;if(n===void 0)t=Vt(this,t,s,0),o=!us(t)||t!==this._$AH&&t!==Mt,o&&(this._$AH=t);else{const l=t;let p,m;for(t=n[0],p=0;p<n.length-1;p++)m=Vt(this,l[i+p],s,p),m===Mt&&(m=this._$AH[p]),o||=!us(m)||m!==this._$AH[p],m===c?t=c:t!==c&&(t+=(m??"")+n[p+1]),this._$AH[p]=m}o&&!a&&this.j(t)}j(t){t===c?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}}class en extends Gs{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===c?void 0:t}}class tn extends Gs{constructor(){super(...arguments),this.type=4}j(t){this.element.toggleAttribute(this.name,!!t&&t!==c)}}class sn extends Gs{constructor(t,s,i,a,n){super(t,s,i,a,n),this.type=5}_$AI(t,s=this){if((t=Vt(this,t,s,0)??c)===Mt)return;const i=this._$AH,a=t===c&&i!==c||t.capture!==i.capture||t.once!==i.once||t.passive!==i.passive,n=t!==c&&(i===c||a);a&&this.element.removeEventListener(this.name,this,i),n&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,t):this._$AH.handleEvent(t)}}class an{constructor(t,s,i){this.element=t,this.type=6,this._$AN=void 0,this._$AM=s,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(t){Vt(this,t)}}const rn=Wi.litHtmlPolyfillSupport;rn?.(ms,$s),(Wi.litHtmlVersions??=[]).push("3.3.3");const nn=(e,t,s)=>{const i=s?.renderBefore??t;let a=i._$litPart$;if(a===void 0){const n=s?.renderBefore??null;i._$litPart$=a=new $s(t.insertBefore(hs(),n),n,void 0,s??{})}return a._$AI(e),a};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const qi=globalThis;let $=class extends Lt{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){const t=super.createRenderRoot();return this.renderOptions.renderBefore??=t.firstChild,t}update(t){const s=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=nn(s,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return Mt}};$._$litElement$=!0,$.finalized=!0,qi.litElementHydrateSupport?.({LitElement:$});const on=qi.litElementPolyfillSupport;on?.({LitElement:$});(qi.litElementVersions??=[]).push("4.2.2");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 */const ot=hn(class extends un{constructor(e){if(super(e),e.type!==pn.ATTRIBUTE||e.name!=="class"||e.strings?.length>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(e){return" "+Object.keys(e).filter(t=>e[t]).join(" ")+" "}update(e,[t]){if(this.st===void 0){this.st=new Set,e.strings!==void 0&&(this.nt=new Set(e.strings.join(" ").split(/\s/).filter(i=>i!=="")));for(const i in t)t[i]&&!this.nt?.has(i)&&this.st.add(i);return this.render(t)}const s=e.element.classList;for(const i of this.st)i in t||(s.remove(i),this.st.delete(i));for(const i in t){const a=!!t[i];a===this.st.has(i)||this.nt?.has(i)||(a?(s.add(i),this.st.add(i)):(s.remove(i),this.st.delete(i)))}return Mt}});var mn=Object.defineProperty,fn=Object.getOwnPropertyDescriptor,Ys=(e,t,s,i)=>{for(var a=i>1?void 0:i?fn(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&mn(t,s,a),a};const ua={live:h`<circle cx="12" cy="12" r="3"/><path d="M6.3 6.3a8 8 0 0 0 0 11.4M17.7 6.3a8 8 0 0 1 0 11.4M3.5 3.5a12 12 0 0 0 0 17M20.5 3.5a12 12 0 0 1 0 17"/>`,explore:h`<path d="M3 6.5 9 4l6 2.5 6-2.5v13.5L15 20l-6-2.5L3 20z"/><path d="M9 4v13.5M15 6.5V20"/>`,investigate:h`<circle cx="11" cy="11" r="6.5"/><path d="m20 20-4.3-4.3M11 8v3l2 1.5"/>`,system:h`<circle cx="12" cy="12" r="3"/><path d="M19.4 15a1.7 1.7 0 0 0 .3 1.8l.1.1a2 2 0 1 1-2.8 2.8l-.1-.1a1.7 1.7 0 0 0-1.8-.3 1.7 1.7 0 0 0-1 1.5V21a2 2 0 1 1-4 0v-.1a1.7 1.7 0 0 0-1.1-1.5 1.7 1.7 0 0 0-1.8.3l-.1.1a2 2 0 1 1-2.8-2.8l.1-.1a1.7 1.7 0 0 0 .3-1.8 1.7 1.7 0 0 0-1.5-1H3a2 2 0 1 1 0-4h.1a1.7 1.7 0 0 0 1.5-1.1 1.7 1.7 0 0 0-.3-1.8l-.1-.1a2 2 0 1 1 2.8-2.8l.1.1a1.7 1.7 0 0 0 1.8.3H9a1.7 1.7 0 0 0 1-1.5V3a2 2 0 1 1 4 0v.1a1.7 1.7 0 0 0 1 1.5 1.7 1.7 0 0 0 1.8-.3l.1-.1a2 2 0 1 1 2.8 2.8l-.1.1a1.7 1.7 0 0 0-.3 1.8V9a1.7 1.7 0 0 0 1.5 1H21a2 2 0 1 1 0 4h-.1a1.7 1.7 0 0 0-1.5 1z"/>`,camera:h`<path d="M3 8.5A1.5 1.5 0 0 1 4.5 7H8l1.5-2h5L16 7h3.5A1.5 1.5 0 0 1 21 8.5v9a1.5 1.5 0 0 1-1.5 1.5h-15A1.5 1.5 0 0 1 3 17.5z"/><circle cx="12" cy="13" r="3.5"/>`,search:h`<circle cx="11" cy="11" r="6.5"/><path d="m20 20-4.3-4.3"/>`,bell:h`<path d="M6 16V11a6 6 0 0 1 12 0v5l1.5 2h-15z"/><path d="M10 20a2 2 0 0 0 4 0"/>`,user:h`<circle cx="12" cy="8" r="4"/><path d="M4 21a8 8 0 0 1 16 0"/>`,play:h`<path d="M7 5v14l11-7z"/>`,expand:h`<path d="M15 4h5v5M9 20H4v-5M20 4l-6 6M4 20l6-6"/>`,close:h`<path d="M6 6l12 12M18 6 6 18"/>`,chevron:h`<path d="m9 6 6 6-6 6"/>`,warning:h`<path d="M12 3 2.5 20h19z"/><path d="M12 9v5M12 17h.01"/>`,info:h`<circle cx="12" cy="12" r="9"/><path d="M12 11v5M12 8h.01"/>`,lock:h`<rect x="5" y="11" width="14" height="10" rx="2"/><path d="M8 11V7a4 4 0 0 1 8 0v4"/>`,unlock:h`<rect x="5" y="11" width="14" height="10" rx="2"/><path d="M8 11V7a4 4 0 0 1 7.5-2"/>`,offline:h`<path d="M2 8.5a15 15 0 0 1 20 0M5.5 12a10 10 0 0 1 13 0M9 15.5a5 5 0 0 1 6 0"/><path d="M12 19h.01"/><path d="M3 3l18 18"/>`,refresh:h`<path d="M20 12a8 8 0 1 1-2.3-5.7"/><path d="M20 4v5h-5"/>`,layers:h`<path d="m12 3 9 5-9 5-9-5z"/><path d="m3 13 9 5 9-5M3 17.5l9 5 9-5"/>`,floor:h`<path d="M4 6h16M4 12h16M4 18h16"/><path d="M8 3v18"/>`,plus:h`<path d="M12 5v14M5 12h14"/>`,minus:h`<path d="M5 12h14"/>`,fit:h`<path d="M4 9V4h5M20 9V4h-5M4 15v5h5M20 15v5h-5"/>`,door:h`<rect x="6" y="3" width="12" height="18" rx="1"/><path d="M14 12h.01"/>`,light:h`<path d="M9 18h6M10 21h4"/><path d="M12 3a6 6 0 0 0-3.5 10.9c.8.6 1.5 1.6 1.5 2.6h4c0-1 .7-2 1.5-2.6A6 6 0 0 0 12 3z"/>`,sensor:h`<circle cx="12" cy="12" r="2"/><path d="M7.8 7.8a6 6 0 0 0 0 8.4M16.2 7.8a6 6 0 0 1 0 8.4M4.9 4.9a10 10 0 0 0 0 14.2M19.1 4.9a10 10 0 0 1 0 14.2"/>`,check:h`<path d="m5 12 5 5 9-10"/>`,clock:h`<circle cx="12" cy="12" r="9"/><path d="M12 7v5l3 2"/>`,download:h`<path d="M12 4v11M7 10l5 5 5-5M4 20h16"/>`,pin:h`<path d="M9 4h6l-1 6 3 3v2H7v-2l3-3z"/><path d="M12 15v6"/>`,more:h`<circle cx="6" cy="12" r="1.3"/><circle cx="12" cy="12" r="1.3"/><circle cx="18" cy="12" r="1.3"/>`,building:h`<rect x="4" y="3" width="16" height="18" rx="1"/><path d="M9 7h2M13 7h2M9 11h2M13 11h2M9 15h2M13 15h2M10 21v-3h4v3"/>`,map:h`<path d="M3 6.5 9 4l6 2.5 6-2.5v13.5L15 20l-6-2.5L3 20z"/>`,upload:h`<path d="M12 16V5M7 10l5-5 5 5M4 20h16"/>`,list:h`<path d="M8 6h13M8 12h13M8 18h13M3 6h.01M3 12h.01M3 18h.01"/>`,history:h`<path d="M3 12a9 9 0 1 0 3-6.7"/><path d="M3 4v5h5M12 8v4l3 2"/>`,target:h`<circle cx="12" cy="12" r="8"/><circle cx="12" cy="12" r="3"/><path d="M12 2v4M12 18v4M2 12h4M18 12h4"/>`,filter:h`<path d="M4 5h16l-6 8v6l-4-2v-4z"/>`,users:h`<circle cx="9" cy="8" r="3.5"/><path d="M2.5 20a6.5 6.5 0 0 1 13 0"/><circle cx="17" cy="9" r="2.5"/><path d="M15.5 14.5A5 5 0 0 1 21.5 20"/>`,shield:h`<path d="M12 3 4 6v6c0 4.5 3.4 7.7 8 9 4.6-1.3 8-4.5 8-9V6z"/><path d="m9 12 2 2 4-4"/>`,storage:h`<rect x="3" y="4" width="18" height="6" rx="1.5"/><rect x="3" y="14" width="18" height="6" rx="1.5"/><path d="M7 7h.01M7 17h.01"/>`,edit:h`<path d="M4 20h4l10.5-10.5a2 2 0 0 0 0-2.8l-1.2-1.2a2 2 0 0 0-2.8 0L4 16z"/><path d="m13 7 4 4"/>`,pause:h`<path d="M8 5v14M16 5v14"/>`,skip:h`<path d="M5 5v14l8-7zM15 5h2v14h-2z"/>`,case:h`<rect x="3" y="7" width="18" height="13" rx="2"/><path d="M8 7V5a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2M3 12h18"/>`,rule:h`<path d="M4 6h10M4 12h16M4 18h7"/><circle cx="18" cy="6" r="2"/><circle cx="15" cy="18" r="2"/>`,link:h`<path d="M10 14a4 4 0 0 0 5.7 0l3-3a4 4 0 0 0-5.7-5.7l-1 1"/><path d="M14 10a4 4 0 0 0-5.7 0l-3 3a4 4 0 0 0 5.7 5.7l1-1"/>`,grid:h`<rect x="3" y="3" width="7" height="7" rx="1.5"/><rect x="14" y="3" width="7" height="7" rx="1.5"/><rect x="3" y="14" width="7" height="7" rx="1.5"/><rect x="14" y="14" width="7" height="7" rx="1.5"/>`,dashboard:h`<rect x="3" y="3" width="8" height="10" rx="1.5"/><rect x="13" y="3" width="8" height="6" rx="1.5"/><rect x="13" y="11" width="8" height="10" rx="1.5"/><rect x="3" y="15" width="8" height="6" rx="1.5"/>`,home:h`<path d="M3 11 12 4l9 7"/><path d="M5 10v10h14V10"/><path d="M10 20v-6h4v6"/>`,star:h`<path d="m12 3 2.8 5.7 6.2.9-4.5 4.4 1 6.2-5.5-2.9L6.5 20.2l1-6.2L3 9.6l6.2-.9z"/>`,aperture:h`<circle cx="12" cy="12" r="9"/><path d="m14.3 4.5-5 8.6M20.7 9.5H10.8M18.4 17.5l-5-8.6M9.7 19.5l5-8.6M3.3 14.5h9.9M5.6 6.5l5 8.6"/>`,volume:h`<path d="M4 9.5v5h3.5L12 18.5v-13L7.5 9.5z"/><path d="M15.5 8.5a5 5 0 0 1 0 7M18.5 5.5a9 9 0 0 1 0 13"/>`,mic:h`<rect x="9" y="3" width="6" height="11" rx="3"/><path d="M5.5 11a6.5 6.5 0 0 0 13 0M12 17.5V21M9 21h6"/>`,back10:h`<path d="M4 12a8 8 0 1 0 2.3-5.7"/><path d="M4 4v5h5"/><path d="M10.5 15.5V10l-1.5 1"/><rect x="13.5" y="10" width="3.5" height="5.5" rx="1.7"/>`,forward10:h`<path d="M20 12a8 8 0 1 1-2.3-5.7"/><path d="M20 4v5h-5"/><path d="M10.5 15.5V10l-1.5 1"/><rect x="13.5" y="10" width="3.5" height="5.5" rx="1.7"/>`,chevronDown:h`<path d="m6 9 6 6 6-6"/>`,stairs:h`<path d="M3 20h4v-4h4v-4h4V8h5"/>`,elevator:h`<rect x="4" y="3" width="16" height="18" rx="1.5"/><path d="M12 3v18M8 10l1.5-2 1.5 2M14.5 14l1.5 2 1.5-2"/>`,menu:h`<path d="M4 7h16M4 12h16M4 17h16"/>`,calendar:h`<rect x="3" y="5" width="18" height="16" rx="2"/><path d="M3 10h18M8 3v4M16 3v4"/>`,trash:h`<path d="M4 7h16M9 7V4h6v3M6 7l1 13h10l1-13"/>`,eye:h`<path d="M2 12s3.5-6 10-6 10 6 10 6-3.5 6-10 6S2 12 2 12z"/><circle cx="12" cy="12" r="3"/>`,cpu:h`<rect x="6" y="6" width="12" height="12" rx="2"/><rect x="9" y="9" width="6" height="6"/><path d="M9 2v4M15 2v4M9 18v4M15 18v4M2 9h4M2 15h4M18 9h4M18 15h4"/>`,activity:h`<path d="M3 12h4l3-8 4 16 3-8h4"/>`,image:h`<rect x="3" y="4" width="18" height="16" rx="2"/><circle cx="8.5" cy="9.5" r="1.5"/><path d="m21 16-5-5-9 9"/>`,wifi:h`<path d="M2 8.5a15 15 0 0 1 20 0M5.5 12a10 10 0 0 1 13 0M9 15.5a5 5 0 0 1 6 0"/><path d="M12 19h.01"/>`,signal:h`<path d="M4 18v-3M9 18v-7M14 18V7M19 18V4"/>`,move:h`<path d="M12 3v18M3 12h18M8 7l4-4 4 4M8 17l4 4 4-4M7 8l-4 4 4 4M17 8l4 4-4 4"/>`,bookmark:h`<path d="M6 3h12v18l-6-4-6 4z"/>`,route:h`<circle cx="6" cy="18" r="2.5"/><circle cx="18" cy="6" r="2.5"/><path d="M8 17c5-1 3-9 8-10"/>`,logout:h`<path d="M10 4H5v16h5M14 8l4 4-4 4M18 12H9"/>`};let jt=class extends ${constructor(){super(...arguments),this.name="info",this.size=20,this.flip=!1}render(){this.style.setProperty("--sw-icon-size",`${this.size}px`);const e=this.name==="chevron";return r`<svg viewBox="0 0 24 24" aria-hidden="true" ?data-dir=${e}>${ua[this.name]??ua.info}</svg>`}};jt.styles=x`
  ...
  `;Ys([u()],jt.prototype,"name",2);Ys([u({type:Number})],jt.prototype,"size",2);Ys([u({type:Boolean,reflect:!0})],jt.prototype,"flip",2);jt=Ys([k("sw-icon")],jt);var wn=Object.defineProperty,vn=Object.getOwnPropertyDescriptor,it=(e,t,s,i)=>{for(var a=i>1?void 0:i?vn(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&wn(t,s,a),a};let Oe=class extends ${constructor(){super(...arguments),this.variant="secondary",this.size="md",this.disabled=!1,this.iconOnly=!1,this.round=!1,this.label="",this.type="button"}render(){return r`
  ...
  `;Js([u({reflect:!0})],Ft.prototype,"kind",2);Js([u()],Ft.prototype,"label",2);Js([u({type:Boolean,reflect:!0})],Ft.prototype,"onImage",2);Ft=Js([k("sw-badge")],Ft);var xn=Object.defineProperty,kn=Object.getOwnPropertyDescriptor,xs=(e,t,s,i)=>{for(var a=i>1?void 0:i?kn(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&xn(t,s,a),a};let At=class extends ${constructor(){super(...arguments),this.items=[],this.active="",this.segmented=!1,this.underline=!1}choose(e){this.active=e.id,this.dispatchEvent(new CustomEvent("change",{detail:{id:e.id},bubbles:!0,composed:!0}))}render(){return r`${this.items.map(e=>e.href?r`<a href=${e.href} class=${e.id===this.active?"on":""} aria-current=${e.id===this.active?"page":"false"}>${e.label}${e.count!==void 0?r`<span class="count">(${e.count})</span>`:""}</a>`:r`<button type="button" class=${e.id===this.active?"on":""} aria-pressed=${e.id===this.active} @click=${()=>this.choose(e)}>${e.label}${e.count!==void 0?r`<span class="count">(${e.count})</span>`:""}</button>`)}`}};At.styles=x`
    :host {
      display: inline-flex;
      gap: 2px;
      overflow-x: auto;
  ...
  `;xs([u({attribute:!1})],At.prototype,"items",2);xs([u()],At.prototype,"active",2);xs([u({type:Boolean,reflect:!0})],At.prototype,"segmented",2);xs([u({type:Boolean,reflect:!0})],At.prototype,"underline",2);At=xs([k("sw-tabs")],At);var _n=Object.defineProperty,zn=Object.getOwnPropertyDescriptor,Ki=(e,t,s,i)=>{for(var a=i>1?void 0:i?zn(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&_n(t,s,a),a};let fs=class extends ${constructor(){super(...arguments),this.name="",this.size=32}render(){this.style.setProperty("--sz",`${this.size}px`);const e=this.name.trim().split(/\s+/),t=e.length>1?e[0][0]+e[1][0]:this.name.slice(0,2);return r`${t}`}};fs.styles=x`
    :host {
      display: inline-grid;
      place-items: center;
  ...
  `;Ki([u()],fs.prototype,"name",2);Ki([u({type:Number})],fs.prototype,"size",2);fs=Ki([k("sw-avatar")],fs);var Sn=Object.defineProperty,Mn=Object.getOwnPropertyDescriptor,ks=(e,t,s,i)=>{for(var a=i>1?void 0:i?Mn(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&Sn(t,s,a),a};let It=class extends ${constructor(){super(...arguments),this.selected=!1,this.dot=""}render(){return r`
  ...
  `;ks([u({type:Boolean,reflect:!0})],It.prototype,"selected",2);ks([u()],It.prototype,"icon",2);ks([u({type:Number})],It.prototype,"count",2);ks([u()],It.prototype,"dot",2);It=ks([k("sw-chip")],It);var An=Object.defineProperty,In=Object.getOwnPropertyDescriptor,Xs=(e,t,s,i)=>{for(var a=i>1?void 0:i?In(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&An(t,s,a),a};let Ut=class extends ${constructor(){super(...arguments),this.open=!1,this.heading="",this.subheading=""}close(){this.open=!1,this.dispatchEvent(new CustomEvent("close",{bubbles:!0,composed:!0}))}render(){return r`
  ...
  `;Gt([u()],pt.prototype,"heading",2);Gt([u({type:Number})],pt.prototype,"x",2);Gt([u({type:Number})],pt.prototype,"y",2);Gt([u({type:Number})],pt.prototype,"stageWidth",2);Gt([u({type:Number})],pt.prototype,"stageHeight",2);pt=Gt([k("sw-popover")],pt);var Cn=Object.defineProperty,Tn=Object.getOwnPropertyDescriptor,Qs=(e,t,s,i)=>{for(var a=i>1?void 0:i?Tn(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&Cn(t,s,a),a};let Wt=class extends ${constructor(){super(...arguments),this.label="",this.hint="",this.inline=!1}render(){return r`
  ...
  `;Qs([u()],Wt.prototype,"label",2);Qs([u()],Wt.prototype,"hint",2);Qs([u({type:Boolean,reflect:!0})],Wt.prototype,"inline",2);Wt=Qs([k("sw-field")],Wt);var Dn=Object.defineProperty,On=Object.getOwnPropertyDescriptor,tr=(e,t,s,i)=>{for(var a=i>1?void 0:i?On(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&Dn(t,s,a),a};let Rn=0,Vs=class extends ${constructor(){super(...arguments),this.kind="lobby",this.uid=`sc${Rn+=1}`}grad(e,t,s=!0){const i=`${e}-${this.uid}`;return h`<linearGradient id=${i} x1="0" y1="0" x2=${s?0:1} y2=${s?1:0}>${t.map(([a,n])=>h`<stop offset=${a} stop-color=${n} />`)}</linearGradient>`}url(e){return`url(#${e}-${this.uid})`}vignette(){const e=`vig-${this.uid}`;return h`<defs><radialGradient id=${e} cx="50%" cy="45%" r="72%"><stop offset="0.55" stop-color="#000" stop-opacity="0" /><stop offset="1" stop-color="#000" stop-opacity="0.38" /></radialGradient></defs><rect width="320" height="180" fill=${`url(#${e})`} />`}entrance(){return h`
  ...
  `;me([u()],ne.prototype,"cameraId",2);me([u()],ne.prototype,"profile",2);me([u()],ne.prototype,"mode",2);me([u()],ne.prototype,"poster",2);me([u({type:Boolean})],ne.prototype,"active",2);me([u({type:Boolean,reflect:!0})],ne.prototype,"compact",2);me([u()],ne.prototype,"wsUrl",2);me([u({type:Boolean})],ne.prototype,"retry",2);me([u({type:Boolean})],ne.prototype,"recorded",2);me([d()],ne.prototype,"status",2);me([d()],ne.prototype,"transport",2);me([d()],ne.prototype,"error",2);me([d()],ne.prototype,"muted",2);me([Kt("video")],ne.prototype,"video",2);ne=me([k("sw-live-player")],ne);var eo=Object.defineProperty,to=Object.getOwnPropertyDescriptor,fe=(e,t,s,i)=>{for(var a=i>1?void 0:i?to(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&eo(t,s,a),a};let oe=class extends ${constructor(){super(...arguments),this.name="",this.meta="",this.state="unknown",this.scene="lobby",this.selected=!1,this.compact=!1,this.dark=!1,this.noDemo=!1,this.stamp="",this.poster="",this.cameraId="",this.live=!1,this.profile="sub",this.transport="auto"}offMessage(){return this.state==="forbidden"?"אין הרשאת צפייה":this.state==="offline"?"המצלמה מנותקת":"מצב לא ידוע"}render(){if(this.state==="offline"||this.state==="forbidden"||this.state==="unknown")return r`<div class="off">
  ...
  `;fe([u()],oe.prototype,"name",2);fe([u()],oe.prototype,"meta",2);fe([u({reflect:!0})],oe.prototype,"state",2);fe([u({reflect:!0})],oe.prototype,"scene",2);fe([u({type:Boolean,reflect:!0})],oe.prototype,"selected",2);fe([u({type:Boolean,reflect:!0})],oe.prototype,"compact",2);fe([u({type:Boolean,reflect:!0})],oe.prototype,"dark",2);fe([u({type:Boolean,reflect:!0})],oe.prototype,"noDemo",2);fe([u()],oe.prototype,"stamp",2);fe([u()],oe.prototype,"poster",2);fe([u()],oe.prototype,"cameraId",2);fe([u({type:Boolean})],oe.prototype,"live",2);fe([u()],oe.prototype,"profile",2);fe([u()],oe.prototype,"transport",2);oe=fe([k("sw-camera-tile")],oe);var so=Object.defineProperty,io=Object.getOwnPropertyDescriptor,Jt=(e,t,s,i)=>{for(var a=i>1?void 0:i?io(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&so(t,s,a),a};const ao={loading:{icon:"clock",title:()=>y("states.loading"),hint:()=>"",tone:"neutral"},empty:{icon:"map",title:()=>y("states.empty"),hint:()=>"",tone:"neutral"},error:{icon:"warning",title:()=>y("states.error"),hint:()=>y("states.errorHint"),tone:"danger"},forbidden:{icon:"lock",title:()=>y("states.forbidden"),hint:()=>y("states.forbiddenHint"),tone:"forbidden"},stale:{icon:"offline",title:()=>y("states.stale"),hint:()=>y("states.staleHint"),tone:"stale"},partial:{icon:"info",title:()=>y("states.partial"),hint:()=>"",tone:"stale"}};let ht=class extends ${constructor(){super(...arguments),this.state="empty",this.heading="",this.hint="",this.actionLabel="",this.compact=!1}render(){const e=ao[this.state],t=this.hint||e.hint();return r`
  ...
  `;Jt([u({reflect:!0})],ht.prototype,"state",2);Jt([u()],ht.prototype,"heading",2);Jt([u()],ht.prototype,"hint",2);Jt([u()],ht.prototype,"actionLabel",2);Jt([u({type:Boolean,reflect:!0})],ht.prototype,"compact",2);ht=Jt([k("sw-state-panel")],ht);var ro=Object.defineProperty,no=Object.getOwnPropertyDescriptor,ti=(e,t,s,i)=>{for(var a=i>1?void 0:i?no(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&ro(t,s,a),a};let Zt=class extends ${constructor(){super(...arguments),this.open=!1,this.heading="",this.subheading="",this.onKey=e=>{e.key==="Escape"&&this.open&&this.close()}}close(){this.open=!1,this.dispatchEvent(new CustomEvent("close",{bubbles:!0,composed:!0}))}connectedCallback(){super.connectedCallback(),window.addEventListener("keydown",this.onKey)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("keydown",this.onKey)}render(){return r`<div class="backdrop" @click=${e=>e.target===e.currentTarget&&this.close()}>
  ...
  `;ti([u({type:Boolean,reflect:!0})],Zt.prototype,"open",2);ti([u()],Zt.prototype,"heading",2);ti([u()],Zt.prototype,"subheading",2);Zt=ti([k("sw-dialog")],Zt);var oo=Object.defineProperty,lo=Object.getOwnPropertyDescriptor,U=(e,t,s,i)=>{for(var a=i>1?void 0:i?lo(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&oo(t,s,a),a};const li=.2,di=6,ma={live:"var(--sw-accent)",recorded:"var(--sw-accent)",historic:"var(--sw-accent)",offline:"var(--sw-offline)",stale:"var(--sw-stale)",unknown:"var(--sw-unknown)",forbidden:"var(--sw-forbidden)",error:"var(--sw-danger)",neutral:"var(--sw-surface)",partial:"var(--sw-stale)"},co={camera:h`<path d="M-7 -4.5A1.5 1.5 0 0 1 -5.5 -6H-2l1.5-2h5L6 -6h1.5A1.5 1.5 0 0 1 9 -4.5v9A1.5 1.5 0 0 1 7.5 6h-13A1.5 1.5 0 0 1 -7 4.5z" transform="translate(-1 0) scale(0.9)"/><circle cx="-1" cy="0" r="3"/>`,lock:h`<rect x="-6" y="-2" width="12" height="9" rx="2"/><path d="M-3.5 -2v-3a3.5 3.5 0 0 1 7 0v3"/>`,light:h`<path d="M-3 6h6M-2 8.5h4"/><path d="M0 -8a5 5 0 0 0-3 9c.7.5 1.2 1.3 1.2 2.2h3.6c0-.9.5-1.7 1.2-2.2A5 5 0 0 0 0 -8z"/>`,binary_sensor:h`<circle cx="0" cy="0" r="2"/><path d="M-4.5 -4.5a6.4 6.4 0 0 0 0 9M4.5 -4.5a6.4 6.4 0 0 1 0 9"/>`};function po(e){let t=0,s=0,i=0;for(let a=0;a<e.length;a++){const n=e[a],o=e[(a+1)%e.length],l=n.x*o.y-o.x*n.y;t+=l,s+=(n.x+o.x)*l,i+=(n.y+o.y)*l}if(Math.abs(t)<1e-12){const a=e.length||1;return{x:e.reduce((n,o)=>n+o.x,0)/a,y:e.reduce((n,o)=>n+o.y,0)/a}}return{x:s/(3*t),y:i/(3*t)}}let C=class extends ${constructor(){super(...arguments),this.planWidth=1e3,this.planHeight=700,this.plan=null,this.markers=[],this.selectedId=null,this.selectedIds=[],this.dimEntities=!1,this.alwaysLabel=!1,this.imageUrl=null,this.editable=!1,this.placing=!1,this.coneRadius=140,this.zones=[],this.selectedZoneId=null,this.zoneLabels=!0,this.draftPoints=[],this.boxSelect=!1,this.box=null,this.boxStart=null,this.scale=1,this.tx=0,this.ty=0,this.hoverId=null,this.dragging=null,this.orienting=null,this.zoneDraft=null,this.lastVertexPress=null,this.pointers=new Map,this.lastPan=null,this.lastPinchDist=0,this.dragMoved=!1,this.fitted=!1,this.minScale=li,this.onWheel=e=>{e.preventDefault();const t=this.getBoundingClientRect();this.zoomBy(e.deltaY<0?1.15:1/1.15,e.clientX-t.left,e.clientY-t.top)},this.onMarkerPointerDown=(e,t)=>{if(!this.editable||t.button!==0)return;t.stopPropagation(),t.preventDefault(),this.dragging={id:e.id,x:e.x,y:e.y},this.viewport.setPointerCapture(t.pointerId);const s=a=>{const n=this.getBoundingClientRect(),o=this.toPlan(a.clientX-n.left,a.clientY-n.top);this.dragging={id:e.id,x:o.x,y:o.y}},i=a=>{this.viewport.removeEventListener("pointermove",s),this.viewport.removeEventListener("pointerup",i),this.viewport.removeEventListener("pointercancel",i);const n=this.getBoundingClientRect(),o=this.toPlan(a.clientX-n.left,a.clientY-n.top),l=Math.abs(o.x-e.x)>5e-4||Math.abs(o.y-e.y)>5e-4;this.dragging=null,l?(this.dragMoved=!0,setTimeout(()=>this.dragMoved=!1,0),this.dispatchEvent(new CustomEvent("marker-move",{detail:{id:e.id,x:o.x,y:o.y},bubbles:!0,composed:!0}))):this.select(e,a)};this.viewport.addEventListener("pointermove",s),this.viewport.addEventListener("pointerup",i),this.viewport.addEventListener("pointercancel",i)},this.onPointerDown=e=>{if(this.pointers.set(e.pointerId,{x:e.clientX,y:e.clientY}),this.dragMoved=!1,this.pointers.size===1){if(this.boxSelect&&e.button===0&&!e.shiftKey&&!this.editable&&!this.placing){const t=this.getBoundingClientRect();this.boxStart={x:e.clientX-t.left,y:e.clientY-t.top},this.lastPan=null;return}this.lastPan={x:e.clientX,y:e.clientY},this.viewport.classList.add("dragging")}else this.pointers.size===2&&(this.lastPinchDist=this.pinchDistance(),this.lastPan=null,this.boxStart=null,this.box=null)},this.onPointerMove=e=>{if(this.pointers.has(e.pointerId)){if(this.pointers.set(e.pointerId,{x:e.clientX,y:e.clientY}),this.pointers.size===2){const t=this.pinchDistance();if(this.lastPinchDist>0){const[s,i]=[...this.pointers.values()],a=this.getBoundingClientRect();this.zoomBy(t/this.lastPinchDist,(s.x+i.x)/2-a.left,(s.y+i.y)/2-a.top)}this.lastPinchDist=t,this.dragMoved=!0;return}if(this.boxStart){const t=this.getBoundingClientRect(),s=e.clientX-t.left,i=e.clientY-t.top;!this.dragMoved&&Math.abs(s-this.boxStart.x)+Math.abs(i-this.boxStart.y)>3&&(this.dragMoved=!0,this.viewport.hasPointerCapture(e.pointerId)||this.viewport.setPointerCapture(e.pointerId)),this.dragMoved&&(this.box={x0:Math.min(this.boxStart.x,s),y0:Math.min(this.boxStart.y,i),x1:Math.max(this.boxStart.x,s),y1:Math.max(this.boxStart.y,i)});return}if(this.lastPan){const t=e.clientX-this.lastPan.x,s=e.clientY-this.lastPan.y;!this.dragMoved&&Math.abs(t)+Math.abs(s)>2&&(this.dragMoved=!0,this.viewport.hasPointerCapture(e.pointerId)||this.viewport.setPointerCapture(e.pointerId)),this.tx+=t,this.ty+=s,this.lastPan={x:e.clientX,y:e.clientY}}}},this.onPointerUp=e=>{if(this.pointers.delete(e.pointerId),this.boxStart&&this.pointers.size===0){const t=this.box;if(this.boxStart=null,this.box=null,t&&t.x1-t.x0>=4&&t.y1-t.y0>=4){const s=this.markers.filter(i=>{const a=this.toScreen(i.x,i.y);return a.x>=t.x0&&a.x<=t.x1&&a.y>=t.y0&&a.y<=t.y1}).map(i=>i.id);this.dispatchEvent(new CustomEvent("box-select",{detail:{ids:s},bubbles:!0,composed:!0}))}}if(this.pointers.size===0)this.lastPan=null,this.viewport.classList.remove("dragging");else if(this.pointers.size===1){const[t]=[...this.pointers.values()];this.lastPan={x:t.x,y:t.y}}},this.onBackgroundClick=e=>{if(!this.dragMoved){if(this.placing){const t=this.getBoundingClientRect(),s=this.toPlan(e.clientX-t.left,e.clientY-t.top);this.dispatchEvent(new CustomEvent("plan-click",{detail:{x:+s.x.toFixed(4),y:+s.y.toFixed(4)},bubbles:!0,composed:!0}));return}this.dispatchEvent(new CustomEvent("marker-select",{detail:{id:null},bubbles:!0,composed:!0}))}},this.onHandlePointerDown=(e,t,s)=>{if(!this.editable||s.button!==0)return;s.stopPropagation(),s.preventDefault();const i=this.getBoundingClientRect(),a=e.rotation??0,n=e.fov??90,o=t==="left"?a+n/2:a-n/2;this.orienting={id:e.id,rotation:a,fov:n},this.viewport.setPointerCapture(s.pointerId);const l=f=>{const v=this.bearingTo(e,f.clientX-i.left,f.clientY-i.top);if(t==="dir")return{rotation:Math.round(v),fov:n};let M=t==="left"?o-v:v-o;M=(M%360+360)%360;const _=Math.max(10,Math.min(180,Math.round(M))),O=t==="left"?o-_/2:o+_/2;return{rotation:Math.round((O%360+360)%360),fov:_}},p=f=>{this.orienting={id:e.id,...l(f)}},m=f=>{this.viewport.removeEventListener("pointermove",p),this.viewport.removeEventListener("pointerup",m),this.viewport.removeEventListener("pointercancel",m);const v=l(f);this.orienting=null,this.dragMoved=!0,setTimeout(()=>this.dragMoved=!1,0),(v.rotation!==a||v.fov!==n)&&this.dispatchEvent(new CustomEvent("marker-orient",{detail:{id:e.id,...v},bubbles:!0,composed:!0}))};this.viewport.addEventListener("pointermove",p),this.viewport.addEventListener("pointerup",m),this.viewport.addEventListener("pointercancel",m)}}connectedCallback(){super.connectedCallback(),this.resizeObserver=new ResizeObserver(()=>{this.fitted||this.fit()}),this.resizeObserver.observe(this)}disconnectedCallback(){super.disconnectedCallback(),this.resizeObserver?.disconnect()}updated(e){(e.has("planWidth")||e.has("planHeight"))&&(this.fitted=!1,this.fit()),(e.has("scale")||e.has("tx")||e.has("ty"))&&this.dispatchEvent(new CustomEvent("view-change",{bubbles:!0,composed:!0}))}get zoom(){return this.scale}focusMarker(e){const t=this.renderRoot.querySelector(`g.marker[data-id="${CSS.escape(e)}"]`);return t?.focus(),!!t}toScreen(e,t){return{x:this.tx+e*this.planWidth*this.scale,y:this.ty+t*this.planHeight*this.scale}}fit(){const e=this.clientWidth,t=this.clientHeight;if(!e||!t||!this.planWidth||!this.planHeight)return;const s=24,i=Math.min((e-s*2)/this.planWidth,(t-s*2)/this.planHeight);this.minScale=Math.min(li,i),this.scale=Math.max(this.minScale,Math.min(di,i)),this.tx=(e-this.planWidth*this.scale)/2,this.ty=(t-this.planHeight*this.scale)/2,this.fitted=!0}zoomToBox(e,t,s,i,a=48){const n=this.clientWidth,o=this.clientHeight;if(!n||!o||!this.planWidth||!this.planHeight)return;const l=Math.max(1e-6,s-e)*this.planWidth,p=Math.max(1e-6,i-t)*this.planHeight,m=Math.max(li,Math.min(di,Math.min((n-a*2)/l,(o-a*2)/p,2.5)));this.scale=m,this.tx=n/2-(e+s)/2*this.planWidth*m,this.ty=o/2-(t+i)/2*this.planHeight*m,this.fitted=!0}zoomBy(e,t,s){const i=this.clientWidth,a=this.clientHeight,n=t??i/2,o=s??a/2,l=Math.max(this.minScale,Math.min(di,this.scale*e)),p=l/this.scale;this.tx=n-(n-this.tx)*p,this.ty=o-(o-this.ty)*p,this.scale=l,this.fitted=!0}toPlan(e,t){return{x:Math.min(1,Math.max(0,(e-this.tx)/this.scale/this.planWidth)),y:Math.min(1,Math.max(0,(t-this.ty)/this.scale/this.planHeight))}}pinchDistance(){const[e,t]=[...this.pointers.values()];return Math.hypot(e.x-t.x,e.y-t.y)}select(e,t){if(this.dragMoved)return;t.stopPropagation();const s=this.toScreen(e.x,e.y),i={id:e.id,sx:s.x,sy:s.y};this.dispatchEvent(new CustomEvent("marker-select",{detail:i,bubbles:!0,composed:!0}))}selectZone(e,t){this.dragMoved||this.placing||(t.stopPropagation(),this.dispatchEvent(new CustomEvent("zone-select",{detail:{id:e.id},bubbles:!0,composed:!0})))}onVertexPointerDown(e,t,s,i=!1){if(!this.editable||s.button!==0)return;if(s.stopPropagation(),s.preventDefault(),!i){const m=this.lastVertexPress,f=performance.now();if(m&&m.id===e.id&&m.index===t&&f-m.at<450){this.lastVertexPress=null,this.removeVertex(e,t,s);return}this.lastVertexPress={id:e.id,index:t,at:f}}const a=this.getBoundingClientRect();let n=e.polygon.map(m=>({x:m.x,y:m.y})),o=t;if(i){const m=n[t],f=n[(t+1)%n.length];n.splice(t+1,0,{x:+((m.x+f.x)/2).toFixed(4),y:+((m.y+f.y)/2).toFixed(4)}),o=t+1}this.zoneDraft={id:e.id,polygon:n},this.viewport.setPointerCapture(s.pointerId);const l=m=>{const f=this.toPlan(m.clientX-a.left,m.clientY-a.top);n=n.map((v,M)=>M===o?{x:+f.x.toFixed(4),y:+f.y.toFixed(4)}:v),this.zoneDraft={id:e.id,polygon:n}},p=()=>{this.viewport.removeEventListener("pointermove",l),this.viewport.removeEventListener("pointerup",p),this.viewport.removeEventListener("pointercancel",p);const m=i||n.some((f,v)=>f.x!==e.polygon[v].x||f.y!==e.polygon[v].y);this.zoneDraft=null,this.dragMoved=!0,setTimeout(()=>this.dragMoved=!1,0),m&&this.dispatchEvent(new CustomEvent("zone-edit",{detail:{id:e.id,polygon:n},bubbles:!0,composed:!0}))};this.viewport.addEventListener("pointermove",l),this.viewport.addEventListener("pointerup",p),this.viewport.addEventListener("pointercancel",p)}removeVertex(e,t,s){if(s.stopPropagation(),!this.editable||e.polygon.length<=3)return;const i=e.polygon.filter((a,n)=>n!==t);this.dispatchEvent(new CustomEvent("zone-edit",{detail:{id:e.id,polygon:i},bubbles:!0,composed:!0}))}renderZoneHandles(e,t){const s=1/this.scale,i=this.planWidth,a=this.planHeight;return h`<g class="zone-handles">
    ...
    </g>`}renderZone(e){if(e.polygon.length<3)return c;const t=1/this.scale,s=this.zoneDraft?.id===e.id?this.zoneDraft.polygon:e.polygon,i=s.map(M=>`${(M.x*this.planWidth).toFixed(1)},${(M.y*this.planHeight).toFixed(1)}`).join(" "),a=po(s),n=this.selectedZoneId===e.id,o=Math.max(36,e.name.length*7+18),l=s.map(M=>M.x),p=s.map(M=>M.y),m=(Math.max(...l)-Math.min(...l))*this.planWidth*this.scale,f=(Math.max(...p)-Math.min(...p))*this.planHeight*this.scale,v=n||e.candidate||m>=o+12&&f>=30;return h`
      <g class="zone ${n?"selected":""} ${e.candidate?"candidate":""}" style="--zc:${e.color}" role="button" tabindex="0" aria-label=${e.name} aria-pressed=${n}
         data-zone=${e.id}
         @click=${M=>this.selectZone(e,M)} @keydown=${M=>(M.key==="Enter"||M.key===" ")&&this.selectZone(e,M)}>
    ...
    </g>`}bearingTo(e,t,s){const i=this.toScreen(e.x,e.y);return((Math.atan2(s-i.y,t-i.x)*180/Math.PI+90)%360+360)%360}renderHandles(e,t,s){const i=this.coneRadius,a=1/this.scale,n=(f,v)=>({x:Math.cos(C.rad(f))*v,y:Math.sin(C.rad(f))*v}),o=n(t-s/2,i),l=n(t+s/2,i),p=n(t,i*.72),m=7*a;return h`
      <line class="handle-line" x1="0" y1="0" x2=${p.x.toFixed(1)} y2=${p.y.toFixed(1)} />
      <rect class="handle" x=${(o.x-m).toFixed(1)} y=${(o.y-m).toFixed(1)} width=${(m*2).toFixed(1)} height=${(m*2).toFixed(1)} rx=${(1.5*a).toFixed(1)} role="slider" aria-label="קצה שדה ראייה" @pointerdown=${f=>this.onHandlePointerDown(e,"left",f)} @click=${f=>f.stopPropagation()} />
      <rect class="handle" x=${(l.x-m).toFixed(1)} y=${(l.y-m).toFixed(1)} width=${(m*2).toFixed(1)} height=${(m*2).toFixed(1)} rx=${(1.5*a).toFixed(1)} role="slider" aria-label="קצה שדה ראייה" @pointerdown=${f=>this.onHandlePointerDown(e,"right",f)} @click=${f=>f.stopPropagation()} />
      <circle class="handle" cx=${p.x.toFixed(1)} cy=${p.y.toFixed(1)} r=${(8*a).toFixed(1)} role="slider" aria-label="כיוון מבט" @pointerdown=${f=>this.onHandlePointerDown(e,"dir",f)} @click=${f=>f.stopPropagation()} />
    `}static rad(e){return(e-90)*Math.PI/180}fovPath(e,t,s){const i=C.rad(e-t/2),a=C.rad(e+t/2),n=Math.cos(i)*s,o=Math.sin(i)*s,l=Math.cos(a)*s,p=Math.sin(a)*s;return`M0 0 L${n.toFixed(1)} ${o.toFixed(1)} A${s} ${s} 0 ${t>180?1:0} 1 ${l.toFixed(1)} ${p.toFixed(1)} Z`}renderMarker(e){const t=this.dragging?.id===e.id?this.dragging:e,s=this.orienting?.id===e.id?this.orienting:null,i=s?s.rotation:e.rotation??0,a=s?s.fov:e.fov,n=t.x*this.planWidth,o=t.y*this.planHeight,l=1/this.scale,p=e.kind==="camera",m=ma[e.state]??ma.neutral,f=this.selectedId===e.id||this.selectedIds.includes(e.id),v=this.alwaysLabel||f||this.hoverId===e.id,M=Math.max(44,e.label.length*6.5+16),_=this.dimEntities&&!p,O=p?13:11;return h`
      <g class="marker ${e.state} ${f?"selected":""} ${_?"dimmed":""} ${this.editable?"editable":""}"
         ...
         @pointerdown=${ae=>this.onMarkerPointerDown(e,ae)}
         @click=${ae=>this.editable?ae.stopPropagation():this.select(e,ae)}
         @keydown=${ae=>(ae.key==="Enter"||ae.key===" ")&&this.select(e,ae)}>
        ${p&&a&&e.state!=="forbidden"?h`<path class="fov ${e.state==="offline"?"off":""}" d=${this.fovPath(i,a,this.coneRadius)} />`:c}
        ${p&&a&&this.editable&&f&&!this.dragging?this.renderHandles(e,i,a):c}
        <g transform="scale(${l})">
          <circle class="halo" r=${O+9} />
          <circle class="pin" r=${O} fill=${m} />
          <g class="icon" transform="scale(${p?.85:.75})">${co[e.kind]}</g>
          ...
          ${v?h`<g transform="translate(0 ${O+14})">
                <rect class="lbl-bg" x=${-M/2} y="-10" width=${M} height="20" rx="6" />
  ...
  `;U([u({type:Number})],C.prototype,"planWidth",2);U([u({type:Number})],C.prototype,"planHeight",2);U([u({attribute:!1})],C.prototype,"plan",2);U([u({attribute:!1})],C.prototype,"markers",2);U([u()],C.prototype,"selectedId",2);U([u({attribute:!1})],C.prototype,"selectedIds",2);U([u({type:Boolean})],C.prototype,"dimEntities",2);U([u({type:Boolean})],C.prototype,"alwaysLabel",2);U([u()],C.prototype,"imageUrl",2);U([u({type:Boolean})],C.prototype,"editable",2);U([u({type:Boolean})],C.prototype,"placing",2);U([u({type:Number})],C.prototype,"coneRadius",2);U([u({attribute:!1})],C.prototype,"zones",2);U([u()],C.prototype,"selectedZoneId",2);U([u({type:Boolean})],C.prototype,"zoneLabels",2);U([u({attribute:!1})],C.prototype,"draftPoints",2);U([u({type:Boolean})],C.prototype,"boxSelect",2);U([d()],C.prototype,"box",2);U([d()],C.prototype,"scale",2);U([d()],C.prototype,"tx",2);U([d()],C.prototype,"ty",2);U([d()],C.prototype,"hoverId",2);U([d()],C.prototype,"dragging",2);U([d()],C.prototype,"orienting",2);U([d()],C.prototype,"zoneDraft",2);U([Kt(".viewport")],C.prototype,"viewport",2);C=U([k("sw-plan-canvas")],C);const fa={name:"אתר הדגמה",building:"מבנה א"},ut=[{id:"f0",name:"קומה 0",hasPlan:!0,planWidth:1200,planHeight:800,cameraCount:6,entityCount:4},{id:"f-1",name:"קומה 1-",hasPlan:!0,planWidth:900,planHeight:1100,cameraCount:3,entityCount:1},{id:"f-2",name:"קומה 2-",hasPlan:!1,planWidth:0,planHeight:0,cameraCount:2,entityCount:0}],as=[{id:"cam-1",name:"כניסה ראשית",floorId:"f0",x:.09,y:.52,rotation:20,fov:70,state:"live",source:"NVR ערוץ 1"},{id:"cam-2",name:"לובי",floorId:"f0",x:.34,y:.3,rotation:120,fov:80,state:"live",source:"NVR ערוץ 2"},{id:"cam-3",name:"מסדרון מזרחי",floorId:"f0",x:.62,y:.55,rotation:180,fov:60,state:"offline",source:"NVR ערוץ 3"},{id:"cam-4",name:"אולם",floorId:"f0",x:.82,y:.22,rotation:210,fov:90,state:"live",source:"NVR ערוץ 4"},{id:"cam-5",name:"חדר מדרגות",floorId:"f0",x:.9,y:.8,rotation:250,fov:60,state:"stale",source:"NVR ערוץ 5"},{id:"cam-6",name:"חניה",floorId:"f0",x:.4,y:.86,rotation:300,fov:75,state:"forbidden",source:"NVR ערוץ 6"},{id:"cam-7",name:"מחסן",floorId:"f-1",x:.3,y:.3,rotation:45,fov:70,state:"live",source:"NVR ערוץ 7"},{id:"cam-8",name:"חדר מכונות",floorId:"f-1",x:.7,y:.6,rotation:200,fov:70,state:"live",source:"NVR ערוץ 8"},{id:"cam-9",name:"מקלט",floorId:"f-1",x:.5,y:.85,rotation:270,fov:70,state:"offline",source:"NVR ערוץ 9"}],Rs=[{id:"lock.main_door",name:"דלת כניסה",floorId:"f0",x:.05,y:.4,domain:"lock",state:"locked",stateLabelKey:"entity.locked",controllable:!1,lastChanged:"לפני 12 דק׳"},{id:"light.lobby",name:"תאורת לובי",floorId:"f0",x:.3,y:.42,domain:"light",state:"on",stateLabelKey:"entity.on",controllable:!0,lastChanged:"לפני שעה"},{id:"binary_sensor.hall_motion",name:"תנועה באולם",floorId:"f0",x:.7,y:.3,domain:"binary_sensor",state:"off",stateLabelKey:"entity.off",controllable:!1,lastChanged:"לפני 3 דק׳"},{id:"light.corridor",name:"תאורת מסדרון",floorId:"f0",x:.55,y:.66,domain:"light",state:"off",stateLabelKey:"entity.off",controllable:!0,lastChanged:"אתמול 22:10"},{id:"lock.shelter",name:"דלת מקלט",floorId:"f-1",x:.46,y:.9,domain:"lock",state:"locked",stateLabelKey:"entity.locked",controllable:!1,lastChanged:"לפני 2 שעות"}],ar={f0:[{x:40,y:40,w:300,h:260,label:"לובי",kind:"lobby"},{x:40,y:340,w:300,h:220,label:"משרדים",kind:"office"},{x:40,y:600,w:460,h:160,label:"חניה מקורה",kind:"parking"},{x:380,y:40,w:420,h:300,label:"אולם",kind:"hall"},{x:840,y:40,w:320,h:300,label:"אולם ב",kind:"meeting"},{x:380,y:380,w:300,h:180,label:"חדר ישיבות",kind:"meeting"},{x:720,y:380,w:440,h:180,label:"מסדרון מזרחי",kind:"corridor"},{x:540,y:600,w:620,h:160,label:"שירותים ומדרגות",kind:"stairs"}],"f-1":[{x:40,y:40,w:400,h:400,label:"מחסן",kind:"storage"},{x:480,y:40,w:380,h:400,label:"חדר מכונות",kind:"machines"},{x:40,y:480,w:820,h:200,label:"מסדרון",kind:"corridor"},{x:40,y:720,w:820,h:340,label:"מקלט",kind:"shelter"}]};function xi(e){const t=ar[e],s=ut.find(i=>i.id===e);return!t||!s?.hasPlan?[]:t.map(i=>({x:i.x/s.planWidth,y:i.y/s.planHeight,w:i.w/s.planWidth,h:i.h/s.planHeight}))}const re="var(--sw-map-furniture)",Y="var(--sw-map-furniture-line)";function ho(e){const t=e.x+e.w/2,s=e.y+e.h/2;switch(e.kind){case"lobby":return h`<rect x=${e.x+30} y=${e.y+e.h-70} width="130" height="30" rx="4" fill=${re} stroke=${Y} /><rect x=${e.x+170} y=${e.y+30} width="110" height="36" rx="10" fill=${re} stroke=${Y} /><circle cx=${e.x+22} cy=${e.y+22} r="10" fill="#dfe9d9" stroke="#b9cfae" /><circle cx=${e.x+e.w-22} cy=${e.y+22} r="10" fill="#dfe9d9" stroke="#b9cfae" />`;case"office":return h`${[0,1].map(i=>[0,1,2].map(a=>h`<rect x=${e.x+30+a*92} y=${e.y+36+i*92} width="56" height="28" rx="2" fill=${re} stroke=${Y} /><circle cx=${e.x+58+a*92} cy=${e.y+78+i*92} r="8" fill=${re} stroke=${Y} />`))}`;case"parking":return h`${[0,1,2,3,4,5,6,7].map(i=>h`<line x1=${e.x+30+i*56} y1=${e.y+20} x2=${e.x+30+i*56} y2=${e.y+e.h-20} stroke=${Y} stroke-dasharray="6 6" />`)}${[1,3,4].map(i=>h`<rect x=${e.x+42+i*56} y=${e.y+36} width="30" height="70" rx="8" fill="#d5dce8" stroke=${Y} />`)}`;case"hall":return h`${[0,1,2,3].map(i=>[0,1,2,3,4,5].map(a=>h`<rect x=${e.x+50+a*56} y=${e.y+60+i*52} width="26" height="16" rx="3" fill=${re} stroke=${Y} />`))}<rect x=${e.x+40} y=${e.y+20} width=${e.w-80} height="14" rx="2" fill=${re} stroke=${Y} />`;case"meeting":return h`<rect x=${t-80} y=${s-26} width="160" height="52" rx="12" fill=${re} stroke=${Y} />${[0,1,2].map(i=>h`<circle cx=${t-50+i*50} cy=${s-44} r="9" fill=${re} stroke=${Y} /><circle cx=${t-50+i*50} cy=${s+44} r="9" fill=${re} stroke=${Y} />`)}`;case"corridor":return h`<rect x=${e.x+30} y=${s-8} width="90" height="16" rx="3" fill=${re} stroke=${Y} />`;case"stairs":return h`<rect x=${e.x+e.w-130} y=${e.y+30} width="100" height="100" fill=${re} stroke=${Y} />${[1,2,3,4,5,6,7].map(i=>h`<line x1=${e.x+e.w-130} y1=${e.y+30+i*12.5} x2=${e.x+e.w-30} y2=${e.y+30+i*12.5} stroke=${Y} />`)}${[0,1,2,3].map(i=>h`<rect x=${e.x+30+i*46} y=${e.y+30} width="36" height="46" fill=${re} stroke=${Y} />`)}`;case"storage":return h`${[0,1,2,3].map(i=>h`<rect x=${e.x+40+i*92} y=${e.y+40} width="30" height=${e.h-80} fill=${re} stroke=${Y} />`)}`;case"machines":return h`${[0,1,2].map(i=>h`<rect x=${e.x+40} y=${e.y+40+i*120} width="110" height="72" rx="4" fill=${re} stroke=${Y} /><circle cx=${e.x+240} cy=${e.y+76+i*120} r="26" fill=${re} stroke=${Y} />`)}`;case"shelter":return h`${[0,1,2,3].map(i=>h`<rect x=${e.x+60} y=${e.y+50+i*70} width="220" height="22" rx="3" fill=${re} stroke=${Y} /><rect x=${e.x+e.w-280} y=${e.y+50+i*70} width="220" height="22" rx="3" fill=${re} stroke=${Y} />`)}`;default:return""}}function rr(e){const t=ar[e],s=ut.find(i=>i.id===e);return!t||!s?null:h`
    ...
    ${t.map(i=>h`
      ...
      `)}
  `}const ki=[{id:"site-a",name:"אתר הדגמה",address:"רחוב הדוגמה 1",buildings:2,cameras:10,online:9,alerts:2,health:"stale"},{id:"site-b",name:"סניף צפון",address:"שדרות הדגמה 20",buildings:1,cameras:6,online:6,alerts:0,health:"live"},{id:"site-c",name:"מחסן לוגיסטי",address:"אזור תעשייה",buildings:1,cameras:4,online:3,alerts:1,health:"offline"}],uo=[{id:"bld-a",siteId:"site-a",name:"מבנה א",floors:[{id:"f0",name:"קומה 0",cameras:6,entities:4,hasPlan:!0},{id:"f-1",name:"קומה 1-",cameras:3,entities:1,hasPlan:!0},{id:"f-2",name:"קומה 2-",cameras:2,entities:0,hasPlan:!1}]},{id:"bld-b",siteId:"site-a",name:"מבנה ב",floors:[{id:"b-f0",name:"קרקע",cameras:1,entities:2,hasPlan:!1}]}],q=[{id:"cam-1",name:"כניסה ראשית",floor:"קומה 0",state:"live",stream:"sub",fps:25,bitrateKbps:3072,firmware:"V5.8.10",lastEvent:"לפני 2 דק׳",recording:"continuous",ptz:!1,audio:!1},{id:"cam-2",name:"לובי",floor:"קומה 0",state:"live",stream:"sub",fps:25,bitrateKbps:3072,firmware:"V5.8.10",lastEvent:"לפני 5 דק׳",recording:"motion",ptz:!1,audio:!0},{id:"cam-3",name:"מסדרון מזרחי",floor:"קומה 0",state:"offline",stream:"sub",fps:null,bitrateKbps:null,firmware:"V5.8.10",lastEvent:"לפני שעה",recording:"unknown",ptz:!1,audio:!1},{id:"cam-4",name:"אולם",floor:"קומה 0",state:"live",stream:"main",fps:25,bitrateKbps:5120,firmware:"V5.8.10",lastEvent:"לפני 12 דק׳",recording:"continuous",ptz:!0,audio:!1},{id:"cam-5",name:"חדר מדרגות",floor:"קומה 0",state:"stale",stream:"sub",fps:20,bitrateKbps:2048,firmware:"V5.8.9",lastEvent:"לפני 40 דק׳",recording:"continuous",ptz:!1,audio:!1},{id:"cam-6",name:"חניה מקורה",floor:"קומה 0",state:"forbidden",stream:"sub",fps:null,bitrateKbps:null,firmware:"—",lastEvent:"—",recording:"unknown",ptz:!1,audio:!1},{id:"cam-7",name:"מחסן",floor:"קומה 1-",state:"live",stream:"sub",fps:25,bitrateKbps:3072,firmware:"V5.8.10",lastEvent:"לפני 3 שעות",recording:"motion",ptz:!1,audio:!1},{id:"cam-8",name:"חדר מכונות",floor:"קומה 1-",state:"live",stream:"sub",fps:25,bitrateKbps:3072,firmware:"V5.8.10",lastEvent:"אתמול",recording:"continuous",ptz:!1,audio:!1},{id:"cam-9",name:"מקלט",floor:"קומה 1-",state:"offline",stream:"sub",fps:null,bitrateKbps:null,firmware:"V5.8.10",lastEvent:"לפני יומיים",recording:"unknown",ptz:!1,audio:!1},{id:"cam-10",name:"חצר אחורית",floor:"חוץ",state:"live",stream:"sub",fps:25,bitrateKbps:4096,firmware:"V5.8.10",lastEvent:"לפני 8 דק׳",recording:"continuous",ptz:!0,audio:!0}],Ue={"cam-1":"entrance","cam-2":"lobby","cam-3":"corridor","cam-4":"hall","cam-5":"corridor","cam-6":"parking","cam-7":"warehouse","cam-8":"warehouse","cam-9":"night","cam-10":"backyard"},_i={person:"זיהוי אדם",vehicle:"זיהוי רכב",motion:"תנועה",line:"חציית קו",offline:"מצלמה מנותקת",door:"דלת נפתחה"},Je=[{id:"ev-1",time:"היום 10:14",minuteOfDay:614,type:"person",title:"אדם זוהה",camera:"כניסה ראשית",floor:"קומה 0",source:"NVR",acked:!1,severity:"alert"},{id:"ev-2",time:"היום 09:42",minuteOfDay:582,type:"vehicle",title:"רכב זוהה",camera:"חצר אחורית",floor:"חוץ",source:"NVR",acked:!1,severity:"info"},{id:"ev-3",time:"היום 08:31",minuteOfDay:511,type:"motion",title:"תנועה",camera:"מחסן",floor:"קומה 1-",source:"NVR",acked:!0,severity:"info"},{id:"ev-4",time:"היום 08:12",minuteOfDay:492,type:"door",title:"דלת כניסה נפתחה",camera:"כניסה ראשית",floor:"קומה 0",source:"HA",acked:!0,severity:"info"},{id:"ev-5",time:"היום 07:55",minuteOfDay:475,type:"offline",title:"מסדרון מזרחי מנותק",camera:"מסדרון מזרחי",floor:"קומה 0",source:"NVR",acked:!1,severity:"critical"},{id:"ev-6",time:"היום 06:43",minuteOfDay:403,type:"line",title:"חציית קו",camera:"חניה מקורה",floor:"קומה 0",source:"NVR",acked:!0,severity:"alert"},{id:"ev-7",time:"אתמול 23:10",minuteOfDay:1390,type:"person",title:"אדם זוהה",camera:"לובי",floor:"קומה 0",source:"NVR",acked:!0,severity:"info"}],js=[{startMin:0,endMin:190,kind:"continuous"},{startMin:205,endMin:460,kind:"continuous"},{startMin:470,endMin:474,kind:"motion"},{startMin:480,endMin:486,kind:"motion"},{startMin:492,endMin:640,kind:"continuous"},{startMin:660,endMin:1439,kind:"continuous"}],zi=[{id:"u-1",name:"יוני",haUser:"joni",active:!0,lastSync:"לפני 20 שנ׳",groups:["מנהלי מערכת"],bindings:[{role:"מנהל מערכת VMS",scope:"כל ההתקנה"}],haAdmin:!0},{id:"u-2",name:"דנה",haUser:"dana",active:!0,lastSync:"לפני 20 שנ׳",groups:["עורכי קומה 2"],bindings:[{role:"עורך מפות",scope:"מבנה א · קומה 2"}],haAdmin:!1},{id:"u-3",name:"יוסי",haUser:"yossi",active:!0,lastSync:"לפני 20 שנ׳",groups:["מנהלי מבנה א"],bindings:[{role:"מנהל אתר/מבנה",scope:"מבנה א"}],haAdmin:!1},{id:"u-4",name:"codex",haUser:"codex",active:!0,lastSync:"לפני 20 שנ׳",groups:[],bindings:[],haAdmin:!1},{id:"u-5",name:"רון",haUser:"ron",active:!1,lastSync:"לפני 3 ימים",groups:["צופים"],bindings:[{role:"צופה",scope:"אתר הדגמה"}],haAdmin:!1}],nr=[{id:"g-1",name:"מנהלי מערכת",members:1,bindings:["מנהל מערכת VMS · כל ההתקנה"]},{id:"g-2",name:"עורכי קומה 2",members:1,bindings:["עורך מפות · מבנה א · קומה 2"]},{id:"g-3",name:"מנהלי מבנה א",members:1,bindings:["מנהל אתר/מבנה · מבנה א"]},{id:"g-4",name:"צופים",members:1,bindings:["צופה · אתר הדגמה"]}],or=[{id:"viewer",name:"צופה",allowed:"מפה, מצב ישויות מורשה, שידור חי",denied:"היסטוריה, עריכה, ייצוא, שליטה"},{id:"operator",name:"מפעיל",allowed:"צפייה, Playback, סקירת אירועים וסימון טיפול",denied:"עריכת מפות, תפקידים, ייצוא, פעולות פיזיות"},{id:"editor",name:"עורך מפות ותצוגות",allowed:"צפייה, יבוא/עריכה/פרסום מפות, מיקומים ותצוגות",denied:"Playback, ייצוא, משתמשים, סודות, שליטה"},{id:"site_admin",name:"מנהל אתר / מבנה / קומה",allowed:"מפעיל + עורך, הגדרות תוכן מקומיות",denied:"הגדרות מערכת, תפקידים, סודות, כתיבה ל־NVR"},{id:"system_admin",name:"מנהל מערכת VMS",allowed:"הגדרות מוצר, מקורות, מדיניות, קבוצות ושיוכים",denied:"ניהול HA, שליטה פיזית, ייצוא ראיות ללא grant"}],lr=[{time:"10:24",user:"יוני",action:"צפייה חיה",resource:"כניסה ראשית",decision:"הותר",role:"מנהל מערכת · כל ההתקנה"},{time:"10:18",user:"דנה",action:"פרסום תוכנית",resource:"מבנה א · קומה 2",decision:"הותר",role:"עורך מפות · קומה 2"},{time:"10:11",user:"דנה",action:"עריכת תוכנית",resource:"מבנה א · קומה 3",decision:"נחסם: מחוץ להיקף",role:"עורך מפות · קומה 2"},{time:"09:55",user:"יוסי",action:"ייצוא קטע",resource:"לובי 09:10–09:20",decision:"נחסם: אין הרשאת ייצוא",role:"מנהל מבנה · מבנה א"},{time:"09:43",user:"codex",action:"כניסה דרך Ingress",resource:"—",decision:"הותר, ללא שיוך",role:"—"},{time:"09:30",user:"יוני",action:"הפעלת תאורה",resource:"light.lobby",decision:"הותר (HA אישר)",role:"מנהל מערכת"},{time:"08:12",user:"מערכת",action:"סנכרון משתמשים",resource:"HA bridge",decision:"5 משתמשים, 0 שינויים",role:"—"}],dr=[{id:"job-1",title:"ייצוא: כניסה ראשית 09:10–09:25",status:"הושלם",progress:100,size:"182 MB",hash:"sha256 ✓"},{id:"job-2",title:"ייצוא: לובי 23:00–23:40",status:"בתהליך",progress:62,size:"—",hash:"—"},{id:"job-3",title:"תמונות מקדימות: קומה 0",status:"ממתין",progress:0,size:"—",hash:"—"},{id:"job-4",title:"ייצוא: חצר אחורית 02:00–04:00",status:"נכשל: פער בהקלטה",progress:35,size:"—",hash:"—"}],Si=[{id:"case-1",title:"כניסה לא מורשית — 13.09",status:"פתוח",owner:"יוני",clips:3,notes:2,preserved:2,missing:1},{id:"case-2",title:"נזק לרכב בחניה",status:"בבדיקה",owner:"יוסי",clips:2,notes:1,preserved:2,missing:0},{id:"case-3",title:"דלת מקלט פתוחה בלילה",status:"סגור",owner:"יוני",clips:1,notes:3,preserved:1,missing:0}],Mi=[{id:"r-1",name:"אדם בלילה",trigger:"זיהוי אדם",scope:"חוץ · 22:00–06:00",action:"התראה + פתיחת מצלמות",enabled:!0,last:"אתמול 23:10"},{id:"r-2",name:"רכב באזור מוגבל",trigger:"זיהוי רכב",scope:"חניה מקורה",action:"התראה",enabled:!0,last:"היום 09:42"},{id:"r-3",name:"דלת נשארה פתוחה",trigger:"דלת > 60 שנ׳",scope:"כל הדלתות",action:"התראה + הקלטה",enabled:!0,last:"—"},{id:"r-4",name:"מצלמה מנותקת",trigger:"ניתוק",scope:"כל האתר",action:"התראה מיידית",enabled:!1,last:"היום 07:55"}],cr=[{name:"NVR (הקלטה)",state:"live",detail:"10/10 ערוצים, דיסק תקין"},{name:"go2rtc (מדיה)",state:"live",detail:"גרסה ‎1.9.x‎ · 4 זרמים פעילים"},{name:"גשר Home Assistant",state:"stale",detail:"סנכרון אחרון לפני 4 דק׳"},{name:"מסד נתונים",state:"live",detail:"WAL · גיבוי אחרון אתמול 02:00"},{name:"תור עבודות",state:"partial",detail:"1 בתהליך · 1 נכשל"}],mo=["live","explore","investigate","system"];function ws(e=window.location.hash){const t=e.replace(/^#/,"")||"/explore/floors/f0",[s,i=""]=t.split("?"),a=s.startsWith("/")?s:`/${s}`,n=a.split("/").filter(Boolean),o=n[0];return{path:a,segments:n,params:new URLSearchParams(i),mode:o&&mo.includes(o)?o:null}}function b(e,t){const s=t?`?${new URLSearchParams(t).toString()}`:"";window.location.hash=`#${e}${s}`}function fo(e){const t=()=>e(ws());return window.addEventListener("hashchange",t),e(ws()),()=>window.removeEventListener("hashchange",t)}const Ai=new Set;let mt={mode:"loading",me:null,error:null};function As(e){mt=e,Ai.forEach(t=>t(mt))}function pr(e){return Ai.add(e),e(mt),()=>Ai.delete(e)}async function wo(){try{const e=await z("me");As({mode:e.has_access?"api":"no_access",me:e,error:null})}catch(e){e instanceof xe&&e.status===401?As({mode:"unauthenticated",me:null,error:e.body.user_message}):e instanceof xe?As({mode:"demo",me:null,error:e.body.user_message}):As({mode:"demo",me:null,error:null})}return mt}const g=()=>mt.mode==="api";function vo(e){const t=ut.find(i=>i.id===e)??ut[0],s=as.filter(i=>i.floorId===t.id);return{source:"demo",floorId:t.id,floorName:t.name,buildingName:fa.building,siteName:fa.name,width:t.planWidth||1200,height:t.planHeight||800,imageUrl:null,planSvg:t.hasPlan?rr(t.id):null,planStatus:t.hasPlan?"published":"none",planVersionId:t.hasPlan?`demo-${t.id}`:null,needsAlignment:!1,renderMode:"source",stylizedAvailable:!1,planPublishedAt:null,planArchivedAt:null,at:null,history:null,historyFrom:null,haHistory:null,anchors:s.map((i,a)=>({id:`demo-anchor-${i.id}`,floor_id:t.id,plan_version_id:`demo-${t.id}`,resource_type:"camera",resource_id:i.id,position:{x:i.x,y:i.y},rotation_degrees:i.rotation,field_of_view_degrees:i.fov,layer_id:"cameras",label:i.name,revision:1,effective_from:"",effective_to:null,updated_at:"",camera:{id:i.id,recorder_id:"demo",channel:a+1,name:i.name,name_source:i.name,alias:null,enabled:!0,sort_order:a,main_track:null,sub_track:null,status:i.state==="offline"?"offline":"online",last_seen_at:null}})),zones:[],cameras:[],permissions:{edit:!0,publish:!0,import:!0}}}async function vs(e,t=!1,s){if(!g())return vo(e);const i=new URLSearchParams;t&&i.set("draft","true"),s&&i.set("at",s);const a=i.toString(),n=await z(`floors/${e}/map${a?`?${a}`:""}`);return{source:"api",floorId:n.floor.id,floorName:n.floor.name,buildingName:n.building.name,siteName:n.site.name,width:n.plan?.width_px??1200,height:n.plan?.height_px??800,imageUrl:n.plan?Xe(n.plan.image_url):null,planSvg:null,planStatus:n.plan?n.plan.status==="published"?"published":"draft":"none",planVersionId:n.plan?.id??null,needsAlignment:n.needs_alignment,anchors:n.anchors,zones:n.zones??[],cameras:n.cameras,permissions:n.permissions,renderMode:n.plan?.render_mode==="stylized"?"stylized":"source",stylizedAvailable:!!n.plan?.stylized_url,planPublishedAt:n.plan?.published_at??null,planArchivedAt:n.plan?.archived_at??null,at:n.at??null,history:n.history??null,historyFrom:n.history_from??null,haHistory:n.ha_history??null}}function rs(e,t){const s=e.camera;return s?s.status==="online"?"live":s.status==="offline"?"offline":t??"unknown":t??"unknown"}const go=e=>z(`floors/${e}/plan-assets`),bo=(e,t)=>{const s=new FormData;return s.append("file",t,t.name),ei(`floors/${e}/plan-assets`,s)},yo=e=>z(`floors/${e}/plan-versions`),$o=(e,t)=>A(`floors/${e}/plan-versions`,t),Ii=e=>A(`plan-versions/${e}/publish`),xo=(e,t)=>z(`plan-versions/${e}/diff`),ko=(e,t,s)=>A(`plan-versions/${e}/rollback`,{revision:t,expected_published_id:s}),wa=(e,t)=>A(`floors/${e}/anchors`,t),_o=(e,t)=>Le(`map-anchors/${e}`,t),zo=e=>he(`map-anchors/${e}`),Pe=()=>z("cameras"),So=()=>A("cameras/sync"),Mo=e=>A("cameras",e),Ao=(e,t)=>Le(`cameras/${e}`,t),Io=e=>z(`plan-assets/${e}/dxf`),Po=(e,t)=>Yt(`plan-assets/${e}/dxf`,t);function Eo(){return{source:"demo",sites:ki.map((t,s)=>({id:t.id,name:t.name,address:t.address,timezone:"Asia/Jerusalem",sort_order:s,updated_at:"",buildings:uo.filter(i=>i.siteId===t.id).map((i,a)=>({id:i.id,site_id:t.id,name:i.name,sort_order:a,updated_at:"",floors:i.floors.map((n,o)=>{const l=ut.find(p=>p.id===n.id);return{id:n.id,building_id:i.id,name:n.name,level:-o,sort_order:o,ha_area_id:null,has_plan:n.hasPlan,published_version_id:n.hasPlan?`demo-${n.id}`:null,plan_width_px:l?.planWidth??null,plan_height_px:l?.planHeight??null,draft_version_id:null,anchor_count:n.cameras+n.entities,camera_count:n.cameras,updated_at:""}})}))})),canCreateSite:!0}}async function gt(){if(!g())return Eo();const e=await z("sites?tree=true");return{source:"api",sites:e.sites,canCreateSite:e.can_create_site}}const Co=e=>A("sites",e),To=(e,t)=>Le(`sites/${e}`,t),Do=e=>he(`sites/${e}`),hr=(e,t)=>A(`sites/${e}/buildings`,t),Oo=(e,t)=>Le(`buildings/${e}`,t),Ro=e=>he(`buildings/${e}`),No=(e,t)=>A(`buildings/${e}/floors`,t),Bo=(e,t)=>Le(`floors/${e}`,t),Lo=(e,t=!1)=>he(`floors/${e}${t?"?force=true":""}`);function Ho(e,t,s){const i=new FormData;return i.append("file",s,s.name),ei(`${e}s/${t}/image`,i)}const Vo=(e,t)=>Dt(`${e}s/${t}/image`,{method:"DELETE"}),va=e=>ce(e.replace(/^api\/v1\//,""));function ur(e,t){for(const s of e.sites)for(const i of s.buildings??[]){const a=(i.floors??[]).find(n=>n.id===t);if(a)return{site:s,building:i,floor:a}}return null}function mr(e){for(const t of e.sites)for(const s of t.buildings??[])for(const i of s.floors??[])return i;return null}function Pt(e){return String(e??"").replace(/(^|[^\w])(-\d)/g,"$1‎$2")}function jo(e){return e==null?"":`‎${e}`}const Pi=[{id:"room",label:"חדר"},{id:"zone",label:"אזור"},{id:"corridor",label:"מסדרון"},{id:"outdoor",label:"חוץ"},{id:"service",label:"שירות / טכני"}],Fo=e=>Pi.find(t=>t.id===e)?.label??e,Uo=e=>z(`floors/${e}/zones`),Wo=(e,t)=>A(`floors/${e}/zones`,t),Zo=(e,t)=>Le(`zones/${e}`,t),qo=e=>he(`zones/${e}`),Ko=(e,t="medium")=>A(`floors/${e}/zones/detect`,{strength:t}),Go=(e,t,s)=>A(`floors/${e}/zones/accept`,{candidates:t,replace_auto:s});function ns(e,t){let s=!1;for(let i=0,a=t.length-1;i<t.length;a=i++){const n=t[i],o=t[a];n.y>e.y!=o.y>e.y&&e.x<(o.x-n.x)*(e.y-n.y)/(o.y-n.y)+n.x&&(s=!s)}return s}const fr=()=>z("views"),wr=e=>A("views",e),Yo=(e,t)=>Yt(`views/${e}`,t),Jo=e=>he(`views/${e}`),vr=e=>`#/live/wall?cameras=${encodeURIComponent(e.cameras.join(","))}`,Xo=e=>`#/kiosk/all?cameras=${encodeURIComponent(e.cameras.join(","))}&cols=${e.cols}&rows=${e.rows}`;var Qo=Object.defineProperty,el=Object.getOwnPropertyDescriptor,_s=(e,t,s,i)=>{for(var a=i>1?void 0:i?el(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&Qo(t,s,a),a};let Et=class extends ${constructor(){super(...arguments),this.checked=!1,this.disabled=!1,this.label="",this.labelHidden=!1}flip(){this.disabled||(this.checked=!this.checked,this.dispatchEvent(new CustomEvent("change",{detail:{checked:this.checked},bubbles:!0,composed:!0})))}render(){return r`<button type="button" role="switch" aria-checked=${this.checked} aria-label=${this.label} ?disabled=${this.disabled} @click=${this.flip}></button>${this.label&&!this.labelHidden?r`<span>${this.label}</span>`:""}`}};Et.styles=x`
    :host {
      display: inline-flex;
      align-items: center;
      gap: var(--sw-s-2);
  ...
  `;_s([u({type:Boolean,reflect:!0})],Et.prototype,"checked",2);_s([u({type:Boolean,reflect:!0})],Et.prototype,"disabled",2);_s([u()],Et.prototype,"label",2);_s([u({type:Boolean})],Et.prototype,"labelHidden",2);Et=_s([k("sw-toggle")],Et);function gr(e={}){const t=new URLSearchParams;e.domain&&t.set("domain",e.domain),e.q&&t.set("q",e.q),e.area&&t.set("area",e.area),e.placed!==void 0&&t.set("placed",String(e.placed)),e.includeDisabled&&t.set("include_disabled","true"),e.limit&&t.set("limit",String(e.limit));const s=t.toString();return z(`ha/entities${s?`?${s}`:""}`)}const tl=()=>z("ha/status"),sl=(e=!1)=>z(`ha/bridge/pairing${e?"?regenerate=true":""}`),ga=e=>z(`ha/actions/${e}`),il=()=>A("ha/bridge/install");function al(e,t,s={},i=!1){const a={allowed_action_id:t,arguments:s,expected_state_version:null,confirmation_grant:i?"confirmed":null,client_request_id:crypto.randomUUID(),expires_at:new Date(Date.now()+6e4).toISOString().replace(/\.\d{3}Z$/,"Z")};return A(`ha/entities/${encodeURIComponent(e)}/actions`,a)}async function rl(e,t,s){let i=await ga(e);t(i);for(let a=0;a<16&&i.status==="pending";a++)await new Promise(n=>setTimeout(n,1500)),i=await ga(e),t(i);return i}const nl={ha_unauthorized:"Home Assistant דחה את הפעולה: למשתמש שלך אין הרשאה לישות זו ב־Home Assistant",ha_unknown_user:"Home Assistant אינו מכיר את המשתמש שמאחורי ההפעלה הזו",bridge_not_paired:"גשר SMPLWISE אינו מצומד",bridge_error:"הגשר החזיר שגיאה",ha_unavailable:"Home Assistant אינו זמין",service_not_allowed:"הגשר סירב: השירות אינו ברשימת הפעולות המאושרות (גשר ישן? מאז 0.2.1 נוספו climate / media / number / select / alarm — הפעל את Home Assistant מחדש כדי לטעון את הגרסה החדשה)",unknown_user:"Home Assistant אינו מכיר את המשתמש"},ol={pending:"נשלח · ממתין לעדכון מ־Home Assistant",confirmed:"אושר · המצב התעדכן",unknown:"לא ידוע · לא התקבל עדכון מצב",failed:"נכשל",denied:"נדחה · אין הרשאה ב־Home Assistant"},ll=new Set(["on","open","opening","unlocked","unlocking","playing","home","heat","cool","heat_cool","dry","fan_only","cleaning","active","detected","problem","running"]),Is={on:"דולק",off:"כבוי",locked:"נעול",unlocked:"פתוח",locking:"נועל…",unlocking:"פותח…",jammed:"תקוע",open:"פתוח",closed:"סגור",opening:"נפתח…",closing:"נסגר…",unavailable:"לא זמין",unknown:"לא ידוע",idle:"לא פעיל",home:"בבית",not_home:"מחוץ לבית",playing:"מנגן",paused:"מושהה",standby:"המתנה",heat:"חימום",cool:"קירור",auto:"אוטומטי",dry:"ייבוש",fan_only:"מאוורר",docked:"בתחנה",cleaning:"מנקה",returning:"חוזר"},dl={motion:["תנועה","ללא תנועה"],occupancy:["נוכחות","ללא נוכחות"],presence:["נוכח","לא נוכח"],door:["פתוחה","סגורה"],window:["פתוח","סגור"],opening:["פתוח","סגור"],garage_door:["פתוח","סגור"],lock:["פתוח","נעול"],connectivity:["מחובר","מנותק"],power:["פועל","כבוי"],problem:["תקלה","תקין"],safety:["לא בטוח","בטוח"],smoke:["עשן","ללא עשן"],moisture:["רטוב","יבש"],battery:["סוללה חלשה","סוללה תקינה"],running:["פועל","לא פועל"],sound:["רעש","שקט"],vibration:["רטט","ללא רטט"],update:["עדכון זמין","מעודכן"]};function ft(e){const t=e.state;if(t==null)return"לא ידוע";if(t==="unavailable"||t==="unknown")return Is[t];if(e.domain==="binary_sensor"){const s=dl[e.device_class??""];return s?t==="on"?s[0]:s[1]:t==="on"?"פעיל":"לא פעיל"}if(e.domain==="sensor"||e.domain==="number"||e.domain==="input_number"){const s=Number(t);return!Number.isNaN(s)&&t.trim()!==""?`${Number.isInteger(s)?s:s.toFixed(Math.min(2,(t.split(".")[1]??"").length))}${e.unit?` ${e.unit}`:""}`:t}return e.domain==="light"&&t==="on"&&typeof e.attributes.brightness=="number"?`דולק · ${Math.round(e.attributes.brightness/255*100)}%`:e.domain==="cover"&&typeof e.attributes.current_position=="number"&&(t==="open"||t==="closed")?`${Is[t]} · ${e.attributes.current_position}%`:e.domain==="climate"&&typeof e.attributes.current_temperature=="number"?`${Is[t]??t} · ${e.attributes.current_temperature}°`:Is[t]??t}function Ei(e){return!e||e.removed_at?"unknown":e.state==="unavailable"||!e.available?"offline":e.fresh?e.state===null||e.state==="unknown"?"unknown":ll.has(e.state)?"live":"neutral":"stale"}function si(e,t){return e==="doors"||t==="lock"||t==="cover"?"lock":e==="lights"||t==="light"||t==="switch"||t==="fan"?"light":"binary_sensor"}function gs(e){return{light:"תאורה",switch:"מתג",lock:"מנעול",cover:"תריס / שער",binary_sensor:"חיישן בינארי",sensor:"חיישן",fan:"מאוורר",climate:"אקלים",camera:"מצלמת HA",button:"כפתור",script:"סקריפט",scene:"סצנה",automation:"אוטומציה",media_player:"נגן",event:"אירוע",number:"מספר",select:"בחירה",input_boolean:"דגל",alarm_control_panel:"אזעקה",siren:"צופר",vacuum:"שואב",weather:"מזג אוויר",sun:"שמש"}[e]??e}function De(e){if(!e)return"—";const t=new Date(e);return Number.isNaN(t.getTime())?e:t.toLocaleString("he-IL",{dateStyle:"short",timeStyle:"medium"})}function br(e,t){let s=null,i=!1,a=2e3;const n=(()=>{const l=new URL(ce("ha/ws"));return l.protocol=l.protocol==="https:"?"wss:":"ws:",l.toString()})(),o=()=>{if(!i){try{s=new WebSocket(n)}catch{return}s.onopen=()=>{a=2e3},s.onmessage=l=>{try{const p=JSON.parse(l.data);p.type==="entity_state_changed"?e({type:"entity_state_changed",entity:p.payload.entity}):p.type==="ha_sync_state"?e({type:"ha_sync_state",connected:!!p.payload.connected}):p.type==="heartbeat"&&e({type:"heartbeat",sync:p.payload.sync})}catch{}},s.onclose=l=>{!i&&l.code!==4403&&l.code!==4401&&(window.setTimeout(o,a),a=Math.min(3e4,a*2))}}};return o(),()=>{i=!0,s?.close()}}var cl=Object.defineProperty,pl=Object.getOwnPropertyDescriptor,V=(e,t,s,i)=>{for(var a=i>1?void 0:i?pl(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&cl(t,s,a),a};const hl={off:"כבוי",heat:"חימום",cool:"קירור",heat_cool:"חימום/קירור",auto:"אוטומטי",dry:"ייבוש",fan_only:"מאוורר בלבד"},ul=[{id:"cameras",icon:"camera",label:()=>y("floor.cameras")},{id:"doors",icon:"door",label:()=>y("floor.doors")},{id:"lights",icon:"light",label:()=>y("floor.lights")},{id:"sensors",icon:"sensor",label:()=>y("floor.sensors")},{id:"zones",icon:"map",label:()=>"חדרים ואזורים"}],ba=["entrance","lobby","corridor","hall","parking","warehouse","backyard","driveway","night"];let R=class extends ${constructor(){super(...arguments),this.floorId="f0",this.screenState="ready",this.focusZone="",this.focusCamera="",this.focusEntity="",this.selectedZoneId=null,this.bundle=null,this.tree=null,this.loadError="",this.noFloors=!1,this.selectedId=null,this.anchor=null,this.layers=new Set(["cameras","doors","lights","sensors","zones"]),this.pinned=!1,this.panel=!1,this.multi=!1,this.sideList=(()=>{try{return localStorage.getItem("sw.map.sidelist")==="1"}catch{return!1}})(),this.saveView=null,this.savedView=null,this.picked=[],this.narrow=!1,this.syncConnected=!0,this.action=null,this.confirmSpec=null,this.stopWs=null,this.mq=window.matchMedia("(max-width: 767px)"),this.onMq=()=>this.narrow=this.mq.matches,this.onKey=e=>{if(e.key==="Escape"&&!this.confirmSpec)if(this.selectedId){const t=this.selectedId;this.close(),this.canvas?.focusMarker(t)}else this.panel&&(this.panel=!1)},this.actionArgs={}}connectedCallback(){super.connectedCallback(),this.narrow=this.mq.matches,this.mq.addEventListener("change",this.onMq),window.addEventListener("keydown",this.onKey),this.load()}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("keydown",this.onKey),this.mq.removeEventListener("change",this.onMq),this.stopWs?.(),this.stopWs=null}startWs(){this.stopWs||!g()||(this.stopWs=br(e=>{const t=this.bundle;if(e.type==="entity_state_changed"&&t){if(!t.anchors.some(s=>s.resource_type==="ha_entity"&&s.resource_id===e.entity.entity_id))return;this.bundle={...t,anchors:t.anchors.map(s=>s.resource_type==="ha_entity"&&s.resource_id===e.entity.entity_id?{...s,entity:{...s.entity??{},...e.entity,actions:s.entity?.actions}}:s)}}else e.type==="ha_sync_state"?this.syncConnected=e.connected:e.type==="heartbeat"&&(this.syncConnected=e.sync.connected)}))}updated(e){e.has("floorId")&&e.get("floorId")!==void 0?(this.selectedId=null,this.anchor=null,this.selectedZoneId=null,this.load()):(e.has("focusZone")||e.has("focusCamera")||e.has("focusEntity"))&&this.bundle&&this.applyFocus()}async applyFocus(){const e=this.bundle;if(!e||!this.focusZone&&!this.focusCamera&&!this.focusEntity)return;await this.updateComplete;const t=this.canvas;if(!t)return;const s=this.focusZone?e.zones.find(a=>a.id===this.focusZone):null;if(s){const a=s.polygon.map(o=>o.x),n=s.polygon.map(o=>o.y);this.selectedZoneId=s.id,t.zoomToBox(Math.min(...a),Math.min(...n),Math.max(...a),Math.max(...n))}const i=this.focusCamera?e.anchors.find(a=>a.resource_type==="camera"&&a.resource_id===this.focusCamera):this.focusEntity?e.anchors.find(a=>a.resource_type==="ha_entity"&&a.resource_id===this.focusEntity):null;if(i){t.zoomToBox(i.position.x-.12,i.position.y-.12,i.position.x+.12,i.position.y+.12),await this.updateComplete;const a=t.toScreen(i.position.x,i.position.y);this.selectedId=i.id,this.anchor={x:a.x,y:a.y}}}async load(){this.loadError="";try{const e=this.tree??await gt();if(this.tree=e,g()&&!ur(e,this.floorId)){const t=mr(e);if(t&&t.id!==this.floorId){b(`/explore/floors/${t.id}`);return}if(!t){this.noFloors=!0,this.bundle=null;return}}this.noFloors=!1,this.restoreLayers(),this.bundle=await vs(this.floorId),this.bundle.source==="api"&&this.startWs(),this.applyFocus()}catch(e){this.loadError=w(e),this.bundle=null}}get floors(){return this.tree?.source==="api"?this.tree.sites.flatMap(e=>(e.buildings??[]).flatMap(t=>(t.floors??[]).map(s=>({id:s.id,name:`${t.name} · ${s.name}`,cameraCount:s.camera_count,hasPlan:s.has_plan})))):ut.map(e=>({id:e.id,name:e.name,cameraCount:e.cameraCount,hasPlan:e.hasPlan}))}get markers(){const e=this.bundle;if(!e)return[];const t=this.screenState==="stale";if(e.source==="demo"){const s=this.layers.has("cameras")?as.filter(a=>a.floorId===e.floorId).map(a=>({id:a.id,kind:"camera",label:a.name,x:a.x,y:a.y,rotation:a.rotation,fov:a.fov,state:a.state})):[],i=Rs.filter(a=>a.floorId===e.floorId).filter(a=>a.domain==="lock"&&this.layers.has("doors")||a.domain==="light"&&this.layers.has("lights")||a.domain==="binary_sensor"&&this.layers.has("sensors")).map(a=>({id:a.id,kind:a.domain,label:a.name,x:a.x,y:a.y,state:t?"stale":"neutral"}));return[...s,...i]}return e.anchors.filter(s=>s.resource_type==="camera"?this.layers.has("cameras"):this.layers.has(s.layer_id==="doors"?"doors":s.layer_id==="lights"?"lights":"sensors")).map(s=>({id:s.id,kind:s.resource_type==="camera"?"camera":si(s.layer_id,s.entity?.domain),label:s.camera?.name??s.entity?.name??s.label??s.resource_id,x:s.position.x,y:s.position.y,rotation:s.rotation_degrees,fov:s.field_of_view_degrees??void 0,state:s.resource_type==="camera"?rs(s):t?"stale":this.entityTone(s.entity)}))}layerCounts(){const e=this.bundle,t={cameras:0,doors:0,lights:0,sensors:0,zones:e?.zones.length??0};if(!e)return t;if(e.source==="demo"){t.cameras=as.filter(s=>s.floorId===e.floorId).length;for(const s of Rs.filter(i=>i.floorId===e.floorId))s.domain==="lock"?t.doors++:s.domain==="light"?t.lights++:t.sensors++;return t}for(const s of e.anchors)s.resource_type==="camera"?t.cameras++:s.layer_id==="doors"?t.doors++:s.layer_id==="lights"?t.lights++:t.sensors++;return t}zoneOf(e){return this.bundle?.zones.find(s=>ns(e.position,s.polygon))?.name??null}toggleLayer(e){const t=new Set(this.layers);t.has(e)?t.delete(e):t.add(e),this.setLayers(t)}setLayers(e){this.layers=e;try{localStorage.setItem(`sw.floor.layers.${this.floorId}`,JSON.stringify([...e]))}catch{}}restoreLayers(){try{const e=localStorage.getItem(`sw.floor.layers.${this.floorId}`);if(!e)return;const t=JSON.parse(e);Array.isArray(t)&&(this.layers=new Set(t.filter(s=>["cameras","doors","lights","sensors","zones"].includes(s))))}catch{}}cameraAnchors(){return(this.bundle?.anchors??[]).filter(e=>e.resource_type==="camera"&&this.layers.has("cameras"))}togglePick(e){this.picked=this.picked.includes(e)?this.picked.filter(t=>t!==e):[...this.picked,e]}pickedCameraIds(){const e=new Map((this.bundle?.anchors??[]).map(t=>[t.id,t.resource_id]));return this.picked.map(t=>e.get(t)).filter(t=>!!t)}setMulti(e){this.multi=e,this.picked=[],this.saveView=null,this.savedView=null,e&&this.close()}addPicks(e){const t=new Set(this.cameraAnchors().map(i=>i.id)),s=e.filter(i=>t.has(i)&&!this.picked.includes(i));s.length&&(this.picked=[...this.picked,...s])}pickZone(e){const t=this.bundle?.zones.find(a=>a.id===e);if(!t)return;const s=this.cameraAnchors().filter(a=>ns(a.position,t.polygon)).map(a=>a.id);if(!s.length)return;const i=s.every(a=>this.picked.includes(a));this.picked=i?this.picked.filter(a=>!s.includes(a)):[...this.picked,...s.filter(a=>!this.picked.includes(a))]}roomChips(){const e=this.bundle;if(!e)return c;const t=this.cameraAnchors(),s=e.zones.map(i=>({z:i,ids:t.filter(a=>ns(a.position,i.polygon)).map(a=>a.id)})).filter(i=>i.ids.length);return s.length?r`<span class="roomchips" data-room-chips>${s.map(i=>r`<sw-chip icon="layers" data-room-chip=${i.z.id} ?selected=${i.ids.every(a=>this.picked.includes(a))} @click=${()=>this.pickZone(i.z.id)}>${i.z.name} (${i.ids.length})</sw-chip>`)}</span>`:c}toggleSideList(){this.sideList=!this.sideList;try{localStorage.setItem("sw.map.sidelist",this.sideList?"1":"0")}catch{}}async jumpTo(e){if(e.resource_type==="camera"?(this.focusCamera=e.resource_id,this.focusEntity=""):(this.focusEntity=e.resource_id,this.focusCamera=""),this.focusZone="",this.multi&&e.resource_type==="camera"){this.togglePick(e.id);return}await this.applyFocus()}renderSideList(){const e=this.bundle;if(!e||!this.sideList||e.source!=="api")return c;const t=e.anchors.filter(o=>o.resource_type==="camera"),s=e.anchors.filter(o=>o.resource_type==="ha_entity"),i={light:"תאורה",switch:"מפסקים",lock:"מנעולים",binary_sensor:"חיישנים",sensor:"חיישנים",cover:"תריסים",climate:"מיזוג",media_player:"מדיה",alarm_control_panel:"אזעקה"},a=new Map;for(const o of s){const l=o.entity?.domain??o.resource_id.split(".")[0];a.set(l,[...a.get(l)??[],o])}const n=o=>o.camera?o.camera.status==="online"?"#22c55e":o.camera.status==="offline"?"#ef4444":"var(--sw-text-3)":o.entity?.state==="on"||o.entity?.state==="unlocked"||o.entity?.state==="open"?"var(--sw-accent)":"var(--sw-text-3)";return r`<div class="sidelist" data-sidelist>
      ...
      <div class="body">
        ...
        ${this.floors.map(o=>r`<button class="it ${o.id===this.floorId?"on":""}" data-side-floor=${o.id} @click=${()=>{o.id!==this.floorId&&b(`/explore/floors/${o.id}`)}}>
          <sw-icon name="building" size=${12}></sw-icon><span class="nm">${Pt(o.name)}</span><span class="st">${o.cameraCount} מצלמות${o.hasPlan?"":" · אין תוכנית"}</span></button>`)}
    ...
    </sw-dialog>`}openWall(){const e=this.pickedCameraIds();e.length&&b("/live/wall",{cameras:e.join(",")})}openSync(){const e=this.pickedCameraIds();e.length&&b("/investigate/playback",{camera:e[0],extra:e.slice(1,4).join(",")})}renderPickbar(){const e=this.bundle;if(!e)return c;const t=this.cameraAnchors(),s=m=>e.anchors.find(f=>f.id===m),i=m=>{const f=s(m);return f?.camera?.name??f?.label??f?.resource_id??m},a=this.pickSummary(),n=e.anchors.filter(m=>m.resource_type==="camera").length,o=this.floors.find(m=>m.id===this.floorId)?.cameraCount??n,l=Math.max(0,o-n),p=a.total?`נבחרו ${a.total} · ${a.online} זמינות${a.offline?` · ${a.offline} לא מקוונות`:""}${a.denied?` · ${a.denied} ללא הרשאה`:""}${l?` · ${l} מצלמות של הקומה אינן על המפה`:""}`:`לחץ על מצלמות או גרור מלבן על המפה · לחיצה על חדר בוחרת את מצלמותיו · Shift+גרירה מזיזה את המפה · עד 4 לניגון מסונכרן${l?` · ${l} מצלמות של הקומה אינן על המפה`:""}`;return r`<div class="pickbar" data-pickbar>
      <span class="hint" data-pick-hint>${p}</span>
      ${this.picked.map(m=>{const f=s(m),v=f?.camera?.can_view_live===!1;return r`<sw-chip selected icon="camera" dot=${this.pickDot(f)} title=${v?"אין הרשאת צפייה חיה":f?.camera?.status==="online"?"מקוונת":"לא מקוונת"} data-pick-chip=${v?"denied":f?.camera?.status??"unknown"} @click=${()=>this.togglePick(m)}>${i(m)}</sw-chip>`})}
      <sw-chip data-pick-all @click=${()=>this.picked=t.map(m=>m.id)}>בחר הכל (${t.length})</sw-chip>
      ${this.roomChips()}
      ...
      ${s.actions===void 0?r`<div class="note">${y("entity.noControl")}</div>`:s.actions.length===0?r`<div class="note">קריאה בלבד — אין פעולות מותרות ל־${gs(s.domain)}.</div>`:c}
      ...
      ${a?r`<div class=${a.error||a.record?.status==="failed"||a.record?.status==="denied"?"warn":"note"}>${a.spec.label}: ${a.error?a.error:a.record?`${ol[a.record.status]}${a.record.error?` — ${nl[a.record.error]??a.record.error}`:""}`:"שולח…"}</div>`:c}
    ...
    `}apiCameraBody(e,t){const s=e.camera,i=rs(e),a=ba[((s?.channel??1)-1)%ba.length],n=i==="live"&&!!s&&s.can_view_live!==!1,o=this.zoneOf(e),l=o?`${t} / ${o}`:`${t} · ערוץ ${s?.channel??"?"}`;return r`
      ${i==="offline"?r`<div class="off"><div><sw-icon name="offline" size=${22}></sw-icon><div>${y("camera.offlineReason")}</div></div></div>`:r`<sw-camera-tile name="" state=${i==="live"?"live":"unknown"} scene=${a} poster=${s?Fe(s.id,Date.now()):""} ?live=${n} .cameraId=${n?s.id:""} data-live=${n?"1":"0"} @click=${()=>s&&b(`/live/cameras/${s.id}`)}></sw-camera-tile>`}
      ...
      <div class="head">
        ...
        <div class="tools">
          <div class="layers" role="group" aria-label=${y("floor.layers")}>
            ${ul.map(n=>r`<button class=${this.layers.has(n.id)?"on":""} title=${n.label()} aria-label=${n.label()} aria-pressed=${this.layers.has(n.id)} @click=${()=>this.toggleLayer(n.id)}><sw-icon name=${n.icon} size=${14}></sw-icon></button>`)}
          </div>
          ...
          <sw-field style="min-inline-size:280px"><select aria-label=${y("floor.switcher")} @change=${n=>b(`/explore/floors/${n.target.value}`)}>${t.map(n=>r`<option value=${n.id} ?selected=${n.id===this.floorId}>${Pt(n.name)} · ${n.cameraCount} מצלמות${n.hasPlan?"":" · אין תוכנית"}</option>`)}</select></sw-field>
  ...
  `;V([u()],R.prototype,"floorId",2);V([u()],R.prototype,"screenState",2);V([u()],R.prototype,"focusZone",2);V([u()],R.prototype,"focusCamera",2);V([u()],R.prototype,"focusEntity",2);V([d()],R.prototype,"selectedZoneId",2);V([d()],R.prototype,"bundle",2);V([d()],R.prototype,"tree",2);V([d()],R.prototype,"loadError",2);V([d()],R.prototype,"noFloors",2);V([d()],R.prototype,"selectedId",2);V([d()],R.prototype,"anchor",2);V([d()],R.prototype,"layers",2);V([d()],R.prototype,"pinned",2);V([d()],R.prototype,"panel",2);V([d()],R.prototype,"multi",2);V([d()],R.prototype,"sideList",2);V([d()],R.prototype,"saveView",2);V([d()],R.prototype,"savedView",2);V([d()],R.prototype,"picked",2);V([d()],R.prototype,"narrow",2);V([d()],R.prototype,"syncConnected",2);V([d()],R.prototype,"action",2);V([d()],R.prototype,"confirmSpec",2);V([Kt("sw-plan-canvas")],R.prototype,"canvas",2);V([Kt(".stage")],R.prototype,"stage",2);V([d()],R.prototype,"actionArgs",2);R=V([k("explore-floor-map")],R);var ml=Object.defineProperty,fl=Object.getOwnPropertyDescriptor,Xt=(e,t,s,i)=>{for(var a=i>1?void 0:i?fl(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&ml(t,s,a),a};let wt=class extends ${constructor(){super(...arguments),this.heading="",this.subheading="",this.crumbs="",this.wide=!1,this.flush=!1}render(){const e=this.crumbs?this.crumbs.split("|").map(t=>t.trim()):[];return r`
      <header>
        <div>
  ...
  `;Xt([u()],wt.prototype,"heading",2);Xt([u()],wt.prototype,"subheading",2);Xt([u()],wt.prototype,"crumbs",2);Xt([u({type:Boolean,reflect:!0})],wt.prototype,"wide",2);Xt([u({type:Boolean,reflect:!0})],wt.prototype,"flush",2);wt=Xt([k("sw-page")],wt);var wl=Object.defineProperty,vl=Object.getOwnPropertyDescriptor,zs=(e,t,s,i)=>{for(var a=i>1?void 0:i?vl(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&wl(t,s,a),a};let Ct=class extends ${constructor(){super(...arguments),this.heading="",this.subheading="",this.flush=!1,this.interactive=!1}render(){return r`
  ...
  `;zs([u()],Ct.prototype,"heading",2);zs([u()],Ct.prototype,"subheading",2);zs([u({type:Boolean,reflect:!0})],Ct.prototype,"flush",2);zs([u({type:Boolean,reflect:!0})],Ct.prototype,"interactive",2);Ct=zs([k("sw-card")],Ct);var gl=Object.defineProperty,bl=Object.getOwnPropertyDescriptor,at=(e,t,s,i)=>{for(var a=i>1?void 0:i?bl(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&gl(t,s,a),a};const yl=["house","building","warehouse"];let Re=class extends ${constructor(){super(...arguments),this.tab="all",this.tree=null,this.dialog=null,this.notice="",this.formName="",this.formAddress="",this.busy=!1,this.error=""}connectedCallback(){super.connectedCallback(),this.reload()}async reload(){try{this.tree=await gt()}catch(e){this.error=w(e)}}open(e){this.formName=e&&e.kind==="edit-site"?e.site.name:e&&e.kind==="edit-building"?e.building.name:"",this.formAddress=e&&e.kind==="edit-site"?e.site.address:"",this.error="",this.dialog=e}pickImage(e,t){const s=document.createElement("input");s.type="file",s.accept="image/png,image/jpeg",s.addEventListener("change",async()=>{const i=s.files?.[0];if(i){this.busy=!0;try{await Ho(e,t,i),this.notice="התמונה נשמרה.",await this.reload()}catch(a){this.notice=w(a)}finally{this.busy=!1}}}),s.click()}async removeImage(e,t){this.busy=!0;try{await Vo(e,t),await this.reload()}catch(s){this.notice=w(s)}finally{this.busy=!1}}renderMenu(e,t,s){const i=s?!!s.image_url:!!t.image_url,a=s?s.id:t.id;return r`<span class="menu" @click=${o=>o.stopPropagation()}>
    ...
    </span>`}async submit(){const e=this.dialog;if(e){this.busy=!0,this.error="";try{if(e.kind==="site"){const t=await Co({name:this.formName.trim(),address:this.formAddress.trim()});this.dialog=null,await this.reload(),this.open({kind:"building",site:t})}else if(e.kind==="building"){const t=await hr(e.site.id,{name:this.formName.trim()});this.dialog=null,b(`/explore/buildings/${t.id}/floors`)}else e.kind==="edit-site"?(await To(e.site.id,{name:this.formName.trim(),address:this.formAddress.trim()}),this.dialog=null,await this.reload()):e.kind==="edit-building"?(await Oo(e.building.id,{name:this.formName.trim()}),this.dialog=null,await this.reload()):e.kind==="delete-site"?(await Do(e.site.id),this.dialog=null,await this.reload()):e.kind==="delete-building"&&(await Ro(e.building.id),this.dialog=null,await this.reload())}catch(t){this.error=w(t)}finally{this.busy=!1}}}openSite(e){const t=e.buildings?.[0];t?b(`/explore/buildings/${t.id}/floors`):this.open({kind:"building",site:e})}renderSites(e){return r`<div class="grid">
      ${e.sites.map((t,s)=>{const i=t.buildings??[],a=i.reduce((n,o)=>n+(o.floors??[]).reduce((l,p)=>l+p.camera_count,0),0);return r`<sw-card flush interactive data-site-card=${t.id} @click=${()=>this.openSite(t)}>
          <div class="pic">${t.image_url?r`<img class="photo" src=${va(t.image_url)} alt="" />`:r`<sw-scene kind=${yl[s%3]}></sw-scene>${e.source==="demo"?r`<span class="demo">דמו</span>`:r`<span class="demo">איור</span>`}`}</div>
          <div class="info">
      ...
      ${t.map(({s,b:i},a)=>r`<sw-card class="brow" data-building-card=${i.id} @click=${()=>b(`/explore/buildings/${i.id}/floors`)}>
          ${i.image_url?r`<img class="photo small" src=${va(i.image_url)} alt="" />`:r`<sw-scene kind=${a%2?"house":"building"}></sw-scene>`}
  ...
  `;at([d()],Re.prototype,"tab",2);at([d()],Re.prototype,"tree",2);at([d()],Re.prototype,"dialog",2);at([d()],Re.prototype,"notice",2);at([d()],Re.prototype,"formName",2);at([d()],Re.prototype,"formAddress",2);at([d()],Re.prototype,"busy",2);at([d()],Re.prototype,"error",2);Re=at([k("explore-sites")],Re);var $l=Object.defineProperty,xl=Object.getOwnPropertyDescriptor,Ss=(e,t,s,i)=>{for(var a=i>1?void 0:i?xl(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&$l(t,s,a),a};let Tt=class extends ${constructor(){super(...arguments),this.rooms=[],this.selected=!1,this.empty=!1,this.width=132}iso(e,t){return{x:60+(e-t)*58,y:6+(e+t)*26}}poly(e){return e.map(t=>`${t.x.toFixed(1)},${t.y.toFixed(1)}`).join(" ")}render(){this.style.setProperty("--w",`${this.width}px`);const e=[this.iso(0,0),this.iso(1,0),this.iso(1,1),this.iso(0,1)],t=7,s=[this.iso(1,0),this.iso(1,1),{x:this.iso(1,1).x,y:this.iso(1,1).y+t},{x:this.iso(1,0).x,y:this.iso(1,0).y+t}],i=[this.iso(0,1),this.iso(1,1),{x:this.iso(1,1).x,y:this.iso(1,1).y+t},{x:this.iso(0,1).x,y:this.iso(0,1).y+t}];return r`<svg viewBox="0 0 120 72" aria-hidden="true">
  ...
  `;Ss([u({attribute:!1})],Tt.prototype,"rooms",2);Ss([u({type:Boolean,reflect:!0})],Tt.prototype,"selected",2);Ss([u({type:Boolean,reflect:!0})],Tt.prototype,"empty",2);Ss([u({type:Number})],Tt.prototype,"width",2);Tt=Ss([k("sw-floor-iso")],Tt);var kl=Object.defineProperty,_l=Object.getOwnPropertyDescriptor,Ze=(e,t,s,i)=>{for(var a=i>1?void 0:i?_l(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&kl(t,s,a),a};let Se=class extends ${constructor(){super(...arguments),this.buildingId="bld-a",this.tree=null,this.selected=null,this.tab="floors",this.dialog=null,this.busy=!1,this.error="",this.formName="",this.formLevel=0}connectedCallback(){super.connectedCallback(),this.reload()}updated(e){e.has("buildingId")&&e.get("buildingId")!==void 0&&(this.selected=null)}async reload(){try{this.tree=await gt(),this.error=""}catch(e){this.error=w(e)}}get context(){if(!this.tree)return null;for(const s of this.tree.sites)for(const i of s.buildings??[])if(i.id===this.buildingId)return{site:s,building:i};const e=this.tree.sites[0],t=e?.buildings?.[0];return e&&t?{site:e,building:t}:null}async run(e){this.busy=!0,this.error="";try{await e(),this.dialog=null,await this.reload()}catch(t){t instanceof xe&&t.code==="has_anchors"&&this.dialog?.kind==="delete"?(this.dialog={...this.dialog,force:!0},this.error=`${t.body.user_message} (${t.body.details.anchors??""} פריטים)`):this.error=w(t)}finally{this.busy=!1}}openDialog(e){this.error="",this.formName=e?.kind==="rename"?e.floor.name:"",this.formLevel=e?.kind==="rename"?e.floor.level:0,this.dialog=e}renderDialog(e){const t=this.dialog;if(!t)return c;const s=this.tree?.source==="demo",i=r`<sw-field label="שם"><input .value=${this.formName} @input=${l=>this.formName=l.target.value} placeholder="למשל: קומה 1" autofocus /></sw-field>`,a=r`<sw-field label="מפלס (0 = קרקע, שלילי = מרתף)" hint="קובע את סדר התצוגה בין הקומות"><input type="number" data-ltr .value=${String(this.formLevel)} @input=${l=>this.formLevel=Number(l.target.value)} /></sw-field>`,n=this.error?r`<div class="err">${this.error}</div>`:c,o=s?r`<div class="err">נתוני הדגמה: אין שרת מחובר, השינוי לא יישמר.</div>`:c;switch(t.kind){case"floor":return r`<sw-dialog open heading="קומה חדשה" subheading=${`${e.name}`} @close=${()=>this.dialog=null}>
          ${i}${a}${n}${o}
          <sw-button slot="footer" variant="ghost" @click=${()=>this.dialog=null}>ביטול</sw-button>
          <sw-button slot="footer" variant="primary" ?disabled=${!this.formName.trim()||this.busy||s} @click=${()=>this.run(async()=>{const l=await No(e.id,{name:this.formName.trim(),level:this.formLevel});this.selected=l.id})}>הוסף קומה</sw-button>
        </sw-dialog>`;case"rename":return r`<sw-dialog open heading="עריכת קומה" subheading=${t.floor.name} @close=${()=>this.dialog=null}>
          ${i}${a}${n}${o}
          <sw-button slot="footer" variant="ghost" @click=${()=>this.dialog=null}>ביטול</sw-button>
          <sw-button slot="footer" variant="primary" ?disabled=${!this.formName.trim()||this.busy||s} @click=${()=>this.run(()=>Bo(t.floor.id,{name:this.formName.trim(),level:this.formLevel}))}>שמירה</sw-button>
          ...
          ${n}${o}
          <sw-button slot="footer" variant="ghost" @click=${()=>this.dialog=null}>ביטול</sw-button>
          <sw-button slot="footer" variant="danger" ?disabled=${this.busy||s} @click=${()=>this.run(async()=>{await Lo(t.floor.id,t.force),this.selected===t.floor.id&&(this.selected=null)})}>${t.force?"מחק כולל הפריטים":"מחק קומה"}</sw-button>
          ...
          ${i}${n}${o}
          <sw-button slot="footer" variant="ghost" @click=${()=>this.dialog=null}>ביטול</sw-button>
          <sw-button slot="footer" variant="primary" ?disabled=${!this.formName.trim()||this.busy||s} @click=${()=>this.run(async()=>{const l=await hr(this.context.site.id,{name:this.formName.trim()});b(`/explore/buildings/${l.id}/floors`)})}>הוסף מבנה</sw-button>
      ...
      <sw-page heading=${s.name} subheading=${`${t.address||t.name} · ${i.length} קומות${o.source==="demo"?" · נתוני הדגמה":""}`} crumbs=${`אתרים | ${t.name} | ${s.name}`}>
        ...
        ${this.tab==="floors"?r`<div class="list">
              ...
              ${i.map(l=>r`<button class="floor ${a?.id===l.id?"on":""}" @click=${()=>a?.id===l.id?b(`/explore/floors/${l.id}`):this.selected=l.id} aria-pressed=${a?.id===l.id}>
                  <div class="txt">
                    <div class="title">${Pt(l.name)}</div>
                    <div class="counts">${l.camera_count} מצלמות · ${l.anchor_count} פריטים במפה · מפלס ${jo(l.level)}${l.has_plan?"":" · אין תוכנית עדיין"}${l.draft_version_id?" · טיוטה ממתינה לפרסום":""}</div>
                  </div>
            ...
            </div>`:this.tab==="cameras"?r`<div class="cams">${i.map(l=>r`<sw-card heading=${Pt(l.name)} subheading="${l.camera_count} מצלמות" interactive @click=${()=>b(`/explore/floors/${l.id}`)}></sw-card>`)}</div>`:r`<sw-card heading="פרטי המבנה">
                <dl>
  ...
  `;Ze([u()],Se.prototype,"buildingId",2);Ze([d()],Se.prototype,"tree",2);Ze([d()],Se.prototype,"selected",2);Ze([d()],Se.prototype,"tab",2);Ze([d()],Se.prototype,"dialog",2);Ze([d()],Se.prototype,"busy",2);Ze([d()],Se.prototype,"error",2);Ze([d()],Se.prototype,"formName",2);Ze([d()],Se.prototype,"formLevel",2);Se=Ze([k("explore-floors")],Se);var zl=Object.defineProperty,Sl=Object.getOwnPropertyDescriptor,Gi=(e,t,s,i)=>{for(var a=i>1?void 0:i?Sl(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&zl(t,s,a),a};let bs=class extends ${constructor(){super(...arguments),this.steps=[],this.current=0}render(){return r`${this.steps.map((e,t)=>r`
  ...
  `;Gi([u({attribute:!1})],bs.prototype,"steps",2);Gi([u({type:Number})],bs.prototype,"current",2);bs=Gi([k("sw-steps")],bs);var Ml=Object.defineProperty,Al=Object.getOwnPropertyDescriptor,ee=(e,t,s,i)=>{for(var a=i>1?void 0:i?Al(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&Ml(t,s,a),a};const ci=["קובץ","עמוד","חיתוך וסיבוב","שם והערות","שמירה ופרסום"];function ya(e){return e>=1024*1024?`${(e/1024/1024).toFixed(1)} MB`:`${Math.max(1,Math.round(e/1024))} KB`}let G=class extends ${constructor(){super(...arguments),this.floorId="",this.step=0,this.tree=null,this.assets=[],this.asset=null,this.page=1,this.rotation=0,this.crop={x:0,y:0,w:1,h:1},this.notes="",this.version=null,this.busy=!1,this.error="",this.dragOver=!1,this.dxf=null,this.dxfLayers=null,this.dxfUnits=null,this.dxfBusy=!1,this.previewBust=0,this.startCrop=e=>{if(e.button!==0)return;const t=e.currentTarget,s=t.getBoundingClientRect(),i=l=>({x:Math.min(1,Math.max(0,(l.clientX-s.left)/s.width)),y:Math.min(1,Math.max(0,(l.clientY-s.top)/s.height))}),a=i(e);t.setPointerCapture(e.pointerId),e.preventDefault();const n=l=>{const p=i(l),m=Math.min(a.x,p.x),f=Math.min(a.y,p.y),v=Math.abs(p.x-a.x),M=Math.abs(p.y-a.y);v>.01&&M>.01&&(this.crop={x:+m.toFixed(4),y:+f.toFixed(4),w:+v.toFixed(4),h:+M.toFixed(4)})},o=()=>{t.removeEventListener("pointermove",n),t.removeEventListener("pointerup",o),t.removeEventListener("pointercancel",o),(this.crop.w<.02||this.crop.h<.02)&&(this.crop={x:0,y:0,w:1,h:1})};t.addEventListener("pointermove",n),t.addEventListener("pointerup",o),t.addEventListener("pointercancel",o)}}connectedCallback(){super.connectedCallback(),this.init()}async init(){try{this.tree=await gt(),g()&&this.floorId&&(this.assets=(await go(this.floorId)).assets)}catch(e){this.error=w(e)}}get floor(){return this.tree&&this.floorId?ur(this.tree,this.floorId):null}updated(e){if(e.has("asset")&&g()){const t=this.asset;t&&t.kind==="dxf"&&(!this.dxf||this.dxf.asset_id!==t.id)?this.loadDxf(t.id):(!t||t.kind!=="dxf")&&(this.dxf=null)}}async loadDxf(e){try{const t=await Io(e);this.dxf=t,this.dxfLayers=t.options.layers,this.dxfUnits=t.options.units??(t.info?.units&&t.info.units!=="unitless"?t.info.units:null)}catch(t){this.error=w(t)}}toggleDxfLayer(e){const t=this.dxf?.info?.layers.filter(i=>i.drawable>0).map(i=>i.name)??[],s=this.dxfLayers??t;this.dxfLayers=s.includes(e)?s.filter(i=>i!==e):[...s,e]}async applyDxf(){if(this.dxf){this.dxfBusy=!0,this.error="";try{const e=this.dxf.info?.layers.filter(s=>s.drawable>0).map(s=>s.name)??[],t=this.dxfLayers&&this.dxfLayers.length!==e.length?this.dxfLayers:null;this.dxf=await Po(this.dxf.asset_id,{layers:t,units:this.dxfUnits}),this.dxfLayers=this.dxf.options.layers,this.previewBust=Date.now()}catch(e){this.error=w(e)}finally{this.dxfBusy=!1}}}renderDxf(){const e=this.dxf;if(!e||!e.info)return c;const t=e.info.layers.filter(l=>l.drawable>0).map(l=>l.name),s=this.dxfLayers??t,i=e.info.extent,a=Object.entries(e.render?.skipped??e.info.unsupported),n=e.render?.meters_per_px,o=e.render?.units&&e.render.units!=="unitless";return r`<sw-card heading="DXF · שכבות, יחידות וקנה מידה" subheading=${`${e.adapter.library} (${e.adapter.license}) · המקור נשמר כפי שהועלה; התצוגה נגזרת ממנו`} data-dxf>
      ...
      <div class="note">DWG אינו נתמך (פורמט סגור) — יש להמיר ל־DXF לפני הייבוא.</div>
    </sw-card>`}async onFile(e){if(!(!e||!this.floorId)){this.busy=!0,this.error="";try{this.asset=await bo(this.floorId,e),this.page=1,this.rotation=0,this.crop={x:0,y:0,w:1,h:1},this.version=null,this.step=this.asset.page_count>1?1:2,this.assets=[this.asset,...this.assets.filter(t=>t.id!==this.asset.id)]}catch(t){this.error=w(t)}finally{this.busy=!1}}}async save(){if(!(!this.asset||!this.floorId)){this.busy=!0,this.error="";try{const e=this.crop.x===0&&this.crop.y===0&&this.crop.w===1&&this.crop.h===1;this.version=await $o(this.floorId,{asset_id:this.asset.id,page:this.page,rotation:this.rotation,crop:e?null:this.crop,notes:this.notes})}catch(e){this.error=w(e)}finally{this.busy=!1}}}async publish(){if(this.version){this.busy=!0,this.error="";try{this.version=await Ii(this.version.id)}catch(e){this.error=w(e)}finally{this.busy=!1}}}setCrop(e,t){const s=Math.max(0,Math.min(100,t))/100,i={...this.crop,[e]:s};i.x+i.w>1&&(i.w=1-i.x),i.y+i.h>1&&(i.h=1-i.y),i.w<=.02&&(i.w=.02),i.h<=.02&&(i.h=.02),this.crop=i}previewUrl(){const e=this.asset?.pages.find(s=>s.page===this.page)??this.asset?.pages[0];if(!e)return"";const t=Xe(e.preview_url)+(this.previewBust?`${e.preview_url.includes("?")?"&":"?"}v=${this.previewBust}`:"");return this.rotation?`${t}${t.includes("?")?"&":"?"}rotation=${this.rotation}`:t}renderStep(){const e=this.asset;switch(this.step){case 0:return r`
          ...
          ${this.version?r`<div class="ok">✓ הגרסה נשמרה (${this.version.width_px}×${this.version.height_px} px) · ${this.version.status==="published"?"פורסמה — היא הרקע של הקומה":"טיוטה — עורכי הקומה רואים אותה, צופים עדיין לא"}</div>
                <div class="preview" style="min-block-size:220px"><img src=${Xe(this.version.image_url)} alt="רקע התוכנית" /></div>`:r`<div class="note">סיכום: ${e?.original_name} · עמוד ${this.page} · סיבוב ${this.rotation}° · חיתוך ${Math.round(this.crop.w*100)}%×${Math.round(this.crop.h*100)}%. השמירה מייצרת רקע נגזר; המקור לא משתנה.</div>`}
          <div class="row">
                ...
                <div class="layout">
                  ...
                  <div class="side">
                    ...
                    <div class="foot">
                      ...
                      ${this.step<ci.length-1?r`<sw-button variant="primary" ?disabled=${!t||this.busy} @click=${()=>this.step=Math.min(ci.length-1,this.step+1)}>הבא</sw-button>`:c}
                    </div>
                  </div>
                </div>`:this.renderDemo()}
      </sw-page>
  ...
  `;ee([u()],G.prototype,"floorId",2);ee([d()],G.prototype,"step",2);ee([d()],G.prototype,"tree",2);ee([d()],G.prototype,"assets",2);ee([d()],G.prototype,"asset",2);ee([d()],G.prototype,"page",2);ee([d()],G.prototype,"rotation",2);ee([d()],G.prototype,"crop",2);ee([d()],G.prototype,"notes",2);ee([d()],G.prototype,"version",2);ee([d()],G.prototype,"busy",2);ee([d()],G.prototype,"error",2);ee([d()],G.prototype,"dragOver",2);ee([d()],G.prototype,"dxf",2);ee([d()],G.prototype,"dxfLayers",2);ee([d()],G.prototype,"dxfUnits",2);ee([d()],G.prototype,"dxfBusy",2);ee([d()],G.prototype,"previewBust",2);G=ee([k("explore-plan-import")],G);const pi={white:"לבן",tint:"גוון לכל חדר",none:"ללא מילוי"};async function Il(e,t){const s=await A(`plan-versions/${e}/stylize`,t);return{...s,source_url:Xe(s.source_url)+`?v=${Date.now()}`,stylized_url:Xe(s.stylized_url)+`?v=${Date.now()}`}}const Pl=(e,t)=>Le(`plan-versions/${e}`,{render_mode:t});var El=Object.defineProperty,Cl=Object.getOwnPropertyDescriptor,T=(e,t,s,i)=>{for(var a=i>1?void 0:i?Cl(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&El(t,s,a),a};const Ps=["#2767ED","#22A06B","#F59E0B","#8B5CF6","#0EA5E9","#EC4899","#14B8A6","#F97316"],Tl=[{id:"select",icon:"target",label:"בחירה וגרירה",ready:!0},{id:"camera",icon:"camera",label:"הוספת מצלמה",ready:!0},{id:"entity",icon:"light",label:"הוספת ישות HA",ready:!0},{id:"zones",icon:"map",label:"חדרים ואזורים",ready:!0},{id:"layers",icon:"layers",label:"שכבות",ready:!0}],$a=[{id:"cameras",label:"מצלמות"},{id:"doors",label:"דלתות ומנעולים"},{id:"lights",label:"תאורה ומתגים"},{id:"sensors",label:"חיישנים"}],Dl={asset:"קובץ",page:"עמוד",rotation:"סיבוב",crop:"חיתוך",width_px:"רוחב",height_px:"גובה"},hi=e=>e?new Intl.DateTimeFormat("he-IL",{dateStyle:"short",timeStyle:"short"}).format(new Date(e)):"";let E=class extends ${constructor(){super(...arguments),this.floorId="",this.presetEntity="",this.bundle=null,this.anchors=[],this.dirty=new Set,this.undo=[],this.redo=[],this.selectedId=null,this.tool="select",this.layers=new Set(["cameras","doors","lights","sensors"]),this.placing=null,this.entQ="",this.entResults=null,this.entBusy=!1,this.busy=!1,this.error="",this.info="",this.stylizing=!1,this.stylized=null,this.stylizeOpts={strength:"medium",keepLines:!1,roomFill:"white"},this.zones=[],this.versions=[],this.diff=null,this.selectedZoneId=null,this.candidates=null,this.detecting=!1,this.detectStrength="medium",this.replaceAuto=!0,this.drawing=null,this.showZones=!0,this.zoneBusy=!1,this.entTimer=0,this.onKey=e=>this.handleKey(e)}connectedCallback(){super.connectedCallback(),this.load(),window.addEventListener("keydown",this.onKey),this.presetEntity&&(this.tool="entity",this.entQ=this.presetEntity,this.searchEntities())}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("keydown",this.onKey)}async load(){this.error="";try{const e=await vs(this.floorId||"f0",!0);this.bundle=e,this.anchors=e.anchors.map(t=>({...t,position:{...t.position}})),this.zones=e.zones,this.loadVersions(),this.selectedZoneId&&!this.zones.some(t=>t.id===this.selectedZoneId)&&(this.selectedZoneId=null),this.dirty=new Set,this.undo=[],this.redo=[],this.selectedId&&!this.anchors.some(t=>t.id===this.selectedId)&&(this.selectedId=null)}catch(e){this.error=w(e)}}get selected(){return this.anchors.find(e=>e.id===this.selectedId)}layerOf(e){return e.resource_type==="camera"?"cameras":e.layer_id==="doors"?"doors":e.layer_id==="lights"?"lights":"sensors"}get markers(){return this.anchors.filter(e=>this.layers.has(this.layerOf(e))).map(e=>({id:e.id,kind:e.resource_type==="camera"?"camera":si(e.layer_id,e.entity?.domain),label:e.camera?.name??e.entity?.name??e.label??e.resource_id,x:e.position.x,y:e.position.y,rotation:e.rotation_degrees,fov:e.field_of_view_degrees??void 0,state:e.resource_type==="camera"?this.bundle?.source==="demo"?"live":rs(e):"neutral"}))}anchorName(e){return e.camera?.name??e.entity?.name??e.label??e.resource_id}get selectedZone(){return this.zones.find(e=>e.id===this.selectedZoneId)}get planZones(){if(!this.showZones)return[];const e=this.zones.map(s=>({id:s.id,name:s.name,kind:s.kind,color:s.color,polygon:s.polygon})),t=(this.candidates??[]).map((s,i)=>({id:`cand-${i}`,name:s.include?s.name:"",color:s.include?Ps[i%Ps.length]:"#9AA3B5",polygon:s.polygon,candidate:!0}));return[...e,...t]}async detect(){const e=this.bundle;if(e){if(e.source==="demo"){this.info="נתוני הדגמה: הזיהוי עובד מול השרת.";return}this.detecting=!0,this.error="";try{const t=await Ko(e.floorId,this.detectStrength);this.candidates=t.rooms.map((s,i)=>({polygon:s.polygon,name:`חדר ${i+1}`,kind:"room",include:!0})),this.selectedZoneId=null,this.selectedId=null,this.info=t.rooms.length?`${t.rooms.length} חדרים זוהו · תן שמות ושמור`:"לא זוהו חדרים סגורים; נסה עוצמה אחרת או צייר אזור ידנית",setTimeout(()=>this.info="",5e3)}catch(t){this.error=w(t)}finally{this.detecting=!1}}}setCandidate(e,t){this.candidates&&(this.candidates=this.candidates.map((s,i)=>i===e?{...s,...t}:s))}async acceptCandidates(){const e=this.bundle,t=(this.candidates??[]).filter(s=>s.include);if(!(!e||!t.length)){this.zoneBusy=!0,this.error="";try{const s=await Go(e.floorId,t.map(i=>({polygon:i.polygon,name:i.name,kind:i.kind})),this.replaceAuto);this.candidates=null,this.zones=s.zones,this.info=`${s.created.length} חדרים נשמרו`,setTimeout(()=>this.info="",3e3)}catch(s){this.error=w(s)}finally{this.zoneBusy=!1}}}startDrawing(){this.drawing=[],this.placing=null,this.candidates=null,this.selectedZoneId=null,this.selectedId=null}addDraftPoint(e,t){const s=this.drawing,i=this.bundle;if(!(!s||!i)){if(s.length>=3){const a=this.canvas?.zoom??1;if(Math.hypot((e-s[0].x)*i.width*a,(t-s[0].y)*i.height*a)<12){this.finishDrawing();return}}this.drawing=[...s,{x:+e.toFixed(4),y:+t.toFixed(4)}]}}async finishDrawing(){const e=this.drawing,t=this.bundle;if(!(!e||!t||e.length<3)){if(t.source==="demo"){this.info="נתוני הדגמה: השמירה עובדת מול השרת.",this.drawing=null;return}this.zoneBusy=!0,this.error="";try{const s=await Wo(t.floorId,{name:`אזור ${this.zones.length+1}`,kind:"zone",polygon:e});this.drawing=null,this.zones=[...this.zones,s],this.selectedZoneId=s.id,this.info="האזור נוצר · תן לו שם",setTimeout(()=>this.info="",3e3)}catch(s){this.error=w(s)}finally{this.zoneBusy=!1}}}async patchZone(e,t){if(this.bundle?.source!=="demo"){this.zoneBusy=!0,this.error="";try{const s=await Zo(e.id,{revision:e.revision,...t});this.zones=this.zones.map(i=>i.id===s.id?s:i)}catch(s){s instanceof xe&&s.status===409?(this.error="האזור השתנה בינתיים על ידי עורך אחר; נטען מחדש בלי לדרוס.",await this.load()):this.error=w(s)}finally{this.zoneBusy=!1}}}async removeZone(e){if(this.bundle?.source!=="demo"&&window.confirm(`למחוק את "${e.name}"? המצלמות והישויות בקומה לא מושפעות.`)){this.zoneBusy=!0,this.error="";try{await qo(e.id),this.zones=this.zones.filter(t=>t.id!==e.id),this.selectedZoneId===e.id&&(this.selectedZoneId=null)}catch(t){this.error=w(t)}finally{this.zoneBusy=!1}}}snapshot(){this.undo=[...this.undo.slice(-40),this.anchors.map(e=>({...e,position:{...e.position}}))],this.redo=[]}apply(e,t){this.snapshot(),this.anchors=this.anchors.map(s=>s.id===e?{...s,...t,position:t.position??s.position}:s),this.dirty=new Set(this.dirty).add(e)}nudge(e,t){const s=this.selected;s&&this.apply(s.id,{position:{x:+Math.min(1,Math.max(0,s.position.x+e)).toFixed(4),y:+Math.min(1,Math.max(0,s.position.y+t)).toFixed(4)}})}doUndo(){const e=this.undo[this.undo.length-1];e&&(this.redo=[...this.redo,this.anchors],this.undo=this.undo.slice(0,-1),this.anchors=e,this.dirty=new Set(this.anchors.map(t=>t.id)))}doRedo(){const e=this.redo[this.redo.length-1];e&&(this.undo=[...this.undo,this.anchors],this.redo=this.redo.slice(0,-1),this.anchors=e,this.dirty=new Set(this.anchors.map(t=>t.id)))}handleKey(e){const t=e.composedPath()[0],s=t&&(t.tagName==="INPUT"||t.tagName==="TEXTAREA"||t.tagName==="SELECT"||t.isContentEditable);if(e.key==="Escape"){this.drawing?this.drawing=null:this.placing?this.placing=null:this.candidates?this.candidates=null:(this.selectedId=null,this.selectedZoneId=null);return}if(s)return;if(e.key==="Enter"&&this.drawing){e.preventDefault(),this.finishDrawing();return}if((e.key==="Delete"||e.key==="Backspace")&&!this.selected&&this.selectedZone){e.preventDefault(),this.removeZone(this.selectedZone);return}if((e.ctrlKey||e.metaKey)&&e.key.toLowerCase()==="z"){e.preventDefault(),e.shiftKey?this.doRedo():this.doUndo();return}if((e.ctrlKey||e.metaKey)&&e.key.toLowerCase()==="y"){e.preventDefault(),this.doRedo();return}if((e.ctrlKey||e.metaKey)&&e.key.toLowerCase()==="s"){e.preventDefault(),this.save();return}if(!this.selected)return;const i=e.shiftKey?.01:.002;e.key==="ArrowLeft"?(e.preventDefault(),this.nudge(-i,0)):e.key==="ArrowRight"?(e.preventDefault(),this.nudge(i,0)):e.key==="ArrowUp"?(e.preventDefault(),this.nudge(0,-i)):e.key==="ArrowDown"?(e.preventDefault(),this.nudge(0,i)):(e.key==="Delete"||e.key==="Backspace")&&(e.preventDefault(),this.removeSelected())}async save(){if(!this.bundle||this.bundle.source==="demo")return this.info="נתוני הדגמה: השינויים נשמרים רק במסך זה.",this.dirty=new Set,!0;if(!this.dirty.size)return!0;this.busy=!0,this.error="";let e=!1;try{for(const t of this.dirty){const s=this.anchors.find(i=>i.id===t);if(s)try{const i=await _o(t,{revision:s.revision,x:s.position.x,y:s.position.y,rotation_degrees:s.rotation_degrees,field_of_view_degrees:s.field_of_view_degrees,label:s.label});this.anchors=this.anchors.map(a=>a.id===t?{...a,revision:i.revision}:a)}catch(i){if(i instanceof xe&&i.code==="stale_revision")e=!0;else throw i}}return e?(this.error="חלק מהפריטים השתנו בינתיים על ידי עורך אחר; המפה נטענה מחדש בלי לדרוס את השינוי שלו.",await this.load(),!1):(this.dirty=new Set,this.info="המיקומים נשמרו",setTimeout(()=>this.info="",2500),!0)}catch(t){return this.error=w(t),!1}finally{this.busy=!1}}async place(e,t){const s=this.placing;if(!(!s||!this.bundle)){if(this.bundle.source==="demo"){this.info="נתוני הדגמה: הוספה עובדת מול השרת.",this.placing=null;return}if(!(this.dirty.size&&!await this.save())){this.busy=!0,this.error="";try{const i=s.kind==="camera"?await wa(this.bundle.floorId,{resource_type:"camera",resource_id:s.camera.id,x:e,y:t,rotation_degrees:0,field_of_view_degrees:90}):await wa(this.bundle.floorId,{resource_type:"ha_entity",resource_id:s.entity.entity_id,x:e,y:t,rotation_degrees:0,field_of_view_degrees:null});this.placing=null,await this.load(),this.selectedId=i.id,this.tool="select",this.info=`${this.anchorName(i)} הוצב · גרור לדיוק, קבע כיוון בידיות`,setTimeout(()=>this.info="",4e3)}catch(i){this.error=w(i)}finally{this.busy=!1}}}}async removeSelected(){const e=this.selected;if(!(!e||!this.bundle)){if(this.bundle.source==="demo"){this.info="נתוני הדגמה: הסרה עובדת מול השרת.";return}if(window.confirm(`להסיר את "${this.anchorName(e)}" מהמפה? המקור עצמו לא נמחק.`)){this.busy=!0,this.error="";try{await zo(e.id),this.selectedId=null,await this.load()}catch(t){this.error=w(t)}finally{this.busy=!1}}}}async loadVersions(){const e=this.bundle;if(!e||e.source==="demo"||!e.permissions.edit){this.versions=[];return}try{this.versions=(await yo(e.floorId)).versions}catch{this.versions=[]}}async publish(){if(!this.bundle?.planVersionId||this.dirty.size&&!await this.save())return;const e=this.versions.find(t=>t.id===this.bundle?.planVersionId);if(!e){await this.publishNow(this.bundle.planVersionId);return}await this.openDiff("publish",e)}async publishNow(e){this.busy=!0,this.error="";try{await Ii(e),this.info="הגרסה פורסמה; הצופים רואים אותה עכשיו",await this.load()}catch(t){this.error=w(t)}finally{this.busy=!1}}async openDiff(e,t){this.diff={mode:e,version:t,data:null,error:""};try{const s=await xo(t.id);this.diff?.version.id===t.id&&(this.diff={mode:e,version:t,data:s,error:""})}catch(s){this.diff={mode:e,version:t,data:null,error:w(s)}}}async confirmDiff(){const e=this.diff;if(!(!e?.data||e.mode==="compare")){this.busy=!0,this.error="";try{e.mode==="publish"?(await Ii(e.version.id),this.info="הגרסה פורסמה; הצופים רואים אותה עכשיו"):(await ko(e.version.id,e.version.revision,e.data.from?.id??null),this.info="הגרסה שוחזרה ופורסמה מחדש; העוגנים נשמרו"),this.diff=null,await this.load(),setTimeout(()=>this.info="",4e3)}catch(t){this.diff={...e,error:w(t)},t instanceof xe&&t.status===409&&this.loadVersions()}finally{this.busy=!1}}}async searchEntities(){if(this.bundle?.source!=="demo"){this.entBusy=!0;try{const e=await gr({q:this.entQ||void 0,limit:40});this.entResults=e.entities}catch(e){this.error=w(e),this.entResults=[]}finally{this.entBusy=!1}}}onEntQuery(e){this.entQ=e,window.clearTimeout(this.entTimer),this.entTimer=window.setTimeout(()=>void this.searchEntities(),250)}async stylize(e,t){if(!this.bundle?.planVersionId||this.bundle.source==="demo")return;const s=this.stylizeOpts;(e!==void 0||t!==void 0)&&(this.stylizeOpts={...s,strength:e??s.strength,keepLines:t??s.keepLines}),this.stylizing=!0,this.error="";try{this.stylized=await Il(this.bundle.planVersionId,{strength:this.stylizeOpts.strength,keep_lines:this.stylizeOpts.keepLines,room_fill:this.stylizeOpts.roomFill})}catch(i){this.error=w(i)}finally{this.stylizing=!1}}async useRender(e){if(this.bundle?.planVersionId){this.busy=!0,this.error="";try{await Pl(this.bundle.planVersionId,e),this.stylized=null,await this.load(),this.info=e==="stylized"?"המפה מציגה עכשיו את שפת SMPLWISE":"המפה מציגה את תוכנית המקור",setTimeout(()=>this.info="",3e3)}catch(t){this.error=w(t)}finally{this.busy=!1}}}pickTool(e){this.tool=e,this.placing=null,e==="entity"&&this.entResults===null&&this.searchEntities()}renderCameraInspector(e){const t=e.camera,s=e.field_of_view_degrees??0;return r`<sw-card heading="הגדרות מצלמה" subheading="גרירה במפה, ידיות לכיוון ולשדה הראייה, או הזנה מדויקת">
      ...
      ${t?r`<div class="kv"><span class="k">מצב עכשיו</span><span>${ft(t)}</span></div><div class="kv"><span class="k">סוג</span><span>${gs(t.domain)}</span></div>`:c}
      <sw-field label="שכבה" style="margin-block-start:8px"><select @change=${s=>this.apply(e.id,{layer_id:s.target.value})}>${$a.filter(s=>s.id!=="cameras").map(s=>r`<option value=${s.id} ?selected=${e.layer_id===s.id}>${s.label}</option>`)}</select></sw-field>
      <div class="two">
      ...
      <div class="two">
        <sw-field label="סוג"><select @change=${i=>this.patchZone(e,{kind:i.target.value})}>${Pi.map(i=>r`<option value=${i.id} ?selected=${e.kind===i.id}>${i.label}</option>`)}</select></sw-field>
      ...
      ${t?r`<div class="note">${t.length} חדרים זוהו · סמן, תן שם ושמור. הפוליגונים מוצגים במפה בקו מקווקו.</div>
            <div class="candlist">${t.map((i,a)=>r`<div class="cand" data-candidate><input type="checkbox" .checked=${i.include} aria-label="כלול" @change=${n=>this.setCandidate(a,{include:n.target.checked})} /><i class="sw" style="background:${Ps[a%Ps.length]}"></i><input class="name" .value=${i.name} placeholder="שם החדר" aria-label="שם החדר" @input=${n=>this.setCandidate(a,{name:n.target.value})} /><select aria-label="סוג" @change=${n=>this.setCandidate(a,{kind:n.target.value})}>${Pi.map(n=>r`<option value=${n.id} ?selected=${i.kind===n.id}>${n.label}</option>`)}</select></div>`)}</div>
      ...
      ${e.planStatus==="none"?c:r`<div class="row"><span class="lbl">תצוגת המפה<span class="muted">${e.renderMode==="stylized"?"שפת SMPLWISE (עיבוד אוטומטי של המקור)":"תוכנית המקור כפי שהועלתה"}</span></span>${e.renderMode==="stylized"?r`<sw-button size="sm" ?disabled=${this.busy} @click=${()=>this.useRender("source")}>הצג מקור</sw-button>`:e.stylizedAvailable?r`<sw-button size="sm" ?disabled=${this.busy} @click=${()=>this.useRender("stylized")}>הצג שפת SMPLWISE</sw-button>`:c}</div>
          ...
          <div class="two" data-stylize-opts>
            ...
            <sw-field label="מילוי חדרים"><select aria-label="מילוי חדרים" @change=${s=>this.stylizeOpts={...this.stylizeOpts,roomFill:s.target.value}}>${Object.keys(pi).map(s=>r`<option value=${s} ?selected=${this.stylizeOpts.roomFill===s}>${pi[s]}</option>`)}</select></sw-field>
          </div>
      ...
      <div class="vlist" data-version-list>
        ${this.versions.map(t=>{const s=t.id===e.planVersionId,i=t.status==="published"?"recorded":t.status==="draft"?"partial":"neutral",a=t.status==="published"?"מפורסמת":t.status==="draft"?"טיוטה":"ארכיון";return r`<div class="vrow ${s?"cur":""}" data-version-row data-version-id=${t.id} data-version-status=${t.status}>
            <img src=${Xe(t.image_url)} alt="" loading="lazy" />
            <div class="meta">
              <span><sw-badge kind=${i} label=${a}></sw-badge> <span class="ltr">${hi(t.published_at??t.created_at)}</span></span>
      ...
      ${t?r`<div class="compare">
              <div><div class="note">${t.from?`מפורסמת · ${hi(t.from.published_at??t.from.created_at)}`:"אין גרסה מפורסמת"}</div>${t.from?r`<img src=${Xe(t.from.image_url)} alt="הגרסה המפורסמת" />`:r`<div class="note">—</div>`}</div>
              <div><div class="note">${e.mode==="rollback"?"לשחזור":"חדשה"} · ${hi(t.to.published_at??t.to.created_at)}</div><img src=${Xe(t.to.image_url)} alt="הגרסה החדשה" /></div>
            </div>
            <div class="dsum" data-diff-summary>
              ${t.from?t.geometry.same?r`<sw-badge kind="recorded" label="גאומטריה זהה"></sw-badge>`:r`<sw-badge kind="partial" label=${`שינוי: ${t.geometry.changes.map(a=>Dl[a.field]??a.field).join(", ")}`}></sw-badge>`:r`<sw-badge kind="neutral" label="פרסום ראשון"></sw-badge>`}
        ...
        ${e.planStatus==="none"?r`<sw-state-panel state="empty" heading="לקומה אין תוכנית" hint="העלה תוכנית קודם; אחר כך אפשר להציב מצלמות וישויות."><div style="margin-block-start:10px"><sw-button variant="primary" icon="upload" @click=${()=>b(`/explore/floors/${e.floorId}/import`)}>העלאת תוכנית</sw-button></div></sw-state-panel>`:r`<div class="layout">
              <div class="mapwrap">
                ...
                <div class="rail" role="toolbar" aria-label="כלי עריכה">
                  ${Tl.map(n=>r`<button class=${n.id===this.tool?"on":""} ?disabled=${!n.ready} title=${n.label} aria-label=${n.label} aria-pressed=${n.id===this.tool} @click=${()=>this.pickTool(n.id)}><sw-icon .name=${n.icon} size=${18}></sw-icon></button>`)}
                  <hr />
  ...
  `;T([u()],E.prototype,"floorId",2);T([u()],E.prototype,"presetEntity",2);T([d()],E.prototype,"bundle",2);T([d()],E.prototype,"anchors",2);T([d()],E.prototype,"dirty",2);T([d()],E.prototype,"undo",2);T([d()],E.prototype,"redo",2);T([d()],E.prototype,"selectedId",2);T([d()],E.prototype,"tool",2);T([d()],E.prototype,"layers",2);T([d()],E.prototype,"placing",2);T([d()],E.prototype,"entQ",2);T([d()],E.prototype,"entResults",2);T([d()],E.prototype,"entBusy",2);T([d()],E.prototype,"busy",2);T([d()],E.prototype,"error",2);T([d()],E.prototype,"info",2);T([d()],E.prototype,"stylizing",2);T([d()],E.prototype,"stylized",2);T([d()],E.prototype,"stylizeOpts",2);T([d()],E.prototype,"zones",2);T([d()],E.prototype,"versions",2);T([d()],E.prototype,"diff",2);T([d()],E.prototype,"selectedZoneId",2);T([d()],E.prototype,"candidates",2);T([d()],E.prototype,"detecting",2);T([d()],E.prototype,"detectStrength",2);T([d()],E.prototype,"replaceAuto",2);T([d()],E.prototype,"drawing",2);T([d()],E.prototype,"showZones",2);T([d()],E.prototype,"zoneBusy",2);T([Kt("sw-plan-canvas")],E.prototype,"canvas",2);E=T([k("explore-plan-editor")],E);var Ol=Object.defineProperty,Rl=Object.getOwnPropertyDescriptor,Ot=(e,t,s,i)=>{for(var a=i>1?void 0:i?Rl(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&Ol(t,s,a),a};let et=class extends ${constructor(){super(...arguments),this.columns=[],this.rows=[],this.rowKey="id",this.selected=null,this.emptyText="אין שורות להצגה",this.dense=!1}pick(e){const t=String(e[this.rowKey]??"");this.dispatchEvent(new CustomEvent("row-select",{detail:{id:t,row:e},bubbles:!0,composed:!0}))}render(){return this.rows.length?r`
    ...
    `:r`<div class="empty">${this.emptyText}</div>`}};et.styles=x`
    :host {
      display: block;
      background: var(--sw-surface);
      border: 1px solid var(--sw-border);
  ...
  `;Ot([u({attribute:!1})],et.prototype,"columns",2);Ot([u({attribute:!1})],et.prototype,"rows",2);Ot([u()],et.prototype,"rowKey",2);Ot([u()],et.prototype,"selected",2);Ot([u()],et.prototype,"emptyText",2);Ot([u({type:Boolean,reflect:!0})],et.prototype,"dense",2);et=Ot([k("sw-table")],et);var Nl=Object.defineProperty,Bl=Object.getOwnPropertyDescriptor,He=(e,t,s,i)=>{for(var a=i>1?void 0:i?Bl(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&Nl(t,s,a),a};const Es=[{id:"lock.main_door",name:"דלת כניסה",domain:"lock",area:"לובי",state:"נעול",fresh:"live",placed:!0,actions:"נעילה / פתיחה (grant נפרד)"},{id:"light.lobby",name:"תאורת לובי",domain:"light",area:"לובי",state:"דולק · 80%",fresh:"live",placed:!0,actions:"הדלקה / כיבוי / עמעום"},{id:"binary_sensor.hall_motion",name:"תנועה באולם",domain:"binary_sensor",area:"אולם",state:"ללא תנועה",fresh:"live",placed:!0,actions:"קריאה בלבד"},{id:"climate.hall",name:"מזגן אולם",domain:"climate",area:"אולם",state:"קירור · 23°",fresh:"stale",placed:!1,actions:"יעד טמפרטורה (allowlist)"},{id:"cover.parking_gate",name:"שער חניה",domain:"cover",area:"חניה",state:"סגור",fresh:"live",placed:!1,actions:"פתיחה / סגירה (רגיש)"},{id:"script.night_mode",name:"מצב לילה",domain:"script",area:"—",state:"—",fresh:"unknown",placed:!1,actions:"חסום עד allowlist"},{id:"sensor.power_main",name:"צריכת חשמל",domain:"sensor",area:"חדר מכונות",state:"4.2 kW",fresh:"live",placed:!1,actions:"קריאה בלבד"},{id:"camera.intercom_m2",name:"אינטרקום M2",domain:"camera",area:"כניסה",state:"זמין",fresh:"live",placed:!1,actions:"צפייה (provider נפרד)"}];function Ll(e){return e==="lock"||e==="cover"?"lock":e==="light"||e==="switch"||e==="fan"?"light":e==="camera"?"camera":e==="climate"||e==="script"||e==="scene"||e==="button"||e==="automation"?"activity":"sensor"}let ke=class extends ${constructor(){super(...arguments),this.selected=null,this.domain="all",this.q="",this.area="",this.onlyPlaced=!1,this.cat=null,this.error="",this.loading=!1,this.sync=null,this.firstFloorId=null,this.stopWs=null,this.searchTimer=0,this.columns=[{key:"name",label:"ישות",render:e=>r`<span style="display:inline-flex;align-items:center;gap:8px"><span style="display:grid;place-items:center;inline-size:26px;block-size:26px;border-radius:7px;background:var(--sw-accent-soft);color:var(--sw-accent)"><sw-icon name=${Ll(String(e.domain))} size=${13}></sw-icon></span><span><strong>${String(e.name)}</strong><div class="ltr" style="font-size:var(--sw-fs-xs);color:var(--sw-text-3)">${String(e.id)}</div></span></span>`},{key:"domain",label:"Domain",ltr:!0},{key:"area",label:"אזור HA"},{key:"state",label:"מצב"},{key:"fresh",label:"רעננות",render:e=>r`<sw-badge kind=${e.fresh} label=${e.fresh==="live"||e.fresh==="neutral"?"עדכני":e.fresh==="stale"?"מיושן":e.fresh==="offline"?"לא זמין":"לא ידוע"}></sw-badge>`},{key:"placed",label:"במפה",render:e=>e.placed?r`<sw-badge kind="recorded" label="מוצב"></sw-badge>`:r`<span style="color:var(--sw-text-3)">לא</span>`}]}connectedCallback(){super.connectedCallback(),g()&&(this.load(),gt().then(e=>this.firstFloorId=mr(e)?.id??null).catch(()=>{}),this.stopWs=br(e=>{if(e.type==="entity_state_changed"&&this.cat){const t=this.cat.entities.findIndex(s=>s.entity_id===e.entity.entity_id);if(t>=0){const s=[...this.cat.entities];s[t]={...s[t],...e.entity,placements:s[t].placements,actions:s[t].actions},this.cat={...this.cat,entities:s}}}else e.type==="heartbeat"?this.sync=e.sync:e.type==="ha_sync_state"&&this.sync&&(this.sync={...this.sync,connected:e.connected})}))}disconnectedCallback(){super.disconnectedCallback(),this.stopWs?.(),this.stopWs=null}async load(){this.loading=!0,this.error="";try{this.cat=await gr({domain:this.domain==="all"?void 0:this.domain,q:this.q||void 0,area:this.area||void 0,placed:this.onlyPlaced?!0:void 0,limit:800}),this.sync=this.cat.sync}catch(e){this.error=w(e)}finally{this.loading=!1}}onSearch(e){this.q=e,window.clearTimeout(this.searchTimer),this.searchTimer=window.setTimeout(()=>void this.load(),250)}toRow(e){return{id:e.entity_id,name:e.name||e.original_name||e.entity_id,domain:e.domain,area:e.area_name??"—",state:ft(e),fresh:Ei(e),placed:!!e.placements?.length,actions:e.actions?.length?e.actions.map(t=>`${t.label}${t.sensitive?" (רגיש)":""}`).join(" / "):"קריאה בלבד"}}renderApiDrawer(e){const t=Ei(e),s=Object.entries(e.attributes).filter(([i])=>i!=="friendly_name"&&i!=="icon").slice(0,14);return r`<sw-drawer open heading=${e.name||e.original_name||e.entity_id} subheading=${e.entity_id} @close=${()=>this.selected=null}>
      <dl>
        <dt>מצב</dt><dd><sw-badge kind=${t} label=${ft(e)}></sw-badge></dd>
        <dt>Domain</dt><dd><span class="ltr">${e.domain}</span> · ${gs(e.domain)}${e.device_class?r` · <span class="ltr">${e.device_class}</span>`:c}</dd>
        <dt>אזור HA</dt><dd>${e.area_name??"—"}${e.ha_floor_name?` · ${e.ha_floor_name}`:""}</dd>
        <dt>שינוי אחרון</dt><dd>${De(e.last_changed)}</dd>
        <dt>נראה לאחרונה</dt><dd>${De(e.state_seen_at)}${e.fresh?"":" · הסנכרון מנותק"}</dd>
    ...
    `}render(){if(g())return this.renderApi();const e=["all",...new Set(Es.map(i=>i.domain))],t=Es.filter(i=>this.domain==="all"||i.domain===this.domain),s=Es.find(i=>i.id===this.selected);return r`
      <sw-page heading="קטלוג ישויות Home Assistant" subheading="${Es.length} ישויות מורשות לחיבור · הצבה על המפה ושליטה הן הרשאות נפרדות · נתוני הדגמה">
  ...
  `;He([d()],ke.prototype,"selected",2);He([d()],ke.prototype,"domain",2);He([d()],ke.prototype,"q",2);He([d()],ke.prototype,"area",2);He([d()],ke.prototype,"onlyPlaced",2);He([d()],ke.prototype,"cat",2);He([d()],ke.prototype,"error",2);He([d()],ke.prototype,"loading",2);He([d()],ke.prototype,"sync",2);He([d()],ke.prototype,"firstFloorId",2);ke=He([k("explore-entities")],ke);var Hl=Object.defineProperty,Vl=Object.getOwnPropertyDescriptor,yr=(e,t,s,i)=>{for(var a=i>1?void 0:i?Vl(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&Hl(t,s,a),a};const ui=[{id:"d1",name:"כניסה ראשית",kind:"דלת זכוכית",lock:"נעול",contact:"סגור",relay:"לא פעיל",ringing:!1,scene:"entrance"},{id:"d2",name:"לובי",kind:"דלת פנימית",lock:"פתוח",contact:"פתוח",relay:"לא פעיל",ringing:!1,scene:"lobby"},{id:"d3",name:"אינטרקום M2",kind:"עמדת דלת",lock:"נעול",contact:"סגור",relay:"לא פעיל",ringing:!0,scene:"entrance"},{id:"d4",name:"מחסן",kind:"דלת שירות",lock:"נעול",contact:"סגור",relay:"לא פעיל",ringing:!1,scene:"warehouse"}];let Fs=class extends ${constructor(){super(...arguments),this.selected="d1"}render(){if(g())return r`<sw-page heading="דלתות ואינטרקום" subheading="V1 · מצלמה, צלצול, מגע דלת וממסר הם ארבעה נתונים שונים">
      ...
      </sw-page>`;const e=ui.find(t=>t.id===this.selected)??ui[0];return r`
      <sw-page heading="דלתות ואינטרקום" subheading="V1 · מצלמה, צלצול, מגע דלת וממסר הם ארבעה נתונים שונים · נתוני הדגמה">
        ...
        <div class="layout">
          <div class="list">
            ${ui.map(t=>r`<button class="door ${t.id===this.selected?"on":""}" @click=${()=>this.selected=t.id} aria-pressed=${t.id===this.selected}>
  ...
  `;yr([d()],Fs.prototype,"selected",2);Fs=yr([k("explore-access")],Fs);var jl=Object.defineProperty,Fl=Object.getOwnPropertyDescriptor,Rt=(e,t,s,i)=>{for(var a=i>1?void 0:i?Fl(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&jl(t,s,a),a};let tt=class extends ${constructor(){super(...arguments),this.label="",this.value="",this.detail="",this.icon="info",this.tone="neutral",this.badge=""}render(){return r`
  ...
  `;Rt([u()],tt.prototype,"label",2);Rt([u()],tt.prototype,"value",2);Rt([u()],tt.prototype,"detail",2);Rt([u()],tt.prototype,"icon",2);Rt([u({reflect:!0})],tt.prototype,"tone",2);Rt([u()],tt.prototype,"badge",2);tt=Rt([k("sw-kpi")],tt);function ii(e={}){const t=new URLSearchParams;e.date&&t.set("date",e.date),e.from&&e.to&&(t.set("from",e.from),t.set("to",e.to)),e.acked&&t.set("acked","true"),e.cameraId&&t.set("camera_id",e.cameraId),e.type&&t.set("type",e.type),e.unacked&&t.set("unacked","true"),e.limit&&t.set("limit",String(e.limit)),e.floorId&&t.set("floor_id",e.floorId),e.zoneId&&t.set("zone_id",e.zoneId),e.buildingId&&t.set("building_id",e.buildingId),e.siteId&&t.set("site_id",e.siteId),e.source&&t.set("source",e.source),e.severity&&t.set("severity",e.severity);const s=t.toString();return z(`events${s?`?${s}`:""}`)}const Ul=()=>z("events/summary"),Wl=(e,t)=>z(`cameras/${e}/events?date=${t}`),$r=e=>A(`events/${e}/ack`),xa=e=>A("events/ack-many",{event_ids:e}),ka={camera:"לפי מצלמה",all:"כל המצלמות יחד",zone:"לפי חדר",floor:"לפי קומה"};function Zl(e={}){const t=new URLSearchParams;e.date&&t.set("date",e.date),e.cameraId&&t.set("camera_id",e.cameraId),e.gap&&t.set("gap",String(e.gap)),e.by&&t.set("by",e.by),e.limit&&t.set("limit",String(e.limit));const s=t.toString();return z(`events/windows${s?`?${s}`:""}`)}const ql=e=>z(`events/${e}`),zt=(e,t=0)=>ce(`events/${e}/thumbnail${t?`?v=${t}`:""}`);async function xr(e){try{const t=await fetch(zt(e),{credentials:"include",cache:"no-store"});return t.status===200?"ready":t.status===202?"pending":"unavailable"}catch{return"pending"}}const K={motion:"תנועה",person:"אדם",vehicle:"רכב",line:"חציית קו",field:"חדירה לאזור",offline:"אובדן וידאו",tamper:"חבלה במצלמה",door:"דלת",io:"כניסת חיווי",storage:"אחסון",system:"מערכת",coverage_gap:"פער בקליטת אירועים",manual:"הקלטה ידנית",other:"אחר"},Ns={motion:"#ef4444",person:"#2f6bff",vehicle:"#22c55e",line:"#f59e0b",field:"#f59e0b",offline:"#6b7280",tamper:"#b45309",door:"#8b5cf6",io:"#8b5cf6",storage:"#6b7280",system:"#6b7280",coverage_gap:"#6b7280",manual:"#2f6bff",other:"#6b7280"};function Kl(e){return e==="person"||e==="vehicle"||e==="motion"||e==="line"||e==="offline"||e==="door"?e:e==="field"?"line":e==="io"?"door":e==="tamper"||e==="coverage_gap"||e==="storage"||e==="system"?"offline":"motion"}function Gl(e,t){let s=null,i=!1,a=2e3;const n=(()=>{const l=new URL(ce("events/ws"));return l.protocol=l.protocol==="https:"?"wss:":"ws:",l.toString()})(),o=()=>{if(!i){try{s=new WebSocket(n)}catch{return}s.onopen=()=>{a=2e3,t?.(null,!0)},s.onmessage=l=>{try{const p=JSON.parse(l.data);p.type==="event_added"||p.type==="event_updated"?e(p.payload):p.type==="heartbeat"&&t?.(p.payload.ingest,!0)}catch{}},s.onclose=()=>{t?.(null,!1),i||(window.setTimeout(o,a),a=Math.min(3e4,a*2))}}};return o(),()=>{i=!0,s?.close()}}const Yl={measured:"נמדד",inferred:"נגזר",command:"פקודה",availability:"זמינות"},Jl=(e,t=120)=>z(`events/${e}/correlation?window=${t}`),Xl=(e=90)=>z(`events/facets?days=${e}`),_a={alertstream:"אירוע NVR",recording:"נגזר מהקלטה",system:"מערכת",ha:"חיישן HA"},Ql=(e,t=90)=>z(`events/${e}/route?window=${t}`),kr=(e=!1)=>z(`storage${e?"?fresh=true":""}`);function kt(e){return e==null?"—":e>=1024*1024?`${(e/1024/1024).toFixed(2)} TB`:e>=1024?`${(e/1024).toFixed(0)} GB`:`${e} MB`}const os={ok:"תקין",warn:"לתשומת לב",error:"שגיאה"},za={ok:"live",warn:"stale",error:"offline"},_r=(e=!1)=>z(`health/report${e?"?fresh=1":""}`),Yi=()=>z("health/summary");function ed(e){return e<3600?`${Math.floor(e/60)} דק׳`:e<86400?`${Math.floor(e/3600)} שע׳ ${Math.floor(e%3600/60)} דק׳`:`${Math.floor(e/86400)} ימים ${Math.floor(e%86400/3600)} שע׳`}let Bs=null,Cs=null;const td={"media.transport_default":"mse","media.max_live_sessions":8,"media.wall_profile":"sub","snapshots.max_age_s":60};async function Ve(e=!1){return g()?Bs&&!e?Bs:(Cs||(Cs=sr().then(t=>Bs=t.settings).finally(()=>Cs=null)),Cs):td}function Sa(){Bs=null}function Ji(e){return ir()||e?.["media.transport_default"]||"mse"}var sd=Object.defineProperty,id=Object.getOwnPropertyDescriptor,Ee=(e,t,s,i)=>{for(var a=i>1?void 0:i?id(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&sd(t,s,a),a};function ad(e){return e<5?"לילה טוב":e<12?"בוקר טוב":e<17?"צהריים טובים":e<21?"ערב טוב":"לילה טוב"}const rd={person:"var(--sw-accent)",vehicle:"var(--sw-live)",motion:"var(--sw-danger)",line:"var(--sw-stale)",offline:"var(--sw-offline)",door:"var(--sw-purple)"},nd={"כניסה ראשית":"entrance","חצר אחורית":"backyard",מחסן:"warehouse",לובי:"lobby","חניה מקורה":"parking"};let ve=class extends ${constructor(){super(...arguments),this.cams=null,this.recorder=null,this.sites=null,this.summary=null,this.recent=[],this.storage=null,this.health=null,this.raw=null,this.tz="Asia/Jerusalem",this.now=new Date,this.loaded=!1,this.timer=0,this.clockTimer=0}connectedCallback(){super.connectedCallback(),g()&&(this.load(),this.timer=window.setInterval(()=>void this.load(),6e4),this.clockTimer=window.setInterval(()=>this.now=new Date,3e4))}disconnectedCallback(){window.clearInterval(this.timer),window.clearInterval(this.clockTimer),super.disconnectedCallback()}async load(){this.loadStorage();const[e,t,s,i,a,n,o]=await Promise.allSettled([Ve(),Pe(),z("sites?tree=true"),Ul(),ii({limit:6}),Yi(),z("health")]);e.status==="fulfilled"&&(this.tz=e.value["time.zone"]??this.tz),t.status==="fulfilled"?(this.cams=t.value.cameras.filter(l=>l.enabled),this.recorder=t.value.recorder):this.cams===null&&(this.cams=[]),s.status==="fulfilled"?this.sites=s.value.sites:this.sites===null&&(this.sites=[]),i.status==="fulfilled"&&(this.summary=i.value),a.status==="fulfilled"&&(this.recent=a.value.events),n.status==="fulfilled"&&(this.health=n.value),o.status==="fulfilled"&&(this.raw=o.value),this.loaded=!0,this.now=new Date}async loadStorage(){try{this.storage=await kr()}catch{this.storage=null}}fmtTime(e){return new Date(e).toLocaleTimeString("he-IL",{hour:"2-digit",minute:"2-digit",timeZone:this.tz})}spots(){const e=[],t=this.cams??[];for(const a of t.filter(n=>n.status==="offline"))e.push({kind:"critical",title:`מצלמה מנותקת: ${a.name}`,meta:`ערוץ ${a.channel}${a.last_seen_at?` · נראתה לאחרונה ${this.fmtTime(a.last_seen_at)}`:""}`,why:"מוצג כי ה־NVR מדווח שהערוץ אינו מחובר",link:`#/live/cameras/${a.id}`});for(const a of(this.health?.items??[]).filter(n=>n.status!=="ok"))e.push({kind:a.status==="error"?"critical":"alert",title:a.label,meta:`בדיקת מערכת · ${os[a.status]}`,why:"מוצג כי בדיקת הבריאות של ה־Add-on מדווחת על כך",link:"#/system/diagnostics"});const s=this.summary?.today.unacked??0;if(s>0){const a=Object.entries(this.summary?.today.by_type??{}).sort((n,o)=>o[1]-n[1]).slice(0,3).map(([n,o])=>`${K[n]??n} ${o}`).join(" · ");e.push({kind:"alert",title:`${s} אירועים שלא נבדקו היום`,meta:a,why:"מוצג כי אירועים ממתינים לסימון טיפול במרכז האירועים",link:"#/investigate/events"})}const i=this.raw?.events.ingest;return i?.connected&&!i.events_stored&&!i.last_event_at&&e.push({kind:"info",title:"ה־NVR לא שלח התראות מאז ההפעלה",meta:"אירועי תנועה נגזרים מההקלטות כל 10 דקות",why:'מוצג כי זרם ההתראות מחובר אך ריק — ב־NVR יש להפעיל "Notify Surveillance Center" ב־linkage של זיהוי התנועה',link:"#/system/setup"}),this.raw?.home_assistant.configured&&!this.raw.home_assistant.connected&&e.push({kind:"alert",title:"אין חיבור ל־Home Assistant",meta:this.raw.home_assistant.last_error??"",why:"מוצג כי מצבי הישויות והדלתות עלולים להיות מיושנים",link:"#/system/setup"}),e}renderApi(){const e=mt.me?.user,t=e?.display_name||e?.username||"",s=Number(this.now.toLocaleString("en-GB",{hour:"numeric",hour12:!1,timeZone:this.tz})),i=this.cams??[],a=i.filter(S=>S.status==="online").length,n=this.sites??[],o=n.flatMap(S=>(S.buildings??[]).flatMap(te=>te.floors??[])),l=this.health,p=l?l.status==="ok"?"live":l.status==="warn"?"stale":"offline":"neutral",m=l?.items.find(S=>S.status!=="ok"),f=this.loaded?this.spots():[],v=this.storage,M=v?.totals??null,_=M?.used_pct??null,O=34,ae=2*Math.PI*O,Bt=i.filter(S=>S.status==="online").slice(0,2);return r`
      <sw-page heading=${`${ad(s)}${t?`, ${t}`:""}`} subheading=${l?`מצב המערכת: ${os[l.status]}${m?` · ${m.label}`:" · כל הבדיקות תקינות"}`:"קורא את מצב המערכת…"}>
        ...
        <div class="kpis" data-overview-kpis>
          ...
          <sw-kpi icon="shield" tone=${p} value=${l?os[l.status]:"…"} label="מצב מערכת" detail=${m?m.label:"NVR, go2rtc, HA ואחסון"}></sw-kpi>
        </div>
        ${Bt.length?r`<div class="fav" data-overview-favorites>
              ${Bt.map(S=>r`<sw-camera-tile name=${S.name} state="live" cameraId=${S.id} poster=${Fe(S.id)} noDemo @click=${()=>b(`/live/cameras/${S.id}`)}></sw-camera-tile>`)}
            </div>`:c}
        <div class="row2">
          ${v&&M?r`<sw-card heading="אחסון" subheading=${v.cached?"מהמטמון · נמדד מול ה־NVR":"נמדד מול ה־NVR"}>
                <div class="donut">
                  <svg viewBox="0 0 84 84" role="img" aria-label=${`אחסון בשימוש ${_??0}%`}>
                    ${h`<circle cx="42" cy="42" r=${O} fill="none" stroke="var(--sw-surface-3)" stroke-width="9" />
                    <circle cx="42" cy="42" r=${O} fill="none" stroke="var(--sw-accent)" stroke-width="9" stroke-linecap="round" stroke-dasharray=${`${ae*(_??0)/100} ${ae}`} transform="rotate(-90 42 42)" />
                    <text x="42" y="47" text-anchor="middle" font-size="15" font-weight="700" fill="var(--sw-text)" font-family="var(--sw-font)">${_??0}%</text>`}
                  </svg>
                  <div class="txt">
                    <div class="big">${kt(M.used_mb)} מתוך ${kt(M.capacity_mb)}</div>
                    <div class="bar"><i style=${`inline-size:${_??0}%`}></i></div>
                    <div class="muted">${v.retention.measured_days_min!==null?`הקלטה ישנה ביותר ≈ ${v.retention.measured_days_min}${v.retention.measured_days_max!==null&&v.retention.measured_days_max!==v.retention.measured_days_min?`–${v.retention.measured_days_max}`:""} ימים (נמדד)`:v.retention.measured_reason}${v.work_mode?` · ${v.work_mode}`:""} · ${M.disks} דיסקים</div>
                  </div>
                </div>
              </sw-card>`:c}
          <sw-card heading="אתרים ומבנים" subheading=${n.length?`${n.length} אתרים · ${o.length} קומות`:"עדיין לא הוגדרו אתרים"}>
            ${n.map(S=>{const te=(S.buildings??[]).flatMap(es=>es.floors??[]),ni=te.filter(es=>es.has_plan).length,Br=te.reduce((es,Lr)=>es+Lr.camera_count,0);return r`<div class="hrow" @click=${()=>b("/explore/sites")} style="cursor:pointer"><span>${S.name}<div class="muted">${(S.buildings??[]).length} מבנים · ${te.length} קומות · ${Br} מצלמות מוצבות · ${ni}/${te.length} תוכניות</div></span><span class="status"><i style=${`--c:${te.length&&ni===te.length?"var(--sw-live)":"var(--sw-stale)"}`}></i>${te.length&&ni===te.length?"תוכניות מפורסמות":"חסרות תוכניות"}</span></div>`})}
        ...
        <div class="row3">
          <sw-card heading="אירועים אחרונים" subheading=${this.summary?`${this.summary.today.total} היום · ${this.summary.today.measured} נמדדו · ${this.summary.today.inferred} נגזרו מהקלטה`:""}>
            ...
            ${this.recent.length?this.recent.map(S=>r`<div class="ev" data-overview-event @click=${()=>b(`/investigate/events/${S.id}`)}>
                    ${S.thumbnail==="ready"?r`<img class="thumb" src=${zt(S.id)} alt="" loading="lazy" />`:r`<div class="none"><sw-icon name=${S.type==="offline"||S.type==="coverage_gap"?"offline":S.type==="door"||S.type==="io"?"door":S.type==="person"?"user":S.type==="vehicle"?"route":"bell"} size=${14}></sw-icon></div>`}
                    <div class="txt"><b style=${`--tone:${Ns[S.type]??"#6b7280"}`}><i></i>${K[S.type]??S.type}${S.acked_at?"":" · לבדיקה"}</b><small>${S.camera_name??S.details?.name??"ללא מצלמה"} · ${S.confidence==="inferred"?"נגזר מהקלטה":S.source==="ha"?"חיישן HA":"התראה"}</small></div>
          ...
          <sw-card heading="דורש תשומת לב" subheading="כל פריט מסביר מדוע הוא מוצג">
            ${f.length?f.map(S=>r`<div class="spot ${S.kind}" data-overview-spot>
    ...
    `}render(){if(g())return this.renderApi();const e=q.filter(l=>l.state==="live"||l.state==="stale").length,t=Je.filter(l=>!l.acked),s=[{kind:"critical",title:"מצלמה מנותקת: מסדרון מזרחי",meta:"קומה 0 · מאז 07:55",why:"מוצג כי אין הקלטה ממצלמה זו כבר שעתיים",link:"#/system/devices"},{kind:"alert",title:`${t.length} אירועים שלא נבדקו`,meta:"אדם בכניסה הראשית 10:14, רכב בחצר 09:42",why:"מוצג כי אירועי אדם/רכב מחכים לסימון טיפול",link:"#/investigate/events"},{kind:"alert",title:"החיבור ל־Home Assistant לא רענן",meta:"סנכרון אחרון לפני 4 דק׳",why:"מוצג כי מצבי הישויות עלולים להיות מיושנים",link:"#/system/diagnostics"}],i=.68,a=34,n=2*Math.PI*a,o=q.filter(l=>l.state==="live").slice(0,2);return r`
      <sw-page heading="בוקר טוב, יוני" subheading="המערכת פועלת · גשר Home Assistant לא רענן · נתוני הדגמה">
        ...
        <div class="kpis">
          ...
          <sw-kpi icon="building" value=${String(ki.length)} label="אתרים" detail="פעילים" tone="neutral"></sw-kpi>
          <sw-kpi icon="bell" value=${String(Je.length)} label="אירועים" detail="ב־24 השעות" tone="neutral" badge=${`${t.length} חדשים`}></sw-kpi>
        ...
        <div class="row2">
          ...
          <sw-card heading="בריאות האתרים">
            ${ki.map(l=>r`<div class="hrow"><span>${l.name}<div class="muted">${l.online}/${l.cameras} מצלמות · ${l.alerts} התראות</div></span><span class="status"><i style="--c:${l.health==="live"?"var(--sw-live)":l.health==="offline"?"var(--sw-danger)":"var(--sw-stale)"}"></i>${l.health==="live"?"מחובר":l.health==="offline"?"מנותק":"חלקי"}</span></div>`)}
            ${cr.slice(0,2).map(l=>r`<div class="hrow"><span>${l.name}<div class="muted">${l.detail}</div></span><span class="status"><i style="--c:${l.state==="live"?"var(--sw-live)":"var(--sw-stale)"}"></i>${l.state==="live"?"מחובר":"לא רענן"}</span></div>`)}
          </sw-card>
        </div>
        <div class="row3">
          <sw-card heading="אירועים אחרונים">
            <a slot="actions" class="seeall" href="#/investigate/events">הצג הכל</a>
            ${Je.slice(0,5).map(l=>r`<div class="ev" @click=${()=>b("/investigate/events")}>
                ${l.type==="offline"||l.type==="door"?r`<div class="none"><sw-icon name=${l.type==="offline"?"offline":"door"} size=${14}></sw-icon></div>`:r`<sw-scene kind=${nd[l.camera]??"lobby"}></sw-scene>`}
                <div class="txt"><b style="--tone:${rd[l.type]}"><i></i>${_i[l.type]}</b><small>${l.camera} · ${l.floor}</small></div>
                <time>${l.time}</time>
              </div>`)}
          </sw-card>
          <sw-card heading="דורש תשומת לב" subheading="כל פריט מסביר מדוע הוא מוצג">
  ...
  `;Ee([d()],ve.prototype,"cams",2);Ee([d()],ve.prototype,"recorder",2);Ee([d()],ve.prototype,"sites",2);Ee([d()],ve.prototype,"summary",2);Ee([d()],ve.prototype,"recent",2);Ee([d()],ve.prototype,"storage",2);Ee([d()],ve.prototype,"health",2);Ee([d()],ve.prototype,"raw",2);Ee([d()],ve.prototype,"tz",2);Ee([d()],ve.prototype,"now",2);Ee([d()],ve.prototype,"loaded",2);ve=Ee([k("live-overview")],ve);var od=Object.defineProperty,ld=Object.getOwnPropertyDescriptor,rt=(e,t,s,i)=>{for(var a=i>1?void 0:i?ld(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&od(t,s,a),a};const mi=[1,2,4,6,8,9,12,16,20,25,32],Ma="sw.wall.count",Aa=[{id:"all",label:"כל המצלמות"},{id:"outside",label:"חוץ"},{id:"inside",label:"פנים"},{id:"night",label:"לילה"}];let Ne=class extends ${constructor(){super(...arguments),this.cameras="",this.count=4,this.stream="auto",this.view="all",this.cams=null,this.settings=null,this.error="",this.posterBust=Date.now()}connectedCallback(){super.connectedCallback(),this.load(),this.posterTimer=window.setInterval(()=>this.posterBust=Date.now(),6e4)}disconnectedCallback(){super.disconnectedCallback(),window.clearInterval(this.posterTimer)}setCount(e){this.count=e;try{localStorage.setItem(Ma,String(e))}catch{}}async load(){if(g())try{const[e,t]=await Promise.all([Pe(),Ve()]);this.cams=e.cameras.filter(n=>n.enabled),this.settings=t;let s=0;try{s=Number(localStorage.getItem(Ma)??0)}catch{}const i=Number(t["ui.wall_count"]??0),a=mi.includes(s)?s:mi.includes(i)?i:0;a&&(this.count=a)}catch(e){this.error=w(e)}}renderApi(){const e=this.cams;if(this.error)return r`<sw-state-panel state="error" hint=${this.error} actionLabel="נסה שוב" @action=${()=>this.load()}></sw-state-panel>`;if(!e)return r`<sw-state-panel state="loading"></sw-state-panel>`;if(!e.length)return r`<sw-state-panel state="empty" heading="אין מצלמות זמינות" hint="המצלמות מתגלות אוטומטית מה־NVR בהפעלה ובכל 10 דקות. אם הרשימה ריקה: בדוק את פרטי ה־NVR בהגדרות ה־Add-on ואת יומן ה־Add-on, או הרץ סנכרון ידני; ייתכן גם שאין לך הרשאה למצלמות."><div style="margin-block-start:10px"><sw-button @click=${()=>b("/system/devices")}>למצלמות</sw-button></div></sw-state-panel>`;const t=this.cameras?this.cameras.split(",").filter(Boolean):[],s=t.length?e.filter(m=>t.includes(m.id)):e,i=t.length?Math.max(1,s.length):this.count,a=s.slice(0,i),n=i===1?1:i===2||i<=4?2:i<=9?3:i<=16?4:i<=25?5:6,o=this.settings?.["media.max_live_sessions"]??8,l=this.stream==="auto"?this.settings?.["media.wall_profile"]??"sub":this.stream,p=Ji(this.settings);return r`
      <div class="grid" style="--cols:${n}">
        ${a.map((m,f)=>r`<sw-camera-tile
            name=${m.name}
            state=${m.status==="online"?"live":m.status==="offline"?"offline":"unknown"}
            ?live=${m.status!=="offline"&&m.can_view_live!==!1&&f<o}
            cameraId=${m.id}
            profile=${l}
            transport=${p}
            poster=${m.status==="offline"?"":Fe(m.id,this.posterBust)}
            ?compact=${i>=9}
            @click=${()=>b(`/live/cameras/${m.id}`)}></sw-camera-tile>`)}
      </div>
    ...
    `}renderDemo(){const e=q.slice(0,this.count),t=this.count===1?1:this.count===2||this.count<=4?2:this.count<=9?3:4;return r`
    ...
    `}render(){const e=g(),t=e?this.cams?.length??0:q.length;return r`
      <sw-page heading="כל המצלמות" subheading="${t} מצלמות${e?"":` · תצוגה: ${Aa.find(s=>s.id===this.view)?.label} · נתוני הדגמה`}" wide>
        ${e?c:r`<sw-field slot="actions"><select aria-label="תצוגה" @change=${s=>this.view=s.target.value}>${Aa.map(s=>r`<option value=${s.id} ?selected=${s.id===this.view}>${s.label}</option>`)}</select></sw-field>`}
        ...
        <div slot="actions" class="layouts" role="group" aria-label="פריסה">
          ${mi.map(s=>r`<button class=${s===this.count?"on":""} @click=${()=>this.setCount(s)} aria-pressed=${s===this.count}>${s}</button>`)}
        </div>
  ...
  `;rt([u()],Ne.prototype,"cameras",2);rt([d()],Ne.prototype,"count",2);rt([d()],Ne.prototype,"stream",2);rt([d()],Ne.prototype,"view",2);rt([d()],Ne.prototype,"cams",2);rt([d()],Ne.prototype,"settings",2);rt([d()],Ne.prototype,"error",2);rt([d()],Ne.prototype,"posterBust",2);Ne=rt([k("live-wall")],Ne);const dd=()=>z("nvr/notify"),cd=e=>Yt("nvr/notify",e),pd=(e=20)=>z(`nvr/changes?limit=${e}`),hd=e=>A(`nvr/changes/${e}/rollback`),ud=e=>z(`cameras/${e}/record`),md=(e,t)=>A(`cameras/${e}/record/start`,{minutes:t}),fd=e=>A(`cameras/${e}/record/stop`),wd=(e,t)=>Yt(`cameras/${e}/motion`,t);var vd=Object.defineProperty,gd=Object.getOwnPropertyDescriptor,j=(e,t,s,i)=>{for(var a=i>1?void 0:i?gd(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&vd(t,s,a),a};let N=class extends ${constructor(){super(...arguments),this.cameraId="cam-1",this.cam=null,this.zones=null,this.zonesBusy=!1,this.zonesError="",this.motionEdit=null,this.motionConfirm=!1,this.motionBusy=!1,this.motionMsg="",this.paintValue=null,this.rec=null,this.recMinutes=10,this.recBusy=!1,this.recMsg="",this.recTimer=0,this.zoneLayers={motion:!0,privacy:!0,intrusion:!0,lines:!0},this.caps=null,this.capsError="",this.cams=[],this.settings=null,this.error="",this.loading=!0,this.profile="main",this.transport="auto",this.playerStatus="",this.playerTransport="",this.posterBust=Date.now(),this.ptzMode="presets"}async loadRecord(){if(!(!this.cam||!g())){try{this.rec=await ud(this.cam.id)}catch{this.rec=null}window.clearTimeout(this.recTimer),this.rec?.active&&(this.recTimer=window.setTimeout(()=>void this.loadRecord(),15e3))}}async toggleRecord(){if(!(!this.cam||this.recBusy)){this.recBusy=!0,this.recMsg="";try{if(this.rec?.active)await fd(this.cam.id),this.recMsg="ההקלטה הידנית נעצרה.";else{const e=await md(this.cam.id,this.recMinutes);this.recMsg=`הקלטה ידנית החלה · תיעצר אוטומטית ב־${new Date(e.stop_at).toLocaleTimeString("he-IL",{hour:"2-digit",minute:"2-digit"})}.`}await this.loadRecord()}catch(e){this.recMsg=w(e)}finally{this.recBusy=!1}}}renderRecord(){const e=this.rec;if(!e||!e.can_write)return c;const t=e.active,s=t?`${Math.floor(t.remaining_s/60)}:${String(t.remaining_s%60).padStart(2,"0")}`:"";return r`<div class="note" style="margin-block-start:8px;display:flex;flex-wrap:wrap;gap:8px;align-items:center" data-manual-record data-active=${t?"yes":"no"}>
    ...
    </div>`}connectedCallback(){super.connectedCallback(),this.load()}updated(e){e.has("cameraId")&&e.get("cameraId")!==void 0&&this.load(),e.has("cam")&&this.cam&&g()&&!this.zonesBusy&&(!this.zones||this.zones.camera_id!==this.cam.id)&&(this.loadRecord(),this.zonesError="",this.loadZones()),e.has("cam")&&this.cam&&g()&&(!this.caps||this.caps.camera_id!==this.cam.id)&&this.loadCaps()}async loadZones(e=!1){if(this.cam){this.zonesBusy=!0,this.zonesError="";try{this.zones=await Un(this.cam.id,e)}catch(t){this.zonesError=w(t)}finally{this.zonesBusy=!1}}}async loadCaps(e=!1){if(this.cam){this.capsError="";try{this.caps=await Wn(this.cam.id,e)}catch(t){this.capsError=w(t)}}}renderCaps(){const e=this.caps;if(this.capsError&&!e)return r`<div class="note" data-caps>יכולות המצלמה לא נקראו מה־NVR: ${this.capsError}</div>`;if(!e)return r`<div class="note" data-caps>קורא יכולות מה־NVR…</div>`;const t=e.ptz.state==="supported"?"live":e.ptz.state==="unsupported"?"neutral":"unknown",s=e.ptz.state==="supported"?`PTZ: נתמך${e.ptz.preset_count!==null?` · ${e.ptz.preset_count} presets`:""}`:e.ptz.state==="unsupported"?"PTZ: לא נתמך במצלמה זו":"PTZ: לא ידוע",i=e.audio.state==="available"?"live":e.audio.state==="disabled"?"stale":e.audio.state==="unsupported"?"neutral":"unknown",a=e.audio.state==="available"?`שמע דו־כיווני: ערוץ פעיל${e.audio.codec?` (${e.audio.codec})`:""}`:e.audio.state==="disabled"?"שמע דו־כיווני: ערוץ קיים אך כבוי במכשיר":e.audio.state==="unsupported"?"שמע דו־כיווני: אין ערוץ למצלמה זו":"שמע דו־כיווני: לא ידוע";return r`<div class="note" style="margin-block-start:8px;display:flex;flex-wrap:wrap;gap:6px;align-items:center" data-caps data-ptz=${e.ptz.state} data-audio=${e.audio.state}>
      ...
      <div class="zones" data-zones-loaded>
        <div class="frame">
          ...
          <svg viewBox="0 0 1000 1000" preserveAspectRatio="none" aria-label="אזורי זיהוי מעל תמונת המצלמה">
            ${this.motionEdit&&i&&i.rows&&i.cols?this.motionEdit.cells.flatMap((o,l)=>o.map((p,m)=>h`<rect class=${p?"cell":"cell off"} data-motion-cell=${`${l}-${m}`} x=${m*1e3/i.cols} y=${l*1e3/i.rows} width=${1e3/i.cols} height=${1e3/i.rows} style="cursor:crosshair;${p?"":"fill:rgba(255,255,255,0.03);stroke:rgba(255,255,255,0.18)"}" @pointerdown=${f=>{f.preventDefault(),this.paintCell(l,m,!0)}} @pointerenter=${f=>{f.buttons&1&&this.paintCell(l,m)}} @pointerup=${()=>this.paintValue=null}></rect>`)):c}
            ${!this.motionEdit&&s.motion&&i&&i.rows&&i.cols?i.cells.flatMap((o,l)=>o.map((p,m)=>p?h`<rect x=${m*1e3/i.cols} y=${l*1e3/i.rows} width=${1e3/i.cols} height=${1e3/i.rows} class="cell"></rect>`:c)):c}
      ...
      </div>`}async load(){this.loading=!0,this.error="";try{if(g()){const[e,t]=await Promise.all([Pe(),Ve()]);this.cams=e.cameras,this.cam=e.cameras.find(s=>s.id===this.cameraId)??null,this.settings=t,this.transport=Ji(t)}}catch(e){this.error=w(e)}finally{this.loading=!1}}setTransport(e){Fn(e===(this.settings?.["media.transport_default"]??"mse")?"":e),this.transport=e}onPlayer(e){this.playerStatus=e.detail.status,this.playerTransport=e.detail.transport??""}renderApi(){const e=this.cam;if(this.loading)return r`<sw-state-panel state="loading"></sw-state-panel>`;if(this.error)return r`<sw-state-panel state="error" hint=${this.error} actionLabel="נסה שוב" @action=${()=>this.load()}></sw-state-panel>`;if(!e)return r`<sw-state-panel state="forbidden" heading="המצלמה לא זמינה" hint="המצלמה לא נמצאה או שאין לך הרשאת צפייה בה."></sw-state-panel>`;const t=e.can_view_live!==!1&&e.status!=="offline",s=Fe(e.id,this.posterBust),i=e.stream;return r`
      ...
      <div class="controls">
        <div class="round" role="group" aria-label="פקדי מצלמה">
          ...
          ${ir()?r`<span class="note">ברירת המחדל של המערכת: ${this.settings?.["media.transport_default"]??"mse"}</span>`:c}
        </div>
      ...
      <div class="grid">
        ...
        <sw-card heading="מצלמות נוספות">
          <div class="tiles">
            ${this.cams.filter(a=>a.id!==e.id).slice(0,4).map(a=>r`<sw-camera-tile compact name=${a.name} state=${a.status==="online"?"live":a.status==="offline"?"offline":"unknown"} poster=${a.status==="offline"?"":Fe(a.id)} @click=${()=>b(`/live/cameras/${a.id}`)}></sw-camera-tile>`)}
          </div>
        </sw-card>
      </div>
    `}renderDemo(){const e=q.find(i=>i.id===this.cameraId)??q[0],t=e.state==="live"||e.state==="stale",s=Ue[e.id]??"lobby";return r`
      ...
      <div class="grid">
        ...
        <sw-card heading="מצלמות באותה קומה">
          <div class="tiles">
            ${q.filter(i=>i.floor===e.floor&&i.id!==e.id).slice(0,4).map(i=>r`<sw-camera-tile compact name=${i.name} state=${i.state} scene=${Ue[i.id]??"lobby"} @click=${()=>b(`/live/cameras/${i.id}`)}></sw-camera-tile>`)}
          </div>
        </sw-card>
      </div>
    `}render(){const e=g(),t=e?this.cam?.name??"מצלמה":(q.find(i=>i.id===this.cameraId)??q[0]).name,s=e?this.cam?`ערוץ ${this.cam.channel} · ${this.cam.name_source||""}`:"":`${(q.find(i=>i.id===this.cameraId)??q[0]).floor} · נתוני הדגמה`;return r`
  ...
  `;j([u()],N.prototype,"cameraId",2);j([d()],N.prototype,"cam",2);j([d()],N.prototype,"zones",2);j([d()],N.prototype,"zonesBusy",2);j([d()],N.prototype,"zonesError",2);j([d()],N.prototype,"motionEdit",2);j([d()],N.prototype,"motionConfirm",2);j([d()],N.prototype,"motionBusy",2);j([d()],N.prototype,"motionMsg",2);j([d()],N.prototype,"rec",2);j([d()],N.prototype,"recMinutes",2);j([d()],N.prototype,"recBusy",2);j([d()],N.prototype,"recMsg",2);j([d()],N.prototype,"zoneLayers",2);j([d()],N.prototype,"caps",2);j([d()],N.prototype,"capsError",2);j([d()],N.prototype,"cams",2);j([d()],N.prototype,"settings",2);j([d()],N.prototype,"error",2);j([d()],N.prototype,"loading",2);j([d()],N.prototype,"profile",2);j([d()],N.prototype,"transport",2);j([d()],N.prototype,"playerStatus",2);j([d()],N.prototype,"playerTransport",2);j([d()],N.prototype,"posterBust",2);j([d()],N.prototype,"ptzMode",2);j([Kt("sw-live-player")],N.prototype,"player",2);N=j([k("live-camera")],N);var bd=Object.defineProperty,yd=Object.getOwnPropertyDescriptor,qe=(e,t,s,i)=>{for(var a=i>1?void 0:i?yd(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&bd(t,s,a),a};const $d={name:"",cameras:[],cols:2,rows:2,shared:!1,kiosk:!1},xd=[{name:"כל המצלמות",layout:9,scope:"משותפת",mobile:"4 · משני",owner:"יוני",kiosk:!0},{name:"חוץ",layout:4,scope:"משותפת",mobile:"2 · משני",owner:"יוני",kiosk:!1},{name:"פנים",layout:6,scope:"משותפת",mobile:"ללא",owner:"יוסי",kiosk:!1},{name:"לילה",layout:4,scope:"אישית",mobile:"4 · משני",owner:"דנה",kiosk:!1}];let Me=class extends ${constructor(){super(...arguments),this.views=null,this.cams=[],this.canShare=!1,this.canManageAll=!1,this.editing=null,this.confirmDelete=null,this.busy=!1,this.error="",this.formError=""}connectedCallback(){super.connectedCallback(),g()&&this.load()}async load(){try{const[e,t]=await Promise.all([fr(),Pe()]);this.views=e.views,this.canShare=e.can_share,this.canManageAll=e.can_manage_all,this.cams=t.cameras.filter(s=>s.enabled&&s.can_view_live!==!1),this.error=""}catch(e){this.error=w(e),this.views=this.views??[]}}canEdit(e){return this.canManageAll||e.owner_user_id===mt.me?.user.id}open(e){this.formError="",this.editing=e?{id:e.id,name:e.name,cameras:[...e.cameras],cols:e.cols,rows:e.rows,shared:e.shared,kiosk:e.kiosk}:{...$d,cameras:[]}}toggleCamera(e){if(!this.editing)return;const t=this.editing.cameras.includes(e);!t&&this.editing.cameras.length>=16||(this.editing={...this.editing,cameras:t?this.editing.cameras.filter(s=>s!==e):[...this.editing.cameras,e]})}async save(){const e=this.editing;if(e){if(!e.name.trim()){this.formError="לתצוגה צריך שם.";return}if(!e.cameras.length){this.formError="בחר לפחות מצלמה אחת.";return}this.busy=!0;try{const t={name:e.name.trim(),cameras:e.cameras,cols:e.cols,rows:e.rows,shared:e.shared,kiosk:e.kiosk};e.id?await Yo(e.id,t):await wr(t),this.editing=null,await this.load()}catch(t){this.formError=w(t)}finally{this.busy=!1}}}async removeView(){const e=this.confirmDelete;if(e){this.busy=!0;try{await Jo(e.id),this.confirmDelete=null,await this.load()}catch(t){this.error=w(t)}finally{this.busy=!1}}}renderEditor(){const e=this.editing;return r`<sw-dialog open heading=${e.id?"עריכת תצוגה":"תצוגה חדשה"} subheading="שם, מצלמות ופריסה · תצוגה משותפת נראית לכל המשתמשים" data-view-dialog @close=${()=>this.editing=null}>
      <div class="form">
        ...
        ${e===null?r`<sw-state-panel state="loading" heading="טוען תצוגות…"></sw-state-panel>`:e.length?r`<div class="grid" data-views>
                ${e.map(t=>r`<sw-card data-view=${t.id}>
                    <div class="thumb" style=${`grid-template-columns:repeat(${Math.min(2,Math.max(1,t.cameras.length))}, 1fr)`}>
                      ${t.cameras.slice(0,4).map(s=>r`<img src=${Fe(s)} alt="" loading="lazy" @error=${i=>i.target.style.visibility="hidden"} />`)}
                    ...
                    <div class="foot">
                      <a href=${vr(t)}><sw-button size="sm" variant="primary" icon="play" data-view-open ?disabled=${!t.cameras.length}>פתח</sw-button></a>
                      <a href=${Xo(t)} target="_blank" rel="noopener"><sw-button size="sm" icon="layers" data-view-kiosk-open ?disabled=${!t.cameras.length}>קיוסק</sw-button></a>
                      <span class="grow"></span>
    ...
    `}render(){return g()?this.renderApi():r`
      <sw-page heading="תצוגות שמורות" subheading="תבניות 1 / 2 / 4 / 6 / 9 / 12 / 16 / מותאם, אישיות או משותפות, עם התאמה למובייל · נתוני הדגמה">
        ...
        <div class="grid">
          ${xd.map(e=>{const t=Math.ceil(Math.sqrt(e.layout));return r`<sw-card heading=${e.name}>
              <sw-badge slot="actions" kind="neutral" label=${e.scope}></sw-badge>
              <div class="thumb" style="grid-template-columns:repeat(${t},1fr)">${q.filter(s=>s.state==="live").slice(0,e.layout).map(s=>r`<sw-scene kind=${Ue[s.id]??"lobby"}></sw-scene>`)}</div>
              <dl>
  ...
  `;qe([d()],Me.prototype,"views",2);qe([d()],Me.prototype,"cams",2);qe([d()],Me.prototype,"canShare",2);qe([d()],Me.prototype,"canManageAll",2);qe([d()],Me.prototype,"editing",2);qe([d()],Me.prototype,"confirmDelete",2);qe([d()],Me.prototype,"busy",2);qe([d()],Me.prototype,"error",2);qe([d()],Me.prototype,"formError",2);Me=qe([k("live-views")],Me);var kd=Object.defineProperty,_d=Object.getOwnPropertyDescriptor,nt=(e,t,s,i)=>{for(var a=i>1?void 0:i?_d(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&kd(t,s,a),a};const zr="sw.kiosk.layout",zd=[[2,2],[3,2],[3,3],[4,3],[4,4],[5,4],[6,4]];function Sr(e){try{const i=localStorage.getItem(zr);if(i){const[a,n]=i.split("x").map(Number);if(a>=1&&n>=1)return{cols:a,rows:n}}}catch{}const t=Number(e?.["ui.kiosk_cols"]??0),s=Number(e?.["ui.kiosk_rows"]??0);return{cols:t>=1?t:3,rows:s>=1?s:2}}function fi(e=Sr()){const t=ws().params,s=Math.min(6,Math.max(1,Number(t.get("cols")??e.cols)||e.cols)),i=Math.min(5,Math.max(1,Number(t.get("rows")??e.rows)||e.rows));return{cameras:(t.get("cameras")??"").split(",").map(a=>a.trim()).filter(Boolean),cols:s,rows:i,rotate:Math.max(0,Number(t.get("rotate")??0)||0)}}let Be=class extends ${constructor(){super(...arguments),this.cams=null,this.settings=null,this.clock="",this.page=0,this.health=null,this.disconnected=!1,this.view=fi(),this.failures=0,this.onHash=()=>{this.view=fi(),this.page=this.restorePage(),this.startRotation()},this.started=0,this.staggerTimer=0}setLayout(e){const[t,s]=e.split("x").map(Number);if(!(t>=1&&s>=1))return;try{localStorage.setItem(zr,`${t}x${s}`)}catch{}const i=new URLSearchParams(ws().params);i.set("cols",String(t)),i.set("rows",String(s)),window.location.replace(`#/kiosk/all?${i.toString()}`)}get pageKey(){return`sw.kiosk.page:${this.view.cameras.join(",")}|${this.view.cols}x${this.view.rows}`}restorePage(){try{const e=Number(localStorage.getItem(this.pageKey)??"0");return Number.isFinite(e)&&e>=0?e:0}catch{return 0}}setPage(e){this.page=e;try{localStorage.setItem(this.pageKey,String(e%Math.max(1,this.pages)))}catch{}}connectedCallback(){super.connectedCallback(),this.page=this.restorePage(),this.tick(),this.timer=window.setInterval(()=>this.tick(),1e3),this.unsubscribe=pr(e=>{e.mode==="api"&&this.cams===null?this.load():e.mode!=="loading"&&this.requestUpdate()}),window.addEventListener("hashchange",this.onHash),this.startRotation(),this.pollHealth(),this.healthTimer=window.setInterval(()=>void this.pollHealth(),15e3)}disconnectedCallback(){window.clearTimeout(this.staggerTimer),super.disconnectedCallback(),window.clearInterval(this.timer),window.clearInterval(this.rotateTimer),window.clearInterval(this.healthTimer),window.removeEventListener("hashchange",this.onHash),this.unsubscribe?.()}startRotation(){window.clearInterval(this.rotateTimer),this.view.rotate>0&&(this.rotateTimer=window.setInterval(()=>{this.setPage(this.page+1),this.stagger()},this.view.rotate*1e3)),this.stagger()}async pollHealth(){if(g())try{this.health=await Yi(),(this.disconnected||this.failures>=3)&&this.load(),this.failures=0,this.disconnected=!1}catch{this.failures+=1,this.failures>=3&&(this.disconnected=!0)}}get pageSize(){return this.view.cols*this.view.rows}stagger(){window.clearTimeout(this.staggerTimer),this.started=0;const e=()=>{this.started<this.pageSize&&(this.started+=1,this.staggerTimer=window.setTimeout(e,400))};e()}get selected(){const e=(this.cams??[]).filter(t=>this.view.cameras.length===0||this.view.cameras.includes(t.id));return this.view.cameras.length?this.view.cameras.map(t=>e.find(s=>s.id===t)).filter(t=>!!t):e}get pages(){return Math.max(1,Math.ceil(this.selected.length/this.pageSize))}tick(){const e=new Date;this.clock=`${e.toLocaleDateString("he-IL",{weekday:"long",day:"2-digit",month:"2-digit",year:"numeric"})} · ${e.toLocaleTimeString("he-IL")}`}async load(){if(g())try{const[e,t]=await Promise.all([Pe(),Ve()]);this.cams=e.cameras.filter(s=>s.enabled),this.settings=t,this.view=fi(Sr(t))}catch{this.cams=[]}}render(){const t=g(),s=this.page%this.pages,i=t?this.selected.slice(s*this.pageSize,(s+1)*this.pageSize):[],a=q.filter(l=>l.state!=="forbidden").slice(0,9),n=t?i.filter(l=>l.status==="online").length:7,o=this.settings?.["media.max_live_sessions"]??8;return r`
      <header>
        ...
        ${t?r`<select class="layout" data-kiosk-layout aria-label="פריסה" @change=${l=>this.setLayout(l.target.value)}>
          ${zd.map(([l,p])=>r`<option value=${`${l}x${p}`} ?selected=${l===this.view.cols&&p===this.view.rows}>${l}×${p} · ${l*p} מצלמות בעמוד</option>`)}
        </select>`:c}
        ${t&&this.health?r`<span class="pill" data-kiosk-health data-status=${this.health.status}>מערכת: ${os[this.health.status]}${this.health.items.filter(l=>l.status!=="ok").length?` · ${this.health.items.filter(l=>l.status!=="ok").map(l=>l.label).join(", ")}`:""}</span>`:c}
  ...
  `;nt([d()],Be.prototype,"cams",2);nt([d()],Be.prototype,"settings",2);nt([d()],Be.prototype,"clock",2);nt([d()],Be.prototype,"page",2);nt([d()],Be.prototype,"health",2);nt([d()],Be.prototype,"disconnected",2);nt([d()],Be.prototype,"view",2);nt([d()],Be.prototype,"started",2);Be=nt([k("kiosk-wall")],Be);var Sd=Object.defineProperty,Md=Object.getOwnPropertyDescriptor,Ce=(e,t,s,i)=>{for(var a=i>1?void 0:i?Md(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&Sd(t,s,a),a};const Ad={preserved:"#16a34a",preserving:"#d97706",nvr:"#7c3aed"},Ts=[{label:"יום",minutes:1440},{label:"6 שע׳",minutes:360},{label:"שעה",minutes:60},{label:"10 דק׳",minutes:10},{label:"דקה",minutes:1}];function Ci(e){return String(e).padStart(2,"0")}function ze(e){const t=(e%1440+1440)%1440;return`${Ci(Math.floor(t/60))}:${Ci(Math.floor(t%60))}`}function Ye(e){const t=(e%1440+1440)%1440,s=Math.min(59,Math.round(t%1*60));return`${ze(t)}:${Ci(s)}`}const Id={motion:"#ef4444",person:"#2f6bff",vehicle:"#22c55e",line:"#f59e0b",offline:"#6b7280",door:"#8b5cf6"};let ge=class extends ${constructor(){super(...arguments),this.segments=[],this.events=[],this.bookmarks=[],this.cursor=615,this.windowMinutes=360,this.precision="estimated",this.follow=!0,this.limit=1440,this.hover=null,this.lastHoverBucket=-1,this.viewStart=-1,this.dragging=!1}get start(){const e=Math.max(0,1440-this.windowMinutes);return this.viewStart>=0&&!this.follow?Math.max(0,Math.min(e,this.viewStart)):Math.max(0,Math.min(e,this.cursor-this.windowMinutes/2))}get step(){return this.windowMinutes>=360?1:this.windowMinutes>=60?1/6:1/60}snap(e){const t=this.step;return Math.max(0,Math.min(this.limit,Math.round(e/t)*t))}x(e,t){return(e-this.start)/this.windowMinutes*t}minuteAt(e){const t=e.currentTarget.getBoundingClientRect();return this.start+(e.clientX-t.left)/t.width*this.windowMinutes}onMove(e){const t=this.minuteAt(e);if(this.hover=t,!this.dragging){const s=Math.floor(t*6);if(s!==this.lastHoverBucket){this.lastHoverBucket=s;const i=e.currentTarget.getBoundingClientRect();this.dispatchEvent(new CustomEvent("hover",{detail:{minute:t,x:e.clientX-i.left,width:i.width},bubbles:!0,composed:!0}))}}if(this.dragging){const s=this.snap(t);this.cursor=s,this.dispatchEvent(new CustomEvent("scrub",{detail:{minute:s},bubbles:!0,composed:!0}))}}onDown(e){e.button===0&&(e.currentTarget.setPointerCapture(e.pointerId),this.dragging=!0,this.viewStart=this.start,this.follow=!1)}onUp(e){if(!this.dragging)return;this.dragging=!1;const t=this.snap(this.minuteAt(e));this.cursor=t,this.follow=!0,this.dispatchEvent(new CustomEvent("seek",{detail:{minute:t,alt:e.altKey},bubbles:!0,composed:!0}))}onWheel(e){e.preventDefault();const t=Ts.findIndex(i=>i.minutes===this.windowMinutes),s=Math.max(0,Math.min(Ts.length-1,t+(e.deltaY>0?-1:1)));s!==t&&this.setWindow(Ts[s].minutes,this.minuteAt(e))}setWindow(e,t=this.cursor){const s=Math.max(0,Math.min(1,(t-this.start)/this.windowMinutes));this.windowMinutes=e,this.viewStart=t-s*e,this.follow=!1,this.dispatchEvent(new CustomEvent("window-change",{detail:{minutes:e},bubbles:!0,composed:!0}))}buckets(e){const t=[],s=this.windowMinutes/e;for(let i=0;i<e;i++){const a=this.start+i*s,n=a+s;let o=0;for(const l of this.segments)l.endMin>a&&l.startMin<n&&(o=Math.max(o,l.kind==="motion"?2:1));o&&this.events.some(l=>l.minute>=a-s&&l.minute<=n+s)&&(o=3),t.push(o)}return t}tickEvery(){const e=this.windowMinutes;return e<=1?10/60:e<=10?1:e<=60?10:e<=360?60:180}label(e){return this.windowMinutes<=10?Ye(e):ze(e)}render(){const n=this.tickEvery(),o=[];for(let _=Math.ceil(this.start/n-1e-9)*n;_<=this.start+this.windowMinutes+1e-9;_+=n)o.push(_);const l=[0,12,26,36],p={verified:"זמן מאומת",keyframe_limited:"דיוק לפי keyframe",estimated:"זמן משוער",unknown:"דיוק לא ידוע"}[this.precision],m=this.x(this.cursor,1e3),f=this.label(this.cursor),v=f.length>5?62:48,M=this.limit<this.start+this.windowMinutes?Math.max(0,this.x(this.limit,1e3)):null;return r`
      <div class="bar">
        <span class="precision">${p} · לחיצה או גרירה = seek · גלגלת = זום</span>
        <div class="windows">
          ${Ts.map(_=>r`<button class=${_.minutes===this.windowMinutes?"on":""} @click=${()=>this.setWindow(_.minutes)}>${_.label}</button>`)}
        </div>
      </div>
      <svg
        ...
        ${M!==null?h`<rect x=${M} y="14" width=${Math.max(0,1e3-M)} height=${44} fill="var(--sw-surface-3)" opacity="0.7" />`:c}
        ${this.buckets(160).map((_,O)=>{if(!_)return c;const ae=l[_];return h`<rect x=${O*6.25+1} y=${58-ae} width=${Math.max(2,6.25-2)} height=${ae} rx="1.5" fill="var(--sw-accent)" opacity=${_===1?.45:_===2?.8:1} />`})}
        ...
        ${this.events.map(_=>{const O=this.x(_.minute,1e3);return O<0||O>1e3?c:h`<g><circle cx=${O} cy=${58-l[3]-8} r="3.5" fill=${Id[_.kind]} /><title>${_.label} · ${ze(_.minute)}</title></g>`})}
        ${this.bookmarks.map(_=>{const O=this.x(_.minute,1e3),ae=this.x(_.endMinute,1e3);if(ae<0||O>1e3)return c;const Bt=Ad[_.preservation],S=te=>{te.stopPropagation(),this.cursor=_.minute,this.follow=!0,this.dispatchEvent(new CustomEvent("seek",{detail:{minute:_.minute,alt:!1},bubbles:!0,composed:!0})),this.dispatchEvent(new CustomEvent("bookmark-click",{detail:{id:_.id,minute:_.minute},bubbles:!0,composed:!0}))};return h`<g class="bm" data-bookmark=${_.id} role="button" tabindex="0" aria-label=${_.label} @pointerdown=${te=>te.stopPropagation()} @click=${S} @keydown=${te=>(te.key==="Enter"||te.key===" ")&&S(te)}>
            <rect x=${Math.max(0,O)} y="13" width=${Math.max(2,Math.min(1e3,ae)-Math.max(0,O))} height="3" rx="1.5" fill=${Bt} opacity="0.55" />
            <line x1=${O} x2=${O} y1="3" y2=${58} stroke=${Bt} stroke-dasharray="2 3" opacity="0.6" />
            <polygon points=${`${O},2 ${O+9},6 ${O},10`} fill=${Bt} />
            <title>${_.label} · ${ze(_.minute)}</title>
          </g>`})}
        ...
        ${m>=-60&&m<=1060?h`<g transform="translate(${m} 0)" pointer-events="none">
  ...
  `;Ce([u({attribute:!1})],ge.prototype,"segments",2);Ce([u({attribute:!1})],ge.prototype,"events",2);Ce([u({attribute:!1})],ge.prototype,"bookmarks",2);Ce([u({type:Number})],ge.prototype,"cursor",2);Ce([u({type:Number})],ge.prototype,"windowMinutes",2);Ce([u()],ge.prototype,"precision",2);Ce([u({type:Boolean})],ge.prototype,"follow",2);Ce([u({type:Number})],ge.prototype,"limit",2);Ce([d()],ge.prototype,"hover",2);Ce([d()],ge.prototype,"viewStart",2);Ce([d()],ge.prototype,"dragging",2);ge=Ce([k("sw-timeline")],ge);const ls={open:"פתוח",in_review:"בבדיקה",closed:"סגור"},Pd={preserved:"עותק שמור",preserving:"מעתיק מה־NVR…",nvr_only:"סימנייה ל־NVR בלבד",missing:"חסר: ה־NVR כבר לא מחזיק את הקטע",unknown:"לא נבדק מול ה־NVR",none:""};function Mr(e={}){const t=new URLSearchParams;e.status&&t.set("status",e.status),e.q&&t.set("q",e.q);const s=t.toString();return z(`cases${s?`?${s}`:""}`)}const Ar=e=>A("cases",e),Ed=(e,t=!0)=>z(`cases/${e}${t?"":"?check=false"}`),Cd=(e,t)=>Le(`cases/${e}`,t),Td=e=>he(`cases/${e}`),Ti=(e,t)=>A(`cases/${e}/items`,t),Dd=(e,t)=>he(`cases/${e}/items/${t}`),Od=(e,t)=>A(`cases/${e}/items/${t}/preserve`),Ia={preserved:"עותק שמור",preserving:"מעתיק מה־NVR…",nvr:"סימנייה ל־NVR"},Pa=(e,t)=>z(`cases/bookmarks?camera_id=${encodeURIComponent(e)}&date=${encodeURIComponent(t)}`),Ea=e=>e.toISOString().replace(/\.\d{3}Z$/,"Z"),Di=(e,t=15,s=45)=>({from_at:Ea(new Date(e.getTime()-t*1e3)),to_at:Ea(new Date(e.getTime()+s*1e3))}),Rd=()=>z("evidence/signing"),Nd=()=>A("evidence/signing/rotate"),Bd=e=>A(`cases/${e}/bundle`),Ld=e=>z(`cases/${e}/bundles`),Hd=(e,t)=>ce(`cases/${e}/bundles/${t}`),Vd=(e,t)=>ce(`cases/${e}/items/${t}/file`);function jd(e){const t=new FormData;return t.append("file",e,e.name),ei("cases/bundles/verify",t)}var Fd=Object.defineProperty,Ud=Object.getOwnPropertyDescriptor,Te=(e,t,s,i)=>{for(var a=i>1?void 0:i?Ud(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&Fd(t,s,a),a};let be=class extends ${constructor(){super(...arguments),this.item=null,this.subheading="",this.cases=[],this.loading=!1,this.error="",this.picked="",this.newTitle="",this.note="",this.busy=!1,this.done=null,this.canManage=!0}updated(e){e.has("item")&&this.item&&this.load()}async load(){this.loading=!0,this.error="",this.done=null,this.note="";try{const e=await Mr({status:"open"});this.cases=e.cases,this.canManage=e.can_manage,this.picked=e.cases[0]?.id??"new"}catch(e){this.error=w(e)}finally{this.loading=!1}}close(){this.item=null,this.dispatchEvent(new CustomEvent("close",{bubbles:!0,composed:!0}))}async confirm(){const e=this.item;if(e){this.busy=!0,this.error="";try{let t=this.picked,s=this.cases.find(a=>a.id===t)?.title??"";if(t==="new"){if(!this.newTitle.trim()){this.error="תן שם לתיק החדש.";return}const a=await Ar({title:this.newTitle.trim()});t=a.id,s=a.title}const i=await Ti(t,{...e,note:this.note.trim()||e.note});this.done={id:t,title:s},this.dispatchEvent(new CustomEvent("added",{detail:{caseId:t,item:i},bubbles:!0,composed:!0}))}catch(t){this.error=w(t)}finally{this.busy=!1}}}render(){const e=this.item;if(!e)return c;const t=e.kind==="event"?"האירוע":e.kind==="clip"?"הקטע":"ההערה";return r`<sw-dialog open heading="הוסף לתיק" subheading=${this.subheading} data-case-picker @close=${()=>this.close()}>
  ...
  `;Te([u({attribute:!1})],be.prototype,"item",2);Te([u()],be.prototype,"subheading",2);Te([d()],be.prototype,"cases",2);Te([d()],be.prototype,"loading",2);Te([d()],be.prototype,"error",2);Te([d()],be.prototype,"picked",2);Te([d()],be.prototype,"newTitle",2);Te([d()],be.prototype,"note",2);Te([d()],be.prototype,"busy",2);Te([d()],be.prototype,"done",2);Te([d()],be.prototype,"canManage",2);be=Te([k("sw-case-picker")],be);const Ir=(e,t)=>z(`cameras/${e}/recordings?date=${t}`),ds=new Set,cs=new Set;function Wd(){if(!(!ds.size&&!cs.size)){for(const e of cs)navigator.sendBeacon?.(ce(`playback/groups/${e}/close`),"");for(const e of ds)navigator.sendBeacon?.(ce(`playback/sessions/${e}/close`),"");ds.clear(),cs.clear()}}typeof window<"u"&&window.addEventListener("pagehide",Wd);const Xi=async(e,t)=>{const s=await A("playback/sessions",{camera_id:e,start_at:t});return ds.add(s.id),s},Ca=(e,t)=>A(`playback/sessions/${e}/seek`,{start_at:t}),ys=e=>(ds.delete(e),he(`playback/sessions/${e}`));function Us(e){const t=new URL(ce(`playback/sessions/${e.id}/ws?generation=${e.generation}`));return t.protocol=t.protocol==="https:"?"wss:":"ws:",t.toString()}function Qe(e,t){const s=new Intl.DateTimeFormat("en-CA",{timeZone:t,year:"numeric",month:"2-digit",day:"2-digit"}).formatToParts(e),i=a=>s.find(n=>n.type===a)?.value??"";return`${i("year")}-${i("month")}-${i("day")}`}function X(e,t){const s=new Intl.DateTimeFormat("en-GB",{timeZone:t,hour:"2-digit",minute:"2-digit",second:"2-digit",hourCycle:"h23"}).formatToParts(e),i=a=>Number(s.find(n=>n.type===a)?.value??0);return i("hour")*60+i("minute")+i("second")/60}function je(e,t,s){const[i,a,n]=e.split("-").map(Number),o=Date.UTC(i,a-1,n,Math.floor(t/60),Math.floor(t%60),Math.round(t%1*60)),l=m=>{const f=new Intl.DateTimeFormat("en-US",{timeZone:s,hour12:!1,year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit",second:"2-digit"}).formatToParts(new Date(m)),v=_=>Number(f.find(O=>O.type===_)?.value??0);return Date.UTC(v("year"),v("month")-1,v("day"),v("hour")%24,v("minute"),v("second"))-m};let p=o-l(o);return p=o-l(p),new Date(p)}const Zd=async(e,t)=>{const s=await A("playback/groups",{camera_ids:e,start_at:t});return cs.add(s.id),s},qd=(e,t)=>A(`playback/groups/${e}/seek`,{start_at:t}),Kd=e=>(cs.delete(e),he(`playback/groups/${e}`)),Gd=(e,t)=>A(`playback/groups/${e}/sync`,{p95_s:t.p95,quality:t.quality,samples:t.samples,partial:t.partial,members:t.members}),ai=(e,t)=>ce(`cameras/${e}/frame?at=${encodeURIComponent(t)}`),Pr=(e,t,s)=>({camera_id:e,from_at:t,to_at:s}),Yd=(e,t,s)=>A("exports/estimate",Pr(e,t,s)),Jd=(e,t,s)=>A("exports",Pr(e,t,s)),Xd=()=>z("exports"),Qd=e=>A(`exports/${e}/cancel`),ec=e=>he(`exports/${e}`),Er=e=>ce(`exports/${e}/download`),tc=e=>ce(`exports/${e}/manifest`);function Ht(e){return e==null?"—":e<1024*1024?`${Math.round(e/1024)} KB`:e<1024*1024*1024?`${(e/1024/1024).toFixed(1)} MB`:`${(e/1024/1024/1024).toFixed(2)} GB`}var sc=Object.defineProperty,ic=Object.getOwnPropertyDescriptor,P=(e,t,s,i)=>{for(var a=i>1?void 0:i?ic(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&sc(t,s,a),a};const $t=["closed","expired","failed"];function ss(e){return Ye(Math.max(0,Math.min(1439.983,e)))}function wi(e){const[t=0,s=0,i=0]=e.split(":").map(Number);return t*60+s+i/60}function ac(e){const t=e.map(s=>Math.abs(s)).sort((s,i)=>s-i);return t[Math.min(t.length-1,Math.max(0,Math.ceil(.95*t.length)-1))]}let I=class extends ${constructor(){super(...arguments),this.cameraId="",this.at="",this.extraParam="",this.demoCamera="cam-10",this.cursor=615,this.generation=3,this.playing=!0,this.speed=1,this.filter="all",this.cams=null,this.tz="Asia/Jerusalem",this.date="",this.rec=null,this.dayEvents=[],this.bookmarks=[],this.activeBookmark=null,this.loadingRec=!1,this.session=null,this.group=null,this.extra=[],this.casePick=null,this.preview=null,this.previewTimer=0,this.busy=!1,this.error="",this.notice="",this.tileStatus={},this.drifts={},this.clock=null,this.barrier="none",this.syncStats=null,this.clockPausedAt=0,this.driftSamples={},this.lateSince={},this.resyncAt={},this.resyncs={},this.nudges={},this.groupStartedAt=0,this.lastReport=0,this.seekSentAt={},this.firstPlayAt={},this.startLatency={},this.paused=!1,this.scrubbing=!1,this.position=null,this.exportOpen=!1,this.exportFrom="",this.exportTo="",this.estimate=null,this.exportJob=null,this.exportBusy=!1,this.exportError="",this.onTlHover=e=>{if(!this.cameraId||!g())return;window.clearTimeout(this.previewTimer);const t=e.detail;this.previewTimer=window.setTimeout(()=>{const s=je(this.date,t.minute,this.tz).toISOString().replace(/\.\d{3}Z$/,"Z");this.preview={minute:t.minute,x:t.x,width:t.width,url:ai(this.cameraId,s),failed:!1}},250)},this.onTlHoverEnd=()=>{window.clearTimeout(this.previewTimer),this.preview=null}}connectedCallback(){super.connectedCallback(),g()&&(this.init(),this.ticker=window.setInterval(()=>this.tick(),500))}disconnectedCallback(){super.disconnectedCallback(),window.clearInterval(this.ticker),this.endSession()}updated(e){g()&&e.has("cameraId")&&e.get("cameraId")!==void 0&&this.cams&&this.selectCamera(this.cameraId,!0)}get members(){return[this.cameraId,...this.extra.filter(e=>e!==this.cameraId)]}get groupMode(){return this.extra.filter(e=>e!==this.cameraId).length>0}get masterSession(){return this.groupMode?this.group?.sessions.find(e=>e.camera_id===this.cameraId)??this.group?.sessions[0]??null:this.session}get live(){const e=this.masterSession;return!!e&&!$t.includes(e.state)&&(this.groupMode?!!this.group:!0)}async init(){try{const[e,t]=await Promise.all([Ve(),Pe()]);this.tz=e["time.zone"]??"Asia/Jerusalem",this.cams=t.cameras.filter(n=>n.enabled);const s=this.cams.find(n=>n.id===this.cameraId)??this.cams[0],i=this.at?new Date(this.at):null,a=!!i&&!Number.isNaN(i.getTime());if(this.date=Qe(a?i:new Date,this.tz),s)if(this.cameraId=s.id,this.extraParam&&(this.extra=this.extraParam.split(",").filter(n=>n&&n!==s.id&&this.cams.some(o=>o.id===n)).slice(0,3)),await this.loadRecordings(),a)this.cursor=X(i,this.tz),await this.startAt(i);else{const n=this.rec?.segments.at(-1);this.cursor=n?this.insideLast(n):Math.max(0,X(new Date,this.tz)-5)}}catch(e){this.error=w(e)}}async selectCamera(e,t=!1){!e||!t&&e===this.cameraId||(await this.endSession(),this.cameraId=e,this.extra=this.extra.filter(s=>s!==e),this.error="",this.notice="",await this.loadRecordings())}async setDate(e){if(!e||e===this.date)return;await this.endSession(),this.date=e,await this.loadRecordings();const t=this.rec?.segments.at(-1);this.cursor=t?this.insideLast(t):540}insideLast(e){const t=X(new Date(e.start_at),this.tz),s=X(new Date(e.end_at),this.tz);return Math.max(0,t,s-5)}async loadRecordings(){if(!(!this.cameraId||!this.date)){this.loadingRec=!0,this.rec=null;try{const[e,t,s]=await Promise.all([Ir(this.cameraId,this.date),Wl(this.cameraId,this.date).catch(()=>({events:[]})),Pa(this.cameraId,this.date).catch(()=>({bookmarks:[]}))]);this.rec=e,this.dayEvents=t.events,this.bookmarks=s.bookmarks,this.activeBookmark=null,this.error=""}catch(e){this.error=w(e)}finally{this.loadingRec=!1}}}get markers(){return this.dayEvents.map(e=>({minute:X(new Date(e.occurred_at),this.tz),kind:Kl(e.type),label:`${K[e.type]??e.type}${e.confidence==="inferred"?" (מהקלטה)":""}${e.count>1?` ×${e.count}`:""}`}))}get bookmarkMarkers(){return this.bookmarks.map(e=>({id:e.id,minute:X(new Date(e.from_at),this.tz),endMinute:X(new Date(e.to_at),this.tz),label:`תיק „${e.case_title}”${e.note?` · ${e.note}`:""} · ${Ia[e.preservation]}`,preservation:e.preservation}))}async loadBookmarks(){if(!(!this.cameraId||!this.date))try{this.bookmarks=(await Pa(this.cameraId,this.date)).bookmarks}catch{}}bookmarkAt(e){this.cameraId&&(this.casePick={kind:"clip",camera_id:this.cameraId,...Di(je(this.date,e,this.tz),10,20),note:"סימנייה"})}get segmentsMin(){return this.rec?this.rec.segments.map(e=>{const t=X(new Date(e.start_at),this.tz);let s=X(new Date(e.end_at),this.tz);return s<t&&(s=1440),{startMin:t,endMin:s,kind:e.kind==="continuous"?"continuous":"motion"}}):[]}inRecording(e){return this.segmentsMin.some(t=>e>=t.startMin&&e<=t.endMin)}get limitMinute(){return this.date===Qe(new Date,this.tz)?X(new Date,this.tz):1440}cameraName(e){return this.cams?.find(t=>t.id===e)?.name??e}async startAt(e){if(!(!this.cameraId||this.busy)){this.busy=!0,this.error="",this.notice="",this.scrubbing=!1;try{const t=e.toISOString().replace(/\.\d{3}Z$/,"Z");if(this.groupMode){const s=performance.now(),i=this.group&&this.group.sessions.some(n=>!$t.includes(n.state))?await qd(this.group.id,t):await Zd(this.members,t);this.group=i;for(const n of i.sessions)this.seekSentAt[n.camera_id]=s,delete this.firstPlayAt[n.camera_id];this.session=null,this.position=new Date(i.requested_at);const a=Object.keys(i.missing);a.length&&(this.notice=`ללא הקלטה בזמן הזה: ${a.map(n=>this.cameraName(n)).join(", ")}`)}else{const s=this.session&&!$t.includes(this.session.state)?await Ca(this.session.id,t):await Xi(this.cameraId,t);this.session=s,this.group=null,this.position=new Date(s.requested_at),s.moved_to_next_segment&&(this.notice=`אין הקלטה בזמן שנבחר; הניגון התחיל בקטע הבא (${this.fmt(new Date(s.requested_at))}).`)}if(this.cursor=X(this.position,this.tz),this.paused=!1,this.tileStatus={},this.drifts={},this.resetClock(),!this.isConnected){await this.endSession();return}}catch(t){if(t instanceof xe&&t.body.code==="no_recording")this.notice="אין הקלטה בזמן הזה ובשש השעות שאחריו: פער בכיסוי, לא מדלגים ל־Live.",this.position=e;else if(t instanceof xe&&(t.body.code==="session_over"||t.body.code==="not_found")){this.session=null,this.group=null,this.busy=!1,await this.startAt(e);return}else this.error=w(t)}finally{this.busy=!1}}}async endSession(){const e=this.session,t=this.group;this.session=null,this.group=null,this.tileStatus={},this.drifts={},this.resetClock();try{t?await Kd(t.id):e&&!$t.includes(e.state)&&await ys(e.id)}catch{}}async toggleExtra(e){const t=this.extra.includes(e)?this.extra.filter(i=>i!==e):[...this.extra,e].slice(-3),s=this.currentInstant();await this.endSession(),this.extra=t,s&&await this.startAt(s)}players(){return Array.from(this.renderRoot.querySelectorAll("sw-live-player"))}masterPlayer(){return this.players().find(e=>e.dataset.camera===this.cameraId)??this.players()[0]}currentInstant(){const e=this.masterSession;if(!e)return this.position;if(this.groupMode&&this.clock)return new Date(this.clockNow());const t=new Date(e.requested_at).getTime();return new Date(t+(this.masterPlayer()?.mediaTime??0)*1e3)}tick(){if(!this.masterSession||this.paused||this.scrubbing)return;if(this.groupMode&&this.group){this.tickGroup();return}const t=this.masterPlayer();if(!t||t.status!=="playing")return;const s=this.currentInstant();s&&(this.position=s,this.cursor=X(s,this.tz),t.stale&&t.bufferAhead<.4&&!this.busy&&this.startAt(s))}resetClock(){this.clock=null,this.clockPausedAt=0,this.barrier=this.groupMode?"waiting":"none",this.driftSamples={},this.lateSince={},this.resyncAt={},this.resyncs={},this.nudges={};for(const e of this.players())e.rate=1;this.groupMode&&(this.speed=1),this.syncStats=null,this.groupStartedAt=performance.now(),this.lastReport=0}clockNow(){const e=this.clock;return e.baseMs+((this.paused&&this.clockPausedAt?this.clockPausedAt:performance.now())-e.startedAt)}tickGroup(){const e=this.group,t=performance.now(),s=this.players().map(l=>{const p=l.dataset.camera??"",m=e.sessions.find(f=>f.camera_id===p);return{cid:p,p:l,sess:m,at:m?new Date(m.requested_at).getTime()+l.mediaTime*1e3:NaN}}).filter(l=>l.sess&&!$t.includes(l.sess.state)),i=s.filter(l=>l.p.status==="playing");if(!this.clock){const l=s.length>0&&i.length===s.length,p=t-this.groupStartedAt>12e3&&i.length>0;if(!l&&!p){this.barrier="waiting";return}const m=i.find(f=>f.cid===this.cameraId)??i[0];this.clock={baseMs:m.at,startedAt:t},this.barrier="passed",this.driftSamples={},this.lateSince={}}let a=this.clockNow();if(i.length>=3){const l=i.map(p=>p.at).sort((p,m)=>p-m);a=l[Math.floor(l.length/2)]}else i.length&&(a=(i.find(l=>l.cid===this.cameraId)??i[0]).at);this.clock={baseMs:a,startedAt:t};const n=new Date(a);this.position=n,this.cursor=X(n,this.tz);const o={};for(const l of s){if(l.p.status!=="playing"){o[l.cid]=NaN,this.lateSince[l.cid]||(this.lateSince[l.cid]=t);continue}delete this.lateSince[l.cid];const p=(l.at-a)/1e3;o[l.cid]=p;const m=this.driftSamples[l.cid]??=[];if(m.push(p),m.length>40&&m.shift(),m.length>=2&&Math.abs(p)>.25&&Math.abs(p)<=3){const f=p<0?Math.abs(p)>1?1.15:1.05:Math.abs(p)>1?.85:.95;l.p.rate!==f&&(this.nudges[l.cid]=(this.nudges[l.cid]??0)+1),l.p.rate=f}else(Math.abs(p)<=.25||Math.abs(p)>3)&&(l.p.rate=1);l.cid!==this.cameraId&&m.length>=4&&m.slice(-4).every(f=>Math.abs(f)>3)&&(this.resyncs[l.cid]??0)<2&&t-(this.resyncAt[l.cid]??0)>2e4&&this.resyncMember(l.cid,a)}this.drifts=o,this.syncStats=this.computeSync(s.map(l=>l.cid),t),t-this.lastReport>5e3&&this.syncStats.samples>=4&&(this.lastReport=t,Gd(e.id,this.syncStats).catch(()=>{}))}computeSync(e,t){const s={};let i=null,a=0;for(const p of e){const m=this.driftSamples[p]??[],f=m.length?ac(m):null,v=this.lateSince[p]?t-this.lateSince[p]>8e3:!1;s[p]={p95:f,samples:m.length,last:m.length?m[m.length-1]:null,resyncs:this.resyncs[p]??0,state:v?"late":m.length?"measured":"waiting",latency_ms:this.startLatency[p]??null,nudges:this.nudges[p]??0},a+=m.length,f!==null&&(i=i===null?f:Math.max(i,f))}const n=Object.keys(this.group?.missing??{}),o=Object.values(s).some(p=>p.state==="late"),l=this.barrier!=="passed"||i===null?"waiting":i<=.5?"synced":i<=2?"slight":"out_of_sync";return{p95:i,quality:l,samples:a,partial:n.length>0||o,missing:n,members:s}}async resyncMember(e,t){const s=this.group,i=s?.sessions.find(n=>n.camera_id===e);if(!s||!i||$t.includes(i.state))return;this.resyncAt[e]=performance.now(),this.resyncs[e]=(this.resyncs[e]??0)+1,this.driftSamples[e]=[];const a=Math.min(this.startLatency[e]??4e3,15e3);try{const n=await Ca(i.id,new Date(t+a).toISOString().replace(/\.\d{3}Z$/,"Z"));this.group===s&&(this.group={...s,sessions:s.sessions.map(o=>o.id===n.id?n:o)}),this.seekSentAt[e]=performance.now(),delete this.firstPlayAt[e]}catch{}}syncLabel(){const e=this.syncStats;if(this.barrier==="waiting"||!e||e.quality==="waiting")return"סנכרון: ממתין לחסם הפתיחה";const t=e.p95===null?"—":`${e.p95.toFixed(2)} ש׳`;return`סנכרון: ${{synced:"מסונכרן",slight:"סטייה קלה",out_of_sync:"לא מסונכרן",waiting:""}[e.quality]} · p95 ${t}${e.partial?" · חלקי":""}`}async onSeek(e){const t=e.detail.minute,s=je(this.date,t,this.tz);if(s.getTime()>Date.now()){this.notice="לא ניתן לנגן זמן עתידי.",this.scrubbing=!1;return}this.cursor=t,e.detail.alt&&this.bookmarkAt(t),await this.startAt(s)}onScrub(e){this.scrubbing=!0,this.cursor=e.detail.minute,this.position=je(this.date,e.detail.minute,this.tz)}async nudge(e){const t=this.currentInstant();t&&await this.startAt(new Date(t.getTime()+e*1e3))}setSpeed(e){if(this.groupMode||e>1)return;this.speed=e;const t=this.masterPlayer();t&&(t.rate=e)}stepFrame(e){const t=this.masterPlayer(),s=this.cams?.find(n=>n.id===this.cameraId),i=s?.stream?.fps&&s.stream.fps>0?s.stream.fps:25;if(!t)return;if(!t.stepFrame(e,i)){this.notice="הפריים המבוקש מחוץ למאגר שכבר הגיע מה־NVR — השתמש בקפיצה של 10 שניות או בציר הזמן.";return}this.notice="";const a=this.currentInstant();a&&(this.position=a,this.cursor=X(a,this.tz))}togglePause(){const e=this.players();if(e.length){if(this.paused){const t=this.masterPlayer();if(!this.groupMode&&t?.stale&&this.position){this.startAt(this.position);return}e.forEach(s=>s.resume()),this.clock&&this.clockPausedAt&&(this.clock={...this.clock,startedAt:this.clock.startedAt+(performance.now()-this.clockPausedAt)}),this.clockPausedAt=0}else e.forEach(t=>t.pause()),this.clockPausedAt=performance.now();this.paused=!this.paused}}onTilePlayer(e,t){if(this.tileStatus={...this.tileStatus,[e]:t.detail.status},t.detail.status==="playing"&&this.seekSentAt[e]&&!this.firstPlayAt[e]&&(this.firstPlayAt[e]=performance.now(),this.startLatency[e]=this.firstPlayAt[e]-this.seekSentAt[e]),e===this.cameraId){if(this.masterSession&&t.detail.status==="playing"&&(this.session&&(this.session={...this.session,state:"playing"}),!this.groupMode&&this.speed!==1)){const s=this.masterPlayer();s&&s.rate!==this.speed&&(s.rate=this.speed)}if(t.detail.status==="ended"){const s=this.currentInstant(),i=this.masterSession;s&&i&&new Date(i.playback_end_at).getTime()-s.getTime()<5e3&&this.startAt(new Date(new Date(i.playback_end_at).getTime()+1e3))}}}fmt(e){return new Intl.DateTimeFormat("he-IL",{timeZone:this.tz,hour:"2-digit",minute:"2-digit",second:"2-digit",hourCycle:"h23"}).format(e)}openExport(){const e=Math.floor(this.cursor*60)/60;this.exportFrom=ss(Math.max(0,e-1)),this.exportTo=ss(Math.min(this.limitMinute,e+1)),this.estimate=null,this.exportJob=null,this.exportError="",this.exportOpen=!0}exportRange(){const e=je(this.date,wi(this.exportFrom),this.tz),t=je(this.date,wi(this.exportTo),this.tz);return t.getTime()<=e.getTime()?(this.exportError="זמן הסיום חייב להיות אחרי ההתחלה.",null):[e.toISOString().replace(/\.\d{3}Z$/,"Z"),t.toISOString().replace(/\.\d{3}Z$/,"Z")]}async runEstimate(){const e=this.exportRange();if(e){this.exportBusy=!0,this.exportError="";try{this.estimate=await Yd(this.cameraId,e[0],e[1])}catch(t){this.exportError=w(t)}finally{this.exportBusy=!1}}}async runExport(){const e=this.exportRange();if(e){this.exportBusy=!0,this.exportError="";try{this.exportJob=await Jd(this.cameraId,e[0],e[1])}catch(t){this.exportError=w(t)}finally{this.exportBusy=!1}}}renderExportDialog(){const e=this.estimate,t=this.exportJob;return r`<sw-dialog ?open=${this.exportOpen} heading="ייצוא קטע" subheading=${`${this.cameraName(this.cameraId)} · ${this.date} · ${this.tz}`} @close=${()=>this.exportOpen=!1}>
      <div class="dlg">
        ${t?r`<div class="est"><strong>עבודת הייצוא נוצרה</strong><span>${t.files.length} קבצים · משוער ${Ht(t.estimate_bytes)} · מצב: ${t.state}</span><span>ההתקדמות וההורדה במסך "ייצוא".</span></div>`:r`
              <div class="row">
              ...
              ${e?r`<div class="est">
                    <span>${e.files} קבצי NVR בטווח · נפח משוער ${Ht(e.estimate_bytes)} (מקסימום ${Ht(e.max_bytes)}) · כיסוי ${e.coverage==="complete"?"מלא":"חלקי"}</span>
      ...
      <div class="stage">
        ...
        <div class="bar"><div class="inner">
          ...
          <span class="sep"></span>
          ${[.25,.5,1,2,4].map(o=>{const l=(t?.capabilities.supported_speeds??[1]).includes(o),p=this.masterPlayer()?.transport==="mse",m=o===1||!this.groupMode&&l&&(o>1||p),f=m?o<1?"הילוך איטי: המאגר מתמלא בזמן אמת ונצרך לאט יותר — זמן המקור נשאר מדויק":"":this.groupMode?"בסנכרון רב־מצלמות נתמך רק 1×":o>1?"לא נתמך במסלול הזה: הזרם מגיע מה־NVR בזמן אמת; מהירות מוגברת דורשת מקור ששולח מהר מזמן אמת":"הילוך איטי זמין רק בנתיב MSE";return r`<button class="q ${this.speed===o?"on":""}" data-speed=${o} ?disabled=${!m} title=${f} @click=${()=>this.setSpeed(o)}>${o}×</button>`})}
          <span class="sep"></span>
      ...
      <div class="tlwrap">
        ...
        ${this.preview?r`<div class="tlpreview" data-tl-preview style="left:${Math.max(104,Math.min(this.preview.width-104,this.preview.x))}px">
              ...
              <span>${Ye(this.preview.minute)}</span>
            </div>`:c}
      </div>
      <div class="compare">
      ...
      <div class="filters">
        ...
        ${this.activeBookmark?r`<sw-chip selected icon="case" data-bookmark-active @click=${()=>b(`/investigate/cases/${this.activeBookmark.case_id}`)}>תיק „${this.activeBookmark.case_title}”${this.activeBookmark.note?` · ${this.activeBookmark.note}`:""} · ${Ia[this.activeBookmark.preservation]} · פתח</sw-chip>`:c}
        ...
        ${this.error?r`<span class="err">${this.error}</span>`:c}
        <span class="grow"></span>
        <sw-button size="sm" icon="case" data-add-to-case title="סימנייה בנקודה הנוכחית · Alt+לחיצה על הציר מסמנת נקודה אחרת" ?disabled=${!this.cameraId} @click=${()=>this.casePick={kind:"clip",camera_id:this.cameraId,...Di(je(this.date,this.cursor,this.tz))}}>הוסף לתיק</sw-button>
      ...
      <sw-case-picker .item=${this.casePick} subheading=${`${this.cams?.find(o=>o.id===this.cameraId)?.name??""} · ${this.date} ${Ye(this.cursor)}`} @added=${()=>void this.loadBookmarks()} @close=${()=>this.casePick=null}></sw-case-picker>
      <div class="session">
    ...
    `}seekDemo(e){this.cursor=e.detail.minute,this.generation+=1}renderDemo(){const e=q.find(i=>i.id===this.demoCamera)??q[0],t=!js.some(i=>this.cursor>=i.startMin&&this.cursor<=i.endMin),s=Je.filter(i=>i.minuteOfDay<1440).filter(i=>this.filter==="all"||i.type===this.filter).map(i=>({minute:i.minuteOfDay,kind:i.type,label:i.title}));return r`
      <div class="video ${t?"gap":""}">
        ...
        <span class="stamp">2026-09-14 ${ze(this.cursor)}:00 · actual: ${t?"—":ze(this.cursor)}</span>
        <div class="bar"><div class="inner">
      ...
      <sw-timeline .segments=${js} .events=${s} .cursor=${this.cursor} precision="estimated" @seek=${this.seekDemo}></sw-timeline>
      <div class="filters">
    ...
    `}render(){const e=g(),t=e?this.cams?.find(o=>o.id===this.cameraId):q.find(o=>o.id===this.demoCamera)??q[0],s=t?.name??"הקלטות",i=e?`${this.date} ${ss(this.cursor)} · אזור זמן ${this.tz}`:`14.09.2026 ${ze(this.cursor)} · אזור זמן האתר Asia/Jerusalem · נתוני הדגמה`,a=e?"הקלטות":`הקלטות | ${t?.floor??""}`,n=e?Qe(new Date,this.tz):"2026-09-14";return r`
      <sw-page heading=${s} subheading=${i} crumbs=${a} wide>
        <div slot="actions" class="pick">
          ${e?r`<sw-field><select aria-label="מצלמה" @change=${o=>this.selectCamera(o.target.value)}>${(this.cams??[]).map(o=>r`<option value=${o.id} ?selected=${o.id===this.cameraId}>${o.name}</option>`)}</select></sw-field>`:r`<sw-field><select aria-label="מצלמה" @change=${o=>this.demoCamera=o.target.value}>${q.map(o=>r`<option value=${o.id} ?selected=${o.id===this.demoCamera}>${o.name}</option>`)}</select></sw-field>`}
          ...
          <sw-field style="inline-size:132px"><input type="time" step="1" .value=${e?ss(this.cursor):ze(this.cursor)} data-ltr aria-label="שעה" @change=${o=>{const l=o.target.value;if(e)this.onSeek(new CustomEvent("seek",{detail:{minute:wi(l)}}));else{const[p,m]=l.split(":").map(Number);this.cursor=p*60+m,this.generation+=1}}} /></sw-field>
        </div>
  ...
  `;P([u()],I.prototype,"cameraId",2);P([u()],I.prototype,"at",2);P([u()],I.prototype,"extraParam",2);P([d()],I.prototype,"demoCamera",2);P([d()],I.prototype,"cursor",2);P([d()],I.prototype,"generation",2);P([d()],I.prototype,"playing",2);P([d()],I.prototype,"speed",2);P([d()],I.prototype,"filter",2);P([d()],I.prototype,"cams",2);P([d()],I.prototype,"tz",2);P([d()],I.prototype,"date",2);P([d()],I.prototype,"rec",2);P([d()],I.prototype,"dayEvents",2);P([d()],I.prototype,"bookmarks",2);P([d()],I.prototype,"activeBookmark",2);P([d()],I.prototype,"loadingRec",2);P([d()],I.prototype,"session",2);P([d()],I.prototype,"group",2);P([d()],I.prototype,"extra",2);P([d()],I.prototype,"casePick",2);P([d()],I.prototype,"preview",2);P([d()],I.prototype,"busy",2);P([d()],I.prototype,"error",2);P([d()],I.prototype,"notice",2);P([d()],I.prototype,"tileStatus",2);P([d()],I.prototype,"drifts",2);P([d()],I.prototype,"clock",2);P([d()],I.prototype,"barrier",2);P([d()],I.prototype,"syncStats",2);P([d()],I.prototype,"paused",2);P([d()],I.prototype,"scrubbing",2);P([d()],I.prototype,"position",2);P([d()],I.prototype,"exportOpen",2);P([d()],I.prototype,"exportFrom",2);P([d()],I.prototype,"exportTo",2);P([d()],I.prototype,"estimate",2);P([d()],I.prototype,"exportJob",2);P([d()],I.prototype,"exportBusy",2);P([d()],I.prototype,"exportError",2);I=P([k("investigate-playback")],I);var rc=Object.defineProperty,nc=Object.getOwnPropertyDescriptor,bt=(e,t,s,i)=>{for(var a=i>1?void 0:i?nc(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&rc(t,s,a),a};const Ta="sw.sync.recent";function vi(e){const t=s=>String(s).padStart(2,"0");return`${e.getFullYear()}-${t(e.getMonth()+1)}-${t(e.getDate())}T${t(e.getHours())}:${t(e.getMinutes())}:${t(e.getSeconds())}`}let We=class extends ${constructor(){super(...arguments),this.cursor=615,this.playing=!1,this.cams=null,this.picked=[],this.when=vi(new Date(Date.now()-10*6e4)),this.recent=[],this.error=""}connectedCallback(){if(super.connectedCallback(),!!g()){try{this.recent=JSON.parse(localStorage.getItem(Ta)??"[]")}catch{this.recent=[]}this.load()}}async load(){try{const e=await Pe();this.cams=e.cameras.filter(t=>t.enabled&&t.can_view_live!==!1),this.error=""}catch(e){this.error=w(e),this.cams=[]}}toggle(e){this.picked=this.picked.includes(e)?this.picked.filter(t=>t!==e):this.picked.length>=4?this.picked:[...this.picked,e]}launch(e=this.picked,t){if(e.length<2)return;const s=t??new Date(this.when).toISOString(),i={cameras:e,at:s,opened:new Date().toISOString()},a=this.recent.filter(n=>n.cameras.join(",")!==e.join(","));this.recent=[i,...a].slice(0,6);try{localStorage.setItem(Ta,JSON.stringify(this.recent))}catch{}b("/investigate/playback",{camera:e[0],extra:e.slice(1).join(","),t:s})}name(e){return this.cams?.find(t=>t.id===e)?.name??e}renderApi(){const e=this.cams;return r`
        ...
        ${e===null?r`<sw-state-panel state="loading" heading="טוען מצלמות…"></sw-state-panel>`:r`
            <sw-card heading="מצלמות להשוואה" subheading=${`${this.picked.length} מתוך 4 · הראשונה שנבחרת היא המובילה (שעון הייחוס)`}>
              ...
              ${this.picked.length?r`<div class="picks">${this.picked.map((t,s)=>r`<div class="pick" data-sync-pick=${t}>
                    <img src=${Fe(t)} alt="" loading="lazy" @error=${i=>i.target.style.visibility="hidden"} />
            ...
            <sw-card heading="זמן התחלה" subheading="זמן מקומי של הדפדפן; ההקלטה נפתחת מהפריים הקרוב ביותר">
              <div class="transport">
                ...
                <sw-button size="sm" @click=${()=>this.when=vi(new Date(Date.now()-10*6e4))}>לפני 10 דק׳</sw-button>
                <sw-button size="sm" @click=${()=>this.when=vi(new Date(Date.now()-60*6e4))}>לפני שעה</sw-button>
                <span class="grow"></span>
    ...
    `}render(){if(g())return this.renderApi();const e=[{cam:q[0],drift:"+0.2s",state:"recorded"},{cam:q[9],drift:"-0.4s",state:"recorded"},{cam:q[3],drift:"gap",state:"unknown"},{cam:q[1],drift:"buffering",state:"stale"}];return r`
      <sw-page heading="מרכז שליטה" subheading="ניטור חי עם ניגון מסונכרן · 4 מקורות · שעון ייחוס אחד · נתוני הדגמה" wide>
        ...
        <div class="transport">
          <sw-field><input type="datetime-local" value=${`2026-09-14T${ze(this.cursor)}`} data-ltr aria-label="זמן" @change=${t=>{const s=t.target.value.split("T")[1]??"10:15",[i,a]=s.split(":").map(Number);this.cursor=i*60+a}} /></sw-field>
        ...
        <sw-timeline .segments=${js} .events=${Je.slice(0,4).map(t=>({minute:t.minuteOfDay,kind:t.type,label:t.title}))} .cursor=${this.cursor} precision="estimated" @seek=${t=>this.cursor=t.detail.minute}></sw-timeline>
        <div class="filters">
  ...
  `;bt([d()],We.prototype,"cursor",2);bt([d()],We.prototype,"playing",2);bt([d()],We.prototype,"cams",2);bt([d()],We.prototype,"picked",2);bt([d()],We.prototype,"when",2);bt([d()],We.prototype,"recent",2);bt([d()],We.prototype,"error",2);We=bt([k("investigate-sync")],We);var oc=Object.defineProperty,lc=Object.getOwnPropertyDescriptor,de=(e,t,s,i)=>{for(var a=i>1?void 0:i?lc(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&oc(t,s,a),a};const gi=10;function dc(e){return e==="person"||e==="vehicle"||e==="motion"||e==="line"||e==="offline"||e==="door"?e:"motion"}let Q=class extends ${constructor(){super(...arguments),this.floorId="f0",this.at="",this.camera="",this.minute=615,this.tz="Asia/Jerusalem",this.date="",this.tree=null,this.bundle=null,this.events=[],this.recordings=new Map,this.selectedId=null,this.loading=!1,this.error="",this.frameAt="",this.frameFailed=!1,this.casePick=null,this.frameTimer=0}connectedCallback(){super.connectedCallback(),g()&&this.init()}updated(e){g()&&(e.has("floorId")&&e.get("floorId")!==void 0||e.has("at")&&e.get("at")!==void 0)&&this.init()}async init(){this.loading=!0,this.error="";try{const[e,t]=await Promise.all([Ve(),this.tree?Promise.resolve(this.tree):gt()]);if(this.tz=e["time.zone"]??this.tz,this.tree=t,g()&&this.floors.length&&!this.floors.some(i=>i.id===this.floorId)){const i=new URLSearchParams(window.location.hash.split("?")[1]??"").toString();window.location.replace(`#/investigate/floors/${this.floors[0].id}/history${i?`?${i}`:""}`);return}const s=this.at?new Date(this.at):new Date;if(this.date=Qe(s,this.tz),this.minute=X(s,this.tz),this.bundle=await vs(this.floorId,!1,this.instant.toISOString().replace(/\.\d{3}Z$/,"Z")),this.scheduleFrame(),this.camera){const i=this.bundle.anchors.find(a=>a.resource_type==="camera"&&a.resource_id===this.camera);this.selectedId=i?.id??null}await this.loadDay()}catch(e){this.error=w(e)}finally{this.loading=!1}}async loadDay(){const e=this.bundle;if(!e)return;const t=e.anchors.filter(n=>n.resource_type==="camera").map(n=>n.resource_id),[s,i]=await Promise.all([ii({date:this.date,limit:1e3}).then(n=>n.events.filter(o=>o.camera_id&&t.includes(o.camera_id))).catch(()=>[]),Promise.allSettled(t.map(n=>Ir(n,this.date)))]);this.events=s;const a=new Map;t.forEach((n,o)=>{const l=i[o];a.set(n,l.status==="fulfilled"?l.value:null)}),this.recordings=a}get instant(){return je(this.date,this.minute,this.tz)}segmentsFor(e){const t=this.recordings.get(e);return t?t.segments.map(s=>{const i=X(new Date(s.start_at),this.tz);let a=X(new Date(s.end_at),this.tz);return a<i&&(a=1440),{startMin:i,endMin:a,kind:s.kind==="continuous"?"continuous":"motion"}}):null}coverageAt(e){const t=this.segmentsFor(e);if(!t)return{state:"unknown"};const s=t.find(i=>this.minute>=i.startMin&&this.minute<=i.endMin);return s?{state:"historic",segment:s}:{state:"unknown"}}eventsNear(e,t=gi){const s=this.instant.getTime();return this.events.filter(i=>(!e||i.camera_id===e)&&Math.abs(new Date(i.occurred_at).getTime()-s)<=t*60*1e3).sort((i,a)=>Math.abs(new Date(i.occurred_at).getTime()-s)-Math.abs(new Date(a.occurred_at).getTime()-s))}get apiMarkers(){const e=this.bundle;return e?e.anchors.map(t=>{if(t.resource_type==="camera"){const a=this.coverageAt(t.resource_id),n=this.eventsNear(t.resource_id,5).length,o=t.camera?.name??t.label??t.resource_id;return{id:t.id,kind:"camera",label:n?`${o} · ${n} אירועים`:o,x:t.position.x,y:t.position.y,rotation:t.rotation_degrees,fov:t.field_of_view_degrees??void 0,state:a.state}}const s=t.entity?.state_at,i=t.entity?.name??t.label??t.resource_id;return{id:t.id,kind:si(t.layer_id,t.entity?.domain),label:s?.known&&s.state?`${i} · ${ft({...t.entity??{domain:"",unit:null,device_class:null,attributes:{}},state:s.state})}`:i,x:t.position.x,y:t.position.y,state:s?.known?"historic":"unknown"}}):[]}get selectedAnchor(){return this.bundle?.anchors.find(e=>e.id===this.selectedId)??null}get limitMinute(){return this.date===Qe(new Date,this.tz)?X(new Date,this.tz):1440}setMinute(e){this.minute=Math.max(0,Math.min(this.limitMinute,e)),this.scheduleFrame()}scheduleFrame(){window.clearTimeout(this.frameTimer),this.frameTimer=window.setTimeout(()=>{this.frameAt=this.instant.toISOString().replace(/\.\d{3}Z$/,"Z"),this.frameFailed=!1,this.ensureVersion()},600)}async ensureVersion(){const e=this.bundle;if(!e||e.source!=="api"||!e.at)return;const t=this.instant.toISOString().replace(/\.\d{3}Z$/,"Z");if(!(e.history==="current"?!e.historyFrom||t<e.historyFrom:(!e.planPublishedAt||e.planPublishedAt<=t)&&(!e.planArchivedAt||t<e.planArchivedAt)))try{const i=await vs(this.floorId,!1,t),a=e.anchors.map(n=>n.resource_id).sort().join(",");this.bundle=i,this.selectedId&&!i.anchors.some(n=>n.id===this.selectedId)&&(this.selectedId=null),i.anchors.map(n=>n.resource_id).sort().join(",")!==a&&await this.loadDay()}catch{}}renderEntityStates(e){const t=e.anchors.filter(a=>a.resource_type==="ha_entity");if(!t.length)return r`אין ישויות מוצבות בקומה`;const s=t.filter(a=>a.entity?.state_at?.known),i=e.haHistory;return r`${s.length} מתוך ${t.length} ידועות בזמן זה${i?.from?r` <span class="note">(היסטוריה מקומית מ־<span class="ltr">${this.fmtWhen(i.from)}</span>, ${i.retention_days} ימים)</span>`:r` <span class="note">(אין עדיין היסטוריה מקומית)</span>`}
      <div class="evl" style="margin-block-start:4px">${t.slice(0,8).map(a=>{const n=a.entity?.state_at,o=a.entity?.name??a.label??a.resource_id;return r`<div data-history-entity data-known=${n?.known?"true":"false"}><span>${o}</span><span class="note">${n?.known&&n.state?r`${ft({...a.entity??{domain:"",unit:null,device_class:null,attributes:{}},state:n.state})} · מ־<span class="ltr">${n.changed_at?this.fmt(n.changed_at):""}</span>`:r`לא ידוע${n?.reason?` · ${n.reason}`:""}${n?.state?r` <span class="ltr">(אחרון: ${n.state})</span>`:""}`}</span></div>`})}</div>`}fmtWhen(e){return new Intl.DateTimeFormat("he-IL",{timeZone:this.tz,dateStyle:"short",timeStyle:"short"}).format(new Date(e))}setDate(e){this.date=e,this.minute=Math.min(this.minute,this.limitMinute),this.loadDay()}fmt(e){return new Intl.DateTimeFormat("he-IL",{timeZone:this.tz,hour:"2-digit",minute:"2-digit",second:"2-digit",hourCycle:"h23"}).format(new Date(e))}get floors(){return this.tree?.source!=="api"?[]:this.tree.sites.flatMap(e=>(e.buildings??[]).flatMap(t=>(t.floors??[]).map(s=>({id:s.id,name:`${t.name} · ${s.name}`}))))}renderPanel(e){const t=this.selectedAnchor,s=t?.resource_type==="camera"?t:null,i=s?this.coverageAt(s.resource_id):null,a=s?this.recordings.get(s.resource_id):void 0,n=this.eventsNear(void 0,gi),o=this.instant.toISOString().replace(/\.\d{3}Z$/,"Z");return r`<div class="panel">
      <sw-card heading="בנקודת הזמן שנבחרה" subheading="זמן ונתונים מאותו רגע" data-history-panel>
        <dl>
          <dt>זמן</dt><dd><span class="ltr" data-history-time>${this.date} ${Ye(this.minute)}</span> <span class="note">${this.tz}</span></dd>
          <dt>מצלמה נבחרת</dt><dd data-history-camera>${s?s.camera?.name??s.resource_id:"לחץ על מצלמה במפה"}</dd>
          ${s?r`<dt>הקלטה</dt><dd>${a===void 0?"טוען…":a===null?"לא ניתן לבדוק מול ה־NVR":i?.segment?r`יש הקלטה · ${ze(i.segment.startMin)}–${ze(i.segment.endMin)} · ${i.segment.kind==="continuous"?"רציף":"תנועה"}`:"אין הקלטה בזמן זה (פער)"}</dd>
          ...
          ${s&&this.frameAt?r`<dt>פריים</dt><dd><div class="frame" data-history-frame>${this.frameFailed?r`<span>אין פריים בהקלטה בזמן זה</span>`:r`<img src=${ai(s.resource_id,this.frameAt)} alt="פריים מההקלטה בזמן שנבחר" @error=${()=>this.frameFailed=!0} />`}</div></dd>`:c}
        ...
        <div style="display:flex;gap:8px;flex-wrap:wrap;margin-block-start:10px">
          ...
          <sw-button size="sm" icon="case" data-add-to-case ?disabled=${!s} title=${s?"קטע של המצלמה הנבחרת סביב הזמן שנבחר (15 שניות לפני, 45 אחרי)":"בחר מצלמה במפה"} @click=${()=>{s&&(this.casePick={kind:"clip",camera_id:s.resource_id,...Di(this.instant)})}}>הוסף לתיק</sw-button>
        </div>
      </sw-card>
      <sw-case-picker .item=${this.casePick} subheading=${s?`${s.camera?.name??s.resource_id} · ${this.date} ${Ye(this.minute)}`:""} @close=${()=>this.casePick=null}></sw-case-picker>
      <sw-card heading="אירועים סביב הזמן" subheading=${`±${gi} דקות · מצלמות הקומה`}>
        ${n.length?r`<div class="evl" data-history-events>${n.slice(0,8).map(l=>r`<a class=${s&&l.camera_id===s.resource_id?"hit":""} href=${`#/investigate/events/${l.id}`}><span>${K[l.type]??l.type} · ${l.camera_name??l.channel??""}<div class="s">${l.confidence==="inferred"?"נגזר מהקלטה":"התראה מה־NVR"}${l.acked_at?" · טופל":""}</div></span><span class="ltr">${this.fmt(l.occurred_at)}</span></a>`)}</div>`:r`<div class="note">אין אירועים בחלון הזה.</div>`}
      </sw-card>
    </div>`}renderApi(){const e=this.bundle;if(this.error&&!e)return r`<div class="head"><h1>מפה היסטורית</h1></div><sw-state-panel state="error" hint=${this.error}></sw-state-panel>`;if(!e)return r`<div class="head"><h1>מפה היסטורית</h1></div><sw-state-panel state="loading"></sw-state-panel>`;const t=this.selectedAnchor,s=t?.resource_type==="camera"?this.segmentsFor(t.resource_id)??[]:Array.from(this.recordings.keys()).flatMap(a=>this.segmentsFor(a)??[]),i=(t?.resource_type==="camera"?this.events.filter(a=>a.camera_id===t.resource_id):this.events).map(a=>({minute:X(new Date(a.occurred_at),this.tz),kind:dc(a.type),label:`${K[a.type]??a.type}${a.count>1?` ×${a.count}`:""}`}));return r`
      <div class="head">
        <div><h1>המפה בזמן שנבחר · ${e.floorName}</h1><div class="sub">${e.buildingName} · <span class="ltr">${this.date} ${Ye(this.minute)}</span> · ${this.tz}</div></div>
        <span class="grow"></span>
        ${this.floors.length>1?r`<sw-field><select aria-label="קומה" @change=${a=>b(`/investigate/floors/${a.target.value}`,{t:this.instant.toISOString()})}>${this.floors.map(a=>r`<option value=${a.id} ?selected=${a.id===this.floorId}>${Pt(a.name)}</option>`)}</select></sw-field>`:c}
      ...
      <div class="layout">
        <div class="stage">
          ...
          <div class="hist">מצב היסטורי · <span class="ltr">${Ye(this.minute)}</span></div>
      ...
      <div class="tl">
        <div class="tlbar">
          ...
          <span class="time">${this.date} ${Ye(this.minute)}</span>
          ...
          <span class="grow"></span>
          <sw-field><input type="date" .value=${this.date} max=${Qe(new Date,this.tz)} data-ltr aria-label="תאריך" @change=${a=>this.setDate(a.target.value)} /></sw-field>
    ...
    `}get demoMarkers(){const e=i=>i==="cam-3"||this.minute>=190&&this.minute<=205?"unknown":"historic",t=as.filter(i=>i.floorId===this.floorId).map(i=>({id:i.id,kind:"camera",label:i.name,x:i.x,y:i.y,rotation:i.rotation,fov:i.fov,state:i.state==="forbidden"?"forbidden":e(i.id)})),s=Rs.filter(i=>i.floorId===this.floorId).map((i,a)=>({id:i.id,kind:i.domain,label:i.name,x:i.x,y:i.y,state:a%2?"unknown":"historic"}));return[...t,...s]}renderDemo(){const e=ut.find(t=>t.id===this.floorId)??ut[0];return r`
      <div class="head">
        <div><h1>מפה היסטורית · ${Pt(e.name)}</h1><div class="sub">מצב המפה בזמן נבחר · פעולות פיזיות כבויות בחקירה · נתוני הדגמה</div></div>
        <span class="grow"></span>
        <a href="#/explore/floors/${e.id}"><sw-button icon="live">חזרה ל־Live</sw-button></a>
      </div>
      <div class="bar">
        <sw-badge kind="historic"></sw-badge>
        <span class="time">2026-09-14 ${ze(this.minute)}</span>
      ...
      <div class="stage alone">
        <sw-plan-canvas .planWidth=${e.planWidth} .planHeight=${e.planHeight} .plan=${rr(e.id)} .markers=${this.demoMarkers}></sw-plan-canvas>
        <div class="legend"><span>כחול = יש הקלטה בזמן זה</span><span>מקווקו = לא ידוע / פער</span><span>ישות: מצב ידוע אחרון</span></div>
      </div>
    `}render(){return g()?this.renderApi():this.renderDemo()}};Q.styles=x`
    :host {
      display: flex;
      flex-direction: column;
      min-block-size: 100%;
  ...
  `;de([u()],Q.prototype,"floorId",2);de([u()],Q.prototype,"at",2);de([u()],Q.prototype,"camera",2);de([d()],Q.prototype,"minute",2);de([d()],Q.prototype,"tz",2);de([d()],Q.prototype,"date",2);de([d()],Q.prototype,"tree",2);de([d()],Q.prototype,"bundle",2);de([d()],Q.prototype,"events",2);de([d()],Q.prototype,"recordings",2);de([d()],Q.prototype,"selectedId",2);de([d()],Q.prototype,"loading",2);de([d()],Q.prototype,"error",2);de([d()],Q.prototype,"frameAt",2);de([d()],Q.prototype,"frameFailed",2);de([d()],Q.prototype,"casePick",2);Q=de([k("investigate-history-map")],Q);var cc=Object.defineProperty,pc=Object.getOwnPropertyDescriptor,F=(e,t,s,i)=>{for(var a=i>1?void 0:i?pc(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&cc(t,s,a),a};const hc={person:"#2f6bff",vehicle:"#22c55e",motion:"#ef4444",line:"#f59e0b",offline:"#6b7280",door:"#8b5cf6"},Da={"כניסה ראשית":"entrance","חצר אחורית":"backyard",מחסן:"warehouse",לובי:"lobby","חניה מקורה":"parking","מסדרון מזרחי":"corridor"},uc={info:"מידע",alert:"התראה",critical:"קריטי"};let B=class extends ${constructor(){super(...arguments),this.cameraId="",this.date="",this.initialMode="",this.selected=null,this.filter="all",this.cams=null,this.tz="Asia/Jerusalem",this.type="",this.events=null,this.ingest=null,this.live=!1,this.error="",this.busy=!1,this.thumbVersion=new Map,this.player=null,this.mode="raw",this.windows=null,this.windowGap=180,this.windowBy="camera",this.selectedWindow=null,this.windowsBusy=!1,this.facets=null,this.placeFloor="",this.placeZone="",this.source="",this.unsupported=[],this.thumbTimers=new Map,this.thumbInFlight=0,this.rowPreview=null,this.rowPreviewTimer=0,this.windowColumns=[{key:"thumb",label:"",width:"72px",render:e=>this.renderWindowThumb(e)},{key:"title",label:"חלון אירוע",render:e=>{const t=e;return r`<span class="ty" style="--tone:${Ns[t.dominant_type]??"#6b7280"}"><i></i>${K[t.dominant_type]??t.dominant_type}${t.count>1?r` <span class="sub">×${String(t.count)}</span>`:c}</span><div class="sub">${Object.entries(t.types).map(([s,i])=>`${K[s]??s} ${i}`).join(" · ")} · ${t.confidence==="inferred"?"נגזר מהקלטה":"התראות מה־NVR"}</div>`}},{key:"camera_name",label:"מצלמה / קבוצה",render:e=>{const t=e;return r`${t.camera_name??(t.channel?`ערוץ ${t.channel}`:"מערכת")}${t.group&&t.group!=="camera"&&t.camera_names?.length?r`<div class="sub">${t.camera_names.join(" · ")}</div>`:c}`}},{key:"start",label:"זמן",render:e=>{const t=e;return r`${this.fmt(t.start)}${t.end!==t.start?r` – ${this.fmt(t.end)}`:c}<div class="sub">${this.fmtDate(t.start)}</div>`}},{key:"acked",label:"מצב",render:e=>{const t=e;return r`<sw-badge kind=${t.acked?"live":t.acked_count?"stale":"neutral"} label=${t.acked?"טופל":t.acked_count?`בטיפול ${t.acked_count}/${t.count}`:"חדש"}></sw-badge>`}}],this.apiColumns=[{key:"thumb",label:"",width:"72px",render:e=>this.renderThumb(e)},{key:"type",label:"אירוע",render:e=>r`<span class="ty" style="--tone:${Ns[e.type]??"#6b7280"}"><i></i>${K[e.type]??String(e.type)}${Number(e.count)>1?r` <span class="sub">×${String(e.count)}</span>`:c}</span><div class="sub">${e.source==="ha"?"חיישן HA":e.source==="system"?"מערכת":e.confidence==="inferred"?"נגזר מהקלטה":"התראה מה־NVR"} · ${e.acked_at?`טופל · ${String(e.acked_by_username??"")}`:"ממתין לטיפול"}</div>`},{key:"camera_name",label:"מצלמה",render:e=>r`${String(e.camera_name??(e.channel?`ערוץ ${String(e.channel)}`:"מערכת"))}<div class="sub ltr">${String(e.raw_type)}</div>`},{key:"occurred_at",label:"זמן",render:e=>r`${this.fmt(String(e.occurred_at))}<div class="sub">${this.fmtDate(String(e.occurred_at))}${e.ended_at?` · עד ${this.fmt(String(e.ended_at))}`:""}</div>`},{key:"severity",label:"חומרה",render:e=>r`<sw-badge kind=${e.severity==="critical"?"error":e.severity==="alert"?"stale":"neutral"} label=${uc[e.severity]??String(e.severity)}></sw-badge>`}],this.columns=[{key:"thumb",label:"תמונה",width:"80px",render:e=>e.type==="offline"||e.type==="door"?r`<div class="thumb none"><sw-icon name=${e.type==="offline"?"offline":"door"} size=${14}></sw-icon></div>`:r`<sw-scene class="thumb" kind=${Da[String(e.camera)]??"lobby"}></sw-scene>`},{key:"title",label:"אירוע",render:e=>r`<span class="ty" style="--tone:${hc[e.type]}"><i></i>${_i[e.type]}</span><div class="sub">${String(e.title)} · ${e.acked?"טופל":"ממתין לטיפול"}</div>`},{key:"camera",label:"מצלמה",render:e=>r`${String(e.camera)}<div class="sub">${String(e.floor)}</div>`},{key:"time",label:"זמן",render:e=>r`${String(e.time)}<div class="sub ltr">${String(e.source)}</div>`},{key:"severity",label:"חומרה",render:e=>r`<sw-badge kind=${e.severity==="critical"?"error":e.severity==="alert"?"stale":"neutral"} label=${{info:"מידע",alert:"התראה",critical:"קריטי"}[e.severity]}></sw-badge>`},{key:"more",label:"",width:"40px",render:()=>r`<sw-button variant="ghost" size="sm" iconOnly icon="more" label="עוד"></sw-button>`}]}connectedCallback(){super.connectedCallback(),g()&&(this.init(),this.unsubscribe=Gl(e=>this.onPushed(e),(e,t)=>{this.live=t,e&&(this.ingest=e)}))}disconnectedCallback(){super.disconnectedCallback(),this.unsubscribe?.();for(const e of this.thumbTimers.values())window.clearTimeout(e);this.thumbTimers.clear(),this.stopPlayer()}hoverStart(e,t){if(!e.camera_id||t.pointerType==="touch")return;window.clearTimeout(this.rowPreviewTimer);const s=t.clientX,i=t.clientY;this.rowPreviewTimer=window.setTimeout(()=>{const a=new Date(e.occurred_at).getTime(),n=[-5,0,5].map(o=>{const l=new Date(a+o*1e3).toISOString().replace(/\.\d{3}Z$/,"Z");return{at:l,url:ai(e.camera_id,l),label:o===0?this.fmt(e.occurred_at):`${o>0?"+":""}${o} ש׳`,failed:!1}});this.rowPreview={id:e.id,x:s,y:i,frames:n,camera:e.camera_name??""}},250)}hoverEnd(){window.clearTimeout(this.rowPreviewTimer),this.rowPreview=null}renderRowPreview(){const e=this.rowPreview;if(!e)return c;const t=Math.max(16,Math.min(window.innerWidth-388,e.x-186)),s=e.y+18+230>window.innerHeight?e.y-18-230:e.y+18;return r`<div class="rowpreview" data-row-preview style="left:${t}px;top:${s}px">
      <div class="strip">
      ...
      <div class="wlist" data-window-events>
        ${t.map(s=>r`<a class="wrow" href=${`#/investigate/events/${s.id}`}><span class="ty" style="--tone:${Ns[s.type]??"#6b7280"}"><i></i>${K[s.type]??s.type}</span><span class="ltr">${this.fmt(s.occurred_at)}</span><span class="sub">${s.acked_at?"טופל":"ממתין"}</span></a>`)}
    ...
    </sw-drawer>`}onPushed(e){if(!this.events)return;const t=Qe(new Date(e.occurred_at),this.tz);if(this.date&&t!==this.date||this.cameraId&&e.camera_id!==this.cameraId||this.type&&e.type!==this.type)return;const s=this.cams?.find(n=>n.id===e.camera_id)?.name??null,i={...e,camera_name:e.camera_name??s};(e.thumbnail==="ready"||e.thumbnail==="unavailable")&&(this.cancelPoll(e.id),e.thumbnail==="ready"&&(this.thumbVersion=new Map(this.thumbVersion).set(e.id,Date.now())));const a=this.events.findIndex(n=>n.id===e.id);this.events=a>=0?this.events.map((n,o)=>o===a?{...n,...i}:n):[i,...this.events]}fmt(e){return new Intl.DateTimeFormat("he-IL",{timeZone:this.tz,hour:"2-digit",minute:"2-digit",second:"2-digit",hourCycle:"h23"}).format(new Date(e))}fmtDate(e){return new Intl.DateTimeFormat("he-IL",{timeZone:this.tz,day:"2-digit",month:"2-digit"}).format(new Date(e))}async ack(e){this.busy=!0;try{const t=await $r(e.id);this.events=(this.events??[]).map(s=>s.id===e.id?{...s,...t}:s)}catch(t){this.error=w(t)}finally{this.busy=!1}}renderApi(){if(this.error&&!this.events)return r`<sw-state-panel state="error" hint=${this.error} actionLabel="נסה שוב" @action=${()=>this.init()}></sw-state-panel>`;if(!this.events)return r`<sw-state-panel state="loading"></sw-state-panel>`;const e=this.events.find(i=>i.id===this.selected)??null,t=this.ingest,s=this.events.filter(i=>!i.acked_at).length;return r`
      ...
      <div class="filters">
        ...
        <sw-field><select aria-label="סוג" @change=${i=>{this.type=i.target.value,this.load()}}><option value="" ?selected=${!this.type}>כל סוגי האירועים</option>${Object.keys(K).map(i=>r`<option value=${i} ?selected=${i===this.type}>${K[i]}</option>`)}</select></sw-field>
        ...
        <sw-field><select aria-label="מקור" data-filter-source @change=${i=>{this.source=i.target.value,this.load()}}><option value="" ?selected=${!this.source}>כל המקורות</option>${Object.entries(_a).map(([i,a])=>r`<option value=${i} ?selected=${i===this.source}>${a}</option>`)}</select></sw-field>
        <span class="grow"></span>
      ...
      <div class="stage">
        ${this.mode==="windows"?this.windows===null||this.windowsBusy&&!this.windows.length?r`<sw-state-panel state="loading"></sw-state-panel>`:this.windows.length?r`<div class="banner" style="margin-block-end:8px"><sw-icon name="info" size=${14}></sw-icon><span>${this.windowBy==="camera"?"התראות סמוכות באותה מצלמה":this.windowBy==="all"?"התראות סמוכות מכל המצלמות":this.windowBy==="zone"?"התראות סמוכות באותו חדר":"התראות סמוכות באותה קומה"} הופכות לחלון אירוע אחד (מרווח עד ${Math.round(this.windowGap/60)} דק׳). האירועים המקוריים נשמרים לצפייה.</span><span class="grow"></span>
                  <sw-field><select aria-label="קיבוץ" data-window-by @change=${i=>{this.windowBy=i.target.value,this.loadWindows()}}>${Object.keys(ka).map(i=>r`<option value=${i} ?selected=${this.windowBy===i}>${ka[i]}</option>`)}</select></sw-field>
        ...
        ${e?r`<sw-drawer open heading=${K[e.type]??e.type} subheading=${`${e.camera_name??(e.channel?`ערוץ ${e.channel}`:"מערכת")} · ${this.fmt(e.occurred_at)}`} @close=${()=>this.closeDrawer()}>
              <div class="big">
                ${this.player?.eventId===e.id&&this.player.session?r`<sw-live-player .wsUrl=${Us(this.player.session)} mode="mse" .retry=${!1}></sw-live-player>`:e.thumbnail==="ready"?r`<img src=${zt(e.id,this.thumbVersion.get(e.id)??0)} alt="תמונת האירוע מההקלטה" />`:r`<div class="hint">${e.camera_id?e.thumbnail==="unavailable"?"אין פריים זמין בהקלטה בזמן האירוע":this.player?.eventId===e.id?"פותח את ההקלטה…":"מכין תמונה מההקלטה…":"אירוע ללא מצלמה"}</div>`}
    ...
    `}renderDemo(){const e=Je.filter(s=>this.filter==="all"||!s.acked),t=Je.find(s=>s.id===this.selected);return r`
      <div class="filters">
        ...
        <span class="grow"></span>
        <sw-chip ?selected=${this.filter==="all"} @click=${()=>this.filter="all"} count=${Je.length}>הכל</sw-chip>
        <sw-chip ?selected=${this.filter==="unacked"} @click=${()=>this.filter="unacked"} count=${Je.filter(s=>!s.acked).length}>ללא טיפול</sw-chip>
      </div>
      <div class="stage">
        <sw-table .columns=${this.columns} .rows=${e} .selected=${this.selected} @row-select=${s=>this.selected=s.detail.id}></sw-table>
        ${t?r`<sw-drawer open heading=${_i[t.type]} subheading=${`${t.camera} · ${t.time}`} @close=${()=>this.selected=null}>
              <div class="preview">${t.type==="offline"||t.type==="door"?"אין תמונה לאירוע זה":r`<sw-scene kind=${Da[t.camera]??"lobby"}></sw-scene><span class="demo">דמו · תמונת אירוע מה־NVR (T044)</span>`}</div>
              <dl>
  ...
  `;F([u()],B.prototype,"cameraId",2);F([u()],B.prototype,"date",2);F([u()],B.prototype,"initialMode",2);F([d()],B.prototype,"selected",2);F([d()],B.prototype,"filter",2);F([d()],B.prototype,"cams",2);F([d()],B.prototype,"tz",2);F([d()],B.prototype,"type",2);F([d()],B.prototype,"events",2);F([d()],B.prototype,"ingest",2);F([d()],B.prototype,"live",2);F([d()],B.prototype,"error",2);F([d()],B.prototype,"busy",2);F([d()],B.prototype,"thumbVersion",2);F([d()],B.prototype,"player",2);F([d()],B.prototype,"mode",2);F([d()],B.prototype,"windows",2);F([d()],B.prototype,"windowGap",2);F([d()],B.prototype,"windowBy",2);F([d()],B.prototype,"selectedWindow",2);F([d()],B.prototype,"windowsBusy",2);F([d()],B.prototype,"facets",2);F([d()],B.prototype,"placeFloor",2);F([d()],B.prototype,"placeZone",2);F([d()],B.prototype,"source",2);F([d()],B.prototype,"unsupported",2);F([d()],B.prototype,"rowPreview",2);B=F([k("investigate-events")],B);var mc=Object.defineProperty,fc=Object.getOwnPropertyDescriptor,we=(e,t,s,i)=>{for(var a=i>1?void 0:i?fc(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&mc(t,s,a),a};const wc={measured:"recorded",inferred:"unknown",command:"partial",availability:"stale"},Oa={alertstream:"אירוע NVR",recording:"נגזר מהקלטה",system:"מערכת",ha:"חיישן HA"},Ra=600*1e3;let le=class extends ${constructor(){super(...arguments),this.eventId="",this.ev=null,this.error="",this.tz="Asia/Jerusalem",this.session=null,this.playerError="",this.bundle=null,this.nearby=[],this.corr=null,this.corrError="",this.route=null,this.busy=!1,this.thumbVersion=0,this.casePick=null,this.pollTimer=0}connectedCallback(){super.connectedCallback(),this.load()}disconnectedCallback(){super.disconnectedCallback(),window.clearTimeout(this.pollTimer),this.stopPlayer()}updated(e){e.has("eventId")&&e.get("eventId")!==void 0&&this.load()}async load(){if(g()){this.error="",await this.stopPlayer();try{const e=await ql(this.eventId);this.ev=e,this.tz=e.timezone||this.tz,e.location?.has_plan?this.loadMap(e.location.floor_id):this.bundle=null,this.loadNearby(e),this.loadCorrelation(e.id),this.loadRoute(e.id),e.camera_id&&this.play(e),e.thumbnail==="pending"&&this.pollThumb(e.id)}catch(e){this.error=w(e),this.ev=null}}}async loadRoute(e){this.route=null;try{this.route=await Ql(e)}catch{this.route=null}}renderRoute(){const e=this.route;return!e||!e.spatial?c:r`<sw-card heading="המשך מסלול מוצע" subheading="השערה לפי טופולוגיית המפה · ±${Math.round((new Date(e.window.to).getTime()-new Date(e.window.from).getTime())/1e3)} שניות" style="margin-block-start:12px" data-route>
    ...
    </sw-card>`}async loadCorrelation(e){this.corr=null,this.corrError="";try{this.corr=await Jl(e)}catch(t){this.corrError=w(t)}}async loadMap(e){try{this.bundle=await vs(e)}catch{this.bundle=null}}async loadNearby(e){try{const t=new Date(e.occurred_at).getTime(),s=a=>new Date(a).toISOString().replace(/\.\d{3}Z$/,"Z"),i=await ii({from:s(t-Ra),to:s(t+Ra),limit:30});this.nearby=i.events.filter(a=>a.id!==e.id).slice(0,6)}catch{this.nearby=[]}}pollThumb(e){window.clearTimeout(this.pollTimer),this.pollTimer=window.setTimeout(async()=>{const t=await xr(e).catch(()=>"unavailable");this.ev?.id===e&&(t==="pending"?this.pollThumb(e):(this.ev={...this.ev,thumbnail:t},t==="ready"&&(this.thumbVersion=Date.now())))},1500)}async play(e){if(e.camera_id){this.playerError="";try{const t=new Date(new Date(e.occurred_at).getTime()-2e3).toISOString().replace(/\.\d{3}Z$/,"Z"),s=await Xi(e.camera_id,t);this.ev?.id===e.id?this.session=s:await ys(s.id).catch(()=>{})}catch(t){this.playerError=w(t)}}}async stopPlayer(){const e=this.session;this.session=null,e&&await ys(e.id).catch(()=>{})}async ack(){const e=this.ev;if(!(!e||e.acked_at)){this.busy=!0;try{const t=await $r(e.id);this.ev={...e,acked_at:t.acked_at,acked_by_username:t.acked_by_username}}catch(t){this.error=w(t)}finally{this.busy=!1}}}fmt(e,t=!1){const s=new Date(e),i=new Intl.DateTimeFormat("he-IL",{timeZone:this.tz,hour:"2-digit",minute:"2-digit",second:"2-digit",hourCycle:"h23"}).format(s);return t?`${new Intl.DateTimeFormat("he-IL",{timeZone:this.tz,day:"2-digit",month:"2-digit",year:"numeric"}).format(s)} · ${i}`:i}renderCorrelation(){const e=this.corr,t=e?`±${e.window_s} שניות · ${e.spatial?`סביבת ${e.location?.zone??"המיקום על התוכנית"} (${e.location?.floor_name??""})`:"לפי זמן בלבד"}`:this.corrError?"לא נטען":"טוען…";return r`<sw-card heading="קורלציה דלת–מצלמה–חיישן" subheading=${t} style="margin-block-start:12px" data-correlation>
      ${e?r`${e.entities.length?r`<div class="note" style="margin:0 0 6px" data-correlation-entities>בסביבה: ${e.entities.map(s=>`${s.name}${s.state_missing?" (ללא מצב)":s.state?` · ${s.state}`:""}`).join(" · ")}</div>`:r`<div class="note" style="margin:0 0 6px" data-correlation-entities>אין חיישנים או מנעולים מוצבים בסביבה.</div>`}
            ${e.links.length?r`<div class="corr" data-correlation-links>${e.links.map(s=>r`<div class="link" data-correlation-link data-certainty=${s.certainty}>
                    ...
                    <sw-badge kind=${wc[s.certainty]} label=${Yl[s.certainty]}></sw-badge>
        ...
        <div class="layout">
          <div>
            <div class="player" data-player>
              ${this.session?r`<sw-live-player .wsUrl=${Us(this.session)} mode="mse" .retry=${!1}></sw-live-player>`:e.thumbnail==="ready"?r`<img src=${zt(e.id,this.thumbVersion)} alt="תמונת האירוע מההקלטה" />`:r`<div class="hint">${e.camera_id?this.playerError?`ההקלטה לא נפתחה: ${this.playerError}`:e.thumbnail==="unavailable"?"אין הקלטה זמינה בזמן האירוע":"פותח את ההקלטה…":"אירוע ללא מצלמה — אין וידאו"}</div>`}
          ...
          <div>
            <sw-card heading="הקשר האירוע" data-context>
              <dl class="meta">
                ...
                <dt>מקור</dt><dd>${Oa[e.source]??e.source}${e.camera_id?r` / ${s}`:c} <span class="note" style="margin:0">raw <span class="ltr">${e.raw_type}</span></span></dd>
            ...
            <sw-card heading="אירועים קרובים" subheading="±10 דקות סביב האירוע" style="margin-block-start:12px">
              ${this.nearby.length?r`<div class="nearby">${this.nearby.map(o=>r`<a href=${`#/investigate/events/${o.id}`}><span>${K[o.type]??o.type} · ${o.camera_name??(o.channel?`ערוץ ${o.channel}`:"מערכת")}</span><span class="ltr">${this.fmt(o.occurred_at)}</span></a>`)}</div>`:r`<div class="note" style="margin:0">אין אירועים נוספים בחלון הזה.</div>`}
            </sw-card>
          </div>
        </div>
  ...
  `;we([u()],le.prototype,"eventId",2);we([d()],le.prototype,"ev",2);we([d()],le.prototype,"error",2);we([d()],le.prototype,"tz",2);we([d()],le.prototype,"session",2);we([d()],le.prototype,"playerError",2);we([d()],le.prototype,"bundle",2);we([d()],le.prototype,"nearby",2);we([d()],le.prototype,"corr",2);we([d()],le.prototype,"corrError",2);we([d()],le.prototype,"route",2);we([d()],le.prototype,"busy",2);we([d()],le.prototype,"thumbVersion",2);we([d()],le.prototype,"casePick",2);le=we([k("investigate-event-detail")],le);var vc=Object.getOwnPropertyDescriptor,gc=(e,t,s,i)=>{for(var a=i>1?void 0:i?vc(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=o(a)||a);return a};const bc=[{id:"rv-1",title:"כניסה ראשית · 10:12–10:16",primary:"כניסה ראשית",scene:"entrance",related:["לובי"],events:3,severity:"alert",status:"חדש"},{id:"rv-2",title:"חצר אחורית · 09:40–09:44",primary:"חצר אחורית",scene:"backyard",related:[],events:2,severity:"info",status:"בבדיקה"},{id:"rv-3",title:"חניה מקורה · 06:41–06:45",primary:"חניה מקורה",scene:"parking",related:["כניסה ראשית"],events:1,severity:"alert",status:"טופל"},{id:"rv-4",title:"לובי · אתמול 23:08–23:12",primary:"לובי",scene:"lobby",related:[],events:4,severity:"info",status:"false positive"}];let Oi=class extends ${render(){return r`
  ...
  `;Oi=gc([k("investigate-reviews")],Oi);var yc=Object.defineProperty,$c=Object.getOwnPropertyDescriptor,L=(e,t,s,i)=>{for(var a=i>1?void 0:i?$c(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&yc(t,s,a),a};const xc={open:"stale",in_review:"recorded",closed:"neutral"},kc={preserved:"recorded",preserving:"partial",nvr_only:"stale",missing:"error",unknown:"unknown",none:"neutral"},_c=(e,t)=>new Intl.DateTimeFormat("he-IL",{timeZone:t,dateStyle:"short",timeStyle:"short"}).format(new Date(e)),zc=[{key:"title",label:"תיק",render:e=>r`<strong>${String(e.title)}</strong>${e.tags?r`<div style="font-size:11px;color:var(--sw-text-3)">${String(e.tags)}</div>`:c}`},{key:"status",label:"סטטוס",render:e=>r`<sw-badge kind=${xc[e.status]} label=${ls[e.status]}></sw-badge>`},{key:"owner",label:"בעלים"},{key:"items",label:"פריטים"},{key:"preserved",label:"עותקים שמורים",render:e=>r`${String(e.preserved)} מתוך ${String(e.clips)}`},{key:"updated",label:"עודכן",ltr:!0,render:e=>_c(String(e.updated))}],Sc=[{key:"title",label:"תיק",render:e=>r`<strong>${String(e.title)}</strong>`},{key:"status",label:"סטטוס",render:e=>r`<sw-badge kind=${e.status==="פתוח"?"stale":e.status==="סגור"?"neutral":"recorded"} label=${String(e.status)}></sw-badge>`},{key:"owner",label:"בעלים"},{key:"clips",label:"קטעים"},{key:"notes",label:"הערות"},{key:"preserved",label:"ראיות שמורות",render:e=>r`${e.preserved} שמורות${Number(e.missing)?r` · <span style="color:var(--sw-danger)">${e.missing} חסרות</span>`:""}`},{key:"more",label:"",width:"40px",render:()=>r`<sw-button variant="ghost" size="sm" iconOnly icon="more" label="עוד"></sw-button>`}];let ye=class extends ${constructor(){super(...arguments),this.cases=[],this.canManage=!1,this.loading=!1,this.error="",this.status="all",this.q="",this.creating=!1,this.newTitle="",this.newDesc="",this.newTags="",this.busy=!1,this.qTimer=0}connectedCallback(){super.connectedCallback(),g()&&this.load()}async load(){this.loading=!0,this.error="";try{const e=await Mr({status:this.status==="all"?void 0:this.status,q:this.q||void 0});this.cases=e.cases,this.canManage=e.can_manage}catch(e){this.error=w(e)}finally{this.loading=!1}}setStatus(e){this.status=e,this.load()}onQuery(e){this.q=e,window.clearTimeout(this.qTimer),this.qTimer=window.setTimeout(()=>void this.load(),250)}async create(){if(this.newTitle.trim()){this.busy=!0,this.error="";try{const e=await Ar({title:this.newTitle.trim(),description:this.newDesc,tags:this.newTags.split(",").map(t=>t.trim()).filter(Boolean)});this.creating=!1,this.newTitle=this.newDesc=this.newTags="",b(`/investigate/cases/${e.id}`)}catch(e){this.error=w(e)}finally{this.busy=!1}}}renderApi(){const e=this.cases.map(t=>({id:t.id,title:t.title,status:t.status,owner:t.owner_username,items:t.counts.items,clips:t.counts.events+t.counts.clips,preserved:t.counts.preserved,updated:t.updated_at,tags:t.tags.join(" · ")}));return r`
      <sw-page heading="תיקים" subheading="קישור להקלטה אינו שימור: ראיה נחשבת שמורה רק אחרי העתקה מאומתת מה־NVR">
        ...
        <div class="bar">
          ${["all","open","in_review","closed"].map(t=>r`<sw-chip ?selected=${this.status===t} @click=${()=>this.setStatus(t)}>${t==="all"?"הכל":ls[t]}</sw-chip>`)}
          <span class="grow"></span>
        ...
        ${this.error?r`<div class="err">${this.error}</div>`:c}
        ${this.loading&&!this.cases.length?r`<sw-state-panel state="loading"></sw-state-panel>`:this.cases.length?r`<sw-table data-cases-table .columns=${zc} .rows=${e} @row-select=${t=>b(`/investigate/cases/${t.detail.id}`)}></sw-table>`:r`<sw-state-panel state="empty" heading="אין תיקים עדיין" hint="פתח תיק מדף אירוע, מהנגן או מהמפה ההיסטורית (הוסף לתיק), או כאן."></sw-state-panel>`}
    ...
    `}render(){return g()?this.renderApi():r`
      <sw-page heading="תיקים" subheading="קישור להקלטה אינו שימור: ראיה נחשבת שמורה רק אחרי העתקה מאומתת ו־hash · נתוני הדגמה">
        ...
        <sw-table .columns=${Sc} .rows=${Si} @row-select=${e=>b(`/investigate/cases/${e.detail.id}`)}></sw-table>
      </sw-page>
    `}};ye.styles=x`
    .bar {
      display: flex;
  ...
  `;L([d()],ye.prototype,"cases",2);L([d()],ye.prototype,"canManage",2);L([d()],ye.prototype,"loading",2);L([d()],ye.prototype,"error",2);L([d()],ye.prototype,"status",2);L([d()],ye.prototype,"q",2);L([d()],ye.prototype,"creating",2);L([d()],ye.prototype,"newTitle",2);L([d()],ye.prototype,"newDesc",2);L([d()],ye.prototype,"newTags",2);L([d()],ye.prototype,"busy",2);ye=L([k("investigate-cases")],ye);let J=class extends ${constructor(){super(...arguments),this.caseId="case-1",this.tab="details",this.data=null,this.error="",this.info="",this.busy=!1,this.tz="Asia/Jerusalem",this.noteText="",this.editing=!1,this.editTitle="",this.editDesc="",this.editTags="",this.confirmDelete=!1,this.bundles=[],this.verifyResult=null,this.cams=[],this.snapCam="",this.loadedFor="",this.pollTimer=0}updated(e){e.has("caseId")&&g()&&this.loadedFor!==this.caseId&&this.load()}disconnectedCallback(){super.disconnectedCallback(),window.clearTimeout(this.pollTimer)}async load(){const e=this.caseId;this.loadedFor=e,this.error="";try{const[t,s]=await Promise.all([Ve(),Ed(e)]);this.tz=t["time.zone"]??this.tz,this.data=s,this.bundles=(await Ld(e).catch(()=>({bundles:[]}))).bundles,this.cams.length||(this.cams=(await Pe().catch(()=>({cameras:[]}))).cameras.filter(i=>i.enabled),!this.snapCam&&this.cams[0]&&(this.snapCam=this.cams[0].id)),window.clearTimeout(this.pollTimer),s.items.some(i=>i.preservation==="preserving")&&(this.pollTimer=window.setTimeout(()=>void this.load(),5e3))}catch(t){this.error=w(t)}}fmt(e){return new Intl.DateTimeFormat("he-IL",{timeZone:this.tz,dateStyle:"short",timeStyle:"medium"}).format(new Date(e))}async run(e,t=""){this.busy=!0,this.error="";try{await e(),this.info=t,await this.load(),t&&setTimeout(()=>this.info="",4e3)}catch(s){this.error=w(s),s instanceof xe&&s.status===409&&await this.load()}finally{this.busy=!1}}patchCase(e){const t=this.data;t&&this.run(async()=>{await Cd(t.id,{revision:t.revision,...e})})}async verify(e){if(e){this.verifyResult=null,this.busy=!0,this.error="";try{this.verifyResult=await jd(e)}catch(t){this.error=w(t)}finally{this.busy=!1}}}renderBundleCard(e){const t=this.verifyResult;return r`<sw-card heading="חבילת ראיות" subheading="ZIP עם הקטעים השמורים, התמונות, ההערות, manifest עם SHA-256 לכל קובץ ודוח קריא" data-bundle>
      ${e.can_manage?r`<sw-button size="sm" variant="primary" icon="download" data-bundle-create ?disabled=${this.busy} @click=${()=>void this.run(async()=>{await Bd(e.id)},'החבילה נוצרה; פריטים שאינם עותק שמור מופיעים בה כ"לא נכללו"')}>צור חבילת ראיות</sw-button>`:c}
      ${this.bundles.length?r`<div class="items" style="margin-block-start:8px">${this.bundles.map(s=>r`<div class="item" data-bundle-row style="grid-template-columns:minmax(0,1fr) auto"><div class="body"><strong class="ltr">${s.name}</strong><span class="meta">${Ht(s.bytes)} · ${this.fmt(s.created_at)}${s.signed?` · חתום · מפתח ${s.signed}`:" · ללא חתימה"}</span></div><div class="acts"><a href=${Hd(e.id,s.name)} download><sw-button size="sm" icon="download">הורדה</sw-button></a></div></div>`)}</div>`:r`<div class="hint" style="margin-block-start:6px">עדיין לא נוצרה חבילה לתיק הזה.</div>`}
    ...
    </sw-card>`}renderItem(e,t){const s=e.kind==="event"?`אירוע · ${K[e.event?.type??"other"]??e.event?.type??""}`:e.kind==="clip"?"קטע הקלטה":e.kind==="snapshot"?"תמונה":"הערה",i=e.preservation,a=e.kind==="event"&&e.event?e.event.occurred_at:e.from_at,n=e.kind==="note"?r`<div class="thumb"><sw-icon name="edit" size=${18}></sw-icon></div>`:e.kind==="snapshot"?r`<img class="thumb" src=${Vd(t.id,e.id)} alt="תמונה מהמצלמה" />`:e.kind==="event"&&e.event?.thumbnail==="ready"&&e.event_id?r`<img class="thumb" src=${zt(e.event_id)} alt="" />`:e.camera_id&&a?r`<img class="thumb" src=${ai(e.camera_id,a)} alt="" @error=${o=>o.target.style.visibility="hidden"} />`:r`<div class="thumb"></div>`;return r`<div class="item" data-case-item data-kind=${e.kind} data-preservation=${i}>
      ${n}
      <div class="body">
        <div class="head"><strong>${s}</strong>${e.camera_name?r`<span>· ${e.camera_name}</span>`:c}${i!=="none"?r`<sw-badge kind=${kc[i]} label=${Pd[i]}></sw-badge>`:c}</div>
      ...
      <div class="acts">
        ...
        ${t.can_manage&&e.kind!=="note"&&(i==="nvr_only"||i==="unknown")?r`<sw-button size="sm" icon="download" data-item-preserve ?disabled=${this.busy} @click=${()=>void this.run(()=>Od(t.id,e.id).then(()=>{}),"עבודת שימור נוצרה; הפריט יסומן כשמור כשההעתקה תסתיים")}>שמור עותק</sw-button>`:c}
        ${e.export?.download_ready?r`<a href=${Er(e.export.id)} download><sw-button size="sm" variant="ghost" icon="download">הורדה</sw-button></a>`:c}
        ${t.can_manage?r`<sw-button size="sm" variant="ghost" iconOnly icon="close" label="הסר מהתיק" data-item-remove ?disabled=${this.busy} @click=${()=>void this.run(()=>Dd(t.id,e.id).then(()=>{}))}></sw-button>`:c}
      </div>
      ...
      <sw-page heading=${e.title} subheading=${`${ls[e.status]} · בעלים: ${e.owner_username} · ${t.items} פריטים · ${t.preserved} עותקים שמורים · עודכן ${this.fmt(e.updated_at)}`} crumbs="חקירה | תיקים" wide>
        ${e.can_manage?r`<sw-field slot="actions"><select aria-label="סטטוס" data-case-status ?disabled=${this.busy} @change=${s=>this.patchCase({status:s.target.value})}>${Object.keys(ls).map(s=>r`<option value=${s} ?selected=${s===e.status}>${ls[s]}</option>`)}</select></sw-field>
        ...
        <div class="wrap">
          ...
          <sw-card heading="ראיות והערות" subheading=${e.checked?"מצב השימור נבדק מול ה־NVR עכשיו":"מצב השימור לא נבדק מול ה־NVR"}>
            ...
            ${e.can_manage&&e.status!=="closed"?r`<div class="composer"><sw-field label="הערה חדשה"><textarea rows="2" data-note-text .value=${this.noteText} @input=${s=>this.noteText=s.target.value}></textarea></sw-field><sw-button size="sm" icon="plus" data-note-add ?disabled=${this.busy||!this.noteText.trim()} @click=${()=>void this.run(async()=>{await Ti(e.id,{kind:"note",note:this.noteText.trim()}),this.noteText=""})}>הוסף הערה</sw-button></div>
                  <div class="composer"><sw-field label="תמונה ממצלמה לתיק (עותק שמור מיידי)"><select aria-label="מצלמה לצילום" data-snapshot-camera @change=${s=>this.snapCam=s.target.value}>${this.cams.map(s=>r`<option value=${s.id} ?selected=${s.id===this.snapCam}>${s.name}</option>`)}</select></sw-field><sw-button size="sm" icon="camera" data-snapshot-add ?disabled=${this.busy||!this.snapCam} @click=${()=>void this.run(async()=>{await Ti(e.id,{kind:"snapshot",camera_id:this.snapCam})},"התמונה נשמרה בתיק עם ה־hash שלה")}>צלם תמונה לתיק</sw-button></div>`:c}
          </sw-card>
        ...
        ${this.confirmDelete?r`<sw-dialog open heading="מחיקת תיק" subheading="הפריטים בתיק יימחקו; ההקלטות ב־NVR והעותקים שיוצאו נשארים" @close=${()=>this.confirmDelete=!1}>
              ...
              <sw-button slot="footer" variant="danger" icon="trash" data-case-delete-confirm ?disabled=${this.busy} @click=${()=>{this.confirmDelete=!1,this.run(async()=>{await Td(e.id),b("/investigate/cases")})}}>מחק תיק</sw-button>
            </sw-dialog>`:c}
      </sw-page>
    `}render(){if(g())return this.renderApi();const e=Si.find(t=>t.id===this.caseId)??Si[0];return r`
  ...
  `;L([u()],J.prototype,"caseId",2);L([d()],J.prototype,"tab",2);L([d()],J.prototype,"data",2);L([d()],J.prototype,"error",2);L([d()],J.prototype,"info",2);L([d()],J.prototype,"busy",2);L([d()],J.prototype,"tz",2);L([d()],J.prototype,"noteText",2);L([d()],J.prototype,"editing",2);L([d()],J.prototype,"editTitle",2);L([d()],J.prototype,"editDesc",2);L([d()],J.prototype,"editTags",2);L([d()],J.prototype,"confirmDelete",2);L([d()],J.prototype,"bundles",2);L([d()],J.prototype,"verifyResult",2);L([d()],J.prototype,"cams",2);L([d()],J.prototype,"snapCam",2);J=L([k("investigate-case-detail")],J);var Mc=Object.defineProperty,Ac=Object.getOwnPropertyDescriptor,ri=(e,t,s,i)=>{for(var a=i>1?void 0:i?Ac(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&Mc(t,s,a),a};const Na={queued:"ממתין",running:"מוריד",done:"הושלם",partial:"חלקי",failed:"נכשל",cancelled:"בוטל",interrupted:"הופסק"},Ic={queued:"neutral",running:"live",done:"recorded",partial:"partial",failed:"error",cancelled:"unknown",interrupted:"stale"};let qt=class extends ${constructor(){super(...arguments),this.jobs=null,this.ffmpeg=!0,this.error=""}connectedCallback(){super.connectedCallback(),g()&&(this.load(),this.timer=window.setInterval(()=>this.poll(),3e3))}disconnectedCallback(){super.disconnectedCallback(),window.clearInterval(this.timer)}async load(){try{const e=await Xd();this.jobs=e.jobs,this.ffmpeg=e.ffmpeg,this.error=""}catch(e){this.error=w(e)}}poll(){this.jobs?.some(e=>e.state==="queued"||e.state==="running")&&this.load()}fmt(e,t){return new Intl.DateTimeFormat("he-IL",{timeZone:t,day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit",second:"2-digit",hourCycle:"h23"}).format(new Date(e))}async cancel(e){try{await Qd(e.id),await this.load()}catch(t){this.error=w(t)}}async removeJob(e){try{await ec(e.id),await this.load()}catch(t){this.error=w(t)}}renderApi(){return this.error&&!this.jobs?r`<sw-state-panel state="error" hint=${this.error} actionLabel="נסה שוב" @action=${()=>this.load()}></sw-state-panel>`:this.jobs?this.jobs.length?r`
      ...
      <sw-card>
        ${this.jobs.map(e=>{const t=Math.round((e.progress??0)*100),s=e.files.filter(i=>i.state==="downloaded"||i.state==="remuxed").length;return r`<div class="job">
            <div>
              <div class="title"><strong>${e.camera_name}</strong><sw-badge kind=${Ic[e.state]} label=${Na[e.state]}></sw-badge></div>
              <div class="meta"><span class="ltr">${this.fmt(e.requested_from,e.timezone)} → ${this.fmt(e.requested_to,e.timezone)}</span> · ${e.files.length} קבצים (${s} ירדו) · משוער ${Ht(e.estimate_bytes)}${e.actual_from?r` · בפועל <span class="ltr">${this.fmt(e.actual_from,e.timezone)} → ${this.fmt(e.actual_to??e.actual_from,e.timezone)}</span>`:c}</div>
            ...
            <div><div class="bar ${e.state==="failed"?"fail":e.state==="partial"?"partial":""}"><i style="inline-size:${t}%"></i></div><div class="meta">${Na[e.state]} · ${t}%${e.state==="running"?` · ${Ht(e.files.reduce((i,a)=>i+a.bytes,0))}`:""}</div></div>
            <div class="actions">
              ${e.download_ready?r`<a href=${Er(e.id)} download=${e.output_name??""}><sw-button size="sm" icon="download">הורדה</sw-button></a><a href=${tc(e.id)} target="_blank" rel="noopener"><sw-button size="sm" variant="ghost" icon="list">מניפסט</sw-button></a>`:c}
  ...
  `;ri([d()],qt.prototype,"jobs",2);ri([d()],qt.prototype,"ffmpeg",2);ri([d()],qt.prototype,"error",2);qt=ri([k("investigate-exports")],qt);const Pc={zone:"חדר / אזור",camera:"מצלמה",floor:"קומה",building:"מבנה",entity:"ישות HA"},Ec={zone:"map",camera:"camera",floor:"floor",building:"building",entity:"light"},Cc=(e,t=8)=>z(`search?q=${encodeURIComponent(e)}&limit=${t}`),Tc=(e,t=30)=>z(`search/semantic?q=${encodeURIComponent(e)}&limit=${t}`),Dc=()=>z("search/providers"),Oc={person:"אדם",vehicle:"רכב",motion:"תנועה",door:"דלת",line:"חציית קו",field:"חדירה"};var Rc=Object.defineProperty,Nc=Object.getOwnPropertyDescriptor,Nt=(e,t,s,i)=>{for(var a=i>1?void 0:i?Nc(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&Rc(t,s,a),a};const Bc=[{scene:"entrance",when:"14.09.2026 10:14",cam:"כניסה ראשית",why:"NVR: זיהוי אדם (Smart)"},{scene:"lobby",when:"14.09.2026 10:13",cam:"לובי",why:"NVR: תנועה + סמיכות במפה לכניסה"},{scene:"parking",when:"14.09.2026 06:43",cam:"חניה מקורה",why:"NVR: חציית קו"},{scene:"entrance",when:"14.09.2026 08:12",cam:"כניסה ראשית",why:"HA: דלת נפתחה + תנועה"},{scene:"corridor",when:"13.09.2026 23:10",cam:"מסדרון מזרחי",why:"NVR: זיהוי אדם"},{scene:"backyard",when:"13.09.2026 18:03",cam:"חצר אחורית",why:"NVR: תנועה"}];let st=class extends ${constructor(){super(...arguments),this.by="person",this.q="",this.answer=null,this.providers=null,this.busy=!1,this.error=""}connectedCallback(){super.connectedCallback(),g()&&this.loadProviders()}async loadProviders(){try{this.providers=await Dc()}catch(e){this.error=w(e)}}async run(){const e=this.q.trim();if(e){this.busy=!0,this.error="";try{this.answer=await Tc(e)}catch(t){this.error=w(t)}finally{this.busy=!1}}}fmt(e){try{return new Date(e).toLocaleString("he-IL",{day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit"})}catch{return e}}renderApi(){const e=this.answer,t=this.providers,s=t?.providers.find(n=>n.id==="local"),i=t?.providers.find(n=>n.id==="external"),a={person:"אדם",vehicle:"רכב",motion:"תנועה",line:"חציית קו",field:"חדירה",door:"דלת",offline:"ניתוק",coverage_gap:"פער כיסוי",other:"אחר"};return r`
      <sw-page heading="חיפוש AI" subheading="שאלה חופשית → מסננים של מרכז האירועים (סוג, מקום, זמן) · baseline מקומי ללא רשת · ספק חיצוני רק ב־opt-in">
        ...
        <div class="wrap">
          ...
          ${e?r`<sw-card heading="כך פורשה השאלה" subheading=${`${e.provider.name} · ${e.provider.model_version} · ללא רשת`} data-semantic-parsed>
                  <div class="chips">
                    ${e.parsed.objects.map(n=>r`<sw-chip selected icon="target">${Oc[n]??n}</sw-chip>`)}
    ...
    `}render(){return g()?this.renderApi():r`
      <sw-page heading="חיפוש AI" subheading="מצא בדיוק את מה שאתה מחפש · חיפוש סמנטי רק עם אינדקס אמיתי · נתוני הדגמה">
        ...
        <div class="wrap">
          ...
          <div class="results">
            ${Bc.map(e=>r`<div class="res" @click=${()=>window.location.hash="#/investigate/playback"}><div class="pic"><sw-scene kind=${e.scene}></sw-scene><span class="demo">דמו</span></div><div class="cap">${e.when}<small>${e.cam} · ${e.why}</small></div></div>`)}
          </div>
        </div>
      </sw-page>
    `}};st.styles=x`
  ...
  `;Nt([d()],st.prototype,"by",2);Nt([d()],st.prototype,"q",2);Nt([d()],st.prototype,"answer",2);Nt([d()],st.prototype,"providers",2);Nt([d()],st.prototype,"busy",2);Nt([d()],st.prototype,"error",2);st=Nt([k("investigate-search")],st);const Lc=()=>({name:"",description:"",enabled:!0,owner:"local",ha_automation_id:null,trigger:{types:[],sources:[],severity_min:"info"},scope:{site_ids:[],building_ids:[],floor_ids:[],zone_ids:[],camera_ids:[],entity_ids:[]},window:{days:[],from:null,to:null},cooldown_s:300,actions:[{kind:"notify",message:""}]}),Hc=()=>z("rules"),Vc=e=>A("rules",e),Ba=(e,t)=>Le(`rules/${e}`,t),jc=e=>he(`rules/${e}`),La=(e,t=24)=>A("rules/dry-run",{rule:e,hours:t}),Fc=(e=!1)=>z(`rules/alerts${e?"?unacked=true":""}`),Uc=e=>A(`rules/alerts/${e}/ack`),Ha={mon:"ב׳",tue:"ג׳",wed:"ד׳",thu:"ה׳",fri:"ו׳",sat:"ש׳",sun:"א׳"},Wc={alertstream:"התראת NVR",recording:"נגזר מהקלטה",system:"מערכת",ha:"חיישן HA"};var Zc=Object.defineProperty,qc=Object.getOwnPropertyDescriptor,ie=(e,t,s,i)=>{for(var a=i>1?void 0:i?qc(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&Zc(t,s,a),a};const Va={"r-1":{icon:"user",bg:"#eaf0ff",fg:"#2f6bff"},"r-2":{icon:"move",bg:"#e8f8ee",fg:"#16a34a"},"r-3":{icon:"door",bg:"#fff4e0",fg:"#d97706"},"r-4":{icon:"offline",bg:"#fdecec",fg:"#ef4444"}};let se=class extends ${constructor(){super(...arguments),this.tab="rules",this.rules=[],this.alerts=[],this.unacked=0,this.meta={types:[],sources:[],days:[]},this.error="",this.busy=!1,this.loading=!1,this.editing=null,this.dry=null,this.dryBusy=!1,this.tree=null,this.cams=[],this.zones=[],this.confirmDelete=null,this.tz="Asia/Jerusalem"}connectedCallback(){super.connectedCallback(),g()&&this.load()}async load(){this.loading=!0,this.error="";try{const[e,t]=await Promise.all([Hc(),Fc()]);if(this.rules=e.rules,this.meta={types:e.types,sources:e.sources,days:e.days},this.alerts=t.alerts,this.unacked=t.unacked,!this.tree){const[s,i]=await Promise.all([gt(),Pe()]);this.tree=s,this.cams=i.cameras.filter(a=>a.enabled)}}catch(e){this.error=w(e)}finally{this.loading=!1}}fmt(e){return e?new Intl.DateTimeFormat("he-IL",{timeZone:this.tz,dateStyle:"short",timeStyle:"short"}).format(new Date(e)):"—"}get floors(){return(this.tree?.sites??[]).flatMap(e=>(e.buildings??[]).flatMap(t=>(t.floors??[]).map(s=>({id:s.id,name:`${t.name} · ${s.name}`}))))}async run(e){this.busy=!0,this.error="";try{await e(),await this.load()}catch(t){this.error=w(t),t instanceof xe&&t.status===409&&await this.load()}finally{this.busy=!1}}openEditor(e){if(this.dry=null,this.zones=[],e){const{id:t,revision:s,alerts:i,created_by_username:a,updated_by_username:n,created_at:o,updated_at:l,last_fired_at:p,...m}=e;this.editing={id:t,revision:s,body:JSON.parse(JSON.stringify(m))},m.scope.floor_ids.length===1&&this.loadZones(m.scope.floor_ids[0])}else this.editing={id:null,revision:0,body:Lc()}}async loadZones(e){try{this.zones=(await Uo(e)).zones}catch{this.zones=[]}}edit(e){if(!this.editing)return;const t=JSON.parse(JSON.stringify(this.editing.body));e(t),this.editing={...this.editing,body:t}}toggleIn(e,t){const s=e.indexOf(t);s>=0?e.splice(s,1):e.push(t)}async dryRun(){if(this.editing){this.dryBusy=!0,this.error="";try{this.dry=this.editing.id?await La({...this.editing.body},24):await La(this.editing.body,24)}catch(e){this.error=w(e)}finally{this.dryBusy=!1}}}save(){const e=this.editing;!e||!e.body.name.trim()||this.run(async()=>{e.id?await Ba(e.id,{...e.body,revision:e.revision}):await Vc(e.body),this.editing=null,this.dry=null})}summary(e){const t=e.trigger.types.length?e.trigger.types.map(a=>K[a]??a).join(", "):"כל הסוגים",s=e.scope.floor_ids.length||e.scope.zone_ids.length||e.scope.camera_ids.length||e.scope.building_ids.length||e.scope.site_ids.length?[e.scope.floor_ids.length?`${e.scope.floor_ids.length} קומות`:"",e.scope.zone_ids.length?`${e.scope.zone_ids.length} אזורים`:"",e.scope.camera_ids.length?`${e.scope.camera_ids.length} מצלמות`:""].filter(Boolean).join(" · "):"כל המתקן",i=e.window.from||e.window.to||e.window.days.length?`${e.window.days.map(a=>Ha[a]??a).join("")||"כל יום"} ${e.window.from??"00:00"}–${e.window.to??"24:00"}`:"תמיד";return`${t} · ${s} · ${i} · השהיה ${e.cooldown_s} שנ׳ · ${e.owner==="ha"?`בבעלות HA (${e.ha_automation_id})`:"התראה במערכת"}`}renderEditor(){const e=this.editing;if(!e)return c;const t=e.body,s=this.dry;return r`<sw-dialog open heading=${e.id?"עריכת חוק":"חוק חדש"} subheading="Trigger → היקף → חלון זמן → השהיה → התראה במערכת · הרצה יבשה לפני שמירה" data-rule-dialog @close=${()=>this.editing=null}>
      ${this.error?r`<div class="err">${this.error}</div>`:c}
      <sw-field label="שם"><input data-rule-name .value=${t.name} @input=${i=>this.edit(a=>a.name=i.target.value)} /></sw-field>
      <sw-field label="סוגי אירועים (ריק = הכל)"><div class="chips">${this.meta.types.map(i=>r`<sw-chip data-rule-type=${i} ?selected=${t.trigger.types.includes(i)} @click=${()=>this.edit(a=>this.toggleIn(a.trigger.types,i))}>${K[i]??i}</sw-chip>`)}</div></sw-field>
      <sw-field label="מקורות (ריק = הכל)"><div class="chips">${this.meta.sources.map(i=>r`<sw-chip ?selected=${t.trigger.sources.includes(i)} @click=${()=>this.edit(a=>this.toggleIn(a.trigger.sources,i))}>${Wc[i]??i}</sw-chip>`)}</div></sw-field>
      <div class="two">
      ...
      <sw-field label="ימים (ריק = כל יום)"><div class="chips">${this.meta.days.map(i=>r`<sw-chip ?selected=${t.window.days.includes(i)} @click=${()=>this.edit(a=>this.toggleIn(a.window.days,i))}>${Ha[i]??i}</sw-chip>`)}</div></sw-field>
      <div class="two">
      ...
      ${s?r`<div class="dry">${[...s.would_fire.map(i=>({...i,fire:!0})),...s.suppressed.map(i=>({...i,fire:!1}))].sort((i,a)=>i.occurred_at.localeCompare(a.occurred_at)).slice(0,40).map(i=>r`<div class="dryrow" data-dryrun-row data-fire=${i.fire?"true":"false"}><span class="ltr">${this.fmt(i.occurred_at)}</span><span>${K[i.type]??i.type} · ${i.camera_name??"—"}</span><span class="hint">${i.fire?i.reasons.join(" · "):`נחסם: ${i.suppressed}`}</span></div>`)}${s.would_fire.length+s.suppressed.length>40?r`<div class="hint">מוצגות 40 הראשונות</div>`:c}<div class="hint">${s.note}</div></div>`:c}
      ...
      <sw-page heading="התראות וחוקי אוטומציה" subheading="Trigger → היקף → חלון זמן → השהיה → התראה במערכת · הרצה יבשה לפני הפעלה · אין פקודות למכשירים">
        ...
        ${this.tab==="rules"?this.loading&&!this.rules.length?r`<sw-state-panel state="loading"></sw-state-panel>`:this.rules.length?r`<div class="list">${this.rules.map(e=>r`<sw-card flush class="rule" data-rule-row data-rule-id=${e.id} style="--bg:#eaf0ff;--fg:#2f6bff">
                    ...
                    <sw-toggle ?checked=${e.enabled} ?disabled=${this.busy||e.owner==="ha"} labelHidden label="פעיל" data-rule-toggle @change=${t=>void this.run(async()=>{const{id:s,revision:i,alerts:a,created_by_username:n,updated_by_username:o,created_at:l,updated_at:p,last_fired_at:m,...f}=e;await Ba(s,{...f,enabled:t.detail.checked,revision:i})})}></sw-toggle>
                  ...
                  ${e.acked_at?r`<span class="last">טופל · ${e.acked_by_username??""}</span>`:r`<sw-button size="sm" icon="check" data-alert-ack ?disabled=${this.busy} @click=${()=>void this.run(async()=>{await Uc(e.id)})}>סמן כטופל</sw-button>`}
        ...
        ${this.confirmDelete?r`<sw-dialog open heading="מחיקת חוק" subheading=${this.confirmDelete.name} @close=${()=>this.confirmDelete=null}>
              ...
              <sw-button slot="footer" variant="danger" icon="trash" data-rule-delete-confirm @click=${()=>{const e=this.confirmDelete;this.confirmDelete=null,this.run(async()=>{await jc(e.id)})}}>מחק</sw-button>
            </sw-dialog>`:c}
      </sw-page>
    `}render(){return g()?this.renderApi():r`
      <sw-page heading="התראות וחוקי אוטומציה" subheading="Trigger → היקף → תנאים → פעולה · בדיקה יבשה לפני הפעלה · נתוני הדגמה">
        ...
        <sw-tabs .items=${[{id:"rules",label:"חוקים",count:Mi.length},{id:"notif",label:"התראות"},{id:"sched",label:"לוחות זמנים"},{id:"trig",label:"Triggers"}]} .active=${this.tab} @change=${e=>this.tab=e.detail.id}></sw-tabs>
        ${this.tab==="rules"?r`<div class="list">
              ${Mi.map(e=>{const t=Va[e.id]??Va["r-1"];return r`<sw-card flush class="rule" style="--bg:${t.bg};--fg:${t.fg}">
  ...
  `;ie([d()],se.prototype,"tab",2);ie([d()],se.prototype,"rules",2);ie([d()],se.prototype,"alerts",2);ie([d()],se.prototype,"unacked",2);ie([d()],se.prototype,"meta",2);ie([d()],se.prototype,"error",2);ie([d()],se.prototype,"busy",2);ie([d()],se.prototype,"loading",2);ie([d()],se.prototype,"editing",2);ie([d()],se.prototype,"dry",2);ie([d()],se.prototype,"dryBusy",2);ie([d()],se.prototype,"tree",2);ie([d()],se.prototype,"cams",2);ie([d()],se.prototype,"zones",2);ie([d()],se.prototype,"confirmDelete",2);se=ie([k("investigate-rules")],se);let Ws=class extends ${constructor(){super(...arguments),this.ruleId="r-1"}render(){const e=Mi.find(t=>t.id===this.ruleId)??{name:"חוק חדש",trigger:"זיהוי אדם",scope:"חוץ",action:"התראה"};return r`
  ...
  `;ie([u()],Ws.prototype,"ruleId",2);Ws=ie([k("investigate-rule-editor")],Ws);const Kc=()=>z("identity/users"),Gc=()=>A("identity/sync"),Ds=()=>z("access/roles"),Yc=e=>A("access/bindings",e),Jc=e=>he(`access/bindings/${e}`),Xc=()=>z("access/groups"),Qc=e=>A("access/groups",{name:e}),ep=e=>he(`access/groups/${e}`),tp=(e,t)=>Yt(`access/groups/${e}/members`,{user_ids:t}),sp=e=>A("access/preview",e),ja=(e={})=>{const t=new URLSearchParams;e.prefix&&t.set("prefix",e.prefix),e.actor&&t.set("actor",e.actor),e.resourceId&&t.set("resource_id",e.resourceId),e.limit&&t.set("limit",String(e.limit));const s=t.toString();return z(`audit${s?`?${s}`:""}`)},Fa={verified:"מסונכרן",stale:"סנכרון מיושן",removed:"מושבת / נמחק ב־HA",unavailable:"לא בספריית HA",unknown:"טרם סונכרן",dev:"משתמש פיתוח"},ip={"rbac.bind":"שיוך תפקיד","rbac.unbind":"ביטול שיוך","rbac.group_create":"יצירת קבוצה","rbac.group_members":"שינוי חברי קבוצה","rbac.group_delete":"מחיקת קבוצה","rbac.bootstrap_admin":"מנהל ראשון (bootstrap)","identity.user_disabled":"משתמש הושבת (HA)","identity.user_enabled":"משתמש הופעל (HA)","identity.sync":"סנכרון ספרייה"};function lt(e){if(!e)return"—";const t=new Date(e);return Number.isNaN(t.getTime())?e:t.toLocaleString("he-IL",{dateStyle:"short",timeStyle:"short"})}const ap=e=>A("access/roles",e),rp=(e,t)=>Le(`access/roles/${e}`,t),np=e=>he(`access/roles/${e}`),op=e=>A("access/roles/preview",e),lp=e=>Yt("access/delegation",{delegable_roles:e});var dp=Object.defineProperty,cp=Object.getOwnPropertyDescriptor,Z=(e,t,s,i)=>{for(var a=i>1?void 0:i?cp(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&dp(t,s,a),a};const pp=[{id:"users",label:"משתמשים",count:zi.length},{id:"groups",label:"קבוצות",count:nr.length},{id:"roles",label:"תפקידים",count:or.length},{id:"effective",label:"הרשאות אפקטיביות"},{id:"audit",label:"אודיט הרשאות"}];let W=class extends ${constructor(){super(...arguments),this.tab="users",this.selected=null,this.assigning=!1,this.step=0,this.directory=null,this.roles=null,this.groups=null,this.tree=null,this.audit=null,this.selectedGroup=null,this.wizard=null,this.members=null,this.newGroup="",this.preview=null,this.previewUser="",this.previewScope="installation:*",this.busy=!1,this.error="",this.message="",this.forbidden=!1,this.roleEdit=null,this.roleImpact=null,this.roleDelete=null,this.roleImpactTimer=0,this.userColumns=[{key:"name",label:"שם",render:e=>r`<div class="who"><sw-avatar name=${String(e.name)} size=${30}></sw-avatar><div><strong>${String(e.name)}</strong>${e.haAdmin?r` <sw-badge kind="neutral" label="מנהל HA · מידע בלבד"></sw-badge>`:""}<div class="ltr sub">${String(e.haUser)}@ha.local</div></div></div>`},{key:"role",label:"תפקיד",render:e=>{const t=e.bindings[0];return t?r`<span class="pillsel">${t.role}<sw-icon name="chevronDown" size=${11}></sw-icon></span>`:r`<span class="pillsel" style="color:var(--sw-text-3)">ללא שיוך<sw-icon name="chevronDown" size=${11}></sw-icon></span>`}},{key:"scope",label:"היקף גישה",render:e=>{const t=e.bindings[0];return t?r`<span class="pillsel">${t.scope}<sw-icon name="chevronDown" size=${11}></sw-icon></span>`:r`<span class="sub">—</span>`}},{key:"active",label:"מצב",render:e=>r`<span class="status ${e.active?"":"off"}"><i></i>${e.active?"פעיל":"מושבת ב־HA"}</span>`},{key:"lastSync",label:"סנכרון"},{key:"more",label:"",width:"40px",render:()=>r`<sw-button variant="ghost" size="sm" iconOnly icon="more" label="עוד"></sw-button>`}]}connectedCallback(){super.connectedCallback(),g()&&this.load()}async load(){this.error="";try{const[e,t,s,i]=await Promise.all([Kc(),Ds(),Xc(),gt()]);this.directory=e,this.roles=t,this.groups=s.groups,this.tree=i,this.forbidden=!1,this.previewUser||(this.previewUser=mt.me?.user.id??"")}catch(e){const t=w(e);this.error=t,this.forbidden=/403|הרשאה|forbidden/i.test(t)&&!this.directory}}async loadAudit(){try{const[e,t]=await Promise.all([ja({prefix:"rbac.",limit:100}),ja({prefix:"identity.",limit:50})]);this.audit=[...e.rows,...t.rows].sort((s,i)=>s.at<i.at?1:-1).slice(0,150)}catch(e){this.error=w(e),this.audit=[]}}flash(e){this.message=e,setTimeout(()=>this.message="",3500)}get scopeOptions(){const e=[{type:"installation",id:"*",name:"כל ההתקנה"}];for(const t of this.tree?.sites??[]){e.push({type:"site",id:t.id,name:`אתר · ${t.name}`});for(const s of t.buildings??[]){e.push({type:"building",id:s.id,name:`${t.name} · ${s.name}`});for(const i of s.floors??[])e.push({type:"floor",id:i.id,name:`${t.name} · ${s.name} · ${i.name}`})}}return e}userName(e){return this.directory?.users.find(t=>t.id===e)?.name??e}label(e){return this.roles?.labels[e]??e}startWizard(e,t,s){this.wizard={subjectKind:e,subjectId:t,subjectName:s,roleId:"viewer",scopeKey:"installation:*"}}async saveWizard(){const e=this.wizard;if(!e)return;const[t,s]=e.scopeKey.split(":");this.busy=!0,this.error="";try{const i=await Yc({subject_kind:e.subjectKind,subject_id:e.subjectId,role_id:e.roleId,scope_type:t,scope_id:s});this.flash(`שויך: ${i.role_name} · ${i.scope_name} (רוויזיה ${i.revision})`),this.wizard=null,await this.load()}catch(i){this.error=w(i)}finally{this.busy=!1}}async revoke(e){this.busy=!0,this.error="";try{await Jc(e.id),this.flash(`בוטל: ${e.role_name} · ${e.scope_name}`),await this.load()}catch(t){this.error=w(t)}finally{this.busy=!1}}async sync(){this.busy=!0,this.error="";try{const e=await Gc();this.flash(e.requested?"הספרייה נדחפה מ־Home Assistant":e.note??"הספרייה מתעדכנת אוטומטית כל דקה"),await this.load()}catch(e){this.error=w(e)}finally{this.busy=!1}}async addGroup(){const e=this.newGroup.trim();if(e){this.busy=!0,this.error="";try{const t=await Qc(e);this.newGroup="",this.flash(`נוצרה קבוצה "${t.name}"`),await this.load(),this.selectedGroup=t.id}catch(t){this.error=w(t)}finally{this.busy=!1}}}async saveMembers(e){if(this.members){this.busy=!0,this.error="";try{await tp(e.id,[...this.members]),this.members=null,this.flash("חברי הקבוצה עודכנו"),await this.load()}catch(t){this.error=w(t)}finally{this.busy=!1}}}async removeGroup(e){this.busy=!0,this.error="";try{await ep(e.id),this.selectedGroup=null,this.flash(`הקבוצה "${e.name}" נמחקה והשיוכים שלה בוטלו`),await this.load()}catch(t){this.error=w(t)}finally{this.busy=!1}}async runPreview(){if(!this.previewUser)return;const[e,t]=this.previewScope.split(":");this.busy=!0,this.error="";try{this.preview=await sp({user_id:this.previewUser,scope_type:e,scope_id:t})}catch(s){this.error=w(s)}finally{this.busy=!1}}renderBindingRow(e,t){return r`<div class="bind">
      <div><strong>${e.role_name}</strong> · ${e.scope_name}${e.effect==="deny"?r` <sw-badge kind="forbidden" label="חסימה"></sw-badge>`:c}<div class="sub">${e.via_group?`דרך קבוצה "${e.via_group}" · `:""}מאז ${lt(e.created_at)}${e.expires_at?` · עד ${lt(e.expires_at)}`:""} · רוויזיה ${e.permission_revision}</div></div>
    ...
    </div>`}renderUsersApi(){const e=this.directory,t=e.can_assign,s=[{key:"name",label:"שם",render:a=>r`<div style="display:flex;align-items:center;gap:10px"><sw-avatar name=${String(a.name)} size=${30}></sw-avatar><div><strong>${String(a.name)}</strong>${a.is_admin?r` <sw-badge kind="neutral" label="מנהל HA · מידע בלבד"></sw-badge>`:c}${a.is_self?r` <sw-badge kind="recorded" label="אני"></sw-badge>`:c}<div style="font-size:var(--sw-fs-xs);color:var(--sw-text-3);direction:ltr;text-align:start">${String(a.username||a.id)}</div></div></div>`},{key:"bindings",label:"תפקיד · היקף",render:a=>{const n=a.bindings;return n.length?r`${n.slice(0,2).map(o=>r`<div style="font-size:var(--sw-fs-xs)"><strong>${o.role_name}</strong> · ${o.scope_name}${o.via_group?" (קבוצה)":""}</div>`)}${n.length>2?r`<div style="font-size:var(--sw-fs-xs);color:var(--sw-text-3)">+${n.length-2}</div>`:c}`:r`<span style="font-size:var(--sw-fs-xs);color:var(--sw-text-3)">ללא שיוך · אין גישה לתוכן</span>`}},{key:"groups",label:"קבוצות",render:a=>r`<span style="font-size:var(--sw-fs-xs)">${a.groups.map(n=>n.name).join(", ")||"—"}</span>`},{key:"active",label:"מצב",render:a=>r`<span style="display:inline-flex;align-items:center;gap:6px;font-size:var(--sw-fs-xs)"><i style="inline-size:7px;block-size:7px;border-radius:50%;background:${a.active?"var(--sw-live)":"var(--sw-offline)"}"></i>${a.active?"פעיל":"ללא גישה (HA)"}</span>`},{key:"sync_status",label:"סנכרון",render:a=>r`<span style="font-size:var(--sw-fs-xs)">${Fa[a.sync_status]}</span><div style="font-size:var(--sw-fs-xs);color:var(--sw-text-3)">${a.last_seen_at?`נראה ${lt(String(a.last_seen_at))}`:"טרם נכנס"}</div>`}],i=e.users.find(a=>a.id===this.selected)??null;return r`
      <div class="stage">
        ...
        ${i?r`<sw-drawer open heading=${i.name} subheading=${`Home Assistant · ${i.username||i.id} · ${i.active?"פעיל":"ללא גישה"}`} @close=${()=>{this.selected=null,this.wizard=null}}>
              ${this.wizard&&this.wizard.subjectKind==="user"?this.renderWizard():r`<dl>
                    ...
                    <dt>סנכרון</dt><dd>${Fa[i.sync_status]}${i.synced_at?` · ${lt(i.synced_at)}`:""}</dd>
                    <dt>ב־VMS</dt><dd>${i.first_seen_at?`מאז ${lt(i.first_seen_at)} · לאחרונה ${lt(i.last_seen_at)}`:"טרם נכנס לממשק"}</dd>
    ...
    `}renderUsers(){const e=zi.find(t=>t.id===this.selected);return r`
      <div class="stage">
        <sw-table .columns=${this.userColumns} .rows=${zi} .selected=${this.selected} @row-select=${t=>{this.selected=t.detail.id,this.assigning=!1}}></sw-table>
    ...
    `}renderAudit(){return r`<sw-table dense .columns=${[{key:"time",label:"זמן"},{key:"user",label:"משתמש",render:t=>r`<div class="who"><sw-avatar name=${String(t.user)} size=${24}></sw-avatar>${String(t.user)}</div>`},{key:"action",label:"פעולה"},{key:"resource",label:"משאב"},{key:"decision",label:"החלטה",render:t=>r`<sw-badge kind=${String(t.decision).startsWith("נחסם")?"forbidden":"live"} label=${String(t.decision)}></sw-badge>`},{key:"role",label:"תפקיד/היקף ששימשו"}]} .rows=${lr.filter(t=>t.action.includes("תוכנית")||t.action.includes("סנכרון")||t.action.includes("Ingress"))}></sw-table>`}render(){return g()?this.renderApi():r`
      <sw-page heading="משתמשים והרשאות" subheading="זהות מ־Home Assistant · הרשאות בתוך SMPLWISE בלבד · נתוני הדגמה">
        ...
        <sw-tabs .items=${pp} .active=${this.tab} @change=${e=>this.tab=e.detail.id}></sw-tabs>
        <div class="notice"><sw-icon name="shield" size=${14}></sw-icon>שיוך כאן אינו משנה דבר ב־Home Assistant: לא קבוצות HA, לא דגל מנהל, לא סיסמאות. אין "הוספת משתמש" — משתמשים נוצרים ב־HA בלבד.</div>
  ...
  `;Z([d()],W.prototype,"tab",2);Z([d()],W.prototype,"selected",2);Z([d()],W.prototype,"assigning",2);Z([d()],W.prototype,"step",2);Z([d()],W.prototype,"directory",2);Z([d()],W.prototype,"roles",2);Z([d()],W.prototype,"groups",2);Z([d()],W.prototype,"tree",2);Z([d()],W.prototype,"audit",2);Z([d()],W.prototype,"selectedGroup",2);Z([d()],W.prototype,"wizard",2);Z([d()],W.prototype,"members",2);Z([d()],W.prototype,"newGroup",2);Z([d()],W.prototype,"preview",2);Z([d()],W.prototype,"previewUser",2);Z([d()],W.prototype,"previewScope",2);Z([d()],W.prototype,"busy",2);Z([d()],W.prototype,"error",2);Z([d()],W.prototype,"message",2);Z([d()],W.prototype,"forbidden",2);Z([d()],W.prototype,"roleEdit",2);Z([d()],W.prototype,"roleImpact",2);Z([d()],W.prototype,"roleDelete",2);W=Z([k("system-access")],W);var hp=Object.defineProperty,up=Object.getOwnPropertyDescriptor,Qt=(e,t,s,i)=>{for(var a=i>1?void 0:i?up(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&hp(t,s,a),a};const mp=[{key:"time",label:"זמן",render:e=>r`14.09.2026 ${String(e.time)}`},{key:"user",label:"משתמש",render:e=>r`<span style="display:inline-flex;align-items:center;gap:8px"><sw-avatar name=${String(e.user)} size=${24}></sw-avatar>${String(e.user)}</span>`},{key:"action",label:"פעולה",render:e=>r`<span style=${String(e.decision).startsWith("נחסם")?"color:var(--sw-danger);font-weight:600":""}>${String(e.action)}</span>`},{key:"resource",label:"פרטים",render:e=>r`${String(e.resource)} <span style="color:var(--sw-text-3)">· ${String(e.decision)}</span>`},{key:"role",label:"תפקיד / היקף"},{key:"rev",label:"rev",ltr:!0,render:()=>r`7`}],fp=[{id:"",label:"כל הפעולות"},{id:"rbac.",label:"הרשאות ותפקידים"},{id:"video.",label:"וידאו (לייב, הקלטות, ייצוא)"},{id:"events.",label:"אירועים"},{id:"cases.",label:"תיקים וראיות"},{id:"ha.",label:"פעולות Home Assistant"},{id:"system.",label:"מערכת והגדרות"},{id:"plan.",label:"תוכניות ומפות"}],wp={allowed:{kind:"success",label:"הותר"},granted:{kind:"success",label:"הוענק"},denied:{kind:"danger",label:"נחסם"},refused:{kind:"danger",label:"סורב"},failed:{kind:"warning",label:"נכשל"}},vp=[{key:"at",label:"זמן",ltr:!0,render:e=>r`<span class="ltr">${new Date(String(e.at)).toLocaleString("he-IL",{day:"2-digit",month:"2-digit",year:"numeric",hour:"2-digit",minute:"2-digit",second:"2-digit"})}</span>`},{key:"actor",label:"משתמש",render:e=>r`<span style="display:inline-flex;align-items:center;gap:8px"><sw-avatar name=${String(e.actor_username??"מערכת")} size=${24}></sw-avatar>${String(e.actor_username??"מערכת")}</span>`},{key:"action",label:"פעולה",ltr:!0,render:e=>r`<span class="ltr">${String(e.action)}</span>`},{key:"decision",label:"החלטה",render:e=>{const t=wp[String(e.decision)]??{kind:"neutral",label:String(e.decision)};return r`<sw-badge kind=${t.kind} label=${t.label}></sw-badge>`}},{key:"resource",label:"משאב",render:e=>r`${e.resource_type?r`<span style="color:var(--sw-text-3)">${String(e.resource_type)}</span> `:c}<span class="ltr">${String(e.resource_id??"")}</span>`},{key:"reason",label:"סיבה / פרטים",render:e=>r`${String(e.reason??"")}${Object.keys(e.details??{}).length?r` <span style="color:var(--sw-text-3)" class="ltr">${JSON.stringify(e.details).slice(0,120)}</span>`:c}`},{key:"permission_revision",label:"rev",ltr:!0}];let vt=class extends ${constructor(){super(...arguments),this.rows=null,this.error="",this.family="",this.actor="",this.limit=100}connectedCallback(){super.connectedCallback(),g()&&this.load()}async load(){try{const e=new URLSearchParams({prefix:this.family,limit:String(this.limit)});this.actor.trim()&&e.set("actor",this.actor.trim());const t=await z(`/audit?${e.toString()}`);this.rows=t.rows,this.error=""}catch(e){this.error=w(e),this.rows=[]}}exportCsv(){const e=this.rows??[],t=n=>`"${String(n??"").replace(/"/g,'""')}"`,s=[["at","actor","action","decision","resource_type","resource_id","reason","request_id","permission_revision"].join(",")];for(const n of e)s.push([n.at,n.actor_username,n.action,n.decision,n.resource_type,n.resource_id,n.reason,n.request_id,n.permission_revision].map(t).join(","));const i=new Blob(["\uFEFF"+s.join(`
`)],{type:"text/csv;charset=utf-8"}),a=document.createElement("a");a.href=URL.createObjectURL(i),a.download=`audit-${new Date().toISOString().slice(0,10)}.csv`,a.click(),setTimeout(()=>URL.revokeObjectURL(a.href),2e3)}renderApi(){const e=this.rows;return r`
      <sw-page heading="יומן אודיט" subheading="מי צפה, שינה, ייצא או שלח פעולה · actor, פעולה, החלטה, משאב, סיבה, request_id, permission_revision · אין סיסמאות או טוקנים ביומן">
        ...
        <div class="filters" data-audit-filters>
          <sw-field><select aria-label="פעולה" .value=${this.family} @change=${t=>{this.family=t.target.value,this.load()}}>${fp.map(t=>r`<option value=${t.id} ?selected=${t.id===this.family}>${t.label}</option>`)}</select></sw-field>
        ...
        ${e===null?r`<sw-state-panel state="loading" heading="טוען יומן…"></sw-state-panel>`:e.length?r`<sw-table data-audit-table .columns=${vp} .rows=${e}></sw-table>`:this.error?c:r`<sw-state-panel state="empty" heading="אין רשומות לסינון הזה" hint="נסה משפחת פעולות אחרת או נקה את שם המשתמש"></sw-state-panel>`}
    ...
    `}render(){return g()?this.renderApi():r`
      <sw-page heading="יומן אודיט" subheading="מי צפה, שינה, ייצא או שלח פעולה · actor, מקור זהות, תפקיד והיקף, החלטה, request_id, permission_revision · נתוני הדגמה">
        ...
        <sw-table .columns=${mp} .rows=${lr}></sw-table>
        <div class="pager">
  ...
  `;Qt([d()],vt.prototype,"rows",2);Qt([d()],vt.prototype,"error",2);Qt([d()],vt.prototype,"family",2);Qt([d()],vt.prototype,"actor",2);Qt([d()],vt.prototype,"limit",2);vt=Qt([k("system-audit")],vt);var gp=Object.defineProperty,bp=Object.getOwnPropertyDescriptor,_e=(e,t,s,i)=>{for(var a=i>1?void 0:i?bp(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&gp(t,s,a),a};const yp=[{key:"nvr_host",label:"כתובת ה־NVR"},{key:"nvr_http_port",label:"פורט ISAPI (HTTP)"},{key:"nvr_rtsp_port",label:"פורט RTSP"},{key:"nvr_username",label:"משתמש NVR (קריאה)"},{key:"nvr_password",label:"סיסמת NVR"},{key:"go2rtc_url",label:"כתובת go2rtc"},{key:"go2rtc_api_username",label:"משתמש go2rtc (אם מוגן)"},{key:"go2rtc_api_password",label:"סיסמת go2rtc"},{key:"bootstrap_admin_username",label:"שם משתמש HA של המנהל הראשון"},{key:"log_level",label:"רמת לוג"}];function xt(e){if(!e)return"—";const t=new Date(e);return Number.isNaN(t.getTime())?String(e):t.toLocaleString("he-IL",{day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit",second:"2-digit"})}const bi=["גילוי","NVR","go2rtc","גשר HA","מנהל ראשון","שעון","סיום"];let ue=class extends ${constructor(){super(...arguments),this.step=0,this.raw=null,this.report=null,this.recorder=null,this.error="",this.busy=!1,this.notify=null,this.notifyError="",this.notifyPlan=null,this.notifyBusy=!1,this.notifyResult="",this.changes=[]}connectedCallback(){super.connectedCallback(),g()&&this.load()}async load(){this.loadNvr(),this.busy=!0;try{this.raw=await z("health"),this.error=""}catch(e){this.error=w(e)}try{this.recorder=(await Pe()).recorder}catch{this.recorder=null}try{this.report=await _r()}catch{this.report=null}this.busy=!1}check(e){return this.report?.checks.find(t=>t.id===e)??null}row(e,t,s=""){return r`<div class="check"><span>${e}</span><span class=${`val ${s}`}>${t==null||t===""?"—":String(t)}</span></div>`}async loadNvr(){if(g())try{const[e,t]=await Promise.all([dd(),pd(10)]);this.notify=e,this.changes=t.changes,this.notifyError=""}catch(e){this.notifyError=w(e)}}planNotify(e,t,s){const i=e?e.length:this.notify?.channels.length??0;this.notifyResult="",this.notifyPlan={channels:e,smart:t,enabled:s,label:`${s?"הפעלת":"כיבוי"} Notify Surveillance Center ב־${i} ערוצים${t?" · תנועה + אירועים חכמים":" · זיהוי תנועה"}`}}async runNotify(){const e=this.notifyPlan;if(!(!e||this.notifyBusy)){this.notifyBusy=!0;try{const t=await cd({channels:e.channels,smart:e.smart,enabled:e.enabled});this.notifyResult=`בוצע: ${t.applied} שינויים · ${t.unchanged} כבר היו כך · ${t.skipped} דולגו (סוג אירוע שלא מוגדר בערוץ) · ${t.failed} נכשלו`,this.notifyPlan=null,await this.loadNvr()}catch(t){this.notifyResult=w(t)}finally{this.notifyBusy=!1}}}async rollback(e){if(!this.notifyBusy){this.notifyBusy=!0;try{await hd(e.id),this.notifyResult=`השינוי ${e.target} הוחזר למצב הקודם.`,await this.loadNvr()}catch(t){this.notifyResult=w(t)}finally{this.notifyBusy=!1}}}renderNotifyCard(){const e=this.notify,t=s=>s===null?"—":s?"✓":"✗";return r`<sw-card heading="התראות מה־NVR (Notify Surveillance Center)" subheading="אילו ערוצים מודיעים ל־VMS על תנועה ועל אירועים חכמים · כתיבה מאושרת ל־NVR, עם החזר" data-nvr-notify>
      ...
      <sw-page heading="חיבורים" subheading="מצב החיבורים של ה־Add-on: NVR, go2rtc, Home Assistant ואחסון · קריאה בלבד · הערכים עצמם מוגדרים ב־Home Assistant › Add-ons › SMPLWISE VMS › Configuration">
        ...
        ${e?r`<div class="two" data-connections>
              <sw-card heading="NVR (Hikvision, ISAPI + RTSP)" subheading=${e.nvr_configured?"מוגדר · קריאה בלבד":"לא מוגדר"}>
                ...
                ${this.row("גילוי אחרון תקין",xt(e.discovery.cameras_last_ok),e.discovery.cameras_last_error?"warn":"ok")}
                ${e.discovery.cameras_last_error?this.row("שגיאת גילוי",e.discovery.cameras_last_error,"err"):c}
                ${this.row("זרם התראות (alertStream)",e.events.ingest.connected?`מחובר · פעימה ${xt(e.events.ingest.last_heartbeat_at)}`:`מנותק${e.events.ingest.last_error?` · ${e.events.ingest.last_error}`:""}`,e.events.ingest.connected?"ok":"err")}
                ...
                ${this.row("אירועים שנגזרו מהקלטות (ריצה אחרונה)",`${e.events.derive.derived} · ${xt(e.events.derive.last_ok)}`,e.events.derive.last_error?"warn":"")}
              </sw-card>
              ...
              <sw-card heading="go2rtc (relay לווידאו)" subheading=${e.go2rtc_configured?"מוגדר":"לא מוגדר"}>
                ...
                ${this.row("סנכרון זרמים אחרון תקין",xt(e.discovery.streams_last_ok),e.discovery.streams_last_error?"warn":"ok")}
              ...
              <sw-card heading="Home Assistant" subheading=${e.home_assistant.connected?`מחובר · HA ${e.home_assistant.ha_version??""}`:e.home_assistant.configured?"מוגדר, מנותק":"לא מוגדר"}>
                ...
                ${this.row("תמונת מצב אחרונה",xt(e.home_assistant.last_snapshot_at))}
                ${this.row("עדכון ישות אחרון",xt(e.home_assistant.last_event_at))}
                ${this.row("רישום (אזורים / קומות) עודכן",xt(e.home_assistant.last_registry_at))}
            ...
            <sw-card heading="איפה מגדירים" subheading="הערכים אינם מוצגים כאן ואינם נשמרים ב־VMS; שינוי דורש הפעלה מחדש של ה־Add-on">
              <div class="opts" data-connection-options>
                ${yp.map(t=>r`<div class="check"><span>${t.label}</span><span class="val ltr">${t.key}</span></div>`)}
              </div>
    ...
    `}renderStep(){switch(this.step){case 0:return r`<sw-card heading="גילוי מכשירים" subheading="חיפוש NVR ומצלמות ברשת המקומית · קריאה בלבד, ללא שינוי תצורה במכשיר">
      ...
      <sw-page heading="אשף התקנה" subheading="גילוי NVR ומצלמות, בדיקת זרמים, שמות וקומות · בדיקות קריאה בלבד · נתוני הדגמה">
        <div class="wrap">
          <sw-card><sw-steps .steps=${bi} .current=${this.step}></sw-steps></sw-card>
          ${this.renderStep()}
          <div class="foot">
            ...
            <div style="display:flex;gap:8px">
              ...
              <sw-button variant="primary" @click=${()=>this.step=Math.min(bi.length-1,this.step+1)}>${this.step===bi.length-1?"סיום":"הבא"}</sw-button>
            </div>
          </div>
        </div>
      </sw-page>
  ...
  `;_e([d()],ue.prototype,"step",2);_e([d()],ue.prototype,"raw",2);_e([d()],ue.prototype,"report",2);_e([d()],ue.prototype,"recorder",2);_e([d()],ue.prototype,"error",2);_e([d()],ue.prototype,"busy",2);_e([d()],ue.prototype,"notify",2);_e([d()],ue.prototype,"notifyError",2);_e([d()],ue.prototype,"notifyPlan",2);_e([d()],ue.prototype,"notifyBusy",2);_e([d()],ue.prototype,"notifyResult",2);_e([d()],ue.prototype,"changes",2);ue=_e([k("system-setup")],ue);var $p=Object.defineProperty,xp=Object.getOwnPropertyDescriptor,$e=(e,t,s,i)=>{for(var a=i>1?void 0:i?xp(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&$p(t,s,a),a};const Ua=["entrance","lobby","corridor","hall","parking","warehouse","backyard","driveway","night"];let pe=class extends ${constructor(){super(...arguments),this.selected=null,this.filter="all",this.cameras=null,this.recorder=null,this.canSync=!1,this.discovery=null,this.busy=!1,this.message="",this.error="",this.dialog=!1,this.formChannel=1,this.formAlias="",this.alias="",this.columns=[{key:"name",label:"מצלמה",render:e=>r`<div class="cam">${e.api&&e.api.status==="online"?r`<img class="snap" src=${Fe(String(e.id))} alt="" loading="lazy" style="inline-size:64px;block-size:40px;object-fit:cover;border-radius:5px;flex-shrink:0;background:var(--sw-surface-3);display:block" @error=${t=>t.target.style.visibility="hidden"} />`:e.scene?r`<sw-scene kind=${e.scene}></sw-scene>`:r`<div class="none"></div>`}<div><b>${String(e.name)}</b><small>${String(e.sub)}</small></div></div>`},{key:"state",label:"מצב",render:e=>r`<span class="status"><i style="--c:${e.state==="live"?"var(--sw-live)":e.state==="offline"?"var(--sw-danger)":e.state==="unknown"?"var(--sw-unknown)":"var(--sw-stale)"}"></i>${e.state==="live"?"מחוברת":e.state==="offline"?"מנותקת":e.state==="stale"?"לא מעודכן":e.state==="forbidden"?"ללא הרשאה":"לא נבדק"}</span>`},{key:"fps",label:"FPS",ltr:!0},{key:"bitrate",label:"קצב",ltr:!0},{key:"firmware",label:"זרם ראשי",ltr:!0},{key:"lastEvent",label:"נראתה לאחרונה"},{key:"net",label:"רשת",render:e=>this.net(e.state==="live"?4:e.state==="stale"?2:0)},{key:"more",label:"",width:"40px",render:()=>r`<sw-button variant="ghost" size="sm" iconOnly icon="more" label="עוד"></sw-button>`}]}connectedCallback(){super.connectedCallback(),this.reload()}async reload(){if(!g()){this.cameras=null;return}try{const e=await Pe();this.cameras=e.cameras,this.recorder=e.recorder,this.canSync=e.can_sync,z("health").then(t=>this.discovery=t.discovery).catch(()=>{})}catch(e){this.error=w(e)}}async sync(){this.busy=!0,this.error="",this.message="";try{const e=await So();this.message=`סנכרון הושלם: ${e.channels} ערוצים (${e.created} חדשים, ${e.updated} עודכנו)${e.recorder.model?` · ${e.recorder.model}`:""}`,await this.reload()}catch(e){this.error=w(e)}finally{this.busy=!1}}async register(){this.busy=!0,this.error="";try{await Mo({channel:this.formChannel,alias:this.formAlias.trim()}),this.dialog=!1,await this.reload()}catch(e){this.error=w(e)}finally{this.busy=!1}}async saveAlias(e){this.busy=!0,this.error="";try{await Ao(e,{alias:this.alias.trim()||void 0}),await this.reload(),this.message="הכינוי נשמר (שם ה־NVR לא השתנה)"}catch(t){this.error=w(t)}finally{this.busy=!1}}get rows(){return this.cameras?this.cameras.map(e=>({id:e.id,name:e.name,sub:`ערוץ ${e.channel}${e.name_source&&e.alias?` · NVR: ${e.name_source}`:""}`,state:e.status==="online"?"live":e.status==="offline"?"offline":"unknown",fps:e.stream?.fps?String(e.stream.fps):"—",bitrate:e.stream?.bitrate_kbps?`${(e.stream.bitrate_kbps/1024).toFixed(1)} Mbps`:"—",firmware:e.stream?.resolution?`${e.stream.resolution} ${e.stream.codec??""}`.trim():"—",lastEvent:e.last_seen_at?e.last_seen_at.replace("T"," ").replace("Z",""):"לא נבדק",scene:e.status==="online"?Ua[(e.channel-1)%Ua.length]:null,channel:e.channel,api:e})):q.map(e=>({id:e.id,name:e.name,sub:`${e.floor} · ערוץ ${e.id.replace("cam-","")}`,state:e.state,fps:e.fps?String(e.fps):"—",bitrate:e.bitrateKbps?`${(e.bitrateKbps/1024).toFixed(1)} Mbps`:"—",firmware:e.firmware,lastEvent:e.lastEvent,scene:e.state==="offline"||e.state==="forbidden"?null:Ue[e.id]??"lobby",channel:Number(e.id.replace("cam-",""))}))}net(e){return h`<svg class="net" viewBox="0 0 22 14" aria-label="רשת">${[0,1,2,3].map(t=>h`<rect x=${t*5.5} y=${11-t*3} width="4" height=${3+t*3} rx="1" fill=${t<e?e>=3?"#22c55e":"#f59e0b":"var(--sw-border-strong)"} />`)}</svg>`}render(){const e=this.rows,t=e.filter(a=>this.filter==="all"?!0:this.filter==="online"?a.state==="live":this.filter==="offline"?a.state==="offline":a.state==="stale"||a.state==="forbidden"||a.state==="unknown"),s=e.find(a=>a.id===this.selected),i=!!this.cameras;return r`
  ...
  `;$e([d()],pe.prototype,"selected",2);$e([d()],pe.prototype,"filter",2);$e([d()],pe.prototype,"cameras",2);$e([d()],pe.prototype,"recorder",2);$e([d()],pe.prototype,"canSync",2);$e([d()],pe.prototype,"discovery",2);$e([d()],pe.prototype,"busy",2);$e([d()],pe.prototype,"message",2);$e([d()],pe.prototype,"error",2);$e([d()],pe.prototype,"dialog",2);$e([d()],pe.prototype,"formChannel",2);$e([d()],pe.prototype,"formAlias",2);$e([d()],pe.prototype,"alias",2);pe=$e([k("system-devices")],pe);const Qi="sw.design.override",ea="sw.design.last",ps={a:"SW A",b:"SW B"};let Ms="b";const Ri=new Set;function Zs(e){try{return localStorage.getItem(e)}catch{return null}}function Cr(e,t){try{t===null?localStorage.removeItem(e):localStorage.setItem(e,t)}catch{}}function kp(){try{const s=new URLSearchParams(window.location.search).get("design");if(s==="a"||s==="b")return s}catch{}const e=Zs(Qi);if(e==="a"||e==="b")return e;const t=Zs(ea);return t==="a"||t==="b"?t:"b"}Ms=kp();function Ni(){const e=Zs(Qi);return e==="a"||e==="b"?e:null}function _p(e){Cr(Qi,e),Dr()}function Tr(){return Ms}function zp(e){return Ri.add(e),e(Ms),()=>Ri.delete(e)}function dt(e){Ms=e,document.documentElement.dataset.design=e,Cr(ea,e),Ri.forEach(t=>t(e))}function Sp(e){try{const t=e?JSON.parse(e):{};return{a:(t.a||ps.a).slice(0,24),b:(t.b||ps.b).slice(0,24)}}catch{return{...ps}}}async function Dr(){const e=new URLSearchParams(window.location.search).get("design");if(e==="a"||e==="b")return dt(e),e;const t=Ni();if(t)return dt(t),t;if(!g())return dt("b"),"b";const s=Zs(ea);(s==="a"||s==="b")&&dt(s);try{const a=(await Ve())["ui.design"]==="b"?"b":"a";return dt(a),a}catch{return dt(s==="b"?"b":"a"),Ms}}const Mp={manual:"ידני",upload:"הועלה","auto-pre-upgrade":"אוטומטי · לפני עדכון","auto-daily":"אוטומטי · יומי"},yi={sites:"אתרים",buildings:"מבנים",floors:"קומות",plan_assets:"קבצי תוכנית",plan_versions:"גרסאות תוכנית",map_anchors:"עוגנים",cameras:"מצלמות",spatial_zones:"אזורים",settings:"הגדרות",users:"משתמשים",bindings:"הרשאות",groups:"קבוצות"},Ap=()=>z("backups"),Ip=(e={})=>A("backups",e),Pp=e=>he(`backups/${encodeURIComponent(e)}`),Ep=(e,t)=>A(`backups/${encodeURIComponent(e)}/restore`,t),Cp=e=>ce(`backups/${encodeURIComponent(e)}/download`);function Tp(e){const t=new FormData;return t.append("file",e,e.name),ei("backups/upload",t)}function Wa(e){return e<1024?`${e} B`:e<1024*1024?`${(e/1024).toFixed(0)} KB`:`${(e/1024/1024).toFixed(1)} MB`}var Dp=Object.defineProperty,Op=Object.getOwnPropertyDescriptor,H=(e,t,s,i)=>{for(var a=i>1?void 0:i?Op(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&Dp(t,s,a),a};const Za=[{id:"general",label:"כללי"},{id:"media",label:"וידאו ומדיה"},{id:"ha",label:"גשר Home Assistant"},{id:"health",label:"בריאות ועבודות"},{id:"backup",label:"גיבוי ושחזור"},{id:"support",label:"תמיכה"}];let D=class extends ${constructor(){super(...arguments),this.tab="general",this.settings=null,this.canEdit=!1,this.draft={},this.streams=null,this.go2rtc=null,this.foreign=0,this.sessions=[],this.busy=!1,this.message="",this.error="",this.version="",this.ha=null,this.pairing=null,this.showCode=!1,this.regenArmed=!1,this.copied=!1,this.report=null,this.reportBusy=!1,this.backups=null,this.backupPolicy={},this.backupBusy=!1,this.backupNote="",this.backupMsg="",this.restoreTarget=null,this.restoreMode="replace",this.restoreAccess=!1,this.restoreConfirm="",this.health=null}connectedCallback(){super.connectedCallback();const e=ws().params.get("tab");e&&Za.some(t=>t.id===e)&&(this.tab=e,e==="health"&&this.loadReport(),e==="backup"&&this.loadBackups(),e==="media"&&this.loadMedia(),e==="ha"&&this.loadHa()),this.loadSettings()}async loadSettings(){if(g())try{const[e,t]=await Promise.all([sr(),z("health").catch(()=>null)]);this.settings=e.settings,this.canEdit=e.can_edit,this.draft={},this.version=t?.version??"",this.health=t??null}catch(e){this.error=w(e)}}async loadMedia(){if(!(!g()||!this.canEdit))try{const[e,t]=await Promise.all([Hn(),Vn()]);this.streams=e.streams,this.go2rtc=e.go2rtc,this.foreign=e.foreign_streams,this.sessions=t.sessions,this.error=""}catch(e){this.streams=[],this.error=w(e)}}async loadHa(e=!1){if(g()){this.error="";try{this.ha=await tl(),this.canEdit&&(this.pairing=await sl(e)),e&&(this.regenArmed=!1,this.showCode=!0,this.message="נוצר קוד צימוד חדש; יש להגדיר מחדש את האינטגרציה ב־Home Assistant.",setTimeout(()=>this.message="",4e3))}catch(t){this.error=w(t)}}}async copyCode(){if(this.pairing)try{await navigator.clipboard.writeText(this.pairing.pairing_code),this.copied=!0,setTimeout(()=>this.copied=!1,2e3)}catch{this.showCode=!0}}async installBridgeNow(){this.busy=!0,this.error="";try{const e=await il();this.message=e.state==="installed_pending"?"האינטגרציה הועתקה ל־Home Assistant; הפעל מחדש את Home Assistant ואשר את הגשר שהתגלה.":e.state==="active"?"האינטגרציה פעילה.":e.state==="not_available"?"תיקיית ההגדרות של Home Assistant אינה נגישה ל־Add-on.":`מצב: ${e.state}`,await this.loadHa(),setTimeout(()=>this.message="",6e3)}catch(e){this.error=w(e)}finally{this.busy=!1}}integrationText(e){switch(e.state){case"active":return`פעילה ב־Home Assistant (גרסה ${e.active_version??"?"})`;case"installed_pending":return`הועתקה לתיקיית ההגדרות של HA (גרסה ${e.installed_version??"?"}) ב־${De(e.installed_at)} · הפעל מחדש את Home Assistant ואז אשר את "SMPLWISE Bridge" שהתגלה בהגדרות → מכשירים ושירותים`;case"update_pending":return`עודכנה לגרסה ${e.installed_version??"?"} אך Home Assistant עדיין מריץ ${e.active_version??"?"} · נדרש Restart ל־Home Assistant`;case"not_installed":return"טרם הועתקה";case"error":return`ההעתקה נכשלה (${e.last_error??""})`;default:return e.last_error==="ha_config_not_mapped"?"ה־Add-on לא רואה את תיקיית ההגדרות של Home Assistant (המיפוי homeassistant_config לא ניתן) · התקנה ידנית לפי השלבים למטה":e.last_error==="source_missing"?"קבצי האינטגרציה חסרים בתמונת ה־Add-on · התקנה ידנית לפי השלבים למטה":`ההתקנה האוטומטית נכשלה (${e.last_error??"סיבה לא ידועה"}) · התקנה ידנית לפי השלבים למטה`}}renderIntegration(e){const t=e.integration;if(!t)return c;const s=t.state==="active"?"live":t.state==="installed_pending"||t.state==="update_pending"?"stale":t.state==="error"?"error":"unknown",i=t.state==="active"?"פעילה":t.state==="installed_pending"?"ממתינה ל־Restart":t.state==="update_pending"?"עדכון ממתין":t.state==="error"?"שגיאה":t.state==="not_installed"?"לא הותקנה":"לא זמין";return r`<div class="row"><span class="lbl">התקנת האינטגרציה ב־Home Assistant<span class="muted">${this.integrationText(t)}${t.discovery_posted_at?` · הוכרזה ל־Supervisor ${De(t.discovery_posted_at)}`:""}</span></span><span style="display:flex;gap:8px;align-items:center"><sw-badge kind=${s} label=${i}></sw-badge>${this.canEdit&&t.state!=="not_available"?r`<sw-button size="sm" ?disabled=${this.busy} @click=${()=>this.installBridgeNow()}>התקן / עדכן</sw-button>`:c}</span></div>`}renderHa(){if(!g())return r`<div class="sections"><sw-card heading="גשר Home Assistant"><div class="muted">נתוני הדגמה — הסטטוס והצימוד זמינים מול השרת.</div></sw-card></div>`;const e=this.ha,t=e?.sync,s=this.pairing;return r`<div class="sections">
      <sw-card heading="חיבור ל־Home Assistant" subheading="קריאה בלבד: מצבים, רישום ישויות, אזורים וקומות">
        ${e?r`
            ...
            <div class="row"><span class="lbl">סנכרון מצבים (WebSocket)<span class="muted">${t?.connected?`מחובר · HA ${t.ha_version??"?"} · ${t.entities} ישויות · אירוע אחרון ${De(t.last_event_at)}`:`מנותק${t?.last_error?` · ${t.last_error}`:""} · ${t?.reconnects??0} חיבורים מחדש`}</span></span><sw-badge kind=${t?.connected?"live":"offline"}></sw-badge></div>
            <div class="row"><span class="lbl">רישום ישויות (registry)<span class="muted">עודכן ${De(t?.last_registry_at)} · תמונת מצב ${De(t?.last_snapshot_at)}</span></span><sw-button size="sm" @click=${()=>b("/explore/entities")}>לקטלוג</sw-button></div>`:r`<div class="muted">טוען…</div>`}
      </sw-card>
      <sw-card heading="גשר SMPLWISE (אינטגרציה ב־Home Assistant)" subheading="פעולות על ישויות רצות רק דרך הגשר, בזהות המשתמש, לפי ההרשאות של Home Assistant">
        ${e?r`${this.renderIntegration(e)}<div class="row"><span class="lbl">צימוד<span class="muted">${e.bridge.paired?`מצומד מאז ${De(e.bridge.paired_at)}`:"לא מצומד — פעולות HA ייחסמו עד להתקנת הגשר"}</span></span><sw-badge kind=${e.bridge.paired?"live":"stale"} label=${e.bridge.paired?"מצומד":"לא מצומד"}></sw-badge></div>
            <div class="row"><span class="lbl">ספריית משתמשי HA<span class="muted">${e.bridge.directory_users} משתמשים · עודכן ${De(e.bridge.last_directory_at)}</span></span><sw-badge kind=${e.bridge.directory_users?"recorded":"unknown"}></sw-badge></div>`:c}
    ...
    </div>`}set(e,t){this.draft={...this.draft,[e]:t}}value(e){return this.draft[e]??this.settings?.[e]}async save(){if(Object.keys(this.draft).length){this.busy=!0,this.error="";try{const e=await Bn(this.draft);this.settings=e.settings,this.draft={},Sa(),this.message="ההגדרות נשמרו",setTimeout(()=>this.message="",2500)}catch(e){this.error=w(e)}finally{this.busy=!1}}}async sync(){this.busy=!0,this.error="";try{const e=await Ln();this.message=`זרמים: ${e.created} נוצרו, ${e.updated} עודכנו, ${e.unchanged} ללא שינוי · ${e.foreign_streams_untouched} זרמים זרים לא נגעו`,await this.loadMedia()}catch(e){this.error=w(e)}finally{this.busy=!1}}renderDesign(){if(!g())return c;const e=Sp(this.value("ui.design_names")),t=this.value("ui.design")??"a",s=Ni(),i="ui.design"in this.draft||"ui.design_names"in this.draft,a=(n,o)=>this.set("ui.design_names",JSON.stringify({...e,[n]:o.slice(0,24)}));return r`<sw-card heading="עיצוב הממשק" subheading=${`פעיל עכשיו בדפדפן הזה: ${e[Tr()]}${s?" (עקיפה מקומית)":""}`}>
      ...
      <div class="row"><span class="lbl">שם העיצוב החדש<span class="muted">ברירת מחדל: ${ps.a} · העיצוב מחבילת 50 המסכים</span></span><sw-field class="ctl"><input maxlength="24" ?disabled=${!this.canEdit} .value=${e.a} @change=${n=>a("a",n.target.value)} /></sw-field></div>
      <div class="row"><span class="lbl">שם העיצוב הקודם<span class="muted">ברירת מחדל: ${ps.b} · הלוחות המקוריים</span></span><sw-field class="ctl"><input maxlength="24" ?disabled=${!this.canEdit} .value=${e.b} @change=${n=>a("b",n.target.value)} /></sw-field></div>
      <div class="row"><span class="lbl">בדפדפן הזה בלבד<span class="muted">עקיפה אישית שנשמרת במכשיר; לא משנה את ברירת המחדל</span></span><sw-field class="ctl"><select @change=${n=>{const o=n.target.value;_p(o==="a"||o==="b"?o:null),o!=="a"&&o!=="b"&&dt(t),this.requestUpdate()}}><option value="" ?selected=${!s}>לפי ברירת המחדל</option><option value="a" ?selected=${s==="a"}>${e.a}</option><option value="b" ?selected=${s==="b"}>${e.b}</option></select></sw-field></div>
    ...
    </sw-card>`}async saveDesign(){await this.save(),!Ni()&&this.settings&&dt(this.settings["ui.design"]==="b"?"b":"a")}renderGeneral(){return r`<div class="sections">
      ${this.renderDesign()}
    ...
    </div>`}async loadReport(e=!1){if(g()){this.reportBusy=!0;try{this.report=await _r(e)}catch(t){this.error=w(t)}finally{this.reportBusy=!1}}}renderReport(){const e=this.report;if(!e)return r`<div class="sections"><sw-card heading="בריאות המערכת"><div class="muted">${this.reportBusy?"בודק…":"טוען…"}</div></sw-card></div>`;const t=new Intl.DateTimeFormat("he-IL",{hour:"2-digit",minute:"2-digit",second:"2-digit",hourCycle:"h23"}).format(new Date(e.checked_at));return r`<div class="sections">
      <sw-card heading="בריאות המערכת" subheading="מצב נפרד לכל רכיב, לא נורה אחת">
        <div class="hsum"><sw-badge kind=${za[e.status]} label=${e.status==="ok"?"הכל תקין":e.status==="warn"?"יש מה לבדוק":"יש תקלה"}></sw-badge><span>גרסה <span class="ltr">${e.version}</span> · פעיל ${ed(e.uptime_s)} · נבדק <span class="ltr" data-health-checked>${t}</span></span><span class="grow"></span><sw-button size="sm" icon="refresh" ?disabled=${this.reportBusy} @click=${()=>this.loadReport(!0)}>${this.reportBusy?"בודק…":"בדוק עכשיו"}</sw-button></div>
        <div class="hgrid">${e.checks.map(s=>r`<div class="hcard ${s.status}" data-health-card=${s.id}><div class="hh"><span>${s.label}</span><sw-badge kind=${za[s.status]} label=${os[s.status]}></sw-badge></div><div class="hd">${s.detail}</div></div>`)}</div>
      ...
      <sw-card heading="מצבים נפרדים, לא נורה אחת">${cr.map(e=>r`<div class="row"><span class="lbl">${e.name}<span class="muted">${e.detail}</span></span><sw-badge kind=${e.state}></sw-badge></div>`)}
      ...
      <sw-card heading="תור עבודות">${dr.map(e=>r`<div class="row"><span class="lbl">${e.title}<span class="muted">${e.status}</span></span><span style="display:flex;align-items:center;gap:10px"><span class="bar ${e.status.startsWith("נכשל")?"fail":""}"><i style="--p:${e.progress}%"></i></span><span class="ltr">${e.progress}%</span></span></div>`)}</sw-card>
    </div>`}async loadBackups(){if(g())try{const e=await Ap();this.backups=e.backups,this.backupPolicy=e.policy}catch(e){this.error=w(e),this.backups=[]}}async createBackup(){this.backupBusy=!0,this.backupMsg="";try{const e=await Ip({note:this.backupNote.trim()});this.backupNote="",this.backupMsg=`הגיבוי ${e.name} נוצר (${Wa(e.bytes)})`,await this.loadBackups()}catch(e){this.error=w(e)}finally{this.backupBusy=!1}}async onBackupFile(e){if(e){this.backupBusy=!0,this.backupMsg="";try{const t=await Tp(e);this.backupMsg=`הקובץ הועלה כ־${t.name}; עכשיו אפשר לשחזר ממנו`,await this.loadBackups()}catch(t){this.error=w(t)}finally{this.backupBusy=!1}}}async removeBackup(e){if(window.confirm(`למחוק את הגיבוי ${e.name}?`)){this.backupBusy=!0;try{await Pp(e.name),await this.loadBackups()}catch(t){this.error=w(t)}finally{this.backupBusy=!1}}}openRestore(e){this.restoreTarget=e,this.restoreMode="replace",this.restoreAccess=!1,this.restoreConfirm=""}async doRestore(){const e=this.restoreTarget;if(!(!e||this.restoreConfirm!=="RESTORE")){this.backupBusy=!0,this.error="";try{const t=await Ep(e.name,{mode:this.restoreMode,scope:this.restoreAccess?"project+access":"project",confirm:this.restoreConfirm}),s=Object.entries(t.tables).filter(([i])=>yi[i]).map(([i,a])=>`${a} ${yi[i]}`);this.backupMsg=`שוחזר מ־${e.name} (${t.mode==="replace"?"החלפה":"מיזוג"}): ${s.join(", ")} · ${t.files} קבצים`,this.restoreTarget=null,Sa(),await this.loadBackups()}catch(t){this.error=w(t)}finally{this.backupBusy=!1}}}fmtWhen(e){return new Intl.DateTimeFormat("he-IL",{day:"2-digit",month:"2-digit",year:"numeric",hour:"2-digit",minute:"2-digit",hourCycle:"h23"}).format(new Date(e))}renderBackupRow(e){const t=["sites","floors","plan_versions","map_anchors","spatial_zones","cameras"].filter(s=>e.tables[s]!==void 0).map(s=>`${e.tables[s]} ${yi[s]}`).join(" · ");return r`<div class="brow" data-backup-row>
      <div>
        <div class="name"><span class="ltr">${e.name}</span><sw-badge kind=${e.kind.startsWith("auto")?"neutral":e.kind==="upload"?"stale":"live"} label=${Mp[e.kind]??e.kind}></sw-badge>${e.valid?c:r`<sw-badge kind="error" label="קובץ לא תקין"></sw-badge>`}</div>
        <div class="sub">${this.fmtWhen(e.created_at)} · ${Wa(e.bytes)} · גרסה ${e.app_version??"?"}${e.note?` · ${e.note}`:""}</div>
        ${t?r`<div class="sub">${t} · ${e.files} קבצי תוכנית</div>`:c}
      </div>
      <div class="acts">
        <a href=${Cp(e.name)} download=${e.name} data-backup-download><sw-button size="sm" icon="download">הורד</sw-button></a>
    ...
    ${this.restoreTarget?this.renderRestoreDialog(this.restoreTarget):c}`}renderSupport(){return r`<div class="sections"><sw-card heading="חבילת תמיכה מצונזרת">
      ...
      <sw-page heading="הגדרות המערכת" subheading=${g()?"תעבורת וידאו, go2rtc, מכסות ובריאות":"אזור זמן, מדיניות אחסון, אינטגרציות ובריאות · נתוני הדגמה"}>
        <sw-tabs underline .items=${Za} .active=${this.tab} @change=${e=>{this.tab=e.detail.id,this.tab==="media"&&this.loadMedia(),this.tab==="ha"&&this.loadHa(),this.tab==="backup"&&this.loadBackups(),this.tab==="health"&&this.loadReport()}}></sw-tabs>
  ...
  `;H([d()],D.prototype,"tab",2);H([d()],D.prototype,"settings",2);H([d()],D.prototype,"canEdit",2);H([d()],D.prototype,"draft",2);H([d()],D.prototype,"streams",2);H([d()],D.prototype,"go2rtc",2);H([d()],D.prototype,"foreign",2);H([d()],D.prototype,"sessions",2);H([d()],D.prototype,"busy",2);H([d()],D.prototype,"message",2);H([d()],D.prototype,"error",2);H([d()],D.prototype,"version",2);H([d()],D.prototype,"ha",2);H([d()],D.prototype,"pairing",2);H([d()],D.prototype,"showCode",2);H([d()],D.prototype,"regenArmed",2);H([d()],D.prototype,"copied",2);H([d()],D.prototype,"report",2);H([d()],D.prototype,"reportBusy",2);H([d()],D.prototype,"backups",2);H([d()],D.prototype,"backupPolicy",2);H([d()],D.prototype,"backupBusy",2);H([d()],D.prototype,"backupNote",2);H([d()],D.prototype,"backupMsg",2);H([d()],D.prototype,"restoreTarget",2);H([d()],D.prototype,"restoreMode",2);H([d()],D.prototype,"restoreAccess",2);H([d()],D.prototype,"restoreConfirm",2);H([d()],D.prototype,"health",2);D=H([k("system-diagnostics")],D);var Rp=Object.defineProperty,Np=Object.getOwnPropertyDescriptor,Ke=(e,t,s,i)=>{for(var a=i>1?void 0:i?Np(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&Rp(t,s,a),a};const Bp=[{name:"כניסה ראשית",gb:320},{name:"אולם",gb:410},{name:"חצר אחורית",gb:380},{name:"לובי",gb:180},{name:"מחסן",gb:96}];let Ae=class extends ${constructor(){super(...arguments),this.range="30D",this.data=null,this.error="",this.loading=!1,this.tz="Asia/Jerusalem",this.signing=null,this.signingError="",this.signingBusy=!1,this.rotateConfirm=!1}connectedCallback(){super.connectedCallback(),g()&&(this.load(),this.loadSigning())}async load(e=!1){this.loading=!0,this.error="";try{const[t,s]=await Promise.all([Ve(),kr(e)]);this.tz=t["time.zone"]??this.tz,this.data=s}catch(t){this.error=w(t)}finally{this.loading=!1}}fmt(e){return e?new Intl.DateTimeFormat("he-IL",{timeZone:this.tz,dateStyle:"short",timeStyle:"short"}).format(new Date(e)):"—"}async loadSigning(){try{this.signing=await Rd(),this.signingError=""}catch(e){this.signingError=w(e)}}async rotateKey(){this.signingBusy=!0;try{this.signing=await Nd(),this.rotateConfirm=!1}catch(e){this.signingError=w(e)}finally{this.signingBusy=!1}}renderSigning(){const e=this.signing,t=s=>s?s.replace("T"," ").replace("Z"," UTC"):"—";return r`<sw-card heading="חתימת ראיות" subheading="כל חבילת ראיות חתומה ב־Ed25519 במפתח הפעיל של המתקן; החלק הפרטי נשאר ב־/data/keys ואינו נכלל בגיבוי" data-signing>
      ...
      <sw-page heading="אחסון ותוכנית הקלטה" subheading="קריאה בלבד מה־NVR · נמדד לעומת אומדן, עם הסיבה לכל מספר · אין format, RAID או מחיקה מכאן">
        ...
        ${e.nvr.configured?e.nvr.reachable?r`
                <div class="kpis" data-storage-kpis>
                  <sw-card flush class="kpi"><div><div class="v">${kt(t?.used_mb)}</div><div class="l">בשימוש (נמדד מה־NVR)</div></div><div class="ic"><sw-icon name="storage" size=${16}></sw-icon></div></sw-card>
                  <sw-card flush class="kpi"><div><div class="v">${kt(t?.capacity_mb)}</div><div class="l">קיבולת · ${t?.disks??0} דיסקים${t?.nas?` · ${t.nas} NAS`:""} · מצב ${e.work_mode??"?"}</div></div><div class="ic"><sw-icon name="cpu" size=${16}></sw-icon></div></sw-card>
                  <sw-card flush class="kpi"><div><div class="v">${t?.used_pct==null?"—":`${t.used_pct}%`}</div><div class="l">ניצולת · פנוי ${kt(t?.free_mb)}</div></div><svg viewBox="0 0 40 40" aria-hidden="true">${h`<circle cx="20" cy="20" r=${i} fill="none" stroke="var(--sw-surface-3)" stroke-width="6" /><circle cx="20" cy="20" r=${i} fill="none" stroke="var(--sw-accent)" stroke-width="6" stroke-linecap="round" stroke-dasharray=${`${a*n/100} ${a}`} transform="rotate(-90 20 20)" />`}</svg></sw-card>
                </div>
                  ...
                  <div>
                    <sw-card heading="דיסקים" subheading=${`${t?.disks_ok??0} מתוך ${(t?.disks??0)+(t?.nas??0)} תקינים`}>
                      <div class="tbl disks" data-storage-disks>
                        ...
                        ${[...e.disks,...e.nas].map(l=>r`<div class="r" data-storage-disk><span>${l.name}${l.path?r`<small>${l.path}</small>`:c}</span><span>${l.kind}</span><span><sw-badge kind=${l.status==="ok"?"recorded":"error"} label=${l.status}></sw-badge></span><span class="num">${kt(l.capacity_mb)}</span><span class="num">${kt(l.free_mb)}</span><span>${l.property}</span></div>`)}
                      </div>
                    </sw-card>
                    ${this.renderSigning()}
    ...
    `}render(){if(g())return this.renderApi();const e=[.3,.36,.45,.5,.58,.63,.7],t=600,s=200,i=f=>f/(e.length-1)*420,a=f=>170-f*150,n=e.map((f,v)=>`${v===0?"M":"L"}${i(v)} ${a(f)}`).join(" "),o=`M${i(e.length-1)} ${a(.7)} L520 ${a(.86)} L${t} ${a(1)}`,l=16,p=2*Math.PI*l,m=410;return r`
      <sw-page heading="אנליטיקת אחסון" subheading="Beta · ניטור שימוש, תכנון קדימה ושליטה · נתון נמדד לעומת אומדן מסומן · אין format או RAID · נתוני הדגמה">
        ...
        <sw-card heading="תחזית שימוש באחסון" subheading="עד הקו: נתון נמדד · אחרי הקו: אומדן (אינו תחזית פשוטה של דיסק מתמלא)">
          <svg class="trend" viewBox="0 0 ${t} ${s}" preserveAspectRatio="none" role="img" aria-label="תחזית אחסון">
            ${h`
              ${[.25,.5,.75,1].map(f=>h`<line x1="0" x2=${t} y1=${a(f)} y2=${a(f)} stroke="var(--sw-border)" />`)}
              ...
              ${["ינו","פבר","מרץ","אפר","מאי","יונ","יול"].map((f,v)=>h`<text x=${i(v)} y="190" font-size="10" text-anchor="middle" fill="var(--sw-text-3)" font-family="var(--sw-font)">${f}</text>`)}
              ${["0.5 TB","1 TB","1.5 TB","1.9 TB"].map((f,v)=>h`<text x="4" y=${a(.25*(v+1))-3} font-size="9.5" fill="var(--sw-text-3)" font-family="var(--sw-font)">${f}</text>`)}
            `}
          </svg>
        </sw-card>
        <div class="grid">
          <sw-card heading="שימוש באחסון לפי מצלמה" subheading="נמדד · לפני retention">
            ${Bp.map(f=>r`<div class="cam"><span>${f.name}</span><span class="bar"><i style="--p:${f.gb/m*100}%"></i></span><span class="gb ltr">${f.gb} GB</span></div>`)}
      ...
      <sw-page heading="כל המסכים (סקירת עיצוב)" subheading="29 מסכים על נתוני הדגמה · SC29/SC30 הם אותם מסכים ברוחב טלפון · SC32 (Lovelace) הוא עטיפה של אותם רכיבים">
        ...
        <div class="groups">
          ${Vp.map(e=>r`<sw-card heading=${e.mode}>
              ${e.items.map(t=>r`<a href=${t.route}><span class="sc">${t.sc}</span><span class="name">${t.name}</span><span class="board">${t.board}</span><sw-badge kind=${jp[t.phase]} label=${t.phase}></sw-badge><sw-icon name="chevron" size=${12}></sw-icon></a>`)}
            </sw-card>`)}
        </div>
      </sw-page>
    `}};Bi.styles=x`
  ...
  `;Bi=Hp([k("screens-index")],Bi);var Fp=Object.getOwnPropertyDescriptor,Up=(e,t,s,i)=>{for(var a=i>1?void 0:i?Fp(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=o(a)||a);return a};const Wp=[["--sw-bg","רקע"],["--sw-surface","משטח"],["--sw-surface-3","משטח 3"],["--sw-border","גבול"],["--sw-text","טקסט"],["--sw-text-2","טקסט משני"],["--sw-text-3","טקסט שלישי"],["--sw-accent","כחול"],["--sw-accent-soft","כחול רך"],["--sw-live","חי"],["--sw-offline","מנותק"],["--sw-stale","מיושן"],["--sw-danger","שגיאה"],["--sw-purple","סגול (דלת)"]],Zp=["live","recorded","historic","offline","stale","partial","unknown","forbidden","error"],qp=["loading","empty","error","forbidden","stale","partial"],Kp=["entrance","lobby","corridor","hall","parking","warehouse","backyard","driveway","night","building","house"],Gp=["dashboard","building","camera","bell","history","system","search","user","play","pause","back10","forward10","aperture","volume","mic","expand","close","chevron","chevronDown","warning","info","lock","unlock","offline","refresh","layers","floor","plus","minus","fit","door","light","sensor","check","clock","download","pin","more","map","upload","list","target","filter","users","shield","storage","edit","case","rule","link","grid","home","star","calendar","trash","eye","cpu","activity","image","wifi","signal","move","bookmark","route"];let Li=class extends ${render(){return r`
      ...
      <h3>צבעים</h3>
      <div class="swatches">
        ${Wp.map(([e,t])=>r`<div class="swatch"><div class="c" style="background:var(${e})"></div><div class="n"><span>${t}</span><span class="ltr">${e}</span></div></div>`)}
      </div>
      ...
      <div class="scenes">${Kp.map(e=>r`<div><sw-scene kind=${e}></sw-scene><span>${e}</span></div>`)}</div>
      ...
      <div class="row">${Zp.map(e=>r`<sw-badge kind=${e}></sw-badge>`)}</div>

      <h3>ציר זמן, שלבים, קומות איזומטריות</h3>
      <sw-timeline .segments=${js} .events=${[{minute:614,kind:"person",label:"אדם"},{minute:582,kind:"vehicle",label:"רכב"}]} .cursor=${615}></sw-timeline>
      ...
      <h3>מצבי מסך</h3>
      <div class="grid">
        ${qp.map(e=>r`<div class="panel"><sw-state-panel state=${e} actionLabel=${e==="error"?"נסה שוב":""}></sw-state-panel></div>`)}
      </div>

      <h3>אייקונים</h3>
      <div class="icons">${Gp.map(e=>r`<div class="icon"><sw-icon .name=${e} size=${18}></sw-icon><span class="ltr">${e}</span></div>`)}</div>
    `}};Li.styles=x`
    :host {
      display: block;
...
`):"כל הרכיבים שהתוסף רואה עובדים";return r`<button class="status-a sys ${t.status} ${e?"":"b"}" data-sys-pill data-status=${t.status} title=${a} aria-label=${`מצב המערכת: ${i}`} @click=${()=>window.location.hash="#/system/diagnostics?tab=health"}><i></i>${i}</button>`}renderSysBanner(){const e=this.sys;if(!e||e.status!=="error")return c;const t=e.items.filter(s=>s.status==="error");return r`<div class="sysbanner" role="alert" data-sys-banner><sw-icon name="warning" size=${16}></sw-icon><span>${t.map(s=>s.label).join(" · ")}</span><a href="#/system/diagnostics?tab=health">לבריאות המערכת</a></div>`}onSearchInput(e){const t=e.target.value;if(this.searchQ=t,window.clearTimeout(this.searchTimer),!t.trim()){this.searchResults=[],this.searchOpen=!1;return}this.searchTimer=window.setTimeout(()=>void this.runSearch(t),180)}async runSearch(e){if(!g()){this.searchResults=[],this.searchOpen=!0;return}const t=++this.searchSeq;this.searchBusy=!0;try{const s=await Cc(e,6);if(t!==this.searchSeq)return;this.searchResults=s.results,this.searchIndex=s.results.length?0:-1,this.searchOpen=!0}catch{t===this.searchSeq&&(this.searchResults=[],this.searchOpen=!0)}finally{t===this.searchSeq&&(this.searchBusy=!1)}}onSearchKey(e){if(e.key==="Escape"){this.closeSearch(),e.target.blur();return}if(!this.searchOpen||!this.searchResults.length){e.key==="Enter"&&this.searchQ.trim()&&this.runSearch(this.searchQ);return}if(e.key==="ArrowDown")e.preventDefault(),this.searchIndex=(this.searchIndex+1)%this.searchResults.length;else if(e.key==="ArrowUp")e.preventDefault(),this.searchIndex=(this.searchIndex-1+this.searchResults.length)%this.searchResults.length;else if(e.key==="Enter"){e.preventDefault();const t=this.searchResults[this.searchIndex]??this.searchResults[0];t&&this.openResult(t)}}openResult(e){this.closeSearch();const t=this.renderRoot.querySelector(".search input");t&&(t.value="",t.blur()),this.searchQ="",this.searchResults=[],window.location.hash=`#${e.route}`}closeSearch(){this.searchOpen=!1,this.searchIndex=-1}redirectDemo(e){if(this.enforceKiosk(e))return!0;const t=eh(e.path,this.session.mode==="api");return t?(window.location.replace(`#${t}`),!0):!1}get kioskOnly(){const e=(this.session.me?.bindings??[]).filter(t=>t.effect!=="deny");return this.session.mode==="api"&&e.length>0&&e.every(t=>t.role_id==="kiosk")}enforceKiosk(e){return!this.kioskOnly||e.segments[0]==="kiosk"?!1:(window.location.replace("#/kiosk/all"),!0)}get gated(){return this.session.mode==="no_access"||this.session.mode==="unauthenticated"}renderSearch(e){if(this.gated)return c;const t=this.searchOpen&&!!this.searchQ.trim();return r`<span class="searchwrap ${e?"a":""}">
      ...
      <main>
        ${this.renderGate()||r`
          <div class="subnav">${t.length>1&&!s?r`<sw-tabs .items=${t} .active=${Nr(this.route)}></sw-tabs>`:c}</div>
          <div class="screen">${this.session.mode==="loading"?c:this.renderScreen()}</div>`}
      </main>
      <nav class="bottom" aria-label="ניווט ראשי">
        ${Hi.map(o=>r`<a class=${ot({active:e===o.id})} href=${o.href}><sw-icon .name=${o.icon} size=${20}></sw-icon>${o.label}</a>`)}
      </nav>
    `}embedded(e=this.route){if(e?.params.get("embed")==="1")return!0;try{return sessionStorage.getItem("sw-embed")==="1"}catch{return!1}}render(){if(this.route?.segments[0]==="kiosk")return r`<main style="block-size:100dvh">${this.renderScreen()}</main>`;if(this.embedded())return r`<main class="embed" style="block-size:100dvh;overflow:auto">${this.renderScreen()}</main>`;if(this.design==="a")return this.renderA();const t=Or(this.route),s=t?Ka(Yp[t],this.session.mode==="api"):[],i=this.route?.segments[3]==="edit"||this.route?.segments[3]==="import";return r`
      <nav class="rail" aria-label="ניווט ראשי">
        <div class="brand">
          <img src="${"./"}brand/smplwise-mark.png" alt="SmplWise" />
          <span class="name">SmplWise</span>
        </div>
        ${qa.map(a=>r`<a class=${ot({item:!0,active:t===a.id})} href=${a.href} title=${a.label} aria-current=${t===a.id?"page":"false"}>
            <sw-icon .name=${a.icon} size=${16}></sw-icon><span>${a.label}</span>
          </a>`)}
        <div class="grow"></div>
        ${this.gated?c:r`<a class=${ot({item:!0,small:!0,active:this.route?.segments[0]==="screens"})} href="#/screens" title="כל המסכים">
          <sw-icon name="list" size=${14}></sw-icon><span>כל המסכים</span>
        </a>
        <a class=${ot({item:!0,small:!0,active:this.route?.segments[0]==="styleguide"})} href="#/styleguide" title=${y("nav.styleguide")}>
      ...
      <main>
        ${this.renderGate()||r`
          <div class="subnav">${s.length>1&&!i?r`<sw-tabs .items=${s} .active=${Jp(this.route)}></sw-tabs>`:c}</div>
          <div class="screen">${this.session.mode==="loading"?c:this.renderScreen()}</div>`}
      </main>
      <nav class="bottom" aria-label="ניווט ראשי">
        ${qa.slice(0,4).map(a=>r`<a class=${ot({active:t===a.id})} href=${a.href}><sw-icon .name=${a.icon} size=${20}></sw-icon>${a.label}</a>`)}
        <a class=${ot({active:t==="settings"||t==="playback"})} href="#/system/diagnostics"><sw-icon name="more" size=${20}></sw-icon>עוד</a>
      </nav>
    `}};Ie.styles=x`
    :host {
      display: grid;
  ...
  `;Ge([d()],Ie.prototype,"route",2);Ge([d()],Ie.prototype,"session",2);Ge([d()],Ie.prototype,"design",2);Ge([d()],Ie.prototype,"sys",2);Ge([d()],Ie.prototype,"searchQ",2);Ge([d()],Ie.prototype,"searchResults",2);Ge([d()],Ie.prototype,"searchOpen",2);Ge([d()],Ie.prototype,"searchIndex",2);Ge([d()],Ie.prototype,"searchBusy",2);Ie=Ge([k("sw-app")],Ie);
//# sourceMappingURL=index-B45uySZM.js.map
