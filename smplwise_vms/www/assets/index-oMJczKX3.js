 ...
 */const nt=pn(class extends hn{constructor(e){if(super(e),e.type!==cn.ATTRIBUTE||e.name!=="class"||e.strings?.length>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(e){return" "+Object.keys(e).filter(t=>e[t]).join(" ")+" "}update(e,[t]){if(this.st===void 0){this.st=new Set,e.strings!==void 0&&(this.nt=new Set(e.strings.join(" ").split(/\s/).filter(i=>i!=="")));for(const i in t)t[i]&&!this.nt?.has(i)&&this.st.add(i);return this.render(t)}const s=e.element.classList;for(const i of this.st)i in t||(s.remove(i),this.st.delete(i));for(const i in t){const a=!!t[i];a===this.st.has(i)||this.nt?.has(i)||(a?(s.add(i),this.st.add(i)):(s.remove(i),this.st.delete(i)))}return Mt}});var un=Object.defineProperty,fn=Object.getOwnPropertyDescriptor,Ys=(e,t,s,i)=>{for(var a=i>1?void 0:i?fn(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&un(t,s,a),a};const ua={live:h`<circle cx="12" cy="12" r="3"/><path d="M6.3 6.3a8 8 0 0 0 0 11.4M17.7 6.3a8 8 0 0 1 0 11.4M3.5 3.5a12 12 0 0 0 0 17M20.5 3.5a12 12 0 0 1 0 17"/>`,explore:h`<path d="M3 6.5 9 4l6 2.5 6-2.5v13.5L15 20l-6-2.5L3 20z"/><path d="M9 4v13.5M15 6.5V20"/>`,investigate:h`<circle cx="11" cy="11" r="6.5"/><path d="m20 20-4.3-4.3M11 8v3l2 1.5"/>`,system:h`<circle cx="12" cy="12" r="3"/><path d="M19.4 15a1.7 1.7 0 0 0 .3 1.8l.1.1a2 2 0 1 1-2.8 2.8l-.1-.1a1.7 1.7 0 0 0-1.8-.3 1.7 1.7 0 0 0-1 1.5V21a2 2 0 1 1-4 0v-.1a1.7 1.7 0 0 0-1.1-1.5 1.7 1.7 0 0 0-1.8.3l-.1.1a2 2 0 1 1-2.8-2.8l.1-.1a1.7 1.7 0 0 0 .3-1.8 1.7 1.7 0 0 0-1.5-1H3a2 2 0 1 1 0-4h.1a1.7 1.7 0 0 0 1.5-1.1 1.7 1.7 0 0 0-.3-1.8l-.1-.1a2 2 0 1 1 2.8-2.8l.1.1a1.7 1.7 0 0 0 1.8.3H9a1.7 1.7 0 0 0 1-1.5V3a2 2 0 1 1 4 0v.1a1.7 1.7 0 0 0 1 1.5 1.7 1.7 0 0 0 1.8-.3l.1-.1a2 2 0 1 1 2.8 2.8l-.1.1a1.7 1.7 0 0 0-.3 1.8V9a1.7 1.7 0 0 0 1.5 1H21a2 2 0 1 1 0 4h-.1a1.7 1.7 0 0 0-1.5 1z"/>`,camera:h`<path d="M3 8.5A1.5 1.5 0 0 1 4.5 7H8l1.5-2h5L16 7h3.5A1.5 1.5 0 0 1 21 8.5v9a1.5 1.5 0 0 1-1.5 1.5h-15A1.5 1.5 0 0 1 3 17.5z"/><circle cx="12" cy="13" r="3.5"/>`,search:h`<circle cx="11" cy="11" r="6.5"/><path d="m20 20-4.3-4.3"/>`,bell:h`<path d="M6 16V11a6 6 0 0 1 12 0v5l1.5 2h-15z"/><path d="M10 20a2 2 0 0 0 4 0"/>`,user:h`<circle cx="12" cy="8" r="4"/><path d="M4 21a8 8 0 0 1 16 0"/>`,play:h`<path d="M7 5v14l11-7z"/>`,expand:h`<path d="M15 4h5v5M9 20H4v-5M20 4l-6 6M4 20l6-6"/>`,close:h`<path d="M6 6l12 12M18 6 6 18"/>`,chevron:h`<path d="m9 6 6 6-6 6"/>`,warning:h`<path d="M12 3 2.5 20h19z"/><path d="M12 9v5M12 17h.01"/>`,info:h`<circle cx="12" cy="12" r="9"/><path d="M12 11v5M12 8h.01"/>`,lock:h`<rect x="5" y="11" width="14" height="10" rx="2"/><path d="M8 11V7a4 4 0 0 1 8 0v4"/>`,unlock:h`<rect x="5" y="11" width="14" height="10" rx="2"/><path d="M8 11V7a4 4 0 0 1 7.5-2"/>`,offline:h`<path d="M2 8.5a15 15 0 0 1 20 0M5.5 12a10 10 0 0 1 13 0M9 15.5a5 5 0 0 1 6 0"/><path d="M12 19h.01"/><path d="M3 3l18 18"/>`,refresh:h`<path d="M20 12a8 8 0 1 1-2.3-5.7"/><path d="M20 4v5h-5"/>`,layers:h`<path d="m12 3 9 5-9 5-9-5z"/><path d="m3 13 9 5 9-5M3 17.5l9 5 9-5"/>`,floor:h`<path d="M4 6h16M4 12h16M4 18h16"/><path d="M8 3v18"/>`,plus:h`<path d="M12 5v14M5 12h14"/>`,minus:h`<path d="M5 12h14"/>`,fit:h`<path d="M4 9V4h5M20 9V4h-5M4 15v5h5M20 15v5h-5"/>`,door:h`<rect x="6" y="3" width="12" height="18" rx="1"/><path d="M14 12h.01"/>`,light:h`<path d="M9 18h6M10 21h4"/><path d="M12 3a6 6 0 0 0-3.5 10.9c.8.6 1.5 1.6 1.5 2.6h4c0-1 .7-2 1.5-2.6A6 6 0 0 0 12 3z"/>`,sensor:h`<circle cx="12" cy="12" r="2"/><path d="M7.8 7.8a6 6 0 0 0 0 8.4M16.2 7.8a6 6 0 0 1 0 8.4M4.9 4.9a10 10 0 0 0 0 14.2M19.1 4.9a10 10 0 0 1 0 14.2"/>`,check:h`<path d="m5 12 5 5 9-10"/>`,clock:h`<circle cx="12" cy="12" r="9"/><path d="M12 7v5l3 2"/>`,download:h`<path d="M12 4v11M7 10l5 5 5-5M4 20h16"/>`,pin:h`<path d="M9 4h6l-1 6 3 3v2H7v-2l3-3z"/><path d="M12 15v6"/>`,more:h`<circle cx="6" cy="12" r="1.3"/><circle cx="12" cy="12" r="1.3"/><circle cx="18" cy="12" r="1.3"/>`,building:h`<rect x="4" y="3" width="16" height="18" rx="1"/><path d="M9 7h2M13 7h2M9 11h2M13 11h2M9 15h2M13 15h2M10 21v-3h4v3"/>`,map:h`<path d="M3 6.5 9 4l6 2.5 6-2.5v13.5L15 20l-6-2.5L3 20z"/>`,upload:h`<path d="M12 16V5M7 10l5-5 5 5M4 20h16"/>`,list:h`<path d="M8 6h13M8 12h13M8 18h13M3 6h.01M3 12h.01M3 18h.01"/>`,history:h`<path d="M3 12a9 9 0 1 0 3-6.7"/><path d="M3 4v5h5M12 8v4l3 2"/>`,target:h`<circle cx="12" cy="12" r="8"/><circle cx="12" cy="12" r="3"/><path d="M12 2v4M12 18v4M2 12h4M18 12h4"/>`,filter:h`<path d="M4 5h16l-6 8v6l-4-2v-4z"/>`,users:h`<circle cx="9" cy="8" r="3.5"/><path d="M2.5 20a6.5 6.5 0 0 1 13 0"/><circle cx="17" cy="9" r="2.5"/><path d="M15.5 14.5A5 5 0 0 1 21.5 20"/>`,shield:h`<path d="M12 3 4 6v6c0 4.5 3.4 7.7 8 9 4.6-1.3 8-4.5 8-9V6z"/><path d="m9 12 2 2 4-4"/>`,storage:h`<rect x="3" y="4" width="18" height="6" rx="1.5"/><rect x="3" y="14" width="18" height="6" rx="1.5"/><path d="M7 7h.01M7 17h.01"/>`,edit:h`<path d="M4 20h4l10.5-10.5a2 2 0 0 0 0-2.8l-1.2-1.2a2 2 0 0 0-2.8 0L4 16z"/><path d="m13 7 4 4"/>`,pause:h`<path d="M8 5v14M16 5v14"/>`,skip:h`<path d="M5 5v14l8-7zM15 5h2v14h-2z"/>`,case:h`<rect x="3" y="7" width="18" height="13" rx="2"/><path d="M8 7V5a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2M3 12h18"/>`,rule:h`<path d="M4 6h10M4 12h16M4 18h7"/><circle cx="18" cy="6" r="2"/><circle cx="15" cy="18" r="2"/>`,link:h`<path d="M10 14a4 4 0 0 0 5.7 0l3-3a4 4 0 0 0-5.7-5.7l-1 1"/><path d="M14 10a4 4 0 0 0-5.7 0l-3 3a4 4 0 0 0 5.7 5.7l1-1"/>`,grid:h`<rect x="3" y="3" width="7" height="7" rx="1.5"/><rect x="14" y="3" width="7" height="7" rx="1.5"/><rect x="3" y="14" width="7" height="7" rx="1.5"/><rect x="14" y="14" width="7" height="7" rx="1.5"/>`,dashboard:h`<rect x="3" y="3" width="8" height="10" rx="1.5"/><rect x="13" y="3" width="8" height="6" rx="1.5"/><rect x="13" y="11" width="8" height="10" rx="1.5"/><rect x="3" y="15" width="8" height="6" rx="1.5"/>`,home:h`<path d="M3 11 12 4l9 7"/><path d="M5 10v10h14V10"/><path d="M10 20v-6h4v6"/>`,star:h`<path d="m12 3 2.8 5.7 6.2.9-4.5 4.4 1 6.2-5.5-2.9L6.5 20.2l1-6.2L3 9.6l6.2-.9z"/>`,aperture:h`<circle cx="12" cy="12" r="9"/><path d="m14.3 4.5-5 8.6M20.7 9.5H10.8M18.4 17.5l-5-8.6M9.7 19.5l5-8.6M3.3 14.5h9.9M5.6 6.5l5 8.6"/>`,volume:h`<path d="M4 9.5v5h3.5L12 18.5v-13L7.5 9.5z"/><path d="M15.5 8.5a5 5 0 0 1 0 7M18.5 5.5a9 9 0 0 1 0 13"/>`,mic:h`<rect x="9" y="3" width="6" height="11" rx="3"/><path d="M5.5 11a6.5 6.5 0 0 0 13 0M12 17.5V21M9 21h6"/>`,back10:h`<path d="M4 12a8 8 0 1 0 2.3-5.7"/><path d="M4 4v5h5"/><path d="M10.5 15.5V10l-1.5 1"/><rect x="13.5" y="10" width="3.5" height="5.5" rx="1.7"/>`,forward10:h`<path d="M20 12a8 8 0 1 1-2.3-5.7"/><path d="M20 4v5h-5"/><path d="M10.5 15.5V10l-1.5 1"/><rect x="13.5" y="10" width="3.5" height="5.5" rx="1.7"/>`,chevronDown:h`<path d="m6 9 6 6 6-6"/>`,stairs:h`<path d="M3 20h4v-4h4v-4h4V8h5"/>`,elevator:h`<rect x="4" y="3" width="16" height="18" rx="1.5"/><path d="M12 3v18M8 10l1.5-2 1.5 2M14.5 14l1.5 2 1.5-2"/>`,menu:h`<path d="M4 7h16M4 12h16M4 17h16"/>`,calendar:h`<rect x="3" y="5" width="18" height="16" rx="2"/><path d="M3 10h18M8 3v4M16 3v4"/>`,trash:h`<path d="M4 7h16M9 7V4h6v3M6 7l1 13h10l1-13"/>`,eye:h`<path d="M2 12s3.5-6 10-6 10 6 10 6-3.5 6-10 6S2 12 2 12z"/><circle cx="12" cy="12" r="3"/>`,cpu:h`<rect x="6" y="6" width="12" height="12" rx="2"/><rect x="9" y="9" width="6" height="6"/><path d="M9 2v4M15 2v4M9 18v4M15 18v4M2 9h4M2 15h4M18 9h4M18 15h4"/>`,activity:h`<path d="M3 12h4l3-8 4 16 3-8h4"/>`,image:h`<rect x="3" y="4" width="18" height="16" rx="2"/><circle cx="8.5" cy="9.5" r="1.5"/><path d="m21 16-5-5-9 9"/>`,wifi:h`<path d="M2 8.5a15 15 0 0 1 20 0M5.5 12a10 10 0 0 1 13 0M9 15.5a5 5 0 0 1 6 0"/><path d="M12 19h.01"/>`,signal:h`<path d="M4 18v-3M9 18v-7M14 18V7M19 18V4"/>`,move:h`<path d="M12 3v18M3 12h18M8 7l4-4 4 4M8 17l4 4 4-4M7 8l-4 4 4 4M17 8l4 4-4 4"/>`,bookmark:h`<path d="M6 3h12v18l-6-4-6 4z"/>`,route:h`<circle cx="6" cy="18" r="2.5"/><circle cx="18" cy="6" r="2.5"/><path d="M8 17c5-1 3-9 8-10"/>`,logout:h`<path d="M10 4H5v16h5M14 8l4 4-4 4M18 12H9"/>`};let Ht=class extends ${constructor(){super(...arguments),this.name="info",this.size=20,this.flip=!1}render(){this.style.setProperty("--sw-icon-size",`${this.size}px`);const e=this.name==="chevron";return r`<svg viewBox="0 0 24 24" aria-hidden="true" ?data-dir=${e}>${ua[this.name]??ua.info}</svg>`}};Ht.styles=x`
  ...
  `;Ys([u()],Ht.prototype,"name",2);Ys([u({type:Number})],Ht.prototype,"size",2);Ys([u({type:Boolean,reflect:!0})],Ht.prototype,"flip",2);Ht=Ys([k("sw-icon")],Ht);var mn=Object.defineProperty,wn=Object.getOwnPropertyDescriptor,st=(e,t,s,i)=>{for(var a=i>1?void 0:i?wn(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&mn(t,s,a),a};let Oe=class extends ${constructor(){super(...arguments),this.variant="secondary",this.size="md",this.disabled=!1,this.iconOnly=!1,this.round=!1,this.label="",this.type="button"}render(){return r`
  ...
  `;$s([u({attribute:!1})],At.prototype,"items",2);$s([u()],At.prototype,"active",2);$s([u({type:Boolean,reflect:!0})],At.prototype,"segmented",2);$s([u({type:Boolean,reflect:!0})],At.prototype,"underline",2);At=$s([k("sw-tabs")],At);var kn=Object.defineProperty,_n=Object.getOwnPropertyDescriptor,qi=(e,t,s,i)=>{for(var a=i>1?void 0:i?_n(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&kn(t,s,a),a};let fs=class extends ${constructor(){super(...arguments),this.name="",this.size=32}render(){this.style.setProperty("--sz",`${this.size}px`);const e=this.name.trim().split(/\s+/),t=e.length>1?e[0][0]+e[1][0]:this.name.slice(0,2);return r`${t}`}};fs.styles=x`
    :host {
      display: inline-grid;
      place-items: center;
  ...
  `;qi([u()],fs.prototype,"name",2);qi([u({type:Number})],fs.prototype,"size",2);fs=qi([k("sw-avatar")],fs);var zn=Object.defineProperty,Sn=Object.getOwnPropertyDescriptor,xs=(e,t,s,i)=>{for(var a=i>1?void 0:i?Sn(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&zn(t,s,a),a};let It=class extends ${constructor(){super(...arguments),this.selected=!1,this.dot=""}render(){return r`
  ...
  `;xs([u({type:Boolean,reflect:!0})],It.prototype,"selected",2);xs([u()],It.prototype,"icon",2);xs([u({type:Number})],It.prototype,"count",2);xs([u()],It.prototype,"dot",2);It=xs([k("sw-chip")],It);var Mn=Object.defineProperty,An=Object.getOwnPropertyDescriptor,Xs=(e,t,s,i)=>{for(var a=i>1?void 0:i?An(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&Mn(t,s,a),a};let jt=class extends ${constructor(){super(...arguments),this.open=!1,this.heading="",this.subheading=""}close(){this.open=!1,this.dispatchEvent(new CustomEvent("close",{bubbles:!0,composed:!0}))}render(){return r`
  ...
  `;ue([u()],ne.prototype,"cameraId",2);ue([u()],ne.prototype,"profile",2);ue([u()],ne.prototype,"mode",2);ue([u()],ne.prototype,"poster",2);ue([u({type:Boolean})],ne.prototype,"active",2);ue([u({type:Boolean,reflect:!0})],ne.prototype,"compact",2);ue([u()],ne.prototype,"wsUrl",2);ue([u({type:Boolean})],ne.prototype,"retry",2);ue([u({type:Boolean})],ne.prototype,"recorded",2);ue([d()],ne.prototype,"status",2);ue([d()],ne.prototype,"transport",2);ue([d()],ne.prototype,"error",2);ue([d()],ne.prototype,"muted",2);ue([qt("video")],ne.prototype,"video",2);ne=ue([k("sw-live-player")],ne);var Qn=Object.defineProperty,eo=Object.getOwnPropertyDescriptor,fe=(e,t,s,i)=>{for(var a=i>1?void 0:i?eo(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&Qn(t,s,a),a};let oe=class extends ${constructor(){super(...arguments),this.name="",this.meta="",this.state="unknown",this.scene="lobby",this.selected=!1,this.compact=!1,this.dark=!1,this.noDemo=!1,this.stamp="",this.poster="",this.cameraId="",this.live=!1,this.profile="sub",this.transport="auto"}offMessage(){return this.state==="forbidden"?"אין הרשאת צפייה":this.state==="offline"?"המצלמה מנותקת":"מצב לא ידוע"}render(){if(this.state==="offline"||this.state==="forbidden"||this.state==="unknown")return r`<div class="off">
  ...
  `;Yt([u({reflect:!0})],pt.prototype,"state",2);Yt([u()],pt.prototype,"heading",2);Yt([u()],pt.prototype,"hint",2);Yt([u()],pt.prototype,"actionLabel",2);Yt([u({type:Boolean,reflect:!0})],pt.prototype,"compact",2);pt=Yt([k("sw-state-panel")],pt);var ao=Object.defineProperty,ro=Object.getOwnPropertyDescriptor,ei=(e,t,s,i)=>{for(var a=i>1?void 0:i?ro(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&ao(t,s,a),a};let Ut=class extends ${constructor(){super(...arguments),this.open=!1,this.heading="",this.subheading="",this.onKey=e=>{e.key==="Escape"&&this.open&&this.close()}}close(){this.open=!1,this.dispatchEvent(new CustomEvent("close",{bubbles:!0,composed:!0}))}connectedCallback(){super.connectedCallback(),window.addEventListener("keydown",this.onKey)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("keydown",this.onKey)}render(){return r`<div class="backdrop" @click=${e=>e.target===e.currentTarget&&this.close()}>
  ...
  `;ei([u({type:Boolean,reflect:!0})],Ut.prototype,"open",2);ei([u()],Ut.prototype,"heading",2);ei([u()],Ut.prototype,"subheading",2);Ut=ei([k("sw-dialog")],Ut);var no=Object.defineProperty,oo=Object.getOwnPropertyDescriptor,j=(e,t,s,i)=>{for(var a=i>1?void 0:i?oo(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&no(t,s,a),a};const oi=.2,li=6,fa={live:"var(--sw-accent)",recorded:"var(--sw-accent)",historic:"var(--sw-accent)",offline:"var(--sw-offline)",stale:"var(--sw-stale)",unknown:"var(--sw-unknown)",forbidden:"var(--sw-forbidden)",error:"var(--sw-danger)",neutral:"var(--sw-surface)",partial:"var(--sw-stale)"},lo={camera:h`<path d="M-7 -4.5A1.5 1.5 0 0 1 -5.5 -6H-2l1.5-2h5L6 -6h1.5A1.5 1.5 0 0 1 9 -4.5v9A1.5 1.5 0 0 1 7.5 6h-13A1.5 1.5 0 0 1 -7 4.5z" transform="translate(-1 0) scale(0.9)"/><circle cx="-1" cy="0" r="3"/>`,lock:h`<rect x="-6" y="-2" width="12" height="9" rx="2"/><path d="M-3.5 -2v-3a3.5 3.5 0 0 1 7 0v3"/>`,light:h`<path d="M-3 6h6M-2 8.5h4"/><path d="M0 -8a5 5 0 0 0-3 9c.7.5 1.2 1.3 1.2 2.2h3.6c0-.9.5-1.7 1.2-2.2A5 5 0 0 0 0 -8z"/>`,binary_sensor:h`<circle cx="0" cy="0" r="2"/><path d="M-4.5 -4.5a6.4 6.4 0 0 0 0 9M4.5 -4.5a6.4 6.4 0 0 1 0 9"/>`};function co(e){let t=0,s=0,i=0;for(let a=0;a<e.length;a++){const n=e[a],o=e[(a+1)%e.length],l=n.x*o.y-o.x*n.y;t+=l,s+=(n.x+o.x)*l,i+=(n.y+o.y)*l}if(Math.abs(t)<1e-12){const a=e.length||1;return{x:e.reduce((n,o)=>n+o.x,0)/a,y:e.reduce((n,o)=>n+o.y,0)/a}}return{x:s/(3*t),y:i/(3*t)}}let C=class extends ${constructor(){super(...arguments),this.planWidth=1e3,this.planHeight=700,this.plan=null,this.markers=[],this.selectedId=null,this.selectedIds=[],this.dimEntities=!1,this.alwaysLabel=!1,this.imageUrl=null,this.editable=!1,this.placing=!1,this.coneRadius=140,this.zones=[],this.selectedZoneId=null,this.zoneLabels=!0,this.draftPoints=[],this.boxSelect=!1,this.box=null,this.boxStart=null,this.scale=1,this.tx=0,this.ty=0,this.hoverId=null,this.dragging=null,this.orienting=null,this.zoneDraft=null,this.lastVertexPress=null,this.pointers=new Map,this.lastPan=null,this.lastPinchDist=0,this.dragMoved=!1,this.fitted=!1,this.minScale=oi,this.onWheel=e=>{e.preventDefault();const t=this.getBoundingClientRect();this.zoomBy(e.deltaY<0?1.15:1/1.15,e.clientX-t.left,e.clientY-t.top)},this.onMarkerPointerDown=(e,t)=>{if(!this.editable||t.button!==0)return;t.stopPropagation(),t.preventDefault(),this.dragging={id:e.id,x:e.x,y:e.y},this.viewport.setPointerCapture(t.pointerId);const s=a=>{const n=this.getBoundingClientRect(),o=this.toPlan(a.clientX-n.left,a.clientY-n.top);this.dragging={id:e.id,x:o.x,y:o.y}},i=a=>{this.viewport.removeEventListener("pointermove",s),this.viewport.removeEventListener("pointerup",i),this.viewport.removeEventListener("pointercancel",i);const n=this.getBoundingClientRect(),o=this.toPlan(a.clientX-n.left,a.clientY-n.top),l=Math.abs(o.x-e.x)>5e-4||Math.abs(o.y-e.y)>5e-4;this.dragging=null,l?(this.dragMoved=!0,setTimeout(()=>this.dragMoved=!1,0),this.dispatchEvent(new CustomEvent("marker-move",{detail:{id:e.id,x:o.x,y:o.y},bubbles:!0,composed:!0}))):this.select(e,a)};this.viewport.addEventListener("pointermove",s),this.viewport.addEventListener("pointerup",i),this.viewport.addEventListener("pointercancel",i)},this.onPointerDown=e=>{if(this.pointers.set(e.pointerId,{x:e.clientX,y:e.clientY}),this.dragMoved=!1,this.pointers.size===1){if(this.boxSelect&&e.button===0&&!e.shiftKey&&!this.editable&&!this.placing){const t=this.getBoundingClientRect();this.boxStart={x:e.clientX-t.left,y:e.clientY-t.top},this.lastPan=null;return}this.lastPan={x:e.clientX,y:e.clientY},this.viewport.classList.add("dragging")}else this.pointers.size===2&&(this.lastPinchDist=this.pinchDistance(),this.lastPan=null,this.boxStart=null,this.box=null)},this.onPointerMove=e=>{if(this.pointers.has(e.pointerId)){if(this.pointers.set(e.pointerId,{x:e.clientX,y:e.clientY}),this.pointers.size===2){const t=this.pinchDistance();if(this.lastPinchDist>0){const[s,i]=[...this.pointers.values()],a=this.getBoundingClientRect();this.zoomBy(t/this.lastPinchDist,(s.x+i.x)/2-a.left,(s.y+i.y)/2-a.top)}this.lastPinchDist=t,this.dragMoved=!0;return}if(this.boxStart){const t=this.getBoundingClientRect(),s=e.clientX-t.left,i=e.clientY-t.top;!this.dragMoved&&Math.abs(s-this.boxStart.x)+Math.abs(i-this.boxStart.y)>3&&(this.dragMoved=!0,this.viewport.hasPointerCapture(e.pointerId)||this.viewport.setPointerCapture(e.pointerId)),this.dragMoved&&(this.box={x0:Math.min(this.boxStart.x,s),y0:Math.min(this.boxStart.y,i),x1:Math.max(this.boxStart.x,s),y1:Math.max(this.boxStart.y,i)});return}if(this.lastPan){const t=e.clientX-this.lastPan.x,s=e.clientY-this.lastPan.y;!this.dragMoved&&Math.abs(t)+Math.abs(s)>2&&(this.dragMoved=!0,this.viewport.hasPointerCapture(e.pointerId)||this.viewport.setPointerCapture(e.pointerId)),this.tx+=t,this.ty+=s,this.lastPan={x:e.clientX,y:e.clientY}}}},this.onPointerUp=e=>{if(this.pointers.delete(e.pointerId),this.boxStart&&this.pointers.size===0){const t=this.box;if(this.boxStart=null,this.box=null,t&&t.x1-t.x0>=4&&t.y1-t.y0>=4){const s=this.markers.filter(i=>{const a=this.toScreen(i.x,i.y);return a.x>=t.x0&&a.x<=t.x1&&a.y>=t.y0&&a.y<=t.y1}).map(i=>i.id);this.dispatchEvent(new CustomEvent("box-select",{detail:{ids:s},bubbles:!0,composed:!0}))}}if(this.pointers.size===0)this.lastPan=null,this.viewport.classList.remove("dragging");else if(this.pointers.size===1){const[t]=[...this.pointers.values()];this.lastPan={x:t.x,y:t.y}}},this.onBackgroundClick=e=>{if(!this.dragMoved){if(this.placing){const t=this.getBoundingClientRect(),s=this.toPlan(e.clientX-t.left,e.clientY-t.top);this.dispatchEvent(new CustomEvent("plan-click",{detail:{x:+s.x.toFixed(4),y:+s.y.toFixed(4)},bubbles:!0,composed:!0}));return}this.dispatchEvent(new CustomEvent("marker-select",{detail:{id:null},bubbles:!0,composed:!0}))}},this.onHandlePointerDown=(e,t,s)=>{if(!this.editable||s.button!==0)return;s.stopPropagation(),s.preventDefault();const i=this.getBoundingClientRect(),a=e.rotation??0,n=e.fov??90,o=t==="left"?a+n/2:a-n/2;this.orienting={id:e.id,rotation:a,fov:n},this.viewport.setPointerCapture(s.pointerId);const l=m=>{const v=this.bearingTo(e,m.clientX-i.left,m.clientY-i.top);if(t==="dir")return{rotation:Math.round(v),fov:n};let M=t==="left"?o-v:v-o;M=(M%360+360)%360;const _=Math.max(10,Math.min(180,Math.round(M))),O=t==="left"?o-_/2:o+_/2;return{rotation:Math.round((O%360+360)%360),fov:_}},p=m=>{this.orienting={id:e.id,...l(m)}},f=m=>{this.viewport.removeEventListener("pointermove",p),this.viewport.removeEventListener("pointerup",f),this.viewport.removeEventListener("pointercancel",f);const v=l(m);this.orienting=null,this.dragMoved=!0,setTimeout(()=>this.dragMoved=!1,0),(v.rotation!==a||v.fov!==n)&&this.dispatchEvent(new CustomEvent("marker-orient",{detail:{id:e.id,...v},bubbles:!0,composed:!0}))};this.viewport.addEventListener("pointermove",p),this.viewport.addEventListener("pointerup",f),this.viewport.addEventListener("pointercancel",f)}}connectedCallback(){super.connectedCallback(),this.resizeObserver=new ResizeObserver(()=>{this.fitted||this.fit()}),this.resizeObserver.observe(this)}disconnectedCallback(){super.disconnectedCallback(),this.resizeObserver?.disconnect()}updated(e){(e.has("planWidth")||e.has("planHeight"))&&(this.fitted=!1,this.fit()),(e.has("scale")||e.has("tx")||e.has("ty"))&&this.dispatchEvent(new CustomEvent("view-change",{bubbles:!0,composed:!0}))}get zoom(){return this.scale}focusMarker(e){const t=this.renderRoot.querySelector(`g.marker[data-id="${CSS.escape(e)}"]`);return t?.focus(),!!t}toScreen(e,t){return{x:this.tx+e*this.planWidth*this.scale,y:this.ty+t*this.planHeight*this.scale}}fit(){const e=this.clientWidth,t=this.clientHeight;if(!e||!t||!this.planWidth||!this.planHeight)return;const s=24,i=Math.min((e-s*2)/this.planWidth,(t-s*2)/this.planHeight);this.minScale=Math.min(oi,i),this.scale=Math.max(this.minScale,Math.min(li,i)),this.tx=(e-this.planWidth*this.scale)/2,this.ty=(t-this.planHeight*this.scale)/2,this.fitted=!0}zoomToBox(e,t,s,i,a=48){const n=this.clientWidth,o=this.clientHeight;if(!n||!o||!this.planWidth||!this.planHeight)return;const l=Math.max(1e-6,s-e)*this.planWidth,p=Math.max(1e-6,i-t)*this.planHeight,f=Math.max(oi,Math.min(li,Math.min((n-a*2)/l,(o-a*2)/p,2.5)));this.scale=f,this.tx=n/2-(e+s)/2*this.planWidth*f,this.ty=o/2-(t+i)/2*this.planHeight*f,this.fitted=!0}zoomBy(e,t,s){const i=this.clientWidth,a=this.clientHeight,n=t??i/2,o=s??a/2,l=Math.max(this.minScale,Math.min(li,this.scale*e)),p=l/this.scale;this.tx=n-(n-this.tx)*p,this.ty=o-(o-this.ty)*p,this.scale=l,this.fitted=!0}toPlan(e,t){return{x:Math.min(1,Math.max(0,(e-this.tx)/this.scale/this.planWidth)),y:Math.min(1,Math.max(0,(t-this.ty)/this.scale/this.planHeight))}}pinchDistance(){const[e,t]=[...this.pointers.values()];return Math.hypot(e.x-t.x,e.y-t.y)}select(e,t){if(this.dragMoved)return;t.stopPropagation();const s=this.toScreen(e.x,e.y),i={id:e.id,sx:s.x,sy:s.y};this.dispatchEvent(new CustomEvent("marker-select",{detail:i,bubbles:!0,composed:!0}))}selectZone(e,t){this.dragMoved||this.placing||(t.stopPropagation(),this.dispatchEvent(new CustomEvent("zone-select",{detail:{id:e.id},bubbles:!0,composed:!0})))}onVertexPointerDown(e,t,s,i=!1){if(!this.editable||s.button!==0)return;if(s.stopPropagation(),s.preventDefault(),!i){const f=this.lastVertexPress,m=performance.now();if(f&&f.id===e.id&&f.index===t&&m-f.at<450){this.lastVertexPress=null,this.removeVertex(e,t,s);return}this.lastVertexPress={id:e.id,index:t,at:m}}const a=this.getBoundingClientRect();let n=e.polygon.map(f=>({x:f.x,y:f.y})),o=t;if(i){const f=n[t],m=n[(t+1)%n.length];n.splice(t+1,0,{x:+((f.x+m.x)/2).toFixed(4),y:+((f.y+m.y)/2).toFixed(4)}),o=t+1}this.zoneDraft={id:e.id,polygon:n},this.viewport.setPointerCapture(s.pointerId);const l=f=>{const m=this.toPlan(f.clientX-a.left,f.clientY-a.top);n=n.map((v,M)=>M===o?{x:+m.x.toFixed(4),y:+m.y.toFixed(4)}:v),this.zoneDraft={id:e.id,polygon:n}},p=()=>{this.viewport.removeEventListener("pointermove",l),this.viewport.removeEventListener("pointerup",p),this.viewport.removeEventListener("pointercancel",p);const f=i||n.some((m,v)=>m.x!==e.polygon[v].x||m.y!==e.polygon[v].y);this.zoneDraft=null,this.dragMoved=!0,setTimeout(()=>this.dragMoved=!1,0),f&&this.dispatchEvent(new CustomEvent("zone-edit",{detail:{id:e.id,polygon:n},bubbles:!0,composed:!0}))};this.viewport.addEventListener("pointermove",l),this.viewport.addEventListener("pointerup",p),this.viewport.addEventListener("pointercancel",p)}removeVertex(e,t,s){if(s.stopPropagation(),!this.editable||e.polygon.length<=3)return;const i=e.polygon.filter((a,n)=>n!==t);this.dispatchEvent(new CustomEvent("zone-edit",{detail:{id:e.id,polygon:i},bubbles:!0,composed:!0}))}renderZoneHandles(e,t){const s=1/this.scale,i=this.planWidth,a=this.planHeight;return h`<g class="zone-handles">
    ...
    </g>`}renderZone(e){if(e.polygon.length<3)return c;const t=1/this.scale,s=this.zoneDraft?.id===e.id?this.zoneDraft.polygon:e.polygon,i=s.map(M=>`${(M.x*this.planWidth).toFixed(1)},${(M.y*this.planHeight).toFixed(1)}`).join(" "),a=co(s),n=this.selectedZoneId===e.id,o=Math.max(36,e.name.length*7+18),l=s.map(M=>M.x),p=s.map(M=>M.y),f=(Math.max(...l)-Math.min(...l))*this.planWidth*this.scale,m=(Math.max(...p)-Math.min(...p))*this.planHeight*this.scale,v=n||e.candidate||f>=o+12&&m>=30;return h`
  ...
  `;_s([u({type:Boolean,reflect:!0})],Pt.prototype,"checked",2);_s([u({type:Boolean,reflect:!0})],Pt.prototype,"disabled",2);_s([u()],Pt.prototype,"label",2);_s([u({type:Boolean})],Pt.prototype,"labelHidden",2);Pt=_s([k("sw-toggle")],Pt);function vr(e={}){const t=new URLSearchParams;e.domain&&t.set("domain",e.domain),e.q&&t.set("q",e.q),e.area&&t.set("area",e.area),e.placed!==void 0&&t.set("placed",String(e.placed)),e.includeDisabled&&t.set("include_disabled","true"),e.limit&&t.set("limit",String(e.limit));const s=t.toString();return z(`ha/entities${s?`?${s}`:""}`)}const Ko=()=>z("ha/status"),Go=(e=!1)=>z(`ha/bridge/pairing${e?"?regenerate=true":""}`),va=e=>z(`ha/actions/${e}`),Yo=()=>A("ha/bridge/install");function Jo(e,t,s={},i=!1){const a={allowed_action_id:t,arguments:s,expected_state_version:null,confirmation_grant:i?"confirmed":null,client_request_id:crypto.randomUUID(),expires_at:new Date(Date.now()+6e4).toISOString().replace(/\.\d{3}Z$/,"Z")};return A(`ha/entities/${encodeURIComponent(e)}/actions`,a)}async function Xo(e,t,s){let i=await va(e);t(i);for(let a=0;a<16&&i.status==="pending";a++)await new Promise(n=>setTimeout(n,1500)),i=await va(e),t(i);return i}const Qo={ha_unauthorized:"Home Assistant דחה את הפעולה: למשתמש שלך אין הרשאה לישות זו ב־Home Assistant",ha_unknown_user:"Home Assistant אינו מכיר את המשתמש שמאחורי ההפעלה הזו",bridge_not_paired:"גשר SMPLWISE אינו מצומד",bridge_error:"הגשר החזיר שגיאה",ha_unavailable:"Home Assistant אינו זמין",service_not_allowed:"הגשר סירב: השירות אינו ברשימת הפעולות המאושרות (גשר ישן? מאז 0.2.1 נוספו climate / media / number / select / alarm — הפעל את Home Assistant מחדש כדי לטעון את הגרסה החדשה)",unknown_user:"Home Assistant אינו מכיר את המשתמש"},el={pending:"נשלח · ממתין לעדכון מ־Home Assistant",confirmed:"אושר · המצב התעדכן",unknown:"לא ידוע · לא התקבל עדכון מצב",failed:"נכשל",denied:"נדחה · אין הרשאה ב־Home Assistant"},tl=new Set(["on","open","opening","unlocked","unlocking","playing","home","heat","cool","heat_cool","dry","fan_only","cleaning","active","detected","problem","running"]),Is={on:"דולק",off:"כבוי",locked:"נעול",unlocked:"פתוח",locking:"נועל…",unlocking:"פותח…",jammed:"תקוע",open:"פתוח",closed:"סגור",opening:"נפתח…",closing:"נסגר…",unavailable:"לא זמין",unknown:"לא ידוע",idle:"לא פעיל",home:"בבית",not_home:"מחוץ לבית",playing:"מנגן",paused:"מושהה",standby:"המתנה",heat:"חימום",cool:"קירור",auto:"אוטומטי",dry:"ייבוש",fan_only:"מאוורר",docked:"בתחנה",cleaning:"מנקה",returning:"חוזר"},sl={motion:["תנועה","ללא תנועה"],occupancy:["נוכחות","ללא נוכחות"],presence:["נוכח","לא נוכח"],door:["פתוחה","סגורה"],window:["פתוח","סגור"],opening:["פתוח","סגור"],garage_door:["פתוח","סגור"],lock:["פתוח","נעול"],connectivity:["מחובר","מנותק"],power:["פועל","כבוי"],problem:["תקלה","תקין"],safety:["לא בטוח","בטוח"],smoke:["עשן","ללא עשן"],moisture:["רטוב","יבש"],battery:["סוללה חלשה","סוללה תקינה"],running:["פועל","לא פועל"],sound:["רעש","שקט"],vibration:["רטט","ללא רטט"],update:["עדכון זמין","מעודכן"]};function ft(e){const t=e.state;if(t==null)return"לא ידוע";if(t==="unavailable"||t==="unknown")return Is[t];if(e.domain==="binary_sensor"){const s=sl[e.device_class??""];return s?t==="on"?s[0]:s[1]:t==="on"?"פעיל":"לא פעיל"}if(e.domain==="sensor"||e.domain==="number"||e.domain==="input_number"){const s=Number(t);return!Number.isNaN(s)&&t.trim()!==""?`${Number.isInteger(s)?s:s.toFixed(Math.min(2,(t.split(".")[1]??"").length))}${e.unit?` ${e.unit}`:""}`:t}return e.domain==="light"&&t==="on"&&typeof e.attributes.brightness=="number"?`דולק · ${Math.round(e.attributes.brightness/255*100)}%`:e.domain==="cover"&&typeof e.attributes.current_position=="number"&&(t==="open"||t==="closed")?`${Is[t]} · ${e.attributes.current_position}%`:e.domain==="climate"&&typeof e.attributes.current_temperature=="number"?`${Is[t]??t} · ${e.attributes.current_temperature}°`:Is[t]??t}function Pi(e){return!e||e.removed_at?"unknown":e.state==="unavailable"||!e.available?"offline":e.fresh?e.state===null||e.state==="unknown"?"unknown":tl.has(e.state)?"live":"neutral":"stale"}function ti(e,t){return e==="doors"||t==="lock"||t==="cover"?"lock":e==="lights"||t==="light"||t==="switch"||t==="fan"?"light":"binary_sensor"}function vs(e){return{light:"תאורה",switch:"מתג",lock:"מנעול",cover:"תריס / שער",binary_sensor:"חיישן בינארי",sensor:"חיישן",fan:"מאוורר",climate:"אקלים",camera:"מצלמת HA",button:"כפתור",script:"סקריפט",scene:"סצנה",automation:"אוטומציה",media_player:"נגן",event:"אירוע",number:"מספר",select:"בחירה",input_boolean:"דגל",alarm_control_panel:"אזעקה",siren:"צופר",vacuum:"שואב",weather:"מזג אוויר",sun:"שמש"}[e]??e}function De(e){if(!e)return"—";const t=new Date(e);return Number.isNaN(t.getTime())?e:t.toLocaleString("he-IL",{dateStyle:"short",timeStyle:"medium"})}function gr(e,t){let s=null,i=!1,a=2e3;const n=(()=>{const l=new URL(pe("ha/ws"));return l.protocol=l.protocol==="https:"?"wss:":"ws:",l.toString()})(),o=()=>{if(!i){try{s=new WebSocket(n)}catch{return}s.onopen=()=>{a=2e3},s.onmessage=l=>{try{const p=JSON.parse(l.data);p.type==="entity_state_changed"?e({type:"entity_state_changed",entity:p.payload.entity}):p.type==="ha_sync_state"?e({type:"ha_sync_state",connected:!!p.payload.connected}):p.type==="heartbeat"&&e({type:"heartbeat",sync:p.payload.sync})}catch{}},s.onclose=l=>{!i&&l.code!==4403&&l.code!==4401&&(window.setTimeout(o,a),a=Math.min(3e4,a*2))}}};return o(),()=>{i=!0,s?.close()}}var il=Object.defineProperty,al=Object.getOwnPropertyDescriptor,H=(e,t,s,i)=>{for(var a=i>1?void 0:i?al(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&il(t,s,a),a};const rl={off:"כבוי",heat:"חימום",cool:"קירור",heat_cool:"חימום/קירור",auto:"אוטומטי",dry:"ייבוש",fan_only:"מאוורר בלבד"},nl=[{id:"cameras",icon:"camera",label:()=>y("floor.cameras")},{id:"doors",icon:"door",label:()=>y("floor.doors")},{id:"lights",icon:"light",label:()=>y("floor.lights")},{id:"sensors",icon:"sensor",label:()=>y("floor.sensors")},{id:"zones",icon:"map",label:()=>"חדרים ואזורים"}],ga=["entrance","lobby","corridor","hall","parking","warehouse","backyard","driveway","night"];let R=class extends ${constructor(){super(...arguments),this.floorId="f0",this.screenState="ready",this.focusZone="",this.focusCamera="",this.focusEntity="",this.selectedZoneId=null,this.bundle=null,this.tree=null,this.loadError="",this.noFloors=!1,this.selectedId=null,this.anchor=null,this.layers=new Set(["cameras","doors","lights","sensors","zones"]),this.pinned=!1,this.panel=!1,this.multi=!1,this.sideList=(()=>{try{return localStorage.getItem("sw.map.sidelist")==="1"}catch{return!1}})(),this.saveView=null,this.savedView=null,this.picked=[],this.narrow=!1,this.syncConnected=!0,this.action=null,this.confirmSpec=null,this.stopWs=null,this.mq=window.matchMedia("(max-width: 767px)"),this.onMq=()=>this.narrow=this.mq.matches,this.onKey=e=>{if(e.key==="Escape"&&!this.confirmSpec)if(this.selectedId){const t=this.selectedId;this.close(),this.canvas?.focusMarker(t)}else this.panel&&(this.panel=!1)},this.actionArgs={}}connectedCallback(){super.connectedCallback(),this.narrow=this.mq.matches,this.mq.addEventListener("change",this.onMq),window.addEventListener("keydown",this.onKey),this.load()}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("keydown",this.onKey),this.mq.removeEventListener("change",this.onMq),this.stopWs?.(),this.stopWs=null}startWs(){this.stopWs||!g()||(this.stopWs=gr(e=>{const t=this.bundle;if(e.type==="entity_state_changed"&&t){if(!t.anchors.some(s=>s.resource_type==="ha_entity"&&s.resource_id===e.entity.entity_id))return;this.bundle={...t,anchors:t.anchors.map(s=>s.resource_type==="ha_entity"&&s.resource_id===e.entity.entity_id?{...s,entity:{...s.entity??{},...e.entity,actions:s.entity?.actions}}:s)}}else e.type==="ha_sync_state"?this.syncConnected=e.connected:e.type==="heartbeat"&&(this.syncConnected=e.sync.connected)}))}updated(e){e.has("floorId")&&e.get("floorId")!==void 0?(this.selectedId=null,this.anchor=null,this.selectedZoneId=null,this.load()):(e.has("focusZone")||e.has("focusCamera")||e.has("focusEntity"))&&this.bundle&&this.applyFocus()}async applyFocus(){const e=this.bundle;if(!e||!this.focusZone&&!this.focusCamera&&!this.focusEntity)return;await this.updateComplete;const t=this.canvas;if(!t)return;const s=this.focusZone?e.zones.find(a=>a.id===this.focusZone):null;if(s){const a=s.polygon.map(o=>o.x),n=s.polygon.map(o=>o.y);this.selectedZoneId=s.id,t.zoomToBox(Math.min(...a),Math.min(...n),Math.max(...a),Math.max(...n))}const i=this.focusCamera?e.anchors.find(a=>a.resource_type==="camera"&&a.resource_id===this.focusCamera):this.focusEntity?e.anchors.find(a=>a.resource_type==="ha_entity"&&a.resource_id===this.focusEntity):null;if(i){t.zoomToBox(i.position.x-.12,i.position.y-.12,i.position.x+.12,i.position.y+.12),await this.updateComplete;const a=t.toScreen(i.position.x,i.position.y);this.selectedId=i.id,this.anchor={x:a.x,y:a.y}}}async load(){this.loadError="";try{const e=this.tree??await vt();if(this.tree=e,g()&&!hr(e,this.floorId)){const t=ur(e);if(t&&t.id!==this.floorId){b(`/explore/floors/${t.id}`);return}if(!t){this.noFloors=!0,this.bundle=null;return}}this.noFloors=!1,this.restoreLayers(),this.bundle=await ws(this.floorId),this.bundle.source==="api"&&this.startWs(),this.applyFocus()}catch(e){this.loadError=w(e),this.bundle=null}}get floors(){return this.tree?.source==="api"?this.tree.sites.flatMap(e=>(e.buildings??[]).flatMap(t=>(t.floors??[]).map(s=>({id:s.id,name:`${t.name} · ${s.name}`,cameraCount:s.camera_count,hasPlan:s.has_plan})))):ht.map(e=>({id:e.id,name:e.name,cameraCount:e.cameraCount,hasPlan:e.hasPlan}))}get markers(){const e=this.bundle;if(!e)return[];const t=this.screenState==="stale";if(e.source==="demo"){const s=this.layers.has("cameras")?is.filter(a=>a.floorId===e.floorId).map(a=>({id:a.id,kind:"camera",label:a.name,x:a.x,y:a.y,rotation:a.rotation,fov:a.fov,state:a.state})):[],i=Rs.filter(a=>a.floorId===e.floorId).filter(a=>a.domain==="lock"&&this.layers.has("doors")||a.domain==="light"&&this.layers.has("lights")||a.domain==="binary_sensor"&&this.layers.has("sensors")).map(a=>({id:a.id,kind:a.domain,label:a.name,x:a.x,y:a.y,state:t?"stale":"neutral"}));return[...s,...i]}return e.anchors.filter(s=>s.resource_type==="camera"?this.layers.has("cameras"):this.layers.has(s.layer_id==="doors"?"doors":s.layer_id==="lights"?"lights":"sensors")).map(s=>({id:s.id,kind:s.resource_type==="camera"?"camera":ti(s.layer_id,s.entity?.domain),label:s.camera?.name??s.entity?.name??s.label??s.resource_id,x:s.position.x,y:s.position.y,rotation:s.rotation_degrees,fov:s.field_of_view_degrees??void 0,state:s.resource_type==="camera"?as(s):t?"stale":this.entityTone(s.entity)}))}layerCounts(){const e=this.bundle,t={cameras:0,doors:0,lights:0,sensors:0,zones:e?.zones.length??0};if(!e)return t;if(e.source==="demo"){t.cameras=is.filter(s=>s.floorId===e.floorId).length;for(const s of Rs.filter(i=>i.floorId===e.floorId))s.domain==="lock"?t.doors++:s.domain==="light"?t.lights++:t.sensors++;return t}for(const s of e.anchors)s.resource_type==="camera"?t.cameras++:s.layer_id==="doors"?t.doors++:s.layer_id==="lights"?t.lights++:t.sensors++;return t}zoneOf(e){return this.bundle?.zones.find(s=>rs(e.position,s.polygon))?.name??null}toggleLayer(e){const t=new Set(this.layers);t.has(e)?t.delete(e):t.add(e),this.setLayers(t)}setLayers(e){this.layers=e;try{localStorage.setItem(`sw.floor.layers.${this.floorId}`,JSON.stringify([...e]))}catch{}}restoreLayers(){try{const e=localStorage.getItem(`sw.floor.layers.${this.floorId}`);if(!e)return;const t=JSON.parse(e);Array.isArray(t)&&(this.layers=new Set(t.filter(s=>["cameras","doors","lights","sensors","zones"].includes(s))))}catch{}}cameraAnchors(){return(this.bundle?.anchors??[]).filter(e=>e.resource_type==="camera"&&this.layers.has("cameras"))}togglePick(e){this.picked=this.picked.includes(e)?this.picked.filter(t=>t!==e):[...this.picked,e]}pickedCameraIds(){const e=new Map((this.bundle?.anchors??[]).map(t=>[t.id,t.resource_id]));return this.picked.map(t=>e.get(t)).filter(t=>!!t)}setMulti(e){this.multi=e,this.picked=[],this.saveView=null,this.savedView=null,e&&this.close()}addPicks(e){const t=new Set(this.cameraAnchors().map(i=>i.id)),s=e.filter(i=>t.has(i)&&!this.picked.includes(i));s.length&&(this.picked=[...this.picked,...s])}pickZone(e){const t=this.bundle?.zones.find(a=>a.id===e);if(!t)return;const s=this.cameraAnchors().filter(a=>rs(a.position,t.polygon)).map(a=>a.id);if(!s.length)return;const i=s.every(a=>this.picked.includes(a));this.picked=i?this.picked.filter(a=>!s.includes(a)):[...this.picked,...s.filter(a=>!this.picked.includes(a))]}roomChips(){const e=this.bundle;if(!e)return c;const t=this.cameraAnchors(),s=e.zones.map(i=>({z:i,ids:t.filter(a=>rs(a.position,i.polygon)).map(a=>a.id)})).filter(i=>i.ids.length);return s.length?r`<span class="roomchips" data-room-chips>${s.map(i=>r`<sw-chip icon="layers" data-room-chip=${i.z.id} ?selected=${i.ids.every(a=>this.picked.includes(a))} @click=${()=>this.pickZone(i.z.id)}>${i.z.name} (${i.ids.length})</sw-chip>`)}</span>`:c}toggleSideList(){this.sideList=!this.sideList;try{localStorage.setItem("sw.map.sidelist",this.sideList?"1":"0")}catch{}}async jumpTo(e){if(e.resource_type==="camera"?(this.focusCamera=e.resource_id,this.focusEntity=""):(this.focusEntity=e.resource_id,this.focusCamera=""),this.focusZone="",this.multi&&e.resource_type==="camera"){this.togglePick(e.id);return}await this.applyFocus()}renderSideList(){const e=this.bundle;if(!e||!this.sideList||e.source!=="api")return c;const t=e.anchors.filter(o=>o.resource_type==="camera"),s=e.anchors.filter(o=>o.resource_type==="ha_entity"),i={light:"תאורה",switch:"מפסקים",lock:"מנעולים",binary_sensor:"חיישנים",sensor:"חיישנים",cover:"תריסים",climate:"מיזוג",media_player:"מדיה",alarm_control_panel:"אזעקה"},a=new Map;for(const o of s){const l=o.entity?.domain??o.resource_id.split(".")[0];a.set(l,[...a.get(l)??[],o])}const n=o=>o.camera?o.camera.status==="online"?"#22c55e":o.camera.status==="offline"?"#ef4444":"var(--sw-text-3)":o.entity?.state==="on"||o.entity?.state==="unlocked"||o.entity?.state==="open"?"var(--sw-accent)":"var(--sw-text-3)";return r`<div class="sidelist" data-sidelist>
    ...
    `}renderCard(){const e=this.bundle;if(!this.selectedId||!e)return c;let t="",s="",i=c,a=c;if(e.source==="demo"){const l=is.find(m=>m.id===this.selectedId),p=l?void 0:Rs.find(m=>m.id===this.selectedId);if(!l&&!p)return c;t=l?l.name:p.name,s=l?`${e.floorName} · ${l.source}`:`${e.floorName} · ${y(p.domain==="lock"?"entity.door":p.domain==="light"?"entity.light":"entity.sensor")}`,i=l?this.demoCameraBody(l,e.floorName):this.demoEntityBody(p);const f=l?l.state==="live"||l.state==="stale":!1;a=l?r`<sw-button variant="primary" size="sm" icon="expand" ?disabled=${!f} @click=${()=>b(`/live/cameras/${l.id}`)}>צפייה חיה</sw-button>
  ...
  `;Jt([u()],mt.prototype,"heading",2);Jt([u()],mt.prototype,"subheading",2);Jt([u()],mt.prototype,"crumbs",2);Jt([u({type:Boolean,reflect:!0})],mt.prototype,"wide",2);Jt([u({type:Boolean,reflect:!0})],mt.prototype,"flush",2);mt=Jt([k("sw-page")],mt);var dl=Object.defineProperty,cl=Object.getOwnPropertyDescriptor,zs=(e,t,s,i)=>{for(var a=i>1?void 0:i?cl(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&dl(t,s,a),a};let Et=class extends ${constructor(){super(...arguments),this.heading="",this.subheading="",this.flush=!1,this.interactive=!1}render(){return r`
  ...
  `;gt([d()],Fe.prototype,"tab",2);gt([d()],Fe.prototype,"tree",2);gt([d()],Fe.prototype,"dialog",2);gt([d()],Fe.prototype,"formName",2);gt([d()],Fe.prototype,"formAddress",2);gt([d()],Fe.prototype,"busy",2);gt([d()],Fe.prototype,"error",2);Fe=gt([k("explore-sites")],Fe);var fl=Object.defineProperty,ml=Object.getOwnPropertyDescriptor,Ss=(e,t,s,i)=>{for(var a=i>1?void 0:i?ml(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&fl(t,s,a),a};let Ct=class extends ${constructor(){super(...arguments),this.rooms=[],this.selected=!1,this.empty=!1,this.width=132}iso(e,t){return{x:60+(e-t)*58,y:6+(e+t)*26}}poly(e){return e.map(t=>`${t.x.toFixed(1)},${t.y.toFixed(1)}`).join(" ")}render(){this.style.setProperty("--w",`${this.width}px`);const e=[this.iso(0,0),this.iso(1,0),this.iso(1,1),this.iso(0,1)],t=7,s=[this.iso(1,0),this.iso(1,1),{x:this.iso(1,1).x,y:this.iso(1,1).y+t},{x:this.iso(1,0).x,y:this.iso(1,0).y+t}],i=[this.iso(0,1),this.iso(1,1),{x:this.iso(1,1).x,y:this.iso(1,1).y+t},{x:this.iso(0,1).x,y:this.iso(0,1).y+t}];return r`<svg viewBox="0 0 120 72" aria-hidden="true">
  ...
  `;We([u()],Se.prototype,"buildingId",2);We([d()],Se.prototype,"tree",2);We([d()],Se.prototype,"selected",2);We([d()],Se.prototype,"tab",2);We([d()],Se.prototype,"dialog",2);We([d()],Se.prototype,"busy",2);We([d()],Se.prototype,"error",2);We([d()],Se.prototype,"formName",2);We([d()],Se.prototype,"formLevel",2);Se=We([k("explore-floors")],Se);var gl=Object.defineProperty,bl=Object.getOwnPropertyDescriptor,Gi=(e,t,s,i)=>{for(var a=i>1?void 0:i?bl(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&gl(t,s,a),a};let gs=class extends ${constructor(){super(...arguments),this.steps=[],this.current=0}render(){return r`${this.steps.map((e,t)=>r`
  ...
  `;ee([u()],K.prototype,"floorId",2);ee([d()],K.prototype,"step",2);ee([d()],K.prototype,"tree",2);ee([d()],K.prototype,"assets",2);ee([d()],K.prototype,"asset",2);ee([d()],K.prototype,"page",2);ee([d()],K.prototype,"rotation",2);ee([d()],K.prototype,"crop",2);ee([d()],K.prototype,"notes",2);ee([d()],K.prototype,"version",2);ee([d()],K.prototype,"busy",2);ee([d()],K.prototype,"error",2);ee([d()],K.prototype,"dragOver",2);ee([d()],K.prototype,"dxf",2);ee([d()],K.prototype,"dxfLayers",2);ee([d()],K.prototype,"dxfUnits",2);ee([d()],K.prototype,"dxfBusy",2);ee([d()],K.prototype,"previewBust",2);K=ee([k("explore-plan-import")],K);const ci={white:"לבן",tint:"גוון לכל חדר",none:"ללא מילוי"};async function xl(e,t){const s=await A(`plan-versions/${e}/stylize`,t);return{...s,source_url:Je(s.source_url)+`?v=${Date.now()}`,stylized_url:Je(s.stylized_url)+`?v=${Date.now()}`}}const kl=(e,t)=>it(`plan-versions/${e}`,{render_mode:t});var _l=Object.defineProperty,zl=Object.getOwnPropertyDescriptor,T=(e,t,s,i)=>{for(var a=i>1?void 0:i?zl(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&_l(t,s,a),a};const Ps=["#2767ED","#22A06B","#F59E0B","#8B5CF6","#0EA5E9","#EC4899","#14B8A6","#F97316"],Sl=[{id:"select",icon:"target",label:"בחירה וגרירה",ready:!0},{id:"camera",icon:"camera",label:"הוספת מצלמה",ready:!0},{id:"entity",icon:"light",label:"הוספת ישות HA",ready:!0},{id:"zones",icon:"map",label:"חדרים ואזורים",ready:!0},{id:"layers",icon:"layers",label:"שכבות",ready:!0}],ya=[{id:"cameras",label:"מצלמות"},{id:"doors",label:"דלתות ומנעולים"},{id:"lights",label:"תאורה ומתגים"},{id:"sensors",label:"חיישנים"}],Ml={asset:"קובץ",page:"עמוד",rotation:"סיבוב",crop:"חיתוך",width_px:"רוחב",height_px:"גובה"},pi=e=>e?new Intl.DateTimeFormat("he-IL",{dateStyle:"short",timeStyle:"short"}).format(new Date(e)):"";let E=class extends ${constructor(){super(...arguments),this.floorId="",this.presetEntity="",this.bundle=null,this.anchors=[],this.dirty=new Set,this.undo=[],this.redo=[],this.selectedId=null,this.tool="select",this.layers=new Set(["cameras","doors","lights","sensors"]),this.placing=null,this.entQ="",this.entResults=null,this.entBusy=!1,this.busy=!1,this.error="",this.info="",this.stylizing=!1,this.stylized=null,this.stylizeOpts={strength:"medium",keepLines:!1,roomFill:"white"},this.zones=[],this.versions=[],this.diff=null,this.selectedZoneId=null,this.candidates=null,this.detecting=!1,this.detectStrength="medium",this.replaceAuto=!0,this.drawing=null,this.showZones=!0,this.zoneBusy=!1,this.entTimer=0,this.onKey=e=>this.handleKey(e)}connectedCallback(){super.connectedCallback(),this.load(),window.addEventListener("keydown",this.onKey),this.presetEntity&&(this.tool="entity",this.entQ=this.presetEntity,this.searchEntities())}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("keydown",this.onKey)}async load(){this.error="";try{const e=await ws(this.floorId||"f0",!0);this.bundle=e,this.anchors=e.anchors.map(t=>({...t,position:{...t.position}})),this.zones=e.zones,this.loadVersions(),this.selectedZoneId&&!this.zones.some(t=>t.id===this.selectedZoneId)&&(this.selectedZoneId=null),this.dirty=new Set,this.undo=[],this.redo=[],this.selectedId&&!this.anchors.some(t=>t.id===this.selectedId)&&(this.selectedId=null)}catch(e){this.error=w(e)}}get selected(){return this.anchors.find(e=>e.id===this.selectedId)}layerOf(e){return e.resource_type==="camera"?"cameras":e.layer_id==="doors"?"doors":e.layer_id==="lights"?"lights":"sensors"}get markers(){return this.anchors.filter(e=>this.layers.has(this.layerOf(e))).map(e=>({id:e.id,kind:e.resource_type==="camera"?"camera":ti(e.layer_id,e.entity?.domain),label:e.camera?.name??e.entity?.name??e.label??e.resource_id,x:e.position.x,y:e.position.y,rotation:e.rotation_degrees,fov:e.field_of_view_degrees??void 0,state:e.resource_type==="camera"?this.bundle?.source==="demo"?"live":as(e):"neutral"}))}anchorName(e){return e.camera?.name??e.entity?.name??e.label??e.resource_id}get selectedZone(){return this.zones.find(e=>e.id===this.selectedZoneId)}get planZones(){if(!this.showZones)return[];const e=this.zones.map(s=>({id:s.id,name:s.name,kind:s.kind,color:s.color,polygon:s.polygon})),t=(this.candidates??[]).map((s,i)=>({id:`cand-${i}`,name:s.include?s.name:"",color:s.include?Ps[i%Ps.length]:"#9AA3B5",polygon:s.polygon,candidate:!0}));return[...e,...t]}async detect(){const e=this.bundle;if(e){if(e.source==="demo"){this.info="נתוני הדגמה: הזיהוי עובד מול השרת.";return}this.detecting=!0,this.error="";try{const t=await Vo(e.floorId,this.detectStrength);this.candidates=t.rooms.map((s,i)=>({polygon:s.polygon,name:`חדר ${i+1}`,kind:"room",include:!0})),this.selectedZoneId=null,this.selectedId=null,this.info=t.rooms.length?`${t.rooms.length} חדרים זוהו · תן שמות ושמור`:"לא זוהו חדרים סגורים; נסה עוצמה אחרת או צייר אזור ידנית",setTimeout(()=>this.info="",5e3)}catch(t){this.error=w(t)}finally{this.detecting=!1}}}setCandidate(e,t){this.candidates&&(this.candidates=this.candidates.map((s,i)=>i===e?{...s,...t}:s))}async acceptCandidates(){const e=this.bundle,t=(this.candidates??[]).filter(s=>s.include);if(!(!e||!t.length)){this.zoneBusy=!0,this.error="";try{const s=await jo(e.floorId,t.map(i=>({polygon:i.polygon,name:i.name,kind:i.kind})),this.replaceAuto);this.candidates=null,this.zones=s.zones,this.info=`${s.created.length} חדרים נשמרו`,setTimeout(()=>this.info="",3e3)}catch(s){this.error=w(s)}finally{this.zoneBusy=!1}}}startDrawing(){this.drawing=[],this.placing=null,this.candidates=null,this.selectedZoneId=null,this.selectedId=null}addDraftPoint(e,t){const s=this.drawing,i=this.bundle;if(!(!s||!i)){if(s.length>=3){const a=this.canvas?.zoom??1;if(Math.hypot((e-s[0].x)*i.width*a,(t-s[0].y)*i.height*a)<12){this.finishDrawing();return}}this.drawing=[...s,{x:+e.toFixed(4),y:+t.toFixed(4)}]}}async finishDrawing(){const e=this.drawing,t=this.bundle;if(!(!e||!t||e.length<3)){if(t.source==="demo"){this.info="נתוני הדגמה: השמירה עובדת מול השרת.",this.drawing=null;return}this.zoneBusy=!0,this.error="";try{const s=await Lo(t.floorId,{name:`אזור ${this.zones.length+1}`,kind:"zone",polygon:e});this.drawing=null,this.zones=[...this.zones,s],this.selectedZoneId=s.id,this.info="האזור נוצר · תן לו שם",setTimeout(()=>this.info="",3e3)}catch(s){this.error=w(s)}finally{this.zoneBusy=!1}}}async patchZone(e,t){if(this.bundle?.source!=="demo"){this.zoneBusy=!0,this.error="";try{const s=await Bo(e.id,{revision:e.revision,...t});this.zones=this.zones.map(i=>i.id===s.id?s:i)}catch(s){s instanceof xe&&s.status===409?(this.error="האזור השתנה בינתיים על ידי עורך אחר; נטען מחדש בלי לדרוס.",await this.load()):this.error=w(s)}finally{this.zoneBusy=!1}}}async removeZone(e){if(this.bundle?.source!=="demo"&&window.confirm(`למחוק את "${e.name}"? המצלמות והישויות בקומה לא מושפעות.`)){this.zoneBusy=!0,this.error="";try{await Ho(e.id),this.zones=this.zones.filter(t=>t.id!==e.id),this.selectedZoneId===e.id&&(this.selectedZoneId=null)}catch(t){this.error=w(t)}finally{this.zoneBusy=!1}}}snapshot(){this.undo=[...this.undo.slice(-40),this.anchors.map(e=>({...e,position:{...e.position}}))],this.redo=[]}apply(e,t){this.snapshot(),this.anchors=this.anchors.map(s=>s.id===e?{...s,...t,position:t.position??s.position}:s),this.dirty=new Set(this.dirty).add(e)}nudge(e,t){const s=this.selected;s&&this.apply(s.id,{position:{x:+Math.min(1,Math.max(0,s.position.x+e)).toFixed(4),y:+Math.min(1,Math.max(0,s.position.y+t)).toFixed(4)}})}doUndo(){const e=this.undo[this.undo.length-1];e&&(this.redo=[...this.redo,this.anchors],this.undo=this.undo.slice(0,-1),this.anchors=e,this.dirty=new Set(this.anchors.map(t=>t.id)))}doRedo(){const e=this.redo[this.redo.length-1];e&&(this.undo=[...this.undo,this.anchors],this.redo=this.redo.slice(0,-1),this.anchors=e,this.dirty=new Set(this.anchors.map(t=>t.id)))}handleKey(e){const t=e.composedPath()[0],s=t&&(t.tagName==="INPUT"||t.tagName==="TEXTAREA"||t.tagName==="SELECT"||t.isContentEditable);if(e.key==="Escape"){this.drawing?this.drawing=null:this.placing?this.placing=null:this.candidates?this.candidates=null:(this.selectedId=null,this.selectedZoneId=null);return}if(s)return;if(e.key==="Enter"&&this.drawing){e.preventDefault(),this.finishDrawing();return}if((e.key==="Delete"||e.key==="Backspace")&&!this.selected&&this.selectedZone){e.preventDefault(),this.removeZone(this.selectedZone);return}if((e.ctrlKey||e.metaKey)&&e.key.toLowerCase()==="z"){e.preventDefault(),e.shiftKey?this.doRedo():this.doUndo();return}if((e.ctrlKey||e.metaKey)&&e.key.toLowerCase()==="y"){e.preventDefault(),this.doRedo();return}if((e.ctrlKey||e.metaKey)&&e.key.toLowerCase()==="s"){e.preventDefault(),this.save();return}if(!this.selected)return;const i=e.shiftKey?.01:.002;e.key==="ArrowLeft"?(e.preventDefault(),this.nudge(-i,0)):e.key==="ArrowRight"?(e.preventDefault(),this.nudge(i,0)):e.key==="ArrowUp"?(e.preventDefault(),this.nudge(0,-i)):e.key==="ArrowDown"?(e.preventDefault(),this.nudge(0,i)):(e.key==="Delete"||e.key==="Backspace")&&(e.preventDefault(),this.removeSelected())}async save(){if(!this.bundle||this.bundle.source==="demo")return this.info="נתוני הדגמה: השינויים נשמרים רק במסך זה.",this.dirty=new Set,!0;if(!this.dirty.size)return!0;this.busy=!0,this.error="";let e=!1;try{for(const t of this.dirty){const s=this.anchors.find(i=>i.id===t);if(s)try{const i=await ko(t,{revision:s.revision,x:s.position.x,y:s.position.y,rotation_degrees:s.rotation_degrees,field_of_view_degrees:s.field_of_view_degrees,label:s.label});this.anchors=this.anchors.map(a=>a.id===t?{...a,revision:i.revision}:a)}catch(i){if(i instanceof xe&&i.code==="stale_revision")e=!0;else throw i}}return e?(this.error="חלק מהפריטים השתנו בינתיים על ידי עורך אחר; המפה נטענה מחדש בלי לדרוס את השינוי שלו.",await this.load(),!1):(this.dirty=new Set,this.info="המיקומים נשמרו",setTimeout(()=>this.info="",2500),!0)}catch(t){return this.error=w(t),!1}finally{this.busy=!1}}async place(e,t){const s=this.placing;if(!(!s||!this.bundle)){if(this.bundle.source==="demo"){this.info="נתוני הדגמה: הוספה עובדת מול השרת.",this.placing=null;return}if(!(this.dirty.size&&!await this.save())){this.busy=!0,this.error="";try{const i=s.kind==="camera"?await wa(this.bundle.floorId,{resource_type:"camera",resource_id:s.camera.id,x:e,y:t,rotation_degrees:0,field_of_view_degrees:90}):await wa(this.bundle.floorId,{resource_type:"ha_entity",resource_id:s.entity.entity_id,x:e,y:t,rotation_degrees:0,field_of_view_degrees:null});this.placing=null,await this.load(),this.selectedId=i.id,this.tool="select",this.info=`${this.anchorName(i)} הוצב · גרור לדיוק, קבע כיוון בידיות`,setTimeout(()=>this.info="",4e3)}catch(i){this.error=w(i)}finally{this.busy=!1}}}}async removeSelected(){const e=this.selected;if(!(!e||!this.bundle)){if(this.bundle.source==="demo"){this.info="נתוני הדגמה: הסרה עובדת מול השרת.";return}if(window.confirm(`להסיר את "${this.anchorName(e)}" מהמפה? המקור עצמו לא נמחק.`)){this.busy=!0,this.error="";try{await _o(e.id),this.selectedId=null,await this.load()}catch(t){this.error=w(t)}finally{this.busy=!1}}}}async loadVersions(){const e=this.bundle;if(!e||e.source==="demo"||!e.permissions.edit){this.versions=[];return}try{this.versions=(await bo(e.floorId)).versions}catch{this.versions=[]}}async publish(){if(!this.bundle?.planVersionId||this.dirty.size&&!await this.save())return;const e=this.versions.find(t=>t.id===this.bundle?.planVersionId);if(!e){await this.publishNow(this.bundle.planVersionId);return}await this.openDiff("publish",e)}async publishNow(e){this.busy=!0,this.error="";try{await Ai(e),this.info="הגרסה פורסמה; הצופים רואים אותה עכשיו",await this.load()}catch(t){this.error=w(t)}finally{this.busy=!1}}async openDiff(e,t){this.diff={mode:e,version:t,data:null,error:""};try{const s=await $o(t.id);this.diff?.version.id===t.id&&(this.diff={mode:e,version:t,data:s,error:""})}catch(s){this.diff={mode:e,version:t,data:null,error:w(s)}}}async confirmDiff(){const e=this.diff;if(!(!e?.data||e.mode==="compare")){this.busy=!0,this.error="";try{e.mode==="publish"?(await Ai(e.version.id),this.info="הגרסה פורסמה; הצופים רואים אותה עכשיו"):(await xo(e.version.id,e.version.revision,e.data.from?.id??null),this.info="הגרסה שוחזרה ופורסמה מחדש; העוגנים נשמרו"),this.diff=null,await this.load(),setTimeout(()=>this.info="",4e3)}catch(t){this.diff={...e,error:w(t)},t instanceof xe&&t.status===409&&this.loadVersions()}finally{this.busy=!1}}}async searchEntities(){if(this.bundle?.source!=="demo"){this.entBusy=!0;try{const e=await vr({q:this.entQ||void 0,limit:40});this.entResults=e.entities}catch(e){this.error=w(e),this.entResults=[]}finally{this.entBusy=!1}}}onEntQuery(e){this.entQ=e,window.clearTimeout(this.entTimer),this.entTimer=window.setTimeout(()=>void this.searchEntities(),250)}async stylize(e,t){if(!this.bundle?.planVersionId||this.bundle.source==="demo")return;const s=this.stylizeOpts;(e!==void 0||t!==void 0)&&(this.stylizeOpts={...s,strength:e??s.strength,keepLines:t??s.keepLines}),this.stylizing=!0,this.error="";try{this.stylized=await xl(this.bundle.planVersionId,{strength:this.stylizeOpts.strength,keep_lines:this.stylizeOpts.keepLines,room_fill:this.stylizeOpts.roomFill})}catch(i){this.error=w(i)}finally{this.stylizing=!1}}async useRender(e){if(this.bundle?.planVersionId){this.busy=!0,this.error="";try{await kl(this.bundle.planVersionId,e),this.stylized=null,await this.load(),this.info=e==="stylized"?"המפה מציגה עכשיו את שפת SMPLWISE":"המפה מציגה את תוכנית המקור",setTimeout(()=>this.info="",3e3)}catch(t){this.error=w(t)}finally{this.busy=!1}}}pickTool(e){this.tool=e,this.placing=null,e==="entity"&&this.entResults===null&&this.searchEntities()}renderCameraInspector(e){const t=e.camera,s=e.field_of_view_degrees??0;return r`<sw-card heading="הגדרות מצלמה" subheading="גרירה במפה, ידיות לכיוון ולשדה הראייה, או הזנה מדויקת">
      ...
      ${t?r`<div class="kv"><span class="k">מצב עכשיו</span><span>${ft(t)}</span></div><div class="kv"><span class="k">סוג</span><span>${vs(t.domain)}</span></div>`:c}
  ...
  `;Le([d()],ke.prototype,"selected",2);Le([d()],ke.prototype,"domain",2);Le([d()],ke.prototype,"q",2);Le([d()],ke.prototype,"area",2);Le([d()],ke.prototype,"onlyPlaced",2);Le([d()],ke.prototype,"cat",2);Le([d()],ke.prototype,"error",2);Le([d()],ke.prototype,"loading",2);Le([d()],ke.prototype,"sync",2);Le([d()],ke.prototype,"firstFloorId",2);ke=Le([k("explore-entities")],ke);var Tl=Object.defineProperty,Dl=Object.getOwnPropertyDescriptor,br=(e,t,s,i)=>{for(var a=i>1?void 0:i?Dl(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&Tl(t,s,a),a};const hi=[{id:"d1",name:"כניסה ראשית",kind:"דלת זכוכית",lock:"נעול",contact:"סגור",relay:"לא פעיל",ringing:!1,scene:"entrance"},{id:"d2",name:"לובי",kind:"דלת פנימית",lock:"פתוח",contact:"פתוח",relay:"לא פעיל",ringing:!1,scene:"lobby"},{id:"d3",name:"אינטרקום M2",kind:"עמדת דלת",lock:"נעול",contact:"סגור",relay:"לא פעיל",ringing:!0,scene:"entrance"},{id:"d4",name:"מחסן",kind:"דלת שירות",lock:"נעול",contact:"סגור",relay:"לא פעיל",ringing:!1,scene:"warehouse"}];let Fs=class extends ${constructor(){super(...arguments),this.selected="d1"}render(){if(g())return r`<sw-page heading="דלתות ואינטרקום" subheading="V1 · מצלמה, צלצול, מגע דלת וממסר הם ארבעה נתונים שונים">
  ...
  `;Dt([u()],et.prototype,"label",2);Dt([u()],et.prototype,"value",2);Dt([u()],et.prototype,"detail",2);Dt([u()],et.prototype,"icon",2);Dt([u({reflect:!0})],et.prototype,"tone",2);Dt([u()],et.prototype,"badge",2);et=Dt([k("sw-kpi")],et);function si(e={}){const t=new URLSearchParams;e.date&&t.set("date",e.date),e.from&&e.to&&(t.set("from",e.from),t.set("to",e.to)),e.acked&&t.set("acked","true"),e.cameraId&&t.set("camera_id",e.cameraId),e.type&&t.set("type",e.type),e.unacked&&t.set("unacked","true"),e.limit&&t.set("limit",String(e.limit)),e.floorId&&t.set("floor_id",e.floorId),e.zoneId&&t.set("zone_id",e.zoneId),e.buildingId&&t.set("building_id",e.buildingId),e.siteId&&t.set("site_id",e.siteId),e.source&&t.set("source",e.source),e.severity&&t.set("severity",e.severity);const s=t.toString();return z(`events${s?`?${s}`:""}`)}const Nl=()=>z("events/summary"),Ll=(e,t)=>z(`cameras/${e}/events?date=${t}`),yr=e=>A(`events/${e}/ack`),$a=e=>A("events/ack-many",{event_ids:e}),xa={camera:"לפי מצלמה",all:"כל המצלמות יחד",zone:"לפי חדר",floor:"לפי קומה"};function Bl(e={}){const t=new URLSearchParams;e.date&&t.set("date",e.date),e.cameraId&&t.set("camera_id",e.cameraId),e.gap&&t.set("gap",String(e.gap)),e.by&&t.set("by",e.by),e.limit&&t.set("limit",String(e.limit));const s=t.toString();return z(`events/windows${s?`?${s}`:""}`)}const Hl=e=>z(`events/${e}`),zt=(e,t=0)=>pe(`events/${e}/thumbnail${t?`?v=${t}`:""}`);async function $r(e){try{const t=await fetch(zt(e),{credentials:"include",cache:"no-store"});return t.status===200?"ready":t.status===202?"pending":"unavailable"}catch{return"pending"}}const q={motion:"תנועה",person:"אדם",vehicle:"רכב",line:"חציית קו",field:"חדירה לאזור",offline:"אובדן וידאו",tamper:"חבלה במצלמה",door:"דלת",io:"כניסת חיווי",storage:"אחסון",system:"מערכת",coverage_gap:"פער בקליטת אירועים",manual:"הקלטה ידנית",other:"אחר"},Ns={motion:"#ef4444",person:"#2f6bff",vehicle:"#22c55e",line:"#f59e0b",field:"#f59e0b",offline:"#6b7280",tamper:"#b45309",door:"#8b5cf6",io:"#8b5cf6",storage:"#6b7280",system:"#6b7280",coverage_gap:"#6b7280",manual:"#2f6bff",other:"#6b7280"};function Vl(e){return e==="person"||e==="vehicle"||e==="motion"||e==="line"||e==="offline"||e==="door"?e:e==="field"?"line":e==="io"?"door":e==="tamper"||e==="coverage_gap"||e==="storage"||e==="system"?"offline":"motion"}function jl(e,t){let s=null,i=!1,a=2e3;const n=(()=>{const l=new URL(pe("events/ws"));return l.protocol=l.protocol==="https:"?"wss:":"ws:",l.toString()})(),o=()=>{if(!i){try{s=new WebSocket(n)}catch{return}s.onopen=()=>{a=2e3,t?.(null,!0)},s.onmessage=l=>{try{const p=JSON.parse(l.data);p.type==="event_added"||p.type==="event_updated"?e(p.payload):p.type==="heartbeat"&&t?.(p.payload.ingest,!0)}catch{}},s.onclose=()=>{t?.(null,!1),i||(window.setTimeout(o,a),a=Math.min(3e4,a*2))}}};return o(),()=>{i=!0,s?.close()}}const Fl={measured:"נמדד",inferred:"נגזר",command:"פקודה",availability:"זמינות"},Ul=(e,t=120)=>z(`events/${e}/correlation?window=${t}`),Wl=(e=90)=>z(`events/facets?days=${e}`),ka={alertstream:"אירוע NVR",recording:"נגזר מהקלטה",system:"מערכת",ha:"חיישן HA"},Zl=(e,t=90)=>z(`events/${e}/route?window=${t}`),xr=(e=!1)=>z(`storage${e?"?fresh=true":""}`);function kt(e){return e==null?"—":e>=1024*1024?`${(e/1024/1024).toFixed(2)} TB`:e>=1024?`${(e/1024).toFixed(0)} GB`:`${e} MB`}const ns={ok:"תקין",warn:"לתשומת לב",error:"שגיאה"},_a={ok:"live",warn:"stale",error:"offline"},kr=(e=!1)=>z(`health/report${e?"?fresh=1":""}`),Yi=()=>z("health/summary");function ql(e){return e<3600?`${Math.floor(e/60)} דק׳`:e<86400?`${Math.floor(e/3600)} שע׳ ${Math.floor(e%3600/60)} דק׳`:`${Math.floor(e/86400)} ימים ${Math.floor(e%86400/3600)} שע׳`}let Ls=null,Cs=null;const Kl={"media.transport_default":"mse","media.max_live_sessions":8,"media.wall_profile":"sub","snapshots.max_age_s":60};async function Be(e=!1){return g()?Ls&&!e?Ls:(Cs||(Cs=tr().then(t=>Ls=t.settings).finally(()=>Cs=null)),Cs):Kl}function za(){Ls=null}function Ji(e){return sr()||e?.["media.transport_default"]||"mse"}var Gl=Object.defineProperty,Yl=Object.getOwnPropertyDescriptor,Ee=(e,t,s,i)=>{for(var a=i>1?void 0:i?Yl(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&Gl(t,s,a),a};function Jl(e){return e<5?"לילה טוב":e<12?"בוקר טוב":e<17?"צהריים טובים":e<21?"ערב טוב":"לילה טוב"}const Xl={person:"var(--sw-accent)",vehicle:"var(--sw-live)",motion:"var(--sw-danger)",line:"var(--sw-stale)",offline:"var(--sw-offline)",door:"var(--sw-purple)"},Ql={"כניסה ראשית":"entrance","חצר אחורית":"backyard",מחסן:"warehouse",לובי:"lobby","חניה מקורה":"parking"};let we=class extends ${constructor(){super(...arguments),this.cams=null,this.recorder=null,this.sites=null,this.summary=null,this.recent=[],this.storage=null,this.health=null,this.raw=null,this.tz="Asia/Jerusalem",this.now=new Date,this.loaded=!1,this.timer=0,this.clockTimer=0}connectedCallback(){super.connectedCallback(),g()&&(this.load(),this.timer=window.setInterval(()=>void this.load(),6e4),this.clockTimer=window.setInterval(()=>this.now=new Date,3e4))}disconnectedCallback(){window.clearInterval(this.timer),window.clearInterval(this.clockTimer),super.disconnectedCallback()}async load(){this.loadStorage();const[e,t,s,i,a,n,o]=await Promise.allSettled([Be(),Pe(),z("sites?tree=true"),Nl(),si({limit:6}),Yi(),z("health")]);e.status==="fulfilled"&&(this.tz=e.value["time.zone"]??this.tz),t.status==="fulfilled"?(this.cams=t.value.cameras.filter(l=>l.enabled),this.recorder=t.value.recorder):this.cams===null&&(this.cams=[]),s.status==="fulfilled"?this.sites=s.value.sites:this.sites===null&&(this.sites=[]),i.status==="fulfilled"&&(this.summary=i.value),a.status==="fulfilled"&&(this.recent=a.value.events),n.status==="fulfilled"&&(this.health=n.value),o.status==="fulfilled"&&(this.raw=o.value),this.loaded=!0,this.now=new Date}async loadStorage(){try{this.storage=await xr()}catch{this.storage=null}}fmtTime(e){return new Date(e).toLocaleTimeString("he-IL",{hour:"2-digit",minute:"2-digit",timeZone:this.tz})}spots(){const e=[],t=this.cams??[];for(const a of t.filter(n=>n.status==="offline"))e.push({kind:"critical",title:`מצלמה מנותקת: ${a.name}`,meta:`ערוץ ${a.channel}${a.last_seen_at?` · נראתה לאחרונה ${this.fmtTime(a.last_seen_at)}`:""}`,why:"מוצג כי ה־NVR מדווח שהערוץ אינו מחובר",link:`#/live/cameras/${a.id}`});for(const a of(this.health?.items??[]).filter(n=>n.status!=="ok"))e.push({kind:a.status==="error"?"critical":"alert",title:a.label,meta:`בדיקת מערכת · ${ns[a.status]}`,why:"מוצג כי בדיקת הבריאות של ה־Add-on מדווחת על כך",link:"#/system/diagnostics"});const s=this.summary?.today.unacked??0;if(s>0){const a=Object.entries(this.summary?.today.by_type??{}).sort((n,o)=>o[1]-n[1]).slice(0,3).map(([n,o])=>`${q[n]??n} ${o}`).join(" · ");e.push({kind:"alert",title:`${s} אירועים שלא נבדקו היום`,meta:a,why:"מוצג כי אירועים ממתינים לסימון טיפול במרכז האירועים",link:"#/investigate/events"})}const i=this.raw?.events.ingest;return i?.connected&&!i.events_stored&&!i.last_event_at&&e.push({kind:"info",title:"ה־NVR לא שלח התראות מאז ההפעלה",meta:"אירועי תנועה נגזרים מההקלטות כל 10 דקות",why:'מוצג כי זרם ההתראות מחובר אך ריק — ב־NVR יש להפעיל "Notify Surveillance Center" ב־linkage של זיהוי התנועה',link:"#/system/setup"}),this.raw?.home_assistant.configured&&!this.raw.home_assistant.connected&&e.push({kind:"alert",title:"אין חיבור ל־Home Assistant",meta:this.raw.home_assistant.last_error??"",why:"מוצג כי מצבי הישויות והדלתות עלולים להיות מיושנים",link:"#/system/setup"}),e}renderApi(){const e=ut.me?.user,t=e?.display_name||e?.username||"",s=Number(this.now.toLocaleString("en-GB",{hour:"numeric",hour12:!1,timeZone:this.tz})),i=this.cams??[],a=i.filter(S=>S.status==="online").length,n=this.sites??[],o=n.flatMap(S=>(S.buildings??[]).flatMap(te=>te.floors??[])),l=this.health,p=l?l.status==="ok"?"live":l.status==="warn"?"stale":"offline":"neutral",f=l?.items.find(S=>S.status!=="ok"),m=this.loaded?this.spots():[],v=this.storage,M=v?.totals??null,_=M?.used_pct??null,O=34,ae=2*Math.PI*O,Rt=i.filter(S=>S.status==="online").slice(0,2);return r`
      <sw-page heading=${`${Jl(s)}${t?`, ${t}`:""}`} subheading=${l?`מצב המערכת: ${ns[l.status]}${f?` · ${f.label}`:" · כל הבדיקות תקינות"}`:"קורא את מצב המערכת…"}>
        ...
        <div class="kpis" data-overview-kpis>
          ...
          <sw-kpi icon="shield" tone=${p} value=${l?ns[l.status]:"…"} label="מצב מערכת" detail=${f?f.label:"NVR, go2rtc, HA ואחסון"}></sw-kpi>
        </div>
        ...
        <div class="row3">
          <sw-card heading="אירועים אחרונים" subheading=${this.summary?`${this.summary.today.total} היום · ${this.summary.today.measured} נמדדו · ${this.summary.today.inferred} נגזרו מהקלטה`:""}>
            ...
            ${this.recent.length?this.recent.map(S=>r`<div class="ev" data-overview-event @click=${()=>b(`/investigate/events/${S.id}`)}>
                    ...
                    <div class="txt"><b style=${`--tone:${Ns[S.type]??"#6b7280"}`}><i></i>${q[S.type]??S.type}${S.acked_at?"":" · לבדיקה"}</b><small>${S.camera_name??S.details?.name??"ללא מצלמה"} · ${S.confidence==="inferred"?"נגזר מהקלטה":S.source==="ha"?"חיישן HA":"התראה"}</small></div>
  ...
  `;Ee([d()],we.prototype,"cams",2);Ee([d()],we.prototype,"recorder",2);Ee([d()],we.prototype,"sites",2);Ee([d()],we.prototype,"summary",2);Ee([d()],we.prototype,"recent",2);Ee([d()],we.prototype,"storage",2);Ee([d()],we.prototype,"health",2);Ee([d()],we.prototype,"raw",2);Ee([d()],we.prototype,"tz",2);Ee([d()],we.prototype,"now",2);Ee([d()],we.prototype,"loaded",2);we=Ee([k("live-overview")],we);var ed=Object.defineProperty,td=Object.getOwnPropertyDescriptor,at=(e,t,s,i)=>{for(var a=i>1?void 0:i?td(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&ed(t,s,a),a};const ui=[1,2,4,6,8,9,12,16,20,25,32],Sa="sw.wall.count",Ma=[{id:"all",label:"כל המצלמות"},{id:"outside",label:"חוץ"},{id:"inside",label:"פנים"},{id:"night",label:"לילה"}];let Re=class extends ${constructor(){super(...arguments),this.cameras="",this.count=4,this.stream="auto",this.view="all",this.cams=null,this.settings=null,this.error="",this.posterBust=Date.now()}connectedCallback(){super.connectedCallback(),this.load(),this.posterTimer=window.setInterval(()=>this.posterBust=Date.now(),6e4)}disconnectedCallback(){super.disconnectedCallback(),window.clearInterval(this.posterTimer)}setCount(e){this.count=e;try{localStorage.setItem(Sa,String(e))}catch{}}async load(){if(g())try{const[e,t]=await Promise.all([Pe(),Be()]);this.cams=e.cameras.filter(n=>n.enabled),this.settings=t;let s=0;try{s=Number(localStorage.getItem(Sa)??0)}catch{}const i=Number(t["ui.wall_count"]??0),a=ui.includes(s)?s:ui.includes(i)?i:0;a&&(this.count=a)}catch(e){this.error=w(e)}}renderApi(){const e=this.cams;if(this.error)return r`<sw-state-panel state="error" hint=${this.error} actionLabel="נסה שוב" @action=${()=>this.load()}></sw-state-panel>`;if(!e)return r`<sw-state-panel state="loading"></sw-state-panel>`;if(!e.length)return r`<sw-state-panel state="empty" heading="אין מצלמות זמינות" hint="המצלמות מתגלות אוטומטית מה־NVR בהפעלה ובכל 10 דקות. אם הרשימה ריקה: בדוק את פרטי ה־NVR בהגדרות ה־Add-on ואת יומן ה־Add-on, או הרץ סנכרון ידני; ייתכן גם שאין לך הרשאה למצלמות."><div style="margin-block-start:10px"><sw-button @click=${()=>b("/system/devices")}>למצלמות</sw-button></div></sw-state-panel>`;const t=this.cameras?this.cameras.split(",").filter(Boolean):[],s=t.length?e.filter(f=>t.includes(f.id)):e,i=t.length?Math.max(1,s.length):this.count,a=s.slice(0,i),n=i===1?1:i===2||i<=4?2:i<=9?3:i<=16?4:i<=25?5:6,o=this.settings?.["media.max_live_sessions"]??8,l=this.stream==="auto"?this.settings?.["media.wall_profile"]??"sub":this.stream,p=Ji(this.settings);return r`
      <div class="grid" style="--cols:${n}">
        ${a.map((f,m)=>r`<sw-camera-tile
            ...
            profile=${l}
            transport=${p}
            poster=${f.status==="offline"?"":Ve(f.id,this.posterBust)}
            ?compact=${i>=9}
  ...
  `;at([u()],Re.prototype,"cameras",2);at([d()],Re.prototype,"count",2);at([d()],Re.prototype,"stream",2);at([d()],Re.prototype,"view",2);at([d()],Re.prototype,"cams",2);at([d()],Re.prototype,"settings",2);at([d()],Re.prototype,"error",2);at([d()],Re.prototype,"posterBust",2);Re=at([k("live-wall")],Re);var sd=Object.defineProperty,id=Object.getOwnPropertyDescriptor,J=(e,t,s,i)=>{for(var a=i>1?void 0:i?id(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&sd(t,s,a),a};let Z=class extends ${constructor(){super(...arguments),this.cameraId="cam-1",this.cam=null,this.zones=null,this.zonesBusy=!1,this.zonesError="",this.zoneLayers={motion:!0,privacy:!0,intrusion:!0,lines:!0},this.caps=null,this.capsError="",this.cams=[],this.settings=null,this.error="",this.loading=!0,this.profile="main",this.transport="auto",this.playerStatus="",this.playerTransport="",this.posterBust=Date.now(),this.ptzMode="presets"}connectedCallback(){super.connectedCallback(),this.load()}updated(e){e.has("cameraId")&&e.get("cameraId")!==void 0&&this.load(),e.has("cam")&&this.cam&&g()&&!this.zonesBusy&&(!this.zones||this.zones.camera_id!==this.cam.id)&&(this.zonesError="",this.loadZones()),e.has("cam")&&this.cam&&g()&&(!this.caps||this.caps.camera_id!==this.cam.id)&&this.loadCaps()}async loadZones(e=!1){if(this.cam){this.zonesBusy=!0,this.zonesError="";try{this.zones=await Fn(this.cam.id,e)}catch(t){this.zonesError=w(t)}finally{this.zonesBusy=!1}}}async loadCaps(e=!1){if(this.cam){this.capsError="";try{this.caps=await Un(this.cam.id,e)}catch(t){this.capsError=w(t)}}}renderCaps(){const e=this.caps;if(this.capsError&&!e)return r`<div class="note" data-caps>יכולות המצלמה לא נקראו מה־NVR: ${this.capsError}</div>`;if(!e)return r`<div class="note" data-caps>קורא יכולות מה־NVR…</div>`;const t=e.ptz.state==="supported"?"live":e.ptz.state==="unsupported"?"neutral":"unknown",s=e.ptz.state==="supported"?`PTZ: נתמך${e.ptz.preset_count!==null?` · ${e.ptz.preset_count} presets`:""}`:e.ptz.state==="unsupported"?"PTZ: לא נתמך במצלמה זו":"PTZ: לא ידוע",i=e.audio.state==="available"?"live":e.audio.state==="disabled"?"stale":e.audio.state==="unsupported"?"neutral":"unknown",a=e.audio.state==="available"?`שמע דו־כיווני: ערוץ פעיל${e.audio.codec?` (${e.audio.codec})`:""}`:e.audio.state==="disabled"?"שמע דו־כיווני: ערוץ קיים אך כבוי במכשיר":e.audio.state==="unsupported"?"שמע דו־כיווני: אין ערוץ למצלמה זו":"שמע דו־כיווני: לא ידוע";return r`<div class="note" style="margin-block-start:8px;display:flex;flex-wrap:wrap;gap:6px;align-items:center" data-caps data-ptz=${e.ptz.state} data-audio=${e.audio.state}>
    ...
    `}renderDemo(){const e=W.find(i=>i.id===this.cameraId)??W[0],t=e.state==="live"||e.state==="stale",s=je[e.id]??"lobby";return r`
      ...
      <div class="grid">
        ...
        <sw-card heading="מצלמות באותה קומה">
          <div class="tiles">
            ${W.filter(i=>i.floor===e.floor&&i.id!==e.id).slice(0,4).map(i=>r`<sw-camera-tile compact name=${i.name} state=${i.state} scene=${je[i.id]??"lobby"} @click=${()=>b(`/live/cameras/${i.id}`)}></sw-camera-tile>`)}
          </div>
        </sw-card>
      </div>
  ...
  `;J([u()],Z.prototype,"cameraId",2);J([d()],Z.prototype,"cam",2);J([d()],Z.prototype,"zones",2);J([d()],Z.prototype,"zonesBusy",2);J([d()],Z.prototype,"zonesError",2);J([d()],Z.prototype,"zoneLayers",2);J([d()],Z.prototype,"caps",2);J([d()],Z.prototype,"capsError",2);J([d()],Z.prototype,"cams",2);J([d()],Z.prototype,"settings",2);J([d()],Z.prototype,"error",2);J([d()],Z.prototype,"loading",2);J([d()],Z.prototype,"profile",2);J([d()],Z.prototype,"transport",2);J([d()],Z.prototype,"playerStatus",2);J([d()],Z.prototype,"playerTransport",2);J([d()],Z.prototype,"posterBust",2);J([d()],Z.prototype,"ptzMode",2);J([qt("sw-live-player")],Z.prototype,"player",2);Z=J([k("live-camera")],Z);var ad=Object.defineProperty,rd=Object.getOwnPropertyDescriptor,Ze=(e,t,s,i)=>{for(var a=i>1?void 0:i?rd(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&ad(t,s,a),a};const nd={name:"",cameras:[],cols:2,rows:2,shared:!1,kiosk:!1},od=[{name:"כל המצלמות",layout:9,scope:"משותפת",mobile:"4 · משני",owner:"יוני",kiosk:!0},{name:"חוץ",layout:4,scope:"משותפת",mobile:"2 · משני",owner:"יוני",kiosk:!1},{name:"פנים",layout:6,scope:"משותפת",mobile:"ללא",owner:"יוסי",kiosk:!1},{name:"לילה",layout:4,scope:"אישית",mobile:"4 · משני",owner:"דנה",kiosk:!1}];let Me=class extends ${constructor(){super(...arguments),this.views=null,this.cams=[],this.canShare=!1,this.canManageAll=!1,this.editing=null,this.confirmDelete=null,this.busy=!1,this.error="",this.formError=""}connectedCallback(){super.connectedCallback(),g()&&this.load()}async load(){try{const[e,t]=await Promise.all([fr(),Pe()]);this.views=e.views,this.canShare=e.can_share,this.canManageAll=e.can_manage_all,this.cams=t.cameras.filter(s=>s.enabled&&s.can_view_live!==!1),this.error=""}catch(e){this.error=w(e),this.views=this.views??[]}}canEdit(e){return this.canManageAll||e.owner_user_id===ut.me?.user.id}open(e){this.formError="",this.editing=e?{id:e.id,name:e.name,cameras:[...e.cameras],cols:e.cols,rows:e.rows,shared:e.shared,kiosk:e.kiosk}:{...nd,cameras:[]}}toggleCamera(e){if(!this.editing)return;const t=this.editing.cameras.includes(e);!t&&this.editing.cameras.length>=16||(this.editing={...this.editing,cameras:t?this.editing.cameras.filter(s=>s!==e):[...this.editing.cameras,e]})}async save(){const e=this.editing;if(e){if(!e.name.trim()){this.formError="לתצוגה צריך שם.";return}if(!e.cameras.length){this.formError="בחר לפחות מצלמה אחת.";return}this.busy=!0;try{const t={name:e.name.trim(),cameras:e.cameras,cols:e.cols,rows:e.rows,shared:e.shared,kiosk:e.kiosk};e.id?await Fo(e.id,t):await mr(t),this.editing=null,await this.load()}catch(t){this.formError=w(t)}finally{this.busy=!1}}}async removeView(){const e=this.confirmDelete;if(e){this.busy=!0;try{await Uo(e.id),this.confirmDelete=null,await this.load()}catch(t){this.error=w(t)}finally{this.busy=!1}}}renderEditor(){const e=this.editing;return r`<sw-dialog open heading=${e.id?"עריכת תצוגה":"תצוגה חדשה"} subheading="שם, מצלמות ופריסה · תצוגה משותפת נראית לכל המשתמשים" data-view-dialog @close=${()=>this.editing=null}>
      <div class="form">
      ...
      <sw-page heading="תצוגות שמורות" subheading="תבניות 1 / 2 / 4 / 6 / 9 / 12 / 16 / מותאם, אישיות או משותפות, עם התאמה למובייל · נתוני הדגמה">
        ...
        <div class="grid">
          ${od.map(e=>{const t=Math.ceil(Math.sqrt(e.layout));return r`<sw-card heading=${e.name}>
              ...
              <div class="thumb" style="grid-template-columns:repeat(${t},1fr)">${W.filter(s=>s.state==="live").slice(0,e.layout).map(s=>r`<sw-scene kind=${je[s.id]??"lobby"}></sw-scene>`)}</div>
              <dl>
  ...
  `;rt([d()],Ne.prototype,"cams",2);rt([d()],Ne.prototype,"settings",2);rt([d()],Ne.prototype,"clock",2);rt([d()],Ne.prototype,"page",2);rt([d()],Ne.prototype,"health",2);rt([d()],Ne.prototype,"disconnected",2);rt([d()],Ne.prototype,"view",2);rt([d()],Ne.prototype,"started",2);Ne=rt([k("kiosk-wall")],Ne);var pd=Object.defineProperty,hd=Object.getOwnPropertyDescriptor,Ce=(e,t,s,i)=>{for(var a=i>1?void 0:i?hd(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&pd(t,s,a),a};const ud={preserved:"#16a34a",preserving:"#d97706",nvr:"#7c3aed"},Ts=[{label:"יום",minutes:1440},{label:"6 שע׳",minutes:360},{label:"שעה",minutes:60},{label:"10 דק׳",minutes:10},{label:"דקה",minutes:1}];function Ei(e){return String(e).padStart(2,"0")}function ze(e){const t=(e%1440+1440)%1440;return`${Ei(Math.floor(t/60))}:${Ei(Math.floor(t%60))}`}function Ge(e){const t=(e%1440+1440)%1440,s=Math.min(59,Math.round(t%1*60));return`${ze(t)}:${Ei(s)}`}const fd={motion:"#ef4444",person:"#2f6bff",vehicle:"#22c55e",line:"#f59e0b",offline:"#6b7280",door:"#8b5cf6"};let ve=class extends ${constructor(){super(...arguments),this.segments=[],this.events=[],this.bookmarks=[],this.cursor=615,this.windowMinutes=360,this.precision="estimated",this.follow=!0,this.limit=1440,this.hover=null,this.lastHoverBucket=-1,this.viewStart=-1,this.dragging=!1}get start(){const e=Math.max(0,1440-this.windowMinutes);return this.viewStart>=0&&!this.follow?Math.max(0,Math.min(e,this.viewStart)):Math.max(0,Math.min(e,this.cursor-this.windowMinutes/2))}get step(){return this.windowMinutes>=360?1:this.windowMinutes>=60?1/6:1/60}snap(e){const t=this.step;return Math.max(0,Math.min(this.limit,Math.round(e/t)*t))}x(e,t){return(e-this.start)/this.windowMinutes*t}minuteAt(e){const t=e.currentTarget.getBoundingClientRect();return this.start+(e.clientX-t.left)/t.width*this.windowMinutes}onMove(e){const t=this.minuteAt(e);if(this.hover=t,!this.dragging){const s=Math.floor(t*6);if(s!==this.lastHoverBucket){this.lastHoverBucket=s;const i=e.currentTarget.getBoundingClientRect();this.dispatchEvent(new CustomEvent("hover",{detail:{minute:t,x:e.clientX-i.left,width:i.width},bubbles:!0,composed:!0}))}}if(this.dragging){const s=this.snap(t);this.cursor=s,this.dispatchEvent(new CustomEvent("scrub",{detail:{minute:s},bubbles:!0,composed:!0}))}}onDown(e){e.button===0&&(e.currentTarget.setPointerCapture(e.pointerId),this.dragging=!0,this.viewStart=this.start,this.follow=!1)}onUp(e){if(!this.dragging)return;this.dragging=!1;const t=this.snap(this.minuteAt(e));this.cursor=t,this.follow=!0,this.dispatchEvent(new CustomEvent("seek",{detail:{minute:t,alt:e.altKey},bubbles:!0,composed:!0}))}onWheel(e){e.preventDefault();const t=Ts.findIndex(i=>i.minutes===this.windowMinutes),s=Math.max(0,Math.min(Ts.length-1,t+(e.deltaY>0?-1:1)));s!==t&&this.setWindow(Ts[s].minutes,this.minuteAt(e))}setWindow(e,t=this.cursor){const s=Math.max(0,Math.min(1,(t-this.start)/this.windowMinutes));this.windowMinutes=e,this.viewStart=t-s*e,this.follow=!1,this.dispatchEvent(new CustomEvent("window-change",{detail:{minutes:e},bubbles:!0,composed:!0}))}buckets(e){const t=[],s=this.windowMinutes/e;for(let i=0;i<e;i++){const a=this.start+i*s,n=a+s;let o=0;for(const l of this.segments)l.endMin>a&&l.startMin<n&&(o=Math.max(o,l.kind==="motion"?2:1));o&&this.events.some(l=>l.minute>=a-s&&l.minute<=n+s)&&(o=3),t.push(o)}return t}tickEvery(){const e=this.windowMinutes;return e<=1?10/60:e<=10?1:e<=60?10:e<=360?60:180}label(e){return this.windowMinutes<=10?Ge(e):ze(e)}render(){const n=this.tickEvery(),o=[];for(let _=Math.ceil(this.start/n-1e-9)*n;_<=this.start+this.windowMinutes+1e-9;_+=n)o.push(_);const l=[0,12,26,36],p={verified:"זמן מאומת",keyframe_limited:"דיוק לפי keyframe",estimated:"זמן משוער",unknown:"דיוק לא ידוע"}[this.precision],f=this.x(this.cursor,1e3),m=this.label(this.cursor),v=m.length>5?62:48,M=this.limit<this.start+this.windowMinutes?Math.max(0,this.x(this.limit,1e3)):null;return r`
      ...
      <svg
        ...
        ${this.events.map(_=>{const O=this.x(_.minute,1e3);return O<0||O>1e3?c:h`<g><circle cx=${O} cy=${58-l[3]-8} r="3.5" fill=${fd[_.kind]} /><title>${_.label} · ${ze(_.minute)}</title></g>`})}
  ...
  `;Ce([u({attribute:!1})],ve.prototype,"segments",2);Ce([u({attribute:!1})],ve.prototype,"events",2);Ce([u({attribute:!1})],ve.prototype,"bookmarks",2);Ce([u({type:Number})],ve.prototype,"cursor",2);Ce([u({type:Number})],ve.prototype,"windowMinutes",2);Ce([u()],ve.prototype,"precision",2);Ce([u({type:Boolean})],ve.prototype,"follow",2);Ce([u({type:Number})],ve.prototype,"limit",2);Ce([d()],ve.prototype,"hover",2);Ce([d()],ve.prototype,"viewStart",2);Ce([d()],ve.prototype,"dragging",2);ve=Ce([k("sw-timeline")],ve);const os={open:"פתוח",in_review:"בבדיקה",closed:"סגור"},md={preserved:"עותק שמור",preserving:"מעתיק מה־NVR…",nvr_only:"סימנייה ל־NVR בלבד",missing:"חסר: ה־NVR כבר לא מחזיק את הקטע",unknown:"לא נבדק מול ה־NVR",none:""};function Sr(e={}){const t=new URLSearchParams;e.status&&t.set("status",e.status),e.q&&t.set("q",e.q);const s=t.toString();return z(`cases${s?`?${s}`:""}`)}const Mr=e=>A("cases",e),wd=(e,t=!0)=>z(`cases/${e}${t?"":"?check=false"}`),vd=(e,t)=>it(`cases/${e}`,t),gd=e=>ye(`cases/${e}`),Ci=(e,t)=>A(`cases/${e}/items`,t),bd=(e,t)=>ye(`cases/${e}/items/${t}`),yd=(e,t)=>A(`cases/${e}/items/${t}/preserve`),Aa={preserved:"עותק שמור",preserving:"מעתיק מה־NVR…",nvr:"סימנייה ל־NVR"},Ia=(e,t)=>z(`cases/bookmarks?camera_id=${encodeURIComponent(e)}&date=${encodeURIComponent(t)}`),Pa=e=>e.toISOString().replace(/\.\d{3}Z$/,"Z"),Ti=(e,t=15,s=45)=>({from_at:Pa(new Date(e.getTime()-t*1e3)),to_at:Pa(new Date(e.getTime()+s*1e3))}),$d=()=>z("evidence/signing"),xd=()=>A("evidence/signing/rotate"),kd=e=>A(`cases/${e}/bundle`),_d=e=>z(`cases/${e}/bundles`),zd=(e,t)=>pe(`cases/${e}/bundles/${t}`),Sd=(e,t)=>pe(`cases/${e}/items/${t}/file`);function Md(e){const t=new FormData;return t.append("file",e,e.name),Ki("cases/bundles/verify",t)}var Ad=Object.defineProperty,Id=Object.getOwnPropertyDescriptor,Te=(e,t,s,i)=>{for(var a=i>1?void 0:i?Id(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&Ad(t,s,a),a};let ge=class extends ${constructor(){super(...arguments),this.item=null,this.subheading="",this.cases=[],this.loading=!1,this.error="",this.picked="",this.newTitle="",this.note="",this.busy=!1,this.done=null,this.canManage=!0}updated(e){e.has("item")&&this.item&&this.load()}async load(){this.loading=!0,this.error="",this.done=null,this.note="";try{const e=await Sr({status:"open"});this.cases=e.cases,this.canManage=e.can_manage,this.picked=e.cases[0]?.id??"new"}catch(e){this.error=w(e)}finally{this.loading=!1}}close(){this.item=null,this.dispatchEvent(new CustomEvent("close",{bubbles:!0,composed:!0}))}async confirm(){const e=this.item;if(e){this.busy=!0,this.error="";try{let t=this.picked,s=this.cases.find(a=>a.id===t)?.title??"";if(t==="new"){if(!this.newTitle.trim()){this.error="תן שם לתיק החדש.";return}const a=await Mr({title:this.newTitle.trim()});t=a.id,s=a.title}const i=await Ci(t,{...e,note:this.note.trim()||e.note});this.done={id:t,title:s},this.dispatchEvent(new CustomEvent("added",{detail:{caseId:t,item:i},bubbles:!0,composed:!0}))}catch(t){this.error=w(t)}finally{this.busy=!1}}}render(){const e=this.item;if(!e)return c;const t=e.kind==="event"?"האירוע":e.kind==="clip"?"הקטע":"ההערה";return r`<sw-dialog open heading="הוסף לתיק" subheading=${this.subheading} data-case-picker @close=${()=>this.close()}>
  ...
  `;Te([u({attribute:!1})],ge.prototype,"item",2);Te([u()],ge.prototype,"subheading",2);Te([d()],ge.prototype,"cases",2);Te([d()],ge.prototype,"loading",2);Te([d()],ge.prototype,"error",2);Te([d()],ge.prototype,"picked",2);Te([d()],ge.prototype,"newTitle",2);Te([d()],ge.prototype,"note",2);Te([d()],ge.prototype,"busy",2);Te([d()],ge.prototype,"done",2);Te([d()],ge.prototype,"canManage",2);ge=Te([k("sw-case-picker")],ge);const Ar=(e,t)=>z(`cameras/${e}/recordings?date=${t}`),ls=new Set,ds=new Set;function Pd(){if(!(!ls.size&&!ds.size)){for(const e of ds)navigator.sendBeacon?.(pe(`playback/groups/${e}/close`),"");for(const e of ls)navigator.sendBeacon?.(pe(`playback/sessions/${e}/close`),"");ls.clear(),ds.clear()}}typeof window<"u"&&window.addEventListener("pagehide",Pd);const Xi=async(e,t)=>{const s=await A("playback/sessions",{camera_id:e,start_at:t});return ls.add(s.id),s},Ea=(e,t)=>A(`playback/sessions/${e}/seek`,{start_at:t}),bs=e=>(ls.delete(e),ye(`playback/sessions/${e}`));function Us(e){const t=new URL(pe(`playback/sessions/${e.id}/ws?generation=${e.generation}`));return t.protocol=t.protocol==="https:"?"wss:":"ws:",t.toString()}function Xe(e,t){const s=new Intl.DateTimeFormat("en-CA",{timeZone:t,year:"numeric",month:"2-digit",day:"2-digit"}).formatToParts(e),i=a=>s.find(n=>n.type===a)?.value??"";return`${i("year")}-${i("month")}-${i("day")}`}function X(e,t){const s=new Intl.DateTimeFormat("en-GB",{timeZone:t,hour:"2-digit",minute:"2-digit",second:"2-digit",hourCycle:"h23"}).formatToParts(e),i=a=>Number(s.find(n=>n.type===a)?.value??0);return i("hour")*60+i("minute")+i("second")/60}function He(e,t,s){const[i,a,n]=e.split("-").map(Number),o=Date.UTC(i,a-1,n,Math.floor(t/60),Math.floor(t%60),Math.round(t%1*60)),l=f=>{const m=new Intl.DateTimeFormat("en-US",{timeZone:s,hour12:!1,year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit",second:"2-digit"}).formatToParts(new Date(f)),v=_=>Number(m.find(O=>O.type===_)?.value??0);return Date.UTC(v("year"),v("month")-1,v("day"),v("hour")%24,v("minute"),v("second"))-f};let p=o-l(o);return p=o-l(p),new Date(p)}const Ed=async(e,t)=>{const s=await A("playback/groups",{camera_ids:e,start_at:t});return ds.add(s.id),s},Cd=(e,t)=>A(`playback/groups/${e}/seek`,{start_at:t}),Td=e=>(ds.delete(e),ye(`playback/groups/${e}`)),Dd=(e,t)=>A(`playback/groups/${e}/sync`,{p95_s:t.p95,quality:t.quality,samples:t.samples,partial:t.partial,members:t.members}),ii=(e,t)=>pe(`cameras/${e}/frame?at=${encodeURIComponent(t)}`),Ir=(e,t,s)=>({camera_id:e,from_at:t,to_at:s}),Od=(e,t,s)=>A("exports/estimate",Ir(e,t,s)),Rd=(e,t,s)=>A("exports",Ir(e,t,s)),Nd=()=>z("exports"),Ld=e=>A(`exports/${e}/cancel`),Bd=e=>ye(`exports/${e}`),Pr=e=>pe(`exports/${e}/download`),Hd=e=>pe(`exports/${e}/manifest`);function Lt(e){return e==null?"—":e<1024*1024?`${Math.round(e/1024)} KB`:e<1024*1024*1024?`${(e/1024/1024).toFixed(1)} MB`:`${(e/1024/1024/1024).toFixed(2)} GB`}var Vd=Object.defineProperty,jd=Object.getOwnPropertyDescriptor,P=(e,t,s,i)=>{for(var a=i>1?void 0:i?jd(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&Vd(t,s,a),a};const $t=["closed","expired","failed"];function ts(e){return Ge(Math.max(0,Math.min(1439.983,e)))}function mi(e){const[t=0,s=0,i=0]=e.split(":").map(Number);return t*60+s+i/60}function Fd(e){const t=e.map(s=>Math.abs(s)).sort((s,i)=>s-i);return t[Math.min(t.length-1,Math.max(0,Math.ceil(.95*t.length)-1))]}let I=class extends ${constructor(){super(...arguments),this.cameraId="",this.at="",this.extraParam="",this.demoCamera="cam-10",this.cursor=615,this.generation=3,this.playing=!0,this.speed=1,this.filter="all",this.cams=null,this.tz="Asia/Jerusalem",this.date="",this.rec=null,this.dayEvents=[],this.bookmarks=[],this.activeBookmark=null,this.loadingRec=!1,this.session=null,this.group=null,this.extra=[],this.casePick=null,this.preview=null,this.previewTimer=0,this.busy=!1,this.error="",this.notice="",this.tileStatus={},this.drifts={},this.clock=null,this.barrier="none",this.syncStats=null,this.clockPausedAt=0,this.driftSamples={},this.lateSince={},this.resyncAt={},this.resyncs={},this.nudges={},this.groupStartedAt=0,this.lastReport=0,this.seekSentAt={},this.firstPlayAt={},this.startLatency={},this.paused=!1,this.scrubbing=!1,this.position=null,this.exportOpen=!1,this.exportFrom="",this.exportTo="",this.estimate=null,this.exportJob=null,this.exportBusy=!1,this.exportError="",this.onTlHover=e=>{if(!this.cameraId||!g())return;window.clearTimeout(this.previewTimer);const t=e.detail;this.previewTimer=window.setTimeout(()=>{const s=He(this.date,t.minute,this.tz).toISOString().replace(/\.\d{3}Z$/,"Z");this.preview={minute:t.minute,x:t.x,width:t.width,url:ii(this.cameraId,s),failed:!1}},250)},this.onTlHoverEnd=()=>{window.clearTimeout(this.previewTimer),this.preview=null}}connectedCallback(){super.connectedCallback(),g()&&(this.init(),this.ticker=window.setInterval(()=>this.tick(),500))}disconnectedCallback(){super.disconnectedCallback(),window.clearInterval(this.ticker),this.endSession()}updated(e){g()&&e.has("cameraId")&&e.get("cameraId")!==void 0&&this.cams&&this.selectCamera(this.cameraId,!0)}get members(){return[this.cameraId,...this.extra.filter(e=>e!==this.cameraId)]}get groupMode(){return this.extra.filter(e=>e!==this.cameraId).length>0}get masterSession(){return this.groupMode?this.group?.sessions.find(e=>e.camera_id===this.cameraId)??this.group?.sessions[0]??null:this.session}get live(){const e=this.masterSession;return!!e&&!$t.includes(e.state)&&(this.groupMode?!!this.group:!0)}async init(){try{const[e,t]=await Promise.all([Be(),Pe()]);this.tz=e["time.zone"]??"Asia/Jerusalem",this.cams=t.cameras.filter(n=>n.enabled);const s=this.cams.find(n=>n.id===this.cameraId)??this.cams[0],i=this.at?new Date(this.at):null,a=!!i&&!Number.isNaN(i.getTime());if(this.date=Xe(a?i:new Date,this.tz),s)if(this.cameraId=s.id,this.extraParam&&(this.extra=this.extraParam.split(",").filter(n=>n&&n!==s.id&&this.cams.some(o=>o.id===n)).slice(0,3)),await this.loadRecordings(),a)this.cursor=X(i,this.tz),await this.startAt(i);else{const n=this.rec?.segments.at(-1);this.cursor=n?this.insideLast(n):Math.max(0,X(new Date,this.tz)-5)}}catch(e){this.error=w(e)}}async selectCamera(e,t=!1){!e||!t&&e===this.cameraId||(await this.endSession(),this.cameraId=e,this.extra=this.extra.filter(s=>s!==e),this.error="",this.notice="",await this.loadRecordings())}async setDate(e){if(!e||e===this.date)return;await this.endSession(),this.date=e,await this.loadRecordings();const t=this.rec?.segments.at(-1);this.cursor=t?this.insideLast(t):540}insideLast(e){const t=X(new Date(e.start_at),this.tz),s=X(new Date(e.end_at),this.tz);return Math.max(0,t,s-5)}async loadRecordings(){if(!(!this.cameraId||!this.date)){this.loadingRec=!0,this.rec=null;try{const[e,t,s]=await Promise.all([Ar(this.cameraId,this.date),Ll(this.cameraId,this.date).catch(()=>({events:[]})),Ia(this.cameraId,this.date).catch(()=>({bookmarks:[]}))]);this.rec=e,this.dayEvents=t.events,this.bookmarks=s.bookmarks,this.activeBookmark=null,this.error=""}catch(e){this.error=w(e)}finally{this.loadingRec=!1}}}get markers(){return this.dayEvents.map(e=>({minute:X(new Date(e.occurred_at),this.tz),kind:Vl(e.type),label:`${q[e.type]??e.type}${e.confidence==="inferred"?" (מהקלטה)":""}${e.count>1?` ×${e.count}`:""}`}))}get bookmarkMarkers(){return this.bookmarks.map(e=>({id:e.id,minute:X(new Date(e.from_at),this.tz),endMinute:X(new Date(e.to_at),this.tz),label:`תיק „${e.case_title}”${e.note?` · ${e.note}`:""} · ${Aa[e.preservation]}`,preservation:e.preservation}))}async loadBookmarks(){if(!(!this.cameraId||!this.date))try{this.bookmarks=(await Ia(this.cameraId,this.date)).bookmarks}catch{}}bookmarkAt(e){this.cameraId&&(this.casePick={kind:"clip",camera_id:this.cameraId,...Ti(He(this.date,e,this.tz),10,20),note:"סימנייה"})}get segmentsMin(){return this.rec?this.rec.segments.map(e=>{const t=X(new Date(e.start_at),this.tz);let s=X(new Date(e.end_at),this.tz);return s<t&&(s=1440),{startMin:t,endMin:s,kind:e.kind==="continuous"?"continuous":"motion"}}):[]}inRecording(e){return this.segmentsMin.some(t=>e>=t.startMin&&e<=t.endMin)}get limitMinute(){return this.date===Xe(new Date,this.tz)?X(new Date,this.tz):1440}cameraName(e){return this.cams?.find(t=>t.id===e)?.name??e}async startAt(e){if(!(!this.cameraId||this.busy)){this.busy=!0,this.error="",this.notice="",this.scrubbing=!1;try{const t=e.toISOString().replace(/\.\d{3}Z$/,"Z");if(this.groupMode){const s=performance.now(),i=this.group&&this.group.sessions.some(n=>!$t.includes(n.state))?await Cd(this.group.id,t):await Ed(this.members,t);this.group=i;for(const n of i.sessions)this.seekSentAt[n.camera_id]=s,delete this.firstPlayAt[n.camera_id];this.session=null,this.position=new Date(i.requested_at);const a=Object.keys(i.missing);a.length&&(this.notice=`ללא הקלטה בזמן הזה: ${a.map(n=>this.cameraName(n)).join(", ")}`)}else{const s=this.session&&!$t.includes(this.session.state)?await Ea(this.session.id,t):await Xi(this.cameraId,t);this.session=s,this.group=null,this.position=new Date(s.requested_at),s.moved_to_next_segment&&(this.notice=`אין הקלטה בזמן שנבחר; הניגון התחיל בקטע הבא (${this.fmt(new Date(s.requested_at))}).`)}if(this.cursor=X(this.position,this.tz),this.paused=!1,this.tileStatus={},this.drifts={},this.resetClock(),!this.isConnected){await this.endSession();return}}catch(t){if(t instanceof xe&&t.body.code==="no_recording")this.notice="אין הקלטה בזמן הזה ובשש השעות שאחריו: פער בכיסוי, לא מדלגים ל־Live.",this.position=e;else if(t instanceof xe&&(t.body.code==="session_over"||t.body.code==="not_found")){this.session=null,this.group=null,this.busy=!1,await this.startAt(e);return}else this.error=w(t)}finally{this.busy=!1}}}async endSession(){const e=this.session,t=this.group;this.session=null,this.group=null,this.tileStatus={},this.drifts={},this.resetClock();try{t?await Td(t.id):e&&!$t.includes(e.state)&&await bs(e.id)}catch{}}async toggleExtra(e){const t=this.extra.includes(e)?this.extra.filter(i=>i!==e):[...this.extra,e].slice(-3),s=this.currentInstant();await this.endSession(),this.extra=t,s&&await this.startAt(s)}players(){return Array.from(this.renderRoot.querySelectorAll("sw-live-player"))}masterPlayer(){return this.players().find(e=>e.dataset.camera===this.cameraId)??this.players()[0]}currentInstant(){const e=this.masterSession;if(!e)return this.position;if(this.groupMode&&this.clock)return new Date(this.clockNow());const t=new Date(e.requested_at).getTime();return new Date(t+(this.masterPlayer()?.mediaTime??0)*1e3)}tick(){if(!this.masterSession||this.paused||this.scrubbing)return;if(this.groupMode&&this.group){this.tickGroup();return}const t=this.masterPlayer();if(!t||t.status!=="playing")return;const s=this.currentInstant();s&&(this.position=s,this.cursor=X(s,this.tz),t.stale&&t.bufferAhead<.4&&!this.busy&&this.startAt(s))}resetClock(){this.clock=null,this.clockPausedAt=0,this.barrier=this.groupMode?"waiting":"none",this.driftSamples={},this.lateSince={},this.resyncAt={},this.resyncs={},this.nudges={};for(const e of this.players())e.rate=1;this.groupMode&&(this.speed=1),this.syncStats=null,this.groupStartedAt=performance.now(),this.lastReport=0}clockNow(){const e=this.clock;return e.baseMs+((this.paused&&this.clockPausedAt?this.clockPausedAt:performance.now())-e.startedAt)}tickGroup(){const e=this.group,t=performance.now(),s=this.players().map(l=>{const p=l.dataset.camera??"",f=e.sessions.find(m=>m.camera_id===p);return{cid:p,p:l,sess:f,at:f?new Date(f.requested_at).getTime()+l.mediaTime*1e3:NaN}}).filter(l=>l.sess&&!$t.includes(l.sess.state)),i=s.filter(l=>l.p.status==="playing");if(!this.clock){const l=s.length>0&&i.length===s.length,p=t-this.groupStartedAt>12e3&&i.length>0;if(!l&&!p){this.barrier="waiting";return}const f=i.find(m=>m.cid===this.cameraId)??i[0];this.clock={baseMs:f.at,startedAt:t},this.barrier="passed",this.driftSamples={},this.lateSince={}}let a=this.clockNow();if(i.length>=3){const l=i.map(p=>p.at).sort((p,f)=>p-f);a=l[Math.floor(l.length/2)]}else i.length&&(a=(i.find(l=>l.cid===this.cameraId)??i[0]).at);this.clock={baseMs:a,startedAt:t};const n=new Date(a);this.position=n,this.cursor=X(n,this.tz);const o={};for(const l of s){if(l.p.status!=="playing"){o[l.cid]=NaN,this.lateSince[l.cid]||(this.lateSince[l.cid]=t);continue}delete this.lateSince[l.cid];const p=(l.at-a)/1e3;o[l.cid]=p;const f=this.driftSamples[l.cid]??=[];if(f.push(p),f.length>40&&f.shift(),f.length>=2&&Math.abs(p)>.25&&Math.abs(p)<=3){const m=p<0?Math.abs(p)>1?1.15:1.05:Math.abs(p)>1?.85:.95;l.p.rate!==m&&(this.nudges[l.cid]=(this.nudges[l.cid]??0)+1),l.p.rate=m}else(Math.abs(p)<=.25||Math.abs(p)>3)&&(l.p.rate=1);l.cid!==this.cameraId&&f.length>=4&&f.slice(-4).every(m=>Math.abs(m)>3)&&(this.resyncs[l.cid]??0)<2&&t-(this.resyncAt[l.cid]??0)>2e4&&this.resyncMember(l.cid,a)}this.drifts=o,this.syncStats=this.computeSync(s.map(l=>l.cid),t),t-this.lastReport>5e3&&this.syncStats.samples>=4&&(this.lastReport=t,Dd(e.id,this.syncStats).catch(()=>{}))}computeSync(e,t){const s={};let i=null,a=0;for(const p of e){const f=this.driftSamples[p]??[],m=f.length?Fd(f):null,v=this.lateSince[p]?t-this.lateSince[p]>8e3:!1;s[p]={p95:m,samples:f.length,last:f.length?f[f.length-1]:null,resyncs:this.resyncs[p]??0,state:v?"late":f.length?"measured":"waiting",latency_ms:this.startLatency[p]??null,nudges:this.nudges[p]??0},a+=f.length,m!==null&&(i=i===null?m:Math.max(i,m))}const n=Object.keys(this.group?.missing??{}),o=Object.values(s).some(p=>p.state==="late"),l=this.barrier!=="passed"||i===null?"waiting":i<=.5?"synced":i<=2?"slight":"out_of_sync";return{p95:i,quality:l,samples:a,partial:n.length>0||o,missing:n,members:s}}async resyncMember(e,t){const s=this.group,i=s?.sessions.find(n=>n.camera_id===e);if(!s||!i||$t.includes(i.state))return;this.resyncAt[e]=performance.now(),this.resyncs[e]=(this.resyncs[e]??0)+1,this.driftSamples[e]=[];const a=Math.min(this.startLatency[e]??4e3,15e3);try{const n=await Ea(i.id,new Date(t+a).toISOString().replace(/\.\d{3}Z$/,"Z"));this.group===s&&(this.group={...s,sessions:s.sessions.map(o=>o.id===n.id?n:o)}),this.seekSentAt[e]=performance.now(),delete this.firstPlayAt[e]}catch{}}syncLabel(){const e=this.syncStats;if(this.barrier==="waiting"||!e||e.quality==="waiting")return"סנכרון: ממתין לחסם הפתיחה";const t=e.p95===null?"—":`${e.p95.toFixed(2)} ש׳`;return`סנכרון: ${{synced:"מסונכרן",slight:"סטייה קלה",out_of_sync:"לא מסונכרן",waiting:""}[e.quality]} · p95 ${t}${e.partial?" · חלקי":""}`}async onSeek(e){const t=e.detail.minute,s=He(this.date,t,this.tz);if(s.getTime()>Date.now()){this.notice="לא ניתן לנגן זמן עתידי.",this.scrubbing=!1;return}this.cursor=t,e.detail.alt&&this.bookmarkAt(t),await this.startAt(s)}onScrub(e){this.scrubbing=!0,this.cursor=e.detail.minute,this.position=He(this.date,e.detail.minute,this.tz)}async nudge(e){const t=this.currentInstant();t&&await this.startAt(new Date(t.getTime()+e*1e3))}setSpeed(e){if(this.groupMode||e>1)return;this.speed=e;const t=this.masterPlayer();t&&(t.rate=e)}stepFrame(e){const t=this.masterPlayer(),s=this.cams?.find(n=>n.id===this.cameraId),i=s?.stream?.fps&&s.stream.fps>0?s.stream.fps:25;if(!t)return;if(!t.stepFrame(e,i)){this.notice="הפריים המבוקש מחוץ למאגר שכבר הגיע מה־NVR — השתמש בקפיצה של 10 שניות או בציר הזמן.";return}this.notice="";const a=this.currentInstant();a&&(this.position=a,this.cursor=X(a,this.tz))}togglePause(){const e=this.players();if(e.length){if(this.paused){const t=this.masterPlayer();if(!this.groupMode&&t?.stale&&this.position){this.startAt(this.position);return}e.forEach(s=>s.resume()),this.clock&&this.clockPausedAt&&(this.clock={...this.clock,startedAt:this.clock.startedAt+(performance.now()-this.clockPausedAt)}),this.clockPausedAt=0}else e.forEach(t=>t.pause()),this.clockPausedAt=performance.now();this.paused=!this.paused}}onTilePlayer(e,t){if(this.tileStatus={...this.tileStatus,[e]:t.detail.status},t.detail.status==="playing"&&this.seekSentAt[e]&&!this.firstPlayAt[e]&&(this.firstPlayAt[e]=performance.now(),this.startLatency[e]=this.firstPlayAt[e]-this.seekSentAt[e]),e===this.cameraId){if(this.masterSession&&t.detail.status==="playing"&&(this.session&&(this.session={...this.session,state:"playing"}),!this.groupMode&&this.speed!==1)){const s=this.masterPlayer();s&&s.rate!==this.speed&&(s.rate=this.speed)}if(t.detail.status==="ended"){const s=this.currentInstant(),i=this.masterSession;s&&i&&new Date(i.playback_end_at).getTime()-s.getTime()<5e3&&this.startAt(new Date(new Date(i.playback_end_at).getTime()+1e3))}}}fmt(e){return new Intl.DateTimeFormat("he-IL",{timeZone:this.tz,hour:"2-digit",minute:"2-digit",second:"2-digit",hourCycle:"h23"}).format(e)}openExport(){const e=Math.floor(this.cursor*60)/60;this.exportFrom=ts(Math.max(0,e-1)),this.exportTo=ts(Math.min(this.limitMinute,e+1)),this.estimate=null,this.exportJob=null,this.exportError="",this.exportOpen=!0}exportRange(){const e=He(this.date,mi(this.exportFrom),this.tz),t=He(this.date,mi(this.exportTo),this.tz);return t.getTime()<=e.getTime()?(this.exportError="זמן הסיום חייב להיות אחרי ההתחלה.",null):[e.toISOString().replace(/\.\d{3}Z$/,"Z"),t.toISOString().replace(/\.\d{3}Z$/,"Z")]}async runEstimate(){const e=this.exportRange();if(e){this.exportBusy=!0,this.exportError="";try{this.estimate=await Od(this.cameraId,e[0],e[1])}catch(t){this.exportError=w(t)}finally{this.exportBusy=!1}}}async runExport(){const e=this.exportRange();if(e){this.exportBusy=!0,this.exportError="";try{this.exportJob=await Rd(this.cameraId,e[0],e[1])}catch(t){this.exportError=w(t)}finally{this.exportBusy=!1}}}renderExportDialog(){const e=this.estimate,t=this.exportJob;return r`<sw-dialog ?open=${this.exportOpen} heading="ייצוא קטע" subheading=${`${this.cameraName(this.cameraId)} · ${this.date} · ${this.tz}`} @close=${()=>this.exportOpen=!1}>
    ...
    `}seekDemo(e){this.cursor=e.detail.minute,this.generation+=1}renderDemo(){const e=W.find(i=>i.id===this.demoCamera)??W[0],t=!js.some(i=>this.cursor>=i.startMin&&this.cursor<=i.endMin),s=Ye.filter(i=>i.minuteOfDay<1440).filter(i=>this.filter==="all"||i.type===this.filter).map(i=>({minute:i.minuteOfDay,kind:i.type,label:i.title}));return r`
    ...
    `}render(){const e=g(),t=e?this.cams?.find(o=>o.id===this.cameraId):W.find(o=>o.id===this.demoCamera)??W[0],s=t?.name??"הקלטות",i=e?`${this.date} ${ts(this.cursor)} · אזור זמן ${this.tz}`:`14.09.2026 ${ze(this.cursor)} · אזור זמן האתר Asia/Jerusalem · נתוני הדגמה`,a=e?"הקלטות":`הקלטות | ${t?.floor??""}`,n=e?Xe(new Date,this.tz):"2026-09-14";return r`
      <sw-page heading=${s} subheading=${i} crumbs=${a} wide>
        <div slot="actions" class="pick">
          ...
          <sw-field style="inline-size:132px"><input type="time" step="1" .value=${e?ts(this.cursor):ze(this.cursor)} data-ltr aria-label="שעה" @change=${o=>{const l=o.target.value;if(e)this.onSeek(new CustomEvent("seek",{detail:{minute:mi(l)}}));else{const[p,f]=l.split(":").map(Number);this.cursor=p*60+f,this.generation+=1}}} /></sw-field>
        </div>
  ...
  `;bt([d()],Ue.prototype,"cursor",2);bt([d()],Ue.prototype,"playing",2);bt([d()],Ue.prototype,"cams",2);bt([d()],Ue.prototype,"picked",2);bt([d()],Ue.prototype,"when",2);bt([d()],Ue.prototype,"recent",2);bt([d()],Ue.prototype,"error",2);Ue=bt([k("investigate-sync")],Ue);var Zd=Object.defineProperty,qd=Object.getOwnPropertyDescriptor,de=(e,t,s,i)=>{for(var a=i>1?void 0:i?qd(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&Zd(t,s,a),a};const vi=10;function Kd(e){return e==="person"||e==="vehicle"||e==="motion"||e==="line"||e==="offline"||e==="door"?e:"motion"}let Q=class extends ${constructor(){super(...arguments),this.floorId="f0",this.at="",this.camera="",this.minute=615,this.tz="Asia/Jerusalem",this.date="",this.tree=null,this.bundle=null,this.events=[],this.recordings=new Map,this.selectedId=null,this.loading=!1,this.error="",this.frameAt="",this.frameFailed=!1,this.casePick=null,this.frameTimer=0}connectedCallback(){super.connectedCallback(),g()&&this.init()}updated(e){g()&&(e.has("floorId")&&e.get("floorId")!==void 0||e.has("at")&&e.get("at")!==void 0)&&this.init()}async init(){this.loading=!0,this.error="";try{const[e,t]=await Promise.all([Be(),this.tree?Promise.resolve(this.tree):vt()]);if(this.tz=e["time.zone"]??this.tz,this.tree=t,g()&&this.floors.length&&!this.floors.some(i=>i.id===this.floorId)){const i=new URLSearchParams(window.location.hash.split("?")[1]??"").toString();window.location.replace(`#/investigate/floors/${this.floors[0].id}/history${i?`?${i}`:""}`);return}const s=this.at?new Date(this.at):new Date;if(this.date=Xe(s,this.tz),this.minute=X(s,this.tz),this.bundle=await ws(this.floorId,!1,this.instant.toISOString().replace(/\.\d{3}Z$/,"Z")),this.scheduleFrame(),this.camera){const i=this.bundle.anchors.find(a=>a.resource_type==="camera"&&a.resource_id===this.camera);this.selectedId=i?.id??null}await this.loadDay()}catch(e){this.error=w(e)}finally{this.loading=!1}}async loadDay(){const e=this.bundle;if(!e)return;const t=e.anchors.filter(n=>n.resource_type==="camera").map(n=>n.resource_id),[s,i]=await Promise.all([si({date:this.date,limit:1e3}).then(n=>n.events.filter(o=>o.camera_id&&t.includes(o.camera_id))).catch(()=>[]),Promise.allSettled(t.map(n=>Ar(n,this.date)))]);this.events=s;const a=new Map;t.forEach((n,o)=>{const l=i[o];a.set(n,l.status==="fulfilled"?l.value:null)}),this.recordings=a}get instant(){return He(this.date,this.minute,this.tz)}segmentsFor(e){const t=this.recordings.get(e);return t?t.segments.map(s=>{const i=X(new Date(s.start_at),this.tz);let a=X(new Date(s.end_at),this.tz);return a<i&&(a=1440),{startMin:i,endMin:a,kind:s.kind==="continuous"?"continuous":"motion"}}):null}coverageAt(e){const t=this.segmentsFor(e);if(!t)return{state:"unknown"};const s=t.find(i=>this.minute>=i.startMin&&this.minute<=i.endMin);return s?{state:"historic",segment:s}:{state:"unknown"}}eventsNear(e,t=vi){const s=this.instant.getTime();return this.events.filter(i=>(!e||i.camera_id===e)&&Math.abs(new Date(i.occurred_at).getTime()-s)<=t*60*1e3).sort((i,a)=>Math.abs(new Date(i.occurred_at).getTime()-s)-Math.abs(new Date(a.occurred_at).getTime()-s))}get apiMarkers(){const e=this.bundle;return e?e.anchors.map(t=>{if(t.resource_type==="camera"){const a=this.coverageAt(t.resource_id),n=this.eventsNear(t.resource_id,5).length,o=t.camera?.name??t.label??t.resource_id;return{id:t.id,kind:"camera",label:n?`${o} · ${n} אירועים`:o,x:t.position.x,y:t.position.y,rotation:t.rotation_degrees,fov:t.field_of_view_degrees??void 0,state:a.state}}const s=t.entity?.state_at,i=t.entity?.name??t.label??t.resource_id;return{id:t.id,kind:ti(t.layer_id,t.entity?.domain),label:s?.known&&s.state?`${i} · ${ft({...t.entity??{domain:"",unit:null,device_class:null,attributes:{}},state:s.state})}`:i,x:t.position.x,y:t.position.y,state:s?.known?"historic":"unknown"}}):[]}get selectedAnchor(){return this.bundle?.anchors.find(e=>e.id===this.selectedId)??null}get limitMinute(){return this.date===Xe(new Date,this.tz)?X(new Date,this.tz):1440}setMinute(e){this.minute=Math.max(0,Math.min(this.limitMinute,e)),this.scheduleFrame()}scheduleFrame(){window.clearTimeout(this.frameTimer),this.frameTimer=window.setTimeout(()=>{this.frameAt=this.instant.toISOString().replace(/\.\d{3}Z$/,"Z"),this.frameFailed=!1,this.ensureVersion()},600)}async ensureVersion(){const e=this.bundle;if(!e||e.source!=="api"||!e.at)return;const t=this.instant.toISOString().replace(/\.\d{3}Z$/,"Z");if(!(e.history==="current"?!e.historyFrom||t<e.historyFrom:(!e.planPublishedAt||e.planPublishedAt<=t)&&(!e.planArchivedAt||t<e.planArchivedAt)))try{const i=await ws(this.floorId,!1,t),a=e.anchors.map(n=>n.resource_id).sort().join(",");this.bundle=i,this.selectedId&&!i.anchors.some(n=>n.id===this.selectedId)&&(this.selectedId=null),i.anchors.map(n=>n.resource_id).sort().join(",")!==a&&await this.loadDay()}catch{}}renderEntityStates(e){const t=e.anchors.filter(a=>a.resource_type==="ha_entity");if(!t.length)return r`אין ישויות מוצבות בקומה`;const s=t.filter(a=>a.entity?.state_at?.known),i=e.haHistory;return r`${s.length} מתוך ${t.length} ידועות בזמן זה${i?.from?r` <span class="note">(היסטוריה מקומית מ־<span class="ltr">${this.fmtWhen(i.from)}</span>, ${i.retention_days} ימים)</span>`:r` <span class="note">(אין עדיין היסטוריה מקומית)</span>`}
    ...
    `}get demoMarkers(){const e=i=>i==="cam-3"||this.minute>=190&&this.minute<=205?"unknown":"historic",t=is.filter(i=>i.floorId===this.floorId).map(i=>({id:i.id,kind:"camera",label:i.name,x:i.x,y:i.y,rotation:i.rotation,fov:i.fov,state:i.state==="forbidden"?"forbidden":e(i.id)})),s=Rs.filter(i=>i.floorId===this.floorId).map((i,a)=>({id:i.id,kind:i.domain,label:i.name,x:i.x,y:i.y,state:a%2?"unknown":"historic"}));return[...t,...s]}renderDemo(){const e=ht.find(t=>t.id===this.floorId)??ht[0];return r`
      <div class="head">
  ...
  `;de([u()],Q.prototype,"floorId",2);de([u()],Q.prototype,"at",2);de([u()],Q.prototype,"camera",2);de([d()],Q.prototype,"minute",2);de([d()],Q.prototype,"tz",2);de([d()],Q.prototype,"date",2);de([d()],Q.prototype,"tree",2);de([d()],Q.prototype,"bundle",2);de([d()],Q.prototype,"events",2);de([d()],Q.prototype,"recordings",2);de([d()],Q.prototype,"selectedId",2);de([d()],Q.prototype,"loading",2);de([d()],Q.prototype,"error",2);de([d()],Q.prototype,"frameAt",2);de([d()],Q.prototype,"frameFailed",2);de([d()],Q.prototype,"casePick",2);Q=de([k("investigate-history-map")],Q);var Gd=Object.defineProperty,Yd=Object.getOwnPropertyDescriptor,V=(e,t,s,i)=>{for(var a=i>1?void 0:i?Yd(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&Gd(t,s,a),a};const Jd={person:"#2f6bff",vehicle:"#22c55e",motion:"#ef4444",line:"#f59e0b",offline:"#6b7280",door:"#8b5cf6"},Ta={"כניסה ראשית":"entrance","חצר אחורית":"backyard",מחסן:"warehouse",לובי:"lobby","חניה מקורה":"parking","מסדרון מזרחי":"corridor"},Xd={info:"מידע",alert:"התראה",critical:"קריטי"};let N=class extends ${constructor(){super(...arguments),this.cameraId="",this.date="",this.initialMode="",this.selected=null,this.filter="all",this.cams=null,this.tz="Asia/Jerusalem",this.type="",this.events=null,this.ingest=null,this.live=!1,this.error="",this.busy=!1,this.thumbVersion=new Map,this.player=null,this.mode="raw",this.windows=null,this.windowGap=180,this.windowBy="camera",this.selectedWindow=null,this.windowsBusy=!1,this.facets=null,this.placeFloor="",this.placeZone="",this.source="",this.unsupported=[],this.thumbTimers=new Map,this.thumbInFlight=0,this.rowPreview=null,this.rowPreviewTimer=0,this.windowColumns=[{key:"thumb",label:"",width:"72px",render:e=>this.renderWindowThumb(e)},{key:"title",label:"חלון אירוע",render:e=>{const t=e;return r`<span class="ty" style="--tone:${Ns[t.dominant_type]??"#6b7280"}"><i></i>${q[t.dominant_type]??t.dominant_type}${t.count>1?r` <span class="sub">×${String(t.count)}</span>`:c}</span><div class="sub">${Object.entries(t.types).map(([s,i])=>`${q[s]??s} ${i}`).join(" · ")} · ${t.confidence==="inferred"?"נגזר מהקלטה":"התראות מה־NVR"}</div>`}},{key:"camera_name",label:"מצלמה / קבוצה",render:e=>{const t=e;return r`${t.camera_name??(t.channel?`ערוץ ${t.channel}`:"מערכת")}${t.group&&t.group!=="camera"&&t.camera_names?.length?r`<div class="sub">${t.camera_names.join(" · ")}</div>`:c}`}},{key:"start",label:"זמן",render:e=>{const t=e;return r`${this.fmt(t.start)}${t.end!==t.start?r` – ${this.fmt(t.end)}`:c}<div class="sub">${this.fmtDate(t.start)}</div>`}},{key:"acked",label:"מצב",render:e=>{const t=e;return r`<sw-badge kind=${t.acked?"live":t.acked_count?"stale":"neutral"} label=${t.acked?"טופל":t.acked_count?`בטיפול ${t.acked_count}/${t.count}`:"חדש"}></sw-badge>`}}],this.apiColumns=[{key:"thumb",label:"",width:"72px",render:e=>this.renderThumb(e)},{key:"type",label:"אירוע",render:e=>r`<span class="ty" style="--tone:${Ns[e.type]??"#6b7280"}"><i></i>${q[e.type]??String(e.type)}${Number(e.count)>1?r` <span class="sub">×${String(e.count)}</span>`:c}</span><div class="sub">${e.source==="ha"?"חיישן HA":e.source==="system"?"מערכת":e.confidence==="inferred"?"נגזר מהקלטה":"התראה מה־NVR"} · ${e.acked_at?`טופל · ${String(e.acked_by_username??"")}`:"ממתין לטיפול"}</div>`},{key:"camera_name",label:"מצלמה",render:e=>r`${String(e.camera_name??(e.channel?`ערוץ ${String(e.channel)}`:"מערכת"))}<div class="sub ltr">${String(e.raw_type)}</div>`},{key:"occurred_at",label:"זמן",render:e=>r`${this.fmt(String(e.occurred_at))}<div class="sub">${this.fmtDate(String(e.occurred_at))}${e.ended_at?` · עד ${this.fmt(String(e.ended_at))}`:""}</div>`},{key:"severity",label:"חומרה",render:e=>r`<sw-badge kind=${e.severity==="critical"?"error":e.severity==="alert"?"stale":"neutral"} label=${Xd[e.severity]??String(e.severity)}></sw-badge>`}],this.columns=[{key:"thumb",label:"תמונה",width:"80px",render:e=>e.type==="offline"||e.type==="door"?r`<div class="thumb none"><sw-icon name=${e.type==="offline"?"offline":"door"} size=${14}></sw-icon></div>`:r`<sw-scene class="thumb" kind=${Ta[String(e.camera)]??"lobby"}></sw-scene>`},{key:"title",label:"אירוע",render:e=>r`<span class="ty" style="--tone:${Jd[e.type]}"><i></i>${ki[e.type]}</span><div class="sub">${String(e.title)} · ${e.acked?"טופל":"ממתין לטיפול"}</div>`},{key:"camera",label:"מצלמה",render:e=>r`${String(e.camera)}<div class="sub">${String(e.floor)}</div>`},{key:"time",label:"זמן",render:e=>r`${String(e.time)}<div class="sub ltr">${String(e.source)}</div>`},{key:"severity",label:"חומרה",render:e=>r`<sw-badge kind=${e.severity==="critical"?"error":e.severity==="alert"?"stale":"neutral"} label=${{info:"מידע",alert:"התראה",critical:"קריטי"}[e.severity]}></sw-badge>`},{key:"more",label:"",width:"40px",render:()=>r`<sw-button variant="ghost" size="sm" iconOnly icon="more" label="עוד"></sw-button>`}]}connectedCallback(){super.connectedCallback(),g()&&(this.init(),this.unsubscribe=jl(e=>this.onPushed(e),(e,t)=>{this.live=t,e&&(this.ingest=e)}))}disconnectedCallback(){super.disconnectedCallback(),this.unsubscribe?.();for(const e of this.thumbTimers.values())window.clearTimeout(e);this.thumbTimers.clear(),this.stopPlayer()}hoverStart(e,t){if(!e.camera_id||t.pointerType==="touch")return;window.clearTimeout(this.rowPreviewTimer);const s=t.clientX,i=t.clientY;this.rowPreviewTimer=window.setTimeout(()=>{const a=new Date(e.occurred_at).getTime(),n=[-5,0,5].map(o=>{const l=new Date(a+o*1e3).toISOString().replace(/\.\d{3}Z$/,"Z");return{at:l,url:ii(e.camera_id,l),label:o===0?this.fmt(e.occurred_at):`${o>0?"+":""}${o} ש׳`,failed:!1}});this.rowPreview={id:e.id,x:s,y:i,frames:n,camera:e.camera_name??""}},250)}hoverEnd(){window.clearTimeout(this.rowPreviewTimer),this.rowPreview=null}renderRowPreview(){const e=this.rowPreview;if(!e)return c;const t=Math.max(16,Math.min(window.innerWidth-388,e.x-186)),s=e.y+18+230>window.innerHeight?e.y-18-230:e.y+18;return r`<div class="rowpreview" data-row-preview style="left:${t}px;top:${s}px">
      ...
      <div class="wlist" data-window-events>
        ${t.map(s=>r`<a class="wrow" href=${`#/investigate/events/${s.id}`}><span class="ty" style="--tone:${Ns[s.type]??"#6b7280"}"><i></i>${q[s.type]??s.type}</span><span class="ltr">${this.fmt(s.occurred_at)}</span><span class="sub">${s.acked_at?"טופל":"ממתין"}</span></a>`)}
  ...
  `;L([d()],be.prototype,"cases",2);L([d()],be.prototype,"canManage",2);L([d()],be.prototype,"loading",2);L([d()],be.prototype,"error",2);L([d()],be.prototype,"status",2);L([d()],be.prototype,"q",2);L([d()],be.prototype,"creating",2);L([d()],be.prototype,"newTitle",2);L([d()],be.prototype,"newDesc",2);L([d()],be.prototype,"newTags",2);L([d()],be.prototype,"busy",2);be=L([k("investigate-cases")],be);let Y=class extends ${constructor(){super(...arguments),this.caseId="case-1",this.tab="details",this.data=null,this.error="",this.info="",this.busy=!1,this.tz="Asia/Jerusalem",this.noteText="",this.editing=!1,this.editTitle="",this.editDesc="",this.editTags="",this.confirmDelete=!1,this.bundles=[],this.verifyResult=null,this.cams=[],this.snapCam="",this.loadedFor="",this.pollTimer=0}updated(e){e.has("caseId")&&g()&&this.loadedFor!==this.caseId&&this.load()}disconnectedCallback(){super.disconnectedCallback(),window.clearTimeout(this.pollTimer)}async load(){const e=this.caseId;this.loadedFor=e,this.error="";try{const[t,s]=await Promise.all([Be(),wd(e)]);this.tz=t["time.zone"]??this.tz,this.data=s,this.bundles=(await _d(e).catch(()=>({bundles:[]}))).bundles,this.cams.length||(this.cams=(await Pe().catch(()=>({cameras:[]}))).cameras.filter(i=>i.enabled),!this.snapCam&&this.cams[0]&&(this.snapCam=this.cams[0].id)),window.clearTimeout(this.pollTimer),s.items.some(i=>i.preservation==="preserving")&&(this.pollTimer=window.setTimeout(()=>void this.load(),5e3))}catch(t){this.error=w(t)}}fmt(e){return new Intl.DateTimeFormat("he-IL",{timeZone:this.tz,dateStyle:"short",timeStyle:"medium"}).format(new Date(e))}async run(e,t=""){this.busy=!0,this.error="";try{await e(),this.info=t,await this.load(),t&&setTimeout(()=>this.info="",4e3)}catch(s){this.error=w(s),s instanceof xe&&s.status===409&&await this.load()}finally{this.busy=!1}}patchCase(e){const t=this.data;t&&this.run(async()=>{await vd(t.id,{revision:t.revision,...e})})}async verify(e){if(e){this.verifyResult=null,this.busy=!0,this.error="";try{this.verifyResult=await Md(e)}catch(t){this.error=w(t)}finally{this.busy=!1}}}renderBundleCard(e){const t=this.verifyResult;return r`<sw-card heading="חבילת ראיות" subheading="ZIP עם הקטעים השמורים, התמונות, ההערות, manifest עם SHA-256 לכל קובץ ודוח קריא" data-bundle>
      ...
      ${n}
      <div class="body">
        <div class="head"><strong>${s}</strong>${e.camera_name?r`<span>· ${e.camera_name}</span>`:c}${i!=="none"?r`<sw-badge kind=${lc[i]} label=${md[i]}></sw-badge>`:c}</div>
  ...
  `;L([u()],Y.prototype,"caseId",2);L([d()],Y.prototype,"tab",2);L([d()],Y.prototype,"data",2);L([d()],Y.prototype,"error",2);L([d()],Y.prototype,"info",2);L([d()],Y.prototype,"busy",2);L([d()],Y.prototype,"tz",2);L([d()],Y.prototype,"noteText",2);L([d()],Y.prototype,"editing",2);L([d()],Y.prototype,"editTitle",2);L([d()],Y.prototype,"editDesc",2);L([d()],Y.prototype,"editTags",2);L([d()],Y.prototype,"confirmDelete",2);L([d()],Y.prototype,"bundles",2);L([d()],Y.prototype,"verifyResult",2);L([d()],Y.prototype,"cams",2);L([d()],Y.prototype,"snapCam",2);Y=L([k("investigate-case-detail")],Y);var hc=Object.defineProperty,uc=Object.getOwnPropertyDescriptor,ai=(e,t,s,i)=>{for(var a=i>1?void 0:i?uc(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&hc(t,s,a),a};const Ra={queued:"ממתין",running:"מוריד",done:"הושלם",partial:"חלקי",failed:"נכשל",cancelled:"בוטל",interrupted:"הופסק"},fc={queued:"neutral",running:"live",done:"recorded",partial:"partial",failed:"error",cancelled:"unknown",interrupted:"stale"};let Zt=class extends ${constructor(){super(...arguments),this.jobs=null,this.ffmpeg=!0,this.error=""}connectedCallback(){super.connectedCallback(),g()&&(this.load(),this.timer=window.setInterval(()=>this.poll(),3e3))}disconnectedCallback(){super.disconnectedCallback(),window.clearInterval(this.timer)}async load(){try{const e=await Nd();this.jobs=e.jobs,this.ffmpeg=e.ffmpeg,this.error=""}catch(e){this.error=w(e)}}poll(){this.jobs?.some(e=>e.state==="queued"||e.state==="running")&&this.load()}fmt(e,t){return new Intl.DateTimeFormat("he-IL",{timeZone:t,day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit",second:"2-digit",hourCycle:"h23"}).format(new Date(e))}async cancel(e){try{await Ld(e.id),await this.load()}catch(t){this.error=w(t)}}async removeJob(e){try{await Bd(e.id),await this.load()}catch(t){this.error=w(t)}}renderApi(){return this.error&&!this.jobs?r`<sw-state-panel state="error" hint=${this.error} actionLabel="נסה שוב" @action=${()=>this.load()}></sw-state-panel>`:this.jobs?this.jobs.length?r`
      ...
      <sw-card>
        ${this.jobs.map(e=>{const t=Math.round((e.progress??0)*100),s=e.files.filter(i=>i.state==="downloaded"||i.state==="remuxed").length;return r`<div class="job">
            <div>
              <div class="title"><strong>${e.camera_name}</strong><sw-badge kind=${fc[e.state]} label=${Ra[e.state]}></sw-badge></div>
...
`)],{type:"text/csv;charset=utf-8"}),a=document.createElement("a");a.href=URL.createObjectURL(i),a.download=`audit-${new Date().toISOString().slice(0,10)}.csv`,a.click(),setTimeout(()=>URL.revokeObjectURL(a.href),2e3)}renderApi(){const e=this.rows;return r`
        ...
        ${e?r`<div class="two" data-connections>
            ...
            <sw-card heading="איפה מגדירים" subheading="הערכים אינם מוצגים כאן ואינם נשמרים ב־VMS; שינוי דורש הפעלה מחדש של ה־Add-on">
              <div class="opts" data-connection-options>
                ${dp.map(t=>r`<div class="check"><span>${t.label}</span><span class="val ltr">${t.key}</span></div>`)}
              </div>
  ...
  `;$e([d()],ce.prototype,"selected",2);$e([d()],ce.prototype,"filter",2);$e([d()],ce.prototype,"cameras",2);$e([d()],ce.prototype,"recorder",2);$e([d()],ce.prototype,"canSync",2);$e([d()],ce.prototype,"discovery",2);$e([d()],ce.prototype,"busy",2);$e([d()],ce.prototype,"message",2);$e([d()],ce.prototype,"error",2);$e([d()],ce.prototype,"dialog",2);$e([d()],ce.prototype,"formChannel",2);$e([d()],ce.prototype,"formAlias",2);$e([d()],ce.prototype,"alias",2);ce=$e([k("system-devices")],ce);const Qi="sw.design.override",ea="sw.design.last",cs={a:"SW A",b:"SW B"};let Ms="b";const Oi=new Set;function Zs(e){try{return localStorage.getItem(e)}catch{return null}}function Er(e,t){try{t===null?localStorage.removeItem(e):localStorage.setItem(e,t)}catch{}}function hp(){try{const s=new URLSearchParams(window.location.search).get("design");if(s==="a"||s==="b")return s}catch{}const e=Zs(Qi);if(e==="a"||e==="b")return e;const t=Zs(ea);return t==="a"||t==="b"?t:"b"}Ms=hp();function Ri(){const e=Zs(Qi);return e==="a"||e==="b"?e:null}function up(e){Er(Qi,e),Tr()}function Cr(){return Ms}function fp(e){return Oi.add(e),e(Ms),()=>Oi.delete(e)}function lt(e){Ms=e,document.documentElement.dataset.design=e,Er(ea,e),Oi.forEach(t=>t(e))}function mp(e){try{const t=e?JSON.parse(e):{};return{a:(t.a||cs.a).slice(0,24),b:(t.b||cs.b).slice(0,24)}}catch{return{...cs}}}async function Tr(){const e=new URLSearchParams(window.location.search).get("design");if(e==="a"||e==="b")return lt(e),e;const t=Ri();if(t)return lt(t),t;if(!g())return lt("b"),"b";const s=Zs(ea);(s==="a"||s==="b")&&lt(s);try{const a=(await Be())["ui.design"]==="b"?"b":"a";return lt(a),a}catch{return lt(s==="b"?"b":"a"),Ms}}const wp={manual:"ידני",upload:"הועלה","auto-pre-upgrade":"אוטומטי · לפני עדכון","auto-daily":"אוטומטי · יומי"},bi={sites:"אתרים",buildings:"מבנים",floors:"קומות",plan_assets:"קבצי תוכנית",plan_versions:"גרסאות תוכנית",map_anchors:"עוגנים",cameras:"מצלמות",spatial_zones:"אזורים",settings:"הגדרות",users:"משתמשים",bindings:"הרשאות",groups:"קבוצות"},vp=()=>z("backups"),gp=(e={})=>A("backups",e),bp=e=>ye(`backups/${encodeURIComponent(e)}`),yp=(e,t)=>A(`backups/${encodeURIComponent(e)}/restore`,t),$p=e=>pe(`backups/${encodeURIComponent(e)}/download`);function xp(e){const t=new FormData;return t.append("file",e,e.name),Ki("backups/upload",t)}function Ua(e){return e<1024?`${e} B`:e<1024*1024?`${(e/1024).toFixed(0)} KB`:`${(e/1024/1024).toFixed(1)} MB`}var kp=Object.defineProperty,_p=Object.getOwnPropertyDescriptor,B=(e,t,s,i)=>{for(var a=i>1?void 0:i?_p(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&kp(t,s,a),a};const Wa=[{id:"general",label:"כללי"},{id:"media",label:"וידאו ומדיה"},{id:"ha",label:"גשר Home Assistant"},{id:"health",label:"בריאות ועבודות"},{id:"backup",label:"גיבוי ושחזור"},{id:"support",label:"תמיכה"}];let D=class extends ${constructor(){super(...arguments),this.tab="general",this.settings=null,this.canEdit=!1,this.draft={},this.streams=null,this.go2rtc=null,this.foreign=0,this.sessions=[],this.busy=!1,this.message="",this.error="",this.version="",this.ha=null,this.pairing=null,this.showCode=!1,this.regenArmed=!1,this.copied=!1,this.report=null,this.reportBusy=!1,this.backups=null,this.backupPolicy={},this.backupBusy=!1,this.backupNote="",this.backupMsg="",this.restoreTarget=null,this.restoreMode="replace",this.restoreAccess=!1,this.restoreConfirm="",this.health=null}connectedCallback(){super.connectedCallback();const e=ms().params.get("tab");e&&Wa.some(t=>t.id===e)&&(this.tab=e,e==="health"&&this.loadReport(),e==="backup"&&this.loadBackups(),e==="media"&&this.loadMedia(),e==="ha"&&this.loadHa()),this.loadSettings()}async loadSettings(){if(g())try{const[e,t]=await Promise.all([tr(),z("health").catch(()=>null)]);this.settings=e.settings,this.canEdit=e.can_edit,this.draft={},this.version=t?.version??"",this.health=t??null}catch(e){this.error=w(e)}}async loadMedia(){if(!(!g()||!this.canEdit))try{const[e,t]=await Promise.all([Bn(),Hn()]);this.streams=e.streams,this.go2rtc=e.go2rtc,this.foreign=e.foreign_streams,this.sessions=t.sessions,this.error=""}catch(e){this.streams=[],this.error=w(e)}}async loadHa(e=!1){if(g()){this.error="";try{this.ha=await Ko(),this.canEdit&&(this.pairing=await Go(e)),e&&(this.regenArmed=!1,this.showCode=!0,this.message="נוצר קוד צימוד חדש; יש להגדיר מחדש את האינטגרציה ב־Home Assistant.",setTimeout(()=>this.message="",4e3))}catch(t){this.error=w(t)}}}async copyCode(){if(this.pairing)try{await navigator.clipboard.writeText(this.pairing.pairing_code),this.copied=!0,setTimeout(()=>this.copied=!1,2e3)}catch{this.showCode=!0}}async installBridgeNow(){this.busy=!0,this.error="";try{const e=await Yo();this.message=e.state==="installed_pending"?"האינטגרציה הועתקה ל־Home Assistant; הפעל מחדש את Home Assistant ואשר את הגשר שהתגלה.":e.state==="active"?"האינטגרציה פעילה.":e.state==="not_available"?"תיקיית ההגדרות של Home Assistant אינה נגישה ל־Add-on.":`מצב: ${e.state}`,await this.loadHa(),setTimeout(()=>this.message="",6e3)}catch(e){this.error=w(e)}finally{this.busy=!1}}integrationText(e){switch(e.state){case"active":return`פעילה ב־Home Assistant (גרסה ${e.active_version??"?"})`;case"installed_pending":return`הועתקה לתיקיית ההגדרות של HA (גרסה ${e.installed_version??"?"}) ב־${De(e.installed_at)} · הפעל מחדש את Home Assistant ואז אשר את "SMPLWISE Bridge" שהתגלה בהגדרות → מכשירים ושירותים`;case"update_pending":return`עודכנה לגרסה ${e.installed_version??"?"} אך Home Assistant עדיין מריץ ${e.active_version??"?"} · נדרש Restart ל־Home Assistant`;case"not_installed":return"טרם הועתקה";case"error":return`ההעתקה נכשלה (${e.last_error??""})`;default:return e.last_error==="ha_config_not_mapped"?"ה־Add-on לא רואה את תיקיית ההגדרות של Home Assistant (המיפוי homeassistant_config לא ניתן) · התקנה ידנית לפי השלבים למטה":e.last_error==="source_missing"?"קבצי האינטגרציה חסרים בתמונת ה־Add-on · התקנה ידנית לפי השלבים למטה":`ההתקנה האוטומטית נכשלה (${e.last_error??"סיבה לא ידועה"}) · התקנה ידנית לפי השלבים למטה`}}renderIntegration(e){const t=e.integration;if(!t)return c;const s=t.state==="active"?"live":t.state==="installed_pending"||t.state==="update_pending"?"stale":t.state==="error"?"error":"unknown",i=t.state==="active"?"פעילה":t.state==="installed_pending"?"ממתינה ל־Restart":t.state==="update_pending"?"עדכון ממתין":t.state==="error"?"שגיאה":t.state==="not_installed"?"לא הותקנה":"לא זמין";return r`<div class="row"><span class="lbl">התקנת האינטגרציה ב־Home Assistant<span class="muted">${this.integrationText(t)}${t.discovery_posted_at?` · הוכרזה ל־Supervisor ${De(t.discovery_posted_at)}`:""}</span></span><span style="display:flex;gap:8px;align-items:center"><sw-badge kind=${s} label=${i}></sw-badge>${this.canEdit&&t.state!=="not_available"?r`<sw-button size="sm" ?disabled=${this.busy} @click=${()=>this.installBridgeNow()}>התקן / עדכן</sw-button>`:c}</span></div>`}renderHa(){if(!g())return r`<div class="sections"><sw-card heading="גשר Home Assistant"><div class="muted">נתוני הדגמה — הסטטוס והצימוד זמינים מול השרת.</div></sw-card></div>`;const e=this.ha,t=e?.sync,s=this.pairing;return r`<div class="sections">
      ...
      <div class="acts">
        <a href=${$p(e.name)} download=${e.name} data-backup-download><sw-button size="sm" icon="download">הורד</sw-button></a>
      ...
      <sw-page heading="אנליטיקת אחסון" subheading="Beta · ניטור שימוש, תכנון קדימה ושליטה · נתון נמדד לעומת אומדן מסומן · אין format או RAID · נתוני הדגמה">
        ...
        <div class="grid">
          <sw-card heading="שימוש באחסון לפי מצלמה" subheading="נמדד · לפני retention">
            ${Mp.map(m=>r`<div class="cam"><span>${m.name}</span><span class="bar"><i style="--p:${m.gb/f*100}%"></i></span><span class="gb ltr">${m.gb} GB</span></div>`)}
  ...
  `;qe([d()],Ae.prototype,"range",2);qe([d()],Ae.prototype,"data",2);qe([d()],Ae.prototype,"error",2);qe([d()],Ae.prototype,"loading",2);qe([d()],Ae.prototype,"tz",2);qe([d()],Ae.prototype,"signing",2);qe([d()],Ae.prototype,"signingError",2);qe([d()],Ae.prototype,"signingBusy",2);qe([d()],Ae.prototype,"rotateConfirm",2);Ae=qe([k("system-storage")],Ae);var Ap=Object.getOwnPropertyDescriptor,Ip=(e,t,s,i)=>{for(var a=i>1?void 0:i?Ap(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=o(a)||a);return a};const Pp=[{mode:"סקירה ומצלמות",items:[{sc:"SC01",name:"סקירה (Dashboard)",route:"#/live",phase:"PILOT",board:"1:01 · 2:15"},{sc:"SC07",name:"כל המצלמות (Grid)",route:"#/live/wall",phase:"PILOT",board:"1:06"},{sc:"SC08",name:"מצלמה בודדת",route:"#/live/cameras/cam-4",phase:"PILOT",board:"1:05"},{sc:"SC09",name:"תצוגות שמורות",route:"#/live/views",phase:"PILOT",board:"legacy"},{sc:"SC27",name:"בריאות מצלמות",route:"#/system/devices",phase:"PILOT",board:"2:12"},{sc:"SC31",name:"קיוסק / תצוגת קיר",route:"#/kiosk/all",phase:"BETA",board:"3:24"}]},{mode:"אתרים ומפות",items:[{sc:"SC02",name:"אתרים ומבנים",route:"#/explore/sites",phase:"PILOT",board:"1:02 · 3:17"},{sc:"SC03",name:"דפדפן קומות",route:"#/explore/buildings/bld-a/floors",phase:"PILOT",board:"1:03"},{sc:"SC04",name:"מפת קומה חיה",route:"#/explore/floors/f0",phase:"PILOT",board:"1:04"},{sc:"SC05",name:"ייבוא ותיקון תוכנית",route:"#/explore/floors/f-2/import",phase:"PILOT",board:"2:13"},{sc:"SC06",name:"עורך תוכנית ועוגנים",route:"#/explore/floors/f0/edit",phase:"PILOT",board:"2:13"},{sc:"SC10",name:"קטלוג ישויות HA",route:"#/explore/entities",phase:"PILOT",board:"new"},{sc:"SC23",name:"דלתות ואינטרקום",route:"#/explore/access/d1",phase:"V1",board:"3:18"}]},{mode:"אירועים והקלטות",items:[{sc:"SC14",name:"מרכז אירועים",route:"#/investigate/events",phase:"PILOT",board:"1:08"},{sc:"SC12",name:"הקלטות / ציר זמן",route:"#/investigate/playback",phase:"PILOT",board:"1:07 · 2:16"},{sc:"SC13",name:"מרכז שליטה / ניגון מסונכרן",route:"#/investigate/playback/sync",phase:"BETA",board:"2:14"},{sc:"SC11",name:"מפה היסטורית",route:"#/investigate/floors/f0/history",phase:"PILOT",board:"new"},{sc:"SC15",name:"תור Review",route:"#/investigate/reviews",phase:"BETA",board:"legacy"},{sc:"SC16",name:"תיקים",route:"#/investigate/cases",phase:"BETA",board:"2:10"},{sc:"SC17",name:"סקירת אירוע / תיק",route:"#/investigate/cases/case-1",phase:"BETA",board:"2:10"},{sc:"SC18",name:"ייצוא והורדות",route:"#/investigate/exports",phase:"BETA",board:"2:10"},{sc:"SC19",name:"חיפוש AI",route:"#/investigate/search",phase:"BETA",board:"2:09"},{sc:"SC21",name:"התראות וחוקים",route:"#/investigate/rules",phase:"BETA",board:"3:19"},{sc:"SC22",name:"עורך חוק",route:"#/investigate/rules/r-1",phase:"BETA",board:"3:19"}]},{mode:"הגדרות",items:[{sc:"SC28",name:"הגדרות המערכת",route:"#/system/diagnostics",phase:"PILOT",board:"3:23"},{sc:"SC24",name:"משתמשים והרשאות",route:"#/system/access",phase:"PILOT",board:"3:20"},{sc:"SC25",name:"יומן אודיט",route:"#/system/audit",phase:"PILOT",board:"3:21"},{sc:"SC20",name:"אנליטיקת אחסון",route:"#/system/storage",phase:"BETA",board:"2:11"},{sc:"SC26",name:"אשף התקנה",route:"#/system/setup",phase:"PILOT",board:"3:22"}]}],Ep={PILOT:"live",BETA:"recorded",V1:"neutral"};let Ni=class extends ${render(){return r`
      <sw-page heading="כל המסכים (סקירת עיצוב)" subheading="29 מסכים על נתוני הדגמה · SC29/SC30 הם אותם מסכים ברוחב טלפון · SC32 (Lovelace) הוא עטיפה של אותם רכיבים">
        ...
        <div class="groups">
          ${Pp.map(e=>r`<sw-card heading=${e.mode}>
              ${e.items.map(t=>r`<a href=${t.route}><span class="sc">${t.sc}</span><span class="name">${t.name}</span><span class="board">${t.board}</span><sw-badge kind=${Ep[t.phase]} label=${t.phase}></sw-badge><sw-icon name="chevron" size=${12}></sw-icon></a>`)}
            </sw-card>`)}
        </div>
      </sw-page>
    `}};Ni.styles=x`
  ...
  `;Ni=Ip([k("screens-index")],Ni);var Cp=Object.getOwnPropertyDescriptor,Tp=(e,t,s,i)=>{for(var a=i>1?void 0:i?Cp(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=o(a)||a);return a};const Dp=[["--sw-bg","רקע"],["--sw-surface","משטח"],["--sw-surface-3","משטח 3"],["--sw-border","גבול"],["--sw-text","טקסט"],["--sw-text-2","טקסט משני"],["--sw-text-3","טקסט שלישי"],["--sw-accent","כחול"],["--sw-accent-soft","כחול רך"],["--sw-live","חי"],["--sw-offline","מנותק"],["--sw-stale","מיושן"],["--sw-danger","שגיאה"],["--sw-purple","סגול (דלת)"]],Op=["live","recorded","historic","offline","stale","partial","unknown","forbidden","error"],Rp=["loading","empty","error","forbidden","stale","partial"],Np=["entrance","lobby","corridor","hall","parking","warehouse","backyard","driveway","night","building","house"],Lp=["dashboard","building","camera","bell","history","system","search","user","play","pause","back10","forward10","aperture","volume","mic","expand","close","chevron","chevronDown","warning","info","lock","unlock","offline","refresh","layers","floor","plus","minus","fit","door","light","sensor","check","clock","download","pin","more","map","upload","list","target","filter","users","shield","storage","edit","case","rule","link","grid","home","star","calendar","trash","eye","cpu","activity","image","wifi","signal","move","bookmark","route"];let Li=class extends ${render(){return r`
      ...
      <h3>צבעים</h3>
      <div class="swatches">
        ${Dp.map(([e,t])=>r`<div class="swatch"><div class="c" style="background:var(${e})"></div><div class="n"><span>${t}</span><span class="ltr">${e}</span></div></div>`)}
      </div>
      ...
      <div class="scenes">${Np.map(e=>r`<div><sw-scene kind=${e}></sw-scene><span>${e}</span></div>`)}</div>
      ...
      <div class="row">${Op.map(e=>r`<sw-badge kind=${e}></sw-badge>`)}</div>
      ...
      <h3>מצבי מסך</h3>
      <div class="grid">
        ${Rp.map(e=>r`<div class="panel"><sw-state-panel state=${e} actionLabel=${e==="error"?"נסה שוב":""}></sw-state-panel></div>`)}
      </div>
...
`):"כל הרכיבים שהתוסף רואה עובדים";return r`<button class="status-a sys ${t.status} ${e?"":"b"}" data-sys-pill data-status=${t.status} title=${a} aria-label=${`מצב המערכת: ${i}`} @click=${()=>window.location.hash="#/system/diagnostics?tab=health"}><i></i>${i}</button>`}renderSysBanner(){const e=this.sys;if(!e||e.status!=="error")return c;const t=e.items.filter(s=>s.status==="error");return r`<div class="sysbanner" role="alert" data-sys-banner><sw-icon name="warning" size=${16}></sw-icon><span>${t.map(s=>s.label).join(" · ")}</span><a href="#/system/diagnostics?tab=health">לבריאות המערכת</a></div>`}onSearchInput(e){const t=e.target.value;if(this.searchQ=t,window.clearTimeout(this.searchTimer),!t.trim()){this.searchResults=[],this.searchOpen=!1;return}this.searchTimer=window.setTimeout(()=>void this.runSearch(t),180)}async runSearch(e){if(!g()){this.searchResults=[],this.searchOpen=!0;return}const t=++this.searchSeq;this.searchBusy=!0;try{const s=await vc(e,6);if(t!==this.searchSeq)return;this.searchResults=s.results,this.searchIndex=s.results.length?0:-1,this.searchOpen=!0}catch{t===this.searchSeq&&(this.searchResults=[],this.searchOpen=!0)}finally{t===this.searchSeq&&(this.searchBusy=!1)}}onSearchKey(e){if(e.key==="Escape"){this.closeSearch(),e.target.blur();return}if(!this.searchOpen||!this.searchResults.length){e.key==="Enter"&&this.searchQ.trim()&&this.runSearch(this.searchQ);return}if(e.key==="ArrowDown")e.preventDefault(),this.searchIndex=(this.searchIndex+1)%this.searchResults.length;else if(e.key==="ArrowUp")e.preventDefault(),this.searchIndex=(this.searchIndex-1+this.searchResults.length)%this.searchResults.length;else if(e.key==="Enter"){e.preventDefault();const t=this.searchResults[this.searchIndex]??this.searchResults[0];t&&this.openResult(t)}}openResult(e){this.closeSearch();const t=this.renderRoot.querySelector(".search input");t&&(t.value="",t.blur()),this.searchQ="",this.searchResults=[],window.location.hash=`#${e.route}`}closeSearch(){this.searchOpen=!1,this.searchIndex=-1}redirectDemo(e){if(this.enforceKiosk(e))return!0;const t=Fp(e.path,this.session.mode==="api");return t?(window.location.replace(`#${t}`),!0):!1}get kioskOnly(){const e=(this.session.me?.bindings??[]).filter(t=>t.effect!=="deny");return this.session.mode==="api"&&e.length>0&&e.every(t=>t.role_id==="kiosk")}enforceKiosk(e){return!this.kioskOnly||e.segments[0]==="kiosk"?!1:(window.location.replace("#/kiosk/all"),!0)}get gated(){return this.session.mode==="no_access"||this.session.mode==="unauthenticated"}renderSearch(e){if(this.gated)return c;const t=this.searchOpen&&!!this.searchQ.trim();return r`<span class="searchwrap ${e?"a":""}">
    ...
    `}embedded(e=this.route){if(e?.params.get("embed")==="1")return!0;try{return sessionStorage.getItem("sw-embed")==="1"}catch{return!1}}render(){if(this.route?.segments[0]==="kiosk")return r`<main style="block-size:100dvh">${this.renderScreen()}</main>`;if(this.embedded())return r`<main class="embed" style="block-size:100dvh;overflow:auto">${this.renderScreen()}</main>`;if(this.design==="a")return this.renderA();const t=Dr(this.route),s=t?qa(Bp[t],this.session.mode==="api"):[],i=this.route?.segments[3]==="edit"||this.route?.segments[3]==="import";return r`
      ...
      <main>
        ${this.renderGate()||r`
          <div class="subnav">${s.length>1&&!i?r`<sw-tabs .items=${s} .active=${Hp(this.route)}></sw-tabs>`:c}</div>
          <div class="screen">${this.session.mode==="loading"?c:this.renderScreen()}</div>`}
      </main>
      <nav class="bottom" aria-label="ניווט ראשי">
...
//# sourceMappingURL=index-oMJczKX3.js.map
