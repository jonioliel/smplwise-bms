...
from .routers import access, anchors, backup, cameras, catalog, events, exports, frames, ha, health, me, media, plans, playback, playback_groups, recordings, search, settings as settings_router, zones
