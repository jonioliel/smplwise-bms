...
from .routers import access, anchors, backup, cameras, cases, catalog, events, exports, frames, ha, health, me, media, plans, playback, playback_groups, recordings, search, settings as settings_router, storage, zones
